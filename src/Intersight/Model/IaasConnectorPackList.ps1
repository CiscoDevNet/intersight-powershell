...
IaasConnectorPackList<PSCustomObject>
#>

function Initialize-IntersightIaasConnectorPackList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIaasConnectorPackList' | Write-Debug
...
Convert from JSON to IaasConnectorPackList<PSCustomObject>
...
IaasConnectorPackList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIaasConnectorPackList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIaasConnectorPackList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIaasConnectorPackList
