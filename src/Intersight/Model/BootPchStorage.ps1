...
BootPchStorage<PSCustomObject>
#>

function Initialize-IntersightBootPchStorage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootPchStorage' | Write-Debug
...
Convert from JSON to BootPchStorage<PSCustomObject>
...
BootPchStorage<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootPchStorage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootPchStorage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootPchStorage
        $AllProperties = ("ClassId", "ObjectType", "Enabled", "Name", "Bootloader", "Lun")
