...
SoftwarerepositoryReleaseList<PSCustomObject>
#>

function Initialize-IntersightSoftwarerepositoryReleaseList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwarerepositoryReleaseList' | Write-Debug
...
Convert from JSON to SoftwarerepositoryReleaseList<PSCustomObject>
...
SoftwarerepositoryReleaseList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwarerepositoryReleaseList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSoftwarerepositoryReleaseList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSoftwarerepositoryReleaseList
