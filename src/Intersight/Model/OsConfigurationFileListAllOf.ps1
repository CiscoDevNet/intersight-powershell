...
OsConfigurationFileListAllOf<PSCustomObject>
#>

function Initialize-IntersightOsConfigurationFileListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightOsConfigurationFileListAllOf' | Write-Debug
...
Convert from JSON to OsConfigurationFileListAllOf<PSCustomObject>
...
OsConfigurationFileListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToOsConfigurationFileListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightOsConfigurationFileListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightOsConfigurationFileListAllOf
