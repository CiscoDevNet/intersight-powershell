...
BootUsbAllOf<PSCustomObject>
#>

function Initialize-IntersightBootUsbAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.Usb")]
        [String]
        ${ClassId} = "boot.Usb",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.Usb")]
        ...
        ${ObjectType} = "boot.Usb",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("None", "usb-cd", "usb-fdd", "usb-hdd")]
        [String]
        ${Subtype} = "None"
    )

    Process {
        'Creating PSCustomObject: Intersight => IntersightBootUsbAllOf' | Write-Debug
...
Convert from JSON to BootUsbAllOf<PSCustomObject>
...
BootUsbAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootUsbAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootUsbAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootUsbAllOf
