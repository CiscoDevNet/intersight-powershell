...
AssetAddressInformationAllOf<PSCustomObject>
#>

function Initialize-IntersightAssetAddressInformationAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("asset.AddressInformation")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAssetAddressInformationAllOf' | Write-Debug
...
Convert from JSON to AssetAddressInformationAllOf<PSCustomObject>
...
AssetAddressInformationAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAssetAddressInformationAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAssetAddressInformationAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAssetAddressInformationAllOf
        $AllProperties = ("ClassId", "ObjectType", "Address1", "Address2", "Address3", "City", "Country", "County", "Location", "Name", "PostalCode", "Province", "State")
