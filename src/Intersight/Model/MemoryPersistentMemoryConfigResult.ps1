...
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryConfigResult {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "ConfigErrorDesc", "ConfigResult", "ConfigSequenceNo", "ConfigState", "InventoryDeviceInfo", "MemoryPersistentMemoryConfiguration", "PersistentMemoryNamespaceConfigResults", "RegisteredDevice")
