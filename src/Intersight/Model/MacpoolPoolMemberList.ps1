...
MacpoolPoolMemberList<PSCustomObject>
#>

function Initialize-IntersightMacpoolPoolMemberList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMacpoolPoolMemberList' | Write-Debug
...
Convert from JSON to MacpoolPoolMemberList<PSCustomObject>
...
MacpoolPoolMemberList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMacpoolPoolMemberList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMacpoolPoolMemberList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMacpoolPoolMemberList
