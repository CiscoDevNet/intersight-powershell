...
function ConvertFrom-IntersightJsonToApplianceBackupBase {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Filename", "Protocol", "RemoteHost", "RemotePath", "RemotePort", "Username")
