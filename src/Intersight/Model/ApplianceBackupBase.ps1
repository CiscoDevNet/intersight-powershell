...
function ConvertFrom-IntersightJsonToApplianceBackupBase {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Filename", "Protocol", "RemoteHost", "RemotePath", "RemotePort", "Username")
