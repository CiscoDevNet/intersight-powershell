...
function ConvertFrom-IntersightJsonToEquipmentChassis {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ChassisId", "ConnectionPath", "ConnectionStatus", "Description", "FaultSummary", "ManagementMode", "Name", "OperState", "PartNumber", "Pid", "PlatformType", "ProductName", "Sku", "Vid", "Blades", "Fanmodules", "InventoryDeviceInfo", "Ioms", "LocatorLed", "PsuControl", "Psus", "RegisteredDevice", "Sasexpanders", "Siocs", "StorageEnclosures")
