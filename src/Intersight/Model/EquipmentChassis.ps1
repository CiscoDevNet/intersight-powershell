...
function ConvertFrom-IntersightJsonToEquipmentChassis {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "AlarmSummary", "ChassisId", "ConnectionPath", "ConnectionStatus", "Description", "FaultSummary", "ManagementMode", "Name", "OperReason", "OperState", "PartNumber", "Pid", "PlatformType", "ProductName", "Sku", "Vid", "Blades", "Fanmodules", "InventoryDeviceInfo", "Ioms", "LocatorLed", "PsuControl", "Psus", "RegisteredDevice", "Sasexpanders", "Siocs", "StorageEnclosures", "VirtualDriveContainer")
