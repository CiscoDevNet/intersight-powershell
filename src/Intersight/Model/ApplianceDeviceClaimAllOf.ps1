...
function ConvertFrom-IntersightJsonToApplianceDeviceClaimAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "DeviceId", "Hostname", "IsPasswordSet", "IsRenew", "Message", "Password", "PlatformType", "RequestId", "SecurityToken", "Status", "Username", "Account")
