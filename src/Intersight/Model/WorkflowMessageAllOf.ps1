...
WorkflowMessageAllOf<PSCustomObject>
#>

function Initialize-IntersightWorkflowMessageAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.Message")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowMessageAllOf' | Write-Debug
...
Convert from JSON to WorkflowMessageAllOf<PSCustomObject>
...
WorkflowMessageAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowMessageAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowMessageAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowMessageAllOf
        $AllProperties = ("ClassId", "ObjectType", "Message", "Severity")
