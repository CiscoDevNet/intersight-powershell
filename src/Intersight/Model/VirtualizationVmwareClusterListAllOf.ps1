...
VirtualizationVmwareClusterListAllOf<PSCustomObject>
#>

function Initialize-IntersightVirtualizationVmwareClusterListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationVmwareClusterListAllOf' | Write-Debug
...
Convert from JSON to VirtualizationVmwareClusterListAllOf<PSCustomObject>
...
VirtualizationVmwareClusterListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationVmwareClusterListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationVmwareClusterListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationVmwareClusterListAllOf
