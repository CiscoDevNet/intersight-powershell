...
ConnectorUrl<PSCustomObject>
#>

function Initialize-IntersightConnectorUrl {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConnectorUrl' | Write-Debug
...
Convert from JSON to ConnectorUrl<PSCustomObject>
...
ConnectorUrl<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConnectorUrl {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConnectorUrl' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConnectorUrl
