...
InventoryGenericInventory<PSCustomObject>
#>

function Initialize-IntersightInventoryGenericInventory {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("inventory.GenericInventory")]
        [String]
        ${ClassId} = "inventory.GenericInventory",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("inventory.GenericInventory")]
        [String]
        ${ObjectType} = "inventory.GenericInventory",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightInventoryGenericInventory' | Write-Debug
...
Convert from JSON to InventoryGenericInventory<PSCustomObject>
...
InventoryGenericInventory<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToInventoryGenericInventory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightInventoryGenericInventory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightInventoryGenericInventory
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Key", "Type", "Value", "InventoryDeviceInfo", "InventoryGenericInventoryHolder", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "InventoryGenericInventoryHolder"))) { #optional property not found
            $InventoryGenericInventoryHolder = $null
        } else {
            $InventoryGenericInventoryHolder = $JsonParameters.PSobject.Properties["InventoryGenericInventoryHolder"].value
        }
