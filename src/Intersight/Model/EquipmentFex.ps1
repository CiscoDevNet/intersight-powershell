...
EquipmentFex<PSCustomObject>
#>

function Initialize-IntersightEquipmentFex {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.Fex")]
        [String]
        ${ClassId} = "equipment.Fex",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.Fex")]
        [String]
        ${ObjectType} = "equipment.Fex",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentFex' | Write-Debug
...
Convert from JSON to EquipmentFex<PSCustomObject>
...
EquipmentFex<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentFex {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentFex' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentFex
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ConnectionStatus", "Description", "ModuleId", "OperReason", "OperState", "PartNumber", "Pid", "Presence", "ProductName", "Sku", "Version", "Vid", "HostPorts", "MgmtController", "NetworkPorts", "DiscoveryState", "Fans", "InventoryDeviceInfo", "Ioms", "LocatorLed", "NetworkElement", "Psus", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "DiscoveryState"))) { #optional property not found
            $DiscoveryState = $null
        } else {
            $DiscoveryState = $JsonParameters.PSobject.Properties["DiscoveryState"].value
        }
