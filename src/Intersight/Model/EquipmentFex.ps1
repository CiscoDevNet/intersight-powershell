...
function ConvertFrom-IntersightJsonToEquipmentFex {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ConnectionStatus", "Description", "ModuleId", "OperState", "PartNumber", "Pid", "Presence", "ProductName", "Sku", "Version", "Vid", "HostPorts", "MgmtController", "NetworkPorts", "DiscoveryState", "Fans", "InventoryDeviceInfo", "LocatorLed", "NetworkElement", "Psus", "RegisteredDevice")
