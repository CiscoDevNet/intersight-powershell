...
function ConvertFrom-IntersightJsonToComputePhysicalSummary {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AdminPowerState", "AlarmSummary", "AssetTag", "AvailableMemory", "BiosPostComplete", "ChassisId", "ConnectionStatus", "CpuCapacity", "DeviceMoId", "Dn", "FaultSummary", "Firmware", "Ipv4Address", "KvmIpAddresses", "ManagementMode", "MemorySpeed", "MgmtIpAddress", "Model", "Name", "NumAdaptors", "NumCpuCores", "NumCpuCoresEnabled", "NumCpus", "NumEthHostInterfaces", "NumFcHostInterfaces", "NumThreads", "OperPowerState", "OperState", "Operability", "PlatformType", "Presence", "Revision", "Rn", "ScaledMode", "Serial", "ServerId", "ServiceProfile", "SlotId", "SourceObjectType", "TopologyScanStatus", "TotalMemory", "UserLabel", "Uuid", "Vendor", "InventoryDeviceInfo", "RegisteredDevice")
