...
ConnectorStreamMessageAllOf<PSCustomObject>
#>

function Initialize-IntersightConnectorStreamMessageAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConnectorStreamMessageAllOf' | Write-Debug
...
Convert from JSON to ConnectorStreamMessageAllOf<PSCustomObject>
...
ConnectorStreamMessageAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConnectorStreamMessageAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConnectorStreamMessageAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConnectorStreamMessageAllOf
        $AllProperties = ("ClassId", "ObjectType", "StreamName")
