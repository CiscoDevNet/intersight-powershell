...
SoftwareHclMetaListAllOf<PSCustomObject>
#>

function Initialize-IntersightSoftwareHclMetaListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwareHclMetaListAllOf' | Write-Debug
...
Convert from JSON to SoftwareHclMetaListAllOf<PSCustomObject>
...
SoftwareHclMetaListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwareHclMetaListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSoftwareHclMetaListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSoftwareHclMetaListAllOf
