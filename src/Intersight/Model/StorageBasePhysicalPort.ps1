...
StorageBasePhysicalPort<PSCustomObject>
#>

function Initialize-IntersightStorageBasePhysicalPort {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiPort", "storage.NetAppFcInterface", "storage.NetAppFcPort", "storage.PurePort")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiPort", "storage.NetAppFcInterface", "storage.NetAppFcPort", "storage.PurePort")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageBasePhysicalPort' | Write-Debug
...
Convert from JSON to StorageBasePhysicalPort<PSCustomObject>
...
StorageBasePhysicalPort<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageBasePhysicalPort {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageBasePhysicalPort' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageBasePhysicalPort
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Iqn", "Name", "Speed", "Status", "Type", "Wwn", "Wwnn", "Wwpn")
