...
function Initialize-IntersightStorageBasePhysicalPort {
    ...
    Param (
        ...
        [ValidateSet("storage.HitachiPort", "storage.PurePort")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiPort", "storage.PurePort")]
...
function ConvertFrom-IntersightJsonToStorageBasePhysicalPort {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Iqn", "Name", "Speed", "Status", "Type", "Wwn", "Wwnn", "Wwpn")
