...
function ConvertFrom-IntersightJsonToStoragePureHostLun {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Hlu", "HostName", "VolumeName", "HostGroupName", "Shared", "Array", "Host", "HostGroup", "RegisteredDevice", "Volume")
