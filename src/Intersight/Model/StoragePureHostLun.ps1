...
StoragePureHostLun<PSCustomObject>
#>

function Initialize-IntersightStoragePureHostLun {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PureHostLun")]
        [String]
        ${ClassId} = "storage.PureHostLun",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PureHostLun")]
        [String]
        ${ObjectType} = "storage.PureHostLun",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePureHostLun' | Write-Debug
...
Convert from JSON to StoragePureHostLun<PSCustomObject>
...
StoragePureHostLun<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePureHostLun {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePureHostLun' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePureHostLun
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Hlu", "HostName", "VolumeName", "HostGroupName", "Shared", "Array", "Host", "HostGroup", "RegisteredDevice", "Volume")
