...
function ConvertFrom-IntersightJsonToStoragePureHostLun {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Hlu", "HostName", "VolumeName", "HostGroupName", "Shared", "Array", "Host", "HostGroup", "RegisteredDevice", "Volume")
