...
function ConvertFrom-IntersightJsonToIaasMostRunTasks {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "TaskCategory", "TaskExecutionCount", "TaskName", "TaskType", "Guid")
