...
WorkflowFailureEndTask<PSCustomObject>
#>

function Initialize-IntersightWorkflowFailureEndTask {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowFailureEndTask' | Write-Debug
...
Convert from JSON to WorkflowFailureEndTask<PSCustomObject>
...
WorkflowFailureEndTask<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowFailureEndTask {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowFailureEndTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowFailureEndTask
