...
function ConvertFrom-IntersightJsonToPciSwitch {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "DeviceId", "Health", "NumOfAdaptors", "PciAddress", "PciSlot", "ProductName", "ProductRevision", "SubDeviceId", "SubVendorId", "Temperature", "Type", "VendorId", "ComputeBoard", "InventoryDeviceInfo", "Links", "RegisteredDevice", "RunningFirmware")
