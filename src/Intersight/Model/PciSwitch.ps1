...
function Initialize-IntersightPciSwitch {
    ...
    Param (
        ...
        [ValidateSet("pci.Switch")]
        [String]
        ${ClassId} = "pci.Switch",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("pci.Switch")]
        [String]
        ${ObjectType} = "pci.Switch",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
...
function ConvertFrom-IntersightJsonToPciSwitch {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "DeviceId", "Health", "NumOfAdaptors", "PciAddress", "PciSlot", "ProductName", "ProductRevision", "SubDeviceId", "SubVendorId", "Temperature", "Type", "VendorId", "ComputeBoard", "InventoryDeviceInfo", "Links", "RegisteredDevice", "RunningFirmware")
