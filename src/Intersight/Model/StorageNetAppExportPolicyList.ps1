...
StorageNetAppExportPolicyList<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppExportPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppExportPolicyList' | Write-Debug
...
Convert from JSON to StorageNetAppExportPolicyList<PSCustomObject>
...
StorageNetAppExportPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppExportPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppExportPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppExportPolicyList
