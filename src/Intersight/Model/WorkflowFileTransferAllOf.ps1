...
WorkflowFileTransferAllOf<PSCustomObject>
#>

function Initialize-IntersightWorkflowFileTransferAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowFileTransferAllOf' | Write-Debug
...
Convert from JSON to WorkflowFileTransferAllOf<PSCustomObject>
...
WorkflowFileTransferAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowFileTransferAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowFileTransferAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowFileTransferAllOf
        $AllProperties = ("ClassId", "ObjectType", "DestinationFilePath", "FileMode", "SourceFilePath")
