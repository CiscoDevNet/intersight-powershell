...
HyperflexProxySettingPolicy<PSCustomObject>
#>

function Initialize-IntersightHyperflexProxySettingPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexProxySettingPolicy' | Write-Debug
...
Convert from JSON to HyperflexProxySettingPolicy<PSCustomObject>
...
HyperflexProxySettingPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexProxySettingPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexProxySettingPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexProxySettingPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Hostname", "IsPasswordSet", "Password", "Port", "Username", "ClusterProfiles", "Organization")
