...
function ConvertFrom-IntersightJsonToHyperflexProxySettingPolicy {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Hostname", "IsPasswordSet", "Password", "Port", "Username", "ClusterProfiles", "Organization")
