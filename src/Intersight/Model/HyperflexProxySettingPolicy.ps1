...
function ConvertFrom-IntersightJsonToHyperflexProxySettingPolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Hostname", "IsPasswordSet", "Password", "Port", "Username", "ClusterProfiles", "Organization")
