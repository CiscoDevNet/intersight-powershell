...
function ConvertFrom-IntersightJsonToStorageFlexFlashControllerProps {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "CardsManageable", "ConfiguredMode", "ControllerName", "ControllerStatus", "FwVersion", "InternalState", "OperatingMode", "PhysicalDriveCount", "ProductName", "StartupFwVersion", "VirtualDriveCount", "InventoryDeviceInfo", "RegisteredDevice", "StorageFlexFlashController")
