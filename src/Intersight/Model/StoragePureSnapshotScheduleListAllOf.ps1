...
StoragePureSnapshotScheduleListAllOf<PSCustomObject>
#>

function Initialize-IntersightStoragePureSnapshotScheduleListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePureSnapshotScheduleListAllOf' | Write-Debug
...
Convert from JSON to StoragePureSnapshotScheduleListAllOf<PSCustomObject>
...
StoragePureSnapshotScheduleListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePureSnapshotScheduleListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePureSnapshotScheduleListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePureSnapshotScheduleListAllOf
