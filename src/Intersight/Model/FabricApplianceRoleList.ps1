...
FabricApplianceRoleList<PSCustomObject>
#>

function Initialize-IntersightFabricApplianceRoleList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricApplianceRoleList' | Write-Debug
...
Convert from JSON to FabricApplianceRoleList<PSCustomObject>
...
FabricApplianceRoleList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricApplianceRoleList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricApplianceRoleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricApplianceRoleList
