...
IaasLicenseInfoListAllOf<PSCustomObject>
#>

function Initialize-IntersightIaasLicenseInfoListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIaasLicenseInfoListAllOf' | Write-Debug
...
Convert from JSON to IaasLicenseInfoListAllOf<PSCustomObject>
...
IaasLicenseInfoListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIaasLicenseInfoListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIaasLicenseInfoListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIaasLicenseInfoListAllOf
