...
BootNvmeDeviceListAllOf<PSCustomObject>
#>

function Initialize-IntersightBootNvmeDeviceListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootNvmeDeviceListAllOf' | Write-Debug
...
Convert from JSON to BootNvmeDeviceListAllOf<PSCustomObject>
...
BootNvmeDeviceListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootNvmeDeviceListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootNvmeDeviceListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootNvmeDeviceListAllOf
