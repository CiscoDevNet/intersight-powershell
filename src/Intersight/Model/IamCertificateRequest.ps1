...
IamCertificateRequest<PSCustomObject>
#>

function Initialize-IntersightIamCertificateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamCertificateRequest' | Write-Debug
...
Convert from JSON to IamCertificateRequest<PSCustomObject>
...
IamCertificateRequest<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamCertificateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamCertificateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamCertificateRequest
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "EmailAddress", "Name", "Request", "SelfSigned", "Subject", "SubjectAlternateName", "Account", "Certificate", "PrivateKeySpec")
