...
PoolAbstractPool<PSCustomObject>
#>

function Initialize-IntersightPoolAbstractPool {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fcpool.Pool", "ippool.Pool", "ippool.ShadowPool", "iqnpool.Pool", "macpool.Pool", "uuidpool.Pool")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fcpool.Pool", "ippool.Pool", "ippool.ShadowPool", "iqnpool.Pool", "macpool.Pool", "uuidpool.Pool")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPoolAbstractPool' | Write-Debug
...
Convert from JSON to PoolAbstractPool<PSCustomObject>
...
PoolAbstractPool<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPoolAbstractPool {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPoolAbstractPool' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPoolAbstractPool
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Assigned", "AssignmentOrder", "Size")
