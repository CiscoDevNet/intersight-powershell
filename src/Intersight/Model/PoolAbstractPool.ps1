...
function Initialize-IntersightPoolAbstractPool {
    ...
    Param (
        ...
        [ValidateSet("fcpool.Pool", "ippool.Pool", "ippool.ShadowPool", "macpool.Pool", "uuidpool.Pool")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fcpool.Pool", "ippool.Pool", "ippool.ShadowPool", "macpool.Pool", "uuidpool.Pool")]
...
function ConvertFrom-IntersightJsonToPoolAbstractPool {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Assigned", "AssignmentOrder", "Size")
