...
AssetParentConnectionSignatureAllOf<PSCustomObject>
#>

function Initialize-IntersightAssetParentConnectionSignatureAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("asset.ParentConnectionSignature")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAssetParentConnectionSignatureAllOf' | Write-Debug
...
Convert from JSON to AssetParentConnectionSignatureAllOf<PSCustomObject>
...
AssetParentConnectionSignatureAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAssetParentConnectionSignatureAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAssetParentConnectionSignatureAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAssetParentConnectionSignatureAllOf
        $AllProperties = ("ClassId", "ObjectType", "DeviceId", "NodeId", "Signature", "TimeStamp")
