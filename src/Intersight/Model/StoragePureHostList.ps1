...
StoragePureHostList<PSCustomObject>
#>

function Initialize-IntersightStoragePureHostList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePureHostList' | Write-Debug
...
Convert from JSON to StoragePureHostList<PSCustomObject>
...
StoragePureHostList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePureHostList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePureHostList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePureHostList
