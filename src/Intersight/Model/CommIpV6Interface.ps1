...
CommIpV6Interface<PSCustomObject>
#>

function Initialize-IntersightCommIpV6Interface {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCommIpV6Interface' | Write-Debug
...
Convert from JSON to CommIpV6Interface<PSCustomObject>
...
CommIpV6Interface<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCommIpV6Interface {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCommIpV6Interface' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCommIpV6Interface
