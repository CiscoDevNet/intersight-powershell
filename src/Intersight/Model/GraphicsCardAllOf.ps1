...
function ConvertFrom-IntersightJsonToGraphicsCardAllOf {
    ...
    Process {
        ...
        $AllProperties = ("CardId", "DeviceId", "ExpanderSlot", "FirmwareVersion", "Mode", "NumGpus", "OperState", "PciAddress", "PciAddressList", "PciSlot", "ComputeBlade", "ComputeBoard", "ComputeRackUnit", "GraphicsControllers", "InventoryDeviceInfo", "RegisteredDevice", "RunningFirmware")
