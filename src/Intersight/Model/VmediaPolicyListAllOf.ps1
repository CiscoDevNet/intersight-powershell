...
VmediaPolicyListAllOf<PSCustomObject>
#>

function Initialize-IntersightVmediaPolicyListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVmediaPolicyListAllOf' | Write-Debug
...
Convert from JSON to VmediaPolicyListAllOf<PSCustomObject>
...
VmediaPolicyListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVmediaPolicyListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVmediaPolicyListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVmediaPolicyListAllOf
