...
FirmwareRunningFirmwareListAllOf<PSCustomObject>
#>

function Initialize-IntersightFirmwareRunningFirmwareListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareRunningFirmwareListAllOf' | Write-Debug
...
Convert from JSON to FirmwareRunningFirmwareListAllOf<PSCustomObject>
...
FirmwareRunningFirmwareListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareRunningFirmwareListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareRunningFirmwareListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareRunningFirmwareListAllOf
