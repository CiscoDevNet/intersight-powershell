...
ComputeRackUnitIdentityList<PSCustomObject>
#>

function Initialize-IntersightComputeRackUnitIdentityList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightComputeRackUnitIdentityList' | Write-Debug
...
Convert from JSON to ComputeRackUnitIdentityList<PSCustomObject>
...
ComputeRackUnitIdentityList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToComputeRackUnitIdentityList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightComputeRackUnitIdentityList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightComputeRackUnitIdentityList
