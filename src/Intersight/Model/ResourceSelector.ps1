...
function Initialize-IntersightResourceSelector {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightResourceSelector' | Write-Debug
...
Convert from JSON to ResourceSelector<PSCustomObject>
...
ResourceSelector<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToResourceSelector {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightResourceSelector' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightResourceSelector
