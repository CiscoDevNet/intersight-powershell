...
ComputeBoardList<PSCustomObject>
#>

function Initialize-IntersightComputeBoardList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightComputeBoardList' | Write-Debug
...
Convert from JSON to ComputeBoardList<PSCustomObject>
...
ComputeBoardList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToComputeBoardList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightComputeBoardList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightComputeBoardList
