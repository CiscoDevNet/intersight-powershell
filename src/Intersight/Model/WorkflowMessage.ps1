...
WorkflowMessage<PSCustomObject>
#>

function Initialize-IntersightWorkflowMessage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowMessage' | Write-Debug
...
Convert from JSON to WorkflowMessage<PSCustomObject>
...
WorkflowMessage<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowMessage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowMessage
