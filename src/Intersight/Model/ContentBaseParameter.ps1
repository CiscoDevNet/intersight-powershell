...
ContentBaseParameter<PSCustomObject>
#>

function Initialize-IntersightContentBaseParameter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightContentBaseParameter' | Write-Debug
...
Convert from JSON to ContentBaseParameter<PSCustomObject>
...
ContentBaseParameter<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToContentBaseParameter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightContentBaseParameter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightContentBaseParameter
