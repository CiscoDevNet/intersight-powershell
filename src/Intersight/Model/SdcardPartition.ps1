...
SdcardPartition<PSCustomObject>
#>

function Initialize-IntersightSdcardPartition {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSdcardPartition' | Write-Debug
...
Convert from JSON to SdcardPartition<PSCustomObject>
...
SdcardPartition<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSdcardPartition {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSdcardPartition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSdcardPartition
