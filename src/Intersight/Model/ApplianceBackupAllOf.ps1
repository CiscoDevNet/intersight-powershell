...
ApplianceBackupAllOf<PSCustomObject>
#>

function Initialize-IntersightApplianceBackupAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightApplianceBackupAllOf' | Write-Debug
...
Convert from JSON to ApplianceBackupAllOf<PSCustomObject>
...
ApplianceBackupAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToApplianceBackupAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightApplianceBackupAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightApplianceBackupAllOf
        $AllProperties = ("ElapsedTime", "EndTime", "IsPasswordSet", "Messages", "Password", "StartTime", "Status", "Account")
