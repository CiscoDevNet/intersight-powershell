...
StorageBaseHost<PSCustomObject>
#>

function Initialize-IntersightStorageBaseHost {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiHost", "storage.NetAppInitiatorGroup", "storage.PureHost")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiHost", "storage.NetAppInitiatorGroup", "storage.PureHost")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageBaseHost' | Write-Debug
...
Convert from JSON to StorageBaseHost<PSCustomObject>
...
StorageBaseHost<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageBaseHost {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageBaseHost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageBaseHost
