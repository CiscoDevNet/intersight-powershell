...
CapabilityChassisDescriptor<PSCustomObject>
#>

function Initialize-IntersightCapabilityChassisDescriptor {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.ChassisDescriptor")]
        [String]
        ${ClassId} = "capability.ChassisDescriptor",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.ChassisDescriptor")]
        [String]
        ${ObjectType} = "capability.ChassisDescriptor",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilityChassisDescriptor' | Write-Debug
...
Convert from JSON to CapabilityChassisDescriptor<PSCustomObject>
...
CapabilityChassisDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilityChassisDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilityChassisDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilityChassisDescriptor
