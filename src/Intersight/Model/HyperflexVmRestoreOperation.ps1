...
HyperflexVmRestoreOperation<PSCustomObject>
#>

function Initialize-IntersightHyperflexVmRestoreOperation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexVmRestoreOperation' | Write-Debug
...
Convert from JSON to HyperflexVmRestoreOperation<PSCustomObject>
...
HyperflexVmRestoreOperation<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexVmRestoreOperation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexVmRestoreOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexVmRestoreOperation
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "NewName", "PowerOn", "Organization", "RestoreEdgeClusterMoid", "VmBackupInfoMoid", "VmSnapshotInfoMoid")
