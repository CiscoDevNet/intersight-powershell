...
VirtualizationMemoryCapacityAllOf<PSCustomObject>
#>

function Initialize-IntersightVirtualizationMemoryCapacityAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("virtualization.MemoryCapacity")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationMemoryCapacityAllOf' | Write-Debug
...
Convert from JSON to VirtualizationMemoryCapacityAllOf<PSCustomObject>
...
VirtualizationMemoryCapacityAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationMemoryCapacityAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationMemoryCapacityAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationMemoryCapacityAllOf
