...
FcPhysicalPort<PSCustomObject>
#>

function Initialize-IntersightFcPhysicalPort {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fc.PhysicalPort")]
        [String]
        ${ClassId} = "fc.PhysicalPort",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fc.PhysicalPort")]
        [String]
        ${ObjectType} = "fc.PhysicalPort",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFcPhysicalPort' | Write-Debug
...
Convert from JSON to FcPhysicalPort<PSCustomObject>
...
FcPhysicalPort<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFcPhysicalPort {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFcPhysicalPort' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFcPhysicalPort
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "OperState", "OperStateQual", "PortId", "Role", "SlotId", "SwitchId", "AdminSpeed", "AdminState", "B2bCredit", "MaxSpeed", "Mode", "OperSpeed", "PeerDn", "PortChannelId", "TransceiverType", "Vsan", "Wwn", "InventoryDeviceInfo", "PortGroup", "PortSubGroup", "RegisteredDevice")
