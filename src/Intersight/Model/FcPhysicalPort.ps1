...
function ConvertFrom-IntersightJsonToFcPhysicalPort {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "OperState", "OperStateQual", "PortId", "Role", "SlotId", "SwitchId", "AdminSpeed", "AdminState", "B2bCredit", "MaxSpeed", "Mode", "OperSpeed", "PeerDn", "PortChannelId", "TransceiverType", "Vsan", "Wwn", "InventoryDeviceInfo", "PortGroup", "PortSubGroup", "RegisteredDevice")
