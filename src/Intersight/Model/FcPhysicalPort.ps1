...
function ConvertFrom-IntersightJsonToFcPhysicalPort {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "OperState", "OperStateQual", "PortId", "Role", "SlotId", "SwitchId", "AdminSpeed", "AdminState", "B2bCredit", "MaxSpeed", "Mode", "OperSpeed", "PeerDn", "PortChannelId", "TransceiverType", "Vsan", "Wwn", "InventoryDeviceInfo", "PortGroup", "PortSubGroup", "RegisteredDevice")
