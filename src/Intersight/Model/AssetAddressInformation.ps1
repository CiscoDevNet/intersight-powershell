...
AssetAddressInformation<PSCustomObject>
#>

function Initialize-IntersightAssetAddressInformation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAssetAddressInformation' | Write-Debug
...
Convert from JSON to AssetAddressInformation<PSCustomObject>
...
AssetAddressInformation<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAssetAddressInformation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAssetAddressInformation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAssetAddressInformation
