...
function ConvertFrom-IntersightJsonToEquipmentRackEnclosureSlot {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "RackId", "RackUnitDn", "EquipmentRackEnclosure", "InventoryDeviceInfo", "RackUnit", "RegisteredDevice")
