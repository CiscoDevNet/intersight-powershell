...
EquipmentRackEnclosureSlot<PSCustomObject>
#>

function Initialize-IntersightEquipmentRackEnclosureSlot {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.RackEnclosureSlot")]
        [String]
        ${ClassId} = "equipment.RackEnclosureSlot",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.RackEnclosureSlot")]
        [String]
        ${ObjectType} = "equipment.RackEnclosureSlot",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentRackEnclosureSlot' | Write-Debug
...
Convert from JSON to EquipmentRackEnclosureSlot<PSCustomObject>
...
EquipmentRackEnclosureSlot<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentRackEnclosureSlot {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentRackEnclosureSlot' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentRackEnclosureSlot
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "RackId", "RackUnitDn", "EquipmentRackEnclosure", "InventoryDeviceInfo", "RackUnit", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "RackId"))) { #optional property not found
            $RackId = $null
        } else {
            $RackId = $JsonParameters.PSobject.Properties["RackId"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "RackUnitDn"))) { #optional property not found
            $RackUnitDn = $null
        } else {
            $RackUnitDn = $JsonParameters.PSobject.Properties["RackUnitDn"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "RackUnit"))) { #optional property not found
            $RackUnit = $null
        } else {
            $RackUnit = $JsonParameters.PSobject.Properties["RackUnit"].value
        }
