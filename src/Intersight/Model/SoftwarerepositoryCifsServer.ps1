...
SoftwarerepositoryCifsServer<PSCustomObject>
#>

function Initialize-IntersightSoftwarerepositoryCifsServer {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("softwarerepository.CifsServer")]
        [String]
        ${ClassId} = "softwarerepository.CifsServer",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("softwarerepository.CifsServer")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwarerepositoryCifsServer' | Write-Debug
...
Convert from JSON to SoftwarerepositoryCifsServer<PSCustomObject>
...
SoftwarerepositoryCifsServer<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwarerepositoryCifsServer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSoftwarerepositoryCifsServer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSoftwarerepositoryCifsServer
        $AllProperties = ("ClassId", "ObjectType", "FileLocation", "IsPasswordSet", "MountOption", "Password", "RemoteFile", "RemoteIp", "RemoteShare", "Username")
