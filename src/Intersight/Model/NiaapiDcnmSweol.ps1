...
NiaapiDcnmSweol<PSCustomObject>
#>

function Initialize-IntersightNiaapiDcnmSweol {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiDcnmSweol' | Write-Debug
...
Convert from JSON to NiaapiDcnmSweol<PSCustomObject>
...
NiaapiDcnmSweol<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiDcnmSweol {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiDcnmSweol' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiDcnmSweol
