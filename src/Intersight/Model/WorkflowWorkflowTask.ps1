...
WorkflowWorkflowTask<PSCustomObject>
#>

function Initialize-IntersightWorkflowWorkflowTask {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowWorkflowTask' | Write-Debug
...
Convert from JSON to WorkflowWorkflowTask<PSCustomObject>
...
WorkflowWorkflowTask<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowWorkflowTask {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowWorkflowTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowWorkflowTask
