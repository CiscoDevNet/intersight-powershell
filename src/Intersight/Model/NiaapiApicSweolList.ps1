...
NiaapiApicSweolList<PSCustomObject>
#>

function Initialize-IntersightNiaapiApicSweolList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiApicSweolList' | Write-Debug
...
Convert from JSON to NiaapiApicSweolList<PSCustomObject>
...
NiaapiApicSweolList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiApicSweolList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiApicSweolList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiApicSweolList
