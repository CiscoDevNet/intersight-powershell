...
function ConvertFrom-IntersightJsonToWorkflowWebApi {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Body", "ContentType", "Name", "Outcomes", "ResponseSpec", "SkipOnCondition", "StartDelay", "Timeout", "EndpointRequestType", "Headers", "Method", "MoType", "Protocol", "TargetType", "Url")
