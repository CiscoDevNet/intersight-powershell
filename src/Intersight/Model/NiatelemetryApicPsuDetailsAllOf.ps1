...
Definition of the list of properties defined in 'niatelemetry.ApicPsuDetails', excluding properties defined in parent classes.
...
NiatelemetryApicPsuDetailsAllOf<PSCustomObject>
#>

function Initialize-IntersightNiatelemetryApicPsuDetailsAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiatelemetryApicPsuDetailsAllOf' | Write-Debug
...
Convert from JSON to NiatelemetryApicPsuDetailsAllOf<PSCustomObject>
...
NiatelemetryApicPsuDetailsAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiatelemetryApicPsuDetailsAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiatelemetryApicPsuDetailsAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiatelemetryApicPsuDetailsAllOf
