...
FabricAppliancePcRole<PSCustomObject>
#>

function Initialize-IntersightFabricAppliancePcRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricAppliancePcRole' | Write-Debug
...
Convert from JSON to FabricAppliancePcRole<PSCustomObject>
...
FabricAppliancePcRole<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricAppliancePcRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricAppliancePcRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricAppliancePcRole
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "PcId", "Ports", "PortPolicy", "AdminSpeed", "Mode", "Priority", "EthNetworkControlPolicy", "EthNetworkGroupPolicy")
