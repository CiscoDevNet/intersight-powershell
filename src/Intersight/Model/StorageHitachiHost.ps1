...
StorageHitachiHost<PSCustomObject>
#>

function Initialize-IntersightStorageHitachiHost {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageHitachiHost' | Write-Debug
...
Convert from JSON to StorageHitachiHost<PSCustomObject>
...
StorageHitachiHost<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageHitachiHost {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageHitachiHost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageHitachiHost
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Initiators", "Name", "OsType", "StorageUtilization", "AuthenticationMode", "HostGroupId", "HostGroupNumber", "HostModeOptions", "IsChapMutual", "IscsiName", "PortId", "PortLunSecurity", "Type", "Wwn", "Array", "RegisteredDevice")
