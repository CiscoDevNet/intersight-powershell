...
WorkflowControlTask<PSCustomObject>
#>

function Initialize-IntersightWorkflowControlTask {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowControlTask' | Write-Debug
...
Convert from JSON to WorkflowControlTask<PSCustomObject>
...
WorkflowControlTask<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowControlTask {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowControlTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowControlTask
