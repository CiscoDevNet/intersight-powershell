...
StorageNetAppLunMapListAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppLunMapListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppLunMapListAllOf' | Write-Debug
...
Convert from JSON to StorageNetAppLunMapListAllOf<PSCustomObject>
...
StorageNetAppLunMapListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppLunMapListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppLunMapListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppLunMapListAllOf
