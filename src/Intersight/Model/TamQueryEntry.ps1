...
TamQueryEntry<PSCustomObject>
#>

function Initialize-IntersightTamQueryEntry {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTamQueryEntry' | Write-Debug
...
Convert from JSON to TamQueryEntry<PSCustomObject>
...
TamQueryEntry<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTamQueryEntry {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTamQueryEntry' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTamQueryEntry
