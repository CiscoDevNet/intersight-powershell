...
WorkflowMoReferenceDataType<PSCustomObject>
#>

function Initialize-IntersightWorkflowMoReferenceDataType {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.MoReferenceDataType")]
        [String]
        ${ClassId} = "workflow.MoReferenceDataType",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.MoReferenceDataType")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowMoReferenceDataType' | Write-Debug
...
Convert from JSON to WorkflowMoReferenceDataType<PSCustomObject>
...
WorkflowMoReferenceDataType<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowMoReferenceDataType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowMoReferenceDataType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowMoReferenceDataType
        $AllProperties = ("ClassId", "ObjectType", "Default", "Description", "DisplayMeta", "InputParameters", "Label", "Name", "Required", "Properties")
