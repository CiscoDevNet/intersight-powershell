...
IaasLicenseInfoList<PSCustomObject>
#>

function Initialize-IntersightIaasLicenseInfoList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIaasLicenseInfoList' | Write-Debug
...
Convert from JSON to IaasLicenseInfoList<PSCustomObject>
...
IaasLicenseInfoList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIaasLicenseInfoList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIaasLicenseInfoList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIaasLicenseInfoList
