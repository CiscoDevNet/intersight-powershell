...
function ConvertFrom-IntersightJsonToManagementInterfaceAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Gateway", "HostName", "IpAddress", "Ipv4Address", "Ipv4Gateway", "Ipv4Mask", "Ipv6Address", "Ipv6Gateway", "Ipv6Prefix", "MacAddress", "Mask", "SwitchId", "UemConnStatus", "VirtualHostName", "InventoryDeviceInfo", "ManagementController", "RegisteredDevice")
