...
IqnpoolPool<PSCustomObject>
#>

function Initialize-IntersightIqnpoolPool {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iqnpool.Pool")]
        [String]
        ${ClassId} = "iqnpool.Pool",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iqnpool.Pool")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIqnpoolPool' | Write-Debug
        ...
        if (!$IqnSuffixBlocks -and $IqnSuffixBlocks.length -lt 1) {
            throw "invalid value for 'IqnSuffixBlocks', number of items must be greater than or equal to 1."
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "IqnSuffixBlocks" = ${IqnSuffixBlocks}
            "Prefix" = ${Prefix}
...
Convert from JSON to IqnpoolPool<PSCustomObject>
...
IqnpoolPool<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIqnpoolPool {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIqnpoolPool' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIqnpoolPool
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Assigned", "AssignmentOrder", "Size", "IqnSuffixBlocks", "Prefix", "BlockHeads", "Organization")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "IqnSuffixBlocks"))) { #optional property not found
            $IqnSuffixBlocks = $null
        } else {
            $IqnSuffixBlocks = $JsonParameters.PSobject.Properties["IqnSuffixBlocks"].value
        }
