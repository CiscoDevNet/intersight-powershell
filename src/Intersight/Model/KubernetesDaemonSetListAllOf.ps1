...
KubernetesDaemonSetListAllOf<PSCustomObject>
#>

function Initialize-IntersightKubernetesDaemonSetListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesDaemonSetListAllOf' | Write-Debug
...
Convert from JSON to KubernetesDaemonSetListAllOf<PSCustomObject>
...
KubernetesDaemonSetListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesDaemonSetListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesDaemonSetListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesDaemonSetListAllOf
