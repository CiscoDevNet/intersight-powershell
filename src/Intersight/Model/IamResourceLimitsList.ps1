...
IamResourceLimitsList<PSCustomObject>
#>

function Initialize-IntersightIamResourceLimitsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamResourceLimitsList' | Write-Debug
...
Convert from JSON to IamResourceLimitsList<PSCustomObject>
...
IamResourceLimitsList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamResourceLimitsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamResourceLimitsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamResourceLimitsList
