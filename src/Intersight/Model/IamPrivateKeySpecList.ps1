...
IamPrivateKeySpecList<PSCustomObject>
#>

function Initialize-IntersightIamPrivateKeySpecList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamPrivateKeySpecList' | Write-Debug
...
Convert from JSON to IamPrivateKeySpecList<PSCustomObject>
...
IamPrivateKeySpecList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamPrivateKeySpecList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamPrivateKeySpecList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamPrivateKeySpecList
