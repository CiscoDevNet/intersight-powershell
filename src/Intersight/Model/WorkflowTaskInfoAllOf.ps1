...
function ConvertFrom-IntersightJsonToWorkflowTaskInfoAllOf {
    ...
    Process {
        ...
        $AllProperties = ("Description", "EndTime", "FailureReason", "Input", "InstId", "Internal", "Label", "Message", "Name", "Output", "RefName", "RetryCount", "RunningInstId", "StartTime", "Status", "TaskInstIdList", "SubWorkflowInfo", "TaskDefinition", "WorkflowInfo")
