...
PciSwitchListAllOf<PSCustomObject>
#>

function Initialize-IntersightPciSwitchListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPciSwitchListAllOf' | Write-Debug
...
Convert from JSON to PciSwitchListAllOf<PSCustomObject>
...
PciSwitchListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPciSwitchListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPciSwitchListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPciSwitchListAllOf
