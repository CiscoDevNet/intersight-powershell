...
ForecastDefinitionList<PSCustomObject>
#>

function Initialize-IntersightForecastDefinitionList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightForecastDefinitionList' | Write-Debug
...
Convert from JSON to ForecastDefinitionList<PSCustomObject>
...
ForecastDefinitionList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToForecastDefinitionList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightForecastDefinitionList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightForecastDefinitionList
