...
function ConvertFrom-IntersightJsonToStoragePurePort {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Iqn", "Name", "Speed", "Status", "Type", "Wwn", "Wwnn", "Wwpn", "Failover", "Portal", "Array", "Controller", "RegisteredDevice")
