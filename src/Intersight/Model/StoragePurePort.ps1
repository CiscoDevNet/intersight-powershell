...
function ConvertFrom-IntersightJsonToStoragePurePort {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Iqn", "Name", "Speed", "Status", "Type", "Wwn", "Wwnn", "Wwpn", "Failover", "Portal", "Array", "Controller", "RegisteredDevice")
