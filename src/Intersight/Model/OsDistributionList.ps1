...
OsDistributionList<PSCustomObject>
#>

function Initialize-IntersightOsDistributionList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightOsDistributionList' | Write-Debug
...
Convert from JSON to OsDistributionList<PSCustomObject>
...
OsDistributionList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToOsDistributionList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightOsDistributionList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightOsDistributionList
