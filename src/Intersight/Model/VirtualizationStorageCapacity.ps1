...
VirtualizationStorageCapacity<PSCustomObject>
#>

function Initialize-IntersightVirtualizationStorageCapacity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationStorageCapacity' | Write-Debug
...
Convert from JSON to VirtualizationStorageCapacity<PSCustomObject>
...
VirtualizationStorageCapacity<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationStorageCapacity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationStorageCapacity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationStorageCapacity
