...
VirtualizationHost<PSCustomObject>
#>

function Initialize-IntersightVirtualizationHost {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("virtualization.Host")]
        [String]
        ${ClassId} = "virtualization.Host",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("virtualization.Host")]
        [String]
        ${ObjectType} = "virtualization.Host",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        ...
        ${Parent},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("None", "PowerOffStorageController", "PowerOnStorageController")]
        [String]
        ${Action} = "None",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [PSCustomObject]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationHost' | Write-Debug
...
Convert from JSON to VirtualizationHost<PSCustomObject>
...
VirtualizationHost<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationHost {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationHost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationHost
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Action", "HypervisorType", "Identity", "Model", "Name", "Serial", "Vendor", "Inventory", "RegisteredDevice", "WorkflowInfo")
