...
IamPrivilegeSetListAllOf<PSCustomObject>
#>

function Initialize-IntersightIamPrivilegeSetListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamPrivilegeSetListAllOf' | Write-Debug
...
Convert from JSON to IamPrivilegeSetListAllOf<PSCustomObject>
...
IamPrivilegeSetListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamPrivilegeSetListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamPrivilegeSetListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamPrivilegeSetListAllOf
