...
LicenseSmartlicenseToken<PSCustomObject>
#>

function Initialize-IntersightLicenseSmartlicenseToken {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightLicenseSmartlicenseToken' | Write-Debug
...
Convert from JSON to LicenseSmartlicenseToken<PSCustomObject>
...
LicenseSmartlicenseToken<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToLicenseSmartlicenseToken {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightLicenseSmartlicenseToken' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightLicenseSmartlicenseToken
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Token", "AccountLicenseData")
