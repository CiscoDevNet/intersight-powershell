...
BiosPolicyListAllOf<PSCustomObject>
#>

function Initialize-IntersightBiosPolicyListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBiosPolicyListAllOf' | Write-Debug
...
Convert from JSON to BiosPolicyListAllOf<PSCustomObject>
...
BiosPolicyListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBiosPolicyListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBiosPolicyListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBiosPolicyListAllOf
