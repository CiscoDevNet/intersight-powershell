...
TerminalAuditLog<PSCustomObject>
#>

function Initialize-IntersightTerminalAuditLog {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("terminal.AuditLog")]
        [String]
        ${ClassId} = "terminal.AuditLog",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("terminal.AuditLog")]
        [String]
        ${ObjectType} = "terminal.AuditLog",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTerminalAuditLog' | Write-Debug
...
Convert from JSON to TerminalAuditLog<PSCustomObject>
...
TerminalAuditLog<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTerminalAuditLog {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTerminalAuditLog' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTerminalAuditLog
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "EndTime", "StartTime", "DeviceRegistration", "User")
