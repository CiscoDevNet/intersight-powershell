...
EquipmentRackEnclosure<PSCustomObject>
#>

function Initialize-IntersightEquipmentRackEnclosure {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.RackEnclosure")]
        [String]
        ${ClassId} = "equipment.RackEnclosure",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.RackEnclosure")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentRackEnclosure' | Write-Debug
...
Convert from JSON to EquipmentRackEnclosure<PSCustomObject>
...
EquipmentRackEnclosure<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentRackEnclosure {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentRackEnclosure' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentRackEnclosure
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "EnclosureId", "Fanmodules", "InventoryDeviceInfo", "Psus", "RegisteredDevice", "Slots")
