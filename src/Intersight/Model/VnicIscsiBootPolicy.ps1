...
VnicIscsiBootPolicy<PSCustomObject>
#>

function Initialize-IntersightVnicIscsiBootPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVnicIscsiBootPolicy' | Write-Debug
...
Convert from JSON to VnicIscsiBootPolicy<PSCustomObject>
...
VnicIscsiBootPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVnicIscsiBootPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVnicIscsiBootPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVnicIscsiBootPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "AutoTargetvendorName", "Chap", "InitiatorIpSource", "InitiatorStaticIpV4Address", "InitiatorStaticIpV4Config", "MutualChap", "TargetSourceType", "InitiatorIpPool", "IscsiAdapterPolicy", "Organization", "PrimaryTargetPolicy", "SecondaryTargetPolicy")
