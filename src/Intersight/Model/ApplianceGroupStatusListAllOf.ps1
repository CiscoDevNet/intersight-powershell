...
ApplianceGroupStatusListAllOf<PSCustomObject>
#>

function Initialize-IntersightApplianceGroupStatusListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightApplianceGroupStatusListAllOf' | Write-Debug
...
Convert from JSON to ApplianceGroupStatusListAllOf<PSCustomObject>
...
ApplianceGroupStatusListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToApplianceGroupStatusListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightApplianceGroupStatusListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightApplianceGroupStatusListAllOf
