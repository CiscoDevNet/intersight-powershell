...
function ConvertFrom-IntersightJsonToHyperflexCapabilityInfo {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "CapabilityConstraints", "Name", "Value", "AppCatalog")
