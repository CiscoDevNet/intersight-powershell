...
function ConvertFrom-IntersightJsonToHyperflexCapabilityInfo {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "CapabilityConstraints", "Name", "Value", "AppCatalog")
