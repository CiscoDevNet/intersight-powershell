...
SdwanProfile<PSCustomObject>
#>

function Initialize-IntersightSdwanProfile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSdwanProfile' | Write-Debug
...
Convert from JSON to SdwanProfile<PSCustomObject>
...
SdwanProfile<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSdwanProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSdwanProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSdwanProfile
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Type", "SrcTemplate", "Action", "ConfigContext", "Organization", "RouterNodes", "RouterPolicy", "VmanageAccount")
