...
FirmwareDriveDescriptorListAllOf<PSCustomObject>
#>

function Initialize-IntersightFirmwareDriveDescriptorListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareDriveDescriptorListAllOf' | Write-Debug
...
Convert from JSON to FirmwareDriveDescriptorListAllOf<PSCustomObject>
...
FirmwareDriveDescriptorListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareDriveDescriptorListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareDriveDescriptorListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareDriveDescriptorListAllOf
