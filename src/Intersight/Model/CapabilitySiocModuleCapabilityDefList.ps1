...
CapabilitySiocModuleCapabilityDefList<PSCustomObject>
#>

function Initialize-IntersightCapabilitySiocModuleCapabilityDefList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilitySiocModuleCapabilityDefList' | Write-Debug
...
Convert from JSON to CapabilitySiocModuleCapabilityDefList<PSCustomObject>
...
CapabilitySiocModuleCapabilityDefList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilitySiocModuleCapabilityDefList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilitySiocModuleCapabilityDefList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilitySiocModuleCapabilityDefList
