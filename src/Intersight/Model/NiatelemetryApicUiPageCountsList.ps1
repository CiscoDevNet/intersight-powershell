...
NiatelemetryApicUiPageCountsList<PSCustomObject>
#>

function Initialize-IntersightNiatelemetryApicUiPageCountsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiatelemetryApicUiPageCountsList' | Write-Debug
...
Convert from JSON to NiatelemetryApicUiPageCountsList<PSCustomObject>
...
NiatelemetryApicUiPageCountsList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiatelemetryApicUiPageCountsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiatelemetryApicUiPageCountsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiatelemetryApicUiPageCountsList
