...
SdcardOperatingSystem<PSCustomObject>
#>

function Initialize-IntersightSdcardOperatingSystem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSdcardOperatingSystem' | Write-Debug
...
Convert from JSON to SdcardOperatingSystem<PSCustomObject>
...
SdcardOperatingSystem<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSdcardOperatingSystem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSdcardOperatingSystem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSdcardOperatingSystem
