...
PortPhysical<PSCustomObject>
#>

function Initialize-IntersightPortPhysical {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("ether.HostPort", "ether.PhysicalPort", "fc.PhysicalPort")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("ether.HostPort", "ether.PhysicalPort", "fc.PhysicalPort")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPortPhysical' | Write-Debug
...
Convert from JSON to PortPhysical<PSCustomObject>
...
PortPhysical<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPortPhysical {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPortPhysical' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPortPhysical
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "OperState", "OperStateQual", "PortId", "Role", "SlotId", "SwitchId")
