...
function ConvertFrom-IntersightJsonToIaasDeviceStatus {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AccountName", "AccountType", "Category", "ClaimStatus", "ConnectionStatus", "DeviceModel", "DeviceVendor", "DeviceVersion", "IpAddress", "Pod", "PodType", "Guid")
