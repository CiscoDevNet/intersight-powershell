...
function ConvertFrom-IntersightJsonToEquipmentIoCardAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "ConnectionPath", "DcSupported", "Side", "EquipmentChassis", "EquipmentFex", "InventoryDeviceInfo", "PhysicalDeviceRegistration", "RegisteredDevice")
