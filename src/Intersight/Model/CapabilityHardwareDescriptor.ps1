...
CapabilityHardwareDescriptor<PSCustomObject>
#>

function Initialize-IntersightCapabilityHardwareDescriptor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilityHardwareDescriptor' | Write-Debug
...
Convert from JSON to CapabilityHardwareDescriptor<PSCustomObject>
...
CapabilityHardwareDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilityHardwareDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilityHardwareDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilityHardwareDescriptor
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Model", "Vendor", "Version", "Capabilities")
