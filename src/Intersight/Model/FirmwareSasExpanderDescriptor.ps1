...
FirmwareSasExpanderDescriptor<PSCustomObject>
#>

function Initialize-IntersightFirmwareSasExpanderDescriptor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareSasExpanderDescriptor' | Write-Debug
...
Convert from JSON to FirmwareSasExpanderDescriptor<PSCustomObject>
...
FirmwareSasExpanderDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareSasExpanderDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareSasExpanderDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareSasExpanderDescriptor
