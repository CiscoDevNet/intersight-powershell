...
function ConvertFrom-IntersightJsonToWorkflowPendingDynamicWorkflowInfo {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Input", "Name", "PendingServices", "Src", "Status", "WaitOnDuplicate", "WorkflowActionTaskLists", "WorkflowCtx", "WorkflowKey", "WorkflowMeta", "WorkflowInfo")
