...
FirmwarePcieDescriptorList<PSCustomObject>
#>

function Initialize-IntersightFirmwarePcieDescriptorList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwarePcieDescriptorList' | Write-Debug
...
Convert from JSON to FirmwarePcieDescriptorList<PSCustomObject>
...
FirmwarePcieDescriptorList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwarePcieDescriptorList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwarePcieDescriptorList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwarePcieDescriptorList
