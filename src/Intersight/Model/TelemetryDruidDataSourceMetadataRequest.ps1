...
TelemetryDruidDataSourceMetadataRequest<PSCustomObject>
#>

function Initialize-IntersightTelemetryDruidDataSourceMetadataRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTelemetryDruidDataSourceMetadataRequest' | Write-Debug
...
Convert from JSON to TelemetryDruidDataSourceMetadataRequest<PSCustomObject>
...
TelemetryDruidDataSourceMetadataRequest<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTelemetryDruidDataSourceMetadataRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTelemetryDruidDataSourceMetadataRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTelemetryDruidDataSourceMetadataRequest
        $AllProperties = ("queryType", "dataSource", "context")
