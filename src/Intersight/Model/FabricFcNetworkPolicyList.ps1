...
FabricFcNetworkPolicyList<PSCustomObject>
#>

function Initialize-IntersightFabricFcNetworkPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricFcNetworkPolicyList' | Write-Debug
...
Convert from JSON to FabricFcNetworkPolicyList<PSCustomObject>
...
FabricFcNetworkPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricFcNetworkPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricFcNetworkPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricFcNetworkPolicyList
