...
BootPrecisionPolicyListAllOf<PSCustomObject>
#>

function Initialize-IntersightBootPrecisionPolicyListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootPrecisionPolicyListAllOf' | Write-Debug
...
Convert from JSON to BootPrecisionPolicyListAllOf<PSCustomObject>
...
BootPrecisionPolicyListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootPrecisionPolicyListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootPrecisionPolicyListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootPrecisionPolicyListAllOf
