...
function ConvertFrom-IntersightJsonToLicenseLicenseInfo {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ActiveAdmin", "DaysLeft", "EndTime", "EnforceMode", "ErrorDesc", "EvaluationPeriod", "ExtraEvaluation", "LicenseCount", "LicenseState", "LicenseType", "StartTime", "TrialAdmin", "AccountLicenseData")
