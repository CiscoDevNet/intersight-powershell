...
function ConvertFrom-IntersightJsonToLicenseLicenseInfo {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ActiveAdmin", "DaysLeft", "EndTime", "EnforceMode", "ErrorDesc", "EvaluationPeriod", "ExtraEvaluation", "LicenseCount", "LicenseState", "LicenseType", "StartTime", "TrialAdmin", "AccountLicenseData")
