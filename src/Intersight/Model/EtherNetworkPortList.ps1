...
EtherNetworkPortList<PSCustomObject>
#>

function Initialize-IntersightEtherNetworkPortList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEtherNetworkPortList' | Write-Debug
...
Convert from JSON to EtherNetworkPortList<PSCustomObject>
...
EtherNetworkPortList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEtherNetworkPortList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEtherNetworkPortList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEtherNetworkPortList
