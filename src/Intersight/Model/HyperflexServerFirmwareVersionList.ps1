...
HyperflexServerFirmwareVersionList<PSCustomObject>
#>

function Initialize-IntersightHyperflexServerFirmwareVersionList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexServerFirmwareVersionList' | Write-Debug
...
Convert from JSON to HyperflexServerFirmwareVersionList<PSCustomObject>
...
HyperflexServerFirmwareVersionList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexServerFirmwareVersionList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexServerFirmwareVersionList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexServerFirmwareVersionList
