...
Definition of the list of properties defined in 'port.Physical', excluding properties defined in parent classes.
...
PortPhysicalAllOf<PSCustomObject>
#>

function Initialize-IntersightPortPhysicalAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPortPhysicalAllOf' | Write-Debug
...
Convert from JSON to PortPhysicalAllOf<PSCustomObject>
...
PortPhysicalAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPortPhysicalAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPortPhysicalAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPortPhysicalAllOf
        $AllProperties = ("ClassId", "ObjectType", "OperState", "OperStateQual", "PortId", "Role", "SlotId", "SwitchId")
