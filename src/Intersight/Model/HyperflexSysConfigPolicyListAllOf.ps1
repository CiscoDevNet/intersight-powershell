...
HyperflexSysConfigPolicyListAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexSysConfigPolicyListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexSysConfigPolicyListAllOf' | Write-Debug
...
Convert from JSON to HyperflexSysConfigPolicyListAllOf<PSCustomObject>
...
HyperflexSysConfigPolicyListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexSysConfigPolicyListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexSysConfigPolicyListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexSysConfigPolicyListAllOf
