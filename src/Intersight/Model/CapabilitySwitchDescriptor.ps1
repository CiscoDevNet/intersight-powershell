...
.PARAMETER ExpectedMemory
The total expected memory for this hardware.
.PARAMETER Revision
Revision for the fabric interconnect.
.OUTPUTS

CapabilitySwitchDescriptor<PSCustomObject>
#>

function Initialize-IntersightCapabilitySwitchDescriptor {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.SwitchDescriptor")]
        [String]
        ${ClassId} = "capability.SwitchDescriptor",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.SwitchDescriptor")]
        [String]
        ${ObjectType} = "capability.SwitchDescriptor",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilitySwitchDescriptor' | Write-Debug
...
Convert from JSON to CapabilitySwitchDescriptor<PSCustomObject>
...
CapabilitySwitchDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilitySwitchDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilitySwitchDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilitySwitchDescriptor
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Model", "Vendor", "Version", "Capabilities", "ExpectedMemory", "Revision")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ExpectedMemory"))) { #optional property not found
            $ExpectedMemory = $null
        } else {
            $ExpectedMemory = $JsonParameters.PSobject.Properties["ExpectedMemory"].value
        }
