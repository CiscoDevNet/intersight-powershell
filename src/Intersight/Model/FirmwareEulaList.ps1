...
FirmwareEulaList<PSCustomObject>
#>

function Initialize-IntersightFirmwareEulaList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareEulaList' | Write-Debug
...
Convert from JSON to FirmwareEulaList<PSCustomObject>
...
FirmwareEulaList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareEulaList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareEulaList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareEulaList
