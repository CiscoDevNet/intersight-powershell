...
HyperflexLogicalAvailabilityZoneAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexLogicalAvailabilityZoneAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexLogicalAvailabilityZoneAllOf' | Write-Debug
...
Convert from JSON to HyperflexLogicalAvailabilityZoneAllOf<PSCustomObject>
...
HyperflexLogicalAvailabilityZoneAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexLogicalAvailabilityZoneAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexLogicalAvailabilityZoneAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexLogicalAvailabilityZoneAllOf
        $AllProperties = ("AutoConfig")
