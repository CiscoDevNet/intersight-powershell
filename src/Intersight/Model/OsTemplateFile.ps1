...
OsTemplateFile<PSCustomObject>
#>

function Initialize-IntersightOsTemplateFile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightOsTemplateFile' | Write-Debug
...
Convert from JSON to OsTemplateFile<PSCustomObject>
...
OsTemplateFile<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToOsTemplateFile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightOsTemplateFile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightOsTemplateFile
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Placeholders", "TemplateContent")
