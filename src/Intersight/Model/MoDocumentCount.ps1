...
MoDocumentCount<PSCustomObject>
#>

function Initialize-IntersightMoDocumentCount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMoDocumentCount' | Write-Debug
...
Convert from JSON to MoDocumentCount<PSCustomObject>
...
MoDocumentCount<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMoDocumentCount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMoDocumentCount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMoDocumentCount
        $AllProperties = ("ObjectType", "Count")
