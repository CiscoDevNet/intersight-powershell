...
TaskPureScopedInventory<PSCustomObject>
#>

function Initialize-IntersightTaskPureScopedInventory {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("task.PureScopedInventory")]
        [String]
        ${ClassId} = "task.PureScopedInventory",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("task.PureScopedInventory")]
        [String]
        ${ObjectType} = "task.PureScopedInventory",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTaskPureScopedInventory' | Write-Debug
...
Convert from JSON to TaskPureScopedInventory<PSCustomObject>
...
TaskPureScopedInventory<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTaskPureScopedInventory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTaskPureScopedInventory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTaskPureScopedInventory
