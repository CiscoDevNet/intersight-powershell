...
NiaapiDcnmFieldNoticeList<PSCustomObject>
#>

function Initialize-IntersightNiaapiDcnmFieldNoticeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiDcnmFieldNoticeList' | Write-Debug
...
Convert from JSON to NiaapiDcnmFieldNoticeList<PSCustomObject>
...
NiaapiDcnmFieldNoticeList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiDcnmFieldNoticeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiDcnmFieldNoticeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiDcnmFieldNoticeList
