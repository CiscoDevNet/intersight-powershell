...
CapabilityEquipmentPhysicalDefListAllOf<PSCustomObject>
#>

function Initialize-IntersightCapabilityEquipmentPhysicalDefListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilityEquipmentPhysicalDefListAllOf' | Write-Debug
...
Convert from JSON to CapabilityEquipmentPhysicalDefListAllOf<PSCustomObject>
...
CapabilityEquipmentPhysicalDefListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilityEquipmentPhysicalDefListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilityEquipmentPhysicalDefListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilityEquipmentPhysicalDefListAllOf
