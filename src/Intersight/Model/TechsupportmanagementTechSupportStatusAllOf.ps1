...
function ConvertFrom-IntersightJsonToTechsupportmanagementTechSupportStatusAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "FileName", "Reason", "RelayReason", "RelayStatus", "RequestTs", "Status", "TechsupportDownloadUrl", "ClusterMember", "DeviceRegistration", "OriginResource", "TechSupportRequest")
