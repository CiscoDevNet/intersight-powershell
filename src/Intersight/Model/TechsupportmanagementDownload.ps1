...
TechsupportmanagementDownload<PSCustomObject>
#>

function Initialize-IntersightTechsupportmanagementDownload {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("techsupportmanagement.Download")]
        [String]
        ${ClassId} = "techsupportmanagement.Download",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("techsupportmanagement.Download")]
        [String]
        ${ObjectType} = "techsupportmanagement.Download",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTechsupportmanagementDownload' | Write-Debug
...
Convert from JSON to TechsupportmanagementDownload<PSCustomObject>
...
TechsupportmanagementDownload<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTechsupportmanagementDownload {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTechsupportmanagementDownload' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTechsupportmanagementDownload
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "TechSupportStatus")
