...
Definition of the list of properties defined in 'niatelemetry.Fault', excluding properties defined in parent classes.
...
NiatelemetryFaultAllOf<PSCustomObject>
#>

function Initialize-IntersightNiatelemetryFaultAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiatelemetryFaultAllOf' | Write-Debug
...
Convert from JSON to NiatelemetryFaultAllOf<PSCustomObject>
...
NiatelemetryFaultAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiatelemetryFaultAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiatelemetryFaultAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiatelemetryFaultAllOf
        $AllProperties = ("ClassId", "ObjectType", "Code", "Description", "Dn", "RecordType", "RecordVersion", "Severity", "SiteName", "Type", "RegisteredDevice")
