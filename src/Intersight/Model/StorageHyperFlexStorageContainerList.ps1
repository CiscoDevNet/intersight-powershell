...
StorageHyperFlexStorageContainerList<PSCustomObject>
#>

function Initialize-IntersightStorageHyperFlexStorageContainerList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageHyperFlexStorageContainerList' | Write-Debug
...
Convert from JSON to StorageHyperFlexStorageContainerList<PSCustomObject>
...
StorageHyperFlexStorageContainerList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageHyperFlexStorageContainerList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageHyperFlexStorageContainerList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageHyperFlexStorageContainerList
