...
function Initialize-IntersightIamIdpReference {
    ...
    Param (
        ...
        [ValidateSet("iam.IdpReference")]
        [String]
        ${ClassId} = "iam.IdpReference",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iam.IdpReference")]
        [String]
...
function ConvertFrom-IntersightJsonToIamIdpReference {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DomainName", "IdpEntityId", "MultiFactorAuthentication", "Name", "Account", "Idp", "UserPreferences", "Usergroups", "Users")
