...
function ConvertFrom-IntersightJsonToIamIdpReference {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DomainName", "IdpEntityId", "MultiFactorAuthentication", "Name", "Account", "Idp", "UserPreferences", "Usergroups", "Users")
