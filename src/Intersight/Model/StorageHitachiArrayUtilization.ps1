...
Storage space consumption of Hitachi Virtual Storage.
...
StorageHitachiArrayUtilization<PSCustomObject>
#>

function Initialize-IntersightStorageHitachiArrayUtilization {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageHitachiArrayUtilization' | Write-Debug
...
Convert from JSON to StorageHitachiArrayUtilization<PSCustomObject>
...
StorageHitachiArrayUtilization<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageHitachiArrayUtilization {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageHitachiArrayUtilization' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageHitachiArrayUtilization
        $AllProperties = ("ClassId", "ObjectType", "Available", "CapacityUtilization", "Free", "Total", "Used", "DataReduction", "Provisioned")
