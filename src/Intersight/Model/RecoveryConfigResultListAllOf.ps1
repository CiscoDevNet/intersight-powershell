...
RecoveryConfigResultListAllOf<PSCustomObject>
#>

function Initialize-IntersightRecoveryConfigResultListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightRecoveryConfigResultListAllOf' | Write-Debug
...
Convert from JSON to RecoveryConfigResultListAllOf<PSCustomObject>
...
RecoveryConfigResultListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToRecoveryConfigResultListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightRecoveryConfigResultListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightRecoveryConfigResultListAllOf
