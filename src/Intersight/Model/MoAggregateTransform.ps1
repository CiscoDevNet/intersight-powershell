...
MoAggregateTransform<PSCustomObject>
#>

function Initialize-IntersightMoAggregateTransform {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMoAggregateTransform' | Write-Debug
...
Convert from JSON to MoAggregateTransform<PSCustomObject>
...
MoAggregateTransform<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMoAggregateTransform {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMoAggregateTransform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMoAggregateTransform
        $AllProperties = ("ObjectType", "Results")
