...
SmtpPolicy<PSCustomObject>
#>

function Initialize-IntersightSmtpPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSmtpPolicy' | Write-Debug
...
Convert from JSON to SmtpPolicy<PSCustomObject>
...
SmtpPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSmtpPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSmtpPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSmtpPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Enabled", "MinSeverity", "SenderEmail", "SmtpPort", "SmtpRecipients", "SmtpServer", "Organization", "Profiles")
