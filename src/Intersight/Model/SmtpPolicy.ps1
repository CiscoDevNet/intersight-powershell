...
function ConvertFrom-IntersightJsonToSmtpPolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Enabled", "MinSeverity", "SenderEmail", "SmtpPort", "SmtpRecipients", "SmtpServer", "Organization", "Profiles")
