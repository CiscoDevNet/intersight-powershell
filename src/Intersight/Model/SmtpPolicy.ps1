...
function ConvertFrom-IntersightJsonToSmtpPolicy {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Enabled", "MinSeverity", "SenderEmail", "SmtpPort", "SmtpRecipients", "SmtpServer", "Organization", "Profiles")
