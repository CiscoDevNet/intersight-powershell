...
function ConvertFrom-IntersightJsonToStorageSasExpanderAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ExpanderId", "Name", "OperState", "Operability", "Presence", "SasAddress", "ComputeRackUnit", "Controller", "EquipmentChassis", "InventoryDeviceInfo", "RegisteredDevice")
