...
KubernetesVersionPolicy<PSCustomObject>
#>

function Initialize-IntersightKubernetesVersionPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesVersionPolicy' | Write-Debug
...
Convert from JSON to KubernetesVersionPolicy<PSCustomObject>
...
KubernetesVersionPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesVersionPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesVersionPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesVersionPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Organization", "Profiles", "Version")
