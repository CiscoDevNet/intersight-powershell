...
VirtualizationCpuInfo<PSCustomObject>
#>

function Initialize-IntersightVirtualizationCpuInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationCpuInfo' | Write-Debug
...
Convert from JSON to VirtualizationCpuInfo<PSCustomObject>
...
VirtualizationCpuInfo<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationCpuInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationCpuInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationCpuInfo
