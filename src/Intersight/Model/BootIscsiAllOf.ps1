...
BootIscsiAllOf<PSCustomObject>
#>

function Initialize-IntersightBootIscsiAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootIscsiAllOf' | Write-Debug
...
Convert from JSON to BootIscsiAllOf<PSCustomObject>
...
BootIscsiAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootIscsiAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootIscsiAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootIscsiAllOf
        $AllProperties = ("ClassId", "ObjectType", "Bootloader", "InterfaceName", "Port", "Slot")
