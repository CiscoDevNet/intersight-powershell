...
StorageBaseArrayDisk<PSCustomObject>
#>

function Initialize-IntersightStorageBaseArrayDisk {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiDisk", "storage.NetAppBaseDisk", "storage.PureDisk")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiDisk", "storage.NetAppBaseDisk", "storage.PureDisk")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageBaseArrayDisk' | Write-Debug
...
Convert from JSON to StorageBaseArrayDisk<PSCustomObject>
...
StorageBaseArrayDisk<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageBaseArrayDisk {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageBaseArrayDisk' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageBaseArrayDisk
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Name", "PartNumber", "Protocol", "Speed", "Status", "StorageUtilization", "Type", "Version")
