...
function Initialize-IntersightStorageBaseArrayDisk {
    ...
    Param (
        ...
        [ValidateSet("storage.HitachiDisk", "storage.PureDisk")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiDisk", "storage.PureDisk")]
...
function ConvertFrom-IntersightJsonToStorageBaseArrayDisk {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Name", "PartNumber", "Protocol", "Speed", "Status", "StorageUtilization", "Type", "Version")
