...
MemoryArrayList<PSCustomObject>
#>

function Initialize-IntersightMemoryArrayList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMemoryArrayList' | Write-Debug
...
Convert from JSON to MemoryArrayList<PSCustomObject>
...
MemoryArrayList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMemoryArrayList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMemoryArrayList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMemoryArrayList
