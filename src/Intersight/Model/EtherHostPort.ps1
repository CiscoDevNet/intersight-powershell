...
EtherHostPort<PSCustomObject>
#>

function Initialize-IntersightEtherHostPort {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("ether.HostPort")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEtherHostPort' | Write-Debug
...
Convert from JSON to EtherHostPort<PSCustomObject>
...
EtherHostPort<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEtherHostPort {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
