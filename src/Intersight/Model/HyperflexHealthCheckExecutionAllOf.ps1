...
Definition of the list of properties defined in 'hyperflex.HealthCheckExecution', excluding properties defined in parent classes.
...
HyperflexHealthCheckExecutionAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexHealthCheckExecutionAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexHealthCheckExecutionAllOf' | Write-Debug
...
Convert from JSON to HyperflexHealthCheckExecutionAllOf<PSCustomObject>
...
HyperflexHealthCheckExecutionAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexHealthCheckExecutionAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexHealthCheckExecutionAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexHealthCheckExecutionAllOf
        $AllProperties = ("ClassId", "ObjectType", "Category", "Cause", "CompletionTime", "HealthCheckDetails", "HealthCheckExecutionErrorDetails", "HealthCheckExecutionErrorSummary", "HealthCheckExecutionStatus", "HealthCheckResult", "HealthCheckSummary", "HxDeviceName", "Uuid", "HealthCheckDefinition", "HxCluster", "RegisteredDevice")
