...
ChassisIomProfileList<PSCustomObject>
#>

function Initialize-IntersightChassisIomProfileList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightChassisIomProfileList' | Write-Debug
...
Convert from JSON to ChassisIomProfileList<PSCustomObject>
...
ChassisIomProfileList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToChassisIomProfileList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightChassisIomProfileList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightChassisIomProfileList
