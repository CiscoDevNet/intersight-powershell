...
BootSdDevice<PSCustomObject>
#>

function Initialize-IntersightBootSdDevice {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.SdDevice")]
        [String]
        ${ClassId} = "boot.SdDevice",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.SdDevice")]
        [String]
        ${ObjectType} = "boot.SdDevice",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootSdDevice' | Write-Debug
...
Convert from JSON to BootSdDevice<PSCustomObject>
...
BootSdDevice<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootSdDevice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootSdDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootSdDevice
