...
BootUsb<PSCustomObject>
#>

function Initialize-IntersightBootUsb {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootUsb' | Write-Debug
...
Convert from JSON to BootUsb<PSCustomObject>
...
BootUsb<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootUsb {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootUsb' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootUsb
