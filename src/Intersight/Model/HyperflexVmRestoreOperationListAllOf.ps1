...
HyperflexVmRestoreOperationListAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexVmRestoreOperationListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexVmRestoreOperationListAllOf' | Write-Debug
...
Convert from JSON to HyperflexVmRestoreOperationListAllOf<PSCustomObject>
...
HyperflexVmRestoreOperationListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexVmRestoreOperationListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexVmRestoreOperationListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexVmRestoreOperationListAllOf
