...
WorkflowPrimitiveDataType<PSCustomObject>
#>

function Initialize-IntersightWorkflowPrimitiveDataType {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.PrimitiveDataType")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowPrimitiveDataType' | Write-Debug
...
Convert from JSON to WorkflowPrimitiveDataType<PSCustomObject>
...
WorkflowPrimitiveDataType<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowPrimitiveDataType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowPrimitiveDataType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowPrimitiveDataType
