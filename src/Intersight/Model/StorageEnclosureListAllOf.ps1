...
StorageEnclosureListAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageEnclosureListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageEnclosureListAllOf' | Write-Debug
...
Convert from JSON to StorageEnclosureListAllOf<PSCustomObject>
...
StorageEnclosureListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageEnclosureListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageEnclosureListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageEnclosureListAllOf
