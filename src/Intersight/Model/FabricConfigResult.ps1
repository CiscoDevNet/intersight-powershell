...
FabricConfigResult<PSCustomObject>
#>

function Initialize-IntersightFabricConfigResult {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.ConfigResult")]
        [String]
        ${ClassId} = "fabric.ConfigResult",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.ConfigResult")]
        [String]
        ${ObjectType} = "fabric.ConfigResult",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricConfigResult' | Write-Debug
...
Convert from JSON to FabricConfigResult<PSCustomObject>
...
FabricConfigResult<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricConfigResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricConfigResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricConfigResult
