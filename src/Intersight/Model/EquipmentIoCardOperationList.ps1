...
EquipmentIoCardOperationList<PSCustomObject>
#>

function Initialize-IntersightEquipmentIoCardOperationList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentIoCardOperationList' | Write-Debug
...
Convert from JSON to EquipmentIoCardOperationList<PSCustomObject>
...
EquipmentIoCardOperationList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentIoCardOperationList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentIoCardOperationList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentIoCardOperationList
