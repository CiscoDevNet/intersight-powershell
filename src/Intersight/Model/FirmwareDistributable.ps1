...
FirmwareDistributable<PSCustomObject>
#>

function Initialize-IntersightFirmwareDistributable {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("firmware.Distributable")]
        [String]
        ${ClassId} = "firmware.Distributable",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("firmware.Distributable")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareDistributable' | Write-Debug
...
Convert from JSON to FirmwareDistributable<PSCustomObject>
...
FirmwareDistributable<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareDistributable {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
