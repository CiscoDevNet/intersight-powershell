...
RecommendationPhysicalItemList<PSCustomObject>
#>

function Initialize-IntersightRecommendationPhysicalItemList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightRecommendationPhysicalItemList' | Write-Debug
...
Convert from JSON to RecommendationPhysicalItemList<PSCustomObject>
...
RecommendationPhysicalItemList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToRecommendationPhysicalItemList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightRecommendationPhysicalItemList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightRecommendationPhysicalItemList
