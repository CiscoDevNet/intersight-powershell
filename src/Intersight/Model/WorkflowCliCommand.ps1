...
function ConvertFrom-IntersightJsonToWorkflowCliCommand {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Body", "ContentType", "Name", "Outcomes", "ResponseSpec", "SkipOnCondition", "StartDelay", "Timeout", "Command", "EndPrompt", "ExpectPrompts", "SkipStatusCheck", "TerminalEnd", "TerminalStart", "Type")
