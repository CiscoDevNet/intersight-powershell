...
function ConvertFrom-IntersightJsonToManagementInterface {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Gateway", "HostName", "IpAddress", "Ipv4Address", "Ipv4Gateway", "Ipv4Mask", "Ipv6Address", "Ipv6Gateway", "Ipv6Prefix", "MacAddress", "Mask", "SwitchId", "UemConnStatus", "VirtualHostName", "InventoryDeviceInfo", "ManagementController", "RegisteredDevice")
