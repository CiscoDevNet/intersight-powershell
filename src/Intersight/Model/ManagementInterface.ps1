...
ManagementInterface<PSCustomObject>
#>

function Initialize-IntersightManagementInterface {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightManagementInterface' | Write-Debug
...
Convert from JSON to ManagementInterface<PSCustomObject>
...
ManagementInterface<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToManagementInterface {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightManagementInterface' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightManagementInterface
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Gateway", "HostName", "IpAddress", "Ipv4Address", "Ipv4Gateway", "Ipv4Mask", "Ipv6Address", "Ipv6Gateway", "Ipv6Prefix", "MacAddress", "Mask", "SwitchId", "UemConnStatus", "VirtualHostName", "VlanId", "InventoryDeviceInfo", "ManagementController", "RegisteredDevice")
