...
function ConvertFrom-IntersightJsonToEtherPortChannel {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "AccessVlan", "AdminState", "AllowedVlans", "Mode", "NativeVlan", "OperSpeed", "OperState", "OperStateQual", "PortChannelId", "Role", "SwitchId", "EquipmentSwitchCard", "RegisteredDevice")
