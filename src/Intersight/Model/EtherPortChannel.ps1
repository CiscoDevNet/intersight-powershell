...
function ConvertFrom-IntersightJsonToEtherPortChannel {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "AccessVlan", "AdminState", "AllowedVlans", "Mode", "NativeVlan", "OperSpeed", "OperState", "OperStateQual", "PortChannelId", "Role", "SwitchId", "EquipmentSwitchCard", "RegisteredDevice")
