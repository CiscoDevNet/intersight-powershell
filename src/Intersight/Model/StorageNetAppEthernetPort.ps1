...
StorageNetAppEthernetPort<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppEthernetPort {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.NetAppEthernetPort")]
        [String]
        ${ClassId} = "storage.NetAppEthernetPort",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.NetAppEthernetPort")]
        [String]
        ${ObjectType} = "storage.NetAppEthernetPort",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppEthernetPort' | Write-Debug
...
Convert from JSON to StorageNetAppEthernetPort<PSCustomObject>
...
StorageNetAppEthernetPort<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppEthernetPort {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppEthernetPort' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppEthernetPort
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Enabled", "MacAddress", "Mtu", "Name", "Speed", "State", "Type", "Uuid", "ArrayController")
