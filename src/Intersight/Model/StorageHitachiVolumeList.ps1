...
StorageHitachiVolumeList<PSCustomObject>
#>

function Initialize-IntersightStorageHitachiVolumeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageHitachiVolumeList' | Write-Debug
...
Convert from JSON to StorageHitachiVolumeList<PSCustomObject>
...
StorageHitachiVolumeList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageHitachiVolumeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageHitachiVolumeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageHitachiVolumeList
