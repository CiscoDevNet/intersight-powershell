...
HyperflexHealthCheckExecutionSnapshot<PSCustomObject>
#>

function Initialize-IntersightHyperflexHealthCheckExecutionSnapshot {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexHealthCheckExecutionSnapshot' | Write-Debug
...
Convert from JSON to HyperflexHealthCheckExecutionSnapshot<PSCustomObject>
...
HyperflexHealthCheckExecutionSnapshot<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexHealthCheckExecutionSnapshot {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexHealthCheckExecutionSnapshot' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexHealthCheckExecutionSnapshot
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Category", "Cause", "CompletionTime", "HealthCheckDetails", "HealthCheckExecutionErrorDetails", "HealthCheckExecutionErrorSummary", "HealthCheckExecutionStatus", "HealthCheckResult", "HealthCheckSummary", "HxDeviceName", "HealthCheckDefinition", "HxCluster", "RegisteredDevice", "Workflow")
