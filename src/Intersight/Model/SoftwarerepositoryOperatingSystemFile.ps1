...
SoftwarerepositoryOperatingSystemFile<PSCustomObject>
#>

function Initialize-IntersightSoftwarerepositoryOperatingSystemFile {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("softwarerepository.OperatingSystemFile")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwarerepositoryOperatingSystemFile' | Write-Debug
...
Convert from JSON to SoftwarerepositoryOperatingSystemFile<PSCustomObject>
...
SoftwarerepositoryOperatingSystemFile<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwarerepositoryOperatingSystemFile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
