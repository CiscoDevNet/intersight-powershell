...
HyperflexVmRestoreOperationList<PSCustomObject>
#>

function Initialize-IntersightHyperflexVmRestoreOperationList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexVmRestoreOperationList' | Write-Debug
...
Convert from JSON to HyperflexVmRestoreOperationList<PSCustomObject>
...
HyperflexVmRestoreOperationList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexVmRestoreOperationList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexVmRestoreOperationList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexVmRestoreOperationList
