...
function ConvertFrom-IntersightJsonToFabricConfigResultEntry {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "CompletedTime", "Context", "Message", "OwnerId", "State", "Type", "ConfigResult")
