...
FabricConfigResultEntry<PSCustomObject>
#>

function Initialize-IntersightFabricConfigResultEntry {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.ConfigResultEntry")]
        [String]
        ${ClassId} = "fabric.ConfigResultEntry",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.ConfigResultEntry")]
        [String]
        ${ObjectType} = "fabric.ConfigResultEntry",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricConfigResultEntry' | Write-Debug
...
Convert from JSON to FabricConfigResultEntry<PSCustomObject>
...
FabricConfigResultEntry<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricConfigResultEntry {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricConfigResultEntry' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricConfigResultEntry
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "CompletedTime", "Context", "Message", "OwnerId", "State", "Type", "ConfigResult")
