...
function ConvertFrom-IntersightJsonToPolicyAbstractConfigResultEntry {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "CompletedTime", "Context", "Message", "OwnerId", "State", "Type")
