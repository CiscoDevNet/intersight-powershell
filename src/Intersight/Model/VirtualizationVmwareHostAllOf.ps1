...
function ConvertFrom-IntersightJsonToVirtualizationVmwareHostAllOf {
    ...
    Process {
        ...
        $AllProperties = ("BootTime", "ConnectionState", "HwPowerState", "NetworkAdapterCount", "ResourceConsumed", "StorageAdapterCount", "VcenterHostId", "Cluster", "Datacenter", "Datastores")
