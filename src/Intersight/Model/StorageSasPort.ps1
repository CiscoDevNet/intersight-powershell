...
function ConvertFrom-IntersightJsonToStorageSasPort {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Address", "DiskId", "EndPointId", "LinkDescription", "LinkSpeed", "InventoryDeviceInfo", "RegisteredDevice", "StoragePhysicalDisk")
