...
PolicyAbstractProfile<PSCustomObject>
#>

function Initialize-IntersightPolicyAbstractProfile {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("chassis.IomProfile", "chassis.Profile", "fabric.SwitchClusterProfile", "fabric.SwitchProfile", "hyperflex.ClusterProfile", "hyperflex.NodeProfile", "kubernetes.AciCniProfile", "kubernetes.ClusterProfile", "kubernetes.NodeGroupProfile", "kubernetes.VirtualMachineNodeProfile", "recovery.BackupProfile", "sdwan.Profile", "server.Profile")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("chassis.IomProfile", "chassis.Profile", "fabric.SwitchClusterProfile", "fabric.SwitchProfile", "hyperflex.ClusterProfile", "hyperflex.NodeProfile", "kubernetes.AciCniProfile", "kubernetes.ClusterProfile", "kubernetes.NodeGroupProfile", "kubernetes.VirtualMachineNodeProfile", "recovery.BackupProfile", "sdwan.Profile", "server.Profile")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPolicyAbstractProfile' | Write-Debug
...
Convert from JSON to PolicyAbstractProfile<PSCustomObject>
...
PolicyAbstractProfile<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPolicyAbstractProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPolicyAbstractProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPolicyAbstractProfile
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Type", "SrcTemplate")
