...
PortGroup<PSCustomObject>
#>

function Initialize-IntersightPortGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPortGroup' | Write-Debug
...
Convert from JSON to PortGroup<PSCustomObject>
...
PortGroup<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPortGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPortGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPortGroup
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Transport", "EquipmentSharedIoModule", "EquipmentSwitchCard", "EthernetPorts", "FcPorts", "InventoryDeviceInfo", "RegisteredDevice", "SubGroups")
