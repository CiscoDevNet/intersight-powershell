...
WorkflowWorkflowProperties<PSCustomObject>
#>

function Initialize-IntersightWorkflowWorkflowProperties {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowWorkflowProperties' | Write-Debug
...
Convert from JSON to WorkflowWorkflowProperties<PSCustomObject>
...
WorkflowWorkflowProperties<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowWorkflowProperties {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowWorkflowProperties' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowWorkflowProperties
