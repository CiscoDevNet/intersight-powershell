...
function ConvertFrom-IntersightJsonToCapabilityIoCardDescriptor {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Model", "Vendor", "Version", "Capabilities", "Section", "NumHifPorts", "Revision")
