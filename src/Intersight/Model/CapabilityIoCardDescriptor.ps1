...
CapabilityIoCardDescriptor<PSCustomObject>
#>

function Initialize-IntersightCapabilityIoCardDescriptor {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.IoCardDescriptor")]
        [String]
        ${ClassId} = "capability.IoCardDescriptor",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.IoCardDescriptor")]
        [String]
        ${ObjectType} = "capability.IoCardDescriptor",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        ...
        ${Revision},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("inline", "cross-connected")]
        [String]
        ${UifConnectivity} = "inline"
    )

    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilityIoCardDescriptor' | Write-Debug
        ...
        $PSO = [PSCustomObject]@{
            ...
            "NumHifPorts" = ${NumHifPorts}
            "Revision" = ${Revision}
            "UifConnectivity" = ${UifConnectivity}
        }
...
Convert from JSON to CapabilityIoCardDescriptor<PSCustomObject>
...
CapabilityIoCardDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilityIoCardDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilityIoCardDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilityIoCardDescriptor
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Model", "Vendor", "Version", "Capabilities", "NumHifPorts", "Revision", "UifConnectivity")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "NumHifPorts"))) { #optional property not found
            $NumHifPorts = $null
        } else {
            $NumHifPorts = $JsonParameters.PSobject.Properties["NumHifPorts"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "UifConnectivity"))) { #optional property not found
            $UifConnectivity = $null
        } else {
            $UifConnectivity = $JsonParameters.PSobject.Properties["UifConnectivity"].value
        }
