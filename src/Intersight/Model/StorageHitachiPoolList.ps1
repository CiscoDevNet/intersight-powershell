...
StorageHitachiPoolList<PSCustomObject>
#>

function Initialize-IntersightStorageHitachiPoolList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageHitachiPoolList' | Write-Debug
...
Convert from JSON to StorageHitachiPoolList<PSCustomObject>
...
StorageHitachiPoolList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageHitachiPoolList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageHitachiPoolList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageHitachiPoolList
