...
IamClientMetaAllOf<PSCustomObject>
#>

function Initialize-IntersightIamClientMetaAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamClientMetaAllOf' | Write-Debug
...
Convert from JSON to IamClientMetaAllOf<PSCustomObject>
...
IamClientMetaAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamClientMetaAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamClientMetaAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamClientMetaAllOf
