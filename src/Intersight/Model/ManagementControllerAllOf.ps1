...
function ConvertFrom-IntersightJsonToManagementControllerAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Model", "AdapterUnit", "ComputeBlade", "ComputeRackUnit", "EquipmentIoCardBase", "EquipmentSharedIoModule", "EquipmentSystemIoController", "InventoryDeviceInfo", "ManagementInterfaces", "NetworkElement", "RegisteredDevice", "RunningFirmware", "StorageSasExpander", "TopSystem")
