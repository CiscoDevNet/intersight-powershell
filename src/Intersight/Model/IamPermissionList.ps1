...
IamPermissionList<PSCustomObject>
#>

function Initialize-IntersightIamPermissionList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamPermissionList' | Write-Debug
...
Convert from JSON to IamPermissionList<PSCustomObject>
...
IamPermissionList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamPermissionList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamPermissionList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamPermissionList
