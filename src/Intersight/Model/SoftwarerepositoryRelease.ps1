...
function ConvertFrom-IntersightJsonToSoftwarerepositoryRelease {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ReleaseDate", "ReleaseNotesUrl", "SupportedModels", "Type", "Version", "Catalog")
