...
function ConvertFrom-IntersightJsonToSoftwarerepositoryRelease {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ReleaseDate", "ReleaseNotesUrl", "SupportedModels", "Type", "Version", "Catalog")
