...
FirmwareEulaListAllOf<PSCustomObject>
#>

function Initialize-IntersightFirmwareEulaListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareEulaListAllOf' | Write-Debug
...
Convert from JSON to FirmwareEulaListAllOf<PSCustomObject>
...
FirmwareEulaListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareEulaListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareEulaListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareEulaListAllOf
