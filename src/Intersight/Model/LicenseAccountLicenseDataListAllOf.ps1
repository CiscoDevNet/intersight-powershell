...
LicenseAccountLicenseDataListAllOf<PSCustomObject>
#>

function Initialize-IntersightLicenseAccountLicenseDataListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightLicenseAccountLicenseDataListAllOf' | Write-Debug
...
Convert from JSON to LicenseAccountLicenseDataListAllOf<PSCustomObject>
...
LicenseAccountLicenseDataListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToLicenseAccountLicenseDataListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightLicenseAccountLicenseDataListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightLicenseAccountLicenseDataListAllOf
