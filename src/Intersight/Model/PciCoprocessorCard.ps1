...
PciCoprocessorCard<PSCustomObject>
#>

function Initialize-IntersightPciCoprocessorCard {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("pci.CoprocessorCard")]
        [String]
        ${ClassId} = "pci.CoprocessorCard",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("pci.CoprocessorCard")]
        [String]
        ${ObjectType} = "pci.CoprocessorCard",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPciCoprocessorCard' | Write-Debug
...
Convert from JSON to PciCoprocessorCard<PSCustomObject>
...
PciCoprocessorCard<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPciCoprocessorCard {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPciCoprocessorCard' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPciCoprocessorCard
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "CardId", "PciSlot", "ComputeBoard", "InventoryDeviceInfo", "RegisteredDevice")
