...
function ConvertFrom-IntersightJsonToIamIdp {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DomainName", "IdpEntityId", "Metadata", "Name", "Type", "Account", "LdapPolicy", "System", "UserPreferences", "Usergroups", "Users")
