...
HyperflexClusterStoragePolicyListAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexClusterStoragePolicyListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexClusterStoragePolicyListAllOf' | Write-Debug
...
Convert from JSON to HyperflexClusterStoragePolicyListAllOf<PSCustomObject>
...
HyperflexClusterStoragePolicyListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexClusterStoragePolicyListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexClusterStoragePolicyListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexClusterStoragePolicyListAllOf
