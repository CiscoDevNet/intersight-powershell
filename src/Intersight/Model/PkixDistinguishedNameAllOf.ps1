...
PkixDistinguishedNameAllOf<PSCustomObject>
#>

function Initialize-IntersightPkixDistinguishedNameAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("pkix.DistinguishedName")]
        [String]
        ${ClassId} = "pkix.DistinguishedName",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("pkix.DistinguishedName")]
        [String]
        ${ObjectType} = "pkix.DistinguishedName",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String[]]
        ${Country},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPkixDistinguishedNameAllOf' | Write-Debug
...
Convert from JSON to PkixDistinguishedNameAllOf<PSCustomObject>
...
PkixDistinguishedNameAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPkixDistinguishedNameAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPkixDistinguishedNameAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPkixDistinguishedNameAllOf
        $AllProperties = ("ClassId", "ObjectType", "CommonName", "Country", "Locality", "Organization", "OrganizationalUnit", "State")
