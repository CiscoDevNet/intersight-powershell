...
InventoryGenericInventoryHolderAllOf<PSCustomObject>
#>

function Initialize-IntersightInventoryGenericInventoryHolderAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightInventoryGenericInventoryHolderAllOf' | Write-Debug
...
Convert from JSON to InventoryGenericInventoryHolderAllOf<PSCustomObject>
...
InventoryGenericInventoryHolderAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToInventoryGenericInventoryHolderAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightInventoryGenericInventoryHolderAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightInventoryGenericInventoryHolderAllOf
        $AllProperties = ("ClassId", "ObjectType", "Endpoint", "ComputeBlade", "ComputeRackUnit", "GenericInventory", "InventoryDeviceInfo", "RegisteredDevice")
