...
ContentParameter<PSCustomObject>
#>

function Initialize-IntersightContentParameter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightContentParameter' | Write-Debug
...
Convert from JSON to ContentParameter<PSCustomObject>
...
ContentParameter<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToContentParameter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightContentParameter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightContentParameter
