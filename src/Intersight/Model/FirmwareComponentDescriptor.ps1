...
FirmwareComponentDescriptor<PSCustomObject>
#>

function Initialize-IntersightFirmwareComponentDescriptor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareComponentDescriptor' | Write-Debug
...
Convert from JSON to FirmwareComponentDescriptor<PSCustomObject>
...
FirmwareComponentDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareComponentDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareComponentDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareComponentDescriptor
