...
function ConvertFrom-IntersightJsonToHyperflexClusterStoragePolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "DiskPartitionCleanup", "LogicalAvalabilityZoneConfig", "VdiOptimization", "ClusterProfiles", "Organization")
