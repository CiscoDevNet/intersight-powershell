...
function ConvertFrom-IntersightJsonToHyperflexClusterStoragePolicy {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "DiskPartitionCleanup", "LogicalAvalabilityZoneConfig", "VdiOptimization", "ClusterProfiles", "Organization")
