...
IaasConnectorPackListAllOf<PSCustomObject>
#>

function Initialize-IntersightIaasConnectorPackListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIaasConnectorPackListAllOf' | Write-Debug
...
Convert from JSON to IaasConnectorPackListAllOf<PSCustomObject>
...
IaasConnectorPackListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIaasConnectorPackListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIaasConnectorPackListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIaasConnectorPackListAllOf
