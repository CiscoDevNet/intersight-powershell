...
function ConvertFrom-IntersightJsonToApplianceDeviceClaim {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceId", "Hostname", "IsPasswordSet", "IsRenew", "Message", "Password", "PlatformType", "RequestId", "SecurityToken", "Status", "Username", "Account")
