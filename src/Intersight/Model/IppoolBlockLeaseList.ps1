...
IppoolBlockLeaseList<PSCustomObject>
#>

function Initialize-IntersightIppoolBlockLeaseList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIppoolBlockLeaseList' | Write-Debug
...
Convert from JSON to IppoolBlockLeaseList<PSCustomObject>
...
IppoolBlockLeaseList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIppoolBlockLeaseList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIppoolBlockLeaseList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIppoolBlockLeaseList
