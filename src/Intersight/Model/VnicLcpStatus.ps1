...
VnicLcpStatus<PSCustomObject>
#>

function Initialize-IntersightVnicLcpStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVnicLcpStatus' | Write-Debug
...
Convert from JSON to VnicLcpStatus<PSCustomObject>
...
VnicLcpStatus<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVnicLcpStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVnicLcpStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVnicLcpStatus
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Reason", "Status", "VnicInfo", "Profile")
