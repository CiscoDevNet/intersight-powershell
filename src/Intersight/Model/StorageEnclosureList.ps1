...
StorageEnclosureList<PSCustomObject>
#>

function Initialize-IntersightStorageEnclosureList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageEnclosureList' | Write-Debug
...
Convert from JSON to StorageEnclosureList<PSCustomObject>
...
StorageEnclosureList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageEnclosureList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageEnclosureList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageEnclosureList
