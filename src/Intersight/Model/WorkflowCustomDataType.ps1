...
WorkflowCustomDataType<PSCustomObject>
#>

function Initialize-IntersightWorkflowCustomDataType {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.CustomDataType")]
        [String]
        ${ClassId} = "workflow.CustomDataType",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.CustomDataType")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowCustomDataType' | Write-Debug
...
Convert from JSON to WorkflowCustomDataType<PSCustomObject>
...
WorkflowCustomDataType<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowCustomDataType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowCustomDataType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowCustomDataType
