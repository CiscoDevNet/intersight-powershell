...
function ConvertFrom-IntersightJsonToForecastDefinition {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AlertThresholdInPercentage", "DataSource", "MetricName", "MinNumOfDaysOfData", "NumOfDaysOfHistoricalData", "PlatformType", "Catalog")
