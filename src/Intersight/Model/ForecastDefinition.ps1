...
ForecastDefinition<PSCustomObject>
#>

function Initialize-IntersightForecastDefinition {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("forecast.Definition")]
        [String]
        ${ClassId} = "forecast.Definition",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("forecast.Definition")]
        [String]
        ${ObjectType} = "forecast.Definition",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightForecastDefinition' | Write-Debug
...
Convert from JSON to ForecastDefinition<PSCustomObject>
...
ForecastDefinition<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToForecastDefinition {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightForecastDefinition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightForecastDefinition
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AlertThresholdInPercentage", "DataSource", "MetricName", "MinNumOfDaysOfData", "NumOfDaysOfHistoricalData", "PlatformType", "Catalog")
