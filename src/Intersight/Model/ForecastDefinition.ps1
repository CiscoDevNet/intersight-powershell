...
function ConvertFrom-IntersightJsonToForecastDefinition {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AlertThresholdInPercentage", "DataSource", "MetricName", "MinNumOfDaysOfData", "NumOfDaysOfHistoricalData", "PlatformType", "Catalog")
