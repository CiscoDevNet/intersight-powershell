...
HyperflexNamedVsan<PSCustomObject>
#>

function Initialize-IntersightHyperflexNamedVsan {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexNamedVsan' | Write-Debug
...
Convert from JSON to HyperflexNamedVsan<PSCustomObject>
...
HyperflexNamedVsan<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexNamedVsan {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexNamedVsan' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexNamedVsan
