...
SshPolicyAllOf<PSCustomObject>
#>

function Initialize-IntersightSshPolicyAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSshPolicyAllOf' | Write-Debug
...
Convert from JSON to SshPolicyAllOf<PSCustomObject>
...
SshPolicyAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSshPolicyAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSshPolicyAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSshPolicyAllOf
        $AllProperties = ("ClassId", "ObjectType", "Enabled", "Port", "Timeout", "Organization", "Profiles")
