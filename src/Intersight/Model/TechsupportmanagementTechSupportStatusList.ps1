...
TechsupportmanagementTechSupportStatusList<PSCustomObject>
#>

function Initialize-IntersightTechsupportmanagementTechSupportStatusList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTechsupportmanagementTechSupportStatusList' | Write-Debug
...
Convert from JSON to TechsupportmanagementTechSupportStatusList<PSCustomObject>
...
TechsupportmanagementTechSupportStatusList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTechsupportmanagementTechSupportStatusList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTechsupportmanagementTechSupportStatusList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTechsupportmanagementTechSupportStatusList
