...
HyperflexAlarmListAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexAlarmListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexAlarmListAllOf' | Write-Debug
...
Convert from JSON to HyperflexAlarmListAllOf<PSCustomObject>
...
HyperflexAlarmListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexAlarmListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexAlarmListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexAlarmListAllOf
