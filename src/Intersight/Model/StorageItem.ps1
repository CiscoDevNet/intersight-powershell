...
function ConvertFrom-IntersightJsonToStorageItem {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "AlarmType", "Name", "OperState", "Size", "Used", "InventoryDeviceInfo", "NetworkElement", "RegisteredDevice")
