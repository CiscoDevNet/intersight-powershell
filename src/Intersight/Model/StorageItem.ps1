...
function Initialize-IntersightStorageItem {
    ...
    Param (
        ...
        [ValidateSet("storage.Item")]
        [String]
        ${ClassId} = "storage.Item",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.Item")]
        [String]
        ${ObjectType} = "storage.Item",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
...
function ConvertFrom-IntersightJsonToStorageItem {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "AlarmType", "Name", "OperState", "Size", "Used", "InventoryDeviceInfo", "NetworkElement", "RegisteredDevice")
