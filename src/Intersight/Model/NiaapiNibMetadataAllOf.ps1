...
Definition of the list of properties defined in 'niaapi.NibMetadata', excluding properties defined in parent classes.
...
NiaapiNibMetadataAllOf<PSCustomObject>
#>

function Initialize-IntersightNiaapiNibMetadataAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiNibMetadataAllOf' | Write-Debug
...
Convert from JSON to NiaapiNibMetadataAllOf<PSCustomObject>
...
NiaapiNibMetadataAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiNibMetadataAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiNibMetadataAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiNibMetadataAllOf
