...
function ConvertFrom-IntersightJsonToHyperflexClusterAllOf {
    ...
    Process {
        ...
        $AllProperties = ("CapacityRunway", "ClusterName", "ClusterType", "ClusterUuid", "ComputeNodeCount", "ConvergedNodeCount", "DeploymentType", "DeviceId", "FltAggr", "HxVersion", "HxdpBuildVersion", "HypervisorType", "HypervisorVersion", "Summary", "UtilizationPercentage", "UtilizationTrendPercentage", "VmCount", "Alarm", "Health", "Nodes", "RegisteredDevice")
