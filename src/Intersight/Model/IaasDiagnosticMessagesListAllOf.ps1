...
IaasDiagnosticMessagesListAllOf<PSCustomObject>
#>

function Initialize-IntersightIaasDiagnosticMessagesListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIaasDiagnosticMessagesListAllOf' | Write-Debug
...
Convert from JSON to IaasDiagnosticMessagesListAllOf<PSCustomObject>
...
IaasDiagnosticMessagesListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIaasDiagnosticMessagesListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIaasDiagnosticMessagesListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIaasDiagnosticMessagesListAllOf
