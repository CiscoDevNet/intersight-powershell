...
.PARAMETER Array
No description available.
.PARAMETER ParityGroup
No description available.
.PARAMETER RegisteredDevice
No description available.
.OUTPUTS

StorageHitachiDisk<PSCustomObject>
#>

function Initialize-IntersightStorageHitachiDisk {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiDisk")]
        [String]
        ${ClassId} = "storage.HitachiDisk",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiDisk")]
        [String]
        ${ObjectType} = "storage.HitachiDisk",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageHitachiDisk' | Write-Debug
...
Convert from JSON to StorageHitachiDisk<PSCustomObject>
...
StorageHitachiDisk<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageHitachiDisk {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageHitachiDisk' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageHitachiDisk
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Name", "PartNumber", "Protocol", "Speed", "Status", "StorageUtilization", "Type", "Version", "DriveTypeCode", "ParityGroupId", "TypeDetail", "Usage", "Array", "ParityGroup", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "DriveTypeCode"))) { #optional property not found
            $DriveTypeCode = $null
        } else {
            $DriveTypeCode = $JsonParameters.PSobject.Properties["DriveTypeCode"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ParityGroupId"))) { #optional property not found
            $ParityGroupId = $null
        } else {
            $ParityGroupId = $JsonParameters.PSobject.Properties["ParityGroupId"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "TypeDetail"))) { #optional property not found
            $TypeDetail = $null
        } else {
            $TypeDetail = $JsonParameters.PSobject.Properties["TypeDetail"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ParityGroup"))) { #optional property not found
            $ParityGroup = $null
        } else {
            $ParityGroup = $JsonParameters.PSobject.Properties["ParityGroup"].value
        }
