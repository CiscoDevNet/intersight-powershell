...
AssetParentConnectionSignature<PSCustomObject>
#>

function Initialize-IntersightAssetParentConnectionSignature {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAssetParentConnectionSignature' | Write-Debug
...
Convert from JSON to AssetParentConnectionSignature<PSCustomObject>
...
AssetParentConnectionSignature<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAssetParentConnectionSignature {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAssetParentConnectionSignature' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAssetParentConnectionSignature
