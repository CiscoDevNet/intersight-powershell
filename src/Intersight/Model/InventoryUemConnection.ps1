...
InventoryUemConnection<PSCustomObject>
#>

function Initialize-IntersightInventoryUemConnection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightInventoryUemConnection' | Write-Debug
...
Convert from JSON to InventoryUemConnection<PSCustomObject>
...
InventoryUemConnection<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToInventoryUemConnection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightInventoryUemConnection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightInventoryUemConnection
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ConnectionStatus", "EpInfo", "EpType", "Ip", "MemberIdentity", "Model", "Serial", "TargetMoId", "Vendor", "ComputeBlade", "ComputeRackUnit", "RegisteredDevice")
