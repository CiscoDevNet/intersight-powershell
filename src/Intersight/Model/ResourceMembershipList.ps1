...
ResourceMembershipList<PSCustomObject>
#>

function Initialize-IntersightResourceMembershipList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightResourceMembershipList' | Write-Debug
...
Convert from JSON to ResourceMembershipList<PSCustomObject>
...
ResourceMembershipList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToResourceMembershipList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightResourceMembershipList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightResourceMembershipList
