...
VnicVifStatus<PSCustomObject>
#>

function Initialize-IntersightVnicVifStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVnicVifStatus' | Write-Debug
...
Convert from JSON to VnicVifStatus<PSCustomObject>
...
VnicVifStatus<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVnicVifStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVnicVifStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVnicVifStatus
