...
function ConvertFrom-IntersightJsonToNiaapiSoftwareEol {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AffectedVersions", "AnnouncementDate", "AnnouncementDateEpoch", "BulletinNo", "Description", "EndofNewServiceAttachmentDate", "EndofNewServiceAttachmentDateEpoch", "EndofServiceContractRenewalDate", "EndofServiceContractRenewalDateEpoch", "EndofSwMaintenanceDate", "EndofSwMaintenanceDateEpoch", "Headline", "LastDateofSupport", "LastDateofSupportEpoch", "LastShipDate", "LastShipDateEpoch", "MigrationUrl", "SoftwareEolUrl")
