...
BiosBootDeviceListAllOf<PSCustomObject>
#>

function Initialize-IntersightBiosBootDeviceListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBiosBootDeviceListAllOf' | Write-Debug
...
Convert from JSON to BiosBootDeviceListAllOf<PSCustomObject>
...
BiosBootDeviceListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBiosBootDeviceListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBiosBootDeviceListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBiosBootDeviceListAllOf
