...
VirtualizationVirtualMachine<PSCustomObject>
#>

function Initialize-IntersightVirtualizationVirtualMachine {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationVirtualMachine' | Write-Debug
...
Convert from JSON to VirtualizationVirtualMachine<PSCustomObject>
...
VirtualizationVirtualMachine<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationVirtualMachine {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationVirtualMachine' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationVirtualMachine
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Action", "ActionInfo", "AffinitySelectors", "AntiAffinitySelectors", "CloudInitConfig", "ClusterEsxi", "Cpu", "Discovered", "Disk", "GuestOs", "HostEsxi", "HypervisorType", "Interfaces", "Labels", "Memory", "Name", "PowerState", "ProvisionType", "VmConfig", "_0_VirtualMachineNodeProfile", "Cluster", "Host", "Inventory", "RegisteredDevice", "WorkflowInfo")
