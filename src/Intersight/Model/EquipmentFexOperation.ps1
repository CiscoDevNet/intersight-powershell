...
function ConvertFrom-IntersightJsonToEquipmentFexOperation {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AdminLocatorLedAction", "AdminLocatorLedActionState", "DeviceRegistration", "Fex")
