...
EquipmentFexOperation<PSCustomObject>
#>

function Initialize-IntersightEquipmentFexOperation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentFexOperation' | Write-Debug
...
Convert from JSON to EquipmentFexOperation<PSCustomObject>
...
EquipmentFexOperation<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentFexOperation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentFexOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentFexOperation
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AdminLocatorLedAction", "AdminLocatorLedActionState", "DeviceRegistration", "Fex")
