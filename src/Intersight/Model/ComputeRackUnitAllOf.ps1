...
function ConvertFrom-IntersightJsonToComputeRackUnitAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ConnectionStatus", "ServerId", "TopologyScanStatus", "Adapters", "BiosBootmode", "Biosunits", "Bmc", "Board", "BootDeviceBootmode", "Fanmodules", "GenericInventoryHolders", "GraphicsCards", "InventoryDeviceInfo", "LocatorLed", "MemoryArrays", "PciDevices", "Processors", "Psus", "RackEnclosureSlot", "RegisteredDevice", "SasExpanders", "StorageControllers", "StorageEnclosures", "TopSystem", "UemConnection")
