...
VirtualizationBaseDatastore<PSCustomObject>
#>

function Initialize-IntersightVirtualizationBaseDatastore {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationBaseDatastore' | Write-Debug
...
Convert from JSON to VirtualizationBaseDatastore<PSCustomObject>
...
VirtualizationBaseDatastore<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationBaseDatastore {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationBaseDatastore' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationBaseDatastore
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "RegisteredDevice", "Capacity", "HostCount", "Identity", "Name", "Type", "VmCount")
