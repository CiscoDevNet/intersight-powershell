...
MacpoolUniverseListAllOf<PSCustomObject>
#>

function Initialize-IntersightMacpoolUniverseListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMacpoolUniverseListAllOf' | Write-Debug
...
Convert from JSON to MacpoolUniverseListAllOf<PSCustomObject>
...
MacpoolUniverseListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMacpoolUniverseListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMacpoolUniverseListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMacpoolUniverseListAllOf
