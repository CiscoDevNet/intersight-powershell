...
NiatelemetryNexusDashboardDetailsList<PSCustomObject>
#>

function Initialize-IntersightNiatelemetryNexusDashboardDetailsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiatelemetryNexusDashboardDetailsList' | Write-Debug
...
Convert from JSON to NiatelemetryNexusDashboardDetailsList<PSCustomObject>
...
NiatelemetryNexusDashboardDetailsList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiatelemetryNexusDashboardDetailsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiatelemetryNexusDashboardDetailsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiatelemetryNexusDashboardDetailsList
