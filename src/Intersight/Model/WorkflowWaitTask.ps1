...
WorkflowWaitTask<PSCustomObject>
#>

function Initialize-IntersightWorkflowWaitTask {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.WaitTask")]
        [String]
        ${ClassId} = "workflow.WaitTask",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.WaitTask")]
        [String]
        ${ObjectType} = "workflow.WaitTask",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Description},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowWaitTask' | Write-Debug
...
Convert from JSON to WorkflowWaitTask<PSCustomObject>
...
WorkflowWaitTask<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowWaitTask {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowWaitTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowWaitTask
        $AllProperties = ("ClassId", "ObjectType", "Description", "Label", "Name", "InputParameters", "OnFailure", "OnSuccess", "RollbackDisabled", "UseDefault", "Prompts")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "Prompts"))) { #optional property not found
            $Prompts = $null
        } else {
            $Prompts = $JsonParameters.PSobject.Properties["Prompts"].value
        }
