...
EquipmentChassisOperation<PSCustomObject>
#>

function Initialize-IntersightEquipmentChassisOperation {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.ChassisOperation")]
        [String]
        ${ClassId} = "equipment.ChassisOperation",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.ChassisOperation")]
        [String]
        ${ObjectType} = "equipment.ChassisOperation",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentChassisOperation' | Write-Debug
...
Convert from JSON to EquipmentChassisOperation<PSCustomObject>
...
EquipmentChassisOperation<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentChassisOperation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentChassisOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentChassisOperation
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AdminLocatorLedAction", "ConfigState", "Chassis", "DeviceRegistration")
