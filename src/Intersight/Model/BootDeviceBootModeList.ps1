...
BootDeviceBootModeList<PSCustomObject>
#>

function Initialize-IntersightBootDeviceBootModeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootDeviceBootModeList' | Write-Debug
...
Convert from JSON to BootDeviceBootModeList<PSCustomObject>
...
BootDeviceBootModeList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootDeviceBootModeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootDeviceBootModeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootDeviceBootModeList
