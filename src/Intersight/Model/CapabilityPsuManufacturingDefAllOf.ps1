...
CapabilityPsuManufacturingDefAllOf<PSCustomObject>
#>

function Initialize-IntersightCapabilityPsuManufacturingDefAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilityPsuManufacturingDefAllOf' | Write-Debug
...
Convert from JSON to CapabilityPsuManufacturingDefAllOf<PSCustomObject>
...
CapabilityPsuManufacturingDefAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilityPsuManufacturingDefAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilityPsuManufacturingDefAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilityPsuManufacturingDefAllOf
