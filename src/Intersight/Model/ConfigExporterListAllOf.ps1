...
ConfigExporterListAllOf<PSCustomObject>
#>

function Initialize-IntersightConfigExporterListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConfigExporterListAllOf' | Write-Debug
...
Convert from JSON to ConfigExporterListAllOf<PSCustomObject>
...
ConfigExporterListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConfigExporterListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConfigExporterListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConfigExporterListAllOf
