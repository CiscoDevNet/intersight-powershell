...
EquipmentChassisOperationAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentChassisOperationAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentChassisOperationAllOf' | Write-Debug
...
Convert from JSON to EquipmentChassisOperationAllOf<PSCustomObject>
...
EquipmentChassisOperationAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentChassisOperationAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentChassisOperationAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentChassisOperationAllOf
        $AllProperties = ("ClassId", "ObjectType", "AdminLocatorLedAction", "ConfigState", "Chassis", "DeviceRegistration")
