...
function ConvertFrom-IntersightJsonToApplianceSystemInfo {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "CloudConnStatus", "DeploymentSize", "Hostname", "InitDone", "OperationalStatus", "SerialId", "TimeZone", "Version")
