...
function ConvertFrom-IntersightJsonToApplianceSystemInfo {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "CloudConnStatus", "DeploymentSize", "Hostname", "InitDone", "OperationalStatus", "SerialId", "TimeZone", "Version")
