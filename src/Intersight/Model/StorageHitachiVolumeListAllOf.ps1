...
StorageHitachiVolumeListAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageHitachiVolumeListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageHitachiVolumeListAllOf' | Write-Debug
...
Convert from JSON to StorageHitachiVolumeListAllOf<PSCustomObject>
...
StorageHitachiVolumeListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageHitachiVolumeListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageHitachiVolumeListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageHitachiVolumeListAllOf
