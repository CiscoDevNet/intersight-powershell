...
CapabilitySiocModuleDescriptorListAllOf<PSCustomObject>
#>

function Initialize-IntersightCapabilitySiocModuleDescriptorListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilitySiocModuleDescriptorListAllOf' | Write-Debug
...
Convert from JSON to CapabilitySiocModuleDescriptorListAllOf<PSCustomObject>
...
CapabilitySiocModuleDescriptorListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilitySiocModuleDescriptorListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilitySiocModuleDescriptorListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilitySiocModuleDescriptorListAllOf
