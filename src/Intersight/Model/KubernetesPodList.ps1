...
KubernetesPodList<PSCustomObject>
#>

function Initialize-IntersightKubernetesPodList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesPodList' | Write-Debug
...
Convert from JSON to KubernetesPodList<PSCustomObject>
...
KubernetesPodList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesPodList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesPodList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesPodList
