...
HyperflexBackupClusterListAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexBackupClusterListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexBackupClusterListAllOf' | Write-Debug
...
Convert from JSON to HyperflexBackupClusterListAllOf<PSCustomObject>
...
HyperflexBackupClusterListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexBackupClusterListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexBackupClusterListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexBackupClusterListAllOf
