...
function ConvertFrom-IntersightJsonToVnicEthIf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Cdn", "FailoverEnabled", "MacAddress", "Name", "Order", "Placement", "StandbyVifId", "UsnicSettings", "VifId", "VmqSettings", "EthAdapterPolicy", "EthNetworkPolicy", "EthQosPolicy", "FabricEthNetworkControlPolicy", "FabricEthNetworkGroupPolicy", "LanConnectivityPolicy", "LcpVnic", "MacLease", "MacPool", "Profile", "SpVnics")
