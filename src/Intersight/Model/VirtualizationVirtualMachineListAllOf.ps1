...
VirtualizationVirtualMachineListAllOf<PSCustomObject>
#>

function Initialize-IntersightVirtualizationVirtualMachineListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationVirtualMachineListAllOf' | Write-Debug
...
Convert from JSON to VirtualizationVirtualMachineListAllOf<PSCustomObject>
...
VirtualizationVirtualMachineListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationVirtualMachineListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationVirtualMachineListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationVirtualMachineListAllOf
