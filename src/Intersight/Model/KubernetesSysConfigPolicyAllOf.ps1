...
KubernetesSysConfigPolicyAllOf<PSCustomObject>
#>

function Initialize-IntersightKubernetesSysConfigPolicyAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesSysConfigPolicyAllOf' | Write-Debug
...
Convert from JSON to KubernetesSysConfigPolicyAllOf<PSCustomObject>
...
KubernetesSysConfigPolicyAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesSysConfigPolicyAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesSysConfigPolicyAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesSysConfigPolicyAllOf
