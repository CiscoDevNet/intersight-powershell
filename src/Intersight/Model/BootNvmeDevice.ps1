...
BootNvmeDevice<PSCustomObject>
#>

function Initialize-IntersightBootNvmeDevice {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.NvmeDevice")]
        [String]
        ${ClassId} = "boot.NvmeDevice",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.NvmeDevice")]
        [String]
        ${ObjectType} = "boot.NvmeDevice",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootNvmeDevice' | Write-Debug
...
Convert from JSON to BootNvmeDevice<PSCustomObject>
...
BootNvmeDevice<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootNvmeDevice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootNvmeDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootNvmeDevice
