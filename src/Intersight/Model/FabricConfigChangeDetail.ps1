...
FabricConfigChangeDetail<PSCustomObject>
#>

function Initialize-IntersightFabricConfigChangeDetail {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.ConfigChangeDetail")]
        [String]
        ${ClassId} = "fabric.ConfigChangeDetail",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.ConfigChangeDetail")]
        [String]
        ${ObjectType} = "fabric.ConfigChangeDetail",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricConfigChangeDetail' | Write-Debug
...
Convert from JSON to FabricConfigChangeDetail<PSCustomObject>
...
FabricConfigChangeDetail<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricConfigChangeDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricConfigChangeDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricConfigChangeDetail
