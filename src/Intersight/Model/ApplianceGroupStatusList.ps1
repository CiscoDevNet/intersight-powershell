...
ApplianceGroupStatusList<PSCustomObject>
#>

function Initialize-IntersightApplianceGroupStatusList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightApplianceGroupStatusList' | Write-Debug
...
Convert from JSON to ApplianceGroupStatusList<PSCustomObject>
...
ApplianceGroupStatusList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToApplianceGroupStatusList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightApplianceGroupStatusList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightApplianceGroupStatusList
