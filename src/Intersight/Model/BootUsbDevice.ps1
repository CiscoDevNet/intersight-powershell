...
BootUsbDevice<PSCustomObject>
#>

function Initialize-IntersightBootUsbDevice {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.UsbDevice")]
        [String]
        ${ClassId} = "boot.UsbDevice",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.UsbDevice")]
        [String]
        ${ObjectType} = "boot.UsbDevice",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootUsbDevice' | Write-Debug
...
Convert from JSON to BootUsbDevice<PSCustomObject>
...
BootUsbDevice<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootUsbDevice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootUsbDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootUsbDevice
