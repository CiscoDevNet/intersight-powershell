...
HclCompatibilityStatus<PSCustomObject>
#>

function Initialize-IntersightHclCompatibilityStatus {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hcl.CompatibilityStatus")]
        [String]
        ${ClassId} = "hcl.CompatibilityStatus",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hcl.CompatibilityStatus")]
        [String]
        ${ObjectType} = "hcl.CompatibilityStatus",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        ...
        ${ProfileList},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("FillSupportedVersions", "CheckCompatibility", "GetRecommendedDrivers")]
        [String]
        ${RequestType} = "FillSupportedVersions"
    )

    Process {
        'Creating PSCustomObject: Intersight => IntersightHclCompatibilityStatus' | Write-Debug
        ...
        if (!$ProfileList -and $ProfileList.length -lt 1) {
            throw "invalid value for 'ProfileList', number of items must be greater than or equal to 1."
        }
...
Convert from JSON to HclCompatibilityStatus<PSCustomObject>
...
HclCompatibilityStatus<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHclCompatibilityStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHclCompatibilityStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHclCompatibilityStatus
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ProfileList", "RequestType")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ProfileList"))) { #optional property not found
            $ProfileList = $null
        } else {
            $ProfileList = $JsonParameters.PSobject.Properties["ProfileList"].value
        }
