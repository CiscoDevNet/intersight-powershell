...
CapabilitySiocModuleDescriptorList<PSCustomObject>
#>

function Initialize-IntersightCapabilitySiocModuleDescriptorList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilitySiocModuleDescriptorList' | Write-Debug
...
Convert from JSON to CapabilitySiocModuleDescriptorList<PSCustomObject>
...
CapabilitySiocModuleDescriptorList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilitySiocModuleDescriptorList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilitySiocModuleDescriptorList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilitySiocModuleDescriptorList
