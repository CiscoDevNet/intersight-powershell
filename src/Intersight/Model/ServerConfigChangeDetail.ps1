...
ServerConfigChangeDetail<PSCustomObject>
#>

function Initialize-IntersightServerConfigChangeDetail {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("server.ConfigChangeDetail")]
        [String]
        ${ClassId} = "server.ConfigChangeDetail",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("server.ConfigChangeDetail")]
        [String]
        ${ObjectType} = "server.ConfigChangeDetail",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightServerConfigChangeDetail' | Write-Debug
...
Convert from JSON to ServerConfigChangeDetail<PSCustomObject>
...
ServerConfigChangeDetail<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToServerConfigChangeDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightServerConfigChangeDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightServerConfigChangeDetail
