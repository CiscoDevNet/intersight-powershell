...
function ConvertFrom-IntersightJsonToComputeBladeIdentity {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AdminAction", "AdminActionState", "Identifier", "Lifecycle", "Model", "Serial", "Vendor", "DeviceRegistration", "PendingDiscovery", "PhysicalDeviceRegistration", "ChassisId", "DeviceMoId", "SlotId")
