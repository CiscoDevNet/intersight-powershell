...
function Initialize-IntersightComputeBladeIdentity {
    ...
    Param (
        ...
        [ValidateSet("compute.BladeIdentity")]
        [String]
        ${ClassId} = "compute.BladeIdentity",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("compute.BladeIdentity")]
        [String]
...
function ConvertFrom-IntersightJsonToComputeBladeIdentity {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AdminAction", "AdminActionState", "Identifier", "Lifecycle", "Model", "Serial", "Vendor", "RegisteredDevice", "PhysicalDeviceRegistration", "ChassisId", "FirmwareSupportability", "Presence", "SlotId")
