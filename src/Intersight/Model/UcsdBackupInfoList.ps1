...
UcsdBackupInfoList<PSCustomObject>
#>

function Initialize-IntersightUcsdBackupInfoList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightUcsdBackupInfoList' | Write-Debug
...
Convert from JSON to UcsdBackupInfoList<PSCustomObject>
...
UcsdBackupInfoList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToUcsdBackupInfoList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightUcsdBackupInfoList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightUcsdBackupInfoList
