...
VnicEthQosPolicy<PSCustomObject>
#>

function Initialize-IntersightVnicEthQosPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVnicEthQosPolicy' | Write-Debug
...
Convert from JSON to VnicEthQosPolicy<PSCustomObject>
...
VnicEthQosPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVnicEthQosPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVnicEthQosPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVnicEthQosPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Burst", "Cos", "Mtu", "Priority", "RateLimit", "TrustHostCos", "Organization")
