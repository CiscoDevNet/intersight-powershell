...
function ConvertFrom-IntersightJsonToNiaapiDcnmFieldNotice {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Bugid", "FieldNoticeDesc", "FieldNoticeId", "FieldNoticeUrl", "Headline", "Hwpid", "RevisionInfo", "SwRelease", "WorkaroundUrl")
