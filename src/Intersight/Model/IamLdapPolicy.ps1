...
function ConvertFrom-IntersightJsonToIamLdapPolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "BaseProperties", "DnsParameters", "EnableDns", "Enabled", "UserSearchPrecedence", "_0_Idp", "ApplianceAccount", "Groups", "Organization", "Profiles", "Providers")
