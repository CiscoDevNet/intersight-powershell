...
function ConvertFrom-IntersightJsonToIamLdapPolicy {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "BaseProperties", "DnsParameters", "EnableDns", "Enabled", "UserSearchPrecedence", "_0_Idp", "ApplianceAccount", "Groups", "Organization", "Profiles", "Providers")
