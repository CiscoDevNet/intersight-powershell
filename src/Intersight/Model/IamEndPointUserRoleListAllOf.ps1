...
IamEndPointUserRoleListAllOf<PSCustomObject>
#>

function Initialize-IntersightIamEndPointUserRoleListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamEndPointUserRoleListAllOf' | Write-Debug
...
Convert from JSON to IamEndPointUserRoleListAllOf<PSCustomObject>
...
IamEndPointUserRoleListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamEndPointUserRoleListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamEndPointUserRoleListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamEndPointUserRoleListAllOf
