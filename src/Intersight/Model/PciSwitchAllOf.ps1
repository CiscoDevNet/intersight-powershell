...
function ConvertFrom-IntersightJsonToPciSwitchAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "DeviceId", "Health", "NumOfAdaptors", "PciAddress", "PciSlot", "ProductName", "ProductRevision", "SubDeviceId", "SubVendorId", "Temperature", "Type", "VendorId", "ComputeBoard", "InventoryDeviceInfo", "Links", "RegisteredDevice", "RunningFirmware")
