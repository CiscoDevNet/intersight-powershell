...
Configuration object sent by user to apply on a port.
...
function ConvertFrom-IntersightJsonToFabricPortRole {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AggregatePortId", "PortId", "SlotId", "PortPolicy")
