...
function Initialize-IntersightIaasLicenseKeysInfoAllOf {
    ...
    Param (
        ...
        [ValidateSet("iaas.LicenseKeysInfo")]
        [String]
        ${ClassId} = "iaas.LicenseKeysInfo",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iaas.LicenseKeysInfo")]
        [String]
        ${ObjectType} = "iaas.LicenseKeysInfo"
    )
...
function ConvertFrom-IntersightJsonToIaasLicenseKeysInfoAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Count", "ExpirationDate", "LicenseId", "Pid")
