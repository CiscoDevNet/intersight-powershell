...
function ConvertFrom-IntersightJsonToStorageVirtualDriveExtensionAllOf {
    ...
    Process {
        ...
        $AllProperties = ("Bootable", "ContainerId", "DriveState", "Name", "OperDeviceId", "Uuid", "VendorUuid", "VirtualDriveDn", "VirtualDriveId", "InventoryDeviceInfo", "RegisteredDevice", "StorageController", "VirtualDrive")
