...
FirmwareSasExpanderDescriptorListAllOf<PSCustomObject>
#>

function Initialize-IntersightFirmwareSasExpanderDescriptorListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareSasExpanderDescriptorListAllOf' | Write-Debug
...
Convert from JSON to FirmwareSasExpanderDescriptorListAllOf<PSCustomObject>
...
FirmwareSasExpanderDescriptorListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareSasExpanderDescriptorListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareSasExpanderDescriptorListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareSasExpanderDescriptorListAllOf
