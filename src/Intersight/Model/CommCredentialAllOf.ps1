...
CommCredentialAllOf<PSCustomObject>
#>

function Initialize-IntersightCommCredentialAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCommCredentialAllOf' | Write-Debug
...
Convert from JSON to CommCredentialAllOf<PSCustomObject>
...
CommCredentialAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCommCredentialAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCommCredentialAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCommCredentialAllOf
