...
VirtualizationVirtualDisk<PSCustomObject>
#>

function Initialize-IntersightVirtualizationVirtualDisk {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationVirtualDisk' | Write-Debug
...
Convert from JSON to VirtualizationVirtualDisk<PSCustomObject>
...
VirtualizationVirtualDisk<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationVirtualDisk {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationVirtualDisk' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationVirtualDisk
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Capacity", "Discovered", "Mode", "Name", "SourceCerts", "SourceDiskToClone", "SourceFilePath", "Cluster", "Inventory", "RegisteredDevice", "WorkflowInfo")
