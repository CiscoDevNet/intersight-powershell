...
function ConvertFrom-IntersightJsonToStorageVirtualDrive {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "AccessPolicy", "ActualWriteCachePolicy", "AvailableSize", "BlockSize", "Bootable", "ConfigState", "ConfiguredWriteCachePolicy", "ConnectionProtocol", "DriveCache", "DriveSecurity", "DriveState", "IoPolicy", "Name", "NumBlocks", "OperState", "Operability", "PhysicalBlockSize", "Presence", "ReadPolicy", "SecurityFlags", "Size", "StripSize", "Type", "Uuid", "VendorUuid", "VirtualDriveId", "DiskGroup", "InventoryDeviceInfo", "PhysicalDiskUsages", "RegisteredDevice", "StorageController", "VdMemberEps", "VirtualDriveExtension")
