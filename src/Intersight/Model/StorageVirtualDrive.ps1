...
function ConvertFrom-IntersightJsonToStorageVirtualDrive {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "AccessPolicy", "ActualWriteCachePolicy", "AvailableSize", "BlockSize", "Bootable", "ConfigState", "ConfiguredWriteCachePolicy", "ConnectionProtocol", "DriveCache", "DriveSecurity", "DriveState", "IoPolicy", "Name", "NumBlocks", "OperState", "Operability", "PhysicalBlockSize", "Presence", "ReadPolicy", "SecurityFlags", "Size", "StripSize", "Type", "Uuid", "VendorUuid", "VirtualDriveId", "DiskGroup", "InventoryDeviceInfo", "PhysicalDiskUsages", "RegisteredDevice", "StorageController", "StorageVirtualDriveContainer", "VdMemberEps", "VirtualDriveExtension")
