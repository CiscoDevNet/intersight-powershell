...
function ConvertFrom-IntersightJsonToWorkflowTaskInfo {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "EndTime", "FailureReason", "Input", "InstId", "Internal", "Label", "Message", "Name", "Output", "RefName", "RetryCount", "RunningInstId", "StartTime", "Status", "TaskInstIdList", "SubWorkflowInfo", "TaskDefinition", "WorkflowInfo")
