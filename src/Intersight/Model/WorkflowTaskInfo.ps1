...
function ConvertFrom-IntersightJsonToWorkflowTaskInfo {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "EndTime", "FailureReason", "Input", "InstId", "Internal", "Label", "Message", "Name", "Output", "RefName", "RetryCount", "RollbackDisabled", "RunningInstId", "StartTime", "Status", "TaskInstIdList", "SubWorkflowInfo", "TaskDefinition", "WorkflowInfo")
