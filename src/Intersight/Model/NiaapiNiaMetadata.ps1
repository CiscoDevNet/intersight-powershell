...
NiaapiNiaMetadata<PSCustomObject>
#>

function Initialize-IntersightNiaapiNiaMetadata {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiNiaMetadata' | Write-Debug
...
Convert from JSON to NiaapiNiaMetadata<PSCustomObject>
...
NiaapiNiaMetadata<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiNiaMetadata {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiNiaMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiNiaMetadata
