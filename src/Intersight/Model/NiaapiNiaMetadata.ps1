...
function ConvertFrom-IntersightJsonToNiaapiNiaMetadata {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Content", "Date", "MetadataChksum", "MetadataFilename", "Version")
