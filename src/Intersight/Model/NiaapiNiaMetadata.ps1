...
function ConvertFrom-IntersightJsonToNiaapiNiaMetadata {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Content", "Date", "MetadataChksum", "MetadataFilename", "Version")
