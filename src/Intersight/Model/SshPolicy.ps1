...
SshPolicy<PSCustomObject>
#>

function Initialize-IntersightSshPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("ssh.Policy")]
        [String]
        ${ClassId} = "ssh.Policy",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("ssh.Policy")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSshPolicy' | Write-Debug
        ...
        if ($Timeout -and $Timeout -gt 10800) {
          throw "invalid value for 'Timeout', must be smaller than or equal to 10800."
        }

        if ($Timeout -and $Timeout -lt 60) {
          throw "invalid value for 'Timeout', must be greater than or equal to 60."
        }
...
Convert from JSON to SshPolicy<PSCustomObject>
...
SshPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSshPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSshPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSshPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Enabled", "Port", "Timeout", "Organization", "Profiles")
