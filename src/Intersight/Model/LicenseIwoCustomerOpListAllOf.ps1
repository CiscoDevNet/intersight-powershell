...
LicenseIwoCustomerOpListAllOf<PSCustomObject>
#>

function Initialize-IntersightLicenseIwoCustomerOpListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightLicenseIwoCustomerOpListAllOf' | Write-Debug
...
Convert from JSON to LicenseIwoCustomerOpListAllOf<PSCustomObject>
...
LicenseIwoCustomerOpListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToLicenseIwoCustomerOpListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightLicenseIwoCustomerOpListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightLicenseIwoCustomerOpListAllOf
