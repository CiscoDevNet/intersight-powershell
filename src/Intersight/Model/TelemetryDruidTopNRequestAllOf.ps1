...
TelemetryDruidTopNRequestAllOf<PSCustomObject>
#>

function Initialize-IntersightTelemetryDruidTopNRequestAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTelemetryDruidTopNRequestAllOf' | Write-Debug
...
Convert from JSON to TelemetryDruidTopNRequestAllOf<PSCustomObject>
...
TelemetryDruidTopNRequestAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTelemetryDruidTopNRequestAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTelemetryDruidTopNRequestAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTelemetryDruidTopNRequestAllOf
        $AllProperties = ("dataSource", "intervals", "granularity", "filter", "aggregations", "postAggregations", "dimension", "threshold", "metric", "context")
