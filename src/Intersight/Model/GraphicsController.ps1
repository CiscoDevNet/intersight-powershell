...
GraphicsController<PSCustomObject>
#>

function Initialize-IntersightGraphicsController {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("graphics.Controller")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightGraphicsController' | Write-Debug
...
Convert from JSON to GraphicsController<PSCustomObject>
...
GraphicsController<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToGraphicsController {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightGraphicsController' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightGraphicsController
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ControllerId", "PciAddr", "PciSlot", "GraphicsCard", "InventoryDeviceInfo", "RegisteredDevice")
