...
NiatelemetryApicFanDetails<PSCustomObject>
#>

function Initialize-IntersightNiatelemetryApicFanDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiatelemetryApicFanDetails' | Write-Debug
...
Convert from JSON to NiatelemetryApicFanDetails<PSCustomObject>
...
NiatelemetryApicFanDetails<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiatelemetryApicFanDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiatelemetryApicFanDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiatelemetryApicFanDetails
