...
NiaapiSoftwareRegexAllOf<PSCustomObject>
#>

function Initialize-IntersightNiaapiSoftwareRegexAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("niaapi.SoftwareRegex")]
        [String]
        ${ClassId} = "niaapi.SoftwareRegex",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("niaapi.SoftwareRegex")]
        [String]
        ${ObjectType} = "niaapi.SoftwareRegex",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Regex},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiSoftwareRegexAllOf' | Write-Debug
...
Convert from JSON to NiaapiSoftwareRegexAllOf<PSCustomObject>
...
NiaapiSoftwareRegexAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiSoftwareRegexAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiSoftwareRegexAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiSoftwareRegexAllOf
        $AllProperties = ("ClassId", "ObjectType", "Regex", "SoftwareVersion")
