...
function ConvertFrom-IntersightJsonToStorageFlexUtilVirtualDriveAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "DriveStatus", "DriveType", "PartitionId", "PartitionName", "ResidentImage", "Size", "VirtualDrive", "InventoryDeviceInfo", "RegisteredDevice", "StorageFlexUtilController")
