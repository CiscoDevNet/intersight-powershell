...
function ConvertFrom-IntersightJsonToEquipmentIoCardBaseAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "ConnectionStatus", "Description", "ModuleId", "OperState", "PartNumber", "Pid", "Presence", "ProductName", "Sku", "Version", "Vid", "HostPorts", "MgmtController", "NetworkPorts")
