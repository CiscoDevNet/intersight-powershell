...
StoragePureDisk<PSCustomObject>
#>

function Initialize-IntersightStoragePureDisk {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PureDisk")]
        [String]
        ${ClassId} = "storage.PureDisk",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PureDisk")]
        [String]
        ${ObjectType} = "storage.PureDisk",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePureDisk' | Write-Debug
...
Convert from JSON to StoragePureDisk<PSCustomObject>
...
StoragePureDisk<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePureDisk {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePureDisk' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePureDisk
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Name", "PartNumber", "Protocol", "Speed", "Status", "StorageUtilization", "Type", "Version", "Array", "RegisteredDevice")
