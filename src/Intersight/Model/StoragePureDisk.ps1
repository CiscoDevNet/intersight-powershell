...
function ConvertFrom-IntersightJsonToStoragePureDisk {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Name", "PartNumber", "Protocol", "Speed", "Status", "StorageUtilization", "Type", "Version", "Array", "RegisteredDevice")
