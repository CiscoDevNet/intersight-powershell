...
PciSwitchList<PSCustomObject>
#>

function Initialize-IntersightPciSwitchList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPciSwitchList' | Write-Debug
...
Convert from JSON to PciSwitchList<PSCustomObject>
...
PciSwitchList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPciSwitchList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPciSwitchList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPciSwitchList
