...
ManagementEntityListAllOf<PSCustomObject>
#>

function Initialize-IntersightManagementEntityListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightManagementEntityListAllOf' | Write-Debug
...
Convert from JSON to ManagementEntityListAllOf<PSCustomObject>
...
ManagementEntityListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToManagementEntityListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightManagementEntityListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightManagementEntityListAllOf
