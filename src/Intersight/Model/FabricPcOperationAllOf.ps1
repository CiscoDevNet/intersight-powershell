...
FabricPcOperationAllOf<PSCustomObject>
#>

function Initialize-IntersightFabricPcOperationAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricPcOperationAllOf' | Write-Debug
...
Convert from JSON to FabricPcOperationAllOf<PSCustomObject>
...
FabricPcOperationAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricPcOperationAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricPcOperationAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricPcOperationAllOf
        $AllProperties = ("ClassId", "ObjectType", "AdminState", "PcId", "NetworkElement")
