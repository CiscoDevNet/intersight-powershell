...
FabricPortOperation<PSCustomObject>
#>

function Initialize-IntersightFabricPortOperation {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.PortOperation")]
        [String]
        ${ClassId} = "fabric.PortOperation",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.PortOperation")]
        [String]
        ${ObjectType} = "fabric.PortOperation",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricPortOperation' | Write-Debug
...
Convert from JSON to FabricPortOperation<PSCustomObject>
...
FabricPortOperation<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricPortOperation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricPortOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricPortOperation
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AggregatePortId", "PortId", "SlotId", "AdminState", "NetworkElement")
