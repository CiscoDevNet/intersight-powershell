...
StoragePureDiskList<PSCustomObject>
#>

function Initialize-IntersightStoragePureDiskList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePureDiskList' | Write-Debug
...
Convert from JSON to StoragePureDiskList<PSCustomObject>
...
StoragePureDiskList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePureDiskList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePureDiskList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePureDiskList
