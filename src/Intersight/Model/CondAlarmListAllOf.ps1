...
CondAlarmListAllOf<PSCustomObject>
#>

function Initialize-IntersightCondAlarmListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCondAlarmListAllOf' | Write-Debug
...
Convert from JSON to CondAlarmListAllOf<PSCustomObject>
...
CondAlarmListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCondAlarmListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCondAlarmListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCondAlarmListAllOf
