...
NiaapiApicHweol<PSCustomObject>
#>

function Initialize-IntersightNiaapiApicHweol {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiApicHweol' | Write-Debug
...
Convert from JSON to NiaapiApicHweol<PSCustomObject>
...
NiaapiApicHweol<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiApicHweol {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiApicHweol' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiApicHweol
