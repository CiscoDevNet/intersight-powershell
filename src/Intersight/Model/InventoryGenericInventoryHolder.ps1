...
function ConvertFrom-IntersightJsonToInventoryGenericInventoryHolder {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Endpoint", "ComputeBlade", "ComputeRackUnit", "GenericInventory", "InventoryDeviceInfo", "RegisteredDevice")
