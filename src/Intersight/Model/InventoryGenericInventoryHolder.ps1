...
InventoryGenericInventoryHolder<PSCustomObject>
#>

function Initialize-IntersightInventoryGenericInventoryHolder {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("inventory.GenericInventoryHolder")]
        [String]
        ${ClassId} = "inventory.GenericInventoryHolder",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("inventory.GenericInventoryHolder")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightInventoryGenericInventoryHolder' | Write-Debug
...
Convert from JSON to InventoryGenericInventoryHolder<PSCustomObject>
...
InventoryGenericInventoryHolder<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToInventoryGenericInventoryHolder {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightInventoryGenericInventoryHolder' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightInventoryGenericInventoryHolder
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Endpoint", "ComputeBlade", "ComputeRackUnit", "GenericInventory", "InventoryDeviceInfo", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "GenericInventory"))) { #optional property not found
            $GenericInventory = $null
        } else {
            $GenericInventory = $JsonParameters.PSobject.Properties["GenericInventory"].value
        }
