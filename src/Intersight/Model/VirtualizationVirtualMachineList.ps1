...
VirtualizationVirtualMachineList<PSCustomObject>
#>

function Initialize-IntersightVirtualizationVirtualMachineList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationVirtualMachineList' | Write-Debug
...
Convert from JSON to VirtualizationVirtualMachineList<PSCustomObject>
...
VirtualizationVirtualMachineList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationVirtualMachineList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationVirtualMachineList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationVirtualMachineList
