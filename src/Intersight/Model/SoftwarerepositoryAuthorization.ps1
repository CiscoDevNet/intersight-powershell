...
function ConvertFrom-IntersightJsonToSoftwarerepositoryAuthorization {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "IsPasswordSet", "IsUserIdSet", "Password", "RepositoryType", "UserId", "Account")
