...
SoftwarerepositoryAuthorization<PSCustomObject>
#>

function Initialize-IntersightSoftwarerepositoryAuthorization {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("softwarerepository.Authorization")]
        [String]
        ${ClassId} = "softwarerepository.Authorization",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("softwarerepository.Authorization")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwarerepositoryAuthorization' | Write-Debug
...
Convert from JSON to SoftwarerepositoryAuthorization<PSCustomObject>
...
SoftwarerepositoryAuthorization<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwarerepositoryAuthorization {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSoftwarerepositoryAuthorization' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSoftwarerepositoryAuthorization
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "IsPasswordSet", "IsUserIdSet", "Password", "RepositoryType", "UserId", "Account")
