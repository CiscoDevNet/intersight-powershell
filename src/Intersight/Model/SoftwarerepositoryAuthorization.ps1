...
function ConvertFrom-IntersightJsonToSoftwarerepositoryAuthorization {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "IsPasswordSet", "IsUserIdSet", "Password", "RepositoryType", "UserId", "Account")
