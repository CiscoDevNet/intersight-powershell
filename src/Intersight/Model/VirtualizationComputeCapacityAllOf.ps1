...
Definition of the list of properties defined in 'virtualization.ComputeCapacity', excluding properties defined in parent classes.
...
VirtualizationComputeCapacityAllOf<PSCustomObject>
#>

function Initialize-IntersightVirtualizationComputeCapacityAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationComputeCapacityAllOf' | Write-Debug
...
Convert from JSON to VirtualizationComputeCapacityAllOf<PSCustomObject>
...
VirtualizationComputeCapacityAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationComputeCapacityAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationComputeCapacityAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationComputeCapacityAllOf
        $AllProperties = ("Capacity", "Free", "Used")
