...
FabricSystemQosPolicy<PSCustomObject>
#>

function Initialize-IntersightFabricSystemQosPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.SystemQosPolicy")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricSystemQosPolicy' | Write-Debug
...
Convert from JSON to FabricSystemQosPolicy<PSCustomObject>
...
FabricSystemQosPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricSystemQosPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricSystemQosPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricSystemQosPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Classes", "Organization", "Profiles")
