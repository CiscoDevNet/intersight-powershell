...
RecoveryBackupSchedule<PSCustomObject>
#>

function Initialize-IntersightRecoveryBackupSchedule {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightRecoveryBackupSchedule' | Write-Debug
...
Convert from JSON to RecoveryBackupSchedule<PSCustomObject>
...
RecoveryBackupSchedule<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToRecoveryBackupSchedule {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightRecoveryBackupSchedule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightRecoveryBackupSchedule
