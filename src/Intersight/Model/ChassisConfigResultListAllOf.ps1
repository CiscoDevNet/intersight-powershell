...
ChassisConfigResultListAllOf<PSCustomObject>
#>

function Initialize-IntersightChassisConfigResultListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightChassisConfigResultListAllOf' | Write-Debug
...
Convert from JSON to ChassisConfigResultListAllOf<PSCustomObject>
...
ChassisConfigResultListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToChassisConfigResultListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightChassisConfigResultListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightChassisConfigResultListAllOf
