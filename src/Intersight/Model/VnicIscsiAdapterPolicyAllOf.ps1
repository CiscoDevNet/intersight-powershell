...
Definition of the list of properties defined in 'vnic.IscsiAdapterPolicy', excluding properties defined in parent classes.
...
VnicIscsiAdapterPolicyAllOf<PSCustomObject>
#>

function Initialize-IntersightVnicIscsiAdapterPolicyAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVnicIscsiAdapterPolicyAllOf' | Write-Debug
...
Convert from JSON to VnicIscsiAdapterPolicyAllOf<PSCustomObject>
...
VnicIscsiAdapterPolicyAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVnicIscsiAdapterPolicyAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVnicIscsiAdapterPolicyAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVnicIscsiAdapterPolicyAllOf
        $AllProperties = ("ClassId", "ObjectType", "ConnectionTimeOut", "DhcpTimeout", "LunBusyRetryCount", "Organization")
