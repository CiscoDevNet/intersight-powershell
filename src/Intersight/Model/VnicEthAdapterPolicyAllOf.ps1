...
function ConvertFrom-IntersightJsonToVnicEthAdapterPolicyAllOf {
    ...
    Process {
        ...
        $AllProperties = ("AdvancedFilter", "ArfsSettings", "CompletionQueueSettings", "InterruptScaling", "InterruptSettings", "NvgreSettings", "RoceSettings", "RssHashSettings", "RssSettings", "RxQueueSettings", "TcpOffloadSettings", "TxQueueSettings", "UplinkFailbackTimeout", "VxlanSettings", "Organization")
