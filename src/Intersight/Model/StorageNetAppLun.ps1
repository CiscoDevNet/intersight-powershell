...
StorageNetAppLun<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppLun {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.NetAppLun")]
        [String]
        ${ClassId} = "storage.NetAppLun",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.NetAppLun")]
        [String]
        ${ObjectType} = "storage.NetAppLun",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppLun' | Write-Debug
...
Convert from JSON to StorageNetAppLun<PSCustomObject>
...
StorageNetAppLun<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppLun {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppLun' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppLun
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "NaaId", "Name", "Size", "StorageUtilization", "OsType", "Serial", "State", "Uuid", "Array", "Host", "StorageContainer")
