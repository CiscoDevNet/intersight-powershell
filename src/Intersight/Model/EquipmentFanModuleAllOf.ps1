...
function ConvertFrom-IntersightJsonToEquipmentFanModuleAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Description", "ModuleId", "OperReason", "OperState", "PartNumber", "Pid", "Presence", "Sku", "TrayId", "Vid", "ComputeRackUnit", "EquipmentChassis", "EquipmentRackEnclosure", "Fans", "InventoryDeviceInfo", "NetworkElement", "RegisteredDevice")
