...
function ConvertFrom-IntersightJsonToEquipmentFanModuleAllOf {
    ...
    Process {
        ...
        $AllProperties = ("Description", "ModuleId", "OperState", "PartNumber", "Pid", "Presence", "Sku", "TrayId", "Vid", "ComputeRackUnit", "EquipmentChassis", "EquipmentRackEnclosure", "Fans", "InventoryDeviceInfo", "NetworkElement", "RegisteredDevice")
