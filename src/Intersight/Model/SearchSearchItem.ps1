...
SearchSearchItem<PSCustomObject>
#>

function Initialize-IntersightSearchSearchItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSearchSearchItem' | Write-Debug
...
Convert from JSON to SearchSearchItem<PSCustomObject>
...
SearchSearchItem<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSearchSearchItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSearchSearchItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSearchSearchItem
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames")
