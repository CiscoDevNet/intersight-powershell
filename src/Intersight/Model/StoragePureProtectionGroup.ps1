...
function ConvertFrom-IntersightJsonToStoragePureProtectionGroup {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Prefix", "ReplicationEnabled", "SnapshotEnabled", "Size", "Source", "Targets", "Array", "HostGroups", "Hosts", "RegisteredDevice", "Volumes")
