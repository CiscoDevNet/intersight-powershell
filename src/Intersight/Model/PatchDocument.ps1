...
function Initialize-IntersightPatchDocument {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPatchDocument' | Write-Debug
...
Convert from JSON to PatchDocument<PSCustomObject>
...
PatchDocument<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPatchDocument {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPatchDocument' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPatchDocument
        $AllProperties = ("op", "path", "value", "from")
