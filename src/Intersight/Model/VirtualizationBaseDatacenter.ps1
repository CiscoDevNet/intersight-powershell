...
VirtualizationBaseDatacenter<PSCustomObject>
#>

function Initialize-IntersightVirtualizationBaseDatacenter {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.HxapDatacenter", "virtualization.VmwareDatacenter")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.HxapDatacenter", "virtualization.VmwareDatacenter")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationBaseDatacenter' | Write-Debug
...
Convert from JSON to VirtualizationBaseDatacenter<PSCustomObject>
...
VirtualizationBaseDatacenter<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationBaseDatacenter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationBaseDatacenter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationBaseDatacenter
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "RegisteredDevice", "Identity", "Name")
