...
function ConvertFrom-IntersightJsonToSoftwarerepositoryFileAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Description", "DownloadCount", "ImportAction", "ImportState", "ImportedTime", "LastAccessTime", "Md5eTag", "Md5sum", "Name", "ReleaseDate", "Sha512sum", "Size", "SoftwareAdvisoryUrl", "Source", "Version")
