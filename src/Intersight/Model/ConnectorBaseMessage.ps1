...
ConnectorBaseMessage<PSCustomObject>
#>

function Initialize-IntersightConnectorBaseMessage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConnectorBaseMessage' | Write-Debug
...
Convert from JSON to ConnectorBaseMessage<PSCustomObject>
...
ConnectorBaseMessage<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConnectorBaseMessage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConnectorBaseMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConnectorBaseMessage
