...
StoragePureArray<PSCustomObject>
#>

function Initialize-IntersightStoragePureArray {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PureArray")]
        [String]
        ${ClassId} = "storage.PureArray",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PureArray")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePureArray' | Write-Debug
...
Convert from JSON to StoragePureArray<PSCustomObject>
...
StoragePureArray<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePureArray {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePureArray' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePureArray
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Name", "Uuid", "Version", "StorageUtilization", "RegisteredDevice")
