...
FabricPortPolicy<PSCustomObject>
#>

function Initialize-IntersightFabricPortPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.PortPolicy")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricPortPolicy' | Write-Debug
...
Convert from JSON to FabricPortPolicy<PSCustomObject>
...
FabricPortPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricPortPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricPortPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricPortPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "DeviceModel", "Organization", "Profiles")
