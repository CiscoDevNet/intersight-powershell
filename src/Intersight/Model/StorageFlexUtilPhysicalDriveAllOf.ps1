...
function ConvertFrom-IntersightJsonToStorageFlexUtilPhysicalDriveAllOf {
    ...
    Process {
        ...
        $AllProperties = ("BlockSize", "Capacity", "Controller", "DrivesEnabled", "Health", "ManufacturerDate", "ManufacturerId", "OemId", "PartitionCount", "PdStatus", "PhysicalDrive", "ProductName", "ProductRevision", "ReadErrorCount", "ReadErrorThreshold", "WriteEnabled", "WriteErrorCount", "WriteErrorThreshold", "InventoryDeviceInfo", "RegisteredDevice", "StorageFlexUtilController")
