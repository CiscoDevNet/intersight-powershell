...
function ConvertFrom-IntersightJsonToLicenseLicenseReservationOp {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AuthCode", "AuthCodeInstalled", "ConfirmCode", "GenerateRequestCode", "GenerateReturnCode", "RequestCode", "ReturnCode", "Account")
