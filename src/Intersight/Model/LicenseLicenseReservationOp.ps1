...
function ConvertFrom-IntersightJsonToLicenseLicenseReservationOp {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AuthCode", "AuthCodeInstalled", "ConfirmCode", "GenerateRequestCode", "GenerateReturnCode", "RequestCode", "ReturnCode", "Account")
