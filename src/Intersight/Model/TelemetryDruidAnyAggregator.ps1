...
TelemetryDruidAnyAggregator<PSCustomObject>
#>

function Initialize-IntersightTelemetryDruidAnyAggregator {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTelemetryDruidAnyAggregator' | Write-Debug
...
Convert from JSON to TelemetryDruidAnyAggregator<PSCustomObject>
...
TelemetryDruidAnyAggregator<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTelemetryDruidAnyAggregator {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTelemetryDruidAnyAggregator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTelemetryDruidAnyAggregator
