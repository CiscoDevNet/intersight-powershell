...
IaasUcsdManagedInfraList<PSCustomObject>
#>

function Initialize-IntersightIaasUcsdManagedInfraList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIaasUcsdManagedInfraList' | Write-Debug
...
Convert from JSON to IaasUcsdManagedInfraList<PSCustomObject>
...
IaasUcsdManagedInfraList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIaasUcsdManagedInfraList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIaasUcsdManagedInfraList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIaasUcsdManagedInfraList
