...
SyslogLocalClientBase<PSCustomObject>
#>

function Initialize-IntersightSyslogLocalClientBase {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSyslogLocalClientBase' | Write-Debug
...
Convert from JSON to SyslogLocalClientBase<PSCustomObject>
...
SyslogLocalClientBase<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSyslogLocalClientBase {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSyslogLocalClientBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSyslogLocalClientBase
