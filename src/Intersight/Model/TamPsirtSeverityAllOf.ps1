...
TamPsirtSeverityAllOf<PSCustomObject>
#>

function Initialize-IntersightTamPsirtSeverityAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("tam.PsirtSeverity")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTamPsirtSeverityAllOf' | Write-Debug
...
Convert from JSON to TamPsirtSeverityAllOf<PSCustomObject>
...
TamPsirtSeverityAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTamPsirtSeverityAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTamPsirtSeverityAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTamPsirtSeverityAllOf
