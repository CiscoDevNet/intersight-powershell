...
TelemetryDruidCountAggregator<PSCustomObject>
#>

function Initialize-IntersightTelemetryDruidCountAggregator {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTelemetryDruidCountAggregator' | Write-Debug
...
Convert from JSON to TelemetryDruidCountAggregator<PSCustomObject>
...
TelemetryDruidCountAggregator<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTelemetryDruidCountAggregator {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTelemetryDruidCountAggregator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTelemetryDruidCountAggregator
