...
StoragePurePortList<PSCustomObject>
#>

function Initialize-IntersightStoragePurePortList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePurePortList' | Write-Debug
...
Convert from JSON to StoragePurePortList<PSCustomObject>
...
StoragePurePortList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePurePortList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePurePortList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePurePortList
