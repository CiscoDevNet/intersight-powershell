...
SnapshotPoint information from StDataServiceManager.
...
HyperflexSnapshotPoint<PSCustomObject>
#>

function Initialize-IntersightHyperflexSnapshotPoint {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexSnapshotPoint' | Write-Debug
...
Convert from JSON to HyperflexSnapshotPoint<PSCustomObject>
...
HyperflexSnapshotPoint<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexSnapshotPoint {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexSnapshotPoint' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexSnapshotPoint
