...
TelemetryDruidFragmentSearchSpecAllOf<PSCustomObject>
#>

function Initialize-IntersightTelemetryDruidFragmentSearchSpecAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTelemetryDruidFragmentSearchSpecAllOf' | Write-Debug
...
Convert from JSON to TelemetryDruidFragmentSearchSpecAllOf<PSCustomObject>
...
TelemetryDruidFragmentSearchSpecAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTelemetryDruidFragmentSearchSpecAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTelemetryDruidFragmentSearchSpecAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTelemetryDruidFragmentSearchSpecAllOf
        $AllProperties = ("values", "case_sensitive")
