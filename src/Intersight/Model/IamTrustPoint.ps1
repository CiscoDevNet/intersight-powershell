...
IamTrustPoint<PSCustomObject>
#>

function Initialize-IntersightIamTrustPoint {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iam.TrustPoint")]
        [String]
        ${ClassId} = "iam.TrustPoint",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iam.TrustPoint")]
        [String]
        ${ObjectType} = "iam.TrustPoint",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamTrustPoint' | Write-Debug
...
Convert from JSON to IamTrustPoint<PSCustomObject>
...
IamTrustPoint<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamTrustPoint {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamTrustPoint' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamTrustPoint
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Certificates", "Chain", "Account")
