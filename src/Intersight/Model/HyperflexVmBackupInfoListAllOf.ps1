...
HyperflexVmBackupInfoListAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexVmBackupInfoListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexVmBackupInfoListAllOf' | Write-Debug
...
Convert from JSON to HyperflexVmBackupInfoListAllOf<PSCustomObject>
...
HyperflexVmBackupInfoListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexVmBackupInfoListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexVmBackupInfoListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexVmBackupInfoListAllOf
