...
function ConvertFrom-IntersightJsonToAdapterHostIscsiInterfaceAllOf {
    ...
    Process {
        ...
        $AllProperties = ("AdminState", "EpDn", "HostIscsiInterfaceId", "HostVisible", "MacAddress", "Name", "OperState", "Operability", "PeerDn", "AdapterUnit", "InventoryDeviceInfo", "RegisteredDevice")
