...
AdapterHostIscsiInterfaceAllOf<PSCustomObject>
#>

function Initialize-IntersightAdapterHostIscsiInterfaceAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAdapterHostIscsiInterfaceAllOf' | Write-Debug
...
Convert from JSON to AdapterHostIscsiInterfaceAllOf<PSCustomObject>
...
AdapterHostIscsiInterfaceAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAdapterHostIscsiInterfaceAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAdapterHostIscsiInterfaceAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAdapterHostIscsiInterfaceAllOf
        $AllProperties = ("ClassId", "ObjectType", "AdminState", "EpDn", "HostIscsiInterfaceId", "HostVisible", "MacAddress", "Name", "OperState", "Operability", "PeerDn", "AdapterUnit", "InventoryDeviceInfo", "RegisteredDevice")
