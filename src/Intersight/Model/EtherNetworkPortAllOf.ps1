...
EtherNetworkPortAllOf<PSCustomObject>
#>

function Initialize-IntersightEtherNetworkPortAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEtherNetworkPortAllOf' | Write-Debug
...
Convert from JSON to EtherNetworkPortAllOf<PSCustomObject>
...
EtherNetworkPortAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEtherNetworkPortAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEtherNetworkPortAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEtherNetworkPortAllOf
        $AllProperties = ("ClassId", "ObjectType", "ModuleId", "PeerDn", "PortId", "SlotId", "Speed", "SwitchId", "EquipmentIoCardBase", "RegisteredDevice")
