...
ConnectorpackConnectorPackUpgradeList<PSCustomObject>
#>

function Initialize-IntersightConnectorpackConnectorPackUpgradeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConnectorpackConnectorPackUpgradeList' | Write-Debug
...
Convert from JSON to ConnectorpackConnectorPackUpgradeList<PSCustomObject>
...
ConnectorpackConnectorPackUpgradeList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConnectorpackConnectorPackUpgradeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConnectorpackConnectorPackUpgradeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConnectorpackConnectorPackUpgradeList
