...
SoftwareHclMetaAllOf<PSCustomObject>
#>

function Initialize-IntersightSoftwareHclMetaAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwareHclMetaAllOf' | Write-Debug
...
Convert from JSON to SoftwareHclMetaAllOf<PSCustomObject>
...
SoftwareHclMetaAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwareHclMetaAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSoftwareHclMetaAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSoftwareHclMetaAllOf
        $AllProperties = ("ClassId", "ObjectType", "ContentType", "Catalog")
