...
FirmwarePcieDescriptorListAllOf<PSCustomObject>
#>

function Initialize-IntersightFirmwarePcieDescriptorListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwarePcieDescriptorListAllOf' | Write-Debug
...
Convert from JSON to FirmwarePcieDescriptorListAllOf<PSCustomObject>
...
FirmwarePcieDescriptorListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwarePcieDescriptorListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwarePcieDescriptorListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwarePcieDescriptorListAllOf
