...
function ConvertFrom-IntersightJsonToStorageFlexUtilVirtualDrive {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "DriveStatus", "DriveType", "PartitionId", "PartitionName", "ResidentImage", "Size", "VirtualDrive", "InventoryDeviceInfo", "RegisteredDevice", "StorageFlexUtilController")
