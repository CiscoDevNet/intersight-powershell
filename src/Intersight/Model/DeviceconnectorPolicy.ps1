...
DeviceconnectorPolicy<PSCustomObject>
#>

function Initialize-IntersightDeviceconnectorPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("deviceconnector.Policy")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightDeviceconnectorPolicy' | Write-Debug
...
Convert from JSON to DeviceconnectorPolicy<PSCustomObject>
...
DeviceconnectorPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToDeviceconnectorPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightDeviceconnectorPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightDeviceconnectorPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "LockoutEnabled", "Organization", "Profiles")
