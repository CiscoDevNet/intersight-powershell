...
NiatelemetryNiaFeatureUsageAllOf<PSCustomObject>
#>

function Initialize-IntersightNiatelemetryNiaFeatureUsageAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiatelemetryNiaFeatureUsageAllOf' | Write-Debug
...
Convert from JSON to NiatelemetryNiaFeatureUsageAllOf<PSCustomObject>
...
NiatelemetryNiaFeatureUsageAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiatelemetryNiaFeatureUsageAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
