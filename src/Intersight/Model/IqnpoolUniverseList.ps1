...
IqnpoolUniverseList<PSCustomObject>
#>

function Initialize-IntersightIqnpoolUniverseList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIqnpoolUniverseList' | Write-Debug
...
Convert from JSON to IqnpoolUniverseList<PSCustomObject>
...
IqnpoolUniverseList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIqnpoolUniverseList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIqnpoolUniverseList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIqnpoolUniverseList
