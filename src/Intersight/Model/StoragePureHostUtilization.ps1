...
StoragePureHostUtilization<PSCustomObject>
#>

function Initialize-IntersightStoragePureHostUtilization {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePureHostUtilization' | Write-Debug
...
Convert from JSON to StoragePureHostUtilization<PSCustomObject>
...
StoragePureHostUtilization<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePureHostUtilization {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePureHostUtilization' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePureHostUtilization
