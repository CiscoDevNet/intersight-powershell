...
FirmwareDistributableMetaListAllOf<PSCustomObject>
#>

function Initialize-IntersightFirmwareDistributableMetaListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareDistributableMetaListAllOf' | Write-Debug
...
Convert from JSON to FirmwareDistributableMetaListAllOf<PSCustomObject>
...
FirmwareDistributableMetaListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareDistributableMetaListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareDistributableMetaListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareDistributableMetaListAllOf
