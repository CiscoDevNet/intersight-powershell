...
.PARAMETER BootDeviceBootSecurity
No description available.
...
function Initialize-IntersightComputePhysical {
    ...
    Param (
        ...
        ${MgmtIpAddress},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("Unknown", "WillBootError", "MemoryInoperable", "ProcessorInoperable")]
        [String[]]
        ${OperReason},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
...
function ConvertFrom-IntersightJsonToComputePhysical {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "AdminPowerState", "AlarmSummary", "AssetTag", "AvailableMemory", "BiosPostComplete", "FaultSummary", "KvmIpAddresses", "ManagementMode", "MemorySpeed", "MgmtIpAddress", "NumAdaptors", "NumCpuCores", "NumCpuCoresEnabled", "NumCpus", "NumEthHostInterfaces", "NumFcHostInterfaces", "NumThreads", "OperPowerState", "OperReason", "OperState", "Operability", "PlatformType", "Presence", "ServiceProfile", "TotalMemory", "UserLabel", "Uuid", "BootCddDevices", "BootDeviceBootSecurity", "BootHddDevices", "BootIscsiDevices", "BootNvmeDevices", "BootPchStorageDevices", "BootPxeDevices", "BootSanDevices", "BootSdDevices", "BootUefiShellDevices", "BootUsbDevices", "BootVmediaDevices", "MgmtIdentity", "Vmedia")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "BootDeviceBootSecurity"))) { #optional property not found
            $BootDeviceBootSecurity = $null
        } else {
            $BootDeviceBootSecurity = $JsonParameters.PSobject.Properties["BootDeviceBootSecurity"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "Vmedia"))) { #optional property not found
            $Vmedia = $null
        } else {
            $Vmedia = $JsonParameters.PSobject.Properties["Vmedia"].value
        }
