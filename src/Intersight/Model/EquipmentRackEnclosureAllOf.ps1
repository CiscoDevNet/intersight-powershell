...
EquipmentRackEnclosureAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentRackEnclosureAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentRackEnclosureAllOf' | Write-Debug
...
Convert from JSON to EquipmentRackEnclosureAllOf<PSCustomObject>
...
EquipmentRackEnclosureAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentRackEnclosureAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentRackEnclosureAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentRackEnclosureAllOf
        $AllProperties = ("ClassId", "ObjectType", "EnclosureId", "Fanmodules", "InventoryDeviceInfo", "Psus", "RegisteredDevice", "Slots")
