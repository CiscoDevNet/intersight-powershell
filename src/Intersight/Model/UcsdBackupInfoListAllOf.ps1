...
UcsdBackupInfoListAllOf<PSCustomObject>
#>

function Initialize-IntersightUcsdBackupInfoListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightUcsdBackupInfoListAllOf' | Write-Debug
...
Convert from JSON to UcsdBackupInfoListAllOf<PSCustomObject>
...
UcsdBackupInfoListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToUcsdBackupInfoListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightUcsdBackupInfoListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightUcsdBackupInfoListAllOf
