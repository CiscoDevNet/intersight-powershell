...
IamPrivilegeSetList<PSCustomObject>
#>

function Initialize-IntersightIamPrivilegeSetList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamPrivilegeSetList' | Write-Debug
...
Convert from JSON to IamPrivilegeSetList<PSCustomObject>
...
IamPrivilegeSetList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamPrivilegeSetList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamPrivilegeSetList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamPrivilegeSetList
