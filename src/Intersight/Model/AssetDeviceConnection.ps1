...
AssetDeviceConnection<PSCustomObject>
#>

function Initialize-IntersightAssetDeviceConnection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAssetDeviceConnection' | Write-Debug
...
Convert from JSON to AssetDeviceConnection<PSCustomObject>
...
AssetDeviceConnection<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAssetDeviceConnection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
