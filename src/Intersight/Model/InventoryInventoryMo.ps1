...
InventoryInventoryMo<PSCustomObject>
#>

function Initialize-IntersightInventoryInventoryMo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightInventoryInventoryMo' | Write-Debug
...
Convert from JSON to InventoryInventoryMo<PSCustomObject>
...
InventoryInventoryMo<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToInventoryInventoryMo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightInventoryInventoryMo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightInventoryInventoryMo
