...
SyslogLocalFileLoggingClient<PSCustomObject>
#>

function Initialize-IntersightSyslogLocalFileLoggingClient {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("syslog.LocalFileLoggingClient")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSyslogLocalFileLoggingClient' | Write-Debug
...
Convert from JSON to SyslogLocalFileLoggingClient<PSCustomObject>
...
SyslogLocalFileLoggingClient<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSyslogLocalFileLoggingClient {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSyslogLocalFileLoggingClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSyslogLocalFileLoggingClient
        $AllProperties = ("ClassId", "ObjectType", "MinSeverity")
