...
IamUserGroup<PSCustomObject>
#>

function Initialize-IntersightIamUserGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamUserGroup' | Write-Debug
...
Convert from JSON to IamUserGroup<PSCustomObject>
...
IamUserGroup<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamUserGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamUserGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamUserGroup
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Idp", "Idpreference", "Permissions", "Qualifier", "Users")
