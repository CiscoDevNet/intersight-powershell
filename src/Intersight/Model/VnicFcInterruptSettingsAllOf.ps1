...
VnicFcInterruptSettingsAllOf<PSCustomObject>
#>

function Initialize-IntersightVnicFcInterruptSettingsAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("vnic.FcInterruptSettings")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVnicFcInterruptSettingsAllOf' | Write-Debug
...
Convert from JSON to VnicFcInterruptSettingsAllOf<PSCustomObject>
...
VnicFcInterruptSettingsAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVnicFcInterruptSettingsAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVnicFcInterruptSettingsAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVnicFcInterruptSettingsAllOf
        $AllProperties = ("ClassId", "ObjectType", "Mode")
