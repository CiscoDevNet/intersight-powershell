...
Specify ESXi virtual machine configuration data.
...
VirtualizationEsxiVmConfiguration<PSCustomObject>
#>

function Initialize-IntersightVirtualizationEsxiVmConfiguration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationEsxiVmConfiguration' | Write-Debug
...
Convert from JSON to VirtualizationEsxiVmConfiguration<PSCustomObject>
...
VirtualizationEsxiVmConfiguration<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationEsxiVmConfiguration {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationEsxiVmConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationEsxiVmConfiguration
