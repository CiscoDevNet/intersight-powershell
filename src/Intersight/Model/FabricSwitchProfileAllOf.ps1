...
FabricSwitchProfileAllOf<PSCustomObject>
#>

function Initialize-IntersightFabricSwitchProfileAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricSwitchProfileAllOf' | Write-Debug
...
Convert from JSON to FabricSwitchProfileAllOf<PSCustomObject>
...
FabricSwitchProfileAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricSwitchProfileAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricSwitchProfileAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricSwitchProfileAllOf
        $AllProperties = ("ClassId", "ObjectType", "ConfigChanges", "AssignedSwitch", "AssociatedSwitch", "ConfigChangeDetails", "ConfigResult", "RunningWorkflows", "SwitchClusterProfile")
