...
LicenseIwoCustomerOpList<PSCustomObject>
#>

function Initialize-IntersightLicenseIwoCustomerOpList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightLicenseIwoCustomerOpList' | Write-Debug
...
Convert from JSON to LicenseIwoCustomerOpList<PSCustomObject>
...
LicenseIwoCustomerOpList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToLicenseIwoCustomerOpList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightLicenseIwoCustomerOpList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightLicenseIwoCustomerOpList
