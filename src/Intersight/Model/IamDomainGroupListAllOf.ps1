...
IamDomainGroupListAllOf<PSCustomObject>
#>

function Initialize-IntersightIamDomainGroupListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamDomainGroupListAllOf' | Write-Debug
...
Convert from JSON to IamDomainGroupListAllOf<PSCustomObject>
...
IamDomainGroupListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamDomainGroupListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamDomainGroupListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamDomainGroupListAllOf
