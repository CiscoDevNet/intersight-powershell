...
CapabilityEndpointDescriptor<PSCustomObject>
#>

function Initialize-IntersightCapabilityEndpointDescriptor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilityEndpointDescriptor' | Write-Debug
...
Convert from JSON to CapabilityEndpointDescriptor<PSCustomObject>
...
CapabilityEndpointDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilityEndpointDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilityEndpointDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilityEndpointDescriptor
