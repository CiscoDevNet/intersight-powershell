...
function ConvertFrom-IntersightJsonToWorkflowSubWorkflowTask {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Description", "Label", "Name", "InputParameters", "OnFailure", "OnSuccess", "CatalogMoid", "Version", "WorkflowDefinitionId", "WorkflowDefinitionName")
