...
function ConvertFrom-IntersightJsonToWorkflowSubWorkflowTask {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Description", "Label", "Name", "InputParameters", "OnFailure", "OnSuccess", "RollbackDisabled", "CatalogMoid", "Version", "WorkflowDefinitionId", "WorkflowDefinitionName")
