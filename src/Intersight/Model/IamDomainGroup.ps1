...
function ConvertFrom-IntersightJsonToIamDomainGroup {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Partition1", "Partition2", "Partition3", "PartitionKey", "Usage", "Account")
