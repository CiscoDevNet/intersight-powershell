...
IamDomainGroup<PSCustomObject>
#>

function Initialize-IntersightIamDomainGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamDomainGroup' | Write-Debug
...
Convert from JSON to IamDomainGroup<PSCustomObject>
...
IamDomainGroup<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamDomainGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamDomainGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamDomainGroup
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Partition1", "Partition2", "Partition3", "PartitionKey", "Usage", "Account")
