...
function ConvertFrom-IntersightJsonToIamDomainGroup {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Partition1", "Partition2", "Partition3", "PartitionKey", "Usage", "Account")
