...
ForecastModel<PSCustomObject>
#>

function Initialize-IntersightForecastModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightForecastModel' | Write-Debug
...
Convert from JSON to ForecastModel<PSCustomObject>
...
ForecastModel<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToForecastModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightForecastModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightForecastModel
