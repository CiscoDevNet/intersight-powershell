...
CommHttpProxyPolicyList<PSCustomObject>
#>

function Initialize-IntersightCommHttpProxyPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCommHttpProxyPolicyList' | Write-Debug
...
Convert from JSON to CommHttpProxyPolicyList<PSCustomObject>
...
CommHttpProxyPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCommHttpProxyPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCommHttpProxyPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCommHttpProxyPolicyList
