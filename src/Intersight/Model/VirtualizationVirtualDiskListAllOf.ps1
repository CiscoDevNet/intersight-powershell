...
VirtualizationVirtualDiskListAllOf<PSCustomObject>
#>

function Initialize-IntersightVirtualizationVirtualDiskListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationVirtualDiskListAllOf' | Write-Debug
...
Convert from JSON to VirtualizationVirtualDiskListAllOf<PSCustomObject>
...
VirtualizationVirtualDiskListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationVirtualDiskListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationVirtualDiskListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationVirtualDiskListAllOf
