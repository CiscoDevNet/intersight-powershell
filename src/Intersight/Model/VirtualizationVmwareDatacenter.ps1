...
.PARAMETER HypervisorManager
No description available.
.OUTPUTS

VirtualizationVmwareDatacenter<PSCustomObject>
#>

function Initialize-IntersightVirtualizationVmwareDatacenter {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("virtualization.VmwareDatacenter")]
        [String]
        ${ClassId} = "virtualization.VmwareDatacenter",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("virtualization.VmwareDatacenter")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationVmwareDatacenter' | Write-Debug
...
Convert from JSON to VirtualizationVmwareDatacenter<PSCustomObject>
...
VirtualizationVmwareDatacenter<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationVmwareDatacenter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationVmwareDatacenter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationVmwareDatacenter
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "RegisteredDevice", "Identity", "Name", "ClusterCount", "DatastoreCount", "HostCount", "NetworkCount", "VmCount", "HypervisorManager")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "HypervisorManager"))) { #optional property not found
            $HypervisorManager = $null
        } else {
            $HypervisorManager = $JsonParameters.PSobject.Properties["HypervisorManager"].value
        }
