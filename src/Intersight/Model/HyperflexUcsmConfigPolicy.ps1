...
HyperflexUcsmConfigPolicy<PSCustomObject>
#>

function Initialize-IntersightHyperflexUcsmConfigPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexUcsmConfigPolicy' | Write-Debug
...
Convert from JSON to HyperflexUcsmConfigPolicy<PSCustomObject>
...
HyperflexUcsmConfigPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexUcsmConfigPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexUcsmConfigPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexUcsmConfigPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "KvmIpRange", "MacPrefixRange", "ServerFirmwareVersion", "ClusterProfiles", "Organization")
