...
function ConvertFrom-IntersightJsonToHyperflexUcsmConfigPolicy {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "KvmIpRange", "MacPrefixRange", "ServerFirmwareVersion", "ClusterProfiles", "Organization")
