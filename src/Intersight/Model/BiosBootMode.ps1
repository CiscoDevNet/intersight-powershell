...
function ConvertFrom-IntersightJsonToBiosBootMode {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "ActualBootMode", "ComputeBlade", "ComputeRackUnit", "InventoryDeviceInfo", "RegisteredDevice")
