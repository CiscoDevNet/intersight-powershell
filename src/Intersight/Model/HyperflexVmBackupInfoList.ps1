...
HyperflexVmBackupInfoList<PSCustomObject>
#>

function Initialize-IntersightHyperflexVmBackupInfoList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexVmBackupInfoList' | Write-Debug
...
Convert from JSON to HyperflexVmBackupInfoList<PSCustomObject>
...
HyperflexVmBackupInfoList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexVmBackupInfoList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexVmBackupInfoList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexVmBackupInfoList
