...
EquipmentIdentitySummaryListAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentIdentitySummaryListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentIdentitySummaryListAllOf' | Write-Debug
...
Convert from JSON to EquipmentIdentitySummaryListAllOf<PSCustomObject>
...
EquipmentIdentitySummaryListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentIdentitySummaryListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentIdentitySummaryListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentIdentitySummaryListAllOf
