...
function ConvertFrom-IntersightJsonToIamApiKey {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "HashAlgorithm", "KeySpec", "PrivateKey", "Purpose", "SigningAlgorithm", "Permission", "User")
