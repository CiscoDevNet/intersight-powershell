...
IaasLicenseKeysInfo<PSCustomObject>
#>

function Initialize-IntersightIaasLicenseKeysInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIaasLicenseKeysInfo' | Write-Debug
...
Convert from JSON to IaasLicenseKeysInfo<PSCustomObject>
...
IaasLicenseKeysInfo<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIaasLicenseKeysInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIaasLicenseKeysInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIaasLicenseKeysInfo
