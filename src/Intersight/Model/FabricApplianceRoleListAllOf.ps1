...
FabricApplianceRoleListAllOf<PSCustomObject>
#>

function Initialize-IntersightFabricApplianceRoleListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricApplianceRoleListAllOf' | Write-Debug
...
Convert from JSON to FabricApplianceRoleListAllOf<PSCustomObject>
...
FabricApplianceRoleListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricApplianceRoleListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricApplianceRoleListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricApplianceRoleListAllOf
