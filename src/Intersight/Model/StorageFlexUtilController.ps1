...
function ConvertFrom-IntersightJsonToStorageFlexUtilController {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "ControllerName", "ControllerStatus", "FfControllerId", "InternalState", "ComputeBoard", "FlexUtilPhysicalDrives", "FlexUtilVirtualDrives", "InventoryDeviceInfo", "RegisteredDevice")
