...
function ConvertFrom-IntersightJsonToStorageFlexUtilController {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "ControllerName", "ControllerStatus", "FfControllerId", "InternalState", "ComputeBoard", "FlexUtilPhysicalDrives", "FlexUtilVirtualDrives", "InventoryDeviceInfo", "RegisteredDevice")
