...
StorageFlexUtilController<PSCustomObject>
#>

function Initialize-IntersightStorageFlexUtilController {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.FlexUtilController")]
        [String]
        ${ClassId} = "storage.FlexUtilController",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.FlexUtilController")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageFlexUtilController' | Write-Debug
...
Convert from JSON to StorageFlexUtilController<PSCustomObject>
...
StorageFlexUtilController<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageFlexUtilController {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageFlexUtilController' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageFlexUtilController
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "ControllerName", "ControllerStatus", "FfControllerId", "InternalState", "ComputeBoard", "FlexUtilPhysicalDrives", "FlexUtilVirtualDrives", "InventoryDeviceInfo", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "FlexUtilPhysicalDrives"))) { #optional property not found
            $FlexUtilPhysicalDrives = $null
        } else {
            $FlexUtilPhysicalDrives = $JsonParameters.PSobject.Properties["FlexUtilPhysicalDrives"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "FlexUtilVirtualDrives"))) { #optional property not found
            $FlexUtilVirtualDrives = $null
        } else {
            $FlexUtilVirtualDrives = $JsonParameters.PSobject.Properties["FlexUtilVirtualDrives"].value
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "InternalState" = ${InternalState}
            "ComputeBoard" = ${ComputeBoard}
            "FlexUtilPhysicalDrives" = ${FlexUtilPhysicalDrives}
            "FlexUtilVirtualDrives" = ${FlexUtilVirtualDrives}
            "InventoryDeviceInfo" = ${InventoryDeviceInfo}
            "RegisteredDevice" = ${RegisteredDevice}
        }
