...
RecoveryConfigResultList<PSCustomObject>
#>

function Initialize-IntersightRecoveryConfigResultList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightRecoveryConfigResultList' | Write-Debug
...
Convert from JSON to RecoveryConfigResultList<PSCustomObject>
...
RecoveryConfigResultList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToRecoveryConfigResultList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightRecoveryConfigResultList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightRecoveryConfigResultList
