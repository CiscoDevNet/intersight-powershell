...
function ConvertFrom-IntersightJsonToWorkflowWorkerTask {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Description", "Label", "Name", "InputParameters", "OnFailure", "OnSuccess", "RollbackDisabled", "CatalogMoid", "TaskDefinitionId", "TaskDefinitionName", "Version")
