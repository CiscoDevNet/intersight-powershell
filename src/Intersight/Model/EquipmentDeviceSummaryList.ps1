...
EquipmentDeviceSummaryList<PSCustomObject>
#>

function Initialize-IntersightEquipmentDeviceSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentDeviceSummaryList' | Write-Debug
...
Convert from JSON to EquipmentDeviceSummaryList<PSCustomObject>
...
EquipmentDeviceSummaryList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentDeviceSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentDeviceSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentDeviceSummaryList
