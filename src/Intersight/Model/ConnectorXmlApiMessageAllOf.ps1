...
ConnectorXmlApiMessageAllOf<PSCustomObject>
#>

function Initialize-IntersightConnectorXmlApiMessageAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConnectorXmlApiMessageAllOf' | Write-Debug
...
Convert from JSON to ConnectorXmlApiMessageAllOf<PSCustomObject>
...
ConnectorXmlApiMessageAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConnectorXmlApiMessageAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConnectorXmlApiMessageAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConnectorXmlApiMessageAllOf
        $AllProperties = ("ClassId", "ObjectType", "WithAuth", "XmlRequest")
