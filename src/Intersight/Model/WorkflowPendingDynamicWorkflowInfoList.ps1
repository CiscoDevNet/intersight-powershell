...
WorkflowPendingDynamicWorkflowInfoList<PSCustomObject>
#>

function Initialize-IntersightWorkflowPendingDynamicWorkflowInfoList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowPendingDynamicWorkflowInfoList' | Write-Debug
...
Convert from JSON to WorkflowPendingDynamicWorkflowInfoList<PSCustomObject>
...
WorkflowPendingDynamicWorkflowInfoList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowPendingDynamicWorkflowInfoList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowPendingDynamicWorkflowInfoList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowPendingDynamicWorkflowInfoList
