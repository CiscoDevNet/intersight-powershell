...
TechsupportmanagementCollectionControlPolicyList<PSCustomObject>
#>

function Initialize-IntersightTechsupportmanagementCollectionControlPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTechsupportmanagementCollectionControlPolicyList' | Write-Debug
...
Convert from JSON to TechsupportmanagementCollectionControlPolicyList<PSCustomObject>
...
TechsupportmanagementCollectionControlPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTechsupportmanagementCollectionControlPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTechsupportmanagementCollectionControlPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTechsupportmanagementCollectionControlPolicyList
