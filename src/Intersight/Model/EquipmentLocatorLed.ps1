...
EquipmentLocatorLed<PSCustomObject>
#>

function Initialize-IntersightEquipmentLocatorLed {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentLocatorLed' | Write-Debug
...
Convert from JSON to EquipmentLocatorLed<PSCustomObject>
...
EquipmentLocatorLed<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentLocatorLed {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentLocatorLed' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentLocatorLed
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Color", "OperState", "ComputeBlade", "ComputeRackUnit", "EquipmentChassis", "EquipmentFex", "InventoryDeviceInfo", "RegisteredDevice", "StoragePhysicalDisk")
