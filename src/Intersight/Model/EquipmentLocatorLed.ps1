...
function ConvertFrom-IntersightJsonToEquipmentLocatorLed {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Color", "OperState", "ComputeBlade", "ComputeRackUnit", "EquipmentChassis", "EquipmentFex", "InventoryDeviceInfo", "RegisteredDevice", "StoragePhysicalDisk")
