...
function ConvertFrom-IntersightJsonToEquipmentLocatorLed {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Color", "OperState", "ComputeBlade", "ComputeRackUnit", "EquipmentChassis", "EquipmentFex", "InventoryDeviceInfo", "RegisteredDevice", "StoragePhysicalDisk")
