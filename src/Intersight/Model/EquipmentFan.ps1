...
function ConvertFrom-IntersightJsonToEquipmentFan {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Description", "FanId", "FanModuleId", "ModuleId", "OperState", "PartNumber", "Pid", "Presence", "Sku", "TrayId", "Vid", "EquipmentFanModule", "EquipmentFex", "InventoryDeviceInfo", "RegisteredDevice")
