...
EquipmentFan<PSCustomObject>
#>

function Initialize-IntersightEquipmentFan {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.Fan")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentFan' | Write-Debug
...
Convert from JSON to EquipmentFan<PSCustomObject>
...
EquipmentFan<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentFan {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentFan' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentFan
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Description", "FanId", "FanModuleId", "ModuleId", "OperReason", "OperState", "PartNumber", "Pid", "Presence", "Sku", "TrayId", "Vid", "EquipmentFanModule", "EquipmentFex", "InventoryDeviceInfo", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "FanModuleId"))) { #optional property not found
            $FanModuleId = $null
        } else {
            $FanModuleId = $JsonParameters.PSobject.Properties["FanModuleId"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "EquipmentFanModule"))) { #optional property not found
            $EquipmentFanModule = $null
        } else {
            $EquipmentFanModule = $JsonParameters.PSobject.Properties["EquipmentFanModule"].value
        }
