...
WorkflowLoopTaskAllOf<PSCustomObject>
#>

function Initialize-IntersightWorkflowLoopTaskAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowLoopTaskAllOf' | Write-Debug
...
Convert from JSON to WorkflowLoopTaskAllOf<PSCustomObject>
...
WorkflowLoopTaskAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowLoopTaskAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowLoopTaskAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowLoopTaskAllOf
        $AllProperties = ("ClassId", "ObjectType", "Count", "LoopStartTask", "NumberOfBatches", "OnSuccess", "Parallel")
