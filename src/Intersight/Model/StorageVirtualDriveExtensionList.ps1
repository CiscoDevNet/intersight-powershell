...
StorageVirtualDriveExtensionList<PSCustomObject>
#>

function Initialize-IntersightStorageVirtualDriveExtensionList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageVirtualDriveExtensionList' | Write-Debug
...
Convert from JSON to StorageVirtualDriveExtensionList<PSCustomObject>
...
StorageVirtualDriveExtensionList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageVirtualDriveExtensionList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageVirtualDriveExtensionList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageVirtualDriveExtensionList
