...
AssetClusterMemberList<PSCustomObject>
#>

function Initialize-IntersightAssetClusterMemberList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAssetClusterMemberList' | Write-Debug
...
Convert from JSON to AssetClusterMemberList<PSCustomObject>
...
AssetClusterMemberList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAssetClusterMemberList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAssetClusterMemberList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAssetClusterMemberList
