...
FirmwareNxosDescriptorListAllOf<PSCustomObject>
#>

function Initialize-IntersightFirmwareNxosDescriptorListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareNxosDescriptorListAllOf' | Write-Debug
...
Convert from JSON to FirmwareNxosDescriptorListAllOf<PSCustomObject>
...
FirmwareNxosDescriptorListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareNxosDescriptorListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareNxosDescriptorListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareNxosDescriptorListAllOf
