...
ApplianceRestoreList<PSCustomObject>
#>

function Initialize-IntersightApplianceRestoreList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightApplianceRestoreList' | Write-Debug
...
Convert from JSON to ApplianceRestoreList<PSCustomObject>
...
ApplianceRestoreList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToApplianceRestoreList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightApplianceRestoreList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightApplianceRestoreList
