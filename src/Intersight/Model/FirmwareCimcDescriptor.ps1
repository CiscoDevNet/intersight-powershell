...
FirmwareCimcDescriptor<PSCustomObject>
#>

function Initialize-IntersightFirmwareCimcDescriptor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareCimcDescriptor' | Write-Debug
...
Convert from JSON to FirmwareCimcDescriptor<PSCustomObject>
...
FirmwareCimcDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareCimcDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareCimcDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareCimcDescriptor
