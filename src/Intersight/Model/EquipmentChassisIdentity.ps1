...
function ConvertFrom-IntersightJsonToEquipmentChassisIdentity {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AdminAction", "AdminActionState", "Identifier", "Lifecycle", "Model", "Serial", "Vendor", "DeviceRegistration", "IoCardIdentityList", "Chassis")
