...
StorageFlexUtilControllerListAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageFlexUtilControllerListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageFlexUtilControllerListAllOf' | Write-Debug
...
Convert from JSON to StorageFlexUtilControllerListAllOf<PSCustomObject>
...
StorageFlexUtilControllerListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageFlexUtilControllerListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageFlexUtilControllerListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageFlexUtilControllerListAllOf
