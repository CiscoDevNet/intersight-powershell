...
WorkflowWorkflowInfo<PSCustomObject>
#>

function Initialize-IntersightWorkflowWorkflowInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowWorkflowInfo' | Write-Debug
        ...
        $PSO = [PSCustomObject]@{
            ...
            "_1_SwitchProfile" = ${Var1SwitchProfile}
            "Account" = ${Account}
...
Convert from JSON to WorkflowWorkflowInfo<PSCustomObject>
...
WorkflowWorkflowInfo<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowWorkflowInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowWorkflowInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowWorkflowInfo
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Action", "CleanupTime", "EndTime", "FailedWorkflowCleanupDuration", "Input", "InstId", "Internal", "LastAction", "Message", "MetaVersion", "Name", "Output", "PauseReason", "Progress", "Properties", "RetryFromTaskName", "Src", "StartTime", "Status", "SuccessWorkflowCleanupDuration", "TraceId", "Type", "UserId", "WaitReason", "WorkflowCtx", "WorkflowMetaType", "WorkflowTaskCount", "_0_ClusterProfile", "_1_SwitchProfile", "Account", "AssociatedObject", "Organization", "ParentTaskInfo", "PendingDynamicWorkflowInfo", "Permission", "TaskInfos", "WorkflowDefinition")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "_1_SwitchProfile"))) { #optional property not found
            $Var1SwitchProfile = $null
        } else {
            $Var1SwitchProfile = $JsonParameters.PSobject.Properties["_1_SwitchProfile"].value
        }
