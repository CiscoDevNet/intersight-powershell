...
function ConvertFrom-IntersightJsonToWorkflowWorkflowInfo {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Action", "CleanupTime", "Email", "EndTime", "FailedWorkflowCleanupDuration", "Input", "InstId", "Internal", "LastAction", "Message", "MetaVersion", "Name", "Output", "PauseReason", "Progress", "Properties", "RetryFromTaskName", "Src", "StartTime", "Status", "SuccessWorkflowCleanupDuration", "TraceId", "Type", "UserActionRequired", "UserId", "WaitReason", "WorkflowCtx", "WorkflowMetaType", "WorkflowTaskCount", "_0_RollbackWorkflow", "_1_SwitchProfile", "_2_ClusterProfile", "Account", "AssociatedObject", "Organization", "ParentTaskInfo", "PendingDynamicWorkflowInfo", "Permission", "TaskInfos", "WorkflowDefinition")
