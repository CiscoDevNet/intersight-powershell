...
KubernetesSysConfigPolicy<PSCustomObject>
#>

function Initialize-IntersightKubernetesSysConfigPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("kubernetes.SysConfigPolicy")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesSysConfigPolicy' | Write-Debug
...
Convert from JSON to KubernetesSysConfigPolicy<PSCustomObject>
...
KubernetesSysConfigPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesSysConfigPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesSysConfigPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesSysConfigPolicy
