...
EquipmentDeviceSummaryListAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentDeviceSummaryListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentDeviceSummaryListAllOf' | Write-Debug
...
Convert from JSON to EquipmentDeviceSummaryListAllOf<PSCustomObject>
...
EquipmentDeviceSummaryListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentDeviceSummaryListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentDeviceSummaryListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentDeviceSummaryListAllOf
