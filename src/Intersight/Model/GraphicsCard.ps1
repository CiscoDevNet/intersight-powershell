...
function ConvertFrom-IntersightJsonToGraphicsCard {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "CardId", "DeviceId", "ExpanderSlot", "FirmwareVersion", "Mode", "NumGpus", "OperState", "PciAddress", "PciAddressList", "PciSlot", "ComputeBlade", "ComputeBoard", "ComputeRackUnit", "GraphicsControllers", "InventoryDeviceInfo", "RegisteredDevice", "RunningFirmware")
