...
HyperflexClusterStoragePolicyList<PSCustomObject>
#>

function Initialize-IntersightHyperflexClusterStoragePolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexClusterStoragePolicyList' | Write-Debug
...
Convert from JSON to HyperflexClusterStoragePolicyList<PSCustomObject>
...
HyperflexClusterStoragePolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexClusterStoragePolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexClusterStoragePolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexClusterStoragePolicyList
