...
TelemetryDruidAndFilter<PSCustomObject>
#>

function Initialize-IntersightTelemetryDruidAndFilter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTelemetryDruidAndFilter' | Write-Debug
...
Convert from JSON to TelemetryDruidAndFilter<PSCustomObject>
...
TelemetryDruidAndFilter<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTelemetryDruidAndFilter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTelemetryDruidAndFilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTelemetryDruidAndFilter
        $AllProperties = ("type", "extractionFn", "fields")
