...
StorageBaseArrayController<PSCustomObject>
#>

function Initialize-IntersightStorageBaseArrayController {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiController", "storage.NetAppNode", "storage.PureController")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiController", "storage.NetAppNode", "storage.PureController")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageBaseArrayController' | Write-Debug
...
Convert from JSON to StorageBaseArrayController<PSCustomObject>
...
StorageBaseArrayController<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageBaseArrayController {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageBaseArrayController' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageBaseArrayController
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Name", "OperationalMode", "Status", "Version")
