...
KvmVmConsoleList<PSCustomObject>
#>

function Initialize-IntersightKvmVmConsoleList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKvmVmConsoleList' | Write-Debug
...
Convert from JSON to KvmVmConsoleList<PSCustomObject>
...
KvmVmConsoleList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKvmVmConsoleList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKvmVmConsoleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKvmVmConsoleList
