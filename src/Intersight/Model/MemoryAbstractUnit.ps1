...
MemoryAbstractUnit<PSCustomObject>
#>

function Initialize-IntersightMemoryAbstractUnit {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMemoryAbstractUnit' | Write-Debug
...
Convert from JSON to MemoryAbstractUnit<PSCustomObject>
...
MemoryAbstractUnit<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMemoryAbstractUnit {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
