...
SoftwareSolutionDistributable<PSCustomObject>
#>

function Initialize-IntersightSoftwareSolutionDistributable {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwareSolutionDistributable' | Write-Debug
...
Convert from JSON to SoftwareSolutionDistributable<PSCustomObject>
...
SoftwareSolutionDistributable<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwareSolutionDistributable {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSoftwareSolutionDistributable' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSoftwareSolutionDistributable
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "DownloadCount", "ImportAction", "ImportState", "ImportedTime", "LastAccessTime", "Md5eTag", "Md5sum", "Name", "ReleaseDate", "Sha512sum", "Size", "SoftwareAdvisoryUrl", "Source", "Version", "BundleType", "ComponentMeta", "Guid", "Mdfid", "Model", "PlatformType", "RecommendedBuild", "ReleaseNotesUrl", "SoftwareTypeId", "SupportedModels", "Vendor", "DistributableMetas", "Release", "FilePath", "SolutionName", "SubType", "_0_Version", "_1_Version", "_2_Version", "_3_Version", "Catalog")
