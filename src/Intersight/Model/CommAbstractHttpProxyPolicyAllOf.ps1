...
Definition of the list of properties defined in 'comm.AbstractHttpProxyPolicy', excluding properties defined in parent classes.
...
CommAbstractHttpProxyPolicyAllOf<PSCustomObject>
#>

function Initialize-IntersightCommAbstractHttpProxyPolicyAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCommAbstractHttpProxyPolicyAllOf' | Write-Debug
...
Convert from JSON to CommAbstractHttpProxyPolicyAllOf<PSCustomObject>
...
CommAbstractHttpProxyPolicyAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCommAbstractHttpProxyPolicyAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCommAbstractHttpProxyPolicyAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCommAbstractHttpProxyPolicyAllOf
        $AllProperties = ("ClassId", "ObjectType", "Hostname", "IsPasswordSet", "Password", "Port", "Username", "Organization")
