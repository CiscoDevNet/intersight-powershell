...
HyperflexHealthCheckPackageChecksumList<PSCustomObject>
#>

function Initialize-IntersightHyperflexHealthCheckPackageChecksumList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexHealthCheckPackageChecksumList' | Write-Debug
...
Convert from JSON to HyperflexHealthCheckPackageChecksumList<PSCustomObject>
...
HyperflexHealthCheckPackageChecksumList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexHealthCheckPackageChecksumList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexHealthCheckPackageChecksumList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexHealthCheckPackageChecksumList
