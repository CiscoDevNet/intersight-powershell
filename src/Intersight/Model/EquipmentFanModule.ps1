...
function ConvertFrom-IntersightJsonToEquipmentFanModule {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Description", "ModuleId", "OperState", "PartNumber", "Pid", "Presence", "Sku", "TrayId", "Vid", "ComputeRackUnit", "EquipmentChassis", "EquipmentRackEnclosure", "Fans", "InventoryDeviceInfo", "NetworkElement", "RegisteredDevice")
