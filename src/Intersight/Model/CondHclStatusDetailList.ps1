...
CondHclStatusDetailList<PSCustomObject>
#>

function Initialize-IntersightCondHclStatusDetailList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCondHclStatusDetailList' | Write-Debug
...
Convert from JSON to CondHclStatusDetailList<PSCustomObject>
...
CondHclStatusDetailList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCondHclStatusDetailList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCondHclStatusDetailList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCondHclStatusDetailList
