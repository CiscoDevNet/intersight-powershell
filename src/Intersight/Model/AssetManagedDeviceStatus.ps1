...
AssetManagedDeviceStatus<PSCustomObject>
#>

function Initialize-IntersightAssetManagedDeviceStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAssetManagedDeviceStatus' | Write-Debug
...
Convert from JSON to AssetManagedDeviceStatus<PSCustomObject>
...
AssetManagedDeviceStatus<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAssetManagedDeviceStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAssetManagedDeviceStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAssetManagedDeviceStatus
        $AllProperties = ("ClassId", "ObjectType", "CloudPort", "ConnectionFailureReason", "ConnectionStatus", "ErrorCode", "ErrorReason", "ProcessId", "ServerPort", "State")
