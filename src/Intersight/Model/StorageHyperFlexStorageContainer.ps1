...
StorageHyperFlexStorageContainer<PSCustomObject>
#>

function Initialize-IntersightStorageHyperFlexStorageContainer {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HyperFlexStorageContainer")]
        [String]
        ${ClassId} = "storage.HyperFlexStorageContainer",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HyperFlexStorageContainer")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageHyperFlexStorageContainer' | Write-Debug
...
Convert from JSON to StorageHyperFlexStorageContainer<PSCustomObject>
...
StorageHyperFlexStorageContainer<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageHyperFlexStorageContainer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageHyperFlexStorageContainer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageHyperFlexStorageContainer
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "CreatedTime", "Name", "StorageUtilization", "LastAccessTime", "LastModifiedTime", "ProvisionedCapacity", "Type", "UnCompressedUsedBytes", "Uuid", "Cluster", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "UnCompressedUsedBytes"))) { #optional property not found
            $UnCompressedUsedBytes = $null
        } else {
            $UnCompressedUsedBytes = $JsonParameters.PSobject.Properties["UnCompressedUsedBytes"].value
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "Type" = ${Type}
            "UnCompressedUsedBytes" = ${UnCompressedUsedBytes}
            "Uuid" = ${Uuid}
            "Cluster" = ${Cluster}
            "RegisteredDevice" = ${RegisteredDevice}
        }
