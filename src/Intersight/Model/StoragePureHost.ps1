...
function ConvertFrom-IntersightJsonToStoragePureHost {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Initiators", "Name", "OsType", "StorageUtilization", "HostGroupName", "Array", "HostGroup", "ProtectionGroup", "RegisteredDevice")
