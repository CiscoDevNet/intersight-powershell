...
StoragePureHost<PSCustomObject>
#>

function Initialize-IntersightStoragePureHost {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PureHost")]
        [String]
        ${ClassId} = "storage.PureHost",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PureHost")]
        [String]
        ${ObjectType} = "storage.PureHost",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePureHost' | Write-Debug
...
Convert from JSON to StoragePureHost<PSCustomObject>
...
StoragePureHost<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePureHost {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
