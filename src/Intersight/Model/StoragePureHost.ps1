...
function ConvertFrom-IntersightJsonToStoragePureHost {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Initiators", "Name", "OsType", "StorageUtilization", "HostGroupName", "Array", "HostGroup", "ProtectionGroup", "RegisteredDevice")
