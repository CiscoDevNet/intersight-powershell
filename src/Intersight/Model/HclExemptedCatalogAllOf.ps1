...
HclExemptedCatalogAllOf<PSCustomObject>
#>

function Initialize-IntersightHclExemptedCatalogAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHclExemptedCatalogAllOf' | Write-Debug
...
Convert from JSON to HclExemptedCatalogAllOf<PSCustomObject>
...
HclExemptedCatalogAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHclExemptedCatalogAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHclExemptedCatalogAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHclExemptedCatalogAllOf
        $AllProperties = ("ClassId", "ObjectType", "Comments", "Name", "OsVendor", "OsVersion", "ProcessorName", "ProductModels", "ProductType", "ServerPid", "UcsVersion", "VersionType")
