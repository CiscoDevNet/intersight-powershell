...
ConnectorFetchStreamMessage<PSCustomObject>
#>

function Initialize-IntersightConnectorFetchStreamMessage {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("connector.FetchStreamMessage")]
        [String]
        ${ClassId} = "connector.FetchStreamMessage",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("connector.FetchStreamMessage")]
        [String]
        ${ObjectType} = "connector.FetchStreamMessage",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${EncryptedAesKey},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConnectorFetchStreamMessage' | Write-Debug
...
Convert from JSON to ConnectorFetchStreamMessage<PSCustomObject>
...
ConnectorFetchStreamMessage<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConnectorFetchStreamMessage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConnectorFetchStreamMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConnectorFetchStreamMessage
        $AllProperties = ("ClassId", "ObjectType", "EncryptedAesKey", "EncryptionKey", "SecureProperties", "StreamName", "Sequences")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "Sequences"))) { #optional property not found
            $Sequences = $null
        } else {
            $Sequences = $JsonParameters.PSobject.Properties["Sequences"].value
        }
