...
SoftwareUcsdBundleDistributable<PSCustomObject>
#>

function Initialize-IntersightSoftwareUcsdBundleDistributable {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwareUcsdBundleDistributable' | Write-Debug
...
Convert from JSON to SoftwareUcsdBundleDistributable<PSCustomObject>
...
SoftwareUcsdBundleDistributable<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwareUcsdBundleDistributable {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSoftwareUcsdBundleDistributable' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSoftwareUcsdBundleDistributable
