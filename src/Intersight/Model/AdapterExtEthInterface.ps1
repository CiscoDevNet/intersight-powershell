...
AdapterExtEthInterface<PSCustomObject>
#>

function Initialize-IntersightAdapterExtEthInterface {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAdapterExtEthInterface' | Write-Debug
...
Convert from JSON to AdapterExtEthInterface<PSCustomObject>
...
AdapterExtEthInterface<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAdapterExtEthInterface {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAdapterExtEthInterface' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAdapterExtEthInterface
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "OperState", "AcknowledgedPeerInterface", "PeerInterface", "AdminState", "EpDn", "ExtEthInterfaceId", "InterfaceType", "MacAddress", "PeerAggrPortId", "PeerDn", "PeerPortId", "PeerSlotId", "SwitchId", "AdapterUnit", "InventoryDeviceInfo", "RegisteredDevice")
