...
EtherPhysicalPortBase<PSCustomObject>
#>

function Initialize-IntersightEtherPhysicalPortBase {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("ether.HostPort", "ether.PhysicalPort")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("ether.HostPort", "ether.PhysicalPort")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEtherPhysicalPortBase' | Write-Debug
...
Convert from JSON to EtherPhysicalPortBase<PSCustomObject>
...
EtherPhysicalPortBase<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEtherPhysicalPortBase {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEtherPhysicalPortBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEtherPhysicalPortBase
