...
SyslogPolicyList<PSCustomObject>
#>

function Initialize-IntersightSyslogPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSyslogPolicyList' | Write-Debug
...
Convert from JSON to SyslogPolicyList<PSCustomObject>
...
SyslogPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSyslogPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSyslogPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSyslogPolicyList
