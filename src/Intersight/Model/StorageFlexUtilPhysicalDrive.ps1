...
function ConvertFrom-IntersightJsonToStorageFlexUtilPhysicalDrive {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "BlockSize", "Capacity", "Controller", "DrivesEnabled", "Health", "ManufacturerDate", "ManufacturerId", "OemId", "PartitionCount", "PdStatus", "PhysicalDrive", "ProductName", "ProductRevision", "ReadErrorCount", "ReadErrorThreshold", "WriteEnabled", "WriteErrorCount", "WriteErrorThreshold", "InventoryDeviceInfo", "RegisteredDevice", "StorageFlexUtilController")
