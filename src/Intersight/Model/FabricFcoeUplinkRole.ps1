...
FabricFcoeUplinkRole<PSCustomObject>
#>

function Initialize-IntersightFabricFcoeUplinkRole {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.FcoeUplinkRole")]
        [String]
        ${ClassId} = "fabric.FcoeUplinkRole",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.FcoeUplinkRole")]
        [String]
        ${ObjectType} = "fabric.FcoeUplinkRole",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricFcoeUplinkRole' | Write-Debug
...
Convert from JSON to FabricFcoeUplinkRole<PSCustomObject>
...
FabricFcoeUplinkRole<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricFcoeUplinkRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricFcoeUplinkRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricFcoeUplinkRole
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AggregatePortId", "PortId", "SlotId", "PortPolicy", "AdminSpeed", "Fec", "UdldAdminState")
