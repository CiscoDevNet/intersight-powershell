...
function ConvertFrom-IntersightJsonToTamSecurityAdvisory {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Severity", "State", "Actions", "AdvisoryId", "ApiDataSources", "BaseScore", "CveIds", "DatePublished", "DateUpdated", "EnvironmentalScore", "ExternalUrl", "Recommendation", "Status", "TemporalScore", "Version", "Workaround", "Organization")
