...
StorageStorageUtilizationAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageStorageUtilizationAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PureHostUtilization", "storage.PureVolumeUtilization")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PureHostUtilization", "storage.PureVolumeUtilization")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageStorageUtilizationAllOf' | Write-Debug
...
Convert from JSON to StorageStorageUtilizationAllOf<PSCustomObject>
...
StorageStorageUtilizationAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageStorageUtilizationAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageStorageUtilizationAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageStorageUtilizationAllOf
        $AllProperties = ("ClassId", "ObjectType", "DataReduction", "Snapshot", "ThinProvisioned", "TotalReduction", "Volume")
