...
Definition of the list of properties defined in 'fabric.TransceiverRole', excluding properties defined in parent classes.
...
FabricTransceiverRoleAllOf<PSCustomObject>
#>

function Initialize-IntersightFabricTransceiverRoleAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricTransceiverRoleAllOf' | Write-Debug
...
Convert from JSON to FabricTransceiverRoleAllOf<PSCustomObject>
...
FabricTransceiverRoleAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricTransceiverRoleAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricTransceiverRoleAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricTransceiverRoleAllOf
        $AllProperties = ("ClassId", "ObjectType", "AdminSpeed", "Fec")
