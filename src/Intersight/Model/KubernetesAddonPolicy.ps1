...
KubernetesAddonPolicy<PSCustomObject>
#>

function Initialize-IntersightKubernetesAddonPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("kubernetes.AddonPolicy")]
        [String]
        ${ClassId} = "kubernetes.AddonPolicy",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("kubernetes.AddonPolicy")]
        [String]
        ${ObjectType} = "kubernetes.AddonPolicy",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesAddonPolicy' | Write-Debug
...
Convert from JSON to KubernetesAddonPolicy<PSCustomObject>
...
KubernetesAddonPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesAddonPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesAddonPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesAddonPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "SystemManaged", "Addons", "ClusterProfiles", "Organization")
