...
StorageNetAppLunMap<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppLunMap {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppLunMap' | Write-Debug
...
Convert from JSON to StorageNetAppLunMap<PSCustomObject>
...
StorageNetAppLunMap<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppLunMap {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppLunMap' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppLunMap
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Hlu", "HostName", "VolumeName", "Uuid", "Host", "Tenant", "Volume")
