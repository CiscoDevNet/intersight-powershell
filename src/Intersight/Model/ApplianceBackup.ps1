...
ApplianceBackup<PSCustomObject>
#>

function Initialize-IntersightApplianceBackup {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("appliance.Backup")]
        [String]
        ${ClassId} = "appliance.Backup",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("appliance.Backup")]
        [String]
        ${ObjectType} = "appliance.Backup",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightApplianceBackup' | Write-Debug
...
Convert from JSON to ApplianceBackup<PSCustomObject>
...
ApplianceBackup<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToApplianceBackup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightApplianceBackup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightApplianceBackup
