...
BootNvme<PSCustomObject>
#>

function Initialize-IntersightBootNvme {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootNvme' | Write-Debug
...
Convert from JSON to BootNvme<PSCustomObject>
...
BootNvme<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootNvme {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootNvme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootNvme
        $AllProperties = ("ClassId", "ObjectType", "Enabled", "Name", "Bootloader")
