...
ServerConfigResultEntry<PSCustomObject>
#>

function Initialize-IntersightServerConfigResultEntry {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("server.ConfigResultEntry")]
        [String]
        ${ClassId} = "server.ConfigResultEntry",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("server.ConfigResultEntry")]
        [String]
        ${ObjectType} = "server.ConfigResultEntry",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightServerConfigResultEntry' | Write-Debug
...
Convert from JSON to ServerConfigResultEntry<PSCustomObject>
...
ServerConfigResultEntry<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToServerConfigResultEntry {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightServerConfigResultEntry' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightServerConfigResultEntry
