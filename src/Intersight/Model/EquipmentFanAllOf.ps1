...
function ConvertFrom-IntersightJsonToEquipmentFanAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Description", "FanId", "FanModuleId", "ModuleId", "OperState", "PartNumber", "Pid", "Presence", "Sku", "TrayId", "Vid", "EquipmentFanModule", "EquipmentFex", "InventoryDeviceInfo", "RegisteredDevice")
