...
EquipmentFanAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentFanAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentFanAllOf' | Write-Debug
...
Convert from JSON to EquipmentFanAllOf<PSCustomObject>
...
EquipmentFanAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentFanAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentFanAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentFanAllOf
        $AllProperties = ("ClassId", "ObjectType", "Description", "FanId", "FanModuleId", "ModuleId", "OperReason", "OperState", "PartNumber", "Pid", "Presence", "Sku", "TrayId", "Vid", "EquipmentFanModule", "EquipmentFex", "InventoryDeviceInfo", "RegisteredDevice")
