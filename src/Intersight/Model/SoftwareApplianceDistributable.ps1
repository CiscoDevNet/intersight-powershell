...
Appliance image distributed by Cisco. This image is required to upgrade the on-premise Intersight Appliance. There are two use cases. In Intersight SaaS, the object represents a downloadable image, whereas on the Appliance the represents the image that is uploaded by the user and to be used for upgrade.
...
SoftwareApplianceDistributable<PSCustomObject>
#>

function Initialize-IntersightSoftwareApplianceDistributable {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwareApplianceDistributable' | Write-Debug
...
Convert from JSON to SoftwareApplianceDistributable<PSCustomObject>
...
SoftwareApplianceDistributable<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwareApplianceDistributable {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSoftwareApplianceDistributable' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSoftwareApplianceDistributable
