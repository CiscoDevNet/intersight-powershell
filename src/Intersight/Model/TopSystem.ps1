...
function ConvertFrom-IntersightJsonToTopSystem {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Ipv4Address", "Ipv6Address", "Mode", "Name", "TimeZone", "ComputeBlades", "ComputeRackUnits", "InventoryDeviceInfo", "ManagementController", "NetworkElements", "RegisteredDevice")
