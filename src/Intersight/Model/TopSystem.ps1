...
TopSystem<PSCustomObject>
#>

function Initialize-IntersightTopSystem {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("top.System")]
        [String]
        ${ClassId} = "top.System",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("top.System")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTopSystem' | Write-Debug
...
Convert from JSON to TopSystem<PSCustomObject>
...
TopSystem<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTopSystem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTopSystem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTopSystem
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Ipv4Address", "Ipv6Address", "Mode", "Name", "TimeZone", "ComputeBlades", "ComputeRackUnits", "InventoryDeviceInfo", "ManagementController", "NetworkElements", "RegisteredDevice")
