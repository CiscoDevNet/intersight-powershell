...
IaasConnectorPack<PSCustomObject>
#>

function Initialize-IntersightIaasConnectorPack {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iaas.ConnectorPack")]
        [String]
        ${ClassId} = "iaas.ConnectorPack",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iaas.ConnectorPack")]
        [String]
        ${ObjectType} = "iaas.ConnectorPack",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIaasConnectorPack' | Write-Debug
...
Convert from JSON to IaasConnectorPack<PSCustomObject>
...
IaasConnectorPack<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIaasConnectorPack {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIaasConnectorPack' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIaasConnectorPack
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "CompleteVersion", "DependencyNames", "DownloadedVersion", "Name", "State", "Version", "Guid")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "CompleteVersion"))) { #optional property not found
            $CompleteVersion = $null
        } else {
            $CompleteVersion = $JsonParameters.PSobject.Properties["CompleteVersion"].value
        }
