...
function ConvertFrom-IntersightJsonToOsConfigurationFile {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "FileContent", "Internal", "Name", "Placeholders", "Supported", "Catalog", "Distributions")
