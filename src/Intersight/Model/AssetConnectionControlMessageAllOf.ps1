...
AssetConnectionControlMessageAllOf<PSCustomObject>
#>

function Initialize-IntersightAssetConnectionControlMessageAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAssetConnectionControlMessageAllOf' | Write-Debug
...
Convert from JSON to AssetConnectionControlMessageAllOf<PSCustomObject>
...
AssetConnectionControlMessageAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAssetConnectionControlMessageAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAssetConnectionControlMessageAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAssetConnectionControlMessageAllOf
        $AllProperties = ("Account", "ConnectorVersion", "DeviceId", "DomainGroup", "Evict", "Leadership", "NewIdentity", "Partition")
