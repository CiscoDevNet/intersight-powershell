...
FabricSwitchClusterProfile<PSCustomObject>
#>

function Initialize-IntersightFabricSwitchClusterProfile {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.SwitchClusterProfile")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricSwitchClusterProfile' | Write-Debug
...
Convert from JSON to FabricSwitchClusterProfile<PSCustomObject>
...
FabricSwitchClusterProfile<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricSwitchClusterProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricSwitchClusterProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricSwitchClusterProfile
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Type", "SrcTemplate", "ConfigContext", "SwitchProfilesCount", "Organization", "SwitchProfiles")
