...
function ConvertFrom-IntersightJsonToFabricSwitchClusterProfile {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Type", "SrcTemplate", "ConfigContext", "SwitchProfilesCount", "Organization", "SwitchProfiles")
