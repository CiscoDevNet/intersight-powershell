...
VirtualizationVmwareVcenter<PSCustomObject>
#>

function Initialize-IntersightVirtualizationVmwareVcenter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationVmwareVcenter' | Write-Debug
...
Convert from JSON to VirtualizationVmwareVcenter<PSCustomObject>
...
VirtualizationVmwareVcenter<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationVmwareVcenter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationVmwareVcenter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationVmwareVcenter
