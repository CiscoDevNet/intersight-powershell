...
IqnpoolUniverseListAllOf<PSCustomObject>
#>

function Initialize-IntersightIqnpoolUniverseListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIqnpoolUniverseListAllOf' | Write-Debug
...
Convert from JSON to IqnpoolUniverseListAllOf<PSCustomObject>
...
IqnpoolUniverseListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIqnpoolUniverseListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIqnpoolUniverseListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIqnpoolUniverseListAllOf
