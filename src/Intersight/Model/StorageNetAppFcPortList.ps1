...
StorageNetAppFcPortList<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppFcPortList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppFcPortList' | Write-Debug
...
Convert from JSON to StorageNetAppFcPortList<PSCustomObject>
...
StorageNetAppFcPortList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppFcPortList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppFcPortList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppFcPortList
