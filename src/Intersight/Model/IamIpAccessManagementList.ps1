...
IamIpAccessManagementList<PSCustomObject>
#>

function Initialize-IntersightIamIpAccessManagementList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamIpAccessManagementList' | Write-Debug
...
Convert from JSON to IamIpAccessManagementList<PSCustomObject>
...
IamIpAccessManagementList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamIpAccessManagementList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamIpAccessManagementList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamIpAccessManagementList
