...
StorageStorageUtilization<PSCustomObject>
#>

function Initialize-IntersightStorageStorageUtilization {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageStorageUtilization' | Write-Debug
...
Convert from JSON to StorageStorageUtilization<PSCustomObject>
...
StorageStorageUtilization<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageStorageUtilization {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageStorageUtilization' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageStorageUtilization
