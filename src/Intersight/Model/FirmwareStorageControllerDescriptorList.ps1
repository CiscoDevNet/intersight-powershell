...
FirmwareStorageControllerDescriptorList<PSCustomObject>
#>

function Initialize-IntersightFirmwareStorageControllerDescriptorList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareStorageControllerDescriptorList' | Write-Debug
...
Convert from JSON to FirmwareStorageControllerDescriptorList<PSCustomObject>
...
FirmwareStorageControllerDescriptorList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareStorageControllerDescriptorList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareStorageControllerDescriptorList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareStorageControllerDescriptorList
