...
FaultInstance<PSCustomObject>
#>

function Initialize-IntersightFaultInstance {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFaultInstance' | Write-Debug
...
Convert from JSON to FaultInstance<PSCustomObject>
...
FaultInstance<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFaultInstance {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFaultInstance' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFaultInstance
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Acknowledged", "AffectedDn", "AffectedMoId", "AffectedMoType", "AncestorMoId", "AncestorMoType", "Code", "CreationTime", "Description", "LastTransitionTime", "NumOccurrences", "OriginalSeverity", "PreviousSeverity", "Rule", "Severity", "InventoryDeviceInfo", "RegisteredDevice")
