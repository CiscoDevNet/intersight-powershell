...
function ConvertFrom-IntersightJsonToAdapterHostIscsiInterface {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "AdminState", "EpDn", "HostIscsiInterfaceId", "HostVisible", "MacAddress", "Name", "OperState", "Operability", "PeerDn", "AdapterUnit", "InventoryDeviceInfo", "RegisteredDevice")
