...
AdapterHostIscsiInterface<PSCustomObject>
#>

function Initialize-IntersightAdapterHostIscsiInterface {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("adapter.HostIscsiInterface")]
        [String]
        ${ClassId} = "adapter.HostIscsiInterface",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("adapter.HostIscsiInterface")]
        [String]
        ${ObjectType} = "adapter.HostIscsiInterface",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAdapterHostIscsiInterface' | Write-Debug
...
Convert from JSON to AdapterHostIscsiInterface<PSCustomObject>
...
AdapterHostIscsiInterface<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAdapterHostIscsiInterface {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAdapterHostIscsiInterface' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAdapterHostIscsiInterface
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "AdminState", "EpDn", "HostIscsiInterfaceId", "HostVisible", "MacAddress", "Name", "OperState", "Operability", "PeerDn", "AdapterUnit", "InventoryDeviceInfo", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "HostIscsiInterfaceId"))) { #optional property not found
            $HostIscsiInterfaceId = $null
        } else {
            $HostIscsiInterfaceId = $JsonParameters.PSobject.Properties["HostIscsiInterfaceId"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "HostVisible"))) { #optional property not found
            $HostVisible = $null
        } else {
            $HostVisible = $JsonParameters.PSobject.Properties["HostVisible"].value
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "EpDn" = ${EpDn}
            "HostIscsiInterfaceId" = ${HostIscsiInterfaceId}
