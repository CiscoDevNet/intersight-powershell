...
PortSubGroupList<PSCustomObject>
#>

function Initialize-IntersightPortSubGroupList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPortSubGroupList' | Write-Debug
...
Convert from JSON to PortSubGroupList<PSCustomObject>
...
PortSubGroupList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPortSubGroupList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPortSubGroupList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPortSubGroupList
