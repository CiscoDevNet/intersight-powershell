...
TamActionAllOf<PSCustomObject>
#>

function Initialize-IntersightTamActionAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTamActionAllOf' | Write-Debug
...
Convert from JSON to TamActionAllOf<PSCustomObject>
...
TamActionAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTamActionAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTamActionAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTamActionAllOf
        $AllProperties = ("AffectedObjectType", "AlertType", "Identifiers", "Name", "OperationType", "Queries", "Type")
