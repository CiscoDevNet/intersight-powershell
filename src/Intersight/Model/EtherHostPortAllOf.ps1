...
EtherHostPortAllOf<PSCustomObject>
#>

function Initialize-IntersightEtherHostPortAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEtherHostPortAllOf' | Write-Debug
...
Convert from JSON to EtherHostPortAllOf<PSCustomObject>
...
EtherHostPortAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEtherHostPortAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEtherHostPortAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEtherHostPortAllOf
        $AllProperties = ("ClassId", "ObjectType", "ModuleId", "Speed", "EquipmentIoCardBase", "RegisteredDevice")
