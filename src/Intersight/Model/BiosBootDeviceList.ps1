...
BiosBootDeviceList<PSCustomObject>
#>

function Initialize-IntersightBiosBootDeviceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBiosBootDeviceList' | Write-Debug
...
Convert from JSON to BiosBootDeviceList<PSCustomObject>
...
BiosBootDeviceList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBiosBootDeviceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBiosBootDeviceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBiosBootDeviceList
