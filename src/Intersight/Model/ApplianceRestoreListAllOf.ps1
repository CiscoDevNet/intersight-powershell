...
ApplianceRestoreListAllOf<PSCustomObject>
#>

function Initialize-IntersightApplianceRestoreListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightApplianceRestoreListAllOf' | Write-Debug
...
Convert from JSON to ApplianceRestoreListAllOf<PSCustomObject>
...
ApplianceRestoreListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToApplianceRestoreListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightApplianceRestoreListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightApplianceRestoreListAllOf
