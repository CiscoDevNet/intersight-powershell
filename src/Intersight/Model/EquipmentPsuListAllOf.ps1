...
EquipmentPsuListAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentPsuListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentPsuListAllOf' | Write-Debug
...
Convert from JSON to EquipmentPsuListAllOf<PSCustomObject>
...
EquipmentPsuListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentPsuListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentPsuListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentPsuListAllOf
