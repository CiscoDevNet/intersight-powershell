...
StorageEnclosureDiskList<PSCustomObject>
#>

function Initialize-IntersightStorageEnclosureDiskList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageEnclosureDiskList' | Write-Debug
...
Convert from JSON to StorageEnclosureDiskList<PSCustomObject>
...
StorageEnclosureDiskList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageEnclosureDiskList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageEnclosureDiskList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageEnclosureDiskList
