...
function Initialize-IntersightWorkflowBaseDataTypeAllOf {
    ...
    Param (
        ...
        [ValidateSet("workflow.ArrayDataType", "workflow.CustomDataType", "workflow.MoReferenceDataType", "workflow.PrimitiveDataType", "workflow.TargetDataType")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.ArrayDataType", "workflow.CustomDataType", "workflow.MoReferenceDataType", "workflow.PrimitiveDataType", "workflow.TargetDataType")]
...
function ConvertFrom-IntersightJsonToWorkflowBaseDataTypeAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Default", "Description", "DisplayMeta", "InputParameters", "Label", "Name", "Required")
