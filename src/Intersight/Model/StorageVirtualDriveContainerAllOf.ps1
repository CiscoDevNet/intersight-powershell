...
Definition of the list of properties defined in 'storage.VirtualDriveContainer', excluding properties defined in parent classes.
...
StorageVirtualDriveContainerAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageVirtualDriveContainerAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageVirtualDriveContainerAllOf' | Write-Debug
...
Convert from JSON to StorageVirtualDriveContainerAllOf<PSCustomObject>
...
StorageVirtualDriveContainerAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageVirtualDriveContainerAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageVirtualDriveContainerAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageVirtualDriveContainerAllOf
        $AllProperties = ("ClassId", "ObjectType", "ContainerId", "EquipmentChassis", "InventoryDeviceInfo", "RegisteredDevice", "VirtualDrive")
