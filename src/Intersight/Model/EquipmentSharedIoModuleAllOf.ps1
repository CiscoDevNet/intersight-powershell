...
function ConvertFrom-IntersightJsonToEquipmentSharedIoModuleAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "ConfigState", "Discovery", "MacOfSharedIomAside", "MacOfSharedIomBside", "OperState", "PartNumber", "Reachability", "UsrLbl", "Vid", "Controller", "EquipmentSystemIoController", "InventoryDeviceInfo", "PortGroups", "RegisteredDevice")
