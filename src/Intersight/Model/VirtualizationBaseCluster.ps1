...
VirtualizationBaseCluster<PSCustomObject>
#>

function Initialize-IntersightVirtualizationBaseCluster {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.HxapCluster", "virtualization.VmwareCluster")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.HxapCluster", "virtualization.VmwareCluster")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationBaseCluster' | Write-Debug
...
Convert from JSON to VirtualizationBaseCluster<PSCustomObject>
...
VirtualizationBaseCluster<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationBaseCluster {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationBaseCluster' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationBaseCluster
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "HypervisorType", "Identity", "MemoryCapacity", "Name", "ProcessorCapacity", "Status", "TotalCores")
