...
function ConvertFrom-IntersightJsonToVirtualizationBaseCluster {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "HypervisorType", "Identity", "MemoryCapacity", "Name", "ProcessorCapacity", "Status", "TotalCores")
