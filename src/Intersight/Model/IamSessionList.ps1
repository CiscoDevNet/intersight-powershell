...
IamSessionList<PSCustomObject>
#>

function Initialize-IntersightIamSessionList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamSessionList' | Write-Debug
...
Convert from JSON to IamSessionList<PSCustomObject>
...
IamSessionList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamSessionList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamSessionList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamSessionList
