...
WorkflowAbstractWorkerTaskAllOf<PSCustomObject>
#>

function Initialize-IntersightWorkflowAbstractWorkerTaskAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowAbstractWorkerTaskAllOf' | Write-Debug
...
Convert from JSON to WorkflowAbstractWorkerTaskAllOf<PSCustomObject>
...
WorkflowAbstractWorkerTaskAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowAbstractWorkerTaskAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowAbstractWorkerTaskAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowAbstractWorkerTaskAllOf
        $AllProperties = ("ClassId", "ObjectType", "InputParameters", "OnFailure", "OnSuccess", "RollbackDisabled", "UseDefault")
