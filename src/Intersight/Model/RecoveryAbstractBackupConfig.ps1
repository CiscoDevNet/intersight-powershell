...
RecoveryAbstractBackupConfig<PSCustomObject>
#>

function Initialize-IntersightRecoveryAbstractBackupConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightRecoveryAbstractBackupConfig' | Write-Debug
...
Convert from JSON to RecoveryAbstractBackupConfig<PSCustomObject>
...
RecoveryAbstractBackupConfig<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToRecoveryAbstractBackupConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightRecoveryAbstractBackupConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightRecoveryAbstractBackupConfig
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "FileNamePrefix", "IsPasswordSet", "LocationType", "Password", "Path", "Protocol", "RetentionCount", "UserName")
