...
StorageBaseStorageContainer<PSCustomObject>
#>

function Initialize-IntersightStorageBaseStorageContainer {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HyperFlexStorageContainer", "storage.NetAppVolume")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HyperFlexStorageContainer", "storage.NetAppVolume")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageBaseStorageContainer' | Write-Debug
...
Convert from JSON to StorageBaseStorageContainer<PSCustomObject>
...
StorageBaseStorageContainer<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageBaseStorageContainer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageBaseStorageContainer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageBaseStorageContainer
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "CreatedTime", "Name", "StorageUtilization")
