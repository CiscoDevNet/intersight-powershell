...
IamLdapGroup<PSCustomObject>
#>

function Initialize-IntersightIamLdapGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamLdapGroup' | Write-Debug
...
Convert from JSON to IamLdapGroup<PSCustomObject>
...
IamLdapGroup<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamLdapGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamLdapGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamLdapGroup
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Domain", "Name", "EndPointRole", "LdapPolicy")
