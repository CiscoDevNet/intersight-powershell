...
HclOperatingSystemVendorList<PSCustomObject>
#>

function Initialize-IntersightHclOperatingSystemVendorList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHclOperatingSystemVendorList' | Write-Debug
...
Convert from JSON to HclOperatingSystemVendorList<PSCustomObject>
...
HclOperatingSystemVendorList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHclOperatingSystemVendorList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHclOperatingSystemVendorList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHclOperatingSystemVendorList
