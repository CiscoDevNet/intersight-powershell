...
NiaapiApicReleaseRecommendList<PSCustomObject>
#>

function Initialize-IntersightNiaapiApicReleaseRecommendList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiApicReleaseRecommendList' | Write-Debug
...
Convert from JSON to NiaapiApicReleaseRecommendList<PSCustomObject>
...
NiaapiApicReleaseRecommendList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiApicReleaseRecommendList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiApicReleaseRecommendList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiApicReleaseRecommendList
