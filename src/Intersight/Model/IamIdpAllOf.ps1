...
function ConvertFrom-IntersightJsonToIamIdpAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "DomainName", "EnableSingleLogout", "IdpEntityId", "Metadata", "Name", "Type", "Account", "LdapPolicy", "System", "UserPreferences", "Usergroups", "Users")
