...
FabricQosPolicyAllOf<PSCustomObject>
#>

function Initialize-IntersightFabricQosPolicyAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricQosPolicyAllOf' | Write-Debug
...
Convert from JSON to FabricQosPolicyAllOf<PSCustomObject>
...
FabricQosPolicyAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricQosPolicyAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricQosPolicyAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricQosPolicyAllOf
        $AllProperties = ("Classes", "Organization", "Profiles")
