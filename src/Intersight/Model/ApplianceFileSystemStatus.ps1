...
ApplianceFileSystemStatus<PSCustomObject>
#>

function Initialize-IntersightApplianceFileSystemStatus {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("appliance.FileSystemStatus")]
        [String]
        ${ClassId} = "appliance.FileSystemStatus",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("appliance.FileSystemStatus")]
        [String]
        ${ObjectType} = "appliance.FileSystemStatus",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightApplianceFileSystemStatus' | Write-Debug
...
Convert from JSON to ApplianceFileSystemStatus<PSCustomObject>
...
ApplianceFileSystemStatus<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToApplianceFileSystemStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightApplianceFileSystemStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightApplianceFileSystemStatus
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Capacity", "Mountpoint", "OperationalStatus", "StatusChecks", "Usage", "NodeStatus")
