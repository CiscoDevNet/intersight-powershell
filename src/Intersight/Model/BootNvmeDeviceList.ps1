...
BootNvmeDeviceList<PSCustomObject>
#>

function Initialize-IntersightBootNvmeDeviceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootNvmeDeviceList' | Write-Debug
...
Convert from JSON to BootNvmeDeviceList<PSCustomObject>
...
BootNvmeDeviceList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootNvmeDeviceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootNvmeDeviceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootNvmeDeviceList
