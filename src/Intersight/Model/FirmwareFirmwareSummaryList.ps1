...
FirmwareFirmwareSummaryList<PSCustomObject>
#>

function Initialize-IntersightFirmwareFirmwareSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareFirmwareSummaryList' | Write-Debug
...
Convert from JSON to FirmwareFirmwareSummaryList<PSCustomObject>
...
FirmwareFirmwareSummaryList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareFirmwareSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareFirmwareSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareFirmwareSummaryList
