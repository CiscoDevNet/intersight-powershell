...
PolicyinventoryAbstractDeviceInfo<PSCustomObject>
#>

function Initialize-IntersightPolicyinventoryAbstractDeviceInfo {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("inventory.DeviceInfo")]
        [String]
        ${ClassId} = "inventory.DeviceInfo",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("inventory.DeviceInfo")]
        [String]
        ${ObjectType} = "inventory.DeviceInfo",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPolicyinventoryAbstractDeviceInfo' | Write-Debug
...
Convert from JSON to PolicyinventoryAbstractDeviceInfo<PSCustomObject>
...
PolicyinventoryAbstractDeviceInfo<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPolicyinventoryAbstractDeviceInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPolicyinventoryAbstractDeviceInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPolicyinventoryAbstractDeviceInfo
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ConfigState", "ControlAction", "ErrorState", "JobInfo", "OperState", "ProfileMoId", "RegisteredDevice")
