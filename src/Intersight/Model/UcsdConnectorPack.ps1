...
UcsdConnectorPack<PSCustomObject>
#>

function Initialize-IntersightUcsdConnectorPack {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("ucsd.ConnectorPack")]
        [String]
        ${ClassId} = "ucsd.ConnectorPack",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("ucsd.ConnectorPack")]
        [String]
        ${ObjectType} = "ucsd.ConnectorPack",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String[]]
        ${DependencyNames},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightUcsdConnectorPack' | Write-Debug
...
Convert from JSON to UcsdConnectorPack<PSCustomObject>
...
UcsdConnectorPack<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToUcsdConnectorPack {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightUcsdConnectorPack' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightUcsdConnectorPack
        $AllProperties = ("ClassId", "ObjectType", "ConnectorFeature", "DependencyNames", "DownloadedVersion", "Name", "Services", "State", "Version")
