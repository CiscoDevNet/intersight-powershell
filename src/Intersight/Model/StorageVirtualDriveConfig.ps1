...
function ConvertFrom-IntersightJsonToStorageVirtualDriveConfig {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccessPolicy", "BootDrive", "DiskGroupName", "DiskGroupPolicy", "DriveCache", "ExpandToAvailable", "IoPolicy", "Name", "ReadPolicy", "Size", "WritePolicy")
