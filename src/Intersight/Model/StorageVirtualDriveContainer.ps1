...
StorageVirtualDriveContainer<PSCustomObject>
#>

function Initialize-IntersightStorageVirtualDriveContainer {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.VirtualDriveContainer")]
        [String]
        ${ClassId} = "storage.VirtualDriveContainer",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.VirtualDriveContainer")]
        [String]
        ${ObjectType} = "storage.VirtualDriveContainer",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageVirtualDriveContainer' | Write-Debug
...
Convert from JSON to StorageVirtualDriveContainer<PSCustomObject>
...
StorageVirtualDriveContainer<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageVirtualDriveContainer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageVirtualDriveContainer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageVirtualDriveContainer
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ContainerId", "EquipmentChassis", "InventoryDeviceInfo", "RegisteredDevice", "VirtualDrive")
