...
VirtualizationVmwareVirtualMachineList<PSCustomObject>
#>

function Initialize-IntersightVirtualizationVmwareVirtualMachineList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationVmwareVirtualMachineList' | Write-Debug
...
Convert from JSON to VirtualizationVmwareVirtualMachineList<PSCustomObject>
...
VirtualizationVmwareVirtualMachineList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationVmwareVirtualMachineList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationVmwareVirtualMachineList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationVmwareVirtualMachineList
