...
FcpoolPool<PSCustomObject>
#>

function Initialize-IntersightFcpoolPool {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fcpool.Pool")]
        [String]
        ${ClassId} = "fcpool.Pool",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fcpool.Pool")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFcpoolPool' | Write-Debug
        ...
        if (!$IdBlocks -and $IdBlocks.length -lt 1) {
            throw "invalid value for 'IdBlocks', number of items must be greater than or equal to 1."
        }
...
Convert from JSON to FcpoolPool<PSCustomObject>
...
FcpoolPool<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFcpoolPool {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFcpoolPool' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFcpoolPool
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Assigned", "AssignmentOrder", "Size", "IdBlocks", "PoolPurpose", "BlockHeads", "Organization")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "IdBlocks"))) { #optional property not found
            $IdBlocks = $null
        } else {
            $IdBlocks = $JsonParameters.PSobject.Properties["IdBlocks"].value
        }
