...
NiaapiNibMetadata<PSCustomObject>
#>

function Initialize-IntersightNiaapiNibMetadata {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("niaapi.NibMetadata")]
        [String]
        ${ClassId} = "niaapi.NibMetadata",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("niaapi.NibMetadata")]
        [String]
        ${ObjectType} = "niaapi.NibMetadata",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiNibMetadata' | Write-Debug
...
Convert from JSON to NiaapiNibMetadata<PSCustomObject>
...
NiaapiNibMetadata<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiNibMetadata {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiNibMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiNibMetadata
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Content", "Date", "MetadataChksum", "MetadataFilename", "Version")
