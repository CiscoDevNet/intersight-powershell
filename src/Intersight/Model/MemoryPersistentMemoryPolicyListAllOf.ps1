...
MemoryPersistentMemoryPolicyListAllOf<PSCustomObject>
#>

function Initialize-IntersightMemoryPersistentMemoryPolicyListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMemoryPersistentMemoryPolicyListAllOf' | Write-Debug
...
Convert from JSON to MemoryPersistentMemoryPolicyListAllOf<PSCustomObject>
...
MemoryPersistentMemoryPolicyListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryPolicyListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMemoryPersistentMemoryPolicyListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMemoryPersistentMemoryPolicyListAllOf
