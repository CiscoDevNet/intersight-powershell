...
FirmwareFirmwareInventory<PSCustomObject>
#>

function Initialize-IntersightFirmwareFirmwareInventory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareFirmwareInventory' | Write-Debug
...
Convert from JSON to FirmwareFirmwareInventory<PSCustomObject>
...
FirmwareFirmwareInventory<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareFirmwareInventory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareFirmwareInventory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareFirmwareInventory
