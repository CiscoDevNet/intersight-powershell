...
AdapterHostEthInterfaceListAllOf<PSCustomObject>
#>

function Initialize-IntersightAdapterHostEthInterfaceListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAdapterHostEthInterfaceListAllOf' | Write-Debug
...
Convert from JSON to AdapterHostEthInterfaceListAllOf<PSCustomObject>
...
AdapterHostEthInterfaceListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAdapterHostEthInterfaceListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAdapterHostEthInterfaceListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAdapterHostEthInterfaceListAllOf
