...
VirtualizationGuestInfoAllOf<PSCustomObject>
#>

function Initialize-IntersightVirtualizationGuestInfoAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationGuestInfoAllOf' | Write-Debug
...
Convert from JSON to VirtualizationGuestInfoAllOf<PSCustomObject>
...
VirtualizationGuestInfoAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationGuestInfoAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationGuestInfoAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationGuestInfoAllOf
