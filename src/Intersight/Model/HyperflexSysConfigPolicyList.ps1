...
HyperflexSysConfigPolicyList<PSCustomObject>
#>

function Initialize-IntersightHyperflexSysConfigPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexSysConfigPolicyList' | Write-Debug
...
Convert from JSON to HyperflexSysConfigPolicyList<PSCustomObject>
...
HyperflexSysConfigPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexSysConfigPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexSysConfigPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexSysConfigPolicyList
