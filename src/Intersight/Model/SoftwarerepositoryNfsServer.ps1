...
SoftwarerepositoryNfsServer<PSCustomObject>
#>

function Initialize-IntersightSoftwarerepositoryNfsServer {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwarerepositoryNfsServer' | Write-Debug
...
Convert from JSON to SoftwarerepositoryNfsServer<PSCustomObject>
...
SoftwarerepositoryNfsServer<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwarerepositoryNfsServer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSoftwarerepositoryNfsServer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSoftwarerepositoryNfsServer
