...
MacpoolIdBlockListAllOf<PSCustomObject>
#>

function Initialize-IntersightMacpoolIdBlockListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMacpoolIdBlockListAllOf' | Write-Debug
...
Convert from JSON to MacpoolIdBlockListAllOf<PSCustomObject>
...
MacpoolIdBlockListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMacpoolIdBlockListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMacpoolIdBlockListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMacpoolIdBlockListAllOf
