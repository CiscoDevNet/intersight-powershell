...
InventoryDnMoBindingListAllOf<PSCustomObject>
#>

function Initialize-IntersightInventoryDnMoBindingListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightInventoryDnMoBindingListAllOf' | Write-Debug
...
Convert from JSON to InventoryDnMoBindingListAllOf<PSCustomObject>
...
InventoryDnMoBindingListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToInventoryDnMoBindingListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightInventoryDnMoBindingListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightInventoryDnMoBindingListAllOf
