...
BootPchStorageDeviceListAllOf<PSCustomObject>
#>

function Initialize-IntersightBootPchStorageDeviceListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootPchStorageDeviceListAllOf' | Write-Debug
...
Convert from JSON to BootPchStorageDeviceListAllOf<PSCustomObject>
...
BootPchStorageDeviceListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootPchStorageDeviceListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootPchStorageDeviceListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootPchStorageDeviceListAllOf
