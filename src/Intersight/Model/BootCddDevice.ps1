...
BootCddDevice<PSCustomObject>
#>

function Initialize-IntersightBootCddDevice {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.CddDevice")]
        [String]
        ${ClassId} = "boot.CddDevice",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.CddDevice")]
        [String]
        ${ObjectType} = "boot.CddDevice",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootCddDevice' | Write-Debug
...
Convert from JSON to BootCddDevice<PSCustomObject>
...
BootCddDevice<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootCddDevice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootCddDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootCddDevice
