...
ApplianceDiagSetting<PSCustomObject>
#>

function Initialize-IntersightApplianceDiagSetting {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("appliance.DiagSetting")]
        [String]
        ${ClassId} = "appliance.DiagSetting",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("appliance.DiagSetting")]
        [String]
        ${ObjectType} = "appliance.DiagSetting",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightApplianceDiagSetting' | Write-Debug
...
Convert from JSON to ApplianceDiagSetting<PSCustomObject>
...
ApplianceDiagSetting<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToApplianceDiagSetting {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightApplianceDiagSetting' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightApplianceDiagSetting
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "IsPasswordSet", "Message", "Password", "Account")
