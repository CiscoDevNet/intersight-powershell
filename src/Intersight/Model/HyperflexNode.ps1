...
function ConvertFrom-IntersightJsonToHyperflexNode {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "BuildNumber", "DisplayVersion", "HostName", "Hypervisor", "Identity", "Ip", "Lockdown", "ModelNumber", "Role", "SerialNumber", "Status", "Version", "Cluster", "ClusterMember", "PhysicalServer")
