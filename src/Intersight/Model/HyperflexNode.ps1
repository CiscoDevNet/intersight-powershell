...
function ConvertFrom-IntersightJsonToHyperflexNode {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "BuildNumber", "DisplayVersion", "HostName", "Hypervisor", "Identity", "Ip", "Lockdown", "ModelNumber", "Role", "SerialNumber", "Status", "Version", "Cluster", "ClusterMember", "PhysicalServer")
