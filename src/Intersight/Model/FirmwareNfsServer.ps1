...
FirmwareNfsServer<PSCustomObject>
#>

function Initialize-IntersightFirmwareNfsServer {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareNfsServer' | Write-Debug
...
Convert from JSON to FirmwareNfsServer<PSCustomObject>
...
FirmwareNfsServer<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareNfsServer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareNfsServer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareNfsServer
