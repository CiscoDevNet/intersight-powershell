...
EquipmentTpmAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentTpmAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentTpmAllOf' | Write-Debug
...
Convert from JSON to EquipmentTpmAllOf<PSCustomObject>
...
EquipmentTpmAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentTpmAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentTpmAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentTpmAllOf
        $AllProperties = ("ClassId", "ObjectType", "ActivationStatus", "AdminState", "FirmwareVersion", "Ownership", "Presence", "TpmId", "Version", "ComputeBoard", "InventoryDeviceInfo", "RegisteredDevice")
