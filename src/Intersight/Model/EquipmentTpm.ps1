...
EquipmentTpm<PSCustomObject>
#>

function Initialize-IntersightEquipmentTpm {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.Tpm")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentTpm' | Write-Debug
...
Convert from JSON to EquipmentTpm<PSCustomObject>
...
EquipmentTpm<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentTpm {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentTpm' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentTpm
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ActivationStatus", "AdminState", "FirmwareVersion", "Ownership", "Presence", "TpmId", "Version", "ComputeBoard", "InventoryDeviceInfo", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ActivationStatus"))) { #optional property not found
            $ActivationStatus = $null
        } else {
            $ActivationStatus = $JsonParameters.PSobject.Properties["ActivationStatus"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "Ownership"))) { #optional property not found
            $Ownership = $null
        } else {
            $Ownership = $JsonParameters.PSobject.Properties["Ownership"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "TpmId"))) { #optional property not found
            $TpmId = $null
        } else {
            $TpmId = $JsonParameters.PSobject.Properties["TpmId"].value
        }
