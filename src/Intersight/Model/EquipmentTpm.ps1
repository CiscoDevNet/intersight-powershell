...
function ConvertFrom-IntersightJsonToEquipmentTpm {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ActivationStatus", "AdminState", "Ownership", "Presence", "TpmId", "Version", "ComputeBoard", "InventoryDeviceInfo", "RegisteredDevice")
