...
function ConvertFrom-IntersightJsonToEquipmentTpm {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ActivationStatus", "AdminState", "Ownership", "Presence", "TpmId", "Version", "ComputeBoard", "InventoryDeviceInfo", "RegisteredDevice")
