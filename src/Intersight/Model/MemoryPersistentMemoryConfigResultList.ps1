...
MemoryPersistentMemoryConfigResultList<PSCustomObject>
#>

function Initialize-IntersightMemoryPersistentMemoryConfigResultList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMemoryPersistentMemoryConfigResultList' | Write-Debug
...
Convert from JSON to MemoryPersistentMemoryConfigResultList<PSCustomObject>
...
MemoryPersistentMemoryConfigResultList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryConfigResultList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMemoryPersistentMemoryConfigResultList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMemoryPersistentMemoryConfigResultList
