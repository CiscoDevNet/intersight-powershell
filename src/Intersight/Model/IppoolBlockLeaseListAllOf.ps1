...
IppoolBlockLeaseListAllOf<PSCustomObject>
#>

function Initialize-IntersightIppoolBlockLeaseListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIppoolBlockLeaseListAllOf' | Write-Debug
...
Convert from JSON to IppoolBlockLeaseListAllOf<PSCustomObject>
...
IppoolBlockLeaseListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIppoolBlockLeaseListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIppoolBlockLeaseListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIppoolBlockLeaseListAllOf
