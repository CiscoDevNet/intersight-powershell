...
SoftwareUcsdDistributable<PSCustomObject>
#>

function Initialize-IntersightSoftwareUcsdDistributable {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwareUcsdDistributable' | Write-Debug
...
Convert from JSON to SoftwareUcsdDistributable<PSCustomObject>
...
SoftwareUcsdDistributable<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwareUcsdDistributable {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSoftwareUcsdDistributable' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSoftwareUcsdDistributable
