...
ChassisConfigResult<PSCustomObject>
#>

function Initialize-IntersightChassisConfigResult {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("chassis.ConfigResult")]
        [String]
        ${ClassId} = "chassis.ConfigResult",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("chassis.ConfigResult")]
        [String]
        ${ObjectType} = "chassis.ConfigResult",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightChassisConfigResult' | Write-Debug
...
Convert from JSON to ChassisConfigResult<PSCustomObject>
...
ChassisConfigResult<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToChassisConfigResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightChassisConfigResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightChassisConfigResult
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ConfigStage", "ConfigState", "ValidationState", "Profile", "ResultEntries")
