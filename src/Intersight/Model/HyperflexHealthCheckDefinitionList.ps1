...
HyperflexHealthCheckDefinitionList<PSCustomObject>
#>

function Initialize-IntersightHyperflexHealthCheckDefinitionList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexHealthCheckDefinitionList' | Write-Debug
...
Convert from JSON to HyperflexHealthCheckDefinitionList<PSCustomObject>
...
HyperflexHealthCheckDefinitionList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexHealthCheckDefinitionList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexHealthCheckDefinitionList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexHealthCheckDefinitionList
