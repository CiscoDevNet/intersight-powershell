...
CommCredential<PSCustomObject>
#>

function Initialize-IntersightCommCredential {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCommCredential' | Write-Debug
...
Convert from JSON to CommCredential<PSCustomObject>
...
CommCredential<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCommCredential {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCommCredential' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCommCredential
