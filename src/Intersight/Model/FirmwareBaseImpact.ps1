...
FirmwareBaseImpact<PSCustomObject>
#>

function Initialize-IntersightFirmwareBaseImpact {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareBaseImpact' | Write-Debug
...
Convert from JSON to FirmwareBaseImpact<PSCustomObject>
...
FirmwareBaseImpact<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareBaseImpact {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareBaseImpact' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareBaseImpact
