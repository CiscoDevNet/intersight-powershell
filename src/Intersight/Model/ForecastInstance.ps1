...
function ConvertFrom-IntersightJsonToForecastInstance {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AltModel", "DeviceId", "FullCapDays", "MetricName", "MinDaysForForecast", "Model", "ThresholdDays", "ForecastDef", "RegisteredDevice")
