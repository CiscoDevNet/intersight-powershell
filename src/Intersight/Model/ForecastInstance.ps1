...
function ConvertFrom-IntersightJsonToForecastInstance {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AltModel", "DeviceId", "FullCapDays", "MetricName", "MinDaysForForecast", "Model", "ThresholdDays", "ForecastDef", "RegisteredDevice")
