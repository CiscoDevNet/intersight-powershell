...
ForecastInstance<PSCustomObject>
#>

function Initialize-IntersightForecastInstance {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightForecastInstance' | Write-Debug
...
Convert from JSON to ForecastInstance<PSCustomObject>
...
ForecastInstance<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToForecastInstance {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightForecastInstance' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightForecastInstance
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AltModel", "DeviceId", "FullCapDays", "MetricName", "MinDaysForForecast", "Model", "ThresholdDays", "ForecastDef", "RegisteredDevice")
