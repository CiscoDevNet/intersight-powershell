...
function ConvertFrom-IntersightJsonToFirmwareUpgradeImpactStatus {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Components", "ComputationState", "ExcludeComponents", "Impacts", "Summary", "Upgrade")
