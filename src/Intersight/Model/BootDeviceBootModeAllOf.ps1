...
BootDeviceBootModeAllOf<PSCustomObject>
#>

function Initialize-IntersightBootDeviceBootModeAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootDeviceBootModeAllOf' | Write-Debug
...
Convert from JSON to BootDeviceBootModeAllOf<PSCustomObject>
...
BootDeviceBootModeAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootDeviceBootModeAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootDeviceBootModeAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootDeviceBootModeAllOf
        $AllProperties = ("ClassId", "ObjectType", "ConfiguredBootMode", "ComputeBlade", "ComputeRackUnit", "InventoryDeviceInfo", "RegisteredDevice")
