...
HclDriverImage<PSCustomObject>
#>

function Initialize-IntersightHclDriverImage {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hcl.DriverImage")]
        [String]
        ${ClassId} = "hcl.DriverImage",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hcl.DriverImage")]
        [String]
        ${ObjectType} = "hcl.DriverImage",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHclDriverImage' | Write-Debug
...
Convert from JSON to HclDriverImage<PSCustomObject>
...
HclDriverImage<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHclDriverImage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHclDriverImage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHclDriverImage
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DriverIsoUrl", "ManagementType", "ServerPid")
