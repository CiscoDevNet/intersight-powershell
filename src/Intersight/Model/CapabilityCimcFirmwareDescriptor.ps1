...
CapabilityCimcFirmwareDescriptor<PSCustomObject>
#>

function Initialize-IntersightCapabilityCimcFirmwareDescriptor {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.CimcFirmwareDescriptor")]
        [String]
        ${ClassId} = "capability.CimcFirmwareDescriptor",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.CimcFirmwareDescriptor")]
        [String]
        ${ObjectType} = "capability.CimcFirmwareDescriptor",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilityCimcFirmwareDescriptor' | Write-Debug
...
Convert from JSON to CapabilityCimcFirmwareDescriptor<PSCustomObject>
...
CapabilityCimcFirmwareDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilityCimcFirmwareDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilityCimcFirmwareDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilityCimcFirmwareDescriptor
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Model", "Vendor", "Version", "Capabilities", "Revision")
