...
function Initialize-IntersightAssetHttpConnectionAllOf {
    ...
    Param (
        ...
        [ValidateSet("asset.HttpConnection")]
        [String]
        ${ClassId} = "asset.HttpConnection",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("asset.HttpConnection")]
        [String]
...
function ConvertFrom-IntersightJsonToAssetHttpConnectionAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "CertificateAuthority", "IsSecure", "ManagementAddress", "Port")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "CertificateAuthority"))) { #optional property not found
            $CertificateAuthority = $null
        } else {
            $CertificateAuthority = $JsonParameters.PSobject.Properties["CertificateAuthority"].value
        }
