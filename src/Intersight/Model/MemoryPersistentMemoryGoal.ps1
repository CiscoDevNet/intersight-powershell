...
MemoryPersistentMemoryGoal<PSCustomObject>
#>

function Initialize-IntersightMemoryPersistentMemoryGoal {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("memory.PersistentMemoryGoal")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMemoryPersistentMemoryGoal' | Write-Debug
...
Convert from JSON to MemoryPersistentMemoryGoal<PSCustomObject>
...
MemoryPersistentMemoryGoal<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryGoal {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMemoryPersistentMemoryGoal' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMemoryPersistentMemoryGoal
        $AllProperties = ("ClassId", "ObjectType", "MemoryModePercentage", "PersistentMemoryType", "SocketId")
