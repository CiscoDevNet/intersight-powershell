...
IppoolUniverseListAllOf<PSCustomObject>
#>

function Initialize-IntersightIppoolUniverseListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIppoolUniverseListAllOf' | Write-Debug
...
Convert from JSON to IppoolUniverseListAllOf<PSCustomObject>
...
IppoolUniverseListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIppoolUniverseListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIppoolUniverseListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIppoolUniverseListAllOf
