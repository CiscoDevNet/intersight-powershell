...
StorageNetAppEthernetPortList<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppEthernetPortList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppEthernetPortList' | Write-Debug
...
Convert from JSON to StorageNetAppEthernetPortList<PSCustomObject>
...
StorageNetAppEthernetPortList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppEthernetPortList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppEthernetPortList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppEthernetPortList
