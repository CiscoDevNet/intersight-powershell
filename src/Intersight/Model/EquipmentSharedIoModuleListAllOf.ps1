...
EquipmentSharedIoModuleListAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentSharedIoModuleListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentSharedIoModuleListAllOf' | Write-Debug
...
Convert from JSON to EquipmentSharedIoModuleListAllOf<PSCustomObject>
...
EquipmentSharedIoModuleListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentSharedIoModuleListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentSharedIoModuleListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentSharedIoModuleListAllOf
