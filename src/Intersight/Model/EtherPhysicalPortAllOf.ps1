...
function ConvertFrom-IntersightJsonToEtherPhysicalPortAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AdminSpeed", "AdminState", "AggregatePortId", "LicenseGrace", "LicenseState", "InventoryDeviceInfo", "PortGroup", "PortSubGroup", "RegisteredDevice")
