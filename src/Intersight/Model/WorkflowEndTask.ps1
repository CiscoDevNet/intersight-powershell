...
WorkflowEndTask<PSCustomObject>
#>

function Initialize-IntersightWorkflowEndTask {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowEndTask' | Write-Debug
...
Convert from JSON to WorkflowEndTask<PSCustomObject>
...
WorkflowEndTask<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowEndTask {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowEndTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowEndTask
