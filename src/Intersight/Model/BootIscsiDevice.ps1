...
BootIscsiDevice<PSCustomObject>
#>

function Initialize-IntersightBootIscsiDevice {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.IscsiDevice")]
        [String]
        ${ClassId} = "boot.IscsiDevice",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.IscsiDevice")]
        [String]
        ${ObjectType} = "boot.IscsiDevice",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootIscsiDevice' | Write-Debug
...
Convert from JSON to BootIscsiDevice<PSCustomObject>
...
BootIscsiDevice<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootIscsiDevice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootIscsiDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootIscsiDevice
