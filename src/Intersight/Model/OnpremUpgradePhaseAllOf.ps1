...
OnpremUpgradePhaseAllOf<PSCustomObject>
#>

function Initialize-IntersightOnpremUpgradePhaseAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightOnpremUpgradePhaseAllOf' | Write-Debug
...
Convert from JSON to OnpremUpgradePhaseAllOf<PSCustomObject>
...
OnpremUpgradePhaseAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToOnpremUpgradePhaseAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightOnpremUpgradePhaseAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightOnpremUpgradePhaseAllOf
