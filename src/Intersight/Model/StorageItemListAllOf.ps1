...
StorageItemListAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageItemListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageItemListAllOf' | Write-Debug
...
Convert from JSON to StorageItemListAllOf<PSCustomObject>
...
StorageItemListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageItemListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageItemListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageItemListAllOf
