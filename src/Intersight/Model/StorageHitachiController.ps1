...
StorageHitachiController<PSCustomObject>
#>

function Initialize-IntersightStorageHitachiController {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiController")]
        [String]
        ${ClassId} = "storage.HitachiController",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiController")]
        [String]
        ${ObjectType} = "storage.HitachiController",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageHitachiController' | Write-Debug
...
Convert from JSON to StorageHitachiController<PSCustomObject>
...
StorageHitachiController<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageHitachiController {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageHitachiController' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageHitachiController
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Name", "OperationalMode", "Status", "Version", "Array", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "OperationalMode"))) { #optional property not found
            $OperationalMode = $null
        } else {
            $OperationalMode = $JsonParameters.PSobject.Properties["OperationalMode"].value
        }
