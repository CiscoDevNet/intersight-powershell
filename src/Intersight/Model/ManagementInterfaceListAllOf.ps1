...
ManagementInterfaceListAllOf<PSCustomObject>
#>

function Initialize-IntersightManagementInterfaceListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightManagementInterfaceListAllOf' | Write-Debug
...
Convert from JSON to ManagementInterfaceListAllOf<PSCustomObject>
...
ManagementInterfaceListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToManagementInterfaceListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightManagementInterfaceListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightManagementInterfaceListAllOf
