...
BiosUnit<PSCustomObject>
#>

function Initialize-IntersightBiosUnit {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("bios.Unit")]
        [String]
        ${ClassId} = "bios.Unit",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("bios.Unit")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBiosUnit' | Write-Debug
...
Convert from JSON to BiosUnit<PSCustomObject>
...
BiosUnit<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBiosUnit {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBiosUnit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBiosUnit
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "InitSeq", "InitTs", "ComputeBlade", "ComputeRackUnit", "InventoryDeviceInfo", "RegisteredDevice", "RunningFirmware", "SystemBootOrder")
