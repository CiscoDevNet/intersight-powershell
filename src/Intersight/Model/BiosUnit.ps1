...
function ConvertFrom-IntersightJsonToBiosUnit {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "InitSeq", "InitTs", "ComputeBlade", "ComputeRackUnit", "InventoryDeviceInfo", "RegisteredDevice", "RunningFirmware", "SystemBootOrder")
