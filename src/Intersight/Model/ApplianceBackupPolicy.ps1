...
function ConvertFrom-IntersightJsonToApplianceBackupPolicy {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Filename", "Protocol", "RemoteHost", "RemotePath", "RemotePort", "Username", "BackupTime", "IsPasswordSet", "ManualBackup", "Password", "Schedule", "Account")
