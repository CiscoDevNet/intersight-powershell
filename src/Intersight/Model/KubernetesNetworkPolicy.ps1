...
KubernetesNetworkPolicy<PSCustomObject>
#>

function Initialize-IntersightKubernetesNetworkPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesNetworkPolicy' | Write-Debug
...
Convert from JSON to KubernetesNetworkPolicy<PSCustomObject>
...
KubernetesNetworkPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesNetworkPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesNetworkPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesNetworkPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "CniConfig", "CniType", "PodNetworkCidr", "ServiceCidr", "ClusterProfiles", "Organization")
