...
KubernetesVersionPolicyList<PSCustomObject>
#>

function Initialize-IntersightKubernetesVersionPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesVersionPolicyList' | Write-Debug
...
Convert from JSON to KubernetesVersionPolicyList<PSCustomObject>
...
KubernetesVersionPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesVersionPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesVersionPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesVersionPolicyList
