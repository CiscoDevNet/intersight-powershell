...
CondAlarmAggregationList<PSCustomObject>
#>

function Initialize-IntersightCondAlarmAggregationList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCondAlarmAggregationList' | Write-Debug
...
Convert from JSON to CondAlarmAggregationList<PSCustomObject>
...
CondAlarmAggregationList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCondAlarmAggregationList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCondAlarmAggregationList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCondAlarmAggregationList
