...
function ConvertFrom-IntersightJsonToAssetTargetAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "ClaimedByUserName", "Connections", "ConnectorVersion", "ExternalIpAddress", "IpAddress", "Name", "ProductId", "ReadOnly", "Services", "Status", "StatusErrorReason", "TargetId", "TargetType", "Account", "Assist", "RegisteredDevice")
