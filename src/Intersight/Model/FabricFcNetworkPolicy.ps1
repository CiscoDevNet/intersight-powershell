...
FabricFcNetworkPolicy<PSCustomObject>
#>

function Initialize-IntersightFabricFcNetworkPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.FcNetworkPolicy")]
        [String]
        ${ClassId} = "fabric.FcNetworkPolicy",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.FcNetworkPolicy")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricFcNetworkPolicy' | Write-Debug
...
Convert from JSON to FabricFcNetworkPolicy<PSCustomObject>
...
FabricFcNetworkPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricFcNetworkPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricFcNetworkPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricFcNetworkPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "EnableTrunking", "Organization", "Profiles")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "EnableTrunking"))) { #optional property not found
            $EnableTrunking = $null
        } else {
            $EnableTrunking = $JsonParameters.PSobject.Properties["EnableTrunking"].value
        }
