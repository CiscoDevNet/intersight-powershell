...
Type to represent switch ports. A common port naming convention is to identify a port as ""slotId/portId"" when no breakout port is configured and ""slotId/aggregatePortId/portId"" when a breakout port is configured.
...
FabricPortIdentifier<PSCustomObject>
#>

function Initialize-IntersightFabricPortIdentifier {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricPortIdentifier' | Write-Debug
...
Convert from JSON to FabricPortIdentifier<PSCustomObject>
...
FabricPortIdentifier<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricPortIdentifier {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricPortIdentifier' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricPortIdentifier
