...
HyperflexConfigResultEntry<PSCustomObject>
#>

function Initialize-IntersightHyperflexConfigResultEntry {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.ConfigResultEntry")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexConfigResultEntry' | Write-Debug
...
Convert from JSON to HyperflexConfigResultEntry<PSCustomObject>
...
HyperflexConfigResultEntry<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexConfigResultEntry {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexConfigResultEntry' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexConfigResultEntry
