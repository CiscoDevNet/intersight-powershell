...
function ConvertFrom-IntersightJsonToHclHyperflexSoftwareCompatibilityInfo {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Constraints", "HxdpVersion", "HypervisorType", "HypervisorVersion", "ServerFwVersion", "AppCatalog")
