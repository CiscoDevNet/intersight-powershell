...
HclHyperflexSoftwareCompatibilityInfo<PSCustomObject>
#>

function Initialize-IntersightHclHyperflexSoftwareCompatibilityInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHclHyperflexSoftwareCompatibilityInfo' | Write-Debug
...
Convert from JSON to HclHyperflexSoftwareCompatibilityInfo<PSCustomObject>
...
HclHyperflexSoftwareCompatibilityInfo<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHclHyperflexSoftwareCompatibilityInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHclHyperflexSoftwareCompatibilityInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHclHyperflexSoftwareCompatibilityInfo
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Constraints", "HxdpVersion", "HypervisorType", "HypervisorVersion", "ServerFwVersion", "AppCatalog")
