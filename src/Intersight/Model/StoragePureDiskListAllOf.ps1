...
StoragePureDiskListAllOf<PSCustomObject>
#>

function Initialize-IntersightStoragePureDiskListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePureDiskListAllOf' | Write-Debug
...
Convert from JSON to StoragePureDiskListAllOf<PSCustomObject>
...
StoragePureDiskListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePureDiskListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePureDiskListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePureDiskListAllOf
