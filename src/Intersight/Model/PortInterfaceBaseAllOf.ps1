...
PortInterfaceBaseAllOf<PSCustomObject>
#>

function Initialize-IntersightPortInterfaceBaseAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPortInterfaceBaseAllOf' | Write-Debug
...
Convert from JSON to PortInterfaceBaseAllOf<PSCustomObject>
...
PortInterfaceBaseAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPortInterfaceBaseAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPortInterfaceBaseAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPortInterfaceBaseAllOf
        $AllProperties = ("ClassId", "ObjectType", "OperState", "AcknowledgedPeerInterface", "PeerInterface")
