...
InventoryGenericInventoryListAllOf<PSCustomObject>
#>

function Initialize-IntersightInventoryGenericInventoryListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightInventoryGenericInventoryListAllOf' | Write-Debug
...
Convert from JSON to InventoryGenericInventoryListAllOf<PSCustomObject>
...
InventoryGenericInventoryListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToInventoryGenericInventoryListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightInventoryGenericInventoryListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightInventoryGenericInventoryListAllOf
