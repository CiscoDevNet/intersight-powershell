...
.PARAMETER WebUiRequest
The body content of the UI HTTP request to send to the BMC platform.
.OUTPUTS

ImcconnectorWebUiMessage<PSCustomObject>
#>

function Initialize-IntersightImcconnectorWebUiMessage {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("imcconnector.WebUiMessage")]
        [String]
        ${ClassId} = "imcconnector.WebUiMessage",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("imcconnector.WebUiMessage")]
        [String]
        ${ObjectType} = "imcconnector.WebUiMessage",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${EncryptedAesKey},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightImcconnectorWebUiMessage' | Write-Debug
...
Convert from JSON to ImcconnectorWebUiMessage<PSCustomObject>
...
ImcconnectorWebUiMessage<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToImcconnectorWebUiMessage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightImcconnectorWebUiMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightImcconnectorWebUiMessage
        $AllProperties = ("ClassId", "ObjectType", "EncryptedAesKey", "EncryptionKey", "SecureProperties", "RemoteUserLocale", "RemoteUserName", "RemoteUserRoles", "RemoteUserSessionId", "WebUiRequest")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "WebUiRequest"))) { #optional property not found
            $WebUiRequest = $null
        } else {
            $WebUiRequest = $JsonParameters.PSobject.Properties["WebUiRequest"].value
        }
