...
VirtualizationBaseHypervisorManager<PSCustomObject>
#>

function Initialize-IntersightVirtualizationBaseHypervisorManager {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.CiscoHypervisorManager", "virtualization.VmwareVcenter")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.CiscoHypervisorManager", "virtualization.VmwareVcenter")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationBaseHypervisorManager' | Write-Debug
...
Convert from JSON to VirtualizationBaseHypervisorManager<PSCustomObject>
...
VirtualizationBaseHypervisorManager<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationBaseHypervisorManager {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationBaseHypervisorManager' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationBaseHypervisorManager
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Identity", "Name", "Version", "RegisteredDevice")
