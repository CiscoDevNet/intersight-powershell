...
HyperflexFeatureLimitInternalListAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexFeatureLimitInternalListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexFeatureLimitInternalListAllOf' | Write-Debug
...
Convert from JSON to HyperflexFeatureLimitInternalListAllOf<PSCustomObject>
...
HyperflexFeatureLimitInternalListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexFeatureLimitInternalListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexFeatureLimitInternalListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexFeatureLimitInternalListAllOf
