...
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryPolicy {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Goals", "LocalSecurity", "LogicalNamespaces", "ManagementMode", "RetainNamespaces", "Organization", "Profiles")
