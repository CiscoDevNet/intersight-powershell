...
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryPolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Goals", "LocalSecurity", "LogicalNamespaces", "ManagementMode", "RetainNamespaces", "Organization", "Profiles")
