...
MemoryPersistentMemoryPolicy<PSCustomObject>
#>

function Initialize-IntersightMemoryPersistentMemoryPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("memory.PersistentMemoryPolicy")]
        [String]
        ${ClassId} = "memory.PersistentMemoryPolicy",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("memory.PersistentMemoryPolicy")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMemoryPersistentMemoryPolicy' | Write-Debug
...
Convert from JSON to MemoryPersistentMemoryPolicy<PSCustomObject>
...
MemoryPersistentMemoryPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMemoryPersistentMemoryPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMemoryPersistentMemoryPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Goals", "LocalSecurity", "LogicalNamespaces", "ManagementMode", "RetainNamespaces", "Organization", "Profiles")
