...
TelemetryDruidFragmentSearchSpec<PSCustomObject>
#>

function Initialize-IntersightTelemetryDruidFragmentSearchSpec {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTelemetryDruidFragmentSearchSpec' | Write-Debug
...
Convert from JSON to TelemetryDruidFragmentSearchSpec<PSCustomObject>
...
TelemetryDruidFragmentSearchSpec<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTelemetryDruidFragmentSearchSpec {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTelemetryDruidFragmentSearchSpec' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTelemetryDruidFragmentSearchSpec
        $AllProperties = ("type", "values", "case_sensitive")
