...
KvmSessionList<PSCustomObject>
#>

function Initialize-IntersightKvmSessionList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKvmSessionList' | Write-Debug
...
Convert from JSON to KvmSessionList<PSCustomObject>
...
KvmSessionList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKvmSessionList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKvmSessionList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKvmSessionList
