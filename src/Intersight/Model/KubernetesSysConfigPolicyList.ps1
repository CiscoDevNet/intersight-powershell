...
KubernetesSysConfigPolicyList<PSCustomObject>
#>

function Initialize-IntersightKubernetesSysConfigPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesSysConfigPolicyList' | Write-Debug
...
Convert from JSON to KubernetesSysConfigPolicyList<PSCustomObject>
...
KubernetesSysConfigPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesSysConfigPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesSysConfigPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesSysConfigPolicyList
