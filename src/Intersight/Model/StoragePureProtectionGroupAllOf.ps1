...
StoragePureProtectionGroupAllOf<PSCustomObject>
#>

function Initialize-IntersightStoragePureProtectionGroupAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePureProtectionGroupAllOf' | Write-Debug
...
Convert from JSON to StoragePureProtectionGroupAllOf<PSCustomObject>
...
StoragePureProtectionGroupAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePureProtectionGroupAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePureProtectionGroupAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePureProtectionGroupAllOf
        $AllProperties = ("ClassId", "ObjectType", "Size", "Source", "Targets", "Array", "HostGroups", "Hosts", "RegisteredDevice", "Volumes")
