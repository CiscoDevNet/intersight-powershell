...
InventoryDnMoBindingList<PSCustomObject>
#>

function Initialize-IntersightInventoryDnMoBindingList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightInventoryDnMoBindingList' | Write-Debug
...
Convert from JSON to InventoryDnMoBindingList<PSCustomObject>
...
InventoryDnMoBindingList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToInventoryDnMoBindingList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightInventoryDnMoBindingList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightInventoryDnMoBindingList
