...
VnicRssHashSettings<PSCustomObject>
#>

function Initialize-IntersightVnicRssHashSettings {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("vnic.RssHashSettings")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVnicRssHashSettings' | Write-Debug
...
Convert from JSON to VnicRssHashSettings<PSCustomObject>
...
VnicRssHashSettings<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVnicRssHashSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVnicRssHashSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVnicRssHashSettings
        $AllProperties = ("ClassId", "ObjectType", "Ipv4Hash", "Ipv6ExtHash", "Ipv6Hash", "TcpIpv4Hash", "TcpIpv6ExtHash", "TcpIpv6Hash", "UdpIpv4Hash", "UdpIpv6Hash")
