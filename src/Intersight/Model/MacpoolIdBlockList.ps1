...
MacpoolIdBlockList<PSCustomObject>
#>

function Initialize-IntersightMacpoolIdBlockList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMacpoolIdBlockList' | Write-Debug
...
Convert from JSON to MacpoolIdBlockList<PSCustomObject>
...
MacpoolIdBlockList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMacpoolIdBlockList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMacpoolIdBlockList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMacpoolIdBlockList
