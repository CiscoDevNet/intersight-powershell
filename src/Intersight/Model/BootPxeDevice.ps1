...
BootPxeDevice<PSCustomObject>
#>

function Initialize-IntersightBootPxeDevice {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.PxeDevice")]
        [String]
        ${ClassId} = "boot.PxeDevice",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.PxeDevice")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootPxeDevice' | Write-Debug
...
Convert from JSON to BootPxeDevice<PSCustomObject>
...
BootPxeDevice<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootPxeDevice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootPxeDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootPxeDevice
