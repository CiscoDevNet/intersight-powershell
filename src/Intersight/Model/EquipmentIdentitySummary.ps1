...
function ConvertFrom-IntersightJsonToEquipmentIdentitySummary {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AdapterSerial", "AdminAction", "AdminActionState", "ChassisId", "DeviceMoId", "Identifier", "IoCardIdentityList", "Lifecycle", "Model", "PendingDiscovery", "Serial", "SlotId", "SourceObjectType", "SwitchId", "Vendor", "DeviceRegistration")
