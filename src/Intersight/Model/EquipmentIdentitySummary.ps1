...
function ConvertFrom-IntersightJsonToEquipmentIdentitySummary {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AdapterSerial", "AdminAction", "AdminActionState", "ChassisId", "DeviceMoId", "Identifier", "IoCardIdentityList", "Lifecycle", "Model", "PendingDiscovery", "Serial", "SlotId", "SourceObjectType", "SwitchId", "Vendor", "DeviceRegistration")
