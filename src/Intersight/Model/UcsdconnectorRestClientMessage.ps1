...
UcsdconnectorRestClientMessage<PSCustomObject>
#>

function Initialize-IntersightUcsdconnectorRestClientMessage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightUcsdconnectorRestClientMessage' | Write-Debug
...
Convert from JSON to UcsdconnectorRestClientMessage<PSCustomObject>
...
UcsdconnectorRestClientMessage<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToUcsdconnectorRestClientMessage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightUcsdconnectorRestClientMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightUcsdconnectorRestClientMessage
        $AllProperties = ("ClassId", "ObjectType", "EncryptedAesKey", "EncryptionKey", "SecureProperties", "RemoteUserLocale", "RemoteUserName", "RemoteUserRoles", "RemoteUserSessionId", "Body", "Header", "Method", "RestUrl")
