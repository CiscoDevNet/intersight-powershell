...
function ConvertFrom-IntersightJsonToStoragePhysicalDiskExtension {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Bootable", "DiskDn", "DiskId", "DiskState", "Health", "InventoryDeviceInfo", "PhysicalDisk", "RegisteredDevice", "StorageController")
