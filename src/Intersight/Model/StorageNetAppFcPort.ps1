...
StorageNetAppFcPort<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppFcPort {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.NetAppFcPort")]
        [String]
        ${ClassId} = "storage.NetAppFcPort",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.NetAppFcPort")]
        [String]
        ${ObjectType} = "storage.NetAppFcPort",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppFcPort' | Write-Debug
...
Convert from JSON to StorageNetAppFcPort<PSCustomObject>
...
StorageNetAppFcPort<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppFcPort {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppFcPort' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppFcPort
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Iqn", "Name", "Speed", "Status", "Type", "Wwn", "Wwnn", "Wwpn", "PortStatus", "State", "Uuid", "ArrayController")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "PortStatus"))) { #optional property not found
            $PortStatus = $null
        } else {
            $PortStatus = $JsonParameters.PSobject.Properties["PortStatus"].value
        }
