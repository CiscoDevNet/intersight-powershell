...
function ConvertFrom-IntersightJsonToFirmwareDistributableMeta {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "BucketName", "FileType", "FromVersion", "Mdfid", "SoftwareTypeId", "Source", "SupportedModels", "ToVersion")
