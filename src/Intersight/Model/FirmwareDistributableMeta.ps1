...
function ConvertFrom-IntersightJsonToFirmwareDistributableMeta {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "BucketName", "FileType", "FromVersion", "Mdfid", "SoftwareTypeId", "Source", "SupportedModels", "ToVersion")
