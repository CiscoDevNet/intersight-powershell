...
HyperflexClusterNetworkPolicyList<PSCustomObject>
#>

function Initialize-IntersightHyperflexClusterNetworkPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexClusterNetworkPolicyList' | Write-Debug
...
Convert from JSON to HyperflexClusterNetworkPolicyList<PSCustomObject>
...
HyperflexClusterNetworkPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexClusterNetworkPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexClusterNetworkPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexClusterNetworkPolicyList
