...
HyperflexServerFirmwareVersionListAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexServerFirmwareVersionListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexServerFirmwareVersionListAllOf' | Write-Debug
...
Convert from JSON to HyperflexServerFirmwareVersionListAllOf<PSCustomObject>
...
HyperflexServerFirmwareVersionListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexServerFirmwareVersionListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexServerFirmwareVersionListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexServerFirmwareVersionListAllOf
