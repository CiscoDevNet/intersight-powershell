...
FirmwareBiosDescriptor<PSCustomObject>
#>

function Initialize-IntersightFirmwareBiosDescriptor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareBiosDescriptor' | Write-Debug
...
Convert from JSON to FirmwareBiosDescriptor<PSCustomObject>
...
FirmwareBiosDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareBiosDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareBiosDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareBiosDescriptor
