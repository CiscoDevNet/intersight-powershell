...
TaskHitachiScopedInventory<PSCustomObject>
#>

function Initialize-IntersightTaskHitachiScopedInventory {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("task.HitachiScopedInventory")]
        [String]
        ${ClassId} = "task.HitachiScopedInventory",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("task.HitachiScopedInventory")]
        [String]
        ${ObjectType} = "task.HitachiScopedInventory",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTaskHitachiScopedInventory' | Write-Debug
...
Convert from JSON to TaskHitachiScopedInventory<PSCustomObject>
...
TaskHitachiScopedInventory<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTaskHitachiScopedInventory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTaskHitachiScopedInventory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTaskHitachiScopedInventory
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "NamingProperty", "Queries", "Type", "Values", "RegisteredDevice")
