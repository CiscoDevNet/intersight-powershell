...
ServerConfigChangeDetailList<PSCustomObject>
#>

function Initialize-IntersightServerConfigChangeDetailList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightServerConfigChangeDetailList' | Write-Debug
...
Convert from JSON to ServerConfigChangeDetailList<PSCustomObject>
...
ServerConfigChangeDetailList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToServerConfigChangeDetailList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightServerConfigChangeDetailList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightServerConfigChangeDetailList
