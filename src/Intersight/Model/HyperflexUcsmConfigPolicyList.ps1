...
HyperflexUcsmConfigPolicyList<PSCustomObject>
#>

function Initialize-IntersightHyperflexUcsmConfigPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexUcsmConfigPolicyList' | Write-Debug
...
Convert from JSON to HyperflexUcsmConfigPolicyList<PSCustomObject>
...
HyperflexUcsmConfigPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexUcsmConfigPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexUcsmConfigPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexUcsmConfigPolicyList
