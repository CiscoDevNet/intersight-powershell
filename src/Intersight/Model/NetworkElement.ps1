...
function ConvertFrom-IntersightJsonToNetworkElement {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "AdminEvacState", "AdminInbandInterfaceState", "AlarmSummary", "AvailableMemory", "EthernetMode", "EthernetSwitchingMode", "FaultSummary", "FcMode", "FcSwitchingMode", "InbandIpAddress", "InbandIpGateway", "InbandIpMask", "InbandVlan", "ManagementMode", "OperEvacState", "Operability", "OutOfBandIpAddress", "OutOfBandIpGateway", "OutOfBandIpMask", "OutOfBandIpv4Address", "OutOfBandIpv4Gateway", "OutOfBandIpv4Mask", "OutOfBandIpv6Address", "OutOfBandIpv6Gateway", "OutOfBandIpv6Prefix", "OutOfBandMac", "SwitchId", "TotalMemory", "Cards", "Fanmodules", "InventoryDeviceInfo", "ManagementController", "ManagementEntity", "NetworkFcZoneInfo", "NetworkVlanPortInfo", "PortMacBindings", "Psus", "RegisteredDevice", "StorageItems", "TopSystem", "UcsmRunningFirmware")
