...
NiaapiNibMetadataListAllOf<PSCustomObject>
#>

function Initialize-IntersightNiaapiNibMetadataListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiNibMetadataListAllOf' | Write-Debug
...
Convert from JSON to NiaapiNibMetadataListAllOf<PSCustomObject>
...
NiaapiNibMetadataListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiNibMetadataListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiNibMetadataListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiNibMetadataListAllOf
