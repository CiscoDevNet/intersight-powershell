...
ConnectorScopedInventory<PSCustomObject>
#>

function Initialize-IntersightConnectorScopedInventory {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("task.HitachiScopedInventory", "task.NetAppScopedInventory", "task.PureScopedInventory")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("task.HitachiScopedInventory", "task.NetAppScopedInventory", "task.PureScopedInventory")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConnectorScopedInventory' | Write-Debug
...
Convert from JSON to ConnectorScopedInventory<PSCustomObject>
...
ConnectorScopedInventory<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConnectorScopedInventory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConnectorScopedInventory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConnectorScopedInventory
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "NamingProperty", "Queries", "Type", "Values")
