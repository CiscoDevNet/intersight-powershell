...
IamLdapBasePropertiesAllOf<PSCustomObject>
#>

function Initialize-IntersightIamLdapBasePropertiesAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamLdapBasePropertiesAllOf' | Write-Debug
...
Convert from JSON to IamLdapBasePropertiesAllOf<PSCustomObject>
...
IamLdapBasePropertiesAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamLdapBasePropertiesAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamLdapBasePropertiesAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamLdapBasePropertiesAllOf
        $AllProperties = ("Attribute", "BaseDn", "BindDn", "BindMethod", "Domain", "EnableEncryption", "EnableGroupAuthorization", "Filter", "GroupAttribute", "IsPasswordSet", "NestedGroupSearchDepth", "Password", "Timeout")
