...
HyperflexAlarmList<PSCustomObject>
#>

function Initialize-IntersightHyperflexAlarmList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexAlarmList' | Write-Debug
...
Convert from JSON to HyperflexAlarmList<PSCustomObject>
...
HyperflexAlarmList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexAlarmList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexAlarmList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexAlarmList
