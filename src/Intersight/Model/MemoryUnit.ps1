...
function ConvertFrom-IntersightJsonToMemoryUnit {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "AdminState", "ArrayId", "Bank", "Capacity", "Clock", "FormFactor", "Latency", "Location", "OperPowerState", "OperState", "Operability", "Presence", "Set", "Speed", "Thermal", "Type", "Visibility", "Width", "MemoryId", "InventoryDeviceInfo", "MemoryArray", "RegisteredDevice")
