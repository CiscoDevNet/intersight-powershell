...
MemoryUnit<PSCustomObject>
#>

function Initialize-IntersightMemoryUnit {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("memory.Unit")]
        [String]
        ${ClassId} = "memory.Unit",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("memory.Unit")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMemoryUnit' | Write-Debug
...
Convert from JSON to MemoryUnit<PSCustomObject>
...
MemoryUnit<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMemoryUnit {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
