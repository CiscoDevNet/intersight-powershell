...
function ConvertFrom-IntersightJsonToStoragePhysicalDiskAllOf {
    ...
    Process {
        ...
        $AllProperties = ("BlockSize", "Bootable", "ConfigurationCheckpoint", "ConfigurationState", "DiscoveredPath", "DiskId", "DiskState", "DriveFirmware", "DriveState", "FdeCapable", "HotSpareType", "LinkSpeed", "LinkState", "NumBlocks", "OperPowerState", "OperQualifierReason", "Operability", "PhysicalBlockSize", "Pid", "Presence", "Protocol", "RawSize", "Secured", "Size", "Thermal", "Type", "VariantType", "InventoryDeviceInfo", "LocatorLed", "PhysicalDiskExtensions", "RegisteredDevice", "RunningFirmware", "SasPorts", "StorageController", "StorageEnclosure")
