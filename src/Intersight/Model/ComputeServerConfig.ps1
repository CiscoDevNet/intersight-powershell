...
ComputeServerConfig<PSCustomObject>
#>

function Initialize-IntersightComputeServerConfig {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("compute.ServerConfig")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightComputeServerConfig' | Write-Debug
...
Convert from JSON to ComputeServerConfig<PSCustomObject>
...
ComputeServerConfig<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToComputeServerConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightComputeServerConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightComputeServerConfig
        $AllProperties = ("ClassId", "ObjectType", "AssetTag", "UserLabel")
