...
NiatelemetryApicFanDetailsList<PSCustomObject>
#>

function Initialize-IntersightNiatelemetryApicFanDetailsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiatelemetryApicFanDetailsList' | Write-Debug
...
Convert from JSON to NiatelemetryApicFanDetailsList<PSCustomObject>
...
NiatelemetryApicFanDetailsList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiatelemetryApicFanDetailsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiatelemetryApicFanDetailsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiatelemetryApicFanDetailsList
