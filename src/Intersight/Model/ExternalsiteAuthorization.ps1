...
ExternalsiteAuthorization<PSCustomObject>
#>

function Initialize-IntersightExternalsiteAuthorization {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("externalsite.Authorization")]
        [String]
        ${ClassId} = "externalsite.Authorization",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("externalsite.Authorization")]
        [String]
        ${ObjectType} = "externalsite.Authorization",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightExternalsiteAuthorization' | Write-Debug
...
Convert from JSON to ExternalsiteAuthorization<PSCustomObject>
...
ExternalsiteAuthorization<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToExternalsiteAuthorization {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightExternalsiteAuthorization' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightExternalsiteAuthorization
