...
function ConvertFrom-IntersightJsonToHyperflexCluster {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AlarmSummary", "CapacityRunway", "ClusterName", "ClusterType", "ClusterUuid", "ComputeNodeCount", "ConvergedNodeCount", "DeploymentType", "DeviceId", "FltAggr", "HxVersion", "HxdpBuildVersion", "HypervisorType", "HypervisorVersion", "Summary", "UtilizationPercentage", "UtilizationTrendPercentage", "VmCount", "Alarm", "Health", "Nodes", "RegisteredDevice", "StorageContainers", "Volumes")
