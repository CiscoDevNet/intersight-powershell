...
function ConvertFrom-IntersightJsonToCapabilityEquipmentSlotArrayAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "FirstIndex", "Height", "HorizontalStartOffset", "InlineGroupSeparation", "InlineGroupSize", "InlineOffset", "Location", "NumberOfSlots", "Orientation", "Selector", "SlotsPerLine", "TransverseGroupSeparation", "TransverseGroupSize", "TransverseOffset", "VerticalStartOffset", "Width")
