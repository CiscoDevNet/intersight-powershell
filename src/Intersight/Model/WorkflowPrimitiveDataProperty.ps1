...
WorkflowPrimitiveDataProperty<PSCustomObject>
#>

function Initialize-IntersightWorkflowPrimitiveDataProperty {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowPrimitiveDataProperty' | Write-Debug
...
Convert from JSON to WorkflowPrimitiveDataProperty<PSCustomObject>
...
WorkflowPrimitiveDataProperty<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowPrimitiveDataProperty {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowPrimitiveDataProperty' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowPrimitiveDataProperty
