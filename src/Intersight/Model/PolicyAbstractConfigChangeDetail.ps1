...
function Initialize-IntersightPolicyAbstractConfigChangeDetail {
    ...
    Param (
        ...
        [ValidateSet("chassis.ConfigChangeDetail", "fabric.ConfigChangeDetail", "server.ConfigChangeDetail")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("chassis.ConfigChangeDetail", "fabric.ConfigChangeDetail", "server.ConfigChangeDetail")]
...
function ConvertFrom-IntersightJsonToPolicyAbstractConfigChangeDetail {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Changes", "ConfigChangeContext", "ConfigChangeFlag", "Disruptions", "Message", "ModStatus")
