...
MacpoolPool<PSCustomObject>
#>

function Initialize-IntersightMacpoolPool {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("macpool.Pool")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMacpoolPool' | Write-Debug
        ...
        if (!$MacBlocks -and $MacBlocks.length -lt 1) {
            throw "invalid value for 'MacBlocks', number of items must be greater than or equal to 1."
        }
...
Convert from JSON to MacpoolPool<PSCustomObject>
...
MacpoolPool<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMacpoolPool {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMacpoolPool' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMacpoolPool
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Assigned", "AssignmentOrder", "Size", "MacBlocks", "BlockHeads", "Organization")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "MacBlocks"))) { #optional property not found
            $MacBlocks = $null
        } else {
            $MacBlocks = $JsonParameters.PSobject.Properties["MacBlocks"].value
        }
