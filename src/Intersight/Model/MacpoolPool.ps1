...
function ConvertFrom-IntersightJsonToMacpoolPool {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Assigned", "AssignmentOrder", "Size", "MacBlocks", "BlockHeads", "Organization")
