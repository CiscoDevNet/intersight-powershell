...
function ConvertFrom-IntersightJsonToComputeBoard {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "BoardId", "CpuTypeController", "OperPowerState", "OperReason", "Presence", "ComputeBlade", "ComputeRackUnit", "EquipmentTpms", "GraphicsCards", "InventoryDeviceInfo", "MemoryArrays", "PciCoprocessorCards", "PciSwitch", "PersistentMemoryConfiguration", "Processors", "RegisteredDevice", "SecurityUnits", "StorageControllers", "StorageFlexFlashControllers", "StorageFlexUtilControllers")
