...
function ConvertFrom-IntersightJsonToSnmpPolicyAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccessCommunityString", "CommunityAccess", "Enabled", "EngineId", "SnmpPort", "SnmpTraps", "SnmpUsers", "SysContact", "SysLocation", "TrapCommunity", "Organization", "Profiles")
