...
VnicFcInterruptSettings<PSCustomObject>
#>

function Initialize-IntersightVnicFcInterruptSettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVnicFcInterruptSettings' | Write-Debug
...
Convert from JSON to VnicFcInterruptSettings<PSCustomObject>
...
VnicFcInterruptSettings<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVnicFcInterruptSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVnicFcInterruptSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVnicFcInterruptSettings
