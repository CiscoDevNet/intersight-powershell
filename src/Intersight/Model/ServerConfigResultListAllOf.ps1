...
ServerConfigResultListAllOf<PSCustomObject>
#>

function Initialize-IntersightServerConfigResultListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightServerConfigResultListAllOf' | Write-Debug
...
Convert from JSON to ServerConfigResultListAllOf<PSCustomObject>
...
ServerConfigResultListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToServerConfigResultListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightServerConfigResultListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightServerConfigResultListAllOf
