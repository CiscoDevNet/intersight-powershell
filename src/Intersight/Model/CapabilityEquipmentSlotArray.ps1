...
function ConvertFrom-IntersightJsonToCapabilityEquipmentSlotArray {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Section", "Pid", "Sku", "Vid", "FirstIndex", "Height", "HorizontalStartOffset", "InlineGroupSeparation", "InlineGroupSize", "InlineOffset", "Location", "NumberOfSlots", "Orientation", "Selector", "SlotsPerLine", "TransverseGroupSeparation", "TransverseGroupSize", "TransverseOffset", "VerticalStartOffset", "Width")
