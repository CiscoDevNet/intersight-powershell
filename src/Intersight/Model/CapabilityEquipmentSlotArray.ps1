...
function ConvertFrom-IntersightJsonToCapabilityEquipmentSlotArray {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Pid", "Sku", "Vid", "FirstIndex", "Height", "HorizontalStartOffset", "InlineGroupSeparation", "InlineGroupSize", "InlineOffset", "Location", "NumberOfSlots", "Orientation", "Selector", "SlotsPerLine", "TransverseGroupSeparation", "TransverseGroupSize", "TransverseOffset", "VerticalStartOffset", "Width")
