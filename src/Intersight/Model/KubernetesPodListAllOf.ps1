...
KubernetesPodListAllOf<PSCustomObject>
#>

function Initialize-IntersightKubernetesPodListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesPodListAllOf' | Write-Debug
...
Convert from JSON to KubernetesPodListAllOf<PSCustomObject>
...
KubernetesPodListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesPodListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesPodListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesPodListAllOf
