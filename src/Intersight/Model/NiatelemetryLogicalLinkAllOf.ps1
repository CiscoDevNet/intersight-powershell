...
Definition of the list of properties defined in 'niatelemetry.LogicalLink', excluding properties defined in parent classes.
...
NiatelemetryLogicalLinkAllOf<PSCustomObject>
#>

function Initialize-IntersightNiatelemetryLogicalLinkAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiatelemetryLogicalLinkAllOf' | Write-Debug
...
Convert from JSON to NiatelemetryLogicalLinkAllOf<PSCustomObject>
...
NiatelemetryLogicalLinkAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiatelemetryLogicalLinkAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiatelemetryLogicalLinkAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiatelemetryLogicalLinkAllOf
