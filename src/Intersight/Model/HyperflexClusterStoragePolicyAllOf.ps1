...
HyperflexClusterStoragePolicyAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexClusterStoragePolicyAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexClusterStoragePolicyAllOf' | Write-Debug
...
Convert from JSON to HyperflexClusterStoragePolicyAllOf<PSCustomObject>
...
HyperflexClusterStoragePolicyAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexClusterStoragePolicyAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexClusterStoragePolicyAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexClusterStoragePolicyAllOf
        $AllProperties = ("ClassId", "ObjectType", "DiskPartitionCleanup", "LogicalAvalabilityZoneConfig", "VdiOptimization", "ClusterProfiles", "Organization")
