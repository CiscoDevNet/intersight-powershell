...
SdcardPartitionAllOf<PSCustomObject>
#>

function Initialize-IntersightSdcardPartitionAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("sdcard.Partition")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSdcardPartitionAllOf' | Write-Debug
...
Convert from JSON to SdcardPartitionAllOf<PSCustomObject>
...
SdcardPartitionAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSdcardPartitionAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSdcardPartitionAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSdcardPartitionAllOf
        $AllProperties = ("ClassId", "ObjectType", "Type", "VirtualDrives")
