...
CondAlarmAggregationListAllOf<PSCustomObject>
#>

function Initialize-IntersightCondAlarmAggregationListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCondAlarmAggregationListAllOf' | Write-Debug
...
Convert from JSON to CondAlarmAggregationListAllOf<PSCustomObject>
...
CondAlarmAggregationListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCondAlarmAggregationListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCondAlarmAggregationListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCondAlarmAggregationListAllOf
