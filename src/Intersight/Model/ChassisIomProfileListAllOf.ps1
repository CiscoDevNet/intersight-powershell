...
ChassisIomProfileListAllOf<PSCustomObject>
#>

function Initialize-IntersightChassisIomProfileListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightChassisIomProfileListAllOf' | Write-Debug
...
Convert from JSON to ChassisIomProfileListAllOf<PSCustomObject>
...
ChassisIomProfileListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToChassisIomProfileListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightChassisIomProfileListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightChassisIomProfileListAllOf
