...
LicenseAccountLicenseDataList<PSCustomObject>
#>

function Initialize-IntersightLicenseAccountLicenseDataList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightLicenseAccountLicenseDataList' | Write-Debug
...
Convert from JSON to LicenseAccountLicenseDataList<PSCustomObject>
...
LicenseAccountLicenseDataList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToLicenseAccountLicenseDataList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightLicenseAccountLicenseDataList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightLicenseAccountLicenseDataList
