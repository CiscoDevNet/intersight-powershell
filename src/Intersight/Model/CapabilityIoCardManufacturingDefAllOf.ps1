...
CapabilityIoCardManufacturingDefAllOf<PSCustomObject>
#>

function Initialize-IntersightCapabilityIoCardManufacturingDefAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilityIoCardManufacturingDefAllOf' | Write-Debug
...
Convert from JSON to CapabilityIoCardManufacturingDefAllOf<PSCustomObject>
...
CapabilityIoCardManufacturingDefAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilityIoCardManufacturingDefAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilityIoCardManufacturingDefAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilityIoCardManufacturingDefAllOf
