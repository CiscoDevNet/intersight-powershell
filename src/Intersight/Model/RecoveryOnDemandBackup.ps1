...
function ConvertFrom-IntersightJsonToRecoveryOnDemandBackup {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "FileNamePrefix", "IsPasswordSet", "LocationType", "Password", "Path", "Protocol", "RetentionCount", "UserName", "ConfigResult", "DeviceId", "Organization")
