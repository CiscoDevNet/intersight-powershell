...
function ConvertFrom-IntersightJsonToWorkflowWorkflowMeta {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "InputParameters", "Name", "OutputParameters", "Retryable", "SchemaVersion", "Src", "Tasks", "Type", "Version", "WaitOnDuplicate", "Organization")
