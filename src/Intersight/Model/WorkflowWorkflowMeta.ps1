...
function ConvertFrom-IntersightJsonToWorkflowWorkflowMeta {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "InputParameters", "Name", "OutputParameters", "Retryable", "SchemaVersion", "Src", "Tasks", "Type", "Version", "WaitOnDuplicate", "Organization")
