...
WorkflowWorkflowMeta<PSCustomObject>
#>

function Initialize-IntersightWorkflowWorkflowMeta {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowWorkflowMeta' | Write-Debug
...
Convert from JSON to WorkflowWorkflowMeta<PSCustomObject>
...
WorkflowWorkflowMeta<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowWorkflowMeta {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowWorkflowMeta' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowWorkflowMeta
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "InputParameters", "Name", "OutputParameters", "Retryable", "SchemaVersion", "Src", "Tasks", "Type", "Version", "WaitOnDuplicate", "Organization")
