...
FirmwareRunningFirmware<PSCustomObject>
#>

function Initialize-IntersightFirmwareRunningFirmware {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("firmware.RunningFirmware")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareRunningFirmware' | Write-Debug
...
Convert from JSON to FirmwareRunningFirmware<PSCustomObject>
...
FirmwareRunningFirmware<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareRunningFirmware {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareRunningFirmware' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareRunningFirmware
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Component", "PackageVersion", "Type", "Version", "BiosUnit", "GraphicsCard", "InventoryDeviceInfo", "ManagementController", "NetworkElements", "PciSwitch", "RegisteredDevice", "StorageController", "StorageFlexFlashController", "StoragePhysicalDisk")
