...
function ConvertFrom-IntersightJsonToFirmwareRunningFirmware {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Component", "PackageVersion", "Type", "Version", "BiosUnit", "GraphicsCard", "InventoryDeviceInfo", "ManagementController", "NetworkElements", "PciSwitch", "RegisteredDevice", "StorageController", "StorageFlexFlashController", "StoragePhysicalDisk")
