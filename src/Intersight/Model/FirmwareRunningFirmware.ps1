...
function ConvertFrom-IntersightJsonToFirmwareRunningFirmware {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Component", "PackageVersion", "Type", "Version", "BiosUnit", "GraphicsCard", "InventoryDeviceInfo", "ManagementController", "NetworkElements", "PciSwitch", "RegisteredDevice", "StorageController", "StorageFlexFlashController", "StoragePhysicalDisk")
