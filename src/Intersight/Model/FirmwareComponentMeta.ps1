...
FirmwareComponentMeta<PSCustomObject>
#>

function Initialize-IntersightFirmwareComponentMeta {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareComponentMeta' | Write-Debug
...
Convert from JSON to FirmwareComponentMeta<PSCustomObject>
...
FirmwareComponentMeta<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareComponentMeta {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareComponentMeta' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareComponentMeta
        $AllProperties = ("ClassId", "ObjectType", "ComponentLabel", "ComponentType", "Description", "Disruption", "IsOobSupported", "Model", "OobManageability", "PackedVersion", "RedfishUrl", "Vendor")
