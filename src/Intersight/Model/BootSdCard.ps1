...
BootSdCard<PSCustomObject>
#>

function Initialize-IntersightBootSdCard {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootSdCard' | Write-Debug
...
Convert from JSON to BootSdCard<PSCustomObject>
...
BootSdCard<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootSdCard {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootSdCard' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootSdCard
        $AllProperties = ("ClassId", "ObjectType", "Enabled", "Name", "Bootloader", "Lun", "Subtype")
