...
EquipmentFexAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentFexAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentFexAllOf' | Write-Debug
...
Convert from JSON to EquipmentFexAllOf<PSCustomObject>
...
EquipmentFexAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentFexAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentFexAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentFexAllOf
        $AllProperties = ("ClassId", "ObjectType", "DiscoveryState", "Fans", "InventoryDeviceInfo", "Ioms", "LocatorLed", "NetworkElement", "Psus", "RegisteredDevice")
