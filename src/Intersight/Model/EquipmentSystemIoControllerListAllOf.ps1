...
EquipmentSystemIoControllerListAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentSystemIoControllerListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentSystemIoControllerListAllOf' | Write-Debug
...
Convert from JSON to EquipmentSystemIoControllerListAllOf<PSCustomObject>
...
EquipmentSystemIoControllerListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentSystemIoControllerListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentSystemIoControllerListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentSystemIoControllerListAllOf
