...
PkixDistinguishedName<PSCustomObject>
#>

function Initialize-IntersightPkixDistinguishedName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPkixDistinguishedName' | Write-Debug
...
Convert from JSON to PkixDistinguishedName<PSCustomObject>
...
PkixDistinguishedName<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPkixDistinguishedName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPkixDistinguishedName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPkixDistinguishedName
