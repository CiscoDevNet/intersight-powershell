...
EquipmentFexOperationList<PSCustomObject>
#>

function Initialize-IntersightEquipmentFexOperationList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentFexOperationList' | Write-Debug
...
Convert from JSON to EquipmentFexOperationList<PSCustomObject>
...
EquipmentFexOperationList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentFexOperationList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentFexOperationList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentFexOperationList
