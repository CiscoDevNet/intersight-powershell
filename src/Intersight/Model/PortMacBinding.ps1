...
function ConvertFrom-IntersightJsonToPortMacBinding {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "AggregatePortId", "ChassisId", "DeviceMac", "PortId", "PortMac", "SlotId", "SwitchId", "NetworkElement", "RegisteredDevice")
