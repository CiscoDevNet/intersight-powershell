...
CommAbstractHttpProxyPolicy<PSCustomObject>
#>

function Initialize-IntersightCommAbstractHttpProxyPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("comm.HttpProxyPolicy")]
        [String]
        ${ClassId} = "comm.HttpProxyPolicy",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("comm.HttpProxyPolicy")]
        [String]
        ${ObjectType} = "comm.HttpProxyPolicy",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCommAbstractHttpProxyPolicy' | Write-Debug
...
Convert from JSON to CommAbstractHttpProxyPolicy<PSCustomObject>
...
CommAbstractHttpProxyPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCommAbstractHttpProxyPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCommAbstractHttpProxyPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCommAbstractHttpProxyPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Hostname", "IsPasswordSet", "Password", "Port", "Username", "Organization")
