...
VirtualizationVirtualDiskList<PSCustomObject>
#>

function Initialize-IntersightVirtualizationVirtualDiskList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationVirtualDiskList' | Write-Debug
...
Convert from JSON to VirtualizationVirtualDiskList<PSCustomObject>
...
VirtualizationVirtualDiskList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationVirtualDiskList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationVirtualDiskList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationVirtualDiskList
