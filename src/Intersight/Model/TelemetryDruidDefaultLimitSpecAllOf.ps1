...
TelemetryDruidDefaultLimitSpecAllOf<PSCustomObject>
#>

function Initialize-IntersightTelemetryDruidDefaultLimitSpecAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTelemetryDruidDefaultLimitSpecAllOf' | Write-Debug
...
Convert from JSON to TelemetryDruidDefaultLimitSpecAllOf<PSCustomObject>
...
TelemetryDruidDefaultLimitSpecAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTelemetryDruidDefaultLimitSpecAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTelemetryDruidDefaultLimitSpecAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTelemetryDruidDefaultLimitSpecAllOf
        $AllProperties = ("limit", "columns")
