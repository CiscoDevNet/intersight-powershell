...
function ConvertFrom-IntersightJsonToStorageFlexFlashVirtualDrive {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "DriveScope", "DriveStatus", "PartitionId", "ResidentImage", "Size", "VirtualDrive", "InventoryDeviceInfo", "RegisteredDevice", "StorageFlexFlashController")
