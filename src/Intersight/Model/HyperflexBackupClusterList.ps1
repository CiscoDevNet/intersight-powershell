...
HyperflexBackupClusterList<PSCustomObject>
#>

function Initialize-IntersightHyperflexBackupClusterList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexBackupClusterList' | Write-Debug
...
Convert from JSON to HyperflexBackupClusterList<PSCustomObject>
...
HyperflexBackupClusterList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexBackupClusterList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexBackupClusterList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexBackupClusterList
