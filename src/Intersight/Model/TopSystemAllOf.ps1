...
function ConvertFrom-IntersightJsonToTopSystemAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Ipv4Address", "Ipv6Address", "Mode", "Name", "TimeZone", "ComputeBlades", "ComputeRackUnits", "InventoryDeviceInfo", "ManagementController", "NetworkElements", "RegisteredDevice")
