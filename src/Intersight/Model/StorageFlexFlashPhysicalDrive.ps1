...
StorageFlexFlashPhysicalDrive<PSCustomObject>
#>

function Initialize-IntersightStorageFlexFlashPhysicalDrive {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.FlexFlashPhysicalDrive")]
        [String]
        ${ClassId} = "storage.FlexFlashPhysicalDrive",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.FlexFlashPhysicalDrive")]
        [String]
        ${ObjectType} = "storage.FlexFlashPhysicalDrive",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageFlexFlashPhysicalDrive' | Write-Debug
...
Convert from JSON to StorageFlexFlashPhysicalDrive<PSCustomObject>
...
StorageFlexFlashPhysicalDrive<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageFlexFlashPhysicalDrive {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageFlexFlashPhysicalDrive' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageFlexFlashPhysicalDrive
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "CardStatus", "CardType", "OemId", "PdStatus", "InventoryDeviceInfo", "RegisteredDevice", "StorageFlexFlashController")
