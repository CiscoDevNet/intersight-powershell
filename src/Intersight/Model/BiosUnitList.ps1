...
BiosUnitList<PSCustomObject>
#>

function Initialize-IntersightBiosUnitList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBiosUnitList' | Write-Debug
...
Convert from JSON to BiosUnitList<PSCustomObject>
...
BiosUnitList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBiosUnitList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBiosUnitList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBiosUnitList
