...
EquipmentIoExpanderAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentIoExpanderAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentIoExpanderAllOf' | Write-Debug
...
Convert from JSON to EquipmentIoExpanderAllOf<PSCustomObject>
...
EquipmentIoExpanderAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentIoExpanderAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentIoExpanderAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentIoExpanderAllOf
        $AllProperties = ("ClassId", "ObjectType", "OperState", "Presence", "ComputeBlade", "InventoryDeviceInfo", "RegisteredDevice")
