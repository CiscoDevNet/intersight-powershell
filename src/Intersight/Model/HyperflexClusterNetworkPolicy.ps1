...
HyperflexClusterNetworkPolicy<PSCustomObject>
#>

function Initialize-IntersightHyperflexClusterNetworkPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexClusterNetworkPolicy' | Write-Debug
...
Convert from JSON to HyperflexClusterNetworkPolicy<PSCustomObject>
...
HyperflexClusterNetworkPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexClusterNetworkPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexClusterNetworkPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexClusterNetworkPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "JumboFrame", "KvmIpRange", "MacPrefixRange", "MgmtVlan", "UplinkSpeed", "VmMigrationVlan", "VmNetworkVlans", "ClusterProfiles", "Organization")
