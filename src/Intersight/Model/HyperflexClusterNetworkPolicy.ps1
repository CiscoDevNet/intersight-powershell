...
function ConvertFrom-IntersightJsonToHyperflexClusterNetworkPolicy {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "JumboFrame", "KvmIpRange", "MacPrefixRange", "MgmtVlan", "UplinkSpeed", "VmMigrationVlan", "VmNetworkVlans", "ClusterProfiles", "Organization")
