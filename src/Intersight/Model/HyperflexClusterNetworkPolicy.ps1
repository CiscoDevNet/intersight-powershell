...
function ConvertFrom-IntersightJsonToHyperflexClusterNetworkPolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "JumboFrame", "KvmIpRange", "MacPrefixRange", "MgmtVlan", "UplinkSpeed", "VmMigrationVlan", "VmNetworkVlans", "ClusterProfiles", "Organization")
