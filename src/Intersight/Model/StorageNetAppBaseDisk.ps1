...
StorageNetAppBaseDisk<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppBaseDisk {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.NetAppBaseDisk")]
        [String]
        ${ClassId} = "storage.NetAppBaseDisk",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.NetAppBaseDisk")]
        [String]
        ${ObjectType} = "storage.NetAppBaseDisk",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppBaseDisk' | Write-Debug
...
Convert from JSON to StorageNetAppBaseDisk<PSCustomObject>
...
StorageNetAppBaseDisk<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppBaseDisk {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppBaseDisk' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppBaseDisk
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Name", "PartNumber", "Protocol", "Speed", "Status", "StorageUtilization", "Type", "Version", "BaseDiskModel", "ContainerType", "DiskType", "State", "Uuid", "Array", "ArrayController", "DiskPool")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "BaseDiskModel"))) { #optional property not found
            $BaseDiskModel = $null
        } else {
            $BaseDiskModel = $JsonParameters.PSobject.Properties["BaseDiskModel"].value
        }
