...
ServerConfigResultList<PSCustomObject>
#>

function Initialize-IntersightServerConfigResultList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightServerConfigResultList' | Write-Debug
...
Convert from JSON to ServerConfigResultList<PSCustomObject>
...
ServerConfigResultList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToServerConfigResultList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightServerConfigResultList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightServerConfigResultList
