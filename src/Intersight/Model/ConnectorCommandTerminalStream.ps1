...
ConnectorCommandTerminalStream<PSCustomObject>
#>

function Initialize-IntersightConnectorCommandTerminalStream {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConnectorCommandTerminalStream' | Write-Debug
...
Convert from JSON to ConnectorCommandTerminalStream<PSCustomObject>
...
ConnectorCommandTerminalStream<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConnectorCommandTerminalStream {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConnectorCommandTerminalStream' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConnectorCommandTerminalStream
        $AllProperties = ("ClassId", "ObjectType", "EncryptedAesKey", "EncryptionKey", "SecureProperties", "MsgType", "Sequence", "Stream")
