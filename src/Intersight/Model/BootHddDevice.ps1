...
BootHddDevice<PSCustomObject>
#>

function Initialize-IntersightBootHddDevice {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.HddDevice")]
        [String]
        ${ClassId} = "boot.HddDevice",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.HddDevice")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootHddDevice' | Write-Debug
...
Convert from JSON to BootHddDevice<PSCustomObject>
...
BootHddDevice<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootHddDevice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootHddDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootHddDevice
