...
Configuration object sent by user to apply on a port-channel.
...
FabricPortChannelRole<PSCustomObject>
#>

function Initialize-IntersightFabricPortChannelRole {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.AppliancePcRole", "fabric.FcUplinkPcRole", "fabric.FcoeUplinkPcRole", "fabric.UplinkPcRole")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.AppliancePcRole", "fabric.FcUplinkPcRole", "fabric.FcoeUplinkPcRole", "fabric.UplinkPcRole")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricPortChannelRole' | Write-Debug
...
Convert from JSON to FabricPortChannelRole<PSCustomObject>
...
FabricPortChannelRole<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricPortChannelRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricPortChannelRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricPortChannelRole
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "PcId", "Ports", "PortPolicy")
