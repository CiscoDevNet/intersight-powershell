...
WorkflowErrorResponseHandlerList<PSCustomObject>
#>

function Initialize-IntersightWorkflowErrorResponseHandlerList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowErrorResponseHandlerList' | Write-Debug
...
Convert from JSON to WorkflowErrorResponseHandlerList<PSCustomObject>
...
WorkflowErrorResponseHandlerList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowErrorResponseHandlerList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowErrorResponseHandlerList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowErrorResponseHandlerList
