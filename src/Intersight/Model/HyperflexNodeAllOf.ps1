...
function ConvertFrom-IntersightJsonToHyperflexNodeAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "BuildNumber", "DisplayVersion", "HostName", "Hypervisor", "Identity", "Ip", "Lockdown", "ModelNumber", "Role", "SerialNumber", "Status", "Version", "Cluster", "ClusterMember", "PhysicalServer")
