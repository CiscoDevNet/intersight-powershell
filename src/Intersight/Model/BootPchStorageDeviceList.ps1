...
BootPchStorageDeviceList<PSCustomObject>
#>

function Initialize-IntersightBootPchStorageDeviceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootPchStorageDeviceList' | Write-Debug
...
Convert from JSON to BootPchStorageDeviceList<PSCustomObject>
...
BootPchStorageDeviceList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootPchStorageDeviceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootPchStorageDeviceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootPchStorageDeviceList
