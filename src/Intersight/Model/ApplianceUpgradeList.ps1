...
ApplianceUpgradeList<PSCustomObject>
#>

function Initialize-IntersightApplianceUpgradeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightApplianceUpgradeList' | Write-Debug
...
Convert from JSON to ApplianceUpgradeList<PSCustomObject>
...
ApplianceUpgradeList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToApplianceUpgradeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightApplianceUpgradeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightApplianceUpgradeList
