...
function ConvertFrom-IntersightJsonToComputePhysicalSummaryAllOf {
    ...
    Process {
        ...
        $AllProperties = ("AdminPowerState", "AssetTag", "AvailableMemory", "BiosPostComplete", "ChassisId", "ConnectionStatus", "CpuCapacity", "DeviceMoId", "Dn", "FaultSummary", "Firmware", "Ipv4Address", "KvmIpAddresses", "ManagementMode", "MemorySpeed", "MgmtIpAddress", "Model", "Name", "NumAdaptors", "NumCpuCores", "NumCpuCoresEnabled", "NumCpus", "NumEthHostInterfaces", "NumFcHostInterfaces", "NumThreads", "OperPowerState", "OperState", "Operability", "PlatformType", "Presence", "Revision", "Rn", "ScaledMode", "Serial", "ServerId", "ServiceProfile", "SlotId", "SourceObjectType", "TopologyScanStatus", "TotalMemory", "UserLabel", "Uuid", "Vendor", "EquipmentChassis", "InventoryDeviceInfo", "RegisteredDevice")
