...
function ConvertFrom-IntersightJsonToComputePhysicalSummaryAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AdminPowerState", "AlarmSummary", "AssetTag", "AvailableMemory", "BiosPostComplete", "ChassisId", "ConnectionStatus", "CpuCapacity", "DeviceMoId", "Dn", "FaultSummary", "Firmware", "Ipv4Address", "KvmIpAddresses", "ManagementMode", "MemorySpeed", "MgmtIpAddress", "Model", "Name", "NumAdaptors", "NumCpuCores", "NumCpuCoresEnabled", "NumCpus", "NumEthHostInterfaces", "NumFcHostInterfaces", "NumThreads", "OperPowerState", "OperReason", "OperState", "Operability", "PlatformType", "Presence", "Revision", "Rn", "ScaledMode", "Serial", "ServerId", "ServiceProfile", "SlotId", "SourceObjectType", "TopologyScanStatus", "TotalMemory", "UserLabel", "Uuid", "Vendor", "InventoryDeviceInfo", "RegisteredDevice")
