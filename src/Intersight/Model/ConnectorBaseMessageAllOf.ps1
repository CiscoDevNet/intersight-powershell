...
ConnectorBaseMessageAllOf<PSCustomObject>
#>

function Initialize-IntersightConnectorBaseMessageAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("connector.CloseStreamMessage", "connector.CommandControlMessage", "connector.CommandTerminalStream", "connector.FetchStreamMessage", "connector.FileMessage", "connector.HttpRequest", "connector.SshConfig", "connector.SshMessage", "connector.StartStream", "connector.StartStreamFromDevice", "connector.StreamAcknowledge", "connector.StreamInput", "connector.StreamKeepalive", "connector.XmlApiMessage", "imcconnector.WebUiMessage", "ucsdconnector.RestClientMessage", "workflow.FileTransfer", "workflow.SshCmd", "workflow.SshConfig")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("connector.CloseStreamMessage", "connector.CommandControlMessage", "connector.CommandTerminalStream", "connector.FetchStreamMessage", "connector.FileMessage", "connector.HttpRequest", "connector.SshConfig", "connector.SshMessage", "connector.StartStream", "connector.StartStreamFromDevice", "connector.StreamAcknowledge", "connector.StreamInput", "connector.StreamKeepalive", "connector.XmlApiMessage", "imcconnector.WebUiMessage", "ucsdconnector.RestClientMessage", "workflow.FileTransfer", "workflow.SshCmd", "workflow.SshConfig")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConnectorBaseMessageAllOf' | Write-Debug
...
Convert from JSON to ConnectorBaseMessageAllOf<PSCustomObject>
...
ConnectorBaseMessageAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConnectorBaseMessageAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConnectorBaseMessageAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConnectorBaseMessageAllOf
        $AllProperties = ("ClassId", "ObjectType", "EncryptedAesKey", "EncryptionKey", "SecureProperties")
