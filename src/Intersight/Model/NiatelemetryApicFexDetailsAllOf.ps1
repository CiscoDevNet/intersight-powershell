...
Definition of the list of properties defined in 'niatelemetry.ApicFexDetails', excluding properties defined in parent classes.
...
NiatelemetryApicFexDetailsAllOf<PSCustomObject>
#>

function Initialize-IntersightNiatelemetryApicFexDetailsAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiatelemetryApicFexDetailsAllOf' | Write-Debug
...
Convert from JSON to NiatelemetryApicFexDetailsAllOf<PSCustomObject>
...
NiatelemetryApicFexDetailsAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiatelemetryApicFexDetailsAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiatelemetryApicFexDetailsAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiatelemetryApicFexDetailsAllOf
