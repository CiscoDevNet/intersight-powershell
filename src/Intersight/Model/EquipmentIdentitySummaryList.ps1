...
EquipmentIdentitySummaryList<PSCustomObject>
#>

function Initialize-IntersightEquipmentIdentitySummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentIdentitySummaryList' | Write-Debug
...
Convert from JSON to EquipmentIdentitySummaryList<PSCustomObject>
...
EquipmentIdentitySummaryList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentIdentitySummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentIdentitySummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentIdentitySummaryList
