...
FirmwareStorageControllerDescriptor<PSCustomObject>
#>

function Initialize-IntersightFirmwareStorageControllerDescriptor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareStorageControllerDescriptor' | Write-Debug
...
Convert from JSON to FirmwareStorageControllerDescriptor<PSCustomObject>
...
FirmwareStorageControllerDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareStorageControllerDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareStorageControllerDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareStorageControllerDescriptor
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Model", "Vendor", "Version", "Capabilities", "Section", "BrandString", "Label", "Revision")
