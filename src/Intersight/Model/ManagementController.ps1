...
function Initialize-IntersightManagementController {
    ...
    Param (
        ...
        [ValidateSet("management.Controller")]
        [String]
        ${ClassId} = "management.Controller",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("management.Controller")]
        [String]
...
function ConvertFrom-IntersightJsonToManagementController {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "AdapterUnit", "ComputeBlade", "ComputeRackUnit", "EquipmentIoCardBase", "EquipmentSharedIoModule", "EquipmentSystemIoController", "InventoryDeviceInfo", "ManagementInterfaces", "NetworkElement", "RegisteredDevice", "RunningFirmware", "StorageSasExpander", "TopSystem")
