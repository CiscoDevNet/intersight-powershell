...
function ConvertFrom-IntersightJsonToManagementController {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "AdapterUnit", "ComputeBlade", "ComputeRackUnit", "EquipmentIoCardBase", "EquipmentSharedIoModule", "EquipmentSystemIoController", "InventoryDeviceInfo", "ManagementInterfaces", "NetworkElement", "RegisteredDevice", "RunningFirmware", "StorageSasExpander", "TopSystem")
