...
BootVmediaDeviceList<PSCustomObject>
#>

function Initialize-IntersightBootVmediaDeviceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootVmediaDeviceList' | Write-Debug
...
Convert from JSON to BootVmediaDeviceList<PSCustomObject>
...
BootVmediaDeviceList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootVmediaDeviceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootVmediaDeviceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootVmediaDeviceList
