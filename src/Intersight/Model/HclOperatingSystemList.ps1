...
HclOperatingSystemList<PSCustomObject>
#>

function Initialize-IntersightHclOperatingSystemList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHclOperatingSystemList' | Write-Debug
...
Convert from JSON to HclOperatingSystemList<PSCustomObject>
...
HclOperatingSystemList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHclOperatingSystemList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHclOperatingSystemList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHclOperatingSystemList
