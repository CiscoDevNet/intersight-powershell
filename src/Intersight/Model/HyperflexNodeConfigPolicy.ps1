...
HyperflexNodeConfigPolicy<PSCustomObject>
#>

function Initialize-IntersightHyperflexNodeConfigPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexNodeConfigPolicy' | Write-Debug
...
Convert from JSON to HyperflexNodeConfigPolicy<PSCustomObject>
...
HyperflexNodeConfigPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexNodeConfigPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexNodeConfigPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexNodeConfigPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "DataIpRange", "HxdpIpRange", "HypervisorControlIpRange", "MgmtIpRange", "NodeNamePrefix", "ClusterProfiles", "Organization")
