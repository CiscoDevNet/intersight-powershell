...
function ConvertFrom-IntersightJsonToHyperflexNodeConfigPolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "DataIpRange", "HxdpIpRange", "HypervisorControlIpRange", "MgmtIpRange", "NodeNamePrefix", "ClusterProfiles", "Organization")
