...
function ConvertFrom-IntersightJsonToHyperflexNodeConfigPolicy {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "DataIpRange", "HxdpIpRange", "MgmtIpRange", "NodeNamePrefix", "ClusterProfiles", "Organization")
