...
function ConvertFrom-IntersightJsonToEquipmentPsuAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Description", "OperState", "PartNumber", "Pid", "Presence", "PsuFwVersion", "PsuId", "PsuInputSrc", "PsuType", "PsuWattage", "Sku", "Vid", "Voltage", "ComputeRackUnit", "EquipmentChassis", "EquipmentFex", "EquipmentRackEnclosure", "InventoryDeviceInfo", "NetworkElement", "RegisteredDevice")
