...
FabricEthNetworkPolicy<PSCustomObject>
#>

function Initialize-IntersightFabricEthNetworkPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.EthNetworkPolicy")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricEthNetworkPolicy' | Write-Debug
...
Convert from JSON to FabricEthNetworkPolicy<PSCustomObject>
...
FabricEthNetworkPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricEthNetworkPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricEthNetworkPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricEthNetworkPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Organization", "Profiles")
