...
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryUnit {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "AdminState", "ArrayId", "Bank", "Capacity", "Clock", "FormFactor", "Latency", "Location", "OperPowerState", "OperReason", "OperState", "Operability", "Presence", "Set", "Speed", "Thermal", "Type", "Visibility", "Width", "AppDirectCapacity", "CountStatus", "FirmwareVersion", "FrozenStatus", "HealthState", "LockStatus", "MemoryCapacity", "MemoryId", "PersistentMemoryCapacity", "ReservedCapacity", "SecurityStatus", "SocketId", "SocketMemoryId", "TotalCapacity", "Uid", "InventoryDeviceInfo", "MemoryArray", "RegisteredDevice")
