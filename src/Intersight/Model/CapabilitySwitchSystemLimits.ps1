...
CapabilitySwitchSystemLimits<PSCustomObject>
#>

function Initialize-IntersightCapabilitySwitchSystemLimits {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilitySwitchSystemLimits' | Write-Debug
...
Convert from JSON to CapabilitySwitchSystemLimits<PSCustomObject>
...
CapabilitySwitchSystemLimits<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilitySwitchSystemLimits {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilitySwitchSystemLimits' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilitySwitchSystemLimits
