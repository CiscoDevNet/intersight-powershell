...
function ConvertFrom-IntersightJsonToVnicFcIfAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Name", "Order", "PersistentBindings", "Placement", "Type", "VifId", "Wwpn", "FcAdapterPolicy", "FcNetworkPolicy", "FcQosPolicy", "Profile", "SanConnectivityPolicy", "ScpVhba", "SpVhbas", "WwpnLease", "WwpnPool")
