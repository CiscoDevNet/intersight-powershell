...
function Initialize-IntersightVnicFcIfAllOf {
    ...
    Process {
        ...
        $PSO = [PSCustomObject]@{
            ...
            "Placement" = ${Placement}
            "StaticWwpnAddress" = ${StaticWwpnAddress}
            "Type" = ${Type}
            "WwpnAddressType" = ${WwpnAddressType}
...
function ConvertFrom-IntersightJsonToVnicFcIfAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Name", "Order", "PersistentBindings", "Placement", "StaticWwpnAddress", "Type", "VifId", "Wwpn", "WwpnAddressType", "FcAdapterPolicy", "FcNetworkPolicy", "FcQosPolicy", "Profile", "SanConnectivityPolicy", "ScpVhba", "SpVhbas", "WwpnLease", "WwpnPool")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "StaticWwpnAddress"))) { #optional property not found
            $StaticWwpnAddress = $null
        } else {
            $StaticWwpnAddress = $JsonParameters.PSobject.Properties["StaticWwpnAddress"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "WwpnAddressType"))) { #optional property not found
            $WwpnAddressType = $null
        } else {
            $WwpnAddressType = $JsonParameters.PSobject.Properties["WwpnAddressType"].value
        }
