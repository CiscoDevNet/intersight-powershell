...
OsCatalog<PSCustomObject>
#>

function Initialize-IntersightOsCatalog {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("os.Catalog")]
        [String]
        ${ClassId} = "os.Catalog",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("os.Catalog")]
        [String]
        ${ObjectType} = "os.Catalog",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightOsCatalog' | Write-Debug
...
Convert from JSON to OsCatalog<PSCustomObject>
...
OsCatalog<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToOsCatalog {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightOsCatalog' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightOsCatalog
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "ConfigurationFiles", "Distributions", "Organization")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ConfigurationFiles"))) { #optional property not found
            $ConfigurationFiles = $null
        } else {
            $ConfigurationFiles = $JsonParameters.PSobject.Properties["ConfigurationFiles"].value
        }
