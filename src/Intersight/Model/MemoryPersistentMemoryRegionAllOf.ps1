...
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryRegionAllOf {
    ...
    Process {
        ...
        $AllProperties = ("FreeCapacity", "HealthState", "InterleavedSetId", "LocaterIds", "PersistentMemoryType", "RegionId", "SocketId", "SocketMemoryId", "TotalCapacity", "InventoryDeviceInfo", "MemoryPersistentMemoryConfiguration", "PersistentMemoryNamespaces", "RegisteredDevice")
