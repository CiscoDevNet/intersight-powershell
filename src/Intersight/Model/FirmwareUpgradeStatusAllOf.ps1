...
function ConvertFrom-IntersightJsonToFirmwareUpgradeStatusAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "DownloadError", "DownloadMessage", "DownloadPercentage", "DownloadProgress", "DownloadRetries", "DownloadStage", "EpPowerStatus", "OverallError", "OverallPercentage", "Overallstatus", "PendingType", "Sha256checksum", "Upgrade", "Workflow")
