...
HyperflexNodeProfile<PSCustomObject>
#>

function Initialize-IntersightHyperflexNodeProfile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexNodeProfile' | Write-Debug
...
Convert from JSON to HyperflexNodeProfile<PSCustomObject>
...
HyperflexNodeProfile<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexNodeProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexNodeProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexNodeProfile
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Type", "SrcTemplate", "HxdpDataIp", "HxdpMgmtIp", "HypervisorControlIp", "HypervisorDataIp", "HypervisorMgmtIp", "AssignedServer", "ClusterProfile")
