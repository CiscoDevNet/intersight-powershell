...
SdcardPolicy<PSCustomObject>
#>

function Initialize-IntersightSdcardPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("sdcard.Policy")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSdcardPolicy' | Write-Debug
...
Convert from JSON to SdcardPolicy<PSCustomObject>
...
SdcardPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSdcardPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSdcardPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSdcardPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Partitions", "Organization", "Profiles")
