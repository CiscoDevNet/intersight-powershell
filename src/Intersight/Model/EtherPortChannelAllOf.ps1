...
function ConvertFrom-IntersightJsonToEtherPortChannelAllOf {
    ...
    Process {
        ...
        $AllProperties = ("AccessVlan", "AdminState", "AllowedVlans", "Mode", "NativeVlan", "OperSpeed", "OperState", "OperStateQual", "PortChannelId", "Role", "SwitchId", "EquipmentSwitchCard", "RegisteredDevice")
