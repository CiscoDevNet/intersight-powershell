...
BootDeviceBootSecurity<PSCustomObject>
#>

function Initialize-IntersightBootDeviceBootSecurity {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.DeviceBootSecurity")]
        [String]
        ${ClassId} = "boot.DeviceBootSecurity",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.DeviceBootSecurity")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootDeviceBootSecurity' | Write-Debug
...
Convert from JSON to BootDeviceBootSecurity<PSCustomObject>
...
BootDeviceBootSecurity<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootDeviceBootSecurity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootDeviceBootSecurity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootDeviceBootSecurity
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "SecureBoot", "ComputePhysical", "InventoryDeviceInfo", "RegisteredDevice")
