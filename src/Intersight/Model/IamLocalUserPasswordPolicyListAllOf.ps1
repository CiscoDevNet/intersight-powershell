...
IamLocalUserPasswordPolicyListAllOf<PSCustomObject>
#>

function Initialize-IntersightIamLocalUserPasswordPolicyListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamLocalUserPasswordPolicyListAllOf' | Write-Debug
...
Convert from JSON to IamLocalUserPasswordPolicyListAllOf<PSCustomObject>
...
IamLocalUserPasswordPolicyListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamLocalUserPasswordPolicyListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamLocalUserPasswordPolicyListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamLocalUserPasswordPolicyListAllOf
