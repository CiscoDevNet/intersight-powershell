...
KubernetesVersionPolicyListAllOf<PSCustomObject>
#>

function Initialize-IntersightKubernetesVersionPolicyListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesVersionPolicyListAllOf' | Write-Debug
...
Convert from JSON to KubernetesVersionPolicyListAllOf<PSCustomObject>
...
KubernetesVersionPolicyListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesVersionPolicyListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesVersionPolicyListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesVersionPolicyListAllOf
