...
SyslogLocalClientBaseAllOf<PSCustomObject>
#>

function Initialize-IntersightSyslogLocalClientBaseAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSyslogLocalClientBaseAllOf' | Write-Debug
...
Convert from JSON to SyslogLocalClientBaseAllOf<PSCustomObject>
...
SyslogLocalClientBaseAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSyslogLocalClientBaseAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSyslogLocalClientBaseAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSyslogLocalClientBaseAllOf
