...
RecoveryScheduleConfigPolicy<PSCustomObject>
#>

function Initialize-IntersightRecoveryScheduleConfigPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("recovery.ScheduleConfigPolicy")]
        [String]
        ${ClassId} = "recovery.ScheduleConfigPolicy",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("recovery.ScheduleConfigPolicy")]
        [String]
        ${ObjectType} = "recovery.ScheduleConfigPolicy",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightRecoveryScheduleConfigPolicy' | Write-Debug
...
Convert from JSON to RecoveryScheduleConfigPolicy<PSCustomObject>
...
RecoveryScheduleConfigPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToRecoveryScheduleConfigPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightRecoveryScheduleConfigPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightRecoveryScheduleConfigPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Schedule", "BackupProfiles", "Organization")
