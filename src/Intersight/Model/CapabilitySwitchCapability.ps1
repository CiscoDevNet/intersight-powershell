...
function ConvertFrom-IntersightJsonToCapabilitySwitchCapability {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Pid", "Sku", "Vid", "DefaultFcoeVlan", "DynamicVifsSupported", "FanModulesSupported", "FcEndHostModeReservedVsans", "FcUplinkPortsAutoNegotiationSupported", "LocatorBeaconSupported", "MaxPorts", "MaxSlots", "NetworkLimits", "PortsSupporting100gSpeed", "PortsSupporting10gSpeed", "PortsSupporting1gSpeed", "PortsSupporting25gSpeed", "PortsSupporting40gSpeed", "PortsSupportingBreakout", "PortsSupportingFcoe", "PortsSupportingServerRole", "ReservedVsans", "SerenoNetflowSupported", "StorageLimits", "SwitchingModeCapabilities", "SystemLimits", "UnifiedPorts", "UnifiedRule")
