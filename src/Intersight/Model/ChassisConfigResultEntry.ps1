...
ChassisConfigResultEntry<PSCustomObject>
#>

function Initialize-IntersightChassisConfigResultEntry {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("chassis.ConfigResultEntry")]
        [String]
        ${ClassId} = "chassis.ConfigResultEntry",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("chassis.ConfigResultEntry")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightChassisConfigResultEntry' | Write-Debug
...
Convert from JSON to ChassisConfigResultEntry<PSCustomObject>
...
ChassisConfigResultEntry<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToChassisConfigResultEntry {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightChassisConfigResultEntry' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightChassisConfigResultEntry
