...
EtherNetworkPortListAllOf<PSCustomObject>
#>

function Initialize-IntersightEtherNetworkPortListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEtherNetworkPortListAllOf' | Write-Debug
...
Convert from JSON to EtherNetworkPortListAllOf<PSCustomObject>
...
EtherNetworkPortListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEtherNetworkPortListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEtherNetworkPortListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEtherNetworkPortListAllOf
