...
function ConvertFrom-IntersightJsonToFirmwareUpgradeBase {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DirectDownload", "FileServer", "NetworkShare", "SkipEstimateImpact", "Status", "UpgradeType", "Distributable", "Release", "UpgradeImpact", "UpgradeStatus")
