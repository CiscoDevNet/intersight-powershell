...
CondHclStatusJobListAllOf<PSCustomObject>
#>

function Initialize-IntersightCondHclStatusJobListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCondHclStatusJobListAllOf' | Write-Debug
...
Convert from JSON to CondHclStatusJobListAllOf<PSCustomObject>
...
CondHclStatusJobListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCondHclStatusJobListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCondHclStatusJobListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCondHclStatusJobListAllOf
