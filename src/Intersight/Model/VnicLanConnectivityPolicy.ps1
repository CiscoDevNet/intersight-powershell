...
function ConvertFrom-IntersightJsonToVnicLanConnectivityPolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "PlacementMode", "TargetPlatform", "EthIfs", "Organization", "Profiles")
