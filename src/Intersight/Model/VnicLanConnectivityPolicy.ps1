...
VnicLanConnectivityPolicy<PSCustomObject>
#>

function Initialize-IntersightVnicLanConnectivityPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVnicLanConnectivityPolicy' | Write-Debug
...
Convert from JSON to VnicLanConnectivityPolicy<PSCustomObject>
...
VnicLanConnectivityPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVnicLanConnectivityPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVnicLanConnectivityPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVnicLanConnectivityPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "IqnAllocationType", "PlacementMode", "StaticIqnName", "TargetPlatform", "EthIfs", "IqnPool", "Organization", "Profiles")
