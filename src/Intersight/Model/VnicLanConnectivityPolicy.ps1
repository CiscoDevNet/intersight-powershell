...
function ConvertFrom-IntersightJsonToVnicLanConnectivityPolicy {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "PlacementMode", "TargetPlatform", "EthIfs", "Organization", "Profiles")
