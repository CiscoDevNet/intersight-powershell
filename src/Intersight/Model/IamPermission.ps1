...
function ConvertFrom-IntersightJsonToIamPermission {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Account", "EndPointRoles", "ResourceRoles", "Roles", "SessionLimits", "UserGroups", "Users")
