...
IamPermission<PSCustomObject>
#>

function Initialize-IntersightIamPermission {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamPermission' | Write-Debug
...
Convert from JSON to IamPermission<PSCustomObject>
...
IamPermission<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamPermission {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamPermission' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamPermission
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Account", "EndPointRoles", "PrivilegeSets", "ResourceRoles", "Roles", "SessionLimits", "UserGroups", "Users")
