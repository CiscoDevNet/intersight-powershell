...
BootDeviceBootModeListAllOf<PSCustomObject>
#>

function Initialize-IntersightBootDeviceBootModeListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootDeviceBootModeListAllOf' | Write-Debug
...
Convert from JSON to BootDeviceBootModeListAllOf<PSCustomObject>
...
BootDeviceBootModeListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootDeviceBootModeListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootDeviceBootModeListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootDeviceBootModeListAllOf
