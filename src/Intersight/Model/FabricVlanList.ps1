...
FabricVlanList<PSCustomObject>
#>

function Initialize-IntersightFabricVlanList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricVlanList' | Write-Debug
...
Convert from JSON to FabricVlanList<PSCustomObject>
...
FabricVlanList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricVlanList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricVlanList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricVlanList
