...
StorageVirtualDriveExtensionListAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageVirtualDriveExtensionListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageVirtualDriveExtensionListAllOf' | Write-Debug
...
Convert from JSON to StorageVirtualDriveExtensionListAllOf<PSCustomObject>
...
StorageVirtualDriveExtensionListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageVirtualDriveExtensionListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageVirtualDriveExtensionListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageVirtualDriveExtensionListAllOf
