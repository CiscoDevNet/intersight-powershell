...
HyperflexAppCatalog<PSCustomObject>
#>

function Initialize-IntersightHyperflexAppCatalog {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.AppCatalog")]
        [String]
        ${ClassId} = "hyperflex.AppCatalog",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.AppCatalog")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexAppCatalog' | Write-Debug
...
Convert from JSON to HyperflexAppCatalog<PSCustomObject>
...
HyperflexAppCatalog<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexAppCatalog {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexAppCatalog' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexAppCatalog
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Version", "FeatureLimitExternal", "FeatureLimitInternal", "HxdpVersions", "HyperflexCapabilityInfos", "HyperflexSoftwareCompatibilityInfos", "ServerFirmwareVersion", "ServerModel")
