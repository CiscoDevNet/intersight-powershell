...
function ConvertFrom-IntersightJsonToFcPhysicalPortAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AdminSpeed", "AdminState", "B2bCredit", "MaxSpeed", "Mode", "OperSpeed", "PeerDn", "PortChannelId", "TransceiverType", "Vsan", "Wwn", "InventoryDeviceInfo", "PortGroup", "PortSubGroup", "RegisteredDevice")
