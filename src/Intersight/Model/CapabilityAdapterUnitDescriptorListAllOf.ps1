...
CapabilityAdapterUnitDescriptorListAllOf<PSCustomObject>
#>

function Initialize-IntersightCapabilityAdapterUnitDescriptorListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilityAdapterUnitDescriptorListAllOf' | Write-Debug
...
Convert from JSON to CapabilityAdapterUnitDescriptorListAllOf<PSCustomObject>
...
CapabilityAdapterUnitDescriptorListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilityAdapterUnitDescriptorListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilityAdapterUnitDescriptorListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilityAdapterUnitDescriptorListAllOf
