...
CommHttpProxyPolicy<PSCustomObject>
#>

function Initialize-IntersightCommHttpProxyPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCommHttpProxyPolicy' | Write-Debug
...
Convert from JSON to CommHttpProxyPolicy<PSCustomObject>
...
CommHttpProxyPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCommHttpProxyPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCommHttpProxyPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCommHttpProxyPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Hostname", "IsPasswordSet", "Password", "Port", "Username", "Organization", "ClusterProfiles")
