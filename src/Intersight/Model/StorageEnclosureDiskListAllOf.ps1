...
StorageEnclosureDiskListAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageEnclosureDiskListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageEnclosureDiskListAllOf' | Write-Debug
...
Convert from JSON to StorageEnclosureDiskListAllOf<PSCustomObject>
...
StorageEnclosureDiskListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageEnclosureDiskListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageEnclosureDiskListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageEnclosureDiskListAllOf
