...
ConfigImporter<PSCustomObject>
#>

function Initialize-IntersightConfigImporter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConfigImporter' | Write-Debug
...
Convert from JSON to ConfigImporter<PSCustomObject>
...
ConfigImporter<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConfigImporter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConfigImporter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConfigImporter
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ImportPath", "ImportSource", "Name", "SkipIntegrityChecks", "Status", "StatusMessage", "ImportedItems", "Organization")
