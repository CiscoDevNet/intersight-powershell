...
function ConvertFrom-IntersightJsonToConfigImporter {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ImportPath", "ImportSource", "Name", "SkipIntegrityChecks", "Status", "StatusMessage", "ImportedItems", "Organization")
