...
function ConvertFrom-IntersightJsonToConfigImporter {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ImportPath", "ImportSource", "Name", "SkipIntegrityChecks", "Status", "StatusMessage", "ImportedItems", "Organization")
