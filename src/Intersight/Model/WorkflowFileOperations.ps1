...
WorkflowFileOperations<PSCustomObject>
#>

function Initialize-IntersightWorkflowFileOperations {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowFileOperations' | Write-Debug
...
Convert from JSON to WorkflowFileOperations<PSCustomObject>
...
WorkflowFileOperations<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowFileOperations {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowFileOperations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowFileOperations
        $AllProperties = ("ClassId", "ObjectType", "AssetTargetMoid", "Body", "ContentType", "Description", "Label", "Name", "Outcomes", "ResponseSpec", "SkipOnCondition", "StartDelay", "Timeout", "FileDownload", "FileTemplate", "OperationType")
