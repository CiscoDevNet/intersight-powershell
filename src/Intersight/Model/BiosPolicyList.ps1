...
BiosPolicyList<PSCustomObject>
#>

function Initialize-IntersightBiosPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBiosPolicyList' | Write-Debug
...
Convert from JSON to BiosPolicyList<PSCustomObject>
...
BiosPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBiosPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBiosPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBiosPolicyList
