...
HyperflexClusterBackupPolicyDeploymentList<PSCustomObject>
#>

function Initialize-IntersightHyperflexClusterBackupPolicyDeploymentList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexClusterBackupPolicyDeploymentList' | Write-Debug
...
Convert from JSON to HyperflexClusterBackupPolicyDeploymentList<PSCustomObject>
...
HyperflexClusterBackupPolicyDeploymentList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexClusterBackupPolicyDeploymentList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexClusterBackupPolicyDeploymentList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexClusterBackupPolicyDeploymentList
