...
WorkflowWorkflowMetaList<PSCustomObject>
#>

function Initialize-IntersightWorkflowWorkflowMetaList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowWorkflowMetaList' | Write-Debug
...
Convert from JSON to WorkflowWorkflowMetaList<PSCustomObject>
...
WorkflowWorkflowMetaList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowWorkflowMetaList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowWorkflowMetaList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowWorkflowMetaList
