...
Abstract class that defines properties common for all Switch specific 'defs'.
...
CapabilitySwitchCapabilityDef<PSCustomObject>
#>

function Initialize-IntersightCapabilitySwitchCapabilityDef {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.EquipmentPhysicalDef", "capability.EquipmentSlotArray", "capability.SwitchCapability", "capability.SwitchManufacturingDef")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.EquipmentPhysicalDef", "capability.EquipmentSlotArray", "capability.SwitchCapability", "capability.SwitchManufacturingDef")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilitySwitchCapabilityDef' | Write-Debug
...
Convert from JSON to CapabilitySwitchCapabilityDef<PSCustomObject>
...
CapabilitySwitchCapabilityDef<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilitySwitchCapabilityDef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilitySwitchCapabilityDef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilitySwitchCapabilityDef
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Pid", "Sku", "Vid")
