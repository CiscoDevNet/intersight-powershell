...
NiaapiNewReleasePost<PSCustomObject>
#>

function Initialize-IntersightNiaapiNewReleasePost {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiNewReleasePost' | Write-Debug
...
Convert from JSON to NiaapiNewReleasePost<PSCustomObject>
...
NiaapiNewReleasePost<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiNewReleasePost {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiNewReleasePost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiNewReleasePost
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "PostDate", "PostDetail", "PostType", "Postid", "Revision")
