...
SoftwarerepositoryNfsServerAllOf<PSCustomObject>
#>

function Initialize-IntersightSoftwarerepositoryNfsServerAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("softwarerepository.NfsServer")]
        [String]
        ${ClassId} = "softwarerepository.NfsServer",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("softwarerepository.NfsServer")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwarerepositoryNfsServerAllOf' | Write-Debug
...
Convert from JSON to SoftwarerepositoryNfsServerAllOf<PSCustomObject>
...
SoftwarerepositoryNfsServerAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwarerepositoryNfsServerAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSoftwarerepositoryNfsServerAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSoftwarerepositoryNfsServerAllOf
