...
BootHddDeviceListAllOf<PSCustomObject>
#>

function Initialize-IntersightBootHddDeviceListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootHddDeviceListAllOf' | Write-Debug
...
Convert from JSON to BootHddDeviceListAllOf<PSCustomObject>
...
BootHddDeviceListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootHddDeviceListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootHddDeviceListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootHddDeviceListAllOf
