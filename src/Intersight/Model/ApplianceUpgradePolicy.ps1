...
function ConvertFrom-IntersightJsonToApplianceUpgradePolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AutoUpgrade", "BlackoutDatesEnabled", "BlackoutEndDate", "BlackoutStartDate", "EnableMetaDataSync", "Schedule", "Account")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "EnableMetaDataSync"))) { #optional property not found
            $EnableMetaDataSync = $null
        } else {
            $EnableMetaDataSync = $JsonParameters.PSobject.Properties["EnableMetaDataSync"].value
        }
