...
function Initialize-IntersightFabricServerRole {
    ...
    Param (
        ...
        [ValidateSet("fabric.FcUplinkRole", "fabric.FcoeUplinkRole", "fabric.ServerRole", "fabric.UplinkRole")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.FcUplinkRole", "fabric.FcoeUplinkRole", "fabric.ServerRole", "fabric.UplinkRole")]
...
function ConvertFrom-IntersightJsonToFabricServerRole {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AggregatePortId", "PortId", "SlotId", "PortPolicy")
