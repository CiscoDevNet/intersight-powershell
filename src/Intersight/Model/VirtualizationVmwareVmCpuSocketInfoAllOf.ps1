...
VirtualizationVmwareVmCpuSocketInfoAllOf<PSCustomObject>
#>

function Initialize-IntersightVirtualizationVmwareVmCpuSocketInfoAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationVmwareVmCpuSocketInfoAllOf' | Write-Debug
...
Convert from JSON to VirtualizationVmwareVmCpuSocketInfoAllOf<PSCustomObject>
...
VirtualizationVmwareVmCpuSocketInfoAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationVmwareVmCpuSocketInfoAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationVmwareVmCpuSocketInfoAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationVmwareVmCpuSocketInfoAllOf
