...
OsConfigurationFileList<PSCustomObject>
#>

function Initialize-IntersightOsConfigurationFileList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightOsConfigurationFileList' | Write-Debug
...
Convert from JSON to OsConfigurationFileList<PSCustomObject>
...
OsConfigurationFileList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToOsConfigurationFileList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightOsConfigurationFileList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightOsConfigurationFileList
