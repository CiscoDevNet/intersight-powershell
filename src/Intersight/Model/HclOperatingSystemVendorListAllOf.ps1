...
HclOperatingSystemVendorListAllOf<PSCustomObject>
#>

function Initialize-IntersightHclOperatingSystemVendorListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHclOperatingSystemVendorListAllOf' | Write-Debug
...
Convert from JSON to HclOperatingSystemVendorListAllOf<PSCustomObject>
...
HclOperatingSystemVendorListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHclOperatingSystemVendorListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHclOperatingSystemVendorListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHclOperatingSystemVendorListAllOf
