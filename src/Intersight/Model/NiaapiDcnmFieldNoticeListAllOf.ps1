...
NiaapiDcnmFieldNoticeListAllOf<PSCustomObject>
#>

function Initialize-IntersightNiaapiDcnmFieldNoticeListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiDcnmFieldNoticeListAllOf' | Write-Debug
...
Convert from JSON to NiaapiDcnmFieldNoticeListAllOf<PSCustomObject>
...
NiaapiDcnmFieldNoticeListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiDcnmFieldNoticeListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiDcnmFieldNoticeListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiDcnmFieldNoticeListAllOf
