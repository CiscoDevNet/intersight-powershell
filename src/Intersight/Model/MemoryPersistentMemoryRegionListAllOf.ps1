...
MemoryPersistentMemoryRegionListAllOf<PSCustomObject>
#>

function Initialize-IntersightMemoryPersistentMemoryRegionListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMemoryPersistentMemoryRegionListAllOf' | Write-Debug
...
Convert from JSON to MemoryPersistentMemoryRegionListAllOf<PSCustomObject>
...
MemoryPersistentMemoryRegionListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryRegionListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMemoryPersistentMemoryRegionListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMemoryPersistentMemoryRegionListAllOf
