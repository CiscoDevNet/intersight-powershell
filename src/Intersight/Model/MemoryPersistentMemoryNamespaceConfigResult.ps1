...
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryNamespaceConfigResult {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "ConfigStatus", "Name", "SocketId", "SocketMemoryId", "InventoryDeviceInfo", "MemoryPersistentMemoryConfigResult", "RegisteredDevice")
