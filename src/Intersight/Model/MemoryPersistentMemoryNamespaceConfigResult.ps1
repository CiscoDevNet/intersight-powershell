...
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryNamespaceConfigResult {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "ConfigStatus", "Name", "SocketId", "SocketMemoryId", "InventoryDeviceInfo", "MemoryPersistentMemoryConfigResult", "RegisteredDevice")
