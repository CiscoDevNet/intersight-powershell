...
MemoryPersistentMemoryNamespaceConfigResult<PSCustomObject>
#>

function Initialize-IntersightMemoryPersistentMemoryNamespaceConfigResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMemoryPersistentMemoryNamespaceConfigResult' | Write-Debug
...
Convert from JSON to MemoryPersistentMemoryNamespaceConfigResult<PSCustomObject>
...
MemoryPersistentMemoryNamespaceConfigResult<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryNamespaceConfigResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMemoryPersistentMemoryNamespaceConfigResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMemoryPersistentMemoryNamespaceConfigResult
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "ConfigStatus", "Name", "SocketId", "SocketMemoryId", "InventoryDeviceInfo", "MemoryPersistentMemoryConfigResult", "RegisteredDevice")
