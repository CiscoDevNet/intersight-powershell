...
AdapterUnitAllOf<PSCustomObject>
#>

function Initialize-IntersightAdapterUnitAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAdapterUnitAllOf' | Write-Debug
...
Convert from JSON to AdapterUnitAllOf<PSCustomObject>
...
AdapterUnitAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAdapterUnitAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAdapterUnitAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAdapterUnitAllOf
        $AllProperties = ("ClassId", "ObjectType", "AdapterId", "BaseMacAddress", "ConnectionStatus", "Integrated", "OperState", "Operability", "PartNumber", "PciSlot", "Power", "Presence", "Thermal", "Vid", "ComputeBlade", "ComputeRackUnit", "Controller", "ExtEthIfs", "HostEthIfs", "HostFcIfs", "HostIscsiIfs", "InventoryDeviceInfo", "RegisteredDevice")
