...
NiaapiFieldNotice<PSCustomObject>
#>

function Initialize-IntersightNiaapiFieldNotice {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiFieldNotice' | Write-Debug
...
Convert from JSON to NiaapiFieldNotice<PSCustomObject>
...
NiaapiFieldNotice<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiFieldNotice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiFieldNotice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiFieldNotice
