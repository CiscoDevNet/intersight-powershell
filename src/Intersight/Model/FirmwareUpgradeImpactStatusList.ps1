...
FirmwareUpgradeImpactStatusList<PSCustomObject>
#>

function Initialize-IntersightFirmwareUpgradeImpactStatusList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareUpgradeImpactStatusList' | Write-Debug
...
Convert from JSON to FirmwareUpgradeImpactStatusList<PSCustomObject>
...
FirmwareUpgradeImpactStatusList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareUpgradeImpactStatusList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareUpgradeImpactStatusList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareUpgradeImpactStatusList
