...
WorkflowArrayDataTypeAllOf<PSCustomObject>
#>

function Initialize-IntersightWorkflowArrayDataTypeAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowArrayDataTypeAllOf' | Write-Debug
...
Convert from JSON to WorkflowArrayDataTypeAllOf<PSCustomObject>
...
WorkflowArrayDataTypeAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowArrayDataTypeAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowArrayDataTypeAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowArrayDataTypeAllOf
        $AllProperties = ("ClassId", "ObjectType", "ArrayItemType", "Max", "Min")
