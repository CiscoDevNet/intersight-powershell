...
IamDomainGroupList<PSCustomObject>
#>

function Initialize-IntersightIamDomainGroupList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamDomainGroupList' | Write-Debug
...
Convert from JSON to IamDomainGroupList<PSCustomObject>
...
IamDomainGroupList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamDomainGroupList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamDomainGroupList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamDomainGroupList
