...
function ConvertFrom-IntersightJsonToStorageStoragePolicy {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "GlobalHotSpares", "RetainPolicyVirtualDrives", "UnusedDisksState", "VirtualDrives", "DiskGroupPolicies", "Organization", "Profiles")
