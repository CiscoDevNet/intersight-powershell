...
function ConvertFrom-IntersightJsonToStorageStoragePolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "GlobalHotSpares", "RetainPolicyVirtualDrives", "UnusedDisksState", "VirtualDrives", "DiskGroupPolicies", "Organization", "Profiles")
