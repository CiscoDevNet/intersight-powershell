...
EquipmentSwitchCard<PSCustomObject>
#>

function Initialize-IntersightEquipmentSwitchCard {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentSwitchCard' | Write-Debug
...
Convert from JSON to EquipmentSwitchCard<PSCustomObject>
...
EquipmentSwitchCard<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentSwitchCard {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentSwitchCard' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentSwitchCard
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Description", "EthernetSwitchingMode", "FcSwitchingMode", "NumPorts", "OutOfBandIpAddress", "OutOfBandIpGateway", "Presence", "SlotId", "State", "SwitchId", "Thermal", "FcPortChannels", "InventoryDeviceInfo", "NetworkElement", "PortChannels", "PortGroups", "RegisteredDevice")
