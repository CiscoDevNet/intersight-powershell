...
function ConvertFrom-IntersightJsonToEquipmentSwitchCard {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Description", "EthernetSwitchingMode", "FcSwitchingMode", "NumPorts", "OutOfBandIpAddress", "OutOfBandIpGateway", "Presence", "SlotId", "State", "SwitchId", "FcPortChannels", "InventoryDeviceInfo", "NetworkElement", "PortChannels", "PortGroups", "RegisteredDevice")
