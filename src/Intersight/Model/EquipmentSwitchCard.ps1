...
function ConvertFrom-IntersightJsonToEquipmentSwitchCard {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Description", "NumPorts", "OutOfBandIpAddress", "OutOfBandIpGateway", "Presence", "SlotId", "State", "SwitchId", "FcPortChannels", "InventoryDeviceInfo", "NetworkElement", "PortChannels", "PortGroups", "RegisteredDevice")
