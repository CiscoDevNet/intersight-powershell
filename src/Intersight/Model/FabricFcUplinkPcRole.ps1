...
function ConvertFrom-IntersightJsonToFabricFcUplinkPcRole {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "PcId", "Ports", "PortPolicy", "AdminSpeed", "FillPattern", "VsanId")
