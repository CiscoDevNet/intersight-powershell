...
StorageNetAppExportPolicyListAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppExportPolicyListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppExportPolicyListAllOf' | Write-Debug
...
Convert from JSON to StorageNetAppExportPolicyListAllOf<PSCustomObject>
...
StorageNetAppExportPolicyListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppExportPolicyListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppExportPolicyListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppExportPolicyListAllOf
