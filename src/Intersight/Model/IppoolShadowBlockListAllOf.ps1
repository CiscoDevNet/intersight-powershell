...
IppoolShadowBlockListAllOf<PSCustomObject>
#>

function Initialize-IntersightIppoolShadowBlockListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIppoolShadowBlockListAllOf' | Write-Debug
...
Convert from JSON to IppoolShadowBlockListAllOf<PSCustomObject>
...
IppoolShadowBlockListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIppoolShadowBlockListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIppoolShadowBlockListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIppoolShadowBlockListAllOf
