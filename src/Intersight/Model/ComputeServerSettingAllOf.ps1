...
function ConvertFrom-IntersightJsonToComputeServerSettingAllOf {
    ...
    Process {
        ...
        $AllProperties = ("AdminLocatorLedState", "AdminPowerState", "ConfigState", "OneTimeBootDevice", "PersistentMemoryOperation", "ServerConfig", "LocatorLed", "RegisteredDevice", "RunningWorkflow", "Server")
