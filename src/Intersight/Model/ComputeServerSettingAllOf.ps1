...
function ConvertFrom-IntersightJsonToComputeServerSettingAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AdminLocatorLedState", "AdminPowerState", "ConfigState", "OneTimeBootDevice", "PersistentMemoryOperation", "ServerConfig", "LocatorLed", "RegisteredDevice", "RunningWorkflow", "Server")
