...
IamSessionLimitsList<PSCustomObject>
#>

function Initialize-IntersightIamSessionLimitsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamSessionLimitsList' | Write-Debug
...
Convert from JSON to IamSessionLimitsList<PSCustomObject>
...
IamSessionLimitsList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamSessionLimitsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamSessionLimitsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamSessionLimitsList
