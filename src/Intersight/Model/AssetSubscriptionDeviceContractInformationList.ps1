...
AssetSubscriptionDeviceContractInformationList<PSCustomObject>
#>

function Initialize-IntersightAssetSubscriptionDeviceContractInformationList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAssetSubscriptionDeviceContractInformationList' | Write-Debug
...
Convert from JSON to AssetSubscriptionDeviceContractInformationList<PSCustomObject>
...
AssetSubscriptionDeviceContractInformationList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAssetSubscriptionDeviceContractInformationList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAssetSubscriptionDeviceContractInformationList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAssetSubscriptionDeviceContractInformationList
