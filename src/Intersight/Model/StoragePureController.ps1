...
StoragePureController<PSCustomObject>
#>

function Initialize-IntersightStoragePureController {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PureController")]
        [String]
        ${ClassId} = "storage.PureController",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PureController")]
        [String]
        ${ObjectType} = "storage.PureController",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePureController' | Write-Debug
...
Convert from JSON to StoragePureController<PSCustomObject>
...
StoragePureController<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePureController {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePureController' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePureController
