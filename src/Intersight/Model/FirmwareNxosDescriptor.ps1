...
FirmwareNxosDescriptor<PSCustomObject>
#>

function Initialize-IntersightFirmwareNxosDescriptor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareNxosDescriptor' | Write-Debug
...
Convert from JSON to FirmwareNxosDescriptor<PSCustomObject>
...
FirmwareNxosDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareNxosDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareNxosDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareNxosDescriptor
