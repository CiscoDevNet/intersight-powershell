...
FabricVsanList<PSCustomObject>
#>

function Initialize-IntersightFabricVsanList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricVsanList' | Write-Debug
...
Convert from JSON to FabricVsanList<PSCustomObject>
...
FabricVsanList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricVsanList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricVsanList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricVsanList
