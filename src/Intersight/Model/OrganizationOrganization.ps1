...
OrganizationOrganization<PSCustomObject>
#>

function Initialize-IntersightOrganizationOrganization {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("organization.Organization")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightOrganizationOrganization' | Write-Debug
...
Convert from JSON to OrganizationOrganization<PSCustomObject>
...
OrganizationOrganization<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToOrganizationOrganization {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightOrganizationOrganization' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightOrganizationOrganization
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Account", "ResourceGroups")
