...
MemoryPersistentMemoryPolicyList<PSCustomObject>
#>

function Initialize-IntersightMemoryPersistentMemoryPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMemoryPersistentMemoryPolicyList' | Write-Debug
...
Convert from JSON to MemoryPersistentMemoryPolicyList<PSCustomObject>
...
MemoryPersistentMemoryPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMemoryPersistentMemoryPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMemoryPersistentMemoryPolicyList
