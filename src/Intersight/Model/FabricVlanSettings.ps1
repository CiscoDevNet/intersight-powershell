...
FabricVlanSettings<PSCustomObject>
#>

function Initialize-IntersightFabricVlanSettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricVlanSettings' | Write-Debug
...
Convert from JSON to FabricVlanSettings<PSCustomObject>
...
FabricVlanSettings<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricVlanSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricVlanSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricVlanSettings
