...
IamEndPointRoleList<PSCustomObject>
#>

function Initialize-IntersightIamEndPointRoleList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamEndPointRoleList' | Write-Debug
...
Convert from JSON to IamEndPointRoleList<PSCustomObject>
...
IamEndPointRoleList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamEndPointRoleList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamEndPointRoleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamEndPointRoleList
