...
IamCertificateListAllOf<PSCustomObject>
#>

function Initialize-IntersightIamCertificateListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamCertificateListAllOf' | Write-Debug
...
Convert from JSON to IamCertificateListAllOf<PSCustomObject>
...
IamCertificateListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamCertificateListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamCertificateListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamCertificateListAllOf
