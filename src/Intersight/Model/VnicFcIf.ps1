...
function ConvertFrom-IntersightJsonToVnicFcIf {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Order", "PersistentBindings", "Placement", "Type", "VifId", "Wwpn", "FcAdapterPolicy", "FcNetworkPolicy", "FcQosPolicy", "Profile", "SanConnectivityPolicy", "ScpVhba", "SpVhbas", "WwpnLease", "WwpnPool")
