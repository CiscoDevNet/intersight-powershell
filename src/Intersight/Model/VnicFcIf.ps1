...
function ConvertFrom-IntersightJsonToVnicFcIf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Order", "PersistentBindings", "Placement", "StaticWwpnAddress", "Type", "VifId", "Wwpn", "WwpnAddressType", "FcAdapterPolicy", "FcNetworkPolicy", "FcQosPolicy", "Profile", "SanConnectivityPolicy", "ScpVhba", "SpVhbas", "WwpnLease", "WwpnPool")
