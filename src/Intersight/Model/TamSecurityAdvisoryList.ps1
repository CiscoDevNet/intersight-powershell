...
TamSecurityAdvisoryList<PSCustomObject>
#>

function Initialize-IntersightTamSecurityAdvisoryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTamSecurityAdvisoryList' | Write-Debug
...
Convert from JSON to TamSecurityAdvisoryList<PSCustomObject>
...
TamSecurityAdvisoryList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTamSecurityAdvisoryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTamSecurityAdvisoryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTamSecurityAdvisoryList
