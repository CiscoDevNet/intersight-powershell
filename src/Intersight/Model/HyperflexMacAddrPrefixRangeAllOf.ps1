...
HyperflexMacAddrPrefixRangeAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexMacAddrPrefixRangeAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexMacAddrPrefixRangeAllOf' | Write-Debug
...
Convert from JSON to HyperflexMacAddrPrefixRangeAllOf<PSCustomObject>
...
HyperflexMacAddrPrefixRangeAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexMacAddrPrefixRangeAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexMacAddrPrefixRangeAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexMacAddrPrefixRangeAllOf
