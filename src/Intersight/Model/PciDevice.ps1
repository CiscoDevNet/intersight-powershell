...
PciDevice<PSCustomObject>
#>

function Initialize-IntersightPciDevice {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("pci.Device")]
        [String]
        ${ClassId} = "pci.Device",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("pci.Device")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPciDevice' | Write-Debug
...
Convert from JSON to PciDevice<PSCustomObject>
...
PciDevice<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPciDevice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPciDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPciDevice
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "FirmwareVersion", "Pid", "SlotId", "ComputeBlade", "ComputeRackUnit", "InventoryDeviceInfo", "RegisteredDevice")
