...
NiatelemetryFault<PSCustomObject>
#>

function Initialize-IntersightNiatelemetryFault {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("niatelemetry.Fault")]
        [String]
        ${ClassId} = "niatelemetry.Fault",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("niatelemetry.Fault")]
        [String]
        ${ObjectType} = "niatelemetry.Fault",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiatelemetryFault' | Write-Debug
...
Convert from JSON to NiatelemetryFault<PSCustomObject>
...
NiatelemetryFault<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiatelemetryFault {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiatelemetryFault' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiatelemetryFault
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Code", "Description", "Dn", "RecordType", "RecordVersion", "Severity", "SiteName", "Type", "RegisteredDevice")
