...
TelemetryDruidGreatestLeastPostAggregator<PSCustomObject>
#>

function Initialize-IntersightTelemetryDruidGreatestLeastPostAggregator {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTelemetryDruidGreatestLeastPostAggregator' | Write-Debug
...
Convert from JSON to TelemetryDruidGreatestLeastPostAggregator<PSCustomObject>
...
TelemetryDruidGreatestLeastPostAggregator<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTelemetryDruidGreatestLeastPostAggregator {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTelemetryDruidGreatestLeastPostAggregator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTelemetryDruidGreatestLeastPostAggregator
        $AllProperties = ("type", "name", "fields")
