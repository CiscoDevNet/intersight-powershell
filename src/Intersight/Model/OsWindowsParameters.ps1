...
OsWindowsParameters<PSCustomObject>
#>

function Initialize-IntersightOsWindowsParameters {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightOsWindowsParameters' | Write-Debug
...
Convert from JSON to OsWindowsParameters<PSCustomObject>
...
OsWindowsParameters<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToOsWindowsParameters {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightOsWindowsParameters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightOsWindowsParameters
