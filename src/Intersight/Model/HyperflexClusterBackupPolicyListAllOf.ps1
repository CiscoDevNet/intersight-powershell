...
HyperflexClusterBackupPolicyListAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexClusterBackupPolicyListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexClusterBackupPolicyListAllOf' | Write-Debug
...
Convert from JSON to HyperflexClusterBackupPolicyListAllOf<PSCustomObject>
...
HyperflexClusterBackupPolicyListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexClusterBackupPolicyListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexClusterBackupPolicyListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexClusterBackupPolicyListAllOf
