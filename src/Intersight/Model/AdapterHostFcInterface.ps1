...
AdapterHostFcInterface<PSCustomObject>
#>

function Initialize-IntersightAdapterHostFcInterface {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAdapterHostFcInterface' | Write-Debug
...
Convert from JSON to AdapterHostFcInterface<PSCustomObject>
...
AdapterHostFcInterface<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAdapterHostFcInterface {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAdapterHostFcInterface' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAdapterHostFcInterface
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "AdminState", "EpDn", "HostFcInterfaceId", "Name", "OperState", "Operability", "OriginalWwnn", "OriginalWwpn", "PeerDn", "Wwnn", "Wwpn", "AdapterUnit", "InventoryDeviceInfo", "RegisteredDevice")
