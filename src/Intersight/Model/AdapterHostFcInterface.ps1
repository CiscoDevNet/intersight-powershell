...
function ConvertFrom-IntersightJsonToAdapterHostFcInterface {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "AdminState", "EpDn", "HostFcInterfaceId", "Name", "OperState", "Operability", "OriginalWwnn", "OriginalWwpn", "PeerDn", "Wwnn", "Wwpn", "AdapterUnit", "InventoryDeviceInfo", "RegisteredDevice")
