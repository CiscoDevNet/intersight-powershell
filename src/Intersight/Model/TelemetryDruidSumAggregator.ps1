...
TelemetryDruidSumAggregator<PSCustomObject>
#>

function Initialize-IntersightTelemetryDruidSumAggregator {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTelemetryDruidSumAggregator' | Write-Debug
...
Convert from JSON to TelemetryDruidSumAggregator<PSCustomObject>
...
TelemetryDruidSumAggregator<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTelemetryDruidSumAggregator {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTelemetryDruidSumAggregator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTelemetryDruidSumAggregator
