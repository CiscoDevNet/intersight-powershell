...
function ConvertFrom-IntersightJsonToWorkflowWorkflowDefinitionAllOf {
    ...
    Process {
        ...
        $AllProperties = ("DefaultVersion", "Description", "InputDefinition", "Label", "LicenseEntitlement", "MaxTaskCount", "Name", "OutputDefinition", "OutputParameters", "Properties", "Tasks", "UiRenderingData", "ValidationInformation", "Version", "Catalog")
