...
function ConvertFrom-IntersightJsonToWorkflowWorkflowDefinitionAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "DefaultVersion", "Description", "InputDefinition", "InputParameterSet", "Label", "LicenseEntitlement", "MaxTaskCount", "MaxWorkerTaskCount", "Name", "OutputDefinition", "OutputParameters", "Properties", "Tasks", "UiInputFilters", "UiRenderingData", "ValidationInformation", "Version", "Catalog", "WorkflowMetadata")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "MaxWorkerTaskCount"))) { #optional property not found
            $MaxWorkerTaskCount = $null
        } else {
            $MaxWorkerTaskCount = $JsonParameters.PSobject.Properties["MaxWorkerTaskCount"].value
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "MaxWorkerTaskCount" = ${MaxWorkerTaskCount}
            "Name" = ${Name}
            "OutputDefinition" = ${OutputDefinition}
            "OutputParameters" = ${OutputParameters}
            "Properties" = ${Properties}
