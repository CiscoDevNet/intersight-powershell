...
StorageBasePhysicalPortAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageBasePhysicalPortAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageBasePhysicalPortAllOf' | Write-Debug
...
Convert from JSON to StorageBasePhysicalPortAllOf<PSCustomObject>
...
StorageBasePhysicalPortAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageBasePhysicalPortAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageBasePhysicalPortAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageBasePhysicalPortAllOf
        $AllProperties = ("ClassId", "ObjectType", "Iqn", "Name", "Speed", "Status", "Type", "Wwn", "Wwnn", "Wwpn")
