...
TamAdvisoryDefinition<PSCustomObject>
#>

function Initialize-IntersightTamAdvisoryDefinition {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTamAdvisoryDefinition' | Write-Debug
...
Convert from JSON to TamAdvisoryDefinition<PSCustomObject>
...
TamAdvisoryDefinition<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTamAdvisoryDefinition {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTamAdvisoryDefinition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTamAdvisoryDefinition
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Severity", "State", "Actions", "AdvisoryDetails", "AdvisoryId", "ApiDataSources", "DatePublished", "DateUpdated", "ExternalUrl", "Recommendation", "Type", "Version", "Workaround", "Organization")
