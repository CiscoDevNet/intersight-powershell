...
function ConvertFrom-IntersightJsonToTamAdvisoryDefinition {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Severity", "State", "Actions", "AdvisoryDetails", "AdvisoryId", "ApiDataSources", "DatePublished", "DateUpdated", "ExternalUrl", "Recommendation", "Type", "Version", "Workaround", "Organization")
