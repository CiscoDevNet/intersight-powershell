...
function ConvertFrom-IntersightJsonToTamAdvisoryDefinition {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Severity", "State", "Actions", "AdvisoryDetails", "AdvisoryId", "ApiDataSources", "DatePublished", "DateUpdated", "ExternalUrl", "Recommendation", "Type", "Version", "Workaround", "Organization")
