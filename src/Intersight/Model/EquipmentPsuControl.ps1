...
function ConvertFrom-IntersightJsonToEquipmentPsuControl {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ClusterState", "InputPowerState", "Name", "OperQualifier", "OperState", "OutputPowerState", "Redundancy", "EquipmentChassis", "InventoryDeviceInfo", "RegisteredDevice")
