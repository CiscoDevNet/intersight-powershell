...
function ConvertFrom-IntersightJsonToEquipmentPsuControl {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ClusterState", "InputPowerState", "Name", "OperQualifier", "OperState", "OutputPowerState", "Redundancy", "EquipmentChassis", "InventoryDeviceInfo", "RegisteredDevice")
