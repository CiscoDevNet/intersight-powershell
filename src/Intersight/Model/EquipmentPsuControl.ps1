...
EquipmentPsuControl<PSCustomObject>
#>

function Initialize-IntersightEquipmentPsuControl {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.PsuControl")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentPsuControl' | Write-Debug
...
Convert from JSON to EquipmentPsuControl<PSCustomObject>
...
EquipmentPsuControl<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentPsuControl {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentPsuControl' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentPsuControl
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ClusterState", "InputPowerState", "Name", "OperQualifier", "OperReason", "OperState", "OutputPowerState", "Redundancy", "EquipmentChassis", "InventoryDeviceInfo", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ClusterState"))) { #optional property not found
            $ClusterState = $null
        } else {
            $ClusterState = $JsonParameters.PSobject.Properties["ClusterState"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "InputPowerState"))) { #optional property not found
            $InputPowerState = $null
        } else {
            $InputPowerState = $JsonParameters.PSobject.Properties["InputPowerState"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "OperQualifier"))) { #optional property not found
            $OperQualifier = $null
        } else {
            $OperQualifier = $JsonParameters.PSobject.Properties["OperQualifier"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "OutputPowerState"))) { #optional property not found
            $OutputPowerState = $null
        } else {
            $OutputPowerState = $JsonParameters.PSobject.Properties["OutputPowerState"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "Redundancy"))) { #optional property not found
            $Redundancy = $null
        } else {
            $Redundancy = $JsonParameters.PSobject.Properties["Redundancy"].value
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "InputPowerState" = ${InputPowerState}
            "Name" = ${Name}
