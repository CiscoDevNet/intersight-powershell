...
KubernetesDeployment<PSCustomObject>
#>

function Initialize-IntersightKubernetesDeployment {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("kubernetes.Deployment")]
        [String]
        ${ClassId} = "kubernetes.Deployment",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("kubernetes.Deployment")]
        [String]
        ${ObjectType} = "kubernetes.Deployment",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesDeployment' | Write-Debug
...
Convert from JSON to KubernetesDeployment<PSCustomObject>
...
KubernetesDeployment<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesDeployment {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesDeployment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesDeployment
