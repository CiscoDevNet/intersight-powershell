...
SearchTagItem<PSCustomObject>
#>

function Initialize-IntersightSearchTagItem {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("search.TagItem")]
        [String]
        ${ClassId} = "search.TagItem",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("search.TagItem")]
        [String]
        ${ObjectType} = "search.TagItem",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSearchTagItem' | Write-Debug
...
Convert from JSON to SearchTagItem<PSCustomObject>
...
SearchTagItem<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSearchTagItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSearchTagItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSearchTagItem
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Count", "Key", "Values")
