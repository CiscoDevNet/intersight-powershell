...
CapabilitySwitchManufacturingDefList<PSCustomObject>
#>

function Initialize-IntersightCapabilitySwitchManufacturingDefList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilitySwitchManufacturingDefList' | Write-Debug
...
Convert from JSON to CapabilitySwitchManufacturingDefList<PSCustomObject>
...
CapabilitySwitchManufacturingDefList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilitySwitchManufacturingDefList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilitySwitchManufacturingDefList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilitySwitchManufacturingDefList
