...
IppoolIpV4Config<PSCustomObject>
#>

function Initialize-IntersightIppoolIpV4Config {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIppoolIpV4Config' | Write-Debug
...
Convert from JSON to IppoolIpV4Config<PSCustomObject>
...
IppoolIpV4Config<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIppoolIpV4Config {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIppoolIpV4Config' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIppoolIpV4Config
