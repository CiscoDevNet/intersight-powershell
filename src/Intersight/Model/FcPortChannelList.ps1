...
FcPortChannelList<PSCustomObject>
#>

function Initialize-IntersightFcPortChannelList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFcPortChannelList' | Write-Debug
...
Convert from JSON to FcPortChannelList<PSCustomObject>
...
FcPortChannelList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFcPortChannelList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFcPortChannelList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFcPortChannelList
