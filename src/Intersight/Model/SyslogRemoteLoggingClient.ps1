...
SyslogRemoteLoggingClient<PSCustomObject>
#>

function Initialize-IntersightSyslogRemoteLoggingClient {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSyslogRemoteLoggingClient' | Write-Debug
...
Convert from JSON to SyslogRemoteLoggingClient<PSCustomObject>
...
SyslogRemoteLoggingClient<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSyslogRemoteLoggingClient {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSyslogRemoteLoggingClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSyslogRemoteLoggingClient
