...
BootHddDeviceList<PSCustomObject>
#>

function Initialize-IntersightBootHddDeviceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootHddDeviceList' | Write-Debug
...
Convert from JSON to BootHddDeviceList<PSCustomObject>
...
BootHddDeviceList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootHddDeviceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootHddDeviceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootHddDeviceList
