...
FirmwareUpgradeImpactStatusListAllOf<PSCustomObject>
#>

function Initialize-IntersightFirmwareUpgradeImpactStatusListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareUpgradeImpactStatusListAllOf' | Write-Debug
...
Convert from JSON to FirmwareUpgradeImpactStatusListAllOf<PSCustomObject>
...
FirmwareUpgradeImpactStatusListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareUpgradeImpactStatusListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareUpgradeImpactStatusListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareUpgradeImpactStatusListAllOf
