...
IamLdapProvider<PSCustomObject>
#>

function Initialize-IntersightIamLdapProvider {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iam.LdapProvider")]
        [String]
        ${ClassId} = "iam.LdapProvider",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iam.LdapProvider")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamLdapProvider' | Write-Debug
...
Convert from JSON to IamLdapProvider<PSCustomObject>
...
IamLdapProvider<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamLdapProvider {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamLdapProvider' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamLdapProvider
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Port", "Server", "LdapPolicy")
