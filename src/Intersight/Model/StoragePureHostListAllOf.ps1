...
StoragePureHostListAllOf<PSCustomObject>
#>

function Initialize-IntersightStoragePureHostListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePureHostListAllOf' | Write-Debug
...
Convert from JSON to StoragePureHostListAllOf<PSCustomObject>
...
StoragePureHostListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePureHostListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePureHostListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePureHostListAllOf
