...
function ConvertFrom-IntersightJsonToSoftwarerepositoryCategoryMapper {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Category", "FileType", "MdfId", "RegexPattern", "Source", "SupportedModels", "SwId", "TagTypes", "Version")
