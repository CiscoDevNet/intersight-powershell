...
function ConvertFrom-IntersightJsonToSoftwarerepositoryCategoryMapper {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Section", "Category", "FileType", "MdfId", "RegexPattern", "Source", "SupportedModels", "SwId", "TagTypes", "Version")
