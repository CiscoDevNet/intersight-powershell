...
function ConvertFrom-IntersightJsonToAssetDeviceClaim {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceUpdates", "SecurityToken", "SerialNumber", "Account", "Device")
