...
function Initialize-IntersightEquipmentAbstractDevice {
    ...
    Param (
        ...
        [ValidateSet("storage.HitachiArray", "storage.PureArray")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiArray", "storage.PureArray")]
...
function ConvertFrom-IntersightJsonToEquipmentAbstractDevice {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Name", "Uuid", "Version")
