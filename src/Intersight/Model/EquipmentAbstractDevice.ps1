...
EquipmentAbstractDevice<PSCustomObject>
#>

function Initialize-IntersightEquipmentAbstractDevice {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiArray", "storage.NetAppCluster", "storage.PureArray")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiArray", "storage.NetAppCluster", "storage.PureArray")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentAbstractDevice' | Write-Debug
...
Convert from JSON to EquipmentAbstractDevice<PSCustomObject>
...
EquipmentAbstractDevice<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentAbstractDevice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentAbstractDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentAbstractDevice
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Name", "Uuid", "Version")
