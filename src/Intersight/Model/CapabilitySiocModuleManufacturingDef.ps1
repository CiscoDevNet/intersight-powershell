...
CapabilitySiocModuleManufacturingDef<PSCustomObject>
#>

function Initialize-IntersightCapabilitySiocModuleManufacturingDef {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.SiocModuleManufacturingDef")]
        [String]
        ${ClassId} = "capability.SiocModuleManufacturingDef",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.SiocModuleManufacturingDef")]
        [String]
        ${ObjectType} = "capability.SiocModuleManufacturingDef",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilitySiocModuleManufacturingDef' | Write-Debug
...
Convert from JSON to CapabilitySiocModuleManufacturingDef<PSCustomObject>
...
CapabilitySiocModuleManufacturingDef<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilitySiocModuleManufacturingDef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilitySiocModuleManufacturingDef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilitySiocModuleManufacturingDef
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Caption", "Description", "Pid", "ProductName", "Sku", "Vid")
