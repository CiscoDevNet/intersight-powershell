...
function ConvertFrom-IntersightJsonToRecoveryBackupProfile {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Type", "SrcTemplate", "Action", "ConfigContext", "Enabled", "BackupConfig", "ConfigResult", "DeviceId", "Organization", "ScheduleConfig")
