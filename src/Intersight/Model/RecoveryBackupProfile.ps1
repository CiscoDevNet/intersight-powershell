...
RecoveryBackupProfile<PSCustomObject>
#>

function Initialize-IntersightRecoveryBackupProfile {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("recovery.BackupProfile")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightRecoveryBackupProfile' | Write-Debug
...
Convert from JSON to RecoveryBackupProfile<PSCustomObject>
...
RecoveryBackupProfile<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToRecoveryBackupProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightRecoveryBackupProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightRecoveryBackupProfile
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Type", "SrcTemplate", "Action", "ConfigContext", "Enabled", "BackupConfig", "ConfigResult", "DeviceId", "Organization", "ScheduleConfig")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "BackupConfig"))) { #optional property not found
            $BackupConfig = $null
        } else {
            $BackupConfig = $JsonParameters.PSobject.Properties["BackupConfig"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ScheduleConfig"))) { #optional property not found
            $ScheduleConfig = $null
        } else {
            $ScheduleConfig = $JsonParameters.PSobject.Properties["ScheduleConfig"].value
        }
