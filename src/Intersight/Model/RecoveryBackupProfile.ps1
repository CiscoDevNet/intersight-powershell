...
function ConvertFrom-IntersightJsonToRecoveryBackupProfile {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Type", "SrcTemplate", "Action", "ConfigContext", "Enabled", "BackupConfig", "ConfigResult", "DeviceId", "Organization", "ScheduleConfig")
