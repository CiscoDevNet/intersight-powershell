...
.PARAMETER ValueAttribute
A property from the Intersight object, value of which can be used as value for referenced input definition.
.OUTPUTS

WorkflowMoReferencePropertyAllOf<PSCustomObject>
#>

function Initialize-IntersightWorkflowMoReferencePropertyAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.MoReferenceProperty")]
        [String]
        ${ClassId} = "workflow.MoReferenceProperty",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.MoReferenceProperty")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowMoReferencePropertyAllOf' | Write-Debug
...
Convert from JSON to WorkflowMoReferencePropertyAllOf<PSCustomObject>
...
WorkflowMoReferencePropertyAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowMoReferencePropertyAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowMoReferencePropertyAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowMoReferencePropertyAllOf
        $AllProperties = ("ClassId", "ObjectType", "DisplayAttributes", "Selector", "ValueAttribute")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ValueAttribute"))) { #optional property not found
            $ValueAttribute = $null
        } else {
            $ValueAttribute = $JsonParameters.PSobject.Properties["ValueAttribute"].value
        }
