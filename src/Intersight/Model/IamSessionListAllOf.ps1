...
IamSessionListAllOf<PSCustomObject>
#>

function Initialize-IntersightIamSessionListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamSessionListAllOf' | Write-Debug
...
Convert from JSON to IamSessionListAllOf<PSCustomObject>
...
IamSessionListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamSessionListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamSessionListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamSessionListAllOf
