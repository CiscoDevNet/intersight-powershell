...
TelemetryDruidOrFilter<PSCustomObject>
#>

function Initialize-IntersightTelemetryDruidOrFilter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTelemetryDruidOrFilter' | Write-Debug
...
Convert from JSON to TelemetryDruidOrFilter<PSCustomObject>
...
TelemetryDruidOrFilter<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTelemetryDruidOrFilter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTelemetryDruidOrFilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTelemetryDruidOrFilter
