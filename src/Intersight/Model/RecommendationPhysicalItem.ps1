...
RecommendationPhysicalItem<PSCustomObject>
#>

function Initialize-IntersightRecommendationPhysicalItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightRecommendationPhysicalItem' | Write-Debug
...
Convert from JSON to RecommendationPhysicalItem<PSCustomObject>
...
RecommendationPhysicalItem<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToRecommendationPhysicalItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightRecommendationPhysicalItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightRecommendationPhysicalItem
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Type", "Capacity", "Count", "IsNew", "MaxCount", "Model", "SourceMoid", "Unit", "Uuid", "CapacityRunway", "PhysicalItem")
