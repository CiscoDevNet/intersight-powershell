...
EquipmentIoCardOperation<PSCustomObject>
#>

function Initialize-IntersightEquipmentIoCardOperation {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.IoCardOperation")]
        [String]
        ${ClassId} = "equipment.IoCardOperation",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.IoCardOperation")]
        [String]
        ${ObjectType} = "equipment.IoCardOperation",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentIoCardOperation' | Write-Debug
...
Convert from JSON to EquipmentIoCardOperation<PSCustomObject>
...
EquipmentIoCardOperation<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentIoCardOperation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentIoCardOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentIoCardOperation
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AdminPowerState", "ConfigState", "DeviceRegistration", "IoCard")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "IoCard"))) { #optional property not found
            $IoCard = $null
        } else {
            $IoCard = $JsonParameters.PSobject.Properties["IoCard"].value
        }
