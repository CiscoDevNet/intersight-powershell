...
PolicyConfigContextAllOf<PSCustomObject>
#>

function Initialize-IntersightPolicyConfigContextAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPolicyConfigContextAllOf' | Write-Debug
...
Convert from JSON to PolicyConfigContextAllOf<PSCustomObject>
...
PolicyConfigContextAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPolicyConfigContextAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPolicyConfigContextAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPolicyConfigContextAllOf
        $AllProperties = ("ConfigState", "ControlAction", "ErrorState", "OperState")
