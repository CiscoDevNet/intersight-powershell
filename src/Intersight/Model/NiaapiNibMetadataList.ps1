...
NiaapiNibMetadataList<PSCustomObject>
#>

function Initialize-IntersightNiaapiNibMetadataList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiNibMetadataList' | Write-Debug
...
Convert from JSON to NiaapiNibMetadataList<PSCustomObject>
...
NiaapiNibMetadataList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiNibMetadataList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiNibMetadataList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiNibMetadataList
