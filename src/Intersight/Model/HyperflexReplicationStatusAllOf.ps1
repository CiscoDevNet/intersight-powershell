...
Definition of the list of properties defined in 'hyperflex.ReplicationStatus', excluding properties defined in parent classes.
...
HyperflexReplicationStatusAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexReplicationStatusAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexReplicationStatusAllOf' | Write-Debug
...
Convert from JSON to HyperflexReplicationStatusAllOf<PSCustomObject>
...
HyperflexReplicationStatusAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexReplicationStatusAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexReplicationStatusAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexReplicationStatusAllOf
