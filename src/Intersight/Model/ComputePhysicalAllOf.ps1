...
function ConvertFrom-IntersightJsonToComputePhysicalAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AdminPowerState", "AlarmSummary", "AssetTag", "AvailableMemory", "BiosPostComplete", "FaultSummary", "KvmIpAddresses", "ManagementMode", "MemorySpeed", "MgmtIpAddress", "NumAdaptors", "NumCpuCores", "NumCpuCoresEnabled", "NumCpus", "NumEthHostInterfaces", "NumFcHostInterfaces", "NumThreads", "OperPowerState", "OperReason", "OperState", "Operability", "PlatformType", "Presence", "ServiceProfile", "TotalMemory", "UserLabel", "Uuid", "BootCddDevices", "BootDeviceBootSecurity", "BootHddDevices", "BootIscsiDevices", "BootNvmeDevices", "BootPchStorageDevices", "BootPxeDevices", "BootSanDevices", "BootSdDevices", "BootUefiShellDevices", "BootUsbDevices", "BootVmediaDevices", "MgmtIdentity", "Vmedia")
