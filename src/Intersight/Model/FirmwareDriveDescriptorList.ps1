...
FirmwareDriveDescriptorList<PSCustomObject>
#>

function Initialize-IntersightFirmwareDriveDescriptorList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareDriveDescriptorList' | Write-Debug
...
Convert from JSON to FirmwareDriveDescriptorList<PSCustomObject>
...
FirmwareDriveDescriptorList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareDriveDescriptorList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareDriveDescriptorList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareDriveDescriptorList
