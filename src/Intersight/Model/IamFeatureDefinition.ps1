...
IamFeatureDefinition<PSCustomObject>
#>

function Initialize-IntersightIamFeatureDefinition {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamFeatureDefinition' | Write-Debug
...
Convert from JSON to IamFeatureDefinition<PSCustomObject>
...
IamFeatureDefinition<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamFeatureDefinition {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamFeatureDefinition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamFeatureDefinition
