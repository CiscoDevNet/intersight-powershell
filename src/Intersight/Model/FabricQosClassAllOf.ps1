...
FabricQosClassAllOf<PSCustomObject>
#>

function Initialize-IntersightFabricQosClassAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricQosClassAllOf' | Write-Debug
...
Convert from JSON to FabricQosClassAllOf<PSCustomObject>
...
FabricQosClassAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricQosClassAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricQosClassAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricQosClassAllOf
        $AllProperties = ("AdminState", "BandwidthPercent", "Cos", "Mtu", "MulticastOptimize", "Name", "PacketDrop", "Weight")
