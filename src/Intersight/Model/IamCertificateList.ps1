...
IamCertificateList<PSCustomObject>
#>

function Initialize-IntersightIamCertificateList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamCertificateList' | Write-Debug
...
Convert from JSON to IamCertificateList<PSCustomObject>
...
IamCertificateList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamCertificateList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamCertificateList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamCertificateList
