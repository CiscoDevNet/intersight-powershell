...
HyperflexClusterBackupPolicyList<PSCustomObject>
#>

function Initialize-IntersightHyperflexClusterBackupPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexClusterBackupPolicyList' | Write-Debug
...
Convert from JSON to HyperflexClusterBackupPolicyList<PSCustomObject>
...
HyperflexClusterBackupPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexClusterBackupPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexClusterBackupPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexClusterBackupPolicyList
