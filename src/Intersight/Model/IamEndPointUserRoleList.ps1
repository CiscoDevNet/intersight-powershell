...
IamEndPointUserRoleList<PSCustomObject>
#>

function Initialize-IntersightIamEndPointUserRoleList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamEndPointUserRoleList' | Write-Debug
...
Convert from JSON to IamEndPointUserRoleList<PSCustomObject>
...
IamEndPointUserRoleList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamEndPointUserRoleList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamEndPointUserRoleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamEndPointUserRoleList
