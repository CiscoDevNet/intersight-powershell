...
KubernetesDaemonSetList<PSCustomObject>
#>

function Initialize-IntersightKubernetesDaemonSetList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesDaemonSetList' | Write-Debug
...
Convert from JSON to KubernetesDaemonSetList<PSCustomObject>
...
KubernetesDaemonSetList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesDaemonSetList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesDaemonSetList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesDaemonSetList
