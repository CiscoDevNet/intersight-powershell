...
BiosSystemBootOrder<PSCustomObject>
#>

function Initialize-IntersightBiosSystemBootOrder {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("bios.SystemBootOrder")]
        [String]
        ${ClassId} = "bios.SystemBootOrder",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("bios.SystemBootOrder")]
        [String]
        ${ObjectType} = "bios.SystemBootOrder",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBiosSystemBootOrder' | Write-Debug
...
Convert from JSON to BiosSystemBootOrder<PSCustomObject>
...
BiosSystemBootOrder<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBiosSystemBootOrder {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBiosSystemBootOrder' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBiosSystemBootOrder
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "BootMode", "Dn", "SecureBoot", "BiosUnit", "BootDevices", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "BootMode"))) { #optional property not found
            $BootMode = $null
        } else {
            $BootMode = $JsonParameters.PSobject.Properties["BootMode"].value
        }
