...
NiaapiApicReleaseRecommendListAllOf<PSCustomObject>
#>

function Initialize-IntersightNiaapiApicReleaseRecommendListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiApicReleaseRecommendListAllOf' | Write-Debug
...
Convert from JSON to NiaapiApicReleaseRecommendListAllOf<PSCustomObject>
...
NiaapiApicReleaseRecommendListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiApicReleaseRecommendListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiApicReleaseRecommendListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiApicReleaseRecommendListAllOf
