...
CapabilityPsuDescriptor<PSCustomObject>
#>

function Initialize-IntersightCapabilityPsuDescriptor {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.PsuDescriptor")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilityPsuDescriptor' | Write-Debug
...
Convert from JSON to CapabilityPsuDescriptor<PSCustomObject>
...
CapabilityPsuDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilityPsuDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilityPsuDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilityPsuDescriptor
