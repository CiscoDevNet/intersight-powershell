...
ApplianceBackupList<PSCustomObject>
#>

function Initialize-IntersightApplianceBackupList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightApplianceBackupList' | Write-Debug
...
Convert from JSON to ApplianceBackupList<PSCustomObject>
...
ApplianceBackupList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToApplianceBackupList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightApplianceBackupList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightApplianceBackupList
