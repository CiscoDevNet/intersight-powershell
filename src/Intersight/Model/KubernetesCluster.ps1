...
function Initialize-IntersightKubernetesCluster {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesCluster' | Write-Debug
...
Convert from JSON to KubernetesCluster<PSCustomObject>
...
KubernetesCluster<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesCluster {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesCluster' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesCluster
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ConnectionStatus", "KubeConfig", "Name", "_0_ClusterProfile", "Organization", "RegisteredDevices")
