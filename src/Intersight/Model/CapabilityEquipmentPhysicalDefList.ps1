...
CapabilityEquipmentPhysicalDefList<PSCustomObject>
#>

function Initialize-IntersightCapabilityEquipmentPhysicalDefList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilityEquipmentPhysicalDefList' | Write-Debug
...
Convert from JSON to CapabilityEquipmentPhysicalDefList<PSCustomObject>
...
CapabilityEquipmentPhysicalDefList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilityEquipmentPhysicalDefList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilityEquipmentPhysicalDefList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilityEquipmentPhysicalDefList
