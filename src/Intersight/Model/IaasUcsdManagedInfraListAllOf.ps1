...
IaasUcsdManagedInfraListAllOf<PSCustomObject>
#>

function Initialize-IntersightIaasUcsdManagedInfraListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIaasUcsdManagedInfraListAllOf' | Write-Debug
...
Convert from JSON to IaasUcsdManagedInfraListAllOf<PSCustomObject>
...
IaasUcsdManagedInfraListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIaasUcsdManagedInfraListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIaasUcsdManagedInfraListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIaasUcsdManagedInfraListAllOf
