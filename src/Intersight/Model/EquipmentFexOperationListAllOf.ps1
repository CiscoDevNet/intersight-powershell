...
EquipmentFexOperationListAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentFexOperationListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentFexOperationListAllOf' | Write-Debug
...
Convert from JSON to EquipmentFexOperationListAllOf<PSCustomObject>
...
EquipmentFexOperationListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentFexOperationListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentFexOperationListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentFexOperationListAllOf
