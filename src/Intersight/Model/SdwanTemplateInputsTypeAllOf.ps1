...
SdwanTemplateInputsTypeAllOf<PSCustomObject>
#>

function Initialize-IntersightSdwanTemplateInputsTypeAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSdwanTemplateInputsTypeAllOf' | Write-Debug
...
Convert from JSON to SdwanTemplateInputsTypeAllOf<PSCustomObject>
...
SdwanTemplateInputsTypeAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSdwanTemplateInputsTypeAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSdwanTemplateInputsTypeAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSdwanTemplateInputsTypeAllOf
