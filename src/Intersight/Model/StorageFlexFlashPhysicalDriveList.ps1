...
StorageFlexFlashPhysicalDriveList<PSCustomObject>
#>

function Initialize-IntersightStorageFlexFlashPhysicalDriveList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageFlexFlashPhysicalDriveList' | Write-Debug
...
Convert from JSON to StorageFlexFlashPhysicalDriveList<PSCustomObject>
...
StorageFlexFlashPhysicalDriveList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageFlexFlashPhysicalDriveList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageFlexFlashPhysicalDriveList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageFlexFlashPhysicalDriveList
