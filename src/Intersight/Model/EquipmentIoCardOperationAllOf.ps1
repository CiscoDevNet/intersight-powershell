...
EquipmentIoCardOperationAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentIoCardOperationAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentIoCardOperationAllOf' | Write-Debug
...
Convert from JSON to EquipmentIoCardOperationAllOf<PSCustomObject>
...
EquipmentIoCardOperationAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentIoCardOperationAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentIoCardOperationAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentIoCardOperationAllOf
        $AllProperties = ("ClassId", "ObjectType", "AdminPowerState", "ConfigState", "DeviceRegistration", "IoCard")
