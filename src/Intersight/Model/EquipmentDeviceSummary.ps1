...
function ConvertFrom-IntersightJsonToEquipmentDeviceSummary {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Dn", "Model", "Serial", "SourceObjectType", "ComputeRackUnit", "EquipmentChassis", "InventoryDeviceInfo", "RegisteredDevice")
