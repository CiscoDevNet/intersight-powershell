...
EquipmentDeviceSummary<PSCustomObject>
#>

function Initialize-IntersightEquipmentDeviceSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentDeviceSummary' | Write-Debug
...
Convert from JSON to EquipmentDeviceSummary<PSCustomObject>
...
EquipmentDeviceSummary<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentDeviceSummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentDeviceSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentDeviceSummary
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Dn", "Model", "Serial", "SourceObjectType", "ComputeRackUnit", "InventoryDeviceInfo", "RegisteredDevice")
