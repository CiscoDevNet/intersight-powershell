...
BootVirtualMedia<PSCustomObject>
#>

function Initialize-IntersightBootVirtualMedia {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootVirtualMedia' | Write-Debug
...
Convert from JSON to BootVirtualMedia<PSCustomObject>
...
BootVirtualMedia<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootVirtualMedia {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootVirtualMedia' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootVirtualMedia
        $AllProperties = ("ClassId", "ObjectType", "Enabled", "Name", "Subtype")
