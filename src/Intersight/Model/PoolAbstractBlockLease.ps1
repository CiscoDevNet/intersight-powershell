...
PoolAbstractBlockLease<PSCustomObject>
#>

function Initialize-IntersightPoolAbstractBlockLease {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPoolAbstractBlockLease' | Write-Debug
...
Convert from JSON to PoolAbstractBlockLease<PSCustomObject>
...
PoolAbstractBlockLease<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPoolAbstractBlockLease {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPoolAbstractBlockLease' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPoolAbstractBlockLease
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Count")
