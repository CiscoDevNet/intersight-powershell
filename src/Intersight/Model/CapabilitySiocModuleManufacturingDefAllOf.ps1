...
CapabilitySiocModuleManufacturingDefAllOf<PSCustomObject>
#>

function Initialize-IntersightCapabilitySiocModuleManufacturingDefAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilitySiocModuleManufacturingDefAllOf' | Write-Debug
...
Convert from JSON to CapabilitySiocModuleManufacturingDefAllOf<PSCustomObject>
...
CapabilitySiocModuleManufacturingDefAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilitySiocModuleManufacturingDefAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilitySiocModuleManufacturingDefAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilitySiocModuleManufacturingDefAllOf
        $AllProperties = ("ClassId", "ObjectType", "Caption", "Description", "Pid", "ProductName", "Sku", "Vid")
