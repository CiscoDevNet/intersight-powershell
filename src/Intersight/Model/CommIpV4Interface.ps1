...
CommIpV4Interface<PSCustomObject>
#>

function Initialize-IntersightCommIpV4Interface {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCommIpV4Interface' | Write-Debug
...
Convert from JSON to CommIpV4Interface<PSCustomObject>
...
CommIpV4Interface<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCommIpV4Interface {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCommIpV4Interface' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCommIpV4Interface
