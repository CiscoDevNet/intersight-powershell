...
HyperflexHealthCheckExecution<PSCustomObject>
#>

function Initialize-IntersightHyperflexHealthCheckExecution {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.HealthCheckExecution")]
        [String]
        ${ClassId} = "hyperflex.HealthCheckExecution",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.HealthCheckExecution")]
        [String]
        ${ObjectType} = "hyperflex.HealthCheckExecution",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexHealthCheckExecution' | Write-Debug
...
Convert from JSON to HyperflexHealthCheckExecution<PSCustomObject>
...
HyperflexHealthCheckExecution<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexHealthCheckExecution {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexHealthCheckExecution' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexHealthCheckExecution
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Category", "Cause", "CompletionTime", "HealthCheckDetails", "HealthCheckExecutionErrorDetails", "HealthCheckExecutionErrorSummary", "HealthCheckExecutionStatus", "HealthCheckResult", "HealthCheckSummary", "HxDeviceName", "Uuid", "HealthCheckDefinition", "HxCluster", "RegisteredDevice")
