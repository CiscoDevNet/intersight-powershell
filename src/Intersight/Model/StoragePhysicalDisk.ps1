...
function ConvertFrom-IntersightJsonToStoragePhysicalDisk {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "BlockSize", "Bootable", "ConfigurationCheckpoint", "ConfigurationState", "DiscoveredPath", "DiskId", "DiskState", "DriveFirmware", "DriveState", "FdeCapable", "HotSpareType", "LinkSpeed", "LinkState", "NumBlocks", "OperPowerState", "OperQualifierReason", "Operability", "PhysicalBlockSize", "Pid", "Presence", "Protocol", "RawSize", "Secured", "Size", "Thermal", "Type", "VariantType", "InventoryDeviceInfo", "LocatorLed", "PhysicalDiskExtensions", "RegisteredDevice", "RunningFirmware", "SasPorts", "StorageController", "StorageEnclosure")
