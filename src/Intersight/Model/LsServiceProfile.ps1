...
function ConvertFrom-IntersightJsonToLsServiceProfile {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "AssignState", "AssocState", "AssociatedServer", "ConfigState", "Name", "OperState", "InventoryDeviceInfo", "RegisteredDevice")
