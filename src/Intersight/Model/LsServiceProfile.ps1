...
function ConvertFrom-IntersightJsonToLsServiceProfile {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "AssignState", "AssocState", "AssociatedServer", "ConfigState", "Name", "OperState", "InventoryDeviceInfo", "RegisteredDevice")
