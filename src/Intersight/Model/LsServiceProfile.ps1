...
LsServiceProfile<PSCustomObject>
#>

function Initialize-IntersightLsServiceProfile {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("ls.ServiceProfile")]
        [String]
        ${ClassId} = "ls.ServiceProfile",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("ls.ServiceProfile")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightLsServiceProfile' | Write-Debug
...
Convert from JSON to LsServiceProfile<PSCustomObject>
...
LsServiceProfile<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToLsServiceProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightLsServiceProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightLsServiceProfile
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "AssignState", "AssocState", "AssociatedServer", "ConfigState", "Name", "OperState", "InventoryDeviceInfo", "RegisteredDevice")
