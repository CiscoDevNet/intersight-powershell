...
ForecastDefinitionListAllOf<PSCustomObject>
#>

function Initialize-IntersightForecastDefinitionListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightForecastDefinitionListAllOf' | Write-Debug
...
Convert from JSON to ForecastDefinitionListAllOf<PSCustomObject>
...
ForecastDefinitionListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToForecastDefinitionListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightForecastDefinitionListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightForecastDefinitionListAllOf
