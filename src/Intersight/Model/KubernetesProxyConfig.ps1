...
Configration for a proxy server.
...
KubernetesProxyConfig<PSCustomObject>
#>

function Initialize-IntersightKubernetesProxyConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesProxyConfig' | Write-Debug
...
Convert from JSON to KubernetesProxyConfig<PSCustomObject>
...
KubernetesProxyConfig<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesProxyConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesProxyConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesProxyConfig
