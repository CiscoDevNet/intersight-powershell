...
function ConvertFrom-IntersightJsonToConnectorHttpRequest {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "EncryptedAesKey", "EncryptionKey", "SecureProperties", "AssetTargetMoid", "Body", "DialTimeout", "EndpointMoid", "Header", "Internal", "Method", "Timeout", "Url")
