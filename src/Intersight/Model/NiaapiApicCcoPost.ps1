...
NiaapiApicCcoPost<PSCustomObject>
#>

function Initialize-IntersightNiaapiApicCcoPost {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiApicCcoPost' | Write-Debug
...
Convert from JSON to NiaapiApicCcoPost<PSCustomObject>
...
NiaapiApicCcoPost<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiApicCcoPost {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiApicCcoPost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiApicCcoPost
