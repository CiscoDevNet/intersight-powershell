...
IamLocalUserPasswordPolicyList<PSCustomObject>
#>

function Initialize-IntersightIamLocalUserPasswordPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamLocalUserPasswordPolicyList' | Write-Debug
...
Convert from JSON to IamLocalUserPasswordPolicyList<PSCustomObject>
...
IamLocalUserPasswordPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamLocalUserPasswordPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamLocalUserPasswordPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamLocalUserPasswordPolicyList
