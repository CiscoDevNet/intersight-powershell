...
FirmwareRunningFirmwareList<PSCustomObject>
#>

function Initialize-IntersightFirmwareRunningFirmwareList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareRunningFirmwareList' | Write-Debug
...
Convert from JSON to FirmwareRunningFirmwareList<PSCustomObject>
...
FirmwareRunningFirmwareList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareRunningFirmwareList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareRunningFirmwareList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareRunningFirmwareList
