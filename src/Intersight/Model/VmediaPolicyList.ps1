...
VmediaPolicyList<PSCustomObject>
#>

function Initialize-IntersightVmediaPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVmediaPolicyList' | Write-Debug
...
Convert from JSON to VmediaPolicyList<PSCustomObject>
...
VmediaPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVmediaPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVmediaPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVmediaPolicyList
