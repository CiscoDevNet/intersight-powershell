...
function Initialize-IntersightVirtualizationVmwareCluster {
    ...
    Param (
        ...
        [ValidateSet("virtualization.VmwareCluster")]
        [String]
        ${ClassId} = "virtualization.VmwareCluster",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("virtualization.VmwareCluster")]
        [String]
...
function ConvertFrom-IntersightJsonToVirtualizationVmwareCluster {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "HypervisorType", "Identity", "MemoryCapacity", "Name", "ProcessorCapacity", "Status", "TotalCores", "DatastoreCount", "Datacenter", "RegisteredDevice")
