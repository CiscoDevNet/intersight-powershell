...
function ConvertFrom-IntersightJsonToMemoryArray {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ArrayId", "CpuId", "CurrentCapacity", "ErrorCorrection", "MaxCapacity", "MaxDevices", "OperPowerState", "Presence", "ComputeBlade", "ComputeBoard", "ComputeRackUnit", "InventoryDeviceInfo", "PersistentMemoryUnits", "RegisteredDevice", "Units")
