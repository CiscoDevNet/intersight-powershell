...
MemoryArray<PSCustomObject>
#>

function Initialize-IntersightMemoryArray {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("memory.Array")]
        [String]
        ${ClassId} = "memory.Array",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("memory.Array")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMemoryArray' | Write-Debug
...
Convert from JSON to MemoryArray<PSCustomObject>
...
MemoryArray<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMemoryArray {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMemoryArray' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMemoryArray
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ArrayId", "CpuId", "CurrentCapacity", "ErrorCorrection", "MaxCapacity", "MaxDevices", "OperPowerState", "Presence", "ComputeBlade", "ComputeBoard", "ComputeRackUnit", "InventoryDeviceInfo", "PersistentMemoryUnits", "RegisteredDevice", "Units")
