...
function ConvertFrom-IntersightJsonToMemoryArray {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ArrayId", "CpuId", "CurrentCapacity", "ErrorCorrection", "MaxCapacity", "MaxDevices", "OperPowerState", "Presence", "ComputeBlade", "ComputeBoard", "ComputeRackUnit", "InventoryDeviceInfo", "PersistentMemoryUnits", "RegisteredDevice", "Units")
