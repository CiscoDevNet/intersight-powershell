...
AssetDeviceClaimAllOf<PSCustomObject>
#>

function Initialize-IntersightAssetDeviceClaimAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAssetDeviceClaimAllOf' | Write-Debug
...
Convert from JSON to AssetDeviceClaimAllOf<PSCustomObject>
...
AssetDeviceClaimAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAssetDeviceClaimAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAssetDeviceClaimAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAssetDeviceClaimAllOf
        $AllProperties = ("ClassId", "ObjectType", "DeviceUpdates", "SecurityToken", "SerialNumber", "Account", "Device")
