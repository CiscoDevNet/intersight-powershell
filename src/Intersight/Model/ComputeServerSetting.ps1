...
function ConvertFrom-IntersightJsonToComputeServerSetting {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "AdminLocatorLedState", "AdminPowerState", "ConfigState", "OneTimeBootDevice", "PersistentMemoryOperation", "ServerConfig", "LocatorLed", "RegisteredDevice", "RunningWorkflow", "Server")
