...
function ConvertFrom-IntersightJsonToComputeServerSetting {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "AdminLocatorLedState", "AdminPowerState", "ConfigState", "OneTimeBootDevice", "PersistentMemoryOperation", "ServerConfig", "LocatorLed", "RegisteredDevice", "RunningWorkflow", "Server")
