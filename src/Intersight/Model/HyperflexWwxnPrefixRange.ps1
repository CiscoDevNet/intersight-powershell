...
HyperflexWwxnPrefixRange<PSCustomObject>
#>

function Initialize-IntersightHyperflexWwxnPrefixRange {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexWwxnPrefixRange' | Write-Debug
...
Convert from JSON to HyperflexWwxnPrefixRange<PSCustomObject>
...
HyperflexWwxnPrefixRange<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexWwxnPrefixRange {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexWwxnPrefixRange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexWwxnPrefixRange
