...
WorkflowWorkflowMetaListAllOf<PSCustomObject>
#>

function Initialize-IntersightWorkflowWorkflowMetaListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowWorkflowMetaListAllOf' | Write-Debug
...
Convert from JSON to WorkflowWorkflowMetaListAllOf<PSCustomObject>
...
WorkflowWorkflowMetaListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowWorkflowMetaListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowWorkflowMetaListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowWorkflowMetaListAllOf
