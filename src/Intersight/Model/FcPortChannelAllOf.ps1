...
function Initialize-IntersightFcPortChannelAllOf {
    ...
    Param (
        ...
        [ValidateSet("fc.PortChannel")]
        [String]
        ${ClassId} = "fc.PortChannel",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fc.PortChannel")]
        [String]
        ${ObjectType} = "fc.PortChannel",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${AdminSpeed},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
...
function ConvertFrom-IntersightJsonToFcPortChannelAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AdminSpeed", "AdminState", "Mode", "OperSpeed", "OperState", "OperStateQual", "PortChannelId", "Role", "SwitchId", "Vsan", "EquipmentSwitchCard", "RegisteredDevice")
