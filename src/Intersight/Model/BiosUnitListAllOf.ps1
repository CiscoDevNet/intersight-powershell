...
BiosUnitListAllOf<PSCustomObject>
#>

function Initialize-IntersightBiosUnitListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBiosUnitListAllOf' | Write-Debug
...
Convert from JSON to BiosUnitListAllOf<PSCustomObject>
...
BiosUnitListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBiosUnitListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBiosUnitListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBiosUnitListAllOf
