...
VnicEthInterruptSettings<PSCustomObject>
#>

function Initialize-IntersightVnicEthInterruptSettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVnicEthInterruptSettings' | Write-Debug
...
Convert from JSON to VnicEthInterruptSettings<PSCustomObject>
...
VnicEthInterruptSettings<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVnicEthInterruptSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVnicEthInterruptSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVnicEthInterruptSettings
