...
VnicFcErrorRecoverySettings<PSCustomObject>
#>

function Initialize-IntersightVnicFcErrorRecoverySettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVnicFcErrorRecoverySettings' | Write-Debug
...
Convert from JSON to VnicFcErrorRecoverySettings<PSCustomObject>
...
VnicFcErrorRecoverySettings<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVnicFcErrorRecoverySettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVnicFcErrorRecoverySettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVnicFcErrorRecoverySettings
