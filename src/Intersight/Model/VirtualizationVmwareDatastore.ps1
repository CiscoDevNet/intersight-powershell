...
function ConvertFrom-IntersightJsonToVirtualizationVmwareDatastore {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "RegisteredDevice", "Capacity", "HostCount", "Identity", "Name", "Type", "VmCount", "Accessible", "MaintenanceMode", "MultipleHostAccess", "Status", "ThinProvisioningSupported", "UnCommitted", "Url", "Cluster", "Datacenter", "Hosts")
