...
StoragePureSnapshotScheduleList<PSCustomObject>
#>

function Initialize-IntersightStoragePureSnapshotScheduleList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePureSnapshotScheduleList' | Write-Debug
...
Convert from JSON to StoragePureSnapshotScheduleList<PSCustomObject>
...
StoragePureSnapshotScheduleList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePureSnapshotScheduleList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePureSnapshotScheduleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePureSnapshotScheduleList
