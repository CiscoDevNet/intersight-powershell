...
function ConvertFrom-IntersightJsonToStorageDiskGroup {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Name", "RaidType", "DedicatedHotSpares", "RegisteredDevice", "Spans", "StorageController", "VirtualDrives")
