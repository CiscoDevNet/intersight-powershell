...
function ConvertFrom-IntersightJsonToStorageDiskGroup {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Name", "RaidType", "DedicatedHotSpares", "RegisteredDevice", "Spans", "StorageController", "VirtualDrives")
