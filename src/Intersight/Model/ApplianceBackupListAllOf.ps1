...
ApplianceBackupListAllOf<PSCustomObject>
#>

function Initialize-IntersightApplianceBackupListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightApplianceBackupListAllOf' | Write-Debug
...
Convert from JSON to ApplianceBackupListAllOf<PSCustomObject>
...
ApplianceBackupListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToApplianceBackupListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightApplianceBackupListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightApplianceBackupListAllOf
