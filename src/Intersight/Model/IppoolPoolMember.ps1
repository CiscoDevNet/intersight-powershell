...
IppoolPoolMember<PSCustomObject>
#>

function Initialize-IntersightIppoolPoolMember {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIppoolPoolMember' | Write-Debug
...
Convert from JSON to IppoolPoolMember<PSCustomObject>
...
IppoolPoolMember<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIppoolPoolMember {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIppoolPoolMember' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIppoolPoolMember
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Assigned", "IpType", "IpV4Address", "IpV6Address", "AssignedToEntity", "IpBlock", "Peer", "Pool")
