...
function ConvertFrom-IntersightJsonToIppoolPoolMember {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Assigned", "IpType", "IpV4Address", "IpV6Address", "AssignedToEntity", "IpBlock", "Peer", "Pool")
