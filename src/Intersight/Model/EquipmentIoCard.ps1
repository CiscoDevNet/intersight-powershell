...
function ConvertFrom-IntersightJsonToEquipmentIoCard {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ConnectionStatus", "Description", "ModuleId", "OperState", "PartNumber", "Pid", "Presence", "ProductName", "Sku", "Version", "Vid", "HostPorts", "MgmtController", "NetworkPorts", "ConnectionPath", "DcSupported", "Side", "EquipmentChassis", "InventoryDeviceInfo", "PhysicalDeviceRegistration", "RegisteredDevice")
