...
EquipmentIoCard<PSCustomObject>
#>

function Initialize-IntersightEquipmentIoCard {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.IoCard")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentIoCard' | Write-Debug
...
Convert from JSON to EquipmentIoCard<PSCustomObject>
...
EquipmentIoCard<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentIoCard {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentIoCard' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentIoCard
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ConnectionStatus", "Description", "ModuleId", "OperReason", "OperState", "PartNumber", "Pid", "Presence", "ProductName", "Sku", "Version", "Vid", "HostPorts", "MgmtController", "NetworkPorts", "ConnectionPath", "DcSupported", "Side", "EquipmentChassis", "EquipmentFex", "InventoryDeviceInfo", "PhysicalDeviceRegistration", "RegisteredDevice")
