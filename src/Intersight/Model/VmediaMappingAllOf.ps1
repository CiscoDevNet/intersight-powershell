...
VmediaMappingAllOf<PSCustomObject>
#>

function Initialize-IntersightVmediaMappingAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVmediaMappingAllOf' | Write-Debug
        ...
        if (!$RemoteFile -and $RemoteFile.length -lt 0) {
            throw "invalid value for 'RemoteFile', the character length must be great than or equal to 0."
        }
...
Convert from JSON to VmediaMappingAllOf<PSCustomObject>
...
VmediaMappingAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVmediaMappingAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVmediaMappingAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVmediaMappingAllOf
        $AllProperties = ("ClassId", "ObjectType", "AuthenticationProtocol", "DeviceType", "FileLocation", "HostName", "IsPasswordSet", "MountOptions", "MountProtocol", "Password", "RemoteFile", "RemotePath", "SanitizedFileLocation", "Username", "VolumeName")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "SanitizedFileLocation"))) { #optional property not found
            $SanitizedFileLocation = $null
        } else {
            $SanitizedFileLocation = $JsonParameters.PSobject.Properties["SanitizedFileLocation"].value
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "RemoteFile" = ${RemoteFile}
            "RemotePath" = ${RemotePath}
            "SanitizedFileLocation" = ${SanitizedFileLocation}
            "Username" = ${Username}
            "VolumeName" = ${VolumeName}
        }
