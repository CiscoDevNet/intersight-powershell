...
CondHclStatus<PSCustomObject>
#>

function Initialize-IntersightCondHclStatus {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("cond.HclStatus")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCondHclStatus' | Write-Debug
...
Convert from JSON to CondHclStatus<PSCustomObject>
...
CondHclStatus<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCondHclStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCondHclStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCondHclStatus
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ComponentStatus", "HardwareStatus", "HclFirmwareVersion", "HclModel", "HclOsVendor", "HclOsVersion", "HclProcessor", "InvFirmwareVersion", "InvModel", "InvOsVendor", "InvOsVersion", "InvProcessor", "Reason", "ServerReason", "SoftwareStatus", "Status", "Details", "ManagedObject", "RegisteredDevice")
