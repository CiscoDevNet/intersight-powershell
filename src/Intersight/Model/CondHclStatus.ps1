...
function ConvertFrom-IntersightJsonToCondHclStatus {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ComponentStatus", "HardwareStatus", "HclFirmwareVersion", "HclModel", "HclOsVendor", "HclOsVersion", "HclProcessor", "InvFirmwareVersion", "InvModel", "InvOsVendor", "InvOsVersion", "InvProcessor", "Reason", "ServerReason", "SoftwareStatus", "Status", "Details", "ManagedObject", "RegisteredDevice")
