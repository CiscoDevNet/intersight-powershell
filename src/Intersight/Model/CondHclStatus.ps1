...
function ConvertFrom-IntersightJsonToCondHclStatus {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ComponentStatus", "HardwareStatus", "HclFirmwareVersion", "HclModel", "HclOsVendor", "HclOsVersion", "HclProcessor", "InvFirmwareVersion", "InvModel", "InvOsVendor", "InvOsVersion", "InvProcessor", "Reason", "ServerReason", "SoftwareStatus", "Status", "Details", "ManagedObject", "RegisteredDevice")
