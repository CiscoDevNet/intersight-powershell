...
ApplianceGroupStatus<PSCustomObject>
#>

function Initialize-IntersightApplianceGroupStatus {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("appliance.GroupStatus")]
        [String]
        ${ClassId} = "appliance.GroupStatus",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("appliance.GroupStatus")]
        [String]
        ${ObjectType} = "appliance.GroupStatus",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightApplianceGroupStatus' | Write-Debug
...
Convert from JSON to ApplianceGroupStatus<PSCustomObject>
...
ApplianceGroupStatus<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToApplianceGroupStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightApplianceGroupStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightApplianceGroupStatus
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "GroupName", "OverallStatus", "Apps", "SystemStatus")
