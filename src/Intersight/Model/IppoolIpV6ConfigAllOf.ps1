...
Definition of the list of properties defined in 'ippool.IpV6Config', excluding properties defined in parent classes.
...
IppoolIpV6ConfigAllOf<PSCustomObject>
#>

function Initialize-IntersightIppoolIpV6ConfigAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIppoolIpV6ConfigAllOf' | Write-Debug
...
Convert from JSON to IppoolIpV6ConfigAllOf<PSCustomObject>
...
IppoolIpV6ConfigAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIppoolIpV6ConfigAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIppoolIpV6ConfigAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIppoolIpV6ConfigAllOf
