...
WorkflowParameterSetAllOf<PSCustomObject>
#>

function Initialize-IntersightWorkflowParameterSetAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowParameterSetAllOf' | Write-Debug
...
Convert from JSON to WorkflowParameterSetAllOf<PSCustomObject>
...
WorkflowParameterSetAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowParameterSetAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowParameterSetAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowParameterSetAllOf
