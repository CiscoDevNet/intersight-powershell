...
function Initialize-IntersightTamBaseAdvisory {
    ...
    Param (
        ...
        [ValidateSet("tam.AdvisoryDefinition", "tam.SecurityAdvisory")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("tam.AdvisoryDefinition", "tam.SecurityAdvisory")]
...
function ConvertFrom-IntersightJsonToTamBaseAdvisory {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Severity", "State")
