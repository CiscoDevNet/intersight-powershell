...
WorkflowWorkflowMetadata<PSCustomObject>
#>

function Initialize-IntersightWorkflowWorkflowMetadata {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowWorkflowMetadata' | Write-Debug
...
Convert from JSON to WorkflowWorkflowMetadata<PSCustomObject>
...
WorkflowWorkflowMetadata<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowWorkflowMetadata {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowWorkflowMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowWorkflowMetadata
