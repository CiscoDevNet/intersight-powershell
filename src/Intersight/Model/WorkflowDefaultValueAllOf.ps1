...
WorkflowDefaultValueAllOf<PSCustomObject>
#>

function Initialize-IntersightWorkflowDefaultValueAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.DefaultValue")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowDefaultValueAllOf' | Write-Debug
...
Convert from JSON to WorkflowDefaultValueAllOf<PSCustomObject>
...
WorkflowDefaultValueAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowDefaultValueAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowDefaultValueAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowDefaultValueAllOf
        $AllProperties = ("ClassId", "ObjectType", "Override", "Value")
