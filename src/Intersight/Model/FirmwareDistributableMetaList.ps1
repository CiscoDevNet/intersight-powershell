...
FirmwareDistributableMetaList<PSCustomObject>
#>

function Initialize-IntersightFirmwareDistributableMetaList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareDistributableMetaList' | Write-Debug
...
Convert from JSON to FirmwareDistributableMetaList<PSCustomObject>
...
FirmwareDistributableMetaList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareDistributableMetaList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareDistributableMetaList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareDistributableMetaList
