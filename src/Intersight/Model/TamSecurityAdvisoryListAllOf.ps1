...
TamSecurityAdvisoryListAllOf<PSCustomObject>
#>

function Initialize-IntersightTamSecurityAdvisoryListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTamSecurityAdvisoryListAllOf' | Write-Debug
...
Convert from JSON to TamSecurityAdvisoryListAllOf<PSCustomObject>
...
TamSecurityAdvisoryListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTamSecurityAdvisoryListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTamSecurityAdvisoryListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTamSecurityAdvisoryListAllOf
