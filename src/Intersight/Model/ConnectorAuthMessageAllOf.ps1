...
ConnectorAuthMessageAllOf<PSCustomObject>
#>

function Initialize-IntersightConnectorAuthMessageAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("connector.CommandControlMessage", "connector.XmlApiMessage", "imcconnector.WebUiMessage", "ucsdconnector.RestClientMessage")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("connector.CommandControlMessage", "connector.XmlApiMessage", "imcconnector.WebUiMessage", "ucsdconnector.RestClientMessage")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConnectorAuthMessageAllOf' | Write-Debug
...
Convert from JSON to ConnectorAuthMessageAllOf<PSCustomObject>
...
ConnectorAuthMessageAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConnectorAuthMessageAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConnectorAuthMessageAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConnectorAuthMessageAllOf
        $AllProperties = ("ClassId", "ObjectType", "RemoteUserLocale", "RemoteUserName", "RemoteUserRoles", "RemoteUserSessionId")
