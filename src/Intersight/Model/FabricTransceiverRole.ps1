...
Configuration object sent by user to apply on a transceiver.
...
FabricTransceiverRole<PSCustomObject>
#>

function Initialize-IntersightFabricTransceiverRole {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.ApplianceRole", "fabric.FcoeUplinkRole", "fabric.UplinkRole")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.ApplianceRole", "fabric.FcoeUplinkRole", "fabric.UplinkRole")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricTransceiverRole' | Write-Debug
...
Convert from JSON to FabricTransceiverRole<PSCustomObject>
...
FabricTransceiverRole<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricTransceiverRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricTransceiverRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricTransceiverRole
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AggregatePortId", "PortId", "SlotId", "PortPolicy", "AdminSpeed", "Fec")
