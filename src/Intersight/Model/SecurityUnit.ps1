...
SecurityUnit<PSCustomObject>
#>

function Initialize-IntersightSecurityUnit {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSecurityUnit' | Write-Debug
...
Convert from JSON to SecurityUnit<PSCustomObject>
...
SecurityUnit<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSecurityUnit {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSecurityUnit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSecurityUnit
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "OperState", "Operability", "PartNumber", "PciSlot", "Power", "Presence", "Thermal", "UnitId", "Vid", "Voltage", "ComputeBoard", "InventoryDeviceInfo", "RegisteredDevice")
