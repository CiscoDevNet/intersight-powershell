...
function ConvertFrom-IntersightJsonToSecurityUnit {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "OperState", "Operability", "PartNumber", "PciSlot", "Power", "Presence", "Thermal", "UnitId", "Vid", "Voltage", "ComputeBoard", "InventoryDeviceInfo", "RegisteredDevice")
