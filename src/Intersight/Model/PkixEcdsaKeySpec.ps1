...
PkixEcdsaKeySpec<PSCustomObject>
#>

function Initialize-IntersightPkixEcdsaKeySpec {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPkixEcdsaKeySpec' | Write-Debug
...
Convert from JSON to PkixEcdsaKeySpec<PSCustomObject>
...
PkixEcdsaKeySpec<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPkixEcdsaKeySpec {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPkixEcdsaKeySpec' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPkixEcdsaKeySpec
        $AllProperties = ("ClassId", "ObjectType", "Name", "Curve")
