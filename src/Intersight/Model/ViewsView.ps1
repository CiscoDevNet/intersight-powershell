...
ViewsView<PSCustomObject>
#>

function Initialize-IntersightViewsView {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightViewsView' | Write-Debug
...
Convert from JSON to ViewsView<PSCustomObject>
...
ViewsView<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToViewsView {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightViewsView' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightViewsView
