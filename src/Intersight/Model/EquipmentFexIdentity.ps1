...
EquipmentFexIdentity<PSCustomObject>
#>

function Initialize-IntersightEquipmentFexIdentity {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.FexIdentity")]
        [String]
        ${ClassId} = "equipment.FexIdentity",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.FexIdentity")]
        [String]
        ${ObjectType} = "equipment.FexIdentity",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentFexIdentity' | Write-Debug
...
Convert from JSON to EquipmentFexIdentity<PSCustomObject>
...
EquipmentFexIdentity<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentFexIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentFexIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentFexIdentity
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AdminAction", "AdminActionState", "Identifier", "Lifecycle", "Model", "Serial", "Vendor", "DeviceRegistration", "PendingDiscovery", "PhysicalDeviceRegistration", "SwitchId", "Fex", "NetworkElement")
