...
function ConvertFrom-IntersightJsonToEquipmentFexIdentity {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AdminAction", "AdminActionState", "Identifier", "Lifecycle", "Model", "Serial", "Vendor", "RegisteredDevice", "PhysicalDeviceRegistration", "SwitchId", "Fex", "NetworkElement")
