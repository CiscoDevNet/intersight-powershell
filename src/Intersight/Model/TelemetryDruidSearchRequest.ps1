...
TelemetryDruidSearchRequest<PSCustomObject>
#>

function Initialize-IntersightTelemetryDruidSearchRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTelemetryDruidSearchRequest' | Write-Debug
...
Convert from JSON to TelemetryDruidSearchRequest<PSCustomObject>
...
TelemetryDruidSearchRequest<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTelemetryDruidSearchRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTelemetryDruidSearchRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTelemetryDruidSearchRequest
        $AllProperties = ("queryType", "dataSource", "intervals", "granularity", "filter", "aggregations", "searchDimensions", "query", "limit", "context")
