...
FabricFcNetworkPolicyListAllOf<PSCustomObject>
#>

function Initialize-IntersightFabricFcNetworkPolicyListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricFcNetworkPolicyListAllOf' | Write-Debug
...
Convert from JSON to FabricFcNetworkPolicyListAllOf<PSCustomObject>
...
FabricFcNetworkPolicyListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricFcNetworkPolicyListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricFcNetworkPolicyListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricFcNetworkPolicyListAllOf
