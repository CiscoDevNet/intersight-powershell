...
HyperflexFeatureLimitInternal<PSCustomObject>
#>

function Initialize-IntersightHyperflexFeatureLimitInternal {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.FeatureLimitInternal")]
        [String]
        ${ClassId} = "hyperflex.FeatureLimitInternal",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.FeatureLimitInternal")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexFeatureLimitInternal' | Write-Debug
...
Convert from JSON to HyperflexFeatureLimitInternal<PSCustomObject>
...
HyperflexFeatureLimitInternal<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexFeatureLimitInternal {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexFeatureLimitInternal' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexFeatureLimitInternal
