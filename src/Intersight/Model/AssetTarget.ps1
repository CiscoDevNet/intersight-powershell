...
function ConvertFrom-IntersightJsonToAssetTarget {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ClaimedByUserName", "Connections", "ConnectorVersion", "ExternalIpAddress", "IpAddress", "Name", "ProductId", "ReadOnly", "Services", "Status", "StatusErrorReason", "TargetId", "TargetType", "Account", "Assist", "RegisteredDevice")
