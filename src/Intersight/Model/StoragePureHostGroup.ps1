...
StoragePureHostGroup<PSCustomObject>
#>

function Initialize-IntersightStoragePureHostGroup {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PureHostGroup")]
        [String]
        ${ClassId} = "storage.PureHostGroup",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PureHostGroup")]
        [String]
        ${ObjectType} = "storage.PureHostGroup",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePureHostGroup' | Write-Debug
...
Convert from JSON to StoragePureHostGroup<PSCustomObject>
...
StoragePureHostGroup<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePureHostGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePureHostGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePureHostGroup
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "StorageUtilization", "HostNames", "Array", "Hosts", "ProtectionGroup", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "HostNames"))) { #optional property not found
            $HostNames = $null
        } else {
            $HostNames = $JsonParameters.PSobject.Properties["HostNames"].value
        }
