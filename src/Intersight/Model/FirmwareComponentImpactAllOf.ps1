...
FirmwareComponentImpactAllOf<PSCustomObject>
#>

function Initialize-IntersightFirmwareComponentImpactAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareComponentImpactAllOf' | Write-Debug
...
Convert from JSON to FirmwareComponentImpactAllOf<PSCustomObject>
...
FirmwareComponentImpactAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareComponentImpactAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareComponentImpactAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareComponentImpactAllOf
        $AllProperties = ("ClassId", "ObjectType", "Component")
