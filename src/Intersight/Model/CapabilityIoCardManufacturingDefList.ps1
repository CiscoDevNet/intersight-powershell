...
CapabilityIoCardManufacturingDefList<PSCustomObject>
#>

function Initialize-IntersightCapabilityIoCardManufacturingDefList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilityIoCardManufacturingDefList' | Write-Debug
...
Convert from JSON to CapabilityIoCardManufacturingDefList<PSCustomObject>
...
CapabilityIoCardManufacturingDefList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilityIoCardManufacturingDefList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilityIoCardManufacturingDefList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilityIoCardManufacturingDefList
