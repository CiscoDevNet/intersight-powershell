...
CapabilityFanModuleManufacturingDefAllOf<PSCustomObject>
#>

function Initialize-IntersightCapabilityFanModuleManufacturingDefAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.FanModuleManufacturingDef")]
        [String]
        ${ClassId} = "capability.FanModuleManufacturingDef",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.FanModuleManufacturingDef")]
        [String]
        ${ObjectType} = "capability.FanModuleManufacturingDef",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Caption},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilityFanModuleManufacturingDefAllOf' | Write-Debug
...
Convert from JSON to CapabilityFanModuleManufacturingDefAllOf<PSCustomObject>
...
CapabilityFanModuleManufacturingDefAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilityFanModuleManufacturingDefAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilityFanModuleManufacturingDefAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilityFanModuleManufacturingDefAllOf
