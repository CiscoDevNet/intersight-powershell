...
CondAlarmList<PSCustomObject>
#>

function Initialize-IntersightCondAlarmList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCondAlarmList' | Write-Debug
...
Convert from JSON to CondAlarmList<PSCustomObject>
...
CondAlarmList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCondAlarmList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCondAlarmList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCondAlarmList
