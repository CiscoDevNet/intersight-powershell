...
KubernetesVirtualMachineInstanceType<PSCustomObject>
#>

function Initialize-IntersightKubernetesVirtualMachineInstanceType {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("kubernetes.VirtualMachineInstanceType")]
        [String]
        ${ClassId} = "kubernetes.VirtualMachineInstanceType",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("kubernetes.VirtualMachineInstanceType")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesVirtualMachineInstanceType' | Write-Debug
...
Convert from JSON to KubernetesVirtualMachineInstanceType<PSCustomObject>
...
KubernetesVirtualMachineInstanceType<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesVirtualMachineInstanceType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesVirtualMachineInstanceType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesVirtualMachineInstanceType
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Cpu", "DiskSize", "Memory", "Organization", "Profiles")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "DiskSize"))) { #optional property not found
            $DiskSize = $null
        } else {
            $DiskSize = $JsonParameters.PSobject.Properties["DiskSize"].value
        }
