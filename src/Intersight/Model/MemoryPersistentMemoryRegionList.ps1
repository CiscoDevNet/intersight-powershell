...
MemoryPersistentMemoryRegionList<PSCustomObject>
#>

function Initialize-IntersightMemoryPersistentMemoryRegionList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMemoryPersistentMemoryRegionList' | Write-Debug
...
Convert from JSON to MemoryPersistentMemoryRegionList<PSCustomObject>
...
MemoryPersistentMemoryRegionList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryRegionList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMemoryPersistentMemoryRegionList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMemoryPersistentMemoryRegionList
