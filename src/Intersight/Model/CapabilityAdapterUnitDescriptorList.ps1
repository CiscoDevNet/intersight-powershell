...
CapabilityAdapterUnitDescriptorList<PSCustomObject>
#>

function Initialize-IntersightCapabilityAdapterUnitDescriptorList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilityAdapterUnitDescriptorList' | Write-Debug
...
Convert from JSON to CapabilityAdapterUnitDescriptorList<PSCustomObject>
...
CapabilityAdapterUnitDescriptorList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilityAdapterUnitDescriptorList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilityAdapterUnitDescriptorList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilityAdapterUnitDescriptorList
