...
IamPermissionListAllOf<PSCustomObject>
#>

function Initialize-IntersightIamPermissionListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamPermissionListAllOf' | Write-Debug
...
Convert from JSON to IamPermissionListAllOf<PSCustomObject>
...
IamPermissionListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamPermissionListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamPermissionListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamPermissionListAllOf
