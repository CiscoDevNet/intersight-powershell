...
Definition of the list of properties defined in 'niatelemetry.Lc', excluding properties defined in parent classes.
...
NiatelemetryLcAllOf<PSCustomObject>
#>

function Initialize-IntersightNiatelemetryLcAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiatelemetryLcAllOf' | Write-Debug
...
Convert from JSON to NiatelemetryLcAllOf<PSCustomObject>
...
NiatelemetryLcAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiatelemetryLcAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiatelemetryLcAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiatelemetryLcAllOf
        $AllProperties = ("ClassId", "ObjectType", "Description", "Dn", "HardwareVersion", "Model", "OperationalState", "PowerState", "RecordType", "RecordVersion", "RedundancyState", "SerialNumber", "SiteName", "RegisteredDevice")
