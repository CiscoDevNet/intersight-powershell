...
function ConvertFrom-IntersightJsonToComputeBlade {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "AdminPowerState", "AssetTag", "AvailableMemory", "BiosPostComplete", "FaultSummary", "KvmIpAddresses", "ManagementMode", "MemorySpeed", "MgmtIpAddress", "NumAdaptors", "NumCpuCores", "NumCpuCoresEnabled", "NumCpus", "NumEthHostInterfaces", "NumFcHostInterfaces", "NumThreads", "OperPowerState", "OperState", "Operability", "PlatformType", "Presence", "ServiceProfile", "TotalMemory", "UserLabel", "Uuid", "MgmtIdentity", "ChassisId", "ScaledMode", "SlotId", "Adapters", "BiosUnits", "Bmc", "Board", "EquipmentChassis", "EquipmentIoExpanders", "GenericInventoryHolders", "GraphicsCards", "InventoryDeviceInfo", "LocatorLed", "MemoryArrays", "PciDevices", "Processors", "RegisteredDevice", "StorageControllers", "StorageEnclosures", "TopSystem", "UemConnection")
