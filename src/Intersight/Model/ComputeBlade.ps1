...
ComputeBlade<PSCustomObject>
#>

function Initialize-IntersightComputeBlade {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightComputeBlade' | Write-Debug
...
Convert from JSON to ComputeBlade<PSCustomObject>
...
ComputeBlade<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToComputeBlade {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
