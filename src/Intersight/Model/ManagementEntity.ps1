...
function ConvertFrom-IntersightJsonToManagementEntity {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "ClusterLinkState", "ClusterReadiness", "ClusterState", "EntityId", "Leadership", "InventoryDeviceInfo", "NetworkElement", "RegisteredDevice")
