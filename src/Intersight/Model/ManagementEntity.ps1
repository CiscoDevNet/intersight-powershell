...
function ConvertFrom-IntersightJsonToManagementEntity {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "ClusterLinkState", "ClusterReadiness", "ClusterState", "EntityId", "Leadership", "InventoryDeviceInfo", "NetworkElement", "RegisteredDevice")
