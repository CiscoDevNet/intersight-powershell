...
ManagementEntity<PSCustomObject>
#>

function Initialize-IntersightManagementEntity {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("management.Entity")]
        [String]
        ${ClassId} = "management.Entity",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("management.Entity")]
        [String]
        ${ObjectType} = "management.Entity",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightManagementEntity' | Write-Debug
...
Convert from JSON to ManagementEntity<PSCustomObject>
...
ManagementEntity<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToManagementEntity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightManagementEntity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightManagementEntity
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "ClusterLinkState", "ClusterReadiness", "ClusterState", "EntityId", "Leadership", "InventoryDeviceInfo", "NetworkElement", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ClusterLinkState"))) { #optional property not found
            $ClusterLinkState = $null
        } else {
            $ClusterLinkState = $JsonParameters.PSobject.Properties["ClusterLinkState"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ClusterReadiness"))) { #optional property not found
            $ClusterReadiness = $null
        } else {
            $ClusterReadiness = $JsonParameters.PSobject.Properties["ClusterReadiness"].value
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "Dn" = ${Dn}
            "Rn" = ${Rn}
            "ClusterLinkState" = ${ClusterLinkState}
