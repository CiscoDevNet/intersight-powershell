...
EquipmentIoCardBase<PSCustomObject>
#>

function Initialize-IntersightEquipmentIoCardBase {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentIoCardBase' | Write-Debug
...
Convert from JSON to EquipmentIoCardBase<PSCustomObject>
...
EquipmentIoCardBase<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentIoCardBase {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
