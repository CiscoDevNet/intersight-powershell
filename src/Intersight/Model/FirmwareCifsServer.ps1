...
FirmwareCifsServer<PSCustomObject>
#>

function Initialize-IntersightFirmwareCifsServer {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareCifsServer' | Write-Debug
...
Convert from JSON to FirmwareCifsServer<PSCustomObject>
...
FirmwareCifsServer<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareCifsServer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareCifsServer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareCifsServer
