...
WorkflowTaskDefinitionListAllOf<PSCustomObject>
#>

function Initialize-IntersightWorkflowTaskDefinitionListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowTaskDefinitionListAllOf' | Write-Debug
...
Convert from JSON to WorkflowTaskDefinitionListAllOf<PSCustomObject>
...
WorkflowTaskDefinitionListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowTaskDefinitionListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowTaskDefinitionListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowTaskDefinitionListAllOf
