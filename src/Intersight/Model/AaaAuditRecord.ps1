...
function ConvertFrom-IntersightJsonToAaaAuditRecord {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Event", "MoDisplayNames", "MoType", "ObjectMoid", "Request", "TraceId", "Email", "InstId", "SourceIp", "Timestamp", "UserIdOrEmail", "Account", "Sessions", "User")
