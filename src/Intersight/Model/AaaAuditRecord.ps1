...
function ConvertFrom-IntersightJsonToAaaAuditRecord {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Event", "MoDisplayNames", "MoType", "ObjectMoid", "Request", "TraceId", "Email", "InstId", "SessionId", "SourceIp", "Timestamp", "UserIdOrEmail", "Account", "Sessions", "User")
