...
AaaAuditRecord<PSCustomObject>
#>

function Initialize-IntersightAaaAuditRecord {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAaaAuditRecord' | Write-Debug
...
Convert from JSON to AaaAuditRecord<PSCustomObject>
...
AaaAuditRecord<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAaaAuditRecord {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAaaAuditRecord' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAaaAuditRecord
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Event", "MoDisplayNames", "MoType", "ObjectMoid", "Request", "TraceId", "Email", "InstId", "SessionId", "SourceIp", "Timestamp", "UserIdOrEmail", "Account", "Sessions", "User")
