...
HyperflexHealthCheckDefinitionListAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexHealthCheckDefinitionListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexHealthCheckDefinitionListAllOf' | Write-Debug
...
Convert from JSON to HyperflexHealthCheckDefinitionListAllOf<PSCustomObject>
...
HyperflexHealthCheckDefinitionListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexHealthCheckDefinitionListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexHealthCheckDefinitionListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexHealthCheckDefinitionListAllOf
