...
WorkflowJoinTask<PSCustomObject>
#>

function Initialize-IntersightWorkflowJoinTask {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowJoinTask' | Write-Debug
...
Convert from JSON to WorkflowJoinTask<PSCustomObject>
...
WorkflowJoinTask<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowJoinTask {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowJoinTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowJoinTask
        $AllProperties = ("ClassId", "ObjectType", "Description", "Label", "Name", "JoinOnTasks", "OnSuccess")
