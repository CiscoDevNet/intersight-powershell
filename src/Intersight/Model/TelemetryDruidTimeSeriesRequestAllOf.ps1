...
TelemetryDruidTimeSeriesRequestAllOf<PSCustomObject>
#>

function Initialize-IntersightTelemetryDruidTimeSeriesRequestAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTelemetryDruidTimeSeriesRequestAllOf' | Write-Debug
...
Convert from JSON to TelemetryDruidTimeSeriesRequestAllOf<PSCustomObject>
...
TelemetryDruidTimeSeriesRequestAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTelemetryDruidTimeSeriesRequestAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTelemetryDruidTimeSeriesRequestAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTelemetryDruidTimeSeriesRequestAllOf
        $AllProperties = ("dataSource", "descending", "intervals", "granularity", "filter", "aggregations", "postAggregations", "limit", "context")
