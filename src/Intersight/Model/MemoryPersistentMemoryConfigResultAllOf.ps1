...
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryConfigResultAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ConfigErrorDesc", "ConfigResult", "ConfigSequenceNo", "ConfigState", "InventoryDeviceInfo", "MemoryPersistentMemoryConfiguration", "PersistentMemoryNamespaceConfigResults", "RegisteredDevice")
