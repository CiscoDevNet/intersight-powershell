...
EquipmentSharedIoModuleList<PSCustomObject>
#>

function Initialize-IntersightEquipmentSharedIoModuleList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentSharedIoModuleList' | Write-Debug
...
Convert from JSON to EquipmentSharedIoModuleList<PSCustomObject>
...
EquipmentSharedIoModuleList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentSharedIoModuleList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentSharedIoModuleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentSharedIoModuleList
