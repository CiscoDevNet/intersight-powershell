...
function ConvertFrom-IntersightJsonToWorkflowTaskDefinition {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DefaultVersion", "Description", "InternalProperties", "Label", "LicenseEntitlement", "Name", "Properties", "RollbackTasks", "SecurePropAccess", "Version", "Catalog", "ImplementedTasks", "InterfaceTask", "TaskMetadata")
