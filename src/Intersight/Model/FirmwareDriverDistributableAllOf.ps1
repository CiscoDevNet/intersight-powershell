...
FirmwareDriverDistributableAllOf<PSCustomObject>
#>

function Initialize-IntersightFirmwareDriverDistributableAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareDriverDistributableAllOf' | Write-Debug
...
Convert from JSON to FirmwareDriverDistributableAllOf<PSCustomObject>
...
FirmwareDriverDistributableAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareDriverDistributableAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareDriverDistributableAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareDriverDistributableAllOf
        $AllProperties = ("ClassId", "ObjectType", "Category", "Directory", "Osname", "Osversion", "Catalog")
