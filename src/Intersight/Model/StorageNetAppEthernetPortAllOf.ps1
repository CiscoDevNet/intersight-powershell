...
StorageNetAppEthernetPortAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppEthernetPortAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppEthernetPortAllOf' | Write-Debug
...
Convert from JSON to StorageNetAppEthernetPortAllOf<PSCustomObject>
...
StorageNetAppEthernetPortAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppEthernetPortAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppEthernetPortAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppEthernetPortAllOf
        $AllProperties = ("ClassId", "ObjectType", "Enabled", "MacAddress", "Mtu", "Name", "Speed", "State", "Type", "Uuid", "ArrayController")
