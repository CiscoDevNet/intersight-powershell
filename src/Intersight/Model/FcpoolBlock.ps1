...
FcpoolBlock<PSCustomObject>
#>

function Initialize-IntersightFcpoolBlock {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFcpoolBlock' | Write-Debug
...
Convert from JSON to FcpoolBlock<PSCustomObject>
...
FcpoolBlock<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFcpoolBlock {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFcpoolBlock' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFcpoolBlock
