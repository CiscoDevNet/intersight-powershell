...
function ConvertFrom-IntersightJsonToVnicFcQosPolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Cos", "MaxDataFieldSize", "Priority", "RateLimit", "Organization")
