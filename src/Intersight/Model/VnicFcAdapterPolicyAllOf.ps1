...
function ConvertFrom-IntersightJsonToVnicFcAdapterPolicyAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ErrorDetectionTimeout", "ErrorRecoverySettings", "FlogiSettings", "InterruptSettings", "IoThrottleCount", "LunCount", "LunQueueDepth", "PlogiSettings", "ResourceAllocationTimeout", "RxQueueSettings", "ScsiQueueSettings", "TxQueueSettings", "Organization")
