...
StorageNetAppFcPortListAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppFcPortListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppFcPortListAllOf' | Write-Debug
...
Convert from JSON to StorageNetAppFcPortListAllOf<PSCustomObject>
...
StorageNetAppFcPortListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppFcPortListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppFcPortListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppFcPortListAllOf
