...
function ConvertFrom-IntersightJsonToServerProfile {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Type", "SrcTemplate", "Action", "ConfigContext", "ConfigChanges", "IsPmcDeployedSecurePassphraseSet", "PmcDeployedSecurePassphrase", "TargetPlatform", "AssignedServer", "AssociatedServer", "ConfigChangeDetails", "ConfigResult", "Organization", "RunningWorkflows")
