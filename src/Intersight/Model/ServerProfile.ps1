...
function ConvertFrom-IntersightJsonToServerProfile {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Type", "SrcTemplate", "Action", "ConfigContext", "ConfigChanges", "IsPmcDeployedSecurePassphraseSet", "PmcDeployedSecurePassphrase", "TargetPlatform", "AssignedServer", "AssociatedServer", "ConfigChangeDetails", "ConfigResult", "Organization", "RunningWorkflows")
