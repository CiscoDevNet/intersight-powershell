...
function ConvertFrom-IntersightJsonToCondHclStatusAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "ComponentStatus", "HardwareStatus", "HclFirmwareVersion", "HclModel", "HclOsVendor", "HclOsVersion", "HclProcessor", "InvFirmwareVersion", "InvModel", "InvOsVendor", "InvOsVersion", "InvProcessor", "Reason", "ServerReason", "SoftwareStatus", "Status", "Details", "ManagedObject", "RegisteredDevice")
