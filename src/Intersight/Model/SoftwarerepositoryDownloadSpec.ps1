...
function ConvertFrom-IntersightJsonToSoftwarerepositoryDownloadSpec {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AuthToken", "Certificate", "Filename", "Md5sum", "Size", "Url", "File")
