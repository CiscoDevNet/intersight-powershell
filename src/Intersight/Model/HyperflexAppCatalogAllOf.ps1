...
function ConvertFrom-IntersightJsonToHyperflexAppCatalogAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Version", "FeatureLimitExternal", "FeatureLimitInternal", "HxdpVersions", "HyperflexCapabilityInfos", "HyperflexSoftwareCompatibilityInfos", "ServerFirmwareVersion", "ServerModel")
