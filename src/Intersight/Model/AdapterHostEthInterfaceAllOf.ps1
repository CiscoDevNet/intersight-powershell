...
AdapterHostEthInterfaceAllOf<PSCustomObject>
#>

function Initialize-IntersightAdapterHostEthInterfaceAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAdapterHostEthInterfaceAllOf' | Write-Debug
...
Convert from JSON to AdapterHostEthInterfaceAllOf<PSCustomObject>
...
AdapterHostEthInterfaceAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAdapterHostEthInterfaceAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAdapterHostEthInterfaceAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAdapterHostEthInterfaceAllOf
        $AllProperties = ("ClassId", "ObjectType", "AdminState", "EpDn", "HostEthInterfaceId", "InterfaceType", "MacAddress", "Name", "Operability", "OriginalMacAddress", "PciAddr", "PeerDn", "VirtualizationPreference", "VnicDn", "AdapterUnit", "InventoryDeviceInfo", "RegisteredDevice")
