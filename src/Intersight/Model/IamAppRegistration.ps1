...
function ConvertFrom-IntersightJsonToIamAppRegistration {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ClientId", "ClientName", "ClientSecret", "ClientType", "Description", "GrantTypes", "RedirectUris", "RenewClientSecret", "ResponseTypes", "RevocationTimestamp", "Revoke", "Account", "OauthTokens", "Permission", "Roles", "User")
