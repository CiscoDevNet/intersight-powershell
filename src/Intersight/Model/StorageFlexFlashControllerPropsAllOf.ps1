...
function ConvertFrom-IntersightJsonToStorageFlexFlashControllerPropsAllOf {
    ...
    Process {
        ...
        $AllProperties = ("CardsManageable", "ConfiguredMode", "ControllerName", "ControllerStatus", "FwVersion", "InternalState", "OperatingMode", "PhysicalDriveCount", "ProductName", "StartupFwVersion", "VirtualDriveCount", "InventoryDeviceInfo", "RegisteredDevice", "StorageFlexFlashController")
