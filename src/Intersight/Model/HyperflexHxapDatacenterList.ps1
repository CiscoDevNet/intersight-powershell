...
HyperflexHxapDatacenterList<PSCustomObject>
#>

function Initialize-IntersightHyperflexHxapDatacenterList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexHxapDatacenterList' | Write-Debug
...
Convert from JSON to HyperflexHxapDatacenterList<PSCustomObject>
...
HyperflexHxapDatacenterList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexHxapDatacenterList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexHxapDatacenterList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexHxapDatacenterList
