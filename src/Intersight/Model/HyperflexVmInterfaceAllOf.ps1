...
Definition of the list of properties defined in 'hyperflex.VmInterface', excluding properties defined in parent classes.
...
HyperflexVmInterfaceAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexVmInterfaceAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexVmInterfaceAllOf' | Write-Debug
...
Convert from JSON to HyperflexVmInterfaceAllOf<PSCustomObject>
...
HyperflexVmInterfaceAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexVmInterfaceAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexVmInterfaceAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexVmInterfaceAllOf
