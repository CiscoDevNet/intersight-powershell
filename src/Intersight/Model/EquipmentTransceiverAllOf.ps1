...
EquipmentTransceiverAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentTransceiverAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentTransceiverAllOf' | Write-Debug
...
Convert from JSON to EquipmentTransceiverAllOf<PSCustomObject>
...
EquipmentTransceiverAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentTransceiverAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentTransceiverAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentTransceiverAllOf
        $AllProperties = ("ClassId", "ObjectType", "OperSpeed", "OperState", "OperStateQual", "PortId", "SlotId", "SwitchId", "Type", "EtherPhysicalPort", "RegisteredDevice")
