...
CommIpV6InterfaceAllOf<PSCustomObject>
#>

function Initialize-IntersightCommIpV6InterfaceAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("comm.IpV6Interface")]
        [String]
        ${ClassId} = "comm.IpV6Interface",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("comm.IpV6Interface")]
        [String]
        ${ObjectType} = "comm.IpV6Interface",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCommIpV6InterfaceAllOf' | Write-Debug
...
Convert from JSON to CommIpV6InterfaceAllOf<PSCustomObject>
...
CommIpV6InterfaceAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCommIpV6InterfaceAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCommIpV6InterfaceAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCommIpV6InterfaceAllOf
        $AllProperties = ("ClassId", "ObjectType", "Gateway", "IpAddress", "Prefix")
