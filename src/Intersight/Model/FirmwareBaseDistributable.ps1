...
FirmwareBaseDistributable<PSCustomObject>
#>

function Initialize-IntersightFirmwareBaseDistributable {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareBaseDistributable' | Write-Debug
...
Convert from JSON to FirmwareBaseDistributable<PSCustomObject>
...
FirmwareBaseDistributable<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareBaseDistributable {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareBaseDistributable' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareBaseDistributable
