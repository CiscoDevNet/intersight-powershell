...
VnicSanConnectivityPolicyAllOf<PSCustomObject>
#>

function Initialize-IntersightVnicSanConnectivityPolicyAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVnicSanConnectivityPolicyAllOf' | Write-Debug
...
Convert from JSON to VnicSanConnectivityPolicyAllOf<PSCustomObject>
...
VnicSanConnectivityPolicyAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVnicSanConnectivityPolicyAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVnicSanConnectivityPolicyAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVnicSanConnectivityPolicyAllOf
        $AllProperties = ("ClassId", "ObjectType", "PlacementMode", "StaticWwnnAddress", "TargetPlatform", "WwnnAddressType", "FcIfs", "Organization", "Profiles", "WwnnPool")
