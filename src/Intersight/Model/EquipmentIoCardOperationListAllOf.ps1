...
EquipmentIoCardOperationListAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentIoCardOperationListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentIoCardOperationListAllOf' | Write-Debug
...
Convert from JSON to EquipmentIoCardOperationListAllOf<PSCustomObject>
...
EquipmentIoCardOperationListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentIoCardOperationListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentIoCardOperationListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentIoCardOperationListAllOf
