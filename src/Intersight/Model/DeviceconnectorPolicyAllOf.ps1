...
DeviceconnectorPolicyAllOf<PSCustomObject>
#>

function Initialize-IntersightDeviceconnectorPolicyAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightDeviceconnectorPolicyAllOf' | Write-Debug
...
Convert from JSON to DeviceconnectorPolicyAllOf<PSCustomObject>
...
DeviceconnectorPolicyAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToDeviceconnectorPolicyAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightDeviceconnectorPolicyAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightDeviceconnectorPolicyAllOf
        $AllProperties = ("ClassId", "ObjectType", "LockoutEnabled", "Organization", "Profiles")
