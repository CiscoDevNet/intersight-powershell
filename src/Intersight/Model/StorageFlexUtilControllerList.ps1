...
StorageFlexUtilControllerList<PSCustomObject>
#>

function Initialize-IntersightStorageFlexUtilControllerList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageFlexUtilControllerList' | Write-Debug
...
Convert from JSON to StorageFlexUtilControllerList<PSCustomObject>
...
StorageFlexUtilControllerList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageFlexUtilControllerList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageFlexUtilControllerList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageFlexUtilControllerList
