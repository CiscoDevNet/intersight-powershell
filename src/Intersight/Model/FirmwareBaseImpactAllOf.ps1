...
function Initialize-IntersightFirmwareBaseImpactAllOf {
    ...
    Param (
        ...
        [ValidateSet("firmware.ChassisUpgradeImpact", "firmware.ComponentImpact", "firmware.FabricUpgradeImpact", "firmware.ServerUpgradeImpact")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("firmware.ChassisUpgradeImpact", "firmware.ComponentImpact", "firmware.FabricUpgradeImpact", "firmware.ServerUpgradeImpact")]
...
function ConvertFrom-IntersightJsonToFirmwareBaseImpactAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "ComputationError", "ComputationStatusDetail", "DomainName", "EndPoint", "FirmwareVersion", "ImpactType", "Model", "TargetFirmwareVersion", "VersionImpact")
