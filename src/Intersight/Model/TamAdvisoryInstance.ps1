...
function Initialize-IntersightTamAdvisoryInstance {
    ...
    Param (
        ...
        [ValidateSet("tam.AdvisoryInstance")]
        [String]
        ${ClassId} = "tam.AdvisoryInstance",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("tam.AdvisoryInstance")]
        [String]
        ${ObjectType} = "tam.AdvisoryInstance",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
...
function ConvertFrom-IntersightJsonToTamAdvisoryInstance {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AffectedObjectMoid", "AffectedObjectType", "LastStateChangeTime", "LastVerifiedTime", "State", "Advisory", "AffectedObject", "DeviceRegistration")
