...
function ConvertFrom-IntersightJsonToTamAdvisoryInstance {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AffectedObjectMoid", "AffectedObjectType", "LastStateChangeTime", "LastVerifiedTime", "State", "Advisory", "AffectedObject", "DeviceRegistration")
