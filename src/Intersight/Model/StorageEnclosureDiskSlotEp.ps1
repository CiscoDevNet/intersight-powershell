...
function ConvertFrom-IntersightJsonToStorageEnclosureDiskSlotEp {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "DrivePath", "Health", "Presence", "Slot", "InventoryDeviceInfo", "RegisteredDevice", "StorageEnclosure")
