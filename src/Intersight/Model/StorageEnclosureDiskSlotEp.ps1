...
function ConvertFrom-IntersightJsonToStorageEnclosureDiskSlotEp {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "DrivePath", "Health", "Presence", "Slot", "InventoryDeviceInfo", "RegisteredDevice", "StorageEnclosure")
