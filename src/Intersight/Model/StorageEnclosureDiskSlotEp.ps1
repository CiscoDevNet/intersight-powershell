...
StorageEnclosureDiskSlotEp<PSCustomObject>
#>

function Initialize-IntersightStorageEnclosureDiskSlotEp {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.EnclosureDiskSlotEp")]
        [String]
        ${ClassId} = "storage.EnclosureDiskSlotEp",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.EnclosureDiskSlotEp")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageEnclosureDiskSlotEp' | Write-Debug
...
Convert from JSON to StorageEnclosureDiskSlotEp<PSCustomObject>
...
StorageEnclosureDiskSlotEp<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageEnclosureDiskSlotEp {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageEnclosureDiskSlotEp' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageEnclosureDiskSlotEp
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "DrivePath", "Health", "Presence", "Slot", "InventoryDeviceInfo", "RegisteredDevice", "StorageEnclosure")
