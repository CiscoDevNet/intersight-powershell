...
function ConvertFrom-IntersightJsonToWorkflowWorkflowDefinition {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DefaultVersion", "Description", "InputDefinition", "InputParameterSet", "Label", "LicenseEntitlement", "MaxTaskCount", "MaxWorkerTaskCount", "Name", "OutputDefinition", "OutputParameters", "Properties", "Tasks", "UiInputFilters", "UiRenderingData", "ValidationInformation", "Version", "Catalog", "WorkflowMetadata")
