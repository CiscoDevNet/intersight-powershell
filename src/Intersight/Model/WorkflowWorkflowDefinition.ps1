...
function ConvertFrom-IntersightJsonToWorkflowWorkflowDefinition {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DefaultVersion", "Description", "InputDefinition", "Label", "LicenseEntitlement", "MaxTaskCount", "Name", "OutputDefinition", "OutputParameters", "Properties", "Tasks", "UiRenderingData", "ValidationInformation", "Version", "Catalog")
