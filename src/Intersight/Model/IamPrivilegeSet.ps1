...
IamPrivilegeSet<PSCustomObject>
#>

function Initialize-IntersightIamPrivilegeSet {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iam.PrivilegeSet")]
        [String]
        ${ClassId} = "iam.PrivilegeSet",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iam.PrivilegeSet")]
        [String]
        ${ObjectType} = "iam.PrivilegeSet",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamPrivilegeSet' | Write-Debug
...
Convert from JSON to IamPrivilegeSet<PSCustomObject>
...
IamPrivilegeSet<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamPrivilegeSet {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamPrivilegeSet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamPrivilegeSet
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "PrivilegeNames", "Account", "AssociatedPrivilegeSets", "Privileges", "System")
