...
KvmVmConsoleListAllOf<PSCustomObject>
#>

function Initialize-IntersightKvmVmConsoleListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKvmVmConsoleListAllOf' | Write-Debug
...
Convert from JSON to KvmVmConsoleListAllOf<PSCustomObject>
...
KvmVmConsoleListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKvmVmConsoleListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKvmVmConsoleListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKvmVmConsoleListAllOf
