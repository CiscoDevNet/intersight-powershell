...
CapabilitySiocModuleDescriptor<PSCustomObject>
#>

function Initialize-IntersightCapabilitySiocModuleDescriptor {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.SiocModuleDescriptor")]
        [String]
        ${ClassId} = "capability.SiocModuleDescriptor",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("capability.SiocModuleDescriptor")]
        [String]
        ${ObjectType} = "capability.SiocModuleDescriptor",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilitySiocModuleDescriptor' | Write-Debug
...
Convert from JSON to CapabilitySiocModuleDescriptor<PSCustomObject>
...
CapabilitySiocModuleDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilitySiocModuleDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilitySiocModuleDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilitySiocModuleDescriptor
