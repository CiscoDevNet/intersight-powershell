...
CondHclStatusJobList<PSCustomObject>
#>

function Initialize-IntersightCondHclStatusJobList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCondHclStatusJobList' | Write-Debug
...
Convert from JSON to CondHclStatusJobList<PSCustomObject>
...
CondHclStatusJobList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCondHclStatusJobList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCondHclStatusJobList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCondHclStatusJobList
