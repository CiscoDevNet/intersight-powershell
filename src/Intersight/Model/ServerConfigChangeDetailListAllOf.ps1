...
ServerConfigChangeDetailListAllOf<PSCustomObject>
#>

function Initialize-IntersightServerConfigChangeDetailListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightServerConfigChangeDetailListAllOf' | Write-Debug
...
Convert from JSON to ServerConfigChangeDetailListAllOf<PSCustomObject>
...
ServerConfigChangeDetailListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToServerConfigChangeDetailListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightServerConfigChangeDetailListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightServerConfigChangeDetailListAllOf
