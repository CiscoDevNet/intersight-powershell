...
StorageLocalDisk<PSCustomObject>
#>

function Initialize-IntersightStorageLocalDisk {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.LocalDisk")]
        [String]
        ${ClassId} = "storage.LocalDisk",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.LocalDisk")]
        [String]
        ${ObjectType} = "storage.LocalDisk",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageLocalDisk' | Write-Debug
...
Convert from JSON to StorageLocalDisk<PSCustomObject>
...
StorageLocalDisk<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageLocalDisk {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageLocalDisk' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageLocalDisk
        $AllProperties = ("ClassId", "ObjectType", "SlotNumber")
