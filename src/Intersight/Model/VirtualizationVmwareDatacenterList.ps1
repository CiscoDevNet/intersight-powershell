...
VirtualizationVmwareDatacenterList<PSCustomObject>
#>

function Initialize-IntersightVirtualizationVmwareDatacenterList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationVmwareDatacenterList' | Write-Debug
...
Convert from JSON to VirtualizationVmwareDatacenterList<PSCustomObject>
...
VirtualizationVmwareDatacenterList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationVmwareDatacenterList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationVmwareDatacenterList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationVmwareDatacenterList
