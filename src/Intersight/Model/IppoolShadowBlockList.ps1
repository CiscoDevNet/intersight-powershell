...
IppoolShadowBlockList<PSCustomObject>
#>

function Initialize-IntersightIppoolShadowBlockList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIppoolShadowBlockList' | Write-Debug
...
Convert from JSON to IppoolShadowBlockList<PSCustomObject>
...
IppoolShadowBlockList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIppoolShadowBlockList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIppoolShadowBlockList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIppoolShadowBlockList
