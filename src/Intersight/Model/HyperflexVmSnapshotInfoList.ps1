...
HyperflexVmSnapshotInfoList<PSCustomObject>
#>

function Initialize-IntersightHyperflexVmSnapshotInfoList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexVmSnapshotInfoList' | Write-Debug
...
Convert from JSON to HyperflexVmSnapshotInfoList<PSCustomObject>
...
HyperflexVmSnapshotInfoList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexVmSnapshotInfoList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexVmSnapshotInfoList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexVmSnapshotInfoList
