...
WorkflowXmlApi<PSCustomObject>
#>

function Initialize-IntersightWorkflowXmlApi {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowXmlApi' | Write-Debug
...
Convert from JSON to WorkflowXmlApi<PSCustomObject>
...
WorkflowXmlApi<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowXmlApi {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowXmlApi' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowXmlApi
        $AllProperties = ("ClassId", "ObjectType", "Body", "ContentType", "Name", "Outcomes", "ResponseSpec", "SkipOnCondition", "StartDelay", "Timeout")
