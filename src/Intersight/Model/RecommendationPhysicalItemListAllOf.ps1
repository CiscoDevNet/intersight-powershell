...
RecommendationPhysicalItemListAllOf<PSCustomObject>
#>

function Initialize-IntersightRecommendationPhysicalItemListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightRecommendationPhysicalItemListAllOf' | Write-Debug
...
Convert from JSON to RecommendationPhysicalItemListAllOf<PSCustomObject>
...
RecommendationPhysicalItemListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToRecommendationPhysicalItemListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightRecommendationPhysicalItemListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightRecommendationPhysicalItemListAllOf
