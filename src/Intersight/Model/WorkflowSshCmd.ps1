...
WorkflowSshCmd<PSCustomObject>
#>

function Initialize-IntersightWorkflowSshCmd {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.SshCmd")]
        [String]
        ${ClassId} = "workflow.SshCmd",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.SshCmd")]
        [String]
        ${ObjectType} = "workflow.SshCmd",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${EncryptedAesKey},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowSshCmd' | Write-Debug
...
Convert from JSON to WorkflowSshCmd<PSCustomObject>
...
WorkflowSshCmd<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowSshCmd {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowSshCmd' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowSshCmd
        $AllProperties = ("ClassId", "ObjectType", "EncryptedAesKey", "EncryptionKey", "SecureProperties", "Command", "CommandType", "ExpectPrompts", "ShellPrompt", "ShellPromptTimeout")
