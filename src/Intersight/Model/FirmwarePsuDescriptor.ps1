...
FirmwarePsuDescriptor<PSCustomObject>
#>

function Initialize-IntersightFirmwarePsuDescriptor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwarePsuDescriptor' | Write-Debug
...
Convert from JSON to FirmwarePsuDescriptor<PSCustomObject>
...
FirmwarePsuDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwarePsuDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwarePsuDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwarePsuDescriptor
