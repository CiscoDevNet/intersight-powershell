...
function ConvertFrom-IntersightJsonToFcPortChannel {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "AdminSpeed", "AdminState", "Mode", "OperSpeed", "OperState", "OperStateQual", "PortChannelId", "Role", "SwitchId", "Vsan", "EquipmentSwitchCard", "RegisteredDevice")
