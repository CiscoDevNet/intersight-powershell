...
VirtualizationStorageCapacityAllOf<PSCustomObject>
#>

function Initialize-IntersightVirtualizationStorageCapacityAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("virtualization.StorageCapacity")]
        [String]
        ${ClassId} = "virtualization.StorageCapacity",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("virtualization.StorageCapacity")]
        [String]
        ${ObjectType} = "virtualization.StorageCapacity",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationStorageCapacityAllOf' | Write-Debug
...
Convert from JSON to VirtualizationStorageCapacityAllOf<PSCustomObject>
...
VirtualizationStorageCapacityAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationStorageCapacityAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationStorageCapacityAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationStorageCapacityAllOf
