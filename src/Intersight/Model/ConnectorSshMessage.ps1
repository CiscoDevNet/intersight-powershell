...
ConnectorSshMessage<PSCustomObject>
#>

function Initialize-IntersightConnectorSshMessage {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("connector.SshMessage")]
        [String]
        ${ClassId} = "connector.SshMessage",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("connector.SshMessage")]
        [String]
        ${ObjectType} = "connector.SshMessage",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${EncryptedAesKey},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConnectorSshMessage' | Write-Debug
...
Convert from JSON to ConnectorSshMessage<PSCustomObject>
...
ConnectorSshMessage<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConnectorSshMessage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConnectorSshMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConnectorSshMessage
        $AllProperties = ("ClassId", "ObjectType", "EncryptedAesKey", "EncryptionKey", "SecureProperties", "ExpectPrompts", "MsgType", "SessionId", "ShellPrompt", "Stream", "Timeout")
