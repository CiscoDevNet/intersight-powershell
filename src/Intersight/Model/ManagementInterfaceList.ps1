...
ManagementInterfaceList<PSCustomObject>
#>

function Initialize-IntersightManagementInterfaceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightManagementInterfaceList' | Write-Debug
...
Convert from JSON to ManagementInterfaceList<PSCustomObject>
...
ManagementInterfaceList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToManagementInterfaceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightManagementInterfaceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightManagementInterfaceList
