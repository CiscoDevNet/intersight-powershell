...
IaasDiagnosticMessagesList<PSCustomObject>
#>

function Initialize-IntersightIaasDiagnosticMessagesList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIaasDiagnosticMessagesList' | Write-Debug
...
Convert from JSON to IaasDiagnosticMessagesList<PSCustomObject>
...
IaasDiagnosticMessagesList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIaasDiagnosticMessagesList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIaasDiagnosticMessagesList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIaasDiagnosticMessagesList
