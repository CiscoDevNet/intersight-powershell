...
function ConvertFrom-IntersightJsonToProcessorUnitAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Architecture", "NumCores", "NumCoresEnabled", "NumThreads", "OperPowerState", "OperReason", "OperState", "Operability", "Presence", "ProcessorId", "SocketDesignation", "Speed", "Stepping", "Thermal", "ComputeBlade", "ComputeBoard", "ComputeRackUnit", "InventoryDeviceInfo", "RegisteredDevice")
