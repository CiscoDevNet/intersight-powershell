...
function ConvertFrom-IntersightJsonToProcessorUnitAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Architecture", "NumCores", "NumCoresEnabled", "NumThreads", "OperPowerState", "OperState", "Operability", "Presence", "ProcessorId", "SocketDesignation", "Speed", "Stepping", "Thermal", "ComputeBlade", "ComputeBoard", "ComputeRackUnit", "InventoryDeviceInfo", "RegisteredDevice")
