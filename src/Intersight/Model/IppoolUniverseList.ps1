...
IppoolUniverseList<PSCustomObject>
#>

function Initialize-IntersightIppoolUniverseList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIppoolUniverseList' | Write-Debug
...
Convert from JSON to IppoolUniverseList<PSCustomObject>
...
IppoolUniverseList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIppoolUniverseList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIppoolUniverseList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIppoolUniverseList
