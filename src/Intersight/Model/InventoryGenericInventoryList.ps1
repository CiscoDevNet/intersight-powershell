...
InventoryGenericInventoryList<PSCustomObject>
#>

function Initialize-IntersightInventoryGenericInventoryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightInventoryGenericInventoryList' | Write-Debug
...
Convert from JSON to InventoryGenericInventoryList<PSCustomObject>
...
InventoryGenericInventoryList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToInventoryGenericInventoryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightInventoryGenericInventoryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightInventoryGenericInventoryList
