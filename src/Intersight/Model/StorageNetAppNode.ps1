...
StorageNetAppNode<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppNode {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.NetAppNode")]
        [String]
        ${ClassId} = "storage.NetAppNode",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.NetAppNode")]
        [String]
        ${ObjectType} = "storage.NetAppNode",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppNode' | Write-Debug
...
Convert from JSON to StorageNetAppNode<PSCustomObject>
...
StorageNetAppNode<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppNode {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppNode' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppNode
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Name", "OperationalMode", "Status", "Version", "Health", "Systemid", "Uuid", "Array")
