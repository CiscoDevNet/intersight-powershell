...
ServerConfigImport<PSCustomObject>
#>

function Initialize-IntersightServerConfigImport {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("server.ConfigImport")]
        [String]
        ${ClassId} = "server.ConfigImport",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("server.ConfigImport")]
        [String]
        ${ObjectType} = "server.ConfigImport",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightServerConfigImport' | Write-Debug
...
Convert from JSON to ServerConfigImport<PSCustomObject>
...
ServerConfigImport<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToServerConfigImport {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightServerConfigImport' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightServerConfigImport
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "PolicyPrefix", "PolicyTypes", "ProfileName", "Organization", "Server", "ServerProfile")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ServerProfile"))) { #optional property not found
            $ServerProfile = $null
        } else {
            $ServerProfile = $JsonParameters.PSobject.Properties["ServerProfile"].value
        }
