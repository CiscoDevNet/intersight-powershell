...
PortInterfaceBase<PSCustomObject>
#>

function Initialize-IntersightPortInterfaceBase {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("adapter.ExtEthInterface", "adapter.HostEthInterface", "ether.NetworkPort")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("adapter.ExtEthInterface", "adapter.HostEthInterface", "ether.NetworkPort")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPortInterfaceBase' | Write-Debug
...
Convert from JSON to PortInterfaceBase<PSCustomObject>
...
PortInterfaceBase<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPortInterfaceBase {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPortInterfaceBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPortInterfaceBase
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "OperState", "AcknowledgedPeerInterface", "PeerInterface")
