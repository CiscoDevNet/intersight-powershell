...
SoftwareHclMetaList<PSCustomObject>
#>

function Initialize-IntersightSoftwareHclMetaList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwareHclMetaList' | Write-Debug
...
Convert from JSON to SoftwareHclMetaList<PSCustomObject>
...
SoftwareHclMetaList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwareHclMetaList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSoftwareHclMetaList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSoftwareHclMetaList
