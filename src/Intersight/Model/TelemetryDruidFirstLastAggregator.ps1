...
TelemetryDruidFirstLastAggregator<PSCustomObject>
#>

function Initialize-IntersightTelemetryDruidFirstLastAggregator {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTelemetryDruidFirstLastAggregator' | Write-Debug
...
Convert from JSON to TelemetryDruidFirstLastAggregator<PSCustomObject>
...
TelemetryDruidFirstLastAggregator<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTelemetryDruidFirstLastAggregator {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTelemetryDruidFirstLastAggregator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTelemetryDruidFirstLastAggregator
