...
KubernetesDaemonSet<PSCustomObject>
#>

function Initialize-IntersightKubernetesDaemonSet {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("kubernetes.DaemonSet")]
        [String]
        ${ClassId} = "kubernetes.DaemonSet",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("kubernetes.DaemonSet")]
        [String]
        ${ObjectType} = "kubernetes.DaemonSet",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesDaemonSet' | Write-Debug
...
Convert from JSON to KubernetesDaemonSet<PSCustomObject>
...
KubernetesDaemonSet<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesDaemonSet {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesDaemonSet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesDaemonSet
