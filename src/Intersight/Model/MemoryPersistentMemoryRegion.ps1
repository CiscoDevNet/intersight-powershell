...
MemoryPersistentMemoryRegion<PSCustomObject>
#>

function Initialize-IntersightMemoryPersistentMemoryRegion {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMemoryPersistentMemoryRegion' | Write-Debug
...
Convert from JSON to MemoryPersistentMemoryRegion<PSCustomObject>
...
MemoryPersistentMemoryRegion<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryRegion {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMemoryPersistentMemoryRegion' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMemoryPersistentMemoryRegion
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "FreeCapacity", "HealthState", "InterleavedSetId", "LocaterIds", "PersistentMemoryType", "RegionId", "SocketId", "SocketMemoryId", "TotalCapacity", "InventoryDeviceInfo", "MemoryPersistentMemoryConfiguration", "PersistentMemoryNamespaces", "RegisteredDevice")
