...
OsOsSupport<PSCustomObject>
#>

function Initialize-IntersightOsOsSupport {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("os.OsSupport")]
        [String]
        ${ClassId} = "os.OsSupport",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("os.OsSupport")]
        [String]
        ${ObjectType} = "os.OsSupport",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightOsOsSupport' | Write-Debug
...
Convert from JSON to OsOsSupport<PSCustomObject>
...
OsOsSupport<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToOsOsSupport {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightOsOsSupport' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightOsOsSupport
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "OsVersion")
