...
ApplianceUpgradeListAllOf<PSCustomObject>
#>

function Initialize-IntersightApplianceUpgradeListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightApplianceUpgradeListAllOf' | Write-Debug
...
Convert from JSON to ApplianceUpgradeListAllOf<PSCustomObject>
...
ApplianceUpgradeListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToApplianceUpgradeListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightApplianceUpgradeListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightApplianceUpgradeListAllOf
