...
function ConvertFrom-IntersightJsonToWorkflowTaskDefinitionAllOf {
    ...
    Process {
        ...
        $AllProperties = ("DefaultVersion", "Description", "InternalProperties", "Label", "LicenseEntitlement", "Name", "Properties", "SecurePropAccess", "Version", "Catalog", "ImplementedTasks", "InterfaceTask")
