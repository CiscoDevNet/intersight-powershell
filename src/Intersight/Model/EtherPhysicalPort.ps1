...
function ConvertFrom-IntersightJsonToEtherPhysicalPort {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "OperState", "OperStateQual", "PortId", "Role", "SlotId", "SwitchId", "MacAddress", "Mode", "OperSpeed", "PeerDn", "PortChannelId", "PortType", "TransceiverType", "AcknowledgedPeerInterface", "PeerInterface", "AdminSpeed", "AdminState", "AggregatePortId", "LicenseGrace", "LicenseState", "InventoryDeviceInfo", "PortGroup", "PortSubGroup", "RegisteredDevice")
