...
function Initialize-IntersightConnectorDownloadStatus {
    ...
    Param (
        ...
        [ValidateSet("firmware.UnsupportedVersionUpgrade", "softwarerepository.CachedImage")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("firmware.UnsupportedVersionUpgrade", "softwarerepository.CachedImage")]
...
function ConvertFrom-IntersightJsonToConnectorDownloadStatus {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Checksum", "DownloadError", "DownloadProgress", "DownloadRetries", "Sha256checksum")
