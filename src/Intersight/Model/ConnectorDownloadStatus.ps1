...
function ConvertFrom-IntersightJsonToConnectorDownloadStatus {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Checksum", "DownloadError", "DownloadProgress", "DownloadRetries", "Sha256checksum")
