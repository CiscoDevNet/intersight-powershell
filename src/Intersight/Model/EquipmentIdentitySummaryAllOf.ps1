...
function ConvertFrom-IntersightJsonToEquipmentIdentitySummaryAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AdapterSerial", "AdminAction", "AdminActionState", "ChassisId", "FirmwareSupportability", "Identifier", "IoCardIdentityList", "Lifecycle", "Model", "Presence", "Serial", "SlotId", "SourceObjectType", "SwitchId", "Vendor", "RegisteredDevice")
