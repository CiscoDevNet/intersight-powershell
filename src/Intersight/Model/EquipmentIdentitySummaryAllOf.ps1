...
function ConvertFrom-IntersightJsonToEquipmentIdentitySummaryAllOf {
    ...
    Process {
        ...
        $AllProperties = ("AdapterSerial", "AdminAction", "AdminActionState", "ChassisId", "DeviceMoId", "Identifier", "IoCardIdentityList", "Lifecycle", "Model", "PendingDiscovery", "Serial", "SlotId", "SourceObjectType", "SwitchId", "Vendor", "DeviceRegistration")
