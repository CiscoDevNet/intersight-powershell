...
SoftwarerepositoryReleaseListAllOf<PSCustomObject>
#>

function Initialize-IntersightSoftwarerepositoryReleaseListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwarerepositoryReleaseListAllOf' | Write-Debug
...
Convert from JSON to SoftwarerepositoryReleaseListAllOf<PSCustomObject>
...
SoftwarerepositoryReleaseListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwarerepositoryReleaseListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSoftwarerepositoryReleaseListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSoftwarerepositoryReleaseListAllOf
