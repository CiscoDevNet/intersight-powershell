...
function Initialize-IntersightIamRole {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iam.Role")]
        [String]
        ${ClassId} = "iam.Role",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iam.Role")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamRole' | Write-Debug
...
IamRole<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamRole
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "PrivilegeNames", "Account", "PrivilegeSets", "System")
