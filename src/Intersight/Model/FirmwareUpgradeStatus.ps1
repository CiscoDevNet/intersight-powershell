...
function ConvertFrom-IntersightJsonToFirmwareUpgradeStatus {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DownloadError", "DownloadMessage", "DownloadPercentage", "DownloadProgress", "DownloadRetries", "DownloadStage", "EpPowerStatus", "OverallError", "OverallPercentage", "Overallstatus", "PendingType", "Sha256checksum", "Upgrade", "Workflow")
