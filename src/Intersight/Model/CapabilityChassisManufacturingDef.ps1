...
function ConvertFrom-IntersightJsonToCapabilityChassisManufacturingDef {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Caption", "ChassisCodeName", "Description", "Pid", "ProductName", "Sku", "Vid")
