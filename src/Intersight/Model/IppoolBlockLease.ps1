...
IppoolBlockLease<PSCustomObject>
#>

function Initialize-IntersightIppoolBlockLease {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIppoolBlockLease' | Write-Debug
...
Convert from JSON to IppoolBlockLease<PSCustomObject>
...
IppoolBlockLease<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIppoolBlockLease {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIppoolBlockLease' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIppoolBlockLease
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Count", "IpType", "AssignedToEntity", "IpLeases", "Pool", "Universe", "Vrf")
