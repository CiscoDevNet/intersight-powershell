...
CondHclStatusDetailListAllOf<PSCustomObject>
#>

function Initialize-IntersightCondHclStatusDetailListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCondHclStatusDetailListAllOf' | Write-Debug
...
Convert from JSON to CondHclStatusDetailListAllOf<PSCustomObject>
...
CondHclStatusDetailListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCondHclStatusDetailListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCondHclStatusDetailListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCondHclStatusDetailListAllOf
