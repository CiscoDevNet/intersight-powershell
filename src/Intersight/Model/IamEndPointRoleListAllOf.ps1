...
IamEndPointRoleListAllOf<PSCustomObject>
#>

function Initialize-IntersightIamEndPointRoleListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamEndPointRoleListAllOf' | Write-Debug
...
Convert from JSON to IamEndPointRoleListAllOf<PSCustomObject>
...
IamEndPointRoleListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamEndPointRoleListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamEndPointRoleListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamEndPointRoleListAllOf
