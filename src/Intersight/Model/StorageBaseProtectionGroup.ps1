...
A protection group contains list of members that are protected together through snapshots with point-in-time consistency across the members. Members within the protection group have common data protection requirements and also the same snapshot, replication, and retention schedules.
...
StorageBaseProtectionGroup<PSCustomObject>
#>

function Initialize-IntersightStorageBaseProtectionGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageBaseProtectionGroup' | Write-Debug
...
Convert from JSON to StorageBaseProtectionGroup<PSCustomObject>
...
StorageBaseProtectionGroup<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageBaseProtectionGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageBaseProtectionGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageBaseProtectionGroup
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Prefix", "ReplicationEnabled", "SnapshotEnabled")
