...
HyperflexFeatureLimitExternal<PSCustomObject>
#>

function Initialize-IntersightHyperflexFeatureLimitExternal {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.FeatureLimitExternal")]
        [String]
        ${ClassId} = "hyperflex.FeatureLimitExternal",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.FeatureLimitExternal")]
        [String]
        ${ObjectType} = "hyperflex.FeatureLimitExternal",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexFeatureLimitExternal' | Write-Debug
...
Convert from JSON to HyperflexFeatureLimitExternal<PSCustomObject>
...
HyperflexFeatureLimitExternal<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexFeatureLimitExternal {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexFeatureLimitExternal' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexFeatureLimitExternal
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "FeatureLimitEntries", "AppCatalog")
