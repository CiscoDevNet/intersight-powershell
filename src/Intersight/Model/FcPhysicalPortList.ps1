...
FcPhysicalPortList<PSCustomObject>
#>

function Initialize-IntersightFcPhysicalPortList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFcPhysicalPortList' | Write-Debug
...
Convert from JSON to FcPhysicalPortList<PSCustomObject>
...
FcPhysicalPortList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFcPhysicalPortList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFcPhysicalPortList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFcPhysicalPortList
