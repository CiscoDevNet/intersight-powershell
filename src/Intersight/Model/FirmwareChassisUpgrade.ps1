...
function Initialize-IntersightFirmwareChassisUpgrade {
    ...
    Param (
        ...
        [ValidateSet("firmware.ChassisUpgrade")]
        [String]
        ${ClassId} = "firmware.ChassisUpgrade",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("firmware.ChassisUpgrade")]
        [String]
        ${ObjectType} = "firmware.ChassisUpgrade",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
...
function ConvertFrom-IntersightJsonToFirmwareChassisUpgrade {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DirectDownload", "FileServer", "NetworkShare", "SkipEstimateImpact", "Status", "UpgradeType", "Distributable", "Release", "UpgradeImpact", "UpgradeStatus", "ExcludeComponentList", "Chassis", "Device")
