...
function ConvertFrom-IntersightJsonToStorageEnclosureAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ChassisId", "Description", "EnclosureId", "NumSlots", "Presence", "ServerId", "Type", "ComputeBlade", "ComputeRackUnit", "EnclosureDiskSlots", "EnclosureDisks", "EquipmentChassis", "InventoryDeviceInfo", "PhysicalDisks", "RegisteredDevice")
