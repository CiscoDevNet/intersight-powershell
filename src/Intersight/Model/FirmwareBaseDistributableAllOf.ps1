...
function ConvertFrom-IntersightJsonToFirmwareBaseDistributableAllOf {
    ...
    Process {
        ...
        $AllProperties = ("BundleType", "ComponentMeta", "Guid", "Mdfid", "Model", "PlatformType", "RecommendedBuild", "ReleaseNotesUrl", "SoftwareTypeId", "SupportedModels", "Vendor", "DistributableMetas", "Release")
