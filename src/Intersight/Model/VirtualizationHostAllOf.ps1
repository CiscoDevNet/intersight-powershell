...
Definition of the list of properties defined in 'virtualization.Host', excluding properties defined in parent classes.
...
VirtualizationHostAllOf<PSCustomObject>
#>

function Initialize-IntersightVirtualizationHostAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationHostAllOf' | Write-Debug
...
Convert from JSON to VirtualizationHostAllOf<PSCustomObject>
...
VirtualizationHostAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationHostAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationHostAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationHostAllOf
        $AllProperties = ("ClassId", "ObjectType", "Action", "HypervisorType", "Identity", "Model", "Name", "Serial", "Vendor", "Inventory", "RegisteredDevice", "WorkflowInfo")
