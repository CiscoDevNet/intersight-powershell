...
AssetClusterMemberListAllOf<PSCustomObject>
#>

function Initialize-IntersightAssetClusterMemberListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAssetClusterMemberListAllOf' | Write-Debug
...
Convert from JSON to AssetClusterMemberListAllOf<PSCustomObject>
...
AssetClusterMemberListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAssetClusterMemberListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAssetClusterMemberListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAssetClusterMemberListAllOf
