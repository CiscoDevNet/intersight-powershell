...
FabricFcUplinkRole<PSCustomObject>
#>

function Initialize-IntersightFabricFcUplinkRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricFcUplinkRole' | Write-Debug
...
Convert from JSON to FabricFcUplinkRole<PSCustomObject>
...
FabricFcUplinkRole<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricFcUplinkRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricFcUplinkRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricFcUplinkRole
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AggregatePortId", "PortId", "SlotId", "PortPolicy", "AdminSpeed", "FillPattern", "VsanId")
