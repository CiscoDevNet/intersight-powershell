...
StorageNetAppLunMapList<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppLunMapList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppLunMapList' | Write-Debug
...
Convert from JSON to StorageNetAppLunMapList<PSCustomObject>
...
StorageNetAppLunMapList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppLunMapList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppLunMapList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppLunMapList
