...
InventoryDeviceInfo<PSCustomObject>
#>

function Initialize-IntersightInventoryDeviceInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightInventoryDeviceInfo' | Write-Debug
...
Convert from JSON to InventoryDeviceInfo<PSCustomObject>
...
InventoryDeviceInfo<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToInventoryDeviceInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightInventoryDeviceInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightInventoryDeviceInfo
