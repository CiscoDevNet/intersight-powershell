...
NiaapiNewReleasePostAllOf<PSCustomObject>
#>

function Initialize-IntersightNiaapiNewReleasePostAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiNewReleasePostAllOf' | Write-Debug
...
Convert from JSON to NiaapiNewReleasePostAllOf<PSCustomObject>
...
NiaapiNewReleasePostAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiNewReleasePostAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiNewReleasePostAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiNewReleasePostAllOf
        $AllProperties = ("ClassId", "ObjectType", "PostDate", "PostDetail", "PostType", "Postid", "Revision")
