...
function ConvertFrom-IntersightJsonToFabricVsan {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DefaultZoning", "FcZoneSharingMode", "FcoeVlan", "Name", "VsanId", "FcNetworkPolicy")
