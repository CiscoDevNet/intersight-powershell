...
function ConvertFrom-IntersightJsonToFabricVsan {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DefaultZoning", "FcZoneSharingMode", "FcoeVlan", "Name", "VsanId", "FcNetworkPolicy")
