...
FabricVsan<PSCustomObject>
#>

function Initialize-IntersightFabricVsan {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.Vsan")]
        [String]
        ${ClassId} = "fabric.Vsan",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.Vsan")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricVsan' | Write-Debug
...
Convert from JSON to FabricVsan<PSCustomObject>
...
FabricVsan<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricVsan {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricVsan' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricVsan
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DefaultZoning", "FcZoneSharingMode", "FcoeVlan", "Name", "VsanId", "FcNetworkPolicy")
