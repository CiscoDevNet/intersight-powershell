...
BootVmediaDevice<PSCustomObject>
#>

function Initialize-IntersightBootVmediaDevice {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.VmediaDevice")]
        [String]
        ${ClassId} = "boot.VmediaDevice",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.VmediaDevice")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootVmediaDevice' | Write-Debug
...
Convert from JSON to BootVmediaDevice<PSCustomObject>
...
BootVmediaDevice<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootVmediaDevice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootVmediaDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootVmediaDevice
