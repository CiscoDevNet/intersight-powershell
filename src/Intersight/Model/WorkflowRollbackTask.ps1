...
WorkflowRollbackTask<PSCustomObject>
#>

function Initialize-IntersightWorkflowRollbackTask {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowRollbackTask' | Write-Debug
...
Convert from JSON to WorkflowRollbackTask<PSCustomObject>
...
WorkflowRollbackTask<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowRollbackTask {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowRollbackTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowRollbackTask
