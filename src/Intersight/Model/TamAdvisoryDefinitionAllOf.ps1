...
function ConvertFrom-IntersightJsonToTamAdvisoryDefinitionAllOf {
    ...
    Process {
        ...
        $AllProperties = ("Actions", "AdvisoryDetails", "AdvisoryId", "ApiDataSources", "DatePublished", "DateUpdated", "ExternalUrl", "Recommendation", "Type", "Version", "Workaround", "Organization")
