...
PoolAbstractPoolAllOf<PSCustomObject>
#>

function Initialize-IntersightPoolAbstractPoolAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPoolAbstractPoolAllOf' | Write-Debug
...
Convert from JSON to PoolAbstractPoolAllOf<PSCustomObject>
...
PoolAbstractPoolAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPoolAbstractPoolAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPoolAbstractPoolAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPoolAbstractPoolAllOf
        $AllProperties = ("ClassId", "ObjectType", "Assigned", "AssignmentOrder", "Size")
