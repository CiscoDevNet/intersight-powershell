...
EquipmentPsuList<PSCustomObject>
#>

function Initialize-IntersightEquipmentPsuList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentPsuList' | Write-Debug
...
Convert from JSON to EquipmentPsuList<PSCustomObject>
...
EquipmentPsuList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentPsuList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentPsuList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentPsuList
