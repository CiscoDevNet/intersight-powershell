...
FirmwarePcieDescriptor<PSCustomObject>
#>

function Initialize-IntersightFirmwarePcieDescriptor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwarePcieDescriptor' | Write-Debug
...
Convert from JSON to FirmwarePcieDescriptor<PSCustomObject>
...
FirmwarePcieDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwarePcieDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwarePcieDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwarePcieDescriptor
