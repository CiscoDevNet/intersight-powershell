...
FabricPortChannelRoleAllOf<PSCustomObject>
#>

function Initialize-IntersightFabricPortChannelRoleAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricPortChannelRoleAllOf' | Write-Debug
...
Convert from JSON to FabricPortChannelRoleAllOf<PSCustomObject>
...
FabricPortChannelRoleAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricPortChannelRoleAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricPortChannelRoleAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricPortChannelRoleAllOf
        $AllProperties = ("ClassId", "ObjectType", "PcId", "Ports", "PortPolicy")
