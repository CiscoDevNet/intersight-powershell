...
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryNamespace {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Capacity", "HealthState", "LabelVersion", "Mode", "Name", "Uuid", "InventoryDeviceInfo", "MemoryPersistentMemoryRegion", "RegisteredDevice")
