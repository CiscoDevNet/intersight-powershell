...
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryNamespace {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Capacity", "HealthState", "LabelVersion", "Mode", "Name", "Uuid", "InventoryDeviceInfo", "MemoryPersistentMemoryRegion", "RegisteredDevice")
