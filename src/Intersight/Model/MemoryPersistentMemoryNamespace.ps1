...
MemoryPersistentMemoryNamespace<PSCustomObject>
#>

function Initialize-IntersightMemoryPersistentMemoryNamespace {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMemoryPersistentMemoryNamespace' | Write-Debug
...
Convert from JSON to MemoryPersistentMemoryNamespace<PSCustomObject>
...
MemoryPersistentMemoryNamespace<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMemoryPersistentMemoryNamespace {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMemoryPersistentMemoryNamespace' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMemoryPersistentMemoryNamespace
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Capacity", "HealthState", "LabelVersion", "Mode", "Name", "Uuid", "InventoryDeviceInfo", "MemoryPersistentMemoryRegion", "RegisteredDevice")
