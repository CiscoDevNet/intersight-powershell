...
HyperflexVmSnapshotInfoListAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexVmSnapshotInfoListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexVmSnapshotInfoListAllOf' | Write-Debug
...
Convert from JSON to HyperflexVmSnapshotInfoListAllOf<PSCustomObject>
...
HyperflexVmSnapshotInfoListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexVmSnapshotInfoListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexVmSnapshotInfoListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexVmSnapshotInfoListAllOf
