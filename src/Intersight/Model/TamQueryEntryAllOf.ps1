...
TamQueryEntryAllOf<PSCustomObject>
#>

function Initialize-IntersightTamQueryEntryAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("tam.QueryEntry")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTamQueryEntryAllOf' | Write-Debug
...
Convert from JSON to TamQueryEntryAllOf<PSCustomObject>
...
TamQueryEntryAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTamQueryEntryAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTamQueryEntryAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTamQueryEntryAllOf
        $AllProperties = ("ClassId", "ObjectType", "Name", "Priority", "Query")
