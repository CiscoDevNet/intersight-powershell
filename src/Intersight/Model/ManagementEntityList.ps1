...
ManagementEntityList<PSCustomObject>
#>

function Initialize-IntersightManagementEntityList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightManagementEntityList' | Write-Debug
...
Convert from JSON to ManagementEntityList<PSCustomObject>
...
ManagementEntityList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToManagementEntityList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightManagementEntityList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightManagementEntityList
