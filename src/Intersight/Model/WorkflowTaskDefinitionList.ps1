...
WorkflowTaskDefinitionList<PSCustomObject>
#>

function Initialize-IntersightWorkflowTaskDefinitionList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowTaskDefinitionList' | Write-Debug
...
Convert from JSON to WorkflowTaskDefinitionList<PSCustomObject>
...
WorkflowTaskDefinitionList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowTaskDefinitionList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowTaskDefinitionList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowTaskDefinitionList
