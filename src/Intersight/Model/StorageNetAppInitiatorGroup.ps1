...
StorageNetAppInitiatorGroup<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppInitiatorGroup {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.NetAppInitiatorGroup")]
        [String]
        ${ClassId} = "storage.NetAppInitiatorGroup",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.NetAppInitiatorGroup")]
        [String]
        ${ObjectType} = "storage.NetAppInitiatorGroup",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppInitiatorGroup' | Write-Debug
...
Convert from JSON to StorageNetAppInitiatorGroup<PSCustomObject>
...
StorageNetAppInitiatorGroup<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppInitiatorGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppInitiatorGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppInitiatorGroup
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Initiators", "Name", "OsType", "StorageUtilization", "Protocol", "Uuid", "Tenant")
