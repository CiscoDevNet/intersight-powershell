...
NiaapiVersionRegex<PSCustomObject>
#>

function Initialize-IntersightNiaapiVersionRegex {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("niaapi.VersionRegex")]
        [String]
        ${ClassId} = "niaapi.VersionRegex",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("niaapi.VersionRegex")]
        [String]
        ${ObjectType} = "niaapi.VersionRegex",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiVersionRegex' | Write-Debug
...
Convert from JSON to NiaapiVersionRegex<PSCustomObject>
...
NiaapiVersionRegex<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiVersionRegex {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiVersionRegex' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiVersionRegex
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Apic", "Dcnm", "Version")
