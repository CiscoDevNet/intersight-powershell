...
Definition of the list of properties defined in 'fabric.MacAgingSettings', excluding properties defined in parent classes.
...
FabricMacAgingSettingsAllOf<PSCustomObject>
#>

function Initialize-IntersightFabricMacAgingSettingsAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricMacAgingSettingsAllOf' | Write-Debug
...
Convert from JSON to FabricMacAgingSettingsAllOf<PSCustomObject>
...
FabricMacAgingSettingsAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricMacAgingSettingsAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricMacAgingSettingsAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricMacAgingSettingsAllOf
