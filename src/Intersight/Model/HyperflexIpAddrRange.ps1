...
HyperflexIpAddrRange<PSCustomObject>
#>

function Initialize-IntersightHyperflexIpAddrRange {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexIpAddrRange' | Write-Debug
...
Convert from JSON to HyperflexIpAddrRange<PSCustomObject>
...
HyperflexIpAddrRange<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexIpAddrRange {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexIpAddrRange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexIpAddrRange
