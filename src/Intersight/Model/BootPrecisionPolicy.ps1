...
function ConvertFrom-IntersightJsonToBootPrecisionPolicy {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "BootDevices", "ConfiguredBootMode", "EnforceUefiSecureBoot", "Organization", "Profiles")
