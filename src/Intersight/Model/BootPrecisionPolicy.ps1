...
function ConvertFrom-IntersightJsonToBootPrecisionPolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "BootDevices", "ConfiguredBootMode", "EnforceUefiSecureBoot", "Organization", "Profiles")
