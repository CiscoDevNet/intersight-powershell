...
VirtualizationVmwareClusterList<PSCustomObject>
#>

function Initialize-IntersightVirtualizationVmwareClusterList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationVmwareClusterList' | Write-Debug
...
Convert from JSON to VirtualizationVmwareClusterList<PSCustomObject>
...
VirtualizationVmwareClusterList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationVmwareClusterList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationVmwareClusterList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationVmwareClusterList
