...
function ConvertFrom-IntersightJsonToStorageSasExpander {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ExpanderId", "Name", "OperState", "Operability", "Presence", "SasAddress", "ComputeRackUnit", "Controller", "EquipmentChassis", "InventoryDeviceInfo", "RegisteredDevice")
