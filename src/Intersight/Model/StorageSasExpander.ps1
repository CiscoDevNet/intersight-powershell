...
function ConvertFrom-IntersightJsonToStorageSasExpander {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ExpanderId", "Name", "OperState", "Operability", "Presence", "SasAddress", "ComputeRackUnit", "Controller", "EquipmentChassis", "InventoryDeviceInfo", "RegisteredDevice")
