...
StorageVirtualDriveExtension<PSCustomObject>
#>

function Initialize-IntersightStorageVirtualDriveExtension {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageVirtualDriveExtension' | Write-Debug
...
Convert from JSON to StorageVirtualDriveExtension<PSCustomObject>
...
StorageVirtualDriveExtension<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageVirtualDriveExtension {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageVirtualDriveExtension' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageVirtualDriveExtension
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Bootable", "ContainerId", "DriveState", "Name", "OperDeviceId", "Uuid", "VendorUuid", "VirtualDriveDn", "VirtualDriveId", "InventoryDeviceInfo", "RegisteredDevice", "StorageController", "VirtualDrive")
