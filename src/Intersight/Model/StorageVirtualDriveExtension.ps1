...
function ConvertFrom-IntersightJsonToStorageVirtualDriveExtension {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Bootable", "ContainerId", "DriveState", "Name", "OperDeviceId", "Uuid", "VendorUuid", "VirtualDriveDn", "VirtualDriveId", "InventoryDeviceInfo", "RegisteredDevice", "StorageController", "VirtualDrive")
