...
function ConvertFrom-IntersightJsonToStorageVirtualDriveExtension {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Bootable", "ContainerId", "DriveState", "Name", "OperDeviceId", "Uuid", "VendorUuid", "VirtualDriveDn", "VirtualDriveId", "InventoryDeviceInfo", "RegisteredDevice", "StorageController", "VirtualDrive")
