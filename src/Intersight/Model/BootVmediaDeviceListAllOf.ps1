...
BootVmediaDeviceListAllOf<PSCustomObject>
#>

function Initialize-IntersightBootVmediaDeviceListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootVmediaDeviceListAllOf' | Write-Debug
...
Convert from JSON to BootVmediaDeviceListAllOf<PSCustomObject>
...
BootVmediaDeviceListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootVmediaDeviceListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootVmediaDeviceListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootVmediaDeviceListAllOf
