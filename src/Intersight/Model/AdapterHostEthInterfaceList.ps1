...
AdapterHostEthInterfaceList<PSCustomObject>
#>

function Initialize-IntersightAdapterHostEthInterfaceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAdapterHostEthInterfaceList' | Write-Debug
...
Convert from JSON to AdapterHostEthInterfaceList<PSCustomObject>
...
AdapterHostEthInterfaceList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAdapterHostEthInterfaceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAdapterHostEthInterfaceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAdapterHostEthInterfaceList
