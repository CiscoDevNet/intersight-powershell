...
StorageHitachiPoolListAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageHitachiPoolListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageHitachiPoolListAllOf' | Write-Debug
...
Convert from JSON to StorageHitachiPoolListAllOf<PSCustomObject>
...
StorageHitachiPoolListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageHitachiPoolListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageHitachiPoolListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageHitachiPoolListAllOf
