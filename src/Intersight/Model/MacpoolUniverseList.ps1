...
MacpoolUniverseList<PSCustomObject>
#>

function Initialize-IntersightMacpoolUniverseList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMacpoolUniverseList' | Write-Debug
...
Convert from JSON to MacpoolUniverseList<PSCustomObject>
...
MacpoolUniverseList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMacpoolUniverseList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMacpoolUniverseList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMacpoolUniverseList
