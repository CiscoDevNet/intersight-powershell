...
HclOperatingSystemListAllOf<PSCustomObject>
#>

function Initialize-IntersightHclOperatingSystemListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHclOperatingSystemListAllOf' | Write-Debug
...
Convert from JSON to HclOperatingSystemListAllOf<PSCustomObject>
...
HclOperatingSystemListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHclOperatingSystemListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHclOperatingSystemListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHclOperatingSystemListAllOf
