...
MacpoolBlock<PSCustomObject>
#>

function Initialize-IntersightMacpoolBlock {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMacpoolBlock' | Write-Debug
...
Convert from JSON to MacpoolBlock<PSCustomObject>
...
MacpoolBlock<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMacpoolBlock {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMacpoolBlock' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMacpoolBlock
