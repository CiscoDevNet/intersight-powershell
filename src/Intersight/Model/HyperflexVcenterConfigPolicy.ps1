...
HyperflexVcenterConfigPolicy<PSCustomObject>
#>

function Initialize-IntersightHyperflexVcenterConfigPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.VcenterConfigPolicy")]
        [String]
        ${ClassId} = "hyperflex.VcenterConfigPolicy",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.VcenterConfigPolicy")]
        [String]
        ${ObjectType} = "hyperflex.VcenterConfigPolicy",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexVcenterConfigPolicy' | Write-Debug
...
Convert from JSON to HyperflexVcenterConfigPolicy<PSCustomObject>
...
HyperflexVcenterConfigPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexVcenterConfigPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexVcenterConfigPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexVcenterConfigPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "DataCenter", "Hostname", "IsPasswordSet", "Password", "SsoUrl", "Username", "ClusterProfiles", "Organization")
