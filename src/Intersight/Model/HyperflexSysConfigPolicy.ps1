...
function ConvertFrom-IntersightJsonToHyperflexSysConfigPolicy {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "DnsDomainName", "DnsServers", "NtpServers", "Timezone", "ClusterProfiles", "Organization")
