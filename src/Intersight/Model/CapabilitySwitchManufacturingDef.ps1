...
function ConvertFrom-IntersightJsonToCapabilitySwitchManufacturingDef {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Pid", "Sku", "Vid", "Caption", "Description", "PartNumber", "ProductName")
