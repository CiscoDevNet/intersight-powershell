...
HyperflexServerFirmwareVersionEntryList<PSCustomObject>
#>

function Initialize-IntersightHyperflexServerFirmwareVersionEntryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexServerFirmwareVersionEntryList' | Write-Debug
...
Convert from JSON to HyperflexServerFirmwareVersionEntryList<PSCustomObject>
...
HyperflexServerFirmwareVersionEntryList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexServerFirmwareVersionEntryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexServerFirmwareVersionEntryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexServerFirmwareVersionEntryList
