...
KvmSessionListAllOf<PSCustomObject>
#>

function Initialize-IntersightKvmSessionListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKvmSessionListAllOf' | Write-Debug
...
Convert from JSON to KvmSessionListAllOf<PSCustomObject>
...
KvmSessionListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKvmSessionListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKvmSessionListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKvmSessionListAllOf
