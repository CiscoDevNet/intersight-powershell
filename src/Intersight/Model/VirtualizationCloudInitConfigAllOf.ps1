...
Definition of the list of properties defined in 'virtualization.CloudInitConfig', excluding properties defined in parent classes.
...
VirtualizationCloudInitConfigAllOf<PSCustomObject>
#>

function Initialize-IntersightVirtualizationCloudInitConfigAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationCloudInitConfigAllOf' | Write-Debug
...
Convert from JSON to VirtualizationCloudInitConfigAllOf<PSCustomObject>
...
VirtualizationCloudInitConfigAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationCloudInitConfigAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationCloudInitConfigAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationCloudInitConfigAllOf
