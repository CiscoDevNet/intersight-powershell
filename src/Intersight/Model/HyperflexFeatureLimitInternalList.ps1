...
HyperflexFeatureLimitInternalList<PSCustomObject>
#>

function Initialize-IntersightHyperflexFeatureLimitInternalList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexFeatureLimitInternalList' | Write-Debug
...
Convert from JSON to HyperflexFeatureLimitInternalList<PSCustomObject>
...
HyperflexFeatureLimitInternalList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexFeatureLimitInternalList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexFeatureLimitInternalList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexFeatureLimitInternalList
