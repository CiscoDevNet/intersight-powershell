...
HyperflexConfigResult<PSCustomObject>
#>

function Initialize-IntersightHyperflexConfigResult {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.ConfigResult")]
        [String]
        ${ClassId} = "hyperflex.ConfigResult",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.ConfigResult")]
        [String]
        ${ObjectType} = "hyperflex.ConfigResult",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexConfigResult' | Write-Debug
...
Convert from JSON to HyperflexConfigResult<PSCustomObject>
...
HyperflexConfigResult<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexConfigResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexConfigResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexConfigResult
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ConfigStage", "ConfigState", "ValidationState", "ConfigProgress", "Duration", "StartTime", "ClusterProfile", "ResultEntries")
