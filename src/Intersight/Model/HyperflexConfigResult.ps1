...
function ConvertFrom-IntersightJsonToHyperflexConfigResult {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ConfigStage", "ConfigState", "ValidationState", "ConfigProgress", "Duration", "StartTime", "ClusterProfile", "ResultEntries")
