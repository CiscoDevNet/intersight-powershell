...
ChassisConfigResultList<PSCustomObject>
#>

function Initialize-IntersightChassisConfigResultList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightChassisConfigResultList' | Write-Debug
...
Convert from JSON to ChassisConfigResultList<PSCustomObject>
...
ChassisConfigResultList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToChassisConfigResultList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightChassisConfigResultList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightChassisConfigResultList
