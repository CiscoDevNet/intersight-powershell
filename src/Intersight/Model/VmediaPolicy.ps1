...
function ConvertFrom-IntersightJsonToVmediaPolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Enabled", "Encryption", "LowPowerUsb", "Mappings", "Organization", "Profiles")
