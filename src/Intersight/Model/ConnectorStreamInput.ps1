...
ConnectorStreamInput<PSCustomObject>
#>

function Initialize-IntersightConnectorStreamInput {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("connector.StreamInput")]
        [String]
        ${ClassId} = "connector.StreamInput",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("connector.StreamInput")]
        [String]
        ${ObjectType} = "connector.StreamInput",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${EncryptedAesKey},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConnectorStreamInput' | Write-Debug
...
Convert from JSON to ConnectorStreamInput<PSCustomObject>
...
ConnectorStreamInput<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConnectorStreamInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConnectorStreamInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConnectorStreamInput
        $AllProperties = ("ClassId", "ObjectType", "EncryptedAesKey", "EncryptionKey", "SecureProperties", "StreamName", "Input")
