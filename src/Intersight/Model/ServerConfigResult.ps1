...
ServerConfigResult<PSCustomObject>
#>

function Initialize-IntersightServerConfigResult {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("server.ConfigResult")]
        [String]
        ${ClassId} = "server.ConfigResult",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("server.ConfigResult")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightServerConfigResult' | Write-Debug
...
Convert from JSON to ServerConfigResult<PSCustomObject>
...
ServerConfigResult<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToServerConfigResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightServerConfigResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightServerConfigResult
