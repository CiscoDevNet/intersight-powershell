...
SoftwareHyperflexDistributable<PSCustomObject>
#>

function Initialize-IntersightSoftwareHyperflexDistributable {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("software.HyperflexDistributable")]
        [String]
        ${ClassId} = "software.HyperflexDistributable",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("software.HyperflexDistributable")]
        [String]
        ${ObjectType} = "software.HyperflexDistributable",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwareHyperflexDistributable' | Write-Debug
...
Convert from JSON to SoftwareHyperflexDistributable<PSCustomObject>
...
SoftwareHyperflexDistributable<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwareHyperflexDistributable {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSoftwareHyperflexDistributable' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSoftwareHyperflexDistributable
