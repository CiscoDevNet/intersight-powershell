...
EquipmentSystemIoController<PSCustomObject>
#>

function Initialize-IntersightEquipmentSystemIoController {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentSystemIoController' | Write-Debug
...
Convert from JSON to EquipmentSystemIoController<PSCustomObject>
...
EquipmentSystemIoController<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentSystemIoController {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentSystemIoController' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentSystemIoController
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ChassisId", "ConnectionPath", "ConnectionStatus", "Description", "ManagingInstance", "OperState", "PartNumber", "Pid", "SystemIoControllerId", "Cmc", "EquipmentChassis", "InventoryDeviceInfo", "RegisteredDevice", "SharedIoModule")
