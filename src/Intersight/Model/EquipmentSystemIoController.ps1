...
function ConvertFrom-IntersightJsonToEquipmentSystemIoController {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ChassisId", "ConnectionPath", "ConnectionStatus", "Description", "ManagingInstance", "OperState", "PartNumber", "Pid", "SystemIoControllerId", "Cmc", "EquipmentChassis", "InventoryDeviceInfo", "RegisteredDevice", "SharedIoModule")
