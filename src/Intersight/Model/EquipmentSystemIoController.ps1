...
function ConvertFrom-IntersightJsonToEquipmentSystemIoController {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ChassisId", "ConnectionPath", "ConnectionStatus", "Description", "ManagingInstance", "OperState", "PartNumber", "Pid", "SystemIoControllerId", "Cmc", "EquipmentChassis", "InventoryDeviceInfo", "RegisteredDevice", "SharedIoModule")
