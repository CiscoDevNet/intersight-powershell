...
StorageNetAppEthernetPortListAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageNetAppEthernetPortListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageNetAppEthernetPortListAllOf' | Write-Debug
...
Convert from JSON to StorageNetAppEthernetPortListAllOf<PSCustomObject>
...
StorageNetAppEthernetPortListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageNetAppEthernetPortListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageNetAppEthernetPortListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageNetAppEthernetPortListAllOf
