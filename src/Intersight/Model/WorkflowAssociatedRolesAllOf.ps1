...
Definition of the list of properties defined in 'workflow.AssociatedRoles', excluding properties defined in parent classes.
...
WorkflowAssociatedRolesAllOf<PSCustomObject>
#>

function Initialize-IntersightWorkflowAssociatedRolesAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowAssociatedRolesAllOf' | Write-Debug
...
Convert from JSON to WorkflowAssociatedRolesAllOf<PSCustomObject>
...
WorkflowAssociatedRolesAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowAssociatedRolesAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowAssociatedRolesAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowAssociatedRolesAllOf
