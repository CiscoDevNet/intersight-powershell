...
StorageHitachiHostLun<PSCustomObject>
#>

function Initialize-IntersightStorageHitachiHostLun {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiHostLun")]
        [String]
        ${ClassId} = "storage.HitachiHostLun",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiHostLun")]
        [String]
        ${ObjectType} = "storage.HitachiHostLun",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageHitachiHostLun' | Write-Debug
...
Convert from JSON to StorageHitachiHostLun<PSCustomObject>
...
StorageHitachiHostLun<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageHitachiHostLun {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageHitachiHostLun' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageHitachiHostLun
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Hlu", "HostName", "VolumeName", "PortId", "Array", "Host", "RegisteredDevice", "Volume")
