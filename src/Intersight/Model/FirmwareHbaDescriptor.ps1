...
FirmwareHbaDescriptor<PSCustomObject>
#>

function Initialize-IntersightFirmwareHbaDescriptor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareHbaDescriptor' | Write-Debug
...
Convert from JSON to FirmwareHbaDescriptor<PSCustomObject>
...
FirmwareHbaDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareHbaDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareHbaDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareHbaDescriptor
