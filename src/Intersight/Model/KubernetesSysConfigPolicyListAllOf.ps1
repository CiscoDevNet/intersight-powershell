...
KubernetesSysConfigPolicyListAllOf<PSCustomObject>
#>

function Initialize-IntersightKubernetesSysConfigPolicyListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesSysConfigPolicyListAllOf' | Write-Debug
...
Convert from JSON to KubernetesSysConfigPolicyListAllOf<PSCustomObject>
...
KubernetesSysConfigPolicyListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesSysConfigPolicyListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesSysConfigPolicyListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesSysConfigPolicyListAllOf
