...
StorageItemAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageItemAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageItemAllOf' | Write-Debug
...
Convert from JSON to StorageItemAllOf<PSCustomObject>
...
StorageItemAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageItemAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageItemAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageItemAllOf
        $AllProperties = ("ClassId", "ObjectType", "AlarmType", "Name", "OperState", "Size", "Used", "InventoryDeviceInfo", "NetworkElement", "RegisteredDevice")
