...
function ConvertFrom-IntersightJsonToSdwanRouterNode {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceTemplate", "Name", "NetworkConfiguration", "TemplateInputs", "Uuid", "Organization", "Profile", "ServerNode")
