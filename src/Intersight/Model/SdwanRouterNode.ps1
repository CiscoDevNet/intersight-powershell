...
SdwanRouterNode<PSCustomObject>
#>

function Initialize-IntersightSdwanRouterNode {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSdwanRouterNode' | Write-Debug
...
Convert from JSON to SdwanRouterNode<PSCustomObject>
...
SdwanRouterNode<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSdwanRouterNode {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSdwanRouterNode' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSdwanRouterNode
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceTemplate", "Name", "NetworkConfiguration", "TemplateInputs", "Uuid", "Organization", "Profile", "ServerNode")
