...
function ConvertFrom-IntersightJsonToSdwanRouterNode {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceTemplate", "Name", "NetworkConfiguration", "TemplateInputs", "Uuid", "Organization", "Profile", "ServerNode")
