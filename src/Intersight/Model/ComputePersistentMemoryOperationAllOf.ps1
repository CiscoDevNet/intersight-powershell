...
ComputePersistentMemoryOperationAllOf<PSCustomObject>
#>

function Initialize-IntersightComputePersistentMemoryOperationAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightComputePersistentMemoryOperationAllOf' | Write-Debug
...
Convert from JSON to ComputePersistentMemoryOperationAllOf<PSCustomObject>
...
ComputePersistentMemoryOperationAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToComputePersistentMemoryOperationAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightComputePersistentMemoryOperationAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightComputePersistentMemoryOperationAllOf
        $AllProperties = ("AdminAction", "IsSecurePassphraseSet", "Modules", "SecurePassphrase")
