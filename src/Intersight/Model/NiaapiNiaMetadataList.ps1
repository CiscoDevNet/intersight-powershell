...
NiaapiNiaMetadataList<PSCustomObject>
#>

function Initialize-IntersightNiaapiNiaMetadataList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiNiaMetadataList' | Write-Debug
...
Convert from JSON to NiaapiNiaMetadataList<PSCustomObject>
...
NiaapiNiaMetadataList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiNiaMetadataList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiNiaMetadataList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiNiaMetadataList
