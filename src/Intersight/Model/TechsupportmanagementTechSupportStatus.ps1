...
function ConvertFrom-IntersightJsonToTechsupportmanagementTechSupportStatus {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "FileName", "Reason", "RelayReason", "RelayStatus", "RequestTs", "Status", "TechsupportDownloadUrl", "ClusterMember", "DeviceRegistration", "OriginResource", "TechSupportRequest")
