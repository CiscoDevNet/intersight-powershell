...
HclHyperflexSoftwareCompatibilityInfoList<PSCustomObject>
#>

function Initialize-IntersightHclHyperflexSoftwareCompatibilityInfoList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHclHyperflexSoftwareCompatibilityInfoList' | Write-Debug
...
Convert from JSON to HclHyperflexSoftwareCompatibilityInfoList<PSCustomObject>
...
HclHyperflexSoftwareCompatibilityInfoList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHclHyperflexSoftwareCompatibilityInfoList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHclHyperflexSoftwareCompatibilityInfoList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHclHyperflexSoftwareCompatibilityInfoList
