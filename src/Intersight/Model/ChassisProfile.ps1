...
ChassisProfile<PSCustomObject>
#>

function Initialize-IntersightChassisProfile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightChassisProfile' | Write-Debug
...
Convert from JSON to ChassisProfile<PSCustomObject>
...
ChassisProfile<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToChassisProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightChassisProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightChassisProfile
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Type", "SrcTemplate", "Action", "ConfigContext", "ConfigChanges", "TargetPlatform", "AssignedChassis", "AssociatedChassis", "ConfigChangeDetails", "ConfigResult", "IomProfiles", "Organization", "RunningWorkflows")
