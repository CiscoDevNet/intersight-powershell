...
HyperflexNamedVsanAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexNamedVsanAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.NamedVsan")]
        [String]
        ${ClassId} = "hyperflex.NamedVsan",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("hyperflex.NamedVsan")]
        [String]
        ${ObjectType} = "hyperflex.NamedVsan",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexNamedVsanAllOf' | Write-Debug
...
Convert from JSON to HyperflexNamedVsanAllOf<PSCustomObject>
...
HyperflexNamedVsanAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexNamedVsanAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexNamedVsanAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexNamedVsanAllOf
        $AllProperties = ("ClassId", "ObjectType", "Name", "VsanId")
