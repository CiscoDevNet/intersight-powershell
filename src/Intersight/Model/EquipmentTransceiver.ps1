...
function ConvertFrom-IntersightJsonToEquipmentTransceiver {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "OperSpeed", "OperState", "OperStateQual", "PortId", "SlotId", "SwitchId", "Type", "EtherPhysicalPort", "RegisteredDevice")
