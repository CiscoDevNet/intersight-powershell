...
EquipmentTransceiver<PSCustomObject>
#>

function Initialize-IntersightEquipmentTransceiver {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.Transceiver")]
        [String]
        ${ClassId} = "equipment.Transceiver",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.Transceiver")]
        [String]
        ${ObjectType} = "equipment.Transceiver",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentTransceiver' | Write-Debug
...
Convert from JSON to EquipmentTransceiver<PSCustomObject>
...
EquipmentTransceiver<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentTransceiver {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentTransceiver' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentTransceiver
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "OperSpeed", "OperState", "OperStateQual", "PortId", "SlotId", "SwitchId", "Type", "EtherPhysicalPort", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "EtherPhysicalPort"))) { #optional property not found
            $EtherPhysicalPort = $null
        } else {
            $EtherPhysicalPort = $JsonParameters.PSobject.Properties["EtherPhysicalPort"].value
        }
