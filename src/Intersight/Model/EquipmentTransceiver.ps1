...
function ConvertFrom-IntersightJsonToEquipmentTransceiver {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "OperSpeed", "OperState", "OperStateQual", "PortId", "SlotId", "SwitchId", "Type", "EtherPhysicalPort", "RegisteredDevice")
