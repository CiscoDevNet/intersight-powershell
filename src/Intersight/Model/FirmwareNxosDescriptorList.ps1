...
FirmwareNxosDescriptorList<PSCustomObject>
#>

function Initialize-IntersightFirmwareNxosDescriptorList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareNxosDescriptorList' | Write-Debug
...
Convert from JSON to FirmwareNxosDescriptorList<PSCustomObject>
...
FirmwareNxosDescriptorList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareNxosDescriptorList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareNxosDescriptorList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareNxosDescriptorList
