...
ComputeRackUnitIdentityListAllOf<PSCustomObject>
#>

function Initialize-IntersightComputeRackUnitIdentityListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightComputeRackUnitIdentityListAllOf' | Write-Debug
...
Convert from JSON to ComputeRackUnitIdentityListAllOf<PSCustomObject>
...
ComputeRackUnitIdentityListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToComputeRackUnitIdentityListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightComputeRackUnitIdentityListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightComputeRackUnitIdentityListAllOf
