...
FabricPortPolicyAllOf<PSCustomObject>
#>

function Initialize-IntersightFabricPortPolicyAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricPortPolicyAllOf' | Write-Debug
...
Convert from JSON to FabricPortPolicyAllOf<PSCustomObject>
...
FabricPortPolicyAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricPortPolicyAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricPortPolicyAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricPortPolicyAllOf
        $AllProperties = ("ClassId", "ObjectType", "DeviceModel", "Organization", "Profiles")
