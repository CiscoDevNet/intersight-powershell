...
FabricSystemQosPolicyList<PSCustomObject>
#>

function Initialize-IntersightFabricSystemQosPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricSystemQosPolicyList' | Write-Debug
...
Convert from JSON to FabricSystemQosPolicyList<PSCustomObject>
...
FabricSystemQosPolicyList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricSystemQosPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricSystemQosPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricSystemQosPolicyList
