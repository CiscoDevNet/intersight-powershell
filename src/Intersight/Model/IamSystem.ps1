...
IamSystem<PSCustomObject>
#>

function Initialize-IntersightIamSystem {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iam.System")]
        [String]
        ${ClassId} = "iam.System",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("iam.System")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamSystem' | Write-Debug
...
Convert from JSON to IamSystem<PSCustomObject>
...
IamSystem<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamSystem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamSystem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamSystem
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "EndPointPrivileges", "EndPointRoles", "Idp", "PrivilegeSets", "Privileges", "Roles", "ServiceProvider")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "EndPointPrivileges"))) { #optional property not found
            $EndPointPrivileges = $null
        } else {
            $EndPointPrivileges = $JsonParameters.PSobject.Properties["EndPointPrivileges"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ServiceProvider"))) { #optional property not found
            $ServiceProvider = $null
        } else {
            $ServiceProvider = $JsonParameters.PSobject.Properties["ServiceProvider"].value
        }
