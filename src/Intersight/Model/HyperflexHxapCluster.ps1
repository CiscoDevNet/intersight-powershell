...
HyperflexHxapCluster<PSCustomObject>
#>

function Initialize-IntersightHyperflexHxapCluster {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexHxapCluster' | Write-Debug
...
Convert from JSON to HyperflexHxapCluster<PSCustomObject>
...
HyperflexHxapCluster<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexHxapCluster {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexHxapCluster' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexHxapCluster
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "HypervisorType", "Identity", "MemoryCapacity", "Name", "ProcessorCapacity", "Status", "TotalCores", "DatacenterName", "FailureReason", "ManagementIpAddress", "Version", "HxCluster", "RegisteredDevice")
