...
HyperflexHxapEvent<PSCustomObject>
#>

function Initialize-IntersightHyperflexHxapEvent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexHxapEvent' | Write-Debug
...
Convert from JSON to HyperflexHxapEvent<PSCustomObject>
...
HyperflexHxapEvent<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexHxapEvent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexHxapEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexHxapEvent
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "FirstTime", "Identity", "LastTime", "Message", "OwnerName", "OwnerType", "OwnerUuid", "Severity", "Cluster")
