...
VnicEthNetworkPolicy<PSCustomObject>
#>

function Initialize-IntersightVnicEthNetworkPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("vnic.EthNetworkPolicy")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVnicEthNetworkPolicy' | Write-Debug
...
Convert from JSON to VnicEthNetworkPolicy<PSCustomObject>
...
VnicEthNetworkPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVnicEthNetworkPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVnicEthNetworkPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVnicEthNetworkPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "TargetPlatform", "VlanSettings", "Organization")
