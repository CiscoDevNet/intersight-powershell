...
PolicyAbstractConfigProfile<PSCustomObject>
#>

function Initialize-IntersightPolicyAbstractConfigProfile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPolicyAbstractConfigProfile' | Write-Debug
...
Convert from JSON to PolicyAbstractConfigProfile<PSCustomObject>
...
PolicyAbstractConfigProfile<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPolicyAbstractConfigProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPolicyAbstractConfigProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPolicyAbstractConfigProfile
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Type", "SrcTemplate", "Action", "ConfigContext")
