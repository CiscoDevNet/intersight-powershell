...
function ConvertFrom-IntersightJsonToFirmwareRunningFirmwareAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Component", "PackageVersion", "Type", "Version", "BiosUnit", "GraphicsCard", "InventoryDeviceInfo", "ManagementController", "NetworkElements", "PciSwitch", "RegisteredDevice", "StorageController", "StorageFlexFlashController", "StoragePhysicalDisk")
