...
function ConvertFrom-IntersightJsonToEquipmentPsu {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Description", "OperReason", "OperState", "PartNumber", "Pid", "Presence", "PsuFwVersion", "PsuId", "PsuInputSrc", "PsuType", "PsuWattage", "Sku", "Vid", "Voltage", "ComputeRackUnit", "EquipmentChassis", "EquipmentFex", "EquipmentRackEnclosure", "InventoryDeviceInfo", "NetworkElement", "RegisteredDevice")
