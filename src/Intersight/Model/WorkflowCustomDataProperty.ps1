...
WorkflowCustomDataProperty<PSCustomObject>
#>

function Initialize-IntersightWorkflowCustomDataProperty {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.CustomDataProperty")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowCustomDataProperty' | Write-Debug
...
Convert from JSON to WorkflowCustomDataProperty<PSCustomObject>
...
WorkflowCustomDataProperty<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowCustomDataProperty {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowCustomDataProperty' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowCustomDataProperty
        $AllProperties = ("ClassId", "ObjectType", "CatalogMoid", "CustomDataTypeId", "CustomDataTypeName")
