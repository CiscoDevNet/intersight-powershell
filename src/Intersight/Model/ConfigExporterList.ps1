...
ConfigExporterList<PSCustomObject>
#>

function Initialize-IntersightConfigExporterList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConfigExporterList' | Write-Debug
...
Convert from JSON to ConfigExporterList<PSCustomObject>
...
ConfigExporterList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConfigExporterList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConfigExporterList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConfigExporterList
