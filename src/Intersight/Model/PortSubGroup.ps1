...
function ConvertFrom-IntersightJsonToPortSubGroup {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Transport", "EthernetPorts", "FcPorts", "InventoryDeviceInfo", "PortGroup", "RegisteredDevice")
