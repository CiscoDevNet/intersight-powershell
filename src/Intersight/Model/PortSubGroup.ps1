...
PortSubGroup<PSCustomObject>
#>

function Initialize-IntersightPortSubGroup {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("port.SubGroup")]
        [String]
        ${ClassId} = "port.SubGroup",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("port.SubGroup")]
        [String]
        ${ObjectType} = "port.SubGroup",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPortSubGroup' | Write-Debug
...
Convert from JSON to PortSubGroup<PSCustomObject>
...
PortSubGroup<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPortSubGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPortSubGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPortSubGroup
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Transport", "EthernetPorts", "FcPorts", "InventoryDeviceInfo", "PortGroup", "RegisteredDevice")
