...
function ConvertFrom-IntersightJsonToPortSubGroup {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Transport", "EthernetPorts", "FcPorts", "InventoryDeviceInfo", "PortGroup", "RegisteredDevice")
