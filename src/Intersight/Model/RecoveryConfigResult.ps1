...
RecoveryConfigResult<PSCustomObject>
#>

function Initialize-IntersightRecoveryConfigResult {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("recovery.ConfigResult")]
        [String]
        ${ClassId} = "recovery.ConfigResult",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("recovery.ConfigResult")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightRecoveryConfigResult' | Write-Debug
        ...
        $PSO = [PSCustomObject]@{
            ...
            "_0_OnDemandBackup" = ${Var0OnDemandBackup}
...
Convert from JSON to RecoveryConfigResult<PSCustomObject>
...
RecoveryConfigResult<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToRecoveryConfigResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightRecoveryConfigResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightRecoveryConfigResult
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ConfigStage", "ConfigState", "ValidationState", "_0_OnDemandBackup", "BackupProfile", "ResultEntries")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "_0_OnDemandBackup"))) { #optional property not found
            $Var0OnDemandBackup = $null
        } else {
            $Var0OnDemandBackup = $JsonParameters.PSobject.Properties["_0_OnDemandBackup"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "BackupProfile"))) { #optional property not found
            $BackupProfile = $null
        } else {
            $BackupProfile = $JsonParameters.PSobject.Properties["BackupProfile"].value
        }
