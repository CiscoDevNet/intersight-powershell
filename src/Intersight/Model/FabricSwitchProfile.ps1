...
function ConvertFrom-IntersightJsonToFabricSwitchProfile {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Type", "SrcTemplate", "Action", "ConfigContext", "ConfigChanges", "AssignedSwitch", "AssociatedSwitch", "ConfigChangeDetails", "ConfigResult", "RunningWorkflows", "SwitchClusterProfile")
