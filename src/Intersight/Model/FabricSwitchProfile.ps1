...
function ConvertFrom-IntersightJsonToFabricSwitchProfile {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Type", "SrcTemplate", "Action", "ConfigContext", "ConfigChanges", "AssignedSwitch", "AssociatedSwitch", "ConfigChangeDetails", "ConfigResult", "RunningWorkflows", "SwitchClusterProfile")
