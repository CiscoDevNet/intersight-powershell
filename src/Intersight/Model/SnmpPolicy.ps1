...
SnmpPolicy<PSCustomObject>
#>

function Initialize-IntersightSnmpPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("snmp.Policy")]
        [String]
        ${ClassId} = "snmp.Policy",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("snmp.Policy")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSnmpPolicy' | Write-Debug
        ...
        if (!$SnmpTraps -and $SnmpTraps.length -gt 15) {
            throw "invalid value for 'SnmpTraps', number of items must be less than or equal to 15."
        }

        if (!$SnmpUsers -and $SnmpUsers.length -gt 15) {
            throw "invalid value for 'SnmpUsers', number of items must be less than or equal to 15."
        }
...
Convert from JSON to SnmpPolicy<PSCustomObject>
...
SnmpPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSnmpPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSnmpPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSnmpPolicy
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "AccessCommunityString", "CommunityAccess", "Enabled", "EngineId", "SnmpPort", "SnmpTraps", "SnmpUsers", "SysContact", "SysLocation", "TrapCommunity", "Organization", "Profiles")
