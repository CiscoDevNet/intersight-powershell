...
function ConvertFrom-IntersightJsonToSnmpPolicy {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "AccessCommunityString", "CommunityAccess", "Enabled", "EngineId", "SnmpPort", "SnmpTraps", "SnmpUsers", "SysContact", "SysLocation", "TrapCommunity", "Organization", "Profiles")
