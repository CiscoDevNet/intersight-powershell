...
function ConvertFrom-IntersightJsonToSnmpPolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "AccessCommunityString", "CommunityAccess", "Enabled", "EngineId", "SnmpPort", "SnmpTraps", "SnmpUsers", "SysContact", "SysLocation", "TrapCommunity", "Organization", "Profiles")
