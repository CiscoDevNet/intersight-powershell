...
EquipmentSystemIoControllerList<PSCustomObject>
#>

function Initialize-IntersightEquipmentSystemIoControllerList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentSystemIoControllerList' | Write-Debug
...
Convert from JSON to EquipmentSystemIoControllerList<PSCustomObject>
...
EquipmentSystemIoControllerList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentSystemIoControllerList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentSystemIoControllerList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentSystemIoControllerList
