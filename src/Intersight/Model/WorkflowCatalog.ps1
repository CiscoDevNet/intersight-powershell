...
WorkflowCatalog<PSCustomObject>
#>

function Initialize-IntersightWorkflowCatalog {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.Catalog")]
        [String]
        ${ClassId} = "workflow.Catalog",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("workflow.Catalog")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowCatalog' | Write-Debug
...
Convert from JSON to WorkflowCatalog<PSCustomObject>
...
WorkflowCatalog<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowCatalog {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowCatalog' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowCatalog
