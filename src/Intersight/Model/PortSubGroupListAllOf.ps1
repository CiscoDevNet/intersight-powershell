...
PortSubGroupListAllOf<PSCustomObject>
#>

function Initialize-IntersightPortSubGroupListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPortSubGroupListAllOf' | Write-Debug
...
Convert from JSON to PortSubGroupListAllOf<PSCustomObject>
...
PortSubGroupListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPortSubGroupListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPortSubGroupListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPortSubGroupListAllOf
