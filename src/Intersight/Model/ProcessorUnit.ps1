...
function ConvertFrom-IntersightJsonToProcessorUnit {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "Architecture", "NumCores", "NumCoresEnabled", "NumThreads", "OperPowerState", "OperState", "Operability", "Presence", "ProcessorId", "SocketDesignation", "Speed", "Stepping", "Thermal", "ComputeBlade", "ComputeBoard", "ComputeRackUnit", "InventoryDeviceInfo", "RegisteredDevice")
