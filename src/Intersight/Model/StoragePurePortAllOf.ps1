...
StoragePurePortAllOf<PSCustomObject>
#>

function Initialize-IntersightStoragePurePortAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePurePortAllOf' | Write-Debug
...
Convert from JSON to StoragePurePortAllOf<PSCustomObject>
...
StoragePurePortAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePurePortAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePurePortAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePurePortAllOf
        $AllProperties = ("ClassId", "ObjectType", "Failover", "Portal", "Array", "Controller", "RegisteredDevice")
