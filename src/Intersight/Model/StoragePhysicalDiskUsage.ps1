...
StoragePhysicalDiskUsage<PSCustomObject>
#>

function Initialize-IntersightStoragePhysicalDiskUsage {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PhysicalDiskUsage")]
        [String]
        ${ClassId} = "storage.PhysicalDiskUsage",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.PhysicalDiskUsage")]
        [String]
        ${ObjectType} = "storage.PhysicalDiskUsage",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePhysicalDiskUsage' | Write-Debug
...
Convert from JSON to StoragePhysicalDiskUsage<PSCustomObject>
...
StoragePhysicalDiskUsage<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePhysicalDiskUsage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePhysicalDiskUsage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePhysicalDiskUsage
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "NumberOfBlocks", "PhysicalDrive", "Span", "StartingBlock", "State", "VirtualDrive", "InventoryDeviceInfo", "RegisteredDevice")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "NumberOfBlocks"))) { #optional property not found
            $NumberOfBlocks = $null
        } else {
            $NumberOfBlocks = $JsonParameters.PSobject.Properties["NumberOfBlocks"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "StartingBlock"))) { #optional property not found
            $StartingBlock = $null
        } else {
            $StartingBlock = $JsonParameters.PSobject.Properties["StartingBlock"].value
        }
