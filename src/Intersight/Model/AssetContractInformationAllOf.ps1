...
AssetContractInformationAllOf<PSCustomObject>
#>

function Initialize-IntersightAssetContractInformationAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightAssetContractInformationAllOf' | Write-Debug
...
Convert from JSON to AssetContractInformationAllOf<PSCustomObject>
...
AssetContractInformationAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToAssetContractInformationAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightAssetContractInformationAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightAssetContractInformationAllOf
        $AllProperties = ("BillTo", "BillToGlobalUltimate", "ContractNumber", "LineStatus")
