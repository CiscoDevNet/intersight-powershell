...
ResourceSelectorAllOf<PSCustomObject>
#>

function Initialize-IntersightResourceSelectorAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("resource.Selector")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightResourceSelectorAllOf' | Write-Debug
...
Convert from JSON to ResourceSelectorAllOf<PSCustomObject>
...
ResourceSelectorAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToResourceSelectorAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightResourceSelectorAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightResourceSelectorAllOf
        $AllProperties = ("ClassId", "ObjectType", "Selector")
