...
FirmwareSasExpanderDescriptorList<PSCustomObject>
#>

function Initialize-IntersightFirmwareSasExpanderDescriptorList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareSasExpanderDescriptorList' | Write-Debug
...
Convert from JSON to FirmwareSasExpanderDescriptorList<PSCustomObject>
...
FirmwareSasExpanderDescriptorList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareSasExpanderDescriptorList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareSasExpanderDescriptorList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareSasExpanderDescriptorList
