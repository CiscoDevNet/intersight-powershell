...
Definition of the list of properties defined in 'kubernetes.VirtualMachineInstanceType', excluding properties defined in parent classes.
...
KubernetesVirtualMachineInstanceTypeAllOf<PSCustomObject>
#>

function Initialize-IntersightKubernetesVirtualMachineInstanceTypeAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesVirtualMachineInstanceTypeAllOf' | Write-Debug
...
Convert from JSON to KubernetesVirtualMachineInstanceTypeAllOf<PSCustomObject>
...
KubernetesVirtualMachineInstanceTypeAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesVirtualMachineInstanceTypeAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesVirtualMachineInstanceTypeAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesVirtualMachineInstanceTypeAllOf
        $AllProperties = ("ClassId", "ObjectType", "Cpu", "DiskSize", "Memory", "Organization", "Profiles")
