...
function ConvertFrom-IntersightJsonToStorageEnclosureDiskAllOf {
    ...
    Process {
        ...
        $AllProperties = ("BlockSize", "DiskId", "DiskState", "Health", "NumBlocks", "Pid", "SasAddress1", "SasAddress2", "Size", "InventoryDeviceInfo", "PhysicalDisk", "RegisteredDevice", "StorageEnclosure")
