...
MacpoolBlockAllOf<PSCustomObject>
#>

function Initialize-IntersightMacpoolBlockAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("macpool.Block")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMacpoolBlockAllOf' | Write-Debug
...
Convert from JSON to MacpoolBlockAllOf<PSCustomObject>
...
MacpoolBlockAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMacpoolBlockAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMacpoolBlockAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMacpoolBlockAllOf
