...
StorageBaseArrayDiskAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageBaseArrayDiskAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageBaseArrayDiskAllOf' | Write-Debug
...
Convert from JSON to StorageBaseArrayDiskAllOf<PSCustomObject>
...
StorageBaseArrayDiskAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageBaseArrayDiskAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageBaseArrayDiskAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageBaseArrayDiskAllOf
        $AllProperties = ("ClassId", "ObjectType", "Name", "PartNumber", "Protocol", "Speed", "Status", "StorageUtilization", "Type", "Version")
