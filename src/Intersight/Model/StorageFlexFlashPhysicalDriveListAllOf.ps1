...
StorageFlexFlashPhysicalDriveListAllOf<PSCustomObject>
#>

function Initialize-IntersightStorageFlexFlashPhysicalDriveListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageFlexFlashPhysicalDriveListAllOf' | Write-Debug
...
Convert from JSON to StorageFlexFlashPhysicalDriveListAllOf<PSCustomObject>
...
StorageFlexFlashPhysicalDriveListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageFlexFlashPhysicalDriveListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageFlexFlashPhysicalDriveListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageFlexFlashPhysicalDriveListAllOf
