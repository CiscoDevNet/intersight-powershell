...
FabricQosPolicy<PSCustomObject>
#>

function Initialize-IntersightFabricQosPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricQosPolicy' | Write-Debug
...
Convert from JSON to FabricQosPolicy<PSCustomObject>
...
FabricQosPolicy<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricQosPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricQosPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricQosPolicy
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Classes", "Organization", "Profiles")
