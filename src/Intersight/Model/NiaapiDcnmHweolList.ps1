...
NiaapiDcnmHweolList<PSCustomObject>
#>

function Initialize-IntersightNiaapiDcnmHweolList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiDcnmHweolList' | Write-Debug
...
Convert from JSON to NiaapiDcnmHweolList<PSCustomObject>
...
NiaapiDcnmHweolList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiDcnmHweolList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiaapiDcnmHweolList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiaapiDcnmHweolList
