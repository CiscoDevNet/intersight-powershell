...
function ConvertFrom-IntersightJsonToWorkflowSshSession {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AssetTargetMoid", "Body", "ContentType", "Description", "Label", "Name", "Outcomes", "ResponseSpec", "SkipOnCondition", "StartDelay", "Timeout", "FileTransferToRemote", "MessageType", "SshCommand", "SshConfiguration")
