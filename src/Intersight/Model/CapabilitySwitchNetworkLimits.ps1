...
Object combines and lists the network-config limits for each of the Fabric/Switch platforms.
...
CapabilitySwitchNetworkLimits<PSCustomObject>
#>

function Initialize-IntersightCapabilitySwitchNetworkLimits {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilitySwitchNetworkLimits' | Write-Debug
...
Convert from JSON to CapabilitySwitchNetworkLimits<PSCustomObject>
...
CapabilitySwitchNetworkLimits<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilitySwitchNetworkLimits {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilitySwitchNetworkLimits' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilitySwitchNetworkLimits
