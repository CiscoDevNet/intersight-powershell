...
function ConvertFrom-IntersightJsonToConfigImportedItem {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "IsShared", "IsUpdated", "Item", "Name", "NewMoid", "ServiceVersion", "Status", "StatusMessage", "Importer")
