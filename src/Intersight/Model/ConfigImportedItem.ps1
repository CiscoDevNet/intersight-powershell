...
function ConvertFrom-IntersightJsonToConfigImportedItem {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "IsShared", "IsUpdated", "Item", "Name", "NewMoid", "ServiceVersion", "Status", "StatusMessage", "Importer")
