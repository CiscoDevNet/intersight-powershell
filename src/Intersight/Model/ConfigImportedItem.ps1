...
ConfigImportedItem<PSCustomObject>
#>

function Initialize-IntersightConfigImportedItem {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("config.ImportedItem")]
        [String]
        ${ClassId} = "config.ImportedItem",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("config.ImportedItem")]
        [String]
        ${ObjectType} = "config.ImportedItem",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightConfigImportedItem' | Write-Debug
...
Convert from JSON to ConfigImportedItem<PSCustomObject>
...
ConfigImportedItem<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToConfigImportedItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightConfigImportedItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightConfigImportedItem
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "IsShared", "IsUpdated", "Item", "Name", "NewMoid", "ServiceVersion", "Status", "StatusMessage", "Importer")
