...
StoragePurePortListAllOf<PSCustomObject>
#>

function Initialize-IntersightStoragePurePortListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStoragePurePortListAllOf' | Write-Debug
...
Convert from JSON to StoragePurePortListAllOf<PSCustomObject>
...
StoragePurePortListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStoragePurePortListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStoragePurePortListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStoragePurePortListAllOf
