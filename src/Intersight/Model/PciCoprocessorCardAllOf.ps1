...
PciCoprocessorCardAllOf<PSCustomObject>
#>

function Initialize-IntersightPciCoprocessorCardAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPciCoprocessorCardAllOf' | Write-Debug
...
Convert from JSON to PciCoprocessorCardAllOf<PSCustomObject>
...
PciCoprocessorCardAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPciCoprocessorCardAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPciCoprocessorCardAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPciCoprocessorCardAllOf
        $AllProperties = ("ClassId", "ObjectType", "CardId", "PciSlot", "ComputeBoard", "InventoryDeviceInfo", "RegisteredDevice")
