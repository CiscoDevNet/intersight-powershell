...
StorageSpan<PSCustomObject>
#>

function Initialize-IntersightStorageSpan {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageSpan' | Write-Debug
...
Convert from JSON to StorageSpan<PSCustomObject>
...
StorageSpan<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageSpan {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageSpan' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageSpan
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Slots", "SpanId", "DiskGroup", "PhysicalDisks", "RegisteredDevice")
