...
function ConvertFrom-IntersightJsonToStorageSpan {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Slots", "SpanId", "DiskGroup", "PhysicalDisks", "RegisteredDevice")
