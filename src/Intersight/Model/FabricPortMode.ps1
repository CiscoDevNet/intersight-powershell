...
function ConvertFrom-IntersightJsonToFabricPortMode {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "CustomMode", "PortIdEnd", "PortIdStart", "SlotId", "PortPolicy")
