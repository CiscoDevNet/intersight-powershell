...
StorageItemList<PSCustomObject>
#>

function Initialize-IntersightStorageItemList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageItemList' | Write-Debug
...
Convert from JSON to StorageItemList<PSCustomObject>
...
StorageItemList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageItemList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageItemList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageItemList
