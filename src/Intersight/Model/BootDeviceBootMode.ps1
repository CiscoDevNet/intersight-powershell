...
BootDeviceBootMode<PSCustomObject>
#>

function Initialize-IntersightBootDeviceBootMode {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.DeviceBootMode")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootDeviceBootMode' | Write-Debug
...
Convert from JSON to BootDeviceBootMode<PSCustomObject>
...
BootDeviceBootMode<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootDeviceBootMode {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootDeviceBootMode' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootDeviceBootMode
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "ConfiguredBootMode", "ComputeBlade", "ComputeRackUnit", "InventoryDeviceInfo", "RegisteredDevice")
