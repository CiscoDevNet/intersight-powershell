...
BootSanDevice<PSCustomObject>
#>

function Initialize-IntersightBootSanDevice {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.SanDevice")]
        [String]
        ${ClassId} = "boot.SanDevice",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.SanDevice")]
        [String]
        ${ObjectType} = "boot.SanDevice",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootSanDevice' | Write-Debug
...
Convert from JSON to BootSanDevice<PSCustomObject>
...
BootSanDevice<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootSanDevice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootSanDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootSanDevice
