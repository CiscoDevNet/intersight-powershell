...
IamAccountExperienceList<PSCustomObject>
#>

function Initialize-IntersightIamAccountExperienceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIamAccountExperienceList' | Write-Debug
...
Convert from JSON to IamAccountExperienceList<PSCustomObject>
...
IamAccountExperienceList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIamAccountExperienceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIamAccountExperienceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIamAccountExperienceList
