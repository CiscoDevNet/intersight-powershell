...
SoftwarerepositoryAuthorizationAllOf<PSCustomObject>
#>

function Initialize-IntersightSoftwarerepositoryAuthorizationAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwarerepositoryAuthorizationAllOf' | Write-Debug
...
Convert from JSON to SoftwarerepositoryAuthorizationAllOf<PSCustomObject>
...
SoftwarerepositoryAuthorizationAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwarerepositoryAuthorizationAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSoftwarerepositoryAuthorizationAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSoftwarerepositoryAuthorizationAllOf
        $AllProperties = ("ClassId", "ObjectType", "IsPasswordSet", "IsUserIdSet", "Password", "RepositoryType", "UserId", "Account")
