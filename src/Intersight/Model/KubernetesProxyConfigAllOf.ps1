...
Definition of the list of properties defined in 'kubernetes.ProxyConfig', excluding properties defined in parent classes.
...
KubernetesProxyConfigAllOf<PSCustomObject>
#>

function Initialize-IntersightKubernetesProxyConfigAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("kubernetes.ProxyConfig")]
        [String]
        ${ClassId} = "kubernetes.ProxyConfig",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("kubernetes.ProxyConfig")]
        [String]
        ${ObjectType} = "kubernetes.ProxyConfig",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightKubernetesProxyConfigAllOf' | Write-Debug
...
Convert from JSON to KubernetesProxyConfigAllOf<PSCustomObject>
...
KubernetesProxyConfigAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToKubernetesProxyConfigAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightKubernetesProxyConfigAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightKubernetesProxyConfigAllOf
        $AllProperties = ("ClassId", "ObjectType", "Hostname", "IsPasswordSet", "Password", "Port", "Protocol", "Username")
