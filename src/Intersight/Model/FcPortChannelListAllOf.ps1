...
FcPortChannelListAllOf<PSCustomObject>
#>

function Initialize-IntersightFcPortChannelListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFcPortChannelListAllOf' | Write-Debug
...
Convert from JSON to FcPortChannelListAllOf<PSCustomObject>
...
FcPortChannelListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFcPortChannelListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFcPortChannelListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFcPortChannelListAllOf
