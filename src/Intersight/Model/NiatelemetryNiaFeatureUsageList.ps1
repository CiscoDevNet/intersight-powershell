...
NiatelemetryNiaFeatureUsageList<PSCustomObject>
#>

function Initialize-IntersightNiatelemetryNiaFeatureUsageList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiatelemetryNiaFeatureUsageList' | Write-Debug
...
Convert from JSON to NiatelemetryNiaFeatureUsageList<PSCustomObject>
...
NiatelemetryNiaFeatureUsageList<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiatelemetryNiaFeatureUsageList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiatelemetryNiaFeatureUsageList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiatelemetryNiaFeatureUsageList
