...
HyperflexClusterNetworkPolicyListAllOf<PSCustomObject>
#>

function Initialize-IntersightHyperflexClusterNetworkPolicyListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightHyperflexClusterNetworkPolicyListAllOf' | Write-Debug
...
Convert from JSON to HyperflexClusterNetworkPolicyListAllOf<PSCustomObject>
...
HyperflexClusterNetworkPolicyListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToHyperflexClusterNetworkPolicyListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightHyperflexClusterNetworkPolicyListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightHyperflexClusterNetworkPolicyListAllOf
