...
FirmwareGpuDescriptor<PSCustomObject>
#>

function Initialize-IntersightFirmwareGpuDescriptor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareGpuDescriptor' | Write-Debug
...
Convert from JSON to FirmwareGpuDescriptor<PSCustomObject>
...
FirmwareGpuDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareGpuDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareGpuDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareGpuDescriptor
