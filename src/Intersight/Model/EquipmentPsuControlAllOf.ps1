...
EquipmentPsuControlAllOf<PSCustomObject>
#>

function Initialize-IntersightEquipmentPsuControlAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentPsuControlAllOf' | Write-Debug
...
Convert from JSON to EquipmentPsuControlAllOf<PSCustomObject>
...
EquipmentPsuControlAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentPsuControlAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentPsuControlAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentPsuControlAllOf
        $AllProperties = ("ClassId", "ObjectType", "ClusterState", "InputPowerState", "Name", "OperQualifier", "OperReason", "OperState", "OutputPowerState", "Redundancy", "EquipmentChassis", "InventoryDeviceInfo", "RegisteredDevice")
