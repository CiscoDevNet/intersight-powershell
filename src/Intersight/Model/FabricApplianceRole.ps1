...
FabricApplianceRole<PSCustomObject>
#>

function Initialize-IntersightFabricApplianceRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricApplianceRole' | Write-Debug
...
Convert from JSON to FabricApplianceRole<PSCustomObject>
...
FabricApplianceRole<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricApplianceRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricApplianceRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricApplianceRole
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AggregatePortId", "PortId", "SlotId", "PortPolicy", "AdminSpeed", "Fec", "Mode", "Priority", "EthNetworkControlPolicy", "EthNetworkGroupPolicy")
