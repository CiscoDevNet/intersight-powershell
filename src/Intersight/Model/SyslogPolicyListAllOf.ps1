...
SyslogPolicyListAllOf<PSCustomObject>
#>

function Initialize-IntersightSyslogPolicyListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSyslogPolicyListAllOf' | Write-Debug
...
Convert from JSON to SyslogPolicyListAllOf<PSCustomObject>
...
SyslogPolicyListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSyslogPolicyListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightSyslogPolicyListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightSyslogPolicyListAllOf
