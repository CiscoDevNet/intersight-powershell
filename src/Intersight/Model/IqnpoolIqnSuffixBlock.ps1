...
IqnpoolIqnSuffixBlock<PSCustomObject>
#>

function Initialize-IntersightIqnpoolIqnSuffixBlock {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightIqnpoolIqnSuffixBlock' | Write-Debug
...
Convert from JSON to IqnpoolIqnSuffixBlock<PSCustomObject>
...
IqnpoolIqnSuffixBlock<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToIqnpoolIqnSuffixBlock {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightIqnpoolIqnSuffixBlock' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightIqnpoolIqnSuffixBlock
        $AllProperties = ("ClassId", "ObjectType", "Size", "From", "Suffix", "To")
