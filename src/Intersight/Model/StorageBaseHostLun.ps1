...
StorageBaseHostLun<PSCustomObject>
#>

function Initialize-IntersightStorageBaseHostLun {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiHostLun", "storage.NetAppLunMap", "storage.PureHostLun")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("storage.HitachiHostLun", "storage.NetAppLunMap", "storage.PureHostLun")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightStorageBaseHostLun' | Write-Debug
...
Convert from JSON to StorageBaseHostLun<PSCustomObject>
...
StorageBaseHostLun<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToStorageBaseHostLun {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightStorageBaseHostLun' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightStorageBaseHostLun
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Hlu", "HostName", "VolumeName")
