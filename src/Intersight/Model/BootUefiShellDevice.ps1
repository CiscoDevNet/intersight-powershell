...
BootUefiShellDevice<PSCustomObject>
#>

function Initialize-IntersightBootUefiShellDevice {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("boot.UefiShellDevice")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootUefiShellDevice' | Write-Debug
...
Convert from JSON to BootUefiShellDevice<PSCustomObject>
...
BootUefiShellDevice<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootUefiShellDevice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootUefiShellDevice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootUefiShellDevice
