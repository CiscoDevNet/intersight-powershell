...
TelemetryDruidDimensionTopNMetricSpecAllOf<PSCustomObject>
#>

function Initialize-IntersightTelemetryDruidDimensionTopNMetricSpecAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightTelemetryDruidDimensionTopNMetricSpecAllOf' | Write-Debug
...
Convert from JSON to TelemetryDruidDimensionTopNMetricSpecAllOf<PSCustomObject>
...
TelemetryDruidDimensionTopNMetricSpecAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToTelemetryDruidDimensionTopNMetricSpecAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightTelemetryDruidDimensionTopNMetricSpecAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightTelemetryDruidDimensionTopNMetricSpecAllOf
        $AllProperties = ("ordering", "previousStop")
