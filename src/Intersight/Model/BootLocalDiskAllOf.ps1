...
BootLocalDiskAllOf<PSCustomObject>
#>

function Initialize-IntersightBootLocalDiskAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightBootLocalDiskAllOf' | Write-Debug
...
Convert from JSON to BootLocalDiskAllOf<PSCustomObject>
...
BootLocalDiskAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToBootLocalDiskAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightBootLocalDiskAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightBootLocalDiskAllOf
        $AllProperties = ("ClassId", "ObjectType", "Bootloader", "Slot")
