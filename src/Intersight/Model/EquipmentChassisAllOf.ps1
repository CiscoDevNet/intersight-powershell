...
function ConvertFrom-IntersightJsonToEquipmentChassisAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AlarmSummary", "ChassisId", "ConnectionPath", "ConnectionStatus", "Description", "FaultSummary", "ManagementMode", "Name", "OperState", "PartNumber", "Pid", "PlatformType", "ProductName", "Sku", "Vid", "Blades", "Fanmodules", "InventoryDeviceInfo", "Ioms", "LocatorLed", "PsuControl", "Psus", "RegisteredDevice", "Sasexpanders", "Siocs", "StorageEnclosures", "VirtualDriveContainer")
