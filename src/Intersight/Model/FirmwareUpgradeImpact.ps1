...
FirmwareUpgradeImpact<PSCustomObject>
#>

function Initialize-IntersightFirmwareUpgradeImpact {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareUpgradeImpact' | Write-Debug
...
Convert from JSON to FirmwareUpgradeImpact<PSCustomObject>
...
FirmwareUpgradeImpact<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareUpgradeImpact {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareUpgradeImpact' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareUpgradeImpact
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Components", "ComputationState", "ExcludeComponents", "Impacts", "Summary", "Chassis", "Device", "Distributable", "NetworkElements", "Release", "Server")
