...
function ConvertFrom-IntersightJsonToFirmwareUpgradeImpact {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Components", "ComputationState", "ExcludeComponents", "Impacts", "Summary", "Chassis", "Device", "Distributable", "NetworkElements", "Release", "Server")
