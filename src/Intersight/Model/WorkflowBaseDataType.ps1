...
WorkflowBaseDataType<PSCustomObject>
#>

function Initialize-IntersightWorkflowBaseDataType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowBaseDataType' | Write-Debug
...
Convert from JSON to WorkflowBaseDataType<PSCustomObject>
...
WorkflowBaseDataType<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowBaseDataType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowBaseDataType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowBaseDataType
