...
function ConvertFrom-IntersightJsonToIamLdapPolicyAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "BaseProperties", "DnsParameters", "EnableDns", "Enabled", "UserSearchPrecedence", "_0_Idp", "ApplianceAccount", "Groups", "Organization", "Profiles", "Providers")
