...
ChassisIomProfile<PSCustomObject>
#>

function Initialize-IntersightChassisIomProfile {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("chassis.IomProfile")]
        [String]
        ${ClassId} = "chassis.IomProfile",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("chassis.IomProfile")]
        [String]
        ${ObjectType} = "chassis.IomProfile",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightChassisIomProfile' | Write-Debug
...
Convert from JSON to ChassisIomProfile<PSCustomObject>
...
ChassisIomProfile<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToChassisIomProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightChassisIomProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightChassisIomProfile
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "Type", "SrcTemplate", "Action", "ConfigContext", "ConfigChanges", "IomEntity", "Organization", "Profile")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "IomEntity"))) { #optional property not found
            $IomEntity = $null
        } else {
            $IomEntity = $JsonParameters.PSobject.Properties["IomEntity"].value
        }
