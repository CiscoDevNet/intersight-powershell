...
WorkflowTargetDataTypeAllOf<PSCustomObject>
#>

function Initialize-IntersightWorkflowTargetDataTypeAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightWorkflowTargetDataTypeAllOf' | Write-Debug
...
Convert from JSON to WorkflowTargetDataTypeAllOf<PSCustomObject>
...
WorkflowTargetDataTypeAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToWorkflowTargetDataTypeAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightWorkflowTargetDataTypeAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightWorkflowTargetDataTypeAllOf
        $AllProperties = ("ClassId", "ObjectType", "CustomDataTypeProperties", "IsArray", "Max", "Min", "Properties")
