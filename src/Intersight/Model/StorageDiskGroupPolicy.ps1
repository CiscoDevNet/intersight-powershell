...
function ConvertFrom-IntersightJsonToStorageDiskGroupPolicy {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "DedicatedHotSpares", "RaidLevel", "SpanGroups", "UseJbods", "Organization", "StoragePolicies")
