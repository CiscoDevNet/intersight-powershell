...
function ConvertFrom-IntersightJsonToStorageDiskGroupPolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Description", "Name", "DedicatedHotSpares", "RaidLevel", "SpanGroups", "UseJbods", "Organization", "StoragePolicies")
