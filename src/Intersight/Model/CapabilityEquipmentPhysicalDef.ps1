...
CapabilityEquipmentPhysicalDef<PSCustomObject>
#>

function Initialize-IntersightCapabilityEquipmentPhysicalDef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightCapabilityEquipmentPhysicalDef' | Write-Debug
...
Convert from JSON to CapabilityEquipmentPhysicalDef<PSCustomObject>
...
CapabilityEquipmentPhysicalDef<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToCapabilityEquipmentPhysicalDef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightCapabilityEquipmentPhysicalDef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightCapabilityEquipmentPhysicalDef
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Pid", "Sku", "Vid", "Depth", "Height", "MaxPower", "MinPower", "NominalPower", "Weight", "Width")
