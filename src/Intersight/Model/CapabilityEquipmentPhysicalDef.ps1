...
function ConvertFrom-IntersightJsonToCapabilityEquipmentPhysicalDef {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Section", "Pid", "Sku", "Vid", "Depth", "Height", "MaxPower", "MinPower", "NominalPower", "Weight", "Width")
