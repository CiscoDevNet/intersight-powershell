...
function ConvertFrom-IntersightJsonToCapabilityEquipmentPhysicalDef {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Name", "Pid", "Sku", "Vid", "Depth", "Height", "MaxPower", "MinPower", "NominalPower", "Weight", "Width")
