...
SoftwareHclMeta<PSCustomObject>
#>

function Initialize-IntersightSoftwareHclMeta {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("software.HclMeta")]
        [String]
        ${ClassId} = "software.HclMeta",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("software.HclMeta")]
        [String]
        ${ObjectType} = "software.HclMeta",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightSoftwareHclMeta' | Write-Debug
...
Convert from JSON to SoftwareHclMeta<PSCustomObject>
...
SoftwareHclMeta<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToSoftwareHclMeta {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
