...
function ConvertFrom-IntersightJsonToIppoolIpLeaseAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "IpType", "IpV4Address", "IpV4Config", "IpV6Address", "IpV6Config", "_0_VirtualMachineNodeProfile", "_1_VirtualMachineNodeProfile", "_2_ClusterProfile", "_3_ClusterProfile", "AssignedToEntity", "BlockLease", "Pool", "PoolMember", "Universe", "Vrf")
