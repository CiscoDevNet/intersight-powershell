...
OsDistributionListAllOf<PSCustomObject>
#>

function Initialize-IntersightOsDistributionListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightOsDistributionListAllOf' | Write-Debug
...
Convert from JSON to OsDistributionListAllOf<PSCustomObject>
...
OsDistributionListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToOsDistributionListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightOsDistributionListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightOsDistributionListAllOf
