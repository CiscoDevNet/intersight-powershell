...
ApplianceDeviceCertificate<PSCustomObject>
#>

function Initialize-IntersightApplianceDeviceCertificate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightApplianceDeviceCertificate' | Write-Debug
...
Convert from JSON to ApplianceDeviceCertificate<PSCustomObject>
...
ApplianceDeviceCertificate<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToApplianceDeviceCertificate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightApplianceDeviceCertificate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightApplianceDeviceCertificate
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "CaCertificate", "CaCertificateExpiryTime", "CertificateRenewalExpiryTime", "CompletedPhases", "ConfigurationMoId", "CurrentPhase", "EndTime", "LastSuccessPollTime", "Messages", "StartTime", "Status")
