...
VirtualizationVmwareDatacenterListAllOf<PSCustomObject>
#>

function Initialize-IntersightVirtualizationVmwareDatacenterListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightVirtualizationVmwareDatacenterListAllOf' | Write-Debug
...
Convert from JSON to VirtualizationVmwareDatacenterListAllOf<PSCustomObject>
...
VirtualizationVmwareDatacenterListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToVirtualizationVmwareDatacenterListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightVirtualizationVmwareDatacenterListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightVirtualizationVmwareDatacenterListAllOf
