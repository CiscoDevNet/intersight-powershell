...
NiaapiHardwareEolAllOf<PSCustomObject>
#>

function Initialize-IntersightNiaapiHardwareEolAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiaapiHardwareEolAllOf' | Write-Debug
...
Convert from JSON to NiaapiHardwareEolAllOf<PSCustomObject>
...
NiaapiHardwareEolAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiaapiHardwareEolAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
