...
function ConvertFrom-IntersightJsonToEquipmentSharedIoModule {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ConfigState", "Discovery", "MacOfSharedIomAside", "MacOfSharedIomBside", "OperState", "PartNumber", "Reachability", "UsrLbl", "Vid", "Controller", "EquipmentSystemIoController", "InventoryDeviceInfo", "PortGroups", "RegisteredDevice")
