...
EquipmentSharedIoModule<PSCustomObject>
#>

function Initialize-IntersightEquipmentSharedIoModule {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.SharedIoModule")]
        [String]
        ${ClassId} = "equipment.SharedIoModule",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("equipment.SharedIoModule")]
        [String]
        ${ObjectType} = "equipment.SharedIoModule",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightEquipmentSharedIoModule' | Write-Debug
...
Convert from JSON to EquipmentSharedIoModule<PSCustomObject>
...
EquipmentSharedIoModule<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToEquipmentSharedIoModule {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightEquipmentSharedIoModule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightEquipmentSharedIoModule
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ConfigState", "Discovery", "MacOfSharedIomAside", "MacOfSharedIomBside", "OperState", "PartNumber", "Reachability", "UsrLbl", "Vid", "Controller", "EquipmentSystemIoController", "InventoryDeviceInfo", "PortGroups", "RegisteredDevice")
