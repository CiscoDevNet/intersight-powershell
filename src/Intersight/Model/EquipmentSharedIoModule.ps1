...
function ConvertFrom-IntersightJsonToEquipmentSharedIoModule {
    ...
    Process {
        ...
        $AllProperties = ("AccountMoid", "ClassId", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "ObjectType", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "DeviceMoId", "Dn", "Rn", "Model", "Revision", "Serial", "Vendor", "ConfigState", "Discovery", "MacOfSharedIomAside", "MacOfSharedIomBside", "OperState", "PartNumber", "Reachability", "UsrLbl", "Vid", "Controller", "EquipmentSystemIoController", "InventoryDeviceInfo", "PortGroups", "RegisteredDevice")
