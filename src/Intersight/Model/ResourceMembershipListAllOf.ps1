...
ResourceMembershipListAllOf<PSCustomObject>
#>

function Initialize-IntersightResourceMembershipListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightResourceMembershipListAllOf' | Write-Debug
...
Convert from JSON to ResourceMembershipListAllOf<PSCustomObject>
...
ResourceMembershipListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToResourceMembershipListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightResourceMembershipListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightResourceMembershipListAllOf
