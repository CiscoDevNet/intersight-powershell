...
FcPhysicalPortListAllOf<PSCustomObject>
#>

function Initialize-IntersightFcPhysicalPortListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFcPhysicalPortListAllOf' | Write-Debug
...
Convert from JSON to FcPhysicalPortListAllOf<PSCustomObject>
...
FcPhysicalPortListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFcPhysicalPortListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFcPhysicalPortListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFcPhysicalPortListAllOf
