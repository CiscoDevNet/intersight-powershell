...
PolicyAbstractConfigResult<PSCustomObject>
#>

function Initialize-IntersightPolicyAbstractConfigResult {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("chassis.ConfigResult", "fabric.ConfigResult", "hyperflex.ConfigResult", "recovery.ConfigResult", "server.ConfigResult")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("chassis.ConfigResult", "fabric.ConfigResult", "hyperflex.ConfigResult", "recovery.ConfigResult", "server.ConfigResult")]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightPolicyAbstractConfigResult' | Write-Debug
...
Convert from JSON to PolicyAbstractConfigResult<PSCustomObject>
...
PolicyAbstractConfigResult<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToPolicyAbstractConfigResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightPolicyAbstractConfigResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightPolicyAbstractConfigResult
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ConfigStage", "ConfigState", "ValidationState")
