...
function Initialize-IntersightPolicyAbstractConfigResult {
    ...
    Param (
        ...
        [ValidateSet("fabric.ConfigResult", "hyperflex.ConfigResult", "recovery.ConfigResult", "server.ConfigResult")]
        [String]
        ${ClassId},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.ConfigResult", "hyperflex.ConfigResult", "recovery.ConfigResult", "server.ConfigResult")]
...
function ConvertFrom-IntersightJsonToPolicyAbstractConfigResult {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "ConfigStage", "ConfigState", "ValidationState")
