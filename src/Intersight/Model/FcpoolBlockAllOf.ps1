...
FcpoolBlockAllOf<PSCustomObject>
#>

function Initialize-IntersightFcpoolBlockAllOf {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fcpool.Block")]
        [String]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFcpoolBlockAllOf' | Write-Debug
...
Convert from JSON to FcpoolBlockAllOf<PSCustomObject>
...
FcpoolBlockAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFcpoolBlockAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFcpoolBlockAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFcpoolBlockAllOf
