...
FabricPcOperation<PSCustomObject>
#>

function Initialize-IntersightFabricPcOperation {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.PcOperation")]
        [String]
        ${ClassId} = "fabric.PcOperation",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("fabric.PcOperation")]
        [String]
        ${ObjectType} = "fabric.PcOperation",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFabricPcOperation' | Write-Debug
...
Convert from JSON to FabricPcOperation<PSCustomObject>
...
FabricPcOperation<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFabricPcOperation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFabricPcOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFabricPcOperation
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "AdminState", "PcId", "NetworkElement")
