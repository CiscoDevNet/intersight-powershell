...
function ConvertFrom-IntersightJsonToAdapterHostFcInterfaceAllOf {
    ...
    Process {
        ...
        $AllProperties = ("AdminState", "EpDn", "HostFcInterfaceId", "Name", "OperState", "Operability", "OriginalWwnn", "OriginalWwpn", "PeerDn", "Wwnn", "Wwpn", "AdapterUnit", "InventoryDeviceInfo", "RegisteredDevice")
