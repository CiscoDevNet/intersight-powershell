...
function ConvertFrom-IntersightJsonToCondAlarm {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Acknowledge", "AcknowledgeBy", "AcknowledgeTime", "AffectedMoDisplayName", "AffectedMoId", "AffectedMoType", "AffectedObject", "AncestorMoId", "AncestorMoType", "Code", "CreationTime", "Description", "LastTransitionTime", "MsAffectedObject", "Name", "OrigSeverity", "Severity", "AffectedMo", "RegisteredDevice")
