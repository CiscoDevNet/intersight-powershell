...
MacpoolPoolMemberListAllOf<PSCustomObject>
#>

function Initialize-IntersightMacpoolPoolMemberListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightMacpoolPoolMemberListAllOf' | Write-Debug
...
Convert from JSON to MacpoolPoolMemberListAllOf<PSCustomObject>
...
MacpoolPoolMemberListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToMacpoolPoolMemberListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightMacpoolPoolMemberListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightMacpoolPoolMemberListAllOf
