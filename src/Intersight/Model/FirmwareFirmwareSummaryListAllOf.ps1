...
FirmwareFirmwareSummaryListAllOf<PSCustomObject>
#>

function Initialize-IntersightFirmwareFirmwareSummaryListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareFirmwareSummaryListAllOf' | Write-Debug
...
Convert from JSON to FirmwareFirmwareSummaryListAllOf<PSCustomObject>
...
FirmwareFirmwareSummaryListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareFirmwareSummaryListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareFirmwareSummaryListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareFirmwareSummaryListAllOf
