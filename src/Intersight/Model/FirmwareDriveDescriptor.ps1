...
FirmwareDriveDescriptor<PSCustomObject>
#>

function Initialize-IntersightFirmwareDriveDescriptor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightFirmwareDriveDescriptor' | Write-Debug
...
Convert from JSON to FirmwareDriveDescriptor<PSCustomObject>
...
FirmwareDriveDescriptor<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToFirmwareDriveDescriptor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightFirmwareDriveDescriptor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightFirmwareDriveDescriptor
