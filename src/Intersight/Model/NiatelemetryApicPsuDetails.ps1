...
NiatelemetryApicPsuDetails<PSCustomObject>
#>

function Initialize-IntersightNiatelemetryApicPsuDetails {
    [CmdletBinding()]
    Param (
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("niatelemetry.ApicPsuDetails")]
        [String]
        ${ClassId} = "niatelemetry.ApicPsuDetails",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("niatelemetry.ApicPsuDetails")]
        [String]
        ${ObjectType} = "niatelemetry.ApicPsuDetails",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
        ${Moid},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightNiatelemetryApicPsuDetails' | Write-Debug
...
Convert from JSON to NiatelemetryApicPsuDetails<PSCustomObject>
...
NiatelemetryApicPsuDetails<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToNiatelemetryApicPsuDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightNiatelemetryApicPsuDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightNiatelemetryApicPsuDetails
