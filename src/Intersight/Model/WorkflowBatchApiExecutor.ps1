...
function ConvertFrom-IntersightJsonToWorkflowBatchApiExecutor {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Batch", "Constraints", "Description", "Name", "Outcomes", "Output", "RetryFromFailedApi", "SkipOnCondition", "ErrorResponseHandler", "TaskDefinition")
