...
function Initialize-IntersightWorkflowBatchApiExecutor {
    ...
    Process {
        ...
        if (!$Batch -and $Batch.length -lt 1) {
            throw "invalid value for 'Batch', number of items must be greater than or equal to 1."
        }
...
function ConvertFrom-IntersightJsonToWorkflowBatchApiExecutor {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Batch", "Constraints", "Description", "Name", "Outcomes", "Output", "RetryFromFailedApi", "SkipOnCondition", "ErrorResponseHandler", "TaskDefinition")
