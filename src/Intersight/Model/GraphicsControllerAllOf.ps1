...
GraphicsControllerAllOf<PSCustomObject>
#>

function Initialize-IntersightGraphicsControllerAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightGraphicsControllerAllOf' | Write-Debug
...
Convert from JSON to GraphicsControllerAllOf<PSCustomObject>
...
GraphicsControllerAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToGraphicsControllerAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightGraphicsControllerAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightGraphicsControllerAllOf
        $AllProperties = ("ClassId", "ObjectType", "ControllerId", "PciAddr", "PciSlot", "GraphicsCard", "InventoryDeviceInfo", "RegisteredDevice")
