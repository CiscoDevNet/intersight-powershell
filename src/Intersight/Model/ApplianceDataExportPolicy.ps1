...
function Initialize-IntersightApplianceDataExportPolicy {
    ...
    Param (
        ...
        [ValidateSet("appliance.DataExportPolicy")]
        [String]
...
function ConvertFrom-IntersightJsonToApplianceDataExportPolicy {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "AccountMoid", "CreateTime", "DomainGroupMoid", "ModTime", "Moid", "Owners", "SharedScope", "Tags", "VersionContext", "_0_ClusterReplicationNetworkPolicy", "Ancestors", "Parent", "PermissionResources", "DisplayNames", "Enable", "Name", "Account", "ParentConfig", "SubConfigs")
