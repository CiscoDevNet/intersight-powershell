...
function ConvertFrom-IntersightJsonToEquipmentSwitchCardAllOf {
    ...
    Process {
        ...
        $AllProperties = ("ClassId", "ObjectType", "Description", "EthernetSwitchingMode", "FcSwitchingMode", "NumPorts", "OutOfBandIpAddress", "OutOfBandIpGateway", "Presence", "SlotId", "State", "SwitchId", "FcPortChannels", "InventoryDeviceInfo", "NetworkElement", "PortChannels", "PortGroups", "RegisteredDevice")
