...
ComputeBoardListAllOf<PSCustomObject>
#>

function Initialize-IntersightComputeBoardListAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Intersight => IntersightComputeBoardListAllOf' | Write-Debug
...
Convert from JSON to ComputeBoardListAllOf<PSCustomObject>
...
ComputeBoardListAllOf<PSCustomObject>
#>
function ConvertFrom-IntersightJsonToComputeBoardListAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Intersight => IntersightComputeBoardListAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntersightComputeBoardListAllOf
