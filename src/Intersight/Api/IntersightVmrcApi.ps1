...
VmrcConsole
#>
function New-IntersightVmrcConsole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-IntersightVmrcConsole' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/vmrc/Consoles'
        ...
        if (!$VmrcConsole) {
            throw "Error! The required parameter `VmrcConsole` missing when calling createVmrcConsole."
        }

        $LocalVarBodyParameter = $VmrcConsole | ConvertTo-Json -Depth 100
...
Delete a 'vmrc.Console' resource.
...
None
#>
function Remove-IntersightVmrcConsole {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-IntersightVmrcConsole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/vmrc/Consoles/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling deleteVmrcConsole."
        }
...
VmrcConsole
#>
function Get-IntersightVmrcConsoleByMoid {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightVmrcConsoleByMoid' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/vmrc/Consoles/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getVmrcConsoleByMoid."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
...
VmrcConsoleResponse
#>
function Get-IntersightVmrcConsoleList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightVmrcConsoleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "VmrcConsoleResponse" `
                                -IsBodyNullable $false

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToVmrcConsoleResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
