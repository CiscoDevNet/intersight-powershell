...
SshPolicy
#>
function New-IntersightSshPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-IntersightSshPolicy' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/ssh/Policies'
        ...
        if (!$SshPolicy) {
            throw "Error! The required parameter `SshPolicy` missing when calling createSshPolicy."
        }

        $LocalVarBodyParameter = $SshPolicy | ConvertTo-Json -Depth 100
...
None
#>
function Remove-IntersightSshPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-IntersightSshPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/ssh/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling deleteSshPolicy."
        }
...
SshPolicy
#>
function Get-IntersightSshPolicyByMoid {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightSshPolicyByMoid' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/ssh/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getSshPolicyByMoid."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
...
SshPolicyResponse
#>
function Get-IntersightSshPolicyList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightSshPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "SshPolicyResponse"

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToSshPolicyResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
...
SshPolicy
#>
function Set-IntersightSshPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-IntersightSshPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/ssh/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling patchSshPolicy."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$SshPolicy) {
            throw "Error! The required parameter `SshPolicy` missing when calling patchSshPolicy."
        }
...
SshPolicy
#>
function Update-IntersightSshPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-IntersightSshPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/ssh/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling updateSshPolicy."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$SshPolicy) {
            throw "Error! The required parameter `SshPolicy` missing when calling updateSshPolicy."
        }
