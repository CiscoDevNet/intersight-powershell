...
SolPolicy
#>
function New-IntersightSolPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-IntersightSolPolicy' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/sol/Policies'
        ...
        if (!$SolPolicy) {
            throw "Error! The required parameter `SolPolicy` missing when calling createSolPolicy."
        }

        $LocalVarBodyParameter = $SolPolicy | ConvertTo-Json -Depth 100
...
None
#>
function Remove-IntersightSolPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-IntersightSolPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/sol/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling deleteSolPolicy."
        }
...
SolPolicy
#>
function Get-IntersightSolPolicyByMoid {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightSolPolicyByMoid' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/sol/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getSolPolicyByMoid."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
...
SolPolicyResponse
#>
function Get-IntersightSolPolicyList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightSolPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "SolPolicyResponse" `
                                -IsBodyNullable $false

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToSolPolicyResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
...
SolPolicy
#>
function Set-IntersightSolPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-IntersightSolPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/sol/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling patchSolPolicy."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$SolPolicy) {
            throw "Error! The required parameter `SolPolicy` missing when calling patchSolPolicy."
        }
...
SolPolicy
#>
function Update-IntersightSolPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-IntersightSolPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/sol/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling updateSolPolicy."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$SolPolicy) {
            throw "Error! The required parameter `SolPolicy` missing when calling updateSolPolicy."
        }
