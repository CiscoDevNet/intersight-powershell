...
TopSystem
#>
function Get-IntersightTopSystemByMoid {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-IntersightTopSystemByMoid' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/top/Systems/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getTopSystemByMoid."
        }
...
TopSystemResponse
#>
function Get-IntersightTopSystemList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightTopSystemList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/top/Systems'
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "TopSystemResponse" `
                                -IsBodyNullable $false

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToTopSystemResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
...
TopSystem
#>
function Set-IntersightTopSystem {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-IntersightTopSystem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/top/Systems/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling patchTopSystem."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$TopSystem) {
            throw "Error! The required parameter `TopSystem` missing when calling patchTopSystem."
        }

        $LocalVarBodyParameter = $TopSystem | ConvertTo-Json -Depth 100
...
TopSystem
#>
function Update-IntersightTopSystem {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-IntersightTopSystem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/top/Systems/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling updateTopSystem."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$TopSystem) {
            throw "Error! The required parameter `TopSystem` missing when calling updateTopSystem."
        }
