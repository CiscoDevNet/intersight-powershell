...
SdcardPolicy
#>
function New-IntersightSdcardPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-IntersightSdcardPolicy' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/sdcard/Policies'
        ...
        if (!$SdcardPolicy) {
            throw "Error! The required parameter `SdcardPolicy` missing when calling createSdcardPolicy."
        }

        $LocalVarBodyParameter = $SdcardPolicy | ConvertTo-Json -Depth 100
...
None
#>
function Remove-IntersightSdcardPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-IntersightSdcardPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/sdcard/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling deleteSdcardPolicy."
        }
...
SdcardPolicy
#>
function Get-IntersightSdcardPolicyByMoid {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightSdcardPolicyByMoid' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/sdcard/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getSdcardPolicyByMoid."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
...
#>
function Get-IntersightSdcardPolicyList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightSdcardPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "SdcardPolicyResponse" `
                                -IsBodyNullable $false

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToSdcardPolicyResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
...
SdcardPolicy
#>
function Set-IntersightSdcardPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-IntersightSdcardPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/sdcard/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling patchSdcardPolicy."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$SdcardPolicy) {
            throw "Error! The required parameter `SdcardPolicy` missing when calling patchSdcardPolicy."
        }
...
SdcardPolicy
#>
function Update-IntersightSdcardPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-IntersightSdcardPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/sdcard/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling updateSdcardPolicy."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$SdcardPolicy) {
            throw "Error! The required parameter `SdcardPolicy` missing when calling updateSdcardPolicy."
        }
