...
ProcessorUnit
#>
function Get-IntersightProcessorUnitByMoid {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-IntersightProcessorUnitByMoid' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/processor/Units/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getProcessorUnitByMoid."
        }
...
#>
function Get-IntersightProcessorUnitList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightProcessorUnitList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/processor/Units'
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "ProcessorUnitResponse" `
                                -IsBodyNullable $false

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToProcessorUnitResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
...
ProcessorUnit
#>
function Set-IntersightProcessorUnit {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-IntersightProcessorUnit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/processor/Units/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling patchProcessorUnit."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$ProcessorUnit) {
            throw "Error! The required parameter `ProcessorUnit` missing when calling patchProcessorUnit."
        }

        $LocalVarBodyParameter = $ProcessorUnit | ConvertTo-Json -Depth 100
...
ProcessorUnit
#>
function Update-IntersightProcessorUnit {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-IntersightProcessorUnit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/processor/Units/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling updateProcessorUnit."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$ProcessorUnit) {
            throw "Error! The required parameter `ProcessorUnit` missing when calling updateProcessorUnit."
        }
