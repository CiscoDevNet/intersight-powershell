...
#>
function Get-IntersightBootDeviceBootSecurityByMoid {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightBootDeviceBootSecurityByMoid' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/boot/DeviceBootSecurities/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getBootDeviceBootSecurityByMoid."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "BootDeviceBootSecurity" `
                                -IsBodyNullable $false
...
#>
function Get-IntersightBootDeviceBootSecurityList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightBootDeviceBootSecurityList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/boot/DeviceBootSecurities'
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "BootDeviceBootSecurityResponse" `
                                -IsBodyNullable $false

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToBootDeviceBootSecurityResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
...
BootDeviceBootSecurity
#>
function Set-IntersightBootDeviceBootSecurity {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-IntersightBootDeviceBootSecurity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/boot/DeviceBootSecurities/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling patchBootDeviceBootSecurity."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$BootDeviceBootSecurity) {
            throw "Error! The required parameter `BootDeviceBootSecurity` missing when calling patchBootDeviceBootSecurity."
        }

        $LocalVarBodyParameter = $BootDeviceBootSecurity | ConvertTo-Json -Depth 100
...
BootDeviceBootSecurity
#>
function Update-IntersightBootDeviceBootSecurity {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-IntersightBootDeviceBootSecurity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/boot/DeviceBootSecurities/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling updateBootDeviceBootSecurity."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$BootDeviceBootSecurity) {
            throw "Error! The required parameter `BootDeviceBootSecurity` missing when calling updateBootDeviceBootSecurity."
        }
