...
function New-IntersightVrfVrf {
    ...
    Process {
        'Calling method: New-IntersightVrfVrf' | Write-Debug
        ...
        if (!$VrfVrf) {
            throw "Error! The required parameter `VrfVrf` missing when calling createVrfVrf."
        }

        $LocalVarBodyParameter = $VrfVrf | ConvertTo-Json -Depth 100
...
None
#>
function Remove-IntersightVrfVrf {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-IntersightVrfVrf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/vrf/Vrves/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling deleteVrfVrf."
        }
...
VrfVrf
#>
function Get-IntersightVrfVrfByMoid {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightVrfVrfByMoid' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/vrf/Vrves/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getVrfVrfByMoid."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
...
VrfVrfResponse
#>
function Get-IntersightVrfVrfList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightVrfVrfList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "VrfVrfResponse" `
                                -IsBodyNullable $false

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToVrfVrfResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
...
function Set-IntersightVrfVrf {
    ...
    Process {
        'Calling method: Set-IntersightVrfVrf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/vrf/Vrves/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling patchVrfVrf."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$VrfVrf) {
            throw "Error! The required parameter `VrfVrf` missing when calling patchVrfVrf."
        }
...
VrfVrf
#>
function Update-IntersightVrfVrf {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-IntersightVrfVrf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/vrf/Vrves/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling updateVrfVrf."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$VrfVrf) {
            throw "Error! The required parameter `VrfVrf` missing when calling updateVrfVrf."
        }
