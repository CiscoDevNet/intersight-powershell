...
LsServiceProfile
#>
function Get-IntersightLsServiceProfileByMoid {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-IntersightLsServiceProfileByMoid' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/ls/ServiceProfiles/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getLsServiceProfileByMoid."
        }
...
#>
function Get-IntersightLsServiceProfileList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightLsServiceProfileList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/ls/ServiceProfiles'
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "LsServiceProfileResponse" `
                                -IsBodyNullable $false

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToLsServiceProfileResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
...
LsServiceProfile
#>
function Set-IntersightLsServiceProfile {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-IntersightLsServiceProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/ls/ServiceProfiles/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling patchLsServiceProfile."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$LsServiceProfile) {
            throw "Error! The required parameter `LsServiceProfile` missing when calling patchLsServiceProfile."
        }

        $LocalVarBodyParameter = $LsServiceProfile | ConvertTo-Json -Depth 100
...
LsServiceProfile
#>
function Update-IntersightLsServiceProfile {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-IntersightLsServiceProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/ls/ServiceProfiles/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling updateLsServiceProfile."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$LsServiceProfile) {
            throw "Error! The required parameter `LsServiceProfile` missing when calling updateLsServiceProfile."
        }
