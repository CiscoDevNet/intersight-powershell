...
#>
function Get-IntersightIwotenantTenantStatusByMoid {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-IntersightIwotenantTenantStatusByMoid' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/iwotenant/TenantStatuses/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getIwotenantTenantStatusByMoid."
        }
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -ReturnType "IwotenantTenantStatus" `
...
#>
function Get-IntersightIwotenantTenantStatusList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightIwotenantTenantStatusList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/iwotenant/TenantStatuses'
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "IwotenantTenantStatusResponse" `
                                -IsBodyNullable $false

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToIwotenantTenantStatusResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
