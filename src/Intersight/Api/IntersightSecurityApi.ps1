...
SecurityUnit
#>
function Get-IntersightSecurityUnitByMoid {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-IntersightSecurityUnitByMoid' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/security/Units/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getSecurityUnitByMoid."
        }
...
#>
function Get-IntersightSecurityUnitList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightSecurityUnitList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/security/Units'
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "SecurityUnitResponse" `
                                -IsBodyNullable $false

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToSecurityUnitResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
...
SecurityUnit
#>
function Set-IntersightSecurityUnit {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-IntersightSecurityUnit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/security/Units/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling patchSecurityUnit."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$SecurityUnit) {
            throw "Error! The required parameter `SecurityUnit` missing when calling patchSecurityUnit."
        }

        $LocalVarBodyParameter = $SecurityUnit | ConvertTo-Json -Depth 100
...
SecurityUnit
#>
function Update-IntersightSecurityUnit {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-IntersightSecurityUnit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/security/Units/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling updateSecurityUnit."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$SecurityUnit) {
            throw "Error! The required parameter `SecurityUnit` missing when calling updateSecurityUnit."
        }
