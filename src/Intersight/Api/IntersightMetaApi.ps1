...
None
#>
function Remove-IntersightMetaDefinition {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Remove-IntersightMetaDefinition' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/meta/Definitions/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling deleteMetaDefinition."
        }
...
MetaDefinition
#>
function Get-IntersightMetaDefinitionByMoid {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightMetaDefinitionByMoid' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/meta/Definitions/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getMetaDefinitionByMoid."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
...
#>
function Get-IntersightMetaDefinitionList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightMetaDefinitionList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/meta/Definitions'
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "MetaDefinitionResponse"

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToMetaDefinitionResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
