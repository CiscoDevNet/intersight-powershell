...
None
#>
function Remove-IntersightUcsdBackupInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Remove-IntersightUcsdBackupInfo' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/ucsd/BackupInfos/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling deleteUcsdBackupInfo."
        }
...
UcsdBackupInfo
#>
function Get-IntersightUcsdBackupInfoByMoid {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightUcsdBackupInfoByMoid' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/ucsd/BackupInfos/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getUcsdBackupInfoByMoid."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
...
#>
function Get-IntersightUcsdBackupInfoList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightUcsdBackupInfoList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/ucsd/BackupInfos'
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "UcsdBackupInfoResponse"

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToUcsdBackupInfoResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
