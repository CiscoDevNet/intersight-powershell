...
AaaAuditRecord
#>
function Get-IntersightAaaAuditRecordByMoid {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-IntersightAaaAuditRecordByMoid' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/aaa/AuditRecords/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getAaaAuditRecordByMoid."
        }
...
#>
function Get-IntersightAaaAuditRecordList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightAaaAuditRecordList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/aaa/AuditRecords'
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "AaaAuditRecordResponse" `
                                -IsBodyNullable $false

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToAaaAuditRecordResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
