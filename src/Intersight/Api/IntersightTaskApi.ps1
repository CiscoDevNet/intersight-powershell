...
.PARAMETER TaskHitachiScopedInventory
...
#>
function New-IntersightTaskHitachiScopedInventory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-IntersightTaskHitachiScopedInventory' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/task/HitachiScopedInventories'
        ...
        if (!$TaskHitachiScopedInventory) {
            throw "Error! The required parameter `TaskHitachiScopedInventory` missing when calling createTaskHitachiScopedInventory."
        }

        $LocalVarBodyParameter = $TaskHitachiScopedInventory | ConvertTo-Json -Depth 100
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'POST' `
                                ...
                                -ReturnType "TaskHitachiScopedInventory" `
...
.PARAMETER TaskNetAppScopedInventory
...
#>
function New-IntersightTaskNetAppScopedInventory {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: New-IntersightTaskNetAppScopedInventory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/task/NetAppScopedInventories'
        ...
        if (!$TaskNetAppScopedInventory) {
            throw "Error! The required parameter `TaskNetAppScopedInventory` missing when calling createTaskNetAppScopedInventory."
        }

        $LocalVarBodyParameter = $TaskNetAppScopedInventory | ConvertTo-Json -Depth 100
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'POST' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "TaskNetAppScopedInventory" `
                                -IsBodyNullable $false
