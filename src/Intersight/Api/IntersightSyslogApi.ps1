...
SyslogPolicy
#>
function New-IntersightSyslogPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-IntersightSyslogPolicy' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/syslog/Policies'
        ...
        if (!$SyslogPolicy) {
            throw "Error! The required parameter `SyslogPolicy` missing when calling createSyslogPolicy."
        }

        $LocalVarBodyParameter = $SyslogPolicy | ConvertTo-Json -Depth 100
...
None
#>
function Remove-IntersightSyslogPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-IntersightSyslogPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/syslog/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling deleteSyslogPolicy."
        }
...
SyslogPolicy
#>
function Get-IntersightSyslogPolicyByMoid {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightSyslogPolicyByMoid' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/syslog/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getSyslogPolicyByMoid."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
...
#>
function Get-IntersightSyslogPolicyList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightSyslogPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "SyslogPolicyResponse" `
                                -IsBodyNullable $false

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToSyslogPolicyResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
...
SyslogPolicy
#>
function Set-IntersightSyslogPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-IntersightSyslogPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/syslog/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling patchSyslogPolicy."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$SyslogPolicy) {
            throw "Error! The required parameter `SyslogPolicy` missing when calling patchSyslogPolicy."
        }
...
SyslogPolicy
#>
function Update-IntersightSyslogPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-IntersightSyslogPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/syslog/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling updateSyslogPolicy."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$SyslogPolicy) {
            throw "Error! The required parameter `SyslogPolicy` missing when calling updateSyslogPolicy."
        }
