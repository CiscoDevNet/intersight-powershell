...
SmtpPolicy
#>
function New-IntersightSmtpPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-IntersightSmtpPolicy' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/smtp/Policies'
        ...
        if (!$SmtpPolicy) {
            throw "Error! The required parameter `SmtpPolicy` missing when calling createSmtpPolicy."
        }

        $LocalVarBodyParameter = $SmtpPolicy | ConvertTo-Json -Depth 100
...
None
#>
function Remove-IntersightSmtpPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-IntersightSmtpPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/smtp/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling deleteSmtpPolicy."
        }
...
SmtpPolicy
#>
function Get-IntersightSmtpPolicyByMoid {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightSmtpPolicyByMoid' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/smtp/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getSmtpPolicyByMoid."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
...
SmtpPolicyResponse
#>
function Get-IntersightSmtpPolicyList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightSmtpPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "SmtpPolicyResponse"

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToSmtpPolicyResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
...
SmtpPolicy
#>
function Set-IntersightSmtpPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-IntersightSmtpPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/smtp/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling patchSmtpPolicy."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$SmtpPolicy) {
            throw "Error! The required parameter `SmtpPolicy` missing when calling patchSmtpPolicy."
        }
...
SmtpPolicy
#>
function Update-IntersightSmtpPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-IntersightSmtpPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/smtp/Policies/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling updateSmtpPolicy."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        if (!$SmtpPolicy) {
            throw "Error! The required parameter `SmtpPolicy` missing when calling updateSmtpPolicy."
        }
