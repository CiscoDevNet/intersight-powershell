...
#>
function Get-IntersightNiaapiNibFileDownloaderByMoid {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightNiaapiNibFileDownloaderByMoid' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/niaapi/NibFileDownloaders/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getNiaapiNibFileDownloaderByMoid."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "NiaapiNibFileDownloader" `
                                -IsBodyNullable $false
...
#>
function Get-IntersightNiaapiNibFileDownloaderList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightNiaapiNibFileDownloaderList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/niaapi/NibFileDownloaders'
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "NiaapiNibFileDownloaderResponse" `
                                -IsBodyNullable $false

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToNiaapiNibFileDownloaderResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
...
NiaapiNibMetadata
#>
function Get-IntersightNiaapiNibMetadataByMoid {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightNiaapiNibMetadataByMoid' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/niaapi/NibMetadata/{Moid}'
        if (!$Moid) {
            throw "Error! The required parameter `Moid` missing when calling getNiaapiNibMetadataByMoid."
        }
        $LocalVarUri = $LocalVarUri.replace('{Moid}', $Moid)
...
#>
function Get-IntersightNiaapiNibMetadataList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-IntersightNiaapiNibMetadataList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/niaapi/NibMetadata'
        ...
        $LocalVarResult = Invoke-IntersightApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "NiaapiNibMetadataResponse" `
                                -IsBodyNullable $false

        # process oneOf response
        $LocalVarResult["Response"] = ConvertFrom-IntersightJsonToNiaapiNibMetadataResponse (ConvertTo-Json $LocalVarResult["Response"] -Depth 100)
