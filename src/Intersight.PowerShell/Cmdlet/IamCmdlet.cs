...
namespace Intersight.PowerShell
{
    ...
    public class GetIntersightIamAccount : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"External identifier for the account, used for integration with external identity systems."</para>
        /// </summary>
        ...
        // <summary>
        /// <para type="description">"A reference to a iamResourceLimits resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public IamResourceLimitsRelationship ResourceLimits
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"A reference to a iamSecurityHolder resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public IamSecurityHolderRelationship SecurityHolder
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Indicates if the account is prone to lockout as it has only a single Account Administrator. \nAn account is prone to lockout if it has only one configured Account Administrator and no user groups configured that \ncan grant Account Administrator role to dynamic users."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public bool SingleAdminLockout
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Status of the account. To activate the Intersight account, claim a device to the account."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamApiKey : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"The IP address from which the API key was last used."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The time at which the API key was last used. It is updated every 24 hours."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The current status of the API key that dictates the validity of the key.\n* `enabled` - An API key/App Registration having enabled status can be used for API invocation.\n* `disabled` - An API key/App Registration having disabled status cannot be used for API invocation.\n* `expired` - An API key/App Registration having expired status cannot be used for API invocation as the expiration date has passed."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public IamApiKey.OperStatusEnum OperStatus
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamAppRegistration : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"A reference to a iamAbstractClientApplication resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public IamAbstractClientApplicationRelationship ClientApplication
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"A unique identifier for the OAuth2 client application.\nThe client ID is auto-generated when the AppRegistration object is created."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"EntityId holds the Id of the client application that is using this AppRegistration."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The ip address from which the App Registration was last used."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The time at which the App Registration was last used. It is updated every 24 hours."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The current status of the App Registration that dictates the validity of the app.\n* `enabled` - An API key/App Registration having enabled status can be used for API invocation.\n* `disabled` - An API key/App Registration having disabled status cannot be used for API invocation.\n* `expired` - An API key/App Registration having expired status cannot be used for API invocation as the expiration date has passed."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public IamAppRegistration.OperStatusEnum OperStatus
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"The timestamp at which an expiry date was first set on this app registration. \nFor expiring App Registrations, this field is same as the create time of the App Registration.\nFor never-expiring App Registrations, this field is set initially to zero time value. If a never-expiry App Registration is later changed to have an expiration, the timestamp marking the start of this transition is recorded in this field."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Defines the expiry time of the token generated via the AppRegistration.\n* `generic` - This sets the expiryTime to ten minutes from the token issuing time.\n* `longLived` - This sets the expiryTime to an year from the token issuing time.\n* `infinite` - This allows for a never-expiring token. Use with caution."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public IamAppRegistration.TokenExpiryEnum TokenExpiry
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamCertificate : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Status of the certificate.\n* `PendingValidation` - The certificate has not been validated.\n* `Valid` - The certificate is valid.\n* `Invalid` - Ther certificate is invalid."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public IamCertificate.StatusEnum Status
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamCertificateRequest : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Generated certificate signing request (CSR) in PEM format."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get IamCuiIntegration.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightIamCuiIntegration", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightIamCuiIntegration : GetCmdletBase
    {
        public GetIntersightIamCuiIntegration()
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamCuiIntegrationListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"CCC inventory synchronization setting.\n* `enable` - Cisco Cloud Control inventory synchronization is enabled.\n* `disable` - Cisco Cloud Control inventory synchronization is disabled."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public IamCuiIntegration.CiscoCloudControlInventorySyncEnum CiscoCloudControlInventorySync
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"The last-modified timestamp of the tenant as returned by the remote API during the most recent workflow-based synchronization."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The modified-time carried by the most recent notification applied to this CUI integration MO, used to detect and skip stale or duplicate notifications."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public DateTime LastNotificationModifiedTime
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Timestamp representing when the customer opted in to CUI identity synchronization."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Identity or name of the engineer who performed the opt-in action."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public string OptInUserIdentity
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Current synchronization status of CUI integration data.\n* `Needs-Sync` - CUI integration data needs to be synchronized.\n* `InProgress` - CUI integration synchronization is in progress.\n* `Done` - CUI integration synchronization is completed."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public IamCuiIntegration.SyncStatusEnum SyncStatus
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Primary tenant ID for CUI integration."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamDefaultAuthentication : GetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamDefaultAuthenticationListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"The default authentication method used to login into Intersight.\n* `Local` - Local authentication uses credentials stored within the Intersight platform for user access.\n* `SSO` - SSO authentication uses an external identity provider for user access.\n* `LDAP` - LDAP authentication uses external LDAP servers for user access."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public IamDefaultAuthentication.DefaultAuthenticationMethodEnum DefaultAuthenticationMethod
        {
            get;
            set;
        }
        ...
        public IamIdpRelationship LdapDomain
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamDomainGroup : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"The name of the domain-group."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = false, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The partition number domain group related messages are produced for 'Partition1' category service topics."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public long Partition1
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"In a cloud environment this parameter will indicate to which partition number domain group related messages are produced for 'Partition2' category service topics."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public long Partition2
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"In a cloud environment this parameter will indicate to which partition number domain group related messages are produced for 'Partition3' category service topics."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public long Partition3
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Partition key used for producing messages to Kafka partitions. By default Domain-group id will be used as partition key. For Domain-groups belonging to Early adopters domain-group id will be prefixed with 'H' and used as partition key, such partition key will be treated differently and messages will always be produced to partition 0."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The number of devices in the domain-group.\nDevice registration notifications are processed to update the usage of the domain-group. The on-boarding account will have multiple domain-groups, and during the device registration least used domain-group will be selected for the device."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamDomainNameInfo : GetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamDomainNameInfoListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"Expiration time of TXT Record."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public DateTime RecordExpiryTime
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Status of Domain Ownership Verification.\n* `Pending` - Domain verification is pending.\n* `Failed` - Domain verification failed. Re-generate token and verify.\n* `Verified` - Domain verification succeeded.\n* `Expired` - TXT Record for Domain verification expired."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public IamDomainNameInfo.StatusEnum Status
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Resource record used to verify Domain Ownership. Users need to verify the domain by adding the TXT Record in their DNS Host."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamEndPointPrivilege : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"The functionality of this privilege."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = false, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The name of the end point privilege."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = false, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamEndPointRole : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"The name of the end point role."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = false, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"User specified tags to roles like as ep-admin or ep-readonly."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        public IamEndPointRole.TypeEnum Type
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamEndPointUserInventory : GetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamEndPointUserInventoryListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"UserId for the end point user."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamEndPointUserPolicyInventory : GetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamEndPointUserPolicyInventoryListWithHttpInfo";
        }
        ...
        public IamEndPointUserPolicyInventory.AccountUnlockModeEnum AccountUnlockMode
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamEndPointUserRole : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Allows to choose custom account types for the endpoint user."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public bool AccountTypeUserDefined
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Denotes whether password has changed."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamEndPointUserRoleInventory : GetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamEndPointUserRoleInventoryListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"A reference to a iamEndPointUserInventory resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public IamEndPointUserInventoryRelationship EndPointUser
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"A reference to a iamEndPointUserPolicyInventory resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public IamEndPointUserPolicyInventoryRelationship EndPointUserPolicy
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamGuestAccessSettings : GetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamGuestAccessSettingsListWithHttpInfo";
        }
    ...
    public class GetIntersightIamIdp : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"The Entity ID of the IdP. In SAML, the entity ID uniquely identifies the IdP or Service Provider."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"A reference to a iamLdapMeta resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public IamLdapMetaRelationship LdapMeta
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"A reference to a iamTestIdpConfiguration resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public IamTestIdpConfigurationRelationship TestIdp
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamIdpReference : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Entity ID of the IdP. In SAML, the entity ID uniquely identifies the IdP/Service Provider."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Cisco IdP reference in an account."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = false, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamIpAccessManagement : GetCmdletBase
    {
        ...
        public IamSecurityHolderRelationship Holder
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"The access to account gets locked out if wrong IP addresses are configured. Account Administrators have privilege to unblock the account. It stores the time when the account was last recovered from lock out."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamIpAddress : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"A reference to a iamIpAccessManagement resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public IamIpAccessManagementRelationship IpAccessManagement
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamLdapConfigParams : GetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamLdapConfigParamsListWithHttpInfo";
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get IamLdapGroupInventory.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightIamLdapGroupInventory", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightIamLdapGroupInventory : GetCmdletBase
    {
        public GetIntersightIamLdapGroupInventory()
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamLdapGroupInventoryListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"A reference to a iamLdapPolicyInventory resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public IamLdapPolicyInventoryRelationship LdapPolicy
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamLdapMeta : GetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamLdapMetaListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"The domain of the Ldap IdP corresponding to the appliance Ldap configuration."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get IamLdapPolicyInventory.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightIamLdapPolicyInventory", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightIamLdapPolicyInventory : GetCmdletBase
    {
        public GetIntersightIamLdapPolicyInventory()
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamLdapPolicyInventoryListWithHttpInfo";
        }
        ...
        public IamLdapPolicyInventory.UserSearchPrecedenceEnum UserSearchPrecedence
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get IamLdapProviderInventory.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightIamLdapProviderInventory", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightIamLdapProviderInventory : GetCmdletBase
    {
        public GetIntersightIamLdapProviderInventory()
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamLdapProviderInventoryListWithHttpInfo";
        }
        ...
        public IamLdapProviderInventory.VendorEnum Vendor
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamLocalUserPassword : GetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamLocalUserPasswordListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"Indicates whether the value of the 'currentPassword' property has been set."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Indicates whether the value of the 'initialPassword' property has been set."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public bool IsInitialPasswordSet
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Indicates whether the value of the 'newPassword' property has been set."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public bool IsNewPasswordSet
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Indicates whether the user should be prompted to reset their password."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamOAuthToken : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Expiration time for the JWT token to which it can be used for api calls."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The user agent IP address from which the auth token is launched."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Expiration time for the JWT token to which it can be refreshed."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The client address from which last login is initiated."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public string LastLoginClient
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"The last login time for user."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Token identifier. Not the Access Token itself."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamPasswordHistorySettingCollection : GetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamPasswordHistorySettingCollectionListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"Orphaned indicates whether policy, server or profile changed or deleted related to this object. Such objects would be marked as orphaned for deletion."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The password history window size (number of previous passwords to remember) that is currently in effect. Used to detect policy changes at deploy time so the stored history can be renormalized if the window has changed."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public long PasswordHistoryWindow
        {
            get;
            set;
        }
        ...
        public IamEndPointUserPolicyRelationship Policy
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamPrivilege : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"The condition expression or criteria that determines when this conditional privilege can grant access to update the specified attribute names."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Informative description about each privilege."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = false, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The hostname prefix of the resource corresponding to this privilege. For example \\'sentry\\' in https://sentry.intersight.com ."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Flag that indicates whether this privilege is conditional."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public bool IsConditionalPrivilege
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"The API method on the rest resource corresponding to privilege. For example READ, CREATE, UPDATE etc."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The name of the privilege reported by microservice."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = false, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The REST API path of the resource corresponding to this privilege. For example /v1/iam/Accounts, /v1/iam/Sessions."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The URL path prefix of the resource corresponding to this privilege. For example /devops/kibana, /devops/grafana etc."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamPrivilegeSet : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Flag used by UI to keep track of the user selection option for future updates of privilege sets."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public bool AllowFutureUpdates
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Description of the privilege set."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = false, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Flag to indicate if the privilege names are updated."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public bool IsPrivilegeNamesUpdated
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"The scope of the privilege set.\n* `Generic` - Privilege set can be added to account wide permission or organization permissions.\n* `Account` - Privilege set can be added to account wide permission only."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public IamPrivilegeSet.ScopeEnum Scope
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"UUID of the privilege set."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamPrivilegeSetMetaInfo : GetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamPrivilegeSetMetaInfoListWithHttpInfo";
        }
    ...
    public class GetIntersightIamQualifier : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"The name of the SAML attribute used to qualify a user to user group. By default this is memberOf attribute in SAML assertion."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = false, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamResourceLimits : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"The maximum number of users allowed in an account. The default value is 200."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        [ValidateRange(1, 200)]
        public long PerAccountUserLimit
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamRole : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Informative description about each role."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = false, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamSecurityHolder : GetCmdletBase
    {
        ...
        public IamIpAccessManagementRelationship IpRulesConfiguration
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamServiceProvider : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Entity ID of the Intersight Service Provider. In SAML, the entity ID uniquely identifies the IdP/Service Provider."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Metadata of the Intersight Service Provider. User downloads the Intersight Service Provider metadata and integrates it with their IdP for authentication."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Name of the Intersight Service Provider."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = false, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamSession : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Expiration time for the session."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Failed logins since last login for admin user."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Idle time expiration for the session."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public DateTime IdleTimeExpiration
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"The type of login that created this session. Indicates whether the session was created through standard web login or JWT token exchange.\n* `weblogin` - Session created through standard web login process.\n* `tokenexchange` - Session created through JWT token exchange process."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public IamSession.LoginTypeEnum LoginType
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamSharingRule : GetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamSharingRuleListWithHttpInfo";
        }
    ...
    public class GetIntersightIamSystem : GetCmdletBase
    {
        ...
        public IamServiceProviderRelationship ServiceProvider
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamTestIdpConfiguration : GetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamTestIdpConfigurationListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"Error returned by the IdP when the configuration test fails."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Entity ID of the IdP whose configuration needs to be tested."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Total number of groups of the user received from the IdP after successful authentication."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public long NoOfGroups
        {
            get;
            set;
        }
    ...
    public class GetIntersightIamUser : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"IP address from which the user last logged in to Intersight."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Last successful login time for user."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Last role modification time for user."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public DateTime LastRoleModifiedTime
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"A reference to a iamLocalUserPassword resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public IamLocalUserPasswordRelationship LocalUserPassword
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Time until which the user account will be locked out."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Name of the user. For remote users, it is the value as configured in the IdP."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = false, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Type of the User. If a user is added manually by specifying the email address, or has logged in using groups, based on the IdP attributes received during authentication. If added manually, the user type will be static, otherwise dynamic."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Unique id of the user used by the identity provider to store the user."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamUserGroup : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"AccessLink using which the guest user uses to log in to Intersight."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        public IamAbstractQualifierRelationship Qualifier
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"A random mixed character string which is unique per user groups. UniqueReferenceId is used as key for identifying the guest user groups."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamUserQualifier : GetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamUserQualifierListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"Holds the information on when last email notification was sent to the guest users."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightIamUserSetting : GetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "GetIamUserSettingListWithHttpInfo";
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to New IamCuiIntegration.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "IntersightIamCuiIntegration", SupportsShouldProcess = true)]
    public class NewIntersightIamCuiIntegration : NewCmdletBase
    {
        public NewIntersightIamCuiIntegration()
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamCuiIntegration();
            MethodName = "CreateIamCuiIntegrationWithHttpInfo";
        }
    ...
    public class NewIntersightIamDomainNameInfo : NewCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamDomainNameInfo();
            MethodName = "CreateIamDomainNameInfoWithHttpInfo";
        }
    ...
    public class NewIntersightIamEndPointUserRole : NewCmdletBase
    {
        ...
        public List<IamAccountTypeBase> AccountTypes
        {
            get;
            set;
        }
    ...
    public class NewIntersightIamGuestAccessSettings : NewCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamGuestAccessSettings();
            MethodName = "CreateIamGuestAccessSettingsWithHttpInfo";
        }
    ...
    public class NewIntersightIamLocalUserPassword : NewCmdletBase
    {
        public NewIntersightIamLocalUserPassword()
        {
            ...
            MethodName = "CreateIamLocalUserPasswordWithHttpInfo";
        }
    ...
    public class NewIntersightIamPermission : NewCmdletBase
    {
        ...
        public List<IamPrivilegeSetRelationship> PrivilegeSets
        {
            get;
            set;
        }
    ...
    public class NewIntersightIamPrivilegeSet : NewCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamPrivilegeSet();
            MethodName = "CreateIamPrivilegeSetWithHttpInfo";
        }
    ...
    public class NewIntersightIamPrivilegeSetMetaInfo : NewCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamPrivilegeSetMetaInfo();
            MethodName = "CreateIamPrivilegeSetMetaInfoWithHttpInfo";
        }
    ...
    public class NewIntersightIamSharingRule : NewCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamSharingRule();
            MethodName = "CreateIamSharingRuleWithHttpInfo";
        }
    ...
    public class NewIntersightIamUserQualifier : NewCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamUserQualifier();
            MethodName = "CreateIamUserQualifierWithHttpInfo";
        }
        ...
        public List<IamUserDetails> UserDetails
        {
            get;
            set;
        }
    ...
    public class NewIntersightIamUserSetting : NewCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamUserSetting();
            MethodName = "CreateIamUserSettingWithHttpInfo";
        }
        ...
        public List<IamDefaultPermissionInfo> DefaultPermission
        {
            get;
            set;
        }
    ...
    public class RemoveIntersightIamDomainNameInfo : RemoveCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "DeleteIamDomainNameInfoWithHttpInfo";
        }
    }
    /// <summary>
    ...
    public class RemoveIntersightIamGuestAccessSettings : RemoveCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "DeleteIamGuestAccessSettingsWithHttpInfo";
        }
    }
    /// <summary>
    ...
    public class RemoveIntersightIamPrivilegeSet : RemoveCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "DeleteIamPrivilegeSetWithHttpInfo";
        }
    }
    /// <summary>
    ...
    public class RemoveIntersightIamSharingRule : RemoveCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "DeleteIamSharingRuleWithHttpInfo";
        }
    }
    /// <summary>
    ...
    public class RemoveIntersightIamUserQualifier : RemoveCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            MethodName = "DeleteIamUserQualifierWithHttpInfo";
        }
    }
    /// <summary>
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Set IamCuiIntegration.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "IntersightIamCuiIntegration", SupportsShouldProcess = true)]
    public class SetIntersightIamCuiIntegration : SetCmdletBase
    {
        public SetIntersightIamCuiIntegration()
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamCuiIntegration();
            MethodName = "UpdateIamCuiIntegrationWithHttpInfo";
        }
    ...
    public class SetIntersightIamDefaultAuthentication : SetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamDefaultAuthentication();
            MethodName = "UpdateIamDefaultAuthenticationWithHttpInfo";
        }
    ...
    public class SetIntersightIamDomainNameInfo : SetCmdletBase
    {
        public SetIntersightIamDomainNameInfo()
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamDomainNameInfo();
            MethodName = "UpdateIamDomainNameInfoWithHttpInfo";
        }
    ...
    public class SetIntersightIamGuestAccessSettings : SetCmdletBase
    {
        public SetIntersightIamGuestAccessSettings()
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamGuestAccessSettings();
            MethodName = "UpdateIamGuestAccessSettingsWithHttpInfo";
        }
    ...
    public class SetIntersightIamIpAccessManagement : SetCmdletBase
    {
        public SetIntersightIamIpAccessManagement()
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamIpAccessManagement();
            MethodName = "UpdateIamIpAccessManagementWithHttpInfo";
        }
    ...
    public class SetIntersightIamIpAddress : SetCmdletBase
    {
        public SetIntersightIamIpAddress()
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamIpAddress();
            MethodName = "UpdateIamIpAddressWithHttpInfo";
        }
    ...
    public class SetIntersightIamPrivilegeSet : SetCmdletBase
    {
        public SetIntersightIamPrivilegeSet()
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamPrivilegeSet();
            MethodName = "UpdateIamPrivilegeSetWithHttpInfo";
        }
    ...
    public class SetIntersightIamResourceLimits : SetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamResourceLimits();
            MethodName = "UpdateIamResourceLimitsWithHttpInfo";
        }
    ...
    public class SetIntersightIamSharingRule : SetCmdletBase
    {
        public SetIntersightIamSharingRule()
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamSharingRule();
            MethodName = "UpdateIamSharingRuleWithHttpInfo";
        }
    ...
    public class SetIntersightIamTestIdpConfiguration : SetCmdletBase
    {
        ...
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamTestIdpConfiguration();
            MethodName = "UpdateIamTestIdpConfigurationWithHttpInfo";
        }
    ...
    public class SetIntersightIamUserQualifier : SetCmdletBase
    {
        public SetIntersightIamUserQualifier()
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamUserQualifier();
            MethodName = "UpdateIamUserQualifierWithHttpInfo";
        }
    ...
    public class SetIntersightIamUserSetting : SetCmdletBase
    {
        public SetIntersightIamUserSetting()
        {
            ApiInstance = new IamApi(Config);
            ModelObject = new IamUserSetting();
            MethodName = "UpdateIamUserSettingWithHttpInfo";
        }
