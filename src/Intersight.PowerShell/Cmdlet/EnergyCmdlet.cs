...
namespace Intersight.PowerShell
{
    ...
    public class NewIntersightEnergyDailyMetrics : NewCmdletBase
    {
        ...
        {
            ApiInstance = new EnergyApi(Config);
            ModelObject = new EnergyDailyMetrics();
            MethodName = "CreateEnergyDailyMetricsWithHttpInfo";
        }
    ...
    public class NewIntersightEnergyMetrics : NewCmdletBase
    {
        ...
        {
            ApiInstance = new EnergyApi(Config);
            ModelObject = new EnergyMetrics();
            MethodName = "CreateEnergyMetricsWithHttpInfo";
        }
