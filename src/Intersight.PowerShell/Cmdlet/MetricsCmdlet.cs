...
namespace Intersight.PowerShell
{
    ...
    public class GetIntersightMetricsConfiguration : GetCmdletBase
    {
        public GetIntersightMetricsConfiguration()
        {
            ...
            MethodName = "GetMetricsConfigurationListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"Enables metric collection for the account, if disabled metrics will be stopped for all resources in the account."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The total number of resources that can be enabled for metric collection in this account."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightMetricsResourceConfiguration : GetCmdletBase
    {
        ...
        {
            ApiInstance = new MetricsApi(Config);
            MethodName = "GetMetricsResourceConfigurationListWithHttpInfo";
        }
        ...
        public AssetTargetRelationship Domain
        {
            get;
            set;
        }
    ...
    public class NewIntersightMetricsResourceConfiguration : NewCmdletBase
    {
        ...
        {
            ApiInstance = new MetricsApi(Config);
            ModelObject = new MetricsResourceConfiguration();
            MethodName = "CreateMetricsResourceConfigurationWithHttpInfo";
        }
    ...
    public class SetIntersightMetricsConfiguration : SetCmdletBase
    {
        ...
        {
            ApiInstance = new MetricsApi(Config);
            ModelObject = new MetricsConfiguration();
            MethodName = "UpdateMetricsConfigurationWithHttpInfo";
        }
    ...
    public class SetIntersightMetricsResourceConfiguration : SetCmdletBase
    {
        public SetIntersightMetricsResourceConfiguration()
        {
            ApiInstance = new MetricsApi(Config);
            ModelObject = new MetricsResourceConfiguration();
            MethodName = "UpdateMetricsResourceConfigurationWithHttpInfo";
        }
