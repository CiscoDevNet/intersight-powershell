...
{
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get ApiproxyAllowList.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightApiproxyAllowList", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightApiproxyAllowList : GetCmdletBase
    {
        public GetIntersightApiproxyAllowList()
        {
            ApiInstance = new ApiproxyApi(Config);
            MethodName = "GetApiproxyAllowListListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"Version of the allow list file."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
