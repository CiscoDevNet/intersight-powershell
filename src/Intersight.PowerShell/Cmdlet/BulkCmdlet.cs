...
namespace Intersight.PowerShell
{
    ...
    public class GetIntersightBulkExportedItem : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"A reference to a bulkBaseExport resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public BulkBaseExportRelationship Export
        {
            get;
            set;
        }
    ...
    public class NewIntersightBulkExport : NewCmdletBase
    {
        ...
        public List<BulkRelatedTypeExportOption> RelatedTypeOptions
        {
            get;
            set;
        }
    ...
    public class NewIntersightBulkMoCloner : NewCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">The Prefer request header field is used to indicate that particular server behaviors are preferred  by the client but are not required for successful completion of the request.   The \"respond-async\" preference indicates that the client prefers the server to respond  asynchronously to a response. The Prefer header is described in RFC 7240.</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = false, ValueFromPipeline = false)]
