...
namespace Intersight.PowerShell
{
    ...
    public class GetIntersightAaaAuditRecord : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"The user-friendly label for the object type that was changed."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public string AffectedObjectTypeLabel
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"A reference to a iamSession resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public IamSessionRelationship Sessions
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"The creation time of AuditRecordLocal, which is the time when the affected MO was created/modified/deleted."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightAaaRetentionConfig : GetCmdletBase
    {
        ...
        {
            ApiInstance = new AaaApi(Config);
            MethodName = "GetAaaRetentionConfigListWithHttpInfo";
        }
    ...
    public class GetIntersightAaaRetentionPolicy : GetCmdletBase
    {
        ...
        {
            ApiInstance = new AaaApi(Config);
            MethodName = "GetAaaRetentionPolicyListWithHttpInfo";
        }
    ...
    public class NewIntersightAaaRetentionPolicy : NewCmdletBase
    {
        ...
        {
            ApiInstance = new AaaApi(Config);
            ModelObject = new AaaRetentionPolicy();
            MethodName = "CreateAaaRetentionPolicyWithHttpInfo";
        }
    ...
    public class SetIntersightAaaRetentionPolicy : SetCmdletBase
    {
        public SetIntersightAaaRetentionPolicy()
        {
            ApiInstance = new AaaApi(Config);
            ModelObject = new AaaRetentionPolicy();
            MethodName = "UpdateAaaRetentionPolicyWithHttpInfo";
        }
