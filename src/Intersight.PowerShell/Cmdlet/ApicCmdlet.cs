...
namespace Intersight.PowerShell
{
    ...
    public class GetIntersightApicAciPod : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ApicApi(Config);
            MethodName = "GetApicAciPodListWithHttpInfo";
        }
    ...
    public class GetIntersightApicApplication : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ApicApi(Config);
            MethodName = "GetApicApplicationListWithHttpInfo";
        }
        ...
        public ApicTenantRelationship Tenant
        {
            get;
            set;
        }
    ...
    public class GetIntersightApicApplicationEndpointGroup : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ApicApi(Config);
            MethodName = "GetApicApplicationEndpointGroupListWithHttpInfo";
        }
        ...
        public ApicApplicationRelationship Application
        {
            get;
            set;
        }
    ...
    public class GetIntersightApicBridgeDomain : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ApicApi(Config);
            MethodName = "GetApicBridgeDomainListWithHttpInfo";
        }
    ...
    public class GetIntersightApicExternalRoutedLayerThreeDomain : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ApicApi(Config);
            MethodName = "GetApicExternalRoutedLayerThreeDomainListWithHttpInfo";
        }
    ...
    public class GetIntersightApicFabricLeafNode : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ApicApi(Config);
            MethodName = "GetApicFabricLeafNodeListWithHttpInfo";
        }
    ...
    public class GetIntersightApicFabricLeafNodeInterface : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ApicApi(Config);
            MethodName = "GetApicFabricLeafNodeInterfaceListWithHttpInfo";
        }
        ...
        public ApicFabricLeafNodeRelationship FabricLeafNode
        {
            get;
            set;
        }
    ...
    public class GetIntersightApicOut : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ApicApi(Config);
            MethodName = "GetApicOutListWithHttpInfo";
        }
    ...
    public class GetIntersightApicSubnet : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ApicApi(Config);
            MethodName = "GetApicSubnetListWithHttpInfo";
        }
        ...
        public ApicBridgeDomainRelationship BridgeDomain
        {
            get;
            set;
        }
    ...
    public class GetIntersightApicTenant : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ApicApi(Config);
            MethodName = "GetApicTenantListWithHttpInfo";
        }
    ...
    public class GetIntersightApicVpcGroup : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ApicApi(Config);
            MethodName = "GetApicVpcGroupListWithHttpInfo";
        }
    ...
    public class GetIntersightApicVrfs : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ApicApi(Config);
            MethodName = "GetApicVrfsListWithHttpInfo";
        }
