...
namespace Intersight.PowerShell
{
    ...
    public class GetIntersightResourcepoolLease : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ResourcepoolApi(Config);
            MethodName = "GetResourcepoolLeaseListWithHttpInfo";
        }
        ...
        public ResourcepoolLeaseResourceRelationship LeasedResource
        {
            get;
            set;
        }
        ...
        public ResourcepoolPoolRelationship Pool
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"A reference to a resourcepoolPoolMember resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public ResourcepoolPoolMemberRelationship PoolMember
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"A reference to a resourcepoolUniverse resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public ResourcepoolUniverseRelationship Universe
        {
            get;
            set;
        }
    ...
    public class GetIntersightResourcepoolLeaseResource : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ResourcepoolApi(Config);
            MethodName = "GetResourcepoolLeaseResourceListWithHttpInfo";
        }
    ...
    public class GetIntersightResourcepoolMembershipReservation : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ResourcepoolApi(Config);
            MethodName = "GetResourcepoolMembershipReservationListWithHttpInfo";
        }
        ...
        public ResourcepoolMembershipReservation.StatusEnum Status
        {
            get;
            set;
        }
    ...
    public class GetIntersightResourcepoolPool : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ResourcepoolApi(Config);
            MethodName = "GetResourcepoolPoolListWithHttpInfo";
        }
    ...
    public class GetIntersightResourcepoolPoolMember : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ResourcepoolApi(Config);
            MethodName = "GetResourcepoolPoolMemberListWithHttpInfo";
        }
        ...
        public ResourcepoolLeaseRelationship Peer
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"A reference to a resourcepoolReservation resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public ResourcepoolReservationRelationship Reservation
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Identifies if the member has been reserved."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightResourcepoolQualificationPolicy : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ResourcepoolApi(Config);
            MethodName = "GetResourcepoolQualificationPolicyListWithHttpInfo";
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get ResourcepoolReservation.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightResourcepoolReservation", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightResourcepoolReservation : GetCmdletBase
    {
        public GetIntersightResourcepoolReservation()
        {
            ApiInstance = new ResourcepoolApi(Config);
            MethodName = "GetResourcepoolReservationListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"The type and serial number of the resource for display."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightResourcepoolUniverse : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ResourcepoolApi(Config);
            MethodName = "GetResourcepoolUniverseListWithHttpInfo";
        }
    ...
    public class NewIntersightResourcepoolPool : NewCmdletBase
    {
        ...
        {
            ApiInstance = new ResourcepoolApi(Config);
            ModelObject = new ResourcepoolPool();
            MethodName = "CreateResourcepoolPoolWithHttpInfo";
        }
        ...
        public List<ResourcepoolReservationRelationship> Reservations
        {
            get;
            set;
        }
        ...
        public ResourcepoolResourcePoolParameters ResourcePoolParameters
        {
            get;
            set;
        }
    ...
    public class NewIntersightResourcepoolQualificationPolicy : NewCmdletBase
    {
        ...
        {
            ApiInstance = new ResourcepoolApi(Config);
            ModelObject = new ResourcepoolQualificationPolicy();
            MethodName = "CreateResourcepoolQualificationPolicyWithHttpInfo";
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to New ResourcepoolReservation.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "IntersightResourcepoolReservation", SupportsShouldProcess = true)]
    public class NewIntersightResourcepoolReservation : NewCmdletBase
    {
        public NewIntersightResourcepoolReservation()
        {
            ApiInstance = new ResourcepoolApi(Config);
            ModelObject = new ResourcepoolReservation();
            MethodName = "CreateResourcepoolReservationWithHttpInfo";
        }
    ...
    public class RemoveIntersightResourcepoolLease : RemoveCmdletBase
    {
        ...
        {
            ApiInstance = new ResourcepoolApi(Config);
            MethodName = "DeleteResourcepoolLeaseWithHttpInfo";
        }
    }
    /// <summary>
    ...
    public class RemoveIntersightResourcepoolMembershipReservation : RemoveCmdletBase
    {
        ...
        {
            ApiInstance = new ResourcepoolApi(Config);
            MethodName = "DeleteResourcepoolMembershipReservationWithHttpInfo";
        }
    }
    /// <summary>
    ...
    public class RemoveIntersightResourcepoolPool : RemoveCmdletBase
    {
        ...
        {
            ApiInstance = new ResourcepoolApi(Config);
            MethodName = "DeleteResourcepoolPoolWithHttpInfo";
        }
    }
    /// <summary>
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Remove ResourcepoolReservation.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Remove, "IntersightResourcepoolReservation", SupportsShouldProcess = true)]
    public class RemoveIntersightResourcepoolReservation : RemoveCmdletBase
    {
        public RemoveIntersightResourcepoolReservation()
        {
            ApiInstance = new ResourcepoolApi(Config);
            MethodName = "DeleteResourcepoolReservationWithHttpInfo";
        }
    }
    /// <summary>
    ...
    public class SetIntersightResourcepoolMembershipReservation : SetCmdletBase
    {
        ...
        {
            ApiInstance = new ResourcepoolApi(Config);
            ModelObject = new ResourcepoolMembershipReservation();
            MethodName = "UpdateResourcepoolMembershipReservationWithHttpInfo";
        }
        ...
        public List<ResourcepoolPoolRelationship> Pools
        {
            get;
            set;
        }
    ...
    public class SetIntersightResourcepoolPool : SetCmdletBase
    {
        public SetIntersightResourcepoolPool()
        {
            ApiInstance = new ResourcepoolApi(Config);
            ModelObject = new ResourcepoolPool();
            MethodName = "UpdateResourcepoolPoolWithHttpInfo";
        }
    ...
    public class SetIntersightResourcepoolQualificationPolicy : SetCmdletBase
    {
        public SetIntersightResourcepoolQualificationPolicy()
        {
            ApiInstance = new ResourcepoolApi(Config);
            ModelObject = new ResourcepoolQualificationPolicy();
            MethodName = "UpdateResourcepoolQualificationPolicyWithHttpInfo";
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Set ResourcepoolReservation.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Set, "IntersightResourcepoolReservation", SupportsShouldProcess = true)]
    public class SetIntersightResourcepoolReservation : SetCmdletBase
    {
        public SetIntersightResourcepoolReservation()
        {
            ApiInstance = new ResourcepoolApi(Config);
            ModelObject = new ResourcepoolReservation();
            MethodName = "UpdateResourcepoolReservationWithHttpInfo";
        }
