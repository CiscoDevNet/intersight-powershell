...
namespace Intersight.PowerShell
{
    ...
    public class GetIntersightFirmwareChassisUpgrade : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Name of the chassis on which the firmware upgrade operation is performed."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightFirmwarePciNodeUpgrade : GetCmdletBase
    {
        ...
        {
            ApiInstance = new FirmwareApi(Config);
            MethodName = "GetFirmwarePciNodeUpgradeListWithHttpInfo";
        }
    ...
    public class GetIntersightFirmwarePsxDescriptor : GetCmdletBase
    {
        ...
        {
            ApiInstance = new FirmwareApi(Config);
            MethodName = "GetFirmwarePsxDescriptorListWithHttpInfo";
        }
    ...
    public class GetIntersightFirmwareRunningFirmware : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"A reference to a equipmentPsu resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public EquipmentPsuRelationship EquipmentPsu
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get FirmwareSecureRouterUpgrade.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightFirmwareSecureRouterUpgrade", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightFirmwareSecureRouterUpgrade : GetCmdletBase
    {
        public GetIntersightFirmwareSecureRouterUpgrade()
        {
            ApiInstance = new FirmwareApi(Config);
            MethodName = "GetFirmwareSecureRouterUpgradeListWithHttpInfo";
        }
    ...
    public class GetIntersightFirmwareSwitchUpgrade : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Name of the Fabric Interconnect on which the firmware upgrade operation is performed."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightFirmwareUpgrade : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Name of the server on which the firmware upgrade operation is performed."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightFirmwareUpgradeStatus : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"A boolean flag which indicates that the generated pre-signed url is not a CDN URL when set to true."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class NewIntersightFirmwarePciNodeUpgrade : NewCmdletBase
    {
        ...
        {
            ApiInstance = new FirmwareApi(Config);
            ModelObject = new FirmwarePciNodeUpgrade();
            MethodName = "CreateFirmwarePciNodeUpgradeWithHttpInfo";
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to New FirmwareSecureRouterUpgrade.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "IntersightFirmwareSecureRouterUpgrade", SupportsShouldProcess = true)]
    public class NewIntersightFirmwareSecureRouterUpgrade : NewCmdletBase
    {
        public NewIntersightFirmwareSecureRouterUpgrade()
        {
            ApiInstance = new FirmwareApi(Config);
            ModelObject = new FirmwareSecureRouterUpgrade();
            MethodName = "CreateFirmwareSecureRouterUpgradeWithHttpInfo";
        }
    ...
    public class NewIntersightFirmwareUpgradeImpact : NewCmdletBase
    {
        ...
        public List<NetworkSecureRouterRelationship> NetworkSecureRouter
        {
            get;
            set;
        }
        ...
        public List<PciNodeRelationship> PciNode
        {
            get;
            set;
        }
    ...
    public class RemoveIntersightFirmwarePciNodeUpgrade : RemoveCmdletBase
    {
        ...
        {
            ApiInstance = new FirmwareApi(Config);
            MethodName = "DeleteFirmwarePciNodeUpgradeWithHttpInfo";
        }
    }
    /// <summary>
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Remove FirmwareSecureRouterUpgrade.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Remove, "IntersightFirmwareSecureRouterUpgrade", SupportsShouldProcess = true)]
    public class RemoveIntersightFirmwareSecureRouterUpgrade : RemoveCmdletBase
    {
        public RemoveIntersightFirmwareSecureRouterUpgrade()
        {
            ApiInstance = new FirmwareApi(Config);
            MethodName = "DeleteFirmwareSecureRouterUpgradeWithHttpInfo";
        }
    }
    /// <summary>
