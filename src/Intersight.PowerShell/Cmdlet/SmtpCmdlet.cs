...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get SmtpPolicyInventory.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightSmtpPolicyInventory", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightSmtpPolicyInventory : GetCmdletBase
    {
        public GetIntersightSmtpPolicyInventory()
        {
            ApiInstance = new SmtpApi(Config);
            MethodName = "GetSmtpPolicyInventoryListWithHttpInfo";
        }
        ...
        public SmtpPolicyInventory.MinSeverityEnum MinSeverity
        {
            get;
            set;
        }
    ...
    public class GetIntersightSmtpPolicyTest : GetCmdletBase
    {
        ...
        {
            ApiInstance = new SmtpApi(Config);
            MethodName = "GetSmtpPolicyTestListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"Information on the last status, including any encountered error specifics, to assist users in troubleshooting SMTP policy issues."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public string LastStatusDetails
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"The date and time of the most recent successful attempt to send a test email notification."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public DateTime LastSuccessfulAttemptTime
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Status of the last test email notification.\n* `` - Notification has not been tried.\n* `failed` - Sending notification failed.\n* `success` - Sending notification successful."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public SmtpPolicyTest.LastTestStatusEnum LastTestStatus
        {
            get;
            set;
        }
        ...
        public SmtpPolicyRelationship Policy
        {
            get;
            set;
        }
    ...
    public class NewIntersightSmtpPolicyTest : NewCmdletBase
    {
        ...
        {
            ApiInstance = new SmtpApi(Config);
            ModelObject = new SmtpPolicyTest();
            MethodName = "CreateSmtpPolicyTestWithHttpInfo";
        }
    ...
    public class RemoveIntersightSmtpPolicyTest : RemoveCmdletBase
    {
        ...
        {
            ApiInstance = new SmtpApi(Config);
            MethodName = "DeleteSmtpPolicyTestWithHttpInfo";
        }
    }
    /// <summary>
    ...
    public class SetIntersightSmtpPolicyTest : SetCmdletBase
    {
        public SetIntersightSmtpPolicyTest()
        {
            ApiInstance = new SmtpApi(Config);
            ModelObject = new SmtpPolicyTest();
            MethodName = "UpdateSmtpPolicyTestWithHttpInfo";
        }
