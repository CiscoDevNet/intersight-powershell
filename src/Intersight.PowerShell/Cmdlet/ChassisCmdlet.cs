...
namespace Intersight.PowerShell
{
    ...
    public class GetIntersightChassisConfigResult : GetCmdletBase
    {
        ...
        public ChassisBaseProfileRelationship Profile
        {
            get;
            set;
        }
    ...
    public class GetIntersightChassisProfileTemplate : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ChassisApi(Config);
            MethodName = "GetChassisProfileTemplateListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"The count of the chassis profiles derived from the template."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class NewIntersightChassisProfileTemplate : NewCmdletBase
    {
        ...
        {
            ApiInstance = new ChassisApi(Config);
            ModelObject = new ChassisProfileTemplate();
            MethodName = "CreateChassisProfileTemplateWithHttpInfo";
        }
    ...
    public class RemoveIntersightChassisProfileTemplate : RemoveCmdletBase
    {
        ...
        {
            ApiInstance = new ChassisApi(Config);
            MethodName = "DeleteChassisProfileTemplateWithHttpInfo";
        }
    }
    /// <summary>
    ...
    public class SetIntersightChassisProfileTemplate : SetCmdletBase
    {
        public SetIntersightChassisProfileTemplate()
        {
            ApiInstance = new ChassisApi(Config);
            ModelObject = new ChassisProfileTemplate();
            MethodName = "UpdateChassisProfileTemplateWithHttpInfo";
        }
