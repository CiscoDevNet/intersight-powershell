...
namespace Intersight.PowerShell
{
    ...
    public class GetIntersightVnicEthIf : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Static/Pool/DHCP Type of IPv6 address allocated to the vNIC. It is derived from iSCSI boot policy IP Address type.\n* `None` - Type indicates that there is no IP associated to an vnic.\n* `DHCP` - The IP address is assigned using DHCP, if available.\n* `Static` - Static IPv4 address is assigned to the iSCSI boot interface based on the information entered in this area.\n* `Pool` - An IPv4 address is assigned to the iSCSI boot interface from the management IP address pool."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public VnicEthIf.IscsiIpV6AddressAllocationTypeEnum IscsiIpV6AddressAllocationType
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"IPv6 address associated to the iSCSI vNIC."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        public string IscsiIpv6Address
        {
            get;
            set;
        }
    ...
    public class GetIntersightVnicEthIfInventory : GetCmdletBase
    {
        ...
        public VnicEthIfInventory.IscsiIpV6AddressAllocationTypeEnum IscsiIpV6AddressAllocationType
        {
            get;
            set;
        }
    ...
    public class GetIntersightVnicIscsiBootPolicyInventory : GetCmdletBase
    {
        ...
        public VnicIscsiBootPolicyInventory.IscsiIpTypeEnum IscsiIpType
        {
            get;
            set;
        }
    ...
    public class GetIntersightVnicIscsiStaticTargetPolicyInventory : GetCmdletBase
    {
        ...
        public VnicIscsiStaticTargetPolicyInventory.IscsiIpTypeEnum IscsiIpType
        {
            get;
            set;
        }
    ...
    public class GetIntersightVnicLanSettings : GetCmdletBase
    {
        ...
        {
            ApiInstance = new VnicApi(Config);
            MethodName = "GetVnicLanSettingsListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"A reference to a iqnpoolLease resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public IqnpoolLeaseRelationship IqnLease
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Qualified Name (IQN) assigned to iSCSI vNICs in a Fabric Interconnect domain."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightVnicSanSettings : GetCmdletBase
    {
        ...
        {
            ApiInstance = new VnicApi(Config);
            MethodName = "GetVnicSanSettingsListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"The WWNN address that is assigned to the server node based on the wwn pool that has been assigned in the SAN Connectivity Policy."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        [ValidatePattern("^$|((^20|5[0-9a-fA-F]{1}):([0-9a-fA-F]{2}:){6}([0-9a-fA-F]{2})$)")]
        public string Wwnn
        ...
        public FcpoolLeaseRelationship WwnnLease
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get VnicServiceEthIf.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightVnicServiceEthIf", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightVnicServiceEthIf : GetCmdletBase
    {
        public GetIntersightVnicServiceEthIf()
        {
            ApiInstance = new VnicApi(Config);
            MethodName = "GetVnicServiceEthIfListWithHttpInfo";
        }
        ...
        public VnicServiceEthIf.TemplateSyncStatusEnum TemplateSyncStatus
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"The Vif Id should be same as the channel number of the vethernet created on switch in order to set up the data path. The property is applicable only for Fabric Interconnect attached servers where a vethernet is created on the switch for every vNIC."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get VnicServiceEthIfInventory.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightVnicServiceEthIfInventory", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightVnicServiceEthIfInventory : GetCmdletBase
    {
        public GetIntersightVnicServiceEthIfInventory()
        {
            ApiInstance = new VnicApi(Config);
            MethodName = "GetVnicServiceEthIfInventoryListWithHttpInfo";
        }
        ...
        public VnicServiceEthIfInventory.TemplateSyncStatusEnum TemplateSyncStatus
        {
            get;
            set;
        }
    ...
    public class GetIntersightVnicVhbaTemplate : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"The template sync status with all derived objects.\n* `None` - The Enum value represents that the object is not attached to any template.\n* `OK` - The Enum value represents that the object values are in sync with attached template.\n* `Scheduled` - The Enum value represents that the object sync from attached template is scheduled from template.\n* `InProgress` - The Enum value represents that the object sync with the attached template is in progress.\n* `OutOfSync` - The Enum value represents that the object values are not in sync with attached template."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public VnicVhbaTemplate.UpdateStatusEnum UpdateStatus
        {
            get;
            set;
        }
    ...
    public class GetIntersightVnicVifIdPool : GetCmdletBase
    {
        ...
        {
            ApiInstance = new VnicApi(Config);
            MethodName = "GetVnicVifIdPoolListWithHttpInfo";
        }
    ...
    public class GetIntersightVnicVnicTemplate : GetCmdletBase
    {
        ...
        public VnicVnicTemplate.UpdateStatusEnum UpdateStatus
        {
            get;
            set;
        }
    ...
    public class NewIntersightVnicEthIf : NewCmdletBase
    {
        ...
        public List<VnicNetFlowMonitorSession> NetFlowMonitorSessions
        {
            get;
            set;
        }
    ...
    public class NewIntersightVnicIscsiBootPolicy : NewCmdletBase
    {
        ...
        public IppoolIpV6Config InitiatorStaticIpV6Config
        {
            get;
            set;
        }
