...
namespace Intersight.PowerShell
{
    ...
    public class GetIntersightPoolIdMappingMember : GetCmdletBase
    {
        ...
        {
            ApiInstance = new PoolApi(Config);
            MethodName = "GetPoolIdMappingMemberListWithHttpInfo";
        }
    ...
    public class GetIntersightPoolIdMappingPolicy : GetCmdletBase
    {
        ...
        {
            ApiInstance = new PoolApi(Config);
            MethodName = "GetPoolIdMappingPolicyListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"The number of ID pools to which this ID mapping policy is attached."</para>
        /// </summary>
    ...
    public class NewIntersightPoolIdMappingPolicy : NewCmdletBase
    {
        ...
        {
            ApiInstance = new PoolApi(Config);
            ModelObject = new PoolIdMappingPolicy();
            MethodName = "CreatePoolIdMappingPolicyWithHttpInfo";
        }
    ...
    public class RemoveIntersightPoolIdMappingPolicy : RemoveCmdletBase
    {
        ...
        {
            ApiInstance = new PoolApi(Config);
            MethodName = "DeletePoolIdMappingPolicyWithHttpInfo";
        }
    }
    /// <summary>
    ...
    public class SetIntersightPoolIdMappingPolicy : SetCmdletBase
    {
        public SetIntersightPoolIdMappingPolicy()
        {
            ApiInstance = new PoolApi(Config);
            ModelObject = new PoolIdMappingPolicy();
            MethodName = "UpdatePoolIdMappingPolicyWithHttpInfo";
        }
