...
namespace Intersight.PowerShell
{
    ...
    public class GetIntersightApplianceBackup : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Download URL for the backup artifact when available. Only populated for successful local-protocol backups; empty for remote-protocol backups."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get ApplianceBackupDownload.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightApplianceBackupDownload", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightApplianceBackupDownload : GetCmdletBase
    {
        public GetIntersightApplianceBackupDownload()
        {
            ApiInstance = new ApplianceApi(Config);
            MethodName = "GetApplianceBackupDownloadListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"A reference to a applianceBackup resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public ApplianceBackupRelationship Backup
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get ApplianceCpuUtilization.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightApplianceCpuUtilization", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightApplianceCpuUtilization : GetCmdletBase
    {
        public GetIntersightApplianceCpuUtilization()
        {
            ApiInstance = new ApplianceApi(Config);
            MethodName = "GetApplianceCpuUtilizationListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"The end of the measurement window."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Uniquely identifies the source of the metric."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Hostname of the Intersight Appliance node. This human-readable identifier \ncorresponds to the Kubernetes node name used for metric queries and provides \nan intuitive way for users to correlate resource utilization data \nwith specific physical or virtual machines in the cluster topology."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The start of the measurement window."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The percent utilization of the metric."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightApplianceFileSystemOpStatus : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Symbolic order identifier of the physical disk from /dev/disk/by-order (e.g., disk1, disk2).\nThis provides a stable, human-readable identifier for the disk that persists across reboots,\nunlike device names which may change. Currently, the relationship between filesystems to disks\nis one-to-one and this is unlikely to change in the future."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public string DiskOrder
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"A reference to a applianceFileSystemOpSummary resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public ApplianceFileSystemOpSummaryRelationship FileSystemOpSummary
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Hostname of the Intersight Appliance node on which this filesystem is located."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get ApplianceFileSystemOpSummary.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightApplianceFileSystemOpSummary", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightApplianceFileSystemOpSummary : GetCmdletBase
    {
        public GetIntersightApplianceFileSystemOpSummary()
        {
            ApiInstance = new ApplianceApi(Config);
            MethodName = "GetApplianceFileSystemOpSummaryListWithHttpInfo";
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get ApplianceFileSystemTelemetry.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightApplianceFileSystemTelemetry", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightApplianceFileSystemTelemetry : GetCmdletBase
    {
        public GetIntersightApplianceFileSystemTelemetry()
        {
            ApiInstance = new ApplianceApi(Config);
            MethodName = "GetApplianceFileSystemTelemetryListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"The instance identifier from which the metrics were collected."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Operational status of filesystem utilization.\nValues are Optimal, Warning, or Critical based on configured thresholds.\n* `Optimal` - Resource usage is within normal operating parameters.\n* `Warning` - Resource usage has exceeded warning thresholds and attention may be needed.\n* `Critical` - Resource usage has exceeded critical thresholds and immediate attention is required."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public ApplianceFileSystemTelemetry.UsageEnum Usage
        {
            get;
            set;
        }
    ...
    public class GetIntersightApplianceFqdnUpdate : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ApplianceApi(Config);
            MethodName = "GetApplianceFqdnUpdateListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"End date of the appliance FQDN change."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Start date of the appliance FQDN change."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The status of the FQDN update operation.\n* `NotStarted` - Appliance FQDN update operation has not started.\n* `Started` - Appliance FQDN update operation has started.\n* `Failed` - Appliance FQDN update operation has failed.\n* `Completed` - Appliance FQDN update operation has completed."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public ApplianceFqdnUpdate.StatusEnum Status
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get ApplianceMemoryUtilization.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightApplianceMemoryUtilization", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightApplianceMemoryUtilization : GetCmdletBase
    {
        public GetIntersightApplianceMemoryUtilization()
        {
            ApiInstance = new ApplianceApi(Config);
            MethodName = "GetApplianceMemoryUtilizationListWithHttpInfo";
        }
    ...
    public class GetIntersightApplianceMetricsConfig : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Measures the utilization of the metrics feature in relation to the available capacity of the system."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightApplianceMetricsIngestionUtilization : GetCmdletBase
    {
        ...
        {
            ApiInstance = new ApplianceApi(Config);
            MethodName = "GetApplianceMetricsIngestionUtilizationListWithHttpInfo";
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get ApplianceNodeIopsMetric.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightApplianceNodeIopsMetric", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightApplianceNodeIopsMetric : GetCmdletBase
    {
        public GetIntersightApplianceNodeIopsMetric()
        {
            ApiInstance = new ApplianceApi(Config);
            MethodName = "GetApplianceNodeIopsMetricListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"Aggregate input/output operations per second."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get ApplianceNodeTelemetry.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightApplianceNodeTelemetry", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightApplianceNodeTelemetry : GetCmdletBase
    {
        public GetIntersightApplianceNodeTelemetry()
        {
            ApiInstance = new ApplianceApi(Config);
            MethodName = "GetApplianceNodeTelemetryListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"CpuUsage indicates the operational status of CPU utilization on the Assist node.\nValues are Optimal, Warning, or Critical based on configured thresholds.\n* `Optimal` - Resource usage is within normal operating parameters.\n* `Warning` - Resource usage has exceeded warning thresholds and attention may be needed.\n* `Critical` - Resource usage has exceeded critical thresholds and immediate attention is required."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public ApplianceNodeTelemetry.CpuUsageEnum CpuUsage
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"MemoryUsage indicates the operational status of memory utilization on the Assist node.\nValues are Optimal, Warning, or Critical based on configured thresholds.\n* `Optimal` - Resource usage is within normal operating parameters.\n* `Warning` - Resource usage has exceeded warning thresholds and attention may be needed.\n* `Critical` - Resource usage has exceeded critical thresholds and immediate attention is required."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public ApplianceNodeTelemetry.MemoryUsageEnum MemoryUsage
        {
            get;
            set;
        }
    ...
    public class NewIntersightApplianceFqdnUpdate : NewCmdletBase
    {
        ...
        {
            ApiInstance = new ApplianceApi(Config);
            ModelObject = new ApplianceFqdnUpdate();
            MethodName = "CreateApplianceFqdnUpdateWithHttpInfo";
        }
    ...
    public class SetIntersightApplianceFqdnUpdate : SetCmdletBase
    {
        public SetIntersightApplianceFqdnUpdate()
        {
            ApiInstance = new ApplianceApi(Config);
            ModelObject = new ApplianceFqdnUpdate();
            MethodName = "UpdateApplianceFqdnUpdateWithHttpInfo";
        }
