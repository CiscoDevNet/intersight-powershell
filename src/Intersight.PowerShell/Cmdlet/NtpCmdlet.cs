...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get NtpPolicyInventory.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightNtpPolicyInventory", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightNtpPolicyInventory : GetCmdletBase
    {
        public GetIntersightNtpPolicyInventory()
        {
            ApiInstance = new NtpApi(Config);
            MethodName = "GetNtpPolicyInventoryListWithHttpInfo";
        }
        ...
        public NtpPolicyInventory.TimezoneEnum Timezone
        {
            get;
            set;
        }
