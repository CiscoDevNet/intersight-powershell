...
{
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get HclDataImportLog.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightHclDataImportLog", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightHclDataImportLog : GetCmdletBase
    {
        public GetIntersightHclDataImportLog()
        {
            ApiInstance = new HclApi(Config);
            MethodName = "GetHclDataImportLogListWithHttpInfo";
        }
        ...
        // <summary>
        /// <para type="description">"Type of the initiator whether it is manual or a automated periodic operation by system. The value will be set during DoPost to Manual.\n* `Auto` - Import is auto triggered during service startup or periodic poll.\n* `Manual` - Import is triggered externally by devops using API."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]

        public HclDataImportLog.InitiatorTypeEnum InitiatorType
        {
            get;
            set;
        }
    ...
    public class GetIntersightHclExemptedCatalog : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"It indicates the personality of the sever."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightHclHwCatalogInfo : GetCmdletBase
    {
        ...
        {
            ApiInstance = new HclApi(Config);
            MethodName = "GetHclHwCatalogInfoListWithHttpInfo";
        }
    ...
    public class GetIntersightHclServerCatalog : GetCmdletBase
    {
        ...
        {
            ApiInstance = new HclApi(Config);
            MethodName = "GetHclServerCatalogListWithHttpInfo";
        }
    ...
    public class GetIntersightHclServerHwCatalogInfo : GetCmdletBase
    {
        ...
        {
            ApiInstance = new HclApi(Config);
            MethodName = "GetHclServerHwCatalogInfoListWithHttpInfo";
        }
