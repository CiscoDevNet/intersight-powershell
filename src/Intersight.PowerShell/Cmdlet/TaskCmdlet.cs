...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to New TaskPureFlashBladeScopedInventory.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "IntersightTaskPureFlashBladeScopedInventory", SupportsShouldProcess = true)]
    public class NewIntersightTaskPureFlashBladeScopedInventory : NewCmdletBase
    {
        public NewIntersightTaskPureFlashBladeScopedInventory()
        {
            ApiInstance = new TaskApi(Config);
            ModelObject = new TaskPureFlashBladeScopedInventory();
            MethodName = "CreateTaskPureFlashBladeScopedInventoryWithHttpInfo";
        }
