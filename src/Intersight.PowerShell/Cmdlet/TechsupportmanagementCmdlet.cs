...
namespace Intersight.PowerShell
{
    ...
    public class GetIntersightTechsupportmanagementEndPoint : GetCmdletBase
    {
        ...
        {
            ApiInstance = new TechsupportmanagementApi(Config);
            MethodName = "GetTechsupportmanagementEndPointListWithHttpInfo";
        }
    ...
    public class GetIntersightTechsupportmanagementTechSupportStatus : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"Status of the techsupport collection. Valid values are Scheduled, Pending, CollectionInProgress, CollectionFailed, CollectionComplete, UploadPending, UploadInProgress, UploadPartsComplete, UploadPreparingNextFile, UploadFailed, TechsupportDownloadUrlCreationFailed, PartiallyCompleted, AwaitingAllCollections, and Completed. The final status will be one of CollectionFailed, UploadFailed, or TechsupportDownloadUrlCreationFailed if there is a failure, Completed if the request completed successfully and the file (or files) were uploaded to Intersight Storage Service, or PartiallyCompleted if at least one file in a multiple file collection uploaded successfully. AwaitingAllCollections is a transient status used when regular techsupport collection fails but PseudoSamTech collection is still in progress. All the remaining status values indicates the progress of techsupport collection."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
