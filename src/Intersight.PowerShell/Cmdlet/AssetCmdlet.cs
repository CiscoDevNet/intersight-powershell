...
{
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Get AssetClaimToken.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "IntersightAssetClaimToken", DefaultParameterSetName = "CmdletParam", SupportsShouldProcess = true)]
    public class GetIntersightAssetClaimToken : GetCmdletBase
    {
        public GetIntersightAssetClaimToken()
        {
            ApiInstance = new AssetApi(Config);
            MethodName = "GetAssetClaimTokenListWithHttpInfo";
        }
    ...
    public class GetIntersightAssetClusterMember : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"The DNS hostname the device connector has used to connect to Intersight. Devices may be configured to connect to a set of DNS hostnames which all resolve to the same Intersight instance, the connected host is the latest hostname the device used to connect successfully to Intersight."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"The IP Address of the managed device as seen from Intersight at the time of registration.\nThis could be the IP address of the managed device's interface which has a route to the internet or a NAT IP address when the managed device is deployed in a private network."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightAssetGeoLocation : GetCmdletBase
    {
        ...
        {
            ApiInstance = new AssetApi(Config);
            MethodName = "GetAssetGeoLocationListWithHttpInfo";
        }
    ...
    public class GetIntersightAssetTarget : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"ExternalIpAddress is applicable for targets which are managed via an Intersight Device Connector. The value is the IP Address of the target as seen from Intersight. It is either the IP Address of the managed target's interface which has a route to the internet or a NAT IP Address when the target is deployed in a private network."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        public IamTrustPointRelationship TrustPoint
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to New AssetClaimToken.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.New, "IntersightAssetClaimToken", SupportsShouldProcess = true)]
    public class NewIntersightAssetClaimToken : NewCmdletBase
    {
        public NewIntersightAssetClaimToken()
        {
            ApiInstance = new AssetApi(Config);
            ModelObject = new AssetClaimToken();
            MethodName = "CreateAssetClaimTokenWithHttpInfo";
        }
    ...
    public class NewIntersightAssetGeoLocation : NewCmdletBase
    {
        ...
        {
            ApiInstance = new AssetApi(Config);
            ModelObject = new AssetGeoLocation();
            MethodName = "CreateAssetGeoLocationWithHttpInfo";
        }
        ...
        public CommPhysicalAddress Address
        {
            get;
            set;
        }
        ...
        public CommGeoPoint Coordinates
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Remove AssetClaimToken.</para>
    /// </summary>
    [Cmdlet(VerbsCommon.Remove, "IntersightAssetClaimToken", SupportsShouldProcess = true)]
    public class RemoveIntersightAssetClaimToken : RemoveCmdletBase
    {
        public RemoveIntersightAssetClaimToken()
        {
            ApiInstance = new AssetApi(Config);
            MethodName = "DeleteAssetClaimTokenWithHttpInfo";
        }
    }
    /// <summary>
    ...
    public class SetIntersightAssetGeoLocation : SetCmdletBase
    {
        public SetIntersightAssetGeoLocation()
        {
            ApiInstance = new AssetApi(Config);
            ModelObject = new AssetGeoLocation();
            MethodName = "UpdateAssetGeoLocationWithHttpInfo";
        }
