...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize NtpPolicyInventory.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightNtpPolicyInventory")]
    public class InitializeIntersightNtpPolicyInventory : PSCmdlet
    {
        public InitializeIntersightNtpPolicyInventory()
        {
            ClassId = NtpPolicyInventory.ClassIdEnum.NtpPolicyInventory;
            ObjectType = NtpPolicyInventory.ObjectTypeEnum.NtpPolicyInventory;
        ...
        public NtpPolicyInventory.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public NtpPolicyInventory.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.NtpPolicyInventory initObject = new Intersight.Model.NtpPolicyInventory();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
