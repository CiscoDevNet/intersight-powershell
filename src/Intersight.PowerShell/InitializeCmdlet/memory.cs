...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize MemoryPolicy.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightMemoryPolicy")]
    public class InitializeIntersightMemoryPolicy : PSCmdlet
    {
        public InitializeIntersightMemoryPolicy()
        {
            ClassId = MemoryPolicy.ClassIdEnum.MemoryPolicy;
            ObjectType = MemoryPolicy.ObjectTypeEnum.MemoryPolicy;
        ...
        public MemoryPolicy.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public MemoryPolicy.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.MemoryPolicy initObject = new Intersight.Model.MemoryPolicy();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
            ...
            if (this.MyInvocation.BoundParameters.ContainsKey("EnableDimmBlocklisting"))
            {
                initObject.EnableDimmBlocklisting = this.EnableDimmBlocklisting;
            }
            if (this.MyInvocation.BoundParameters.ContainsKey("Moid"))
            {
                initObject.Moid = this.Moid;
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize MemoryPolicyInventory.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightMemoryPolicyInventory")]
    public class InitializeIntersightMemoryPolicyInventory : PSCmdlet
    {
        public InitializeIntersightMemoryPolicyInventory()
        {
            ClassId = MemoryPolicyInventory.ClassIdEnum.MemoryPolicyInventory;
            ObjectType = MemoryPolicyInventory.ObjectTypeEnum.MemoryPolicyInventory;
        ...
        public MemoryPolicyInventory.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public MemoryPolicyInventory.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.MemoryPolicyInventory initObject = new Intersight.Model.MemoryPolicyInventory();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
