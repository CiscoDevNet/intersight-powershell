...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize SolPolicyInventory.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightSolPolicyInventory")]
    public class InitializeIntersightSolPolicyInventory : PSCmdlet
    {
        public InitializeIntersightSolPolicyInventory()
        {
            ClassId = SolPolicyInventory.ClassIdEnum.SolPolicyInventory;
            ObjectType = SolPolicyInventory.ObjectTypeEnum.SolPolicyInventory;
        ...
        public SolPolicyInventory.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public SolPolicyInventory.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.SolPolicyInventory initObject = new Intersight.Model.SolPolicyInventory();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
