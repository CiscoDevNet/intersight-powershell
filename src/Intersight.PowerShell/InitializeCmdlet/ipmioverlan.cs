...
{
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize IpmioverlanPolicy.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightIpmioverlanPolicy")]
    public class InitializeIntersightIpmioverlanPolicy : PSCmdlet
    {
        public InitializeIntersightIpmioverlanPolicy()
        {
            ClassId = IpmioverlanPolicy.ClassIdEnum.IpmioverlanPolicy;
            ObjectType = IpmioverlanPolicy.ObjectTypeEnum.IpmioverlanPolicy;
            Privilege = IpmioverlanPolicy.PrivilegeEnum.Admin;
        ...
        public IpmioverlanPolicy.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public IpmioverlanPolicy.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            Intersight.Model.IpmioverlanPolicy initObject = new Intersight.Model.IpmioverlanPolicy();
            ...
            if (this.MyInvocation.BoundParameters.ContainsKey("Privilege"))
            {
                initObject.Privilege = this.Privilege;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize IpmioverlanPolicyInventory.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightIpmioverlanPolicyInventory")]
    public class InitializeIntersightIpmioverlanPolicyInventory : PSCmdlet
    {
        public InitializeIntersightIpmioverlanPolicyInventory()
        {
            ClassId = IpmioverlanPolicyInventory.ClassIdEnum.IpmioverlanPolicyInventory;
            ObjectType = IpmioverlanPolicyInventory.ObjectTypeEnum.IpmioverlanPolicyInventory;
        ...
        public IpmioverlanPolicyInventory.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public IpmioverlanPolicyInventory.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.IpmioverlanPolicyInventory initObject = new Intersight.Model.IpmioverlanPolicyInventory();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
