...
namespace Intersight.PowerShell
{
    ...
    public class InitializeIntersightVnicEthAdapterPolicy : PSCmdlet
    {
        ...
        // <summary>
        /// <para type="description">"Enables EtherChannel Pinning to combine multiple physical links between two network switches into a single logical link. Transmit Queue Count should be at least 2 to enable ether channel pinning."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]

        public bool EtherChannelPinningEnabled
        {
            get;
            set;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.MyInvocation.BoundParameters.ContainsKey("EtherChannelPinningEnabled"))
            {
                initObject.EtherChannelPinningEnabled = this.EtherChannelPinningEnabled;
            }
    ...
    public class InitializeIntersightVnicEthIf : PSCmdlet
    {
        ...
        public List<Model.VnicNetFlowMonitorSession> NetFlowMonitorSessions
        {
            get;
            set;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.MyInvocation.BoundParameters.ContainsKey("NetFlowMonitorSessions"))
            {
                initObject.NetFlowMonitorSessions = this.NetFlowMonitorSessions;
            }
            initObject.ObjectType = this.ObjectType;
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize VnicEthIfOldInfo.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightVnicEthIfOldInfo")]
    public class InitializeIntersightVnicEthIfOldInfo : PSCmdlet
    {
        public InitializeIntersightVnicEthIfOldInfo()
        {
            ClassId = VnicEthIfOldInfo.ClassIdEnum.VnicEthIfOldInfo;
            ObjectType = VnicEthIfOldInfo.ObjectTypeEnum.VnicEthIfOldInfo;
        ...
        public VnicEthIfOldInfo.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public VnicEthIfOldInfo.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.VnicEthIfOldInfo initObject = new Intersight.Model.VnicEthIfOldInfo();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize VnicFcIfOldInfo.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightVnicFcIfOldInfo")]
    public class InitializeIntersightVnicFcIfOldInfo : PSCmdlet
    {
        public InitializeIntersightVnicFcIfOldInfo()
        {
            ClassId = VnicFcIfOldInfo.ClassIdEnum.VnicFcIfOldInfo;
            ObjectType = VnicFcIfOldInfo.ObjectTypeEnum.VnicFcIfOldInfo;
        ...
        public VnicFcIfOldInfo.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public VnicFcIfOldInfo.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.VnicFcIfOldInfo initObject = new Intersight.Model.VnicFcIfOldInfo();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize VnicLanSettings.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightVnicLanSettings")]
    public class InitializeIntersightVnicLanSettings : PSCmdlet
    {
        public InitializeIntersightVnicLanSettings()
        {
            ClassId = VnicLanSettings.ClassIdEnum.VnicLanSettings;
            ObjectType = VnicLanSettings.ObjectTypeEnum.VnicLanSettings;
        ...
        public VnicLanSettings.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public VnicLanSettings.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.VnicLanSettings initObject = new Intersight.Model.VnicLanSettings();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize VnicNetFlowMonitorSession.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightVnicNetFlowMonitorSession")]
    public class InitializeIntersightVnicNetFlowMonitorSession : PSCmdlet
    {
        public InitializeIntersightVnicNetFlowMonitorSession()
        {
            ClassId = VnicNetFlowMonitorSession.ClassIdEnum.VnicNetFlowMonitorSession;
            FlowDirection = VnicNetFlowMonitorSession.FlowDirectionEnum.Both;
            ObjectType = VnicNetFlowMonitorSession.ObjectTypeEnum.VnicNetFlowMonitorSession;
        ...
        public VnicNetFlowMonitorSession.ClassIdEnum ClassId
        {
            get;
            set;
        }
        // <summary>
        /// <para type="description">"Direction of the flow to monitor (ingress, egress, or both).\n* `both` - Both direction for NetFlow monitor.\n* `rx` - Input direction for NetFlow monitor.\n* `tx` - Output direction for NetFlow monitor."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]

        public VnicNetFlowMonitorSession.FlowDirectionEnum FlowDirection
        {
            get;
            set;
        }
        // <summary>
        /// <para type="description">"Name of the NetFlow monitor to use for this vNIC. The NetFlow monitor must be pre-configured on the Fabric Interconnects. It is configured as part of the NetFlow policy attached to the Fabric Switch Cluster profile."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        [ValidatePattern("^$|^[a-zA-Z0-9_.:-]{1,64}$")]
        ...
        public VnicNetFlowMonitorSession.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.VnicNetFlowMonitorSession initObject = new Intersight.Model.VnicNetFlowMonitorSession();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
            initObject.ClassId = this.ClassId;
            if (this.MyInvocation.BoundParameters.ContainsKey("FlowDirection"))
            {
                initObject.FlowDirection = this.FlowDirection;
            }
            if (this.MyInvocation.BoundParameters.ContainsKey("MonitorName"))
            {
                initObject.MonitorName = this.MonitorName;
            }
            initObject.ObjectType = this.ObjectType;
            WriteObject(initObject);
        }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize VnicSanSettings.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightVnicSanSettings")]
    public class InitializeIntersightVnicSanSettings : PSCmdlet
    {
        public InitializeIntersightVnicSanSettings()
        {
            ClassId = VnicSanSettings.ClassIdEnum.VnicSanSettings;
            ObjectType = VnicSanSettings.ObjectTypeEnum.VnicSanSettings;
        ...
        public VnicSanSettings.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public VnicSanSettings.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.VnicSanSettings initObject = new Intersight.Model.VnicSanSettings();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize VnicSanSettingsOldInfo.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightVnicSanSettingsOldInfo")]
    public class InitializeIntersightVnicSanSettingsOldInfo : PSCmdlet
    {
        public InitializeIntersightVnicSanSettingsOldInfo()
        {
            ClassId = VnicSanSettingsOldInfo.ClassIdEnum.VnicSanSettingsOldInfo;
            ObjectType = VnicSanSettingsOldInfo.ObjectTypeEnum.VnicSanSettingsOldInfo;
        ...
        public VnicSanSettingsOldInfo.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public VnicSanSettingsOldInfo.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        // <summary>
        /// <para type="description">"The WWN pool used for assigning the WWNN address to the server node."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]

        public Model.MoMoRef WwnnPool
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.VnicSanSettingsOldInfo initObject = new Intersight.Model.VnicSanSettingsOldInfo();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize VnicServiceEthIf.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightVnicServiceEthIf")]
    public class InitializeIntersightVnicServiceEthIf : PSCmdlet
    {
        public InitializeIntersightVnicServiceEthIf()
        {
            ClassId = VnicServiceEthIf.ClassIdEnum.VnicServiceEthIf;
            ObjectType = VnicServiceEthIf.ObjectTypeEnum.VnicServiceEthIf;

        }
        // <summary>
        /// <para type="description">"Adapter Information for server."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        ...
        public VnicServiceEthIf.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Name of the service virtual ethernet interface."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        [ValidatePattern("^[a-zA-Z0-9-._:]+$")]
        public string Name
        ...
        public VnicServiceEthIf.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.VnicServiceEthIf initObject = new Intersight.Model.VnicServiceEthIf();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdapterId"))
            {
                initObject.AdapterId = this.AdapterId;
            }
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize VnicServiceEthIfInventory.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightVnicServiceEthIfInventory")]
    public class InitializeIntersightVnicServiceEthIfInventory : PSCmdlet
    {
        public InitializeIntersightVnicServiceEthIfInventory()
        {
            ClassId = VnicServiceEthIfInventory.ClassIdEnum.VnicServiceEthIfInventory;
            ObjectType = VnicServiceEthIfInventory.ObjectTypeEnum.VnicServiceEthIfInventory;
        ...
        public VnicServiceEthIfInventory.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public VnicServiceEthIfInventory.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.VnicServiceEthIfInventory initObject = new Intersight.Model.VnicServiceEthIfInventory();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize VnicVifIdPool.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightVnicVifIdPool")]
    public class InitializeIntersightVnicVifIdPool : PSCmdlet
    {
        public InitializeIntersightVnicVifIdPool()
        {
            ClassId = VnicVifIdPool.ClassIdEnum.VnicVifIdPool;
            ObjectType = VnicVifIdPool.ObjectTypeEnum.VnicVifIdPool;
        ...
        public VnicVifIdPool.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public VnicVifIdPool.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.VnicVifIdPool initObject = new Intersight.Model.VnicVifIdPool();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
