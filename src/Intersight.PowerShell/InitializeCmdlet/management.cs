...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize ManagementReplayConfigInfo.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightManagementReplayConfigInfo")]
    public class InitializeIntersightManagementReplayConfigInfo : PSCmdlet
    {
        public InitializeIntersightManagementReplayConfigInfo()
        {
            ClassId = ManagementReplayConfigInfo.ClassIdEnum.ManagementReplayConfigInfo;
            ObjectType = ManagementReplayConfigInfo.ObjectTypeEnum.ManagementReplayConfigInfo;
        ...
        public ManagementReplayConfigInfo.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public ManagementReplayConfigInfo.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.ManagementReplayConfigInfo initObject = new Intersight.Model.ManagementReplayConfigInfo();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
