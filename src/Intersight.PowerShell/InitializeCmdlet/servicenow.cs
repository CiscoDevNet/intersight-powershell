...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize ServicenowChangeRequestDoc.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightServicenowChangeRequestDoc")]
    public class InitializeIntersightServicenowChangeRequestDoc : PSCmdlet
    {
        public InitializeIntersightServicenowChangeRequestDoc()
        {
            ClassId = ServicenowChangeRequestDoc.ClassIdEnum.ServicenowChangeRequestDoc;
            ObjectType = ServicenowChangeRequestDoc.ObjectTypeEnum.ServicenowChangeRequestDoc;
        ...
        public ServicenowChangeRequestDoc.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public ServicenowChangeRequestDoc.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.ServicenowChangeRequestDoc initObject = new Intersight.Model.ServicenowChangeRequestDoc();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
            initObject.ClassId = this.ClassId;
            if (this.MyInvocation.BoundParameters.ContainsKey("ExampleValue"))
            {
                initObject.ExampleValue = this.ExampleValue;
            }
            if (this.MyInvocation.BoundParameters.ContainsKey("InternalType"))
            {
                initObject.InternalType = this.InternalType;
            }
            ...
            {
                initObject.PropertyName = this.PropertyName;
            }
            if (this.MyInvocation.BoundParameters.ContainsKey("Tags"))
            {
                initObject.Tags = this.Tags;
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize ServicenowIncidentDoc.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightServicenowIncidentDoc")]
    public class InitializeIntersightServicenowIncidentDoc : PSCmdlet
    {
        public InitializeIntersightServicenowIncidentDoc()
        {
            ClassId = ServicenowIncidentDoc.ClassIdEnum.ServicenowIncidentDoc;
            ObjectType = ServicenowIncidentDoc.ObjectTypeEnum.ServicenowIncidentDoc;
        ...
        public ServicenowIncidentDoc.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public ServicenowIncidentDoc.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.ServicenowIncidentDoc initObject = new Intersight.Model.ServicenowIncidentDoc();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
