...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize EtherInterSwitchPort.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightEtherInterSwitchPort")]
    public class InitializeIntersightEtherInterSwitchPort : PSCmdlet
    {
        public InitializeIntersightEtherInterSwitchPort()
        {
            ClassId = EtherInterSwitchPort.ClassIdEnum.EtherInterSwitchPort;
            ObjectType = EtherInterSwitchPort.ObjectTypeEnum.EtherInterSwitchPort;
        ...
        public EtherInterSwitchPort.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public EtherInterSwitchPort.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        public Model.EtherInterSwitchPortRelationship PeerInterface
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.EtherInterSwitchPort initObject = new Intersight.Model.EtherInterSwitchPort();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize EtherLanPort.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightEtherLanPort")]
    public class InitializeIntersightEtherLanPort : PSCmdlet
    {
        public InitializeIntersightEtherLanPort()
        {
            ClassId = EtherLanPort.ClassIdEnum.EtherLanPort;
            ObjectType = EtherLanPort.ObjectTypeEnum.EtherLanPort;
        ...
        public EtherLanPort.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public EtherLanPort.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.EtherLanPort initObject = new Intersight.Model.EtherLanPort();
            if (this.MyInvocation.BoundParameters.ContainsKey("AcknowledgedPeerInterface"))
            {
                initObject.AcknowledgedPeerInterface = this.AcknowledgedPeerInterface;
            }
