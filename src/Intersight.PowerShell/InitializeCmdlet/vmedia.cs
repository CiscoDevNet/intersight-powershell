...
namespace Intersight.PowerShell
{
    ...
    public class InitializeIntersightVmediaPolicy : PSCmdlet
    {
        ...
        // <summary>
        /// <para type="description">"If enabled, allows encryption of all Virtual Media communications. Please note that this can no longer be disabled for servers running versions 4.2 and above."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize VmediaPolicyInventory.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightVmediaPolicyInventory")]
    public class InitializeIntersightVmediaPolicyInventory : PSCmdlet
    {
        public InitializeIntersightVmediaPolicyInventory()
        {
            ClassId = VmediaPolicyInventory.ClassIdEnum.VmediaPolicyInventory;
            ObjectType = VmediaPolicyInventory.ObjectTypeEnum.VmediaPolicyInventory;
        ...
        public VmediaPolicyInventory.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public VmediaPolicyInventory.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.VmediaPolicyInventory initObject = new Intersight.Model.VmediaPolicyInventory();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
