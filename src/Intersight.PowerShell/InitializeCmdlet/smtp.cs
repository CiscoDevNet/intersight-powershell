...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize SmtpPolicyInventory.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightSmtpPolicyInventory")]
    public class InitializeIntersightSmtpPolicyInventory : PSCmdlet
    {
        public InitializeIntersightSmtpPolicyInventory()
        {
            ClassId = SmtpPolicyInventory.ClassIdEnum.SmtpPolicyInventory;
            ObjectType = SmtpPolicyInventory.ObjectTypeEnum.SmtpPolicyInventory;
        ...
        public SmtpPolicyInventory.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public SmtpPolicyInventory.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.SmtpPolicyInventory initObject = new Intersight.Model.SmtpPolicyInventory();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize SmtpPolicyTest.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightSmtpPolicyTest")]
    public class InitializeIntersightSmtpPolicyTest : PSCmdlet
    {
        public InitializeIntersightSmtpPolicyTest()
        {
            ClassId = SmtpPolicyTest.ClassIdEnum.SmtpPolicyTest;
            ObjectType = SmtpPolicyTest.ObjectTypeEnum.SmtpPolicyTest;
        ...
        public SmtpPolicyTest.ClassIdEnum ClassId
        {
            get;
            set;
        }
        // <summary>
        /// <para type="description">"If enabled, an attempt will be made to send a test email notification to the configured recipients."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        ...
        public SmtpPolicyTest.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        // <summary>
        /// <para type="description">"A reference to a smtpPolicy resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]

        public Model.SmtpPolicyRelationship Policy
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.SmtpPolicyTest initObject = new Intersight.Model.SmtpPolicyTest();
            ...
            if (this.MyInvocation.BoundParameters.ContainsKey("Recipients"))
            {
                initObject.Recipients = this.Recipients;
            }
            if (this.MyInvocation.BoundParameters.ContainsKey("Tags"))
            {
                initObject.Tags = this.Tags;
