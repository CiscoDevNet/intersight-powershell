...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize KvmPolicyInventory.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightKvmPolicyInventory")]
    public class InitializeIntersightKvmPolicyInventory : PSCmdlet
    {
        public InitializeIntersightKvmPolicyInventory()
        {
            ClassId = KvmPolicyInventory.ClassIdEnum.KvmPolicyInventory;
            ObjectType = KvmPolicyInventory.ObjectTypeEnum.KvmPolicyInventory;
        ...
        public KvmPolicyInventory.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public KvmPolicyInventory.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        protected override void ProcessRecord()
        {
            Intersight.Model.KvmPolicyInventory initObject = new Intersight.Model.KvmPolicyInventory();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
