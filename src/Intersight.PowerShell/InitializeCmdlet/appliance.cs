...
namespace Intersight.PowerShell
{
    ...
    public class InitializeIntersightApplianceBackup : PSCmdlet
    {
        ...
        // <summary>
        /// <para type="description">"Set to true to allow deletion of the oldest local backup when local backup retention limit is reached. If false and retention count is reached, the backup operation fails."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        ...
        // <summary>
        /// <para type="description">"Hostname of the remote file server. Not required when protocol is local."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        ...
        // <summary>
        /// <para type="description">"File server directory or share name to copy the file. Not required when protocol is local."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        [ValidatePattern("^$|^[^`]+$")]
        ...
        // <summary>
        /// <para type="description">"Remote TCP port on the file server (e.g. 22 for scp). Not required when protocol is local."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        ...
        // <summary>
        /// <para type="description">"Set to true to inherit credentials, protocol, and file server settings from the appliance backup policy. If false, use explicit settings provided in this backup object."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]

        public bool UsePolicySettings
        {
            get;
            set;
        }
        // <summary>
        /// <para type="description">"Username to authenticate the fileserver. Not required when protocol is local."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.MyInvocation.BoundParameters.ContainsKey("UsePolicySettings"))
            {
                initObject.UsePolicySettings = this.UsePolicySettings;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize ApplianceBackupDownload.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightApplianceBackupDownload")]
    public class InitializeIntersightApplianceBackupDownload : PSCmdlet
    {
        public InitializeIntersightApplianceBackupDownload()
        {
            ClassId = ApplianceBackupDownload.ClassIdEnum.ApplianceBackupDownload;
            ObjectType = ApplianceBackupDownload.ObjectTypeEnum.ApplianceBackupDownload;
        ...
        public ApplianceBackupDownload.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public ApplianceBackupDownload.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.ApplianceBackupDownload initObject = new Intersight.Model.ApplianceBackupDownload();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize ApplianceCpuUtilization.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightApplianceCpuUtilization")]
    public class InitializeIntersightApplianceCpuUtilization : PSCmdlet
    {
        public InitializeIntersightApplianceCpuUtilization()
        {
            ClassId = ApplianceCpuUtilization.ClassIdEnum.ApplianceCpuUtilization;
            ObjectType = ApplianceCpuUtilization.ObjectTypeEnum.ApplianceCpuUtilization;
        ...
        public ApplianceCpuUtilization.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public ApplianceCpuUtilization.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.ApplianceCpuUtilization initObject = new Intersight.Model.ApplianceCpuUtilization();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize ApplianceFileSystemOpSummary.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightApplianceFileSystemOpSummary")]
    public class InitializeIntersightApplianceFileSystemOpSummary : PSCmdlet
    {
        public InitializeIntersightApplianceFileSystemOpSummary()
        {
            ClassId = ApplianceFileSystemOpSummary.ClassIdEnum.ApplianceFileSystemOpSummary;
            ObjectType = ApplianceFileSystemOpSummary.ObjectTypeEnum.ApplianceFileSystemOpSummary;
        ...
        public ApplianceFileSystemOpSummary.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public ApplianceFileSystemOpSummary.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.ApplianceFileSystemOpSummary initObject = new Intersight.Model.ApplianceFileSystemOpSummary();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize ApplianceFileSystemTelemetry.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightApplianceFileSystemTelemetry")]
    public class InitializeIntersightApplianceFileSystemTelemetry : PSCmdlet
    {
        public InitializeIntersightApplianceFileSystemTelemetry()
        {
            ClassId = ApplianceFileSystemTelemetry.ClassIdEnum.ApplianceFileSystemTelemetry;
            ObjectType = ApplianceFileSystemTelemetry.ObjectTypeEnum.ApplianceFileSystemTelemetry;
        ...
        public ApplianceFileSystemTelemetry.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public ApplianceFileSystemTelemetry.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.ApplianceFileSystemTelemetry initObject = new Intersight.Model.ApplianceFileSystemTelemetry();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize ApplianceFqdnUpdate.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightApplianceFqdnUpdate")]
    public class InitializeIntersightApplianceFqdnUpdate : PSCmdlet
    {
        public InitializeIntersightApplianceFqdnUpdate()
        {
            ClassId = ApplianceFqdnUpdate.ClassIdEnum.ApplianceFqdnUpdate;
            ObjectType = ApplianceFqdnUpdate.ObjectTypeEnum.ApplianceFqdnUpdate;
        ...
        public ApplianceFqdnUpdate.ClassIdEnum ClassId
        {
            get;
            set;
        }
        // <summary>
        /// <para type="description">"The FQDN (fully qualified domain name) of the destination appliance for target migration."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        ...
        public ApplianceFqdnUpdate.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.ApplianceFqdnUpdate initObject = new Intersight.Model.ApplianceFqdnUpdate();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
            initObject.ClassId = this.ClassId;
            if (this.MyInvocation.BoundParameters.ContainsKey("Fqdn"))
            {
                initObject.Fqdn = this.Fqdn;
            }
            if (this.MyInvocation.BoundParameters.ContainsKey("Moid"))
            {
                initObject.Moid = this.Moid;
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize ApplianceMemoryUtilization.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightApplianceMemoryUtilization")]
    public class InitializeIntersightApplianceMemoryUtilization : PSCmdlet
    {
        public InitializeIntersightApplianceMemoryUtilization()
        {
            ClassId = ApplianceMemoryUtilization.ClassIdEnum.ApplianceMemoryUtilization;
            ObjectType = ApplianceMemoryUtilization.ObjectTypeEnum.ApplianceMemoryUtilization;
        ...
        public ApplianceMemoryUtilization.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public ApplianceMemoryUtilization.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.ApplianceMemoryUtilization initObject = new Intersight.Model.ApplianceMemoryUtilization();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize ApplianceMetricsIngestionUtilization.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightApplianceMetricsIngestionUtilization")]
    public class InitializeIntersightApplianceMetricsIngestionUtilization : PSCmdlet
    {
        public InitializeIntersightApplianceMetricsIngestionUtilization()
        {
            ClassId = ApplianceMetricsIngestionUtilization.ClassIdEnum.ApplianceMetricsIngestionUtilization;
            ObjectType = ApplianceMetricsIngestionUtilization.ObjectTypeEnum.ApplianceMetricsIngestionUtilization;
        ...
        public ApplianceMetricsIngestionUtilization.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public ApplianceMetricsIngestionUtilization.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.ApplianceMetricsIngestionUtilization initObject = new Intersight.Model.ApplianceMetricsIngestionUtilization();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize ApplianceNodeIopsMetric.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightApplianceNodeIopsMetric")]
    public class InitializeIntersightApplianceNodeIopsMetric : PSCmdlet
    {
        public InitializeIntersightApplianceNodeIopsMetric()
        {
            ClassId = ApplianceNodeIopsMetric.ClassIdEnum.ApplianceNodeIopsMetric;
            ObjectType = ApplianceNodeIopsMetric.ObjectTypeEnum.ApplianceNodeIopsMetric;
        ...
        public ApplianceNodeIopsMetric.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public ApplianceNodeIopsMetric.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.ApplianceNodeIopsMetric initObject = new Intersight.Model.ApplianceNodeIopsMetric();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize ApplianceNodeTelemetry.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightApplianceNodeTelemetry")]
    public class InitializeIntersightApplianceNodeTelemetry : PSCmdlet
    {
        public InitializeIntersightApplianceNodeTelemetry()
        {
            ClassId = ApplianceNodeTelemetry.ClassIdEnum.ApplianceNodeTelemetry;
            ObjectType = ApplianceNodeTelemetry.ObjectTypeEnum.ApplianceNodeTelemetry;
        ...
        public ApplianceNodeTelemetry.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public ApplianceNodeTelemetry.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.ApplianceNodeTelemetry initObject = new Intersight.Model.ApplianceNodeTelemetry();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
