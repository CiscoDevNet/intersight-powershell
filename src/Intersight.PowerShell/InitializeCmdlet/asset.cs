...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize AssetClaimToken.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightAssetClaimToken")]
    public class InitializeIntersightAssetClaimToken : PSCmdlet
    {
        public InitializeIntersightAssetClaimToken()
        {
            ClassId = AssetClaimToken.ClassIdEnum.AssetClaimToken;
            ObjectType = AssetClaimToken.ObjectTypeEnum.AssetClaimToken;
        ...
        // <summary>
        /// <para type="description">"The claim generated to configure the device to connect and claim to the user account."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        ...
        public AssetClaimToken.ClassIdEnum ClassId
        {
            get;
            set;
        }
        // <summary>
        /// <para type="description">"The expiry time of the claim token, after this time any generated claims from this token are no longer valid."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        ...
        public AssetClaimToken.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.AssetClaimToken initObject = new Intersight.Model.AssetClaimToken();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
            if (this.MyInvocation.BoundParameters.ContainsKey("Claim"))
            {
                initObject.Claim = this.Claim;
            }
            initObject.ClassId = this.ClassId;
            if (this.MyInvocation.BoundParameters.ContainsKey("ExpirationDate"))
            {
                initObject.ExpirationDate = this.ExpirationDate;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize AssetGeoLocation.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightAssetGeoLocation")]
    public class InitializeIntersightAssetGeoLocation : PSCmdlet
    {
        public InitializeIntersightAssetGeoLocation()
        {
            ClassId = AssetGeoLocation.ClassIdEnum.AssetGeoLocation;
            ObjectType = AssetGeoLocation.ObjectTypeEnum.AssetGeoLocation;
        ...
        // <summary>
        /// <para type="description">"The location's street address."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]

        public Model.CommPhysicalAddress Address
        {
            get;
            set;
        }
        ...
        public AssetGeoLocation.ClassIdEnum ClassId
        {
            get;
            set;
        }
        // <summary>
        /// <para type="description">"The location's longitude and latitude coordinates."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]

        public Model.CommGeoPoint Coordinates
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"A user provided name for the location."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        ...
        public AssetGeoLocation.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.AssetGeoLocation initObject = new Intersight.Model.AssetGeoLocation();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
            ...
            initObject.ClassId = this.ClassId;
            if (this.MyInvocation.BoundParameters.ContainsKey("Coordinates"))
            {
                initObject.Coordinates = this.Coordinates;
            }
            if (this.MyInvocation.BoundParameters.ContainsKey("Moid"))
            {
                initObject.Moid = this.Moid;
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize AssetSplunkTokenCredential.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightAssetSplunkTokenCredential")]
    public class InitializeIntersightAssetSplunkTokenCredential : PSCmdlet
    {
        public InitializeIntersightAssetSplunkTokenCredential()
        {
            ClassId = AssetSplunkTokenCredential.ClassIdEnum.AssetSplunkTokenCredential;
            ObjectType = AssetSplunkTokenCredential.ObjectTypeEnum.AssetSplunkTokenCredential;
        ...
        public AssetSplunkTokenCredential.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public AssetSplunkTokenCredential.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        // <summary>
        /// <para type="description">"The Splunk token used to authenticate with a managed target."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.AssetSplunkTokenCredential initObject = new Intersight.Model.AssetSplunkTokenCredential();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize AssetToken.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightAssetToken")]
    public class InitializeIntersightAssetToken : PSCmdlet
    {
        public InitializeIntersightAssetToken()
        {
            ClassId = AssetToken.ClassIdEnum.AssetToken;
            ObjectType = AssetToken.ObjectTypeEnum.AssetToken;
        ...
        public AssetToken.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public AssetToken.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.AssetToken initObject = new Intersight.Model.AssetToken();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
