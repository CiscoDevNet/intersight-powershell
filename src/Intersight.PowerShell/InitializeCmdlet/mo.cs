...
{
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize MoBaseComplexType.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightMoBaseComplexType")]
    public class InitializeIntersightMoBaseComplexType : PSCmdlet
    {
        public InitializeIntersightMoBaseComplexType()
        {
        ...
        public MoBaseComplexType.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public MoBaseComplexType.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            Intersight.Model.MoBaseComplexType initObject = new Intersight.Model.MoBaseComplexType();
