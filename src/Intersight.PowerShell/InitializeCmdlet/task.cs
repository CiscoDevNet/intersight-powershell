...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize TaskPureFlashBladeScopedInventory.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightTaskPureFlashBladeScopedInventory")]
    public class InitializeIntersightTaskPureFlashBladeScopedInventory : PSCmdlet
    {
        public InitializeIntersightTaskPureFlashBladeScopedInventory()
        {
            ClassId = TaskPureFlashBladeScopedInventory.ClassIdEnum.TaskPureFlashBladeScopedInventory;
            ObjectType = TaskPureFlashBladeScopedInventory.ObjectTypeEnum.TaskPureFlashBladeScopedInventory;
        ...
        public TaskPureFlashBladeScopedInventory.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public TaskPureFlashBladeScopedInventory.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.TaskPureFlashBladeScopedInventory initObject = new Intersight.Model.TaskPureFlashBladeScopedInventory();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
