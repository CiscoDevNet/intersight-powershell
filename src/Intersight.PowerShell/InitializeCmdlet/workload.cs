...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize WorkloadClearWorkloadTag.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightWorkloadClearWorkloadTag")]
    public class InitializeIntersightWorkloadClearWorkloadTag : PSCmdlet
    {
        public InitializeIntersightWorkloadClearWorkloadTag()
        {
            ClassId = WorkloadClearWorkloadTag.ClassIdEnum.WorkloadClearWorkloadTag;
            ObjectType = WorkloadClearWorkloadTag.ObjectTypeEnum.WorkloadClearWorkloadTag;
        ...
        public WorkloadClearWorkloadTag.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public WorkloadClearWorkloadTag.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        public List<Model.MoMoRef> Objects
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.WorkloadClearWorkloadTag initObject = new Intersight.Model.WorkloadClearWorkloadTag();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
            ...
            initObject.ObjectType = this.ObjectType;
            if (this.MyInvocation.BoundParameters.ContainsKey("Objects"))
            {
                initObject.Objects = this.Objects;
            }
            if (this.MyInvocation.BoundParameters.ContainsKey("Tags"))
            {
                initObject.Tags = this.Tags;
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize WorkloadRenameRequest.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightWorkloadRenameRequest")]
    public class InitializeIntersightWorkloadRenameRequest : PSCmdlet
    {
        public InitializeIntersightWorkloadRenameRequest()
        {
            Action = WorkloadRenameRequest.ActionEnum.None;
            ClassId = WorkloadRenameRequest.ClassIdEnum.WorkloadRenameRequest;
            ObjectType = WorkloadRenameRequest.ObjectTypeEnum.WorkloadRenameRequest;

        }
        // <summary>
        /// <para type="description">"The action to be taken for the rename operation on an object.\n* `None` - No action is to be taken for the rename request.\n* `Rename` - The object is to be renamed with the new name in the request."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]

        public WorkloadRenameRequest.ActionEnum Action
        {
            get;
            set;
        }
        ...
        public WorkloadRenameRequest.ClassIdEnum ClassId
        {
            get;
            set;
        }
        // <summary>
        /// <para type="description">"The new name for the object. This name will be used to rename all objects associated with it."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        ...
        public WorkloadRenameRequest.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.WorkloadRenameRequest initObject = new Intersight.Model.WorkloadRenameRequest();
    ...
    public class InitializeIntersightWorkloadWorkloadDeployment : PSCmdlet
    {
        ...
        // <summary>
        /// <para type="description">"The request for the renaming operation on the workload deployment object."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]

        public Model.WorkloadRenameRequest RenameRequest
        {
            get;
            set;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.MyInvocation.BoundParameters.ContainsKey("RenameRequest"))
            {
                initObject.RenameRequest = this.RenameRequest;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize WorkloadWorkloadMetadata.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightWorkloadWorkloadMetadata")]
    public class InitializeIntersightWorkloadWorkloadMetadata : PSCmdlet
    {
        public InitializeIntersightWorkloadWorkloadMetadata()
        {
            ClassId = WorkloadWorkloadMetadata.ClassIdEnum.WorkloadWorkloadMetadata;
            ObjectType = WorkloadWorkloadMetadata.ObjectTypeEnum.WorkloadWorkloadMetadata;
        ...
        public WorkloadWorkloadMetadata.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public WorkloadWorkloadMetadata.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"The request for the renaming operation on the workload definition object."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false)]
        ...
        {
            PSUtils.ProcessRelationshipParam(this.MyInvocation.BoundParameters);
            Intersight.Model.WorkloadWorkloadMetadata initObject = new Intersight.Model.WorkloadWorkloadMetadata();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
