...
{
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize ProcessorUnit.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightProcessorUnit")]
    public class InitializeIntersightProcessorUnit:PSCmdlet
	{
		public InitializeIntersightProcessorUnit()
		{
            ClassId = ProcessorUnit.ClassIdEnum.ProcessorUnit;
            ObjectType = ProcessorUnit.ObjectTypeEnum.ProcessorUnit;
        ...
        public ProcessorUnit.ClassIdEnum ClassId {
            get;
            set;
        }
        // <summary>
        ...
        public ProcessorUnit.ObjectTypeEnum ObjectType {
            get;
            set;
        }
        // <summary>
        ...
        {
             Intersight.Model.ProcessorUnit initObject = new Intersight.Model.ProcessorUnit();
