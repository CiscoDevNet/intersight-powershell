...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize AccessIpAddress.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightAccessIpAddress")]
    public class InitializeIntersightAccessIpAddress : PSCmdlet
    {
        public InitializeIntersightAccessIpAddress()
        {
            ClassId = AccessIpAddress.ClassIdEnum.AccessIpAddress;
            ObjectType = AccessIpAddress.ObjectTypeEnum.AccessIpAddress;
        ...
        public AccessIpAddress.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public AccessIpAddress.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        protected override void ProcessRecord()
        {
            Intersight.Model.AccessIpAddress initObject = new Intersight.Model.AccessIpAddress();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize AccessPolicyInventory.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightAccessPolicyInventory")]
    public class InitializeIntersightAccessPolicyInventory : PSCmdlet
    {
        public InitializeIntersightAccessPolicyInventory()
        {
            ClassId = AccessPolicyInventory.ClassIdEnum.AccessPolicyInventory;
            ObjectType = AccessPolicyInventory.ObjectTypeEnum.AccessPolicyInventory;
        ...
        public AccessPolicyInventory.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public AccessPolicyInventory.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        protected override void ProcessRecord()
        {
            Intersight.Model.AccessPolicyInventory initObject = new Intersight.Model.AccessPolicyInventory();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
