...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize CertificatemanagementPolicyInventory.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightCertificatemanagementPolicyInventory")]
    public class InitializeIntersightCertificatemanagementPolicyInventory : PSCmdlet
    {
        public InitializeIntersightCertificatemanagementPolicyInventory()
        {
            ClassId = CertificatemanagementPolicyInventory.ClassIdEnum.CertificatemanagementPolicyInventory;
            ObjectType = CertificatemanagementPolicyInventory.ObjectTypeEnum.CertificatemanagementPolicyInventory;
        ...
        public CertificatemanagementPolicyInventory.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public CertificatemanagementPolicyInventory.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        protected override void ProcessRecord()
        {
            Intersight.Model.CertificatemanagementPolicyInventory initObject = new Intersight.Model.CertificatemanagementPolicyInventory();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
