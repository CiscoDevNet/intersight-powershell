...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize NetworkconfigPolicyInventory.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightNetworkconfigPolicyInventory")]
    public class InitializeIntersightNetworkconfigPolicyInventory : PSCmdlet
    {
        public InitializeIntersightNetworkconfigPolicyInventory()
        {
            ClassId = NetworkconfigPolicyInventory.ClassIdEnum.NetworkconfigPolicyInventory;
            ObjectType = NetworkconfigPolicyInventory.ObjectTypeEnum.NetworkconfigPolicyInventory;
        ...
        public NetworkconfigPolicyInventory.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public NetworkconfigPolicyInventory.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        protected override void ProcessRecord()
        {
            Intersight.Model.NetworkconfigPolicyInventory initObject = new Intersight.Model.NetworkconfigPolicyInventory();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
