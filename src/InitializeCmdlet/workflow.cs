...
namespace Intersight.PowerShell
{
    ...
    public class InitializeIntersightWorkflowJoinTask:PSCmdlet
	{
        ...
        public List<string> JoinOnTasks {
            get;
            set;
        }
        // <summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.MyInvocation.BoundParameters.ContainsKey("JoinOnTasks"))
            {
                initObject.JoinOnTasks = this.JoinOnTasks;
            }
            if (this.MyInvocation.BoundParameters.ContainsKey("Label"))
            {
                initObject.Label = this.Label;
    ...
    public class InitializeIntersightWorkflowEnumEntry:PSCmdlet
	{
        ...
        // <summary>
        /// <para type="description">"Label for the enum value. A user friendly short string to identify the enum value. Label can only contain letters (a-z, A-Z), numbers (0-9), hyphen (-), period (.), colon (:), space ( ), single quote ('), forward slash (/), or an underscore (_)."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true,ValueFromPipeline = false)]
    ...
    public class InitializeIntersightWorkflowAssociatedRoles:PSCmdlet
	{
        ...
        public List<Model.WorkflowAssociatedRoles> WorkflowRoles {
            get;
            set;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.MyInvocation.BoundParameters.ContainsKey("TaskNames"))
            {
                initObject.TaskNames = this.TaskNames;
            }
            if (this.MyInvocation.BoundParameters.ContainsKey("WorkflowRoles"))
            {
                initObject.WorkflowRoles = this.WorkflowRoles;
            }
            WriteObject(initObject);
        }
    ...
    public class InitializeIntersightWorkflowValidationInformation:PSCmdlet
	{
        ...
        public List<Model.WorkflowValidationError> ValidationError {
            get;
            set;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            initObject.ClassId = this.ClassId;
            initObject.ObjectType = this.ObjectType;
            if (this.MyInvocation.BoundParameters.ContainsKey("ValidationError"))
            {
                initObject.ValidationError = this.ValidationError;
            }
            WriteObject(initObject);
        }
