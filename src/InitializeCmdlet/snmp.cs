...
namespace Intersight.PowerShell
{
    ...
    /// <summary>
    /// <para type="synopsis">This is the cmdlet to Initialize SnmpPolicyInventory.</para>
    /// </summary>
    [Cmdlet(VerbsData.Initialize, "IntersightSnmpPolicyInventory")]
    public class InitializeIntersightSnmpPolicyInventory : PSCmdlet
    {
        public InitializeIntersightSnmpPolicyInventory()
        {
            ClassId = SnmpPolicyInventory.ClassIdEnum.SnmpPolicyInventory;
            ObjectType = SnmpPolicyInventory.ObjectTypeEnum.SnmpPolicyInventory;
        ...
        public SnmpPolicyInventory.ClassIdEnum ClassId
        {
            get;
            set;
        }
        ...
        public SnmpPolicyInventory.ObjectTypeEnum ObjectType
        {
            get;
            set;
        }
        ...
        protected override void ProcessRecord()
        {
            Intersight.Model.SnmpPolicyInventory initObject = new Intersight.Model.SnmpPolicyInventory();
            if (this.MyInvocation.BoundParameters.ContainsKey("AdditionalProperties"))
            {
                initObject.AdditionalProperties = this.AdditionalProperties;
            }
