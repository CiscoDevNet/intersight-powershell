...
namespace Intersight.PowerShell
{
    ...
    public class InitializeIntersightStoragePhysicalDisk:PSCmdlet
	{
        ...
        protected override void ProcessRecord()
        {
            ...
            if (this.MyInvocation.BoundParameters.ContainsKey("ReadErrorCountThreshold"))
            {
                initObject.ReadErrorCountThreshold = this.ReadErrorCountThreshold;
            }
            ...
            if (this.MyInvocation.BoundParameters.ContainsKey("WriteErrorCountThreshold"))
            {
                initObject.WriteErrorCountThreshold = this.WriteErrorCountThreshold;
            }
            if (this.MyInvocation.BoundParameters.ContainsKey("WriteIoErrorCount"))
            {
                initObject.WriteIoErrorCount = this.WriteIoErrorCount;
            }
            WriteObject(initObject);
        }
    ...
    public class InitializeIntersightStorageBaseInitiator:PSCmdlet
	{
		...
		{
            ClassId = StorageBaseInitiator.ClassIdEnum.StorageHitachiInitiator;
            ObjectType = StorageBaseInitiator.ObjectTypeEnum.StorageHitachiInitiator;
    ...
    public class InitializeIntersightStorageNetAppCluster:PSCmdlet
	{
        ...
        public Model.StorageNetAppStorageClusterEfficiency ClusterEfficiency {
            get;
            set;
        }
        // <summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            initObject.ClassId = this.ClassId;
            if (this.MyInvocation.BoundParameters.ContainsKey("ClusterEfficiency"))
            {
                initObject.ClusterEfficiency = this.ClusterEfficiency;
            }
            if (this.MyInvocation.BoundParameters.ContainsKey("Moid"))
            {
                initObject.Moid = this.Moid;
