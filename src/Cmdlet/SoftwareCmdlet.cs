...
namespace Intersight.PowerShell
{
    ...
    public class GetIntersightSoftwareDownloadHistory : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"The email id of the user who initiated the software download."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightSoftwareHciBundleDistributable : GetCmdletBase
    {
        ...
        {
            ApiInstance = new SoftwareApi(Config);
            MethodName = "GetSoftwareHciBundleDistributableListWithHttpInfo";
        }
        ...
        public SoftwareHciBundleDistributable.FeatureSourceEnum FeatureSource
        {
            get;
            set;
        }
    ...
    public class GetIntersightSoftwareHciDistributable : GetCmdletBase
    {
        ...
        {
            ApiInstance = new SoftwareApi(Config);
            MethodName = "GetSoftwareHciDistributableListWithHttpInfo";
        }
        ...
        public SoftwareHciDistributable.FeatureSourceEnum FeatureSource
        {
            get;
            set;
        }
    ...
    public class GetIntersightSoftwareIksBundleDistributable : GetCmdletBase
    {
        ...
        {
            ApiInstance = new SoftwareApi(Config);
            MethodName = "GetSoftwareIksBundleDistributableListWithHttpInfo";
        }
    ...
    public class NewIntersightSoftwareHciBundleDistributable : NewCmdletBase
    {
        ...
        {
            ApiInstance = new SoftwareApi(Config);
            ModelObject = new SoftwareHciBundleDistributable();
            MethodName = "CreateSoftwareHciBundleDistributableWithHttpInfo";
        }
    ...
    public class NewIntersightSoftwareHciDistributable : NewCmdletBase
    {
        ...
        {
            ApiInstance = new SoftwareApi(Config);
            ModelObject = new SoftwareHciDistributable();
            MethodName = "CreateSoftwareHciDistributableWithHttpInfo";
        }
    ...
    public class NewIntersightSoftwareIksBundleDistributable : NewCmdletBase
    {
        ...
        {
            ApiInstance = new SoftwareApi(Config);
            ModelObject = new SoftwareIksBundleDistributable();
            MethodName = "CreateSoftwareIksBundleDistributableWithHttpInfo";
        }
    ...
    public class RemoveIntersightSoftwareHciBundleDistributable : RemoveCmdletBase
    {
        ...
        {
            ApiInstance = new SoftwareApi(Config);
            MethodName = "DeleteSoftwareHciBundleDistributableWithHttpInfo";
        }
    }
    /// <summary>
    ...
    public class RemoveIntersightSoftwareHciDistributable : RemoveCmdletBase
    {
        ...
        {
            ApiInstance = new SoftwareApi(Config);
            MethodName = "DeleteSoftwareHciDistributableWithHttpInfo";
        }
    }
    /// <summary>
    ...
    public class RemoveIntersightSoftwareIksBundleDistributable : RemoveCmdletBase
    {
        ...
        {
            ApiInstance = new SoftwareApi(Config);
            MethodName = "DeleteSoftwareIksBundleDistributableWithHttpInfo";
        }
    }
    /// <summary>
    ...
    public class SetIntersightSoftwareHciBundleDistributable : SetCmdletBase
    {
        public SetIntersightSoftwareHciBundleDistributable()
        {
            ApiInstance = new SoftwareApi(Config);
            ModelObject = new SoftwareHciBundleDistributable();
            MethodName = "UpdateSoftwareHciBundleDistributableWithHttpInfo";
        }
    ...
    public class SetIntersightSoftwareHciDistributable : SetCmdletBase
    {
        public SetIntersightSoftwareHciDistributable()
        {
            ApiInstance = new SoftwareApi(Config);
            ModelObject = new SoftwareHciDistributable();
            MethodName = "UpdateSoftwareHciDistributableWithHttpInfo";
        }
    ...
    public class SetIntersightSoftwareIksBundleDistributable : SetCmdletBase
    {
        public SetIntersightSoftwareIksBundleDistributable()
        {
            ApiInstance = new SoftwareApi(Config);
            ModelObject = new SoftwareIksBundleDistributable();
            MethodName = "UpdateSoftwareIksBundleDistributableWithHttpInfo";
        }
