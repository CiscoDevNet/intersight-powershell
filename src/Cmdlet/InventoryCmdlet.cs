...
namespace Intersight.PowerShell
{
    ...
    public class SetIntersightInventoryGenericInventory : SetCmdletBase
    {
        public SetIntersightInventoryGenericInventory()
        {
            ...
            MethodName = "PatchInventoryGenericInventoryWithHttpInfo";
        }
    ...
    public class GetIntersightInventoryGenericInventoryHolder : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"The endpoint represented by this holder."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
    ...
    public class GetIntersightInventoryGenericInventory : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"A reference to a inventoryGenericInventoryHolder resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public InventoryGenericInventoryHolderRelationship InventoryGenericInventoryHolder
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"Key of inventory data for Generic Inventory data set."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Type of inventory data for Generic Inventory data set."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
        ...
        // <summary>
        /// <para type="description">"Value of inventory data for Generic Inventory data set."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
