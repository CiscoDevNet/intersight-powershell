...
namespace Intersight.PowerShell
{
    ...
    public class GetIntersightTerminalAuditLog : GetCmdletBase
    {
        ...
        // <summary>
        /// <para type="description">"A reference to a assetDeviceConnection resource.\nWhen the $expand query parameter is specified, the referenced resource is returned inline."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = true, ParameterSetName = "CmdletParam")]

        public AssetDeviceConnectionRelationship DeviceRegistration
        {
            get;
            set;
        }
        ...
        // <summary>
        /// <para type="description">"The time the terminal was closed. If terminal has not closed, value is zero time."</para>
        /// </summary>
        ...
        // <summary>
        /// <para type="description">"The time the terminal session was opened."</para>
        /// </summary>
        [Parameter(Mandatory = false, ValueFromPipelineByPropertyName = true, ValueFromPipeline = false, ParameterSetName = "CmdletParam")]
