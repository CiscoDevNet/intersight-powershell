...
```powershell
$RecommendationCapacityRunwayResponse = Initialize-IntersightRecommendationCapacityRunwayResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$RecommendationCapacityRunwayResponse | ConvertTo-JSON
```
