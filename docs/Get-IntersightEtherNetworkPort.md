...
# Get-IntersightEtherNetworkPort

## SYNOPSIS
Get the EtherNetworkPort

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEtherNetworkPort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEtherNetworkPort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EtherNetworkPort&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEtherNetworkPort
```
Above example returns the list of EtherNetworkPort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEtherNetworkPort -Name "MoName"
```
Above example returns the EtherNetworkPort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEtherNetworkPort -Organization $organization
```
Above example returns the list of EtherNetworkPort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEtherNetworkPort -InlineCount allpages
```
Above example returns the list of EtherNetworkPort along with count.
...
### -Name
Specifies the name of the EtherNetworkPort.
...
### -Organization
Specifies the organization, to fetch the EtherNetworkPort under it.
...
[Set-IntersightEtherNetworkPort](./Set-IntersightEtherNetworkPort.md)
