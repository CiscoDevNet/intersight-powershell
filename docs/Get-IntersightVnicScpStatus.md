...
# Get-IntersightVnicScpStatus

## SYNOPSIS
Get the VnicScpStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicScpStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicScpStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicScpStatus&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicScpStatus
```
Above example returns the list of VnicScpStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicScpStatus -Name "MoName"
```
Above example returns the VnicScpStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicScpStatus -Organization $organization
```
Above example returns the list of VnicScpStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicScpStatus -InlineCount allpages
```
Above example returns the list of VnicScpStatus along with count.
...
### -Name
Specifies the name of the VnicScpStatus.
...
### -Organization
Specifies the organization, to fetch the VnicScpStatus under it.
