...
# Initialize-IntersightWorkflowAnsibleBatchExecutor
...
```yaml
Type: WorkflowAnsibleBatchExecutor.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowAnsibleBatchExecutor.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowAnsibleBatchExecutor
```
