...
## SYNOPSIS
Get the VirtualizationVmwareVirtualDisk

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareVirtualDisk [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareVirtualDisk [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualDisk
```
Above example returns the list of VirtualizationVmwareVirtualDisk.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualDisk -Name "MoName"
```
Above example returns the VirtualizationVmwareVirtualDisk matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualDisk -Organization $organization
```
Above example returns the list of VirtualizationVmwareVirtualDisk available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualDisk -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareVirtualDisk along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareVirtualDisk.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareVirtualDisk under it.
...
[Set-IntersightVirtualizationVmwareVirtualDisk](./Set-IntersightVirtualizationVmwareVirtualDisk.md)
