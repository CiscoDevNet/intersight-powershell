...
## SYNOPSIS
Get the VirtualizationVmwareDatacenter

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareDatacenter [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareDatacenter [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;VirtualizationVmwareDatacenter&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDatacenter
```
Above example returns the list of VirtualizationVmwareDatacenter.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDatacenter -Name "MoName"
```
Above example returns the VirtualizationVmwareDatacenter matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDatacenter -Organization $organization
```
Above example returns the list of VirtualizationVmwareDatacenter available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDatacenter -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareDatacenter along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareDatacenter.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareDatacenter under it.
...
[Set-IntersightVirtualizationVmwareDatacenter](./Set-IntersightVirtualizationVmwareDatacenter.md)
