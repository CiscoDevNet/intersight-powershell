...
## SYNOPSIS
Get the NiatelemetryHttpsAclContractFilterMap

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryHttpsAclContractFilterMap [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryHttpsAclContractFilterMap [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryHttpsAclContractFilterMap&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclContractFilterMap
```
Above example returns the list of NiatelemetryHttpsAclContractFilterMap.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclContractFilterMap -Name "MoName"
```
Above example returns the NiatelemetryHttpsAclContractFilterMap matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclContractFilterMap -Organization $organization
```
Above example returns the list of NiatelemetryHttpsAclContractFilterMap available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclContractFilterMap -InlineCount allpages
```
Above example returns the list of NiatelemetryHttpsAclContractFilterMap along with count.
...
### -Name
Specifies the name of the NiatelemetryHttpsAclContractFilterMap.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryHttpsAclContractFilterMap under it.
