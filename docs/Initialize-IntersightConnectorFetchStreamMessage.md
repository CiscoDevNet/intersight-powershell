...
Initialize-IntersightConnectorFetchStreamMessage [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< ConnectorFetchStreamMessage.ClassIdEnum>][-EncryptedAesKey< string>][-EncryptionKey< string>][-ObjectType< ConnectorFetchStreamMessage.ObjectTypeEnum>][-SecureProperties< object>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ConnectorFetchStreamMessage.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ConnectorFetchStreamMessage.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightConnectorFetchStreamMessage
```
