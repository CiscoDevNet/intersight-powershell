...
# Initialize-IntersightFabricFcUplinkRole
...
Initialize-IntersightFabricFcUplinkRole [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AdminSpeed< FabricFcUplinkRole.AdminSpeedEnum>][-AggregatePortId< long>][-ClassId< FabricFcUplinkRole.ClassIdEnum>][-FillPattern< FabricFcUplinkRole.FillPatternEnum>][-Moid< string>][-ObjectType< FabricFcUplinkRole.ObjectTypeEnum>][-PortId< long>][-PortPolicy< Model.FabricPortPolicyRelationship>][-SlotId< long>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-UserLabel< string>][-VsanId< long>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: FabricFcUplinkRole.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricFcUplinkRole.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFabricFcUplinkRole
```
