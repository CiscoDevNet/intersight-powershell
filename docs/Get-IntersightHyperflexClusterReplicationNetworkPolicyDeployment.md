...
## SYNOPSIS
Get the HyperflexClusterReplicationNetworkPolicyDeployment

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexClusterReplicationNetworkPolicyDeployment [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexClusterReplicationNetworkPolicyDeployment [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterReplicationNetworkPolicyDeployment
```
Above example returns the list of HyperflexClusterReplicationNetworkPolicyDeployment.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterReplicationNetworkPolicyDeployment -Name "MoName"
```
Above example returns the HyperflexClusterReplicationNetworkPolicyDeployment matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterReplicationNetworkPolicyDeployment -Organization $organization
```
Above example returns the list of HyperflexClusterReplicationNetworkPolicyDeployment available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterReplicationNetworkPolicyDeployment -InlineCount allpages
```
Above example returns the list of HyperflexClusterReplicationNetworkPolicyDeployment along with count.
...
### -Name
Specifies the name of the HyperflexClusterReplicationNetworkPolicyDeployment.
...
### -Organization
Specifies the organization, to fetch the HyperflexClusterReplicationNetworkPolicyDeployment under it.
