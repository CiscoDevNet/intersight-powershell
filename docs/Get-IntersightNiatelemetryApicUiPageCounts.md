...
## SYNOPSIS
Get the NiatelemetryApicUiPageCounts

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicUiPageCounts [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicUiPageCounts [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetryApicUiPageCounts&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicUiPageCounts
```
Above example returns the list of NiatelemetryApicUiPageCounts.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicUiPageCounts -Name "MoName"
```
Above example returns the NiatelemetryApicUiPageCounts matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicUiPageCounts -Organization $organization
```
Above example returns the list of NiatelemetryApicUiPageCounts available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicUiPageCounts -InlineCount allpages
```
Above example returns the list of NiatelemetryApicUiPageCounts along with count.
...
### -Name
Specifies the name of the NiatelemetryApicUiPageCounts.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicUiPageCounts under it.
