...
## SYNOPSIS
Get the StorageFlexFlashController

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageFlexFlashController [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageFlexFlashController [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageFlexFlashController&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashController
```
Above example returns the list of StorageFlexFlashController.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashController -Name "MoName"
```
Above example returns the StorageFlexFlashController matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashController -Organization $organization
```
Above example returns the list of StorageFlexFlashController available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashController -InlineCount allpages
```
Above example returns the list of StorageFlexFlashController along with count.
...
### -Name
Specifies the name of the StorageFlexFlashController.
...
### -Organization
Specifies the organization, to fetch the StorageFlexFlashController under it.
...
[Set-IntersightStorageFlexFlashController](./Set-IntersightStorageFlexFlashController.md)
