...
# Get-IntersightHyperflexHxapVirtualMachineNetworkInterface

## SYNOPSIS
Get the HyperflexHxapVirtualMachineNetworkInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHxapVirtualMachineNetworkInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHxapVirtualMachineNetworkInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHxapVirtualMachineNetworkInterface&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapVirtualMachineNetworkInterface
```
Above example returns the list of HyperflexHxapVirtualMachineNetworkInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapVirtualMachineNetworkInterface -Name "MoName"
```
Above example returns the HyperflexHxapVirtualMachineNetworkInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapVirtualMachineNetworkInterface -Organization $organization
```
Above example returns the list of HyperflexHxapVirtualMachineNetworkInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapVirtualMachineNetworkInterface -InlineCount allpages
```
Above example returns the list of HyperflexHxapVirtualMachineNetworkInterface along with count.
...
### -Name
Specifies the name of the HyperflexHxapVirtualMachineNetworkInterface.
...
### -Organization
Specifies the organization, to fetch the HyperflexHxapVirtualMachineNetworkInterface under it.
...
[Remove-IntersightHyperflexHxapVirtualMachineNetworkInterface](./Remove-IntersightHyperflexHxapVirtualMachineNetworkInterface.md)
