...
## SYNOPSIS
Get the IqnpoolUniverse

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIqnpoolUniverse [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIqnpoolUniverse [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IqnpoolUniverse&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIqnpoolUniverse
```
Above example returns the list of IqnpoolUniverse.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIqnpoolUniverse -Name "MoName"
```
Above example returns the IqnpoolUniverse matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIqnpoolUniverse -Organization $organization
```
Above example returns the list of IqnpoolUniverse available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIqnpoolUniverse -InlineCount allpages
```
Above example returns the list of IqnpoolUniverse along with count.
...
### -Name
Specifies the name of the IqnpoolUniverse.
...
### -Organization
Specifies the organization, to fetch the IqnpoolUniverse under it.
