...
## SYNOPSIS
Get the MemoryPersistentMemoryPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMemoryPersistentMemoryPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMemoryPersistentMemoryPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;MemoryPersistentMemoryPolicy&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryPolicy
```
Above example returns the list of MemoryPersistentMemoryPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryPolicy -Name "MoName"
```
Above example returns the MemoryPersistentMemoryPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryPolicy -Organization $organization
```
Above example returns the list of MemoryPersistentMemoryPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryPolicy -InlineCount allpages
```
Above example returns the list of MemoryPersistentMemoryPolicy along with count.
...
### -Name
Specifies the name of the MemoryPersistentMemoryPolicy.
...
### -Organization
Specifies the organization, to fetch the MemoryPersistentMemoryPolicy under it.
