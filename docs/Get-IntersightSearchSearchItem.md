...
# Get-IntersightSearchSearchItem

## SYNOPSIS
Get the SearchSearchItem

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSearchSearchItem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSearchSearchItem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSearchSearchItem
```
Above example returns the list of SearchSearchItem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSearchSearchItem -Name "MoName"
```
Above example returns the SearchSearchItem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSearchSearchItem -Organization $organization
```
Above example returns the list of SearchSearchItem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSearchSearchItem -InlineCount allpages
```
Above example returns the list of SearchSearchItem along with count.
...
### -Name
Specifies the name of the SearchSearchItem.
...
### -Organization
Specifies the organization, to fetch the SearchSearchItem under it.
