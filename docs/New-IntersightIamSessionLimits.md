...
New-IntersightIamSessionLimits [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-IdleTimeOut< long>][-MaximumLimit< long>][-Moid< string>][-PerUserLimit< long>][-Permission< IamPermissionRelationship>][-SessionTimeOut< long>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
