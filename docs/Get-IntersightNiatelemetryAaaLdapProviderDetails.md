...
## SYNOPSIS
Get the NiatelemetryAaaLdapProviderDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryAaaLdapProviderDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryAaaLdapProviderDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryAaaLdapProviderDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAaaLdapProviderDetails
```
Above example returns the list of NiatelemetryAaaLdapProviderDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAaaLdapProviderDetails -Name "MoName"
```
Above example returns the NiatelemetryAaaLdapProviderDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAaaLdapProviderDetails -Organization $organization
```
Above example returns the list of NiatelemetryAaaLdapProviderDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAaaLdapProviderDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryAaaLdapProviderDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryAaaLdapProviderDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryAaaLdapProviderDetails under it.
