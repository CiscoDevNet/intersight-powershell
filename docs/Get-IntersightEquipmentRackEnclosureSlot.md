...
## SYNOPSIS
Get the EquipmentRackEnclosureSlot

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentRackEnclosureSlot [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentRackEnclosureSlot [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentRackEnclosureSlot&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentRackEnclosureSlot
```
Above example returns the list of EquipmentRackEnclosureSlot.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentRackEnclosureSlot -Name "MoName"
```
Above example returns the EquipmentRackEnclosureSlot matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentRackEnclosureSlot -Organization $organization
```
Above example returns the list of EquipmentRackEnclosureSlot available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentRackEnclosureSlot -InlineCount allpages
```
Above example returns the list of EquipmentRackEnclosureSlot along with count.
...
### -Name
Specifies the name of the EquipmentRackEnclosureSlot.
...
### -Organization
Specifies the organization, to fetch the EquipmentRackEnclosureSlot under it.
...
[Set-IntersightEquipmentRackEnclosureSlot](./Set-IntersightEquipmentRackEnclosureSlot.md)
