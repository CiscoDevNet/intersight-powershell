...
## SYNOPSIS
Get the KubernetesCatalog

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesCatalog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesCatalog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KubernetesCatalog&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesCatalog
```
Above example returns the list of KubernetesCatalog.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesCatalog -Name "MoName"
```
Above example returns the KubernetesCatalog matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesCatalog -Organization $organization
```
Above example returns the list of KubernetesCatalog available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesCatalog -InlineCount allpages
```
Above example returns the list of KubernetesCatalog along with count.
...
### -Name
Specifies the name of the KubernetesCatalog.
...
### -Organization
Specifies the organization, to fetch the KubernetesCatalog under it.
