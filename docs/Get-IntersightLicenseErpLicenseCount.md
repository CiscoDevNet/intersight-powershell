...
# Get-IntersightLicenseErpLicenseCount

## SYNOPSIS
Get the LicenseErpLicenseCount

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightLicenseErpLicenseCount [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightLicenseErpLicenseCount [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;LicenseErpLicenseCount&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightLicenseErpLicenseCount
```
Above example returns the list of LicenseErpLicenseCount.

### Example 2
```powershell
PS C:\> $result = Get-IntersightLicenseErpLicenseCount -Name "MoName"
```
Above example returns the LicenseErpLicenseCount matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightLicenseErpLicenseCount -Organization $organization
```
Above example returns the list of LicenseErpLicenseCount available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightLicenseErpLicenseCount -InlineCount allpages
```
Above example returns the list of LicenseErpLicenseCount along with count.
...
### -Name
Specifies the name of the LicenseErpLicenseCount.
...
### -Organization
Specifies the organization, to fetch the LicenseErpLicenseCount under it.
