...
## SYNOPSIS
Get the HclOperatingSystem

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHclOperatingSystem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHclOperatingSystem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;HclOperatingSystem&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHclOperatingSystem
```
Above example returns the list of HclOperatingSystem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHclOperatingSystem -Name "MoName"
```
Above example returns the HclOperatingSystem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHclOperatingSystem -Organization $organization
```
Above example returns the list of HclOperatingSystem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHclOperatingSystem -InlineCount allpages
```
Above example returns the list of HclOperatingSystem along with count.
...
### -Name
Specifies the name of the HclOperatingSystem.
...
### -Organization
Specifies the organization, to fetch the HclOperatingSystem under it.
