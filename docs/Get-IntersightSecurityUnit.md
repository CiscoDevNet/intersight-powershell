...
## SYNOPSIS
Get the SecurityUnit

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSecurityUnit [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSecurityUnit [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SecurityUnit&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSecurityUnit
```
Above example returns the list of SecurityUnit.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSecurityUnit -Name "MoName"
```
Above example returns the SecurityUnit matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSecurityUnit -Organization $organization
```
Above example returns the list of SecurityUnit available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSecurityUnit -InlineCount allpages
```
Above example returns the list of SecurityUnit along with count.
...
### -Name
Specifies the name of the SecurityUnit.
...
### -Organization
Specifies the organization, to fetch the SecurityUnit under it.
...
[Set-IntersightSecurityUnit](./Set-IntersightSecurityUnit.md)
