...
# Get-IntersightIaasUcsdMessages

## SYNOPSIS
Get the IaasUcsdMessages

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIaasUcsdMessages [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIaasUcsdMessages [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IaasUcsdMessages&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIaasUcsdMessages
```
Above example returns the list of IaasUcsdMessages.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIaasUcsdMessages -Name "MoName"
```
Above example returns the IaasUcsdMessages matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIaasUcsdMessages -Organization $organization
```
Above example returns the list of IaasUcsdMessages available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIaasUcsdMessages -InlineCount allpages
```
Above example returns the list of IaasUcsdMessages along with count.
...
### -Name
Specifies the name of the IaasUcsdMessages.
...
### -Organization
Specifies the organization, to fetch the IaasUcsdMessages under it.
