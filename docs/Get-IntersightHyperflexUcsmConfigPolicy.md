...
## SYNOPSIS
Get the HyperflexUcsmConfigPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexUcsmConfigPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexUcsmConfigPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;HyperflexUcsmConfigPolicy&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexUcsmConfigPolicy
```
Above example returns the list of HyperflexUcsmConfigPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexUcsmConfigPolicy -Name "MoName"
```
Above example returns the HyperflexUcsmConfigPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexUcsmConfigPolicy -Organization $organization
```
Above example returns the list of HyperflexUcsmConfigPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexUcsmConfigPolicy -InlineCount allpages
```
Above example returns the list of HyperflexUcsmConfigPolicy along with count.
...
### -Name
Specifies the name of the HyperflexUcsmConfigPolicy.
...
### -Organization
Specifies the organization, to fetch the HyperflexUcsmConfigPolicy under it.
