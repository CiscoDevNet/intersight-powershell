...
```powershell
$NiatelemetryNexusDashboardDetailsResponse = Initialize-IntersightNiatelemetryNexusDashboardDetailsResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiatelemetryNexusDashboardDetailsResponse | ConvertTo-JSON
```
