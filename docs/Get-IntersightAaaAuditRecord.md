...
## SYNOPSIS
Get the AaaAuditRecord

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAaaAuditRecord [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAaaAuditRecord [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAaaAuditRecord
```
Above example returns the list of AaaAuditRecord.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAaaAuditRecord -Name "MoName"
```
Above example returns the AaaAuditRecord matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAaaAuditRecord -Organization $organization
```
Above example returns the list of AaaAuditRecord available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAaaAuditRecord -InlineCount allpages
```
Above example returns the list of AaaAuditRecord along with count.
...
### -Name
Specifies the name of the AaaAuditRecord.
...
### -Organization
Specifies the organization, to fetch the AaaAuditRecord under it.
