...
## SYNOPSIS
Get the InventoryGenericInventoryHolder

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightInventoryGenericInventoryHolder [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightInventoryGenericInventoryHolder [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;InventoryGenericInventoryHolder&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightInventoryGenericInventoryHolder
```
Above example returns the list of InventoryGenericInventoryHolder.

### Example 2
```powershell
PS C:\> $result = Get-IntersightInventoryGenericInventoryHolder -Name "MoName"
```
Above example returns the InventoryGenericInventoryHolder matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightInventoryGenericInventoryHolder -Organization $organization
```
Above example returns the list of InventoryGenericInventoryHolder available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightInventoryGenericInventoryHolder -InlineCount allpages
```
Above example returns the list of InventoryGenericInventoryHolder along with count.
...
### -Name
Specifies the name of the InventoryGenericInventoryHolder.
...
### -Organization
Specifies the organization, to fetch the InventoryGenericInventoryHolder under it.
...
[Set-IntersightInventoryGenericInventoryHolder](./Set-IntersightInventoryGenericInventoryHolder.md)
