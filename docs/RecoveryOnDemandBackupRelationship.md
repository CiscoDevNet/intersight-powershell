...
```powershell
$RecoveryOnDemandBackupRelationship = Initialize-IntersightRecoveryOnDemandBackupRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$RecoveryOnDemandBackupRelationship | ConvertTo-JSON
```
