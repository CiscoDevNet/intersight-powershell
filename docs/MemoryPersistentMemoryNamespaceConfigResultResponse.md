...
```powershell
$MemoryPersistentMemoryNamespaceConfigResultResponse = Initialize-IntersightMemoryPersistentMemoryNamespaceConfigResultResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$MemoryPersistentMemoryNamespaceConfigResultResponse | ConvertTo-JSON
```
