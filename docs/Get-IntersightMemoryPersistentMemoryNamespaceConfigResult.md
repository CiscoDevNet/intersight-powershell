...
## SYNOPSIS
Get the MemoryPersistentMemoryNamespaceConfigResult

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMemoryPersistentMemoryNamespaceConfigResult [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMemoryPersistentMemoryNamespaceConfigResult [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;MemoryPersistentMemoryNamespaceConfigResult&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryNamespaceConfigResult
```
Above example returns the list of MemoryPersistentMemoryNamespaceConfigResult.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryNamespaceConfigResult -Name "MoName"
```
Above example returns the MemoryPersistentMemoryNamespaceConfigResult matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryNamespaceConfigResult -Organization $organization
```
Above example returns the list of MemoryPersistentMemoryNamespaceConfigResult available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryNamespaceConfigResult -InlineCount allpages
```
Above example returns the list of MemoryPersistentMemoryNamespaceConfigResult along with count.
...
### -Name
Specifies the name of the MemoryPersistentMemoryNamespaceConfigResult.
...
### -Organization
Specifies the organization, to fetch the MemoryPersistentMemoryNamespaceConfigResult under it.
...
[Set-IntersightMemoryPersistentMemoryNamespaceConfigResult](./Set-IntersightMemoryPersistentMemoryNamespaceConfigResult.md)
