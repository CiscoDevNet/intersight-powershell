...
# Get-IntersightPartnerintegrationDcLogs

## SYNOPSIS
Get the PartnerintegrationDcLogs

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPartnerintegrationDcLogs [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPartnerintegrationDcLogs [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PartnerintegrationDcLogs&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationDcLogs
```
Above example returns the list of PartnerintegrationDcLogs.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationDcLogs -Name "MoName"
```
Above example returns the PartnerintegrationDcLogs matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationDcLogs -Organization $organization
```
Above example returns the list of PartnerintegrationDcLogs available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationDcLogs -InlineCount allpages
```
Above example returns the list of PartnerintegrationDcLogs along with count.
...
### -Name
Specifies the name of the PartnerintegrationDcLogs.
...
### -Organization
Specifies the organization, to fetch the PartnerintegrationDcLogs under it.
