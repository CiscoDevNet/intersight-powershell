...
# Get-IntersightResourcepoolMembershipReservation

## SYNOPSIS
Get the ResourcepoolMembershipReservation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightResourcepoolMembershipReservation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourcepoolMembershipReservation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ResourcepoolMembershipReservation&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourcepoolMembershipReservation
```
Above example returns the list of ResourcepoolMembershipReservation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourcepoolMembershipReservation -Name "MoName"
```
Above example returns the ResourcepoolMembershipReservation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourcepoolMembershipReservation -Organization $organization
```
Above example returns the list of ResourcepoolMembershipReservation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourcepoolMembershipReservation -InlineCount allpages
```
Above example returns the list of ResourcepoolMembershipReservation along with count.
...
### -Name
Specifies the name of the ResourcepoolMembershipReservation.
...
### -Organization
Specifies the organization, to fetch the ResourcepoolMembershipReservation under it.
...
[Remove-IntersightResourcepoolMembershipReservation](./Remove-IntersightResourcepoolMembershipReservation.md)
