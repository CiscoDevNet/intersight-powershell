...
# Get-IntersightNetworkSecureRouter

## SYNOPSIS
Get the NetworkSecureRouter

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkSecureRouter [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkSecureRouter [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NetworkSecureRouter&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkSecureRouter
```
Above example returns the list of NetworkSecureRouter.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkSecureRouter -Name "MoName"
```
Above example returns the NetworkSecureRouter matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkSecureRouter -Organization $organization
```
Above example returns the list of NetworkSecureRouter available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkSecureRouter -InlineCount allpages
```
Above example returns the list of NetworkSecureRouter along with count.
...
### -Name
Specifies the name of the NetworkSecureRouter.
...
### -Organization
Specifies the organization, to fetch the NetworkSecureRouter under it.
...
[Set-IntersightNetworkSecureRouter](./Set-IntersightNetworkSecureRouter.md)
