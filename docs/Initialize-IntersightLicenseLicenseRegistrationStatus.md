...
# Initialize-IntersightLicenseLicenseRegistrationStatus
...
```yaml
Type: LicenseLicenseRegistrationStatus.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightLicenseLicenseRegistrationStatus
```
