...
## SYNOPSIS
Get the VirtualizationVirtualMachine

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVirtualMachine [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVirtualMachine [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVirtualMachine
```
Above example returns the list of VirtualizationVirtualMachine.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVirtualMachine -Name "MoName"
```
Above example returns the VirtualizationVirtualMachine matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVirtualMachine -Organization $organization
```
Above example returns the list of VirtualizationVirtualMachine available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVirtualMachine -InlineCount allpages
```
Above example returns the list of VirtualizationVirtualMachine along with count.
...
### -Name
Specifies the name of the VirtualizationVirtualMachine.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVirtualMachine under it.
