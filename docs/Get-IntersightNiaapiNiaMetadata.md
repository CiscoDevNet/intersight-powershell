...
## SYNOPSIS
Get the NiaapiNiaMetadata

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiNiaMetadata [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiNiaMetadata [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiaapiNiaMetadata&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiNiaMetadata
```
Above example returns the list of NiaapiNiaMetadata.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiNiaMetadata -Name "MoName"
```
Above example returns the NiaapiNiaMetadata matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiNiaMetadata -Organization $organization
```
Above example returns the list of NiaapiNiaMetadata available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiNiaMetadata -InlineCount allpages
```
Above example returns the list of NiaapiNiaMetadata along with count.
...
### -Name
Specifies the name of the NiaapiNiaMetadata.
...
### -Organization
Specifies the organization, to fetch the NiaapiNiaMetadata under it.
