...
# Initialize-IntersightHyperflexCluster
...
Initialize-IntersightHyperflexCluster [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AssociatedProfile< Model.PolicyAbstractProfileRelationship>][-ChildClusters< System.Collections.Generic.List`1[Model.HyperflexBaseClusterRelationship]>][-ClassId< HyperflexCluster.ClassIdEnum>][-ClusterPurpose< HyperflexCluster.ClusterPurposeEnum>][-EncryptionStatus< string>][-HypervisorType< HyperflexCluster.HypervisorTypeEnum>][-Moid< string>][-ObjectType< HyperflexCluster.ObjectTypeEnum>][-ParentCluster< Model.ComputeBaseClusterRelationship>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: System.Collections.Generic.List`1[Model.HyperflexBaseClusterRelationship]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: HyperflexCluster.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: HyperflexCluster.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.ComputeBaseClusterRelationship
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightHyperflexCluster
```
