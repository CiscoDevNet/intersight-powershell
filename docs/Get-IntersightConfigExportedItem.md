...
# Get-IntersightConfigExportedItem

## SYNOPSIS
Get the ConfigExportedItem

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightConfigExportedItem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightConfigExportedItem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ConfigExportedItem&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightConfigExportedItem
```
Above example returns the list of ConfigExportedItem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightConfigExportedItem -Name "MoName"
```
Above example returns the ConfigExportedItem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightConfigExportedItem -Organization $organization
```
Above example returns the list of ConfigExportedItem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightConfigExportedItem -InlineCount allpages
```
Above example returns the list of ConfigExportedItem along with count.
...
### -Name
Specifies the name of the ConfigExportedItem.
...
### -Organization
Specifies the organization, to fetch the ConfigExportedItem under it.
