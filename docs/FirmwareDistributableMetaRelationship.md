...
```powershell
$FirmwareDistributableMetaRelationship = Initialize-IntersightFirmwareDistributableMetaRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$FirmwareDistributableMetaRelationship | ConvertTo-JSON
```
