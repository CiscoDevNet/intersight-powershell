...
### CmdletParam (Default)
```
Get-IntersightCapabilitySwitchDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilitySwitchDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchDescriptor
```
Above example returns the list of CapabilitySwitchDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchDescriptor -Name "MoName"
```
Above example returns the CapabilitySwitchDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchDescriptor -Organization $organization
```
Above example returns the list of CapabilitySwitchDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchDescriptor -InlineCount allpages
```
Above example returns the list of CapabilitySwitchDescriptor along with count.
...
### -Name
Specifies the name of the CapabilitySwitchDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilitySwitchDescriptor under it.
