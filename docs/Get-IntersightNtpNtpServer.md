...
# Get-IntersightNtpNtpServer

## SYNOPSIS
Get the NtpNtpServer

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNtpNtpServer [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNtpNtpServer [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NtpNtpServer&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNtpNtpServer
```
Above example returns the list of NtpNtpServer.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNtpNtpServer -Name "MoName"
```
Above example returns the NtpNtpServer matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNtpNtpServer -Organization $organization
```
Above example returns the list of NtpNtpServer available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNtpNtpServer -InlineCount allpages
```
Above example returns the list of NtpNtpServer along with count.
...
### -Name
Specifies the name of the NtpNtpServer.
...
### -Organization
Specifies the organization, to fetch the NtpNtpServer under it.
