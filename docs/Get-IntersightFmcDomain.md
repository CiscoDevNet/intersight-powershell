...
### CmdletParam (Default)
```
Get-IntersightFmcDomain [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFmcDomain [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FmcDomain&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFmcDomain
```
Above example returns the list of FmcDomain.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFmcDomain -Name "MoName"
```
Above example returns the FmcDomain matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFmcDomain -Organization $organization
```
Above example returns the list of FmcDomain available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFmcDomain -InlineCount allpages
```
Above example returns the list of FmcDomain along with count.
...
### -Name
Specifies the name of the FmcDomain.
...
### -Organization
Specifies the organization, to fetch the FmcDomain under it.
