...
```powershell
$CapabilityAdapterUnitDescriptorResponse = Initialize-IntersightCapabilityAdapterUnitDescriptorResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilityAdapterUnitDescriptorResponse | ConvertTo-JSON
```
