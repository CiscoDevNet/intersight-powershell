...
## SYNOPSIS
Get the StoragePureReplicationSchedule

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureReplicationSchedule [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureReplicationSchedule [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureReplicationSchedule&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureReplicationSchedule
```
Above example returns the list of StoragePureReplicationSchedule.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureReplicationSchedule -Name "MoName"
```
Above example returns the StoragePureReplicationSchedule matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureReplicationSchedule -Organization $organization
```
Above example returns the list of StoragePureReplicationSchedule available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureReplicationSchedule -InlineCount allpages
```
Above example returns the list of StoragePureReplicationSchedule along with count.
...
### -Name
Specifies the name of the StoragePureReplicationSchedule.
...
### -Organization
Specifies the organization, to fetch the StoragePureReplicationSchedule under it.
