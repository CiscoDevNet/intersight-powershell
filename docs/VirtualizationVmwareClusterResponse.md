...
```powershell
$VirtualizationVmwareClusterResponse = Initialize-IntersightVirtualizationVmwareClusterResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$VirtualizationVmwareClusterResponse | ConvertTo-JSON
```
