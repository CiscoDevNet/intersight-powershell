...
### CmdletParam (Default)
```
Get-IntersightFabricVlan [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricVlan [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricVlan&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricVlan
```
Above example returns the list of FabricVlan.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricVlan -Name "MoName"
```
Above example returns the FabricVlan matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricVlan -Organization $organization
```
Above example returns the list of FabricVlan available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricVlan -InlineCount allpages
```
Above example returns the list of FabricVlan along with count.
...
### -Name
Specifies the name of the FabricVlan.
...
### -Organization
Specifies the organization, to fetch the FabricVlan under it.
