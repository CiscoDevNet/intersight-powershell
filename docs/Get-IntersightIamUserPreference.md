...
# Get-IntersightIamUserPreference

## SYNOPSIS
Get the IamUserPreference

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamUserPreference [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamUserPreference [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamUserPreference&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamUserPreference
```
Above example returns the list of IamUserPreference.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamUserPreference -Name "MoName"
```
Above example returns the IamUserPreference matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamUserPreference -Organization $organization
```
Above example returns the list of IamUserPreference available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamUserPreference -InlineCount allpages
```
Above example returns the list of IamUserPreference along with count.
...
### -Name
Specifies the name of the IamUserPreference.
...
### -Organization
Specifies the organization, to fetch the IamUserPreference under it.
...
[Set-IntersightIamUserPreference](./Set-IntersightIamUserPreference.md)
