...
## SYNOPSIS
Get the LicenseSmartlicenseToken

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightLicenseSmartlicenseToken [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightLicenseSmartlicenseToken [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;LicenseSmartlicenseToken&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightLicenseSmartlicenseToken
```
Above example returns the list of LicenseSmartlicenseToken.

### Example 2
```powershell
PS C:\> $result = Get-IntersightLicenseSmartlicenseToken -Name "MoName"
```
Above example returns the LicenseSmartlicenseToken matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightLicenseSmartlicenseToken -Organization $organization
```
Above example returns the list of LicenseSmartlicenseToken available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightLicenseSmartlicenseToken -InlineCount allpages
```
Above example returns the list of LicenseSmartlicenseToken along with count.
...
### -Name
Specifies the name of the LicenseSmartlicenseToken.
...
### -Organization
Specifies the organization, to fetch the LicenseSmartlicenseToken under it.
...
[Set-IntersightLicenseSmartlicenseToken](./Set-IntersightLicenseSmartlicenseToken.md)
