...
# Get-IntersightHciEsxiVmDisk

## SYNOPSIS
Get the HciEsxiVmDisk

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHciEsxiVmDisk [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciEsxiVmDisk [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciEsxiVmDisk&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciEsxiVmDisk
```
Above example returns the list of HciEsxiVmDisk.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciEsxiVmDisk -Name "MoName"
```
Above example returns the HciEsxiVmDisk matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciEsxiVmDisk -Organization $organization
```
Above example returns the list of HciEsxiVmDisk available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciEsxiVmDisk -InlineCount allpages
```
Above example returns the list of HciEsxiVmDisk along with count.
...
### -Name
Specifies the name of the HciEsxiVmDisk.
...
### -Organization
Specifies the organization, to fetch the HciEsxiVmDisk under it.
