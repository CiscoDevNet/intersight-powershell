...
# Initialize-IntersightHyperflexHypervisorVirtualMachine
...
Initialize-IntersightHyperflexHypervisorVirtualMachine [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-BootTime< DateTime>][-Capacity< Model.InfraHardwareInfo>][-ClassId< HyperflexHypervisorVirtualMachine.ClassIdEnum>][-CpuUtilization< float>][-GuestInfo< Model.VirtualizationGuestInfo>][-HypervisorType< HyperflexHypervisorVirtualMachine.HypervisorTypeEnum>][-Identity< string>][-IpAddress< System.Collections.Generic.List`1[string]>][-MemoryCapacity< Model.VirtualizationMemoryCapacity>][-MemoryUtilization< float>][-Moid< string>][-Name< string>][-ObjectType< HyperflexHypervisorVirtualMachine.ObjectTypeEnum>][-PowerState< HyperflexHypervisorVirtualMachine.PowerStateEnum>][-ProcessorCapacity< Model.VirtualizationComputeCapacity>][-Provider< HyperflexHypervisorVirtualMachine.ProviderEnum>][-RegisteredDevice< Model.AssetDeviceRegistrationRelationship>][-State< HyperflexHypervisorVirtualMachine.StateEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Uuid< string>][-VmCreationTime< DateTime>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: HyperflexHypervisorVirtualMachine.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: HyperflexHypervisorVirtualMachine.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightHyperflexHypervisorVirtualMachine
```
