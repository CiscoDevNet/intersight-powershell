...
# Get-IntersightHciViolation

## SYNOPSIS
Get the HciViolation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHciViolation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciViolation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciViolation&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciViolation
```
Above example returns the list of HciViolation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciViolation -Name "MoName"
```
Above example returns the HciViolation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciViolation -Organization $organization
```
Above example returns the list of HciViolation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciViolation -InlineCount allpages
```
Above example returns the list of HciViolation along with count.
...
### -Name
Specifies the name of the HciViolation.
...
### -Organization
Specifies the organization, to fetch the HciViolation under it.
