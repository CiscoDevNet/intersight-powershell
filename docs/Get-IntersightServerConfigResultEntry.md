...
## SYNOPSIS
Get the ServerConfigResultEntry

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightServerConfigResultEntry [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightServerConfigResultEntry [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ServerConfigResultEntry&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightServerConfigResultEntry
```
Above example returns the list of ServerConfigResultEntry.

### Example 2
```powershell
PS C:\> $result = Get-IntersightServerConfigResultEntry -Name "MoName"
```
Above example returns the ServerConfigResultEntry matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightServerConfigResultEntry -Organization $organization
```
Above example returns the list of ServerConfigResultEntry available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightServerConfigResultEntry -InlineCount allpages
```
Above example returns the list of ServerConfigResultEntry along with count.
...
### -Name
Specifies the name of the ServerConfigResultEntry.
...
### -Organization
Specifies the organization, to fetch the ServerConfigResultEntry under it.
