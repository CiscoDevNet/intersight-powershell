...
## SYNOPSIS
Get the CloudSkuInstanceType

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudSkuInstanceType [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudSkuInstanceType [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CloudSkuInstanceType&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudSkuInstanceType
```
Above example returns the list of CloudSkuInstanceType.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudSkuInstanceType -Name "MoName"
```
Above example returns the CloudSkuInstanceType matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudSkuInstanceType -Organization $organization
```
Above example returns the list of CloudSkuInstanceType available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudSkuInstanceType -InlineCount allpages
```
Above example returns the list of CloudSkuInstanceType along with count.
...
### -Name
Specifies the name of the CloudSkuInstanceType.
...
### -Organization
Specifies the organization, to fetch the CloudSkuInstanceType under it.
