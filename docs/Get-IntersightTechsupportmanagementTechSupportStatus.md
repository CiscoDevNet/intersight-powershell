...
### CmdletParam (Default)
```
Get-IntersightTechsupportmanagementTechSupportStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightTechsupportmanagementTechSupportStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementTechSupportStatus
```
Above example returns the list of TechsupportmanagementTechSupportStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementTechSupportStatus -Name "MoName"
```
Above example returns the TechsupportmanagementTechSupportStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementTechSupportStatus -Organization $organization
```
Above example returns the list of TechsupportmanagementTechSupportStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementTechSupportStatus -InlineCount allpages
```
Above example returns the list of TechsupportmanagementTechSupportStatus along with count.
...
### -Name
Specifies the name of the TechsupportmanagementTechSupportStatus.
...
### -Organization
Specifies the organization, to fetch the TechsupportmanagementTechSupportStatus under it.
