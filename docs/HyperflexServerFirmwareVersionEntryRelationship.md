...
```powershell
$HyperflexServerFirmwareVersionEntryRelationship = Initialize-IntersightHyperflexServerFirmwareVersionEntryRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexServerFirmwareVersionEntryRelationship | ConvertTo-JSON
```
