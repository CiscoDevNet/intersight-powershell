...
# Get-IntersightAaaRetentionPolicy

## SYNOPSIS
Get the AaaRetentionPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAaaRetentionPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAaaRetentionPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAaaRetentionPolicy
```
Above example returns the list of AaaRetentionPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAaaRetentionPolicy -Name "MoName"
```
Above example returns the AaaRetentionPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAaaRetentionPolicy -Organization $organization
```
Above example returns the list of AaaRetentionPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAaaRetentionPolicy -InlineCount allpages
```
Above example returns the list of AaaRetentionPolicy along with count.
...
### -Name
Specifies the name of the AaaRetentionPolicy.
...
### -Organization
Specifies the organization, to fetch the AaaRetentionPolicy under it.
