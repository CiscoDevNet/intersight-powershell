...
## SYNOPSIS
Get the VnicEthAdapterPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicEthAdapterPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicEthAdapterPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicEthAdapterPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicEthAdapterPolicy
```
Above example returns the list of VnicEthAdapterPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicEthAdapterPolicy -Name "MoName"
```
Above example returns the VnicEthAdapterPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicEthAdapterPolicy -Organization $organization
```
Above example returns the list of VnicEthAdapterPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicEthAdapterPolicy -InlineCount allpages
```
Above example returns the list of VnicEthAdapterPolicy along with count.
...
### -Name
Specifies the name of the VnicEthAdapterPolicy.
...
### -Organization
Specifies the organization, to fetch the VnicEthAdapterPolicy under it.
