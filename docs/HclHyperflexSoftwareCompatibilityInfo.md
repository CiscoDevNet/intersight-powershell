...
```powershell
$HclHyperflexSoftwareCompatibilityInfo = Initialize-IntersightHclHyperflexSoftwareCompatibilityInfo  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$HclHyperflexSoftwareCompatibilityInfo | ConvertTo-JSON
```
