...
Note :- Use Initialize-IntersightHyperflexVmDisk to create the object of complex type HyperflexVmDisk

```yaml
Type: System.Collections.Generic.List`1[HyperflexVmDisk]
Parameter Sets: (All)
Aliases:
...
Note :- Use Initialize-IntersightHyperflexVmInterface to create the object of complex type HyperflexVmInterface

```yaml
Type: System.Collections.Generic.List`1[HyperflexVmInterface]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: HyperflexHxapVirtualMachine.PowerStateEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: HyperflexHxapVirtualMachine.ProviderEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: HyperflexHxapVirtualMachine.StateEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: HyperflexHxapVirtualMachine.StatusEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Set-IntersightHyperflexHxapVirtualMachine
```
...
[Get-IntersightHyperflexHxapVirtualMachine](./Get-IntersightHyperflexHxapVirtualMachine.md)
...
[Initialize-IntersightHyperflexVmInterface](./Initialize-IntersightHyperflexVmInterface.md)
