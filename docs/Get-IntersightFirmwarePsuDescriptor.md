...
## SYNOPSIS
Get the FirmwarePsuDescriptor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwarePsuDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwarePsuDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwarePsuDescriptor&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwarePsuDescriptor
```
Above example returns the list of FirmwarePsuDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwarePsuDescriptor -Name "MoName"
```
Above example returns the FirmwarePsuDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwarePsuDescriptor -Organization $organization
```
Above example returns the list of FirmwarePsuDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwarePsuDescriptor -InlineCount allpages
```
Above example returns the list of FirmwarePsuDescriptor along with count.
...
### -Name
Specifies the name of the FirmwarePsuDescriptor.
...
### -Organization
Specifies the organization, to fetch the FirmwarePsuDescriptor under it.
