...
# Get-IntersightTerminalAuditLog

## SYNOPSIS
Get the TerminalAuditLog

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightTerminalAuditLog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightTerminalAuditLog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightTerminalAuditLog
```
Above example returns the list of TerminalAuditLog.

### Example 2
```powershell
PS C:\> $result = Get-IntersightTerminalAuditLog -Name "MoName"
```
Above example returns the TerminalAuditLog matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightTerminalAuditLog -Organization $organization
```
Above example returns the list of TerminalAuditLog available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightTerminalAuditLog -InlineCount allpages
```
Above example returns the list of TerminalAuditLog along with count.
...
### -Name
Specifies the name of the TerminalAuditLog.
...
### -Organization
Specifies the organization, to fetch the TerminalAuditLog under it.
