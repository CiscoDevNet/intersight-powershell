...
# Get-IntersightStoragePureSmbPolicyRule

## SYNOPSIS
Get the StoragePureSmbPolicyRule

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureSmbPolicyRule [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureSmbPolicyRule [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureSmbPolicyRule&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureSmbPolicyRule
```
Above example returns the list of StoragePureSmbPolicyRule.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureSmbPolicyRule -Name "MoName"
```
Above example returns the StoragePureSmbPolicyRule matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureSmbPolicyRule -Organization $organization
```
Above example returns the list of StoragePureSmbPolicyRule available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureSmbPolicyRule -InlineCount allpages
```
Above example returns the list of StoragePureSmbPolicyRule along with count.
...
### -Name
Specifies the name of the StoragePureSmbPolicyRule.
...
### -Organization
Specifies the organization, to fetch the StoragePureSmbPolicyRule under it.
