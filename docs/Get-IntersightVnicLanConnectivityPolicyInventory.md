...
# Get-IntersightVnicLanConnectivityPolicyInventory

## SYNOPSIS
Get the VnicLanConnectivityPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicLanConnectivityPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicLanConnectivityPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicLanConnectivityPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicLanConnectivityPolicyInventory
```
Above example returns the list of VnicLanConnectivityPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicLanConnectivityPolicyInventory -Name "MoName"
```
Above example returns the VnicLanConnectivityPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicLanConnectivityPolicyInventory -Organization $organization
```
Above example returns the list of VnicLanConnectivityPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicLanConnectivityPolicyInventory -InlineCount allpages
```
Above example returns the list of VnicLanConnectivityPolicyInventory along with count.
...
### -Name
Specifies the name of the VnicLanConnectivityPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the VnicLanConnectivityPolicyInventory under it.
