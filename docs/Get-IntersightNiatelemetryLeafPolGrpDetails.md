...
# Get-IntersightNiatelemetryLeafPolGrpDetails

## SYNOPSIS
Get the NiatelemetryLeafPolGrpDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryLeafPolGrpDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryLeafPolGrpDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetryLeafPolGrpDetails&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryLeafPolGrpDetails
```
Above example returns the list of NiatelemetryLeafPolGrpDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryLeafPolGrpDetails -Name "MoName"
```
Above example returns the NiatelemetryLeafPolGrpDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryLeafPolGrpDetails -Organization $organization
```
Above example returns the list of NiatelemetryLeafPolGrpDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryLeafPolGrpDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryLeafPolGrpDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryLeafPolGrpDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryLeafPolGrpDetails under it.
