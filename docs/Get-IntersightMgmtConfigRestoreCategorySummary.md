...
# Get-IntersightMgmtConfigRestoreCategorySummary

## SYNOPSIS
Get the MgmtConfigRestoreCategorySummary

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMgmtConfigRestoreCategorySummary [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMgmtConfigRestoreCategorySummary [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MgmtConfigRestoreCategorySummary&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMgmtConfigRestoreCategorySummary
```
Above example returns the list of MgmtConfigRestoreCategorySummary.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMgmtConfigRestoreCategorySummary -Name "MoName"
```
Above example returns the MgmtConfigRestoreCategorySummary matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMgmtConfigRestoreCategorySummary -Organization $organization
```
Above example returns the list of MgmtConfigRestoreCategorySummary available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMgmtConfigRestoreCategorySummary -InlineCount allpages
```
Above example returns the list of MgmtConfigRestoreCategorySummary along with count.
...
### -Name
Specifies the name of the MgmtConfigRestoreCategorySummary.
...
### -Organization
Specifies the organization, to fetch the MgmtConfigRestoreCategorySummary under it.
