...
# Get-IntersightCondAlarmDefinition

## SYNOPSIS
Get the CondAlarmDefinition

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCondAlarmDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCondAlarmDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CondAlarmDefinition&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCondAlarmDefinition
```
Above example returns the list of CondAlarmDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCondAlarmDefinition -Name "MoName"
```
Above example returns the CondAlarmDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCondAlarmDefinition -Organization $organization
```
Above example returns the list of CondAlarmDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCondAlarmDefinition -InlineCount allpages
```
Above example returns the list of CondAlarmDefinition along with count.
...
### -Name
Specifies the name of the CondAlarmDefinition.
...
### -Organization
Specifies the organization, to fetch the CondAlarmDefinition under it.
