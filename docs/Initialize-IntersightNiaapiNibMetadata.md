...
# Initialize-IntersightNiaapiNibMetadata
...
Initialize-IntersightNiaapiNibMetadata [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< NiaapiNibMetadata.ClassIdEnum>][-Content< System.Collections.Generic.List`1[Model.NiaapiDetail]>][-Date< DateTime>][-MetadataChksum< string>][-MetadataFilename< string>][-Moid< string>][-ObjectType< NiaapiNibMetadata.ObjectTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Version< long>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: NiaapiNibMetadata.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: NiaapiNibMetadata.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightNiaapiNibMetadata
```
