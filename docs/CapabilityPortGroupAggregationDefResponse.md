...
```powershell
$CapabilityPortGroupAggregationDefResponse = Initialize-IntersightCapabilityPortGroupAggregationDefResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilityPortGroupAggregationDefResponse | ConvertTo-JSON
```
