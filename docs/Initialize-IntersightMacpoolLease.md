...
# Initialize-IntersightMacpoolLease
...
```yaml
Type: MacpoolLease.AllocationTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: MacpoolLease.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightMacpoolLease
```
