...
# Initialize-IntersightIamPermission
...
```yaml
Type: IamPermission.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.IamResourceRolesRelationship]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.IamSessionLimitsRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.IamUserGroupRelationship]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.IamUserRelationship]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIamPermission
```
