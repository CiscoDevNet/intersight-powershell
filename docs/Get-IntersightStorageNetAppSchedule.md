...
# Get-IntersightStorageNetAppSchedule

## SYNOPSIS
Get the StorageNetAppSchedule

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppSchedule [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppSchedule [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppSchedule&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSchedule
```
Above example returns the list of StorageNetAppSchedule.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSchedule -Name "MoName"
```
Above example returns the StorageNetAppSchedule matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSchedule -Organization $organization
```
Above example returns the list of StorageNetAppSchedule available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSchedule -InlineCount allpages
```
Above example returns the list of StorageNetAppSchedule along with count.
...
### -Name
Specifies the name of the StorageNetAppSchedule.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppSchedule under it.
