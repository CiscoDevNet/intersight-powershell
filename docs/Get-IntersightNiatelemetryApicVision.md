...
# Get-IntersightNiatelemetryApicVision

## SYNOPSIS
Get the NiatelemetryApicVision

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicVision [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicVision [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryApicVision&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicVision
```
Above example returns the list of NiatelemetryApicVision.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicVision -Name "MoName"
```
Above example returns the NiatelemetryApicVision matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicVision -Organization $organization
```
Above example returns the list of NiatelemetryApicVision available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicVision -InlineCount allpages
```
Above example returns the list of NiatelemetryApicVision along with count.
...
### -Name
Specifies the name of the NiatelemetryApicVision.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicVision under it.
