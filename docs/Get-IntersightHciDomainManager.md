...
# Get-IntersightHciDomainManager

## SYNOPSIS
Get the HciDomainManager

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHciDomainManager [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciDomainManager [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciDomainManager&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciDomainManager
```
Above example returns the list of HciDomainManager.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciDomainManager -Name "MoName"
```
Above example returns the HciDomainManager matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciDomainManager -Organization $organization
```
Above example returns the list of HciDomainManager available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciDomainManager -InlineCount allpages
```
Above example returns the list of HciDomainManager along with count.
...
### -Name
Specifies the name of the HciDomainManager.
...
### -Organization
Specifies the organization, to fetch the HciDomainManager under it.
