...
## SYNOPSIS
Get the VnicIscsiAdapterPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicIscsiAdapterPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicIscsiAdapterPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicIscsiAdapterPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicIscsiAdapterPolicy
```
Above example returns the list of VnicIscsiAdapterPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicIscsiAdapterPolicy -Name "MoName"
```
Above example returns the VnicIscsiAdapterPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicIscsiAdapterPolicy -Organization $organization
```
Above example returns the list of VnicIscsiAdapterPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicIscsiAdapterPolicy -InlineCount allpages
```
Above example returns the list of VnicIscsiAdapterPolicy along with count.
...
### -Name
Specifies the name of the VnicIscsiAdapterPolicy.
...
### -Organization
Specifies the organization, to fetch the VnicIscsiAdapterPolicy under it.
