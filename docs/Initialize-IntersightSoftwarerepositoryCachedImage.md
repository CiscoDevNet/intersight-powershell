...
# Initialize-IntersightSoftwarerepositoryCachedImage
...
Initialize-IntersightSoftwarerepositoryCachedImage [-Action< SoftwarerepositoryCachedImage.ActionEnum>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Checksum< Model.ConnectorFileChecksum>][-ClassId< SoftwarerepositoryCachedImage.ClassIdEnum>][-DownloadError< string>][-DownloadProgress< long>][-DownloadRetries< long>][-Moid< string>][-ObjectType< SoftwarerepositoryCachedImage.ObjectTypeEnum>][-RegisteredWorkflows< System.Collections.Generic.List`1[string]>][-Sha256checksum< byte[]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: SoftwarerepositoryCachedImage.ActionEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: SoftwarerepositoryCachedImage.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: SoftwarerepositoryCachedImage.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightSoftwarerepositoryCachedImage
```
