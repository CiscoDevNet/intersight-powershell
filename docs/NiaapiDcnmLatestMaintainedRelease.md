...
```powershell
$NiaapiDcnmLatestMaintainedRelease = Initialize-IntersightNiaapiDcnmLatestMaintainedRelease  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$NiaapiDcnmLatestMaintainedRelease | ConvertTo-JSON
```
