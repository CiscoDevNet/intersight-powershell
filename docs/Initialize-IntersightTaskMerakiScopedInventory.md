...
# Initialize-IntersightTaskMerakiScopedInventory
...
```yaml
Type: TaskMerakiScopedInventory.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TaskMerakiScopedInventory.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTaskMerakiScopedInventory
```
