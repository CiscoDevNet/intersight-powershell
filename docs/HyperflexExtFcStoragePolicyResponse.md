...
```powershell
$HyperflexExtFcStoragePolicyResponse = Initialize-IntersightHyperflexExtFcStoragePolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexExtFcStoragePolicyResponse | ConvertTo-JSON
```
