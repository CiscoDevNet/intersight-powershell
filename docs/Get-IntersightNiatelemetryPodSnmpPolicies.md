...
## SYNOPSIS
Get the NiatelemetryPodSnmpPolicies

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryPodSnmpPolicies [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryPodSnmpPolicies [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryPodSnmpPolicies&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPodSnmpPolicies
```
Above example returns the list of NiatelemetryPodSnmpPolicies.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPodSnmpPolicies -Name "MoName"
```
Above example returns the NiatelemetryPodSnmpPolicies matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPodSnmpPolicies -Organization $organization
```
Above example returns the list of NiatelemetryPodSnmpPolicies available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPodSnmpPolicies -InlineCount allpages
```
Above example returns the list of NiatelemetryPodSnmpPolicies along with count.
...
### -Name
Specifies the name of the NiatelemetryPodSnmpPolicies.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryPodSnmpPolicies under it.
