...
# Initialize-IntersightWorkflowSshBatchExecutor
...
```yaml
Type: WorkflowSshBatchExecutor.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowSshBatchExecutor.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowSshBatchExecutor
```
