...
**Status** | [**KubernetesServiceStatus**](KubernetesServiceStatus.md) |  | [optional] 
...
```powershell
$KubernetesServiceAllOf = Initialize-IntersightKubernetesServiceAllOf  -ClassId null `
 -ObjectType null `
 -Status null `
...
```powershell
$KubernetesServiceAllOf | ConvertTo-JSON
```
