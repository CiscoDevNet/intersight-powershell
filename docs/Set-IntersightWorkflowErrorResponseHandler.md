...
Set-IntersightWorkflowErrorResponseHandler [-AdditionalProperties< Dictionary<string,object>>][-Catalog< WorkflowCatalogRelationship>][-Description< string>][[-Moid]< string>][-Name< string>][-Parameters< List<ContentParameter>>][-PlatformType< WorkflowErrorResponseHandler.PlatformTypeEnum>][-Tags< List<MoTag>>][-Types< List<ContentComplexType>>]
