...
Initialize-IntersightFabricVlanSettings [-AdditionalProperties< Dictionary<string,object>>][-AllowedVlans< string>][-ClassId< FabricVlanSettings.ClassIdEnum>][-NativeVlan< long>][-ObjectType< FabricVlanSettings.ObjectTypeEnum>]
