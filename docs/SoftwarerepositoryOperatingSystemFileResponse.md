...
```powershell
$SoftwarerepositoryOperatingSystemFileResponse = Initialize-IntersightSoftwarerepositoryOperatingSystemFileResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwarerepositoryOperatingSystemFileResponse | ConvertTo-JSON
```
