...
### CmdletParam (Default)
```
Get-IntersightCapabilityServerTopologyMap [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityServerTopologyMap [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
