...
# Get-IntersightComputeScrubPolicy

## SYNOPSIS
Get the ComputeScrubPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputeScrubPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputeScrubPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ComputeScrubPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputeScrubPolicy
```
Above example returns the list of ComputeScrubPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputeScrubPolicy -Name "MoName"
```
Above example returns the ComputeScrubPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputeScrubPolicy -Organization $organization
```
Above example returns the list of ComputeScrubPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputeScrubPolicy -InlineCount allpages
```
Above example returns the list of ComputeScrubPolicy along with count.
...
### -Name
Specifies the name of the ComputeScrubPolicy.
...
### -Organization
Specifies the organization, to fetch the ComputeScrubPolicy under it.
...
[Remove-IntersightComputeScrubPolicy](./Remove-IntersightComputeScrubPolicy.md)
