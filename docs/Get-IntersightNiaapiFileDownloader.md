...
## SYNOPSIS
Get the NiaapiFileDownloader

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiFileDownloader [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiFileDownloader [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiaapiFileDownloader&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiFileDownloader
```
Above example returns the list of NiaapiFileDownloader.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiFileDownloader -Name "MoName"
```
Above example returns the NiaapiFileDownloader matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiFileDownloader -Organization $organization
```
Above example returns the list of NiaapiFileDownloader available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiFileDownloader -InlineCount allpages
```
Above example returns the list of NiaapiFileDownloader along with count.
...
### -Name
Specifies the name of the NiaapiFileDownloader.
...
### -Organization
Specifies the organization, to fetch the NiaapiFileDownloader under it.
