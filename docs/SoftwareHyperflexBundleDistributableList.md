...
```powershell
$SoftwareHyperflexBundleDistributableList = Initialize-IntersightSoftwareHyperflexBundleDistributableList  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwareHyperflexBundleDistributableList | ConvertTo-JSON
```
