...
Set-IntersightIamSessionLimits [-AdditionalProperties< Dictionary<string,object>>][-IdleTimeOut< long>][[-Moid]< string>][-PerUserLimit< long>][-Permission< IamPermissionRelationship>][-SessionTimeOut< long>][-Tags< List<MoTag>>]
