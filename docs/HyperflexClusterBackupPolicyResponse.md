...
```powershell
$HyperflexClusterBackupPolicyResponse = Initialize-IntersightHyperflexClusterBackupPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexClusterBackupPolicyResponse | ConvertTo-JSON
```
