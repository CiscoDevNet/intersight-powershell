...
### CmdletParam (Default)
```
Get-IntersightIamUser [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamUser [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamUser
```
Above example returns the list of IamUser.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamUser -Name "MoName"
```
Above example returns the IamUser matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamUser -Organization $organization
```
Above example returns the list of IamUser available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamUser -InlineCount allpages
```
Above example returns the list of IamUser along with count.
...
### -Name
Specifies the name of the IamUser.
...
### -Organization
Specifies the organization, to fetch the IamUser under it.
