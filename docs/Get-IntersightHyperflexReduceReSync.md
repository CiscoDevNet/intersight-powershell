...
# Get-IntersightHyperflexReduceReSync

## SYNOPSIS
Get the HyperflexReduceReSync

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexReduceReSync [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexReduceReSync [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexReduceReSync&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexReduceReSync
```
Above example returns the list of HyperflexReduceReSync.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexReduceReSync -Name "MoName"
```
Above example returns the HyperflexReduceReSync matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexReduceReSync -Organization $organization
```
Above example returns the list of HyperflexReduceReSync available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexReduceReSync -InlineCount allpages
```
Above example returns the list of HyperflexReduceReSync along with count.
...
### -Name
Specifies the name of the HyperflexReduceReSync.
...
### -Organization
Specifies the organization, to fetch the HyperflexReduceReSync under it.
