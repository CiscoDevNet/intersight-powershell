...
```powershell
$ApplianceCertificateSettingResponse = Initialize-IntersightApplianceCertificateSettingResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$ApplianceCertificateSettingResponse | ConvertTo-JSON
```
