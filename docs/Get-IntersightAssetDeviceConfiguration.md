...
## SYNOPSIS
Get the AssetDeviceConfiguration

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAssetDeviceConfiguration [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAssetDeviceConfiguration [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAssetDeviceConfiguration
```
Above example returns the list of AssetDeviceConfiguration.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAssetDeviceConfiguration -Name "MoName"
```
Above example returns the AssetDeviceConfiguration matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAssetDeviceConfiguration -Organization $organization
```
Above example returns the list of AssetDeviceConfiguration available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAssetDeviceConfiguration -InlineCount allpages
```
Above example returns the list of AssetDeviceConfiguration along with count.
...
### -Name
Specifies the name of the AssetDeviceConfiguration.
...
### -Organization
Specifies the organization, to fetch the AssetDeviceConfiguration under it.
...
[Set-IntersightAssetDeviceConfiguration](./Set-IntersightAssetDeviceConfiguration.md)
