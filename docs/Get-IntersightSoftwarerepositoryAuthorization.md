...
## SYNOPSIS
Get the SoftwarerepositoryAuthorization

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwarerepositoryAuthorization [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwarerepositoryAuthorization [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryAuthorization
```
Above example returns the list of SoftwarerepositoryAuthorization.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryAuthorization -Name "MoName"
```
Above example returns the SoftwarerepositoryAuthorization matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryAuthorization -Organization $organization
```
Above example returns the list of SoftwarerepositoryAuthorization available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryAuthorization -InlineCount allpages
```
Above example returns the list of SoftwarerepositoryAuthorization along with count.
...
### -Name
Specifies the name of the SoftwarerepositoryAuthorization.
...
### -Organization
Specifies the organization, to fetch the SoftwarerepositoryAuthorization under it.
