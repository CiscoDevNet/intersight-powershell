...
```powershell
$HclHardwareCompatibilityProfileAllOf = Initialize-IntersightHclHardwareCompatibilityProfileAllOf  -ClassId null `
 -ObjectType null `
 -DriverIsoUrl null `
 -ErrorCode null `
 -Id null `
...
```powershell
$HclHardwareCompatibilityProfileAllOf | ConvertTo-JSON
```
