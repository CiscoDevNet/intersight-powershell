...
## SYNOPSIS
Get the MemoryPersistentMemoryConfiguration

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMemoryPersistentMemoryConfiguration [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMemoryPersistentMemoryConfiguration [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MemoryPersistentMemoryConfiguration&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryConfiguration
```
Above example returns the list of MemoryPersistentMemoryConfiguration.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryConfiguration -Name "MoName"
```
Above example returns the MemoryPersistentMemoryConfiguration matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryConfiguration -Organization $organization
```
Above example returns the list of MemoryPersistentMemoryConfiguration available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryConfiguration -InlineCount allpages
```
Above example returns the list of MemoryPersistentMemoryConfiguration along with count.
...
### -Name
Specifies the name of the MemoryPersistentMemoryConfiguration.
...
### -Organization
Specifies the organization, to fetch the MemoryPersistentMemoryConfiguration under it.
...
[Set-IntersightMemoryPersistentMemoryConfiguration](./Set-IntersightMemoryPersistentMemoryConfiguration.md)
