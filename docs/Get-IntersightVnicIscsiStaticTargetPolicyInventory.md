...
# Get-IntersightVnicIscsiStaticTargetPolicyInventory

## SYNOPSIS
Get the VnicIscsiStaticTargetPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicIscsiStaticTargetPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicIscsiStaticTargetPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicIscsiStaticTargetPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicIscsiStaticTargetPolicyInventory
```
Above example returns the list of VnicIscsiStaticTargetPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicIscsiStaticTargetPolicyInventory -Name "MoName"
```
Above example returns the VnicIscsiStaticTargetPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicIscsiStaticTargetPolicyInventory -Organization $organization
```
Above example returns the list of VnicIscsiStaticTargetPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicIscsiStaticTargetPolicyInventory -InlineCount allpages
```
Above example returns the list of VnicIscsiStaticTargetPolicyInventory along with count.
...
### -Name
Specifies the name of the VnicIscsiStaticTargetPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the VnicIscsiStaticTargetPolicyInventory under it.
