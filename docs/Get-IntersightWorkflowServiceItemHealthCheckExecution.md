...
# Get-IntersightWorkflowServiceItemHealthCheckExecution

## SYNOPSIS
Get the WorkflowServiceItemHealthCheckExecution

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowServiceItemHealthCheckExecution [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowServiceItemHealthCheckExecution [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowServiceItemHealthCheckExecution&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemHealthCheckExecution
```
Above example returns the list of WorkflowServiceItemHealthCheckExecution.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemHealthCheckExecution -Name "MoName"
```
Above example returns the WorkflowServiceItemHealthCheckExecution matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemHealthCheckExecution -Organization $organization
```
Above example returns the list of WorkflowServiceItemHealthCheckExecution available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemHealthCheckExecution -InlineCount allpages
```
Above example returns the list of WorkflowServiceItemHealthCheckExecution along with count.
...
### -Name
Specifies the name of the WorkflowServiceItemHealthCheckExecution.
...
### -Organization
Specifies the organization, to fetch the WorkflowServiceItemHealthCheckExecution under it.
