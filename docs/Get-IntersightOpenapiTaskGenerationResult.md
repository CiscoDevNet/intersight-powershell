...
# Get-IntersightOpenapiTaskGenerationResult

## SYNOPSIS
Get the OpenapiTaskGenerationResult

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOpenapiTaskGenerationResult [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOpenapiTaskGenerationResult [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;OpenapiTaskGenerationResult&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOpenapiTaskGenerationResult
```
Above example returns the list of OpenapiTaskGenerationResult.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOpenapiTaskGenerationResult -Name "MoName"
```
Above example returns the OpenapiTaskGenerationResult matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOpenapiTaskGenerationResult -Organization $organization
```
Above example returns the list of OpenapiTaskGenerationResult available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOpenapiTaskGenerationResult -InlineCount allpages
```
Above example returns the list of OpenapiTaskGenerationResult along with count.
...
### -Name
Specifies the name of the OpenapiTaskGenerationResult.
...
### -Organization
Specifies the organization, to fetch the OpenapiTaskGenerationResult under it.
...
[Remove-IntersightOpenapiTaskGenerationResult](./Remove-IntersightOpenapiTaskGenerationResult.md)
