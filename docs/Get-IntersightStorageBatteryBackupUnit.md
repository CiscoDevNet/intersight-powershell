...
# Get-IntersightStorageBatteryBackupUnit

## SYNOPSIS
Get the StorageBatteryBackupUnit

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageBatteryBackupUnit [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageBatteryBackupUnit [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageBatteryBackupUnit&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageBatteryBackupUnit
```
Above example returns the list of StorageBatteryBackupUnit.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageBatteryBackupUnit -Name "MoName"
```
Above example returns the StorageBatteryBackupUnit matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageBatteryBackupUnit -Organization $organization
```
Above example returns the list of StorageBatteryBackupUnit available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageBatteryBackupUnit -InlineCount allpages
```
Above example returns the list of StorageBatteryBackupUnit along with count.
...
### -Name
Specifies the name of the StorageBatteryBackupUnit.
...
### -Organization
Specifies the organization, to fetch the StorageBatteryBackupUnit under it.
...
[Set-IntersightStorageBatteryBackupUnit](./Set-IntersightStorageBatteryBackupUnit.md)
