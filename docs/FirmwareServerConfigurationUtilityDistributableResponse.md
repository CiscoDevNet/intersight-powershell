...
```powershell
$FirmwareServerConfigurationUtilityDistributableResponse = Initialize-IntersightFirmwareServerConfigurationUtilityDistributableResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$FirmwareServerConfigurationUtilityDistributableResponse | ConvertTo-JSON
```
