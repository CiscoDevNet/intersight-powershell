...
Initialize-IntersightVnicVifStatus [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< VnicVifStatus.ClassIdEnum>][-Name< string>][-ObjectType< VnicVifStatus.ObjectTypeEnum>][-Reason< string>][-Status< VnicVifStatus.StatusEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
