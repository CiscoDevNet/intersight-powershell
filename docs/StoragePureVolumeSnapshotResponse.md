...
```powershell
$StoragePureVolumeSnapshotResponse = Initialize-IntersightStoragePureVolumeSnapshotResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StoragePureVolumeSnapshotResponse | ConvertTo-JSON
```
