...
## SYNOPSIS
Get the StorageFlexFlashControllerProps

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageFlexFlashControllerProps [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageFlexFlashControllerProps [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageFlexFlashControllerProps&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashControllerProps
```
Above example returns the list of StorageFlexFlashControllerProps.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashControllerProps -Name "MoName"
```
Above example returns the StorageFlexFlashControllerProps matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashControllerProps -Organization $organization
```
Above example returns the list of StorageFlexFlashControllerProps available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashControllerProps -InlineCount allpages
```
Above example returns the list of StorageFlexFlashControllerProps along with count.
...
### -Name
Specifies the name of the StorageFlexFlashControllerProps.
...
### -Organization
Specifies the organization, to fetch the StorageFlexFlashControllerProps under it.
...
[Set-IntersightStorageFlexFlashControllerProps](./Set-IntersightStorageFlexFlashControllerProps.md)
