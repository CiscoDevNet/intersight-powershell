...
Initialize-IntersightAssetIntersightDeviceConnectorConnection [-AdditionalProperties< Dictionary<string,object>>][-ClassId< AssetIntersightDeviceConnectorConnection.ClassIdEnum>][-Credential< Model.AssetCredential>][-ObjectType< AssetIntersightDeviceConnectorConnection.ObjectTypeEnum>]
...
### Example 1
```powershell
PS C:\> Initialize-IntersightAssetIntersightDeviceConnectorConnection
```
