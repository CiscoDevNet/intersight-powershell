...
## SYNOPSIS
Get the FabricUplinkPcRole

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricUplinkPcRole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricUplinkPcRole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricUplinkPcRole&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricUplinkPcRole
```
Above example returns the list of FabricUplinkPcRole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricUplinkPcRole -Name "MoName"
```
Above example returns the FabricUplinkPcRole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricUplinkPcRole -Organization $organization
```
Above example returns the list of FabricUplinkPcRole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricUplinkPcRole -InlineCount allpages
```
Above example returns the list of FabricUplinkPcRole along with count.
...
### -Name
Specifies the name of the FabricUplinkPcRole.
...
### -Organization
Specifies the organization, to fetch the FabricUplinkPcRole under it.
