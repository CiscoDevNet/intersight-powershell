...
## SYNOPSIS
Get the WorkflowWorkflowInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowWorkflowInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowWorkflowInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowWorkflowInfo&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowWorkflowInfo
```
Above example returns the list of WorkflowWorkflowInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowWorkflowInfo -Name "MoName"
```
Above example returns the WorkflowWorkflowInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowWorkflowInfo -Organization $organization
```
Above example returns the list of WorkflowWorkflowInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowWorkflowInfo -InlineCount allpages
```
Above example returns the list of WorkflowWorkflowInfo along with count.
...
### -Name
Specifies the name of the WorkflowWorkflowInfo.
...
### -Organization
Specifies the organization, to fetch the WorkflowWorkflowInfo under it.
