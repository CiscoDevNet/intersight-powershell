...
```powershell
$ExternalsiteAuthorizationResponse = Initialize-IntersightExternalsiteAuthorizationResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$ExternalsiteAuthorizationResponse | ConvertTo-JSON
```
