...
## SYNOPSIS
Get the HyperflexServerFirmwareVersion

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexServerFirmwareVersion [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexServerFirmwareVersion [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexServerFirmwareVersion
```
Above example returns the list of HyperflexServerFirmwareVersion.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexServerFirmwareVersion -Name "MoName"
```
Above example returns the HyperflexServerFirmwareVersion matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexServerFirmwareVersion -Organization $organization
```
Above example returns the list of HyperflexServerFirmwareVersion available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexServerFirmwareVersion -InlineCount allpages
```
Above example returns the list of HyperflexServerFirmwareVersion along with count.
...
### -Name
Specifies the name of the HyperflexServerFirmwareVersion.
...
### -Organization
Specifies the organization, to fetch the HyperflexServerFirmwareVersion under it.
