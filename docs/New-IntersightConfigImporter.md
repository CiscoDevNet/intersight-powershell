...
New-IntersightConfigImporter [-AdditionalProperties< Dictionary<string,object>>][-ImportPath< string>][-ImportSource< ConfigImporter.ImportSourceEnum>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-SkipIntegrityChecks< bool>][-Tags< List<MoTag>>]
...
### Example 1
```powershell
PS C:\> New-IntersightConfigImporter
```
