...
### CmdletParam (Default)
```
Get-IntersightKvmSession [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKvmSession [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;KvmSession&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKvmSession
```
Above example returns the list of KvmSession.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKvmSession -Name "MoName"
```
Above example returns the KvmSession matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKvmSession -Organization $organization
```
Above example returns the list of KvmSession available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKvmSession -InlineCount allpages
```
Above example returns the list of KvmSession along with count.
...
### -Name
Specifies the name of the KvmSession.
...
### -Organization
Specifies the organization, to fetch the KvmSession under it.
