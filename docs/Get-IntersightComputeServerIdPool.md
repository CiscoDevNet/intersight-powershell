...
# Get-IntersightComputeServerIdPool

## SYNOPSIS
Get the ComputeServerIdPool

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputeServerIdPool [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputeServerIdPool [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ComputeServerIdPool&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputeServerIdPool
```
Above example returns the list of ComputeServerIdPool.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputeServerIdPool -Name "MoName"
```
Above example returns the ComputeServerIdPool matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputeServerIdPool -Organization $organization
```
Above example returns the list of ComputeServerIdPool available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputeServerIdPool -InlineCount allpages
```
Above example returns the list of ComputeServerIdPool along with count.
...
### -Name
Specifies the name of the ComputeServerIdPool.
...
### -Organization
Specifies the organization, to fetch the ComputeServerIdPool under it.
