...
```powershell
$WorkflowPendingDynamicWorkflowInfo = Initialize-IntersightWorkflowPendingDynamicWorkflowInfo  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$WorkflowPendingDynamicWorkflowInfo | ConvertTo-JSON
```
