...
## SYNOPSIS
Get the WorkflowWorkflowDefinition

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowWorkflowDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowWorkflowDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowWorkflowDefinition
```
Above example returns the list of WorkflowWorkflowDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowWorkflowDefinition -Name "MoName"
```
Above example returns the WorkflowWorkflowDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowWorkflowDefinition -Organization $organization
```
Above example returns the list of WorkflowWorkflowDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowWorkflowDefinition -InlineCount allpages
```
Above example returns the list of WorkflowWorkflowDefinition along with count.
...
### -Name
Specifies the name of the WorkflowWorkflowDefinition.
...
### -Organization
Specifies the organization, to fetch the WorkflowWorkflowDefinition under it.
