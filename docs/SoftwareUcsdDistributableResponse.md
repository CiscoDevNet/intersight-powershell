...
```powershell
$SoftwareUcsdDistributableResponse = Initialize-IntersightSoftwareUcsdDistributableResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwareUcsdDistributableResponse | ConvertTo-JSON
```
