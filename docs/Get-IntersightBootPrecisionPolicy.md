...
## SYNOPSIS
Get the BootPrecisionPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBootPrecisionPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBootPrecisionPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;BootPrecisionPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBootPrecisionPolicy
```
Above example returns the list of BootPrecisionPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBootPrecisionPolicy -Name "MoName"
```
Above example returns the BootPrecisionPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBootPrecisionPolicy -Organization $organization
```
Above example returns the list of BootPrecisionPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBootPrecisionPolicy -InlineCount allpages
```
Above example returns the list of BootPrecisionPolicy along with count.
...
### -Name
Specifies the name of the BootPrecisionPolicy.
...
### -Organization
Specifies the organization, to fetch the BootPrecisionPolicy under it.
