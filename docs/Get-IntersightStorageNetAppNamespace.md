...
### CmdletParam (Default)
```
Get-IntersightStorageNetAppNamespace [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppNamespace [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
