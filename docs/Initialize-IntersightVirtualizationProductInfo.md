...
Initialize-IntersightVirtualizationProductInfo [-AdditionalProperties< Dictionary<string,object>>][-Build< string>][-ClassId< VirtualizationProductInfo.ClassIdEnum>][-ObjectType< VirtualizationProductInfo.ObjectTypeEnum>][-ProductName< string>][-ProductType< string>][-ProductVendor< string>][-Version< string>]
...
```yaml
Type: VirtualizationProductInfo.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VirtualizationProductInfo.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVirtualizationProductInfo
```
