...
Initialize-IntersightVirtualizationProductInfo [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Build< string>][-ClassId< VirtualizationProductInfo.ClassIdEnum>][-ObjectType< VirtualizationProductInfo.ObjectTypeEnum>][-ProductName< string>][-ProductType< string>][-ProductVendor< string>][-Version< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
