...
```powershell
$FabricEthNetworkControlPolicyResponse = Initialize-IntersightFabricEthNetworkControlPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$FabricEthNetworkControlPolicyResponse | ConvertTo-JSON
```
