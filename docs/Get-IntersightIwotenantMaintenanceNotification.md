...
# Get-IntersightIwotenantMaintenanceNotification

## SYNOPSIS
Get the IwotenantMaintenanceNotification

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIwotenantMaintenanceNotification [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIwotenantMaintenanceNotification [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IwotenantMaintenanceNotification&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIwotenantMaintenanceNotification
```
Above example returns the list of IwotenantMaintenanceNotification.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIwotenantMaintenanceNotification -Name "MoName"
```
Above example returns the IwotenantMaintenanceNotification matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIwotenantMaintenanceNotification -Organization $organization
```
Above example returns the list of IwotenantMaintenanceNotification available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIwotenantMaintenanceNotification -InlineCount allpages
```
Above example returns the list of IwotenantMaintenanceNotification along with count.
...
### -Name
Specifies the name of the IwotenantMaintenanceNotification.
...
### -Organization
Specifies the organization, to fetch the IwotenantMaintenanceNotification under it.
