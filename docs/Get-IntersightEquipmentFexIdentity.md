...
### CmdletParam (Default)
```
Get-IntersightEquipmentFexIdentity [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentFexIdentity [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentFexIdentity
```
Above example returns the list of EquipmentFexIdentity.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentFexIdentity -Name "MoName"
```
Above example returns the EquipmentFexIdentity matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentFexIdentity -Organization $organization
```
Above example returns the list of EquipmentFexIdentity available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentFexIdentity -InlineCount allpages
```
Above example returns the list of EquipmentFexIdentity along with count.
...
### -Name
Specifies the name of the EquipmentFexIdentity.
...
### -Organization
Specifies the organization, to fetch the EquipmentFexIdentity under it.
...
[Set-IntersightEquipmentFexIdentity](./Set-IntersightEquipmentFexIdentity.md)
