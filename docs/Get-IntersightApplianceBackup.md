...
## SYNOPSIS
Get the ApplianceBackup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceBackup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceBackup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceBackup
```
Above example returns the list of ApplianceBackup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceBackup -Name "MoName"
```
Above example returns the ApplianceBackup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceBackup -Organization $organization
```
Above example returns the list of ApplianceBackup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceBackup -InlineCount allpages
```
Above example returns the list of ApplianceBackup along with count.
...
### -Name
Specifies the name of the ApplianceBackup.
...
### -Organization
Specifies the organization, to fetch the ApplianceBackup under it.
