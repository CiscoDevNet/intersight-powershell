...
# Initialize-IntersightKubernetesConfigResultEntry
...
Initialize-IntersightKubernetesConfigResultEntry [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< KubernetesConfigResultEntry.ClassIdEnum>][-CompletedTime< string>][-ConfigResult< Model.KubernetesConfigResultRelationship>][-Context< Model.PolicyConfigResultContext>][-Message< string>][-Moid< string>][-ObjectType< KubernetesConfigResultEntry.ObjectTypeEnum>][-OwnerId< string>][-State< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Type< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: KubernetesConfigResultEntry.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.KubernetesConfigResultRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: KubernetesConfigResultEntry.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightKubernetesConfigResultEntry
```
