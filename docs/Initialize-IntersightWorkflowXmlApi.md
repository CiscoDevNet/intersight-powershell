...
Initialize-IntersightWorkflowXmlApi [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Body< string>][-ClassId< WorkflowXmlApi.ClassIdEnum>][-ContentType< string>][-Description< string>][-ErrorContentType< string>][-Label< string>][-Name< string>][-ObjectType< WorkflowXmlApi.ObjectTypeEnum>][-Outcomes< object>][-ResponseSpec< object>][-SkipOnCondition< string>][-StartDelay< long>][-Timeout< long>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowXmlApi.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowXmlApi.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowXmlApi
```
