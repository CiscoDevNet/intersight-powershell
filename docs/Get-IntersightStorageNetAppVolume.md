...
## SYNOPSIS
Get the StorageNetAppVolume

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppVolume [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppVolume [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppVolume&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppVolume
```
Above example returns the list of StorageNetAppVolume.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppVolume -Name "MoName"
```
Above example returns the StorageNetAppVolume matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppVolume -Organization $organization
```
Above example returns the list of StorageNetAppVolume available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppVolume -InlineCount allpages
```
Above example returns the list of StorageNetAppVolume along with count.
...
### -Name
Specifies the name of the StorageNetAppVolume.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppVolume under it.
...
[Set-IntersightStorageNetAppVolume](./Set-IntersightStorageNetAppVolume.md)
