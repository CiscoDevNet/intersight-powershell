...
# Initialize-IntersightVirtualizationVmwareVirtualMachineSnapshot
...
Initialize-IntersightVirtualizationVmwareVirtualMachineSnapshot [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< VirtualizationVmwareVirtualMachineSnapshot.ClassIdEnum>][-CreationTime< DateTime>][-CurrentSnapshot< bool>][-Description< string>][-Golden< bool>][-Identity< string>][-Key< long>][-Moid< string>][-Name< string>][-ObjectType< VirtualizationVmwareVirtualMachineSnapshot.ObjectTypeEnum>][-PredecessorId< long>][-Quiesced< bool>][-RefValue< string>][-RegisteredDevice< Model.AssetDeviceRegistrationRelationship>][-SnapshotSize< long>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: VirtualizationVmwareVirtualMachineSnapshot.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VirtualizationVmwareVirtualMachineSnapshot.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVirtualizationVmwareVirtualMachineSnapshot
```
