...
```powershell
$CapabilityEquipmentPhysicalDefResponse = Initialize-IntersightCapabilityEquipmentPhysicalDefResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilityEquipmentPhysicalDefResponse | ConvertTo-JSON
```
