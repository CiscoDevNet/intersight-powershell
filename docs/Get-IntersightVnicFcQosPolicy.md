...
## SYNOPSIS
Get the VnicFcQosPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicFcQosPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicFcQosPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicFcQosPolicy
```
Above example returns the list of VnicFcQosPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicFcQosPolicy -Name "MoName"
```
Above example returns the VnicFcQosPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicFcQosPolicy -Organization $organization
```
Above example returns the list of VnicFcQosPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicFcQosPolicy -InlineCount allpages
```
Above example returns the list of VnicFcQosPolicy along with count.
...
### -Name
Specifies the name of the VnicFcQosPolicy.
...
### -Organization
Specifies the organization, to fetch the VnicFcQosPolicy under it.
