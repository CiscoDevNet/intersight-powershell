...
## SYNOPSIS
Get the KubernetesVirtualMachineInstanceType

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesVirtualMachineInstanceType [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesVirtualMachineInstanceType [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesVirtualMachineInstanceType
```
Above example returns the list of KubernetesVirtualMachineInstanceType.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesVirtualMachineInstanceType -Name "MoName"
```
Above example returns the KubernetesVirtualMachineInstanceType matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesVirtualMachineInstanceType -Organization $organization
```
Above example returns the list of KubernetesVirtualMachineInstanceType available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesVirtualMachineInstanceType -InlineCount allpages
```
Above example returns the list of KubernetesVirtualMachineInstanceType along with count.
...
### -Name
Specifies the name of the KubernetesVirtualMachineInstanceType.
...
### -Organization
Specifies the organization, to fetch the KubernetesVirtualMachineInstanceType under it.
