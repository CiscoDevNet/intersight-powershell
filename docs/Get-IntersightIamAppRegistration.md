...
## SYNOPSIS
Get the IamAppRegistration

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamAppRegistration [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamAppRegistration [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamAppRegistration
```
Above example returns the list of IamAppRegistration.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamAppRegistration -Name "MoName"
```
Above example returns the IamAppRegistration matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamAppRegistration -Organization $organization
```
Above example returns the list of IamAppRegistration available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamAppRegistration -InlineCount allpages
```
Above example returns the list of IamAppRegistration along with count.
...
### -Name
Specifies the name of the IamAppRegistration.
...
### -Organization
Specifies the organization, to fetch the IamAppRegistration under it.
