...
# Get-IntersightOpenapiProcessFile

## SYNOPSIS
Get the OpenapiProcessFile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOpenapiProcessFile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOpenapiProcessFile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;OpenapiProcessFile&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOpenapiProcessFile
```
Above example returns the list of OpenapiProcessFile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOpenapiProcessFile -Name "MoName"
```
Above example returns the OpenapiProcessFile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOpenapiProcessFile -Organization $organization
```
Above example returns the list of OpenapiProcessFile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOpenapiProcessFile -InlineCount allpages
```
Above example returns the list of OpenapiProcessFile along with count.
...
### -Name
Specifies the name of the OpenapiProcessFile.
...
### -Organization
Specifies the organization, to fetch the OpenapiProcessFile under it.
...
[Remove-IntersightOpenapiProcessFile](./Remove-IntersightOpenapiProcessFile.md)
