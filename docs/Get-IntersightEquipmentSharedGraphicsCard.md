...
### CmdletParam (Default)
```
Get-IntersightEquipmentSharedGraphicsCard [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentSharedGraphicsCard [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
