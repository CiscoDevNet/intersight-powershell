...
# Initialize-IntersightHyperflexClusterStoragePolicy
...
Initialize-IntersightHyperflexClusterStoragePolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< HyperflexClusterStoragePolicy.ClassIdEnum>][-ClusterProfiles< System.Collections.Generic.List`1[Model.HyperflexClusterProfileRelationship]>][-Description< string>][-DiskPartitionCleanup< bool>][-LogicalAvalabilityZoneConfig< Model.HyperflexLogicalAvailabilityZone>][-Moid< string>][-Name< string>][-ObjectType< HyperflexClusterStoragePolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-VdiOptimization< bool>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: HyperflexClusterStoragePolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.HyperflexLogicalAvailabilityZone
Parameter Sets: (All)
Aliases:
...
```yaml
Type: HyperflexClusterStoragePolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightHyperflexClusterStoragePolicy
```
