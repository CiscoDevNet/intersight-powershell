...
# Initialize-IntersightCapabilityServerPcieConnectivityCatalog
...
```yaml
Type: CapabilityServerPcieConnectivityCatalog.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CapabilityServerPcieConnectivityCatalog.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.CapabilityServerPcieConnectivityLayout]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCapabilityServerPcieConnectivityCatalog
```
