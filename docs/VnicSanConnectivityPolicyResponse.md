...
```powershell
$VnicSanConnectivityPolicyResponse = Initialize-IntersightVnicSanConnectivityPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$VnicSanConnectivityPolicyResponse | ConvertTo-JSON
```
