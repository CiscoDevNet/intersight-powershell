...
### CmdletParam (Default)
```
Get-IntersightAccessPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAccessPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAccessPolicy
```
Above example returns the list of AccessPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAccessPolicy -Name "MoName"
```
Above example returns the AccessPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAccessPolicy -Organization $organization
```
Above example returns the list of AccessPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAccessPolicy -InlineCount allpages
```
Above example returns the list of AccessPolicy along with count.
...
### -Name
Specifies the name of the AccessPolicy.
...
### -Organization
Specifies the organization, to fetch the AccessPolicy under it.
