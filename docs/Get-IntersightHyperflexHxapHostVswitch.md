...
# Get-IntersightHyperflexHxapHostVswitch

## SYNOPSIS
Get the HyperflexHxapHostVswitch

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHxapHostVswitch [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHxapHostVswitch [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHxapHostVswitch&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapHostVswitch
```
Above example returns the list of HyperflexHxapHostVswitch.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapHostVswitch -Name "MoName"
```
Above example returns the HyperflexHxapHostVswitch matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapHostVswitch -Organization $organization
```
Above example returns the list of HyperflexHxapHostVswitch available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapHostVswitch -InlineCount allpages
```
Above example returns the list of HyperflexHxapHostVswitch along with count.
...
### -Name
Specifies the name of the HyperflexHxapHostVswitch.
...
### -Organization
Specifies the organization, to fetch the HyperflexHxapHostVswitch under it.
