...
```yaml
Type: System.Collections.Generic.List`1[Model.NetworkFeatureControlRelationship]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.NetworkInterfaceListRelationship]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.NetworkLicenseFileRelationship]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.NetworkSupervisorCardRelationship]
Parameter Sets: (All)
Aliases:
