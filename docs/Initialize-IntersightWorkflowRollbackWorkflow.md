...
# Initialize-IntersightWorkflowRollbackWorkflow
...
Initialize-IntersightWorkflowRollbackWorkflow [-Action< WorkflowRollbackWorkflow.ActionEnum>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< WorkflowRollbackWorkflow.ClassIdEnum>][-ContinueOnTaskFailure< bool>][-Moid< string>][-ObjectType< WorkflowRollbackWorkflow.ObjectTypeEnum>][-PrimaryWorkflow< Model.WorkflowWorkflowInfoRelationship>][-SelectedTasks< System.Collections.Generic.List`1[Model.WorkflowRollbackWorkflowTask]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowRollbackWorkflow.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowRollbackWorkflow.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.WorkflowRollbackWorkflowTask]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowRollbackWorkflow
```
