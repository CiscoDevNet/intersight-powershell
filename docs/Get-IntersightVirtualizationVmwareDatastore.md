...
## SYNOPSIS
Get the VirtualizationVmwareDatastore

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareDatastore [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareDatastore [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareDatastore&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDatastore
```
Above example returns the list of VirtualizationVmwareDatastore.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDatastore -Name "MoName"
```
Above example returns the VirtualizationVmwareDatastore matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDatastore -Organization $organization
```
Above example returns the list of VirtualizationVmwareDatastore available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDatastore -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareDatastore along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareDatastore.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareDatastore under it.
...
[Set-IntersightVirtualizationVmwareDatastore](./Set-IntersightVirtualizationVmwareDatastore.md)
