...
# Get-IntersightIwotenantTenantCustomization

## SYNOPSIS
Get the IwotenantTenantCustomization

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIwotenantTenantCustomization [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIwotenantTenantCustomization [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IwotenantTenantCustomization&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIwotenantTenantCustomization
```
Above example returns the list of IwotenantTenantCustomization.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIwotenantTenantCustomization -Name "MoName"
```
Above example returns the IwotenantTenantCustomization matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIwotenantTenantCustomization -Organization $organization
```
Above example returns the list of IwotenantTenantCustomization available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIwotenantTenantCustomization -InlineCount allpages
```
Above example returns the list of IwotenantTenantCustomization along with count.
...
### -Name
Specifies the name of the IwotenantTenantCustomization.
...
### -Organization
Specifies the organization, to fetch the IwotenantTenantCustomization under it.
