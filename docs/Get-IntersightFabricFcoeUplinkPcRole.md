...
## SYNOPSIS
Get the FabricFcoeUplinkPcRole

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricFcoeUplinkPcRole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricFcoeUplinkPcRole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricFcoeUplinkPcRole&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricFcoeUplinkPcRole
```
Above example returns the list of FabricFcoeUplinkPcRole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricFcoeUplinkPcRole -Name "MoName"
```
Above example returns the FabricFcoeUplinkPcRole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricFcoeUplinkPcRole -Organization $organization
```
Above example returns the list of FabricFcoeUplinkPcRole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricFcoeUplinkPcRole -InlineCount allpages
```
Above example returns the list of FabricFcoeUplinkPcRole along with count.
...
### -Name
Specifies the name of the FabricFcoeUplinkPcRole.
...
### -Organization
Specifies the organization, to fetch the FabricFcoeUplinkPcRole under it.
