...
## SYNOPSIS
Get the NiatelemetryPodTimeServerPolicies

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryPodTimeServerPolicies [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryPodTimeServerPolicies [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryPodTimeServerPolicies&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPodTimeServerPolicies
```
Above example returns the list of NiatelemetryPodTimeServerPolicies.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPodTimeServerPolicies -Name "MoName"
```
Above example returns the NiatelemetryPodTimeServerPolicies matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPodTimeServerPolicies -Organization $organization
```
Above example returns the list of NiatelemetryPodTimeServerPolicies available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPodTimeServerPolicies -InlineCount allpages
```
Above example returns the list of NiatelemetryPodTimeServerPolicies along with count.
...
### -Name
Specifies the name of the NiatelemetryPodTimeServerPolicies.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryPodTimeServerPolicies under it.
