...
### CmdletParam (Default)
```
Get-IntersightHyperflexSoftwareDistributionComponent [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexSoftwareDistributionComponent [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareDistributionComponent
```
Above example returns the list of HyperflexSoftwareDistributionComponent.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareDistributionComponent -Name "MoName"
```
Above example returns the HyperflexSoftwareDistributionComponent matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareDistributionComponent -Organization $organization
```
Above example returns the list of HyperflexSoftwareDistributionComponent available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareDistributionComponent -InlineCount allpages
```
Above example returns the list of HyperflexSoftwareDistributionComponent along with count.
...
### -Name
Specifies the name of the HyperflexSoftwareDistributionComponent.
...
### -Organization
Specifies the organization, to fetch the HyperflexSoftwareDistributionComponent under it.
