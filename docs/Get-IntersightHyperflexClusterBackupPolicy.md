...
## SYNOPSIS
Get the HyperflexClusterBackupPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexClusterBackupPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexClusterBackupPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;HyperflexClusterBackupPolicy&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterBackupPolicy
```
Above example returns the list of HyperflexClusterBackupPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterBackupPolicy -Name "MoName"
```
Above example returns the HyperflexClusterBackupPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterBackupPolicy -Organization $organization
```
Above example returns the list of HyperflexClusterBackupPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterBackupPolicy -InlineCount allpages
```
Above example returns the list of HyperflexClusterBackupPolicy along with count.
...
### -Name
Specifies the name of the HyperflexClusterBackupPolicy.
...
### -Organization
Specifies the organization, to fetch the HyperflexClusterBackupPolicy under it.
