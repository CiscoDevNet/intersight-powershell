...
# Get-IntersightPartnerintegrationModel

## SYNOPSIS
Get the PartnerintegrationModel

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPartnerintegrationModel [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPartnerintegrationModel [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PartnerintegrationModel&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationModel
```
Above example returns the list of PartnerintegrationModel.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationModel -Name "MoName"
```
Above example returns the PartnerintegrationModel matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationModel -Organization $organization
```
Above example returns the list of PartnerintegrationModel available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationModel -InlineCount allpages
```
Above example returns the list of PartnerintegrationModel along with count.
...
### -Name
Specifies the name of the PartnerintegrationModel.
...
### -Organization
Specifies the organization, to fetch the PartnerintegrationModel under it.
...
[Remove-IntersightPartnerintegrationModel](./Remove-IntersightPartnerintegrationModel.md)
