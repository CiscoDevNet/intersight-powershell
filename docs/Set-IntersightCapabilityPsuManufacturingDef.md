...
Set-IntersightCapabilityPsuManufacturingDef [-AdditionalProperties< Dictionary<string,object>>][-Caption< string>][-Description< string>][[-Moid]< string>][-Name< string>][-Pid< string>][-ProductName< string>][-Sku< string>][-Tags< List<MoTag>>][-Vid< string>]
