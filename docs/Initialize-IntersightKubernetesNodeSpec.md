...
Initialize-IntersightKubernetesNodeSpec [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< KubernetesNodeSpec.ClassIdEnum>][-ObjectType< KubernetesNodeSpec.ObjectTypeEnum>][-PodCidr< string>][-ProviderId< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
