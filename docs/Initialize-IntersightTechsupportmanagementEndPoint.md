...
# Initialize-IntersightTechsupportmanagementEndPoint
...
Initialize-IntersightTechsupportmanagementEndPoint [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< TechsupportmanagementEndPoint.ClassIdEnum>][-ClusterMember< Model.AssetClusterMemberRelationship>][-DeviceMoid< string>][-DeviceRegistration< Model.AssetDeviceRegistrationRelationship>][-DeviceType< string>][-Dn< string>][-Moid< string>][-ObjectType< TechsupportmanagementEndPoint.ObjectTypeEnum>][-Pid< string>][-PlatformType< TechsupportmanagementEndPoint.PlatformTypeEnum>][-Serial< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TargetResource< Model.MoBaseMoRelationship>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: TechsupportmanagementEndPoint.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TechsupportmanagementEndPoint.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTechsupportmanagementEndPoint
```
