...
## SYNOPSIS
Get the NiaapiApicLatestMaintainedRelease

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiApicLatestMaintainedRelease [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiApicLatestMaintainedRelease [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiaapiApicLatestMaintainedRelease&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiApicLatestMaintainedRelease
```
Above example returns the list of NiaapiApicLatestMaintainedRelease.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiApicLatestMaintainedRelease -Name "MoName"
```
Above example returns the NiaapiApicLatestMaintainedRelease matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiApicLatestMaintainedRelease -Organization $organization
```
Above example returns the list of NiaapiApicLatestMaintainedRelease available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiApicLatestMaintainedRelease -InlineCount allpages
```
Above example returns the list of NiaapiApicLatestMaintainedRelease along with count.
...
### -Name
Specifies the name of the NiaapiApicLatestMaintainedRelease.
...
### -Organization
Specifies the organization, to fetch the NiaapiApicLatestMaintainedRelease under it.
