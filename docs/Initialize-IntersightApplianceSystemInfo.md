...
Initialize-IntersightApplianceSystemInfo [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< ApplianceSystemInfo.ClassIdEnum>][-Moid< string>][-ObjectType< ApplianceSystemInfo.ObjectTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TimeZone< ApplianceSystemInfo.TimeZoneEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ApplianceSystemInfo.TimeZoneEnum
Parameter Sets: (All)
Aliases:
