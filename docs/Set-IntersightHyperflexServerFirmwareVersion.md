...
Set-IntersightHyperflexServerFirmwareVersion [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AppCatalog< HyperflexAppCatalogRelationship>][[-Moid]< string>][-ServerFirmwareVersionEntries< System.Collections.Generic.List`1[HyperflexServerFirmwareVersionEntryRelationship]>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> Set-IntersightHyperflexServerFirmwareVersion
```
