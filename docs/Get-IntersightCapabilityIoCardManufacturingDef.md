...
### CmdletParam (Default)
```
Get-IntersightCapabilityIoCardManufacturingDef [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityIoCardManufacturingDef [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityIoCardManufacturingDef
```
Above example returns the list of CapabilityIoCardManufacturingDef.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityIoCardManufacturingDef -Name "MoName"
```
Above example returns the CapabilityIoCardManufacturingDef matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityIoCardManufacturingDef -Organization $organization
```
Above example returns the list of CapabilityIoCardManufacturingDef available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityIoCardManufacturingDef -InlineCount allpages
```
Above example returns the list of CapabilityIoCardManufacturingDef along with count.
...
### -Name
Specifies the name of the CapabilityIoCardManufacturingDef.
...
### -Organization
Specifies the organization, to fetch the CapabilityIoCardManufacturingDef under it.
