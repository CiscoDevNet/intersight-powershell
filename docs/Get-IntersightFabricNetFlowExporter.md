...
# Get-IntersightFabricNetFlowExporter

## SYNOPSIS
Get the FabricNetFlowExporter

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricNetFlowExporter [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricNetFlowExporter [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricNetFlowExporter&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowExporter
```
Above example returns the list of FabricNetFlowExporter.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowExporter -Name "MoName"
```
Above example returns the FabricNetFlowExporter matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowExporter -Organization $organization
```
Above example returns the list of FabricNetFlowExporter available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowExporter -InlineCount allpages
```
Above example returns the list of FabricNetFlowExporter along with count.
...
### -Name
Specifies the name of the FabricNetFlowExporter.
...
### -Organization
Specifies the organization, to fetch the FabricNetFlowExporter under it.
...
[Set-IntersightFabricNetFlowExporter](./Set-IntersightFabricNetFlowExporter.md)
