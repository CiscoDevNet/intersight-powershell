...
# Initialize-IntersightTechsupportmanagementTechSupportBundle
...
Initialize-IntersightTechsupportmanagementTechSupportBundle [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< TechsupportmanagementTechSupportBundle.ClassIdEnum>][-Moid< string>][-ObjectType< TechsupportmanagementTechSupportBundle.ObjectTypeEnum>][-Pid< string>][-PlatformParam< Model.ConnectorPlatformParamBase>][-PlatformType< TechsupportmanagementTechSupportBundle.PlatformTypeEnum>][-Serial< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TargetResource< Model.MoBaseMoRelationship>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: TechsupportmanagementTechSupportBundle.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TechsupportmanagementTechSupportBundle.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.ConnectorPlatformParamBase
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTechsupportmanagementTechSupportBundle
```
