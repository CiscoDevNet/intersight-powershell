...
# Initialize-IntersightKubernetesCluster
...
Initialize-IntersightKubernetesCluster [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< KubernetesCluster.ClassIdEnum>][-ClusterAddonProfile< Model.KubernetesClusterAddonProfileRelationship>][-ConnectionStatus< KubernetesCluster.ConnectionStatusEnum>][-KubeConfig< string>][-Moid< string>][-ObjectType< KubernetesCluster.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-RegisteredDevices< System.Collections.Generic.List`1[Model.AssetDeviceRegistrationRelationship]>][-StorageClusters< System.Collections.Generic.List`1[Model.StorageBaseClusterRelationship]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: KubernetesCluster.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.KubernetesClusterAddonProfileRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: KubernetesCluster.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.AssetDeviceRegistrationRelationship]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightKubernetesCluster
```
