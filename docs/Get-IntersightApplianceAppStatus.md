...
## SYNOPSIS
Get the ApplianceAppStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceAppStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceAppStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceAppStatus
```
Above example returns the list of ApplianceAppStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceAppStatus -Name "MoName"
```
Above example returns the ApplianceAppStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceAppStatus -Organization $organization
```
Above example returns the list of ApplianceAppStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceAppStatus -InlineCount allpages
```
Above example returns the list of ApplianceAppStatus along with count.
...
### -Name
Specifies the name of the ApplianceAppStatus.
...
### -Organization
Specifies the organization, to fetch the ApplianceAppStatus under it.
