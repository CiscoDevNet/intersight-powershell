...
# Get-IntersightStoragePureArrayAlerts

## SYNOPSIS
Get the StoragePureArrayAlerts

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureArrayAlerts [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureArrayAlerts [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureArrayAlerts&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureArrayAlerts
```
Above example returns the list of StoragePureArrayAlerts.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureArrayAlerts -Name "MoName"
```
Above example returns the StoragePureArrayAlerts matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureArrayAlerts -Organization $organization
```
Above example returns the list of StoragePureArrayAlerts available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureArrayAlerts -InlineCount allpages
```
Above example returns the list of StoragePureArrayAlerts along with count.
...
### -Name
Specifies the name of the StoragePureArrayAlerts.
...
### -Organization
Specifies the organization, to fetch the StoragePureArrayAlerts under it.
