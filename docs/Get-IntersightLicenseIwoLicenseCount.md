...
## SYNOPSIS
Get the LicenseIwoLicenseCount

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightLicenseIwoLicenseCount [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightLicenseIwoLicenseCount [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;LicenseIwoLicenseCount&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightLicenseIwoLicenseCount
```
Above example returns the list of LicenseIwoLicenseCount.

### Example 2
```powershell
PS C:\> $result = Get-IntersightLicenseIwoLicenseCount -Name "MoName"
```
Above example returns the LicenseIwoLicenseCount matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightLicenseIwoLicenseCount -Organization $organization
```
Above example returns the list of LicenseIwoLicenseCount available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightLicenseIwoLicenseCount -InlineCount allpages
```
Above example returns the list of LicenseIwoLicenseCount along with count.
...
### -Name
Specifies the name of the LicenseIwoLicenseCount.
...
### -Organization
Specifies the organization, to fetch the LicenseIwoLicenseCount under it.
...
[Set-IntersightLicenseIwoLicenseCount](./Set-IntersightLicenseIwoLicenseCount.md)
