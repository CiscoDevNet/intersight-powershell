...
# Get-IntersightKubernetesPod

## SYNOPSIS
Get the KubernetesPod

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesPod [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesPod [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;KubernetesPod&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesPod
```
Above example returns the list of KubernetesPod.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesPod -Name "MoName"
```
Above example returns the KubernetesPod matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesPod -Organization $organization
```
Above example returns the list of KubernetesPod available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesPod -InlineCount allpages
```
Above example returns the list of KubernetesPod along with count.
...
### -Name
Specifies the name of the KubernetesPod.
...
### -Organization
Specifies the organization, to fetch the KubernetesPod under it.
...
[Remove-IntersightKubernetesPod](./Remove-IntersightKubernetesPod.md)
