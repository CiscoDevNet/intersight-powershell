...
# Get-IntersightComputeVmedia

## SYNOPSIS
Get the ComputeVmedia

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputeVmedia [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputeVmedia [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ComputeVmedia&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputeVmedia
```
Above example returns the list of ComputeVmedia.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputeVmedia -Name "MoName"
```
Above example returns the ComputeVmedia matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputeVmedia -Organization $organization
```
Above example returns the list of ComputeVmedia available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputeVmedia -InlineCount allpages
```
Above example returns the list of ComputeVmedia along with count.
...
### -Name
Specifies the name of the ComputeVmedia.
...
### -Organization
Specifies the organization, to fetch the ComputeVmedia under it.
