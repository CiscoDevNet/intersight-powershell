...
## SYNOPSIS
Get the VirtualizationVmwareFolder

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareFolder [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareFolder [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareFolder&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareFolder
```
Above example returns the list of VirtualizationVmwareFolder.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareFolder -Name "MoName"
```
Above example returns the VirtualizationVmwareFolder matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareFolder -Organization $organization
```
Above example returns the list of VirtualizationVmwareFolder available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareFolder -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareFolder along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareFolder.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareFolder under it.
...
[Set-IntersightVirtualizationVmwareFolder](./Set-IntersightVirtualizationVmwareFolder.md)
