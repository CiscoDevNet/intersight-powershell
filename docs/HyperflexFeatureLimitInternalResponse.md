...
```powershell
$HyperflexFeatureLimitInternalResponse = Initialize-IntersightHyperflexFeatureLimitInternalResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexFeatureLimitInternalResponse | ConvertTo-JSON
```
