...
```powershell
$HyperflexFeatureLimitInternalRelationship = Initialize-IntersightHyperflexFeatureLimitInternalRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexFeatureLimitInternalRelationship | ConvertTo-JSON
```
