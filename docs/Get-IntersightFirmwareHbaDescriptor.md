...
## SYNOPSIS
Get the FirmwareHbaDescriptor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareHbaDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareHbaDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareHbaDescriptor
```
Above example returns the list of FirmwareHbaDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareHbaDescriptor -Name "MoName"
```
Above example returns the FirmwareHbaDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareHbaDescriptor -Organization $organization
```
Above example returns the list of FirmwareHbaDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareHbaDescriptor -InlineCount allpages
```
Above example returns the list of FirmwareHbaDescriptor along with count.
...
### -Name
Specifies the name of the FirmwareHbaDescriptor.
...
### -Organization
Specifies the organization, to fetch the FirmwareHbaDescriptor under it.
