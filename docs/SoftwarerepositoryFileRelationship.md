...
```powershell
$SoftwarerepositoryFileRelationship = Initialize-IntersightSoftwarerepositoryFileRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$SoftwarerepositoryFileRelationship | ConvertTo-JSON
```
