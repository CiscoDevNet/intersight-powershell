...
## SYNOPSIS
Get the EquipmentSwitchCard

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentSwitchCard [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentSwitchCard [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentSwitchCard&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentSwitchCard
```
Above example returns the list of EquipmentSwitchCard.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentSwitchCard -Name "MoName"
```
Above example returns the EquipmentSwitchCard matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentSwitchCard -Organization $organization
```
Above example returns the list of EquipmentSwitchCard available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentSwitchCard -InlineCount allpages
```
Above example returns the list of EquipmentSwitchCard along with count.
...
### -Name
Specifies the name of the EquipmentSwitchCard.
...
### -Organization
Specifies the organization, to fetch the EquipmentSwitchCard under it.
...
[Set-IntersightEquipmentSwitchCard](./Set-IntersightEquipmentSwitchCard.md)
