...
# Get-IntersightFabricFcZonePolicy

## SYNOPSIS
Get the FabricFcZonePolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricFcZonePolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricFcZonePolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricFcZonePolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricFcZonePolicy
```
Above example returns the list of FabricFcZonePolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricFcZonePolicy -Name "MoName"
```
Above example returns the FabricFcZonePolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricFcZonePolicy -Organization $organization
```
Above example returns the list of FabricFcZonePolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricFcZonePolicy -InlineCount allpages
```
Above example returns the list of FabricFcZonePolicy along with count.
...
### -Name
Specifies the name of the FabricFcZonePolicy.
...
### -Organization
Specifies the organization, to fetch the FabricFcZonePolicy under it.
