...
## SYNOPSIS
Get the StorageDriveGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageDriveGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageDriveGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageDriveGroup&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageDriveGroup
```
Above example returns the list of StorageDriveGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageDriveGroup -Name "MoName"
```
Above example returns the StorageDriveGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageDriveGroup -Organization $organization
```
Above example returns the list of StorageDriveGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageDriveGroup -InlineCount allpages
```
Above example returns the list of StorageDriveGroup along with count.
...
### -Name
Specifies the name of the StorageDriveGroup.
...
### -Organization
Specifies the organization, to fetch the StorageDriveGroup under it.
