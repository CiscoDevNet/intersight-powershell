...
# Get-IntersightComputePersonality

## SYNOPSIS
Get the ComputePersonality

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputePersonality [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputePersonality [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ComputePersonality&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputePersonality
```
Above example returns the list of ComputePersonality.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputePersonality -Name "MoName"
```
Above example returns the ComputePersonality matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputePersonality -Organization $organization
```
Above example returns the list of ComputePersonality available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputePersonality -InlineCount allpages
```
Above example returns the list of ComputePersonality along with count.
...
### -Name
Specifies the name of the ComputePersonality.
...
### -Organization
Specifies the organization, to fetch the ComputePersonality under it.
...
[Set-IntersightComputePersonality](./Set-IntersightComputePersonality.md)
