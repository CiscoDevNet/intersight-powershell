...
## SYNOPSIS
Get the HyperflexNode

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexNode [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexNode [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexNode&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexNode
```
Above example returns the list of HyperflexNode.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexNode -Name "MoName"
```
Above example returns the HyperflexNode matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexNode -Organization $organization
```
Above example returns the list of HyperflexNode available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexNode -InlineCount allpages
```
Above example returns the list of HyperflexNode along with count.
...
### -Name
Specifies the name of the HyperflexNode.
...
### -Organization
Specifies the organization, to fetch the HyperflexNode under it.
