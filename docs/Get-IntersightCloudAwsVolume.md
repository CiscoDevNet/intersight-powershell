...
# Get-IntersightCloudAwsVolume

## SYNOPSIS
Get the CloudAwsVolume

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudAwsVolume [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudAwsVolume [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;CloudAwsVolume&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudAwsVolume
```
Above example returns the list of CloudAwsVolume.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudAwsVolume -Name "MoName"
```
Above example returns the CloudAwsVolume matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudAwsVolume -Organization $organization
```
Above example returns the list of CloudAwsVolume available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudAwsVolume -InlineCount allpages
```
Above example returns the list of CloudAwsVolume along with count.
...
### -Name
Specifies the name of the CloudAwsVolume.
...
### -Organization
Specifies the organization, to fetch the CloudAwsVolume under it.
