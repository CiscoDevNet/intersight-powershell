...
Initialize-IntersightUcsdUcsdRestoreParameters [-AdditionalProperties< Dictionary<string,object>>][-ClassId< UcsdUcsdRestoreParameters.ClassIdEnum>][-Location< string>][-ObjectType< UcsdUcsdRestoreParameters.ObjectTypeEnum>][-Password< string>][-Protocol< string>][-RestoreConfigurationFiles< bool>][-RestoreLicense< bool>][-Username< string>]
