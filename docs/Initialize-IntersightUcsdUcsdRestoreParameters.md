...
Initialize-IntersightUcsdUcsdRestoreParameters [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< UcsdUcsdRestoreParameters.ClassIdEnum>][-Location< string>][-ObjectType< UcsdUcsdRestoreParameters.ObjectTypeEnum>][-Password< string>][-Protocol< string>][-RestoreConfigurationFiles< bool>][-RestoreLicense< bool>][-Username< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: UcsdUcsdRestoreParameters.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightUcsdUcsdRestoreParameters
```
