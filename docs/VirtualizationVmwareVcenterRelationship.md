...
```powershell
$VirtualizationVmwareVcenterRelationship = Initialize-IntersightVirtualizationVmwareVcenterRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$VirtualizationVmwareVcenterRelationship | ConvertTo-JSON
```
