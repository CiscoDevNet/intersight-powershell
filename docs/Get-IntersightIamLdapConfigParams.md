...
# Get-IntersightIamLdapConfigParams

## SYNOPSIS
Get the IamLdapConfigParams

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamLdapConfigParams [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamLdapConfigParams [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamLdapConfigParams&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamLdapConfigParams
```
Above example returns the list of IamLdapConfigParams.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamLdapConfigParams -Name "MoName"
```
Above example returns the IamLdapConfigParams matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamLdapConfigParams -Organization $organization
```
Above example returns the list of IamLdapConfigParams available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamLdapConfigParams -InlineCount allpages
```
Above example returns the list of IamLdapConfigParams along with count.
...
### -Name
Specifies the name of the IamLdapConfigParams.
...
### -Organization
Specifies the organization, to fetch the IamLdapConfigParams under it.
