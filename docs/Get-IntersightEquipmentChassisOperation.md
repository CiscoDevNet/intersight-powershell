...
### CmdletParam (Default)
```
Get-IntersightEquipmentChassisOperation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentChassisOperation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisOperation
```
Above example returns the list of EquipmentChassisOperation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisOperation -Name "MoName"
```
Above example returns the EquipmentChassisOperation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisOperation -Organization $organization
```
Above example returns the list of EquipmentChassisOperation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisOperation -InlineCount allpages
```
Above example returns the list of EquipmentChassisOperation along with count.
...
### -Name
Specifies the name of the EquipmentChassisOperation.
...
### -Organization
Specifies the organization, to fetch the EquipmentChassisOperation under it.
...
[Set-IntersightEquipmentChassisOperation](./Set-IntersightEquipmentChassisOperation.md)
