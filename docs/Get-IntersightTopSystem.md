...
### CmdletParam (Default)
```
Get-IntersightTopSystem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightTopSystem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;TopSystem&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightTopSystem
```
Above example returns the list of TopSystem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightTopSystem -Name "MoName"
```
Above example returns the TopSystem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightTopSystem -Organization $organization
```
Above example returns the list of TopSystem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightTopSystem -InlineCount allpages
```
Above example returns the list of TopSystem along with count.
...
### -Name
Specifies the name of the TopSystem.
...
### -Organization
Specifies the organization, to fetch the TopSystem under it.
...
[Set-IntersightTopSystem](./Set-IntersightTopSystem.md)
