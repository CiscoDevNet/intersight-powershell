...
## SYNOPSIS
Get the StorageNetAppAggregateEvent

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppAggregateEvent [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppAggregateEvent [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppAggregateEvent&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppAggregateEvent
```
Above example returns the list of StorageNetAppAggregateEvent.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppAggregateEvent -Name "MoName"
```
Above example returns the StorageNetAppAggregateEvent matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppAggregateEvent -Organization $organization
```
Above example returns the list of StorageNetAppAggregateEvent available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppAggregateEvent -InlineCount allpages
```
Above example returns the list of StorageNetAppAggregateEvent along with count.
...
### -Name
Specifies the name of the StorageNetAppAggregateEvent.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppAggregateEvent under it.
