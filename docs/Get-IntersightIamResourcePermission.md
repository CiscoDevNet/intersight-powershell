...
## SYNOPSIS
Get the IamResourcePermission

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamResourcePermission [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamResourcePermission [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IamResourcePermission&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamResourcePermission
```
Above example returns the list of IamResourcePermission.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamResourcePermission -Name "MoName"
```
Above example returns the IamResourcePermission matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamResourcePermission -Organization $organization
```
Above example returns the list of IamResourcePermission available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamResourcePermission -InlineCount allpages
```
Above example returns the list of IamResourcePermission along with count.
...
### -Name
Specifies the name of the IamResourcePermission.
...
### -Organization
Specifies the organization, to fetch the IamResourcePermission under it.
