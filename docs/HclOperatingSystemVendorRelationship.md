...
```powershell
$HclOperatingSystemVendorRelationship = Initialize-IntersightHclOperatingSystemVendorRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HclOperatingSystemVendorRelationship | ConvertTo-JSON
```
