...
# Get-IntersightApplianceFqdnUpdate

## SYNOPSIS
Get the ApplianceFqdnUpdate

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceFqdnUpdate [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceFqdnUpdate [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceFqdnUpdate&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceFqdnUpdate
```
Above example returns the list of ApplianceFqdnUpdate.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceFqdnUpdate -Name "MoName"
```
Above example returns the ApplianceFqdnUpdate matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceFqdnUpdate -Organization $organization
```
Above example returns the list of ApplianceFqdnUpdate available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceFqdnUpdate -InlineCount allpages
```
Above example returns the list of ApplianceFqdnUpdate along with count.
...
### -Name
Specifies the name of the ApplianceFqdnUpdate.
...
### -Organization
Specifies the organization, to fetch the ApplianceFqdnUpdate under it.
...
[New-IntersightApplianceFqdnUpdate](./New-IntersightApplianceFqdnUpdate.md)

[Set-IntersightApplianceFqdnUpdate](./Set-IntersightApplianceFqdnUpdate.md)
