...
```powershell
$StorageHyperFlexStorageContainerResponse = Initialize-IntersightStorageHyperFlexStorageContainerResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageHyperFlexStorageContainerResponse | ConvertTo-JSON
```
