...
## SYNOPSIS
Get the StorageVirtualDriveIdentity

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageVirtualDriveIdentity [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageVirtualDriveIdentity [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageVirtualDriveIdentity&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDriveIdentity
```
Above example returns the list of StorageVirtualDriveIdentity.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDriveIdentity -Name "MoName"
```
Above example returns the StorageVirtualDriveIdentity matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDriveIdentity -Organization $organization
```
Above example returns the list of StorageVirtualDriveIdentity available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDriveIdentity -InlineCount allpages
```
Above example returns the list of StorageVirtualDriveIdentity along with count.
...
### -Name
Specifies the name of the StorageVirtualDriveIdentity.
...
### -Organization
Specifies the organization, to fetch the StorageVirtualDriveIdentity under it.
