...
### CmdletParam (Default)
```
Get-IntersightCondAlarmClassification [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCondAlarmClassification [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
