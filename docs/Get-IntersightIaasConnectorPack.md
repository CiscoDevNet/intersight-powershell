...
# Get-IntersightIaasConnectorPack

## SYNOPSIS
Get the IaasConnectorPack

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIaasConnectorPack [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIaasConnectorPack [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IaasConnectorPack&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIaasConnectorPack
```
Above example returns the list of IaasConnectorPack.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIaasConnectorPack -Name "MoName"
```
Above example returns the IaasConnectorPack matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIaasConnectorPack -Organization $organization
```
Above example returns the list of IaasConnectorPack available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIaasConnectorPack -InlineCount allpages
```
Above example returns the list of IaasConnectorPack along with count.
...
### -Name
Specifies the name of the IaasConnectorPack.
...
### -Organization
Specifies the organization, to fetch the IaasConnectorPack under it.
