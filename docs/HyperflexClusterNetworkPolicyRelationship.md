...
```powershell
$HyperflexClusterNetworkPolicyRelationship = Initialize-IntersightHyperflexClusterNetworkPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexClusterNetworkPolicyRelationship | ConvertTo-JSON
```
