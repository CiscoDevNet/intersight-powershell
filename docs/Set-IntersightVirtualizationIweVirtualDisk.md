...
Set-IntersightVirtualizationIweVirtualDisk [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Cluster< VirtualizationIweClusterRelationship>][[-Moid]< string>][-Name< string>][-RegisteredDevice< AssetDeviceRegistrationRelationship>][-Size< long>][-SourceVirtualDisk< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: VirtualizationIweClusterRelationship
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Set-IntersightVirtualizationIweVirtualDisk
```
