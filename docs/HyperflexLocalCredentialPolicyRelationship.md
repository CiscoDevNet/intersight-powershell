...
```powershell
$HyperflexLocalCredentialPolicyRelationship = Initialize-IntersightHyperflexLocalCredentialPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexLocalCredentialPolicyRelationship | ConvertTo-JSON
```
