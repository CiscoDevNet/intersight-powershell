...
New-IntersightKubernetesVersionPolicy [-AdditionalProperties< Dictionary<string,object>>][-Description< string>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-Profiles< List<KubernetesNodeGroupProfileRelationship>>][-Tags< List<MoTag>>][-Version< KubernetesVersionRelationship>]
