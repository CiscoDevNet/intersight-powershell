...
```powershell
$KubernetesVirtualMachineInfrastructureProvider = Initialize-IntersightKubernetesVirtualMachineInfrastructureProvider  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$KubernetesVirtualMachineInfrastructureProvider | ConvertTo-JSON
```
