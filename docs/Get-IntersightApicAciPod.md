...
### CmdletParam (Default)
```
Get-IntersightApicAciPod [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApicAciPod [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApicAciPod&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApicAciPod
```
Above example returns the list of ApicAciPod.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApicAciPod -Name "MoName"
```
Above example returns the ApicAciPod matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApicAciPod -Organization $organization
```
Above example returns the list of ApicAciPod available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApicAciPod -InlineCount allpages
```
Above example returns the list of ApicAciPod along with count.
...
### -Name
Specifies the name of the ApicAciPod.
...
### -Organization
Specifies the organization, to fetch the ApicAciPod under it.
