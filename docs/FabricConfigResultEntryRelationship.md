...
```powershell
$FabricConfigResultEntryRelationship = Initialize-IntersightFabricConfigResultEntryRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$FabricConfigResultEntryRelationship | ConvertTo-JSON
```
