...
Initialize-IntersightWorkflowStartTask [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< WorkflowStartTask.ClassIdEnum>][-Description< string>][-Label< string>][-Name< string>][-NextTask< string>][-ObjectType< WorkflowStartTask.ObjectTypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowStartTask.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowStartTask.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowStartTask
```
