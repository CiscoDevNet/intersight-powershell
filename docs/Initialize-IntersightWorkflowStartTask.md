...
Initialize-IntersightWorkflowStartTask [-AdditionalProperties< Dictionary<string,object>>][-ClassId< WorkflowStartTask.ClassIdEnum>][-Description< string>][-Label< string>][-Name< string>][-NextTask< string>][-ObjectType< WorkflowStartTask.ObjectTypeEnum>]
