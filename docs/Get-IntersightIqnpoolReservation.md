...
# Get-IntersightIqnpoolReservation

## SYNOPSIS
Get the IqnpoolReservation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIqnpoolReservation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIqnpoolReservation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IqnpoolReservation&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIqnpoolReservation
```
Above example returns the list of IqnpoolReservation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIqnpoolReservation -Name "MoName"
```
Above example returns the IqnpoolReservation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIqnpoolReservation -Organization $organization
```
Above example returns the list of IqnpoolReservation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIqnpoolReservation -InlineCount allpages
```
Above example returns the list of IqnpoolReservation along with count.
...
### -Name
Specifies the name of the IqnpoolReservation.
...
### -Organization
Specifies the organization, to fetch the IqnpoolReservation under it.
...
[Remove-IntersightIqnpoolReservation](./Remove-IntersightIqnpoolReservation.md)
