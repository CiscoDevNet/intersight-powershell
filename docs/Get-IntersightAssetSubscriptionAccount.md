...
## SYNOPSIS
Get the AssetSubscriptionAccount

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAssetSubscriptionAccount [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAssetSubscriptionAccount [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;AssetSubscriptionAccount&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAssetSubscriptionAccount
```
Above example returns the list of AssetSubscriptionAccount.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAssetSubscriptionAccount -Name "MoName"
```
Above example returns the AssetSubscriptionAccount matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAssetSubscriptionAccount -Organization $organization
```
Above example returns the list of AssetSubscriptionAccount available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAssetSubscriptionAccount -InlineCount allpages
```
Above example returns the list of AssetSubscriptionAccount along with count.
...
### -Name
Specifies the name of the AssetSubscriptionAccount.
...
### -Organization
Specifies the organization, to fetch the AssetSubscriptionAccount under it.
...
[Remove-IntersightAssetSubscriptionAccount](./Remove-IntersightAssetSubscriptionAccount.md)
