...
### CmdletParam (Default)
```
Get-IntersightEquipmentFru [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentFru [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentFru
```
Above example returns the list of EquipmentFru.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentFru -Name "MoName"
```
Above example returns the EquipmentFru matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentFru -Organization $organization
```
Above example returns the list of EquipmentFru available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentFru -InlineCount allpages
```
Above example returns the list of EquipmentFru along with count.
...
### -Name
Specifies the name of the EquipmentFru.
...
### -Organization
Specifies the organization, to fetch the EquipmentFru under it.
...
[Set-IntersightEquipmentFru](./Set-IntersightEquipmentFru.md)
