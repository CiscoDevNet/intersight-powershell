...
```powershell
$NiatelemetryMsoSchemaDetailsResponse = Initialize-IntersightNiatelemetryMsoSchemaDetailsResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiatelemetryMsoSchemaDetailsResponse | ConvertTo-JSON
```
