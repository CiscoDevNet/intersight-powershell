...
### CmdletParam (Default)
```
Get-IntersightOsInstall [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOsInstall [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;OsInstall&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOsInstall
```
Above example returns the list of OsInstall.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOsInstall -Name "MoName"
```
Above example returns the OsInstall matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOsInstall -Organization $organization
```
Above example returns the list of OsInstall available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOsInstall -InlineCount allpages
```
Above example returns the list of OsInstall along with count.
...
### -Name
Specifies the name of the OsInstall.
...
### -Organization
Specifies the organization, to fetch the OsInstall under it.
...
[New-IntersightOsInstall](./New-IntersightOsInstall.md)
