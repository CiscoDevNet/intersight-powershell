...
Set-IntersightRecoveryScheduleConfigPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-BackupProfiles< System.Collections.Generic.List`1[RecoveryBackupProfileRelationship]>][-Description< string>][[-Moid]< string>][-Name< string>][-Organization< OrganizationOrganizationRelationship>][-Schedule< RecoveryBackupSchedule>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> Set-IntersightRecoveryScheduleConfigPolicy
```
