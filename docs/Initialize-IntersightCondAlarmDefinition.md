...
# Initialize-IntersightCondAlarmDefinition
...
Note :- Use Initialize-IntersightCondAlarmAction to create the object of complex type CondAlarmAction

```yaml
Type: System.Collections.Generic.List`1[Model.CondAlarmAction]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CondAlarmDefinition.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CondAlarmDefinition.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCondAlarmDefinition
```
...
[Initialize-IntersightCondAlarmAction](./Initialize-IntersightCondAlarmAction.md)
