...
Initialize-IntersightBootNvme [-AdditionalProperties< Dictionary<string,object>>][-Bootloader< Model.BootBootloader>][-ClassId< BootNvme.ClassIdEnum>][-Enabled< bool>][-Name< string>][-ObjectType< BootNvme.ObjectTypeEnum>]
