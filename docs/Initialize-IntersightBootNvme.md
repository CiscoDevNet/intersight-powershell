...
Initialize-IntersightBootNvme [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Bootloader< Model.BootBootloader>][-ClassId< BootNvme.ClassIdEnum>][-Enabled< bool>][-Name< string>][-ObjectType< BootNvme.ObjectTypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### -Bootloader
Details of the bootloader to be used during NVME boot.
...
### Example 1
```powershell
PS C:\> Initialize-IntersightBootNvme
```
