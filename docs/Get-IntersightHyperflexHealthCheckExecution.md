...
## SYNOPSIS
Get the HyperflexHealthCheckExecution

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHealthCheckExecution [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHealthCheckExecution [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHealthCheckExecution&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckExecution
```
Above example returns the list of HyperflexHealthCheckExecution.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckExecution -Name "MoName"
```
Above example returns the HyperflexHealthCheckExecution matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckExecution -Organization $organization
```
Above example returns the list of HyperflexHealthCheckExecution available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckExecution -InlineCount allpages
```
Above example returns the list of HyperflexHealthCheckExecution along with count.
...
### -Name
Specifies the name of the HyperflexHealthCheckExecution.
...
### -Organization
Specifies the organization, to fetch the HyperflexHealthCheckExecution under it.
