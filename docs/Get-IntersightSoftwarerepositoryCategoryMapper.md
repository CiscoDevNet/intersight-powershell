...
### CmdletParam (Default)
```
Get-IntersightSoftwarerepositoryCategoryMapper [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwarerepositoryCategoryMapper [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;SoftwarerepositoryCategoryMapper&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategoryMapper
```
Above example returns the list of SoftwarerepositoryCategoryMapper.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategoryMapper -Name "MoName"
```
Above example returns the SoftwarerepositoryCategoryMapper matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategoryMapper -Organization $organization
```
Above example returns the list of SoftwarerepositoryCategoryMapper available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategoryMapper -InlineCount allpages
```
Above example returns the list of SoftwarerepositoryCategoryMapper along with count.
...
### -Name
Specifies the name of the SoftwarerepositoryCategoryMapper.
...
### -Organization
Specifies the organization, to fetch the SoftwarerepositoryCategoryMapper under it.
