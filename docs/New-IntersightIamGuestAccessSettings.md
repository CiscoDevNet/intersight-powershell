...
# New-IntersightIamGuestAccessSettings
...
New-IntersightIamGuestAccessSettings [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AllowedDomainNames< System.Collections.Generic.List`1[string]>][-MaxGuestAccessLinkShelfLife< long>][-Moid< string>][-OverrideIpAccessRestriction< bool>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;IamGuestAccessSettings&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightIamGuestAccessSettings
```
