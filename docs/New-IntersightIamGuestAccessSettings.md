...
New-IntersightIamGuestAccessSettings [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AllowedDomainNames< System.Collections.Generic.List`1[string]>][-MaxGuestAccessLinkShelfLife< long>][-Moid< string>][-OverrideIpAccessRestriction< bool>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
