...
# Get-IntersightHyperflexTarget

## SYNOPSIS
Get the HyperflexTarget

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexTarget [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexTarget [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexTarget&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexTarget
```
Above example returns the list of HyperflexTarget.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexTarget -Name "MoName"
```
Above example returns the HyperflexTarget matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexTarget -Organization $organization
```
Above example returns the list of HyperflexTarget available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexTarget -InlineCount allpages
```
Above example returns the list of HyperflexTarget along with count.
...
### -Name
Specifies the name of the HyperflexTarget.
...
### -Organization
Specifies the organization, to fetch the HyperflexTarget under it.
...
[Set-IntersightHyperflexTarget](./Set-IntersightHyperflexTarget.md)
