...
## SYNOPSIS
Get the StorageHitachiDisk

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiDisk [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiDisk [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiDisk&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiDisk
```
Above example returns the list of StorageHitachiDisk.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiDisk -Name "MoName"
```
Above example returns the StorageHitachiDisk matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiDisk -Organization $organization
```
Above example returns the list of StorageHitachiDisk available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiDisk -InlineCount allpages
```
Above example returns the list of StorageHitachiDisk along with count.
...
### -Name
Specifies the name of the StorageHitachiDisk.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiDisk under it.
