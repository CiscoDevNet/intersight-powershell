...
# Initialize-IntersightFabricSwitchProfileTemplate
...
```yaml
Type: FabricSwitchProfileTemplate.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricSwitchProfileTemplate.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFabricSwitchProfileTemplate
```
