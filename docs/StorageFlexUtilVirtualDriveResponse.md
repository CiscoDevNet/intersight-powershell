...
```powershell
$StorageFlexUtilVirtualDriveResponse = Initialize-IntersightStorageFlexUtilVirtualDriveResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageFlexUtilVirtualDriveResponse | ConvertTo-JSON
```
