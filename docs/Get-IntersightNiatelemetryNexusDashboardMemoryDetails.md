...
## SYNOPSIS
Get the NiatelemetryNexusDashboardMemoryDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryNexusDashboardMemoryDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryNexusDashboardMemoryDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryNexusDashboardMemoryDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboardMemoryDetails
```
Above example returns the list of NiatelemetryNexusDashboardMemoryDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboardMemoryDetails -Name "MoName"
```
Above example returns the NiatelemetryNexusDashboardMemoryDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboardMemoryDetails -Organization $organization
```
Above example returns the list of NiatelemetryNexusDashboardMemoryDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboardMemoryDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryNexusDashboardMemoryDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryNexusDashboardMemoryDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryNexusDashboardMemoryDetails under it.
