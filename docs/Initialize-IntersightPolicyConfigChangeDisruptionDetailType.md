...
# Initialize-IntersightPolicyConfigChangeDisruptionDetailType
...
```yaml
Type: PolicyConfigChangeDisruptionDetailType.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: PolicyConfigChangeDisruptionDetailType.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightPolicyConfigChangeDisruptionDetailType
```
