...
## SYNOPSIS
Get the SoftwareHclMeta

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwareHclMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwareHclMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwareHclMeta
```
Above example returns the list of SoftwareHclMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwareHclMeta -Name "MoName"
```
Above example returns the SoftwareHclMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwareHclMeta -Organization $organization
```
Above example returns the list of SoftwareHclMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwareHclMeta -InlineCount allpages
```
Above example returns the list of SoftwareHclMeta along with count.
...
### -Name
Specifies the name of the SoftwareHclMeta.
...
### -Organization
Specifies the organization, to fetch the SoftwareHclMeta under it.
