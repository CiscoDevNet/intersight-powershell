...
# Get-IntersightManagementInterface

## SYNOPSIS
Get the ManagementInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightManagementInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightManagementInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;ManagementInterface&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightManagementInterface
```
Above example returns the list of ManagementInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightManagementInterface -Name "MoName"
```
Above example returns the ManagementInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightManagementInterface -Organization $organization
```
Above example returns the list of ManagementInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightManagementInterface -InlineCount allpages
```
Above example returns the list of ManagementInterface along with count.
...
### -Name
Specifies the name of the ManagementInterface.
...
### -Organization
Specifies the organization, to fetch the ManagementInterface under it.
...
[Set-IntersightManagementInterface](./Set-IntersightManagementInterface.md)
