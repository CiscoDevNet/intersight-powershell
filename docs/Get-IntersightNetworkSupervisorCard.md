...
# Get-IntersightNetworkSupervisorCard

## SYNOPSIS
Get the NetworkSupervisorCard

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkSupervisorCard [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkSupervisorCard [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NetworkSupervisorCard&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkSupervisorCard
```
Above example returns the list of NetworkSupervisorCard.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkSupervisorCard -Name "MoName"
```
Above example returns the NetworkSupervisorCard matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkSupervisorCard -Organization $organization
```
Above example returns the list of NetworkSupervisorCard available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkSupervisorCard -InlineCount allpages
```
Above example returns the list of NetworkSupervisorCard along with count.
...
### -Name
Specifies the name of the NetworkSupervisorCard.
...
### -Organization
Specifies the organization, to fetch the NetworkSupervisorCard under it.
