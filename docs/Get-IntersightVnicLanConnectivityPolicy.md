...
## SYNOPSIS
Get the VnicLanConnectivityPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicLanConnectivityPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicLanConnectivityPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicLanConnectivityPolicy
```
Above example returns the list of VnicLanConnectivityPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicLanConnectivityPolicy -Name "MoName"
```
Above example returns the VnicLanConnectivityPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicLanConnectivityPolicy -Organization $organization
```
Above example returns the list of VnicLanConnectivityPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicLanConnectivityPolicy -InlineCount allpages
```
Above example returns the list of VnicLanConnectivityPolicy along with count.
...
### -Name
Specifies the name of the VnicLanConnectivityPolicy.
...
### -Organization
Specifies the organization, to fetch the VnicLanConnectivityPolicy under it.
