...
## SYNOPSIS
Get the StorageNetAppFcPort

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppFcPort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppFcPort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageNetAppFcPort&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcPort
```
Above example returns the list of StorageNetAppFcPort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcPort -Name "MoName"
```
Above example returns the StorageNetAppFcPort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcPort -Organization $organization
```
Above example returns the list of StorageNetAppFcPort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcPort -InlineCount allpages
```
Above example returns the list of StorageNetAppFcPort along with count.
...
### -Name
Specifies the name of the StorageNetAppFcPort.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppFcPort under it.
