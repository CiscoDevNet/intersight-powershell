...
# Initialize-IntersightTerraformExecutor
...
```yaml
Type: TerraformExecutor.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.TerraformCloudResource]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TerraformExecutor.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.TerraformRunstate]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTerraformExecutor
```
