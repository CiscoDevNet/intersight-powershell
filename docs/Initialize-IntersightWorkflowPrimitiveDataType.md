...
Initialize-IntersightWorkflowPrimitiveDataType [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< WorkflowPrimitiveDataType.ClassIdEnum>][-Default< Model.WorkflowDefaultValue>][-Description< string>][-DisplayMeta< Model.WorkflowDisplayMeta>][-InputParameters< object>][-Label< string>][-Name< string>][-ObjectType< WorkflowPrimitiveDataType.ObjectTypeEnum>][-Properties< Model.WorkflowPrimitiveDataProperty>][-Required< bool>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
