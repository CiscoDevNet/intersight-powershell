...
## SYNOPSIS
Get the HyperflexExtFcStoragePolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexExtFcStoragePolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexExtFcStoragePolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;HyperflexExtFcStoragePolicy&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexExtFcStoragePolicy
```
Above example returns the list of HyperflexExtFcStoragePolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexExtFcStoragePolicy -Name "MoName"
```
Above example returns the HyperflexExtFcStoragePolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexExtFcStoragePolicy -Organization $organization
```
Above example returns the list of HyperflexExtFcStoragePolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexExtFcStoragePolicy -InlineCount allpages
```
Above example returns the list of HyperflexExtFcStoragePolicy along with count.
...
### -Name
Specifies the name of the HyperflexExtFcStoragePolicy.
...
### -Organization
Specifies the organization, to fetch the HyperflexExtFcStoragePolicy under it.
