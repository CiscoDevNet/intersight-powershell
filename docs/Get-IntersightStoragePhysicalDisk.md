...
## SYNOPSIS
Get the StoragePhysicalDisk

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePhysicalDisk [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePhysicalDisk [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StoragePhysicalDisk&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePhysicalDisk
```
Above example returns the list of StoragePhysicalDisk.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePhysicalDisk -Name "MoName"
```
Above example returns the StoragePhysicalDisk matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePhysicalDisk -Organization $organization
```
Above example returns the list of StoragePhysicalDisk available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePhysicalDisk -InlineCount allpages
```
Above example returns the list of StoragePhysicalDisk along with count.
...
### -Name
Specifies the name of the StoragePhysicalDisk.
...
### -Organization
Specifies the organization, to fetch the StoragePhysicalDisk under it.
...
[Set-IntersightStoragePhysicalDisk](./Set-IntersightStoragePhysicalDisk.md)
