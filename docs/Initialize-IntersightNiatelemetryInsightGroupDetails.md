...
# Initialize-IntersightNiatelemetryInsightGroupDetails
...
```yaml
Type: NiatelemetryInsightGroupDetails.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: NiatelemetryInsightGroupDetails.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightNiatelemetryInsightGroupDetails
```
