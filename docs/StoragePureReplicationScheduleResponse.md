...
```powershell
$StoragePureReplicationScheduleResponse = Initialize-IntersightStoragePureReplicationScheduleResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StoragePureReplicationScheduleResponse | ConvertTo-JSON
```
