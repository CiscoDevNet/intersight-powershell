...
# Get-IntersightStorageNetAppClusterSnapMirrorPolicy

## SYNOPSIS
Get the StorageNetAppClusterSnapMirrorPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppClusterSnapMirrorPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppClusterSnapMirrorPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppClusterSnapMirrorPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppClusterSnapMirrorPolicy
```
Above example returns the list of StorageNetAppClusterSnapMirrorPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppClusterSnapMirrorPolicy -Name "MoName"
```
Above example returns the StorageNetAppClusterSnapMirrorPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppClusterSnapMirrorPolicy -Organization $organization
```
Above example returns the list of StorageNetAppClusterSnapMirrorPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppClusterSnapMirrorPolicy -InlineCount allpages
```
Above example returns the list of StorageNetAppClusterSnapMirrorPolicy along with count.
...
### -Name
Specifies the name of the StorageNetAppClusterSnapMirrorPolicy.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppClusterSnapMirrorPolicy under it.
