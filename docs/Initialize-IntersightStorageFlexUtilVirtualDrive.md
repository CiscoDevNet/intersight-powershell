...
# Initialize-IntersightStorageFlexUtilVirtualDrive
...
```yaml
Type: StorageFlexUtilVirtualDrive.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: StorageFlexUtilVirtualDrive.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightStorageFlexUtilVirtualDrive
```
