...
```powershell
$HyperflexCiscoHypervisorManagerRelationship = Initialize-IntersightHyperflexCiscoHypervisorManagerRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexCiscoHypervisorManagerRelationship | ConvertTo-JSON
```
