...
# Get-IntersightNiatelemetryApicPodData

## SYNOPSIS
Get the NiatelemetryApicPodData

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicPodData [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicPodData [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryApicPodData&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicPodData
```
Above example returns the list of NiatelemetryApicPodData.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicPodData -Name "MoName"
```
Above example returns the NiatelemetryApicPodData matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicPodData -Organization $organization
```
Above example returns the list of NiatelemetryApicPodData available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicPodData -InlineCount allpages
```
Above example returns the list of NiatelemetryApicPodData along with count.
...
### -Name
Specifies the name of the NiatelemetryApicPodData.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicPodData under it.
