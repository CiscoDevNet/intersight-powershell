...
# Get-IntersightHclServerHwCatalogInfo

## SYNOPSIS
Get the HclServerHwCatalogInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHclServerHwCatalogInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHclServerHwCatalogInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HclServerHwCatalogInfo&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHclServerHwCatalogInfo
```
Above example returns the list of HclServerHwCatalogInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHclServerHwCatalogInfo -Name "MoName"
```
Above example returns the HclServerHwCatalogInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHclServerHwCatalogInfo -Organization $organization
```
Above example returns the list of HclServerHwCatalogInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHclServerHwCatalogInfo -InlineCount allpages
```
Above example returns the list of HclServerHwCatalogInfo along with count.
...
### -Name
Specifies the name of the HclServerHwCatalogInfo.
...
### -Organization
Specifies the organization, to fetch the HclServerHwCatalogInfo under it.
