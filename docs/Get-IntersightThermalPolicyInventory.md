...
# Get-IntersightThermalPolicyInventory

## SYNOPSIS
Get the ThermalPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightThermalPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightThermalPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ThermalPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightThermalPolicyInventory
```
Above example returns the list of ThermalPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightThermalPolicyInventory -Name "MoName"
```
Above example returns the ThermalPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightThermalPolicyInventory -Organization $organization
```
Above example returns the list of ThermalPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightThermalPolicyInventory -InlineCount allpages
```
Above example returns the list of ThermalPolicyInventory along with count.
...
### -Name
Specifies the name of the ThermalPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the ThermalPolicyInventory under it.
