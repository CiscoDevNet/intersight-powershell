...
# Get-IntersightAccessPolicyInventory

## SYNOPSIS
Get the AccessPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAccessPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAccessPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAccessPolicyInventory
```
Above example returns the list of AccessPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAccessPolicyInventory -Name "MoName"
```
Above example returns the AccessPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAccessPolicyInventory -Organization $organization
```
Above example returns the list of AccessPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAccessPolicyInventory -InlineCount allpages
```
Above example returns the list of AccessPolicyInventory along with count.
...
### -Name
Specifies the name of the AccessPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the AccessPolicyInventory under it.
