...
# Get-IntersightIamUserGroup

## SYNOPSIS
Get the IamUserGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamUserGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamUserGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamUserGroup
```
Above example returns the list of IamUserGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamUserGroup -Name "MoName"
```
Above example returns the IamUserGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamUserGroup -Organization $organization
```
Above example returns the list of IamUserGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamUserGroup -InlineCount allpages
```
Above example returns the list of IamUserGroup along with count.
...
### -Name
Specifies the name of the IamUserGroup.
...
### -Organization
Specifies the organization, to fetch the IamUserGroup under it.
