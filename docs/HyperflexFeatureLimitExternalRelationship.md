...
```powershell
$HyperflexFeatureLimitExternalRelationship = Initialize-IntersightHyperflexFeatureLimitExternalRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexFeatureLimitExternalRelationship | ConvertTo-JSON
```
