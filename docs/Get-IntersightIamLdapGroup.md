...
# Get-IntersightIamLdapGroup

## SYNOPSIS
Get the IamLdapGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamLdapGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamLdapGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamLdapGroup
```
Above example returns the list of IamLdapGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamLdapGroup -Name "MoName"
```
Above example returns the IamLdapGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamLdapGroup -Organization $organization
```
Above example returns the list of IamLdapGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamLdapGroup -InlineCount allpages
```
Above example returns the list of IamLdapGroup along with count.
...
### -Name
Specifies the name of the IamLdapGroup.
...
### -Organization
Specifies the organization, to fetch the IamLdapGroup under it.
