...
## SYNOPSIS
Get the LicenseCustomerOp

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightLicenseCustomerOp [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightLicenseCustomerOp [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;LicenseCustomerOp&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightLicenseCustomerOp
```
Above example returns the list of LicenseCustomerOp.

### Example 2
```powershell
PS C:\> $result = Get-IntersightLicenseCustomerOp -Name "MoName"
```
Above example returns the LicenseCustomerOp matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightLicenseCustomerOp -Organization $organization
```
Above example returns the list of LicenseCustomerOp available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightLicenseCustomerOp -InlineCount allpages
```
Above example returns the list of LicenseCustomerOp along with count.
...
### -Name
Specifies the name of the LicenseCustomerOp.
...
### -Organization
Specifies the organization, to fetch the LicenseCustomerOp under it.
...
[Set-IntersightLicenseCustomerOp](./Set-IntersightLicenseCustomerOp.md)
