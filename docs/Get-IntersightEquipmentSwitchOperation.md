...
# Get-IntersightEquipmentSwitchOperation

## SYNOPSIS
Get the EquipmentSwitchOperation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentSwitchOperation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentSwitchOperation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentSwitchOperation&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentSwitchOperation
```
Above example returns the list of EquipmentSwitchOperation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentSwitchOperation -Name "MoName"
```
Above example returns the EquipmentSwitchOperation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentSwitchOperation -Organization $organization
```
Above example returns the list of EquipmentSwitchOperation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentSwitchOperation -InlineCount allpages
```
Above example returns the list of EquipmentSwitchOperation along with count.
...
### -Name
Specifies the name of the EquipmentSwitchOperation.
...
### -Organization
Specifies the organization, to fetch the EquipmentSwitchOperation under it.
...
[Set-IntersightEquipmentSwitchOperation](./Set-IntersightEquipmentSwitchOperation.md)
