...
## SYNOPSIS
Get the FabricPortOperation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricPortOperation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricPortOperation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricPortOperation&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricPortOperation
```
Above example returns the list of FabricPortOperation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricPortOperation -Name "MoName"
```
Above example returns the FabricPortOperation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricPortOperation -Organization $organization
```
Above example returns the list of FabricPortOperation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricPortOperation -InlineCount allpages
```
Above example returns the list of FabricPortOperation along with count.
...
### -Name
Specifies the name of the FabricPortOperation.
...
### -Organization
Specifies the organization, to fetch the FabricPortOperation under it.
