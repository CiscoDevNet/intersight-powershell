...
```powershell
$TechsupportmanagementDownloadResponse = Initialize-IntersightTechsupportmanagementDownloadResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$TechsupportmanagementDownloadResponse | ConvertTo-JSON
```
