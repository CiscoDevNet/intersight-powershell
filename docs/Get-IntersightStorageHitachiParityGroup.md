...
## SYNOPSIS
Get the StorageHitachiParityGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiParityGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiParityGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiParityGroup&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiParityGroup
```
Above example returns the list of StorageHitachiParityGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiParityGroup -Name "MoName"
```
Above example returns the StorageHitachiParityGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiParityGroup -Organization $organization
```
Above example returns the list of StorageHitachiParityGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiParityGroup -InlineCount allpages
```
Above example returns the list of StorageHitachiParityGroup along with count.
...
### -Name
Specifies the name of the StorageHitachiParityGroup.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiParityGroup under it.
