...
# Get-IntersightStorageNetAppSvmSnapMirrorPolicy

## SYNOPSIS
Get the StorageNetAppSvmSnapMirrorPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppSvmSnapMirrorPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppSvmSnapMirrorPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppSvmSnapMirrorPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSvmSnapMirrorPolicy
```
Above example returns the list of StorageNetAppSvmSnapMirrorPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSvmSnapMirrorPolicy -Name "MoName"
```
Above example returns the StorageNetAppSvmSnapMirrorPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSvmSnapMirrorPolicy -Organization $organization
```
Above example returns the list of StorageNetAppSvmSnapMirrorPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSvmSnapMirrorPolicy -InlineCount allpages
```
Above example returns the list of StorageNetAppSvmSnapMirrorPolicy along with count.
...
### -Name
Specifies the name of the StorageNetAppSvmSnapMirrorPolicy.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppSvmSnapMirrorPolicy under it.
