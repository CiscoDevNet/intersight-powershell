...
# Get-IntersightNetworkconfigPolicyInventory

## SYNOPSIS
Get the NetworkconfigPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkconfigPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkconfigPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NetworkconfigPolicyInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkconfigPolicyInventory
```
Above example returns the list of NetworkconfigPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkconfigPolicyInventory -Name "MoName"
```
Above example returns the NetworkconfigPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkconfigPolicyInventory -Organization $organization
```
Above example returns the list of NetworkconfigPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkconfigPolicyInventory -InlineCount allpages
```
Above example returns the list of NetworkconfigPolicyInventory along with count.
...
### -Name
Specifies the name of the NetworkconfigPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the NetworkconfigPolicyInventory under it.
