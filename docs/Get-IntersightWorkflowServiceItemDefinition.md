...
# Get-IntersightWorkflowServiceItemDefinition

## SYNOPSIS
Get the WorkflowServiceItemDefinition

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowServiceItemDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowServiceItemDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowServiceItemDefinition&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemDefinition
```
Above example returns the list of WorkflowServiceItemDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemDefinition -Name "MoName"
```
Above example returns the WorkflowServiceItemDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemDefinition -Organization $organization
```
Above example returns the list of WorkflowServiceItemDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemDefinition -InlineCount allpages
```
Above example returns the list of WorkflowServiceItemDefinition along with count.
...
### -Name
Specifies the name of the WorkflowServiceItemDefinition.
...
### -Organization
Specifies the organization, to fetch the WorkflowServiceItemDefinition under it.
