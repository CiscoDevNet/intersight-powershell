...
New-IntersightUuidpoolPool [-AdditionalProperties< Dictionary<string,object>>][-AssignmentOrder< UuidpoolPool.AssignmentOrderEnum>][-Description< string>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-Prefix< string>][-Tags< List<MoTag>>][-UuidSuffixBlocks< List<UuidpoolUuidBlock>>]
