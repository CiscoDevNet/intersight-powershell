...
Initialize-IntersightVirtualizationVirtualDiskConfig [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Capacity< string>][-ClassId< VirtualizationVirtualDiskConfig.ClassIdEnum>][-Mode< VirtualizationVirtualDiskConfig.ModeEnum>][-ObjectType< VirtualizationVirtualDiskConfig.ObjectTypeEnum>][-SourceCerts< string>][-SourceDiskToClone< string>][-SourceFilePath< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
