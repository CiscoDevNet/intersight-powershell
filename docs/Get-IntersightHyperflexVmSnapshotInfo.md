...
## SYNOPSIS
Get the HyperflexVmSnapshotInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexVmSnapshotInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexVmSnapshotInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexVmSnapshotInfo&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexVmSnapshotInfo
```
Above example returns the list of HyperflexVmSnapshotInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexVmSnapshotInfo -Name "MoName"
```
Above example returns the HyperflexVmSnapshotInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexVmSnapshotInfo -Organization $organization
```
Above example returns the list of HyperflexVmSnapshotInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexVmSnapshotInfo -InlineCount allpages
```
Above example returns the list of HyperflexVmSnapshotInfo along with count.
...
### -Name
Specifies the name of the HyperflexVmSnapshotInfo.
...
### -Organization
Specifies the organization, to fetch the HyperflexVmSnapshotInfo under it.
...
[Remove-IntersightHyperflexVmSnapshotInfo](./Remove-IntersightHyperflexVmSnapshotInfo.md)
