...
```powershell
$WorkflowErrorResponseHandlerRelationship = Initialize-IntersightWorkflowErrorResponseHandlerRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$WorkflowErrorResponseHandlerRelationship | ConvertTo-JSON
```
