...
### CmdletParam (Default)
```
Get-IntersightFabricEthNetworkPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricEthNetworkPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;FabricEthNetworkPolicy&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkPolicy
```
Above example returns the list of FabricEthNetworkPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkPolicy -Name "MoName"
```
Above example returns the FabricEthNetworkPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkPolicy -Organization $organization
```
Above example returns the list of FabricEthNetworkPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkPolicy -InlineCount allpages
```
Above example returns the list of FabricEthNetworkPolicy along with count.
...
### -Name
Specifies the name of the FabricEthNetworkPolicy.
...
### -Organization
Specifies the organization, to fetch the FabricEthNetworkPolicy under it.
