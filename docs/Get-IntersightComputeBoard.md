...
# Get-IntersightComputeBoard

## SYNOPSIS
Get the ComputeBoard

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputeBoard [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputeBoard [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ComputeBoard&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputeBoard
```
Above example returns the list of ComputeBoard.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputeBoard -Name "MoName"
```
Above example returns the ComputeBoard matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputeBoard -Organization $organization
```
Above example returns the list of ComputeBoard available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputeBoard -InlineCount allpages
```
Above example returns the list of ComputeBoard along with count.
...
### -Name
Specifies the name of the ComputeBoard.
...
### -Organization
Specifies the organization, to fetch the ComputeBoard under it.
...
[Set-IntersightComputeBoard](./Set-IntersightComputeBoard.md)
