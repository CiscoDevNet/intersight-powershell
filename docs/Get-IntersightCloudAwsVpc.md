...
### CmdletParam (Default)
```
Get-IntersightCloudAwsVpc [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudAwsVpc [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CloudAwsVpc&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudAwsVpc
```
Above example returns the list of CloudAwsVpc.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudAwsVpc -Name "MoName"
```
Above example returns the CloudAwsVpc matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudAwsVpc -Organization $organization
```
Above example returns the list of CloudAwsVpc available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudAwsVpc -InlineCount allpages
```
Above example returns the list of CloudAwsVpc along with count.
...
### -Name
Specifies the name of the CloudAwsVpc.
...
### -Organization
Specifies the organization, to fetch the CloudAwsVpc under it.
