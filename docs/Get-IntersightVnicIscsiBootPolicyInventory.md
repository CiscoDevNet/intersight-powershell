...
# Get-IntersightVnicIscsiBootPolicyInventory

## SYNOPSIS
Get the VnicIscsiBootPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicIscsiBootPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicIscsiBootPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicIscsiBootPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicIscsiBootPolicyInventory
```
Above example returns the list of VnicIscsiBootPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicIscsiBootPolicyInventory -Name "MoName"
```
Above example returns the VnicIscsiBootPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicIscsiBootPolicyInventory -Organization $organization
```
Above example returns the list of VnicIscsiBootPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicIscsiBootPolicyInventory -InlineCount allpages
```
Above example returns the list of VnicIscsiBootPolicyInventory along with count.
...
### -Name
Specifies the name of the VnicIscsiBootPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the VnicIscsiBootPolicyInventory under it.
