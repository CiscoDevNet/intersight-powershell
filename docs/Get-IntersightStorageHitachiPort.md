...
## SYNOPSIS
Get the StorageHitachiPort

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiPort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiPort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiPort&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiPort
```
Above example returns the list of StorageHitachiPort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiPort -Name "MoName"
```
Above example returns the StorageHitachiPort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiPort -Organization $organization
```
Above example returns the list of StorageHitachiPort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiPort -InlineCount allpages
```
Above example returns the list of StorageHitachiPort along with count.
...
### -Name
Specifies the name of the StorageHitachiPort.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiPort under it.
