...
Initialize-IntersightWorkflowWaitTask [-AdditionalProperties< Dictionary<string,object>>][-ClassId< WorkflowWaitTask.ClassIdEnum>][-Description< string>][-InputParameters< object>][-Label< string>][-Name< string>][-ObjectType< WorkflowWaitTask.ObjectTypeEnum>][-OnFailure< string>][-OnSuccess< string>][-Prompts< List<Model.WorkflowWaitTaskPrompt>>][-RollbackDisabled< bool>][-UseDefault< bool>]
