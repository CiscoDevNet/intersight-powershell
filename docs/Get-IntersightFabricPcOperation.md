...
# Get-IntersightFabricPcOperation

## SYNOPSIS
Get the FabricPcOperation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricPcOperation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricPcOperation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricPcOperation&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricPcOperation
```
Above example returns the list of FabricPcOperation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricPcOperation -Name "MoName"
```
Above example returns the FabricPcOperation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricPcOperation -Organization $organization
```
Above example returns the list of FabricPcOperation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricPcOperation -InlineCount allpages
```
Above example returns the list of FabricPcOperation along with count.
...
### -Name
Specifies the name of the FabricPcOperation.
...
### -Organization
Specifies the organization, to fetch the FabricPcOperation under it.
