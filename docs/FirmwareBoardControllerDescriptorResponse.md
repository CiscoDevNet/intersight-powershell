...
```powershell
$FirmwareBoardControllerDescriptorResponse = Initialize-IntersightFirmwareBoardControllerDescriptorResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$FirmwareBoardControllerDescriptorResponse | ConvertTo-JSON
```
