...
## SYNOPSIS
Get the NiatelemetrySupervisorModuleDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetrySupervisorModuleDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetrySupervisorModuleDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetrySupervisorModuleDetails&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySupervisorModuleDetails
```
Above example returns the list of NiatelemetrySupervisorModuleDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySupervisorModuleDetails -Name "MoName"
```
Above example returns the NiatelemetrySupervisorModuleDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySupervisorModuleDetails -Organization $organization
```
Above example returns the list of NiatelemetrySupervisorModuleDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySupervisorModuleDetails -InlineCount allpages
```
Above example returns the list of NiatelemetrySupervisorModuleDetails along with count.
...
### -Name
Specifies the name of the NiatelemetrySupervisorModuleDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetrySupervisorModuleDetails under it.
