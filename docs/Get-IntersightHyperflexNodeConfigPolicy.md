...
## SYNOPSIS
Get the HyperflexNodeConfigPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexNodeConfigPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexNodeConfigPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexNodeConfigPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexNodeConfigPolicy
```
Above example returns the list of HyperflexNodeConfigPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexNodeConfigPolicy -Name "MoName"
```
Above example returns the HyperflexNodeConfigPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexNodeConfigPolicy -Organization $organization
```
Above example returns the list of HyperflexNodeConfigPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexNodeConfigPolicy -InlineCount allpages
```
Above example returns the list of HyperflexNodeConfigPolicy along with count.
...
### -Name
Specifies the name of the HyperflexNodeConfigPolicy.
...
### -Organization
Specifies the organization, to fetch the HyperflexNodeConfigPolicy under it.
