...
# Get-IntersightHciCompliance

## SYNOPSIS
Get the HciCompliance

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHciCompliance [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciCompliance [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciCompliance&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciCompliance
```
Above example returns the list of HciCompliance.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciCompliance -Name "MoName"
```
Above example returns the HciCompliance matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciCompliance -Organization $organization
```
Above example returns the list of HciCompliance available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciCompliance -InlineCount allpages
```
Above example returns the list of HciCompliance along with count.
...
### -Name
Specifies the name of the HciCompliance.
...
### -Organization
Specifies the organization, to fetch the HciCompliance under it.
