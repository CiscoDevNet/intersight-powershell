...
```powershell
$InventoryGenericInventoryHolderListAllOf = Initialize-IntersightInventoryGenericInventoryHolderListAllOf  -Count null `
 -Results null
```

- Convert the resource to JSON
```powershell
$InventoryGenericInventoryHolderListAllOf | ConvertTo-JSON
```
