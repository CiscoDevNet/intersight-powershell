...
### CmdletParam (Default)
```
Get-IntersightCapabilityIomUpgradeSupportMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityIomUpgradeSupportMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityIomUpgradeSupportMeta
```
Above example returns the list of CapabilityIomUpgradeSupportMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityIomUpgradeSupportMeta -Name "MoName"
```
Above example returns the CapabilityIomUpgradeSupportMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityIomUpgradeSupportMeta -Organization $organization
```
Above example returns the list of CapabilityIomUpgradeSupportMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityIomUpgradeSupportMeta -InlineCount allpages
```
Above example returns the list of CapabilityIomUpgradeSupportMeta along with count.
...
### -Name
Specifies the name of the CapabilityIomUpgradeSupportMeta.
...
### -Organization
Specifies the organization, to fetch the CapabilityIomUpgradeSupportMeta under it.
