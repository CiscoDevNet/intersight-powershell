...
# Get-IntersightWorkloadClearWorkloadTag

## SYNOPSIS
Get the WorkloadClearWorkloadTag

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkloadClearWorkloadTag [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkloadClearWorkloadTag [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkloadClearWorkloadTag&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkloadClearWorkloadTag
```
Above example returns the list of WorkloadClearWorkloadTag.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkloadClearWorkloadTag -Name "MoName"
```
Above example returns the WorkloadClearWorkloadTag matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkloadClearWorkloadTag -Organization $organization
```
Above example returns the list of WorkloadClearWorkloadTag available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkloadClearWorkloadTag -InlineCount allpages
```
Above example returns the list of WorkloadClearWorkloadTag along with count.
...
### -Name
Specifies the name of the WorkloadClearWorkloadTag.
...
### -Organization
Specifies the organization, to fetch the WorkloadClearWorkloadTag under it.
...
[Remove-IntersightWorkloadClearWorkloadTag](./Remove-IntersightWorkloadClearWorkloadTag.md)
