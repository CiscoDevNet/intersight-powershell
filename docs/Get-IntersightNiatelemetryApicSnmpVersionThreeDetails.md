...
## SYNOPSIS
Get the NiatelemetryApicSnmpVersionThreeDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicSnmpVersionThreeDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicSnmpVersionThreeDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetryApicSnmpVersionThreeDetails&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpVersionThreeDetails
```
Above example returns the list of NiatelemetryApicSnmpVersionThreeDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpVersionThreeDetails -Name "MoName"
```
Above example returns the NiatelemetryApicSnmpVersionThreeDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpVersionThreeDetails -Organization $organization
```
Above example returns the list of NiatelemetryApicSnmpVersionThreeDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpVersionThreeDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryApicSnmpVersionThreeDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryApicSnmpVersionThreeDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicSnmpVersionThreeDetails under it.
