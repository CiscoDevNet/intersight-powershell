...
```powershell
$SoftwareApplianceDistributableResponse = Initialize-IntersightSoftwareApplianceDistributableResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwareApplianceDistributableResponse | ConvertTo-JSON
```
