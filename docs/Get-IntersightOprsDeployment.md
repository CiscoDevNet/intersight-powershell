...
# Get-IntersightOprsDeployment

## SYNOPSIS
Get the OprsDeployment

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOprsDeployment [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOprsDeployment [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;OprsDeployment&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOprsDeployment
```
Above example returns the list of OprsDeployment.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOprsDeployment -Name "MoName"
```
Above example returns the OprsDeployment matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOprsDeployment -Organization $organization
```
Above example returns the list of OprsDeployment available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOprsDeployment -InlineCount allpages
```
Above example returns the list of OprsDeployment along with count.
...
### -Name
Specifies the name of the OprsDeployment.
...
### -Organization
Specifies the organization, to fetch the OprsDeployment under it.
