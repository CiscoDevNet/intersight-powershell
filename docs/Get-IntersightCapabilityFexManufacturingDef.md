...
### CmdletParam (Default)
```
Get-IntersightCapabilityFexManufacturingDef [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityFexManufacturingDef [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityFexManufacturingDef
```
Above example returns the list of CapabilityFexManufacturingDef.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityFexManufacturingDef -Name "MoName"
```
Above example returns the CapabilityFexManufacturingDef matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityFexManufacturingDef -Organization $organization
```
Above example returns the list of CapabilityFexManufacturingDef available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityFexManufacturingDef -InlineCount allpages
```
Above example returns the list of CapabilityFexManufacturingDef along with count.
...
### -Name
Specifies the name of the CapabilityFexManufacturingDef.
...
### -Organization
Specifies the organization, to fetch the CapabilityFexManufacturingDef under it.
...
[Remove-IntersightCapabilityFexManufacturingDef](./Remove-IntersightCapabilityFexManufacturingDef.md)
