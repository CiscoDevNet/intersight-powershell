...
## SYNOPSIS
Get the ApplianceRemoteFileImport

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceRemoteFileImport [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceRemoteFileImport [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceRemoteFileImport
```
Above example returns the list of ApplianceRemoteFileImport.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceRemoteFileImport -Name "MoName"
```
Above example returns the ApplianceRemoteFileImport matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceRemoteFileImport -Organization $organization
```
Above example returns the list of ApplianceRemoteFileImport available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceRemoteFileImport -InlineCount allpages
```
Above example returns the list of ApplianceRemoteFileImport along with count.
...
### -Name
Specifies the name of the ApplianceRemoteFileImport.
...
### -Organization
Specifies the organization, to fetch the ApplianceRemoteFileImport under it.
...
[New-IntersightApplianceRemoteFileImport](./New-IntersightApplianceRemoteFileImport.md)
