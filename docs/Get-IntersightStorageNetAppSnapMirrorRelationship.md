...
# Get-IntersightStorageNetAppSnapMirrorRelationship

## SYNOPSIS
Get the StorageNetAppSnapMirrorRelationship

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppSnapMirrorRelationship [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppSnapMirrorRelationship [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppSnapMirrorRelationship&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSnapMirrorRelationship
```
Above example returns the list of StorageNetAppSnapMirrorRelationship.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSnapMirrorRelationship -Name "MoName"
```
Above example returns the StorageNetAppSnapMirrorRelationship matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSnapMirrorRelationship -Organization $organization
```
Above example returns the list of StorageNetAppSnapMirrorRelationship available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSnapMirrorRelationship -InlineCount allpages
```
Above example returns the list of StorageNetAppSnapMirrorRelationship along with count.
...
### -Name
Specifies the name of the StorageNetAppSnapMirrorRelationship.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppSnapMirrorRelationship under it.
