...
```powershell
$StorageFlexFlashVirtualDriveResponse = Initialize-IntersightStorageFlexFlashVirtualDriveResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageFlexFlashVirtualDriveResponse | ConvertTo-JSON
```
