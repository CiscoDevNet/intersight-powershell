...
## SYNOPSIS
Get the StorageNetAppBaseDisk

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppBaseDisk [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppBaseDisk [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppBaseDisk
```
Above example returns the list of StorageNetAppBaseDisk.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppBaseDisk -Name "MoName"
```
Above example returns the StorageNetAppBaseDisk matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppBaseDisk -Organization $organization
```
Above example returns the list of StorageNetAppBaseDisk available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppBaseDisk -InlineCount allpages
```
Above example returns the list of StorageNetAppBaseDisk along with count.
...
### -Name
Specifies the name of the StorageNetAppBaseDisk.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppBaseDisk under it.
