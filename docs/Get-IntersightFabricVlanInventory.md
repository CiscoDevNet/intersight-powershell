...
### CmdletParam (Default)
```
Get-IntersightFabricVlanInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricVlanInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
