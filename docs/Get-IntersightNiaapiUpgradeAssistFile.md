...
# Get-IntersightNiaapiUpgradeAssistFile

## SYNOPSIS
Get the NiaapiUpgradeAssistFile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiUpgradeAssistFile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiUpgradeAssistFile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiaapiUpgradeAssistFile&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiUpgradeAssistFile
```
Above example returns the list of NiaapiUpgradeAssistFile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiUpgradeAssistFile -Name "MoName"
```
Above example returns the NiaapiUpgradeAssistFile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiUpgradeAssistFile -Organization $organization
```
Above example returns the list of NiaapiUpgradeAssistFile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiUpgradeAssistFile -InlineCount allpages
```
Above example returns the list of NiaapiUpgradeAssistFile along with count.
...
### -Name
Specifies the name of the NiaapiUpgradeAssistFile.
...
### -Organization
Specifies the organization, to fetch the NiaapiUpgradeAssistFile under it.
