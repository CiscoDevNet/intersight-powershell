...
```powershell
$EquipmentSharedIoModuleRelationship = Initialize-IntersightEquipmentSharedIoModuleRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$EquipmentSharedIoModuleRelationship | ConvertTo-JSON
```
