...
# Get-IntersightMgmtConfigCategorySummary

## SYNOPSIS
Get the MgmtConfigCategorySummary

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMgmtConfigCategorySummary [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMgmtConfigCategorySummary [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MgmtConfigCategorySummary&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMgmtConfigCategorySummary
```
Above example returns the list of MgmtConfigCategorySummary.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMgmtConfigCategorySummary -Name "MoName"
```
Above example returns the MgmtConfigCategorySummary matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMgmtConfigCategorySummary -Organization $organization
```
Above example returns the list of MgmtConfigCategorySummary available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMgmtConfigCategorySummary -InlineCount allpages
```
Above example returns the list of MgmtConfigCategorySummary along with count.
...
### -Name
Specifies the name of the MgmtConfigCategorySummary.
...
### -Organization
Specifies the organization, to fetch the MgmtConfigCategorySummary under it.
