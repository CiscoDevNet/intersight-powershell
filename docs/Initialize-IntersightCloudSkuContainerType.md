...
Initialize-IntersightCloudSkuContainerType [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< CloudSkuContainerType.ClassIdEnum>][-CpuUnit< CloudSkuContainerType.CpuUnitEnum>][-CustomAttributes< System.Collections.Generic.List`1[Model.CloudCustomAttributes]>][-Description< string>][-IsActive< bool>][-IsAutoDiscovered< bool>][-Moid< string>][-Name< string>][-NumOfCpus< long>][-ObjectType< CloudSkuContainerType.ObjectTypeEnum>][-PlatformType< CloudSkuContainerType.PlatformTypeEnum>][-ServiceCategory< CloudSkuContainerType.ServiceCategoryEnum>][-ServiceFamily< string>][-ServiceName< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Target< Model.AssetTargetRelationship>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
