...
# Initialize-IntersightCloudSkuContainerType
...
Initialize-IntersightCloudSkuContainerType [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-BasePrice< float>][-ClassId< CloudSkuContainerType.ClassIdEnum>][-CpuUnit< CloudSkuContainerType.CpuUnitEnum>][-Currency< CloudSkuContainerType.CurrencyEnum>][-CustomAttributes< System.Collections.Generic.List`1[Model.CloudCustomAttributes]>][-Description< string>][-IsActive< bool>][-IsAutoDiscovered< bool>][-Moid< string>][-Name< string>][-NumOfCpus< long>][-ObjectType< CloudSkuContainerType.ObjectTypeEnum>][-PlatformType< CloudSkuContainerType.PlatformTypeEnum>][-Region< Model.CloudRegionsRelationship>][-RegionId< string>][-ServiceCategory< CloudSkuContainerType.ServiceCategoryEnum>][-ServiceFamily< string>][-ServiceName< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Target< Model.AssetTargetRelationship>][-Unit< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: CloudSkuContainerType.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CloudSkuContainerType.CurrencyEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CloudSkuContainerType.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CloudSkuContainerType.ServiceCategoryEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCloudSkuContainerType
```
