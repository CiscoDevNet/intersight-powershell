...
# Initialize-IntersightVirtualizationHost
...
Initialize-IntersightVirtualizationHost [-Action< VirtualizationHost.ActionEnum>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< VirtualizationHost.ClassIdEnum>][-Evacuate< bool>][-HostConfig< Model.VirtualizationBaseHostConfiguration>][-MaintenanceState< VirtualizationHost.MaintenanceStateEnum>][-Moid< string>][-ObjectType< VirtualizationHost.ObjectTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: VirtualizationHost.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.VirtualizationBaseHostConfiguration
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VirtualizationHost.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVirtualizationHost
```
