...
# Get-IntersightVnicEthNetworkPolicyInventory

## SYNOPSIS
Get the VnicEthNetworkPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicEthNetworkPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicEthNetworkPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicEthNetworkPolicyInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicEthNetworkPolicyInventory
```
Above example returns the list of VnicEthNetworkPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicEthNetworkPolicyInventory -Name "MoName"
```
Above example returns the VnicEthNetworkPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicEthNetworkPolicyInventory -Organization $organization
```
Above example returns the list of VnicEthNetworkPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicEthNetworkPolicyInventory -InlineCount allpages
```
Above example returns the list of VnicEthNetworkPolicyInventory along with count.
...
### -Name
Specifies the name of the VnicEthNetworkPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the VnicEthNetworkPolicyInventory under it.
