...
### CmdletParam (Default)
```
Get-IntersightStorageSpan [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageSpan [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageSpan
```
Above example returns the list of StorageSpan.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageSpan -Name "MoName"
```
Above example returns the StorageSpan matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageSpan -Organization $organization
```
Above example returns the list of StorageSpan available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageSpan -InlineCount allpages
```
Above example returns the list of StorageSpan along with count.
...
### -Name
Specifies the name of the StorageSpan.
...
### -Organization
Specifies the organization, to fetch the StorageSpan under it.
...
[Set-IntersightStorageSpan](./Set-IntersightStorageSpan.md)
