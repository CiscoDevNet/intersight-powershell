...
# Get-IntersightNiatelemetryHcloudDetails

## SYNOPSIS
Get the NiatelemetryHcloudDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryHcloudDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryHcloudDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryHcloudDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHcloudDetails
```
Above example returns the list of NiatelemetryHcloudDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHcloudDetails -Name "MoName"
```
Above example returns the NiatelemetryHcloudDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHcloudDetails -Organization $organization
```
Above example returns the list of NiatelemetryHcloudDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHcloudDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryHcloudDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryHcloudDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryHcloudDetails under it.
