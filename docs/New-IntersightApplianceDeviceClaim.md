...
New-IntersightApplianceDeviceClaim [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Hostname< string>][-IsRenew< bool>][-Moid< string>][-Password< string>][-PlatformType< ApplianceDeviceClaim.PlatformTypeEnum>][-RequestId< string>][-Reservation< ResourceReservationRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Username< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
