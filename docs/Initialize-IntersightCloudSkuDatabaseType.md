...
Initialize-IntersightCloudSkuDatabaseType [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< CloudSkuDatabaseType.ClassIdEnum>][-CustomAttributes< System.Collections.Generic.List`1[Model.CloudCustomAttributes]>][-DatabaseEdition< string>][-DatabaseEngine< string>][-Description< string>][-IsActive< bool>][-IsAutoDiscovered< bool>][-LicenseModel< string>][-Moid< string>][-Name< string>][-NetworkPerformance< string>][-ObjectType< CloudSkuDatabaseType.ObjectTypeEnum>][-PlatformType< CloudSkuDatabaseType.PlatformTypeEnum>][-ServiceCategory< CloudSkuDatabaseType.ServiceCategoryEnum>][-ServiceFamily< string>][-ServiceName< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Target< Model.AssetTargetRelationship>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
