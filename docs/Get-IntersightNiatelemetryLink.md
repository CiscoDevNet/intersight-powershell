...
# Get-IntersightNiatelemetryLink

## SYNOPSIS
Get the NiatelemetryLink

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryLink [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryLink [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryLink&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryLink
```
Above example returns the list of NiatelemetryLink.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryLink -Name "MoName"
```
Above example returns the NiatelemetryLink matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryLink -Organization $organization
```
Above example returns the list of NiatelemetryLink available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryLink -InlineCount allpages
```
Above example returns the list of NiatelemetryLink along with count.
...
### -Name
Specifies the name of the NiatelemetryLink.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryLink under it.
