...
# Get-IntersightStoragePureDirectoryQuota

## SYNOPSIS
Get the StoragePureDirectoryQuota

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureDirectoryQuota [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureDirectoryQuota [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureDirectoryQuota&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectoryQuota
```
Above example returns the list of StoragePureDirectoryQuota.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectoryQuota -Name "MoName"
```
Above example returns the StoragePureDirectoryQuota matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectoryQuota -Organization $organization
```
Above example returns the list of StoragePureDirectoryQuota available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectoryQuota -InlineCount allpages
```
Above example returns the list of StoragePureDirectoryQuota along with count.
...
### -Name
Specifies the name of the StoragePureDirectoryQuota.
...
### -Organization
Specifies the organization, to fetch the StoragePureDirectoryQuota under it.
