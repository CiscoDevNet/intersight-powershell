...
# Get-IntersightStorageController

## SYNOPSIS
Get the StorageController

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageController [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageController [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageController&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageController
```
Above example returns the list of StorageController.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageController -Name "MoName"
```
Above example returns the StorageController matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageController -Organization $organization
```
Above example returns the list of StorageController available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageController -InlineCount allpages
```
Above example returns the list of StorageController along with count.
...
### -Name
Specifies the name of the StorageController.
...
### -Organization
Specifies the organization, to fetch the StorageController under it.
...
[Set-IntersightStorageController](./Set-IntersightStorageController.md)
