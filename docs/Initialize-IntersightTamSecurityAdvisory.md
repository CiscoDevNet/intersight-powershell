...
# Initialize-IntersightTamSecurityAdvisory
...
```yaml
Type: TamSecurityAdvisory.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TamSecurityAdvisory.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTamSecurityAdvisory
```
