...
## SYNOPSIS
Get the FirmwarePcieDescriptor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwarePcieDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwarePcieDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;FirmwarePcieDescriptor&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwarePcieDescriptor
```
Above example returns the list of FirmwarePcieDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwarePcieDescriptor -Name "MoName"
```
Above example returns the FirmwarePcieDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwarePcieDescriptor -Organization $organization
```
Above example returns the list of FirmwarePcieDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwarePcieDescriptor -InlineCount allpages
```
Above example returns the list of FirmwarePcieDescriptor along with count.
...
### -Name
Specifies the name of the FirmwarePcieDescriptor.
...
### -Organization
Specifies the organization, to fetch the FirmwarePcieDescriptor under it.
