...
# Initialize-IntersightVnicVhbaTemplate
...
Initialize-IntersightVnicVhbaTemplate [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< VnicVhbaTemplate.ClassIdEnum>][-Description< string>][-EnableOverride< bool>][-FcAdapterPolicy< Model.VnicFcAdapterPolicyRelationship>][-FcNetworkPolicy< Model.VnicFcNetworkPolicyRelationship>][-FcQosPolicy< Model.VnicFcQosPolicyRelationship>][-FcZonePolicies< System.Collections.Generic.List`1[Model.FabricFcZonePolicyRelationship]>][-Moid< string>][-Name< string>][-ObjectType< VnicVhbaTemplate.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-PeerVhbaName< string>][-PersistentBindings< bool>][-PinGroupName< string>][-SwitchId< VnicVhbaTemplate.SwitchIdEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TemplateActions< System.Collections.Generic.List`1[Model.MotemplateActionEntry]>][-Type< VnicVhbaTemplate.TypeEnum>][-WwpnPool< Model.FcpoolPoolRelationship>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: VnicVhbaTemplate.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.VnicFcAdapterPolicyRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.VnicFcNetworkPolicyRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VnicVhbaTemplate.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.FcpoolPoolRelationship
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVnicVhbaTemplate
```
