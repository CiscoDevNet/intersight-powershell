...
# Get-IntersightSdwanRouterPolicy

## SYNOPSIS
Get the SdwanRouterPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSdwanRouterPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSdwanRouterPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;SdwanRouterPolicy&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSdwanRouterPolicy
```
Above example returns the list of SdwanRouterPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSdwanRouterPolicy -Name "MoName"
```
Above example returns the SdwanRouterPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSdwanRouterPolicy -Organization $organization
```
Above example returns the list of SdwanRouterPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSdwanRouterPolicy -InlineCount allpages
```
Above example returns the list of SdwanRouterPolicy along with count.
...
### -Name
Specifies the name of the SdwanRouterPolicy.
...
### -Organization
Specifies the organization, to fetch the SdwanRouterPolicy under it.
