...
### CmdletParam (Default)
```
Get-IntersightPciPort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPciPort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
