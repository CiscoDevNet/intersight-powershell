...
# Get-IntersightMarketplaceUseCaseVersion

## SYNOPSIS
Get the MarketplaceUseCaseVersion

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMarketplaceUseCaseVersion [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMarketplaceUseCaseVersion [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MarketplaceUseCaseVersion&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMarketplaceUseCaseVersion
```
Above example returns the list of MarketplaceUseCaseVersion.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMarketplaceUseCaseVersion -Name "MoName"
```
Above example returns the MarketplaceUseCaseVersion matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMarketplaceUseCaseVersion -Organization $organization
```
Above example returns the list of MarketplaceUseCaseVersion available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMarketplaceUseCaseVersion -InlineCount allpages
```
Above example returns the list of MarketplaceUseCaseVersion along with count.
...
### -Name
Specifies the name of the MarketplaceUseCaseVersion.
...
### -Organization
Specifies the organization, to fetch the MarketplaceUseCaseVersion under it.
