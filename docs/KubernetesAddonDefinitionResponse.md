...
```powershell
$KubernetesAddonDefinitionResponse = Initialize-IntersightKubernetesAddonDefinitionResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$KubernetesAddonDefinitionResponse | ConvertTo-JSON
```
