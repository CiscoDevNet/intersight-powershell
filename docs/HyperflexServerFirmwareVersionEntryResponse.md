...
```powershell
$HyperflexServerFirmwareVersionEntryResponse = Initialize-IntersightHyperflexServerFirmwareVersionEntryResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexServerFirmwareVersionEntryResponse | ConvertTo-JSON
```
