...
```powershell
$ApplianceDataExportPolicyResponse = Initialize-IntersightApplianceDataExportPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$ApplianceDataExportPolicyResponse | ConvertTo-JSON
```
