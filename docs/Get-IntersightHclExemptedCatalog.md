...
## SYNOPSIS
Get the HclExemptedCatalog

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHclExemptedCatalog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHclExemptedCatalog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;HclExemptedCatalog&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHclExemptedCatalog
```
Above example returns the list of HclExemptedCatalog.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHclExemptedCatalog -Name "MoName"
```
Above example returns the HclExemptedCatalog matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHclExemptedCatalog -Organization $organization
```
Above example returns the list of HclExemptedCatalog available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHclExemptedCatalog -InlineCount allpages
```
Above example returns the list of HclExemptedCatalog along with count.
...
### -Name
Specifies the name of the HclExemptedCatalog.
...
### -Organization
Specifies the organization, to fetch the HclExemptedCatalog under it.
