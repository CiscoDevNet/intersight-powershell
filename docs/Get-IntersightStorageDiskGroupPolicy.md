...
# Get-IntersightStorageDiskGroupPolicy

## SYNOPSIS
Get the StorageDiskGroupPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageDiskGroupPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageDiskGroupPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageDiskGroupPolicy&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageDiskGroupPolicy
```
Above example returns the list of StorageDiskGroupPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageDiskGroupPolicy -Name "MoName"
```
Above example returns the StorageDiskGroupPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageDiskGroupPolicy -Organization $organization
```
Above example returns the list of StorageDiskGroupPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageDiskGroupPolicy -InlineCount allpages
```
Above example returns the list of StorageDiskGroupPolicy along with count.
...
### -Name
Specifies the name of the StorageDiskGroupPolicy.
...
### -Organization
Specifies the organization, to fetch the StorageDiskGroupPolicy under it.
