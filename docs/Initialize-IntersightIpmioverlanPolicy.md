...
# Initialize-IntersightIpmioverlanPolicy
...
Initialize-IntersightIpmioverlanPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< IpmioverlanPolicy.ClassIdEnum>][-Description< string>][-Enabled< bool>][-EncryptionKey< string>][-Moid< string>][-Name< string>][-ObjectType< IpmioverlanPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Privilege< IpmioverlanPolicy.PrivilegeEnum>][-Profiles< System.Collections.Generic.List`1[Model.PolicyAbstractConfigProfileRelationship]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: IpmioverlanPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IpmioverlanPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIpmioverlanPolicy
```
