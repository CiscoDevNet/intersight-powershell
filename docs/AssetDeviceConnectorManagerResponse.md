...
```powershell
$AssetDeviceConnectorManagerResponse = Initialize-IntersightAssetDeviceConnectorManagerResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$AssetDeviceConnectorManagerResponse | ConvertTo-JSON
```
