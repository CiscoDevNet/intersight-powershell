...
# Initialize-IntersightBulkSubRequestObj
...
```yaml
Type: BulkSubRequestObj.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: BulkSubRequestObj.VerbEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightBulkSubRequestObj
```
