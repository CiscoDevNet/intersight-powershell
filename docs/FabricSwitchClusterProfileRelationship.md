...
```powershell
$FabricSwitchClusterProfileRelationship = Initialize-IntersightFabricSwitchClusterProfileRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$FabricSwitchClusterProfileRelationship | ConvertTo-JSON
```
