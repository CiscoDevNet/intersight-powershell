# SoftwareUcsdDistributableAllOf
## Properties
...
```powershell
$SoftwareUcsdDistributableAllOf = Initialize-IntersightSoftwareUcsdDistributableAllOf  -ClassId null `
 -ObjectType null `
 -Catalog null
```
...
```powershell
$SoftwareUcsdDistributableAllOf | ConvertTo-JSON
```
