...
# Get-IntersightIppoolIpLease

## SYNOPSIS
Get the IppoolIpLease

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIppoolIpLease [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIppoolIpLease [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IppoolIpLease&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIppoolIpLease
```
Above example returns the list of IppoolIpLease.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIppoolIpLease -Name "MoName"
```
Above example returns the IppoolIpLease matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIppoolIpLease -Organization $organization
```
Above example returns the list of IppoolIpLease available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIppoolIpLease -InlineCount allpages
```
Above example returns the list of IppoolIpLease along with count.
...
### -Name
Specifies the name of the IppoolIpLease.
...
### -Organization
Specifies the organization, to fetch the IppoolIpLease under it.
...
[Remove-IntersightIppoolIpLease](./Remove-IntersightIppoolIpLease.md)
