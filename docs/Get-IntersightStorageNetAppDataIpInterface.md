...
# Get-IntersightStorageNetAppDataIpInterface

## SYNOPSIS
Get the StorageNetAppDataIpInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppDataIpInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppDataIpInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppDataIpInterface&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppDataIpInterface
```
Above example returns the list of StorageNetAppDataIpInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppDataIpInterface -Name "MoName"
```
Above example returns the StorageNetAppDataIpInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppDataIpInterface -Organization $organization
```
Above example returns the list of StorageNetAppDataIpInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppDataIpInterface -InlineCount allpages
```
Above example returns the list of StorageNetAppDataIpInterface along with count.
...
### -Name
Specifies the name of the StorageNetAppDataIpInterface.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppDataIpInterface under it.
