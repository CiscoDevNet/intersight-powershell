...
## SYNOPSIS
Get the StorageNetAppInitiatorGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppInitiatorGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppInitiatorGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageNetAppInitiatorGroup&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppInitiatorGroup
```
Above example returns the list of StorageNetAppInitiatorGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppInitiatorGroup -Name "MoName"
```
Above example returns the StorageNetAppInitiatorGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppInitiatorGroup -Organization $organization
```
Above example returns the list of StorageNetAppInitiatorGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppInitiatorGroup -InlineCount allpages
```
Above example returns the list of StorageNetAppInitiatorGroup along with count.
...
### -Name
Specifies the name of the StorageNetAppInitiatorGroup.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppInitiatorGroup under it.
