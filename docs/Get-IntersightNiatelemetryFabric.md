...
# Get-IntersightNiatelemetryFabric

## SYNOPSIS
Get the NiatelemetryFabric

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryFabric [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryFabric [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryFabric&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabric
```
Above example returns the list of NiatelemetryFabric.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabric -Name "MoName"
```
Above example returns the NiatelemetryFabric matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabric -Organization $organization
```
Above example returns the list of NiatelemetryFabric available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabric -InlineCount allpages
```
Above example returns the list of NiatelemetryFabric along with count.
...
### -Name
Specifies the name of the NiatelemetryFabric.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryFabric under it.
