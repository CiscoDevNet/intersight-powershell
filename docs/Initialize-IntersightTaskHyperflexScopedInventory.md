...
# Initialize-IntersightTaskHyperflexScopedInventory
...
```yaml
Type: TaskHyperflexScopedInventory.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TaskHyperflexScopedInventory.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTaskHyperflexScopedInventory
```
