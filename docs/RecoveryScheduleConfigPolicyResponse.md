...
```powershell
$RecoveryScheduleConfigPolicyResponse = Initialize-IntersightRecoveryScheduleConfigPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$RecoveryScheduleConfigPolicyResponse | ConvertTo-JSON
```
