...
# Get-IntersightNetworkVpcDomain

## SYNOPSIS
Get the NetworkVpcDomain

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkVpcDomain [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkVpcDomain [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NetworkVpcDomain&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkVpcDomain
```
Above example returns the list of NetworkVpcDomain.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkVpcDomain -Name "MoName"
```
Above example returns the NetworkVpcDomain matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkVpcDomain -Organization $organization
```
Above example returns the list of NetworkVpcDomain available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkVpcDomain -InlineCount allpages
```
Above example returns the list of NetworkVpcDomain along with count.
...
### -Name
Specifies the name of the NetworkVpcDomain.
...
### -Organization
Specifies the organization, to fetch the NetworkVpcDomain under it.
