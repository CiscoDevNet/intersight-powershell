...
## SYNOPSIS
Get the StorageVirtualDrive

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageVirtualDrive [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageVirtualDrive [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageVirtualDrive&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDrive
```
Above example returns the list of StorageVirtualDrive.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDrive -Name "MoName"
```
Above example returns the StorageVirtualDrive matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDrive -Organization $organization
```
Above example returns the list of StorageVirtualDrive available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDrive -InlineCount allpages
```
Above example returns the list of StorageVirtualDrive along with count.
...
### -Name
Specifies the name of the StorageVirtualDrive.
...
### -Organization
Specifies the organization, to fetch the StorageVirtualDrive under it.
...
[Set-IntersightStorageVirtualDrive](./Set-IntersightStorageVirtualDrive.md)
