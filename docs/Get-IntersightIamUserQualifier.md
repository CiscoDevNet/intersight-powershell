...
# Get-IntersightIamUserQualifier

## SYNOPSIS
Get the IamUserQualifier

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamUserQualifier [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamUserQualifier [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamUserQualifier&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamUserQualifier
```
Above example returns the list of IamUserQualifier.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamUserQualifier -Name "MoName"
```
Above example returns the IamUserQualifier matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamUserQualifier -Organization $organization
```
Above example returns the list of IamUserQualifier available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamUserQualifier -InlineCount allpages
```
Above example returns the list of IamUserQualifier along with count.
...
### -Name
Specifies the name of the IamUserQualifier.
...
### -Organization
Specifies the organization, to fetch the IamUserQualifier under it.
