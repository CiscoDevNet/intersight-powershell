...
# Get-IntersightFabricSpanSourceEthPort

## SYNOPSIS
Get the FabricSpanSourceEthPort

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricSpanSourceEthPort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricSpanSourceEthPort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricSpanSourceEthPort&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceEthPort
```
Above example returns the list of FabricSpanSourceEthPort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceEthPort -Name "MoName"
```
Above example returns the FabricSpanSourceEthPort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceEthPort -Organization $organization
```
Above example returns the list of FabricSpanSourceEthPort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceEthPort -InlineCount allpages
```
Above example returns the list of FabricSpanSourceEthPort along with count.
...
### -Name
Specifies the name of the FabricSpanSourceEthPort.
...
### -Organization
Specifies the organization, to fetch the FabricSpanSourceEthPort under it.
...
[Remove-IntersightFabricSpanSourceEthPort](./Remove-IntersightFabricSpanSourceEthPort.md)
