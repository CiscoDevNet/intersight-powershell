...
Initialize-IntersightFabricPortIdentifier [-AdditionalProperties< Dictionary<string,object>>][-AggregatePortId< long>][-ClassId< FabricPortIdentifier.ClassIdEnum>][-ObjectType< FabricPortIdentifier.ObjectTypeEnum>][-PortId< long>][-SlotId< long>]
