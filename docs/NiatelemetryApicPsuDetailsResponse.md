...
```powershell
$NiatelemetryApicPsuDetailsResponse = Initialize-IntersightNiatelemetryApicPsuDetailsResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiatelemetryApicPsuDetailsResponse | ConvertTo-JSON
```
