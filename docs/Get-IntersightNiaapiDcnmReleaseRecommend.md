...
## SYNOPSIS
Get the NiaapiDcnmReleaseRecommend

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiDcnmReleaseRecommend [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiDcnmReleaseRecommend [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiaapiDcnmReleaseRecommend&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmReleaseRecommend
```
Above example returns the list of NiaapiDcnmReleaseRecommend.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmReleaseRecommend -Name "MoName"
```
Above example returns the NiaapiDcnmReleaseRecommend matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmReleaseRecommend -Organization $organization
```
Above example returns the list of NiaapiDcnmReleaseRecommend available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmReleaseRecommend -InlineCount allpages
```
Above example returns the list of NiaapiDcnmReleaseRecommend along with count.
...
### -Name
Specifies the name of the NiaapiDcnmReleaseRecommend.
...
### -Organization
Specifies the organization, to fetch the NiaapiDcnmReleaseRecommend under it.
