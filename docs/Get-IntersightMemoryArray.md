...
### CmdletParam (Default)
```
Get-IntersightMemoryArray [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMemoryArray [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMemoryArray
```
Above example returns the list of MemoryArray.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMemoryArray -Name "MoName"
```
Above example returns the MemoryArray matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMemoryArray -Organization $organization
```
Above example returns the list of MemoryArray available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMemoryArray -InlineCount allpages
```
Above example returns the list of MemoryArray along with count.
...
### -Name
Specifies the name of the MemoryArray.
...
### -Organization
Specifies the organization, to fetch the MemoryArray under it.
...
[Set-IntersightMemoryArray](./Set-IntersightMemoryArray.md)
