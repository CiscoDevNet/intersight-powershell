...
# Get-IntersightDnacExternalBorderNode

## SYNOPSIS
Get the DnacExternalBorderNode

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightDnacExternalBorderNode [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightDnacExternalBorderNode [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;DnacExternalBorderNode&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightDnacExternalBorderNode
```
Above example returns the list of DnacExternalBorderNode.

### Example 2
```powershell
PS C:\> $result = Get-IntersightDnacExternalBorderNode -Name "MoName"
```
Above example returns the DnacExternalBorderNode matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightDnacExternalBorderNode -Organization $organization
```
Above example returns the list of DnacExternalBorderNode available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightDnacExternalBorderNode -InlineCount allpages
```
Above example returns the list of DnacExternalBorderNode along with count.
...
### -Name
Specifies the name of the DnacExternalBorderNode.
...
### -Organization
Specifies the organization, to fetch the DnacExternalBorderNode under it.
