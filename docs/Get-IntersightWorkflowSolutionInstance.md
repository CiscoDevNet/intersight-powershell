...
## SYNOPSIS
Get the WorkflowSolutionInstance

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowSolutionInstance [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowSolutionInstance [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionInstance
```
Above example returns the list of WorkflowSolutionInstance.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionInstance -Name "MoName"
```
Above example returns the WorkflowSolutionInstance matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionInstance -Organization $organization
```
Above example returns the list of WorkflowSolutionInstance available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionInstance -InlineCount allpages
```
Above example returns the list of WorkflowSolutionInstance along with count.
...
### -Name
Specifies the name of the WorkflowSolutionInstance.
...
### -Organization
Specifies the organization, to fetch the WorkflowSolutionInstance under it.
