...
```powershell
$VirtualizationVirtualMachineRelationship = Initialize-IntersightVirtualizationVirtualMachineRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$VirtualizationVirtualMachineRelationship | ConvertTo-JSON
```
