...
### CmdletParam (Default)
```
Get-IntersightCapabilityServerSchemaDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityServerSchemaDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityServerSchemaDescriptor
```
Above example returns the list of CapabilityServerSchemaDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityServerSchemaDescriptor -Name "MoName"
```
Above example returns the CapabilityServerSchemaDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityServerSchemaDescriptor -Organization $organization
```
Above example returns the list of CapabilityServerSchemaDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityServerSchemaDescriptor -InlineCount allpages
```
Above example returns the list of CapabilityServerSchemaDescriptor along with count.
...
### -Name
Specifies the name of the CapabilityServerSchemaDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilityServerSchemaDescriptor under it.
