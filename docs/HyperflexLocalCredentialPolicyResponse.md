...
```powershell
$HyperflexLocalCredentialPolicyResponse = Initialize-IntersightHyperflexLocalCredentialPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexLocalCredentialPolicyResponse | ConvertTo-JSON
```
