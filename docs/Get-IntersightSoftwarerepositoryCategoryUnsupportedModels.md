...
# Get-IntersightSoftwarerepositoryCategoryUnsupportedModels

## SYNOPSIS
Get the SoftwarerepositoryCategoryUnsupportedModels

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwarerepositoryCategoryUnsupportedModels [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwarerepositoryCategoryUnsupportedModels [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SoftwarerepositoryCategoryUnsupportedModels&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategoryUnsupportedModels
```
Above example returns the list of SoftwarerepositoryCategoryUnsupportedModels.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategoryUnsupportedModels -Name "MoName"
```
Above example returns the SoftwarerepositoryCategoryUnsupportedModels matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategoryUnsupportedModels -Organization $organization
```
Above example returns the list of SoftwarerepositoryCategoryUnsupportedModels available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategoryUnsupportedModels -InlineCount allpages
```
Above example returns the list of SoftwarerepositoryCategoryUnsupportedModels along with count.
...
### -Name
Specifies the name of the SoftwarerepositoryCategoryUnsupportedModels.
...
### -Organization
Specifies the organization, to fetch the SoftwarerepositoryCategoryUnsupportedModels under it.
