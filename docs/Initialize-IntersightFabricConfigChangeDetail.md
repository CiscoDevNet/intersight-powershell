...
# Initialize-IntersightFabricConfigChangeDetail
...
Initialize-IntersightFabricConfigChangeDetail [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Changes< System.Collections.Generic.List`1[string]>][-ClassId< FabricConfigChangeDetail.ClassIdEnum>][-ConfigChangeContext< Model.PolicyConfigResultContext>][-ConfigChangeFlag< FabricConfigChangeDetail.ConfigChangeFlagEnum>][-Disruptions< System.Collections.Generic.List`1[string]>][-Message< string>][-ModStatus< FabricConfigChangeDetail.ModStatusEnum>][-Moid< string>][-ObjectType< FabricConfigChangeDetail.ObjectTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: FabricConfigChangeDetail.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricConfigChangeDetail.ConfigChangeFlagEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricConfigChangeDetail.ModStatusEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricConfigChangeDetail.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFabricConfigChangeDetail
```
