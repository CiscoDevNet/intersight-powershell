...
```powershell
$MemoryPersistentMemoryNamespaceConfigResult = Initialize-IntersightMemoryPersistentMemoryNamespaceConfigResult  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$MemoryPersistentMemoryNamespaceConfigResult | ConvertTo-JSON
```
