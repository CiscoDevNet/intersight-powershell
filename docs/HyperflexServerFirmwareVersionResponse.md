...
```powershell
$HyperflexServerFirmwareVersionResponse = Initialize-IntersightHyperflexServerFirmwareVersionResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexServerFirmwareVersionResponse | ConvertTo-JSON
```
