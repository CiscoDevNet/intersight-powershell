...
# Get-IntersightStorageHyperFlexVolume

## SYNOPSIS
Get the StorageHyperFlexVolume

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHyperFlexVolume [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHyperFlexVolume [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHyperFlexVolume&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHyperFlexVolume
```
Above example returns the list of StorageHyperFlexVolume.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHyperFlexVolume -Name "MoName"
```
Above example returns the StorageHyperFlexVolume matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHyperFlexVolume -Organization $organization
```
Above example returns the list of StorageHyperFlexVolume available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHyperFlexVolume -InlineCount allpages
```
Above example returns the list of StorageHyperFlexVolume along with count.
...
### -Name
Specifies the name of the StorageHyperFlexVolume.
...
### -Organization
Specifies the organization, to fetch the StorageHyperFlexVolume under it.
