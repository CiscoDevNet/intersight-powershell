...
## SYNOPSIS
Get the ApplianceExternalSyslogSetting

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceExternalSyslogSetting [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceExternalSyslogSetting [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceExternalSyslogSetting
```
Above example returns the list of ApplianceExternalSyslogSetting.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceExternalSyslogSetting -Name "MoName"
```
Above example returns the ApplianceExternalSyslogSetting matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceExternalSyslogSetting -Organization $organization
```
Above example returns the list of ApplianceExternalSyslogSetting available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceExternalSyslogSetting -InlineCount allpages
```
Above example returns the list of ApplianceExternalSyslogSetting along with count.
...
### -Name
Specifies the name of the ApplianceExternalSyslogSetting.
...
### -Organization
Specifies the organization, to fetch the ApplianceExternalSyslogSetting under it.
