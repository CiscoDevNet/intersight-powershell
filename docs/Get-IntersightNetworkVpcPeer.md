...
# Get-IntersightNetworkVpcPeer

## SYNOPSIS
Get the NetworkVpcPeer

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkVpcPeer [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkVpcPeer [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NetworkVpcPeer&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkVpcPeer
```
Above example returns the list of NetworkVpcPeer.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkVpcPeer -Name "MoName"
```
Above example returns the NetworkVpcPeer matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkVpcPeer -Organization $organization
```
Above example returns the list of NetworkVpcPeer available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkVpcPeer -InlineCount allpages
```
Above example returns the list of NetworkVpcPeer along with count.
...
### -Name
Specifies the name of the NetworkVpcPeer.
...
### -Organization
Specifies the organization, to fetch the NetworkVpcPeer under it.
