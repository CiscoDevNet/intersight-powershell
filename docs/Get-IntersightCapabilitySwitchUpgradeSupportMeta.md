...
# Get-IntersightCapabilitySwitchUpgradeSupportMeta

## SYNOPSIS
Get the CapabilitySwitchUpgradeSupportMeta

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilitySwitchUpgradeSupportMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilitySwitchUpgradeSupportMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilitySwitchUpgradeSupportMeta&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchUpgradeSupportMeta
```
Above example returns the list of CapabilitySwitchUpgradeSupportMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchUpgradeSupportMeta -Name "MoName"
```
Above example returns the CapabilitySwitchUpgradeSupportMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchUpgradeSupportMeta -Organization $organization
```
Above example returns the list of CapabilitySwitchUpgradeSupportMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchUpgradeSupportMeta -InlineCount allpages
```
Above example returns the list of CapabilitySwitchUpgradeSupportMeta along with count.
...
### -Name
Specifies the name of the CapabilitySwitchUpgradeSupportMeta.
...
### -Organization
Specifies the organization, to fetch the CapabilitySwitchUpgradeSupportMeta under it.
