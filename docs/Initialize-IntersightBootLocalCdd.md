...
Initialize-IntersightBootLocalCdd [-AdditionalProperties< Dictionary<string,object>>][-ClassId< BootLocalCdd.ClassIdEnum>][-Enabled< bool>][-Name< string>][-ObjectType< BootLocalCdd.ObjectTypeEnum>]
