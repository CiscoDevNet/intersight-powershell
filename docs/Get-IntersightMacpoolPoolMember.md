...
# Get-IntersightMacpoolPoolMember

## SYNOPSIS
Get the MacpoolPoolMember

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMacpoolPoolMember [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMacpoolPoolMember [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MacpoolPoolMember&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMacpoolPoolMember
```
Above example returns the list of MacpoolPoolMember.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMacpoolPoolMember -Name "MoName"
```
Above example returns the MacpoolPoolMember matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMacpoolPoolMember -Organization $organization
```
Above example returns the list of MacpoolPoolMember available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMacpoolPoolMember -InlineCount allpages
```
Above example returns the list of MacpoolPoolMember along with count.
...
### -Name
Specifies the name of the MacpoolPoolMember.
...
### -Organization
Specifies the organization, to fetch the MacpoolPoolMember under it.
