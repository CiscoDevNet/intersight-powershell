...
# Get-IntersightIamPrivilegeSetMetaInfo

## SYNOPSIS
Get the IamPrivilegeSetMetaInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamPrivilegeSetMetaInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamPrivilegeSetMetaInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamPrivilegeSetMetaInfo&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamPrivilegeSetMetaInfo
```
Above example returns the list of IamPrivilegeSetMetaInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamPrivilegeSetMetaInfo -Name "MoName"
```
Above example returns the IamPrivilegeSetMetaInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamPrivilegeSetMetaInfo -Organization $organization
```
Above example returns the list of IamPrivilegeSetMetaInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamPrivilegeSetMetaInfo -InlineCount allpages
```
Above example returns the list of IamPrivilegeSetMetaInfo along with count.
...
### -Name
Specifies the name of the IamPrivilegeSetMetaInfo.
...
### -Organization
Specifies the organization, to fetch the IamPrivilegeSetMetaInfo under it.
...
[New-IntersightIamPrivilegeSetMetaInfo](./New-IntersightIamPrivilegeSetMetaInfo.md)
