...
## SYNOPSIS
Get the HyperflexSoftwareVersionPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexSoftwareVersionPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexSoftwareVersionPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexSoftwareVersionPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareVersionPolicy
```
Above example returns the list of HyperflexSoftwareVersionPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareVersionPolicy -Name "MoName"
```
Above example returns the HyperflexSoftwareVersionPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareVersionPolicy -Organization $organization
```
Above example returns the list of HyperflexSoftwareVersionPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareVersionPolicy -InlineCount allpages
```
Above example returns the list of HyperflexSoftwareVersionPolicy along with count.
...
### -Name
Specifies the name of the HyperflexSoftwareVersionPolicy.
...
### -Organization
Specifies the organization, to fetch the HyperflexSoftwareVersionPolicy under it.
