...
### CmdletParam (Default)
```
Get-IntersightCondAlarm [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCondAlarm [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;CondAlarm&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCondAlarm
```
Above example returns the list of CondAlarm.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCondAlarm -Name "MoName"
```
Above example returns the CondAlarm matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCondAlarm -Organization $organization
```
Above example returns the list of CondAlarm available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCondAlarm -InlineCount allpages
```
Above example returns the list of CondAlarm along with count.
...
### -Name
Specifies the name of the CondAlarm.
...
### -Organization
Specifies the organization, to fetch the CondAlarm under it.
...
[Set-IntersightCondAlarm](./Set-IntersightCondAlarm.md)
