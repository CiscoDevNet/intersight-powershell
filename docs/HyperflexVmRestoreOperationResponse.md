...
```powershell
$HyperflexVmRestoreOperationResponse = Initialize-IntersightHyperflexVmRestoreOperationResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexVmRestoreOperationResponse | ConvertTo-JSON
```
