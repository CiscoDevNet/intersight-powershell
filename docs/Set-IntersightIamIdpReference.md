...
Set-IntersightIamIdpReference [-AdditionalProperties< Dictionary<string,object>>][[-Moid]< string>][-MultiFactorAuthentication< bool>][-Tags< List<MoTag>>][-Usergroups< List<IamUserGroupRelationship>>][-Users< List<IamUserRelationship>>]
