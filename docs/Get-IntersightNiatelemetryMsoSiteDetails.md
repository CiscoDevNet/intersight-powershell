...
### CmdletParam (Default)
```
Get-IntersightNiatelemetryMsoSiteDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryMsoSiteDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryMsoSiteDetails&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoSiteDetails
```
Above example returns the list of NiatelemetryMsoSiteDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoSiteDetails -Name "MoName"
```
Above example returns the NiatelemetryMsoSiteDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoSiteDetails -Organization $organization
```
Above example returns the list of NiatelemetryMsoSiteDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoSiteDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryMsoSiteDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryMsoSiteDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryMsoSiteDetails under it.
