...
### CmdletParam (Default)
```
Get-IntersightHyperflexSoftwareDistributionEntry [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexSoftwareDistributionEntry [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareDistributionEntry
```
Above example returns the list of HyperflexSoftwareDistributionEntry.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareDistributionEntry -Name "MoName"
```
Above example returns the HyperflexSoftwareDistributionEntry matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareDistributionEntry -Organization $organization
```
Above example returns the list of HyperflexSoftwareDistributionEntry available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareDistributionEntry -InlineCount allpages
```
Above example returns the list of HyperflexSoftwareDistributionEntry along with count.
...
### -Name
Specifies the name of the HyperflexSoftwareDistributionEntry.
...
### -Organization
Specifies the organization, to fetch the HyperflexSoftwareDistributionEntry under it.
