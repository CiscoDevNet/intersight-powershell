...
Initialize-IntersightBootUsb [-AdditionalProperties< Dictionary<string,object>>][-ClassId< BootUsb.ClassIdEnum>][-Enabled< bool>][-Name< string>][-ObjectType< BootUsb.ObjectTypeEnum>][-Subtype< BootUsb.SubtypeEnum>]
