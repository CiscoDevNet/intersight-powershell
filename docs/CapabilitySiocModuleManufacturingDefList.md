...
```powershell
$CapabilitySiocModuleManufacturingDefList = Initialize-IntersightCapabilitySiocModuleManufacturingDefList  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilitySiocModuleManufacturingDefList | ConvertTo-JSON
```
