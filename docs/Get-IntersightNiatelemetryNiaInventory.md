...
## SYNOPSIS
Get the NiatelemetryNiaInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryNiaInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryNiaInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryNiaInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaInventory
```
Above example returns the list of NiatelemetryNiaInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaInventory -Name "MoName"
```
Above example returns the NiatelemetryNiaInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaInventory -Organization $organization
```
Above example returns the list of NiatelemetryNiaInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaInventory -InlineCount allpages
```
Above example returns the list of NiatelemetryNiaInventory along with count.
...
### -Name
Specifies the name of the NiatelemetryNiaInventory.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryNiaInventory under it.
...
[Set-IntersightNiatelemetryNiaInventory](./Set-IntersightNiatelemetryNiaInventory.md)
