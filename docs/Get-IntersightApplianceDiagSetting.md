...
## SYNOPSIS
Get the ApplianceDiagSetting

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceDiagSetting [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceDiagSetting [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;ApplianceDiagSetting&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceDiagSetting
```
Above example returns the list of ApplianceDiagSetting.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceDiagSetting -Name "MoName"
```
Above example returns the ApplianceDiagSetting matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceDiagSetting -Organization $organization
```
Above example returns the list of ApplianceDiagSetting available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceDiagSetting -InlineCount allpages
```
Above example returns the list of ApplianceDiagSetting along with count.
...
### -Name
Specifies the name of the ApplianceDiagSetting.
...
### -Organization
Specifies the organization, to fetch the ApplianceDiagSetting under it.
