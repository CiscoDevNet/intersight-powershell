...
# Set-IntersightComputePcieConnectivityPolicy
...
Set-IntersightComputePcieConnectivityPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Description< string>][[-Moid]< string>][-Name< string>][-Organization< OrganizationOrganizationRelationship>][-PcieZones< System.Collections.Generic.List`1[ComputePcieZone]>][-Profiles< System.Collections.Generic.List`1[PolicyAbstractConfigProfileRelationship]>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;ComputePcieConnectivityPolicy&apos; resource.
...
```yaml
Type: System.Collections.Generic.List`1[ComputePcieZone]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Set-IntersightComputePcieConnectivityPolicy
```
