...
# Get-IntersightCapabilityStorageControllersMetaData

## SYNOPSIS
Get the CapabilityStorageControllersMetaData

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityStorageControllersMetaData [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityStorageControllersMetaData [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilityStorageControllersMetaData&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityStorageControllersMetaData
```
Above example returns the list of CapabilityStorageControllersMetaData.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityStorageControllersMetaData -Name "MoName"
```
Above example returns the CapabilityStorageControllersMetaData matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityStorageControllersMetaData -Organization $organization
```
Above example returns the list of CapabilityStorageControllersMetaData available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityStorageControllersMetaData -InlineCount allpages
```
Above example returns the list of CapabilityStorageControllersMetaData along with count.
...
### -Name
Specifies the name of the CapabilityStorageControllersMetaData.
...
### -Organization
Specifies the organization, to fetch the CapabilityStorageControllersMetaData under it.
