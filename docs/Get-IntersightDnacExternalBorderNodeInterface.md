...
# Get-IntersightDnacExternalBorderNodeInterface

## SYNOPSIS
Get the DnacExternalBorderNodeInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightDnacExternalBorderNodeInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightDnacExternalBorderNodeInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;DnacExternalBorderNodeInterface&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightDnacExternalBorderNodeInterface
```
Above example returns the list of DnacExternalBorderNodeInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightDnacExternalBorderNodeInterface -Name "MoName"
```
Above example returns the DnacExternalBorderNodeInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightDnacExternalBorderNodeInterface -Organization $organization
```
Above example returns the list of DnacExternalBorderNodeInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightDnacExternalBorderNodeInterface -InlineCount allpages
```
Above example returns the list of DnacExternalBorderNodeInterface along with count.
...
### -Name
Specifies the name of the DnacExternalBorderNodeInterface.
...
### -Organization
Specifies the organization, to fetch the DnacExternalBorderNodeInterface under it.
