...
```powershell
$AdapterHostIscsiInterfaceResponse = Initialize-IntersightAdapterHostIscsiInterfaceResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$AdapterHostIscsiInterfaceResponse | ConvertTo-JSON
```
