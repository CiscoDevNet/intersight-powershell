...
```powershell
$RecoveryConfigResultEntryResponse = Initialize-IntersightRecoveryConfigResultEntryResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$RecoveryConfigResultEntryResponse | ConvertTo-JSON
```
