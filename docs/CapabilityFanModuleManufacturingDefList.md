...
```powershell
$CapabilityFanModuleManufacturingDefList = Initialize-IntersightCapabilityFanModuleManufacturingDefList  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilityFanModuleManufacturingDefList | ConvertTo-JSON
```
