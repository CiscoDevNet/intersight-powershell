...
```powershell
$FabricEthNetworkGroupPolicyRelationship = Initialize-IntersightFabricEthNetworkGroupPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$FabricEthNetworkGroupPolicyRelationship | ConvertTo-JSON
```
