...
### CmdletParam (Default)
```
Get-IntersightNtpPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNtpPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NtpPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNtpPolicy
```
Above example returns the list of NtpPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNtpPolicy -Name "MoName"
```
Above example returns the NtpPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNtpPolicy -Organization $organization
```
Above example returns the list of NtpPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNtpPolicy -InlineCount allpages
```
Above example returns the list of NtpPolicy along with count.
...
### -Name
Specifies the name of the NtpPolicy.
...
### -Organization
Specifies the organization, to fetch the NtpPolicy under it.
