...
### CmdletParam (Default)
```
Get-IntersightMacpoolPool [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMacpoolPool [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MacpoolPool&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMacpoolPool
```
Above example returns the list of MacpoolPool.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMacpoolPool -Name "MoName"
```
Above example returns the MacpoolPool matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMacpoolPool -Organization $organization
```
Above example returns the list of MacpoolPool available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMacpoolPool -InlineCount allpages
```
Above example returns the list of MacpoolPool along with count.
...
### -Name
Specifies the name of the MacpoolPool.
...
### -Organization
Specifies the organization, to fetch the MacpoolPool under it.
