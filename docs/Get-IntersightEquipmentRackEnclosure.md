...
## SYNOPSIS
Get the EquipmentRackEnclosure

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentRackEnclosure [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentRackEnclosure [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;EquipmentRackEnclosure&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentRackEnclosure
```
Above example returns the list of EquipmentRackEnclosure.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentRackEnclosure -Name "MoName"
```
Above example returns the EquipmentRackEnclosure matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentRackEnclosure -Organization $organization
```
Above example returns the list of EquipmentRackEnclosure available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentRackEnclosure -InlineCount allpages
```
Above example returns the list of EquipmentRackEnclosure along with count.
...
### -Name
Specifies the name of the EquipmentRackEnclosure.
...
### -Organization
Specifies the organization, to fetch the EquipmentRackEnclosure under it.
...
[Set-IntersightEquipmentRackEnclosure](./Set-IntersightEquipmentRackEnclosure.md)
