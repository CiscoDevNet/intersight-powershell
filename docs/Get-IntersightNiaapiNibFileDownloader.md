...
## SYNOPSIS
Get the NiaapiNibFileDownloader

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiNibFileDownloader [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiNibFileDownloader [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiaapiNibFileDownloader&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiNibFileDownloader
```
Above example returns the list of NiaapiNibFileDownloader.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiNibFileDownloader -Name "MoName"
```
Above example returns the NiaapiNibFileDownloader matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiNibFileDownloader -Organization $organization
```
Above example returns the list of NiaapiNibFileDownloader available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiNibFileDownloader -InlineCount allpages
```
Above example returns the list of NiaapiNibFileDownloader along with count.
...
### -Name
Specifies the name of the NiaapiNibFileDownloader.
...
### -Organization
Specifies the organization, to fetch the NiaapiNibFileDownloader under it.
