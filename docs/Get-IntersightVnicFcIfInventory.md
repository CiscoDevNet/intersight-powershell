...
# Get-IntersightVnicFcIfInventory

## SYNOPSIS
Get the VnicFcIfInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicFcIfInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicFcIfInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicFcIfInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicFcIfInventory
```
Above example returns the list of VnicFcIfInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicFcIfInventory -Name "MoName"
```
Above example returns the VnicFcIfInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicFcIfInventory -Organization $organization
```
Above example returns the list of VnicFcIfInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicFcIfInventory -InlineCount allpages
```
Above example returns the list of VnicFcIfInventory along with count.
...
### -Name
Specifies the name of the VnicFcIfInventory.
...
### -Organization
Specifies the organization, to fetch the VnicFcIfInventory under it.
