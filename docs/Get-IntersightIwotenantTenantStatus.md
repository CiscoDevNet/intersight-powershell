...
## SYNOPSIS
Get the IwotenantTenantStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIwotenantTenantStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIwotenantTenantStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IwotenantTenantStatus&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIwotenantTenantStatus
```
Above example returns the list of IwotenantTenantStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIwotenantTenantStatus -Name "MoName"
```
Above example returns the IwotenantTenantStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIwotenantTenantStatus -Organization $organization
```
Above example returns the list of IwotenantTenantStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIwotenantTenantStatus -InlineCount allpages
```
Above example returns the list of IwotenantTenantStatus along with count.
...
### -Name
Specifies the name of the IwotenantTenantStatus.
...
### -Organization
Specifies the organization, to fetch the IwotenantTenantStatus under it.
