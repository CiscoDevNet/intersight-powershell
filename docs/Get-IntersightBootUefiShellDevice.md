...
# Get-IntersightBootUefiShellDevice

## SYNOPSIS
Get the BootUefiShellDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBootUefiShellDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBootUefiShellDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBootUefiShellDevice
```
Above example returns the list of BootUefiShellDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBootUefiShellDevice -Name "MoName"
```
Above example returns the BootUefiShellDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBootUefiShellDevice -Organization $organization
```
Above example returns the list of BootUefiShellDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBootUefiShellDevice -InlineCount allpages
```
Above example returns the list of BootUefiShellDevice along with count.
...
### -Name
Specifies the name of the BootUefiShellDevice.
...
### -Organization
Specifies the organization, to fetch the BootUefiShellDevice under it.
...
[Set-IntersightBootUefiShellDevice](./Set-IntersightBootUefiShellDevice.md)
