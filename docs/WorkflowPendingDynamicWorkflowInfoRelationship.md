...
```powershell
$WorkflowPendingDynamicWorkflowInfoRelationship = Initialize-IntersightWorkflowPendingDynamicWorkflowInfoRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$WorkflowPendingDynamicWorkflowInfoRelationship | ConvertTo-JSON
```
