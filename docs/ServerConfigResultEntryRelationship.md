...
```powershell
$ServerConfigResultEntryRelationship = Initialize-IntersightServerConfigResultEntryRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$ServerConfigResultEntryRelationship | ConvertTo-JSON
```
