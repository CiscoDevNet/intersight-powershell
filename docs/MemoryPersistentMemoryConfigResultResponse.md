...
```powershell
$MemoryPersistentMemoryConfigResultResponse = Initialize-IntersightMemoryPersistentMemoryConfigResultResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$MemoryPersistentMemoryConfigResultResponse | ConvertTo-JSON
```
