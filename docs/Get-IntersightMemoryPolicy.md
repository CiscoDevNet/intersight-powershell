...
# Get-IntersightMemoryPolicy

## SYNOPSIS
Get the MemoryPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMemoryPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMemoryPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MemoryPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMemoryPolicy
```
Above example returns the list of MemoryPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMemoryPolicy -Name "MoName"
```
Above example returns the MemoryPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMemoryPolicy -Organization $organization
```
Above example returns the list of MemoryPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMemoryPolicy -InlineCount allpages
```
Above example returns the list of MemoryPolicy along with count.
...
### -Name
Specifies the name of the MemoryPolicy.
...
### -Organization
Specifies the organization, to fetch the MemoryPolicy under it.
...
[Remove-IntersightMemoryPolicy](./Remove-IntersightMemoryPolicy.md)
