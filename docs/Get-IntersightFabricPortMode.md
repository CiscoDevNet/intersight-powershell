...
# Get-IntersightFabricPortMode

## SYNOPSIS
Get the FabricPortMode

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricPortMode [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricPortMode [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricPortMode&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricPortMode
```
Above example returns the list of FabricPortMode.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricPortMode -Name "MoName"
```
Above example returns the FabricPortMode matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricPortMode -Organization $organization
```
Above example returns the list of FabricPortMode available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricPortMode -InlineCount allpages
```
Above example returns the list of FabricPortMode along with count.
...
### -Name
Specifies the name of the FabricPortMode.
...
### -Organization
Specifies the organization, to fetch the FabricPortMode under it.
