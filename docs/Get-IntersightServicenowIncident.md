...
# Get-IntersightServicenowIncident

## SYNOPSIS
Get the ServicenowIncident

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightServicenowIncident [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightServicenowIncident [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ServicenowIncident&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightServicenowIncident
```
Above example returns the list of ServicenowIncident.

### Example 2
```powershell
PS C:\> $result = Get-IntersightServicenowIncident -Name "MoName"
```
Above example returns the ServicenowIncident matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightServicenowIncident -Organization $organization
```
Above example returns the list of ServicenowIncident available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightServicenowIncident -InlineCount allpages
```
Above example returns the list of ServicenowIncident along with count.
...
### -Name
Specifies the name of the ServicenowIncident.
...
### -Organization
Specifies the organization, to fetch the ServicenowIncident under it.
