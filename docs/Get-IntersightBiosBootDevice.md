...
# Get-IntersightBiosBootDevice

## SYNOPSIS
Get the BiosBootDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBiosBootDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBiosBootDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;BiosBootDevice&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBiosBootDevice
```
Above example returns the list of BiosBootDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBiosBootDevice -Name "MoName"
```
Above example returns the BiosBootDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBiosBootDevice -Organization $organization
```
Above example returns the list of BiosBootDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBiosBootDevice -InlineCount allpages
```
Above example returns the list of BiosBootDevice along with count.
...
### -Name
Specifies the name of the BiosBootDevice.
...
### -Organization
Specifies the organization, to fetch the BiosBootDevice under it.
