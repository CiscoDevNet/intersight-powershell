...
# Get-IntersightManagementController

## SYNOPSIS
Get the ManagementController

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightManagementController [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightManagementController [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;ManagementController&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightManagementController
```
Above example returns the list of ManagementController.

### Example 2
```powershell
PS C:\> $result = Get-IntersightManagementController -Name "MoName"
```
Above example returns the ManagementController matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightManagementController -Organization $organization
```
Above example returns the list of ManagementController available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightManagementController -InlineCount allpages
```
Above example returns the list of ManagementController along with count.
...
### -Name
Specifies the name of the ManagementController.
...
### -Organization
Specifies the organization, to fetch the ManagementController under it.
...
[Set-IntersightManagementController](./Set-IntersightManagementController.md)
