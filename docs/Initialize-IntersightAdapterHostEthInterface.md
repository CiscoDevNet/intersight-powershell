...
# Initialize-IntersightAdapterHostEthInterface
...
```yaml
Type: AdapterHostEthInterface.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: AdapterHostEthInterface.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightAdapterHostEthInterface
```
