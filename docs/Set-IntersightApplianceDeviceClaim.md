...
Set-IntersightApplianceDeviceClaim [-AdditionalProperties< Dictionary<string,object>>][-Hostname< string>][-IsRenew< bool>][[-Moid]< string>][-Password< string>][-PlatformType< ApplianceDeviceClaim.PlatformTypeEnum>][-RequestId< string>][-Tags< List<MoTag>>][-Username< string>]
...
### Example 1
```powershell
PS C:\> Set-IntersightApplianceDeviceClaim
```
