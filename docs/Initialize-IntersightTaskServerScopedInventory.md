...
# Initialize-IntersightTaskServerScopedInventory
...
```yaml
Type: TaskServerScopedInventory.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TaskServerScopedInventory.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTaskServerScopedInventory
```
