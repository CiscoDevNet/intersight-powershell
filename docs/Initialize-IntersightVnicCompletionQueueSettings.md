...
Initialize-IntersightVnicCompletionQueueSettings [-AdditionalProperties< Dictionary<string,object>>][-ClassId< VnicCompletionQueueSettings.ClassIdEnum>][-Count< long>][-ObjectType< VnicCompletionQueueSettings.ObjectTypeEnum>]
