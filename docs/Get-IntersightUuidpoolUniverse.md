...
# Get-IntersightUuidpoolUniverse

## SYNOPSIS
Get the UuidpoolUniverse

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightUuidpoolUniverse [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightUuidpoolUniverse [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;UuidpoolUniverse&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightUuidpoolUniverse
```
Above example returns the list of UuidpoolUniverse.

### Example 2
```powershell
PS C:\> $result = Get-IntersightUuidpoolUniverse -Name "MoName"
```
Above example returns the UuidpoolUniverse matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightUuidpoolUniverse -Organization $organization
```
Above example returns the list of UuidpoolUniverse available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightUuidpoolUniverse -InlineCount allpages
```
Above example returns the list of UuidpoolUniverse along with count.
...
### -Name
Specifies the name of the UuidpoolUniverse.
...
### -Organization
Specifies the organization, to fetch the UuidpoolUniverse under it.
