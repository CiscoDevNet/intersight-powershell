...
# Initialize-IntersightVnicServiceEthIf
...
Initialize-IntersightVnicServiceEthIf [-AdapterId< string>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< VnicServiceEthIf.ClassIdEnum>][-Moid< string>][-Name< string>][-ObjectType< VnicServiceEthIf.ObjectTypeEnum>][-Placement< Model.VnicPlacementSettings>][-Profile< Model.PolicyAbstractConfigProfileRelationship>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TemplateActions< System.Collections.Generic.List`1[Model.MotemplateActionEntry]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: VnicServiceEthIf.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VnicServiceEthIf.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVnicServiceEthIf
```
