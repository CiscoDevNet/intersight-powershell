...
# Initialize-IntersightSoftwareReleaseMeta
...
Initialize-IntersightSoftwareReleaseMeta [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Catalog< Model.SoftwarerepositoryCatalogRelationship>][-ClassId< SoftwareReleaseMeta.ClassIdEnum>][-ImageType< string>][-LatestFileName< string>][-Moid< string>][-ObjectType< SoftwareReleaseMeta.ObjectTypeEnum>][-SoftwareTypeId< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: SoftwareReleaseMeta.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: SoftwareReleaseMeta.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightSoftwareReleaseMeta
```
