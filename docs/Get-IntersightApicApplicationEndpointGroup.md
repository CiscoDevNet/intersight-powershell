...
# Get-IntersightApicApplicationEndpointGroup

## SYNOPSIS
Get the ApicApplicationEndpointGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApicApplicationEndpointGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApicApplicationEndpointGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApicApplicationEndpointGroup&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApicApplicationEndpointGroup
```
Above example returns the list of ApicApplicationEndpointGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApicApplicationEndpointGroup -Name "MoName"
```
Above example returns the ApicApplicationEndpointGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApicApplicationEndpointGroup -Organization $organization
```
Above example returns the list of ApicApplicationEndpointGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApicApplicationEndpointGroup -InlineCount allpages
```
Above example returns the list of ApicApplicationEndpointGroup along with count.
...
### -Name
Specifies the name of the ApicApplicationEndpointGroup.
...
### -Organization
Specifies the organization, to fetch the ApicApplicationEndpointGroup under it.
