...
# Get-IntersightCapabilityVicDescriptor

## SYNOPSIS
Get the CapabilityVicDescriptor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityVicDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityVicDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilityVicDescriptor&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityVicDescriptor
```
Above example returns the list of CapabilityVicDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityVicDescriptor -Name "MoName"
```
Above example returns the CapabilityVicDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityVicDescriptor -Organization $organization
```
Above example returns the list of CapabilityVicDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityVicDescriptor -InlineCount allpages
```
Above example returns the list of CapabilityVicDescriptor along with count.
...
### -Name
Specifies the name of the CapabilityVicDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilityVicDescriptor under it.
