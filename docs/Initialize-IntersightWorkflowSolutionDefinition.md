...
# Initialize-IntersightWorkflowSolutionDefinition
...
Initialize-IntersightWorkflowSolutionDefinition [-ActionDefinitions< System.Collections.Generic.List`1[Model.WorkflowSolutionActionDefinitionRelationship]>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AllowMultipleSolutionInstances< bool>][-Catalog< Model.WorkflowCatalogRelationship>][-ClassId< WorkflowSolutionDefinition.ClassIdEnum>][-CvdId< string>][-DeleteInstanceOnDecommission< bool>][-Description< string>][-Label< string>][-Moid< string>][-Name< string>][-ObjectType< WorkflowSolutionDefinition.ObjectTypeEnum>][-OutputDefinition< System.Collections.Generic.List`1[Model.WorkflowBaseDataType]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Version< long>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: System.Collections.Generic.List`1[Model.WorkflowSolutionActionDefinitionRelationship]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowSolutionDefinition.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowSolutionDefinition.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowSolutionDefinition
```
