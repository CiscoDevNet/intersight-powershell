...
# Delete a 'meta.Definition' resource.
try {
     $Result = Remove-IntersightMetaDefinition -Moid $Moid
} catch {
...
# Read a 'meta.Definition' resource.
try {
     $Result = Get-IntersightMetaDefinitionByMoid -Moid $Moid
} catch {
...
# Read a 'meta.Definition' resource.
try {
     $Result = Get-IntersightMetaDefinitionList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
