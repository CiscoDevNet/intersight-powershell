# Intersight.Intersight/Api.IntersightMetaApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Remove-IntersightMetaDefinition**](IntersightMetaApi.md#Remove-IntersightMetaDefinition) | **DELETE** /api/v1/meta/Definitions/{Moid} | Delete a &#39;meta.Definition&#39; resource.
[**Get-IntersightMetaDefinitionByMoid**](IntersightMetaApi.md#Get-IntersightMetaDefinitionByMoid) | **GET** /api/v1/meta/Definitions/{Moid} | Read a &#39;meta.Definition&#39; resource.
[**Get-IntersightMetaDefinitionList**](IntersightMetaApi.md#Get-IntersightMetaDefinitionList) | **GET** /api/v1/meta/Definitions | Read a &#39;meta.Definition&#39; resource.


<a name="Remove-IntersightMetaDefinition"></a>
# **Remove-IntersightMetaDefinition**
> void Remove-IntersightMetaDefinition<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'meta.Definition' resource.
try {
    Remove-IntersightMetaDefinition -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightMetaDefinition: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a name="Get-IntersightMetaDefinitionByMoid"></a>
# **Get-IntersightMetaDefinitionByMoid**
> MetaDefinition Get-IntersightMetaDefinitionByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'meta.Definition' resource.
try {
    MetaDefinition $Result = Get-IntersightMetaDefinitionByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMetaDefinitionByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMetaDefinitionList"></a>
# **Get-IntersightMetaDefinitionList**
> MetaDefinitionResponse Get-IntersightMetaDefinitionList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'meta.Definition' resource.
try {
    MetaDefinitionResponse $Result = Get-IntersightMetaDefinitionList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMetaDefinitionList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
