...
## SYNOPSIS
Get the StorageNetAppFcPortEvent

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppFcPortEvent [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppFcPortEvent [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppFcPortEvent&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcPortEvent
```
Above example returns the list of StorageNetAppFcPortEvent.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcPortEvent -Name "MoName"
```
Above example returns the StorageNetAppFcPortEvent matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcPortEvent -Organization $organization
```
Above example returns the list of StorageNetAppFcPortEvent available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcPortEvent -InlineCount allpages
```
Above example returns the list of StorageNetAppFcPortEvent along with count.
...
### -Name
Specifies the name of the StorageNetAppFcPortEvent.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppFcPortEvent under it.
