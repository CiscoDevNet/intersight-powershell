...
# Get-IntersightSdaaciConnection

## SYNOPSIS
Get the SdaaciConnection

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSdaaciConnection [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSdaaciConnection [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SdaaciConnection&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSdaaciConnection
```
Above example returns the list of SdaaciConnection.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSdaaciConnection -Name "MoName"
```
Above example returns the SdaaciConnection matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSdaaciConnection -Organization $organization
```
Above example returns the list of SdaaciConnection available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSdaaciConnection -InlineCount allpages
```
Above example returns the list of SdaaciConnection along with count.
...
### -Name
Specifies the name of the SdaaciConnection.
...
### -Organization
Specifies the organization, to fetch the SdaaciConnection under it.
...
[Remove-IntersightSdaaciConnection](./Remove-IntersightSdaaciConnection.md)
