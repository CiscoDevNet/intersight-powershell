...
## SYNOPSIS
Get the WorkflowTaskMetadata

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowTaskMetadata [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowTaskMetadata [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowTaskMetadata&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskMetadata
```
Above example returns the list of WorkflowTaskMetadata.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskMetadata -Name "MoName"
```
Above example returns the WorkflowTaskMetadata matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskMetadata -Organization $organization
```
Above example returns the list of WorkflowTaskMetadata available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskMetadata -InlineCount allpages
```
Above example returns the list of WorkflowTaskMetadata along with count.
...
### -Name
Specifies the name of the WorkflowTaskMetadata.
...
### -Organization
Specifies the organization, to fetch the WorkflowTaskMetadata under it.
