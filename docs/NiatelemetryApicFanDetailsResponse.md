...
```powershell
$NiatelemetryApicFanDetailsResponse = Initialize-IntersightNiatelemetryApicFanDetailsResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiatelemetryApicFanDetailsResponse | ConvertTo-JSON
```
