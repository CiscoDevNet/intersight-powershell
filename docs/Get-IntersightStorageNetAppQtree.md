...
# Get-IntersightStorageNetAppQtree

## SYNOPSIS
Get the StorageNetAppQtree

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppQtree [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppQtree [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppQtree&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppQtree
```
Above example returns the list of StorageNetAppQtree.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppQtree -Name "MoName"
```
Above example returns the StorageNetAppQtree matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppQtree -Organization $organization
```
Above example returns the list of StorageNetAppQtree available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppQtree -InlineCount allpages
```
Above example returns the list of StorageNetAppQtree along with count.
...
### -Name
Specifies the name of the StorageNetAppQtree.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppQtree under it.
