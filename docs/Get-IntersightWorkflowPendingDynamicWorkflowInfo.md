...
## SYNOPSIS
Get the WorkflowPendingDynamicWorkflowInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowPendingDynamicWorkflowInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowPendingDynamicWorkflowInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;WorkflowPendingDynamicWorkflowInfo&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowPendingDynamicWorkflowInfo
```
Above example returns the list of WorkflowPendingDynamicWorkflowInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowPendingDynamicWorkflowInfo -Name "MoName"
```
Above example returns the WorkflowPendingDynamicWorkflowInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowPendingDynamicWorkflowInfo -Organization $organization
```
Above example returns the list of WorkflowPendingDynamicWorkflowInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowPendingDynamicWorkflowInfo -InlineCount allpages
```
Above example returns the list of WorkflowPendingDynamicWorkflowInfo along with count.
...
### -Name
Specifies the name of the WorkflowPendingDynamicWorkflowInfo.
...
### -Organization
Specifies the organization, to fetch the WorkflowPendingDynamicWorkflowInfo under it.
