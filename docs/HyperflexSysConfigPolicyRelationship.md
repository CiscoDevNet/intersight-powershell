...
```powershell
$HyperflexSysConfigPolicyRelationship = Initialize-IntersightHyperflexSysConfigPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexSysConfigPolicyRelationship | ConvertTo-JSON
```
