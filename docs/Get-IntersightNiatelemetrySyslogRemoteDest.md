...
## SYNOPSIS
Get the NiatelemetrySyslogRemoteDest

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetrySyslogRemoteDest [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetrySyslogRemoteDest [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetrySyslogRemoteDest&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySyslogRemoteDest
```
Above example returns the list of NiatelemetrySyslogRemoteDest.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySyslogRemoteDest -Name "MoName"
```
Above example returns the NiatelemetrySyslogRemoteDest matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySyslogRemoteDest -Organization $organization
```
Above example returns the list of NiatelemetrySyslogRemoteDest available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySyslogRemoteDest -InlineCount allpages
```
Above example returns the list of NiatelemetrySyslogRemoteDest along with count.
...
### -Name
Specifies the name of the NiatelemetrySyslogRemoteDest.
...
### -Organization
Specifies the organization, to fetch the NiatelemetrySyslogRemoteDest under it.
