...
```powershell
$StoragePhysicalDiskExtensionResponse = Initialize-IntersightStoragePhysicalDiskExtensionResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StoragePhysicalDiskExtensionResponse | ConvertTo-JSON
```
