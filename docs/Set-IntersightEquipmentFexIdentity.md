...
Set-IntersightEquipmentFexIdentity [-AdditionalProperties< Dictionary<string,object>>][-AdminAction< EquipmentFexIdentity.AdminActionEnum>][-Fex< EquipmentFexRelationship>][[-Moid]< string>][-NetworkElement< NetworkElementRelationship>][-PhysicalDeviceRegistration< AssetDeviceRegistrationRelationship>][-Tags< List<MoTag>>]
...
### Example 1
```powershell
PS C:\> Set-IntersightEquipmentFexIdentity
```
...
[Get-IntersightEquipmentFexIdentity](./Get-IntersightEquipmentFexIdentity.md)
