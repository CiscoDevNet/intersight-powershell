...
# Initialize-IntersightFirmwareIomDescriptor
...
```yaml
Type: FirmwareIomDescriptor.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FirmwareIomDescriptor.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFirmwareIomDescriptor
```
