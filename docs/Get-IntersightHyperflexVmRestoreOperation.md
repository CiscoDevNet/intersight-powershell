...
## SYNOPSIS
Get the HyperflexVmRestoreOperation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexVmRestoreOperation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexVmRestoreOperation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexVmRestoreOperation&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexVmRestoreOperation
```
Above example returns the list of HyperflexVmRestoreOperation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexVmRestoreOperation -Name "MoName"
```
Above example returns the HyperflexVmRestoreOperation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexVmRestoreOperation -Organization $organization
```
Above example returns the list of HyperflexVmRestoreOperation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexVmRestoreOperation -InlineCount allpages
```
Above example returns the list of HyperflexVmRestoreOperation along with count.
...
### -Name
Specifies the name of the HyperflexVmRestoreOperation.
...
### -Organization
Specifies the organization, to fetch the HyperflexVmRestoreOperation under it.
