...
# Initialize-IntersightFabricVlan
...
```yaml
Type: Model.FabricEthNetworkPolicyRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.FabricMulticastPolicyRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricVlan.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFabricVlan
```
