...
```powershell
$TechsupportmanagementTechSupportStatusResponse = Initialize-IntersightTechsupportmanagementTechSupportStatusResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$TechsupportmanagementTechSupportStatusResponse | ConvertTo-JSON
```
