...
## SYNOPSIS
Get the StorageEnclosureDisk

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageEnclosureDisk [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageEnclosureDisk [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageEnclosureDisk&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageEnclosureDisk
```
Above example returns the list of StorageEnclosureDisk.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageEnclosureDisk -Name "MoName"
```
Above example returns the StorageEnclosureDisk matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageEnclosureDisk -Organization $organization
```
Above example returns the list of StorageEnclosureDisk available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageEnclosureDisk -InlineCount allpages
```
Above example returns the list of StorageEnclosureDisk along with count.
...
### -Name
Specifies the name of the StorageEnclosureDisk.
...
### -Organization
Specifies the organization, to fetch the StorageEnclosureDisk under it.
...
[Set-IntersightStorageEnclosureDisk](./Set-IntersightStorageEnclosureDisk.md)
