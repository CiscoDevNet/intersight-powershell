...
New-IntersightFunctionsUpload [-Action< FunctionsUpload.ActionEnum>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Description< string>][-FileName< string>][-FileSize< long>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-PartSize< long>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;FunctionsUpload&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightFunctionsUpload
```
