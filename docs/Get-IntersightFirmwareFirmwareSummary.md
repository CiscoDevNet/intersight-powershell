...
## SYNOPSIS
Get the FirmwareFirmwareSummary

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareFirmwareSummary [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareFirmwareSummary [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;FirmwareFirmwareSummary&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareFirmwareSummary
```
Above example returns the list of FirmwareFirmwareSummary.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareFirmwareSummary -Name "MoName"
```
Above example returns the FirmwareFirmwareSummary matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareFirmwareSummary -Organization $organization
```
Above example returns the list of FirmwareFirmwareSummary available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareFirmwareSummary -InlineCount allpages
```
Above example returns the list of FirmwareFirmwareSummary along with count.
...
### -Name
Specifies the name of the FirmwareFirmwareSummary.
...
### -Organization
Specifies the organization, to fetch the FirmwareFirmwareSummary under it.
