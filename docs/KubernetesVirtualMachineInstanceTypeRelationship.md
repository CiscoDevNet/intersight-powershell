...
```powershell
$KubernetesVirtualMachineInstanceTypeRelationship = Initialize-IntersightKubernetesVirtualMachineInstanceTypeRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$KubernetesVirtualMachineInstanceTypeRelationship | ConvertTo-JSON
```
