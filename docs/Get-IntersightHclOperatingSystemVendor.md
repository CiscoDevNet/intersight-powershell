...
## SYNOPSIS
Get the HclOperatingSystemVendor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHclOperatingSystemVendor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHclOperatingSystemVendor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;HclOperatingSystemVendor&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHclOperatingSystemVendor
```
Above example returns the list of HclOperatingSystemVendor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHclOperatingSystemVendor -Name "MoName"
```
Above example returns the HclOperatingSystemVendor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHclOperatingSystemVendor -Organization $organization
```
Above example returns the list of HclOperatingSystemVendor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHclOperatingSystemVendor -InlineCount allpages
```
Above example returns the list of HclOperatingSystemVendor along with count.
...
### -Name
Specifies the name of the HclOperatingSystemVendor.
...
### -Organization
Specifies the organization, to fetch the HclOperatingSystemVendor under it.
