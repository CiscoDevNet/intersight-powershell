...
### CmdletParam (Default)
```
Get-IntersightEquipmentChassis [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentChassis [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentChassis
```
Above example returns the list of EquipmentChassis.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentChassis -Name "MoName"
```
Above example returns the EquipmentChassis matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentChassis -Organization $organization
```
Above example returns the list of EquipmentChassis available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentChassis -InlineCount allpages
```
Above example returns the list of EquipmentChassis along with count.
...
### -Name
Specifies the name of the EquipmentChassis.
...
### -Organization
Specifies the organization, to fetch the EquipmentChassis under it.
...
[Set-IntersightEquipmentChassis](./Set-IntersightEquipmentChassis.md)
