...
# Get-IntersightCatalystsdwanInterface

## SYNOPSIS
Get the CatalystsdwanInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCatalystsdwanInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCatalystsdwanInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CatalystsdwanInterface&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanInterface
```
Above example returns the list of CatalystsdwanInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanInterface -Name "MoName"
```
Above example returns the CatalystsdwanInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanInterface -Organization $organization
```
Above example returns the list of CatalystsdwanInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanInterface -InlineCount allpages
```
Above example returns the list of CatalystsdwanInterface along with count.
...
### -Name
Specifies the name of the CatalystsdwanInterface.
...
### -Organization
Specifies the organization, to fetch the CatalystsdwanInterface under it.
