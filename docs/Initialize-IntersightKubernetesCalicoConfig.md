...
```yaml
Type: KubernetesCalicoConfig.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
### -IpVersion
IP version that can take on values v4 or v6.\n* `v4` - This refers to the IPv4 address.\n* `v6` - This refers to the IPv6 address.

```yaml
Type: KubernetesCalicoConfig.IpVersionEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightKubernetesCalicoConfig
```
