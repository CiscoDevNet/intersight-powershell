...
# Initialize-IntersightWorkflowPowerShellApi
...
Initialize-IntersightWorkflowPowerShellApi [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Body< string>][-ClassId< WorkflowPowerShellApi.ClassIdEnum>][-ContentType< string>][-Depth< long>][-Description< string>][-ErrorContentType< string>][-Label< string>][-Name< string>][-ObjectType< WorkflowPowerShellApi.ObjectTypeEnum>][-OperationTimeout< string>][-Outcomes< object>][-PowerShellResponseSpec< object>][-ResponseSpec< object>][-SkipOnCondition< string>][-StartDelay< long>][-Timeout< long>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowPowerShellApi.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowPowerShellApi.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowPowerShellApi
```
