...
```powershell
$NiaapiApicReleaseRecommendResponse = Initialize-IntersightNiaapiApicReleaseRecommendResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiaapiApicReleaseRecommendResponse | ConvertTo-JSON
```
