...
New-IntersightCapabilityFanModuleManufacturingDef [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Caption< string>][-Description< string>][-Moid< string>][[-Name]< string>][-Pid< string>][-ProductName< string>][-Sku< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Vid< string>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
