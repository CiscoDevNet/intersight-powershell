...
# Create a 'uuidpool.Pool' resource.
try {
     $Result = New-IntersightUuidpoolPool -UuidpoolPool $UuidpoolPool -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
...
# Delete a 'uuidpool.Pool' resource.
try {
     $Result = Remove-IntersightUuidpoolPool -Moid $Moid
} catch {
...
# Read a 'uuidpool.Block' resource.
try {
     $Result = Get-IntersightUuidpoolBlockByMoid -Moid $Moid
} catch {
...
# Read a 'uuidpool.Block' resource.
try {
     $Result = Get-IntersightUuidpoolBlockList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'uuidpool.Pool' resource.
try {
     $Result = Get-IntersightUuidpoolPoolByMoid -Moid $Moid
} catch {
...
# Read a 'uuidpool.Pool' resource.
try {
     $Result = Get-IntersightUuidpoolPoolList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'uuidpool.PoolMember' resource.
try {
     $Result = Get-IntersightUuidpoolPoolMemberByMoid -Moid $Moid
} catch {
...
# Read a 'uuidpool.PoolMember' resource.
try {
     $Result = Get-IntersightUuidpoolPoolMemberList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'uuidpool.Universe' resource.
try {
     $Result = Get-IntersightUuidpoolUniverseByMoid -Moid $Moid
} catch {
...
# Read a 'uuidpool.Universe' resource.
try {
     $Result = Get-IntersightUuidpoolUniverseList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'uuidpool.UuidLease' resource.
try {
     $Result = Get-IntersightUuidpoolUuidLeaseByMoid -Moid $Moid
} catch {
...
# Read a 'uuidpool.UuidLease' resource.
try {
     $Result = Get-IntersightUuidpoolUuidLeaseList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Update a 'uuidpool.Pool' resource.
try {
     $Result = Set-IntersightUuidpoolPool -Moid $Moid -UuidpoolPool $UuidpoolPool -IfMatch $IfMatch
} catch {
...
# Update a 'uuidpool.Pool' resource.
try {
     $Result = Update-IntersightUuidpoolPool -Moid $Moid -UuidpoolPool $UuidpoolPool -IfMatch $IfMatch
} catch {
