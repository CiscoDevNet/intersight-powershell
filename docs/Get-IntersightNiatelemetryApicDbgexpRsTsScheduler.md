...
## SYNOPSIS
Get the NiatelemetryApicDbgexpRsTsScheduler

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicDbgexpRsTsScheduler [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicDbgexpRsTsScheduler [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicDbgexpRsTsScheduler
```
Above example returns the list of NiatelemetryApicDbgexpRsTsScheduler.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicDbgexpRsTsScheduler -Name "MoName"
```
Above example returns the NiatelemetryApicDbgexpRsTsScheduler matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicDbgexpRsTsScheduler -Organization $organization
```
Above example returns the list of NiatelemetryApicDbgexpRsTsScheduler available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicDbgexpRsTsScheduler -InlineCount allpages
```
Above example returns the list of NiatelemetryApicDbgexpRsTsScheduler along with count.
...
### -Name
Specifies the name of the NiatelemetryApicDbgexpRsTsScheduler.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicDbgexpRsTsScheduler under it.
