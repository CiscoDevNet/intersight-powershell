...
```powershell
$CapabilityEquipmentPhysicalDefList = Initialize-IntersightCapabilityEquipmentPhysicalDefList  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilityEquipmentPhysicalDefList | ConvertTo-JSON
```
