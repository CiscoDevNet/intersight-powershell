...
```powershell
$SoftwareSolutionDistributableResponse = Initialize-IntersightSoftwareSolutionDistributableResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwareSolutionDistributableResponse | ConvertTo-JSON
```
