...
# Get-IntersightBootSdDevice

## SYNOPSIS
Get the BootSdDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBootSdDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBootSdDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBootSdDevice
```
Above example returns the list of BootSdDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBootSdDevice -Name "MoName"
```
Above example returns the BootSdDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBootSdDevice -Organization $organization
```
Above example returns the list of BootSdDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBootSdDevice -InlineCount allpages
```
Above example returns the list of BootSdDevice along with count.
...
### -Name
Specifies the name of the BootSdDevice.
...
### -Organization
Specifies the organization, to fetch the BootSdDevice under it.
...
[Set-IntersightBootSdDevice](./Set-IntersightBootSdDevice.md)
