...
# Get-IntersightSdwanVmanageAccountPolicy

## SYNOPSIS
Get the SdwanVmanageAccountPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSdwanVmanageAccountPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSdwanVmanageAccountPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SdwanVmanageAccountPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSdwanVmanageAccountPolicy
```
Above example returns the list of SdwanVmanageAccountPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSdwanVmanageAccountPolicy -Name "MoName"
```
Above example returns the SdwanVmanageAccountPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSdwanVmanageAccountPolicy -Organization $organization
```
Above example returns the list of SdwanVmanageAccountPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSdwanVmanageAccountPolicy -InlineCount allpages
```
Above example returns the list of SdwanVmanageAccountPolicy along with count.
...
### -Name
Specifies the name of the SdwanVmanageAccountPolicy.
...
### -Organization
Specifies the organization, to fetch the SdwanVmanageAccountPolicy under it.
