...
Initialize-IntersightComputeStorageControllerOperation [-AdditionalProperties< Dictionary<string,object>>][-AdminAction< ComputeStorageControllerOperation.AdminActionEnum>][-ClassId< ComputeStorageControllerOperation.ClassIdEnum>][-ControllerId< string>][-ObjectType< ComputeStorageControllerOperation.ObjectTypeEnum>]
...
```yaml
Type: ComputeStorageControllerOperation.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightComputeStorageControllerOperation
```
