...
## SYNOPSIS
Get the HyperflexDataProtectionPeer

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexDataProtectionPeer [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexDataProtectionPeer [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexDataProtectionPeer&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexDataProtectionPeer
```
Above example returns the list of HyperflexDataProtectionPeer.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexDataProtectionPeer -Name "MoName"
```
Above example returns the HyperflexDataProtectionPeer matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexDataProtectionPeer -Organization $organization
```
Above example returns the list of HyperflexDataProtectionPeer available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexDataProtectionPeer -InlineCount allpages
```
Above example returns the list of HyperflexDataProtectionPeer along with count.
...
### -Name
Specifies the name of the HyperflexDataProtectionPeer.
...
### -Organization
Specifies the organization, to fetch the HyperflexDataProtectionPeer under it.
