...
## SYNOPSIS
Get the NiatelemetryFabricPodProfile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryFabricPodProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryFabricPodProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryFabricPodProfile&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricPodProfile
```
Above example returns the list of NiatelemetryFabricPodProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricPodProfile -Name "MoName"
```
Above example returns the NiatelemetryFabricPodProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricPodProfile -Organization $organization
```
Above example returns the list of NiatelemetryFabricPodProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricPodProfile -InlineCount allpages
```
Above example returns the list of NiatelemetryFabricPodProfile along with count.
...
### -Name
Specifies the name of the NiatelemetryFabricPodProfile.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryFabricPodProfile under it.
