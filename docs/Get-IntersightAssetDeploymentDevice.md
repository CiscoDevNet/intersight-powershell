...
## SYNOPSIS
Get the AssetDeploymentDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAssetDeploymentDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAssetDeploymentDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAssetDeploymentDevice
```
Above example returns the list of AssetDeploymentDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAssetDeploymentDevice -Name "MoName"
```
Above example returns the AssetDeploymentDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAssetDeploymentDevice -Organization $organization
```
Above example returns the list of AssetDeploymentDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAssetDeploymentDevice -InlineCount allpages
```
Above example returns the list of AssetDeploymentDevice along with count.
...
### -Name
Specifies the name of the AssetDeploymentDevice.
...
### -Organization
Specifies the organization, to fetch the AssetDeploymentDevice under it.
...
[Remove-IntersightAssetDeploymentDevice](./Remove-IntersightAssetDeploymentDevice.md)
