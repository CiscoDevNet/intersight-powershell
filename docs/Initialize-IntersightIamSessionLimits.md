...
# Initialize-IntersightIamSessionLimits
...
Initialize-IntersightIamSessionLimits [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< IamSessionLimits.ClassIdEnum>][-IdleTimeOut< long>][-MaximumLimit< long>][-Moid< string>][-ObjectType< IamSessionLimits.ObjectTypeEnum>][-PerUserLimit< long>][-Permission< Model.IamPermissionRelationship>][-SessionTimeOut< long>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: IamSessionLimits.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IamSessionLimits.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIamSessionLimits
```
