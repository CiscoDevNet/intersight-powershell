...
# Get-IntersightHyperflexCiscoHypervisorManager

## SYNOPSIS
Get the HyperflexCiscoHypervisorManager

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexCiscoHypervisorManager [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexCiscoHypervisorManager [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexCiscoHypervisorManager
```
Above example returns the list of HyperflexCiscoHypervisorManager.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexCiscoHypervisorManager -Name "MoName"
```
Above example returns the HyperflexCiscoHypervisorManager matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexCiscoHypervisorManager -Organization $organization
```
Above example returns the list of HyperflexCiscoHypervisorManager available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexCiscoHypervisorManager -InlineCount allpages
```
Above example returns the list of HyperflexCiscoHypervisorManager along with count.
...
### -Name
Specifies the name of the HyperflexCiscoHypervisorManager.
...
### -Organization
Specifies the organization, to fetch the HyperflexCiscoHypervisorManager under it.
...
[New-IntersightHyperflexCiscoHypervisorManager](./New-IntersightHyperflexCiscoHypervisorManager.md)
