...
# Get-IntersightEquipmentEnclosureElement

## SYNOPSIS
Get the EquipmentEnclosureElement

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentEnclosureElement [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentEnclosureElement [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentEnclosureElement&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentEnclosureElement
```
Above example returns the list of EquipmentEnclosureElement.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentEnclosureElement -Name "MoName"
```
Above example returns the EquipmentEnclosureElement matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentEnclosureElement -Organization $organization
```
Above example returns the list of EquipmentEnclosureElement available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentEnclosureElement -InlineCount allpages
```
Above example returns the list of EquipmentEnclosureElement along with count.
...
### -Name
Specifies the name of the EquipmentEnclosureElement.
...
### -Organization
Specifies the organization, to fetch the EquipmentEnclosureElement under it.
...
[Set-IntersightEquipmentEnclosureElement](./Set-IntersightEquipmentEnclosureElement.md)
