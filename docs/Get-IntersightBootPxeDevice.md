...
# Get-IntersightBootPxeDevice

## SYNOPSIS
Get the BootPxeDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBootPxeDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBootPxeDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBootPxeDevice
```
Above example returns the list of BootPxeDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBootPxeDevice -Name "MoName"
```
Above example returns the BootPxeDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBootPxeDevice -Organization $organization
```
Above example returns the list of BootPxeDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBootPxeDevice -InlineCount allpages
```
Above example returns the list of BootPxeDevice along with count.
...
### -Name
Specifies the name of the BootPxeDevice.
...
### -Organization
Specifies the organization, to fetch the BootPxeDevice under it.
...
[Set-IntersightBootPxeDevice](./Set-IntersightBootPxeDevice.md)
