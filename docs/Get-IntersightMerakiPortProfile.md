...
# Get-IntersightMerakiPortProfile

## SYNOPSIS
Get the MerakiPortProfile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMerakiPortProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMerakiPortProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MerakiPortProfile&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMerakiPortProfile
```
Above example returns the list of MerakiPortProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMerakiPortProfile -Name "MoName"
```
Above example returns the MerakiPortProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMerakiPortProfile -Organization $organization
```
Above example returns the list of MerakiPortProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMerakiPortProfile -InlineCount allpages
```
Above example returns the list of MerakiPortProfile along with count.
...
### -Name
Specifies the name of the MerakiPortProfile.
...
### -Organization
Specifies the organization, to fetch the MerakiPortProfile under it.
