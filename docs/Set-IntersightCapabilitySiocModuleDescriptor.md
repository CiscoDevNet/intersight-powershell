...
Set-IntersightCapabilitySiocModuleDescriptor [-AdditionalProperties< Dictionary<string,object>>][-Capabilities< List<CapabilityCapabilityRelationship>>][-Description< string>][-Model< string>][[-Moid]< string>][-Revision< string>][-Tags< List<MoTag>>][-Vendor< string>][-Version< string>]
...
### Example 1
```powershell
PS C:\> Set-IntersightCapabilitySiocModuleDescriptor
```
