...
# Initialize-IntersightVnicLanConnectivityPolicy
...
Initialize-IntersightVnicLanConnectivityPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AzureQosEnabled< bool>][-ClassId< VnicLanConnectivityPolicy.ClassIdEnum>][-Description< string>][-EthIfs< System.Collections.Generic.List`1[Model.VnicEthIfRelationship]>][-IqnAllocationType< VnicLanConnectivityPolicy.IqnAllocationTypeEnum>][-IqnPool< Model.IqnpoolPoolRelationship>][-Moid< string>][-Name< string>][-ObjectType< VnicLanConnectivityPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-PlacementMode< VnicLanConnectivityPolicy.PlacementModeEnum>][-Profiles< System.Collections.Generic.List`1[Model.PolicyAbstractConfigProfileRelationship]>][-StaticIqnName< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TargetPlatform< VnicLanConnectivityPolicy.TargetPlatformEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: VnicLanConnectivityPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.VnicEthIfRelationship]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VnicLanConnectivityPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVnicLanConnectivityPolicy
```
