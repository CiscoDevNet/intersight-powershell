...
# Get-IntersightEquipmentTpm

## SYNOPSIS
Get the EquipmentTpm

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentTpm [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentTpm [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentTpm&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentTpm
```
Above example returns the list of EquipmentTpm.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentTpm -Name "MoName"
```
Above example returns the EquipmentTpm matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentTpm -Organization $organization
```
Above example returns the list of EquipmentTpm available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentTpm -InlineCount allpages
```
Above example returns the list of EquipmentTpm along with count.
...
### -Name
Specifies the name of the EquipmentTpm.
...
### -Organization
Specifies the organization, to fetch the EquipmentTpm under it.
...
[Set-IntersightEquipmentTpm](./Set-IntersightEquipmentTpm.md)
