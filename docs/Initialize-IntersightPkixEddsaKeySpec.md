...
Initialize-IntersightPkixEddsaKeySpec [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Algorithm< PkixEddsaKeySpec.AlgorithmEnum>][-ClassId< PkixEddsaKeySpec.ClassIdEnum>][-ObjectType< PkixEddsaKeySpec.ObjectTypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
