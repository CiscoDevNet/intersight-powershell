...
### CmdletParam (Default)
```
Get-IntersightIamRole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamRole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamRole
```
Above example returns the list of IamRole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamRole -Name "MoName"
```
Above example returns the IamRole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamRole -Organization $organization
```
Above example returns the list of IamRole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamRole -InlineCount allpages
```
Above example returns the list of IamRole along with count.
...
### -Name
Specifies the name of the IamRole.
...
### -Organization
Specifies the organization, to fetch the IamRole under it.
