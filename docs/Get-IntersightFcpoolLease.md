...
### CmdletParam (Default)
```
Get-IntersightFcpoolLease [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFcpoolLease [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FcpoolLease&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFcpoolLease
```
Above example returns the list of FcpoolLease.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFcpoolLease -Name "MoName"
```
Above example returns the FcpoolLease matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFcpoolLease -Organization $organization
```
Above example returns the list of FcpoolLease available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFcpoolLease -InlineCount allpages
```
Above example returns the list of FcpoolLease along with count.
...
### -Name
Specifies the name of the FcpoolLease.
...
### -Organization
Specifies the organization, to fetch the FcpoolLease under it.
...
[Remove-IntersightFcpoolLease](./Remove-IntersightFcpoolLease.md)
