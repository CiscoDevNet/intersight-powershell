...
```powershell
$HyperflexExtIscsiStoragePolicyResponse = Initialize-IntersightHyperflexExtIscsiStoragePolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexExtIscsiStoragePolicyResponse | ConvertTo-JSON
```
