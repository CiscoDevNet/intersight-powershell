...
# Initialize-IntersightIamLocalUserPassword
...
```yaml
Type: IamLocalUserPassword.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IamLocalUserPassword.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIamLocalUserPassword
```
