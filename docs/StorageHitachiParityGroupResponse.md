...
```powershell
$StorageHitachiParityGroupResponse = Initialize-IntersightStorageHitachiParityGroupResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageHitachiParityGroupResponse | ConvertTo-JSON
```
