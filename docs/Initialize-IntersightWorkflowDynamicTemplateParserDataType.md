...
# Initialize-IntersightWorkflowDynamicTemplateParserDataType
...
Initialize-IntersightWorkflowDynamicTemplateParserDataType [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< WorkflowDynamicTemplateParserDataType.ClassIdEnum>][-Default< Model.WorkflowDefaultValue>][-Description< string>][-DisplayMeta< Model.WorkflowDisplayMeta>][-InputParameters< object>][-IsTemplateSecure< bool>][-Label< string>][-Name< string>][-ObjectType< WorkflowDynamicTemplateParserDataType.ObjectTypeEnum>][-Required< bool>][-TemplateType< WorkflowDynamicTemplateParserDataType.TemplateTypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowDynamicTemplateParserDataType.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowDynamicTemplateParserDataType.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### -TemplateType
Template type decides on the API to be used to fetch the placeholders present inside the template.\n* `OsInstall` - This refers to the OS configuration template MO.

```yaml
Type: WorkflowDynamicTemplateParserDataType.TemplateTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowDynamicTemplateParserDataType
```
