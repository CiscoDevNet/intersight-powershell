...
# Get-IntersightHyperflexIscsiNetwork

## SYNOPSIS
Get the HyperflexIscsiNetwork

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexIscsiNetwork [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexIscsiNetwork [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexIscsiNetwork&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexIscsiNetwork
```
Above example returns the list of HyperflexIscsiNetwork.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexIscsiNetwork -Name "MoName"
```
Above example returns the HyperflexIscsiNetwork matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexIscsiNetwork -Organization $organization
```
Above example returns the list of HyperflexIscsiNetwork available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexIscsiNetwork -InlineCount allpages
```
Above example returns the list of HyperflexIscsiNetwork along with count.
...
### -Name
Specifies the name of the HyperflexIscsiNetwork.
...
### -Organization
Specifies the organization, to fetch the HyperflexIscsiNetwork under it.
...
[Set-IntersightHyperflexIscsiNetwork](./Set-IntersightHyperflexIscsiNetwork.md)
