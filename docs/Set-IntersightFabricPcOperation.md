...
Set-IntersightFabricPcOperation [-AdditionalProperties< Dictionary<string,object>>][-AdminState< FabricPcOperation.AdminStateEnum>][-ConfigState< FabricPcOperation.ConfigStateEnum>][[-Moid]< string>][-NetworkElement< NetworkElementRelationship>][-PcId< long>][-Tags< List<MoTag>>]
...
### Example 1
```powershell
PS C:\> Set-IntersightFabricPcOperation
```
