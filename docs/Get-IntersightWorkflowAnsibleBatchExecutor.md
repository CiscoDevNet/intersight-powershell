...
## SYNOPSIS
Get the WorkflowAnsibleBatchExecutor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowAnsibleBatchExecutor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowAnsibleBatchExecutor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowAnsibleBatchExecutor
```
Above example returns the list of WorkflowAnsibleBatchExecutor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowAnsibleBatchExecutor -Name "MoName"
```
Above example returns the WorkflowAnsibleBatchExecutor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowAnsibleBatchExecutor -Organization $organization
```
Above example returns the list of WorkflowAnsibleBatchExecutor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowAnsibleBatchExecutor -InlineCount allpages
```
Above example returns the list of WorkflowAnsibleBatchExecutor along with count.
...
### -Name
Specifies the name of the WorkflowAnsibleBatchExecutor.
...
### -Organization
Specifies the organization, to fetch the WorkflowAnsibleBatchExecutor under it.
