...
## SYNOPSIS
Get the NiatelemetryFault

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryFault [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryFault [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetryFault&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFault
```
Above example returns the list of NiatelemetryFault.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFault -Name "MoName"
```
Above example returns the NiatelemetryFault matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFault -Organization $organization
```
Above example returns the list of NiatelemetryFault available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFault -InlineCount allpages
```
Above example returns the list of NiatelemetryFault along with count.
...
### -Name
Specifies the name of the NiatelemetryFault.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryFault under it.
