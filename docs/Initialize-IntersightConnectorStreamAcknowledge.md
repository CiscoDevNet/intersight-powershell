...
Initialize-IntersightConnectorStreamAcknowledge [-AckSequence< long>][-AdditionalProperties< Dictionary<string,object>>][-ClassId< ConnectorStreamAcknowledge.ClassIdEnum>][-EncryptedAesKey< string>][-EncryptionKey< string>][-ObjectType< ConnectorStreamAcknowledge.ObjectTypeEnum>][-SecureProperties< object>][-StreamName< string>]
