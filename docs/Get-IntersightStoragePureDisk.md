...
# Get-IntersightStoragePureDisk

## SYNOPSIS
Get the StoragePureDisk

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureDisk [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureDisk [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureDisk&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureDisk
```
Above example returns the list of StoragePureDisk.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureDisk -Name "MoName"
```
Above example returns the StoragePureDisk matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureDisk -Organization $organization
```
Above example returns the list of StoragePureDisk available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureDisk -InlineCount allpages
```
Above example returns the list of StoragePureDisk along with count.
...
### -Name
Specifies the name of the StoragePureDisk.
...
### -Organization
Specifies the organization, to fetch the StoragePureDisk under it.
