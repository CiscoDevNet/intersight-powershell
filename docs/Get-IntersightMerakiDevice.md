...
# Get-IntersightMerakiDevice

## SYNOPSIS
Get the MerakiDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMerakiDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMerakiDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MerakiDevice&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMerakiDevice
```
Above example returns the list of MerakiDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMerakiDevice -Name "MoName"
```
Above example returns the MerakiDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMerakiDevice -Organization $organization
```
Above example returns the list of MerakiDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMerakiDevice -InlineCount allpages
```
Above example returns the list of MerakiDevice along with count.
...
### -Name
Specifies the name of the MerakiDevice.
...
### -Organization
Specifies the organization, to fetch the MerakiDevice under it.
