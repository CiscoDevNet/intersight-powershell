...
# Get-IntersightStoragePureHostLun

## SYNOPSIS
Get the StoragePureHostLun

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureHostLun [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureHostLun [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StoragePureHostLun&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureHostLun
```
Above example returns the list of StoragePureHostLun.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureHostLun -Name "MoName"
```
Above example returns the StoragePureHostLun matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureHostLun -Organization $organization
```
Above example returns the list of StoragePureHostLun available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureHostLun -InlineCount allpages
```
Above example returns the list of StoragePureHostLun along with count.
...
### -Name
Specifies the name of the StoragePureHostLun.
...
### -Organization
Specifies the organization, to fetch the StoragePureHostLun under it.
