...
# Get-IntersightOsValidRemoteTarget

## SYNOPSIS
Get the OsValidRemoteTarget

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOsValidRemoteTarget [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOsValidRemoteTarget [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;OsValidRemoteTarget&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOsValidRemoteTarget
```
Above example returns the list of OsValidRemoteTarget.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOsValidRemoteTarget -Name "MoName"
```
Above example returns the OsValidRemoteTarget matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOsValidRemoteTarget -Organization $organization
```
Above example returns the list of OsValidRemoteTarget available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOsValidRemoteTarget -InlineCount allpages
```
Above example returns the list of OsValidRemoteTarget along with count.
...
### -Name
Specifies the name of the OsValidRemoteTarget.
...
### -Organization
Specifies the organization, to fetch the OsValidRemoteTarget under it.
