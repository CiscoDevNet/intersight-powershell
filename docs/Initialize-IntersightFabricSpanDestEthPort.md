...
# Initialize-IntersightFabricSpanDestEthPort
...
Initialize-IntersightFabricSpanDestEthPort [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AdminSpeed< FabricSpanDestEthPort.AdminSpeedEnum>][-AggregatePortId< long>][-ClassId< FabricSpanDestEthPort.ClassIdEnum>][-Fec< FabricSpanDestEthPort.FecEnum>][-Moid< string>][-ObjectType< FabricSpanDestEthPort.ObjectTypeEnum>][-PortId< long>][-SlotId< long>][-SpanSession< Model.FabricSpanSessionRelationship>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: FabricSpanDestEthPort.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricSpanDestEthPort.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFabricSpanDestEthPort
```
