...
# Initialize-IntersightWorkflowMoInventoryDataType
...
Initialize-IntersightWorkflowMoInventoryDataType [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< WorkflowMoInventoryDataType.ClassIdEnum>][-Default< Model.WorkflowDefaultValue>][-Description< string>][-DisplayMeta< Model.WorkflowDisplayMeta>][-InputParameters< object>][-Label< string>][-Name< string>][-ObjectType< WorkflowMoInventoryDataType.ObjectTypeEnum>][-Properties< System.Collections.Generic.List`1[Model.WorkflowMoInventoryProperty]>][-Required< bool>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowMoInventoryDataType.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowMoInventoryDataType.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
Note :- Use Initialize-IntersightWorkflowMoInventoryProperty to create the object of complex type WorkflowMoInventoryProperty

```yaml
Type: System.Collections.Generic.List`1[Model.WorkflowMoInventoryProperty]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowMoInventoryDataType
```
...
[Initialize-IntersightWorkflowMoInventoryProperty](./Initialize-IntersightWorkflowMoInventoryProperty.md)
