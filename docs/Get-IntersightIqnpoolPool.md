...
### CmdletParam (Default)
```
Get-IntersightIqnpoolPool [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIqnpoolPool [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIqnpoolPool
```
Above example returns the list of IqnpoolPool.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIqnpoolPool -Name "MoName"
```
Above example returns the IqnpoolPool matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIqnpoolPool -Organization $organization
```
Above example returns the list of IqnpoolPool available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIqnpoolPool -InlineCount allpages
```
Above example returns the list of IqnpoolPool along with count.
...
### -Name
Specifies the name of the IqnpoolPool.
...
### -Organization
Specifies the organization, to fetch the IqnpoolPool under it.
