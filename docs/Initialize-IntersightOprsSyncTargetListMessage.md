...
# Initialize-IntersightOprsSyncTargetListMessage
...
Initialize-IntersightOprsSyncTargetListMessage [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Assist< Model.AssetDeviceRegistrationRelationship>][-AssistId< string>][-ClassId< OprsSyncTargetListMessage.ClassIdEnum>][-Moid< string>][-ObjectType< OprsSyncTargetListMessage.ObjectTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TargetType< OprsSyncTargetListMessage.TargetTypeEnum>][-Targets< System.Collections.Generic.List`1[string]>][-TimeStamp< DateTime>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: OprsSyncTargetListMessage.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: OprsSyncTargetListMessage.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightOprsSyncTargetListMessage
```
