...
## SYNOPSIS
Get the SchedulerTaskSchedule

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSchedulerTaskSchedule [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSchedulerTaskSchedule [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SchedulerTaskSchedule&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSchedulerTaskSchedule
```
Above example returns the list of SchedulerTaskSchedule.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSchedulerTaskSchedule -Name "MoName"
```
Above example returns the SchedulerTaskSchedule matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSchedulerTaskSchedule -Organization $organization
```
Above example returns the list of SchedulerTaskSchedule available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSchedulerTaskSchedule -InlineCount allpages
```
Above example returns the list of SchedulerTaskSchedule along with count.
...
### -Name
Specifies the name of the SchedulerTaskSchedule.
...
### -Organization
Specifies the organization, to fetch the SchedulerTaskSchedule under it.
