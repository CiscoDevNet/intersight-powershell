...
### CmdletParam (Default)
```
Get-IntersightApicOut [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApicOut [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApicOut&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApicOut
```
Above example returns the list of ApicOut.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApicOut -Name "MoName"
```
Above example returns the ApicOut matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApicOut -Organization $organization
```
Above example returns the list of ApicOut available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApicOut -InlineCount allpages
```
Above example returns the list of ApicOut along with count.
...
### -Name
Specifies the name of the ApicOut.
...
### -Organization
Specifies the organization, to fetch the ApicOut under it.
