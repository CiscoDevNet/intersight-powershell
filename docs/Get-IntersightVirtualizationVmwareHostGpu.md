...
# Get-IntersightVirtualizationVmwareHostGpu

## SYNOPSIS
Get the VirtualizationVmwareHostGpu

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareHostGpu [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareHostGpu [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareHostGpu&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareHostGpu
```
Above example returns the list of VirtualizationVmwareHostGpu.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareHostGpu -Name "MoName"
```
Above example returns the VirtualizationVmwareHostGpu matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareHostGpu -Organization $organization
```
Above example returns the list of VirtualizationVmwareHostGpu available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareHostGpu -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareHostGpu along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareHostGpu.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareHostGpu under it.
