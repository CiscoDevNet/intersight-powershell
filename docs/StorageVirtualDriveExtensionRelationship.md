...
```powershell
$StorageVirtualDriveExtensionRelationship = Initialize-IntersightStorageVirtualDriveExtensionRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StorageVirtualDriveExtensionRelationship | ConvertTo-JSON
```
