...
# Get-IntersightAdapterUnitExpander

## SYNOPSIS
Get the AdapterUnitExpander

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAdapterUnitExpander [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAdapterUnitExpander [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAdapterUnitExpander
```
Above example returns the list of AdapterUnitExpander.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAdapterUnitExpander -Name "MoName"
```
Above example returns the AdapterUnitExpander matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAdapterUnitExpander -Organization $organization
```
Above example returns the list of AdapterUnitExpander available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAdapterUnitExpander -InlineCount allpages
```
Above example returns the list of AdapterUnitExpander along with count.
...
### -Name
Specifies the name of the AdapterUnitExpander.
...
### -Organization
Specifies the organization, to fetch the AdapterUnitExpander under it.
