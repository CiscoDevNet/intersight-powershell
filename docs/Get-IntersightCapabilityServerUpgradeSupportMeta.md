...
### CmdletParam (Default)
```
Get-IntersightCapabilityServerUpgradeSupportMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityServerUpgradeSupportMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityServerUpgradeSupportMeta
```
Above example returns the list of CapabilityServerUpgradeSupportMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityServerUpgradeSupportMeta -Name "MoName"
```
Above example returns the CapabilityServerUpgradeSupportMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityServerUpgradeSupportMeta -Organization $organization
```
Above example returns the list of CapabilityServerUpgradeSupportMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityServerUpgradeSupportMeta -InlineCount allpages
```
Above example returns the list of CapabilityServerUpgradeSupportMeta along with count.
...
### -Name
Specifies the name of the CapabilityServerUpgradeSupportMeta.
...
### -Organization
Specifies the organization, to fetch the CapabilityServerUpgradeSupportMeta under it.
