...
```powershell
$FirmwareServerConfigurationUtilityDistributableRelationship = Initialize-IntersightFirmwareServerConfigurationUtilityDistributableRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$FirmwareServerConfigurationUtilityDistributableRelationship | ConvertTo-JSON
```
