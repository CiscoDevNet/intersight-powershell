...
```powershell
$EquipmentSystemIoControllerRelationship = Initialize-IntersightEquipmentSystemIoControllerRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$EquipmentSystemIoControllerRelationship | ConvertTo-JSON
```
