...
## SYNOPSIS
Get the NiatelemetryNexusDashboardDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryNexusDashboardDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryNexusDashboardDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryNexusDashboardDetails&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboardDetails
```
Above example returns the list of NiatelemetryNexusDashboardDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboardDetails -Name "MoName"
```
Above example returns the NiatelemetryNexusDashboardDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboardDetails -Organization $organization
```
Above example returns the list of NiatelemetryNexusDashboardDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboardDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryNexusDashboardDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryNexusDashboardDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryNexusDashboardDetails under it.
