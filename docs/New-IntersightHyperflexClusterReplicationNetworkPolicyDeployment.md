...
New-IntersightHyperflexClusterReplicationNetworkPolicyDeployment [-AdditionalProperties< Dictionary<string,object>>][-Cluster< HyperflexClusterRelationship>][-Discovered< bool>][-Moid< string>][-Organization< OrganizationOrganizationRelationship>][-ReplicationIpranges< List<HyperflexIpAddrRange>>][-Tags< List<MoTag>>]
...
### Example 1
```powershell
PS C:\> New-IntersightHyperflexClusterReplicationNetworkPolicyDeployment
```
