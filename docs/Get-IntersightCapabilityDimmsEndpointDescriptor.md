...
### CmdletParam (Default)
```
Get-IntersightCapabilityDimmsEndpointDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityDimmsEndpointDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityDimmsEndpointDescriptor
```
Above example returns the list of CapabilityDimmsEndpointDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityDimmsEndpointDescriptor -Name "MoName"
```
Above example returns the CapabilityDimmsEndpointDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityDimmsEndpointDescriptor -Organization $organization
```
Above example returns the list of CapabilityDimmsEndpointDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityDimmsEndpointDescriptor -InlineCount allpages
```
Above example returns the list of CapabilityDimmsEndpointDescriptor along with count.
...
### -Name
Specifies the name of the CapabilityDimmsEndpointDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilityDimmsEndpointDescriptor under it.
