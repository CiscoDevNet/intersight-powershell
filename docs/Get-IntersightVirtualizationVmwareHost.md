...
## SYNOPSIS
Get the VirtualizationVmwareHost

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareHost [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareHost [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareHost&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareHost
```
Above example returns the list of VirtualizationVmwareHost.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareHost -Name "MoName"
```
Above example returns the VirtualizationVmwareHost matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareHost -Organization $organization
```
Above example returns the list of VirtualizationVmwareHost available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareHost -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareHost along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareHost.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareHost under it.
...
[Set-IntersightVirtualizationVmwareHost](./Set-IntersightVirtualizationVmwareHost.md)
