...
New-IntersightSoftwareReleaseMeta [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Catalog< SoftwarerepositoryCatalogRelationship>][-ImageType< string>][-LatestFileName< string>][-Moid< string>][-SoftwareTypeId< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> New-IntersightSoftwareReleaseMeta
```
