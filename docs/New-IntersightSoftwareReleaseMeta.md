...
New-IntersightSoftwareReleaseMeta [-AdditionalProperties< Dictionary<string,object>>][-Catalog< SoftwarerepositoryCatalogRelationship>][-ImageType< string>][-LatestFileName< string>][-Moid< string>][-SoftwareTypeId< string>][-Tags< List<MoTag>>]
