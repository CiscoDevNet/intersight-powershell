...
## SYNOPSIS
Get the NiatelemetryApicAppPluginDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicAppPluginDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicAppPluginDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicAppPluginDetails
```
Above example returns the list of NiatelemetryApicAppPluginDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicAppPluginDetails -Name "MoName"
```
Above example returns the NiatelemetryApicAppPluginDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicAppPluginDetails -Organization $organization
```
Above example returns the list of NiatelemetryApicAppPluginDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicAppPluginDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryApicAppPluginDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryApicAppPluginDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicAppPluginDetails under it.
