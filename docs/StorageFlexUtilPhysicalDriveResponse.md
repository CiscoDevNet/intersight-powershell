...
```powershell
$StorageFlexUtilPhysicalDriveResponse = Initialize-IntersightStorageFlexUtilPhysicalDriveResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageFlexUtilPhysicalDriveResponse | ConvertTo-JSON
```
