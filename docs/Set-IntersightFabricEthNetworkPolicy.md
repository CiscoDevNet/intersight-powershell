...
Set-IntersightFabricEthNetworkPolicy [-AdditionalProperties< Dictionary<string,object>>][-Description< string>][[-Moid]< string>][-Name< string>][-Organization< OrganizationOrganizationRelationship>][-Profiles< List<FabricSwitchProfileRelationship>>][-Tags< List<MoTag>>]
