...
### CmdletParam (Default)
```
Get-IntersightCapabilityPortGroupAggregationDef [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityPortGroupAggregationDef [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityPortGroupAggregationDef
```
Above example returns the list of CapabilityPortGroupAggregationDef.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityPortGroupAggregationDef -Name "MoName"
```
Above example returns the CapabilityPortGroupAggregationDef matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityPortGroupAggregationDef -Organization $organization
```
Above example returns the list of CapabilityPortGroupAggregationDef available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityPortGroupAggregationDef -InlineCount allpages
```
Above example returns the list of CapabilityPortGroupAggregationDef along with count.
...
### -Name
Specifies the name of the CapabilityPortGroupAggregationDef.
...
### -Organization
Specifies the organization, to fetch the CapabilityPortGroupAggregationDef under it.
