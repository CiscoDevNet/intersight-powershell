...
Initialize-IntersightInventoryInventoryMo [-AdditionalProperties< Dictionary<string,object>>][-ClassId< InventoryInventoryMo.ClassIdEnum>][-MoDn< string>][-MoId< string>][-MoType< string>][-ObjectType< InventoryInventoryMo.ObjectTypeEnum>]
