...
Initialize-IntersightInventoryInventoryMo [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< InventoryInventoryMo.ClassIdEnum>][-MoDn< string>][-MoId< string>][-MoType< string>][-ObjectType< InventoryInventoryMo.ObjectTypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: InventoryInventoryMo.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: InventoryInventoryMo.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightInventoryInventoryMo
```
