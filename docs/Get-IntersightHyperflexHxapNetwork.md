...
# Get-IntersightHyperflexHxapNetwork

## SYNOPSIS
Get the HyperflexHxapNetwork

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHxapNetwork [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHxapNetwork [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;HyperflexHxapNetwork&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapNetwork
```
Above example returns the list of HyperflexHxapNetwork.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapNetwork -Name "MoName"
```
Above example returns the HyperflexHxapNetwork matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapNetwork -Organization $organization
```
Above example returns the list of HyperflexHxapNetwork available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapNetwork -InlineCount allpages
```
Above example returns the list of HyperflexHxapNetwork along with count.
...
### -Name
Specifies the name of the HyperflexHxapNetwork.
...
### -Organization
Specifies the organization, to fetch the HyperflexHxapNetwork under it.
...
[Set-IntersightHyperflexHxapNetwork](./Set-IntersightHyperflexHxapNetwork.md)
