...
```powershell
$KubernetesAciCniTenantClusterAllocation = Initialize-IntersightKubernetesAciCniTenantClusterAllocation  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$KubernetesAciCniTenantClusterAllocation | ConvertTo-JSON
```
