...
## SYNOPSIS
Get the RecoveryOnDemandBackup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRecoveryOnDemandBackup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRecoveryOnDemandBackup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;RecoveryOnDemandBackup&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRecoveryOnDemandBackup
```
Above example returns the list of RecoveryOnDemandBackup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRecoveryOnDemandBackup -Name "MoName"
```
Above example returns the RecoveryOnDemandBackup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRecoveryOnDemandBackup -Organization $organization
```
Above example returns the list of RecoveryOnDemandBackup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRecoveryOnDemandBackup -InlineCount allpages
```
Above example returns the list of RecoveryOnDemandBackup along with count.
...
### -Name
Specifies the name of the RecoveryOnDemandBackup.
...
### -Organization
Specifies the organization, to fetch the RecoveryOnDemandBackup under it.
