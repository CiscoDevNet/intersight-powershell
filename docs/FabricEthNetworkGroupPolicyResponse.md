...
```powershell
$FabricEthNetworkGroupPolicyResponse = Initialize-IntersightFabricEthNetworkGroupPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$FabricEthNetworkGroupPolicyResponse | ConvertTo-JSON
```
