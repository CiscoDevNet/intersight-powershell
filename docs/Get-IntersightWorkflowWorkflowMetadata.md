...
## SYNOPSIS
Get the WorkflowWorkflowMetadata

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowWorkflowMetadata [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowWorkflowMetadata [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;WorkflowWorkflowMetadata&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowWorkflowMetadata
```
Above example returns the list of WorkflowWorkflowMetadata.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowWorkflowMetadata -Name "MoName"
```
Above example returns the WorkflowWorkflowMetadata matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowWorkflowMetadata -Organization $organization
```
Above example returns the list of WorkflowWorkflowMetadata available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowWorkflowMetadata -InlineCount allpages
```
Above example returns the list of WorkflowWorkflowMetadata along with count.
...
### -Name
Specifies the name of the WorkflowWorkflowMetadata.
...
### -Organization
Specifies the organization, to fetch the WorkflowWorkflowMetadata under it.
