...
```powershell
$TechsupportmanagementTechSupportBundle = Initialize-IntersightTechsupportmanagementTechSupportBundle  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$TechsupportmanagementTechSupportBundle | ConvertTo-JSON
```
