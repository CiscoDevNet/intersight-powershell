...
```powershell
$HyperflexClusterNetworkPolicyResponse = Initialize-IntersightHyperflexClusterNetworkPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexClusterNetworkPolicyResponse | ConvertTo-JSON
```
