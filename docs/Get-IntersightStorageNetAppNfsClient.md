...
# Get-IntersightStorageNetAppNfsClient

## SYNOPSIS
Get the StorageNetAppNfsClient

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppNfsClient [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppNfsClient [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppNfsClient&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNfsClient
```
Above example returns the list of StorageNetAppNfsClient.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNfsClient -Name "MoName"
```
Above example returns the StorageNetAppNfsClient matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNfsClient -Organization $organization
```
Above example returns the list of StorageNetAppNfsClient available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNfsClient -InlineCount allpages
```
Above example returns the list of StorageNetAppNfsClient along with count.
...
### -Name
Specifies the name of the StorageNetAppNfsClient.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppNfsClient under it.
