...
# Initialize-IntersightMgmtConfigBackupFile
...
Initialize-IntersightMgmtConfigBackupFile [-Account< Model.IamAccountRelationship>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< MgmtConfigBackupFile.ClassIdEnum>][-Description< string>][-ImportAction< MgmtConfigBackupFile.ImportActionEnum>][-Md5eTag< string>][-Md5sum< string>][-Moid< string>][-Name< string>][-ObjectType< MgmtConfigBackupFile.ObjectTypeEnum>][-ReleaseDate< DateTime>][-Sha512sum< string>][-Size< long>][-SoftwareAdvisoryUrl< string>][-Source< Model.SoftwarerepositoryFileServer>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Version< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: MgmtConfigBackupFile.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: MgmtConfigBackupFile.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightMgmtConfigBackupFile
```
