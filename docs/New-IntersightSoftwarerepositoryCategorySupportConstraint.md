...
New-IntersightSoftwarerepositoryCategorySupportConstraint [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ConstraintId< string>][-FilteredModels< System.Collections.Generic.List`1[SoftwarerepositoryConstraintModels]>][-MdfId< string>][-MinVersion< string>][-Moid< string>][[-Name]< string>][-ParseFromImageName< bool>][-SupportedModels< System.Collections.Generic.List`1[string]>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
