...
# Get-IntersightStorageDiskSlot

## SYNOPSIS
Get the StorageDiskSlot

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageDiskSlot [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageDiskSlot [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageDiskSlot&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageDiskSlot
```
Above example returns the list of StorageDiskSlot.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageDiskSlot -Name "MoName"
```
Above example returns the StorageDiskSlot matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageDiskSlot -Organization $organization
```
Above example returns the list of StorageDiskSlot available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageDiskSlot -InlineCount allpages
```
Above example returns the list of StorageDiskSlot along with count.
...
### -Name
Specifies the name of the StorageDiskSlot.
...
### -Organization
Specifies the organization, to fetch the StorageDiskSlot under it.
