...
# Get-IntersightFabricMacSecPolicy

## SYNOPSIS
Get the FabricMacSecPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricMacSecPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricMacSecPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricMacSecPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricMacSecPolicy
```
Above example returns the list of FabricMacSecPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricMacSecPolicy -Name "MoName"
```
Above example returns the FabricMacSecPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricMacSecPolicy -Organization $organization
```
Above example returns the list of FabricMacSecPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricMacSecPolicy -InlineCount allpages
```
Above example returns the list of FabricMacSecPolicy along with count.
...
### -Name
Specifies the name of the FabricMacSecPolicy.
...
### -Organization
Specifies the organization, to fetch the FabricMacSecPolicy under it.
