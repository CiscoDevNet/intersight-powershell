...
# Initialize-IntersightCloudAwsNetworkInterface
...
Initialize-IntersightCloudAwsNetworkInterface [-AdapterType< CloudAwsNetworkInterface.AdapterTypeEnum>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< CloudAwsNetworkInterface.ClassIdEnum>][-MacAddress< string>][-Moid< string>][-Name< string>][-ObjectType< CloudAwsNetworkInterface.ObjectTypeEnum>][-RegisteredDevice< Model.AssetDeviceRegistrationRelationship>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: CloudAwsNetworkInterface.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CloudAwsNetworkInterface.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCloudAwsNetworkInterface
```
