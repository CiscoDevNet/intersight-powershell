...
# Get-IntersightIaasLicenseInfo

## SYNOPSIS
Get the IaasLicenseInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIaasLicenseInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIaasLicenseInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IaasLicenseInfo&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIaasLicenseInfo
```
Above example returns the list of IaasLicenseInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIaasLicenseInfo -Name "MoName"
```
Above example returns the IaasLicenseInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIaasLicenseInfo -Organization $organization
```
Above example returns the list of IaasLicenseInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIaasLicenseInfo -InlineCount allpages
```
Above example returns the list of IaasLicenseInfo along with count.
...
### -Name
Specifies the name of the IaasLicenseInfo.
...
### -Organization
Specifies the organization, to fetch the IaasLicenseInfo under it.
