...
# Get-IntersightIppoolUniverse

## SYNOPSIS
Get the IppoolUniverse

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIppoolUniverse [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIppoolUniverse [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IppoolUniverse&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIppoolUniverse
```
Above example returns the list of IppoolUniverse.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIppoolUniverse -Name "MoName"
```
Above example returns the IppoolUniverse matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIppoolUniverse -Organization $organization
```
Above example returns the list of IppoolUniverse available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIppoolUniverse -InlineCount allpages
```
Above example returns the list of IppoolUniverse along with count.
...
### -Name
Specifies the name of the IppoolUniverse.
...
### -Organization
Specifies the organization, to fetch the IppoolUniverse under it.
