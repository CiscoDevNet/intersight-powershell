...
## SYNOPSIS
Get the StorageNetAppNode

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppNode [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppNode [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppNode&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNode
```
Above example returns the list of StorageNetAppNode.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNode -Name "MoName"
```
Above example returns the StorageNetAppNode matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNode -Organization $organization
```
Above example returns the list of StorageNetAppNode available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNode -InlineCount allpages
```
Above example returns the list of StorageNetAppNode along with count.
...
### -Name
Specifies the name of the StorageNetAppNode.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppNode under it.
