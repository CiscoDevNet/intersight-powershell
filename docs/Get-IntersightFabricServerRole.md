...
## SYNOPSIS
Get the FabricServerRole

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricServerRole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricServerRole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;FabricServerRole&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricServerRole
```
Above example returns the list of FabricServerRole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricServerRole -Name "MoName"
```
Above example returns the FabricServerRole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricServerRole -Organization $organization
```
Above example returns the list of FabricServerRole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricServerRole -InlineCount allpages
```
Above example returns the list of FabricServerRole along with count.
...
### -Name
Specifies the name of the FabricServerRole.
...
### -Organization
Specifies the organization, to fetch the FabricServerRole under it.
