...
## SYNOPSIS
Get the KubernetesBaremetalNodeProfile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesBaremetalNodeProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesBaremetalNodeProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;KubernetesBaremetalNodeProfile&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesBaremetalNodeProfile
```
Above example returns the list of KubernetesBaremetalNodeProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesBaremetalNodeProfile -Name "MoName"
```
Above example returns the KubernetesBaremetalNodeProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesBaremetalNodeProfile -Organization $organization
```
Above example returns the list of KubernetesBaremetalNodeProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesBaremetalNodeProfile -InlineCount allpages
```
Above example returns the list of KubernetesBaremetalNodeProfile along with count.
...
### -Name
Specifies the name of the KubernetesBaremetalNodeProfile.
...
### -Organization
Specifies the organization, to fetch the KubernetesBaremetalNodeProfile under it.
