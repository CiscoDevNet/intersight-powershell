...
Set-IntersightVirtualizationVmwarePhysicalNetworkInterface [-AdditionalProperties< Dictionary<string,object>>][-Driver< string>][-Identity< string>][-LinkSpeed< int>][-MacAddress< string>][[-Moid]< string>][-Name< string>][-Pci< string>][-RegisteredDevice< AssetDeviceRegistrationRelationship>][-SwitchName< string>][-Tags< List<MoTag>>]
