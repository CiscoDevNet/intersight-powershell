...
# New-IntersightResourceSelectionCriteria
...
New-IntersightResourceSelectionCriteria [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Description< string>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-Selectors< System.Collections.Generic.List`1[ResourceSelector]>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;ResourceSelectionCriteria&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightResourceSelectionCriteria
```
