...
Initialize-IntersightFirmwareFirmwareInventory [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Category< string>][-ClassId< FirmwareFirmwareInventory.ClassIdEnum>][-Label< string>][-Model< string>][-ObjectType< FirmwareFirmwareInventory.ObjectTypeEnum>][-UpdateUri< string>][-Vendor< string>][-Version< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
