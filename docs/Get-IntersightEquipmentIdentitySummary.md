...
### CmdletParam (Default)
```
Get-IntersightEquipmentIdentitySummary [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentIdentitySummary [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentIdentitySummary
```
Above example returns the list of EquipmentIdentitySummary.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentIdentitySummary -Name "MoName"
```
Above example returns the EquipmentIdentitySummary matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentIdentitySummary -Organization $organization
```
Above example returns the list of EquipmentIdentitySummary available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentIdentitySummary -InlineCount allpages
```
Above example returns the list of EquipmentIdentitySummary along with count.
...
### -Name
Specifies the name of the EquipmentIdentitySummary.
...
### -Organization
Specifies the organization, to fetch the EquipmentIdentitySummary under it.
