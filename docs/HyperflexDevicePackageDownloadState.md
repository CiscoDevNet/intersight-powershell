...
```powershell
$HyperflexDevicePackageDownloadState = Initialize-IntersightHyperflexDevicePackageDownloadState  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$HyperflexDevicePackageDownloadState | ConvertTo-JSON
```
