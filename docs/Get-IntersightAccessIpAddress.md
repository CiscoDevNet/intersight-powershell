...
# Get-IntersightAccessIpAddress

## SYNOPSIS
Get the AccessIpAddress

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAccessIpAddress [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAccessIpAddress [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAccessIpAddress
```
Above example returns the list of AccessIpAddress.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAccessIpAddress -Name "MoName"
```
Above example returns the AccessIpAddress matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAccessIpAddress -Organization $organization
```
Above example returns the list of AccessIpAddress available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAccessIpAddress -InlineCount allpages
```
Above example returns the list of AccessIpAddress along with count.
...
### -Name
Specifies the name of the AccessIpAddress.
...
### -Organization
Specifies the organization, to fetch the AccessIpAddress under it.
