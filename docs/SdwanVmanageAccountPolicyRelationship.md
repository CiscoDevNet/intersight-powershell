...
```powershell
$SdwanVmanageAccountPolicyRelationship = Initialize-IntersightSdwanVmanageAccountPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$SdwanVmanageAccountPolicyRelationship | ConvertTo-JSON
```
