...
# Get-IntersightStorageHitachiVolumeMigrationPair

## SYNOPSIS
Get the StorageHitachiVolumeMigrationPair

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiVolumeMigrationPair [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiVolumeMigrationPair [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiVolumeMigrationPair&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiVolumeMigrationPair
```
Above example returns the list of StorageHitachiVolumeMigrationPair.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiVolumeMigrationPair -Name "MoName"
```
Above example returns the StorageHitachiVolumeMigrationPair matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiVolumeMigrationPair -Organization $organization
```
Above example returns the list of StorageHitachiVolumeMigrationPair available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiVolumeMigrationPair -InlineCount allpages
```
Above example returns the list of StorageHitachiVolumeMigrationPair along with count.
...
### -Name
Specifies the name of the StorageHitachiVolumeMigrationPair.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiVolumeMigrationPair under it.
