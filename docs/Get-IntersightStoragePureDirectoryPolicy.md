...
# Get-IntersightStoragePureDirectoryPolicy

## SYNOPSIS
Get the StoragePureDirectoryPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureDirectoryPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureDirectoryPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureDirectoryPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectoryPolicy
```
Above example returns the list of StoragePureDirectoryPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectoryPolicy -Name "MoName"
```
Above example returns the StoragePureDirectoryPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectoryPolicy -Organization $organization
```
Above example returns the list of StoragePureDirectoryPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectoryPolicy -InlineCount allpages
```
Above example returns the list of StoragePureDirectoryPolicy along with count.
...
### -Name
Specifies the name of the StoragePureDirectoryPolicy.
...
### -Organization
Specifies the organization, to fetch the StoragePureDirectoryPolicy under it.
