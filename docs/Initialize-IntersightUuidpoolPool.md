...
# Initialize-IntersightUuidpoolPool
...
```yaml
Type: UuidpoolPool.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.UuidpoolUuidBlock]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightUuidpoolPool
```
