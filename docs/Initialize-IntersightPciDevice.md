...
# Initialize-IntersightPciDevice
...
Initialize-IntersightPciDevice [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< PciDevice.ClassIdEnum>][-FirmwareVersion< string>][-Moid< string>][-ObjectType< PciDevice.ObjectTypeEnum>][-Pid< string>][-PreviousFru< Model.EquipmentFruRelationship>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> Initialize-IntersightPciDevice
```
