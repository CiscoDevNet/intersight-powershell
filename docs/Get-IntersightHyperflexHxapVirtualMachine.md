...
# Get-IntersightHyperflexHxapVirtualMachine

## SYNOPSIS
Get the HyperflexHxapVirtualMachine

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHxapVirtualMachine [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHxapVirtualMachine [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHxapVirtualMachine&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapVirtualMachine
```
Above example returns the list of HyperflexHxapVirtualMachine.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapVirtualMachine -Name "MoName"
```
Above example returns the HyperflexHxapVirtualMachine matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapVirtualMachine -Organization $organization
```
Above example returns the list of HyperflexHxapVirtualMachine available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapVirtualMachine -InlineCount allpages
```
Above example returns the list of HyperflexHxapVirtualMachine along with count.
...
### -Name
Specifies the name of the HyperflexHxapVirtualMachine.
...
### -Organization
Specifies the organization, to fetch the HyperflexHxapVirtualMachine under it.
...
[Set-IntersightHyperflexHxapVirtualMachine](./Set-IntersightHyperflexHxapVirtualMachine.md)
