...
## SYNOPSIS
Get the NiatelemetryApicTransceiverDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicTransceiverDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicTransceiverDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicTransceiverDetails
```
Above example returns the list of NiatelemetryApicTransceiverDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicTransceiverDetails -Name "MoName"
```
Above example returns the NiatelemetryApicTransceiverDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicTransceiverDetails -Organization $organization
```
Above example returns the list of NiatelemetryApicTransceiverDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicTransceiverDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryApicTransceiverDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryApicTransceiverDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicTransceiverDetails under it.
