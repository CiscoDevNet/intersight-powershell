...
## SYNOPSIS
Get the StorageFlexFlashPhysicalDrive

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageFlexFlashPhysicalDrive [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageFlexFlashPhysicalDrive [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageFlexFlashPhysicalDrive&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashPhysicalDrive
```
Above example returns the list of StorageFlexFlashPhysicalDrive.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashPhysicalDrive -Name "MoName"
```
Above example returns the StorageFlexFlashPhysicalDrive matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashPhysicalDrive -Organization $organization
```
Above example returns the list of StorageFlexFlashPhysicalDrive available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashPhysicalDrive -InlineCount allpages
```
Above example returns the list of StorageFlexFlashPhysicalDrive along with count.
...
### -Name
Specifies the name of the StorageFlexFlashPhysicalDrive.
...
### -Organization
Specifies the organization, to fetch the StorageFlexFlashPhysicalDrive under it.
...
[Set-IntersightStorageFlexFlashPhysicalDrive](./Set-IntersightStorageFlexFlashPhysicalDrive.md)
