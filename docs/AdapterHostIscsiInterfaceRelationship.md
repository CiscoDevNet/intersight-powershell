...
```powershell
$AdapterHostIscsiInterfaceRelationship = Initialize-IntersightAdapterHostIscsiInterfaceRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$AdapterHostIscsiInterfaceRelationship | ConvertTo-JSON
```
