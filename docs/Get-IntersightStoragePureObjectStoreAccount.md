...
# Get-IntersightStoragePureObjectStoreAccount

## SYNOPSIS
Get the StoragePureObjectStoreAccount

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureObjectStoreAccount [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureObjectStoreAccount [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureObjectStoreAccount&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureObjectStoreAccount
```
Above example returns the list of StoragePureObjectStoreAccount.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureObjectStoreAccount -Name "MoName"
```
Above example returns the StoragePureObjectStoreAccount matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureObjectStoreAccount -Organization $organization
```
Above example returns the list of StoragePureObjectStoreAccount available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureObjectStoreAccount -InlineCount allpages
```
Above example returns the list of StoragePureObjectStoreAccount along with count.
...
### -Name
Specifies the name of the StoragePureObjectStoreAccount.
...
### -Organization
Specifies the organization, to fetch the StoragePureObjectStoreAccount under it.
