...
Set-IntersightEtherNetworkPort [-AcknowledgedPeerInterface< EtherPhysicalPortBaseRelationship>][-AdditionalProperties< Dictionary<string,object>>][-EquipmentIoCardBase< EquipmentIoCardBaseRelationship>][-ModuleId< long>][[-Moid]< string>][-OperState< string>][-PeerDn< string>][-PeerInterface< EtherPhysicalPortBaseRelationship>][-PortId< long>][-SlotId< long>][-SwitchId< string>][-Tags< List<MoTag>>]
