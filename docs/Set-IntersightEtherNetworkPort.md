...
# Set-IntersightEtherNetworkPort
...
Set-IntersightEtherNetworkPort [-AcknowledgedPeerInterface< EtherPhysicalPortBaseRelationship>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-EquipmentIoCardBase< EquipmentIoCardBaseRelationship>][[-Moid]< string>][-OperState< string>][-PeerInterface< EtherPhysicalPortBaseRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;EtherNetworkPort&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightEtherNetworkPort
```
