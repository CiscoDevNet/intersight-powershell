...
# Get-IntersightFmcDeviceHaPair

## SYNOPSIS
Get the FmcDeviceHaPair

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFmcDeviceHaPair [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFmcDeviceHaPair [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FmcDeviceHaPair&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFmcDeviceHaPair
```
Above example returns the list of FmcDeviceHaPair.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFmcDeviceHaPair -Name "MoName"
```
Above example returns the FmcDeviceHaPair matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFmcDeviceHaPair -Organization $organization
```
Above example returns the list of FmcDeviceHaPair available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFmcDeviceHaPair -InlineCount allpages
```
Above example returns the list of FmcDeviceHaPair along with count.
...
### -Name
Specifies the name of the FmcDeviceHaPair.
...
### -Organization
Specifies the organization, to fetch the FmcDeviceHaPair under it.
