...
## SYNOPSIS
Get the FabricConfigResult

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricConfigResult [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricConfigResult [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricConfigResult&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricConfigResult
```
Above example returns the list of FabricConfigResult.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricConfigResult -Name "MoName"
```
Above example returns the FabricConfigResult matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricConfigResult -Organization $organization
```
Above example returns the list of FabricConfigResult available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricConfigResult -InlineCount allpages
```
Above example returns the list of FabricConfigResult along with count.
...
### -Name
Specifies the name of the FabricConfigResult.
...
### -Organization
Specifies the organization, to fetch the FabricConfigResult under it.
