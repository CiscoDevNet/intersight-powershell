...
## SYNOPSIS
Get the StorageEnclosureDiskSlotEp

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageEnclosureDiskSlotEp [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageEnclosureDiskSlotEp [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageEnclosureDiskSlotEp&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageEnclosureDiskSlotEp
```
Above example returns the list of StorageEnclosureDiskSlotEp.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageEnclosureDiskSlotEp -Name "MoName"
```
Above example returns the StorageEnclosureDiskSlotEp matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageEnclosureDiskSlotEp -Organization $organization
```
Above example returns the list of StorageEnclosureDiskSlotEp available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageEnclosureDiskSlotEp -InlineCount allpages
```
Above example returns the list of StorageEnclosureDiskSlotEp along with count.
...
### -Name
Specifies the name of the StorageEnclosureDiskSlotEp.
...
### -Organization
Specifies the organization, to fetch the StorageEnclosureDiskSlotEp under it.
...
[Set-IntersightStorageEnclosureDiskSlotEp](./Set-IntersightStorageEnclosureDiskSlotEp.md)
