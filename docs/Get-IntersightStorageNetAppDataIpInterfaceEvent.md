...
# Get-IntersightStorageNetAppDataIpInterfaceEvent

## SYNOPSIS
Get the StorageNetAppDataIpInterfaceEvent

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppDataIpInterfaceEvent [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppDataIpInterfaceEvent [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppDataIpInterfaceEvent&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppDataIpInterfaceEvent
```
Above example returns the list of StorageNetAppDataIpInterfaceEvent.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppDataIpInterfaceEvent -Name "MoName"
```
Above example returns the StorageNetAppDataIpInterfaceEvent matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppDataIpInterfaceEvent -Organization $organization
```
Above example returns the list of StorageNetAppDataIpInterfaceEvent available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppDataIpInterfaceEvent -InlineCount allpages
```
Above example returns the list of StorageNetAppDataIpInterfaceEvent along with count.
...
### -Name
Specifies the name of the StorageNetAppDataIpInterfaceEvent.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppDataIpInterfaceEvent under it.
