...
```powershell
$HyperflexClusterReplicationNetworkPolicyDeploymentResponse = Initialize-IntersightHyperflexClusterReplicationNetworkPolicyDeploymentResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexClusterReplicationNetworkPolicyDeploymentResponse | ConvertTo-JSON
```
