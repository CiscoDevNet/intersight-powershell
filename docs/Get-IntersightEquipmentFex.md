...
### CmdletParam (Default)
```
Get-IntersightEquipmentFex [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentFex [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentFex
```
Above example returns the list of EquipmentFex.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentFex -Name "MoName"
```
Above example returns the EquipmentFex matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentFex -Organization $organization
```
Above example returns the list of EquipmentFex available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentFex -InlineCount allpages
```
Above example returns the list of EquipmentFex along with count.
...
### -Name
Specifies the name of the EquipmentFex.
...
### -Organization
Specifies the organization, to fetch the EquipmentFex under it.
...
[Set-IntersightEquipmentFex](./Set-IntersightEquipmentFex.md)
