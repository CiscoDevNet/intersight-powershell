...
# Get-IntersightBiosBootMode

## SYNOPSIS
Get the BiosBootMode

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBiosBootMode [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBiosBootMode [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBiosBootMode
```
Above example returns the list of BiosBootMode.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBiosBootMode -Name "MoName"
```
Above example returns the BiosBootMode matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBiosBootMode -Organization $organization
```
Above example returns the list of BiosBootMode available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBiosBootMode -InlineCount allpages
```
Above example returns the list of BiosBootMode along with count.
...
### -Name
Specifies the name of the BiosBootMode.
...
### -Organization
Specifies the organization, to fetch the BiosBootMode under it.
...
[Set-IntersightBiosBootMode](./Set-IntersightBiosBootMode.md)
