...
## SYNOPSIS
Get the VirtualizationVmwareVirtualSwitch

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareVirtualSwitch [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareVirtualSwitch [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareVirtualSwitch&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualSwitch
```
Above example returns the list of VirtualizationVmwareVirtualSwitch.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualSwitch -Name "MoName"
```
Above example returns the VirtualizationVmwareVirtualSwitch matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualSwitch -Organization $organization
```
Above example returns the list of VirtualizationVmwareVirtualSwitch available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualSwitch -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareVirtualSwitch along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareVirtualSwitch.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareVirtualSwitch under it.
...
[Set-IntersightVirtualizationVmwareVirtualSwitch](./Set-IntersightVirtualizationVmwareVirtualSwitch.md)
