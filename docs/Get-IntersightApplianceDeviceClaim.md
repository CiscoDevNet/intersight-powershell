...
## SYNOPSIS
Get the ApplianceDeviceClaim

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceDeviceClaim [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceDeviceClaim [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceClaim
```
Above example returns the list of ApplianceDeviceClaim.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceClaim -Name "MoName"
```
Above example returns the ApplianceDeviceClaim matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceClaim -Organization $organization
```
Above example returns the list of ApplianceDeviceClaim available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceClaim -InlineCount allpages
```
Above example returns the list of ApplianceDeviceClaim along with count.
...
### -Name
Specifies the name of the ApplianceDeviceClaim.
...
### -Organization
Specifies the organization, to fetch the ApplianceDeviceClaim under it.
