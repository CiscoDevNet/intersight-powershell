...
```powershell
$StorageFlexUtilControllerRelationship = Initialize-IntersightStorageFlexUtilControllerRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StorageFlexUtilControllerRelationship | ConvertTo-JSON
```
