...
### CmdletParam (Default)
```
Get-IntersightChassisConfigImport [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightChassisConfigImport [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightChassisConfigImport
```
Above example returns the list of ChassisConfigImport.

### Example 2
```powershell
PS C:\> $result = Get-IntersightChassisConfigImport -Name "MoName"
```
Above example returns the ChassisConfigImport matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightChassisConfigImport -Organization $organization
```
Above example returns the list of ChassisConfigImport available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightChassisConfigImport -InlineCount allpages
```
Above example returns the list of ChassisConfigImport along with count.
...
### -Name
Specifies the name of the ChassisConfigImport.
...
### -Organization
Specifies the organization, to fetch the ChassisConfigImport under it.
...
[New-IntersightChassisConfigImport](./New-IntersightChassisConfigImport.md)
