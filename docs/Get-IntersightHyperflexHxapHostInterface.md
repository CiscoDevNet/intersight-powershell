...
# Get-IntersightHyperflexHxapHostInterface

## SYNOPSIS
Get the HyperflexHxapHostInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHxapHostInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHxapHostInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;HyperflexHxapHostInterface&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapHostInterface
```
Above example returns the list of HyperflexHxapHostInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapHostInterface -Name "MoName"
```
Above example returns the HyperflexHxapHostInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapHostInterface -Organization $organization
```
Above example returns the list of HyperflexHxapHostInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapHostInterface -InlineCount allpages
```
Above example returns the list of HyperflexHxapHostInterface along with count.
...
### -Name
Specifies the name of the HyperflexHxapHostInterface.
...
### -Organization
Specifies the organization, to fetch the HyperflexHxapHostInterface under it.
