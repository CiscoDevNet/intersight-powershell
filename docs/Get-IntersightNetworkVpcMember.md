...
# Get-IntersightNetworkVpcMember

## SYNOPSIS
Get the NetworkVpcMember

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkVpcMember [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkVpcMember [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NetworkVpcMember&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkVpcMember
```
Above example returns the list of NetworkVpcMember.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkVpcMember -Name "MoName"
```
Above example returns the NetworkVpcMember matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkVpcMember -Organization $organization
```
Above example returns the list of NetworkVpcMember available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkVpcMember -InlineCount allpages
```
Above example returns the list of NetworkVpcMember along with count.
...
### -Name
Specifies the name of the NetworkVpcMember.
...
### -Organization
Specifies the organization, to fetch the NetworkVpcMember under it.
