...
```powershell
$InventoryGenericInventoryRelationship = Initialize-IntersightInventoryGenericInventoryRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$InventoryGenericInventoryRelationship | ConvertTo-JSON
```
