...
Initialize-IntersightWorkflowCustomDataType [-AdditionalProperties< Dictionary<string,object>>][-ClassId< WorkflowCustomDataType.ClassIdEnum>][-Default< Model.WorkflowDefaultValue>][-Description< string>][-DisplayMeta< Model.WorkflowDisplayMeta>][-InputParameters< object>][-Label< string>][-Name< string>][-ObjectType< WorkflowCustomDataType.ObjectTypeEnum>][-Properties< Model.WorkflowCustomDataProperty>][-Required< bool>]
