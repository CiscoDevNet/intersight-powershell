...
# Get-IntersightHciNccCheckPolicy

## SYNOPSIS
Get the HciNccCheckPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHciNccCheckPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciNccCheckPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciNccCheckPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciNccCheckPolicy
```
Above example returns the list of HciNccCheckPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciNccCheckPolicy -Name "MoName"
```
Above example returns the HciNccCheckPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciNccCheckPolicy -Organization $organization
```
Above example returns the list of HciNccCheckPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciNccCheckPolicy -InlineCount allpages
```
Above example returns the list of HciNccCheckPolicy along with count.
...
### -Name
Specifies the name of the HciNccCheckPolicy.
...
### -Organization
Specifies the organization, to fetch the HciNccCheckPolicy under it.
