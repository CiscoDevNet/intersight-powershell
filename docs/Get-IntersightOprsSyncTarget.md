...
# Get-IntersightOprsSyncTarget

## SYNOPSIS
Get the OprsSyncTarget

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOprsSyncTarget [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOprsSyncTarget [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOprsSyncTarget
```
Above example returns the list of OprsSyncTarget.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOprsSyncTarget -Name "MoName"
```
Above example returns the OprsSyncTarget matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOprsSyncTarget -Organization $organization
```
Above example returns the list of OprsSyncTarget available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOprsSyncTarget -InlineCount allpages
```
Above example returns the list of OprsSyncTarget along with count.
...
### -Name
Specifies the name of the OprsSyncTarget.
...
### -Organization
Specifies the organization, to fetch the OprsSyncTarget under it.
