...
### CmdletParam (Default)
```
Get-IntersightIamApiKey [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamApiKey [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamApiKey
```
Above example returns the list of IamApiKey.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamApiKey -Name "MoName"
```
Above example returns the IamApiKey matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamApiKey -Organization $organization
```
Above example returns the list of IamApiKey available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamApiKey -InlineCount allpages
```
Above example returns the list of IamApiKey along with count.
...
### -Name
Specifies the name of the IamApiKey.
...
### -Organization
Specifies the organization, to fetch the IamApiKey under it.
