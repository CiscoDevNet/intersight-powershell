...
# Get-IntersightFcpoolPoolMember

## SYNOPSIS
Get the FcpoolPoolMember

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFcpoolPoolMember [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFcpoolPoolMember [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FcpoolPoolMember&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFcpoolPoolMember
```
Above example returns the list of FcpoolPoolMember.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFcpoolPoolMember -Name "MoName"
```
Above example returns the FcpoolPoolMember matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFcpoolPoolMember -Organization $organization
```
Above example returns the list of FcpoolPoolMember available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFcpoolPoolMember -InlineCount allpages
```
Above example returns the list of FcpoolPoolMember along with count.
...
### -Name
Specifies the name of the FcpoolPoolMember.
...
### -Organization
Specifies the organization, to fetch the FcpoolPoolMember under it.
