...
Set-IntersightCapabilitySiocModuleCapabilityDef [-AdditionalProperties< Dictionary<string,object>>][-DcSupported< bool>][[-Moid]< string>][-Name< string>][-Tags< List<MoTag>>]
