...
Set-IntersightCapabilitySiocModuleCapabilityDef [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-DcSupported< bool>][[-Moid]< string>][-Name< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> Set-IntersightCapabilitySiocModuleCapabilityDef
```
