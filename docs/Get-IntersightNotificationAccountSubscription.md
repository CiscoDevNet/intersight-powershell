...
## SYNOPSIS
Get the NotificationAccountSubscription

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNotificationAccountSubscription [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNotificationAccountSubscription [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NotificationAccountSubscription&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNotificationAccountSubscription
```
Above example returns the list of NotificationAccountSubscription.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNotificationAccountSubscription -Name "MoName"
```
Above example returns the NotificationAccountSubscription matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNotificationAccountSubscription -Organization $organization
```
Above example returns the list of NotificationAccountSubscription available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNotificationAccountSubscription -InlineCount allpages
```
Above example returns the list of NotificationAccountSubscription along with count.
...
### -Name
Specifies the name of the NotificationAccountSubscription.
...
### -Organization
Specifies the organization, to fetch the NotificationAccountSubscription under it.
