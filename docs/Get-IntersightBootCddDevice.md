...
# Get-IntersightBootCddDevice

## SYNOPSIS
Get the BootCddDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBootCddDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBootCddDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBootCddDevice
```
Above example returns the list of BootCddDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBootCddDevice -Name "MoName"
```
Above example returns the BootCddDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBootCddDevice -Organization $organization
```
Above example returns the list of BootCddDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBootCddDevice -InlineCount allpages
```
Above example returns the list of BootCddDevice along with count.
...
### -Name
Specifies the name of the BootCddDevice.
...
### -Organization
Specifies the organization, to fetch the BootCddDevice under it.
...
[Set-IntersightBootCddDevice](./Set-IntersightBootCddDevice.md)
