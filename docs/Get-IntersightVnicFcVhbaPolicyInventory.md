...
# Get-IntersightVnicFcVhbaPolicyInventory

## SYNOPSIS
Get the VnicFcVhbaPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicFcVhbaPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicFcVhbaPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicFcVhbaPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicFcVhbaPolicyInventory
```
Above example returns the list of VnicFcVhbaPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicFcVhbaPolicyInventory -Name "MoName"
```
Above example returns the VnicFcVhbaPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicFcVhbaPolicyInventory -Organization $organization
```
Above example returns the list of VnicFcVhbaPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicFcVhbaPolicyInventory -InlineCount allpages
```
Above example returns the list of VnicFcVhbaPolicyInventory along with count.
...
### -Name
Specifies the name of the VnicFcVhbaPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the VnicFcVhbaPolicyInventory under it.
