...
```yaml
Type: System.Collections.Generic.List`1[Model.IamPermissionRelationship]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIamUser
```
