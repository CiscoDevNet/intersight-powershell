...
## SYNOPSIS
Get the NiatelemetryApicSysLogSrc

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicSysLogSrc [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicSysLogSrc [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryApicSysLogSrc&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSysLogSrc
```
Above example returns the list of NiatelemetryApicSysLogSrc.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSysLogSrc -Name "MoName"
```
Above example returns the NiatelemetryApicSysLogSrc matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSysLogSrc -Organization $organization
```
Above example returns the list of NiatelemetryApicSysLogSrc available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSysLogSrc -InlineCount allpages
```
Above example returns the list of NiatelemetryApicSysLogSrc along with count.
...
### -Name
Specifies the name of the NiatelemetryApicSysLogSrc.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicSysLogSrc under it.
