...
# Initialize-IntersightCapabilitySwitchDescriptor
...
```yaml
Type: CapabilitySwitchDescriptor.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CapabilitySwitchDescriptor.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCapabilitySwitchDescriptor
```
