...
## SYNOPSIS
Get the ResourceMembershipHolder

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightResourceMembershipHolder [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourceMembershipHolder [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ResourceMembershipHolder&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourceMembershipHolder
```
Above example returns the list of ResourceMembershipHolder.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourceMembershipHolder -Name "MoName"
```
Above example returns the ResourceMembershipHolder matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourceMembershipHolder -Organization $organization
```
Above example returns the list of ResourceMembershipHolder available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourceMembershipHolder -InlineCount allpages
```
Above example returns the list of ResourceMembershipHolder along with count.
...
### -Name
Specifies the name of the ResourceMembershipHolder.
...
### -Organization
Specifies the organization, to fetch the ResourceMembershipHolder under it.
