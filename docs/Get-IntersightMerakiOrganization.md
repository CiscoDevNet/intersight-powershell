...
# Get-IntersightMerakiOrganization

## SYNOPSIS
Get the MerakiOrganization

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMerakiOrganization [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMerakiOrganization [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MerakiOrganization&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMerakiOrganization
```
Above example returns the list of MerakiOrganization.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMerakiOrganization -Name "MoName"
```
Above example returns the MerakiOrganization matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMerakiOrganization -Organization $organization
```
Above example returns the list of MerakiOrganization available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMerakiOrganization -InlineCount allpages
```
Above example returns the list of MerakiOrganization along with count.
...
### -Name
Specifies the name of the MerakiOrganization.
...
### -Organization
Specifies the organization, to fetch the MerakiOrganization under it.
