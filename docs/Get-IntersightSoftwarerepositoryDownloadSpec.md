...
## SYNOPSIS
Get the SoftwarerepositoryDownloadSpec

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwarerepositoryDownloadSpec [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwarerepositoryDownloadSpec [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryDownloadSpec
```
Above example returns the list of SoftwarerepositoryDownloadSpec.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryDownloadSpec -Name "MoName"
```
Above example returns the SoftwarerepositoryDownloadSpec matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryDownloadSpec -Organization $organization
```
Above example returns the list of SoftwarerepositoryDownloadSpec available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryDownloadSpec -InlineCount allpages
```
Above example returns the list of SoftwarerepositoryDownloadSpec along with count.
...
### -Name
Specifies the name of the SoftwarerepositoryDownloadSpec.
...
### -Organization
Specifies the organization, to fetch the SoftwarerepositoryDownloadSpec under it.
