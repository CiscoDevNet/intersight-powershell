...
# Get-IntersightStorageHitachiRemoteCopyPairUr

## SYNOPSIS
Get the StorageHitachiRemoteCopyPairUr

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiRemoteCopyPairUr [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiRemoteCopyPairUr [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiRemoteCopyPairUr&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteCopyPairUr
```
Above example returns the list of StorageHitachiRemoteCopyPairUr.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteCopyPairUr -Name "MoName"
```
Above example returns the StorageHitachiRemoteCopyPairUr matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteCopyPairUr -Organization $organization
```
Above example returns the list of StorageHitachiRemoteCopyPairUr available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteCopyPairUr -InlineCount allpages
```
Above example returns the list of StorageHitachiRemoteCopyPairUr along with count.
...
### -Name
Specifies the name of the StorageHitachiRemoteCopyPairUr.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiRemoteCopyPairUr under it.
