...
```powershell
$HclHyperflexSoftwareCompatibilityInfoResponse = Initialize-IntersightHclHyperflexSoftwareCompatibilityInfoResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HclHyperflexSoftwareCompatibilityInfoResponse | ConvertTo-JSON
```
