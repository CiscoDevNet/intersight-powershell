...
## SYNOPSIS
Get the FabricApplianceRole

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricApplianceRole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricApplianceRole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricApplianceRole&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricApplianceRole
```
Above example returns the list of FabricApplianceRole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricApplianceRole -Name "MoName"
```
Above example returns the FabricApplianceRole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricApplianceRole -Organization $organization
```
Above example returns the list of FabricApplianceRole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricApplianceRole -InlineCount allpages
```
Above example returns the list of FabricApplianceRole along with count.
...
### -Name
Specifies the name of the FabricApplianceRole.
...
### -Organization
Specifies the organization, to fetch the FabricApplianceRole under it.
