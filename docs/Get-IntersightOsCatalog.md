...
### CmdletParam (Default)
```
Get-IntersightOsCatalog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOsCatalog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;OsCatalog&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOsCatalog
```
Above example returns the list of OsCatalog.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOsCatalog -Name "MoName"
```
Above example returns the OsCatalog matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOsCatalog -Organization $organization
```
Above example returns the list of OsCatalog available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOsCatalog -InlineCount allpages
```
Above example returns the list of OsCatalog along with count.
...
### -Name
Specifies the name of the OsCatalog.
...
### -Organization
Specifies the organization, to fetch the OsCatalog under it.
