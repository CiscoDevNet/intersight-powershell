...
# Get-IntersightHyperflexDrive

## SYNOPSIS
Get the HyperflexDrive

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexDrive [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexDrive [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexDrive&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexDrive
```
Above example returns the list of HyperflexDrive.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexDrive -Name "MoName"
```
Above example returns the HyperflexDrive matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexDrive -Organization $organization
```
Above example returns the list of HyperflexDrive available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexDrive -InlineCount allpages
```
Above example returns the list of HyperflexDrive along with count.
...
### -Name
Specifies the name of the HyperflexDrive.
...
### -Organization
Specifies the organization, to fetch the HyperflexDrive under it.
...
[Set-IntersightHyperflexDrive](./Set-IntersightHyperflexDrive.md)
