...
# Get-IntersightConfigImportedItem

## SYNOPSIS
Get the ConfigImportedItem

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightConfigImportedItem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightConfigImportedItem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ConfigImportedItem&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightConfigImportedItem
```
Above example returns the list of ConfigImportedItem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightConfigImportedItem -Name "MoName"
```
Above example returns the ConfigImportedItem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightConfigImportedItem -Organization $organization
```
Above example returns the list of ConfigImportedItem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightConfigImportedItem -InlineCount allpages
```
Above example returns the list of ConfigImportedItem along with count.
...
### -Name
Specifies the name of the ConfigImportedItem.
...
### -Organization
Specifies the organization, to fetch the ConfigImportedItem under it.
