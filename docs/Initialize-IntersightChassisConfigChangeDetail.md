...
# Initialize-IntersightChassisConfigChangeDetail
...
Initialize-IntersightChassisConfigChangeDetail [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Changes< System.Collections.Generic.List`1[string]>][-ClassId< ChassisConfigChangeDetail.ClassIdEnum>][-ConfigChangeContext< Model.PolicyConfigResultContext>][-ConfigChangeFlag< ChassisConfigChangeDetail.ConfigChangeFlagEnum>][-Disruptions< System.Collections.Generic.List`1[string]>][-Message< string>][-ModStatus< ChassisConfigChangeDetail.ModStatusEnum>][-Moid< string>][-ObjectType< ChassisConfigChangeDetail.ObjectTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ChassisConfigChangeDetail.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ChassisConfigChangeDetail.ConfigChangeFlagEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ChassisConfigChangeDetail.ModStatusEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ChassisConfigChangeDetail.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightChassisConfigChangeDetail
```
