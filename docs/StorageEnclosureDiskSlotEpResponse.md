...
```powershell
$StorageEnclosureDiskSlotEpResponse = Initialize-IntersightStorageEnclosureDiskSlotEpResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageEnclosureDiskSlotEpResponse | ConvertTo-JSON
```
