...
# Get-IntersightKubernetesService

## SYNOPSIS
Get the KubernetesService

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesService [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesService [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KubernetesService&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesService
```
Above example returns the list of KubernetesService.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesService -Name "MoName"
```
Above example returns the KubernetesService matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesService -Organization $organization
```
Above example returns the list of KubernetesService available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesService -InlineCount allpages
```
Above example returns the list of KubernetesService along with count.
...
### -Name
Specifies the name of the KubernetesService.
...
### -Organization
Specifies the organization, to fetch the KubernetesService under it.
...
[Remove-IntersightKubernetesService](./Remove-IntersightKubernetesService.md)
