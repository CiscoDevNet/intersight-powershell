...
```powershell
$MemoryPersistentMemoryConfigurationResponse = Initialize-IntersightMemoryPersistentMemoryConfigurationResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$MemoryPersistentMemoryConfigurationResponse | ConvertTo-JSON
```
