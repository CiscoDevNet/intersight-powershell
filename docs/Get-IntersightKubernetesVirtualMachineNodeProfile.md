...
## SYNOPSIS
Get the KubernetesVirtualMachineNodeProfile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesVirtualMachineNodeProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesVirtualMachineNodeProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KubernetesVirtualMachineNodeProfile&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesVirtualMachineNodeProfile
```
Above example returns the list of KubernetesVirtualMachineNodeProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesVirtualMachineNodeProfile -Name "MoName"
```
Above example returns the KubernetesVirtualMachineNodeProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesVirtualMachineNodeProfile -Organization $organization
```
Above example returns the list of KubernetesVirtualMachineNodeProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesVirtualMachineNodeProfile -InlineCount allpages
```
Above example returns the list of KubernetesVirtualMachineNodeProfile along with count.
...
### -Name
Specifies the name of the KubernetesVirtualMachineNodeProfile.
...
### -Organization
Specifies the organization, to fetch the KubernetesVirtualMachineNodeProfile under it.
