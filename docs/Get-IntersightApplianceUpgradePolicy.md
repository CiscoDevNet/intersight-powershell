...
## SYNOPSIS
Get the ApplianceUpgradePolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceUpgradePolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceUpgradePolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceUpgradePolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceUpgradePolicy
```
Above example returns the list of ApplianceUpgradePolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceUpgradePolicy -Name "MoName"
```
Above example returns the ApplianceUpgradePolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceUpgradePolicy -Organization $organization
```
Above example returns the list of ApplianceUpgradePolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceUpgradePolicy -InlineCount allpages
```
Above example returns the list of ApplianceUpgradePolicy along with count.
...
### -Name
Specifies the name of the ApplianceUpgradePolicy.
...
### -Organization
Specifies the organization, to fetch the ApplianceUpgradePolicy under it.
...
[Set-IntersightApplianceUpgradePolicy](./Set-IntersightApplianceUpgradePolicy.md)
