...
# Create a 'fcpool.Pool' resource.
try {
    FcpoolPool $Result = New-IntersightFcpoolPool -FcpoolPool $FcpoolPool -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
...
# Delete a 'fcpool.Pool' resource.
try {
    Remove-IntersightFcpoolPool -Moid $Moid
} catch {
...
# Read a 'fcpool.FcBlock' resource.
try {
    FcpoolFcBlock $Result = Get-IntersightFcpoolFcBlockByMoid -Moid $Moid
} catch {
...
# Read a 'fcpool.FcBlock' resource.
try {
    FcpoolFcBlockResponse $Result = Get-IntersightFcpoolFcBlockList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'fcpool.Lease' resource.
try {
    FcpoolLease $Result = Get-IntersightFcpoolLeaseByMoid -Moid $Moid
} catch {
...
# Read a 'fcpool.Lease' resource.
try {
    FcpoolLeaseResponse $Result = Get-IntersightFcpoolLeaseList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'fcpool.Pool' resource.
try {
    FcpoolPool $Result = Get-IntersightFcpoolPoolByMoid -Moid $Moid
} catch {
...
# Read a 'fcpool.Pool' resource.
try {
    FcpoolPoolResponse $Result = Get-IntersightFcpoolPoolList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'fcpool.PoolMember' resource.
try {
    FcpoolPoolMember $Result = Get-IntersightFcpoolPoolMemberByMoid -Moid $Moid
} catch {
...
# Read a 'fcpool.PoolMember' resource.
try {
    FcpoolPoolMemberResponse $Result = Get-IntersightFcpoolPoolMemberList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'fcpool.Universe' resource.
try {
    FcpoolUniverse $Result = Get-IntersightFcpoolUniverseByMoid -Moid $Moid
} catch {
...
# Read a 'fcpool.Universe' resource.
try {
    FcpoolUniverseResponse $Result = Get-IntersightFcpoolUniverseList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Update a 'fcpool.Pool' resource.
try {
    FcpoolPool $Result = Set-IntersightFcpoolPool -Moid $Moid -FcpoolPool $FcpoolPool -IfMatch $IfMatch
} catch {
...
# Update a 'fcpool.Pool' resource.
try {
    FcpoolPool $Result = Update-IntersightFcpoolPool -Moid $Moid -FcpoolPool $FcpoolPool -IfMatch $IfMatch
} catch {
