# Intersight.Intersight/Api.IntersightFcpoolApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**New-IntersightFcpoolPool**](IntersightFcpoolApi.md#New-IntersightFcpoolPool) | **POST** /api/v1/fcpool/Pools | Create a &#39;fcpool.Pool&#39; resource.
[**Remove-IntersightFcpoolPool**](IntersightFcpoolApi.md#Remove-IntersightFcpoolPool) | **DELETE** /api/v1/fcpool/Pools/{Moid} | Delete a &#39;fcpool.Pool&#39; resource.
[**Get-IntersightFcpoolFcBlockByMoid**](IntersightFcpoolApi.md#Get-IntersightFcpoolFcBlockByMoid) | **GET** /api/v1/fcpool/FcBlocks/{Moid} | Read a &#39;fcpool.FcBlock&#39; resource.
[**Get-IntersightFcpoolFcBlockList**](IntersightFcpoolApi.md#Get-IntersightFcpoolFcBlockList) | **GET** /api/v1/fcpool/FcBlocks | Read a &#39;fcpool.FcBlock&#39; resource.
[**Get-IntersightFcpoolLeaseByMoid**](IntersightFcpoolApi.md#Get-IntersightFcpoolLeaseByMoid) | **GET** /api/v1/fcpool/Leases/{Moid} | Read a &#39;fcpool.Lease&#39; resource.
[**Get-IntersightFcpoolLeaseList**](IntersightFcpoolApi.md#Get-IntersightFcpoolLeaseList) | **GET** /api/v1/fcpool/Leases | Read a &#39;fcpool.Lease&#39; resource.
[**Get-IntersightFcpoolPoolByMoid**](IntersightFcpoolApi.md#Get-IntersightFcpoolPoolByMoid) | **GET** /api/v1/fcpool/Pools/{Moid} | Read a &#39;fcpool.Pool&#39; resource.
[**Get-IntersightFcpoolPoolList**](IntersightFcpoolApi.md#Get-IntersightFcpoolPoolList) | **GET** /api/v1/fcpool/Pools | Read a &#39;fcpool.Pool&#39; resource.
[**Get-IntersightFcpoolPoolMemberByMoid**](IntersightFcpoolApi.md#Get-IntersightFcpoolPoolMemberByMoid) | **GET** /api/v1/fcpool/PoolMembers/{Moid} | Read a &#39;fcpool.PoolMember&#39; resource.
[**Get-IntersightFcpoolPoolMemberList**](IntersightFcpoolApi.md#Get-IntersightFcpoolPoolMemberList) | **GET** /api/v1/fcpool/PoolMembers | Read a &#39;fcpool.PoolMember&#39; resource.
[**Get-IntersightFcpoolUniverseByMoid**](IntersightFcpoolApi.md#Get-IntersightFcpoolUniverseByMoid) | **GET** /api/v1/fcpool/Universes/{Moid} | Read a &#39;fcpool.Universe&#39; resource.
[**Get-IntersightFcpoolUniverseList**](IntersightFcpoolApi.md#Get-IntersightFcpoolUniverseList) | **GET** /api/v1/fcpool/Universes | Read a &#39;fcpool.Universe&#39; resource.
[**Set-IntersightFcpoolPool**](IntersightFcpoolApi.md#Set-IntersightFcpoolPool) | **PATCH** /api/v1/fcpool/Pools/{Moid} | Update a &#39;fcpool.Pool&#39; resource.
[**Update-IntersightFcpoolPool**](IntersightFcpoolApi.md#Update-IntersightFcpoolPool) | **POST** /api/v1/fcpool/Pools/{Moid} | Update a &#39;fcpool.Pool&#39; resource.


<a name="New-IntersightFcpoolPool"></a>
# **New-IntersightFcpoolPool**
> FcpoolPool New-IntersightFcpoolPool<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-FcpoolPool] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Create a 'fcpool.Pool' resource.
try {
     $Result = New-IntersightFcpoolPool -FcpoolPool $FcpoolPool -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
    Write-Host ("Exception occured when calling New-IntersightFcpoolPool: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a name="Remove-IntersightFcpoolPool"></a>
# **Remove-IntersightFcpoolPool**
> void Remove-IntersightFcpoolPool<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'fcpool.Pool' resource.
try {
     $Result = Remove-IntersightFcpoolPool -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightFcpoolPool: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightFcpoolFcBlockByMoid"></a>
# **Get-IntersightFcpoolFcBlockByMoid**
> FcpoolFcBlock Get-IntersightFcpoolFcBlockByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'fcpool.FcBlock' resource.
try {
     $Result = Get-IntersightFcpoolFcBlockByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightFcpoolFcBlockByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightFcpoolFcBlockList"></a>
# **Get-IntersightFcpoolFcBlockList**
> FcpoolFcBlockResponse Get-IntersightFcpoolFcBlockList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'fcpool.FcBlock' resource.
try {
     $Result = Get-IntersightFcpoolFcBlockList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightFcpoolFcBlockList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightFcpoolLeaseByMoid"></a>
# **Get-IntersightFcpoolLeaseByMoid**
> FcpoolLease Get-IntersightFcpoolLeaseByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'fcpool.Lease' resource.
try {
     $Result = Get-IntersightFcpoolLeaseByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightFcpoolLeaseByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightFcpoolLeaseList"></a>
# **Get-IntersightFcpoolLeaseList**
> FcpoolLeaseResponse Get-IntersightFcpoolLeaseList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'fcpool.Lease' resource.
try {
     $Result = Get-IntersightFcpoolLeaseList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightFcpoolLeaseList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightFcpoolPoolByMoid"></a>
# **Get-IntersightFcpoolPoolByMoid**
> FcpoolPool Get-IntersightFcpoolPoolByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'fcpool.Pool' resource.
try {
     $Result = Get-IntersightFcpoolPoolByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightFcpoolPoolByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightFcpoolPoolList"></a>
# **Get-IntersightFcpoolPoolList**
> FcpoolPoolResponse Get-IntersightFcpoolPoolList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'fcpool.Pool' resource.
try {
     $Result = Get-IntersightFcpoolPoolList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightFcpoolPoolList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightFcpoolPoolMemberByMoid"></a>
# **Get-IntersightFcpoolPoolMemberByMoid**
> FcpoolPoolMember Get-IntersightFcpoolPoolMemberByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'fcpool.PoolMember' resource.
try {
     $Result = Get-IntersightFcpoolPoolMemberByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightFcpoolPoolMemberByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightFcpoolPoolMemberList"></a>
# **Get-IntersightFcpoolPoolMemberList**
> FcpoolPoolMemberResponse Get-IntersightFcpoolPoolMemberList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'fcpool.PoolMember' resource.
try {
     $Result = Get-IntersightFcpoolPoolMemberList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightFcpoolPoolMemberList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightFcpoolUniverseByMoid"></a>
# **Get-IntersightFcpoolUniverseByMoid**
> FcpoolUniverse Get-IntersightFcpoolUniverseByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'fcpool.Universe' resource.
try {
     $Result = Get-IntersightFcpoolUniverseByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightFcpoolUniverseByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightFcpoolUniverseList"></a>
# **Get-IntersightFcpoolUniverseList**
> FcpoolUniverseResponse Get-IntersightFcpoolUniverseList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'fcpool.Universe' resource.
try {
     $Result = Get-IntersightFcpoolUniverseList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightFcpoolUniverseList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightFcpoolPool"></a>
# **Set-IntersightFcpoolPool**
> FcpoolPool Set-IntersightFcpoolPool<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-FcpoolPool] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$FcpoolPool = (Initialize-fcpool.Pool-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -Assigned 123 -AssignmentOrder "AssignmentOrder_example" -Size 123 -IdBlocks @() -PoolPurpose "PoolPurpose_example" -BlockHeads @() -Organization ) # FcpoolPool | The 'fcpool.Pool' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'fcpool.Pool' resource.
try {
     $Result = Set-IntersightFcpoolPool -Moid $Moid -FcpoolPool $FcpoolPool -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightFcpoolPool: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightFcpoolPool"></a>
# **Update-IntersightFcpoolPool**
> FcpoolPool Update-IntersightFcpoolPool<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-FcpoolPool] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'fcpool.Pool' resource.
try {
     $Result = Update-IntersightFcpoolPool -Moid $Moid -FcpoolPool $FcpoolPool -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightFcpoolPool: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
