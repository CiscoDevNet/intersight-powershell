...
# Get-IntersightApiproxyAllowList

## SYNOPSIS
Get the ApiproxyAllowList

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApiproxyAllowList [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApiproxyAllowList [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApiproxyAllowList&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApiproxyAllowList
```
Above example returns the list of ApiproxyAllowList.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApiproxyAllowList -Name "MoName"
```
Above example returns the ApiproxyAllowList matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApiproxyAllowList -Organization $organization
```
Above example returns the list of ApiproxyAllowList available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApiproxyAllowList -InlineCount allpages
```
Above example returns the list of ApiproxyAllowList along with count.
...
### -Name
Specifies the name of the ApiproxyAllowList.
...
### -Organization
Specifies the organization, to fetch the ApiproxyAllowList under it.
