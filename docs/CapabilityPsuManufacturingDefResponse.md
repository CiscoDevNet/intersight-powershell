...
```powershell
$CapabilityPsuManufacturingDefResponse = Initialize-IntersightCapabilityPsuManufacturingDefResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilityPsuManufacturingDefResponse | ConvertTo-JSON
```
