...
New-IntersightKubernetesAddonRepository [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-CaCert< X509Certificate>][-Catalog< WorkflowCatalogRelationship>][-InsecureSkipVerification< bool>][-Moid< string>][[-Name]< string>][-RegisteredDevice< AssetDeviceRegistrationRelationship>][-RepositoryUrl< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Username< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;KubernetesAddonRepository&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightKubernetesAddonRepository
```
