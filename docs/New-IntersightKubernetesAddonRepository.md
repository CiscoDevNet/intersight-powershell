...
New-IntersightKubernetesAddonRepository [-AdditionalProperties< Dictionary<string,object>>][-CaCert< X509Certificate>][-Catalog< WorkflowCatalogRelationship>][-InsecureSkipVerification< bool>][-Moid< string>][[-Name]< string>][-RegisteredDevice< AssetDeviceRegistrationRelationship>][-RepositoryUrl< string>][-Tags< List<MoTag>>][-Username< string>]
