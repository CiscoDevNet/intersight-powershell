...
# Get-IntersightCapabilityFexSupportMeta

## SYNOPSIS
Get the CapabilityFexSupportMeta

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityFexSupportMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityFexSupportMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilityFexSupportMeta&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityFexSupportMeta
```
Above example returns the list of CapabilityFexSupportMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityFexSupportMeta -Name "MoName"
```
Above example returns the CapabilityFexSupportMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityFexSupportMeta -Organization $organization
```
Above example returns the list of CapabilityFexSupportMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityFexSupportMeta -InlineCount allpages
```
Above example returns the list of CapabilityFexSupportMeta along with count.
...
### -Name
Specifies the name of the CapabilityFexSupportMeta.
...
### -Organization
Specifies the organization, to fetch the CapabilityFexSupportMeta under it.
