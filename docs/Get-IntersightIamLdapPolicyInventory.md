...
# Get-IntersightIamLdapPolicyInventory

## SYNOPSIS
Get the IamLdapPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamLdapPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamLdapPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamLdapPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamLdapPolicyInventory
```
Above example returns the list of IamLdapPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamLdapPolicyInventory -Name "MoName"
```
Above example returns the IamLdapPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamLdapPolicyInventory -Organization $organization
```
Above example returns the list of IamLdapPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamLdapPolicyInventory -InlineCount allpages
```
Above example returns the list of IamLdapPolicyInventory along with count.
...
### -Name
Specifies the name of the IamLdapPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the IamLdapPolicyInventory under it.
