...
# Get-IntersightFabricEthNetworkControlPolicyInventory

## SYNOPSIS
Get the FabricEthNetworkControlPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricEthNetworkControlPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricEthNetworkControlPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricEthNetworkControlPolicyInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkControlPolicyInventory
```
Above example returns the list of FabricEthNetworkControlPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkControlPolicyInventory -Name "MoName"
```
Above example returns the FabricEthNetworkControlPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkControlPolicyInventory -Organization $organization
```
Above example returns the list of FabricEthNetworkControlPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkControlPolicyInventory -InlineCount allpages
```
Above example returns the list of FabricEthNetworkControlPolicyInventory along with count.
...
### -Name
Specifies the name of the FabricEthNetworkControlPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the FabricEthNetworkControlPolicyInventory under it.
