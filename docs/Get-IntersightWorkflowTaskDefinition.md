...
## SYNOPSIS
Get the WorkflowTaskDefinition

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowTaskDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowTaskDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowTaskDefinition&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskDefinition
```
Above example returns the list of WorkflowTaskDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskDefinition -Name "MoName"
```
Above example returns the WorkflowTaskDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskDefinition -Organization $organization
```
Above example returns the list of WorkflowTaskDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskDefinition -InlineCount allpages
```
Above example returns the list of WorkflowTaskDefinition along with count.
...
### -Name
Specifies the name of the WorkflowTaskDefinition.
...
### -Organization
Specifies the organization, to fetch the WorkflowTaskDefinition under it.
