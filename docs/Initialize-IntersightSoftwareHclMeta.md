...
# Initialize-IntersightSoftwareHclMeta
...
Initialize-IntersightSoftwareHclMeta [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Catalog< Model.SoftwarerepositoryCatalogRelationship>][-ClassId< SoftwareHclMeta.ClassIdEnum>][-ComponentMeta< System.Collections.Generic.List`1[Model.FirmwareComponentMeta]>][-ContentType< SoftwareHclMeta.ContentTypeEnum>][-Description< string>][-DistributableMetas< System.Collections.Generic.List`1[Model.FirmwareDistributableMetaRelationship]>][-ImageType< string>][-ImportAction< SoftwareHclMeta.ImportActionEnum>][-ImportState< SoftwareHclMeta.ImportStateEnum>][-Md5eTag< string>][-Md5sum< string>][-Mdfid< string>][-Model< string>][-Moid< string>][-Name< string>][-ObjectType< SoftwareHclMeta.ObjectTypeEnum>][-RecommendedBuild< string>][-Release< Model.SoftwarerepositoryReleaseRelationship>][-ReleaseDate< DateTime>][-ReleaseNotesUrl< string>][-Sha512sum< string>][-Size< long>][-SoftwareAdvisoryUrl< string>][-Source< Model.SoftwarerepositoryFileServer>][-SupportedModels< System.Collections.Generic.List`1[string]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Vendor< string>][-Version< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: SoftwareHclMeta.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: SoftwareHclMeta.ContentTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: SoftwareHclMeta.ImportActionEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: SoftwareHclMeta.ImportStateEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: SoftwareHclMeta.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightSoftwareHclMeta
```
