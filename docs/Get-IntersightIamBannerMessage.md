...
# Get-IntersightIamBannerMessage

## SYNOPSIS
Get the IamBannerMessage

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamBannerMessage [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamBannerMessage [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamBannerMessage
```
Above example returns the list of IamBannerMessage.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamBannerMessage -Name "MoName"
```
Above example returns the IamBannerMessage matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamBannerMessage -Organization $organization
```
Above example returns the list of IamBannerMessage available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamBannerMessage -InlineCount allpages
```
Above example returns the list of IamBannerMessage along with count.
...
### -Name
Specifies the name of the IamBannerMessage.
...
### -Organization
Specifies the organization, to fetch the IamBannerMessage under it.
...
[Set-IntersightIamBannerMessage](./Set-IntersightIamBannerMessage.md)
