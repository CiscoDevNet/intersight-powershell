...
### CmdletParam (Default)
```
Get-IntersightBulkRequest [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBulkRequest [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBulkRequest
```
Above example returns the list of BulkRequest.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBulkRequest -Name "MoName"
```
Above example returns the BulkRequest matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBulkRequest -Organization $organization
```
Above example returns the list of BulkRequest available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBulkRequest -InlineCount allpages
```
Above example returns the list of BulkRequest along with count.
...
### -Name
Specifies the name of the BulkRequest.
...
### -Organization
Specifies the organization, to fetch the BulkRequest under it.
...
[New-IntersightBulkRequest](./New-IntersightBulkRequest.md)
