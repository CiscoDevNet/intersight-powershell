...
# Get-IntersightIamCuiIntegration

## SYNOPSIS
Get the IamCuiIntegration

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamCuiIntegration [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamCuiIntegration [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamCuiIntegration&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamCuiIntegration
```
Above example returns the list of IamCuiIntegration.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamCuiIntegration -Name "MoName"
```
Above example returns the IamCuiIntegration matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamCuiIntegration -Organization $organization
```
Above example returns the list of IamCuiIntegration available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamCuiIntegration -InlineCount allpages
```
Above example returns the list of IamCuiIntegration along with count.
...
### -Name
Specifies the name of the IamCuiIntegration.
...
### -Organization
Specifies the organization, to fetch the IamCuiIntegration under it.
