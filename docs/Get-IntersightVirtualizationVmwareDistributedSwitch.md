...
## SYNOPSIS
Get the VirtualizationVmwareDistributedSwitch

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareDistributedSwitch [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareDistributedSwitch [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareDistributedSwitch&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDistributedSwitch
```
Above example returns the list of VirtualizationVmwareDistributedSwitch.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDistributedSwitch -Name "MoName"
```
Above example returns the VirtualizationVmwareDistributedSwitch matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDistributedSwitch -Organization $organization
```
Above example returns the list of VirtualizationVmwareDistributedSwitch available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDistributedSwitch -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareDistributedSwitch along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareDistributedSwitch.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareDistributedSwitch under it.
...
[Set-IntersightVirtualizationVmwareDistributedSwitch](./Set-IntersightVirtualizationVmwareDistributedSwitch.md)
