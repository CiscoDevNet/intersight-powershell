...
## SYNOPSIS
Get the VirtualizationVmwareDistributedNetwork

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareDistributedNetwork [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareDistributedNetwork [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareDistributedNetwork&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDistributedNetwork
```
Above example returns the list of VirtualizationVmwareDistributedNetwork.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDistributedNetwork -Name "MoName"
```
Above example returns the VirtualizationVmwareDistributedNetwork matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDistributedNetwork -Organization $organization
```
Above example returns the list of VirtualizationVmwareDistributedNetwork available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDistributedNetwork -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareDistributedNetwork along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareDistributedNetwork.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareDistributedNetwork under it.
...
[Set-IntersightVirtualizationVmwareDistributedNetwork](./Set-IntersightVirtualizationVmwareDistributedNetwork.md)
