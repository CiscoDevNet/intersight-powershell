...
### CmdletParam (Default)
```
Get-IntersightApicTenant [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApicTenant [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApicTenant&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApicTenant
```
Above example returns the list of ApicTenant.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApicTenant -Name "MoName"
```
Above example returns the ApicTenant matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApicTenant -Organization $organization
```
Above example returns the list of ApicTenant available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApicTenant -InlineCount allpages
```
Above example returns the list of ApicTenant along with count.
...
### -Name
Specifies the name of the ApicTenant.
...
### -Organization
Specifies the organization, to fetch the ApicTenant under it.
