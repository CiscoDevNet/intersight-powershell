...
## SYNOPSIS
Get the NiatelemetrySnmpSrc

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetrySnmpSrc [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetrySnmpSrc [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetrySnmpSrc&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySnmpSrc
```
Above example returns the list of NiatelemetrySnmpSrc.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySnmpSrc -Name "MoName"
```
Above example returns the NiatelemetrySnmpSrc matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySnmpSrc -Organization $organization
```
Above example returns the list of NiatelemetrySnmpSrc available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySnmpSrc -InlineCount allpages
```
Above example returns the list of NiatelemetrySnmpSrc along with count.
...
### -Name
Specifies the name of the NiatelemetrySnmpSrc.
...
### -Organization
Specifies the organization, to fetch the NiatelemetrySnmpSrc under it.
