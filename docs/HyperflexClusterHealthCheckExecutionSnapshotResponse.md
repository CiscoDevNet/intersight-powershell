...
```powershell
$HyperflexClusterHealthCheckExecutionSnapshotResponse = Initialize-IntersightHyperflexClusterHealthCheckExecutionSnapshotResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexClusterHealthCheckExecutionSnapshotResponse | ConvertTo-JSON
```
