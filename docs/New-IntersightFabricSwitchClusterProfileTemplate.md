...
# New-IntersightFabricSwitchClusterProfileTemplate
...
```yaml
Type: System.Collections.Generic.List`1[FabricSwitchProfileTemplateRelationship]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> New-IntersightFabricSwitchClusterProfileTemplate
```
