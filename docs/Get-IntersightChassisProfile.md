...
### CmdletParam (Default)
```
Get-IntersightChassisProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightChassisProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightChassisProfile
```
Above example returns the list of ChassisProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightChassisProfile -Name "MoName"
```
Above example returns the ChassisProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightChassisProfile -Organization $organization
```
Above example returns the list of ChassisProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightChassisProfile -InlineCount allpages
```
Above example returns the list of ChassisProfile along with count.
...
### -Name
Specifies the name of the ChassisProfile.
...
### -Organization
Specifies the organization, to fetch the ChassisProfile under it.
