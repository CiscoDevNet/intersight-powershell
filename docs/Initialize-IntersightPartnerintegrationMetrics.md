...
```yaml
Type: PartnerintegrationMetrics.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.PartnerintegrationMetricsModel
Parameter Sets: (All)
Aliases:
...
```yaml
Type: PartnerintegrationMetrics.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightPartnerintegrationMetrics
```
