...
# Initialize-IntersightIamEndPointUserPolicy
...
```yaml
Type: IamEndPointUserPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IamEndPointUserPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.IamEndPointPasswordProperties
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIamEndPointUserPolicy
```
