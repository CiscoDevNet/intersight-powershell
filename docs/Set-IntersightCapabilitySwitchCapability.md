...
Set-IntersightCapabilitySwitchCapability [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][[-Moid]< string>][-Name< string>][-Pid< CapabilitySwitchCapability.PidEnum>][-Sku< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Vid< string>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
