...
## SYNOPSIS
Get the RecoveryBackupProfile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRecoveryBackupProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRecoveryBackupProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;RecoveryBackupProfile&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRecoveryBackupProfile
```
Above example returns the list of RecoveryBackupProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRecoveryBackupProfile -Name "MoName"
```
Above example returns the RecoveryBackupProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRecoveryBackupProfile -Organization $organization
```
Above example returns the list of RecoveryBackupProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRecoveryBackupProfile -InlineCount allpages
```
Above example returns the list of RecoveryBackupProfile along with count.
...
### -Name
Specifies the name of the RecoveryBackupProfile.
...
### -Organization
Specifies the organization, to fetch the RecoveryBackupProfile under it.
