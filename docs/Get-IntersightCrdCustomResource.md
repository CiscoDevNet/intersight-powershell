...
### CmdletParam (Default)
```
Get-IntersightCrdCustomResource [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCrdCustomResource [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCrdCustomResource
```
Above example returns the list of CrdCustomResource.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCrdCustomResource -Name "MoName"
```
Above example returns the CrdCustomResource matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCrdCustomResource -Organization $organization
```
Above example returns the list of CrdCustomResource available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCrdCustomResource -InlineCount allpages
```
Above example returns the list of CrdCustomResource along with count.
...
### -Name
Specifies the name of the CrdCustomResource.
...
### -Organization
Specifies the organization, to fetch the CrdCustomResource under it.
