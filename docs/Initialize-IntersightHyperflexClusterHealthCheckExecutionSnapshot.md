...
# Initialize-IntersightHyperflexClusterHealthCheckExecutionSnapshot
...
```yaml
Type: HyperflexClusterHealthCheckExecutionSnapshot.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightHyperflexClusterHealthCheckExecutionSnapshot
```
