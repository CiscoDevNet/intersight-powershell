...
# Get-IntersightCatalystsdwanPortChannel

## SYNOPSIS
Get the CatalystsdwanPortChannel

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCatalystsdwanPortChannel [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCatalystsdwanPortChannel [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CatalystsdwanPortChannel&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanPortChannel
```
Above example returns the list of CatalystsdwanPortChannel.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanPortChannel -Name "MoName"
```
Above example returns the CatalystsdwanPortChannel matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanPortChannel -Organization $organization
```
Above example returns the list of CatalystsdwanPortChannel available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanPortChannel -InlineCount allpages
```
Above example returns the list of CatalystsdwanPortChannel along with count.
...
### -Name
Specifies the name of the CatalystsdwanPortChannel.
...
### -Organization
Specifies the organization, to fetch the CatalystsdwanPortChannel under it.
