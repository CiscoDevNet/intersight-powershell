...
# Get-IntersightIamEndPointUserRoleInventory

## SYNOPSIS
Get the IamEndPointUserRoleInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamEndPointUserRoleInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamEndPointUserRoleInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamEndPointUserRoleInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserRoleInventory
```
Above example returns the list of IamEndPointUserRoleInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserRoleInventory -Name "MoName"
```
Above example returns the IamEndPointUserRoleInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserRoleInventory -Organization $organization
```
Above example returns the list of IamEndPointUserRoleInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserRoleInventory -InlineCount allpages
```
Above example returns the list of IamEndPointUserRoleInventory along with count.
...
### -Name
Specifies the name of the IamEndPointUserRoleInventory.
...
### -Organization
Specifies the organization, to fetch the IamEndPointUserRoleInventory under it.
