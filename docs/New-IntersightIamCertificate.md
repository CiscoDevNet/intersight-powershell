...
New-IntersightIamCertificate [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Certificate< X509Certificate>][-CertificateRequest< IamCertificateRequestRelationship>][-Moid< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
