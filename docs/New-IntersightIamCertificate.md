...
New-IntersightIamCertificate [-AdditionalProperties< Dictionary<string,object>>][-Certificate< X509Certificate>][-CertificateRequest< IamCertificateRequestRelationship>][-Moid< string>][-Tags< List<MoTag>>]
