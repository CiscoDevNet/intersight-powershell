...
```powershell
$HyperflexExtFcStoragePolicyRelationship = Initialize-IntersightHyperflexExtFcStoragePolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexExtFcStoragePolicyRelationship | ConvertTo-JSON
```
