...
# Initialize-IntersightPoolIdMappingPolicy
...
```yaml
Type: PoolIdMappingPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: PoolIdMappingPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightPoolIdMappingPolicy
```
