...
### CmdletParam (Default)
```
Get-IntersightCapabilitySwitchManufacturingDef [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilitySwitchManufacturingDef [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchManufacturingDef
```
Above example returns the list of CapabilitySwitchManufacturingDef.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchManufacturingDef -Name "MoName"
```
Above example returns the CapabilitySwitchManufacturingDef matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchManufacturingDef -Organization $organization
```
Above example returns the list of CapabilitySwitchManufacturingDef available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchManufacturingDef -InlineCount allpages
```
Above example returns the list of CapabilitySwitchManufacturingDef along with count.
...
### -Name
Specifies the name of the CapabilitySwitchManufacturingDef.
...
### -Organization
Specifies the organization, to fetch the CapabilitySwitchManufacturingDef under it.
