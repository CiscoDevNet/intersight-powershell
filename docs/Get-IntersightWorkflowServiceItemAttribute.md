...
# Get-IntersightWorkflowServiceItemAttribute

## SYNOPSIS
Get the WorkflowServiceItemAttribute

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowServiceItemAttribute [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowServiceItemAttribute [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowServiceItemAttribute&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemAttribute
```
Above example returns the list of WorkflowServiceItemAttribute.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemAttribute -Name "MoName"
```
Above example returns the WorkflowServiceItemAttribute matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemAttribute -Organization $organization
```
Above example returns the list of WorkflowServiceItemAttribute available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemAttribute -InlineCount allpages
```
Above example returns the list of WorkflowServiceItemAttribute along with count.
...
### -Name
Specifies the name of the WorkflowServiceItemAttribute.
...
### -Organization
Specifies the organization, to fetch the WorkflowServiceItemAttribute under it.
