...
## SYNOPSIS
Get the NiaapiApicCcoPost

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiApicCcoPost [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiApicCcoPost [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiApicCcoPost
```
Above example returns the list of NiaapiApicCcoPost.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiApicCcoPost -Name "MoName"
```
Above example returns the NiaapiApicCcoPost matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiApicCcoPost -Organization $organization
```
Above example returns the list of NiaapiApicCcoPost available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiApicCcoPost -InlineCount allpages
```
Above example returns the list of NiaapiApicCcoPost along with count.
...
### -Name
Specifies the name of the NiaapiApicCcoPost.
...
### -Organization
Specifies the organization, to fetch the NiaapiApicCcoPost under it.
