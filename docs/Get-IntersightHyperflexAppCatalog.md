...
# Get-IntersightHyperflexAppCatalog

## SYNOPSIS
Get the HyperflexAppCatalog

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexAppCatalog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexAppCatalog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexAppCatalog
```
Above example returns the list of HyperflexAppCatalog.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexAppCatalog -Name "MoName"
```
Above example returns the HyperflexAppCatalog matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexAppCatalog -Organization $organization
```
Above example returns the list of HyperflexAppCatalog available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexAppCatalog -InlineCount allpages
```
Above example returns the list of HyperflexAppCatalog along with count.
...
### -Name
Specifies the name of the HyperflexAppCatalog.
...
### -Organization
Specifies the organization, to fetch the HyperflexAppCatalog under it.
