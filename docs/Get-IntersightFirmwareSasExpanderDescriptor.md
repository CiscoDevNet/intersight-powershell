...
## SYNOPSIS
Get the FirmwareSasExpanderDescriptor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareSasExpanderDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareSasExpanderDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareSasExpanderDescriptor
```
Above example returns the list of FirmwareSasExpanderDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareSasExpanderDescriptor -Name "MoName"
```
Above example returns the FirmwareSasExpanderDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareSasExpanderDescriptor -Organization $organization
```
Above example returns the list of FirmwareSasExpanderDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareSasExpanderDescriptor -InlineCount allpages
```
Above example returns the list of FirmwareSasExpanderDescriptor along with count.
...
### -Name
Specifies the name of the FirmwareSasExpanderDescriptor.
...
### -Organization
Specifies the organization, to fetch the FirmwareSasExpanderDescriptor under it.
