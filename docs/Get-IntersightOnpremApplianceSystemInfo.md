...
# Get-IntersightOnpremApplianceSystemInfo

## SYNOPSIS
Get the OnpremApplianceSystemInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOnpremApplianceSystemInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOnpremApplianceSystemInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;OnpremApplianceSystemInfo&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOnpremApplianceSystemInfo
```
Above example returns the list of OnpremApplianceSystemInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOnpremApplianceSystemInfo -Name "MoName"
```
Above example returns the OnpremApplianceSystemInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOnpremApplianceSystemInfo -Organization $organization
```
Above example returns the list of OnpremApplianceSystemInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOnpremApplianceSystemInfo -InlineCount allpages
```
Above example returns the list of OnpremApplianceSystemInfo along with count.
...
### -Name
Specifies the name of the OnpremApplianceSystemInfo.
...
### -Organization
Specifies the organization, to fetch the OnpremApplianceSystemInfo under it.
