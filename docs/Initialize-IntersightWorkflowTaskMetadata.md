...
# Initialize-IntersightWorkflowTaskMetadata
...
```yaml
Type: WorkflowTaskMetadata.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowTaskMetadata.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowTaskMetadata
```
