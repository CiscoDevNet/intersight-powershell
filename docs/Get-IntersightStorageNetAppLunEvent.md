...
## SYNOPSIS
Get the StorageNetAppLunEvent

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppLunEvent [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppLunEvent [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppLunEvent&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLunEvent
```
Above example returns the list of StorageNetAppLunEvent.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLunEvent -Name "MoName"
```
Above example returns the StorageNetAppLunEvent matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLunEvent -Organization $organization
```
Above example returns the list of StorageNetAppLunEvent available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLunEvent -InlineCount allpages
```
Above example returns the list of StorageNetAppLunEvent along with count.
...
### -Name
Specifies the name of the StorageNetAppLunEvent.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppLunEvent under it.
