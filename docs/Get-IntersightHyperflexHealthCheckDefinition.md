...
## SYNOPSIS
Get the HyperflexHealthCheckDefinition

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHealthCheckDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHealthCheckDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHealthCheckDefinition&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckDefinition
```
Above example returns the list of HyperflexHealthCheckDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckDefinition -Name "MoName"
```
Above example returns the HyperflexHealthCheckDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckDefinition -Organization $organization
```
Above example returns the list of HyperflexHealthCheckDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckDefinition -InlineCount allpages
```
Above example returns the list of HyperflexHealthCheckDefinition along with count.
...
### -Name
Specifies the name of the HyperflexHealthCheckDefinition.
...
### -Organization
Specifies the organization, to fetch the HyperflexHealthCheckDefinition under it.
