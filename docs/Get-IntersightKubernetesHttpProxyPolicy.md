...
# Get-IntersightKubernetesHttpProxyPolicy

## SYNOPSIS
Get the KubernetesHttpProxyPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesHttpProxyPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesHttpProxyPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KubernetesHttpProxyPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesHttpProxyPolicy
```
Above example returns the list of KubernetesHttpProxyPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesHttpProxyPolicy -Name "MoName"
```
Above example returns the KubernetesHttpProxyPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesHttpProxyPolicy -Organization $organization
```
Above example returns the list of KubernetesHttpProxyPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesHttpProxyPolicy -InlineCount allpages
```
Above example returns the list of KubernetesHttpProxyPolicy along with count.
...
### -Name
Specifies the name of the KubernetesHttpProxyPolicy.
...
### -Organization
Specifies the organization, to fetch the KubernetesHttpProxyPolicy under it.
...
[Remove-IntersightKubernetesHttpProxyPolicy](./Remove-IntersightKubernetesHttpProxyPolicy.md)
