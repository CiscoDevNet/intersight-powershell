...
## SYNOPSIS
Get the FirmwareBiosDescriptor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareBiosDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareBiosDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareBiosDescriptor&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareBiosDescriptor
```
Above example returns the list of FirmwareBiosDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareBiosDescriptor -Name "MoName"
```
Above example returns the FirmwareBiosDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareBiosDescriptor -Organization $organization
```
Above example returns the list of FirmwareBiosDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareBiosDescriptor -InlineCount allpages
```
Above example returns the list of FirmwareBiosDescriptor along with count.
...
### -Name
Specifies the name of the FirmwareBiosDescriptor.
...
### -Organization
Specifies the organization, to fetch the FirmwareBiosDescriptor under it.
