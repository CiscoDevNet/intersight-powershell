...
## SYNOPSIS
Get the HyperflexHxdpVersion

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHxdpVersion [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHxdpVersion [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHxdpVersion&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHxdpVersion
```
Above example returns the list of HyperflexHxdpVersion.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHxdpVersion -Name "MoName"
```
Above example returns the HyperflexHxdpVersion matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHxdpVersion -Organization $organization
```
Above example returns the list of HyperflexHxdpVersion available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHxdpVersion -InlineCount allpages
```
Above example returns the list of HyperflexHxdpVersion along with count.
...
### -Name
Specifies the name of the HyperflexHxdpVersion.
...
### -Organization
Specifies the organization, to fetch the HyperflexHxdpVersion under it.
