...
### CmdletParam (Default)
```
Get-IntersightNiaapiNdMetadata [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiNdMetadata [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
