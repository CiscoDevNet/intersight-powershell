...
# Get-IntersightNetworkTelemetryCheck

## SYNOPSIS
Get the NetworkTelemetryCheck

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkTelemetryCheck [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkTelemetryCheck [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NetworkTelemetryCheck&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkTelemetryCheck
```
Above example returns the list of NetworkTelemetryCheck.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkTelemetryCheck -Name "MoName"
```
Above example returns the NetworkTelemetryCheck matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkTelemetryCheck -Organization $organization
```
Above example returns the list of NetworkTelemetryCheck available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkTelemetryCheck -InlineCount allpages
```
Above example returns the list of NetworkTelemetryCheck along with count.
...
### -Name
Specifies the name of the NetworkTelemetryCheck.
...
### -Organization
Specifies the organization, to fetch the NetworkTelemetryCheck under it.
