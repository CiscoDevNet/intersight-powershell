...
## SYNOPSIS
Get the NiatelemetryApicRealmDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicRealmDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicRealmDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryApicRealmDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicRealmDetails
```
Above example returns the list of NiatelemetryApicRealmDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicRealmDetails -Name "MoName"
```
Above example returns the NiatelemetryApicRealmDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicRealmDetails -Organization $organization
```
Above example returns the list of NiatelemetryApicRealmDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicRealmDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryApicRealmDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryApicRealmDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicRealmDetails under it.
