...
## SYNOPSIS
Get the StorageNetAppClusterEvent

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppClusterEvent [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppClusterEvent [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppClusterEvent&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppClusterEvent
```
Above example returns the list of StorageNetAppClusterEvent.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppClusterEvent -Name "MoName"
```
Above example returns the StorageNetAppClusterEvent matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppClusterEvent -Organization $organization
```
Above example returns the list of StorageNetAppClusterEvent available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppClusterEvent -InlineCount allpages
```
Above example returns the list of StorageNetAppClusterEvent along with count.
...
### -Name
Specifies the name of the StorageNetAppClusterEvent.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppClusterEvent under it.
