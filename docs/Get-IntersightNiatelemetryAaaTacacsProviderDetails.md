...
## SYNOPSIS
Get the NiatelemetryAaaTacacsProviderDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryAaaTacacsProviderDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryAaaTacacsProviderDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAaaTacacsProviderDetails
```
Above example returns the list of NiatelemetryAaaTacacsProviderDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAaaTacacsProviderDetails -Name "MoName"
```
Above example returns the NiatelemetryAaaTacacsProviderDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAaaTacacsProviderDetails -Organization $organization
```
Above example returns the list of NiatelemetryAaaTacacsProviderDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAaaTacacsProviderDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryAaaTacacsProviderDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryAaaTacacsProviderDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryAaaTacacsProviderDetails under it.
