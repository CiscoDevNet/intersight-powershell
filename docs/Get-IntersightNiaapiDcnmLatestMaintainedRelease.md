...
## SYNOPSIS
Get the NiaapiDcnmLatestMaintainedRelease

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiDcnmLatestMaintainedRelease [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiDcnmLatestMaintainedRelease [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmLatestMaintainedRelease
```
Above example returns the list of NiaapiDcnmLatestMaintainedRelease.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmLatestMaintainedRelease -Name "MoName"
```
Above example returns the NiaapiDcnmLatestMaintainedRelease matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmLatestMaintainedRelease -Organization $organization
```
Above example returns the list of NiaapiDcnmLatestMaintainedRelease available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmLatestMaintainedRelease -InlineCount allpages
```
Above example returns the list of NiaapiDcnmLatestMaintainedRelease along with count.
...
### -Name
Specifies the name of the NiaapiDcnmLatestMaintainedRelease.
...
### -Organization
Specifies the organization, to fetch the NiaapiDcnmLatestMaintainedRelease under it.
