...
```powershell
$CapabilityChassisDescriptorResponse = Initialize-IntersightCapabilityChassisDescriptorResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilityChassisDescriptorResponse | ConvertTo-JSON
```
