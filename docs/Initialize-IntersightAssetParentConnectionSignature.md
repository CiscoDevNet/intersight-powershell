...
```yaml
Type: AssetParentConnectionSignature.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: AssetParentConnectionSignature.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightAssetParentConnectionSignature
```
