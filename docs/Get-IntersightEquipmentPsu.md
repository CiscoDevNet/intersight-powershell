...
# Get-IntersightEquipmentPsu

## SYNOPSIS
Get the EquipmentPsu

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentPsu [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentPsu [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentPsu&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentPsu
```
Above example returns the list of EquipmentPsu.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentPsu -Name "MoName"
```
Above example returns the EquipmentPsu matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentPsu -Organization $organization
```
Above example returns the list of EquipmentPsu available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentPsu -InlineCount allpages
```
Above example returns the list of EquipmentPsu along with count.
...
### -Name
Specifies the name of the EquipmentPsu.
...
### -Organization
Specifies the organization, to fetch the EquipmentPsu under it.
...
[Set-IntersightEquipmentPsu](./Set-IntersightEquipmentPsu.md)
