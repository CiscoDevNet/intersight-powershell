...
Set-IntersightKubernetesAciCniApic [-AciCniProfiles< System.Collections.Generic.List`1[KubernetesAciCniProfileRelationship]>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AssetApicMoid< string>][[-Moid]< string>][-NumAciCniProfiles< long>][-Organization< OrganizationOrganizationRelationship>][-RegisteredDevice< AssetDeviceRegistrationRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> Set-IntersightKubernetesAciCniApic
```
