...
## SYNOPSIS
Get the KubernetesAddonRepository

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesAddonRepository [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesAddonRepository [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KubernetesAddonRepository&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesAddonRepository
```
Above example returns the list of KubernetesAddonRepository.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesAddonRepository -Name "MoName"
```
Above example returns the KubernetesAddonRepository matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesAddonRepository -Organization $organization
```
Above example returns the list of KubernetesAddonRepository available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesAddonRepository -InlineCount allpages
```
Above example returns the list of KubernetesAddonRepository along with count.
...
### -Name
Specifies the name of the KubernetesAddonRepository.
...
### -Organization
Specifies the organization, to fetch the KubernetesAddonRepository under it.
