...
# Initialize-IntersightWorkflowSolutionActionInstance
...
Initialize-IntersightWorkflowSolutionActionInstance [-Action< WorkflowSolutionActionInstance.ActionEnum>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< WorkflowSolutionActionInstance.ClassIdEnum>][-Input< object>][-Moid< string>][-ObjectType< WorkflowSolutionActionInstance.ObjectTypeEnum>][-SolutionActionDefinition< Model.WorkflowSolutionActionDefinitionRelationship>][-SolutionInstance< Model.WorkflowSolutionInstanceRelationship>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowSolutionActionInstance.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowSolutionActionInstance.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.WorkflowSolutionActionDefinitionRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.WorkflowSolutionInstanceRelationship
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowSolutionActionInstance
```
