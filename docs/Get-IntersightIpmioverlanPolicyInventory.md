...
# Get-IntersightIpmioverlanPolicyInventory

## SYNOPSIS
Get the IpmioverlanPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIpmioverlanPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIpmioverlanPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IpmioverlanPolicyInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIpmioverlanPolicyInventory
```
Above example returns the list of IpmioverlanPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIpmioverlanPolicyInventory -Name "MoName"
```
Above example returns the IpmioverlanPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIpmioverlanPolicyInventory -Organization $organization
```
Above example returns the list of IpmioverlanPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIpmioverlanPolicyInventory -InlineCount allpages
```
Above example returns the list of IpmioverlanPolicyInventory along with count.
...
### -Name
Specifies the name of the IpmioverlanPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the IpmioverlanPolicyInventory under it.
