...
# Get-IntersightServerMigrationKeyDetails

## SYNOPSIS
Get the ServerMigrationKeyDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightServerMigrationKeyDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightServerMigrationKeyDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ServerMigrationKeyDetails&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightServerMigrationKeyDetails
```
Above example returns the list of ServerMigrationKeyDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightServerMigrationKeyDetails -Name "MoName"
```
Above example returns the ServerMigrationKeyDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightServerMigrationKeyDetails -Organization $organization
```
Above example returns the list of ServerMigrationKeyDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightServerMigrationKeyDetails -InlineCount allpages
```
Above example returns the list of ServerMigrationKeyDetails along with count.
...
### -Name
Specifies the name of the ServerMigrationKeyDetails.
...
### -Organization
Specifies the organization, to fetch the ServerMigrationKeyDetails under it.
...
[Remove-IntersightServerMigrationKeyDetails](./Remove-IntersightServerMigrationKeyDetails.md)
