...
### CmdletParam (Default)
```
Get-IntersightBiosUnit [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBiosUnit [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBiosUnit
```
Above example returns the list of BiosUnit.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBiosUnit -Name "MoName"
```
Above example returns the BiosUnit matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBiosUnit -Organization $organization
```
Above example returns the list of BiosUnit available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBiosUnit -InlineCount allpages
```
Above example returns the list of BiosUnit along with count.
...
### -Name
Specifies the name of the BiosUnit.
...
### -Organization
Specifies the organization, to fetch the BiosUnit under it.
...
[Set-IntersightBiosUnit](./Set-IntersightBiosUnit.md)
