...
```yaml
Type: System.Collections.Generic.List`1[FabricQosClass]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> New-IntersightFabricSystemQosPolicy
```
