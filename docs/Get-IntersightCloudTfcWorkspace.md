...
## SYNOPSIS
Get the CloudTfcWorkspace

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudTfcWorkspace [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudTfcWorkspace [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudTfcWorkspace
```
Above example returns the list of CloudTfcWorkspace.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudTfcWorkspace -Name "MoName"
```
Above example returns the CloudTfcWorkspace matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudTfcWorkspace -Organization $organization
```
Above example returns the list of CloudTfcWorkspace available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudTfcWorkspace -InlineCount allpages
```
Above example returns the list of CloudTfcWorkspace along with count.
...
### -Name
Specifies the name of the CloudTfcWorkspace.
...
### -Organization
Specifies the organization, to fetch the CloudTfcWorkspace under it.
