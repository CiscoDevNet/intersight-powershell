...
## SYNOPSIS
Get the EquipmentPsuControl

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentPsuControl [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentPsuControl [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentPsuControl&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentPsuControl
```
Above example returns the list of EquipmentPsuControl.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentPsuControl -Name "MoName"
```
Above example returns the EquipmentPsuControl matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentPsuControl -Organization $organization
```
Above example returns the list of EquipmentPsuControl available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentPsuControl -InlineCount allpages
```
Above example returns the list of EquipmentPsuControl along with count.
...
### -Name
Specifies the name of the EquipmentPsuControl.
...
### -Organization
Specifies the organization, to fetch the EquipmentPsuControl under it.
...
[Set-IntersightEquipmentPsuControl](./Set-IntersightEquipmentPsuControl.md)
