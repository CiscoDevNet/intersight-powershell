...
Set-IntersightExternalsiteAuthorization [-AdditionalProperties< Dictionary<string,object>>][[-Moid]< string>][-Password< string>][-RepositoryType< ExternalsiteAuthorization.RepositoryTypeEnum>][-Tags< List<MoTag>>][-UserId< string>]
