...
## SYNOPSIS
Get the ResourceMembership

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightResourceMembership [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourceMembership [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ResourceMembership&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourceMembership
```
Above example returns the list of ResourceMembership.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourceMembership -Name "MoName"
```
Above example returns the ResourceMembership matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourceMembership -Organization $organization
```
Above example returns the list of ResourceMembership available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourceMembership -InlineCount allpages
```
Above example returns the list of ResourceMembership along with count.
...
### -Name
Specifies the name of the ResourceMembership.
...
### -Organization
Specifies the organization, to fetch the ResourceMembership under it.
