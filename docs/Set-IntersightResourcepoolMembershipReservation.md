...
# Set-IntersightResourcepoolMembershipReservation
...
Set-IntersightResourcepoolMembershipReservation [-Account< IamAccountRelationship>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Description< string>][-Expiration< DateTime>][-Identity< MoBaseMoRelationship>][[-Moid]< string>][-Pools< System.Collections.Generic.List`1[ResourcepoolPoolRelationship]>][-ReservationSelector< string>][-ResourceType< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;ResourcepoolMembershipReservation&apos; resource.
...
```yaml
Type: System.Collections.Generic.List`1[ResourcepoolPoolRelationship]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Set-IntersightResourcepoolMembershipReservation
```
