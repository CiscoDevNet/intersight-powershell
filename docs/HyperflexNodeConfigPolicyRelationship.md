...
```powershell
$HyperflexNodeConfigPolicyRelationship = Initialize-IntersightHyperflexNodeConfigPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexNodeConfigPolicyRelationship | ConvertTo-JSON
```
