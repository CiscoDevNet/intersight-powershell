...
```powershell
$HyperflexProxySettingPolicyRelationship = Initialize-IntersightHyperflexProxySettingPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexProxySettingPolicyRelationship | ConvertTo-JSON
```
