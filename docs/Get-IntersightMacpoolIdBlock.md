...
# Get-IntersightMacpoolIdBlock

## SYNOPSIS
Get the MacpoolIdBlock

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMacpoolIdBlock [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMacpoolIdBlock [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;MacpoolIdBlock&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMacpoolIdBlock
```
Above example returns the list of MacpoolIdBlock.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMacpoolIdBlock -Name "MoName"
```
Above example returns the MacpoolIdBlock matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMacpoolIdBlock -Organization $organization
```
Above example returns the list of MacpoolIdBlock available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMacpoolIdBlock -InlineCount allpages
```
Above example returns the list of MacpoolIdBlock along with count.
...
### -Name
Specifies the name of the MacpoolIdBlock.
...
### -Organization
Specifies the organization, to fetch the MacpoolIdBlock under it.
