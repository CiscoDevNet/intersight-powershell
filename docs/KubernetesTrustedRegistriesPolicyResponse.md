...
```powershell
$KubernetesTrustedRegistriesPolicyResponse = Initialize-IntersightKubernetesTrustedRegistriesPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$KubernetesTrustedRegistriesPolicyResponse | ConvertTo-JSON
```
