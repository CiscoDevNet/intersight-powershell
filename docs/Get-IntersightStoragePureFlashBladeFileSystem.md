...
# Get-IntersightStoragePureFlashBladeFileSystem

## SYNOPSIS
Get the StoragePureFlashBladeFileSystem

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureFlashBladeFileSystem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureFlashBladeFileSystem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureFlashBladeFileSystem&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureFlashBladeFileSystem
```
Above example returns the list of StoragePureFlashBladeFileSystem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureFlashBladeFileSystem -Name "MoName"
```
Above example returns the StoragePureFlashBladeFileSystem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureFlashBladeFileSystem -Organization $organization
```
Above example returns the list of StoragePureFlashBladeFileSystem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureFlashBladeFileSystem -InlineCount allpages
```
Above example returns the list of StoragePureFlashBladeFileSystem along with count.
...
### -Name
Specifies the name of the StoragePureFlashBladeFileSystem.
...
### -Organization
Specifies the organization, to fetch the StoragePureFlashBladeFileSystem under it.
