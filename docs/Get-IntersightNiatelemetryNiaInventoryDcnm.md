...
## SYNOPSIS
Get the NiatelemetryNiaInventoryDcnm

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryNiaInventoryDcnm [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryNiaInventoryDcnm [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaInventoryDcnm
```
Above example returns the list of NiatelemetryNiaInventoryDcnm.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaInventoryDcnm -Name "MoName"
```
Above example returns the NiatelemetryNiaInventoryDcnm matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaInventoryDcnm -Organization $organization
```
Above example returns the list of NiatelemetryNiaInventoryDcnm available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaInventoryDcnm -InlineCount allpages
```
Above example returns the list of NiatelemetryNiaInventoryDcnm along with count.
...
### -Name
Specifies the name of the NiatelemetryNiaInventoryDcnm.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryNiaInventoryDcnm under it.
