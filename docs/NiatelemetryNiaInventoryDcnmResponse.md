...
```powershell
$NiatelemetryNiaInventoryDcnmResponse = Initialize-IntersightNiatelemetryNiaInventoryDcnmResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiatelemetryNiaInventoryDcnmResponse | ConvertTo-JSON
```
