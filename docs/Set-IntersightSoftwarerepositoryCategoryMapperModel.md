...
Set-IntersightSoftwarerepositoryCategoryMapperModel [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Category< string>][-DistTag< string>][-ImageType< string>][-IsNfsUpgradeSupported< bool>][[-Moid]< string>][-Name< string>][-RegexPattern< string>][-SeriesId< string>][-SupportedModels< System.Collections.Generic.List`1[string]>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
