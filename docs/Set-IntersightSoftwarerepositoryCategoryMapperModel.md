...
Set-IntersightSoftwarerepositoryCategoryMapperModel [-AdditionalProperties< Dictionary<string,object>>][-Category< string>][-DistTag< string>][-ImageType< string>][[-Moid]< string>][-Name< string>][-RegexPattern< string>][-SeriesId< string>][-SupportedModels< List<string>>][-Tags< List<MoTag>>]
