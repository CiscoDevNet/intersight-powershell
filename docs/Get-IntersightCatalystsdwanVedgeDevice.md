...
# Get-IntersightCatalystsdwanVedgeDevice

## SYNOPSIS
Get the CatalystsdwanVedgeDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCatalystsdwanVedgeDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCatalystsdwanVedgeDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CatalystsdwanVedgeDevice&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanVedgeDevice
```
Above example returns the list of CatalystsdwanVedgeDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanVedgeDevice -Name "MoName"
```
Above example returns the CatalystsdwanVedgeDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanVedgeDevice -Organization $organization
```
Above example returns the list of CatalystsdwanVedgeDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanVedgeDevice -InlineCount allpages
```
Above example returns the list of CatalystsdwanVedgeDevice along with count.
...
### -Name
Specifies the name of the CatalystsdwanVedgeDevice.
...
### -Organization
Specifies the organization, to fetch the CatalystsdwanVedgeDevice under it.
