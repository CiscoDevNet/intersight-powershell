...
# Get-IntersightIaasCustomTaskInfo

## SYNOPSIS
Get the IaasCustomTaskInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIaasCustomTaskInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIaasCustomTaskInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IaasCustomTaskInfo&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIaasCustomTaskInfo
```
Above example returns the list of IaasCustomTaskInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIaasCustomTaskInfo -Name "MoName"
```
Above example returns the IaasCustomTaskInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIaasCustomTaskInfo -Organization $organization
```
Above example returns the list of IaasCustomTaskInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIaasCustomTaskInfo -InlineCount allpages
```
Above example returns the list of IaasCustomTaskInfo along with count.
...
### -Name
Specifies the name of the IaasCustomTaskInfo.
...
### -Organization
Specifies the organization, to fetch the IaasCustomTaskInfo under it.
