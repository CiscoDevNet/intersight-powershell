...
# Get-IntersightStoragePureDirectorySnapshot

## SYNOPSIS
Get the StoragePureDirectorySnapshot

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureDirectorySnapshot [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureDirectorySnapshot [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureDirectorySnapshot&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectorySnapshot
```
Above example returns the list of StoragePureDirectorySnapshot.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectorySnapshot -Name "MoName"
```
Above example returns the StoragePureDirectorySnapshot matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectorySnapshot -Organization $organization
```
Above example returns the list of StoragePureDirectorySnapshot available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectorySnapshot -InlineCount allpages
```
Above example returns the list of StoragePureDirectorySnapshot along with count.
...
### -Name
Specifies the name of the StoragePureDirectorySnapshot.
...
### -Organization
Specifies the organization, to fetch the StoragePureDirectorySnapshot under it.
