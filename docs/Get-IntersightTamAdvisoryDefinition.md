...
## SYNOPSIS
Get the TamAdvisoryDefinition

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightTamAdvisoryDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightTamAdvisoryDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;TamAdvisoryDefinition&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightTamAdvisoryDefinition
```
Above example returns the list of TamAdvisoryDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightTamAdvisoryDefinition -Name "MoName"
```
Above example returns the TamAdvisoryDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightTamAdvisoryDefinition -Organization $organization
```
Above example returns the list of TamAdvisoryDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightTamAdvisoryDefinition -InlineCount allpages
```
Above example returns the list of TamAdvisoryDefinition along with count.
...
### -Name
Specifies the name of the TamAdvisoryDefinition.
...
### -Organization
Specifies the organization, to fetch the TamAdvisoryDefinition under it.
