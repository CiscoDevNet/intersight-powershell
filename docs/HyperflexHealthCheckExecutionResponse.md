...
```powershell
$HyperflexHealthCheckExecutionResponse = Initialize-IntersightHyperflexHealthCheckExecutionResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexHealthCheckExecutionResponse | ConvertTo-JSON
```
