...
# Set-IntersightPartnerintegrationFile
...
Set-IntersightPartnerintegrationFile [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Catalog< SoftwarerepositoryCatalogRelationship>][-Description< string>][-FileType< PartnerintegrationFile.FileTypeEnum>][-ImportAction< PartnerintegrationFile.ImportActionEnum>][-ImportState< PartnerintegrationFile.ImportStateEnum>][-Md5eTag< string>][-Md5sum< string>][[-Moid]< string>][-Name< string>][-ReleaseDate< DateTime>][-Sha512sum< string>][-Size< long>][-SoftwareAdvisoryUrl< string>][-Source< SoftwarerepositoryFileServer>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Version< string>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;PartnerintegrationFile&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightPartnerintegrationFile
```
