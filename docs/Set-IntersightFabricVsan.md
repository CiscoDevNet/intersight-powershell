...
Set-IntersightFabricVsan [-AdditionalProperties< Dictionary<string,object>>][-DefaultZoning< FabricVsan.DefaultZoningEnum>][-FcNetworkPolicy< FabricFcNetworkPolicyRelationship>][-FcZoneSharingMode< string>][-FcoeVlan< long>][[-Moid]< string>][-Name< string>][-Tags< List<MoTag>>][-VsanId< long>]
