...
# Get-IntersightIamLdapGroupInventory

## SYNOPSIS
Get the IamLdapGroupInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamLdapGroupInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamLdapGroupInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamLdapGroupInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamLdapGroupInventory
```
Above example returns the list of IamLdapGroupInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamLdapGroupInventory -Name "MoName"
```
Above example returns the IamLdapGroupInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamLdapGroupInventory -Organization $organization
```
Above example returns the list of IamLdapGroupInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamLdapGroupInventory -InlineCount allpages
```
Above example returns the list of IamLdapGroupInventory along with count.
...
### -Name
Specifies the name of the IamLdapGroupInventory.
...
### -Organization
Specifies the organization, to fetch the IamLdapGroupInventory under it.
