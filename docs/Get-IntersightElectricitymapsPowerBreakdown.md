...
# Get-IntersightElectricitymapsPowerBreakdown

## SYNOPSIS
Get the ElectricitymapsPowerBreakdown

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightElectricitymapsPowerBreakdown [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightElectricitymapsPowerBreakdown [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ElectricitymapsPowerBreakdown&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightElectricitymapsPowerBreakdown
```
Above example returns the list of ElectricitymapsPowerBreakdown.

### Example 2
```powershell
PS C:\> $result = Get-IntersightElectricitymapsPowerBreakdown -Name "MoName"
```
Above example returns the ElectricitymapsPowerBreakdown matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightElectricitymapsPowerBreakdown -Organization $organization
```
Above example returns the list of ElectricitymapsPowerBreakdown available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightElectricitymapsPowerBreakdown -InlineCount allpages
```
Above example returns the list of ElectricitymapsPowerBreakdown along with count.
...
### -Name
Specifies the name of the ElectricitymapsPowerBreakdown.
...
### -Organization
Specifies the organization, to fetch the ElectricitymapsPowerBreakdown under it.
