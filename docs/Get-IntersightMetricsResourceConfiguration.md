...
# Get-IntersightMetricsResourceConfiguration

## SYNOPSIS
Get the MetricsResourceConfiguration

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMetricsResourceConfiguration [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMetricsResourceConfiguration [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MetricsResourceConfiguration&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMetricsResourceConfiguration
```
Above example returns the list of MetricsResourceConfiguration.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMetricsResourceConfiguration -Name "MoName"
```
Above example returns the MetricsResourceConfiguration matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMetricsResourceConfiguration -Organization $organization
```
Above example returns the list of MetricsResourceConfiguration available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMetricsResourceConfiguration -InlineCount allpages
```
Above example returns the list of MetricsResourceConfiguration along with count.
...
### -Name
Specifies the name of the MetricsResourceConfiguration.
...
### -Organization
Specifies the organization, to fetch the MetricsResourceConfiguration under it.
...
[Set-IntersightMetricsResourceConfiguration](./Set-IntersightMetricsResourceConfiguration.md)
