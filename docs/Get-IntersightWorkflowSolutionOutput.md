...
## SYNOPSIS
Get the WorkflowSolutionOutput

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowSolutionOutput [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowSolutionOutput [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowSolutionOutput&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionOutput
```
Above example returns the list of WorkflowSolutionOutput.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionOutput -Name "MoName"
```
Above example returns the WorkflowSolutionOutput matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionOutput -Organization $organization
```
Above example returns the list of WorkflowSolutionOutput available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionOutput -InlineCount allpages
```
Above example returns the list of WorkflowSolutionOutput along with count.
...
### -Name
Specifies the name of the WorkflowSolutionOutput.
...
### -Organization
Specifies the organization, to fetch the WorkflowSolutionOutput under it.
