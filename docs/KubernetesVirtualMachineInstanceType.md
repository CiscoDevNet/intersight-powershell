...
```powershell
$KubernetesVirtualMachineInstanceType = Initialize-IntersightKubernetesVirtualMachineInstanceType  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$KubernetesVirtualMachineInstanceType | ConvertTo-JSON
```
