...
## SYNOPSIS
Get the KubernetesNode

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesNode [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesNode [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KubernetesNode&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesNode
```
Above example returns the list of KubernetesNode.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesNode -Name "MoName"
```
Above example returns the KubernetesNode matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesNode -Organization $organization
```
Above example returns the list of KubernetesNode available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesNode -InlineCount allpages
```
Above example returns the list of KubernetesNode along with count.
...
### -Name
Specifies the name of the KubernetesNode.
...
### -Organization
Specifies the organization, to fetch the KubernetesNode under it.
...
[Remove-IntersightKubernetesNode](./Remove-IntersightKubernetesNode.md)
