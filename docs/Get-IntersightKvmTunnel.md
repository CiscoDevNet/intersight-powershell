...
### CmdletParam (Default)
```
Get-IntersightKvmTunnel [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKvmTunnel [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KvmTunnel&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKvmTunnel
```
Above example returns the list of KvmTunnel.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKvmTunnel -Name "MoName"
```
Above example returns the KvmTunnel matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKvmTunnel -Organization $organization
```
Above example returns the list of KvmTunnel available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKvmTunnel -InlineCount allpages
```
Above example returns the list of KvmTunnel along with count.
...
### -Name
Specifies the name of the KvmTunnel.
...
### -Organization
Specifies the organization, to fetch the KvmTunnel under it.
...
[New-IntersightKvmTunnel](./New-IntersightKvmTunnel.md)
