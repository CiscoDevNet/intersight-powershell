...
```powershell
$SoftwareHyperflexBundleDistributableResponse = Initialize-IntersightSoftwareHyperflexBundleDistributableResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwareHyperflexBundleDistributableResponse | ConvertTo-JSON
```
