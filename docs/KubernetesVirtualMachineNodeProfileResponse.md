...
```powershell
$KubernetesVirtualMachineNodeProfileResponse = Initialize-IntersightKubernetesVirtualMachineNodeProfileResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$KubernetesVirtualMachineNodeProfileResponse | ConvertTo-JSON
```
