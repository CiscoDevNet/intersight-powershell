...
# Get-IntersightApplianceBackupMonitor

## SYNOPSIS
Get the ApplianceBackupMonitor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceBackupMonitor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceBackupMonitor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceBackupMonitor&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceBackupMonitor
```
Above example returns the list of ApplianceBackupMonitor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceBackupMonitor -Name "MoName"
```
Above example returns the ApplianceBackupMonitor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceBackupMonitor -Organization $organization
```
Above example returns the list of ApplianceBackupMonitor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceBackupMonitor -InlineCount allpages
```
Above example returns the list of ApplianceBackupMonitor along with count.
...
### -Name
Specifies the name of the ApplianceBackupMonitor.
...
### -Organization
Specifies the organization, to fetch the ApplianceBackupMonitor under it.
