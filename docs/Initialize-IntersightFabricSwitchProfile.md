...
# Initialize-IntersightFabricSwitchProfile
...
```yaml
Type: FabricSwitchProfile.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricSwitchProfile.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.FabricSwitchClusterProfileRelationship
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFabricSwitchProfile
```
