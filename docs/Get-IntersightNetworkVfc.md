...
### CmdletParam (Default)
```
Get-IntersightNetworkVfc [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkVfc [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
