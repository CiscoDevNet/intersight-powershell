...
# Get-IntersightIamPermission

## SYNOPSIS
Get the IamPermission

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamPermission [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamPermission [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamPermission&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamPermission
```
Above example returns the list of IamPermission.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamPermission -Name "MoName"
```
Above example returns the IamPermission matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamPermission -Organization $organization
```
Above example returns the list of IamPermission available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamPermission -InlineCount allpages
```
Above example returns the list of IamPermission along with count.
...
### -Name
Specifies the name of the IamPermission.
...
### -Organization
Specifies the organization, to fetch the IamPermission under it.
