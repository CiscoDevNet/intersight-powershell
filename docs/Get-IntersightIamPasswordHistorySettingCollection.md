...
# Get-IntersightIamPasswordHistorySettingCollection

## SYNOPSIS
Get the IamPasswordHistorySettingCollection

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamPasswordHistorySettingCollection [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamPasswordHistorySettingCollection [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamPasswordHistorySettingCollection&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamPasswordHistorySettingCollection
```
Above example returns the list of IamPasswordHistorySettingCollection.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamPasswordHistorySettingCollection -Name "MoName"
```
Above example returns the IamPasswordHistorySettingCollection matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamPasswordHistorySettingCollection -Organization $organization
```
Above example returns the list of IamPasswordHistorySettingCollection available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamPasswordHistorySettingCollection -InlineCount allpages
```
Above example returns the list of IamPasswordHistorySettingCollection along with count.
...
### -Name
Specifies the name of the IamPasswordHistorySettingCollection.
...
### -Organization
Specifies the organization, to fetch the IamPasswordHistorySettingCollection under it.
