...
## SYNOPSIS
Get the FabricPcMember

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricPcMember [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricPcMember [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricPcMember&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricPcMember
```
Above example returns the list of FabricPcMember.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricPcMember -Name "MoName"
```
Above example returns the FabricPcMember matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricPcMember -Organization $organization
```
Above example returns the list of FabricPcMember available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricPcMember -InlineCount allpages
```
Above example returns the list of FabricPcMember along with count.
...
### -Name
Specifies the name of the FabricPcMember.
...
### -Organization
Specifies the organization, to fetch the FabricPcMember under it.
