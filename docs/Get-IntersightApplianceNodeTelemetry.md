...
# Get-IntersightApplianceNodeTelemetry

## SYNOPSIS
Get the ApplianceNodeTelemetry

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceNodeTelemetry [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceNodeTelemetry [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceNodeTelemetry&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceNodeTelemetry
```
Above example returns the list of ApplianceNodeTelemetry.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceNodeTelemetry -Name "MoName"
```
Above example returns the ApplianceNodeTelemetry matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceNodeTelemetry -Organization $organization
```
Above example returns the list of ApplianceNodeTelemetry available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceNodeTelemetry -InlineCount allpages
```
Above example returns the list of ApplianceNodeTelemetry along with count.
...
### -Name
Specifies the name of the ApplianceNodeTelemetry.
...
### -Organization
Specifies the organization, to fetch the ApplianceNodeTelemetry under it.
