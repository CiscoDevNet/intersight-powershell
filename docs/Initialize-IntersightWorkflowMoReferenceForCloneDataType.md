...
# Initialize-IntersightWorkflowMoReferenceForCloneDataType
...
Initialize-IntersightWorkflowMoReferenceForCloneDataType [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< WorkflowMoReferenceForCloneDataType.ClassIdEnum>][-Default< Model.WorkflowDefaultValue>][-Description< string>][-DisplayMeta< Model.WorkflowDisplayMeta>][-InputParameters< object>][-Label< string>][-Name< string>][-ObjectType< WorkflowMoReferenceForCloneDataType.ObjectTypeEnum>][-Properties< System.Collections.Generic.List`1[Model.WorkflowMoReferenceProperty]>][-Required< bool>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowMoReferenceForCloneDataType.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowMoReferenceForCloneDataType.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowMoReferenceForCloneDataType
```
