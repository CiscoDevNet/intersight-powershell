...
```powershell
$StorageNetAppExportPolicyResponse = Initialize-IntersightStorageNetAppExportPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageNetAppExportPolicyResponse | ConvertTo-JSON
```
