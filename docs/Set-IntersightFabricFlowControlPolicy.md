...
Set-IntersightFabricFlowControlPolicy [-AdditionalProperties< Dictionary<string,object>>][-Description< string>][[-Moid]< string>][-Name< string>][-Organization< OrganizationOrganizationRelationship>][-PriorityFlowControlMode< FabricFlowControlPolicy.PriorityFlowControlModeEnum>][-ReceiveDirection< FabricFlowControlPolicy.ReceiveDirectionEnum>][-SendDirection< FabricFlowControlPolicy.SendDirectionEnum>][-Tags< List<MoTag>>]
