...
## SYNOPSIS
Get the NiaapiVersionRegex

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiVersionRegex [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiVersionRegex [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiaapiVersionRegex&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiVersionRegex
```
Above example returns the list of NiaapiVersionRegex.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiVersionRegex -Name "MoName"
```
Above example returns the NiaapiVersionRegex matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiVersionRegex -Organization $organization
```
Above example returns the list of NiaapiVersionRegex available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiVersionRegex -InlineCount allpages
```
Above example returns the list of NiaapiVersionRegex along with count.
...
### -Name
Specifies the name of the NiaapiVersionRegex.
...
### -Organization
Specifies the organization, to fetch the NiaapiVersionRegex under it.
