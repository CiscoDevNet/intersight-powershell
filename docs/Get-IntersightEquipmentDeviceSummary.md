...
### CmdletParam (Default)
```
Get-IntersightEquipmentDeviceSummary [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentDeviceSummary [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentDeviceSummary
```
Above example returns the list of EquipmentDeviceSummary.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentDeviceSummary -Name "MoName"
```
Above example returns the EquipmentDeviceSummary matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentDeviceSummary -Organization $organization
```
Above example returns the list of EquipmentDeviceSummary available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentDeviceSummary -InlineCount allpages
```
Above example returns the list of EquipmentDeviceSummary along with count.
...
### -Name
Specifies the name of the EquipmentDeviceSummary.
...
### -Organization
Specifies the organization, to fetch the EquipmentDeviceSummary under it.
