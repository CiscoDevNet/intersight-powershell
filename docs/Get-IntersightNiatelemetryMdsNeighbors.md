...
# Get-IntersightNiatelemetryMdsNeighbors

## SYNOPSIS
Get the NiatelemetryMdsNeighbors

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryMdsNeighbors [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryMdsNeighbors [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryMdsNeighbors&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMdsNeighbors
```
Above example returns the list of NiatelemetryMdsNeighbors.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMdsNeighbors -Name "MoName"
```
Above example returns the NiatelemetryMdsNeighbors matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMdsNeighbors -Organization $organization
```
Above example returns the list of NiatelemetryMdsNeighbors available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMdsNeighbors -InlineCount allpages
```
Above example returns the list of NiatelemetryMdsNeighbors along with count.
...
### -Name
Specifies the name of the NiatelemetryMdsNeighbors.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryMdsNeighbors under it.
