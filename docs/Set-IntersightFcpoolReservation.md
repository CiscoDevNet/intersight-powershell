...
# Set-IntersightFcpoolReservation
...
Set-IntersightFcpoolReservation [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AllocationType< FcpoolReservation.AllocationTypeEnum>][-IdPurpose< string>][-Identity< string>][[-Moid]< string>][-Organization< OrganizationOrganizationRelationship>][-Pool< FcpoolPoolRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;FcpoolReservation&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightFcpoolReservation
```
