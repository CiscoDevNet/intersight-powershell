...
## SYNOPSIS
Get the WorkflowTaskInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowTaskInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowTaskInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;WorkflowTaskInfo&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskInfo
```
Above example returns the list of WorkflowTaskInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskInfo -Name "MoName"
```
Above example returns the WorkflowTaskInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskInfo -Organization $organization
```
Above example returns the list of WorkflowTaskInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskInfo -InlineCount allpages
```
Above example returns the list of WorkflowTaskInfo along with count.
...
### -Name
Specifies the name of the WorkflowTaskInfo.
...
### -Organization
Specifies the organization, to fetch the WorkflowTaskInfo under it.
...
[Set-IntersightWorkflowTaskInfo](./Set-IntersightWorkflowTaskInfo.md)
