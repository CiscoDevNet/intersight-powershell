...
## SYNOPSIS
Get the LicenseIksLicenseCount

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightLicenseIksLicenseCount [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightLicenseIksLicenseCount [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;LicenseIksLicenseCount&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightLicenseIksLicenseCount
```
Above example returns the list of LicenseIksLicenseCount.

### Example 2
```powershell
PS C:\> $result = Get-IntersightLicenseIksLicenseCount -Name "MoName"
```
Above example returns the LicenseIksLicenseCount matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightLicenseIksLicenseCount -Organization $organization
```
Above example returns the list of LicenseIksLicenseCount available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightLicenseIksLicenseCount -InlineCount allpages
```
Above example returns the list of LicenseIksLicenseCount along with count.
...
### -Name
Specifies the name of the LicenseIksLicenseCount.
...
### -Organization
Specifies the organization, to fetch the LicenseIksLicenseCount under it.
