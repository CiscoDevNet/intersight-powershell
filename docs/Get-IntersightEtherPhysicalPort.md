...
## SYNOPSIS
Get the EtherPhysicalPort

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEtherPhysicalPort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEtherPhysicalPort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EtherPhysicalPort&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEtherPhysicalPort
```
Above example returns the list of EtherPhysicalPort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEtherPhysicalPort -Name "MoName"
```
Above example returns the EtherPhysicalPort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEtherPhysicalPort -Organization $organization
```
Above example returns the list of EtherPhysicalPort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEtherPhysicalPort -InlineCount allpages
```
Above example returns the list of EtherPhysicalPort along with count.
...
### -Name
Specifies the name of the EtherPhysicalPort.
...
### -Organization
Specifies the organization, to fetch the EtherPhysicalPort under it.
...
[Set-IntersightEtherPhysicalPort](./Set-IntersightEtherPhysicalPort.md)
