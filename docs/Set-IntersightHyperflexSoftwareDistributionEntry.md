...
Set-IntersightHyperflexSoftwareDistributionEntry [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AppCatalog< HyperflexAppCatalogRelationship>][-DistributionType< string>][-DistributionVersions< System.Collections.Generic.List`1[HyperflexSoftwareDistributionVersionRelationship]>][[-Moid]< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
