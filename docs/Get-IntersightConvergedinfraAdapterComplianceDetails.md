...
### CmdletParam (Default)
```
Get-IntersightConvergedinfraAdapterComplianceDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightConvergedinfraAdapterComplianceDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
