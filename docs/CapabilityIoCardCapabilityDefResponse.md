...
```powershell
$CapabilityIoCardCapabilityDefResponse = Initialize-IntersightCapabilityIoCardCapabilityDefResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilityIoCardCapabilityDefResponse | ConvertTo-JSON
```
