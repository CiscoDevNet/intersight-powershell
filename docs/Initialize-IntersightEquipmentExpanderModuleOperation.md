...
```yaml
Type: EquipmentExpanderModuleOperation.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: EquipmentExpanderModuleOperation.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightEquipmentExpanderModuleOperation
```
