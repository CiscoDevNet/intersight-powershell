...
## SYNOPSIS
Get the NiatelemetryLc

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryLc [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryLc [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryLc&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryLc
```
Above example returns the list of NiatelemetryLc.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryLc -Name "MoName"
```
Above example returns the NiatelemetryLc matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryLc -Organization $organization
```
Above example returns the list of NiatelemetryLc available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryLc -InlineCount allpages
```
Above example returns the list of NiatelemetryLc along with count.
...
### -Name
Specifies the name of the NiatelemetryLc.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryLc under it.
