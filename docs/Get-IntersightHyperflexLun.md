...
# Get-IntersightHyperflexLun

## SYNOPSIS
Get the HyperflexLun

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexLun [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexLun [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexLun&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexLun
```
Above example returns the list of HyperflexLun.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexLun -Name "MoName"
```
Above example returns the HyperflexLun matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexLun -Organization $organization
```
Above example returns the list of HyperflexLun available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexLun -InlineCount allpages
```
Above example returns the list of HyperflexLun along with count.
...
### -Name
Specifies the name of the HyperflexLun.
...
### -Organization
Specifies the organization, to fetch the HyperflexLun under it.
...
[Set-IntersightHyperflexLun](./Set-IntersightHyperflexLun.md)
