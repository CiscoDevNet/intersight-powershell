...
```powershell
$VirtualizationBaseVirtualDiskRelationship = Initialize-IntersightVirtualizationBaseVirtualDiskRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$VirtualizationBaseVirtualDiskRelationship | ConvertTo-JSON
```
