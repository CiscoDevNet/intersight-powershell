...
## SYNOPSIS
Get the KubernetesClusterProfile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesClusterProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesClusterProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KubernetesClusterProfile&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesClusterProfile
```
Above example returns the list of KubernetesClusterProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesClusterProfile -Name "MoName"
```
Above example returns the KubernetesClusterProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesClusterProfile -Organization $organization
```
Above example returns the list of KubernetesClusterProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesClusterProfile -InlineCount allpages
```
Above example returns the list of KubernetesClusterProfile along with count.
...
### -Name
Specifies the name of the KubernetesClusterProfile.
...
### -Organization
Specifies the organization, to fetch the KubernetesClusterProfile under it.
