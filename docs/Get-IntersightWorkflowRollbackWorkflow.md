...
## SYNOPSIS
Get the WorkflowRollbackWorkflow

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowRollbackWorkflow [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowRollbackWorkflow [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowRollbackWorkflow
```
Above example returns the list of WorkflowRollbackWorkflow.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowRollbackWorkflow -Name "MoName"
```
Above example returns the WorkflowRollbackWorkflow matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowRollbackWorkflow -Organization $organization
```
Above example returns the list of WorkflowRollbackWorkflow available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowRollbackWorkflow -InlineCount allpages
```
Above example returns the list of WorkflowRollbackWorkflow along with count.
...
### -Name
Specifies the name of the WorkflowRollbackWorkflow.
...
### -Organization
Specifies the organization, to fetch the WorkflowRollbackWorkflow under it.
