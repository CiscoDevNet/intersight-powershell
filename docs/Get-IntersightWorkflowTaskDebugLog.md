...
## SYNOPSIS
Get the WorkflowTaskDebugLog

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowTaskDebugLog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowTaskDebugLog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;WorkflowTaskDebugLog&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskDebugLog
```
Above example returns the list of WorkflowTaskDebugLog.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskDebugLog -Name "MoName"
```
Above example returns the WorkflowTaskDebugLog matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskDebugLog -Organization $organization
```
Above example returns the list of WorkflowTaskDebugLog available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowTaskDebugLog -InlineCount allpages
```
Above example returns the list of WorkflowTaskDebugLog along with count.
...
### -Name
Specifies the name of the WorkflowTaskDebugLog.
...
### -Organization
Specifies the organization, to fetch the WorkflowTaskDebugLog under it.
