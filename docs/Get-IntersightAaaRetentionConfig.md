...
# Get-IntersightAaaRetentionConfig

## SYNOPSIS
Get the AaaRetentionConfig

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAaaRetentionConfig [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAaaRetentionConfig [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAaaRetentionConfig
```
Above example returns the list of AaaRetentionConfig.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAaaRetentionConfig -Name "MoName"
```
Above example returns the AaaRetentionConfig matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAaaRetentionConfig -Organization $organization
```
Above example returns the list of AaaRetentionConfig available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAaaRetentionConfig -InlineCount allpages
```
Above example returns the list of AaaRetentionConfig along with count.
...
### -Name
Specifies the name of the AaaRetentionConfig.
...
### -Organization
Specifies the organization, to fetch the AaaRetentionConfig under it.
