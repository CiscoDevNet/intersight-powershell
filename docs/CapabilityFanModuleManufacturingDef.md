...
```powershell
$CapabilityFanModuleManufacturingDef = Initialize-IntersightCapabilityFanModuleManufacturingDef  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$CapabilityFanModuleManufacturingDef | ConvertTo-JSON
```
