...
## SYNOPSIS
Get the StorageNetAppNtpServer

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppNtpServer [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppNtpServer [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppNtpServer&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNtpServer
```
Above example returns the list of StorageNetAppNtpServer.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNtpServer -Name "MoName"
```
Above example returns the StorageNetAppNtpServer matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNtpServer -Organization $organization
```
Above example returns the list of StorageNetAppNtpServer available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNtpServer -InlineCount allpages
```
Above example returns the list of StorageNetAppNtpServer along with count.
...
### -Name
Specifies the name of the StorageNetAppNtpServer.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppNtpServer under it.
