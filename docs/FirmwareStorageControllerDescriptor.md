...
```powershell
$FirmwareStorageControllerDescriptor = Initialize-IntersightFirmwareStorageControllerDescriptor  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$FirmwareStorageControllerDescriptor | ConvertTo-JSON
```
