...
## SYNOPSIS
Get the NiatelemetryAppDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryAppDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryAppDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetryAppDetails&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAppDetails
```
Above example returns the list of NiatelemetryAppDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAppDetails -Name "MoName"
```
Above example returns the NiatelemetryAppDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAppDetails -Organization $organization
```
Above example returns the list of NiatelemetryAppDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAppDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryAppDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryAppDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryAppDetails under it.
