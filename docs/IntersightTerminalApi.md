# Intersight.Intersight/Api.IntersightTerminalApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Get-IntersightTerminalAuditLogByMoid**](IntersightTerminalApi.md#Get-IntersightTerminalAuditLogByMoid) | **GET** /api/v1/terminal/AuditLogs/{Moid} | Read a &#39;terminal.AuditLog&#39; resource.
[**Get-IntersightTerminalAuditLogList**](IntersightTerminalApi.md#Get-IntersightTerminalAuditLogList) | **GET** /api/v1/terminal/AuditLogs | Read a &#39;terminal.AuditLog&#39; resource.


<a name="Get-IntersightTerminalAuditLogByMoid"></a>
# **Get-IntersightTerminalAuditLogByMoid**
> TerminalAuditLog Get-IntersightTerminalAuditLogByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'terminal.AuditLog' resource.
try {
    TerminalAuditLog $Result = Get-IntersightTerminalAuditLogByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightTerminalAuditLogByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a name="Get-IntersightTerminalAuditLogList"></a>
# **Get-IntersightTerminalAuditLogList**
> TerminalAuditLogResponse Get-IntersightTerminalAuditLogList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'terminal.AuditLog' resource.
try {
    TerminalAuditLogResponse $Result = Get-IntersightTerminalAuditLogList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightTerminalAuditLogList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
