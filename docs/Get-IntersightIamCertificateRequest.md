...
## SYNOPSIS
Get the IamCertificateRequest

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamCertificateRequest [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamCertificateRequest [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamCertificateRequest&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamCertificateRequest
```
Above example returns the list of IamCertificateRequest.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamCertificateRequest -Name "MoName"
```
Above example returns the IamCertificateRequest matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamCertificateRequest -Organization $organization
```
Above example returns the list of IamCertificateRequest available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamCertificateRequest -InlineCount allpages
```
Above example returns the list of IamCertificateRequest along with count.
...
### -Name
Specifies the name of the IamCertificateRequest.
...
### -Organization
Specifies the organization, to fetch the IamCertificateRequest under it.
