...
## SYNOPSIS
Get the ResourceLicenseResourceCount

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightResourceLicenseResourceCount [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourceLicenseResourceCount [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ResourceLicenseResourceCount&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourceLicenseResourceCount
```
Above example returns the list of ResourceLicenseResourceCount.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourceLicenseResourceCount -Name "MoName"
```
Above example returns the ResourceLicenseResourceCount matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourceLicenseResourceCount -Organization $organization
```
Above example returns the list of ResourceLicenseResourceCount available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourceLicenseResourceCount -InlineCount allpages
```
Above example returns the list of ResourceLicenseResourceCount along with count.
...
### -Name
Specifies the name of the ResourceLicenseResourceCount.
...
### -Organization
Specifies the organization, to fetch the ResourceLicenseResourceCount under it.
