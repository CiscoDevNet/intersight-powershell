...
# Initialize-IntersightTaskPureFlashBladeScopedInventory
...
Initialize-IntersightTaskPureFlashBladeScopedInventory [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< TaskPureFlashBladeScopedInventory.ClassIdEnum>][-Immediate< bool>][-Moid< string>][-NamingProperty< string>][-ObjectType< TaskPureFlashBladeScopedInventory.ObjectTypeEnum>][-Queries< object>][-RegisteredDevice< Model.AssetDeviceRegistrationRelationship>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Type< string>][-Values< System.Collections.Generic.List`1[string]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: TaskPureFlashBladeScopedInventory.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TaskPureFlashBladeScopedInventory.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTaskPureFlashBladeScopedInventory
```
