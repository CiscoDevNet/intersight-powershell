...
### CmdletParam (Default)
```
Get-IntersightCapabilityChassisManufacturingDef [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityChassisManufacturingDef [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityChassisManufacturingDef
```
Above example returns the list of CapabilityChassisManufacturingDef.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityChassisManufacturingDef -Name "MoName"
```
Above example returns the CapabilityChassisManufacturingDef matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityChassisManufacturingDef -Organization $organization
```
Above example returns the list of CapabilityChassisManufacturingDef available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityChassisManufacturingDef -InlineCount allpages
```
Above example returns the list of CapabilityChassisManufacturingDef along with count.
...
### -Name
Specifies the name of the CapabilityChassisManufacturingDef.
...
### -Organization
Specifies the organization, to fetch the CapabilityChassisManufacturingDef under it.
