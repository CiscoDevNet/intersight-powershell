...
# New-IntersightSdaaciConnection
...
New-IntersightSdaaciConnection [-AciL3Out< string>][-AciMatchRuleName< string>][-AciTenant< string>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ApicTarget< AssetTargetRelationship>][-CampusFabricSite< string>][-CatalystCenterTarget< AssetTargetRelationship>][-Epg< string>][-EpgSubnet< string>][-FirewallDevice< string>][-FirewallDomain< string>][-FmcTarget< AssetTargetRelationship>][-Moid< string>][-NodeProfile< string>][-Organization< OrganizationOrganizationRelationship>][-Status< SdaaciConnection.StatusEnum>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Transit< string>][-VirtualNetwork< string>][-VnEpg< string>][-Vrf< string>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;SdaaciConnection&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightSdaaciConnection
```
