...
### CmdletParam (Default)
```
Get-IntersightCertificatemanagementPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCertificatemanagementPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCertificatemanagementPolicyInventory
```
Above example returns the list of CertificatemanagementPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCertificatemanagementPolicyInventory -Name "MoName"
```
Above example returns the CertificatemanagementPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCertificatemanagementPolicyInventory -Organization $organization
```
Above example returns the list of CertificatemanagementPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCertificatemanagementPolicyInventory -InlineCount allpages
```
Above example returns the list of CertificatemanagementPolicyInventory along with count.
...
### -Name
Specifies the name of the CertificatemanagementPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the CertificatemanagementPolicyInventory under it.
