...
## SYNOPSIS
Get the FabricAppliancePcRole

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricAppliancePcRole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricAppliancePcRole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricAppliancePcRole
```
Above example returns the list of FabricAppliancePcRole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricAppliancePcRole -Name "MoName"
```
Above example returns the FabricAppliancePcRole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricAppliancePcRole -Organization $organization
```
Above example returns the list of FabricAppliancePcRole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricAppliancePcRole -InlineCount allpages
```
Above example returns the list of FabricAppliancePcRole along with count.
...
### -Name
Specifies the name of the FabricAppliancePcRole.
...
### -Organization
Specifies the organization, to fetch the FabricAppliancePcRole under it.
