...
# Get-IntersightFirmwareSecureRouterUpgrade

## SYNOPSIS
Get the FirmwareSecureRouterUpgrade

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareSecureRouterUpgrade [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareSecureRouterUpgrade [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareSecureRouterUpgrade&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareSecureRouterUpgrade
```
Above example returns the list of FirmwareSecureRouterUpgrade.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareSecureRouterUpgrade -Name "MoName"
```
Above example returns the FirmwareSecureRouterUpgrade matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareSecureRouterUpgrade -Organization $organization
```
Above example returns the list of FirmwareSecureRouterUpgrade available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareSecureRouterUpgrade -InlineCount allpages
```
Above example returns the list of FirmwareSecureRouterUpgrade along with count.
...
### -Name
Specifies the name of the FirmwareSecureRouterUpgrade.
...
### -Organization
Specifies the organization, to fetch the FirmwareSecureRouterUpgrade under it.
...
[New-IntersightFirmwareSecureRouterUpgrade](./New-IntersightFirmwareSecureRouterUpgrade.md)

[Remove-IntersightFirmwareSecureRouterUpgrade](./Remove-IntersightFirmwareSecureRouterUpgrade.md)
