...
```powershell
$HyperflexServerFirmwareVersionRelationship = Initialize-IntersightHyperflexServerFirmwareVersionRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexServerFirmwareVersionRelationship | ConvertTo-JSON
```
