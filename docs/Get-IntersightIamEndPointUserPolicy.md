...
## SYNOPSIS
Get the IamEndPointUserPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamEndPointUserPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamEndPointUserPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamEndPointUserPolicy&apos; resource.,
...
```
Above example returns the list of IamEndPointUserPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserPolicy -Name "MoName"
```
Above example returns the IamEndPointUserPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserPolicy -Organization $organization
```
Above example returns the list of IamEndPointUserPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserPolicy -InlineCount allpages
```
Above example returns the list of IamEndPointUserPolicy along with count.
...
### -Name
Specifies the name of the IamEndPointUserPolicy.
...
### -Organization
Specifies the organization, to fetch the IamEndPointUserPolicy under it.
