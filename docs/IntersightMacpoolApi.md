# Intersight.Intersight/Api.IntersightMacpoolApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**New-IntersightMacpoolPool**](IntersightMacpoolApi.md#New-IntersightMacpoolPool) | **POST** /api/v1/macpool/Pools | Create a &#39;macpool.Pool&#39; resource.
[**Remove-IntersightMacpoolPool**](IntersightMacpoolApi.md#Remove-IntersightMacpoolPool) | **DELETE** /api/v1/macpool/Pools/{Moid} | Delete a &#39;macpool.Pool&#39; resource.
[**Get-IntersightMacpoolIdBlockByMoid**](IntersightMacpoolApi.md#Get-IntersightMacpoolIdBlockByMoid) | **GET** /api/v1/macpool/IdBlocks/{Moid} | Read a &#39;macpool.IdBlock&#39; resource.
[**Get-IntersightMacpoolIdBlockList**](IntersightMacpoolApi.md#Get-IntersightMacpoolIdBlockList) | **GET** /api/v1/macpool/IdBlocks | Read a &#39;macpool.IdBlock&#39; resource.
[**Get-IntersightMacpoolLeaseByMoid**](IntersightMacpoolApi.md#Get-IntersightMacpoolLeaseByMoid) | **GET** /api/v1/macpool/Leases/{Moid} | Read a &#39;macpool.Lease&#39; resource.
[**Get-IntersightMacpoolLeaseList**](IntersightMacpoolApi.md#Get-IntersightMacpoolLeaseList) | **GET** /api/v1/macpool/Leases | Read a &#39;macpool.Lease&#39; resource.
[**Get-IntersightMacpoolPoolByMoid**](IntersightMacpoolApi.md#Get-IntersightMacpoolPoolByMoid) | **GET** /api/v1/macpool/Pools/{Moid} | Read a &#39;macpool.Pool&#39; resource.
[**Get-IntersightMacpoolPoolList**](IntersightMacpoolApi.md#Get-IntersightMacpoolPoolList) | **GET** /api/v1/macpool/Pools | Read a &#39;macpool.Pool&#39; resource.
[**Get-IntersightMacpoolPoolMemberByMoid**](IntersightMacpoolApi.md#Get-IntersightMacpoolPoolMemberByMoid) | **GET** /api/v1/macpool/PoolMembers/{Moid} | Read a &#39;macpool.PoolMember&#39; resource.
[**Get-IntersightMacpoolPoolMemberList**](IntersightMacpoolApi.md#Get-IntersightMacpoolPoolMemberList) | **GET** /api/v1/macpool/PoolMembers | Read a &#39;macpool.PoolMember&#39; resource.
[**Get-IntersightMacpoolUniverseByMoid**](IntersightMacpoolApi.md#Get-IntersightMacpoolUniverseByMoid) | **GET** /api/v1/macpool/Universes/{Moid} | Read a &#39;macpool.Universe&#39; resource.
[**Get-IntersightMacpoolUniverseList**](IntersightMacpoolApi.md#Get-IntersightMacpoolUniverseList) | **GET** /api/v1/macpool/Universes | Read a &#39;macpool.Universe&#39; resource.
[**Set-IntersightMacpoolPool**](IntersightMacpoolApi.md#Set-IntersightMacpoolPool) | **PATCH** /api/v1/macpool/Pools/{Moid} | Update a &#39;macpool.Pool&#39; resource.
[**Update-IntersightMacpoolPool**](IntersightMacpoolApi.md#Update-IntersightMacpoolPool) | **POST** /api/v1/macpool/Pools/{Moid} | Update a &#39;macpool.Pool&#39; resource.


<a name="New-IntersightMacpoolPool"></a>
# **New-IntersightMacpoolPool**
> MacpoolPool New-IntersightMacpoolPool<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MacpoolPool] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Create a 'macpool.Pool' resource.
try {
     $Result = New-IntersightMacpoolPool -MacpoolPool $MacpoolPool -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
    Write-Host ("Exception occured when calling New-IntersightMacpoolPool: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
------------- | ------------- | ------------- | -------------
 **MacpoolPool** | [**MacpoolPool**](MacpoolPool.md)| The &#39;macpool.Pool&#39; resource to create. | 
...
<a name="Remove-IntersightMacpoolPool"></a>
# **Remove-IntersightMacpoolPool**
> void Remove-IntersightMacpoolPool<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'macpool.Pool' resource.
try {
     $Result = Remove-IntersightMacpoolPool -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightMacpoolPool: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMacpoolIdBlockByMoid"></a>
# **Get-IntersightMacpoolIdBlockByMoid**
> MacpoolIdBlock Get-IntersightMacpoolIdBlockByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'macpool.IdBlock' resource.
try {
     $Result = Get-IntersightMacpoolIdBlockByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMacpoolIdBlockByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMacpoolIdBlockList"></a>
# **Get-IntersightMacpoolIdBlockList**
> MacpoolIdBlockResponse Get-IntersightMacpoolIdBlockList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'macpool.IdBlock' resource.
try {
     $Result = Get-IntersightMacpoolIdBlockList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMacpoolIdBlockList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMacpoolLeaseByMoid"></a>
# **Get-IntersightMacpoolLeaseByMoid**
> MacpoolLease Get-IntersightMacpoolLeaseByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'macpool.Lease' resource.
try {
     $Result = Get-IntersightMacpoolLeaseByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMacpoolLeaseByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMacpoolLeaseList"></a>
# **Get-IntersightMacpoolLeaseList**
> MacpoolLeaseResponse Get-IntersightMacpoolLeaseList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'macpool.Lease' resource.
try {
     $Result = Get-IntersightMacpoolLeaseList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMacpoolLeaseList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMacpoolPoolByMoid"></a>
# **Get-IntersightMacpoolPoolByMoid**
> MacpoolPool Get-IntersightMacpoolPoolByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'macpool.Pool' resource.
try {
     $Result = Get-IntersightMacpoolPoolByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMacpoolPoolByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMacpoolPoolList"></a>
# **Get-IntersightMacpoolPoolList**
> MacpoolPoolResponse Get-IntersightMacpoolPoolList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'macpool.Pool' resource.
try {
     $Result = Get-IntersightMacpoolPoolList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMacpoolPoolList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMacpoolPoolMemberByMoid"></a>
# **Get-IntersightMacpoolPoolMemberByMoid**
> MacpoolPoolMember Get-IntersightMacpoolPoolMemberByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'macpool.PoolMember' resource.
try {
     $Result = Get-IntersightMacpoolPoolMemberByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMacpoolPoolMemberByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMacpoolPoolMemberList"></a>
# **Get-IntersightMacpoolPoolMemberList**
> MacpoolPoolMemberResponse Get-IntersightMacpoolPoolMemberList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'macpool.PoolMember' resource.
try {
     $Result = Get-IntersightMacpoolPoolMemberList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMacpoolPoolMemberList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMacpoolUniverseByMoid"></a>
# **Get-IntersightMacpoolUniverseByMoid**
> MacpoolUniverse Get-IntersightMacpoolUniverseByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'macpool.Universe' resource.
try {
     $Result = Get-IntersightMacpoolUniverseByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMacpoolUniverseByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMacpoolUniverseList"></a>
# **Get-IntersightMacpoolUniverseList**
> MacpoolUniverseResponse Get-IntersightMacpoolUniverseList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'macpool.Universe' resource.
try {
     $Result = Get-IntersightMacpoolUniverseList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMacpoolUniverseList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightMacpoolPool"></a>
# **Set-IntersightMacpoolPool**
> MacpoolPool Set-IntersightMacpoolPool<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MacpoolPool] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>

Update a 'macpool.Pool' resource.
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **MacpoolPool** | [**MacpoolPool**](MacpoolPool.md)| The &#39;macpool.Pool&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Update-IntersightMacpoolPool"></a>
# **Update-IntersightMacpoolPool**
> MacpoolPool Update-IntersightMacpoolPool<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MacpoolPool] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$MacpoolPool =  # MacpoolPool | The 'macpool.Pool' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'macpool.Pool' resource.
try {
     $Result = Update-IntersightMacpoolPool -Moid $Moid -MacpoolPool $MacpoolPool -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightMacpoolPool: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
