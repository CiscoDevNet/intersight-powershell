...
# Create a 'macpool.Pool' resource.
try {
    MacpoolPool $Result = New-IntersightMacpoolPool -MacpoolPool $MacpoolPool -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
...
# Delete a 'macpool.Pool' resource.
try {
    Remove-IntersightMacpoolPool -Moid $Moid
} catch {
...
# Read a 'macpool.IdBlock' resource.
try {
    MacpoolIdBlock $Result = Get-IntersightMacpoolIdBlockByMoid -Moid $Moid
} catch {
...
# Read a 'macpool.IdBlock' resource.
try {
    MacpoolIdBlockResponse $Result = Get-IntersightMacpoolIdBlockList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'macpool.Lease' resource.
try {
    MacpoolLease $Result = Get-IntersightMacpoolLeaseByMoid -Moid $Moid
} catch {
...
# Read a 'macpool.Lease' resource.
try {
    MacpoolLeaseResponse $Result = Get-IntersightMacpoolLeaseList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'macpool.Pool' resource.
try {
    MacpoolPool $Result = Get-IntersightMacpoolPoolByMoid -Moid $Moid
} catch {
...
# Read a 'macpool.Pool' resource.
try {
    MacpoolPoolResponse $Result = Get-IntersightMacpoolPoolList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'macpool.PoolMember' resource.
try {
    MacpoolPoolMember $Result = Get-IntersightMacpoolPoolMemberByMoid -Moid $Moid
} catch {
...
# Read a 'macpool.PoolMember' resource.
try {
    MacpoolPoolMemberResponse $Result = Get-IntersightMacpoolPoolMemberList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'macpool.Universe' resource.
try {
    MacpoolUniverse $Result = Get-IntersightMacpoolUniverseByMoid -Moid $Moid
} catch {
...
# Read a 'macpool.Universe' resource.
try {
    MacpoolUniverseResponse $Result = Get-IntersightMacpoolUniverseList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Update a 'macpool.Pool' resource.
try {
    MacpoolPool $Result = Set-IntersightMacpoolPool -Moid $Moid -MacpoolPool $MacpoolPool -IfMatch $IfMatch
} catch {
...
# Update a 'macpool.Pool' resource.
try {
    MacpoolPool $Result = Update-IntersightMacpoolPool -Moid $Moid -MacpoolPool $MacpoolPool -IfMatch $IfMatch
} catch {
