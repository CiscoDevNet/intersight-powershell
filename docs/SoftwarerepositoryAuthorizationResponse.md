...
```powershell
$SoftwarerepositoryAuthorizationResponse = Initialize-IntersightSoftwarerepositoryAuthorizationResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwarerepositoryAuthorizationResponse | ConvertTo-JSON
```
