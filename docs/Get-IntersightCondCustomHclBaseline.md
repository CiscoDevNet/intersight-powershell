...
# Get-IntersightCondCustomHclBaseline

## SYNOPSIS
Get the CondCustomHclBaseline

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCondCustomHclBaseline [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCondCustomHclBaseline [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CondCustomHclBaseline&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCondCustomHclBaseline
```
Above example returns the list of CondCustomHclBaseline.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCondCustomHclBaseline -Name "MoName"
```
Above example returns the CondCustomHclBaseline matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCondCustomHclBaseline -Organization $organization
```
Above example returns the list of CondCustomHclBaseline available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCondCustomHclBaseline -InlineCount allpages
```
Above example returns the list of CondCustomHclBaseline along with count.
...
### -Name
Specifies the name of the CondCustomHclBaseline.
...
### -Organization
Specifies the organization, to fetch the CondCustomHclBaseline under it.
...
[Remove-IntersightCondCustomHclBaseline](./Remove-IntersightCondCustomHclBaseline.md)
