...
# Initialize-IntersightFirmwareServerConfigurationUtilityDistributable
...
Initialize-IntersightFirmwareServerConfigurationUtilityDistributable [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Catalog< Model.SoftwarerepositoryCatalogRelationship>][-ClassId< FirmwareServerConfigurationUtilityDistributable.ClassIdEnum>][-ComponentMeta< System.Collections.Generic.List`1[Model.FirmwareComponentMeta]>][-Description< string>][-DistributableMetas< System.Collections.Generic.List`1[Model.FirmwareDistributableMetaRelationship]>][-ImageType< string>][-ImportAction< FirmwareServerConfigurationUtilityDistributable.ImportActionEnum>][-ImportState< FirmwareServerConfigurationUtilityDistributable.ImportStateEnum>][-Md5eTag< string>][-Md5sum< string>][-Mdfid< string>][-Model< string>][-Moid< string>][-Name< string>][-ObjectType< FirmwareServerConfigurationUtilityDistributable.ObjectTypeEnum>][-RecommendedBuild< string>][-Release< Model.SoftwarerepositoryReleaseRelationship>][-ReleaseDate< DateTime>][-ReleaseNotesUrl< string>][-Sha512sum< string>][-Size< long>][-SoftwareAdvisoryUrl< string>][-Source< Model.SoftwarerepositoryFileServer>][-SupportedModels< System.Collections.Generic.List`1[string]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Vendor< string>][-Version< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: FirmwareServerConfigurationUtilityDistributable.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FirmwareServerConfigurationUtilityDistributable.ImportActionEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FirmwareServerConfigurationUtilityDistributable.ImportStateEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FirmwareServerConfigurationUtilityDistributable.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFirmwareServerConfigurationUtilityDistributable
```
