...
```powershell
$StorageVirtualDriveExtensionResponse = Initialize-IntersightStorageVirtualDriveExtensionResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageVirtualDriveExtensionResponse | ConvertTo-JSON
```
