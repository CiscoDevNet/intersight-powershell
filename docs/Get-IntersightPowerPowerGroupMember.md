...
# Get-IntersightPowerPowerGroupMember

## SYNOPSIS
Get the PowerPowerGroupMember

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPowerPowerGroupMember [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPowerPowerGroupMember [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PowerPowerGroupMember&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPowerPowerGroupMember
```
Above example returns the list of PowerPowerGroupMember.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPowerPowerGroupMember -Name "MoName"
```
Above example returns the PowerPowerGroupMember matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPowerPowerGroupMember -Organization $organization
```
Above example returns the list of PowerPowerGroupMember available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPowerPowerGroupMember -InlineCount allpages
```
Above example returns the list of PowerPowerGroupMember along with count.
...
### -Name
Specifies the name of the PowerPowerGroupMember.
...
### -Organization
Specifies the organization, to fetch the PowerPowerGroupMember under it.
