...
### CmdletParam (Default)
```
Get-IntersightSshPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSshPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SshPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSshPolicy
```
Above example returns the list of SshPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSshPolicy -Name "MoName"
```
Above example returns the SshPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSshPolicy -Organization $organization
```
Above example returns the list of SshPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSshPolicy -InlineCount allpages
```
Above example returns the list of SshPolicy along with count.
...
### -Name
Specifies the name of the SshPolicy.
...
### -Organization
Specifies the organization, to fetch the SshPolicy under it.
