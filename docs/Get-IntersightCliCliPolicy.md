...
# Get-IntersightCliCliPolicy

## SYNOPSIS
Get the CliCliPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCliCliPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCliCliPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CliCliPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCliCliPolicy
```
Above example returns the list of CliCliPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCliCliPolicy -Name "MoName"
```
Above example returns the CliCliPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCliCliPolicy -Organization $organization
```
Above example returns the list of CliCliPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCliCliPolicy -InlineCount allpages
```
Above example returns the list of CliCliPolicy along with count.
...
### -Name
Specifies the name of the CliCliPolicy.
...
### -Organization
Specifies the organization, to fetch the CliCliPolicy under it.
...
[Remove-IntersightCliCliPolicy](./Remove-IntersightCliCliPolicy.md)
