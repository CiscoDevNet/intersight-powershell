...
## SYNOPSIS
Get the InventoryGenericInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightInventoryGenericInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightInventoryGenericInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;InventoryGenericInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightInventoryGenericInventory
```
Above example returns the list of InventoryGenericInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightInventoryGenericInventory -Name "MoName"
```
Above example returns the InventoryGenericInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightInventoryGenericInventory -Organization $organization
```
Above example returns the list of InventoryGenericInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightInventoryGenericInventory -InlineCount allpages
```
Above example returns the list of InventoryGenericInventory along with count.
...
### -Name
Specifies the name of the InventoryGenericInventory.
...
### -Organization
Specifies the organization, to fetch the InventoryGenericInventory under it.
...
[Set-IntersightInventoryGenericInventory](./Set-IntersightInventoryGenericInventory.md)
