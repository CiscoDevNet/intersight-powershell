...
```powershell
$SoftwareSolutionDistributableRelationship = Initialize-IntersightSoftwareSolutionDistributableRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$SoftwareSolutionDistributableRelationship | ConvertTo-JSON
```
