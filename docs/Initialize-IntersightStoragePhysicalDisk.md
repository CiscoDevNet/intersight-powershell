...
# Initialize-IntersightStoragePhysicalDisk
...
```yaml
Type: StoragePhysicalDisk.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: StoragePhysicalDisk.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### -PercentReservedCapacityConsumed
...
```yaml
Type: System.Collections.Generic.List`1[Model.StoragePhysicalDiskExtensionRelationship]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightStoragePhysicalDisk
```
