...
# Get-IntersightFabricNetFlowMonitor

## SYNOPSIS
Get the FabricNetFlowMonitor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricNetFlowMonitor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricNetFlowMonitor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricNetFlowMonitor&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowMonitor
```
Above example returns the list of FabricNetFlowMonitor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowMonitor -Name "MoName"
```
Above example returns the FabricNetFlowMonitor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowMonitor -Organization $organization
```
Above example returns the list of FabricNetFlowMonitor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowMonitor -InlineCount allpages
```
Above example returns the list of FabricNetFlowMonitor along with count.
...
### -Name
Specifies the name of the FabricNetFlowMonitor.
...
### -Organization
Specifies the organization, to fetch the FabricNetFlowMonitor under it.
...
[Remove-IntersightFabricNetFlowMonitor](./Remove-IntersightFabricNetFlowMonitor.md)
