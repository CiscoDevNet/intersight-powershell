...
# Get-IntersightBootVmediaDevice

## SYNOPSIS
Get the BootVmediaDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBootVmediaDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBootVmediaDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBootVmediaDevice
```
Above example returns the list of BootVmediaDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBootVmediaDevice -Name "MoName"
```
Above example returns the BootVmediaDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBootVmediaDevice -Organization $organization
```
Above example returns the list of BootVmediaDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBootVmediaDevice -InlineCount allpages
```
Above example returns the list of BootVmediaDevice along with count.
...
### -Name
Specifies the name of the BootVmediaDevice.
...
### -Organization
Specifies the organization, to fetch the BootVmediaDevice under it.
...
[Set-IntersightBootVmediaDevice](./Set-IntersightBootVmediaDevice.md)
