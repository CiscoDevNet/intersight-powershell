...
# Initialize-IntersightTaskMdsScopedInventory
...
```yaml
Type: TaskMdsScopedInventory.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TaskMdsScopedInventory.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTaskMdsScopedInventory
```
