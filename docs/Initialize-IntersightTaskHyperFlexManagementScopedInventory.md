...
# Initialize-IntersightTaskHyperFlexManagementScopedInventory
...
```yaml
Type: TaskHyperFlexManagementScopedInventory.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TaskHyperFlexManagementScopedInventory.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTaskHyperFlexManagementScopedInventory
```
