...
# Get-IntersightStoragePureBlade

## SYNOPSIS
Get the StoragePureBlade

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureBlade [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureBlade [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureBlade&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureBlade
```
Above example returns the list of StoragePureBlade.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureBlade -Name "MoName"
```
Above example returns the StoragePureBlade matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureBlade -Organization $organization
```
Above example returns the list of StoragePureBlade available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureBlade -InlineCount allpages
```
Above example returns the list of StoragePureBlade along with count.
...
### -Name
Specifies the name of the StoragePureBlade.
...
### -Organization
Specifies the organization, to fetch the StoragePureBlade under it.
