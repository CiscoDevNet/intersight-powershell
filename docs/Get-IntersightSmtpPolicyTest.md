...
# Get-IntersightSmtpPolicyTest

## SYNOPSIS
Get the SmtpPolicyTest

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSmtpPolicyTest [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSmtpPolicyTest [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SmtpPolicyTest&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSmtpPolicyTest
```
Above example returns the list of SmtpPolicyTest.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSmtpPolicyTest -Name "MoName"
```
Above example returns the SmtpPolicyTest matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSmtpPolicyTest -Organization $organization
```
Above example returns the list of SmtpPolicyTest available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSmtpPolicyTest -InlineCount allpages
```
Above example returns the list of SmtpPolicyTest along with count.
...
### -Name
Specifies the name of the SmtpPolicyTest.
...
### -Organization
Specifies the organization, to fetch the SmtpPolicyTest under it.
...
[Remove-IntersightSmtpPolicyTest](./Remove-IntersightSmtpPolicyTest.md)
