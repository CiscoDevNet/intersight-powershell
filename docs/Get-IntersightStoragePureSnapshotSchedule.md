...
## SYNOPSIS
Get the StoragePureSnapshotSchedule

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureSnapshotSchedule [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureSnapshotSchedule [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureSnapshotSchedule&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureSnapshotSchedule
```
Above example returns the list of StoragePureSnapshotSchedule.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureSnapshotSchedule -Name "MoName"
```
Above example returns the StoragePureSnapshotSchedule matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureSnapshotSchedule -Organization $organization
```
Above example returns the list of StoragePureSnapshotSchedule available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureSnapshotSchedule -InlineCount allpages
```
Above example returns the list of StoragePureSnapshotSchedule along with count.
...
### -Name
Specifies the name of the StoragePureSnapshotSchedule.
...
### -Organization
Specifies the organization, to fetch the StoragePureSnapshotSchedule under it.
