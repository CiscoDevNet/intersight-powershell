...
# Get-IntersightApplianceFileSystemOpSummary

## SYNOPSIS
Get the ApplianceFileSystemOpSummary

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceFileSystemOpSummary [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceFileSystemOpSummary [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceFileSystemOpSummary&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceFileSystemOpSummary
```
Above example returns the list of ApplianceFileSystemOpSummary.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceFileSystemOpSummary -Name "MoName"
```
Above example returns the ApplianceFileSystemOpSummary matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceFileSystemOpSummary -Organization $organization
```
Above example returns the list of ApplianceFileSystemOpSummary available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceFileSystemOpSummary -InlineCount allpages
```
Above example returns the list of ApplianceFileSystemOpSummary along with count.
...
### -Name
Specifies the name of the ApplianceFileSystemOpSummary.
...
### -Organization
Specifies the organization, to fetch the ApplianceFileSystemOpSummary under it.
