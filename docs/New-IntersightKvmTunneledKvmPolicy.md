...
New-IntersightKvmTunneledKvmPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Moid< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-TunneledKvmConfiguration< bool>][-TunneledKvmLaunch< bool>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
