...
## SYNOPSIS
Get the StorageNetAppEthernetPortEvent

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppEthernetPortEvent [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppEthernetPortEvent [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageNetAppEthernetPortEvent&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppEthernetPortEvent
```
Above example returns the list of StorageNetAppEthernetPortEvent.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppEthernetPortEvent -Name "MoName"
```
Above example returns the StorageNetAppEthernetPortEvent matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppEthernetPortEvent -Organization $organization
```
Above example returns the list of StorageNetAppEthernetPortEvent available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppEthernetPortEvent -InlineCount allpages
```
Above example returns the list of StorageNetAppEthernetPortEvent along with count.
...
### -Name
Specifies the name of the StorageNetAppEthernetPortEvent.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppEthernetPortEvent under it.
