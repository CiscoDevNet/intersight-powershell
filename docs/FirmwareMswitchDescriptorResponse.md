...
```powershell
$FirmwareMswitchDescriptorResponse = Initialize-IntersightFirmwareMswitchDescriptorResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$FirmwareMswitchDescriptorResponse | ConvertTo-JSON
```
