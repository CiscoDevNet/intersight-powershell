...
```powershell
$VirtualizationBaseHostRelationship = Initialize-IntersightVirtualizationBaseHostRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$VirtualizationBaseHostRelationship | ConvertTo-JSON
```
