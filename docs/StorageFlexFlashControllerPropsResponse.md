...
```powershell
$StorageFlexFlashControllerPropsResponse = Initialize-IntersightStorageFlexFlashControllerPropsResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageFlexFlashControllerPropsResponse | ConvertTo-JSON
```
