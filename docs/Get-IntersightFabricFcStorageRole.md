...
## SYNOPSIS
Get the FabricFcStorageRole

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricFcStorageRole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricFcStorageRole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricFcStorageRole&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricFcStorageRole
```
Above example returns the list of FabricFcStorageRole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricFcStorageRole -Name "MoName"
```
Above example returns the FabricFcStorageRole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricFcStorageRole -Organization $organization
```
Above example returns the list of FabricFcStorageRole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricFcStorageRole -InlineCount allpages
```
Above example returns the list of FabricFcStorageRole along with count.
...
### -Name
Specifies the name of the FabricFcStorageRole.
...
### -Organization
Specifies the organization, to fetch the FabricFcStorageRole under it.
