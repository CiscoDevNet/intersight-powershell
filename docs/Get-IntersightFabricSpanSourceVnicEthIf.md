...
# Get-IntersightFabricSpanSourceVnicEthIf

## SYNOPSIS
Get the FabricSpanSourceVnicEthIf

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricSpanSourceVnicEthIf [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricSpanSourceVnicEthIf [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricSpanSourceVnicEthIf&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceVnicEthIf
```
Above example returns the list of FabricSpanSourceVnicEthIf.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceVnicEthIf -Name "MoName"
```
Above example returns the FabricSpanSourceVnicEthIf matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceVnicEthIf -Organization $organization
```
Above example returns the list of FabricSpanSourceVnicEthIf available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceVnicEthIf -InlineCount allpages
```
Above example returns the list of FabricSpanSourceVnicEthIf along with count.
...
### -Name
Specifies the name of the FabricSpanSourceVnicEthIf.
...
### -Organization
Specifies the organization, to fetch the FabricSpanSourceVnicEthIf under it.
...
[Remove-IntersightFabricSpanSourceVnicEthIf](./Remove-IntersightFabricSpanSourceVnicEthIf.md)
