...
## SYNOPSIS
Get the StoragePureVolume

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureVolume [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureVolume [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureVolume&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureVolume
```
Above example returns the list of StoragePureVolume.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureVolume -Name "MoName"
```
Above example returns the StoragePureVolume matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureVolume -Organization $organization
```
Above example returns the list of StoragePureVolume available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureVolume -InlineCount allpages
```
Above example returns the list of StoragePureVolume along with count.
...
### -Name
Specifies the name of the StoragePureVolume.
...
### -Organization
Specifies the organization, to fetch the StoragePureVolume under it.
