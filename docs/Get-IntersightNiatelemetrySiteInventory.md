...
## SYNOPSIS
Get the NiatelemetrySiteInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetrySiteInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetrySiteInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySiteInventory
```
Above example returns the list of NiatelemetrySiteInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySiteInventory -Name "MoName"
```
Above example returns the NiatelemetrySiteInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySiteInventory -Organization $organization
```
Above example returns the list of NiatelemetrySiteInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySiteInventory -InlineCount allpages
```
Above example returns the list of NiatelemetrySiteInventory along with count.
...
### -Name
Specifies the name of the NiatelemetrySiteInventory.
...
### -Organization
Specifies the organization, to fetch the NiatelemetrySiteInventory under it.
