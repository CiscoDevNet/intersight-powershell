...
# Initialize-IntersightSoftwarerepositoryCategoryMapperModel
...
```yaml
Type: SoftwarerepositoryCategoryMapperModel.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: SoftwarerepositoryCategoryMapperModel.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightSoftwarerepositoryCategoryMapperModel
```
