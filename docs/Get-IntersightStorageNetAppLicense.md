...
## SYNOPSIS
Get the StorageNetAppLicense

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppLicense [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppLicense [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppLicense&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLicense
```
Above example returns the list of StorageNetAppLicense.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLicense -Name "MoName"
```
Above example returns the StorageNetAppLicense matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLicense -Organization $organization
```
Above example returns the list of StorageNetAppLicense available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLicense -InlineCount allpages
```
Above example returns the list of StorageNetAppLicense along with count.
...
### -Name
Specifies the name of the StorageNetAppLicense.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppLicense under it.
