...
```powershell
$HyperflexAutoSupportPolicyRelationship = Initialize-IntersightHyperflexAutoSupportPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexAutoSupportPolicyRelationship | ConvertTo-JSON
```
