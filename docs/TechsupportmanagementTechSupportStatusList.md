...
```powershell
$TechsupportmanagementTechSupportStatusList = Initialize-IntersightTechsupportmanagementTechSupportStatusList  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$TechsupportmanagementTechSupportStatusList | ConvertTo-JSON
```
