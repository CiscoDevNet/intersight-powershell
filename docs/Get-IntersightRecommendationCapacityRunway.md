...
## SYNOPSIS
Get the RecommendationCapacityRunway

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRecommendationCapacityRunway [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRecommendationCapacityRunway [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;RecommendationCapacityRunway&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRecommendationCapacityRunway
```
Above example returns the list of RecommendationCapacityRunway.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRecommendationCapacityRunway -Name "MoName"
```
Above example returns the RecommendationCapacityRunway matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRecommendationCapacityRunway -Organization $organization
```
Above example returns the list of RecommendationCapacityRunway available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRecommendationCapacityRunway -InlineCount allpages
```
Above example returns the list of RecommendationCapacityRunway along with count.
...
### -Name
Specifies the name of the RecommendationCapacityRunway.
...
### -Organization
Specifies the organization, to fetch the RecommendationCapacityRunway under it.
