...
### CmdletParam (Default)
```
Get-IntersightPciNodeSetting [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPciNodeSetting [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
