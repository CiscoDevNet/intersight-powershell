...
## SYNOPSIS
Get the RecommendationPhysicalItem

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRecommendationPhysicalItem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRecommendationPhysicalItem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRecommendationPhysicalItem
```
Above example returns the list of RecommendationPhysicalItem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRecommendationPhysicalItem -Name "MoName"
```
Above example returns the RecommendationPhysicalItem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRecommendationPhysicalItem -Organization $organization
```
Above example returns the list of RecommendationPhysicalItem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRecommendationPhysicalItem -InlineCount allpages
```
Above example returns the list of RecommendationPhysicalItem along with count.
...
### -Name
Specifies the name of the RecommendationPhysicalItem.
...
### -Organization
Specifies the organization, to fetch the RecommendationPhysicalItem under it.
