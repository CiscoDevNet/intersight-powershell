...
## SYNOPSIS
Get the NiatelemetryInsightGroupDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryInsightGroupDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryInsightGroupDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryInsightGroupDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryInsightGroupDetails
```
Above example returns the list of NiatelemetryInsightGroupDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryInsightGroupDetails -Name "MoName"
```
Above example returns the NiatelemetryInsightGroupDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryInsightGroupDetails -Organization $organization
```
Above example returns the list of NiatelemetryInsightGroupDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryInsightGroupDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryInsightGroupDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryInsightGroupDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryInsightGroupDetails under it.
