...
## SYNOPSIS
Get the IaasDiagnosticMessages

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIaasDiagnosticMessages [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIaasDiagnosticMessages [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIaasDiagnosticMessages
```
Above example returns the list of IaasDiagnosticMessages.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIaasDiagnosticMessages -Name "MoName"
```
Above example returns the IaasDiagnosticMessages matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIaasDiagnosticMessages -Organization $organization
```
Above example returns the list of IaasDiagnosticMessages available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIaasDiagnosticMessages -InlineCount allpages
```
Above example returns the list of IaasDiagnosticMessages along with count.
...
### -Name
Specifies the name of the IaasDiagnosticMessages.
...
### -Organization
Specifies the organization, to fetch the IaasDiagnosticMessages under it.
