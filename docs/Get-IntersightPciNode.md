...
### CmdletParam (Default)
```
Get-IntersightPciNode [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPciNode [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PciNode&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPciNode
```
Above example returns the list of PciNode.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPciNode -Name "MoName"
```
Above example returns the PciNode matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPciNode -Organization $organization
```
Above example returns the list of PciNode available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPciNode -InlineCount allpages
```
Above example returns the list of PciNode along with count.
...
### -Name
Specifies the name of the PciNode.
...
### -Organization
Specifies the organization, to fetch the PciNode under it.
...
[Set-IntersightPciNode](./Set-IntersightPciNode.md)
