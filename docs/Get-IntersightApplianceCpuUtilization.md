...
# Get-IntersightApplianceCpuUtilization

## SYNOPSIS
Get the ApplianceCpuUtilization

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceCpuUtilization [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceCpuUtilization [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceCpuUtilization&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceCpuUtilization
```
Above example returns the list of ApplianceCpuUtilization.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceCpuUtilization -Name "MoName"
```
Above example returns the ApplianceCpuUtilization matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceCpuUtilization -Organization $organization
```
Above example returns the list of ApplianceCpuUtilization available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceCpuUtilization -InlineCount allpages
```
Above example returns the list of ApplianceCpuUtilization along with count.
...
### -Name
Specifies the name of the ApplianceCpuUtilization.
...
### -Organization
Specifies the organization, to fetch the ApplianceCpuUtilization under it.
