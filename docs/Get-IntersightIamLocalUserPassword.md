...
# Get-IntersightIamLocalUserPassword

## SYNOPSIS
Get the IamLocalUserPassword

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamLocalUserPassword [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamLocalUserPassword [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamLocalUserPassword&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamLocalUserPassword
```
Above example returns the list of IamLocalUserPassword.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamLocalUserPassword -Name "MoName"
```
Above example returns the IamLocalUserPassword matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamLocalUserPassword -Organization $organization
```
Above example returns the list of IamLocalUserPassword available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamLocalUserPassword -InlineCount allpages
```
Above example returns the list of IamLocalUserPassword along with count.
...
### -Name
Specifies the name of the IamLocalUserPassword.
...
### -Organization
Specifies the organization, to fetch the IamLocalUserPassword under it.
...
[New-IntersightIamLocalUserPassword](./New-IntersightIamLocalUserPassword.md)

[Set-IntersightIamLocalUserPassword](./Set-IntersightIamLocalUserPassword.md)
