...
```powershell
$StorageStorageContainerUtilization = Initialize-IntersightStorageStorageContainerUtilization  -ClassId null `
 -ObjectType null `
 -Available null `
...
```powershell
$StorageStorageContainerUtilization | ConvertTo-JSON
```
