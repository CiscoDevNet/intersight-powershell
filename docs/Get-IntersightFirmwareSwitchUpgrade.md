...
## SYNOPSIS
Get the FirmwareSwitchUpgrade

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareSwitchUpgrade [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareSwitchUpgrade [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareSwitchUpgrade&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareSwitchUpgrade
```
Above example returns the list of FirmwareSwitchUpgrade.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareSwitchUpgrade -Name "MoName"
```
Above example returns the FirmwareSwitchUpgrade matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareSwitchUpgrade -Organization $organization
```
Above example returns the list of FirmwareSwitchUpgrade available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareSwitchUpgrade -InlineCount allpages
```
Above example returns the list of FirmwareSwitchUpgrade along with count.
...
### -Name
Specifies the name of the FirmwareSwitchUpgrade.
...
### -Organization
Specifies the organization, to fetch the FirmwareSwitchUpgrade under it.
