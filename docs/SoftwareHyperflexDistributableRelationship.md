...
```powershell
$SoftwareHyperflexDistributableRelationship = Initialize-IntersightSoftwareHyperflexDistributableRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$SoftwareHyperflexDistributableRelationship | ConvertTo-JSON
```
