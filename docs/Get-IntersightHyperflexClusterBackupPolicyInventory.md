...
## SYNOPSIS
Get the HyperflexClusterBackupPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexClusterBackupPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexClusterBackupPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterBackupPolicyInventory
```
Above example returns the list of HyperflexClusterBackupPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterBackupPolicyInventory -Name "MoName"
```
Above example returns the HyperflexClusterBackupPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterBackupPolicyInventory -Organization $organization
```
Above example returns the list of HyperflexClusterBackupPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterBackupPolicyInventory -InlineCount allpages
```
Above example returns the list of HyperflexClusterBackupPolicyInventory along with count.
...
### -Name
Specifies the name of the HyperflexClusterBackupPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the HyperflexClusterBackupPolicyInventory under it.
...
[Remove-IntersightHyperflexClusterBackupPolicyInventory](./Remove-IntersightHyperflexClusterBackupPolicyInventory.md)
