...
# Get-IntersightCatalystsdwanConfigGroup

## SYNOPSIS
Get the CatalystsdwanConfigGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCatalystsdwanConfigGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCatalystsdwanConfigGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CatalystsdwanConfigGroup&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanConfigGroup
```
Above example returns the list of CatalystsdwanConfigGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanConfigGroup -Name "MoName"
```
Above example returns the CatalystsdwanConfigGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanConfigGroup -Organization $organization
```
Above example returns the list of CatalystsdwanConfigGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanConfigGroup -InlineCount allpages
```
Above example returns the list of CatalystsdwanConfigGroup along with count.
...
### -Name
Specifies the name of the CatalystsdwanConfigGroup.
...
### -Organization
Specifies the organization, to fetch the CatalystsdwanConfigGroup under it.
