...
### -FabricTechnology
Fabric technology reported by the onboarded DCNM site.
...
```yaml
Type: NiatelemetrySiteInventory.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightNiatelemetrySiteInventory
```
