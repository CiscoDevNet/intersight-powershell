...
### CmdletParam (Default)
```
Get-IntersightServerProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightServerProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;ServerProfile&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightServerProfile
```
Above example returns the list of ServerProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightServerProfile -Name "MoName"
```
Above example returns the ServerProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightServerProfile -Organization $organization
```
Above example returns the list of ServerProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightServerProfile -InlineCount allpages
```
Above example returns the list of ServerProfile along with count.
...
### -Name
Specifies the name of the ServerProfile.
...
### -Organization
Specifies the organization, to fetch the ServerProfile under it.
