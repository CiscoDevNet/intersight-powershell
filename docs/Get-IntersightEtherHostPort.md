...
### CmdletParam (Default)
```
Get-IntersightEtherHostPort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEtherHostPort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EtherHostPort&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEtherHostPort
```
Above example returns the list of EtherHostPort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEtherHostPort -Name "MoName"
```
Above example returns the EtherHostPort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEtherHostPort -Organization $organization
```
Above example returns the list of EtherHostPort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEtherHostPort -InlineCount allpages
```
Above example returns the list of EtherHostPort along with count.
...
### -Name
Specifies the name of the EtherHostPort.
...
### -Organization
Specifies the organization, to fetch the EtherHostPort under it.
...
[Set-IntersightEtherHostPort](./Set-IntersightEtherHostPort.md)
