...
# Get-IntersightVnicIscsiAdapterPolicyInventory

## SYNOPSIS
Get the VnicIscsiAdapterPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicIscsiAdapterPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicIscsiAdapterPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicIscsiAdapterPolicyInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicIscsiAdapterPolicyInventory
```
Above example returns the list of VnicIscsiAdapterPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicIscsiAdapterPolicyInventory -Name "MoName"
```
Above example returns the VnicIscsiAdapterPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicIscsiAdapterPolicyInventory -Organization $organization
```
Above example returns the list of VnicIscsiAdapterPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicIscsiAdapterPolicyInventory -InlineCount allpages
```
Above example returns the list of VnicIscsiAdapterPolicyInventory along with count.
...
### -Name
Specifies the name of the VnicIscsiAdapterPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the VnicIscsiAdapterPolicyInventory under it.
