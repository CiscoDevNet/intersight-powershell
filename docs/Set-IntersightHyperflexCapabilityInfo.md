...
Set-IntersightHyperflexCapabilityInfo [-AdditionalProperties< Dictionary<string,object>>][-AppCatalog< HyperflexAppCatalogRelationship>][-CapabilityConstraints< List<HclConstraint>>][[-Moid]< string>][-Name< string>][-Tags< List<MoTag>>]
