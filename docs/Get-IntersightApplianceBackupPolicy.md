...
## SYNOPSIS
Get the ApplianceBackupPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceBackupPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceBackupPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceBackupPolicy
```
Above example returns the list of ApplianceBackupPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceBackupPolicy -Name "MoName"
```
Above example returns the ApplianceBackupPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceBackupPolicy -Organization $organization
```
Above example returns the list of ApplianceBackupPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceBackupPolicy -InlineCount allpages
```
Above example returns the list of ApplianceBackupPolicy along with count.
...
### -Name
Specifies the name of the ApplianceBackupPolicy.
...
### -Organization
Specifies the organization, to fetch the ApplianceBackupPolicy under it.
