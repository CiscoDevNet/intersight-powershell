...
```powershell
$KubernetesAciCniTenantClusterAllocationRelationship = Initialize-IntersightKubernetesAciCniTenantClusterAllocationRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$KubernetesAciCniTenantClusterAllocationRelationship | ConvertTo-JSON
```
