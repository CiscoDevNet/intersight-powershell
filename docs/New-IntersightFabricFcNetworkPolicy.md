...
New-IntersightFabricFcNetworkPolicy [-AdditionalProperties< Dictionary<string,object>>][-Description< string>][-EnableTrunking< bool>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-Profiles< List<FabricSwitchProfileRelationship>>][-Tags< List<MoTag>>]
