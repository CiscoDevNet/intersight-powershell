...
# Get-IntersightHclHwCatalogInfo

## SYNOPSIS
Get the HclHwCatalogInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHclHwCatalogInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHclHwCatalogInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HclHwCatalogInfo&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHclHwCatalogInfo
```
Above example returns the list of HclHwCatalogInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHclHwCatalogInfo -Name "MoName"
```
Above example returns the HclHwCatalogInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHclHwCatalogInfo -Organization $organization
```
Above example returns the list of HclHwCatalogInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHclHwCatalogInfo -InlineCount allpages
```
Above example returns the list of HclHwCatalogInfo along with count.
...
### -Name
Specifies the name of the HclHwCatalogInfo.
...
### -Organization
Specifies the organization, to fetch the HclHwCatalogInfo under it.
