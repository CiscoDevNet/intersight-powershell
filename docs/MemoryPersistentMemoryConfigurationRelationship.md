...
```powershell
$MemoryPersistentMemoryConfigurationRelationship = Initialize-IntersightMemoryPersistentMemoryConfigurationRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$MemoryPersistentMemoryConfigurationRelationship | ConvertTo-JSON
```
