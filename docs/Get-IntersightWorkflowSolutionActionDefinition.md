...
## SYNOPSIS
Get the WorkflowSolutionActionDefinition

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowSolutionActionDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowSolutionActionDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowSolutionActionDefinition&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionActionDefinition
```
Above example returns the list of WorkflowSolutionActionDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionActionDefinition -Name "MoName"
```
Above example returns the WorkflowSolutionActionDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionActionDefinition -Organization $organization
```
Above example returns the list of WorkflowSolutionActionDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionActionDefinition -InlineCount allpages
```
Above example returns the list of WorkflowSolutionActionDefinition along with count.
...
### -Name
Specifies the name of the WorkflowSolutionActionDefinition.
...
### -Organization
Specifies the organization, to fetch the WorkflowSolutionActionDefinition under it.
