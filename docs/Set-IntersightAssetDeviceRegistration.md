...
Set-IntersightAssetDeviceRegistration [-AccessKeyId< string>][-AdditionalProperties< Dictionary<string,object>>][-DeviceHostname< List<string>>][-DeviceIpAddress< List<string>>][-ExecutionMode< AssetDeviceRegistration.ExecutionModeEnum>][[-Moid]< string>][-ParentSignature< AssetClaimSignature>][-Pid< List<string>>][-PlatformType< AssetDeviceRegistration.PlatformTypeEnum>][-Serial< List<string>>][-Tags< List<MoTag>>]
