...
Set-IntersightAssetDeviceRegistration [-AccessKeyId< string>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ExecutionMode< AssetDeviceRegistration.ExecutionModeEnum>][[-Moid]< string>][-ParentSignature< AssetClaimSignature>][-PlatformType< AssetDeviceRegistration.PlatformTypeEnum>][-RotateAccessKey< bool>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
