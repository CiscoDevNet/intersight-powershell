...
# Get-IntersightVmediaPolicyInventory

## SYNOPSIS
Get the VmediaPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVmediaPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVmediaPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VmediaPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVmediaPolicyInventory
```
Above example returns the list of VmediaPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVmediaPolicyInventory -Name "MoName"
```
Above example returns the VmediaPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVmediaPolicyInventory -Organization $organization
```
Above example returns the list of VmediaPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVmediaPolicyInventory -InlineCount allpages
```
Above example returns the list of VmediaPolicyInventory along with count.
...
### -Name
Specifies the name of the VmediaPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the VmediaPolicyInventory under it.
