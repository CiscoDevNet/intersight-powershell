...
## SYNOPSIS
Get the CloudTfcOrganization

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudTfcOrganization [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudTfcOrganization [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CloudTfcOrganization&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudTfcOrganization
```
Above example returns the list of CloudTfcOrganization.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudTfcOrganization -Name "MoName"
```
Above example returns the CloudTfcOrganization matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudTfcOrganization -Organization $organization
```
Above example returns the list of CloudTfcOrganization available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudTfcOrganization -InlineCount allpages
```
Above example returns the list of CloudTfcOrganization along with count.
...
### -Name
Specifies the name of the CloudTfcOrganization.
...
### -Organization
Specifies the organization, to fetch the CloudTfcOrganization under it.
