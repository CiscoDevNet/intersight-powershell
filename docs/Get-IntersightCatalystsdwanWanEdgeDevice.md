...
# Get-IntersightCatalystsdwanWanEdgeDevice

## SYNOPSIS
Get the CatalystsdwanWanEdgeDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCatalystsdwanWanEdgeDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCatalystsdwanWanEdgeDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CatalystsdwanWanEdgeDevice&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanWanEdgeDevice
```
Above example returns the list of CatalystsdwanWanEdgeDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanWanEdgeDevice -Name "MoName"
```
Above example returns the CatalystsdwanWanEdgeDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanWanEdgeDevice -Organization $organization
```
Above example returns the list of CatalystsdwanWanEdgeDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanWanEdgeDevice -InlineCount allpages
```
Above example returns the list of CatalystsdwanWanEdgeDevice along with count.
...
### -Name
Specifies the name of the CatalystsdwanWanEdgeDevice.
...
### -Organization
Specifies the organization, to fetch the CatalystsdwanWanEdgeDevice under it.
