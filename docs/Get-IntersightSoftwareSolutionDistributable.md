...
### CmdletParam (Default)
```
Get-IntersightSoftwareSolutionDistributable [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwareSolutionDistributable [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwareSolutionDistributable
```
Above example returns the list of SoftwareSolutionDistributable.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwareSolutionDistributable -Name "MoName"
```
Above example returns the SoftwareSolutionDistributable matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwareSolutionDistributable -Organization $organization
```
Above example returns the list of SoftwareSolutionDistributable available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwareSolutionDistributable -InlineCount allpages
```
Above example returns the list of SoftwareSolutionDistributable along with count.
...
### -Name
Specifies the name of the SoftwareSolutionDistributable.
...
### -Organization
Specifies the organization, to fetch the SoftwareSolutionDistributable under it.
