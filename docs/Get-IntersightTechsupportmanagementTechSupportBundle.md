...
## SYNOPSIS
Get the TechsupportmanagementTechSupportBundle

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightTechsupportmanagementTechSupportBundle [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightTechsupportmanagementTechSupportBundle [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;TechsupportmanagementTechSupportBundle&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementTechSupportBundle
```
Above example returns the list of TechsupportmanagementTechSupportBundle.

### Example 2
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementTechSupportBundle -Name "MoName"
```
Above example returns the TechsupportmanagementTechSupportBundle matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementTechSupportBundle -Organization $organization
```
Above example returns the list of TechsupportmanagementTechSupportBundle available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementTechSupportBundle -InlineCount allpages
```
Above example returns the list of TechsupportmanagementTechSupportBundle along with count.
...
### -Name
Specifies the name of the TechsupportmanagementTechSupportBundle.
...
### -Organization
Specifies the organization, to fetch the TechsupportmanagementTechSupportBundle under it.
