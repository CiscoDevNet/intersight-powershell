...
```powershell
$NiatelemetryNiaLicenseStateRelationship = Initialize-IntersightNiatelemetryNiaLicenseStateRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$NiatelemetryNiaLicenseStateRelationship | ConvertTo-JSON
```
