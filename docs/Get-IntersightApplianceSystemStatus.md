...
## SYNOPSIS
Get the ApplianceSystemStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceSystemStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceSystemStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;ApplianceSystemStatus&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceSystemStatus
```
Above example returns the list of ApplianceSystemStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceSystemStatus -Name "MoName"
```
Above example returns the ApplianceSystemStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceSystemStatus -Organization $organization
```
Above example returns the list of ApplianceSystemStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceSystemStatus -InlineCount allpages
```
Above example returns the list of ApplianceSystemStatus along with count.
...
### -Name
Specifies the name of the ApplianceSystemStatus.
...
### -Organization
Specifies the organization, to fetch the ApplianceSystemStatus under it.
