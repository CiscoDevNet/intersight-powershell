...
## SYNOPSIS
Get the BulkSubRequestObj

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBulkSubRequestObj [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBulkSubRequestObj [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;BulkSubRequestObj&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBulkSubRequestObj
```
Above example returns the list of BulkSubRequestObj.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBulkSubRequestObj -Name "MoName"
```
Above example returns the BulkSubRequestObj matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBulkSubRequestObj -Organization $organization
```
Above example returns the list of BulkSubRequestObj available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBulkSubRequestObj -InlineCount allpages
```
Above example returns the list of BulkSubRequestObj along with count.
...
### -Name
Specifies the name of the BulkSubRequestObj.
...
### -Organization
Specifies the organization, to fetch the BulkSubRequestObj under it.
