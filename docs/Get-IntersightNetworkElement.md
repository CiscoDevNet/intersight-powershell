...
## SYNOPSIS
Get the NetworkElement

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkElement [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkElement [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NetworkElement&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkElement
```
Above example returns the list of NetworkElement.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkElement -Name "MoName"
```
Above example returns the NetworkElement matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkElement -Organization $organization
```
Above example returns the list of NetworkElement available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkElement -InlineCount allpages
```
Above example returns the list of NetworkElement along with count.
...
### -Name
Specifies the name of the NetworkElement.
...
### -Organization
Specifies the organization, to fetch the NetworkElement under it.
...
[Set-IntersightNetworkElement](./Set-IntersightNetworkElement.md)
