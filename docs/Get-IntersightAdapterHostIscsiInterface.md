...
## SYNOPSIS
Get the AdapterHostIscsiInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAdapterHostIscsiInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAdapterHostIscsiInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAdapterHostIscsiInterface
```
Above example returns the list of AdapterHostIscsiInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAdapterHostIscsiInterface -Name "MoName"
```
Above example returns the AdapterHostIscsiInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAdapterHostIscsiInterface -Organization $organization
```
Above example returns the list of AdapterHostIscsiInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAdapterHostIscsiInterface -InlineCount allpages
```
Above example returns the list of AdapterHostIscsiInterface along with count.
...
### -Name
Specifies the name of the AdapterHostIscsiInterface.
...
### -Organization
Specifies the organization, to fetch the AdapterHostIscsiInterface under it.
