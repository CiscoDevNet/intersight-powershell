...
New-IntersightFabricLinkControlPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Description< string>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-UdldSettings< FabricUdldSettings>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;FabricLinkControlPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightFabricLinkControlPolicy
```
