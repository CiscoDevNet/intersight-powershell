...
Set-IntersightTechsupportmanagementCollectionControlPolicy [-AdditionalProperties< Dictionary<string,object>>][[-Moid]< string>][-Tags< List<MoTag>>][-TechSupportCollection< TechsupportmanagementCollectionControlPolicy.TechSupportCollectionEnum>]
