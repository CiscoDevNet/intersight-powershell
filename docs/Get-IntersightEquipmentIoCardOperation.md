...
### CmdletParam (Default)
```
Get-IntersightEquipmentIoCardOperation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentIoCardOperation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentIoCardOperation
```
Above example returns the list of EquipmentIoCardOperation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentIoCardOperation -Name "MoName"
```
Above example returns the EquipmentIoCardOperation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentIoCardOperation -Organization $organization
```
Above example returns the list of EquipmentIoCardOperation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentIoCardOperation -InlineCount allpages
```
Above example returns the list of EquipmentIoCardOperation along with count.
...
### -Name
Specifies the name of the EquipmentIoCardOperation.
...
### -Organization
Specifies the organization, to fetch the EquipmentIoCardOperation under it.
...
[Set-IntersightEquipmentIoCardOperation](./Set-IntersightEquipmentIoCardOperation.md)
