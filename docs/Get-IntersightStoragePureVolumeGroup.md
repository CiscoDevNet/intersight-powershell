...
# Get-IntersightStoragePureVolumeGroup

## SYNOPSIS
Get the StoragePureVolumeGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureVolumeGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureVolumeGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureVolumeGroup&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureVolumeGroup
```
Above example returns the list of StoragePureVolumeGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureVolumeGroup -Name "MoName"
```
Above example returns the StoragePureVolumeGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureVolumeGroup -Organization $organization
```
Above example returns the list of StoragePureVolumeGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureVolumeGroup -InlineCount allpages
```
Above example returns the list of StoragePureVolumeGroup along with count.
...
### -Name
Specifies the name of the StoragePureVolumeGroup.
...
### -Organization
Specifies the organization, to fetch the StoragePureVolumeGroup under it.
