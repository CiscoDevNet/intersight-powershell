...
# Get-IntersightStorageHitachiNvmSubsystem

## SYNOPSIS
Get the StorageHitachiNvmSubsystem

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiNvmSubsystem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiNvmSubsystem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiNvmSubsystem&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiNvmSubsystem
```
Above example returns the list of StorageHitachiNvmSubsystem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiNvmSubsystem -Name "MoName"
```
Above example returns the StorageHitachiNvmSubsystem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiNvmSubsystem -Organization $organization
```
Above example returns the list of StorageHitachiNvmSubsystem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiNvmSubsystem -InlineCount allpages
```
Above example returns the list of StorageHitachiNvmSubsystem along with count.
...
### -Name
Specifies the name of the StorageHitachiNvmSubsystem.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiNvmSubsystem under it.
