...
# Get-IntersightNiaapiNdMetadataSoftwareDownload

## SYNOPSIS
Get the NiaapiNdMetadataSoftwareDownload

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiNdMetadataSoftwareDownload [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiNdMetadataSoftwareDownload [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiaapiNdMetadataSoftwareDownload&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiNdMetadataSoftwareDownload
```
Above example returns the list of NiaapiNdMetadataSoftwareDownload.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiNdMetadataSoftwareDownload -Name "MoName"
```
Above example returns the NiaapiNdMetadataSoftwareDownload matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiNdMetadataSoftwareDownload -Organization $organization
```
Above example returns the list of NiaapiNdMetadataSoftwareDownload available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiNdMetadataSoftwareDownload -InlineCount allpages
```
Above example returns the list of NiaapiNdMetadataSoftwareDownload along with count.
...
### -Name
Specifies the name of the NiaapiNdMetadataSoftwareDownload.
...
### -Organization
Specifies the organization, to fetch the NiaapiNdMetadataSoftwareDownload under it.
