...
## SYNOPSIS
Get the NiatelemetrySystemControllerDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetrySystemControllerDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetrySystemControllerDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetrySystemControllerDetails&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySystemControllerDetails
```
Above example returns the list of NiatelemetrySystemControllerDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySystemControllerDetails -Name "MoName"
```
Above example returns the NiatelemetrySystemControllerDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySystemControllerDetails -Organization $organization
```
Above example returns the list of NiatelemetrySystemControllerDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySystemControllerDetails -InlineCount allpages
```
Above example returns the list of NiatelemetrySystemControllerDetails along with count.
...
### -Name
Specifies the name of the NiatelemetrySystemControllerDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetrySystemControllerDetails under it.
