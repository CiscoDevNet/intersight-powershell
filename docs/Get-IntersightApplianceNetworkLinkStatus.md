...
# Get-IntersightApplianceNetworkLinkStatus

## SYNOPSIS
Get the ApplianceNetworkLinkStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceNetworkLinkStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceNetworkLinkStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceNetworkLinkStatus&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceNetworkLinkStatus
```
Above example returns the list of ApplianceNetworkLinkStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceNetworkLinkStatus -Name "MoName"
```
Above example returns the ApplianceNetworkLinkStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceNetworkLinkStatus -Organization $organization
```
Above example returns the list of ApplianceNetworkLinkStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceNetworkLinkStatus -InlineCount allpages
```
Above example returns the list of ApplianceNetworkLinkStatus along with count.
...
### -Name
Specifies the name of the ApplianceNetworkLinkStatus.
...
### -Organization
Specifies the organization, to fetch the ApplianceNetworkLinkStatus under it.
