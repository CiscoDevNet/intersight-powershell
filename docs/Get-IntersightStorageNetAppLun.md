...
## SYNOPSIS
Get the StorageNetAppLun

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppLun [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppLun [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppLun&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLun
```
Above example returns the list of StorageNetAppLun.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLun -Name "MoName"
```
Above example returns the StorageNetAppLun matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLun -Organization $organization
```
Above example returns the list of StorageNetAppLun available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLun -InlineCount allpages
```
Above example returns the list of StorageNetAppLun along with count.
...
### -Name
Specifies the name of the StorageNetAppLun.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppLun under it.
