...
### CmdletParam (Default)
```
Get-IntersightCapabilityFexDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityFexDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityFexDescriptor
```
Above example returns the list of CapabilityFexDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityFexDescriptor -Name "MoName"
```
Above example returns the CapabilityFexDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityFexDescriptor -Organization $organization
```
Above example returns the list of CapabilityFexDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityFexDescriptor -InlineCount allpages
```
Above example returns the list of CapabilityFexDescriptor along with count.
...
### -Name
Specifies the name of the CapabilityFexDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilityFexDescriptor under it.
...
[Remove-IntersightCapabilityFexDescriptor](./Remove-IntersightCapabilityFexDescriptor.md)
