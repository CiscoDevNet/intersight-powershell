...
## SYNOPSIS
Get the VirtualizationVmwareUplinkPort

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareUplinkPort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareUplinkPort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareUplinkPort&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareUplinkPort
```
Above example returns the list of VirtualizationVmwareUplinkPort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareUplinkPort -Name "MoName"
```
Above example returns the VirtualizationVmwareUplinkPort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareUplinkPort -Organization $organization
```
Above example returns the list of VirtualizationVmwareUplinkPort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareUplinkPort -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareUplinkPort along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareUplinkPort.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareUplinkPort under it.
...
[Set-IntersightVirtualizationVmwareUplinkPort](./Set-IntersightVirtualizationVmwareUplinkPort.md)
