...
# Get-IntersightApplianceClusterInfo

## SYNOPSIS
Get the ApplianceClusterInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceClusterInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceClusterInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceClusterInfo&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceClusterInfo
```
Above example returns the list of ApplianceClusterInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceClusterInfo -Name "MoName"
```
Above example returns the ApplianceClusterInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceClusterInfo -Organization $organization
```
Above example returns the list of ApplianceClusterInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceClusterInfo -InlineCount allpages
```
Above example returns the list of ApplianceClusterInfo along with count.
...
### -Name
Specifies the name of the ApplianceClusterInfo.
...
### -Organization
Specifies the organization, to fetch the ApplianceClusterInfo under it.
