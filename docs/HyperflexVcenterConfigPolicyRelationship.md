...
```powershell
$HyperflexVcenterConfigPolicyRelationship = Initialize-IntersightHyperflexVcenterConfigPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexVcenterConfigPolicyRelationship | ConvertTo-JSON
```
