...
# Get-IntersightApplianceBackupDownload

## SYNOPSIS
Get the ApplianceBackupDownload

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceBackupDownload [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceBackupDownload [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceBackupDownload&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceBackupDownload
```
Above example returns the list of ApplianceBackupDownload.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceBackupDownload -Name "MoName"
```
Above example returns the ApplianceBackupDownload matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceBackupDownload -Organization $organization
```
Above example returns the list of ApplianceBackupDownload available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceBackupDownload -InlineCount allpages
```
Above example returns the list of ApplianceBackupDownload along with count.
...
### -Name
Specifies the name of the ApplianceBackupDownload.
...
### -Organization
Specifies the organization, to fetch the ApplianceBackupDownload under it.
