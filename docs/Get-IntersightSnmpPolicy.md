...
### CmdletParam (Default)
```
Get-IntersightSnmpPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSnmpPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSnmpPolicy
```
Above example returns the list of SnmpPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSnmpPolicy -Name "MoName"
```
Above example returns the SnmpPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSnmpPolicy -Organization $organization
```
Above example returns the list of SnmpPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSnmpPolicy -InlineCount allpages
```
Above example returns the list of SnmpPolicy along with count.
...
### -Name
Specifies the name of the SnmpPolicy.
...
### -Organization
Specifies the organization, to fetch the SnmpPolicy under it.
