...
Initialize-IntersightIqnpoolReservationReference [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< IqnpoolReservationReference.ClassIdEnum>][-ObjectType< IqnpoolReservationReference.ObjectTypeEnum>][-ReservationId< string>][-ReservationMoid< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
