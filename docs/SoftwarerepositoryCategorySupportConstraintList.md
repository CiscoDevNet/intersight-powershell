...
```powershell
$SoftwarerepositoryCategorySupportConstraintList = Initialize-IntersightSoftwarerepositoryCategorySupportConstraintList  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwarerepositoryCategorySupportConstraintList | ConvertTo-JSON
```
