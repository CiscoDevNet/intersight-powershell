...
## SYNOPSIS
Get the NiatelemetryApicSnmpCommunityAccessDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicSnmpCommunityAccessDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicSnmpCommunityAccessDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpCommunityAccessDetails
```
Above example returns the list of NiatelemetryApicSnmpCommunityAccessDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpCommunityAccessDetails -Name "MoName"
```
Above example returns the NiatelemetryApicSnmpCommunityAccessDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpCommunityAccessDetails -Organization $organization
```
Above example returns the list of NiatelemetryApicSnmpCommunityAccessDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpCommunityAccessDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryApicSnmpCommunityAccessDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryApicSnmpCommunityAccessDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicSnmpCommunityAccessDetails under it.
