...
### CmdletParam (Default)
```
Get-IntersightWebhookEndpoint [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWebhookEndpoint [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WebhookEndpoint&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWebhookEndpoint
```
Above example returns the list of WebhookEndpoint.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWebhookEndpoint -Name "MoName"
```
Above example returns the WebhookEndpoint matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWebhookEndpoint -Organization $organization
```
Above example returns the list of WebhookEndpoint available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWebhookEndpoint -InlineCount allpages
```
Above example returns the list of WebhookEndpoint along with count.
...
### -Name
Specifies the name of the WebhookEndpoint.
...
### -Organization
Specifies the organization, to fetch the WebhookEndpoint under it.
