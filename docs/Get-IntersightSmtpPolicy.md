...
### CmdletParam (Default)
```
Get-IntersightSmtpPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSmtpPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SmtpPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSmtpPolicy
```
Above example returns the list of SmtpPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSmtpPolicy -Name "MoName"
```
Above example returns the SmtpPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSmtpPolicy -Organization $organization
```
Above example returns the list of SmtpPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSmtpPolicy -InlineCount allpages
```
Above example returns the list of SmtpPolicy along with count.
...
### -Name
Specifies the name of the SmtpPolicy.
...
### -Organization
Specifies the organization, to fetch the SmtpPolicy under it.
