...
## SYNOPSIS
Get the AssetSubscriptionDeviceContractInformation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAssetSubscriptionDeviceContractInformation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAssetSubscriptionDeviceContractInformation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAssetSubscriptionDeviceContractInformation
```
Above example returns the list of AssetSubscriptionDeviceContractInformation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAssetSubscriptionDeviceContractInformation -Name "MoName"
```
Above example returns the AssetSubscriptionDeviceContractInformation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAssetSubscriptionDeviceContractInformation -Organization $organization
```
Above example returns the list of AssetSubscriptionDeviceContractInformation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAssetSubscriptionDeviceContractInformation -InlineCount allpages
```
Above example returns the list of AssetSubscriptionDeviceContractInformation along with count.
...
### -Name
Specifies the name of the AssetSubscriptionDeviceContractInformation.
...
### -Organization
Specifies the organization, to fetch the AssetSubscriptionDeviceContractInformation under it.
