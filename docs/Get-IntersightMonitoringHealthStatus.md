...
## SYNOPSIS
Get the MonitoringHealthStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMonitoringHealthStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMonitoringHealthStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MonitoringHealthStatus&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMonitoringHealthStatus
```
Above example returns the list of MonitoringHealthStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMonitoringHealthStatus -Name "MoName"
```
Above example returns the MonitoringHealthStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMonitoringHealthStatus -Organization $organization
```
Above example returns the list of MonitoringHealthStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMonitoringHealthStatus -InlineCount allpages
```
Above example returns the list of MonitoringHealthStatus along with count.
...
### -Name
Specifies the name of the MonitoringHealthStatus.
...
### -Organization
Specifies the organization, to fetch the MonitoringHealthStatus under it.
