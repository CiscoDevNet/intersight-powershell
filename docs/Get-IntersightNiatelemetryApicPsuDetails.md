...
## SYNOPSIS
Get the NiatelemetryApicPsuDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicPsuDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicPsuDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetryApicPsuDetails&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicPsuDetails
```
Above example returns the list of NiatelemetryApicPsuDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicPsuDetails -Name "MoName"
```
Above example returns the NiatelemetryApicPsuDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicPsuDetails -Organization $organization
```
Above example returns the list of NiatelemetryApicPsuDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicPsuDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryApicPsuDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryApicPsuDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicPsuDetails under it.
