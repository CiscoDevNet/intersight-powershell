...
# Initialize-IntersightFunctionsFunction
...
```yaml
Type: FunctionsFunction.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FunctionsFunction.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFunctionsFunction
```
