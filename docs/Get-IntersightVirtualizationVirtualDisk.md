...
## SYNOPSIS
Get the VirtualizationVirtualDisk

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVirtualDisk [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVirtualDisk [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVirtualDisk&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVirtualDisk
```
Above example returns the list of VirtualizationVirtualDisk.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVirtualDisk -Name "MoName"
```
Above example returns the VirtualizationVirtualDisk matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVirtualDisk -Organization $organization
```
Above example returns the list of VirtualizationVirtualDisk available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVirtualDisk -InlineCount allpages
```
Above example returns the list of VirtualizationVirtualDisk along with count.
...
### -Name
Specifies the name of the VirtualizationVirtualDisk.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVirtualDisk under it.
