...
# Initialize-IntersightCloudSkuNetworkType
...
Initialize-IntersightCloudSkuNetworkType [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-BasePrice< float>][-ClassId< CloudSkuNetworkType.ClassIdEnum>][-Currency< CloudSkuNetworkType.CurrencyEnum>][-CustomAttributes< System.Collections.Generic.List`1[Model.CloudCustomAttributes]>][-Description< string>][-IsActive< bool>][-IsAutoDiscovered< bool>][-Moid< string>][-Name< string>][-ObjectType< CloudSkuNetworkType.ObjectTypeEnum>][-PlatformType< CloudSkuNetworkType.PlatformTypeEnum>][-Region< Model.CloudRegionsRelationship>][-RegionId< string>][-ServiceCategory< CloudSkuNetworkType.ServiceCategoryEnum>][-ServiceFamily< string>][-ServiceName< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Target< Model.AssetTargetRelationship>][-Unit< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: CloudSkuNetworkType.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CloudSkuNetworkType.CurrencyEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CloudSkuNetworkType.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CloudSkuNetworkType.ServiceCategoryEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCloudSkuNetworkType
```
