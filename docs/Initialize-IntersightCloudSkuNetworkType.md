...
Initialize-IntersightCloudSkuNetworkType [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< CloudSkuNetworkType.ClassIdEnum>][-CustomAttributes< System.Collections.Generic.List`1[Model.CloudCustomAttributes]>][-Description< string>][-IsActive< bool>][-IsAutoDiscovered< bool>][-Moid< string>][-Name< string>][-ObjectType< CloudSkuNetworkType.ObjectTypeEnum>][-PlatformType< CloudSkuNetworkType.PlatformTypeEnum>][-ServiceCategory< CloudSkuNetworkType.ServiceCategoryEnum>][-ServiceFamily< string>][-ServiceName< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Target< Model.AssetTargetRelationship>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
