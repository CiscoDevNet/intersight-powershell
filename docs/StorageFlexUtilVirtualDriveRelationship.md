...
```powershell
$StorageFlexUtilVirtualDriveRelationship = Initialize-IntersightStorageFlexUtilVirtualDriveRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StorageFlexUtilVirtualDriveRelationship | ConvertTo-JSON
```
