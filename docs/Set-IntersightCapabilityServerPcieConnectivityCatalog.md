...
Set-IntersightCapabilityServerPcieConnectivityCatalog [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][[-Moid]< string>][-Name< string>][-SupportedLayouts< System.Collections.Generic.List`1[CapabilityServerPcieConnectivityLayout]>][-SupportedNumberOfGpus< System.Collections.Generic.List`1[long]>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
