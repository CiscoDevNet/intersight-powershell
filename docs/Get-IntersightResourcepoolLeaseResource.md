...
## SYNOPSIS
Get the ResourcepoolLeaseResource

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightResourcepoolLeaseResource [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourcepoolLeaseResource [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ResourcepoolLeaseResource&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourcepoolLeaseResource
```
Above example returns the list of ResourcepoolLeaseResource.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourcepoolLeaseResource -Name "MoName"
```
Above example returns the ResourcepoolLeaseResource matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourcepoolLeaseResource -Organization $organization
```
Above example returns the list of ResourcepoolLeaseResource available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourcepoolLeaseResource -InlineCount allpages
```
Above example returns the list of ResourcepoolLeaseResource along with count.
...
### -Name
Specifies the name of the ResourcepoolLeaseResource.
...
### -Organization
Specifies the organization, to fetch the ResourcepoolLeaseResource under it.
