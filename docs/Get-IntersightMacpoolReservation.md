...
# Get-IntersightMacpoolReservation

## SYNOPSIS
Get the MacpoolReservation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMacpoolReservation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMacpoolReservation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MacpoolReservation&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMacpoolReservation
```
Above example returns the list of MacpoolReservation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMacpoolReservation -Name "MoName"
```
Above example returns the MacpoolReservation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMacpoolReservation -Organization $organization
```
Above example returns the list of MacpoolReservation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMacpoolReservation -InlineCount allpages
```
Above example returns the list of MacpoolReservation along with count.
...
### -Name
Specifies the name of the MacpoolReservation.
...
### -Organization
Specifies the organization, to fetch the MacpoolReservation under it.
