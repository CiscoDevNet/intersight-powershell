...
# Get-IntersightWebhookSchema

## SYNOPSIS
Get the WebhookSchema

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWebhookSchema [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWebhookSchema [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WebhookSchema&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWebhookSchema
```
Above example returns the list of WebhookSchema.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWebhookSchema -Name "MoName"
```
Above example returns the WebhookSchema matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWebhookSchema -Organization $organization
```
Above example returns the list of WebhookSchema available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWebhookSchema -InlineCount allpages
```
Above example returns the list of WebhookSchema along with count.
...
### -Name
Specifies the name of the WebhookSchema.
...
### -Organization
Specifies the organization, to fetch the WebhookSchema under it.
...
[Remove-IntersightWebhookSchema](./Remove-IntersightWebhookSchema.md)
