...
# Initialize-IntersightFabricElementIdentity
...
Initialize-IntersightFabricElementIdentity [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AdminAction< FabricElementIdentity.AdminActionEnum>][-ClassId< FabricElementIdentity.ClassIdEnum>][-Identifier< long>][-Moid< string>][-ObjectType< FabricElementIdentity.ObjectTypeEnum>][-ReplacementTarget< Model.NetworkElementRelationship>][-ReplacementType< FabricElementIdentity.ReplacementTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: FabricElementIdentity.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricElementIdentity.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFabricElementIdentity
```
