...
Initialize-IntersightFabricElementIdentity [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AdminAction< FabricElementIdentity.AdminActionEnum>][-ClassId< FabricElementIdentity.ClassIdEnum>][-Moid< string>][-ObjectType< FabricElementIdentity.ObjectTypeEnum>][-ReplacementTarget< Model.NetworkElementRelationship>][-ReplacementType< FabricElementIdentity.ReplacementTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
