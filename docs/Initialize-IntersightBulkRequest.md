...
# Initialize-IntersightBulkRequest
...
```yaml
Type: BulkRequest.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.BulkSubRequest]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightBulkRequest
```
