...
```powershell
$WorkflowErrorResponseHandlerResponse = Initialize-IntersightWorkflowErrorResponseHandlerResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$WorkflowErrorResponseHandlerResponse | ConvertTo-JSON
```
