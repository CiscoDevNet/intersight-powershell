...
# Get-IntersightStoragePureNfsPolicyRule

## SYNOPSIS
Get the StoragePureNfsPolicyRule

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureNfsPolicyRule [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureNfsPolicyRule [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureNfsPolicyRule&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureNfsPolicyRule
```
Above example returns the list of StoragePureNfsPolicyRule.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureNfsPolicyRule -Name "MoName"
```
Above example returns the StoragePureNfsPolicyRule matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureNfsPolicyRule -Organization $organization
```
Above example returns the list of StoragePureNfsPolicyRule available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureNfsPolicyRule -InlineCount allpages
```
Above example returns the list of StoragePureNfsPolicyRule along with count.
...
### -Name
Specifies the name of the StoragePureNfsPolicyRule.
...
### -Organization
Specifies the organization, to fetch the StoragePureNfsPolicyRule under it.
