...
## SYNOPSIS
Get the KubernetesDaemonSet

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesDaemonSet [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesDaemonSet [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KubernetesDaemonSet&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesDaemonSet
```
Above example returns the list of KubernetesDaemonSet.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesDaemonSet -Name "MoName"
```
Above example returns the KubernetesDaemonSet matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesDaemonSet -Organization $organization
```
Above example returns the list of KubernetesDaemonSet available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesDaemonSet -InlineCount allpages
```
Above example returns the list of KubernetesDaemonSet along with count.
...
### -Name
Specifies the name of the KubernetesDaemonSet.
...
### -Organization
Specifies the organization, to fetch the KubernetesDaemonSet under it.
...
[Remove-IntersightKubernetesDaemonSet](./Remove-IntersightKubernetesDaemonSet.md)
