...
# Initialize-IntersightVirtualizationVmwareKernelNetwork
...
Initialize-IntersightVirtualizationVmwareKernelNetwork [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< VirtualizationVmwareKernelNetwork.ClassIdEnum>][-FaultToleranceLogging< bool>][-Identity< string>][-IpAddress< System.Collections.Generic.List`1[string]>][-MacAddress< string>][-Management< bool>][-Moid< string>][-Mtu< long>][-Name< string>][-ObjectType< VirtualizationVmwareKernelNetwork.ObjectTypeEnum>][-RegisteredDevice< Model.AssetDeviceRegistrationRelationship>][-SubnetMask< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TcpIpStack< string>][-Vmotion< bool>][-Vsan< bool>][-VsphereProvisioning< bool>][-VsphereReplication< bool>][-VsphereReplicationNfc< bool>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: VirtualizationVmwareKernelNetwork.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VirtualizationVmwareKernelNetwork.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVirtualizationVmwareKernelNetwork
```
