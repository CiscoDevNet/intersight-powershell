...
# Get-IntersightCoremanagementCoreFile

## SYNOPSIS
Get the CoremanagementCoreFile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCoremanagementCoreFile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCoremanagementCoreFile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CoremanagementCoreFile&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCoremanagementCoreFile
```
Above example returns the list of CoremanagementCoreFile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCoremanagementCoreFile -Name "MoName"
```
Above example returns the CoremanagementCoreFile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCoremanagementCoreFile -Organization $organization
```
Above example returns the list of CoremanagementCoreFile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCoremanagementCoreFile -InlineCount allpages
```
Above example returns the list of CoremanagementCoreFile along with count.
...
### -Name
Specifies the name of the CoremanagementCoreFile.
...
### -Organization
Specifies the organization, to fetch the CoremanagementCoreFile under it.
...
[Remove-IntersightCoremanagementCoreFile](./Remove-IntersightCoremanagementCoreFile.md)
