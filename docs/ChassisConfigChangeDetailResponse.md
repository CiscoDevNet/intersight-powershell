...
```powershell
$ChassisConfigChangeDetailResponse = Initialize-IntersightChassisConfigChangeDetailResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$ChassisConfigChangeDetailResponse | ConvertTo-JSON
```
