...
# Get-IntersightComputeBladeIdentity

## SYNOPSIS
Get the ComputeBladeIdentity

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputeBladeIdentity [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputeBladeIdentity [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ComputeBladeIdentity&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputeBladeIdentity
```
Above example returns the list of ComputeBladeIdentity.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputeBladeIdentity -Name "MoName"
```
Above example returns the ComputeBladeIdentity matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputeBladeIdentity -Organization $organization
```
Above example returns the list of ComputeBladeIdentity available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputeBladeIdentity -InlineCount allpages
```
Above example returns the list of ComputeBladeIdentity along with count.
...
### -Name
Specifies the name of the ComputeBladeIdentity.
...
### -Organization
Specifies the organization, to fetch the ComputeBladeIdentity under it.
