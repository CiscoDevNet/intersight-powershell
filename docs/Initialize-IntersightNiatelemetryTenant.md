...
# Initialize-IntersightNiatelemetryTenant
...
```yaml
Type: NiatelemetryTenant.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: NiatelemetryTenant.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightNiatelemetryTenant
```
