...
## SYNOPSIS
Get the ApplianceFileGateway

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceFileGateway [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceFileGateway [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceFileGateway
```
Above example returns the list of ApplianceFileGateway.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceFileGateway -Name "MoName"
```
Above example returns the ApplianceFileGateway matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceFileGateway -Organization $organization
```
Above example returns the list of ApplianceFileGateway available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceFileGateway -InlineCount allpages
```
Above example returns the list of ApplianceFileGateway along with count.
...
### -Name
Specifies the name of the ApplianceFileGateway.
...
### -Organization
Specifies the organization, to fetch the ApplianceFileGateway under it.
