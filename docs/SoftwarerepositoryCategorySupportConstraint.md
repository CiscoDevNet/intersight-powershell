...
```powershell
$SoftwarerepositoryCategorySupportConstraint = Initialize-IntersightSoftwarerepositoryCategorySupportConstraint  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$SoftwarerepositoryCategorySupportConstraint | ConvertTo-JSON
```
