...
# Get-IntersightRecommendationClusterExpansion

## SYNOPSIS
Get the RecommendationClusterExpansion

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRecommendationClusterExpansion [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRecommendationClusterExpansion [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;RecommendationClusterExpansion&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRecommendationClusterExpansion
```
Above example returns the list of RecommendationClusterExpansion.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRecommendationClusterExpansion -Name "MoName"
```
Above example returns the RecommendationClusterExpansion matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRecommendationClusterExpansion -Organization $organization
```
Above example returns the list of RecommendationClusterExpansion available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRecommendationClusterExpansion -InlineCount allpages
```
Above example returns the list of RecommendationClusterExpansion along with count.
...
### -Name
Specifies the name of the RecommendationClusterExpansion.
...
### -Organization
Specifies the organization, to fetch the RecommendationClusterExpansion under it.
