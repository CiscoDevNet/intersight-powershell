...
## SYNOPSIS
Get the LicenseLicenseInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightLicenseLicenseInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightLicenseLicenseInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightLicenseLicenseInfo
```
Above example returns the list of LicenseLicenseInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightLicenseLicenseInfo -Name "MoName"
```
Above example returns the LicenseLicenseInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightLicenseLicenseInfo -Organization $organization
```
Above example returns the list of LicenseLicenseInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightLicenseLicenseInfo -InlineCount allpages
```
Above example returns the list of LicenseLicenseInfo along with count.
...
### -Name
Specifies the name of the LicenseLicenseInfo.
...
### -Organization
Specifies the organization, to fetch the LicenseLicenseInfo under it.
...
[New-IntersightLicenseLicenseInfo](./New-IntersightLicenseLicenseInfo.md)
