...
## SYNOPSIS
Get the FirmwareUpgradeStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareUpgradeStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareUpgradeStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareUpgradeStatus&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareUpgradeStatus
```
Above example returns the list of FirmwareUpgradeStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareUpgradeStatus -Name "MoName"
```
Above example returns the FirmwareUpgradeStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareUpgradeStatus -Organization $organization
```
Above example returns the list of FirmwareUpgradeStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareUpgradeStatus -InlineCount allpages
```
Above example returns the list of FirmwareUpgradeStatus along with count.
...
### -Name
Specifies the name of the FirmwareUpgradeStatus.
...
### -Organization
Specifies the organization, to fetch the FirmwareUpgradeStatus under it.
