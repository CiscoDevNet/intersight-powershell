...
# Get-IntersightCapabilityHsuIsoFileSupportMeta

## SYNOPSIS
Get the CapabilityHsuIsoFileSupportMeta

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityHsuIsoFileSupportMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityHsuIsoFileSupportMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilityHsuIsoFileSupportMeta&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityHsuIsoFileSupportMeta
```
Above example returns the list of CapabilityHsuIsoFileSupportMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityHsuIsoFileSupportMeta -Name "MoName"
```
Above example returns the CapabilityHsuIsoFileSupportMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityHsuIsoFileSupportMeta -Organization $organization
```
Above example returns the list of CapabilityHsuIsoFileSupportMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityHsuIsoFileSupportMeta -InlineCount allpages
```
Above example returns the list of CapabilityHsuIsoFileSupportMeta along with count.
...
### -Name
Specifies the name of the CapabilityHsuIsoFileSupportMeta.
...
### -Organization
Specifies the organization, to fetch the CapabilityHsuIsoFileSupportMeta under it.
