...
```powershell
$KubernetesVersionPolicyRelationship = Initialize-IntersightKubernetesVersionPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$KubernetesVersionPolicyRelationship | ConvertTo-JSON
```
