...
```powershell
$HyperflexUcsmConfigPolicyResponse = Initialize-IntersightHyperflexUcsmConfigPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexUcsmConfigPolicyResponse | ConvertTo-JSON
```
