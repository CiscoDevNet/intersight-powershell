...
```powershell
$NiatelemetryNexusDashboardMemoryDetailsResponse = Initialize-IntersightNiatelemetryNexusDashboardMemoryDetailsResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiatelemetryNexusDashboardMemoryDetailsResponse | ConvertTo-JSON
```
