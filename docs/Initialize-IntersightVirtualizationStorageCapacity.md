...
Initialize-IntersightVirtualizationStorageCapacity [-AdditionalProperties< Dictionary<string,object>>][-Capacity< long>][-ClassId< VirtualizationStorageCapacity.ClassIdEnum>][-Free< long>][-ObjectType< VirtualizationStorageCapacity.ObjectTypeEnum>][-Used< long>]
