...
Initialize-IntersightVirtualizationStorageCapacity [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Capacity< long>][-ClassId< VirtualizationStorageCapacity.ClassIdEnum>][-Free< long>][-ObjectType< VirtualizationStorageCapacity.ObjectTypeEnum>][-Used< long>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: VirtualizationStorageCapacity.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VirtualizationStorageCapacity.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVirtualizationStorageCapacity
```
