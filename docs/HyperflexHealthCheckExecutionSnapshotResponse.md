...
```powershell
$HyperflexHealthCheckExecutionSnapshotResponse = Initialize-IntersightHyperflexHealthCheckExecutionSnapshotResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexHealthCheckExecutionSnapshotResponse | ConvertTo-JSON
```
