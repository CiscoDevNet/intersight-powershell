...
# Initialize-IntersightMgmtConfigBackupOperation
...
Initialize-IntersightMgmtConfigBackupOperation [-Account< Model.IamAccountRelationship>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< MgmtConfigBackupOperation.ClassIdEnum>][-Description< string>][-Destination< MgmtConfigBackupOperation.DestinationEnum>][-Moid< string>][-Name< string>][-ObjectType< MgmtConfigBackupOperation.ObjectTypeEnum>][-Options< Model.MgmtBackupOptions>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-UserBackupFile< Model.MgmtConfigBackupFileRelationship>][-UserPassword< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: MgmtConfigBackupOperation.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: MgmtConfigBackupOperation.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.MgmtConfigBackupFileRelationship
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightMgmtConfigBackupOperation
```
