...
```powershell
$WorkflowBuildTaskMetaOwnerResponse = Initialize-IntersightWorkflowBuildTaskMetaOwnerResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$WorkflowBuildTaskMetaOwnerResponse | ConvertTo-JSON
```
