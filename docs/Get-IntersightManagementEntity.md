...
## SYNOPSIS
Get the ManagementEntity

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightManagementEntity [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightManagementEntity [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ManagementEntity&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightManagementEntity
```
Above example returns the list of ManagementEntity.

### Example 2
```powershell
PS C:\> $result = Get-IntersightManagementEntity -Name "MoName"
```
Above example returns the ManagementEntity matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightManagementEntity -Organization $organization
```
Above example returns the list of ManagementEntity available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightManagementEntity -InlineCount allpages
```
Above example returns the list of ManagementEntity along with count.
...
### -Name
Specifies the name of the ManagementEntity.
...
### -Organization
Specifies the organization, to fetch the ManagementEntity under it.
...
[Set-IntersightManagementEntity](./Set-IntersightManagementEntity.md)
