...
```powershell
$StorageNetAppInitiatorGroupRelationship = Initialize-IntersightStorageNetAppInitiatorGroupRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StorageNetAppInitiatorGroupRelationship | ConvertTo-JSON
```
