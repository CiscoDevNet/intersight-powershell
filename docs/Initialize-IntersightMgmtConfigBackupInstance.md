...
# Initialize-IntersightMgmtConfigBackupInstance
...
Initialize-IntersightMgmtConfigBackupInstance [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AdminAction< MgmtConfigBackupInstance.AdminActionEnum>][-ClassId< MgmtConfigBackupInstance.ClassIdEnum>][-Description< string>][-Moid< string>][-ObjectType< MgmtConfigBackupInstance.ObjectTypeEnum>][-RetentionLock< bool>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-UserPassword< string>][-UserPublicKey< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: MgmtConfigBackupInstance.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: MgmtConfigBackupInstance.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightMgmtConfigBackupInstance
```
