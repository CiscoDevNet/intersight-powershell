# Intersight.Intersight/Api.IntersightApplianceApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**New-IntersightApplianceBackup**](IntersightApplianceApi.md#New-IntersightApplianceBackup) | **POST** /api/v1/appliance/Backups | Create a &#39;appliance.Backup&#39; resource.
[**New-IntersightApplianceBackupPolicy**](IntersightApplianceApi.md#New-IntersightApplianceBackupPolicy) | **POST** /api/v1/appliance/BackupPolicies | Create a &#39;appliance.BackupPolicy&#39; resource.
[**New-IntersightApplianceDataExportPolicy**](IntersightApplianceApi.md#New-IntersightApplianceDataExportPolicy) | **POST** /api/v1/appliance/DataExportPolicies | Create a &#39;appliance.DataExportPolicy&#39; resource.
[**New-IntersightApplianceDeviceClaim**](IntersightApplianceApi.md#New-IntersightApplianceDeviceClaim) | **POST** /api/v1/appliance/DeviceClaims | Create a &#39;appliance.DeviceClaim&#39; resource.
[**New-IntersightApplianceDiagSetting**](IntersightApplianceApi.md#New-IntersightApplianceDiagSetting) | **POST** /api/v1/appliance/DiagSettings | Create a &#39;appliance.DiagSetting&#39; resource.
...
[**Get-IntersightApplianceBackupPolicyList**](IntersightApplianceApi.md#Get-IntersightApplianceBackupPolicyList) | **GET** /api/v1/appliance/BackupPolicies | Read a &#39;appliance.BackupPolicy&#39; resource.
[**Get-IntersightApplianceCertificateSettingByMoid**](IntersightApplianceApi.md#Get-IntersightApplianceCertificateSettingByMoid) | **GET** /api/v1/appliance/CertificateSettings/{Moid} | Read a &#39;appliance.CertificateSetting&#39; resource.
...
[**Get-IntersightApplianceRestoreList**](IntersightApplianceApi.md#Get-IntersightApplianceRestoreList) | **GET** /api/v1/appliance/Restores | Read a &#39;appliance.Restore&#39; resource.
[**Get-IntersightApplianceSetupInfoByMoid**](IntersightApplianceApi.md#Get-IntersightApplianceSetupInfoByMoid) | **GET** /api/v1/appliance/SetupInfos/{Moid} | Read a &#39;appliance.SetupInfo&#39; resource.
...
[**Get-IntersightApplianceUpgradePolicyList**](IntersightApplianceApi.md#Get-IntersightApplianceUpgradePolicyList) | **GET** /api/v1/appliance/UpgradePolicies | Read a &#39;appliance.UpgradePolicy&#39; resource.
...
<a name="New-IntersightApplianceBackup"></a>
# **New-IntersightApplianceBackup**
> ApplianceBackup New-IntersightApplianceBackup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceBackup] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
------------- | ------------- | ------------- | -------------
 **ApplianceBackup** | [**ApplianceBackup**](ApplianceBackup.md)| The &#39;appliance.Backup&#39; resource to create. | 
...
<a name="New-IntersightApplianceBackupPolicy"></a>
# **New-IntersightApplianceBackupPolicy**
> ApplianceBackupPolicy New-IntersightApplianceBackupPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceBackupPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfNoneMatch] <String><br>
...
$ApplianceBackupPolicy = (Initialize-appliance.BackupPolicy -ClassId "appliance.BackupPolicy" -ObjectType "appliance.BackupPolicy" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Filename "Filename_example" -Protocol "scp" -RemoteHost "RemoteHost_example" -RemotePath "RemotePath_example" -RemotePort 123 -Username "Username_example" -BackupTime Get-Date -IsPasswordSet $false -ManualBackup $false -Password "Password_example" -Schedule (Initialize-onprem.Schedule -ClassId "onprem.Schedule" -ObjectType "onprem.Schedule" -DayOfMonth 123 -DayOfWeek 123 -MonthOfYear 123 -RepeatInterval 123 -TimeOfDay 123 -TimeZone "Pacific/Niue" -WeekOfMonth 123) -Account ) # ApplianceBackupPolicy | The 'appliance.BackupPolicy' resource to create.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
$IfNoneMatch = "IfNoneMatch_example" # String | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ApplianceBackupPolicy** | [**ApplianceBackupPolicy**](ApplianceBackupPolicy.md)| The &#39;appliance.BackupPolicy&#39; resource to create. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
 **IfNoneMatch** | **String**| For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte. | [optional] 
...
<a name="New-IntersightApplianceDataExportPolicy"></a>
# **New-IntersightApplianceDataExportPolicy**
> ApplianceDataExportPolicy New-IntersightApplianceDataExportPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceDataExportPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfNoneMatch] <String><br>
...
$ApplianceDataExportPolicy = (Initialize-appliance.DataExportPolicy -ClassId "appliance.DataExportPolicy" -ObjectType "appliance.DataExportPolicy" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Enable $false -Name "Name_example" -Account  -ParentConfig (Initialize-appliance.DataExportPolicy.Relationship -ClassId "appliance.DataExportPolicy" -ObjectType "appliance.DataExportPolicy" -Moid "Moid_example" -Selector "Selector_example" -Link "Link_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Enable $false -Name "Name_example" -Account  -ParentConfig (Initialize-appliance.DataExportPolicy.Relationship -ClassId "appliance.DataExportPolicy" -ObjectType "appliance.DataExportPolicy" -Moid "Moid_example" -Selector "Selector_example" -Link "Link_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Enable $false -Name "Name_example" -Account  -ParentConfig  -SubConfigs @()) -SubConfigs @()) -SubConfigs @()) # ApplianceDataExportPolicy | The 'appliance.DataExportPolicy' resource to create.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
$IfNoneMatch = "IfNoneMatch_example" # String | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ApplianceDataExportPolicy** | [**ApplianceDataExportPolicy**](ApplianceDataExportPolicy.md)| The &#39;appliance.DataExportPolicy&#39; resource to create. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
 **IfNoneMatch** | **String**| For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte. | [optional] 
...
<a name="New-IntersightApplianceDeviceClaim"></a>
# **New-IntersightApplianceDeviceClaim**
> ApplianceDeviceClaim New-IntersightApplianceDeviceClaim<br>
...
$ApplianceDeviceClaim = (Initialize-appliance.DeviceClaim -ClassId "appliance.DeviceClaim" -ObjectType "appliance.DeviceClaim" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceId "DeviceId_example" -Hostname "Hostname_example" -IsPasswordSet $false -IsRenew $false -Message "Message_example" -Password "Password_example" -PlatformType "" -RequestId "RequestId_example" -SecurityToken "SecurityToken_example" -Status "started" -Username "Username_example" -Account ) # ApplianceDeviceClaim | The 'appliance.DeviceClaim' resource to create.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
$IfNoneMatch = "IfNoneMatch_example" # String | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ApplianceDeviceClaim** | [**ApplianceDeviceClaim**](ApplianceDeviceClaim.md)| The &#39;appliance.DeviceClaim&#39; resource to create. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
 **IfNoneMatch** | **String**| For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte. | [optional] 
...
<a name="New-IntersightApplianceDiagSetting"></a>
# **New-IntersightApplianceDiagSetting**
> ApplianceDiagSetting New-IntersightApplianceDiagSetting<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceDiagSetting] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfNoneMatch] <String><br>
...
$ApplianceDiagSetting = (Initialize-appliance.DiagSetting -ClassId "appliance.DiagSetting" -ObjectType "appliance.DiagSetting" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -IsPasswordSet $false -Message "Message_example" -Password "Password_example" -Account ) # ApplianceDiagSetting | The 'appliance.DiagSetting' resource to create.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
$IfNoneMatch = "IfNoneMatch_example" # String | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ApplianceDiagSetting** | [**ApplianceDiagSetting**](ApplianceDiagSetting.md)| The &#39;appliance.DiagSetting&#39; resource to create. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
 **IfNoneMatch** | **String**| For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte. | [optional] 
...
<a name="New-IntersightApplianceRestore"></a>
# **New-IntersightApplianceRestore**
> ApplianceRestore New-IntersightApplianceRestore<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceRestore] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfNoneMatch] <String><br>
...
$ApplianceRestore = (Initialize-appliance.Restore -ClassId "appliance.Restore" -ObjectType "appliance.Restore" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Filename "Filename_example" -Protocol "scp" -RemoteHost "RemoteHost_example" -RemotePath "RemotePath_example" -RemotePort 123 -Username "Username_example" -ElapsedTime 123 -EndTime Get-Date -IsPasswordSet $false -Messages @("Messages_example") -Password "Password_example" -StartTime Get-Date -Status "Started" -Account ) # ApplianceRestore | The 'appliance.Restore' resource to create.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
$IfNoneMatch = "IfNoneMatch_example" # String | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ApplianceRestore** | [**ApplianceRestore**](ApplianceRestore.md)| The &#39;appliance.Restore&#39; resource to create. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
 **IfNoneMatch** | **String**| For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte. | [optional] 
...
<a name="Remove-IntersightApplianceBackup"></a>
# **Remove-IntersightApplianceBackup**
> void Remove-IntersightApplianceBackup<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Remove-IntersightApplianceRestore"></a>
# **Remove-IntersightApplianceRestore**
> void Remove-IntersightApplianceRestore<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Get-IntersightApplianceBackupByMoid"></a>
# **Get-IntersightApplianceBackupByMoid**
> ApplianceBackup Get-IntersightApplianceBackupByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Get-IntersightApplianceBackupList"></a>
# **Get-IntersightApplianceBackupList**
> ApplianceBackupResponse Get-IntersightApplianceBackupList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
<a name="Get-IntersightApplianceBackupPolicyByMoid"></a>
# **Get-IntersightApplianceBackupPolicyByMoid**
> ApplianceBackupPolicy Get-IntersightApplianceBackupPolicyByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Get-IntersightApplianceBackupPolicyList"></a>
# **Get-IntersightApplianceBackupPolicyList**
> ApplianceBackupPolicyResponse Get-IntersightApplianceBackupPolicyList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
<a name="Get-IntersightApplianceCertificateSettingByMoid"></a>
# **Get-IntersightApplianceCertificateSettingByMoid**
> ApplianceCertificateSetting Get-IntersightApplianceCertificateSettingByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Get-IntersightApplianceCertificateSettingList"></a>
# **Get-IntersightApplianceCertificateSettingList**
> ApplianceCertificateSettingResponse Get-IntersightApplianceCertificateSettingList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
<a name="Get-IntersightApplianceDataExportPolicyByMoid"></a>
# **Get-IntersightApplianceDataExportPolicyByMoid**
> ApplianceDataExportPolicy Get-IntersightApplianceDataExportPolicyByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Get-IntersightApplianceDataExportPolicyList"></a>
# **Get-IntersightApplianceDataExportPolicyList**
> ApplianceDataExportPolicyResponse Get-IntersightApplianceDataExportPolicyList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
<a name="Get-IntersightApplianceDeviceClaimByMoid"></a>
# **Get-IntersightApplianceDeviceClaimByMoid**
> ApplianceDeviceClaim Get-IntersightApplianceDeviceClaimByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Get-IntersightApplianceDeviceClaimList"></a>
# **Get-IntersightApplianceDeviceClaimList**
> ApplianceDeviceClaimResponse Get-IntersightApplianceDeviceClaimList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
<a name="Get-IntersightApplianceDiagSettingByMoid"></a>
# **Get-IntersightApplianceDiagSettingByMoid**
> ApplianceDiagSetting Get-IntersightApplianceDiagSettingByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Get-IntersightApplianceDiagSettingList"></a>
# **Get-IntersightApplianceDiagSettingList**
> ApplianceDiagSettingResponse Get-IntersightApplianceDiagSettingList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
<a name="Get-IntersightApplianceImageBundleByMoid"></a>
# **Get-IntersightApplianceImageBundleByMoid**
> ApplianceImageBundle Get-IntersightApplianceImageBundleByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Get-IntersightApplianceImageBundleList"></a>
# **Get-IntersightApplianceImageBundleList**
> ApplianceImageBundleResponse Get-IntersightApplianceImageBundleList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
<a name="Get-IntersightApplianceNodeInfoByMoid"></a>
# **Get-IntersightApplianceNodeInfoByMoid**
> ApplianceNodeInfo Get-IntersightApplianceNodeInfoByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Get-IntersightApplianceNodeInfoList"></a>
# **Get-IntersightApplianceNodeInfoList**
> ApplianceNodeInfoResponse Get-IntersightApplianceNodeInfoList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
<a name="Get-IntersightApplianceReleaseNoteByMoid"></a>
# **Get-IntersightApplianceReleaseNoteByMoid**
> ApplianceReleaseNote Get-IntersightApplianceReleaseNoteByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Get-IntersightApplianceReleaseNoteList"></a>
# **Get-IntersightApplianceReleaseNoteList**
> ApplianceReleaseNoteResponse Get-IntersightApplianceReleaseNoteList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
<a name="Get-IntersightApplianceRestoreByMoid"></a>
# **Get-IntersightApplianceRestoreByMoid**
> ApplianceRestore Get-IntersightApplianceRestoreByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Get-IntersightApplianceRestoreList"></a>
# **Get-IntersightApplianceRestoreList**
> ApplianceRestoreResponse Get-IntersightApplianceRestoreList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
<a name="Get-IntersightApplianceSetupInfoByMoid"></a>
# **Get-IntersightApplianceSetupInfoByMoid**
> ApplianceSetupInfo Get-IntersightApplianceSetupInfoByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Get-IntersightApplianceSetupInfoList"></a>
# **Get-IntersightApplianceSetupInfoList**
> ApplianceSetupInfoResponse Get-IntersightApplianceSetupInfoList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
<a name="Get-IntersightApplianceSystemInfoByMoid"></a>
# **Get-IntersightApplianceSystemInfoByMoid**
> ApplianceSystemInfo Get-IntersightApplianceSystemInfoByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Get-IntersightApplianceSystemInfoList"></a>
# **Get-IntersightApplianceSystemInfoList**
> ApplianceSystemInfoResponse Get-IntersightApplianceSystemInfoList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
<a name="Get-IntersightApplianceUpgradeByMoid"></a>
# **Get-IntersightApplianceUpgradeByMoid**
> ApplianceUpgrade Get-IntersightApplianceUpgradeByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Get-IntersightApplianceUpgradeList"></a>
# **Get-IntersightApplianceUpgradeList**
> ApplianceUpgradeResponse Get-IntersightApplianceUpgradeList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
<a name="Get-IntersightApplianceUpgradePolicyByMoid"></a>
# **Get-IntersightApplianceUpgradePolicyByMoid**
> ApplianceUpgradePolicy Get-IntersightApplianceUpgradePolicyByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
<a name="Get-IntersightApplianceUpgradePolicyList"></a>
# **Get-IntersightApplianceUpgradePolicyList**
> ApplianceUpgradePolicyResponse Get-IntersightApplianceUpgradePolicyList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
<a name="Set-IntersightApplianceBackupPolicy"></a>
# **Set-IntersightApplianceBackupPolicy**
> ApplianceBackupPolicy Set-IntersightApplianceBackupPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceBackupPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **ApplianceBackupPolicy** | [**ApplianceBackupPolicy**](ApplianceBackupPolicy.md)| The &#39;appliance.BackupPolicy&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightApplianceCertificateSetting"></a>
# **Set-IntersightApplianceCertificateSetting**
> ApplianceCertificateSetting Set-IntersightApplianceCertificateSetting<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceCertificateSetting] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$ApplianceCertificateSetting = (Initialize-appliance.CertificateSetting -ClassId "appliance.CertificateSetting" -ObjectType "appliance.CertificateSetting" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Account  -Certificate (Initialize-iam.Certificate.Relationship -ClassId "iam.Certificate" -ObjectType "iam.Certificate" -Moid "Moid_example" -Selector "Selector_example" -Link "Link_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Certificate  -Status "PendingValidation" -CertificateRequest (Initialize-iam.CertificateRequest.Relationship -ClassId "iam.CertificateRequest" -ObjectType "iam.CertificateRequest" -Moid "Moid_example" -Selector "Selector_example" -Link "Link_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -EmailAddress "EmailAddress_example" -Name "Name_example" -Request "Request_example" -SelfSigned $false -Subject  -SubjectAlternateName (Initialize-pkix.SubjectAlternateName -ClassId "pkix.SubjectAlternateName" -ObjectType "pkix.SubjectAlternateName" -DnsName @("DnsName_example") -EmailAddress @("EmailAddress_example") -IpAddress @("IpAddress_example") -Uri @("Uri_example")) -Account  -Certificate (Initialize-iam.Certificate.Relationship -ClassId "iam.Certificate" -ObjectType "iam.Certificate" -Moid "Moid_example" -Selector "Selector_example" -Link "Link_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Certificate  -Status "PendingValidation" -CertificateRequest (Initialize-iam.CertificateRequest.Relationship -ClassId "iam.CertificateRequest" -ObjectType "iam.CertificateRequest" -Moid "Moid_example" -Selector "Selector_example" -Link "Link_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -EmailAddress "EmailAddress_example" -Name "Name_example" -Request "Request_example" -SelfSigned $false -Subject  -SubjectAlternateName (Initialize-pkix.SubjectAlternateName -ClassId "pkix.SubjectAlternateName" -ObjectType "pkix.SubjectAlternateName" -DnsName @("DnsName_example") -EmailAddress @("EmailAddress_example") -IpAddress @("IpAddress_example") -Uri @("Uri_example")) -Account  -Certificate  -PrivateKeySpec (Initialize-iam.PrivateKeySpec.Relationship -ClassId "iam.PrivateKeySpec" -ObjectType "iam.PrivateKeySpec" -Moid "Moid_example" -Selector "Selector_example" -Link "Link_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Algorithm  -CertificateRequest ))) -PrivateKeySpec (Initialize-iam.PrivateKeySpec.Relationship -ClassId "iam.PrivateKeySpec" -ObjectType "iam.PrivateKeySpec" -Moid "Moid_example" -Selector "Selector_example" -Link "Link_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Algorithm  -CertificateRequest )))) # ApplianceCertificateSetting | The 'appliance.CertificateSetting' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **ApplianceCertificateSetting** | [**ApplianceCertificateSetting**](ApplianceCertificateSetting.md)| The &#39;appliance.CertificateSetting&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightApplianceDataExportPolicy"></a>
# **Set-IntersightApplianceDataExportPolicy**
> ApplianceDataExportPolicy Set-IntersightApplianceDataExportPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceDataExportPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$ApplianceDataExportPolicy = (Initialize-appliance.DataExportPolicy -ClassId "appliance.DataExportPolicy" -ObjectType "appliance.DataExportPolicy" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Enable $false -Name "Name_example" -Account  -ParentConfig  -SubConfigs @()) # ApplianceDataExportPolicy | The 'appliance.DataExportPolicy' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **ApplianceDataExportPolicy** | [**ApplianceDataExportPolicy**](ApplianceDataExportPolicy.md)| The &#39;appliance.DataExportPolicy&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$ApplianceDeviceClaim = (Initialize-appliance.DeviceClaim -ClassId "appliance.DeviceClaim" -ObjectType "appliance.DeviceClaim" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceId "DeviceId_example" -Hostname "Hostname_example" -IsPasswordSet $false -IsRenew $false -Message "Message_example" -Password "Password_example" -PlatformType "" -RequestId "RequestId_example" -SecurityToken "SecurityToken_example" -Status "started" -Username "Username_example" -Account ) # ApplianceDeviceClaim | The 'appliance.DeviceClaim' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
...
<a name="Set-IntersightApplianceDiagSetting"></a>
# **Set-IntersightApplianceDiagSetting**
> ApplianceDiagSetting Set-IntersightApplianceDiagSetting<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceDiagSetting] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **ApplianceDiagSetting** | [**ApplianceDiagSetting**](ApplianceDiagSetting.md)| The &#39;appliance.DiagSetting&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$ApplianceExternalSyslogSetting = (Initialize-appliance.ExternalSyslogSetting -ClassId "appliance.ExternalSyslogSetting" -ObjectType "appliance.ExternalSyslogSetting" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Enabled $false -ExportNginx $false -Port 123 -Server "Server_example" -Account ) # ApplianceExternalSyslogSetting | The 'appliance.ExternalSyslogSetting' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
...
<a name="Set-IntersightApplianceSetupInfo"></a>
# **Set-IntersightApplianceSetupInfo**
> ApplianceSetupInfo Set-IntersightApplianceSetupInfo<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceSetupInfo] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$ApplianceSetupInfo = (Initialize-appliance.SetupInfo -ClassId "appliance.SetupInfo" -ObjectType "appliance.SetupInfo" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -BuildType "BuildType_example" -Capabilities @((Initialize-appliance.KeyValuePair -ClassId "appliance.KeyValuePair" -ObjectType "appliance.KeyValuePair" -Key "Key_example" -Value "Value_example")) -CloudUrl "CloudUrl_example" -DeploymentMode "Connected" -EndTime Get-Date -SetupStates @("SetupStates_example") -StartTime Get-Date -Account ) # ApplianceSetupInfo | The 'appliance.SetupInfo' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **ApplianceSetupInfo** | [**ApplianceSetupInfo**](ApplianceSetupInfo.md)| The &#39;appliance.SetupInfo&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightApplianceUpgrade"></a>
# **Set-IntersightApplianceUpgrade**
> ApplianceUpgrade Set-IntersightApplianceUpgrade<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceUpgrade] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$ApplianceUpgrade = (Initialize-appliance.Upgrade -ClassId "appliance.Upgrade" -ObjectType "appliance.Upgrade" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Active $false -AutoCreated $false -CompletedPhases @((Initialize-onprem.UpgradePhase -ClassId "onprem.UpgradePhase" -ObjectType "onprem.UpgradePhase" -ElapsedTime 123 -EndTime Get-Date -Failed $false -Message "Message_example" -Name "init" -StartTime Get-Date)) -CurrentPhase (Initialize-onprem.UpgradePhase -ClassId "onprem.UpgradePhase" -ObjectType "onprem.UpgradePhase" -ElapsedTime 123 -EndTime Get-Date -Failed $false -Message "Message_example" -Name "init" -StartTime Get-Date) -Description "Description_example" -ElapsedTime 123 -EndTime Get-Date -ErrorCode 123 -Fingerprint "Fingerprint_example" -IsRollingBack $false -IsUserTriggered $false -Messages @("Messages_example") -RollbackNeeded $false -RollbackPhases @() -RollbackStatus "RollbackStatus_example" -Services @("Services_example") -StartTime Get-Date -Status "Status_example" -TotalPhases 123 -UiPackages @("UiPackages_example") -Version "Version_example" -Account  -ImageBundle (Initialize-appliance.ImageBundle.Relationship -ClassId "appliance.ImageBundle" -ObjectType "appliance.ImageBundle" -Moid "Moid_example" -Selector "Selector_example" -Link "Link_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -AnsiblePackages @((Initialize-onprem.ImagePackage -ClassId "onprem.ImagePackage" -ObjectType "onprem.ImagePackage" -FilePath "FilePath_example" -FileSha "FileSha_example" -FileSize 123 -FileTime Get-Date -Filename "Filename_example" -Name "Name_example" -PackageType "PackageType_example" -Version "Version_example")) -AutoUpgrade $false -DcPackages @((Initialize-onprem.ImagePackage -ClassId "onprem.ImagePackage" -ObjectType "onprem.ImagePackage" -FilePath "FilePath_example" -FileSha "FileSha_example" -FileSize 123 -FileTime Get-Date -Filename "Filename_example" -Name "Name_example" -PackageType "PackageType_example" -Version "Version_example")) -DebugPackages @() -Description "Description_example" -EndpointPackages @() -Fingerprint "Fingerprint_example" -HasError $false -InfraPackages @() -InitPackages @() -Name "Name_example" -Notes "Notes_example" -Priority "Normal" -ReleaseTime Get-Date -ServicePackages @() -StatusMessage "StatusMessage_example" -SystemPackages @() -UiPackages @() -UpgradeEndTime Get-Date -UpgradeGracePeriod 123 -UpgradeImpactDuration 123 -UpgradeImpactEnum "None" -UpgradeStartTime Get-Date -Version "Version_example")) # ApplianceUpgrade | The 'appliance.Upgrade' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **ApplianceUpgrade** | [**ApplianceUpgrade**](ApplianceUpgrade.md)| The &#39;appliance.Upgrade&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightApplianceUpgradePolicy"></a>
# **Set-IntersightApplianceUpgradePolicy**
> ApplianceUpgradePolicy Set-IntersightApplianceUpgradePolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceUpgradePolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$ApplianceUpgradePolicy = (Initialize-appliance.UpgradePolicy -ClassId "appliance.UpgradePolicy" -ObjectType "appliance.UpgradePolicy" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -AutoUpgrade $false -BlackoutDatesEnabled $false -BlackoutEndDate Get-Date -BlackoutStartDate Get-Date -EnableMetaDataSync $false -Schedule  -Account ) # ApplianceUpgradePolicy | The 'appliance.UpgradePolicy' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **ApplianceUpgradePolicy** | [**ApplianceUpgradePolicy**](ApplianceUpgradePolicy.md)| The &#39;appliance.UpgradePolicy&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Update-IntersightApplianceBackupPolicy"></a>
# **Update-IntersightApplianceBackupPolicy**
> ApplianceBackupPolicy Update-IntersightApplianceBackupPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceBackupPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
<a name="Update-IntersightApplianceCertificateSetting"></a>
# **Update-IntersightApplianceCertificateSetting**
> ApplianceCertificateSetting Update-IntersightApplianceCertificateSetting<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceCertificateSetting] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$ApplianceCertificateSetting = (Initialize-appliance.CertificateSetting -ClassId "appliance.CertificateSetting" -ObjectType "appliance.CertificateSetting" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Account  -Certificate ) # ApplianceCertificateSetting | The 'appliance.CertificateSetting' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
...
<a name="Update-IntersightApplianceDataExportPolicy"></a>
# **Update-IntersightApplianceDataExportPolicy**
> ApplianceDataExportPolicy Update-IntersightApplianceDataExportPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceDataExportPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
<a name="Update-IntersightApplianceDiagSetting"></a>
# **Update-IntersightApplianceDiagSetting**
> ApplianceDiagSetting Update-IntersightApplianceDiagSetting<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceDiagSetting] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
<a name="Update-IntersightApplianceSetupInfo"></a>
# **Update-IntersightApplianceSetupInfo**
> ApplianceSetupInfo Update-IntersightApplianceSetupInfo<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceSetupInfo] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
<a name="Update-IntersightApplianceUpgrade"></a>
# **Update-IntersightApplianceUpgrade**
> ApplianceUpgrade Update-IntersightApplianceUpgrade<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceUpgrade] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
<a name="Update-IntersightApplianceUpgradePolicy"></a>
# **Update-IntersightApplianceUpgradePolicy**
> ApplianceUpgradePolicy Update-IntersightApplianceUpgradePolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ApplianceUpgradePolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
