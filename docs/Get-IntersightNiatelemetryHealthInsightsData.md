...
# Get-IntersightNiatelemetryHealthInsightsData
...
### CmdletParam (Default)
```
Get-IntersightNiatelemetryHealthInsightsData [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryHealthInsightsData [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryHealthInsightsData&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHealthInsightsData
```
Above example returns the list of NiatelemetryHealthInsightsData.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHealthInsightsData -Name "MoName"
```
Above example returns the NiatelemetryHealthInsightsData matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHealthInsightsData -Organization $organization
```
Above example returns the list of NiatelemetryHealthInsightsData available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHealthInsightsData -InlineCount allpages
```
Above example returns the list of NiatelemetryHealthInsightsData along with count.
...
### -Name
Specifies the name of the NiatelemetryHealthInsightsData.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryHealthInsightsData under it.
