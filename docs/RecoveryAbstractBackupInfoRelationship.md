...
```powershell
$RecoveryAbstractBackupInfoRelationship = Initialize-IntersightRecoveryAbstractBackupInfoRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$RecoveryAbstractBackupInfoRelationship | ConvertTo-JSON
```
