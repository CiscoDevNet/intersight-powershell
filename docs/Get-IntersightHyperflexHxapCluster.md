...
# Get-IntersightHyperflexHxapCluster

## SYNOPSIS
Get the HyperflexHxapCluster

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHxapCluster [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHxapCluster [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHxapCluster&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapCluster
```
Above example returns the list of HyperflexHxapCluster.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapCluster -Name "MoName"
```
Above example returns the HyperflexHxapCluster matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapCluster -Organization $organization
```
Above example returns the list of HyperflexHxapCluster available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapCluster -InlineCount allpages
```
Above example returns the list of HyperflexHxapCluster along with count.
...
### -Name
Specifies the name of the HyperflexHxapCluster.
...
### -Organization
Specifies the organization, to fetch the HyperflexHxapCluster under it.
