...
## SYNOPSIS
Get the FabricEthNetworkGroupPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricEthNetworkGroupPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricEthNetworkGroupPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricEthNetworkGroupPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkGroupPolicy
```
Above example returns the list of FabricEthNetworkGroupPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkGroupPolicy -Name "MoName"
```
Above example returns the FabricEthNetworkGroupPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkGroupPolicy -Organization $organization
```
Above example returns the list of FabricEthNetworkGroupPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkGroupPolicy -InlineCount allpages
```
Above example returns the list of FabricEthNetworkGroupPolicy along with count.
...
### -Name
Specifies the name of the FabricEthNetworkGroupPolicy.
...
### -Organization
Specifies the organization, to fetch the FabricEthNetworkGroupPolicy under it.
