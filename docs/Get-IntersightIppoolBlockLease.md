...
# Get-IntersightIppoolBlockLease

## SYNOPSIS
Get the IppoolBlockLease

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIppoolBlockLease [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIppoolBlockLease [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IppoolBlockLease&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIppoolBlockLease
```
Above example returns the list of IppoolBlockLease.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIppoolBlockLease -Name "MoName"
```
Above example returns the IppoolBlockLease matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIppoolBlockLease -Organization $organization
```
Above example returns the list of IppoolBlockLease available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIppoolBlockLease -InlineCount allpages
```
Above example returns the list of IppoolBlockLease along with count.
...
### -Name
Specifies the name of the IppoolBlockLease.
...
### -Organization
Specifies the organization, to fetch the IppoolBlockLease under it.
