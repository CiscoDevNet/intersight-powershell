...
# Get-IntersightFmcPhysicalInterface

## SYNOPSIS
Get the FmcPhysicalInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFmcPhysicalInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFmcPhysicalInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FmcPhysicalInterface&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFmcPhysicalInterface
```
Above example returns the list of FmcPhysicalInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFmcPhysicalInterface -Name "MoName"
```
Above example returns the FmcPhysicalInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFmcPhysicalInterface -Organization $organization
```
Above example returns the list of FmcPhysicalInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFmcPhysicalInterface -InlineCount allpages
```
Above example returns the list of FmcPhysicalInterface along with count.
...
### -Name
Specifies the name of the FmcPhysicalInterface.
...
### -Organization
Specifies the organization, to fetch the FmcPhysicalInterface under it.
