...
### CmdletParam (Default)
```
Get-IntersightMetaDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMetaDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MetaDefinition&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMetaDefinition
```
Above example returns the list of MetaDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMetaDefinition -Name "MoName"
```
Above example returns the MetaDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMetaDefinition -Organization $organization
```
Above example returns the list of MetaDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMetaDefinition -InlineCount allpages
```
Above example returns the list of MetaDefinition along with count.
...
### -Name
Specifies the name of the MetaDefinition.
...
### -Organization
Specifies the organization, to fetch the MetaDefinition under it.
