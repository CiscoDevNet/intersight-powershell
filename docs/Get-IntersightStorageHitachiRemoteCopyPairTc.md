...
# Get-IntersightStorageHitachiRemoteCopyPairTc

## SYNOPSIS
Get the StorageHitachiRemoteCopyPairTc

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiRemoteCopyPairTc [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiRemoteCopyPairTc [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiRemoteCopyPairTc&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteCopyPairTc
```
Above example returns the list of StorageHitachiRemoteCopyPairTc.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteCopyPairTc -Name "MoName"
```
Above example returns the StorageHitachiRemoteCopyPairTc matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteCopyPairTc -Organization $organization
```
Above example returns the list of StorageHitachiRemoteCopyPairTc available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteCopyPairTc -InlineCount allpages
```
Above example returns the list of StorageHitachiRemoteCopyPairTc along with count.
...
### -Name
Specifies the name of the StorageHitachiRemoteCopyPairTc.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiRemoteCopyPairTc under it.
