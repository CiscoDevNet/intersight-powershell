...
# Initialize-IntersightTaskNetAppScopedInventory
...
```yaml
Type: TaskNetAppScopedInventory.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TaskNetAppScopedInventory.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTaskNetAppScopedInventory
```
