...
# Get-IntersightCapabilityAdapterDeprecatedDef

## SYNOPSIS
Get the CapabilityAdapterDeprecatedDef

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityAdapterDeprecatedDef [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityAdapterDeprecatedDef [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilityAdapterDeprecatedDef&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterDeprecatedDef
```
Above example returns the list of CapabilityAdapterDeprecatedDef.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterDeprecatedDef -Name "MoName"
```
Above example returns the CapabilityAdapterDeprecatedDef matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterDeprecatedDef -Organization $organization
```
Above example returns the list of CapabilityAdapterDeprecatedDef available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterDeprecatedDef -InlineCount allpages
```
Above example returns the list of CapabilityAdapterDeprecatedDef along with count.
...
### -Name
Specifies the name of the CapabilityAdapterDeprecatedDef.
...
### -Organization
Specifies the organization, to fetch the CapabilityAdapterDeprecatedDef under it.
...
[Remove-IntersightCapabilityAdapterDeprecatedDef](./Remove-IntersightCapabilityAdapterDeprecatedDef.md)
