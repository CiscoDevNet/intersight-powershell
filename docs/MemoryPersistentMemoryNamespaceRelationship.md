...
```powershell
$MemoryPersistentMemoryNamespaceRelationship = Initialize-IntersightMemoryPersistentMemoryNamespaceRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$MemoryPersistentMemoryNamespaceRelationship | ConvertTo-JSON
```
