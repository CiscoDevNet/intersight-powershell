...
```powershell
$HyperflexClusterReplicationNetworkPolicy = Initialize-IntersightHyperflexClusterReplicationNetworkPolicy  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$HyperflexClusterReplicationNetworkPolicy | ConvertTo-JSON
```
