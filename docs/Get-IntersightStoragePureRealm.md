...
# Get-IntersightStoragePureRealm

## SYNOPSIS
Get the StoragePureRealm

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureRealm [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureRealm [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureRealm&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureRealm
```
Above example returns the list of StoragePureRealm.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureRealm -Name "MoName"
```
Above example returns the StoragePureRealm matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureRealm -Organization $organization
```
Above example returns the list of StoragePureRealm available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureRealm -InlineCount allpages
```
Above example returns the list of StoragePureRealm along with count.
...
### -Name
Specifies the name of the StoragePureRealm.
...
### -Organization
Specifies the organization, to fetch the StoragePureRealm under it.
