...
# Get-IntersightChassisProfileTemplate

## SYNOPSIS
Get the ChassisProfileTemplate

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightChassisProfileTemplate [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightChassisProfileTemplate [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ChassisProfileTemplate&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightChassisProfileTemplate
```
Above example returns the list of ChassisProfileTemplate.

### Example 2
```powershell
PS C:\> $result = Get-IntersightChassisProfileTemplate -Name "MoName"
```
Above example returns the ChassisProfileTemplate matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightChassisProfileTemplate -Organization $organization
```
Above example returns the list of ChassisProfileTemplate available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightChassisProfileTemplate -InlineCount allpages
```
Above example returns the list of ChassisProfileTemplate along with count.
...
### -Name
Specifies the name of the ChassisProfileTemplate.
...
### -Organization
Specifies the organization, to fetch the ChassisProfileTemplate under it.
