...
### CmdletParam (Default)
```
Get-IntersightCapabilitySiocModuleCapabilityDef [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilitySiocModuleCapabilityDef [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilitySiocModuleCapabilityDef
```
Above example returns the list of CapabilitySiocModuleCapabilityDef.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilitySiocModuleCapabilityDef -Name "MoName"
```
Above example returns the CapabilitySiocModuleCapabilityDef matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilitySiocModuleCapabilityDef -Organization $organization
```
Above example returns the list of CapabilitySiocModuleCapabilityDef available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilitySiocModuleCapabilityDef -InlineCount allpages
```
Above example returns the list of CapabilitySiocModuleCapabilityDef along with count.
...
### -Name
Specifies the name of the CapabilitySiocModuleCapabilityDef.
...
### -Organization
Specifies the organization, to fetch the CapabilitySiocModuleCapabilityDef under it.
