...
```powershell
$AssetDeviceRegistrationRelationship = Initialize-IntersightAssetDeviceRegistrationRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$AssetDeviceRegistrationRelationship | ConvertTo-JSON
```
