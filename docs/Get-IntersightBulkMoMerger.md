...
# Get-IntersightBulkMoMerger

## SYNOPSIS
Get the BulkMoMerger

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBulkMoMerger [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBulkMoMerger [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;BulkMoMerger&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBulkMoMerger
```
Above example returns the list of BulkMoMerger.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBulkMoMerger -Name "MoName"
```
Above example returns the BulkMoMerger matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBulkMoMerger -Organization $organization
```
Above example returns the list of BulkMoMerger available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBulkMoMerger -InlineCount allpages
```
Above example returns the list of BulkMoMerger along with count.
...
### -Name
Specifies the name of the BulkMoMerger.
...
### -Organization
Specifies the organization, to fetch the BulkMoMerger under it.
...
[New-IntersightBulkMoMerger](./New-IntersightBulkMoMerger.md)
