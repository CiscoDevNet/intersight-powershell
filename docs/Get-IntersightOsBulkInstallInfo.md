...
# Get-IntersightOsBulkInstallInfo

## SYNOPSIS
Get the OsBulkInstallInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOsBulkInstallInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOsBulkInstallInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOsBulkInstallInfo
```
Above example returns the list of OsBulkInstallInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOsBulkInstallInfo -Name "MoName"
```
Above example returns the OsBulkInstallInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOsBulkInstallInfo -Organization $organization
```
Above example returns the list of OsBulkInstallInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOsBulkInstallInfo -InlineCount allpages
```
Above example returns the list of OsBulkInstallInfo along with count.
...
### -Name
Specifies the name of the OsBulkInstallInfo.
...
### -Organization
Specifies the organization, to fetch the OsBulkInstallInfo under it.
...
[New-IntersightOsBulkInstallInfo](./New-IntersightOsBulkInstallInfo.md)
