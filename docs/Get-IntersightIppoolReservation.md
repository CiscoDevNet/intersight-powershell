...
# Get-IntersightIppoolReservation

## SYNOPSIS
Get the IppoolReservation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIppoolReservation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIppoolReservation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IppoolReservation&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIppoolReservation
```
Above example returns the list of IppoolReservation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIppoolReservation -Name "MoName"
```
Above example returns the IppoolReservation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIppoolReservation -Organization $organization
```
Above example returns the list of IppoolReservation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIppoolReservation -InlineCount allpages
```
Above example returns the list of IppoolReservation along with count.
...
### -Name
Specifies the name of the IppoolReservation.
...
### -Organization
Specifies the organization, to fetch the IppoolReservation under it.
