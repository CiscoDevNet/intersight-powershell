...
# Initialize-IntersightAssetWorkloadOptimizerMicrosoftAzureBillingOptions
...
```yaml
Type: AssetWorkloadOptimizerMicrosoftAzureBillingOptions.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: AssetWorkloadOptimizerMicrosoftAzureBillingOptions.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightAssetWorkloadOptimizerMicrosoftAzureBillingOptions
```
