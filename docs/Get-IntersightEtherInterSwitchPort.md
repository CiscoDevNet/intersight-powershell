...
# Get-IntersightEtherInterSwitchPort

## SYNOPSIS
Get the EtherInterSwitchPort

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEtherInterSwitchPort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEtherInterSwitchPort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EtherInterSwitchPort&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEtherInterSwitchPort
```
Above example returns the list of EtherInterSwitchPort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEtherInterSwitchPort -Name "MoName"
```
Above example returns the EtherInterSwitchPort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEtherInterSwitchPort -Organization $organization
```
Above example returns the list of EtherInterSwitchPort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEtherInterSwitchPort -InlineCount allpages
```
Above example returns the list of EtherInterSwitchPort along with count.
...
### -Name
Specifies the name of the EtherInterSwitchPort.
...
### -Organization
Specifies the organization, to fetch the EtherInterSwitchPort under it.
