...
```powershell
$MemoryPersistentMemoryRegionResponse = Initialize-IntersightMemoryPersistentMemoryRegionResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$MemoryPersistentMemoryRegionResponse | ConvertTo-JSON
```
