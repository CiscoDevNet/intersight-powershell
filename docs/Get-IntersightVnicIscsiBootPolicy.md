...
## SYNOPSIS
Get the VnicIscsiBootPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicIscsiBootPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicIscsiBootPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicIscsiBootPolicy
```
Above example returns the list of VnicIscsiBootPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicIscsiBootPolicy -Name "MoName"
```
Above example returns the VnicIscsiBootPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicIscsiBootPolicy -Organization $organization
```
Above example returns the list of VnicIscsiBootPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicIscsiBootPolicy -InlineCount allpages
```
Above example returns the list of VnicIscsiBootPolicy along with count.
...
### -Name
Specifies the name of the VnicIscsiBootPolicy.
...
### -Organization
Specifies the organization, to fetch the VnicIscsiBootPolicy under it.
