...
## SYNOPSIS
Get the FirmwareBoardControllerDescriptor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareBoardControllerDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareBoardControllerDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareBoardControllerDescriptor&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareBoardControllerDescriptor
```
Above example returns the list of FirmwareBoardControllerDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareBoardControllerDescriptor -Name "MoName"
```
Above example returns the FirmwareBoardControllerDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareBoardControllerDescriptor -Organization $organization
```
Above example returns the list of FirmwareBoardControllerDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareBoardControllerDescriptor -InlineCount allpages
```
Above example returns the list of FirmwareBoardControllerDescriptor along with count.
...
### -Name
Specifies the name of the FirmwareBoardControllerDescriptor.
...
### -Organization
Specifies the organization, to fetch the FirmwareBoardControllerDescriptor under it.
