...
### CmdletParam (Default)
```
Get-IntersightCloudSkuVolumeType [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudSkuVolumeType [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;CloudSkuVolumeType&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudSkuVolumeType
```
Above example returns the list of CloudSkuVolumeType.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudSkuVolumeType -Name "MoName"
```
Above example returns the CloudSkuVolumeType matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudSkuVolumeType -Organization $organization
```
Above example returns the list of CloudSkuVolumeType available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudSkuVolumeType -InlineCount allpages
```
Above example returns the list of CloudSkuVolumeType along with count.
...
### -Name
Specifies the name of the CloudSkuVolumeType.
...
### -Organization
Specifies the organization, to fetch the CloudSkuVolumeType under it.
