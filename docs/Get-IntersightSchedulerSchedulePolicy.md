...
# Get-IntersightSchedulerSchedulePolicy

## SYNOPSIS
Get the SchedulerSchedulePolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSchedulerSchedulePolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSchedulerSchedulePolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SchedulerSchedulePolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSchedulerSchedulePolicy
```
Above example returns the list of SchedulerSchedulePolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSchedulerSchedulePolicy -Name "MoName"
```
Above example returns the SchedulerSchedulePolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSchedulerSchedulePolicy -Organization $organization
```
Above example returns the list of SchedulerSchedulePolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSchedulerSchedulePolicy -InlineCount allpages
```
Above example returns the list of SchedulerSchedulePolicy along with count.
...
### -Name
Specifies the name of the SchedulerSchedulePolicy.
...
### -Organization
Specifies the organization, to fetch the SchedulerSchedulePolicy under it.
...
[Remove-IntersightSchedulerSchedulePolicy](./Remove-IntersightSchedulerSchedulePolicy.md)
