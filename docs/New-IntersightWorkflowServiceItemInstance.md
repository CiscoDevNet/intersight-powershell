...
New-IntersightWorkflowServiceItemInstance [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Description< string>][-Idp< IamIdpRelationship>][-IdpReference< IamIdpReferenceRelationship>][-Label< string>][-MigrationHistory< System.Collections.Generic.List`1[WorkflowMigrationHistory]>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-ServiceItemDefinition< WorkflowServiceItemDefinitionRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-User< IamUserRelationship>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
