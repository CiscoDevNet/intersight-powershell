...
```powershell
$FirmwareUnsupportedVersionUpgradeResponse = Initialize-IntersightFirmwareUnsupportedVersionUpgradeResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$FirmwareUnsupportedVersionUpgradeResponse | ConvertTo-JSON
```
