...
## SYNOPSIS
Get the HyperflexLocalCredentialPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexLocalCredentialPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexLocalCredentialPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexLocalCredentialPolicy
```
Above example returns the list of HyperflexLocalCredentialPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexLocalCredentialPolicy -Name "MoName"
```
Above example returns the HyperflexLocalCredentialPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexLocalCredentialPolicy -Organization $organization
```
Above example returns the list of HyperflexLocalCredentialPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexLocalCredentialPolicy -InlineCount allpages
```
Above example returns the list of HyperflexLocalCredentialPolicy along with count.
...
### -Name
Specifies the name of the HyperflexLocalCredentialPolicy.
...
### -Organization
Specifies the organization, to fetch the HyperflexLocalCredentialPolicy under it.
