...
## SYNOPSIS
Get the VirtualizationVmwareCluster

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareCluster [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareCluster [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareCluster&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareCluster
```
Above example returns the list of VirtualizationVmwareCluster.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareCluster -Name "MoName"
```
Above example returns the VirtualizationVmwareCluster matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareCluster -Organization $organization
```
Above example returns the list of VirtualizationVmwareCluster available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareCluster -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareCluster along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareCluster.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareCluster under it.
...
[Set-IntersightVirtualizationVmwareCluster](./Set-IntersightVirtualizationVmwareCluster.md)
