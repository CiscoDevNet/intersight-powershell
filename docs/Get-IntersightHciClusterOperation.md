...
# Get-IntersightHciClusterOperation

## SYNOPSIS
Get the HciClusterOperation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHciClusterOperation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciClusterOperation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciClusterOperation&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciClusterOperation
```
Above example returns the list of HciClusterOperation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciClusterOperation -Name "MoName"
```
Above example returns the HciClusterOperation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciClusterOperation -Organization $organization
```
Above example returns the list of HciClusterOperation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciClusterOperation -InlineCount allpages
```
Above example returns the list of HciClusterOperation along with count.
...
### -Name
Specifies the name of the HciClusterOperation.
...
### -Organization
Specifies the organization, to fetch the HciClusterOperation under it.
...
[Set-IntersightHciClusterOperation](./Set-IntersightHciClusterOperation.md)
