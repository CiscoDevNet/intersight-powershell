...
# Set-IntersightFunctionsFunctionVersion
...
Set-IntersightFunctionsFunctionVersion [-ActionExecution< WorkflowWorkflowInfoRelationship>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Code< string>][-Function< FunctionsFunctionRelationship>][[-Moid]< string>][-Runtime< FunctionsRuntimeRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;FunctionsFunctionVersion&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightFunctionsFunctionVersion
```
