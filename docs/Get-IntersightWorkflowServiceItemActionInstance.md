...
# Get-IntersightWorkflowServiceItemActionInstance

## SYNOPSIS
Get the WorkflowServiceItemActionInstance

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowServiceItemActionInstance [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowServiceItemActionInstance [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowServiceItemActionInstance&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemActionInstance
```
Above example returns the list of WorkflowServiceItemActionInstance.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemActionInstance -Name "MoName"
```
Above example returns the WorkflowServiceItemActionInstance matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemActionInstance -Organization $organization
```
Above example returns the list of WorkflowServiceItemActionInstance available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemActionInstance -InlineCount allpages
```
Above example returns the list of WorkflowServiceItemActionInstance along with count.
...
### -Name
Specifies the name of the WorkflowServiceItemActionInstance.
...
### -Organization
Specifies the organization, to fetch the WorkflowServiceItemActionInstance under it.
