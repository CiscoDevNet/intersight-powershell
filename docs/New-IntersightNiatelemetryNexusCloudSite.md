...
# New-IntersightNiatelemetryNexusCloudSite
...
New-IntersightNiatelemetryNexusCloudSite [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Advisories< bool>][-Anomalies< bool>][-CapacityUtilization< bool>][-LicenseType< string>][-Moid< string>][[-Name]< string>][-SiteType< string>][-SoftwareManagement< bool>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Uuid< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;NiatelemetryNexusCloudSite&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightNiatelemetryNexusCloudSite
```
