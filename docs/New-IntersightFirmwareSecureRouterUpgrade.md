...
# New-IntersightFirmwareSecureRouterUpgrade
...
New-IntersightFirmwareSecureRouterUpgrade [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-DirectDownload< FirmwareDirectDownload>][-Distributable< FirmwareDistributableRelationship>][-FileServer< SoftwarerepositoryFileServer>][-Moid< string>][-NetworkSecureRouter< NetworkSecureRouterRelationship>][-NetworkShare< FirmwareNetworkShare>][-Release< SoftwarerepositoryReleaseRelationship>][-SkipEstimateImpact< bool>][-Status< FirmwareSecureRouterUpgrade.StatusEnum>][-Tags< System.Collections.Generic.List`1[MoTag]>][-UpgradeType< FirmwareSecureRouterUpgrade.UpgradeTypeEnum>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;FirmwareSecureRouterUpgrade&apos; resource.
...
```yaml
Type: NetworkSecureRouterRelationship
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> New-IntersightFirmwareSecureRouterUpgrade
```
...
[Get-IntersightFirmwareSecureRouterUpgrade](./Get-IntersightFirmwareSecureRouterUpgrade.md)
