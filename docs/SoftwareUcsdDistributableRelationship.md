...
```powershell
$SoftwareUcsdDistributableRelationship = Initialize-IntersightSoftwareUcsdDistributableRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$SoftwareUcsdDistributableRelationship | ConvertTo-JSON
```
