...
### CmdletParam (Default)
```
Get-IntersightHciAhvVmNic [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciAhvVmNic [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciAhvVmNic&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciAhvVmNic
```
Above example returns the list of HciAhvVmNic.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciAhvVmNic -Name "MoName"
```
Above example returns the HciAhvVmNic matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciAhvVmNic -Organization $organization
```
Above example returns the list of HciAhvVmNic available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciAhvVmNic -InlineCount allpages
```
Above example returns the list of HciAhvVmNic along with count.
...
### -Name
Specifies the name of the HciAhvVmNic.
...
### -Organization
Specifies the organization, to fetch the HciAhvVmNic under it.
