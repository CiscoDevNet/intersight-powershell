# Intersight.Intersight/Api.IntersightRecommendationApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Get-IntersightRecommendationCapacityRunwayByMoid**](IntersightRecommendationApi.md#Get-IntersightRecommendationCapacityRunwayByMoid) | **GET** /api/v1/recommendation/CapacityRunways/{Moid} | Read a &#39;recommendation.CapacityRunway&#39; resource.
[**Get-IntersightRecommendationCapacityRunwayList**](IntersightRecommendationApi.md#Get-IntersightRecommendationCapacityRunwayList) | **GET** /api/v1/recommendation/CapacityRunways | Read a &#39;recommendation.CapacityRunway&#39; resource.
[**Get-IntersightRecommendationPhysicalItemByMoid**](IntersightRecommendationApi.md#Get-IntersightRecommendationPhysicalItemByMoid) | **GET** /api/v1/recommendation/PhysicalItems/{Moid} | Read a &#39;recommendation.PhysicalItem&#39; resource.
[**Get-IntersightRecommendationPhysicalItemList**](IntersightRecommendationApi.md#Get-IntersightRecommendationPhysicalItemList) | **GET** /api/v1/recommendation/PhysicalItems | Read a &#39;recommendation.PhysicalItem&#39; resource.


<a name="Get-IntersightRecommendationCapacityRunwayByMoid"></a>
# **Get-IntersightRecommendationCapacityRunwayByMoid**
> RecommendationCapacityRunway Get-IntersightRecommendationCapacityRunwayByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'recommendation.CapacityRunway' resource.
try {
     $Result = Get-IntersightRecommendationCapacityRunwayByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightRecommendationCapacityRunwayByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a name="Get-IntersightRecommendationCapacityRunwayList"></a>
# **Get-IntersightRecommendationCapacityRunwayList**
> RecommendationCapacityRunwayResponse Get-IntersightRecommendationCapacityRunwayList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'recommendation.CapacityRunway' resource.
try {
     $Result = Get-IntersightRecommendationCapacityRunwayList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightRecommendationCapacityRunwayList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightRecommendationPhysicalItemByMoid"></a>
# **Get-IntersightRecommendationPhysicalItemByMoid**
> RecommendationPhysicalItem Get-IntersightRecommendationPhysicalItemByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'recommendation.PhysicalItem' resource.
try {
     $Result = Get-IntersightRecommendationPhysicalItemByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightRecommendationPhysicalItemByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightRecommendationPhysicalItemList"></a>
# **Get-IntersightRecommendationPhysicalItemList**
> RecommendationPhysicalItemResponse Get-IntersightRecommendationPhysicalItemList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'recommendation.PhysicalItem' resource.
try {
     $Result = Get-IntersightRecommendationPhysicalItemList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightRecommendationPhysicalItemList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
