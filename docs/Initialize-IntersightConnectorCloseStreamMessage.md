...
Initialize-IntersightConnectorCloseStreamMessage [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< ConnectorCloseStreamMessage.ClassIdEnum>][-EncryptedAesKey< string>][-EncryptionKey< string>][-ObjectType< ConnectorCloseStreamMessage.ObjectTypeEnum>][-SecureProperties< object>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ConnectorCloseStreamMessage.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ConnectorCloseStreamMessage.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightConnectorCloseStreamMessage
```
