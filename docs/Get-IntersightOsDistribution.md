...
# Get-IntersightOsDistribution

## SYNOPSIS
Get the OsDistribution

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOsDistribution [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOsDistribution [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;OsDistribution&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOsDistribution
```
Above example returns the list of OsDistribution.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOsDistribution -Name "MoName"
```
Above example returns the OsDistribution matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOsDistribution -Organization $organization
```
Above example returns the list of OsDistribution available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOsDistribution -InlineCount allpages
```
Above example returns the list of OsDistribution along with count.
...
### -Name
Specifies the name of the OsDistribution.
...
### -Organization
Specifies the organization, to fetch the OsDistribution under it.
