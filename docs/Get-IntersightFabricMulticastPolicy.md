...
## SYNOPSIS
Get the FabricMulticastPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricMulticastPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricMulticastPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricMulticastPolicy
```
Above example returns the list of FabricMulticastPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricMulticastPolicy -Name "MoName"
```
Above example returns the FabricMulticastPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricMulticastPolicy -Organization $organization
```
Above example returns the list of FabricMulticastPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricMulticastPolicy -InlineCount allpages
```
Above example returns the list of FabricMulticastPolicy along with count.
...
### -Name
Specifies the name of the FabricMulticastPolicy.
...
### -Organization
Specifies the organization, to fetch the FabricMulticastPolicy under it.
