...
# Get-IntersightIqnpoolLease

## SYNOPSIS
Get the IqnpoolLease

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIqnpoolLease [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIqnpoolLease [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IqnpoolLease&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIqnpoolLease
```
Above example returns the list of IqnpoolLease.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIqnpoolLease -Name "MoName"
```
Above example returns the IqnpoolLease matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIqnpoolLease -Organization $organization
```
Above example returns the list of IqnpoolLease available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIqnpoolLease -InlineCount allpages
```
Above example returns the list of IqnpoolLease along with count.
...
### -Name
Specifies the name of the IqnpoolLease.
...
### -Organization
Specifies the organization, to fetch the IqnpoolLease under it.
...
[Remove-IntersightIqnpoolLease](./Remove-IntersightIqnpoolLease.md)
