...
### CmdletParam (Default)
```
Get-IntersightDeviceconnectorPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightDeviceconnectorPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightDeviceconnectorPolicy
```
Above example returns the list of DeviceconnectorPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightDeviceconnectorPolicy -Name "MoName"
```
Above example returns the DeviceconnectorPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightDeviceconnectorPolicy -Organization $organization
```
Above example returns the list of DeviceconnectorPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightDeviceconnectorPolicy -InlineCount allpages
```
Above example returns the list of DeviceconnectorPolicy along with count.
...
### -Name
Specifies the name of the DeviceconnectorPolicy.
...
### -Organization
Specifies the organization, to fetch the DeviceconnectorPolicy under it.
