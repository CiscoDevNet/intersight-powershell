...
## SYNOPSIS
Get the KubernetesAciCniProfile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesAciCniProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesAciCniProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KubernetesAciCniProfile&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesAciCniProfile
```
Above example returns the list of KubernetesAciCniProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesAciCniProfile -Name "MoName"
```
Above example returns the KubernetesAciCniProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesAciCniProfile -Organization $organization
```
Above example returns the list of KubernetesAciCniProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesAciCniProfile -InlineCount allpages
```
Above example returns the list of KubernetesAciCniProfile along with count.
...
### -Name
Specifies the name of the KubernetesAciCniProfile.
...
### -Organization
Specifies the organization, to fetch the KubernetesAciCniProfile under it.
