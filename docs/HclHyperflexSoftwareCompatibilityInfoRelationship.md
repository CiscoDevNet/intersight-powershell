...
```powershell
$HclHyperflexSoftwareCompatibilityInfoRelationship = Initialize-IntersightHclHyperflexSoftwareCompatibilityInfoRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HclHyperflexSoftwareCompatibilityInfoRelationship | ConvertTo-JSON
```
