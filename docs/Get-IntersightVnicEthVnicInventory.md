...
# Get-IntersightVnicEthVnicInventory

## SYNOPSIS
Get the VnicEthVnicInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicEthVnicInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicEthVnicInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicEthVnicInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicEthVnicInventory
```
Above example returns the list of VnicEthVnicInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicEthVnicInventory -Name "MoName"
```
Above example returns the VnicEthVnicInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicEthVnicInventory -Organization $organization
```
Above example returns the list of VnicEthVnicInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicEthVnicInventory -InlineCount allpages
```
Above example returns the list of VnicEthVnicInventory along with count.
...
### -Name
Specifies the name of the VnicEthVnicInventory.
...
### -Organization
Specifies the organization, to fetch the VnicEthVnicInventory under it.
