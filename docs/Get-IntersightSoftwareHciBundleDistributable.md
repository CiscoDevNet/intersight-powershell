...
# Get-IntersightSoftwareHciBundleDistributable

## SYNOPSIS
Get the SoftwareHciBundleDistributable

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwareHciBundleDistributable [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwareHciBundleDistributable [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SoftwareHciBundleDistributable&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwareHciBundleDistributable
```
Above example returns the list of SoftwareHciBundleDistributable.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwareHciBundleDistributable -Name "MoName"
```
Above example returns the SoftwareHciBundleDistributable matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwareHciBundleDistributable -Organization $organization
```
Above example returns the list of SoftwareHciBundleDistributable available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwareHciBundleDistributable -InlineCount allpages
```
Above example returns the list of SoftwareHciBundleDistributable along with count.
...
### -Name
Specifies the name of the SoftwareHciBundleDistributable.
...
### -Organization
Specifies the organization, to fetch the SoftwareHciBundleDistributable under it.
