...
```powershell
$FabricConfigChangeDetailRelationship = Initialize-IntersightFabricConfigChangeDetailRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$FabricConfigChangeDetailRelationship | ConvertTo-JSON
```
