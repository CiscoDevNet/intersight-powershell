...
# Get-IntersightPartnerintegrationFile

## SYNOPSIS
Get the PartnerintegrationFile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPartnerintegrationFile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPartnerintegrationFile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PartnerintegrationFile&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationFile
```
Above example returns the list of PartnerintegrationFile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationFile -Name "MoName"
```
Above example returns the PartnerintegrationFile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationFile -Organization $organization
```
Above example returns the list of PartnerintegrationFile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationFile -InlineCount allpages
```
Above example returns the list of PartnerintegrationFile along with count.
...
### -Name
Specifies the name of the PartnerintegrationFile.
...
### -Organization
Specifies the organization, to fetch the PartnerintegrationFile under it.
...
[Remove-IntersightPartnerintegrationFile](./Remove-IntersightPartnerintegrationFile.md)
