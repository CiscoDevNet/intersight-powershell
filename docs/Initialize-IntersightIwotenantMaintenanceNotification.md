...
# Initialize-IntersightIwotenantMaintenanceNotification
...
```yaml
Type: IwotenantMaintenanceNotification.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IwotenantMaintenanceNotification.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIwotenantMaintenanceNotification
```
