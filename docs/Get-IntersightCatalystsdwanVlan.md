...
# Get-IntersightCatalystsdwanVlan

## SYNOPSIS
Get the CatalystsdwanVlan

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCatalystsdwanVlan [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCatalystsdwanVlan [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CatalystsdwanVlan&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanVlan
```
Above example returns the list of CatalystsdwanVlan.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanVlan -Name "MoName"
```
Above example returns the CatalystsdwanVlan matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanVlan -Organization $organization
```
Above example returns the list of CatalystsdwanVlan available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanVlan -InlineCount allpages
```
Above example returns the list of CatalystsdwanVlan along with count.
...
### -Name
Specifies the name of the CatalystsdwanVlan.
...
### -Organization
Specifies the organization, to fetch the CatalystsdwanVlan under it.
