...
## SYNOPSIS
Get the ConnectorpackUpgradeImpact

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightConnectorpackUpgradeImpact [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightConnectorpackUpgradeImpact [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightConnectorpackUpgradeImpact
```
Above example returns the list of ConnectorpackUpgradeImpact.

### Example 2
```powershell
PS C:\> $result = Get-IntersightConnectorpackUpgradeImpact -Name "MoName"
```
Above example returns the ConnectorpackUpgradeImpact matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightConnectorpackUpgradeImpact -Organization $organization
```
Above example returns the list of ConnectorpackUpgradeImpact available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightConnectorpackUpgradeImpact -InlineCount allpages
```
Above example returns the list of ConnectorpackUpgradeImpact along with count.
...
### -Name
Specifies the name of the ConnectorpackUpgradeImpact.
...
### -Organization
Specifies the organization, to fetch the ConnectorpackUpgradeImpact under it.
