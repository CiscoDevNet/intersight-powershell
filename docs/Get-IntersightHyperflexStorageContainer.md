...
## SYNOPSIS
Get the HyperflexStorageContainer

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexStorageContainer [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexStorageContainer [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexStorageContainer&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexStorageContainer
```
Above example returns the list of HyperflexStorageContainer.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexStorageContainer -Name "MoName"
```
Above example returns the HyperflexStorageContainer matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexStorageContainer -Organization $organization
```
Above example returns the list of HyperflexStorageContainer available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexStorageContainer -InlineCount allpages
```
Above example returns the list of HyperflexStorageContainer along with count.
...
### -Name
Specifies the name of the HyperflexStorageContainer.
...
### -Organization
Specifies the organization, to fetch the HyperflexStorageContainer under it.
...
[Set-IntersightHyperflexStorageContainer](./Set-IntersightHyperflexStorageContainer.md)
