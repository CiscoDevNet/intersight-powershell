...
```powershell
$FirmwareStorageControllerDescriptorResponse = Initialize-IntersightFirmwareStorageControllerDescriptorResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$FirmwareStorageControllerDescriptorResponse | ConvertTo-JSON
```
