...
# Get-IntersightHciPhysicalGpu

## SYNOPSIS
Get the HciPhysicalGpu

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHciPhysicalGpu [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciPhysicalGpu [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciPhysicalGpu&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciPhysicalGpu
```
Above example returns the list of HciPhysicalGpu.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciPhysicalGpu -Name "MoName"
```
Above example returns the HciPhysicalGpu matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciPhysicalGpu -Organization $organization
```
Above example returns the list of HciPhysicalGpu available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciPhysicalGpu -InlineCount allpages
```
Above example returns the list of HciPhysicalGpu along with count.
...
### -Name
Specifies the name of the HciPhysicalGpu.
...
### -Organization
Specifies the organization, to fetch the HciPhysicalGpu under it.
