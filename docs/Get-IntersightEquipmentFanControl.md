...
### CmdletParam (Default)
```
Get-IntersightEquipmentFanControl [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentFanControl [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentFanControl
```
Above example returns the list of EquipmentFanControl.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentFanControl -Name "MoName"
```
Above example returns the EquipmentFanControl matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentFanControl -Organization $organization
```
Above example returns the list of EquipmentFanControl available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentFanControl -InlineCount allpages
```
Above example returns the list of EquipmentFanControl along with count.
...
### -Name
Specifies the name of the EquipmentFanControl.
...
### -Organization
Specifies the organization, to fetch the EquipmentFanControl under it.
...
[Set-IntersightEquipmentFanControl](./Set-IntersightEquipmentFanControl.md)
