...
# Get-IntersightVirtualizationVmwareVirtualMachineGpu

## SYNOPSIS
Get the VirtualizationVmwareVirtualMachineGpu

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareVirtualMachineGpu [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareVirtualMachineGpu [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareVirtualMachineGpu&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualMachineGpu
```
Above example returns the list of VirtualizationVmwareVirtualMachineGpu.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualMachineGpu -Name "MoName"
```
Above example returns the VirtualizationVmwareVirtualMachineGpu matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualMachineGpu -Organization $organization
```
Above example returns the list of VirtualizationVmwareVirtualMachineGpu available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualMachineGpu -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareVirtualMachineGpu along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareVirtualMachineGpu.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareVirtualMachineGpu under it.
