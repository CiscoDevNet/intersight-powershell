...
## SYNOPSIS
Get the IpmioverlanPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIpmioverlanPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIpmioverlanPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIpmioverlanPolicy
```
Above example returns the list of IpmioverlanPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIpmioverlanPolicy -Name "MoName"
```
Above example returns the IpmioverlanPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIpmioverlanPolicy -Organization $organization
```
Above example returns the list of IpmioverlanPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIpmioverlanPolicy -InlineCount allpages
```
Above example returns the list of IpmioverlanPolicy along with count.
...
### -Name
Specifies the name of the IpmioverlanPolicy.
...
### -Organization
Specifies the organization, to fetch the IpmioverlanPolicy under it.
