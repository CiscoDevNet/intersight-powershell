...
# Get-IntersightApplianceMetricsIngestionUtilization

## SYNOPSIS
Get the ApplianceMetricsIngestionUtilization

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceMetricsIngestionUtilization [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceMetricsIngestionUtilization [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceMetricsIngestionUtilization&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceMetricsIngestionUtilization
```
Above example returns the list of ApplianceMetricsIngestionUtilization.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceMetricsIngestionUtilization -Name "MoName"
```
Above example returns the ApplianceMetricsIngestionUtilization matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceMetricsIngestionUtilization -Organization $organization
```
Above example returns the list of ApplianceMetricsIngestionUtilization available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceMetricsIngestionUtilization -InlineCount allpages
```
Above example returns the list of ApplianceMetricsIngestionUtilization along with count.
...
### -Name
Specifies the name of the ApplianceMetricsIngestionUtilization.
...
### -Organization
Specifies the organization, to fetch the ApplianceMetricsIngestionUtilization under it.
