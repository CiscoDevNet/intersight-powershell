...
# Get-IntersightBulkMoCloner

## SYNOPSIS
Get the BulkMoCloner

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBulkMoCloner [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBulkMoCloner [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;BulkMoCloner&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBulkMoCloner
```
Above example returns the list of BulkMoCloner.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBulkMoCloner -Name "MoName"
```
Above example returns the BulkMoCloner matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBulkMoCloner -Organization $organization
```
Above example returns the list of BulkMoCloner available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBulkMoCloner -InlineCount allpages
```
Above example returns the list of BulkMoCloner along with count.
...
### -Name
Specifies the name of the BulkMoCloner.
...
### -Organization
Specifies the organization, to fetch the BulkMoCloner under it.
...
[New-IntersightBulkMoCloner](./New-IntersightBulkMoCloner.md)
