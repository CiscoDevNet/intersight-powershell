...
# Get-IntersightFabricSwitchProfileTemplate

## SYNOPSIS
Get the FabricSwitchProfileTemplate

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricSwitchProfileTemplate [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricSwitchProfileTemplate [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricSwitchProfileTemplate&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricSwitchProfileTemplate
```
Above example returns the list of FabricSwitchProfileTemplate.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricSwitchProfileTemplate -Name "MoName"
```
Above example returns the FabricSwitchProfileTemplate matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricSwitchProfileTemplate -Organization $organization
```
Above example returns the list of FabricSwitchProfileTemplate available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricSwitchProfileTemplate -InlineCount allpages
```
Above example returns the list of FabricSwitchProfileTemplate along with count.
...
### -Name
Specifies the name of the FabricSwitchProfileTemplate.
...
### -Organization
Specifies the organization, to fetch the FabricSwitchProfileTemplate under it.
