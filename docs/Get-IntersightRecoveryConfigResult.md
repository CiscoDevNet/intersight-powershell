...
## SYNOPSIS
Get the RecoveryConfigResult

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRecoveryConfigResult [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRecoveryConfigResult [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;RecoveryConfigResult&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRecoveryConfigResult
```
Above example returns the list of RecoveryConfigResult.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRecoveryConfigResult -Name "MoName"
```
Above example returns the RecoveryConfigResult matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRecoveryConfigResult -Organization $organization
```
Above example returns the list of RecoveryConfigResult available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRecoveryConfigResult -InlineCount allpages
```
Above example returns the list of RecoveryConfigResult along with count.
...
### -Name
Specifies the name of the RecoveryConfigResult.
...
### -Organization
Specifies the organization, to fetch the RecoveryConfigResult under it.
