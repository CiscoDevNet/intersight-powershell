...
## SYNOPSIS
Get the CloudAwsSecurityGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudAwsSecurityGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudAwsSecurityGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CloudAwsSecurityGroup&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudAwsSecurityGroup
```
Above example returns the list of CloudAwsSecurityGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudAwsSecurityGroup -Name "MoName"
```
Above example returns the CloudAwsSecurityGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudAwsSecurityGroup -Organization $organization
```
Above example returns the list of CloudAwsSecurityGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudAwsSecurityGroup -InlineCount allpages
```
Above example returns the list of CloudAwsSecurityGroup along with count.
...
### -Name
Specifies the name of the CloudAwsSecurityGroup.
...
### -Organization
Specifies the organization, to fetch the CloudAwsSecurityGroup under it.
