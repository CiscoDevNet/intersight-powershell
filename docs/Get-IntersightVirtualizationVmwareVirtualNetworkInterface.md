...
## SYNOPSIS
Get the VirtualizationVmwareVirtualNetworkInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareVirtualNetworkInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareVirtualNetworkInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareVirtualNetworkInterface&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualNetworkInterface
```
Above example returns the list of VirtualizationVmwareVirtualNetworkInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualNetworkInterface -Name "MoName"
```
Above example returns the VirtualizationVmwareVirtualNetworkInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualNetworkInterface -Organization $organization
```
Above example returns the list of VirtualizationVmwareVirtualNetworkInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualNetworkInterface -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareVirtualNetworkInterface along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareVirtualNetworkInterface.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareVirtualNetworkInterface under it.
...
[Set-IntersightVirtualizationVmwareVirtualNetworkInterface](./Set-IntersightVirtualizationVmwareVirtualNetworkInterface.md)
