...
## SYNOPSIS
Get the SoftwarerepositoryOperatingSystemFile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwarerepositoryOperatingSystemFile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwarerepositoryOperatingSystemFile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SoftwarerepositoryOperatingSystemFile&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryOperatingSystemFile
```
Above example returns the list of SoftwarerepositoryOperatingSystemFile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryOperatingSystemFile -Name "MoName"
```
Above example returns the SoftwarerepositoryOperatingSystemFile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryOperatingSystemFile -Organization $organization
```
Above example returns the list of SoftwarerepositoryOperatingSystemFile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryOperatingSystemFile -InlineCount allpages
```
Above example returns the list of SoftwarerepositoryOperatingSystemFile along with count.
...
### -Name
Specifies the name of the SoftwarerepositoryOperatingSystemFile.
...
### -Organization
Specifies the organization, to fetch the SoftwarerepositoryOperatingSystemFile under it.
