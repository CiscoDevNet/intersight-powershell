...
```powershell
$SoftwarerepositoryCategoryMapperResponse = Initialize-IntersightSoftwarerepositoryCategoryMapperResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwarerepositoryCategoryMapperResponse | ConvertTo-JSON
```
