...
## SYNOPSIS
Get the WorkflowSshBatchExecutor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowSshBatchExecutor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowSshBatchExecutor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowSshBatchExecutor&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowSshBatchExecutor
```
Above example returns the list of WorkflowSshBatchExecutor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowSshBatchExecutor -Name "MoName"
```
Above example returns the WorkflowSshBatchExecutor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowSshBatchExecutor -Organization $organization
```
Above example returns the list of WorkflowSshBatchExecutor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowSshBatchExecutor -InlineCount allpages
```
Above example returns the list of WorkflowSshBatchExecutor along with count.
...
### -Name
Specifies the name of the WorkflowSshBatchExecutor.
...
### -Organization
Specifies the organization, to fetch the WorkflowSshBatchExecutor under it.
