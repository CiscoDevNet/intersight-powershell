...
## SYNOPSIS
Get the VnicIscsiStaticTargetPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicIscsiStaticTargetPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicIscsiStaticTargetPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;VnicIscsiStaticTargetPolicy&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicIscsiStaticTargetPolicy
```
Above example returns the list of VnicIscsiStaticTargetPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicIscsiStaticTargetPolicy -Name "MoName"
```
Above example returns the VnicIscsiStaticTargetPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicIscsiStaticTargetPolicy -Organization $organization
```
Above example returns the list of VnicIscsiStaticTargetPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicIscsiStaticTargetPolicy -InlineCount allpages
```
Above example returns the list of VnicIscsiStaticTargetPolicy along with count.
...
### -Name
Specifies the name of the VnicIscsiStaticTargetPolicy.
...
### -Organization
Specifies the organization, to fetch the VnicIscsiStaticTargetPolicy under it.
