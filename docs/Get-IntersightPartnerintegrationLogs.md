...
# Get-IntersightPartnerintegrationLogs

## SYNOPSIS
Get the PartnerintegrationLogs

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPartnerintegrationLogs [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPartnerintegrationLogs [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PartnerintegrationLogs&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationLogs
```
Above example returns the list of PartnerintegrationLogs.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationLogs -Name "MoName"
```
Above example returns the PartnerintegrationLogs matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationLogs -Organization $organization
```
Above example returns the list of PartnerintegrationLogs available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationLogs -InlineCount allpages
```
Above example returns the list of PartnerintegrationLogs along with count.
...
### -Name
Specifies the name of the PartnerintegrationLogs.
...
### -Organization
Specifies the organization, to fetch the PartnerintegrationLogs under it.
