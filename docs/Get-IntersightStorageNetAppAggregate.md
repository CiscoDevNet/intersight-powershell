...
## SYNOPSIS
Get the StorageNetAppAggregate

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppAggregate [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppAggregate [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageNetAppAggregate&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppAggregate
```
Above example returns the list of StorageNetAppAggregate.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppAggregate -Name "MoName"
```
Above example returns the StorageNetAppAggregate matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppAggregate -Organization $organization
```
Above example returns the list of StorageNetAppAggregate available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppAggregate -InlineCount allpages
```
Above example returns the list of StorageNetAppAggregate along with count.
...
### -Name
Specifies the name of the StorageNetAppAggregate.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppAggregate under it.
