...
# Get-IntersightStorageNetAppIscsiService

## SYNOPSIS
Get the StorageNetAppIscsiService

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppIscsiService [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppIscsiService [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppIscsiService&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppIscsiService
```
Above example returns the list of StorageNetAppIscsiService.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppIscsiService -Name "MoName"
```
Above example returns the StorageNetAppIscsiService matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppIscsiService -Organization $organization
```
Above example returns the list of StorageNetAppIscsiService available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppIscsiService -InlineCount allpages
```
Above example returns the list of StorageNetAppIscsiService along with count.
...
### -Name
Specifies the name of the StorageNetAppIscsiService.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppIscsiService under it.
