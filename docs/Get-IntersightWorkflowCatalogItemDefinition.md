...
## SYNOPSIS
Get the WorkflowCatalogItemDefinition

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowCatalogItemDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowCatalogItemDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowCatalogItemDefinition&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowCatalogItemDefinition
```
Above example returns the list of WorkflowCatalogItemDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowCatalogItemDefinition -Name "MoName"
```
Above example returns the WorkflowCatalogItemDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowCatalogItemDefinition -Organization $organization
```
Above example returns the list of WorkflowCatalogItemDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowCatalogItemDefinition -InlineCount allpages
```
Above example returns the list of WorkflowCatalogItemDefinition along with count.
...
### -Name
Specifies the name of the WorkflowCatalogItemDefinition.
...
### -Organization
Specifies the organization, to fetch the WorkflowCatalogItemDefinition under it.
