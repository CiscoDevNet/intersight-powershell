...
## SYNOPSIS
Get the AdapterHostFcInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAdapterHostFcInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAdapterHostFcInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAdapterHostFcInterface
```
Above example returns the list of AdapterHostFcInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAdapterHostFcInterface -Name "MoName"
```
Above example returns the AdapterHostFcInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAdapterHostFcInterface -Organization $organization
```
Above example returns the list of AdapterHostFcInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAdapterHostFcInterface -InlineCount allpages
```
Above example returns the list of AdapterHostFcInterface along with count.
...
### -Name
Specifies the name of the AdapterHostFcInterface.
...
### -Organization
Specifies the organization, to fetch the AdapterHostFcInterface under it.
