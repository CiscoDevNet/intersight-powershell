...
## SYNOPSIS
Get the HyperflexAutoSupportPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexAutoSupportPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexAutoSupportPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexAutoSupportPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexAutoSupportPolicy
```
Above example returns the list of HyperflexAutoSupportPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexAutoSupportPolicy -Name "MoName"
```
Above example returns the HyperflexAutoSupportPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexAutoSupportPolicy -Organization $organization
```
Above example returns the list of HyperflexAutoSupportPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexAutoSupportPolicy -InlineCount allpages
```
Above example returns the list of HyperflexAutoSupportPolicy along with count.
...
### -Name
Specifies the name of the HyperflexAutoSupportPolicy.
...
### -Organization
Specifies the organization, to fetch the HyperflexAutoSupportPolicy under it.
