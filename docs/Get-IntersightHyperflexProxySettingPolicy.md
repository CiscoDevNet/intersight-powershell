...
### CmdletParam (Default)
```
Get-IntersightHyperflexProxySettingPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexProxySettingPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexProxySettingPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexProxySettingPolicy
```
Above example returns the list of HyperflexProxySettingPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexProxySettingPolicy -Name "MoName"
```
Above example returns the HyperflexProxySettingPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexProxySettingPolicy -Organization $organization
```
Above example returns the list of HyperflexProxySettingPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexProxySettingPolicy -InlineCount allpages
```
Above example returns the list of HyperflexProxySettingPolicy along with count.
...
### -Name
Specifies the name of the HyperflexProxySettingPolicy.
...
### -Organization
Specifies the organization, to fetch the HyperflexProxySettingPolicy under it.
