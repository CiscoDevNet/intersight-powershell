...
# Get-IntersightVnicFcQosPolicyInventory

## SYNOPSIS
Get the VnicFcQosPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicFcQosPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicFcQosPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicFcQosPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicFcQosPolicyInventory
```
Above example returns the list of VnicFcQosPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicFcQosPolicyInventory -Name "MoName"
```
Above example returns the VnicFcQosPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicFcQosPolicyInventory -Organization $organization
```
Above example returns the list of VnicFcQosPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicFcQosPolicyInventory -InlineCount allpages
```
Above example returns the list of VnicFcQosPolicyInventory along with count.
...
### -Name
Specifies the name of the VnicFcQosPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the VnicFcQosPolicyInventory under it.
