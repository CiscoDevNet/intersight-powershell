...
## SYNOPSIS
Get the NiatelemetryMsoEpgDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryMsoEpgDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryMsoEpgDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryMsoEpgDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoEpgDetails
```
Above example returns the list of NiatelemetryMsoEpgDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoEpgDetails -Name "MoName"
```
Above example returns the NiatelemetryMsoEpgDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoEpgDetails -Organization $organization
```
Above example returns the list of NiatelemetryMsoEpgDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoEpgDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryMsoEpgDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryMsoEpgDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryMsoEpgDetails under it.
