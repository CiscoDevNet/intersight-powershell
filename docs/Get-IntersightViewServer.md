...
### CmdletParam (Default)
```
Get-IntersightViewServer [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightViewServer [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ViewServer&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightViewServer
```
Above example returns the list of ViewServer.

### Example 2
```powershell
PS C:\> $result = Get-IntersightViewServer -Name "MoName"
```
Above example returns the ViewServer matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightViewServer -Organization $organization
```
Above example returns the list of ViewServer available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightViewServer -InlineCount allpages
```
Above example returns the list of ViewServer along with count.
...
### -Name
Specifies the name of the ViewServer.
...
### -Organization
Specifies the organization, to fetch the ViewServer under it.
