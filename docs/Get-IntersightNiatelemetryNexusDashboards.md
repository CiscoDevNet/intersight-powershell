...
### CmdletParam (Default)
```
Get-IntersightNiatelemetryNexusDashboards [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryNexusDashboards [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryNexusDashboards&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboards
```
Above example returns the list of NiatelemetryNexusDashboards.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboards -Name "MoName"
```
Above example returns the NiatelemetryNexusDashboards matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboards -Organization $organization
```
Above example returns the list of NiatelemetryNexusDashboards available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboards -InlineCount allpages
```
Above example returns the list of NiatelemetryNexusDashboards along with count.
...
### -Name
Specifies the name of the NiatelemetryNexusDashboards.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryNexusDashboards under it.
