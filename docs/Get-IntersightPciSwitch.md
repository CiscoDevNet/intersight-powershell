...
### CmdletParam (Default)
```
Get-IntersightPciSwitch [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPciSwitch [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;PciSwitch&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPciSwitch
```
Above example returns the list of PciSwitch.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPciSwitch -Name "MoName"
```
Above example returns the PciSwitch matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPciSwitch -Organization $organization
```
Above example returns the list of PciSwitch available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPciSwitch -InlineCount allpages
```
Above example returns the list of PciSwitch along with count.
...
### -Name
Specifies the name of the PciSwitch.
...
### -Organization
Specifies the organization, to fetch the PciSwitch under it.
...
[Set-IntersightPciSwitch](./Set-IntersightPciSwitch.md)
