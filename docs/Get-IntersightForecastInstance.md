...
# Get-IntersightForecastInstance

## SYNOPSIS
Get the ForecastInstance

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightForecastInstance [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightForecastInstance [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ForecastInstance&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightForecastInstance
```
Above example returns the list of ForecastInstance.

### Example 2
```powershell
PS C:\> $result = Get-IntersightForecastInstance -Name "MoName"
```
Above example returns the ForecastInstance matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightForecastInstance -Organization $organization
```
Above example returns the list of ForecastInstance available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightForecastInstance -InlineCount allpages
```
Above example returns the list of ForecastInstance along with count.
...
### -Name
Specifies the name of the ForecastInstance.
...
### -Organization
Specifies the organization, to fetch the ForecastInstance under it.
...
[Set-IntersightForecastInstance](./Set-IntersightForecastInstance.md)
