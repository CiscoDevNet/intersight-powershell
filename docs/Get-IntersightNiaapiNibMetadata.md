...
## SYNOPSIS
Get the NiaapiNibMetadata

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiNibMetadata [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiNibMetadata [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiaapiNibMetadata&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiNibMetadata
```
Above example returns the list of NiaapiNibMetadata.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiNibMetadata -Name "MoName"
```
Above example returns the NiaapiNibMetadata matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiNibMetadata -Organization $organization
```
Above example returns the list of NiaapiNibMetadata available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiNibMetadata -InlineCount allpages
```
Above example returns the list of NiaapiNibMetadata along with count.
...
### -Name
Specifies the name of the NiaapiNibMetadata.
...
### -Organization
Specifies the organization, to fetch the NiaapiNibMetadata under it.
