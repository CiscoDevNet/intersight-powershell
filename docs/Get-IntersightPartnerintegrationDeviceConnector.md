...
## SYNOPSIS
Get the PartnerintegrationDeviceConnector

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPartnerintegrationDeviceConnector [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPartnerintegrationDeviceConnector [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PartnerintegrationDeviceConnector&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationDeviceConnector
```
Above example returns the list of PartnerintegrationDeviceConnector.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationDeviceConnector -Name "MoName"
```
Above example returns the PartnerintegrationDeviceConnector matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationDeviceConnector -Organization $organization
```
Above example returns the list of PartnerintegrationDeviceConnector available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationDeviceConnector -InlineCount allpages
```
Above example returns the list of PartnerintegrationDeviceConnector along with count.
...
### -Name
Specifies the name of the PartnerintegrationDeviceConnector.
...
### -Organization
Specifies the organization, to fetch the PartnerintegrationDeviceConnector under it.
...
[Remove-IntersightPartnerintegrationDeviceConnector](./Remove-IntersightPartnerintegrationDeviceConnector.md)
