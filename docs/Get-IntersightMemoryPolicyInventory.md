...
# Get-IntersightMemoryPolicyInventory

## SYNOPSIS
Get the MemoryPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMemoryPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMemoryPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MemoryPolicyInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMemoryPolicyInventory
```
Above example returns the list of MemoryPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMemoryPolicyInventory -Name "MoName"
```
Above example returns the MemoryPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMemoryPolicyInventory -Organization $organization
```
Above example returns the list of MemoryPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMemoryPolicyInventory -InlineCount allpages
```
Above example returns the list of MemoryPolicyInventory along with count.
...
### -Name
Specifies the name of the MemoryPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the MemoryPolicyInventory under it.
