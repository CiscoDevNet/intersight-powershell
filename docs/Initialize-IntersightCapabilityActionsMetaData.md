...
# Initialize-IntersightCapabilityActionsMetaData
...
Initialize-IntersightCapabilityActionsMetaData [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< CapabilityActionsMetaData.ClassIdEnum>][-MaxFwVersion< string>][-MinFwVersion< string>][-Model< string>][-Moid< string>][-Name< string>][-ObjectType< CapabilityActionsMetaData.ObjectTypeEnum>][-SupportedActions< System.Collections.Generic.List`1[string]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TargetType< CapabilityActionsMetaData.TargetTypeEnum>][-Vendor< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: CapabilityActionsMetaData.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CapabilityActionsMetaData.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCapabilityActionsMetaData
```
