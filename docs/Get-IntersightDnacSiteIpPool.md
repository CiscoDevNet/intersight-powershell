...
# Get-IntersightDnacSiteIpPool

## SYNOPSIS
Get the DnacSiteIpPool

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightDnacSiteIpPool [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightDnacSiteIpPool [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;DnacSiteIpPool&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightDnacSiteIpPool
```
Above example returns the list of DnacSiteIpPool.

### Example 2
```powershell
PS C:\> $result = Get-IntersightDnacSiteIpPool -Name "MoName"
```
Above example returns the DnacSiteIpPool matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightDnacSiteIpPool -Organization $organization
```
Above example returns the list of DnacSiteIpPool available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightDnacSiteIpPool -InlineCount allpages
```
Above example returns the list of DnacSiteIpPool along with count.
...
### -Name
Specifies the name of the DnacSiteIpPool.
...
### -Organization
Specifies the organization, to fetch the DnacSiteIpPool under it.
