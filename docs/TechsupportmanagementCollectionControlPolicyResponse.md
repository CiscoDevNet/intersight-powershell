...
```powershell
$TechsupportmanagementCollectionControlPolicyResponse = Initialize-IntersightTechsupportmanagementCollectionControlPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$TechsupportmanagementCollectionControlPolicyResponse | ConvertTo-JSON
```
