...
# Get-IntersightMgmtConfigOperationSetting

## SYNOPSIS
Get the MgmtConfigOperationSetting

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMgmtConfigOperationSetting [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMgmtConfigOperationSetting [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MgmtConfigOperationSetting&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMgmtConfigOperationSetting
```
Above example returns the list of MgmtConfigOperationSetting.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMgmtConfigOperationSetting -Name "MoName"
```
Above example returns the MgmtConfigOperationSetting matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMgmtConfigOperationSetting -Organization $organization
```
Above example returns the list of MgmtConfigOperationSetting available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMgmtConfigOperationSetting -InlineCount allpages
```
Above example returns the list of MgmtConfigOperationSetting along with count.
...
### -Name
Specifies the name of the MgmtConfigOperationSetting.
...
### -Organization
Specifies the organization, to fetch the MgmtConfigOperationSetting under it.
...
[Remove-IntersightMgmtConfigOperationSetting](./Remove-IntersightMgmtConfigOperationSetting.md)
