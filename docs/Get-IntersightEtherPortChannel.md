...
# Get-IntersightEtherPortChannel

## SYNOPSIS
Get the EtherPortChannel

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEtherPortChannel [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEtherPortChannel [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EtherPortChannel&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEtherPortChannel
```
Above example returns the list of EtherPortChannel.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEtherPortChannel -Name "MoName"
```
Above example returns the EtherPortChannel matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEtherPortChannel -Organization $organization
```
Above example returns the list of EtherPortChannel available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEtherPortChannel -InlineCount allpages
```
Above example returns the list of EtherPortChannel along with count.
...
### -Name
Specifies the name of the EtherPortChannel.
...
### -Organization
Specifies the organization, to fetch the EtherPortChannel under it.
