...
```powershell
$VnicLanConnectivityPolicyRelationship = Initialize-IntersightVnicLanConnectivityPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$VnicLanConnectivityPolicyRelationship | ConvertTo-JSON
```
