...
New-IntersightAssetDeviceClaim [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Moid< string>][-Reservation< ResourceReservationRelationship>][-SecurityToken< string>][-SerialNumber< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
