...
```powershell
$MemoryPersistentMemoryConfigResult = Initialize-IntersightMemoryPersistentMemoryConfigResult  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$MemoryPersistentMemoryConfigResult | ConvertTo-JSON
```
