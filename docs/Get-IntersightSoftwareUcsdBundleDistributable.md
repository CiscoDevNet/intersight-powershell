...
## SYNOPSIS
Get the SoftwareUcsdBundleDistributable

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwareUcsdBundleDistributable [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwareUcsdBundleDistributable [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;SoftwareUcsdBundleDistributable&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwareUcsdBundleDistributable
```
Above example returns the list of SoftwareUcsdBundleDistributable.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwareUcsdBundleDistributable -Name "MoName"
```
Above example returns the SoftwareUcsdBundleDistributable matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwareUcsdBundleDistributable -Organization $organization
```
Above example returns the list of SoftwareUcsdBundleDistributable available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwareUcsdBundleDistributable -InlineCount allpages
```
Above example returns the list of SoftwareUcsdBundleDistributable along with count.
...
### -Name
Specifies the name of the SoftwareUcsdBundleDistributable.
...
### -Organization
Specifies the organization, to fetch the SoftwareUcsdBundleDistributable under it.
