...
## SYNOPSIS
Get the HyperflexVcenterConfigPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexVcenterConfigPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexVcenterConfigPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexVcenterConfigPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexVcenterConfigPolicy
```
Above example returns the list of HyperflexVcenterConfigPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexVcenterConfigPolicy -Name "MoName"
```
Above example returns the HyperflexVcenterConfigPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexVcenterConfigPolicy -Organization $organization
```
Above example returns the list of HyperflexVcenterConfigPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexVcenterConfigPolicy -InlineCount allpages
```
Above example returns the list of HyperflexVcenterConfigPolicy along with count.
...
### -Name
Specifies the name of the HyperflexVcenterConfigPolicy.
...
### -Organization
Specifies the organization, to fetch the HyperflexVcenterConfigPolicy under it.
