...
### CmdletParam (Default)
```
Get-IntersightConvergedinfraServerComplianceDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightConvergedinfraServerComplianceDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
