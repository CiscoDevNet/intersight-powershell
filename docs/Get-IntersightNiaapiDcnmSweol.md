...
## SYNOPSIS
Get the NiaapiDcnmSweol

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiDcnmSweol [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiDcnmSweol [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiaapiDcnmSweol&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmSweol
```
Above example returns the list of NiaapiDcnmSweol.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmSweol -Name "MoName"
```
Above example returns the NiaapiDcnmSweol matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmSweol -Organization $organization
```
Above example returns the list of NiaapiDcnmSweol available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmSweol -InlineCount allpages
```
Above example returns the list of NiaapiDcnmSweol along with count.
...
### -Name
Specifies the name of the NiaapiDcnmSweol.
...
### -Organization
Specifies the organization, to fetch the NiaapiDcnmSweol under it.
