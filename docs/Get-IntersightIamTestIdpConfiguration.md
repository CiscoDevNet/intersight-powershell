...
# Get-IntersightIamTestIdpConfiguration

## SYNOPSIS
Get the IamTestIdpConfiguration

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamTestIdpConfiguration [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamTestIdpConfiguration [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamTestIdpConfiguration&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamTestIdpConfiguration
```
Above example returns the list of IamTestIdpConfiguration.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamTestIdpConfiguration -Name "MoName"
```
Above example returns the IamTestIdpConfiguration matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamTestIdpConfiguration -Organization $organization
```
Above example returns the list of IamTestIdpConfiguration available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamTestIdpConfiguration -InlineCount allpages
```
Above example returns the list of IamTestIdpConfiguration along with count.
...
### -Name
Specifies the name of the IamTestIdpConfiguration.
...
### -Organization
Specifies the organization, to fetch the IamTestIdpConfiguration under it.
...
[Set-IntersightIamTestIdpConfiguration](./Set-IntersightIamTestIdpConfiguration.md)
