# SoftwareHyperflexDistributableAllOf
## Properties
...
```powershell
$SoftwareHyperflexDistributableAllOf = Initialize-IntersightSoftwareHyperflexDistributableAllOf  -ClassId null `
 -ObjectType null `
 -Catalog null
```
...
```powershell
$SoftwareHyperflexDistributableAllOf | ConvertTo-JSON
```
