...
Set-IntersightWorkflowCustomDataTypeDefinition [-AdditionalProperties< Dictionary<string,object>>][-Catalog< WorkflowCatalogRelationship>][-CompositeType< bool>][-Description< string>][-Label< string>][[-Moid]< string>][-Name< string>][-ParameterSet< List<WorkflowParameterSet>>][-Properties< WorkflowCustomDataTypeProperties>][-Tags< List<MoTag>>][-TypeDefinition< List<WorkflowBaseDataType>>]
