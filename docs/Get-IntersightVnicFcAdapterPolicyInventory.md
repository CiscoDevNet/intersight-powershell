...
# Get-IntersightVnicFcAdapterPolicyInventory

## SYNOPSIS
Get the VnicFcAdapterPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicFcAdapterPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicFcAdapterPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicFcAdapterPolicyInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicFcAdapterPolicyInventory
```
Above example returns the list of VnicFcAdapterPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicFcAdapterPolicyInventory -Name "MoName"
```
Above example returns the VnicFcAdapterPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicFcAdapterPolicyInventory -Organization $organization
```
Above example returns the list of VnicFcAdapterPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicFcAdapterPolicyInventory -InlineCount allpages
```
Above example returns the list of VnicFcAdapterPolicyInventory along with count.
...
### -Name
Specifies the name of the VnicFcAdapterPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the VnicFcAdapterPolicyInventory under it.
