...
# Initialize-IntersightWorkflowTaskInfoUpdate
...
Initialize-IntersightWorkflowTaskInfoUpdate [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< WorkflowTaskInfoUpdate.ClassIdEnum>][-Input< object>][-Name< string>][-ObjectType< WorkflowTaskInfoUpdate.ObjectTypeEnum>][-Status< WorkflowTaskInfoUpdate.StatusEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowTaskInfoUpdate.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowTaskInfoUpdate.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowTaskInfoUpdate
```
