...
# Get-IntersightPowerPolicyInventory

## SYNOPSIS
Get the PowerPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPowerPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPowerPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PowerPolicyInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPowerPolicyInventory
```
Above example returns the list of PowerPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPowerPolicyInventory -Name "MoName"
```
Above example returns the PowerPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPowerPolicyInventory -Organization $organization
```
Above example returns the list of PowerPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPowerPolicyInventory -InlineCount allpages
```
Above example returns the list of PowerPolicyInventory along with count.
...
### -Name
Specifies the name of the PowerPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the PowerPolicyInventory under it.
