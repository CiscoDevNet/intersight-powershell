...
### CmdletParam (Default)
```
Get-IntersightResourceGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourceGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourceGroup
```
Above example returns the list of ResourceGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourceGroup -Name "MoName"
```
Above example returns the ResourceGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourceGroup -Organization $organization
```
Above example returns the list of ResourceGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourceGroup -InlineCount allpages
```
Above example returns the list of ResourceGroup along with count.
...
### -Name
Specifies the name of the ResourceGroup.
...
### -Organization
Specifies the organization, to fetch the ResourceGroup under it.
