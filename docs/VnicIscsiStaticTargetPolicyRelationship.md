...
```powershell
$VnicIscsiStaticTargetPolicyRelationship = Initialize-IntersightVnicIscsiStaticTargetPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$VnicIscsiStaticTargetPolicyRelationship | ConvertTo-JSON
```
