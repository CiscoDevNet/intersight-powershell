...
## SYNOPSIS
Get the KubernetesNodeGroupProfile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesNodeGroupProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesNodeGroupProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KubernetesNodeGroupProfile&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesNodeGroupProfile
```
Above example returns the list of KubernetesNodeGroupProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesNodeGroupProfile -Name "MoName"
```
Above example returns the KubernetesNodeGroupProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesNodeGroupProfile -Organization $organization
```
Above example returns the list of KubernetesNodeGroupProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesNodeGroupProfile -InlineCount allpages
```
Above example returns the list of KubernetesNodeGroupProfile along with count.
...
### -Name
Specifies the name of the KubernetesNodeGroupProfile.
...
### -Organization
Specifies the organization, to fetch the KubernetesNodeGroupProfile under it.
