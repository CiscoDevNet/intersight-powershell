...
# Get-IntersightNetworkInterfaceList

## SYNOPSIS
Get the NetworkInterfaceList

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkInterfaceList [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkInterfaceList [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NetworkInterfaceList&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkInterfaceList
```
Above example returns the list of NetworkInterfaceList.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkInterfaceList -Name "MoName"
```
Above example returns the NetworkInterfaceList matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkInterfaceList -Organization $organization
```
Above example returns the list of NetworkInterfaceList available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkInterfaceList -InlineCount allpages
```
Above example returns the list of NetworkInterfaceList along with count.
...
### -Name
Specifies the name of the NetworkInterfaceList.
...
### -Organization
Specifies the organization, to fetch the NetworkInterfaceList under it.
