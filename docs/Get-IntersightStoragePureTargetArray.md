...
# Get-IntersightStoragePureTargetArray

## SYNOPSIS
Get the StoragePureTargetArray

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureTargetArray [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureTargetArray [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureTargetArray&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureTargetArray
```
Above example returns the list of StoragePureTargetArray.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureTargetArray -Name "MoName"
```
Above example returns the StoragePureTargetArray matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureTargetArray -Organization $organization
```
Above example returns the list of StoragePureTargetArray available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureTargetArray -InlineCount allpages
```
Above example returns the list of StoragePureTargetArray along with count.
...
### -Name
Specifies the name of the StoragePureTargetArray.
...
### -Organization
Specifies the organization, to fetch the StoragePureTargetArray under it.
