...
# Initialize-IntersightFabricFcoeUplinkRole
...
```yaml
Type: FabricFcoeUplinkRole.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricFcoeUplinkRole.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFabricFcoeUplinkRole
```
