...
## SYNOPSIS
Get the VirtualizationIweVirtualDisk

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationIweVirtualDisk [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationIweVirtualDisk [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;VirtualizationIweVirtualDisk&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweVirtualDisk
```
Above example returns the list of VirtualizationIweVirtualDisk.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweVirtualDisk -Name "MoName"
```
Above example returns the VirtualizationIweVirtualDisk matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweVirtualDisk -Organization $organization
```
Above example returns the list of VirtualizationIweVirtualDisk available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweVirtualDisk -InlineCount allpages
```
Above example returns the list of VirtualizationIweVirtualDisk along with count.
...
### -Name
Specifies the name of the VirtualizationIweVirtualDisk.
...
### -Organization
Specifies the organization, to fetch the VirtualizationIweVirtualDisk under it.
...
[Set-IntersightVirtualizationIweVirtualDisk](./Set-IntersightVirtualizationIweVirtualDisk.md)
