...
## SYNOPSIS
Get the CloudAwsOrganizationalUnit

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudAwsOrganizationalUnit [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudAwsOrganizationalUnit [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudAwsOrganizationalUnit
```
Above example returns the list of CloudAwsOrganizationalUnit.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudAwsOrganizationalUnit -Name "MoName"
```
Above example returns the CloudAwsOrganizationalUnit matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudAwsOrganizationalUnit -Organization $organization
```
Above example returns the list of CloudAwsOrganizationalUnit available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudAwsOrganizationalUnit -InlineCount allpages
```
Above example returns the list of CloudAwsOrganizationalUnit along with count.
...
### -Name
Specifies the name of the CloudAwsOrganizationalUnit.
...
### -Organization
Specifies the organization, to fetch the CloudAwsOrganizationalUnit under it.
