...
Set-IntersightEquipmentIoCard [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ConnectionStatus< string>][-FanModules< System.Collections.Generic.List`1[EquipmentFanModuleRelationship]>][-HostPorts< System.Collections.Generic.List`1[EtherHostPortRelationship]>][[-Moid]< string>][-NetworkPorts< System.Collections.Generic.List`1[EtherNetworkPortRelationship]>][-PhysicalDeviceRegistration< AssetDeviceRegistrationRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> Set-IntersightEquipmentIoCard
```
