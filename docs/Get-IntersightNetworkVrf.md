...
### CmdletParam (Default)
```
Get-IntersightNetworkVrf [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkVrf [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NetworkVrf&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkVrf
```
Above example returns the list of NetworkVrf.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkVrf -Name "MoName"
```
Above example returns the NetworkVrf matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkVrf -Organization $organization
```
Above example returns the list of NetworkVrf available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkVrf -InlineCount allpages
```
Above example returns the list of NetworkVrf along with count.
...
### -Name
Specifies the name of the NetworkVrf.
...
### -Organization
Specifies the organization, to fetch the NetworkVrf under it.
