...
# Get-IntersightStorageNetAppNodeCdpNeighbor

## SYNOPSIS
Get the StorageNetAppNodeCdpNeighbor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppNodeCdpNeighbor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppNodeCdpNeighbor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppNodeCdpNeighbor&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNodeCdpNeighbor
```
Above example returns the list of StorageNetAppNodeCdpNeighbor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNodeCdpNeighbor -Name "MoName"
```
Above example returns the StorageNetAppNodeCdpNeighbor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNodeCdpNeighbor -Organization $organization
```
Above example returns the list of StorageNetAppNodeCdpNeighbor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNodeCdpNeighbor -InlineCount allpages
```
Above example returns the list of StorageNetAppNodeCdpNeighbor along with count.
...
### -Name
Specifies the name of the StorageNetAppNodeCdpNeighbor.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppNodeCdpNeighbor under it.
