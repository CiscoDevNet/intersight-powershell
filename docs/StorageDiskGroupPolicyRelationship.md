...
```powershell
$StorageDiskGroupPolicyRelationship = Initialize-IntersightStorageDiskGroupPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StorageDiskGroupPolicyRelationship | ConvertTo-JSON
```
