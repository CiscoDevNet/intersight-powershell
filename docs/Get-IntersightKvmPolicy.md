...
### CmdletParam (Default)
```
Get-IntersightKvmPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKvmPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKvmPolicy
```
Above example returns the list of KvmPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKvmPolicy -Name "MoName"
```
Above example returns the KvmPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKvmPolicy -Organization $organization
```
Above example returns the list of KvmPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKvmPolicy -InlineCount allpages
```
Above example returns the list of KvmPolicy along with count.
...
### -Name
Specifies the name of the KvmPolicy.
...
### -Organization
Specifies the organization, to fetch the KvmPolicy under it.
