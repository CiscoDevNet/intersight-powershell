...
# Initialize-IntersightComputeBlade
...
```yaml
Type: ComputeBlade.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightComputeBlade
```
