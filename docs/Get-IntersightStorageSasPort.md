...
# Get-IntersightStorageSasPort

## SYNOPSIS
Get the StorageSasPort

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageSasPort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageSasPort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageSasPort&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageSasPort
```
Above example returns the list of StorageSasPort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageSasPort -Name "MoName"
```
Above example returns the StorageSasPort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageSasPort -Organization $organization
```
Above example returns the list of StorageSasPort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageSasPort -InlineCount allpages
```
Above example returns the list of StorageSasPort along with count.
...
### -Name
Specifies the name of the StorageSasPort.
...
### -Organization
Specifies the organization, to fetch the StorageSasPort under it.
...
[Set-IntersightStorageSasPort](./Set-IntersightStorageSasPort.md)
