...
```powershell
$HyperflexFeatureLimitExternalResponse = Initialize-IntersightHyperflexFeatureLimitExternalResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexFeatureLimitExternalResponse | ConvertTo-JSON
```
