...
## SYNOPSIS
Get the HyperflexCluster

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexCluster [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexCluster [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexCluster&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexCluster
```
Above example returns the list of HyperflexCluster.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexCluster -Name "MoName"
```
Above example returns the HyperflexCluster matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexCluster -Organization $organization
```
Above example returns the list of HyperflexCluster available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexCluster -InlineCount allpages
```
Above example returns the list of HyperflexCluster along with count.
...
### -Name
Specifies the name of the HyperflexCluster.
...
### -Organization
Specifies the organization, to fetch the HyperflexCluster under it.
...
[Set-IntersightHyperflexCluster](./Set-IntersightHyperflexCluster.md)
