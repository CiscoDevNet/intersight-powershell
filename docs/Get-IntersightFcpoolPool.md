...
### CmdletParam (Default)
```
Get-IntersightFcpoolPool [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFcpoolPool [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFcpoolPool
```
Above example returns the list of FcpoolPool.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFcpoolPool -Name "MoName"
```
Above example returns the FcpoolPool matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFcpoolPool -Organization $organization
```
Above example returns the list of FcpoolPool available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFcpoolPool -InlineCount allpages
```
Above example returns the list of FcpoolPool along with count.
...
### -Name
Specifies the name of the FcpoolPool.
...
### -Organization
Specifies the organization, to fetch the FcpoolPool under it.
