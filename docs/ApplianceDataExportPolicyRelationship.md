...
```powershell
$ApplianceDataExportPolicyRelationship = Initialize-IntersightApplianceDataExportPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$ApplianceDataExportPolicyRelationship | ConvertTo-JSON
```
