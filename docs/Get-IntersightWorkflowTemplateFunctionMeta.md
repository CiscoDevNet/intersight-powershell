...
## SYNOPSIS
Get the WorkflowTemplateFunctionMeta

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowTemplateFunctionMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowTemplateFunctionMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;WorkflowTemplateFunctionMeta&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowTemplateFunctionMeta
```
Above example returns the list of WorkflowTemplateFunctionMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowTemplateFunctionMeta -Name "MoName"
```
Above example returns the WorkflowTemplateFunctionMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowTemplateFunctionMeta -Organization $organization
```
Above example returns the list of WorkflowTemplateFunctionMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowTemplateFunctionMeta -InlineCount allpages
```
Above example returns the list of WorkflowTemplateFunctionMeta along with count.
...
### -Name
Specifies the name of the WorkflowTemplateFunctionMeta.
...
### -Organization
Specifies the organization, to fetch the WorkflowTemplateFunctionMeta under it.
