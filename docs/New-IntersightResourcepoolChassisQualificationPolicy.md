...
# New-IntersightResourcepoolChassisQualificationPolicy
...
New-IntersightResourcepoolChassisQualificationPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Description< string>][-ExcludeServers< bool>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-Qualifiers< System.Collections.Generic.List`1[ResourceResourceQualifier]>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;ResourcepoolChassisQualificationPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightResourcepoolChassisQualificationPolicy
```
