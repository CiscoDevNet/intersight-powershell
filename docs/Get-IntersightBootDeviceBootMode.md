...
# Get-IntersightBootDeviceBootMode

## SYNOPSIS
Get the BootDeviceBootMode

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBootDeviceBootMode [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBootDeviceBootMode [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBootDeviceBootMode
```
Above example returns the list of BootDeviceBootMode.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBootDeviceBootMode -Name "MoName"
```
Above example returns the BootDeviceBootMode matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBootDeviceBootMode -Organization $organization
```
Above example returns the list of BootDeviceBootMode available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBootDeviceBootMode -InlineCount allpages
```
Above example returns the list of BootDeviceBootMode along with count.
...
### -Name
Specifies the name of the BootDeviceBootMode.
...
### -Organization
Specifies the organization, to fetch the BootDeviceBootMode under it.
...
[Set-IntersightBootDeviceBootMode](./Set-IntersightBootDeviceBootMode.md)
