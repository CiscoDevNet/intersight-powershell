...
# Get-IntersightViewHealthStatus

## SYNOPSIS
Get the ViewHealthStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightViewHealthStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightViewHealthStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ViewHealthStatus&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightViewHealthStatus
```
Above example returns the list of ViewHealthStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightViewHealthStatus -Name "MoName"
```
Above example returns the ViewHealthStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightViewHealthStatus -Organization $organization
```
Above example returns the list of ViewHealthStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightViewHealthStatus -InlineCount allpages
```
Above example returns the list of ViewHealthStatus along with count.
...
### -Name
Specifies the name of the ViewHealthStatus.
...
### -Organization
Specifies the organization, to fetch the ViewHealthStatus under it.
