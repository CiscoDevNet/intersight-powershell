# Intersight.Intersight/Api.IntersightMemoryApi
...
[**Set-IntersightMemoryArray**](IntersightMemoryApi.md#Set-IntersightMemoryArray) | **PATCH** /api/v1/memory/Arrays/{Moid} | Update a &#39;memory.Array&#39; resource.
...
<a name="Get-IntersightMemoryArrayList"></a>
...
# Read a 'memory.PersistentMemoryConfigResult' resource.
try {
     $Result = Get-IntersightMemoryPersistentMemoryConfigResultList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMemoryPersistentMemoryConfigResultList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
# Read a 'memory.PersistentMemoryConfiguration' resource.
try {
     $Result = Get-IntersightMemoryPersistentMemoryConfigurationList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMemoryPersistentMemoryConfigurationList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMemoryPersistentMemoryNamespaceByMoid"></a>
# **Get-IntersightMemoryPersistentMemoryNamespaceByMoid**
> MemoryPersistentMemoryNamespace Get-IntersightMemoryPersistentMemoryNamespaceByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'memory.PersistentMemoryNamespace' resource.
try {
     $Result = Get-IntersightMemoryPersistentMemoryNamespaceByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMemoryPersistentMemoryNamespaceByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMemoryPersistentMemoryNamespaceConfigResultByMoid"></a>
# **Get-IntersightMemoryPersistentMemoryNamespaceConfigResultByMoid**
> MemoryPersistentMemoryNamespaceConfigResult Get-IntersightMemoryPersistentMemoryNamespaceConfigResultByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'memory.PersistentMemoryNamespaceConfigResult' resource.
try {
     $Result = Get-IntersightMemoryPersistentMemoryNamespaceConfigResultByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMemoryPersistentMemoryNamespaceConfigResultByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMemoryPersistentMemoryNamespaceConfigResultList"></a>
# **Get-IntersightMemoryPersistentMemoryNamespaceConfigResultList**
> MemoryPersistentMemoryNamespaceConfigResultResponse Get-IntersightMemoryPersistentMemoryNamespaceConfigResultList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'memory.PersistentMemoryNamespaceConfigResult' resource.
try {
     $Result = Get-IntersightMemoryPersistentMemoryNamespaceConfigResultList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMemoryPersistentMemoryNamespaceConfigResultList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMemoryPersistentMemoryNamespaceList"></a>
# **Get-IntersightMemoryPersistentMemoryNamespaceList**
> MemoryPersistentMemoryNamespaceResponse Get-IntersightMemoryPersistentMemoryNamespaceList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'memory.PersistentMemoryNamespace' resource.
try {
     $Result = Get-IntersightMemoryPersistentMemoryNamespaceList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMemoryPersistentMemoryNamespaceList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMemoryPersistentMemoryPolicyByMoid"></a>
# **Get-IntersightMemoryPersistentMemoryPolicyByMoid**
> MemoryPersistentMemoryPolicy Get-IntersightMemoryPersistentMemoryPolicyByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'memory.PersistentMemoryPolicy' resource.
try {
     $Result = Get-IntersightMemoryPersistentMemoryPolicyByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMemoryPersistentMemoryPolicyByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMemoryPersistentMemoryPolicyList"></a>
# **Get-IntersightMemoryPersistentMemoryPolicyList**
> MemoryPersistentMemoryPolicyResponse Get-IntersightMemoryPersistentMemoryPolicyList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'memory.PersistentMemoryPolicy' resource.
try {
     $Result = Get-IntersightMemoryPersistentMemoryPolicyList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMemoryPersistentMemoryPolicyList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMemoryPersistentMemoryRegionByMoid"></a>
# **Get-IntersightMemoryPersistentMemoryRegionByMoid**
> MemoryPersistentMemoryRegion Get-IntersightMemoryPersistentMemoryRegionByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'memory.PersistentMemoryRegion' resource.
try {
     $Result = Get-IntersightMemoryPersistentMemoryRegionByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMemoryPersistentMemoryRegionByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMemoryPersistentMemoryRegionList"></a>
# **Get-IntersightMemoryPersistentMemoryRegionList**
> MemoryPersistentMemoryRegionResponse Get-IntersightMemoryPersistentMemoryRegionList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'memory.PersistentMemoryRegion' resource.
try {
     $Result = Get-IntersightMemoryPersistentMemoryRegionList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMemoryPersistentMemoryRegionList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMemoryPersistentMemoryUnitByMoid"></a>
# **Get-IntersightMemoryPersistentMemoryUnitByMoid**
> MemoryPersistentMemoryUnit Get-IntersightMemoryPersistentMemoryUnitByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'memory.PersistentMemoryUnit' resource.
try {
     $Result = Get-IntersightMemoryPersistentMemoryUnitByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMemoryPersistentMemoryUnitByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMemoryPersistentMemoryUnitList"></a>
# **Get-IntersightMemoryPersistentMemoryUnitList**
> MemoryPersistentMemoryUnitResponse Get-IntersightMemoryPersistentMemoryUnitList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'memory.PersistentMemoryUnit' resource.
try {
     $Result = Get-IntersightMemoryPersistentMemoryUnitList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMemoryPersistentMemoryUnitList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMemoryUnitByMoid"></a>
# **Get-IntersightMemoryUnitByMoid**
> MemoryUnit Get-IntersightMemoryUnitByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'memory.Unit' resource.
try {
     $Result = Get-IntersightMemoryUnitByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMemoryUnitByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightMemoryUnitList"></a>
# **Get-IntersightMemoryUnitList**
> MemoryUnitResponse Get-IntersightMemoryUnitList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'memory.Unit' resource.
try {
     $Result = Get-IntersightMemoryUnitList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightMemoryUnitList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightMemoryArray"></a>
# **Set-IntersightMemoryArray**
> MemoryArray Set-IntersightMemoryArray<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryArray] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
<a name="Set-IntersightMemoryPersistentMemoryConfigResult"></a>
# **Set-IntersightMemoryPersistentMemoryConfigResult**
> MemoryPersistentMemoryConfigResult Set-IntersightMemoryPersistentMemoryConfigResult<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryPersistentMemoryConfigResult] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$MemoryPersistentMemoryConfigResult = (Initialize-memory.PersistentMemoryConfigResult-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -ConfigErrorDesc "ConfigErrorDesc_example" -ConfigResult "ConfigResult_example" -ConfigSequenceNo 123 -ConfigState "ConfigState_example" -InventoryDeviceInfo  -MemoryPersistentMemoryConfiguration  -PersistentMemoryNamespaceConfigResults @() -RegisteredDevice ) # MemoryPersistentMemoryConfigResult | The 'memory.PersistentMemoryConfigResult' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'memory.PersistentMemoryConfigResult' resource.
try {
     $Result = Set-IntersightMemoryPersistentMemoryConfigResult -Moid $Moid -MemoryPersistentMemoryConfigResult $MemoryPersistentMemoryConfigResult -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightMemoryPersistentMemoryConfigResult: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightMemoryPersistentMemoryConfiguration"></a>
# **Set-IntersightMemoryPersistentMemoryConfiguration**
> MemoryPersistentMemoryConfiguration Set-IntersightMemoryPersistentMemoryConfiguration<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryPersistentMemoryConfiguration] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$MemoryPersistentMemoryConfiguration = (Initialize-memory.PersistentMemoryConfiguration-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -MemoryCapacity "MemoryCapacity_example" -NumOfModules "NumOfModules_example" -NumOfRegions "NumOfRegions_example" -PersistentMemoryCapacity "PersistentMemoryCapacity_example" -ReservedCapacity "ReservedCapacity_example" -SecurityState "SecurityState_example" -TotalCapacity "TotalCapacity_example" -ComputeBoard  -InventoryDeviceInfo  -PersistentMemoryConfigResult  -PersistentMemoryRegions @() -RegisteredDevice ) # MemoryPersistentMemoryConfiguration | The 'memory.PersistentMemoryConfiguration' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'memory.PersistentMemoryConfiguration' resource.
try {
     $Result = Set-IntersightMemoryPersistentMemoryConfiguration -Moid $Moid -MemoryPersistentMemoryConfiguration $MemoryPersistentMemoryConfiguration -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightMemoryPersistentMemoryConfiguration: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightMemoryPersistentMemoryNamespace"></a>
# **Set-IntersightMemoryPersistentMemoryNamespace**
> MemoryPersistentMemoryNamespace Set-IntersightMemoryPersistentMemoryNamespace<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryPersistentMemoryNamespace] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$MemoryPersistentMemoryNamespace = (Initialize-memory.PersistentMemoryNamespace-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Capacity "Capacity_example" -HealthState "HealthState_example" -LabelVersion "LabelVersion_example" -Mode "Mode_example" -Name "Name_example" -Uuid "Uuid_example" -InventoryDeviceInfo  -MemoryPersistentMemoryRegion  -RegisteredDevice ) # MemoryPersistentMemoryNamespace | The 'memory.PersistentMemoryNamespace' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'memory.PersistentMemoryNamespace' resource.
try {
     $Result = Set-IntersightMemoryPersistentMemoryNamespace -Moid $Moid -MemoryPersistentMemoryNamespace $MemoryPersistentMemoryNamespace -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightMemoryPersistentMemoryNamespace: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightMemoryPersistentMemoryNamespaceConfigResult"></a>
# **Set-IntersightMemoryPersistentMemoryNamespaceConfigResult**
> MemoryPersistentMemoryNamespaceConfigResult Set-IntersightMemoryPersistentMemoryNamespaceConfigResult<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryPersistentMemoryNamespaceConfigResult] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$MemoryPersistentMemoryNamespaceConfigResult = (Initialize-memory.PersistentMemoryNamespaceConfigResult-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -ConfigStatus "ConfigStatus_example" -Name "Name_example" -SocketId "SocketId_example" -SocketMemoryId "SocketMemoryId_example" -InventoryDeviceInfo  -MemoryPersistentMemoryConfigResult  -RegisteredDevice ) # MemoryPersistentMemoryNamespaceConfigResult | The 'memory.PersistentMemoryNamespaceConfigResult' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'memory.PersistentMemoryNamespaceConfigResult' resource.
try {
     $Result = Set-IntersightMemoryPersistentMemoryNamespaceConfigResult -Moid $Moid -MemoryPersistentMemoryNamespaceConfigResult $MemoryPersistentMemoryNamespaceConfigResult -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightMemoryPersistentMemoryNamespaceConfigResult: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightMemoryPersistentMemoryPolicy"></a>
# **Set-IntersightMemoryPersistentMemoryPolicy**
> MemoryPersistentMemoryPolicy Set-IntersightMemoryPersistentMemoryPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryPersistentMemoryPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$MemoryPersistentMemoryPolicy = (Initialize-memory.PersistentMemoryPolicy-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -Goals @((Initialize-memory.PersistentMemoryGoal-ClassId "ClassId_example" -ObjectType "ObjectType_example" -MemoryModePercentage 123 -PersistentMemoryType "PersistentMemoryType_example" -SocketId "SocketId_example")) -LocalSecurity (Initialize-memory.PersistentMemoryLocalSecurity-ClassId "ClassId_example" -ObjectType "ObjectType_example" -Enabled $false -IsSecurePassphraseSet $false -SecurePassphrase "SecurePassphrase_example") -LogicalNamespaces @((Initialize-memory.PersistentMemoryLogicalNamespace-ClassId "ClassId_example" -ObjectType "ObjectType_example" -Capacity 123 -Mode "Mode_example" -Name "Name_example" -SocketId 123 -SocketMemoryId "SocketMemoryId_example")) -ManagementMode "ManagementMode_example" -RetainNamespaces $false -Organization  -Profiles @()) # MemoryPersistentMemoryPolicy | The 'memory.PersistentMemoryPolicy' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'memory.PersistentMemoryPolicy' resource.
try {
     $Result = Set-IntersightMemoryPersistentMemoryPolicy -Moid $Moid -MemoryPersistentMemoryPolicy $MemoryPersistentMemoryPolicy -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightMemoryPersistentMemoryPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightMemoryPersistentMemoryRegion"></a>
# **Set-IntersightMemoryPersistentMemoryRegion**
> MemoryPersistentMemoryRegion Set-IntersightMemoryPersistentMemoryRegion<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryPersistentMemoryRegion] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$MemoryPersistentMemoryRegion = (Initialize-memory.PersistentMemoryRegion-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -FreeCapacity "FreeCapacity_example" -HealthState "HealthState_example" -InterleavedSetId "InterleavedSetId_example" -LocaterIds "LocaterIds_example" -PersistentMemoryType "PersistentMemoryType_example" -RegionId "RegionId_example" -SocketId "SocketId_example" -SocketMemoryId "SocketMemoryId_example" -TotalCapacity "TotalCapacity_example" -InventoryDeviceInfo  -MemoryPersistentMemoryConfiguration  -PersistentMemoryNamespaces @() -RegisteredDevice ) # MemoryPersistentMemoryRegion | The 'memory.PersistentMemoryRegion' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'memory.PersistentMemoryRegion' resource.
try {
     $Result = Set-IntersightMemoryPersistentMemoryRegion -Moid $Moid -MemoryPersistentMemoryRegion $MemoryPersistentMemoryRegion -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightMemoryPersistentMemoryRegion: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightMemoryPersistentMemoryUnit"></a>
# **Set-IntersightMemoryPersistentMemoryUnit**
> MemoryPersistentMemoryUnit Set-IntersightMemoryPersistentMemoryUnit<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryPersistentMemoryUnit] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$MemoryPersistentMemoryUnit = (Initialize-memory.PersistentMemoryUnit-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -AdminState "AdminState_example" -ArrayId 123 -Bank 123 -Capacity "Capacity_example" -Clock "Clock_example" -FormFactor "FormFactor_example" -Latency "Latency_example" -Location "Location_example" -OperPowerState "OperPowerState_example" -OperState "OperState_example" -Operability "Operability_example" -Presence "Presence_example" -Set 123 -Speed "Speed_example" -Thermal "Thermal_example" -Type "Type_example" -Visibility "Visibility_example" -Width "Width_example" -AppDirectCapacity "AppDirectCapacity_example" -CountStatus "CountStatus_example" -FirmwareVersion "FirmwareVersion_example" -FrozenStatus "FrozenStatus_example" -HealthState "HealthState_example" -LockStatus "LockStatus_example" -MemoryCapacity "MemoryCapacity_example" -MemoryId 123 -PersistentMemoryCapacity "PersistentMemoryCapacity_example" -ReservedCapacity "ReservedCapacity_example" -SecurityStatus "SecurityStatus_example" -SocketId "SocketId_example" -SocketMemoryId "SocketMemoryId_example" -TotalCapacity "TotalCapacity_example" -Uid "Uid_example" -InventoryDeviceInfo  -MemoryArray  -RegisteredDevice ) # MemoryPersistentMemoryUnit | The 'memory.PersistentMemoryUnit' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'memory.PersistentMemoryUnit' resource.
try {
     $Result = Set-IntersightMemoryPersistentMemoryUnit -Moid $Moid -MemoryPersistentMemoryUnit $MemoryPersistentMemoryUnit -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightMemoryPersistentMemoryUnit: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightMemoryUnit"></a>
# **Set-IntersightMemoryUnit**
> MemoryUnit Set-IntersightMemoryUnit<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryUnit] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$MemoryUnit = (Initialize-memory.Unit-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -AdminState "AdminState_example" -ArrayId 123 -Bank 123 -Capacity "Capacity_example" -Clock "Clock_example" -FormFactor "FormFactor_example" -Latency "Latency_example" -Location "Location_example" -OperPowerState "OperPowerState_example" -OperState "OperState_example" -Operability "Operability_example" -Presence "Presence_example" -Set 123 -Speed "Speed_example" -Thermal "Thermal_example" -Type "Type_example" -Visibility "Visibility_example" -Width "Width_example" -MemoryId 123 -InventoryDeviceInfo  -MemoryArray  -RegisteredDevice ) # MemoryUnit | The 'memory.Unit' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'memory.Unit' resource.
try {
     $Result = Set-IntersightMemoryUnit -Moid $Moid -MemoryUnit $MemoryUnit -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightMemoryUnit: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightMemoryArray"></a>
# **Update-IntersightMemoryArray**
> MemoryArray Update-IntersightMemoryArray<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryArray] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'memory.Array' resource.
try {
     $Result = Update-IntersightMemoryArray -Moid $Moid -MemoryArray $MemoryArray -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightMemoryArray: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightMemoryPersistentMemoryConfigResult"></a>
# **Update-IntersightMemoryPersistentMemoryConfigResult**
> MemoryPersistentMemoryConfigResult Update-IntersightMemoryPersistentMemoryConfigResult<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryPersistentMemoryConfigResult] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'memory.PersistentMemoryConfigResult' resource.
try {
     $Result = Update-IntersightMemoryPersistentMemoryConfigResult -Moid $Moid -MemoryPersistentMemoryConfigResult $MemoryPersistentMemoryConfigResult -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightMemoryPersistentMemoryConfigResult: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightMemoryPersistentMemoryConfiguration"></a>
# **Update-IntersightMemoryPersistentMemoryConfiguration**
> MemoryPersistentMemoryConfiguration Update-IntersightMemoryPersistentMemoryConfiguration<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryPersistentMemoryConfiguration] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'memory.PersistentMemoryConfiguration' resource.
try {
     $Result = Update-IntersightMemoryPersistentMemoryConfiguration -Moid $Moid -MemoryPersistentMemoryConfiguration $MemoryPersistentMemoryConfiguration -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightMemoryPersistentMemoryConfiguration: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightMemoryPersistentMemoryNamespace"></a>
# **Update-IntersightMemoryPersistentMemoryNamespace**
> MemoryPersistentMemoryNamespace Update-IntersightMemoryPersistentMemoryNamespace<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryPersistentMemoryNamespace] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'memory.PersistentMemoryNamespace' resource.
try {
     $Result = Update-IntersightMemoryPersistentMemoryNamespace -Moid $Moid -MemoryPersistentMemoryNamespace $MemoryPersistentMemoryNamespace -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightMemoryPersistentMemoryNamespace: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightMemoryPersistentMemoryNamespaceConfigResult"></a>
# **Update-IntersightMemoryPersistentMemoryNamespaceConfigResult**
> MemoryPersistentMemoryNamespaceConfigResult Update-IntersightMemoryPersistentMemoryNamespaceConfigResult<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryPersistentMemoryNamespaceConfigResult] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'memory.PersistentMemoryNamespaceConfigResult' resource.
try {
     $Result = Update-IntersightMemoryPersistentMemoryNamespaceConfigResult -Moid $Moid -MemoryPersistentMemoryNamespaceConfigResult $MemoryPersistentMemoryNamespaceConfigResult -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightMemoryPersistentMemoryNamespaceConfigResult: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightMemoryPersistentMemoryPolicy"></a>
# **Update-IntersightMemoryPersistentMemoryPolicy**
> MemoryPersistentMemoryPolicy Update-IntersightMemoryPersistentMemoryPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryPersistentMemoryPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'memory.PersistentMemoryPolicy' resource.
try {
     $Result = Update-IntersightMemoryPersistentMemoryPolicy -Moid $Moid -MemoryPersistentMemoryPolicy $MemoryPersistentMemoryPolicy -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightMemoryPersistentMemoryPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightMemoryPersistentMemoryRegion"></a>
# **Update-IntersightMemoryPersistentMemoryRegion**
> MemoryPersistentMemoryRegion Update-IntersightMemoryPersistentMemoryRegion<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryPersistentMemoryRegion] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'memory.PersistentMemoryRegion' resource.
try {
     $Result = Update-IntersightMemoryPersistentMemoryRegion -Moid $Moid -MemoryPersistentMemoryRegion $MemoryPersistentMemoryRegion -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightMemoryPersistentMemoryRegion: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightMemoryPersistentMemoryUnit"></a>
# **Update-IntersightMemoryPersistentMemoryUnit**
> MemoryPersistentMemoryUnit Update-IntersightMemoryPersistentMemoryUnit<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryPersistentMemoryUnit] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'memory.PersistentMemoryUnit' resource.
try {
     $Result = Update-IntersightMemoryPersistentMemoryUnit -Moid $Moid -MemoryPersistentMemoryUnit $MemoryPersistentMemoryUnit -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightMemoryPersistentMemoryUnit: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightMemoryUnit"></a>
# **Update-IntersightMemoryUnit**
> MemoryUnit Update-IntersightMemoryUnit<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MemoryUnit] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'memory.Unit' resource.
try {
     $Result = Update-IntersightMemoryUnit -Moid $Moid -MemoryUnit $MemoryUnit -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightMemoryUnit: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
