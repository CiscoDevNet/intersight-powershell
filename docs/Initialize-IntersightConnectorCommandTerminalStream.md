...
```yaml
Type: ConnectorCommandTerminalStream.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ConnectorCommandTerminalStream.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightConnectorCommandTerminalStream
```
