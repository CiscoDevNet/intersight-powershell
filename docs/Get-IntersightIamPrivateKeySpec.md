...
# Get-IntersightIamPrivateKeySpec

## SYNOPSIS
Get the IamPrivateKeySpec

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamPrivateKeySpec [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamPrivateKeySpec [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamPrivateKeySpec
```
Above example returns the list of IamPrivateKeySpec.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamPrivateKeySpec -Name "MoName"
```
Above example returns the IamPrivateKeySpec matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamPrivateKeySpec -Organization $organization
```
Above example returns the list of IamPrivateKeySpec available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamPrivateKeySpec -InlineCount allpages
```
Above example returns the list of IamPrivateKeySpec along with count.
...
### -Name
Specifies the name of the IamPrivateKeySpec.
...
### -Organization
Specifies the organization, to fetch the IamPrivateKeySpec under it.
