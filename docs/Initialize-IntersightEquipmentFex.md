...
Initialize-IntersightEquipmentFex [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< EquipmentFex.ClassIdEnum>][-ConnectionStatus< string>][-DiscoveryState< string>][-HostPorts< System.Collections.Generic.List`1[Model.EtherHostPortRelationship]>][-Moid< string>][-NetworkElement< Model.NetworkElementRelationship>][-NetworkPorts< System.Collections.Generic.List`1[Model.EtherNetworkPortRelationship]>][-ObjectType< EquipmentFex.ObjectTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> Initialize-IntersightEquipmentFex
```
