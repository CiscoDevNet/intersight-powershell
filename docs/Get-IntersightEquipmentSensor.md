...
# Get-IntersightEquipmentSensor

## SYNOPSIS
Get the EquipmentSensor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentSensor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentSensor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentSensor&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentSensor
```
Above example returns the list of EquipmentSensor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentSensor -Name "MoName"
```
Above example returns the EquipmentSensor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentSensor -Organization $organization
```
Above example returns the list of EquipmentSensor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentSensor -InlineCount allpages
```
Above example returns the list of EquipmentSensor along with count.
...
### -Name
Specifies the name of the EquipmentSensor.
...
### -Organization
Specifies the organization, to fetch the EquipmentSensor under it.
