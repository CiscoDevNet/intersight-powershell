...
# Initialize-IntersightSoftwarerepositoryAuthorization
...
Initialize-IntersightSoftwarerepositoryAuthorization [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< SoftwarerepositoryAuthorization.ClassIdEnum>][-Moid< string>][-ObjectType< SoftwarerepositoryAuthorization.ObjectTypeEnum>][-Password< string>][-RepositoryType< SoftwarerepositoryAuthorization.RepositoryTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-UserId< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: SoftwarerepositoryAuthorization.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: SoftwarerepositoryAuthorization.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightSoftwarerepositoryAuthorization
```
