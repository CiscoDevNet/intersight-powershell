...
Initialize-IntersightFirmwareHttpServer [-AdditionalProperties< Dictionary<string,object>>][-ClassId< FirmwareHttpServer.ClassIdEnum>][-LocationLink< string>][-MountOptions< string>][-ObjectType< FirmwareHttpServer.ObjectTypeEnum>]
