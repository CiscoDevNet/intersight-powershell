...
## SYNOPSIS
Get the ServerConfigResult

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightServerConfigResult [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightServerConfigResult [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightServerConfigResult
```
Above example returns the list of ServerConfigResult.

### Example 2
```powershell
PS C:\> $result = Get-IntersightServerConfigResult -Name "MoName"
```
Above example returns the ServerConfigResult matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightServerConfigResult -Organization $organization
```
Above example returns the list of ServerConfigResult available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightServerConfigResult -InlineCount allpages
```
Above example returns the list of ServerConfigResult along with count.
...
### -Name
Specifies the name of the ServerConfigResult.
...
### -Organization
Specifies the organization, to fetch the ServerConfigResult under it.
