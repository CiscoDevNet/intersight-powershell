...
# Get-IntersightStorageNvmeRaidConfiguration

## SYNOPSIS
Get the StorageNvmeRaidConfiguration

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNvmeRaidConfiguration [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNvmeRaidConfiguration [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNvmeRaidConfiguration&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNvmeRaidConfiguration
```
Above example returns the list of StorageNvmeRaidConfiguration.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNvmeRaidConfiguration -Name "MoName"
```
Above example returns the StorageNvmeRaidConfiguration matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNvmeRaidConfiguration -Organization $organization
```
Above example returns the list of StorageNvmeRaidConfiguration available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNvmeRaidConfiguration -InlineCount allpages
```
Above example returns the list of StorageNvmeRaidConfiguration along with count.
...
### -Name
Specifies the name of the StorageNvmeRaidConfiguration.
...
### -Organization
Specifies the organization, to fetch the StorageNvmeRaidConfiguration under it.
