...
# Initialize-IntersightVmediaPolicy
...
Initialize-IntersightVmediaPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< VmediaPolicy.ClassIdEnum>][-Description< string>][-Enabled< bool>][-Encryption< bool>][-LowPowerUsb< bool>][-Mappings< System.Collections.Generic.List`1[Model.VmediaMapping]>][-Moid< string>][-Name< string>][-ObjectType< VmediaPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Profiles< System.Collections.Generic.List`1[Model.PolicyAbstractConfigProfileRelationship]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
Note :- Use Initialize-IntersightVmediaMapping to create the object of complex type VmediaMapping

```yaml
Type: System.Collections.Generic.List`1[Model.VmediaMapping]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VmediaPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVmediaPolicy
```
