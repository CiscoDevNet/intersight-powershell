...
```powershell
$StoragePureProtectionGroupSnapshot = Initialize-IntersightStoragePureProtectionGroupSnapshot  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$StoragePureProtectionGroupSnapshot | ConvertTo-JSON
```
