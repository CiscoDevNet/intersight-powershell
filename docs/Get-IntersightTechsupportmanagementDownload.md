...
## SYNOPSIS
Get the TechsupportmanagementDownload

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightTechsupportmanagementDownload [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightTechsupportmanagementDownload [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;TechsupportmanagementDownload&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementDownload
```
Above example returns the list of TechsupportmanagementDownload.

### Example 2
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementDownload -Name "MoName"
```
Above example returns the TechsupportmanagementDownload matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementDownload -Organization $organization
```
Above example returns the list of TechsupportmanagementDownload available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementDownload -InlineCount allpages
```
Above example returns the list of TechsupportmanagementDownload along with count.
...
### -Name
Specifies the name of the TechsupportmanagementDownload.
...
### -Organization
Specifies the organization, to fetch the TechsupportmanagementDownload under it.
