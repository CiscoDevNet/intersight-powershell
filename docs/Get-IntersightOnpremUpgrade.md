...
# Get-IntersightOnpremUpgrade

## SYNOPSIS
Get the OnpremUpgrade

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOnpremUpgrade [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOnpremUpgrade [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;OnpremUpgrade&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOnpremUpgrade
```
Above example returns the list of OnpremUpgrade.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOnpremUpgrade -Name "MoName"
```
Above example returns the OnpremUpgrade matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOnpremUpgrade -Organization $organization
```
Above example returns the list of OnpremUpgrade available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOnpremUpgrade -InlineCount allpages
```
Above example returns the list of OnpremUpgrade along with count.
...
### -Name
Specifies the name of the OnpremUpgrade.
...
### -Organization
Specifies the organization, to fetch the OnpremUpgrade under it.
...
[Set-IntersightOnpremUpgrade](./Set-IntersightOnpremUpgrade.md)
