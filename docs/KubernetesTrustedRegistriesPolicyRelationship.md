...
```powershell
$KubernetesTrustedRegistriesPolicyRelationship = Initialize-IntersightKubernetesTrustedRegistriesPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$KubernetesTrustedRegistriesPolicyRelationship | ConvertTo-JSON
```
