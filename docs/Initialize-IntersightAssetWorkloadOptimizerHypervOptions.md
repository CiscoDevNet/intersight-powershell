...
Initialize-IntersightAssetWorkloadOptimizerHypervOptions [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< AssetWorkloadOptimizerHypervOptions.ClassIdEnum>][-DiscoverHostCluster< bool>][-FullDomainName< string>][-ObjectType< AssetWorkloadOptimizerHypervOptions.ObjectTypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
