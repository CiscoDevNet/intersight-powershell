...
# Get-IntersightSoftwareIksBundleDistributable

## SYNOPSIS
Get the SoftwareIksBundleDistributable

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwareIksBundleDistributable [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwareIksBundleDistributable [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SoftwareIksBundleDistributable&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwareIksBundleDistributable
```
Above example returns the list of SoftwareIksBundleDistributable.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwareIksBundleDistributable -Name "MoName"
```
Above example returns the SoftwareIksBundleDistributable matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwareIksBundleDistributable -Organization $organization
```
Above example returns the list of SoftwareIksBundleDistributable available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwareIksBundleDistributable -InlineCount allpages
```
Above example returns the list of SoftwareIksBundleDistributable along with count.
...
### -Name
Specifies the name of the SoftwareIksBundleDistributable.
...
### -Organization
Specifies the organization, to fetch the SoftwareIksBundleDistributable under it.
