...
```powershell
$IamLocalUserPasswordPolicyResponse = Initialize-IntersightIamLocalUserPasswordPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$IamLocalUserPasswordPolicyResponse | ConvertTo-JSON
```
