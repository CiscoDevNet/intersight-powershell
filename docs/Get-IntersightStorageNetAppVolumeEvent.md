...
## SYNOPSIS
Get the StorageNetAppVolumeEvent

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppVolumeEvent [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppVolumeEvent [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppVolumeEvent&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppVolumeEvent
```
Above example returns the list of StorageNetAppVolumeEvent.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppVolumeEvent -Name "MoName"
```
Above example returns the StorageNetAppVolumeEvent matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppVolumeEvent -Organization $organization
```
Above example returns the list of StorageNetAppVolumeEvent available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppVolumeEvent -InlineCount allpages
```
Above example returns the list of StorageNetAppVolumeEvent along with count.
...
### -Name
Specifies the name of the StorageNetAppVolumeEvent.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppVolumeEvent under it.
