...
## SYNOPSIS
Get the StorageVdMemberEp

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageVdMemberEp [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageVdMemberEp [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageVdMemberEp&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageVdMemberEp
```
Above example returns the list of StorageVdMemberEp.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageVdMemberEp -Name "MoName"
```
Above example returns the StorageVdMemberEp matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageVdMemberEp -Organization $organization
```
Above example returns the list of StorageVdMemberEp available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageVdMemberEp -InlineCount allpages
```
Above example returns the list of StorageVdMemberEp along with count.
...
### -Name
Specifies the name of the StorageVdMemberEp.
...
### -Organization
Specifies the organization, to fetch the StorageVdMemberEp under it.
...
[Set-IntersightStorageVdMemberEp](./Set-IntersightStorageVdMemberEp.md)
