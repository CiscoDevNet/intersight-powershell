...
### CmdletParam (Default)
```
Get-IntersightIamSystem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamSystem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamSystem&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamSystem
```
Above example returns the list of IamSystem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamSystem -Name "MoName"
```
Above example returns the IamSystem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamSystem -Organization $organization
```
Above example returns the list of IamSystem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamSystem -InlineCount allpages
```
Above example returns the list of IamSystem along with count.
...
### -Name
Specifies the name of the IamSystem.
...
### -Organization
Specifies the organization, to fetch the IamSystem under it.
