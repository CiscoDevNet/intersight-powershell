...
```powershell
$MemoryPersistentMemoryConfigResultRelationship = Initialize-IntersightMemoryPersistentMemoryConfigResultRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$MemoryPersistentMemoryConfigResultRelationship | ConvertTo-JSON
```
