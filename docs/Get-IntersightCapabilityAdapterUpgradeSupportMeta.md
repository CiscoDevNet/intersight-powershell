...
### CmdletParam (Default)
```
Get-IntersightCapabilityAdapterUpgradeSupportMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityAdapterUpgradeSupportMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterUpgradeSupportMeta
```
Above example returns the list of CapabilityAdapterUpgradeSupportMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterUpgradeSupportMeta -Name "MoName"
```
Above example returns the CapabilityAdapterUpgradeSupportMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterUpgradeSupportMeta -Organization $organization
```
Above example returns the list of CapabilityAdapterUpgradeSupportMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterUpgradeSupportMeta -InlineCount allpages
```
Above example returns the list of CapabilityAdapterUpgradeSupportMeta along with count.
...
### -Name
Specifies the name of the CapabilityAdapterUpgradeSupportMeta.
...
### -Organization
Specifies the organization, to fetch the CapabilityAdapterUpgradeSupportMeta under it.
