...
## SYNOPSIS
Get the HyperflexNodeProfile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexNodeProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexNodeProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexNodeProfile
```
Above example returns the list of HyperflexNodeProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexNodeProfile -Name "MoName"
```
Above example returns the HyperflexNodeProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexNodeProfile -Organization $organization
```
Above example returns the list of HyperflexNodeProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexNodeProfile -InlineCount allpages
```
Above example returns the list of HyperflexNodeProfile along with count.
...
### -Name
Specifies the name of the HyperflexNodeProfile.
...
### -Organization
Specifies the organization, to fetch the HyperflexNodeProfile under it.
