...
### CmdletParam (Default)
```
Get-IntersightEquipmentFanModule [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentFanModule [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentFanModule
```
Above example returns the list of EquipmentFanModule.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentFanModule -Name "MoName"
```
Above example returns the EquipmentFanModule matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentFanModule -Organization $organization
```
Above example returns the list of EquipmentFanModule available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentFanModule -InlineCount allpages
```
Above example returns the list of EquipmentFanModule along with count.
...
### -Name
Specifies the name of the EquipmentFanModule.
...
### -Organization
Specifies the organization, to fetch the EquipmentFanModule under it.
...
[Set-IntersightEquipmentFanModule](./Set-IntersightEquipmentFanModule.md)
