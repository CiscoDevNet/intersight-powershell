...
### CmdletParam (Default)
```
Get-IntersightNetworkVethernet [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkVethernet [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
