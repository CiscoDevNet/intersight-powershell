...
Initialize-IntersightCloudSkuVolumeType [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< CloudSkuVolumeType.ClassIdEnum>][-CustomAttributes< System.Collections.Generic.List`1[Model.CloudCustomAttributes]>][-Description< string>][-IopsUnit< string>][-IsActive< bool>][-IsAutoDiscovered< bool>][-IsBootable< bool>][-IsDefault< bool>][-IsProvisionedIops< bool>][-MaxIops< double>][-MaxReadIops< double>][-MaxReadThroughput< double>][-MaxThroughput< double>][-MaxVolumeSize< double>][-MaxWriteIops< double>][-MaxWriteThroughput< double>][-MinVolumeSize< double>][-Moid< string>][-Name< string>][-ObjectType< CloudSkuVolumeType.ObjectTypeEnum>][-PlatformType< CloudSkuVolumeType.PlatformTypeEnum>][-ServiceCategory< CloudSkuVolumeType.ServiceCategoryEnum>][-ServiceFamily< string>][-ServiceName< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Target< Model.AssetTargetRelationship>][-ThroughputUnit< string>][-Type< string>][-VolumeSizeUnit< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
