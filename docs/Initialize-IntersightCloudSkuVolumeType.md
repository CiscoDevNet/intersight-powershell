...
# Initialize-IntersightCloudSkuVolumeType
...
Initialize-IntersightCloudSkuVolumeType [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-BasePrice< float>][-ClassId< CloudSkuVolumeType.ClassIdEnum>][-Currency< CloudSkuVolumeType.CurrencyEnum>][-CustomAttributes< System.Collections.Generic.List`1[Model.CloudCustomAttributes]>][-Description< string>][-IopsUnit< string>][-IsActive< bool>][-IsAutoDiscovered< bool>][-IsBootable< bool>][-IsDefault< bool>][-IsProvisionedIops< bool>][-MaxIops< double>][-MaxReadIops< double>][-MaxReadThroughput< double>][-MaxThroughput< double>][-MaxVolumeSize< double>][-MaxWriteIops< double>][-MaxWriteThroughput< double>][-MinVolumeSize< double>][-Moid< string>][-Name< string>][-ObjectType< CloudSkuVolumeType.ObjectTypeEnum>][-PlatformType< CloudSkuVolumeType.PlatformTypeEnum>][-Region< Model.CloudRegionsRelationship>][-RegionId< string>][-ServiceCategory< CloudSkuVolumeType.ServiceCategoryEnum>][-ServiceFamily< string>][-ServiceName< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Target< Model.AssetTargetRelationship>][-ThroughputUnit< string>][-Type< string>][-Unit< string>][-VolumeSizeUnit< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: CloudSkuVolumeType.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CloudSkuVolumeType.CurrencyEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CloudSkuVolumeType.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CloudSkuVolumeType.ServiceCategoryEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCloudSkuVolumeType
```
