...
### CmdletParam (Default)
```
Get-IntersightHciGpu [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciGpu [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciGpu&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciGpu
```
Above example returns the list of HciGpu.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciGpu -Name "MoName"
```
Above example returns the HciGpu matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciGpu -Organization $organization
```
Above example returns the list of HciGpu available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciGpu -InlineCount allpages
```
Above example returns the list of HciGpu along with count.
...
### -Name
Specifies the name of the HciGpu.
...
### -Organization
Specifies the organization, to fetch the HciGpu under it.
