...
# Get-IntersightVnicEthVethInventory

## SYNOPSIS
Get the VnicEthVethInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicEthVethInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicEthVethInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicEthVethInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicEthVethInventory
```
Above example returns the list of VnicEthVethInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicEthVethInventory -Name "MoName"
```
Above example returns the VnicEthVethInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicEthVethInventory -Organization $organization
```
Above example returns the list of VnicEthVethInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicEthVethInventory -InlineCount allpages
```
Above example returns the list of VnicEthVethInventory along with count.
...
### -Name
Specifies the name of the VnicEthVethInventory.
...
### -Organization
Specifies the organization, to fetch the VnicEthVethInventory under it.
