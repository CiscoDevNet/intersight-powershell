...
## SYNOPSIS
Get the NiatelemetryNexusDashboardControllerDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryNexusDashboardControllerDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryNexusDashboardControllerDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryNexusDashboardControllerDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboardControllerDetails
```
Above example returns the list of NiatelemetryNexusDashboardControllerDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboardControllerDetails -Name "MoName"
```
Above example returns the NiatelemetryNexusDashboardControllerDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboardControllerDetails -Organization $organization
```
Above example returns the list of NiatelemetryNexusDashboardControllerDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusDashboardControllerDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryNexusDashboardControllerDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryNexusDashboardControllerDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryNexusDashboardControllerDetails under it.
