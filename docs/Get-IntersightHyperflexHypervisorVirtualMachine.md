...
## SYNOPSIS
Get the HyperflexHypervisorVirtualMachine

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHypervisorVirtualMachine [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHypervisorVirtualMachine [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHypervisorVirtualMachine&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHypervisorVirtualMachine
```
Above example returns the list of HyperflexHypervisorVirtualMachine.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHypervisorVirtualMachine -Name "MoName"
```
Above example returns the HyperflexHypervisorVirtualMachine matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHypervisorVirtualMachine -Organization $organization
```
Above example returns the list of HyperflexHypervisorVirtualMachine available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHypervisorVirtualMachine -InlineCount allpages
```
Above example returns the list of HyperflexHypervisorVirtualMachine along with count.
...
### -Name
Specifies the name of the HyperflexHypervisorVirtualMachine.
...
### -Organization
Specifies the organization, to fetch the HyperflexHypervisorVirtualMachine under it.
...
[Set-IntersightHyperflexHypervisorVirtualMachine](./Set-IntersightHyperflexHypervisorVirtualMachine.md)
