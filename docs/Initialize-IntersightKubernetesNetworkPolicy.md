...
# Initialize-IntersightKubernetesNetworkPolicy
...
Initialize-IntersightKubernetesNetworkPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< KubernetesNetworkPolicy.ClassIdEnum>][-ClusterProfiles< System.Collections.Generic.List`1[Model.KubernetesClusterProfileRelationship]>][-CniConfig< Model.KubernetesCniConfig>][-CniType< KubernetesNetworkPolicy.CniTypeEnum>][-Description< string>][-Moid< string>][-Name< string>][-ObjectType< KubernetesNetworkPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-PodNetworkCidr< string>][-ServiceCidr< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: KubernetesNetworkPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.KubernetesCniConfig
Parameter Sets: (All)
Aliases:
...
```yaml
Type: KubernetesNetworkPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightKubernetesNetworkPolicy
```
