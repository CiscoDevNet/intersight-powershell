...
# Get-IntersightHclDataImportLog

## SYNOPSIS
Get the HclDataImportLog

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHclDataImportLog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHclDataImportLog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HclDataImportLog&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHclDataImportLog
```
Above example returns the list of HclDataImportLog.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHclDataImportLog -Name "MoName"
```
Above example returns the HclDataImportLog matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHclDataImportLog -Organization $organization
```
Above example returns the list of HclDataImportLog available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHclDataImportLog -InlineCount allpages
```
Above example returns the list of HclDataImportLog along with count.
...
### -Name
Specifies the name of the HclDataImportLog.
...
### -Organization
Specifies the organization, to fetch the HclDataImportLog under it.
