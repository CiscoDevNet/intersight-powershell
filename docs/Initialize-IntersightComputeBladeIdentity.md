...
Initialize-IntersightComputeBladeIdentity [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AdminAction< ComputeBladeIdentity.AdminActionEnum>][-ClassId< ComputeBladeIdentity.ClassIdEnum>][-Identifier< long>][-Moid< string>][-ObjectType< ComputeBladeIdentity.ObjectTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
