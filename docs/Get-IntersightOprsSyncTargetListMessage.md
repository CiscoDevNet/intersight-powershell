...
## SYNOPSIS
Get the OprsSyncTargetListMessage

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOprsSyncTargetListMessage [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOprsSyncTargetListMessage [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOprsSyncTargetListMessage
```
Above example returns the list of OprsSyncTargetListMessage.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOprsSyncTargetListMessage -Name "MoName"
```
Above example returns the OprsSyncTargetListMessage matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOprsSyncTargetListMessage -Organization $organization
```
Above example returns the list of OprsSyncTargetListMessage available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOprsSyncTargetListMessage -InlineCount allpages
```
Above example returns the list of OprsSyncTargetListMessage along with count.
...
### -Name
Specifies the name of the OprsSyncTargetListMessage.
...
### -Organization
Specifies the organization, to fetch the OprsSyncTargetListMessage under it.
