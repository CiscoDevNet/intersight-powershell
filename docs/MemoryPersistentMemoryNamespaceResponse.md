...
```powershell
$MemoryPersistentMemoryNamespaceResponse = Initialize-IntersightMemoryPersistentMemoryNamespaceResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$MemoryPersistentMemoryNamespaceResponse | ConvertTo-JSON
```
