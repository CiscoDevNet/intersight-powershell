...
### CmdletParam (Default)
```
Get-IntersightCapabilityFexCapabilityDef [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityFexCapabilityDef [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityFexCapabilityDef
```
Above example returns the list of CapabilityFexCapabilityDef.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityFexCapabilityDef -Name "MoName"
```
Above example returns the CapabilityFexCapabilityDef matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityFexCapabilityDef -Organization $organization
```
Above example returns the list of CapabilityFexCapabilityDef available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityFexCapabilityDef -InlineCount allpages
```
Above example returns the list of CapabilityFexCapabilityDef along with count.
...
### -Name
Specifies the name of the CapabilityFexCapabilityDef.
...
### -Organization
Specifies the organization, to fetch the CapabilityFexCapabilityDef under it.
