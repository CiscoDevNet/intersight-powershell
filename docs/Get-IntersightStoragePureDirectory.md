...
# Get-IntersightStoragePureDirectory

## SYNOPSIS
Get the StoragePureDirectory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureDirectory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureDirectory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureDirectory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectory
```
Above example returns the list of StoragePureDirectory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectory -Name "MoName"
```
Above example returns the StoragePureDirectory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectory -Organization $organization
```
Above example returns the list of StoragePureDirectory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectory -InlineCount allpages
```
Above example returns the list of StoragePureDirectory along with count.
...
### -Name
Specifies the name of the StoragePureDirectory.
...
### -Organization
Specifies the organization, to fetch the StoragePureDirectory under it.
