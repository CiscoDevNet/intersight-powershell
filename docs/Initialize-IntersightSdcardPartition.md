...
Initialize-IntersightSdcardPartition [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< SdcardPartition.ClassIdEnum>][-ObjectType< SdcardPartition.ObjectTypeEnum>][-Type< SdcardPartition.TypeEnum>][-VirtualDrives< System.Collections.Generic.List`1[Model.SdcardVirtualDrive]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
