...
```powershell
$KubernetesVirtualMachineInstanceTypeResponse = Initialize-IntersightKubernetesVirtualMachineInstanceTypeResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$KubernetesVirtualMachineInstanceTypeResponse | ConvertTo-JSON
```
