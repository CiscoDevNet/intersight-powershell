...
## SYNOPSIS
Get the NiatelemetryTenant

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryTenant [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryTenant [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetryTenant&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryTenant
```
Above example returns the list of NiatelemetryTenant.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryTenant -Name "MoName"
```
Above example returns the NiatelemetryTenant matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryTenant -Organization $organization
```
Above example returns the list of NiatelemetryTenant available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryTenant -InlineCount allpages
```
Above example returns the list of NiatelemetryTenant along with count.
...
### -Name
Specifies the name of the NiatelemetryTenant.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryTenant under it.
