...
### CmdletParam (Default)
```
Get-IntersightCapabilityPsuManufacturingDef [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityPsuManufacturingDef [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityPsuManufacturingDef
```
Above example returns the list of CapabilityPsuManufacturingDef.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityPsuManufacturingDef -Name "MoName"
```
Above example returns the CapabilityPsuManufacturingDef matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityPsuManufacturingDef -Organization $organization
```
Above example returns the list of CapabilityPsuManufacturingDef available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityPsuManufacturingDef -InlineCount allpages
```
Above example returns the list of CapabilityPsuManufacturingDef along with count.
...
### -Name
Specifies the name of the CapabilityPsuManufacturingDef.
...
### -Organization
Specifies the organization, to fetch the CapabilityPsuManufacturingDef under it.
