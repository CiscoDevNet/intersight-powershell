...
New-IntersightOsTemplateFile [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Moid< string>][[-Name]< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-TemplateContent< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
