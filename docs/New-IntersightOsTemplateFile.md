...
New-IntersightOsTemplateFile [-AdditionalProperties< Dictionary<string,object>>][-Moid< string>][[-Name]< string>][-Placeholders< List<string>>][-Tags< List<MoTag>>][-TemplateContent< string>]
