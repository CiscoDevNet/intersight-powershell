...
New-IntersightOsTemplateFile [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Moid< string>][[-Name]< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-TemplateContent< string>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;OsTemplateFile&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightOsTemplateFile
```
