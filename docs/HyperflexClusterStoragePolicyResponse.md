...
```powershell
$HyperflexClusterStoragePolicyResponse = Initialize-IntersightHyperflexClusterStoragePolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexClusterStoragePolicyResponse | ConvertTo-JSON
```
