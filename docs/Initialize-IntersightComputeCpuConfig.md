...
```yaml
Type: ComputeCpuConfig.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
### -CpuId
Unique identifier for a CPU in the server.\n* `Any` - To map PCIe devices to any CPU.\n* `1` - Identifier used to map PCIe device to CPU-1.\n* `2` - Identifier used to map PCIe device to CPU-2.

```yaml
Type: ComputeCpuConfig.CpuIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ComputeCpuConfig.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ComputeCpuConfig.RootPcieEndpointTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightComputeCpuConfig
```
