...
New-IntersightFirmwareChassisUpgrade [-AdditionalProperties< Dictionary<string,object>>][-Chassis< EquipmentChassisRelationship>][-DirectDownload< FirmwareDirectDownload>][-Distributable< FirmwareDistributableRelationship>][-ExcludeComponentList< List<string>>][-FileServer< SoftwarerepositoryFileServer>][-Moid< string>][-NetworkShare< FirmwareNetworkShare>][-Release< SoftwarerepositoryReleaseRelationship>][-SkipEstimateImpact< bool>][-Status< FirmwareChassisUpgrade.StatusEnum>][-Tags< List<MoTag>>][-UpgradeType< FirmwareChassisUpgrade.UpgradeTypeEnum>]
