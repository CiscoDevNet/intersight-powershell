...
# Get-IntersightWorkloadDeploymentInput

## SYNOPSIS
Get the WorkloadDeploymentInput

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkloadDeploymentInput [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkloadDeploymentInput [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkloadDeploymentInput&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkloadDeploymentInput
```
Above example returns the list of WorkloadDeploymentInput.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkloadDeploymentInput -Name "MoName"
```
Above example returns the WorkloadDeploymentInput matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkloadDeploymentInput -Organization $organization
```
Above example returns the list of WorkloadDeploymentInput available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkloadDeploymentInput -InlineCount allpages
```
Above example returns the list of WorkloadDeploymentInput along with count.
...
### -Name
Specifies the name of the WorkloadDeploymentInput.
...
### -Organization
Specifies the organization, to fetch the WorkloadDeploymentInput under it.
