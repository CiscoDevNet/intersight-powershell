...
# Get-IntersightOnpremAuditRecord

## SYNOPSIS
Get the OnpremAuditRecord

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOnpremAuditRecord [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOnpremAuditRecord [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;OnpremAuditRecord&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOnpremAuditRecord
```
Above example returns the list of OnpremAuditRecord.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOnpremAuditRecord -Name "MoName"
```
Above example returns the OnpremAuditRecord matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOnpremAuditRecord -Organization $organization
```
Above example returns the list of OnpremAuditRecord available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOnpremAuditRecord -InlineCount allpages
```
Above example returns the list of OnpremAuditRecord along with count.
...
### -Name
Specifies the name of the OnpremAuditRecord.
...
### -Organization
Specifies the organization, to fetch the OnpremAuditRecord under it.
