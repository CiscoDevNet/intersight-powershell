...
## SYNOPSIS
Get the NiaapiDcnmFieldNotice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiDcnmFieldNotice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiDcnmFieldNotice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiaapiDcnmFieldNotice&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmFieldNotice
```
Above example returns the list of NiaapiDcnmFieldNotice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmFieldNotice -Name "MoName"
```
Above example returns the NiaapiDcnmFieldNotice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmFieldNotice -Organization $organization
```
Above example returns the list of NiaapiDcnmFieldNotice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmFieldNotice -InlineCount allpages
```
Above example returns the list of NiaapiDcnmFieldNotice along with count.
...
### -Name
Specifies the name of the NiaapiDcnmFieldNotice.
...
### -Organization
Specifies the organization, to fetch the NiaapiDcnmFieldNotice under it.
