...
# Get-IntersightApplianceMemoryUtilization

## SYNOPSIS
Get the ApplianceMemoryUtilization

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceMemoryUtilization [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceMemoryUtilization [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceMemoryUtilization&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceMemoryUtilization
```
Above example returns the list of ApplianceMemoryUtilization.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceMemoryUtilization -Name "MoName"
```
Above example returns the ApplianceMemoryUtilization matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceMemoryUtilization -Organization $organization
```
Above example returns the list of ApplianceMemoryUtilization available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceMemoryUtilization -InlineCount allpages
```
Above example returns the list of ApplianceMemoryUtilization along with count.
...
### -Name
Specifies the name of the ApplianceMemoryUtilization.
...
### -Organization
Specifies the organization, to fetch the ApplianceMemoryUtilization under it.
