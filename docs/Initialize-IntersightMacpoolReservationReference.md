...
# Initialize-IntersightMacpoolReservationReference
...
```yaml
Type: MacpoolReservationReference.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
### -ConsumerType
The consumer type for which the reserved MAC would be used.\n* `Vnic` - MAC reservation would be used by VNIC.

```yaml
Type: MacpoolReservationReference.ConsumerTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightMacpoolReservationReference
```
