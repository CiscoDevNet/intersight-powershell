...
# Get-IntersightOnpremUserPreference

## SYNOPSIS
Get the OnpremUserPreference

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOnpremUserPreference [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOnpremUserPreference [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;OnpremUserPreference&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOnpremUserPreference
```
Above example returns the list of OnpremUserPreference.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOnpremUserPreference -Name "MoName"
```
Above example returns the OnpremUserPreference matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOnpremUserPreference -Organization $organization
```
Above example returns the list of OnpremUserPreference available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOnpremUserPreference -InlineCount allpages
```
Above example returns the list of OnpremUserPreference along with count.
...
### -Name
Specifies the name of the OnpremUserPreference.
...
### -Organization
Specifies the organization, to fetch the OnpremUserPreference under it.
...
[Set-IntersightOnpremUserPreference](./Set-IntersightOnpremUserPreference.md)
