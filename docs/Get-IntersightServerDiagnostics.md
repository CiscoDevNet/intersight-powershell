...
# Get-IntersightServerDiagnostics
...
### CmdletParam (Default)
```
Get-IntersightServerDiagnostics [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightServerDiagnostics [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ServerDiagnostics&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightServerDiagnostics
```
Above example returns the list of ServerDiagnostics.

### Example 2
```powershell
PS C:\> $result = Get-IntersightServerDiagnostics -Name "MoName"
```
Above example returns the ServerDiagnostics matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightServerDiagnostics -Organization $organization
```
Above example returns the list of ServerDiagnostics available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightServerDiagnostics -InlineCount allpages
```
Above example returns the list of ServerDiagnostics along with count.
...
### -Name
Specifies the name of the ServerDiagnostics.
...
### -Organization
Specifies the organization, to fetch the ServerDiagnostics under it.
