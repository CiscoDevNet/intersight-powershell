...
## SYNOPSIS
Get the NetworkFcZoneInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkFcZoneInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkFcZoneInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NetworkFcZoneInfo&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkFcZoneInfo
```
Above example returns the list of NetworkFcZoneInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkFcZoneInfo -Name "MoName"
```
Above example returns the NetworkFcZoneInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkFcZoneInfo -Organization $organization
```
Above example returns the list of NetworkFcZoneInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkFcZoneInfo -InlineCount allpages
```
Above example returns the list of NetworkFcZoneInfo along with count.
...
### -Name
Specifies the name of the NetworkFcZoneInfo.
...
### -Organization
Specifies the organization, to fetch the NetworkFcZoneInfo under it.
...
[Set-IntersightNetworkFcZoneInfo](./Set-IntersightNetworkFcZoneInfo.md)
