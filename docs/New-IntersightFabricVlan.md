...
New-IntersightFabricVlan [-AdditionalProperties< Dictionary<string,object>>][-AutoAllowOnUplinks< bool>][-EthNetworkPolicy< FabricEthNetworkPolicyRelationship>][-IsNative< bool>][-Moid< string>][-MulticastPolicy< FabricMulticastPolicyRelationship>][[-Name]< string>][-Tags< List<MoTag>>][-VlanId< long>]
