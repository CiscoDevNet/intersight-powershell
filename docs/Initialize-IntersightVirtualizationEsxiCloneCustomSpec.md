...
```yaml
Type: VirtualizationEsxiCloneCustomSpec.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VirtualizationEsxiCloneCustomSpec.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVirtualizationEsxiCloneCustomSpec
```
