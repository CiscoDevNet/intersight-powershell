...
```powershell
$WorkflowWorkflowMetadataRelationship = Initialize-IntersightWorkflowWorkflowMetadataRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$WorkflowWorkflowMetadataRelationship | ConvertTo-JSON
```
