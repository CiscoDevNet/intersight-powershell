...
New-IntersightHyperflexClusterReplicationNetworkPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClusterProfiles< System.Collections.Generic.List`1[HyperflexClusterProfileRelationship]>][-Description< string>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-ReplicationBandwidthMbps< long>][-ReplicationIpranges< System.Collections.Generic.List`1[HyperflexIpAddrRange]>][-ReplicationMtu< long>][-ReplicationVlan< HyperflexNamedVlan>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;HyperflexClusterReplicationNetworkPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightHyperflexClusterReplicationNetworkPolicy
```
