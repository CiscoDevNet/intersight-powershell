...
Set-IntersightKubernetesTrustedRegistriesPolicy [-AdditionalProperties< Dictionary<string,object>>][-ClusterProfiles< List<KubernetesClusterProfileRelationship>>][-Description< string>][[-Moid]< string>][-Name< string>][-Organization< OrganizationOrganizationRelationship>][-RootCaRegistries< List<string>>][-Tags< List<MoTag>>][-UnsignedRegistries< List<string>>]
