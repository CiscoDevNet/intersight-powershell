...
### CmdletParam (Default)
```
Get-IntersightFirmwareNxosDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareNxosDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareNxosDescriptor&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareNxosDescriptor
```
Above example returns the list of FirmwareNxosDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareNxosDescriptor -Name "MoName"
```
Above example returns the FirmwareNxosDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareNxosDescriptor -Organization $organization
```
Above example returns the list of FirmwareNxosDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareNxosDescriptor -InlineCount allpages
```
Above example returns the list of FirmwareNxosDescriptor along with count.
...
### -Name
Specifies the name of the FirmwareNxosDescriptor.
...
### -Organization
Specifies the organization, to fetch the FirmwareNxosDescriptor under it.
