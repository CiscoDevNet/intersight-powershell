...
### CmdletParam (Default)
```
Get-IntersightDnacSite [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightDnacSite [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;DnacSite&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightDnacSite
```
Above example returns the list of DnacSite.

### Example 2
```powershell
PS C:\> $result = Get-IntersightDnacSite -Name "MoName"
```
Above example returns the DnacSite matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightDnacSite -Organization $organization
```
Above example returns the list of DnacSite available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightDnacSite -InlineCount allpages
```
Above example returns the list of DnacSite along with count.
...
### -Name
Specifies the name of the DnacSite.
...
### -Organization
Specifies the organization, to fetch the DnacSite under it.
