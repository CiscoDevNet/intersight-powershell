...
## SYNOPSIS
Get the RackUnitPersonality

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRackUnitPersonality [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRackUnitPersonality [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;RackUnitPersonality&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRackUnitPersonality
```
Above example returns the list of RackUnitPersonality.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRackUnitPersonality -Name "MoName"
```
Above example returns the RackUnitPersonality matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRackUnitPersonality -Organization $organization
```
Above example returns the list of RackUnitPersonality available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRackUnitPersonality -InlineCount allpages
```
Above example returns the list of RackUnitPersonality along with count.
...
### -Name
Specifies the name of the RackUnitPersonality.
...
### -Organization
Specifies the organization, to fetch the RackUnitPersonality under it.
...
[Set-IntersightRackUnitPersonality](./Set-IntersightRackUnitPersonality.md)
