...
# Initialize-IntersightHyperflexExtIscsiStoragePolicy
...
Initialize-IntersightHyperflexExtIscsiStoragePolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AdminState< bool>][-ClassId< HyperflexExtIscsiStoragePolicy.ClassIdEnum>][-ClusterProfiles< System.Collections.Generic.List`1[Model.HyperflexClusterProfileRelationship]>][-Description< string>][-ExtaTraffic< Model.HyperflexNamedVlan>][-ExtbTraffic< Model.HyperflexNamedVlan>][-Moid< string>][-Name< string>][-ObjectType< HyperflexExtIscsiStoragePolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: HyperflexExtIscsiStoragePolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: HyperflexExtIscsiStoragePolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightHyperflexExtIscsiStoragePolicy
```
