...
# Get-IntersightRecommendationPurchaseOrderEstimate

## SYNOPSIS
Get the RecommendationPurchaseOrderEstimate

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRecommendationPurchaseOrderEstimate [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRecommendationPurchaseOrderEstimate [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;RecommendationPurchaseOrderEstimate&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRecommendationPurchaseOrderEstimate
```
Above example returns the list of RecommendationPurchaseOrderEstimate.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRecommendationPurchaseOrderEstimate -Name "MoName"
```
Above example returns the RecommendationPurchaseOrderEstimate matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRecommendationPurchaseOrderEstimate -Organization $organization
```
Above example returns the list of RecommendationPurchaseOrderEstimate available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRecommendationPurchaseOrderEstimate -InlineCount allpages
```
Above example returns the list of RecommendationPurchaseOrderEstimate along with count.
...
### -Name
Specifies the name of the RecommendationPurchaseOrderEstimate.
...
### -Organization
Specifies the organization, to fetch the RecommendationPurchaseOrderEstimate under it.
...
[New-IntersightRecommendationPurchaseOrderEstimate](./New-IntersightRecommendationPurchaseOrderEstimate.md)

[Set-IntersightRecommendationPurchaseOrderEstimate](./Set-IntersightRecommendationPurchaseOrderEstimate.md)
