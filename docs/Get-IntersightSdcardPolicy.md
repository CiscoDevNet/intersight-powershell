...
# Get-IntersightSdcardPolicy

## SYNOPSIS
Get the SdcardPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSdcardPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSdcardPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;SdcardPolicy&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSdcardPolicy
```
Above example returns the list of SdcardPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSdcardPolicy -Name "MoName"
```
Above example returns the SdcardPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSdcardPolicy -Organization $organization
```
Above example returns the list of SdcardPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSdcardPolicy -InlineCount allpages
```
Above example returns the list of SdcardPolicy along with count.
...
### -Name
Specifies the name of the SdcardPolicy.
...
### -Organization
Specifies the organization, to fetch the SdcardPolicy under it.
