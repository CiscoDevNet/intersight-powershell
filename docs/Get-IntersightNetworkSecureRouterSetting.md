...
# Get-IntersightNetworkSecureRouterSetting

## SYNOPSIS
Get the NetworkSecureRouterSetting

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkSecureRouterSetting [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkSecureRouterSetting [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NetworkSecureRouterSetting&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkSecureRouterSetting
```
Above example returns the list of NetworkSecureRouterSetting.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkSecureRouterSetting -Name "MoName"
```
Above example returns the NetworkSecureRouterSetting matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkSecureRouterSetting -Organization $organization
```
Above example returns the list of NetworkSecureRouterSetting available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkSecureRouterSetting -InlineCount allpages
```
Above example returns the list of NetworkSecureRouterSetting along with count.
...
### -Name
Specifies the name of the NetworkSecureRouterSetting.
...
### -Organization
Specifies the organization, to fetch the NetworkSecureRouterSetting under it.
...
[Set-IntersightNetworkSecureRouterSetting](./Set-IntersightNetworkSecureRouterSetting.md)
