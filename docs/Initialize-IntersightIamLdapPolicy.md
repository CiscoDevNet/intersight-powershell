...
# Initialize-IntersightIamLdapPolicy
...
Initialize-IntersightIamLdapPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ApplianceAccount< Model.IamAccountRelationship>][-BaseProperties< Model.IamLdapBaseProperties>][-ClassId< IamLdapPolicy.ClassIdEnum>][-Description< string>][-DnsParameters< Model.IamLdapDnsParameters>][-EnableDns< bool>][-Enabled< bool>][-Groups< System.Collections.Generic.List`1[Model.IamLdapGroupRelationship]>][-Moid< string>][-Name< string>][-ObjectType< IamLdapPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Profiles< System.Collections.Generic.List`1[Model.PolicyAbstractConfigProfileRelationship]>][-Providers< System.Collections.Generic.List`1[Model.IamLdapProviderRelationship]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-UserSearchPrecedence< IamLdapPolicy.UserSearchPrecedenceEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: Model.IamLdapBaseProperties
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IamLdapPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.IamLdapDnsParameters
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.IamLdapGroupRelationship]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IamLdapPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.IamLdapProviderRelationship]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIamLdapPolicy
```
