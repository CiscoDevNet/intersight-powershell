...
## SYNOPSIS
Get the KubernetesAddonPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesAddonPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesAddonPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesAddonPolicy
```
Above example returns the list of KubernetesAddonPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesAddonPolicy -Name "MoName"
```
Above example returns the KubernetesAddonPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesAddonPolicy -Organization $organization
```
Above example returns the list of KubernetesAddonPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesAddonPolicy -InlineCount allpages
```
Above example returns the list of KubernetesAddonPolicy along with count.
...
### -Name
Specifies the name of the KubernetesAddonPolicy.
...
### -Organization
Specifies the organization, to fetch the KubernetesAddonPolicy under it.
