...
```powershell
$RecommendationPhysicalItemResponse = Initialize-IntersightRecommendationPhysicalItemResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$RecommendationPhysicalItemResponse | ConvertTo-JSON
```
