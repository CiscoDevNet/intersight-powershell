...
## SYNOPSIS
Get the NiatelemetryApicFexDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicFexDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicFexDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryApicFexDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicFexDetails
```
Above example returns the list of NiatelemetryApicFexDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicFexDetails -Name "MoName"
```
Above example returns the NiatelemetryApicFexDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicFexDetails -Organization $organization
```
Above example returns the list of NiatelemetryApicFexDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicFexDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryApicFexDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryApicFexDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicFexDetails under it.
