...
# Get-IntersightApicBridgeDomain

## SYNOPSIS
Get the ApicBridgeDomain

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApicBridgeDomain [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApicBridgeDomain [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApicBridgeDomain&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApicBridgeDomain
```
Above example returns the list of ApicBridgeDomain.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApicBridgeDomain -Name "MoName"
```
Above example returns the ApicBridgeDomain matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApicBridgeDomain -Organization $organization
```
Above example returns the list of ApicBridgeDomain available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApicBridgeDomain -InlineCount allpages
```
Above example returns the list of ApicBridgeDomain along with count.
...
### -Name
Specifies the name of the ApicBridgeDomain.
...
### -Organization
Specifies the organization, to fetch the ApicBridgeDomain under it.
