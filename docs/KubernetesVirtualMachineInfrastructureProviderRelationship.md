...
```powershell
$KubernetesVirtualMachineInfrastructureProviderRelationship = Initialize-IntersightKubernetesVirtualMachineInfrastructureProviderRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$KubernetesVirtualMachineInfrastructureProviderRelationship | ConvertTo-JSON
```
