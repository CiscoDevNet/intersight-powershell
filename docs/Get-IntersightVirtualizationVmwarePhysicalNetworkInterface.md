...
## SYNOPSIS
Get the VirtualizationVmwarePhysicalNetworkInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwarePhysicalNetworkInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwarePhysicalNetworkInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwarePhysicalNetworkInterface&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwarePhysicalNetworkInterface
```
Above example returns the list of VirtualizationVmwarePhysicalNetworkInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwarePhysicalNetworkInterface -Name "MoName"
```
Above example returns the VirtualizationVmwarePhysicalNetworkInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwarePhysicalNetworkInterface -Organization $organization
```
Above example returns the list of VirtualizationVmwarePhysicalNetworkInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwarePhysicalNetworkInterface -InlineCount allpages
```
Above example returns the list of VirtualizationVmwarePhysicalNetworkInterface along with count.
...
### -Name
Specifies the name of the VirtualizationVmwarePhysicalNetworkInterface.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwarePhysicalNetworkInterface under it.
...
[Set-IntersightVirtualizationVmwarePhysicalNetworkInterface](./Set-IntersightVirtualizationVmwarePhysicalNetworkInterface.md)
