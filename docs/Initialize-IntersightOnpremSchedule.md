...
Initialize-IntersightOnpremSchedule [-AdditionalProperties< Dictionary<string,object>>][-ClassId< OnpremSchedule.ClassIdEnum>][-DayOfMonth< long>][-DayOfWeek< long>][-MonthOfYear< long>][-ObjectType< OnpremSchedule.ObjectTypeEnum>][-RepeatInterval< long>][-TimeOfDay< long>][-TimeZone< OnpremSchedule.TimeZoneEnum>][-WeekOfMonth< long>]
...
```yaml
Type: OnpremSchedule.TimeZoneEnum
Parameter Sets: (All)
Aliases:
