...
```powershell
$TechsupportmanagementTechSupportBundleRelationship = Initialize-IntersightTechsupportmanagementTechSupportBundleRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$TechsupportmanagementTechSupportBundleRelationship | ConvertTo-JSON
```
