...
New-IntersightHyperflexSoftwareDistributionEntry [-AdditionalProperties< Dictionary<string,object>>][-AppCatalog< HyperflexAppCatalogRelationship>][-DistributionType< string>][-DistributionVersions< List<HyperflexSoftwareDistributionVersionRelationship>>][-Moid< string>][-Tags< List<MoTag>>]
