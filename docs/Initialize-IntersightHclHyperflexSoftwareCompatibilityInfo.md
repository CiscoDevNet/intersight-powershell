...
```yaml
Type: HclHyperflexSoftwareCompatibilityInfo.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: HclHyperflexSoftwareCompatibilityInfo.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightHclHyperflexSoftwareCompatibilityInfo
```
