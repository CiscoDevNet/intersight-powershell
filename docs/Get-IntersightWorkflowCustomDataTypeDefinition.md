...
## SYNOPSIS
Get the WorkflowCustomDataTypeDefinition

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowCustomDataTypeDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowCustomDataTypeDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;WorkflowCustomDataTypeDefinition&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowCustomDataTypeDefinition
```
Above example returns the list of WorkflowCustomDataTypeDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowCustomDataTypeDefinition -Name "MoName"
```
Above example returns the WorkflowCustomDataTypeDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowCustomDataTypeDefinition -Organization $organization
```
Above example returns the list of WorkflowCustomDataTypeDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowCustomDataTypeDefinition -InlineCount allpages
```
Above example returns the list of WorkflowCustomDataTypeDefinition along with count.
...
### -Name
Specifies the name of the WorkflowCustomDataTypeDefinition.
...
### -Organization
Specifies the organization, to fetch the WorkflowCustomDataTypeDefinition under it.
