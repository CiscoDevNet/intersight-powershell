...
Initialize-IntersightWorkflowAnsiblePlaySession [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Body< string>][-ClassId< WorkflowAnsiblePlaySession.ClassIdEnum>][-CommandLineArguments< string>][-ContentType< string>][-Description< string>][-ErrorContentType< string>][-HostInventory< string>][-Label< string>][-Name< string>][-ObjectType< WorkflowAnsiblePlaySession.ObjectTypeEnum>][-Outcomes< object>][-PlaybookPath< string>][-ResponseSpec< object>][-SkipOnCondition< string>][-SshOpTimeout< string>][-StartDelay< long>][-Timeout< long>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowAnsiblePlaySession.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowAnsiblePlaySession.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowAnsiblePlaySession
```
