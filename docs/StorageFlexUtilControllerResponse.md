...
```powershell
$StorageFlexUtilControllerResponse = Initialize-IntersightStorageFlexUtilControllerResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageFlexUtilControllerResponse | ConvertTo-JSON
```
