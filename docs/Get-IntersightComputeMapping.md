...
## SYNOPSIS
Get the ComputeMapping

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputeMapping [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputeMapping [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ComputeMapping&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputeMapping
```
Above example returns the list of ComputeMapping.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputeMapping -Name "MoName"
```
Above example returns the ComputeMapping matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputeMapping -Organization $organization
```
Above example returns the list of ComputeMapping available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputeMapping -InlineCount allpages
```
Above example returns the list of ComputeMapping along with count.
...
### -Name
Specifies the name of the ComputeMapping.
...
### -Organization
Specifies the organization, to fetch the ComputeMapping under it.
...
[Set-IntersightComputeMapping](./Set-IntersightComputeMapping.md)
