...
# Get-IntersightStoragePureFileSystems

## SYNOPSIS
Get the StoragePureFileSystems

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureFileSystems [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureFileSystems [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureFileSystems&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureFileSystems
```
Above example returns the list of StoragePureFileSystems.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureFileSystems -Name "MoName"
```
Above example returns the StoragePureFileSystems matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureFileSystems -Organization $organization
```
Above example returns the list of StoragePureFileSystems available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureFileSystems -InlineCount allpages
```
Above example returns the list of StoragePureFileSystems along with count.
...
### -Name
Specifies the name of the StoragePureFileSystems.
...
### -Organization
Specifies the organization, to fetch the StoragePureFileSystems under it.
