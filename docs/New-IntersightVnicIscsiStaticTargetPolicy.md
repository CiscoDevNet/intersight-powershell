...
New-IntersightVnicIscsiStaticTargetPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Description< string>][-IpAddress< string>][-Lun< VnicLun>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-Port< long>][-Tags< System.Collections.Generic.List`1[MoTag]>][-TargetName< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
