...
New-IntersightVnicIscsiStaticTargetPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Description< string>][-IpAddress< string>][-IscsiIpType< VnicIscsiStaticTargetPolicy.IscsiIpTypeEnum>][-Lun< VnicLun>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-Port< long>][-Tags< System.Collections.Generic.List`1[MoTag]>][-TargetName< string>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> New-IntersightVnicIscsiStaticTargetPolicy
```
