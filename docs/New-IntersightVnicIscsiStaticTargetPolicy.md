...
New-IntersightVnicIscsiStaticTargetPolicy [-AdditionalProperties< Dictionary<string,object>>][-Description< string>][-IpAddress< string>][-Lun< VnicLun>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-Port< long>][-Tags< List<MoTag>>][-TargetName< string>]
