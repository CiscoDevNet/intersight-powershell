...
## SYNOPSIS
Get the StorageFlexUtilPhysicalDrive

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageFlexUtilPhysicalDrive [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageFlexUtilPhysicalDrive [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageFlexUtilPhysicalDrive&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageFlexUtilPhysicalDrive
```
Above example returns the list of StorageFlexUtilPhysicalDrive.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageFlexUtilPhysicalDrive -Name "MoName"
```
Above example returns the StorageFlexUtilPhysicalDrive matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageFlexUtilPhysicalDrive -Organization $organization
```
Above example returns the list of StorageFlexUtilPhysicalDrive available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageFlexUtilPhysicalDrive -InlineCount allpages
```
Above example returns the list of StorageFlexUtilPhysicalDrive along with count.
...
### -Name
Specifies the name of the StorageFlexUtilPhysicalDrive.
...
### -Organization
Specifies the organization, to fetch the StorageFlexUtilPhysicalDrive under it.
...
[Set-IntersightStorageFlexUtilPhysicalDrive](./Set-IntersightStorageFlexUtilPhysicalDrive.md)
