...
```powershell
$VirtualizationVmwareDatacenterResponse = Initialize-IntersightVirtualizationVmwareDatacenterResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$VirtualizationVmwareDatacenterResponse | ConvertTo-JSON
```
