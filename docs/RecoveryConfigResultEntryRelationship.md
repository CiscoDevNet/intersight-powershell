...
```powershell
$RecoveryConfigResultEntryRelationship = Initialize-IntersightRecoveryConfigResultEntryRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$RecoveryConfigResultEntryRelationship | ConvertTo-JSON
```
