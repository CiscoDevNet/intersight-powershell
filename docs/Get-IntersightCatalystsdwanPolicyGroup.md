...
# Get-IntersightCatalystsdwanPolicyGroup

## SYNOPSIS
Get the CatalystsdwanPolicyGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCatalystsdwanPolicyGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCatalystsdwanPolicyGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CatalystsdwanPolicyGroup&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanPolicyGroup
```
Above example returns the list of CatalystsdwanPolicyGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanPolicyGroup -Name "MoName"
```
Above example returns the CatalystsdwanPolicyGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanPolicyGroup -Organization $organization
```
Above example returns the list of CatalystsdwanPolicyGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanPolicyGroup -InlineCount allpages
```
Above example returns the list of CatalystsdwanPolicyGroup along with count.
...
### -Name
Specifies the name of the CatalystsdwanPolicyGroup.
...
### -Organization
Specifies the organization, to fetch the CatalystsdwanPolicyGroup under it.
