...
# Get-IntersightNtpPolicyInventory

## SYNOPSIS
Get the NtpPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNtpPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNtpPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NtpPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNtpPolicyInventory
```
Above example returns the list of NtpPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNtpPolicyInventory -Name "MoName"
```
Above example returns the NtpPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNtpPolicyInventory -Organization $organization
```
Above example returns the list of NtpPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNtpPolicyInventory -InlineCount allpages
```
Above example returns the list of NtpPolicyInventory along with count.
...
### -Name
Specifies the name of the NtpPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the NtpPolicyInventory under it.
