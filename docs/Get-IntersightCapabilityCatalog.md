...
### CmdletParam (Default)
```
Get-IntersightCapabilityCatalog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityCatalog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityCatalog
```
Above example returns the list of CapabilityCatalog.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityCatalog -Name "MoName"
```
Above example returns the CapabilityCatalog matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityCatalog -Organization $organization
```
Above example returns the list of CapabilityCatalog available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityCatalog -InlineCount allpages
```
Above example returns the list of CapabilityCatalog along with count.
...
### -Name
Specifies the name of the CapabilityCatalog.
...
### -Organization
Specifies the organization, to fetch the CapabilityCatalog under it.
...
[Set-IntersightCapabilityCatalog](./Set-IntersightCapabilityCatalog.md)
