...
```yaml
Type: SyslogRemoteLoggingClient.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: SyslogRemoteLoggingClient.MinSeverityEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: SyslogRemoteLoggingClient.ProtocolEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightSyslogRemoteLoggingClient
```
