...
# Initialize-IntersightHyperflexKeyEncryptionKey
...
Initialize-IntersightHyperflexKeyEncryptionKey [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< HyperflexKeyEncryptionKey.ClassIdEnum>][-ClusterProfile< Model.HyperflexClusterProfileRelationship>][-IsAccountRecovery< bool>][-Iteration< long>][-Kek< string>][-KeyId< string>][-KeyState< HyperflexKeyEncryptionKey.KeyStateEnum>][-Moid< string>][-ObjectType< HyperflexKeyEncryptionKey.ObjectTypeEnum>][-Passphrase< string>][-ResourceMo< Model.MoBaseMoRelationship>][-ResourceType< HyperflexKeyEncryptionKey.ResourceTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TransitKek< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: HyperflexKeyEncryptionKey.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.HyperflexClusterProfileRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: HyperflexKeyEncryptionKey.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightHyperflexKeyEncryptionKey
```
