...
## SYNOPSIS
Get the FabricSwitchControlPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricSwitchControlPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricSwitchControlPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricSwitchControlPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricSwitchControlPolicy
```
Above example returns the list of FabricSwitchControlPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricSwitchControlPolicy -Name "MoName"
```
Above example returns the FabricSwitchControlPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricSwitchControlPolicy -Organization $organization
```
Above example returns the list of FabricSwitchControlPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricSwitchControlPolicy -InlineCount allpages
```
Above example returns the list of FabricSwitchControlPolicy along with count.
...
### -Name
Specifies the name of the FabricSwitchControlPolicy.
...
### -Organization
Specifies the organization, to fetch the FabricSwitchControlPolicy under it.
