...
```powershell
$WorkflowPendingDynamicWorkflowInfoResponse = Initialize-IntersightWorkflowPendingDynamicWorkflowInfoResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$WorkflowPendingDynamicWorkflowInfoResponse | ConvertTo-JSON
```
