...
```powershell
$CapabilitySwitchManufacturingDefResponse = Initialize-IntersightCapabilitySwitchManufacturingDefResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilitySwitchManufacturingDefResponse | ConvertTo-JSON
```
