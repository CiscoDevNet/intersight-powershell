...
## SYNOPSIS
Get the CloudSkuNetworkType

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudSkuNetworkType [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudSkuNetworkType [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CloudSkuNetworkType&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudSkuNetworkType
```
Above example returns the list of CloudSkuNetworkType.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudSkuNetworkType -Name "MoName"
```
Above example returns the CloudSkuNetworkType matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudSkuNetworkType -Organization $organization
```
Above example returns the list of CloudSkuNetworkType available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudSkuNetworkType -InlineCount allpages
```
Above example returns the list of CloudSkuNetworkType along with count.
...
### -Name
Specifies the name of the CloudSkuNetworkType.
...
### -Organization
Specifies the organization, to fetch the CloudSkuNetworkType under it.
