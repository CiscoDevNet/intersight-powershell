...
```powershell
$HyperflexDevicePackageDownloadStateResponse = Initialize-IntersightHyperflexDevicePackageDownloadStateResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexDevicePackageDownloadStateResponse | ConvertTo-JSON
```
