...
# Get-IntersightStorageNetAppCloudTarget

## SYNOPSIS
Get the StorageNetAppCloudTarget

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppCloudTarget [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppCloudTarget [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppCloudTarget&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCloudTarget
```
Above example returns the list of StorageNetAppCloudTarget.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCloudTarget -Name "MoName"
```
Above example returns the StorageNetAppCloudTarget matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCloudTarget -Organization $organization
```
Above example returns the list of StorageNetAppCloudTarget available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCloudTarget -InlineCount allpages
```
Above example returns the list of StorageNetAppCloudTarget along with count.
...
### -Name
Specifies the name of the StorageNetAppCloudTarget.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppCloudTarget under it.
