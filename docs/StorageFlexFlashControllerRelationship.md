...
```powershell
$StorageFlexFlashControllerRelationship = Initialize-IntersightStorageFlexFlashControllerRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StorageFlexFlashControllerRelationship | ConvertTo-JSON
```
