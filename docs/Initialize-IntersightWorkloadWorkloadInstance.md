...
# Initialize-IntersightWorkloadWorkloadInstance
...
Initialize-IntersightWorkloadWorkloadInstance [-Action< WorkloadWorkloadInstance.ActionEnum>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< WorkloadWorkloadInstance.ClassIdEnum>][-DeploymentInput< Model.WorkloadDeploymentInputRelationship>][-LastDeploymentInput< Model.WorkloadDeploymentInputRelationship>][-Moid< string>][-ObjectType< WorkloadWorkloadInstance.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-WorkloadDeployment< Model.WorkloadWorkloadDeploymentRelationship>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkloadWorkloadInstance.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.WorkloadDeploymentInputRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkloadWorkloadInstance.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.WorkloadWorkloadDeploymentRelationship
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkloadWorkloadInstance
```
