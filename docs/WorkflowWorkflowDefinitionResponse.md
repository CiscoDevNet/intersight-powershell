...
```powershell
$WorkflowWorkflowDefinitionResponse = Initialize-IntersightWorkflowWorkflowDefinitionResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$WorkflowWorkflowDefinitionResponse | ConvertTo-JSON
```
