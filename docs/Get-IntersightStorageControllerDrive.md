...
# Get-IntersightStorageControllerDrive

## SYNOPSIS
Get the StorageControllerDrive

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageControllerDrive [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageControllerDrive [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageControllerDrive&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageControllerDrive
```
Above example returns the list of StorageControllerDrive.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageControllerDrive -Name "MoName"
```
Above example returns the StorageControllerDrive matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageControllerDrive -Organization $organization
```
Above example returns the list of StorageControllerDrive available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageControllerDrive -InlineCount allpages
```
Above example returns the list of StorageControllerDrive along with count.
...
### -Name
Specifies the name of the StorageControllerDrive.
...
### -Organization
Specifies the organization, to fetch the StorageControllerDrive under it.
