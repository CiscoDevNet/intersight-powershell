...
```powershell
$ApplianceFileSystemStatusResponse = Initialize-IntersightApplianceFileSystemStatusResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$ApplianceFileSystemStatusResponse | ConvertTo-JSON
```
