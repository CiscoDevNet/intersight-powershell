...
## SYNOPSIS
Get the NiatelemetryMsoSchemaDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryMsoSchemaDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryMsoSchemaDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetryMsoSchemaDetails&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoSchemaDetails
```
Above example returns the list of NiatelemetryMsoSchemaDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoSchemaDetails -Name "MoName"
```
Above example returns the NiatelemetryMsoSchemaDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoSchemaDetails -Organization $organization
```
Above example returns the list of NiatelemetryMsoSchemaDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoSchemaDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryMsoSchemaDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryMsoSchemaDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryMsoSchemaDetails under it.
