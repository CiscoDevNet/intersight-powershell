...
# Get-IntersightStorageSasExpander

## SYNOPSIS
Get the StorageSasExpander

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageSasExpander [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageSasExpander [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageSasExpander&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageSasExpander
```
Above example returns the list of StorageSasExpander.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageSasExpander -Name "MoName"
```
Above example returns the StorageSasExpander matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageSasExpander -Organization $organization
```
Above example returns the list of StorageSasExpander available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageSasExpander -InlineCount allpages
```
Above example returns the list of StorageSasExpander along with count.
...
### -Name
Specifies the name of the StorageSasExpander.
...
### -Organization
Specifies the organization, to fetch the StorageSasExpander under it.
...
[Set-IntersightStorageSasExpander](./Set-IntersightStorageSasExpander.md)
