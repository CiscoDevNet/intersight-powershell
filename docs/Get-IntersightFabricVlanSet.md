...
# Get-IntersightFabricVlanSet

## SYNOPSIS
Get the FabricVlanSet

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricVlanSet [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricVlanSet [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricVlanSet&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricVlanSet
```
Above example returns the list of FabricVlanSet.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricVlanSet -Name "MoName"
```
Above example returns the FabricVlanSet matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricVlanSet -Organization $organization
```
Above example returns the list of FabricVlanSet available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricVlanSet -InlineCount allpages
```
Above example returns the list of FabricVlanSet along with count.
...
### -Name
Specifies the name of the FabricVlanSet.
...
### -Organization
Specifies the organization, to fetch the FabricVlanSet under it.
