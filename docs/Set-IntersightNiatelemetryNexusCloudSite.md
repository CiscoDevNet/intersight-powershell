...
Set-IntersightNiatelemetryNexusCloudSite [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Advisories< bool>][-Anomalies< bool>][-CapacityUtilization< bool>][-LicenseType< string>][[-Moid]< string>][-Name< string>][-SiteType< string>][-SoftwareManagement< bool>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Uuid< string>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
