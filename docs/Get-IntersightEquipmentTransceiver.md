...
# Get-IntersightEquipmentTransceiver

## SYNOPSIS
Get the EquipmentTransceiver

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentTransceiver [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentTransceiver [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;EquipmentTransceiver&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentTransceiver
```
Above example returns the list of EquipmentTransceiver.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentTransceiver -Name "MoName"
```
Above example returns the EquipmentTransceiver matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentTransceiver -Organization $organization
```
Above example returns the list of EquipmentTransceiver available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentTransceiver -InlineCount allpages
```
Above example returns the list of EquipmentTransceiver along with count.
...
### -Name
Specifies the name of the EquipmentTransceiver.
...
### -Organization
Specifies the organization, to fetch the EquipmentTransceiver under it.
...
[Set-IntersightEquipmentTransceiver](./Set-IntersightEquipmentTransceiver.md)
