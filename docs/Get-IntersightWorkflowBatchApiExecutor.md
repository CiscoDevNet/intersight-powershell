...
## SYNOPSIS
Get the WorkflowBatchApiExecutor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowBatchApiExecutor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowBatchApiExecutor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowBatchApiExecutor
```
Above example returns the list of WorkflowBatchApiExecutor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowBatchApiExecutor -Name "MoName"
```
Above example returns the WorkflowBatchApiExecutor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowBatchApiExecutor -Organization $organization
```
Above example returns the list of WorkflowBatchApiExecutor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowBatchApiExecutor -InlineCount allpages
```
Above example returns the list of WorkflowBatchApiExecutor along with count.
...
### -Name
Specifies the name of the WorkflowBatchApiExecutor.
...
### -Organization
Specifies the organization, to fetch the WorkflowBatchApiExecutor under it.
