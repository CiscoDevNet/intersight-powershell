...
# Get-IntersightVnicServiceEthIf

## SYNOPSIS
Get the VnicServiceEthIf

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicServiceEthIf [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicServiceEthIf [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicServiceEthIf&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicServiceEthIf
```
Above example returns the list of VnicServiceEthIf.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicServiceEthIf -Name "MoName"
```
Above example returns the VnicServiceEthIf matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicServiceEthIf -Organization $organization
```
Above example returns the list of VnicServiceEthIf available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicServiceEthIf -InlineCount allpages
```
Above example returns the list of VnicServiceEthIf along with count.
...
### -Name
Specifies the name of the VnicServiceEthIf.
...
### -Organization
Specifies the organization, to fetch the VnicServiceEthIf under it.
