...
# Get-IntersightHyperflexEncryption

## SYNOPSIS
Get the HyperflexEncryption

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexEncryption [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexEncryption [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexEncryption&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexEncryption
```
Above example returns the list of HyperflexEncryption.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexEncryption -Name "MoName"
```
Above example returns the HyperflexEncryption matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexEncryption -Organization $organization
```
Above example returns the list of HyperflexEncryption available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexEncryption -InlineCount allpages
```
Above example returns the list of HyperflexEncryption along with count.
...
### -Name
Specifies the name of the HyperflexEncryption.
...
### -Organization
Specifies the organization, to fetch the HyperflexEncryption under it.
