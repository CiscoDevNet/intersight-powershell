...
Initialize-IntersightConnectorStartStreamFromDevice [-AdditionalProperties< Dictionary<string,object>>][-ClassId< ConnectorStartStreamFromDevice.ClassIdEnum>][-EncryptedAesKey< string>][-EncryptionKey< string>][-MemberId< string>][-MemberStream< bool>][-ObjectType< ConnectorStartStreamFromDevice.ObjectTypeEnum>][-SecureProperties< object>][-StreamConfig< object>][-StreamName< string>][-StreamType< string>][-Topic< string>]
