...
Initialize-IntersightConnectorStartStreamFromDevice [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< ConnectorStartStreamFromDevice.ClassIdEnum>][-EncryptedAesKey< string>][-EncryptionKey< string>][-MemberId< string>][-MemberStream< bool>][-ObjectType< ConnectorStartStreamFromDevice.ObjectTypeEnum>][-SecureProperties< object>][-StreamConfig< object>][-StreamName< string>][-StreamType< string>][-Topic< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
