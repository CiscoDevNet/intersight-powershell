...
Initialize-IntersightConnectorStartStreamFromDevice [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< ConnectorStartStreamFromDevice.ClassIdEnum>][-EncryptedAesKey< string>][-EncryptionKey< string>][-ObjectType< ConnectorStartStreamFromDevice.ObjectTypeEnum>][-SecureProperties< object>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ConnectorStartStreamFromDevice.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ConnectorStartStreamFromDevice.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightConnectorStartStreamFromDevice
```
