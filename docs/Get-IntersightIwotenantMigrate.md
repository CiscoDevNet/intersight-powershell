...
# Get-IntersightIwotenantMigrate

## SYNOPSIS
Get the IwotenantMigrate

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIwotenantMigrate [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIwotenantMigrate [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IwotenantMigrate&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIwotenantMigrate
```
Above example returns the list of IwotenantMigrate.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIwotenantMigrate -Name "MoName"
```
Above example returns the IwotenantMigrate matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIwotenantMigrate -Organization $organization
```
Above example returns the list of IwotenantMigrate available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIwotenantMigrate -InlineCount allpages
```
Above example returns the list of IwotenantMigrate along with count.
...
### -Name
Specifies the name of the IwotenantMigrate.
...
### -Organization
Specifies the organization, to fetch the IwotenantMigrate under it.
