...
Initialize-IntersightIamEndPointPasswordProperties [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< IamEndPointPasswordProperties.ClassIdEnum>][-EnablePasswordExpiry< bool>][-EnforceStrongPassword< bool>][-ForceSendPassword< bool>][-GracePeriod< long>][-NotificationPeriod< long>][-ObjectType< IamEndPointPasswordProperties.ObjectTypeEnum>][-PasswordExpiryDuration< long>][-PasswordHistory< long>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: IamEndPointPasswordProperties.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IamEndPointPasswordProperties.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIamEndPointPasswordProperties
```
