...
```powershell
$ResourceLicenseResourceCountResponse = Initialize-IntersightResourceLicenseResourceCountResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$ResourceLicenseResourceCountResponse | ConvertTo-JSON
```
