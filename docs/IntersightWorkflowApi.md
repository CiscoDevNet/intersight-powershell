# Intersight.Intersight/Api.IntersightWorkflowApi
...
[**Get-IntersightWorkflowCustomDataTypeDefinitionByMoid**](IntersightWorkflowApi.md#Get-IntersightWorkflowCustomDataTypeDefinitionByMoid) | **GET** /api/v1/workflow/CustomDataTypeDefinitions/{Moid} | Read a &#39;workflow.CustomDataTypeDefinition&#39; resource.
...
[**Set-IntersightWorkflowWorkflowInfo**](IntersightWorkflowApi.md#Set-IntersightWorkflowWorkflowInfo) | **PATCH** /api/v1/workflow/WorkflowInfos/{Moid} | Update a &#39;workflow.WorkflowInfo&#39; resource.
...
<a name="Remove-IntersightWorkflowBatchApiExecutor"></a>
# **Remove-IntersightWorkflowBatchApiExecutor**
> void Remove-IntersightWorkflowBatchApiExecutor<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'workflow.BatchApiExecutor' resource.
try {
    Remove-IntersightWorkflowBatchApiExecutor -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightWorkflowBatchApiExecutor: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Remove-IntersightWorkflowCustomDataTypeDefinition"></a>
# **Remove-IntersightWorkflowCustomDataTypeDefinition**
> void Remove-IntersightWorkflowCustomDataTypeDefinition<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'workflow.CustomDataTypeDefinition' resource.
try {
    Remove-IntersightWorkflowCustomDataTypeDefinition -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightWorkflowCustomDataTypeDefinition: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Remove-IntersightWorkflowErrorResponseHandler"></a>
# **Remove-IntersightWorkflowErrorResponseHandler**
> void Remove-IntersightWorkflowErrorResponseHandler<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'workflow.ErrorResponseHandler' resource.
try {
    Remove-IntersightWorkflowErrorResponseHandler -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightWorkflowErrorResponseHandler: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Remove-IntersightWorkflowTaskDefinition"></a>
# **Remove-IntersightWorkflowTaskDefinition**
> void Remove-IntersightWorkflowTaskDefinition<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'workflow.TaskDefinition' resource.
try {
    Remove-IntersightWorkflowTaskDefinition -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightWorkflowTaskDefinition: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Remove-IntersightWorkflowWorkflowDefinition"></a>
# **Remove-IntersightWorkflowWorkflowDefinition**
> void Remove-IntersightWorkflowWorkflowDefinition<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'workflow.WorkflowDefinition' resource.
try {
    Remove-IntersightWorkflowWorkflowDefinition -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightWorkflowWorkflowDefinition: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Remove-IntersightWorkflowWorkflowInfo"></a>
# **Remove-IntersightWorkflowWorkflowInfo**
> void Remove-IntersightWorkflowWorkflowInfo<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'workflow.WorkflowInfo' resource.
try {
    Remove-IntersightWorkflowWorkflowInfo -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightWorkflowWorkflowInfo: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowBatchApiExecutorByMoid"></a>
# **Get-IntersightWorkflowBatchApiExecutorByMoid**
> WorkflowBatchApiExecutor Get-IntersightWorkflowBatchApiExecutorByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'workflow.BatchApiExecutor' resource.
try {
    WorkflowBatchApiExecutor $Result = Get-IntersightWorkflowBatchApiExecutorByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowBatchApiExecutorByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowBatchApiExecutorList"></a>
# **Get-IntersightWorkflowBatchApiExecutorList**
> WorkflowBatchApiExecutorResponse Get-IntersightWorkflowBatchApiExecutorList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'workflow.BatchApiExecutor' resource.
try {
    WorkflowBatchApiExecutorResponse $Result = Get-IntersightWorkflowBatchApiExecutorList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowBatchApiExecutorList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowBuildTaskMetaByMoid"></a>
# **Get-IntersightWorkflowBuildTaskMetaByMoid**
> WorkflowBuildTaskMeta Get-IntersightWorkflowBuildTaskMetaByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'workflow.BuildTaskMeta' resource.
try {
    WorkflowBuildTaskMeta $Result = Get-IntersightWorkflowBuildTaskMetaByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowBuildTaskMetaByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowBuildTaskMetaList"></a>
# **Get-IntersightWorkflowBuildTaskMetaList**
> WorkflowBuildTaskMetaResponse Get-IntersightWorkflowBuildTaskMetaList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'workflow.BuildTaskMeta' resource.
try {
    WorkflowBuildTaskMetaResponse $Result = Get-IntersightWorkflowBuildTaskMetaList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowBuildTaskMetaList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowBuildTaskMetaOwnerByMoid"></a>
# **Get-IntersightWorkflowBuildTaskMetaOwnerByMoid**
> WorkflowBuildTaskMetaOwner Get-IntersightWorkflowBuildTaskMetaOwnerByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'workflow.BuildTaskMetaOwner' resource.
try {
    WorkflowBuildTaskMetaOwner $Result = Get-IntersightWorkflowBuildTaskMetaOwnerByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowBuildTaskMetaOwnerByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowBuildTaskMetaOwnerList"></a>
# **Get-IntersightWorkflowBuildTaskMetaOwnerList**
> WorkflowBuildTaskMetaOwnerResponse Get-IntersightWorkflowBuildTaskMetaOwnerList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'workflow.BuildTaskMetaOwner' resource.
try {
    WorkflowBuildTaskMetaOwnerResponse $Result = Get-IntersightWorkflowBuildTaskMetaOwnerList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowBuildTaskMetaOwnerList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowCatalogByMoid"></a>
# **Get-IntersightWorkflowCatalogByMoid**
> WorkflowCatalog Get-IntersightWorkflowCatalogByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'workflow.Catalog' resource.
try {
    WorkflowCatalog $Result = Get-IntersightWorkflowCatalogByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowCatalogByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowCatalogList"></a>
# **Get-IntersightWorkflowCatalogList**
> WorkflowCatalogResponse Get-IntersightWorkflowCatalogList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'workflow.Catalog' resource.
try {
    WorkflowCatalogResponse $Result = Get-IntersightWorkflowCatalogList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowCatalogList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowCustomDataTypeDefinitionByMoid"></a>
# **Get-IntersightWorkflowCustomDataTypeDefinitionByMoid**
> WorkflowCustomDataTypeDefinition Get-IntersightWorkflowCustomDataTypeDefinitionByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'workflow.CustomDataTypeDefinition' resource.
try {
    WorkflowCustomDataTypeDefinition $Result = Get-IntersightWorkflowCustomDataTypeDefinitionByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowCustomDataTypeDefinitionByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowCustomDataTypeDefinitionList"></a>
# **Get-IntersightWorkflowCustomDataTypeDefinitionList**
> WorkflowCustomDataTypeDefinitionResponse Get-IntersightWorkflowCustomDataTypeDefinitionList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'workflow.CustomDataTypeDefinition' resource.
try {
    WorkflowCustomDataTypeDefinitionResponse $Result = Get-IntersightWorkflowCustomDataTypeDefinitionList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowCustomDataTypeDefinitionList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowErrorResponseHandlerByMoid"></a>
# **Get-IntersightWorkflowErrorResponseHandlerByMoid**
> WorkflowErrorResponseHandler Get-IntersightWorkflowErrorResponseHandlerByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'workflow.ErrorResponseHandler' resource.
try {
    WorkflowErrorResponseHandler $Result = Get-IntersightWorkflowErrorResponseHandlerByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowErrorResponseHandlerByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowErrorResponseHandlerList"></a>
# **Get-IntersightWorkflowErrorResponseHandlerList**
> WorkflowErrorResponseHandlerResponse Get-IntersightWorkflowErrorResponseHandlerList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'workflow.ErrorResponseHandler' resource.
try {
    WorkflowErrorResponseHandlerResponse $Result = Get-IntersightWorkflowErrorResponseHandlerList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowErrorResponseHandlerList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowPendingDynamicWorkflowInfoByMoid"></a>
# **Get-IntersightWorkflowPendingDynamicWorkflowInfoByMoid**
> WorkflowPendingDynamicWorkflowInfo Get-IntersightWorkflowPendingDynamicWorkflowInfoByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'workflow.PendingDynamicWorkflowInfo' resource.
try {
    WorkflowPendingDynamicWorkflowInfo $Result = Get-IntersightWorkflowPendingDynamicWorkflowInfoByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowPendingDynamicWorkflowInfoByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowPendingDynamicWorkflowInfoList"></a>
# **Get-IntersightWorkflowPendingDynamicWorkflowInfoList**
> WorkflowPendingDynamicWorkflowInfoResponse Get-IntersightWorkflowPendingDynamicWorkflowInfoList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'workflow.PendingDynamicWorkflowInfo' resource.
try {
    WorkflowPendingDynamicWorkflowInfoResponse $Result = Get-IntersightWorkflowPendingDynamicWorkflowInfoList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowPendingDynamicWorkflowInfoList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowTaskDefinitionByMoid"></a>
# **Get-IntersightWorkflowTaskDefinitionByMoid**
> WorkflowTaskDefinition Get-IntersightWorkflowTaskDefinitionByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'workflow.TaskDefinition' resource.
try {
    WorkflowTaskDefinition $Result = Get-IntersightWorkflowTaskDefinitionByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowTaskDefinitionByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowTaskDefinitionList"></a>
# **Get-IntersightWorkflowTaskDefinitionList**
> WorkflowTaskDefinitionResponse Get-IntersightWorkflowTaskDefinitionList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'workflow.TaskDefinition' resource.
try {
    WorkflowTaskDefinitionResponse $Result = Get-IntersightWorkflowTaskDefinitionList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowTaskDefinitionList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowTaskInfoByMoid"></a>
# **Get-IntersightWorkflowTaskInfoByMoid**
> WorkflowTaskInfo Get-IntersightWorkflowTaskInfoByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'workflow.TaskInfo' resource.
try {
    WorkflowTaskInfo $Result = Get-IntersightWorkflowTaskInfoByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowTaskInfoByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowTaskInfoList"></a>
# **Get-IntersightWorkflowTaskInfoList**
> WorkflowTaskInfoResponse Get-IntersightWorkflowTaskInfoList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'workflow.TaskInfo' resource.
try {
    WorkflowTaskInfoResponse $Result = Get-IntersightWorkflowTaskInfoList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowTaskInfoList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowWorkflowDefinitionByMoid"></a>
# **Get-IntersightWorkflowWorkflowDefinitionByMoid**
> WorkflowWorkflowDefinition Get-IntersightWorkflowWorkflowDefinitionByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'workflow.WorkflowDefinition' resource.
try {
    WorkflowWorkflowDefinition $Result = Get-IntersightWorkflowWorkflowDefinitionByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowWorkflowDefinitionByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowWorkflowDefinitionList"></a>
# **Get-IntersightWorkflowWorkflowDefinitionList**
> WorkflowWorkflowDefinitionResponse Get-IntersightWorkflowWorkflowDefinitionList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'workflow.WorkflowDefinition' resource.
try {
    WorkflowWorkflowDefinitionResponse $Result = Get-IntersightWorkflowWorkflowDefinitionList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowWorkflowDefinitionList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowWorkflowInfoByMoid"></a>
# **Get-IntersightWorkflowWorkflowInfoByMoid**
> WorkflowWorkflowInfo Get-IntersightWorkflowWorkflowInfoByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'workflow.WorkflowInfo' resource.
try {
    WorkflowWorkflowInfo $Result = Get-IntersightWorkflowWorkflowInfoByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowWorkflowInfoByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowWorkflowInfoList"></a>
# **Get-IntersightWorkflowWorkflowInfoList**
> WorkflowWorkflowInfoResponse Get-IntersightWorkflowWorkflowInfoList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'workflow.WorkflowInfo' resource.
try {
    WorkflowWorkflowInfoResponse $Result = Get-IntersightWorkflowWorkflowInfoList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowWorkflowInfoList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowWorkflowMetaByMoid"></a>
# **Get-IntersightWorkflowWorkflowMetaByMoid**
> WorkflowWorkflowMeta Get-IntersightWorkflowWorkflowMetaByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'workflow.WorkflowMeta' resource.
try {
    WorkflowWorkflowMeta $Result = Get-IntersightWorkflowWorkflowMetaByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowWorkflowMetaByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowWorkflowMetaList"></a>
# **Get-IntersightWorkflowWorkflowMetaList**
> WorkflowWorkflowMetaResponse Get-IntersightWorkflowWorkflowMetaList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'workflow.WorkflowMeta' resource.
try {
    WorkflowWorkflowMetaResponse $Result = Get-IntersightWorkflowWorkflowMetaList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowWorkflowMetaList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightWorkflowBatchApiExecutor"></a>
# **Set-IntersightWorkflowBatchApiExecutor**
> WorkflowBatchApiExecutor Set-IntersightWorkflowBatchApiExecutor<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowBatchApiExecutor] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$WorkflowBatchApiExecutor = (Initialize-workflow.BatchApiExecutor-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Batch @((Initialize-workflow.Api-ClassId "ClassId_example" -ObjectType "ObjectType_example" -Body "Body_example" -ContentType "ContentType_example" -Name "Name_example" -Outcomes "TODO" -ResponseSpec (Initialize-content.Grammar-ClassId "ClassId_example" -ObjectType "ObjectType_example" -ErrorParameters @() -Parameters @() -Types @()) -SkipOnCondition "SkipOnCondition_example" -StartDelay 123 -Timeout 123)) -Constraints  -Description "Description_example" -Name "Name_example" -Outcomes "TODO" -Output "TODO" -RetryFromFailedApi $false -SkipOnCondition "SkipOnCondition_example" -ErrorResponseHandler (Initialize-workflow.ErrorResponseHandler.Relationship-ClassId "ClassId_example" -ObjectType "ObjectType_example" -Moid "Moid_example" -Selector "Selector_example" -Link "Link_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -Parameters @() -PlatformType "PlatformType_example" -Types @() -Catalog ) -TaskDefinition ) # WorkflowBatchApiExecutor | The 'workflow.BatchApiExecutor' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'workflow.BatchApiExecutor' resource.
try {
    WorkflowBatchApiExecutor $Result = Set-IntersightWorkflowBatchApiExecutor -Moid $Moid -WorkflowBatchApiExecutor $WorkflowBatchApiExecutor -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightWorkflowBatchApiExecutor: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightWorkflowCustomDataTypeDefinition"></a>
# **Set-IntersightWorkflowCustomDataTypeDefinition**
> WorkflowCustomDataTypeDefinition Set-IntersightWorkflowCustomDataTypeDefinition<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowCustomDataTypeDefinition] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$WorkflowCustomDataTypeDefinition = (Initialize-workflow.CustomDataTypeDefinition-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -CompositeType $false -Description "Description_example" -Label "Label_example" -Name "Name_example" -TypeDefinition @() -Catalog ) # WorkflowCustomDataTypeDefinition | The 'workflow.CustomDataTypeDefinition' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'workflow.CustomDataTypeDefinition' resource.
try {
    WorkflowCustomDataTypeDefinition $Result = Set-IntersightWorkflowCustomDataTypeDefinition -Moid $Moid -WorkflowCustomDataTypeDefinition $WorkflowCustomDataTypeDefinition -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightWorkflowCustomDataTypeDefinition: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightWorkflowErrorResponseHandler"></a>
# **Set-IntersightWorkflowErrorResponseHandler**
> WorkflowErrorResponseHandler Set-IntersightWorkflowErrorResponseHandler<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowErrorResponseHandler] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$WorkflowErrorResponseHandler = (Initialize-workflow.ErrorResponseHandler-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -Parameters @() -PlatformType "PlatformType_example" -Types @() -Catalog ) # WorkflowErrorResponseHandler | The 'workflow.ErrorResponseHandler' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'workflow.ErrorResponseHandler' resource.
try {
    WorkflowErrorResponseHandler $Result = Set-IntersightWorkflowErrorResponseHandler -Moid $Moid -WorkflowErrorResponseHandler $WorkflowErrorResponseHandler -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightWorkflowErrorResponseHandler: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightWorkflowTaskDefinition"></a>
# **Set-IntersightWorkflowTaskDefinition**
> WorkflowTaskDefinition Set-IntersightWorkflowTaskDefinition<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowTaskDefinition] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$WorkflowTaskDefinition = (Initialize-workflow.TaskDefinition-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DefaultVersion $false -Description "Description_example" -InternalProperties  -Label "Label_example" -LicenseEntitlement "LicenseEntitlement_example" -Name "Name_example" -Properties  -SecurePropAccess $false -Version 123 -Catalog  -ImplementedTasks @() -InterfaceTask ) # WorkflowTaskDefinition | The 'workflow.TaskDefinition' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'workflow.TaskDefinition' resource.
try {
    WorkflowTaskDefinition $Result = Set-IntersightWorkflowTaskDefinition -Moid $Moid -WorkflowTaskDefinition $WorkflowTaskDefinition -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightWorkflowTaskDefinition: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightWorkflowTaskInfo"></a>
# **Set-IntersightWorkflowTaskInfo**
> WorkflowTaskInfo Set-IntersightWorkflowTaskInfo<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowTaskInfo] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$WorkflowTaskInfo = (Initialize-workflow.TaskInfo-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -EndTime Get-Date -FailureReason "FailureReason_example" -VarInput "TODO" -InstId "InstId_example" -Internal $false -Label "Label_example" -Message @() -Name "Name_example" -Output "TODO" -RefName "RefName_example" -RetryCount 123 -RunningInstId "RunningInstId_example" -StartTime Get-Date -Status "Status_example" -TaskInstIdList @() -SubWorkflowInfo  -TaskDefinition  -WorkflowInfo ) # WorkflowTaskInfo | The 'workflow.TaskInfo' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'workflow.TaskInfo' resource.
try {
    WorkflowTaskInfo $Result = Set-IntersightWorkflowTaskInfo -Moid $Moid -WorkflowTaskInfo $WorkflowTaskInfo -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightWorkflowTaskInfo: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightWorkflowWorkflowDefinition"></a>
# **Set-IntersightWorkflowWorkflowDefinition**
> WorkflowWorkflowDefinition Set-IntersightWorkflowWorkflowDefinition<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowWorkflowDefinition] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$WorkflowWorkflowDefinition = (Initialize-workflow.WorkflowDefinition-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DefaultVersion $false -Description "Description_example" -InputDefinition @() -Label "Label_example" -LicenseEntitlement "LicenseEntitlement_example" -MaxTaskCount 123 -Name "Name_example" -OutputDefinition @() -OutputParameters "TODO" -Properties  -Tasks @() -UiRenderingData "TODO" -ValidationInformation  -Version 123 -Catalog ) # WorkflowWorkflowDefinition | The 'workflow.WorkflowDefinition' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'workflow.WorkflowDefinition' resource.
try {
    WorkflowWorkflowDefinition $Result = Set-IntersightWorkflowWorkflowDefinition -Moid $Moid -WorkflowWorkflowDefinition $WorkflowWorkflowDefinition -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightWorkflowWorkflowDefinition: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightWorkflowWorkflowInfo"></a>
# **Set-IntersightWorkflowWorkflowInfo**
> WorkflowWorkflowInfo Set-IntersightWorkflowWorkflowInfo<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowWorkflowInfo] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$WorkflowWorkflowInfo = (Initialize-workflow.WorkflowInfo-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Action "Action_example" -CleanupTime Get-Date -EndTime Get-Date -FailedWorkflowCleanupDuration 123 -VarInput "TODO" -InstId "InstId_example" -Internal $false -LastAction "LastAction_example" -Message @() -MetaVersion 123 -Name "Name_example" -Output "TODO" -PauseReason "PauseReason_example" -Progress 123 -Properties  -RetryFromTaskName "RetryFromTaskName_example" -Src "Src_example" -StartTime Get-Date -Status "Status_example" -SuccessWorkflowCleanupDuration 123 -TraceId "TraceId_example" -Type "Type_example" -UserId "UserId_example" -WaitReason "WaitReason_example" -WorkflowCtx  -WorkflowMetaType "WorkflowMetaType_example" -WorkflowTaskCount 123 -Var0ClusterProfile  -Var1SwitchProfile  -Account  -AssociatedObject  -Organization  -ParentTaskInfo  -PendingDynamicWorkflowInfo  -Permission  -TaskInfos @() -WorkflowDefinition ) # WorkflowWorkflowInfo | The 'workflow.WorkflowInfo' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'workflow.WorkflowInfo' resource.
try {
    WorkflowWorkflowInfo $Result = Set-IntersightWorkflowWorkflowInfo -Moid $Moid -WorkflowWorkflowInfo $WorkflowWorkflowInfo -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightWorkflowWorkflowInfo: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightWorkflowBatchApiExecutor"></a>
# **Update-IntersightWorkflowBatchApiExecutor**
> WorkflowBatchApiExecutor Update-IntersightWorkflowBatchApiExecutor<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowBatchApiExecutor] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'workflow.BatchApiExecutor' resource.
try {
    WorkflowBatchApiExecutor $Result = Update-IntersightWorkflowBatchApiExecutor -Moid $Moid -WorkflowBatchApiExecutor $WorkflowBatchApiExecutor -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightWorkflowBatchApiExecutor: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightWorkflowCustomDataTypeDefinition"></a>
# **Update-IntersightWorkflowCustomDataTypeDefinition**
> WorkflowCustomDataTypeDefinition Update-IntersightWorkflowCustomDataTypeDefinition<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowCustomDataTypeDefinition] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'workflow.CustomDataTypeDefinition' resource.
try {
    WorkflowCustomDataTypeDefinition $Result = Update-IntersightWorkflowCustomDataTypeDefinition -Moid $Moid -WorkflowCustomDataTypeDefinition $WorkflowCustomDataTypeDefinition -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightWorkflowCustomDataTypeDefinition: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightWorkflowErrorResponseHandler"></a>
# **Update-IntersightWorkflowErrorResponseHandler**
> WorkflowErrorResponseHandler Update-IntersightWorkflowErrorResponseHandler<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowErrorResponseHandler] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'workflow.ErrorResponseHandler' resource.
try {
    WorkflowErrorResponseHandler $Result = Update-IntersightWorkflowErrorResponseHandler -Moid $Moid -WorkflowErrorResponseHandler $WorkflowErrorResponseHandler -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightWorkflowErrorResponseHandler: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightWorkflowTaskDefinition"></a>
# **Update-IntersightWorkflowTaskDefinition**
> WorkflowTaskDefinition Update-IntersightWorkflowTaskDefinition<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowTaskDefinition] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'workflow.TaskDefinition' resource.
try {
    WorkflowTaskDefinition $Result = Update-IntersightWorkflowTaskDefinition -Moid $Moid -WorkflowTaskDefinition $WorkflowTaskDefinition -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightWorkflowTaskDefinition: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightWorkflowTaskInfo"></a>
# **Update-IntersightWorkflowTaskInfo**
> WorkflowTaskInfo Update-IntersightWorkflowTaskInfo<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowTaskInfo] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'workflow.TaskInfo' resource.
try {
    WorkflowTaskInfo $Result = Update-IntersightWorkflowTaskInfo -Moid $Moid -WorkflowTaskInfo $WorkflowTaskInfo -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightWorkflowTaskInfo: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightWorkflowWorkflowDefinition"></a>
# **Update-IntersightWorkflowWorkflowDefinition**
> WorkflowWorkflowDefinition Update-IntersightWorkflowWorkflowDefinition<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowWorkflowDefinition] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'workflow.WorkflowDefinition' resource.
try {
    WorkflowWorkflowDefinition $Result = Update-IntersightWorkflowWorkflowDefinition -Moid $Moid -WorkflowWorkflowDefinition $WorkflowWorkflowDefinition -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightWorkflowWorkflowDefinition: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightWorkflowWorkflowInfo"></a>
# **Update-IntersightWorkflowWorkflowInfo**
> WorkflowWorkflowInfo Update-IntersightWorkflowWorkflowInfo<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowWorkflowInfo] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'workflow.WorkflowInfo' resource.
try {
    WorkflowWorkflowInfo $Result = Update-IntersightWorkflowWorkflowInfo -Moid $Moid -WorkflowWorkflowInfo $WorkflowWorkflowInfo -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightWorkflowWorkflowInfo: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
