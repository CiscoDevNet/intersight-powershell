...
[**New-IntersightWorkflowRollbackWorkflow**](IntersightWorkflowApi.md#New-IntersightWorkflowRollbackWorkflow) | **POST** /api/v1/workflow/RollbackWorkflows | Create a &#39;workflow.RollbackWorkflow&#39; resource.
...
[**Remove-IntersightWorkflowRollbackWorkflow**](IntersightWorkflowApi.md#Remove-IntersightWorkflowRollbackWorkflow) | **DELETE** /api/v1/workflow/RollbackWorkflows/{Moid} | Delete a &#39;workflow.RollbackWorkflow&#39; resource.
...
[**Get-IntersightWorkflowRollbackWorkflowByMoid**](IntersightWorkflowApi.md#Get-IntersightWorkflowRollbackWorkflowByMoid) | **GET** /api/v1/workflow/RollbackWorkflows/{Moid} | Read a &#39;workflow.RollbackWorkflow&#39; resource.
[**Get-IntersightWorkflowRollbackWorkflowList**](IntersightWorkflowApi.md#Get-IntersightWorkflowRollbackWorkflowList) | **GET** /api/v1/workflow/RollbackWorkflows | Read a &#39;workflow.RollbackWorkflow&#39; resource.
...
[**Get-IntersightWorkflowTaskMetadataByMoid**](IntersightWorkflowApi.md#Get-IntersightWorkflowTaskMetadataByMoid) | **GET** /api/v1/workflow/TaskMetadata/{Moid} | Read a &#39;workflow.TaskMetadata&#39; resource.
[**Get-IntersightWorkflowTaskMetadataList**](IntersightWorkflowApi.md#Get-IntersightWorkflowTaskMetadataList) | **GET** /api/v1/workflow/TaskMetadata | Read a &#39;workflow.TaskMetadata&#39; resource.
...
[**Get-IntersightWorkflowWorkflowMetadataByMoid**](IntersightWorkflowApi.md#Get-IntersightWorkflowWorkflowMetadataByMoid) | **GET** /api/v1/workflow/WorkflowMetadata/{Moid} | Read a &#39;workflow.WorkflowMetadata&#39; resource.
[**Get-IntersightWorkflowWorkflowMetadataList**](IntersightWorkflowApi.md#Get-IntersightWorkflowWorkflowMetadataList) | **GET** /api/v1/workflow/WorkflowMetadata | Read a &#39;workflow.WorkflowMetadata&#39; resource.
...
[**Set-IntersightWorkflowRollbackWorkflow**](IntersightWorkflowApi.md#Set-IntersightWorkflowRollbackWorkflow) | **PATCH** /api/v1/workflow/RollbackWorkflows/{Moid} | Update a &#39;workflow.RollbackWorkflow&#39; resource.
...
[**Update-IntersightWorkflowRollbackWorkflow**](IntersightWorkflowApi.md#Update-IntersightWorkflowRollbackWorkflow) | **POST** /api/v1/workflow/RollbackWorkflows/{Moid} | Update a &#39;workflow.RollbackWorkflow&#39; resource.
...
# Create a 'workflow.BatchApiExecutor' resource.
try {
     $Result = New-IntersightWorkflowBatchApiExecutor -WorkflowBatchApiExecutor $WorkflowBatchApiExecutor -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
...
$WorkflowCustomDataTypeDefinition = (Initialize-workflow.CustomDataTypeDefinition -ClassId "workflow.CustomDataTypeDefinition" -ObjectType "workflow.CustomDataTypeDefinition" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -CompositeType $false -Description "Description_example" -Label "Label_example" -Name "Name_example" -ParameterSet @() -TypeDefinition @() -Catalog ) # WorkflowCustomDataTypeDefinition | The 'workflow.CustomDataTypeDefinition' resource to create.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
$IfNoneMatch = "IfNoneMatch_example" # String | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)

# Create a 'workflow.CustomDataTypeDefinition' resource.
try {
     $Result = New-IntersightWorkflowCustomDataTypeDefinition -WorkflowCustomDataTypeDefinition $WorkflowCustomDataTypeDefinition -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
...
$WorkflowErrorResponseHandler = (Initialize-workflow.ErrorResponseHandler -ClassId "workflow.ErrorResponseHandler" -ObjectType "workflow.ErrorResponseHandler" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -Parameters @((Initialize-content.Parameter -ClassId "content.Parameter" -ObjectType "content.Parameter" -AcceptSingleValue $false -ComplexType "ComplexType_example" -ItemType "simple" -Name "Name_example" -Path "Path_example" -Type "simple")) -PlatformType "" -Types @((Initialize-content.ComplexType -ClassId "content.ComplexType" -ObjectType "content.ComplexType" -Name "Name_example" -Parameters @((Initialize-content.BaseParameter -ClassId "content.Parameter" -ObjectType "content.Parameter" -AcceptSingleValue $false -ComplexType "ComplexType_example" -ItemType "simple" -Name "Name_example" -Path "Path_example" -Type "simple")))) -Catalog ) # WorkflowErrorResponseHandler | The 'workflow.ErrorResponseHandler' resource to create.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
$IfNoneMatch = "IfNoneMatch_example" # String | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)

# Create a 'workflow.ErrorResponseHandler' resource.
try {
     $Result = New-IntersightWorkflowErrorResponseHandler -WorkflowErrorResponseHandler $WorkflowErrorResponseHandler -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
...
<a name="New-IntersightWorkflowRollbackWorkflow"></a>
# **New-IntersightWorkflowRollbackWorkflow**
> WorkflowRollbackWorkflow New-IntersightWorkflowRollbackWorkflow<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowRollbackWorkflow] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfNoneMatch] <String><br>
...
$WorkflowRollbackWorkflow = (Initialize-workflow.RollbackWorkflow -ClassId "workflow.RollbackWorkflow" -ObjectType "workflow.RollbackWorkflow" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Action "None" -ContinueOnTaskFailure $false -RollbackTasks @() -SelectedTasks @() -Status "None" -PrimaryWorkflow  -RollbackWorkflows @()) # WorkflowRollbackWorkflow | The 'workflow.RollbackWorkflow' resource to create.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
$IfNoneMatch = "IfNoneMatch_example" # String | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)

# Create a 'workflow.RollbackWorkflow' resource.
try {
     $Result = New-IntersightWorkflowRollbackWorkflow -WorkflowRollbackWorkflow $WorkflowRollbackWorkflow -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
    Write-Host ("Exception occured when calling New-IntersightWorkflowRollbackWorkflow: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
$WorkflowTaskDefinition = (Initialize-workflow.TaskDefinition -ClassId "workflow.TaskDefinition" -ObjectType "workflow.TaskDefinition" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DefaultVersion $false -Description "Description_example" -InternalProperties  -Label "Label_example" -LicenseEntitlement "Base" -Name "Name_example" -Properties  -RollbackTasks @() -SecurePropAccess $false -Version 123 -Catalog  -ImplementedTasks @() -InterfaceTask  -TaskMetadata ) # WorkflowTaskDefinition | The 'workflow.TaskDefinition' resource to create.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
$IfNoneMatch = "IfNoneMatch_example" # String | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)

# Create a 'workflow.TaskDefinition' resource.
try {
     $Result = New-IntersightWorkflowTaskDefinition -WorkflowTaskDefinition $WorkflowTaskDefinition -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
...
$WorkflowWorkflowDefinition = (Initialize-workflow.WorkflowDefinition -ClassId "workflow.WorkflowDefinition" -ObjectType "workflow.WorkflowDefinition" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DefaultVersion $false -Description "Description_example" -InputDefinition @() -InputParameterSet @() -Label "Label_example" -LicenseEntitlement "Base" -MaxTaskCount 123 -MaxWorkerTaskCount 123 -Name "Name_example" -OutputDefinition @() -OutputParameters "TODO" -Properties  -Tasks @() -UiInputFilters @() -UiRenderingData "TODO" -ValidationInformation  -Version 123 -Catalog  -WorkflowMetadata ) # WorkflowWorkflowDefinition | The 'workflow.WorkflowDefinition' resource to create.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
$IfNoneMatch = "IfNoneMatch_example" # String | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)

# Create a 'workflow.WorkflowDefinition' resource.
try {
     $Result = New-IntersightWorkflowWorkflowDefinition -WorkflowWorkflowDefinition $WorkflowWorkflowDefinition -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
...
$WorkflowWorkflowInfo = (Initialize-workflow.WorkflowInfo -ClassId "workflow.WorkflowInfo" -ObjectType "workflow.WorkflowInfo" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Action "None" -CleanupTime Get-Date -Email "Email_example" -EndTime Get-Date -FailedWorkflowCleanupDuration 123 -VarInput "TODO" -InstId "InstId_example" -Internal $false -LastAction "None" -Message @() -MetaVersion 123 -Name "Name_example" -Output "TODO" -PauseReason "None" -Progress 123 -Properties  -RetryFromTaskName "RetryFromTaskName_example" -Src "Src_example" -StartTime Get-Date -Status "Status_example" -SuccessWorkflowCleanupDuration 123 -TraceId "TraceId_example" -Type "Type_example" -UserActionRequired $false -UserId "UserId_example" -WaitReason "None" -WorkflowCtx  -WorkflowMetaType "SystemDefined" -WorkflowTaskCount 123 -WorkflowWorkerTaskCount 123 -Var0RollbackWorkflow  -Var1Profile  -Var2ClusterProfile  -Var3SwitchProfile  -Account  -AssociatedObject  -Organization  -ParentTaskInfo  -PendingDynamicWorkflowInfo  -Permission  -TaskInfos @() -WorkflowDefinition ) # WorkflowWorkflowInfo | The 'workflow.WorkflowInfo' resource to create.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
$IfNoneMatch = "IfNoneMatch_example" # String | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)

# Create a 'workflow.WorkflowInfo' resource.
try {
     $Result = New-IntersightWorkflowWorkflowInfo -WorkflowWorkflowInfo $WorkflowWorkflowInfo -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
...
# Delete a 'workflow.BatchApiExecutor' resource.
try {
     $Result = Remove-IntersightWorkflowBatchApiExecutor -Moid $Moid
} catch {
...
# Delete a 'workflow.CustomDataTypeDefinition' resource.
try {
     $Result = Remove-IntersightWorkflowCustomDataTypeDefinition -Moid $Moid
} catch {
...
# Delete a 'workflow.ErrorResponseHandler' resource.
try {
     $Result = Remove-IntersightWorkflowErrorResponseHandler -Moid $Moid
} catch {
...
<a name="Remove-IntersightWorkflowRollbackWorkflow"></a>
# **Remove-IntersightWorkflowRollbackWorkflow**
> void Remove-IntersightWorkflowRollbackWorkflow<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'workflow.RollbackWorkflow' resource.
try {
     $Result = Remove-IntersightWorkflowRollbackWorkflow -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightWorkflowRollbackWorkflow: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
# Delete a 'workflow.TaskDefinition' resource.
try {
     $Result = Remove-IntersightWorkflowTaskDefinition -Moid $Moid
} catch {
...
# Delete a 'workflow.WorkflowDefinition' resource.
try {
     $Result = Remove-IntersightWorkflowWorkflowDefinition -Moid $Moid
} catch {
...
# Delete a 'workflow.WorkflowInfo' resource.
try {
     $Result = Remove-IntersightWorkflowWorkflowInfo -Moid $Moid
} catch {
...
# Read a 'workflow.BatchApiExecutor' resource.
try {
     $Result = Get-IntersightWorkflowBatchApiExecutorByMoid -Moid $Moid
} catch {
...
# Read a 'workflow.BatchApiExecutor' resource.
try {
     $Result = Get-IntersightWorkflowBatchApiExecutorList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'workflow.BuildTaskMeta' resource.
try {
     $Result = Get-IntersightWorkflowBuildTaskMetaByMoid -Moid $Moid
} catch {
...
# Read a 'workflow.BuildTaskMeta' resource.
try {
     $Result = Get-IntersightWorkflowBuildTaskMetaList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'workflow.BuildTaskMetaOwner' resource.
try {
     $Result = Get-IntersightWorkflowBuildTaskMetaOwnerByMoid -Moid $Moid
} catch {
...
# Read a 'workflow.BuildTaskMetaOwner' resource.
try {
     $Result = Get-IntersightWorkflowBuildTaskMetaOwnerList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'workflow.Catalog' resource.
try {
     $Result = Get-IntersightWorkflowCatalogByMoid -Moid $Moid
} catch {
...
# Read a 'workflow.Catalog' resource.
try {
     $Result = Get-IntersightWorkflowCatalogList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'workflow.CustomDataTypeDefinition' resource.
try {
     $Result = Get-IntersightWorkflowCustomDataTypeDefinitionByMoid -Moid $Moid
} catch {
...
# Read a 'workflow.CustomDataTypeDefinition' resource.
try {
     $Result = Get-IntersightWorkflowCustomDataTypeDefinitionList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'workflow.ErrorResponseHandler' resource.
try {
     $Result = Get-IntersightWorkflowErrorResponseHandlerByMoid -Moid $Moid
} catch {
...
# Read a 'workflow.ErrorResponseHandler' resource.
try {
     $Result = Get-IntersightWorkflowErrorResponseHandlerList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'workflow.PendingDynamicWorkflowInfo' resource.
try {
     $Result = Get-IntersightWorkflowPendingDynamicWorkflowInfoByMoid -Moid $Moid
} catch {
...
# Read a 'workflow.PendingDynamicWorkflowInfo' resource.
try {
     $Result = Get-IntersightWorkflowPendingDynamicWorkflowInfoList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
<a name="Get-IntersightWorkflowRollbackWorkflowByMoid"></a>
# **Get-IntersightWorkflowRollbackWorkflowByMoid**
> WorkflowRollbackWorkflow Get-IntersightWorkflowRollbackWorkflowByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'workflow.RollbackWorkflow' resource.
try {
     $Result = Get-IntersightWorkflowRollbackWorkflowByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowRollbackWorkflowByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowRollbackWorkflowList"></a>
# **Get-IntersightWorkflowRollbackWorkflowList**
> WorkflowRollbackWorkflowResponse Get-IntersightWorkflowRollbackWorkflowList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'workflow.RollbackWorkflow' resource.
try {
     $Result = Get-IntersightWorkflowRollbackWorkflowList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowRollbackWorkflowList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
# Read a 'workflow.TaskDefinition' resource.
try {
     $Result = Get-IntersightWorkflowTaskDefinitionByMoid -Moid $Moid
} catch {
...
# Read a 'workflow.TaskDefinition' resource.
try {
     $Result = Get-IntersightWorkflowTaskDefinitionList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'workflow.TaskInfo' resource.
try {
     $Result = Get-IntersightWorkflowTaskInfoByMoid -Moid $Moid
} catch {
...
# Read a 'workflow.TaskInfo' resource.
try {
     $Result = Get-IntersightWorkflowTaskInfoList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
<a name="Get-IntersightWorkflowTaskMetadataByMoid"></a>
# **Get-IntersightWorkflowTaskMetadataByMoid**
> WorkflowTaskMetadata Get-IntersightWorkflowTaskMetadataByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'workflow.TaskMetadata' resource.
try {
     $Result = Get-IntersightWorkflowTaskMetadataByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowTaskMetadataByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowTaskMetadataList"></a>
# **Get-IntersightWorkflowTaskMetadataList**
> WorkflowTaskMetadataResponse Get-IntersightWorkflowTaskMetadataList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'workflow.TaskMetadata' resource.
try {
     $Result = Get-IntersightWorkflowTaskMetadataList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowTaskMetadataList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
# Read a 'workflow.WorkflowDefinition' resource.
try {
     $Result = Get-IntersightWorkflowWorkflowDefinitionByMoid -Moid $Moid
} catch {
...
# Read a 'workflow.WorkflowDefinition' resource.
try {
     $Result = Get-IntersightWorkflowWorkflowDefinitionList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'workflow.WorkflowInfo' resource.
try {
     $Result = Get-IntersightWorkflowWorkflowInfoByMoid -Moid $Moid
} catch {
...
# Read a 'workflow.WorkflowInfo' resource.
try {
     $Result = Get-IntersightWorkflowWorkflowInfoList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'workflow.WorkflowMeta' resource.
try {
     $Result = Get-IntersightWorkflowWorkflowMetaByMoid -Moid $Moid
} catch {
...
# Read a 'workflow.WorkflowMeta' resource.
try {
     $Result = Get-IntersightWorkflowWorkflowMetaList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
<a name="Get-IntersightWorkflowWorkflowMetadataByMoid"></a>
# **Get-IntersightWorkflowWorkflowMetadataByMoid**
> WorkflowWorkflowMetadata Get-IntersightWorkflowWorkflowMetadataByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'workflow.WorkflowMetadata' resource.
try {
     $Result = Get-IntersightWorkflowWorkflowMetadataByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowWorkflowMetadataByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightWorkflowWorkflowMetadataList"></a>
# **Get-IntersightWorkflowWorkflowMetadataList**
> WorkflowWorkflowMetadataResponse Get-IntersightWorkflowWorkflowMetadataList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'workflow.WorkflowMetadata' resource.
try {
     $Result = Get-IntersightWorkflowWorkflowMetadataList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightWorkflowWorkflowMetadataList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$WorkflowBatchApiExecutor = (Initialize-workflow.BatchApiExecutor -ClassId "workflow.BatchApiExecutor" -ObjectType "workflow.BatchApiExecutor" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Batch @((Initialize-workflow.Api -ClassId "workflow.CliCommand" -ObjectType "workflow.CliCommand" -AssetTargetMoid "AssetTargetMoid_example" -Body "Body_example" -ContentType "ContentType_example" -Description "Description_example" -Label "Label_example" -Name "Name_example" -Outcomes "TODO" -ResponseSpec "TODO" -SkipOnCondition "SkipOnCondition_example" -StartDelay 123 -Timeout 123)) -Constraints  -Description "Description_example" -Name "Name_example" -Outcomes "TODO" -Output "TODO" -RetryFromFailedApi $false -SkipOnCondition "SkipOnCondition_example" -ErrorResponseHandler (Initialize-workflow.ErrorResponseHandler.Relationship -ClassId "workflow.ErrorResponseHandler" -ObjectType "workflow.ErrorResponseHandler" -Moid "Moid_example" -Selector "Selector_example" -Link "Link_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -Parameters @() -PlatformType "" -Types @() -Catalog ) -TaskDefinition ) # WorkflowBatchApiExecutor | The 'workflow.BatchApiExecutor' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'workflow.BatchApiExecutor' resource.
try {
     $Result = Set-IntersightWorkflowBatchApiExecutor -Moid $Moid -WorkflowBatchApiExecutor $WorkflowBatchApiExecutor -IfMatch $IfMatch
} catch {
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$WorkflowCustomDataTypeDefinition = (Initialize-workflow.CustomDataTypeDefinition -ClassId "workflow.CustomDataTypeDefinition" -ObjectType "workflow.CustomDataTypeDefinition" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -CompositeType $false -Description "Description_example" -Label "Label_example" -Name "Name_example" -ParameterSet @() -TypeDefinition @() -Catalog ) # WorkflowCustomDataTypeDefinition | The 'workflow.CustomDataTypeDefinition' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'workflow.CustomDataTypeDefinition' resource.
try {
     $Result = Set-IntersightWorkflowCustomDataTypeDefinition -Moid $Moid -WorkflowCustomDataTypeDefinition $WorkflowCustomDataTypeDefinition -IfMatch $IfMatch
} catch {
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$WorkflowErrorResponseHandler = (Initialize-workflow.ErrorResponseHandler -ClassId "workflow.ErrorResponseHandler" -ObjectType "workflow.ErrorResponseHandler" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -Parameters @() -PlatformType "" -Types @() -Catalog ) # WorkflowErrorResponseHandler | The 'workflow.ErrorResponseHandler' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'workflow.ErrorResponseHandler' resource.
try {
     $Result = Set-IntersightWorkflowErrorResponseHandler -Moid $Moid -WorkflowErrorResponseHandler $WorkflowErrorResponseHandler -IfMatch $IfMatch
} catch {
...
<a name="Set-IntersightWorkflowRollbackWorkflow"></a>
# **Set-IntersightWorkflowRollbackWorkflow**
> WorkflowRollbackWorkflow Set-IntersightWorkflowRollbackWorkflow<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowRollbackWorkflow] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$WorkflowRollbackWorkflow = (Initialize-workflow.RollbackWorkflow -ClassId "workflow.RollbackWorkflow" -ObjectType "workflow.RollbackWorkflow" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Action "None" -ContinueOnTaskFailure $false -RollbackTasks @() -SelectedTasks @() -Status "None" -PrimaryWorkflow  -RollbackWorkflows @()) # WorkflowRollbackWorkflow | The 'workflow.RollbackWorkflow' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'workflow.RollbackWorkflow' resource.
try {
     $Result = Set-IntersightWorkflowRollbackWorkflow -Moid $Moid -WorkflowRollbackWorkflow $WorkflowRollbackWorkflow -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightWorkflowRollbackWorkflow: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$WorkflowTaskDefinition = (Initialize-workflow.TaskDefinition -ClassId "workflow.TaskDefinition" -ObjectType "workflow.TaskDefinition" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DefaultVersion $false -Description "Description_example" -InternalProperties  -Label "Label_example" -LicenseEntitlement "Base" -Name "Name_example" -Properties  -RollbackTasks @() -SecurePropAccess $false -Version 123 -Catalog  -ImplementedTasks @() -InterfaceTask  -TaskMetadata ) # WorkflowTaskDefinition | The 'workflow.TaskDefinition' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'workflow.TaskDefinition' resource.
try {
     $Result = Set-IntersightWorkflowTaskDefinition -Moid $Moid -WorkflowTaskDefinition $WorkflowTaskDefinition -IfMatch $IfMatch
} catch {
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$WorkflowTaskInfo = (Initialize-workflow.TaskInfo -ClassId "workflow.TaskInfo" -ObjectType "workflow.TaskInfo" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Var0ClusterReplicationNetworkPolicy  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -EndTime Get-Date -FailureReason "FailureReason_example" -VarInput "TODO" -InstId "InstId_example" -Internal $false -Label "Label_example" -Message @() -Name "Name_example" -Output "TODO" -RefName "RefName_example" -RetryCount 123 -RollbackDisabled $false -RunningInstId "RunningInstId_example" -StartTime Get-Date -Status "Status_example" -TaskInstIdList @() -SubWorkflowInfo  -TaskDefinition  -WorkflowInfo ) # WorkflowTaskInfo | The 'workflow.TaskInfo' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'workflow.TaskInfo' resource.
try {
     $Result = Set-IntersightWorkflowTaskInfo -Moid $Moid -WorkflowTaskInfo $WorkflowTaskInfo -IfMatch $IfMatch
} catch {
...
# Update a 'workflow.WorkflowDefinition' resource.
try {
     $Result = Set-IntersightWorkflowWorkflowDefinition -Moid $Moid -WorkflowWorkflowDefinition $WorkflowWorkflowDefinition -IfMatch $IfMatch
} catch {
...
# Update a 'workflow.WorkflowInfo' resource.
try {
     $Result = Set-IntersightWorkflowWorkflowInfo -Moid $Moid -WorkflowWorkflowInfo $WorkflowWorkflowInfo -IfMatch $IfMatch
} catch {
...
# Update a 'workflow.BatchApiExecutor' resource.
try {
     $Result = Update-IntersightWorkflowBatchApiExecutor -Moid $Moid -WorkflowBatchApiExecutor $WorkflowBatchApiExecutor -IfMatch $IfMatch
} catch {
...
# Update a 'workflow.CustomDataTypeDefinition' resource.
try {
     $Result = Update-IntersightWorkflowCustomDataTypeDefinition -Moid $Moid -WorkflowCustomDataTypeDefinition $WorkflowCustomDataTypeDefinition -IfMatch $IfMatch
} catch {
...
# Update a 'workflow.ErrorResponseHandler' resource.
try {
     $Result = Update-IntersightWorkflowErrorResponseHandler -Moid $Moid -WorkflowErrorResponseHandler $WorkflowErrorResponseHandler -IfMatch $IfMatch
} catch {
...
<a name="Update-IntersightWorkflowRollbackWorkflow"></a>
# **Update-IntersightWorkflowRollbackWorkflow**
> WorkflowRollbackWorkflow Update-IntersightWorkflowRollbackWorkflow<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-WorkflowRollbackWorkflow] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'workflow.RollbackWorkflow' resource.
try {
     $Result = Update-IntersightWorkflowRollbackWorkflow -Moid $Moid -WorkflowRollbackWorkflow $WorkflowRollbackWorkflow -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightWorkflowRollbackWorkflow: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
# Update a 'workflow.TaskDefinition' resource.
try {
     $Result = Update-IntersightWorkflowTaskDefinition -Moid $Moid -WorkflowTaskDefinition $WorkflowTaskDefinition -IfMatch $IfMatch
} catch {
...
# Update a 'workflow.TaskInfo' resource.
try {
     $Result = Update-IntersightWorkflowTaskInfo -Moid $Moid -WorkflowTaskInfo $WorkflowTaskInfo -IfMatch $IfMatch
} catch {
...
# Update a 'workflow.WorkflowDefinition' resource.
try {
     $Result = Update-IntersightWorkflowWorkflowDefinition -Moid $Moid -WorkflowWorkflowDefinition $WorkflowWorkflowDefinition -IfMatch $IfMatch
} catch {
...
# Update a 'workflow.WorkflowInfo' resource.
try {
     $Result = Update-IntersightWorkflowWorkflowInfo -Moid $Moid -WorkflowWorkflowInfo $WorkflowWorkflowInfo -IfMatch $IfMatch
} catch {
