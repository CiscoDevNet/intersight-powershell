...
# Get-IntersightIaasUcsdInfo

## SYNOPSIS
Get the IaasUcsdInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIaasUcsdInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIaasUcsdInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IaasUcsdInfo&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIaasUcsdInfo
```
Above example returns the list of IaasUcsdInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIaasUcsdInfo -Name "MoName"
```
Above example returns the IaasUcsdInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIaasUcsdInfo -Organization $organization
```
Above example returns the list of IaasUcsdInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIaasUcsdInfo -InlineCount allpages
```
Above example returns the list of IaasUcsdInfo along with count.
...
### -Name
Specifies the name of the IaasUcsdInfo.
...
### -Organization
Specifies the organization, to fetch the IaasUcsdInfo under it.
