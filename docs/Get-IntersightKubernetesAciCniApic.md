...
## SYNOPSIS
Get the KubernetesAciCniApic

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesAciCniApic [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesAciCniApic [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;KubernetesAciCniApic&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesAciCniApic
```
Above example returns the list of KubernetesAciCniApic.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesAciCniApic -Name "MoName"
```
Above example returns the KubernetesAciCniApic matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesAciCniApic -Organization $organization
```
Above example returns the list of KubernetesAciCniApic available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesAciCniApic -InlineCount allpages
```
Above example returns the list of KubernetesAciCniApic along with count.
...
### -Name
Specifies the name of the KubernetesAciCniApic.
...
### -Organization
Specifies the organization, to fetch the KubernetesAciCniApic under it.
