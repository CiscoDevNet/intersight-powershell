...
# Get-IntersightNiatelemetryCluster

## SYNOPSIS
Get the NiatelemetryCluster

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryCluster [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryCluster [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryCluster&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryCluster
```
Above example returns the list of NiatelemetryCluster.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryCluster -Name "MoName"
```
Above example returns the NiatelemetryCluster matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryCluster -Organization $organization
```
Above example returns the list of NiatelemetryCluster available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryCluster -InlineCount allpages
```
Above example returns the list of NiatelemetryCluster along with count.
...
### -Name
Specifies the name of the NiatelemetryCluster.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryCluster under it.
