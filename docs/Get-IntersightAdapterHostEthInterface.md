...
## SYNOPSIS
Get the AdapterHostEthInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAdapterHostEthInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAdapterHostEthInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAdapterHostEthInterface
```
Above example returns the list of AdapterHostEthInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAdapterHostEthInterface -Name "MoName"
```
Above example returns the AdapterHostEthInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAdapterHostEthInterface -Organization $organization
```
Above example returns the list of AdapterHostEthInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAdapterHostEthInterface -InlineCount allpages
```
Above example returns the list of AdapterHostEthInterface along with count.
...
### -Name
Specifies the name of the AdapterHostEthInterface.
...
### -Organization
Specifies the organization, to fetch the AdapterHostEthInterface under it.
