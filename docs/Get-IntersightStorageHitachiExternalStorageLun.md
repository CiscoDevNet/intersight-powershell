...
# Get-IntersightStorageHitachiExternalStorageLun

## SYNOPSIS
Get the StorageHitachiExternalStorageLun

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiExternalStorageLun [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiExternalStorageLun [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiExternalStorageLun&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalStorageLun
```
Above example returns the list of StorageHitachiExternalStorageLun.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalStorageLun -Name "MoName"
```
Above example returns the StorageHitachiExternalStorageLun matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalStorageLun -Organization $organization
```
Above example returns the list of StorageHitachiExternalStorageLun available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalStorageLun -InlineCount allpages
```
Above example returns the list of StorageHitachiExternalStorageLun along with count.
...
### -Name
Specifies the name of the StorageHitachiExternalStorageLun.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiExternalStorageLun under it.
