...
# Get-IntersightUuidpoolBlock

## SYNOPSIS
Get the UuidpoolBlock

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightUuidpoolBlock [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightUuidpoolBlock [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;UuidpoolBlock&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightUuidpoolBlock
```
Above example returns the list of UuidpoolBlock.

### Example 2
```powershell
PS C:\> $result = Get-IntersightUuidpoolBlock -Name "MoName"
```
Above example returns the UuidpoolBlock matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightUuidpoolBlock -Organization $organization
```
Above example returns the list of UuidpoolBlock available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightUuidpoolBlock -InlineCount allpages
```
Above example returns the list of UuidpoolBlock along with count.
...
### -Name
Specifies the name of the UuidpoolBlock.
...
### -Organization
Specifies the organization, to fetch the UuidpoolBlock under it.
