...
```powershell
$HyperflexSoftwareVersionPolicyRelationship = Initialize-IntersightHyperflexSoftwareVersionPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexSoftwareVersionPolicyRelationship | ConvertTo-JSON
```
