...
# Get-IntersightResourcepoolChassisQualificationPolicy

## SYNOPSIS
Get the ResourcepoolChassisQualificationPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightResourcepoolChassisQualificationPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourcepoolChassisQualificationPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ResourcepoolChassisQualificationPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourcepoolChassisQualificationPolicy
```
Above example returns the list of ResourcepoolChassisQualificationPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourcepoolChassisQualificationPolicy -Name "MoName"
```
Above example returns the ResourcepoolChassisQualificationPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourcepoolChassisQualificationPolicy -Organization $organization
```
Above example returns the list of ResourcepoolChassisQualificationPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourcepoolChassisQualificationPolicy -InlineCount allpages
```
Above example returns the list of ResourcepoolChassisQualificationPolicy along with count.
...
### -Name
Specifies the name of the ResourcepoolChassisQualificationPolicy.
...
### -Organization
Specifies the organization, to fetch the ResourcepoolChassisQualificationPolicy under it.
