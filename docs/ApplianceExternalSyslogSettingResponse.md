...
```powershell
$ApplianceExternalSyslogSettingResponse = Initialize-IntersightApplianceExternalSyslogSettingResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$ApplianceExternalSyslogSettingResponse | ConvertTo-JSON
```
