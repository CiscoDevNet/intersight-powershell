...
## SYNOPSIS
Get the KubernetesAciCniTenantClusterAllocation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesAciCniTenantClusterAllocation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesAciCniTenantClusterAllocation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesAciCniTenantClusterAllocation
```
Above example returns the list of KubernetesAciCniTenantClusterAllocation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesAciCniTenantClusterAllocation -Name "MoName"
```
Above example returns the KubernetesAciCniTenantClusterAllocation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesAciCniTenantClusterAllocation -Organization $organization
```
Above example returns the list of KubernetesAciCniTenantClusterAllocation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesAciCniTenantClusterAllocation -InlineCount allpages
```
Above example returns the list of KubernetesAciCniTenantClusterAllocation along with count.
...
### -Name
Specifies the name of the KubernetesAciCniTenantClusterAllocation.
...
### -Organization
Specifies the organization, to fetch the KubernetesAciCniTenantClusterAllocation under it.
