...
```powershell
$CapabilitySwitchCapabilityResponse = Initialize-IntersightCapabilitySwitchCapabilityResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilitySwitchCapabilityResponse | ConvertTo-JSON
```
