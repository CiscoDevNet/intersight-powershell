...
## SYNOPSIS
Get the KubernetesDeployment

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesDeployment [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesDeployment [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;KubernetesDeployment&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesDeployment
```
Above example returns the list of KubernetesDeployment.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesDeployment -Name "MoName"
```
Above example returns the KubernetesDeployment matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesDeployment -Organization $organization
```
Above example returns the list of KubernetesDeployment available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesDeployment -InlineCount allpages
```
Above example returns the list of KubernetesDeployment along with count.
...
### -Name
Specifies the name of the KubernetesDeployment.
...
### -Organization
Specifies the organization, to fetch the KubernetesDeployment under it.
...
[Remove-IntersightKubernetesDeployment](./Remove-IntersightKubernetesDeployment.md)
