...
## SYNOPSIS
Get the FabricSwitchClusterProfile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricSwitchClusterProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricSwitchClusterProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricSwitchClusterProfile
```
Above example returns the list of FabricSwitchClusterProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricSwitchClusterProfile -Name "MoName"
```
Above example returns the FabricSwitchClusterProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricSwitchClusterProfile -Organization $organization
```
Above example returns the list of FabricSwitchClusterProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricSwitchClusterProfile -InlineCount allpages
```
Above example returns the list of FabricSwitchClusterProfile along with count.
...
### -Name
Specifies the name of the FabricSwitchClusterProfile.
...
### -Organization
Specifies the organization, to fetch the FabricSwitchClusterProfile under it.
