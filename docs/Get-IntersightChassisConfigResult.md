...
### CmdletParam (Default)
```
Get-IntersightChassisConfigResult [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightChassisConfigResult [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightChassisConfigResult
```
Above example returns the list of ChassisConfigResult.

### Example 2
```powershell
PS C:\> $result = Get-IntersightChassisConfigResult -Name "MoName"
```
Above example returns the ChassisConfigResult matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightChassisConfigResult -Organization $organization
```
Above example returns the list of ChassisConfigResult available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightChassisConfigResult -InlineCount allpages
```
Above example returns the list of ChassisConfigResult along with count.
...
### -Name
Specifies the name of the ChassisConfigResult.
...
### -Organization
Specifies the organization, to fetch the ChassisConfigResult under it.
