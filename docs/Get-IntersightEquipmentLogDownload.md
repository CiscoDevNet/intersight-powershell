...
# Get-IntersightEquipmentLogDownload

## SYNOPSIS
Get the EquipmentLogDownload

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentLogDownload [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentLogDownload [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentLogDownload&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentLogDownload
```
Above example returns the list of EquipmentLogDownload.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentLogDownload -Name "MoName"
```
Above example returns the EquipmentLogDownload matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentLogDownload -Organization $organization
```
Above example returns the list of EquipmentLogDownload available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentLogDownload -InlineCount allpages
```
Above example returns the list of EquipmentLogDownload along with count.
...
### -Name
Specifies the name of the EquipmentLogDownload.
...
### -Organization
Specifies the organization, to fetch the EquipmentLogDownload under it.
