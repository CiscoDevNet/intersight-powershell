...
## SYNOPSIS
Get the NiatelemetryFabricPodSs

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryFabricPodSs [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryFabricPodSs [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryFabricPodSs&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricPodSs
```
Above example returns the list of NiatelemetryFabricPodSs.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricPodSs -Name "MoName"
```
Above example returns the NiatelemetryFabricPodSs matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricPodSs -Organization $organization
```
Above example returns the list of NiatelemetryFabricPodSs available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricPodSs -InlineCount allpages
```
Above example returns the list of NiatelemetryFabricPodSs along with count.
...
### -Name
Specifies the name of the NiatelemetryFabricPodSs.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryFabricPodSs under it.
