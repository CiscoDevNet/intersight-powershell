...
## SYNOPSIS
Get the NiatelemetryHttpsAclFilterDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryHttpsAclFilterDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryHttpsAclFilterDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryHttpsAclFilterDetails&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclFilterDetails
```
Above example returns the list of NiatelemetryHttpsAclFilterDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclFilterDetails -Name "MoName"
```
Above example returns the NiatelemetryHttpsAclFilterDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclFilterDetails -Organization $organization
```
Above example returns the list of NiatelemetryHttpsAclFilterDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclFilterDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryHttpsAclFilterDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryHttpsAclFilterDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryHttpsAclFilterDetails under it.
