...
```powershell
$CapabilityChassisManufacturingDefResponse = Initialize-IntersightCapabilityChassisManufacturingDefResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilityChassisManufacturingDefResponse | ConvertTo-JSON
```
