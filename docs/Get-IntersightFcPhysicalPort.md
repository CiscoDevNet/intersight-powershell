...
# Get-IntersightFcPhysicalPort

## SYNOPSIS
Get the FcPhysicalPort

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFcPhysicalPort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFcPhysicalPort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;FcPhysicalPort&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFcPhysicalPort
```
Above example returns the list of FcPhysicalPort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFcPhysicalPort -Name "MoName"
```
Above example returns the FcPhysicalPort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFcPhysicalPort -Organization $organization
```
Above example returns the list of FcPhysicalPort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFcPhysicalPort -InlineCount allpages
```
Above example returns the list of FcPhysicalPort along with count.
...
### -Name
Specifies the name of the FcPhysicalPort.
...
### -Organization
Specifies the organization, to fetch the FcPhysicalPort under it.
...
[Set-IntersightFcPhysicalPort](./Set-IntersightFcPhysicalPort.md)
