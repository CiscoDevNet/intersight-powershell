...
Initialize-IntersightVnicVmqSettings [-AdditionalProperties< Dictionary<string,object>>][-ClassId< VnicVmqSettings.ClassIdEnum>][-Enabled< bool>][-MultiQueueSupport< bool>][-NumInterrupts< long>][-NumSubVnics< long>][-NumVmqs< long>][-ObjectType< VnicVmqSettings.ObjectTypeEnum>][-VmmqAdapterPolicy< string>]
