...
Initialize-IntersightVnicVmqSettings [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< VnicVmqSettings.ClassIdEnum>][-Enabled< bool>][-MultiQueueSupport< bool>][-NumInterrupts< long>][-NumSubVnics< long>][-NumVmqs< long>][-ObjectType< VnicVmqSettings.ObjectTypeEnum>][-VmmqAdapterPolicy< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: VnicVmqSettings.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VnicVmqSettings.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVnicVmqSettings
```
