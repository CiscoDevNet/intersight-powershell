...
```powershell
$VirtualizationVirtualMachineResponse = Initialize-IntersightVirtualizationVirtualMachineResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$VirtualizationVirtualMachineResponse | ConvertTo-JSON
```
