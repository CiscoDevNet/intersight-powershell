...
### CmdletParam (Default)
```
Get-IntersightConvergedinfraSwitchComplianceDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightConvergedinfraSwitchComplianceDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
