...
```powershell
$VnicIscsiStaticTargetPolicyResponse = Initialize-IntersightVnicIscsiStaticTargetPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$VnicIscsiStaticTargetPolicyResponse | ConvertTo-JSON
```
