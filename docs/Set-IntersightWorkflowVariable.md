...
Set-IntersightWorkflowVariable [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Catalog< WorkflowCatalogRelationship>][-Definition< WorkflowBaseDataType>][[-Moid]< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Value< object>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
