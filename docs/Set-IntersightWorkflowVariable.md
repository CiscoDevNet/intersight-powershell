...
# Set-IntersightWorkflowVariable
...
Set-IntersightWorkflowVariable [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Catalog< WorkflowCatalogRelationship>][-Definition< WorkflowBaseDataType>][[-Moid]< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Value< object>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;WorkflowVariable&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightWorkflowVariable
```
