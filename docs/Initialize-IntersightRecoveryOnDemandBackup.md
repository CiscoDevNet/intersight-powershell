...
# Initialize-IntersightRecoveryOnDemandBackup
...
Initialize-IntersightRecoveryOnDemandBackup [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< RecoveryOnDemandBackup.ClassIdEnum>][-Description< string>][-DeviceId< Model.AssetDeviceRegistrationRelationship>][-FileNamePrefix< string>][-LocationType< RecoveryOnDemandBackup.LocationTypeEnum>][-Moid< string>][-Name< string>][-ObjectType< RecoveryOnDemandBackup.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Password< string>][-Path< string>][-Protocol< RecoveryOnDemandBackup.ProtocolEnum>][-RetentionCount< long>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-UserName< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: RecoveryOnDemandBackup.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: RecoveryOnDemandBackup.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightRecoveryOnDemandBackup
```
