...
### CmdletParam (Default)
```
Get-IntersightBulkExport [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBulkExport [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;BulkExport&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBulkExport
```
Above example returns the list of BulkExport.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBulkExport -Name "MoName"
```
Above example returns the BulkExport matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBulkExport -Organization $organization
```
Above example returns the list of BulkExport available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBulkExport -InlineCount allpages
```
Above example returns the list of BulkExport along with count.
...
### -Name
Specifies the name of the BulkExport.
...
### -Organization
Specifies the organization, to fetch the BulkExport under it.
