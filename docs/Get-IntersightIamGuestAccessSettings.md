...
# Get-IntersightIamGuestAccessSettings

## SYNOPSIS
Get the IamGuestAccessSettings

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamGuestAccessSettings [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamGuestAccessSettings [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamGuestAccessSettings&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamGuestAccessSettings
```
Above example returns the list of IamGuestAccessSettings.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamGuestAccessSettings -Name "MoName"
```
Above example returns the IamGuestAccessSettings matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamGuestAccessSettings -Organization $organization
```
Above example returns the list of IamGuestAccessSettings available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamGuestAccessSettings -InlineCount allpages
```
Above example returns the list of IamGuestAccessSettings along with count.
...
### -Name
Specifies the name of the IamGuestAccessSettings.
...
### -Organization
Specifies the organization, to fetch the IamGuestAccessSettings under it.
