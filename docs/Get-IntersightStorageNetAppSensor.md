...
## SYNOPSIS
Get the StorageNetAppSensor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppSensor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppSensor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppSensor&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSensor
```
Above example returns the list of StorageNetAppSensor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSensor -Name "MoName"
```
Above example returns the StorageNetAppSensor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSensor -Organization $organization
```
Above example returns the list of StorageNetAppSensor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSensor -InlineCount allpages
```
Above example returns the list of StorageNetAppSensor along with count.
...
### -Name
Specifies the name of the StorageNetAppSensor.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppSensor under it.
