...
## SYNOPSIS
Get the KubernetesSysConfigPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesSysConfigPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesSysConfigPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;KubernetesSysConfigPolicy&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesSysConfigPolicy
```
Above example returns the list of KubernetesSysConfigPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesSysConfigPolicy -Name "MoName"
```
Above example returns the KubernetesSysConfigPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesSysConfigPolicy -Organization $organization
```
Above example returns the list of KubernetesSysConfigPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesSysConfigPolicy -InlineCount allpages
```
Above example returns the list of KubernetesSysConfigPolicy along with count.
...
### -Name
Specifies the name of the KubernetesSysConfigPolicy.
...
### -Organization
Specifies the organization, to fetch the KubernetesSysConfigPolicy under it.
