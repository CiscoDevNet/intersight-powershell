...
# Get-IntersightResourceSharedResourcesInfoHolder

## SYNOPSIS
Get the ResourceSharedResourcesInfoHolder

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightResourceSharedResourcesInfoHolder [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourceSharedResourcesInfoHolder [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ResourceSharedResourcesInfoHolder&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourceSharedResourcesInfoHolder
```
Above example returns the list of ResourceSharedResourcesInfoHolder.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourceSharedResourcesInfoHolder -Name "MoName"
```
Above example returns the ResourceSharedResourcesInfoHolder matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourceSharedResourcesInfoHolder -Organization $organization
```
Above example returns the list of ResourceSharedResourcesInfoHolder available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourceSharedResourcesInfoHolder -InlineCount allpages
```
Above example returns the list of ResourceSharedResourcesInfoHolder along with count.
...
### -Name
Specifies the name of the ResourceSharedResourcesInfoHolder.
...
### -Organization
Specifies the organization, to fetch the ResourceSharedResourcesInfoHolder under it.
...
[Remove-IntersightResourceSharedResourcesInfoHolder](./Remove-IntersightResourceSharedResourcesInfoHolder.md)
