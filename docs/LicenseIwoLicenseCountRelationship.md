...
```powershell
$LicenseIwoLicenseCountRelationship = Initialize-IntersightLicenseIwoLicenseCountRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$LicenseIwoLicenseCountRelationship | ConvertTo-JSON
```
