...
# Get-IntersightWorkflowPowerShellBatchApiExecutor

## SYNOPSIS
Get the WorkflowPowerShellBatchApiExecutor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowPowerShellBatchApiExecutor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowPowerShellBatchApiExecutor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowPowerShellBatchApiExecutor&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowPowerShellBatchApiExecutor
```
Above example returns the list of WorkflowPowerShellBatchApiExecutor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowPowerShellBatchApiExecutor -Name "MoName"
```
Above example returns the WorkflowPowerShellBatchApiExecutor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowPowerShellBatchApiExecutor -Organization $organization
```
Above example returns the list of WorkflowPowerShellBatchApiExecutor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowPowerShellBatchApiExecutor -InlineCount allpages
```
Above example returns the list of WorkflowPowerShellBatchApiExecutor along with count.
...
### -Name
Specifies the name of the WorkflowPowerShellBatchApiExecutor.
...
### -Organization
Specifies the organization, to fetch the WorkflowPowerShellBatchApiExecutor under it.
...
[Remove-IntersightWorkflowPowerShellBatchApiExecutor](./Remove-IntersightWorkflowPowerShellBatchApiExecutor.md)
