...
Set-IntersightSmtpPolicy [-AdditionalProperties< Dictionary<string,object>>][-Description< string>][-Enabled< bool>][-MinSeverity< SmtpPolicy.MinSeverityEnum>][[-Moid]< string>][-Name< string>][-Organization< OrganizationOrganizationRelationship>][-Profiles< List<PolicyAbstractConfigProfileRelationship>>][-SenderEmail< string>][-SmtpPort< long>][-SmtpRecipients< List<string>>][-SmtpServer< string>][-Tags< List<MoTag>>]
