...
## SYNOPSIS
Get the VirtualizationVmwareDatastoreCluster

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareDatastoreCluster [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareDatastoreCluster [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareDatastoreCluster&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDatastoreCluster
```
Above example returns the list of VirtualizationVmwareDatastoreCluster.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDatastoreCluster -Name "MoName"
```
Above example returns the VirtualizationVmwareDatastoreCluster matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDatastoreCluster -Organization $organization
```
Above example returns the list of VirtualizationVmwareDatastoreCluster available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareDatastoreCluster -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareDatastoreCluster along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareDatastoreCluster.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareDatastoreCluster under it.
...
[Set-IntersightVirtualizationVmwareDatastoreCluster](./Set-IntersightVirtualizationVmwareDatastoreCluster.md)
