...
# Get-IntersightMgmtConfigRestoreOperation

## SYNOPSIS
Get the MgmtConfigRestoreOperation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMgmtConfigRestoreOperation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMgmtConfigRestoreOperation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MgmtConfigRestoreOperation&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMgmtConfigRestoreOperation
```
Above example returns the list of MgmtConfigRestoreOperation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMgmtConfigRestoreOperation -Name "MoName"
```
Above example returns the MgmtConfigRestoreOperation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMgmtConfigRestoreOperation -Organization $organization
```
Above example returns the list of MgmtConfigRestoreOperation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMgmtConfigRestoreOperation -InlineCount allpages
```
Above example returns the list of MgmtConfigRestoreOperation along with count.
...
### -Name
Specifies the name of the MgmtConfigRestoreOperation.
...
### -Organization
Specifies the organization, to fetch the MgmtConfigRestoreOperation under it.
...
[New-IntersightMgmtConfigRestoreOperation](./New-IntersightMgmtConfigRestoreOperation.md)
