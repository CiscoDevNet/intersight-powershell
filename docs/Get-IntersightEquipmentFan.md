...
### CmdletParam (Default)
```
Get-IntersightEquipmentFan [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentFan [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentFan
```
Above example returns the list of EquipmentFan.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentFan -Name "MoName"
```
Above example returns the EquipmentFan matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentFan -Organization $organization
```
Above example returns the list of EquipmentFan available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentFan -InlineCount allpages
```
Above example returns the list of EquipmentFan along with count.
...
### -Name
Specifies the name of the EquipmentFan.
...
### -Organization
Specifies the organization, to fetch the EquipmentFan under it.
...
[Set-IntersightEquipmentFan](./Set-IntersightEquipmentFan.md)
