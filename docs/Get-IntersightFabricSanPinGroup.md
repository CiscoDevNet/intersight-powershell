...
# Get-IntersightFabricSanPinGroup

## SYNOPSIS
Get the FabricSanPinGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricSanPinGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricSanPinGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricSanPinGroup&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricSanPinGroup
```
Above example returns the list of FabricSanPinGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricSanPinGroup -Name "MoName"
```
Above example returns the FabricSanPinGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricSanPinGroup -Organization $organization
```
Above example returns the list of FabricSanPinGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricSanPinGroup -InlineCount allpages
```
Above example returns the list of FabricSanPinGroup along with count.
...
### -Name
Specifies the name of the FabricSanPinGroup.
...
### -Organization
Specifies the organization, to fetch the FabricSanPinGroup under it.
...
[Remove-IntersightFabricSanPinGroup](./Remove-IntersightFabricSanPinGroup.md)
