...
### CmdletParam (Default)
```
Get-IntersightFmcDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFmcDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FmcDevice&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFmcDevice
```
Above example returns the list of FmcDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFmcDevice -Name "MoName"
```
Above example returns the FmcDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFmcDevice -Organization $organization
```
Above example returns the list of FmcDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFmcDevice -InlineCount allpages
```
Above example returns the list of FmcDevice along with count.
...
### -Name
Specifies the name of the FmcDevice.
...
### -Organization
Specifies the organization, to fetch the FmcDevice under it.
