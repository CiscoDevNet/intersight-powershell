...
Set-IntersightSolPolicy [-AdditionalProperties< Dictionary<string,object>>][-BaudRate< SolPolicy.BaudRateEnum>][-ComPort< SolPolicy.ComPortEnum>][-Description< string>][-Enabled< bool>][[-Moid]< string>][-Name< string>][-Organization< OrganizationOrganizationRelationship>][-Profiles< List<PolicyAbstractConfigProfileRelationship>>][-SshPort< long>][-Tags< List<MoTag>>]
