...
## SYNOPSIS
Get the IamDomainGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamDomainGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamDomainGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamDomainGroup
```
Above example returns the list of IamDomainGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamDomainGroup -Name "MoName"
```
Above example returns the IamDomainGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamDomainGroup -Organization $organization
```
Above example returns the list of IamDomainGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamDomainGroup -InlineCount allpages
```
Above example returns the list of IamDomainGroup along with count.
...
### -Name
Specifies the name of the IamDomainGroup.
...
### -Organization
Specifies the organization, to fetch the IamDomainGroup under it.
