...
```powershell
$HyperflexCiscoHypervisorManagerResponse = Initialize-IntersightHyperflexCiscoHypervisorManagerResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexCiscoHypervisorManagerResponse | ConvertTo-JSON
```
