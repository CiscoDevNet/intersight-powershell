...
### CmdletParam (Default)
```
Get-IntersightIppoolPool [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIppoolPool [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IppoolPool&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIppoolPool
```
Above example returns the list of IppoolPool.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIppoolPool -Name "MoName"
```
Above example returns the IppoolPool matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIppoolPool -Organization $organization
```
Above example returns the list of IppoolPool available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIppoolPool -InlineCount allpages
```
Above example returns the list of IppoolPool along with count.
...
### -Name
Specifies the name of the IppoolPool.
...
### -Organization
Specifies the organization, to fetch the IppoolPool under it.
