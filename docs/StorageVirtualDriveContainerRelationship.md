...
```powershell
$StorageVirtualDriveContainerRelationship = Initialize-IntersightStorageVirtualDriveContainerRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StorageVirtualDriveContainerRelationship | ConvertTo-JSON
```
