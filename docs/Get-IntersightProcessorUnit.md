...
# Get-IntersightProcessorUnit

## SYNOPSIS
Get the ProcessorUnit

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightProcessorUnit [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightProcessorUnit [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;ProcessorUnit&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightProcessorUnit
```
Above example returns the list of ProcessorUnit.

### Example 2
```powershell
PS C:\> $result = Get-IntersightProcessorUnit -Name "MoName"
```
Above example returns the ProcessorUnit matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightProcessorUnit -Organization $organization
```
Above example returns the list of ProcessorUnit available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightProcessorUnit -InlineCount allpages
```
Above example returns the list of ProcessorUnit along with count.
...
### -Name
Specifies the name of the ProcessorUnit.
...
### -Organization
Specifies the organization, to fetch the ProcessorUnit under it.
...
[Set-IntersightProcessorUnit](./Set-IntersightProcessorUnit.md)
