...
## SYNOPSIS
Get the BiosSystemBootOrder

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBiosSystemBootOrder [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBiosSystemBootOrder [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;BiosSystemBootOrder&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBiosSystemBootOrder
```
Above example returns the list of BiosSystemBootOrder.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBiosSystemBootOrder -Name "MoName"
```
Above example returns the BiosSystemBootOrder matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBiosSystemBootOrder -Organization $organization
```
Above example returns the list of BiosSystemBootOrder available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBiosSystemBootOrder -InlineCount allpages
```
Above example returns the list of BiosSystemBootOrder along with count.
...
### -Name
Specifies the name of the BiosSystemBootOrder.
...
### -Organization
Specifies the organization, to fetch the BiosSystemBootOrder under it.
