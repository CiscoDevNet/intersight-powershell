...
# Get-IntersightSnmpPolicyInventory

## SYNOPSIS
Get the SnmpPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSnmpPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSnmpPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SnmpPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSnmpPolicyInventory
```
Above example returns the list of SnmpPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSnmpPolicyInventory -Name "MoName"
```
Above example returns the SnmpPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSnmpPolicyInventory -Organization $organization
```
Above example returns the list of SnmpPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSnmpPolicyInventory -InlineCount allpages
```
Above example returns the list of SnmpPolicyInventory along with count.
...
### -Name
Specifies the name of the SnmpPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the SnmpPolicyInventory under it.
