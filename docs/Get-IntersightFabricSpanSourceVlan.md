...
# Get-IntersightFabricSpanSourceVlan

## SYNOPSIS
Get the FabricSpanSourceVlan

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricSpanSourceVlan [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricSpanSourceVlan [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricSpanSourceVlan&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceVlan
```
Above example returns the list of FabricSpanSourceVlan.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceVlan -Name "MoName"
```
Above example returns the FabricSpanSourceVlan matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceVlan -Organization $organization
```
Above example returns the list of FabricSpanSourceVlan available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceVlan -InlineCount allpages
```
Above example returns the list of FabricSpanSourceVlan along with count.
...
### -Name
Specifies the name of the FabricSpanSourceVlan.
...
### -Organization
Specifies the organization, to fetch the FabricSpanSourceVlan under it.
...
[Remove-IntersightFabricSpanSourceVlan](./Remove-IntersightFabricSpanSourceVlan.md)
