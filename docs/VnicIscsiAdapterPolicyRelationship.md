...
```powershell
$VnicIscsiAdapterPolicyRelationship = Initialize-IntersightVnicIscsiAdapterPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$VnicIscsiAdapterPolicyRelationship | ConvertTo-JSON
```
