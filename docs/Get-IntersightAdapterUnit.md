...
### CmdletParam (Default)
```
Get-IntersightAdapterUnit [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAdapterUnit [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAdapterUnit
```
Above example returns the list of AdapterUnit.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAdapterUnit -Name "MoName"
```
Above example returns the AdapterUnit matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAdapterUnit -Organization $organization
```
Above example returns the list of AdapterUnit available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAdapterUnit -InlineCount allpages
```
Above example returns the list of AdapterUnit along with count.
...
### -Name
Specifies the name of the AdapterUnit.
...
### -Organization
Specifies the organization, to fetch the AdapterUnit under it.
