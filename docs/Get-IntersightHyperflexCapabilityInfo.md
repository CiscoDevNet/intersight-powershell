...
## SYNOPSIS
Get the HyperflexCapabilityInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexCapabilityInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexCapabilityInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexCapabilityInfo&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexCapabilityInfo
```
Above example returns the list of HyperflexCapabilityInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexCapabilityInfo -Name "MoName"
```
Above example returns the HyperflexCapabilityInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexCapabilityInfo -Organization $organization
```
Above example returns the list of HyperflexCapabilityInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexCapabilityInfo -InlineCount allpages
```
Above example returns the list of HyperflexCapabilityInfo along with count.
...
### -Name
Specifies the name of the HyperflexCapabilityInfo.
...
### -Organization
Specifies the organization, to fetch the HyperflexCapabilityInfo under it.
