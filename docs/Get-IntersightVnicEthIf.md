...
### CmdletParam (Default)
```
Get-IntersightVnicEthIf [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicEthIf [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicEthIf&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicEthIf
```
Above example returns the list of VnicEthIf.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicEthIf -Name "MoName"
```
Above example returns the VnicEthIf matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicEthIf -Organization $organization
```
Above example returns the list of VnicEthIf available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicEthIf -InlineCount allpages
```
Above example returns the list of VnicEthIf along with count.
...
### -Name
Specifies the name of the VnicEthIf.
...
### -Organization
Specifies the organization, to fetch the VnicEthIf under it.
