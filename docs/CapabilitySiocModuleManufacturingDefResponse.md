...
```powershell
$CapabilitySiocModuleManufacturingDefResponse = Initialize-IntersightCapabilitySiocModuleManufacturingDefResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilitySiocModuleManufacturingDefResponse | ConvertTo-JSON
```
