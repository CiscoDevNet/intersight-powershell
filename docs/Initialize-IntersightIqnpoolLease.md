...
# Initialize-IntersightIqnpoolLease
...
```yaml
Type: IqnpoolLease.AllocationTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IqnpoolLease.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIqnpoolLease
```
