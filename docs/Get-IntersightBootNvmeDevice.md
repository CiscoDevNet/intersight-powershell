...
## SYNOPSIS
Get the BootNvmeDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBootNvmeDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBootNvmeDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBootNvmeDevice
```
Above example returns the list of BootNvmeDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBootNvmeDevice -Name "MoName"
```
Above example returns the BootNvmeDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBootNvmeDevice -Organization $organization
```
Above example returns the list of BootNvmeDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBootNvmeDevice -InlineCount allpages
```
Above example returns the list of BootNvmeDevice along with count.
...
### -Name
Specifies the name of the BootNvmeDevice.
...
### -Organization
Specifies the organization, to fetch the BootNvmeDevice under it.
...
[Set-IntersightBootNvmeDevice](./Set-IntersightBootNvmeDevice.md)
