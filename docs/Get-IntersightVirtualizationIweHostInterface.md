...
## SYNOPSIS
Get the VirtualizationIweHostInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationIweHostInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationIweHostInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweHostInterface
```
Above example returns the list of VirtualizationIweHostInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweHostInterface -Name "MoName"
```
Above example returns the VirtualizationIweHostInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweHostInterface -Organization $organization
```
Above example returns the list of VirtualizationIweHostInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweHostInterface -InlineCount allpages
```
Above example returns the list of VirtualizationIweHostInterface along with count.
...
### -Name
Specifies the name of the VirtualizationIweHostInterface.
...
### -Organization
Specifies the organization, to fetch the VirtualizationIweHostInterface under it.
