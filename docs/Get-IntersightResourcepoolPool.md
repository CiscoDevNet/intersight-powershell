...
## SYNOPSIS
Get the ResourcepoolPool

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightResourcepoolPool [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourcepoolPool [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourcepoolPool
```
Above example returns the list of ResourcepoolPool.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourcepoolPool -Name "MoName"
```
Above example returns the ResourcepoolPool matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourcepoolPool -Organization $organization
```
Above example returns the list of ResourcepoolPool available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourcepoolPool -InlineCount allpages
```
Above example returns the list of ResourcepoolPool along with count.
...
### -Name
Specifies the name of the ResourcepoolPool.
...
### -Organization
Specifies the organization, to fetch the ResourcepoolPool under it.
