...
# Get-IntersightLsServiceProfile

## SYNOPSIS
Get the LsServiceProfile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightLsServiceProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightLsServiceProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;LsServiceProfile&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightLsServiceProfile
```
Above example returns the list of LsServiceProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightLsServiceProfile -Name "MoName"
```
Above example returns the LsServiceProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightLsServiceProfile -Organization $organization
```
Above example returns the list of LsServiceProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightLsServiceProfile -InlineCount allpages
```
Above example returns the list of LsServiceProfile along with count.
...
### -Name
Specifies the name of the LsServiceProfile.
...
### -Organization
Specifies the organization, to fetch the LsServiceProfile under it.
...
[Set-IntersightLsServiceProfile](./Set-IntersightLsServiceProfile.md)
