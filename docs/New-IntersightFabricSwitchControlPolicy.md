...
New-IntersightFabricSwitchControlPolicy [-AdditionalProperties< Dictionary<string,object>>][-Description< string>][-MacAgingSettings< FabricMacAgingSettings>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-Profiles< List<FabricSwitchProfileRelationship>>][-Tags< List<MoTag>>][-UdldSettings< FabricUdldGlobalSettings>][-VlanPortOptimizationEnabled< bool>]
