...
## SYNOPSIS
Get the OpenapiTaskGenerationRequest

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOpenapiTaskGenerationRequest [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOpenapiTaskGenerationRequest [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;OpenapiTaskGenerationRequest&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOpenapiTaskGenerationRequest
```
Above example returns the list of OpenapiTaskGenerationRequest.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOpenapiTaskGenerationRequest -Name "MoName"
```
Above example returns the OpenapiTaskGenerationRequest matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOpenapiTaskGenerationRequest -Organization $organization
```
Above example returns the list of OpenapiTaskGenerationRequest available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOpenapiTaskGenerationRequest -InlineCount allpages
```
Above example returns the list of OpenapiTaskGenerationRequest along with count.
...
### -Name
Specifies the name of the OpenapiTaskGenerationRequest.
...
### -Organization
Specifies the organization, to fetch the OpenapiTaskGenerationRequest under it.
