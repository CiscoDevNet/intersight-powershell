...
```powershell
$StorageNetAppEthernetPortRelationship = Initialize-IntersightStorageNetAppEthernetPortRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StorageNetAppEthernetPortRelationship | ConvertTo-JSON
```
