...
# Get-IntersightHciEntitlement

## SYNOPSIS
Get the HciEntitlement

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHciEntitlement [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciEntitlement [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciEntitlement&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciEntitlement
```
Above example returns the list of HciEntitlement.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciEntitlement -Name "MoName"
```
Above example returns the HciEntitlement matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciEntitlement -Organization $organization
```
Above example returns the list of HciEntitlement available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciEntitlement -InlineCount allpages
```
Above example returns the list of HciEntitlement along with count.
...
### -Name
Specifies the name of the HciEntitlement.
...
### -Organization
Specifies the organization, to fetch the HciEntitlement under it.
