...
## SYNOPSIS
Get the IamIdpReference

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamIdpReference [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamIdpReference [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamIdpReference&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamIdpReference
```
Above example returns the list of IamIdpReference.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamIdpReference -Name "MoName"
```
Above example returns the IamIdpReference matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamIdpReference -Organization $organization
```
Above example returns the list of IamIdpReference available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamIdpReference -InlineCount allpages
```
Above example returns the list of IamIdpReference along with count.
...
### -Name
Specifies the name of the IamIdpReference.
...
### -Organization
Specifies the organization, to fetch the IamIdpReference under it.
...
[Set-IntersightIamIdpReference](./Set-IntersightIamIdpReference.md)
