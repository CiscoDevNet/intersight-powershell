...
# Get-IntersightEquipmentEndPointLog

## SYNOPSIS
Get the EquipmentEndPointLog

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentEndPointLog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentEndPointLog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentEndPointLog&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentEndPointLog
```
Above example returns the list of EquipmentEndPointLog.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentEndPointLog -Name "MoName"
```
Above example returns the EquipmentEndPointLog matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentEndPointLog -Organization $organization
```
Above example returns the list of EquipmentEndPointLog available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentEndPointLog -InlineCount allpages
```
Above example returns the list of EquipmentEndPointLog along with count.
...
### -Name
Specifies the name of the EquipmentEndPointLog.
...
### -Organization
Specifies the organization, to fetch the EquipmentEndPointLog under it.
