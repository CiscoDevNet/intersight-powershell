...
## SYNOPSIS
Get the FirmwareDriveDescriptor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareDriveDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareDriveDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareDriveDescriptor
```
Above example returns the list of FirmwareDriveDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareDriveDescriptor -Name "MoName"
```
Above example returns the FirmwareDriveDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareDriveDescriptor -Organization $organization
```
Above example returns the list of FirmwareDriveDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareDriveDescriptor -InlineCount allpages
```
Above example returns the list of FirmwareDriveDescriptor along with count.
...
### -Name
Specifies the name of the FirmwareDriveDescriptor.
...
### -Organization
Specifies the organization, to fetch the FirmwareDriveDescriptor under it.
