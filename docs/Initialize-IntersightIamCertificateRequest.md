...
# Initialize-IntersightIamCertificateRequest
...
Initialize-IntersightIamCertificateRequest [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Certificate< Model.IamCertificateRelationship>][-ClassId< IamCertificateRequest.ClassIdEnum>][-EmailAddress< string>][-Moid< string>][-Name< string>][-ObjectType< IamCertificateRequest.ObjectTypeEnum>][-PrivateKeySpec< Model.IamPrivateKeySpecRelationship>][-SelfSigned< bool>][-Subject< Model.PkixDistinguishedName>][-SubjectAlternateName< Model.PkixSubjectAlternateName>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: Model.IamCertificateRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IamCertificateRequest.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IamCertificateRequest.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.IamPrivateKeySpecRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.PkixDistinguishedName
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.PkixSubjectAlternateName
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIamCertificateRequest
```
