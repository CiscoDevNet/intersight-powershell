...
Initialize-IntersightBootSan [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Bootloader< Model.BootBootloader>][-ClassId< BootSan.ClassIdEnum>][-Enabled< bool>][-InterfaceName< string>][-Lun< long>][-Name< string>][-ObjectType< BootSan.ObjectTypeEnum>][-Slot< string>][-Wwpn< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> Initialize-IntersightBootSan
```
