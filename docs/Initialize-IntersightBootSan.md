...
Initialize-IntersightBootSan [-AdditionalProperties< Dictionary<string,object>>][-Bootloader< Model.BootBootloader>][-ClassId< BootSan.ClassIdEnum>][-Enabled< bool>][-InterfaceName< string>][-Lun< long>][-Name< string>][-ObjectType< BootSan.ObjectTypeEnum>][-Slot< string>][-Wwpn< string>]
