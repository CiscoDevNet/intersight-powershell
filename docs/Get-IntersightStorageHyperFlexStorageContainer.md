...
## SYNOPSIS
Get the StorageHyperFlexStorageContainer

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHyperFlexStorageContainer [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHyperFlexStorageContainer [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHyperFlexStorageContainer&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHyperFlexStorageContainer
```
Above example returns the list of StorageHyperFlexStorageContainer.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHyperFlexStorageContainer -Name "MoName"
```
Above example returns the StorageHyperFlexStorageContainer matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHyperFlexStorageContainer -Organization $organization
```
Above example returns the list of StorageHyperFlexStorageContainer available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHyperFlexStorageContainer -InlineCount allpages
```
Above example returns the list of StorageHyperFlexStorageContainer along with count.
...
### -Name
Specifies the name of the StorageHyperFlexStorageContainer.
...
### -Organization
Specifies the organization, to fetch the StorageHyperFlexStorageContainer under it.
