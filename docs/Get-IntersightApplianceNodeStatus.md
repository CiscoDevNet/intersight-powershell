...
## SYNOPSIS
Get the ApplianceNodeStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceNodeStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceNodeStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceNodeStatus
```
Above example returns the list of ApplianceNodeStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceNodeStatus -Name "MoName"
```
Above example returns the ApplianceNodeStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceNodeStatus -Organization $organization
```
Above example returns the list of ApplianceNodeStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceNodeStatus -InlineCount allpages
```
Above example returns the list of ApplianceNodeStatus along with count.
...
### -Name
Specifies the name of the ApplianceNodeStatus.
...
### -Organization
Specifies the organization, to fetch the ApplianceNodeStatus under it.
