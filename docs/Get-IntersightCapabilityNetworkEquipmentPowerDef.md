...
# Get-IntersightCapabilityNetworkEquipmentPowerDef

## SYNOPSIS
Get the CapabilityNetworkEquipmentPowerDef

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityNetworkEquipmentPowerDef [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityNetworkEquipmentPowerDef [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilityNetworkEquipmentPowerDef&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityNetworkEquipmentPowerDef
```
Above example returns the list of CapabilityNetworkEquipmentPowerDef.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityNetworkEquipmentPowerDef -Name "MoName"
```
Above example returns the CapabilityNetworkEquipmentPowerDef matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityNetworkEquipmentPowerDef -Organization $organization
```
Above example returns the list of CapabilityNetworkEquipmentPowerDef available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityNetworkEquipmentPowerDef -InlineCount allpages
```
Above example returns the list of CapabilityNetworkEquipmentPowerDef along with count.
...
### -Name
Specifies the name of the CapabilityNetworkEquipmentPowerDef.
...
### -Organization
Specifies the organization, to fetch the CapabilityNetworkEquipmentPowerDef under it.
