...
## SYNOPSIS
Get the FirmwareStorageControllerDescriptor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareStorageControllerDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareStorageControllerDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareStorageControllerDescriptor
```
Above example returns the list of FirmwareStorageControllerDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareStorageControllerDescriptor -Name "MoName"
```
Above example returns the FirmwareStorageControllerDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareStorageControllerDescriptor -Organization $organization
```
Above example returns the list of FirmwareStorageControllerDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareStorageControllerDescriptor -InlineCount allpages
```
Above example returns the list of FirmwareStorageControllerDescriptor along with count.
...
### -Name
Specifies the name of the FirmwareStorageControllerDescriptor.
...
### -Organization
Specifies the organization, to fetch the FirmwareStorageControllerDescriptor under it.
