...
## SYNOPSIS
Get the ServerConfigImport

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightServerConfigImport [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightServerConfigImport [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;ServerConfigImport&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightServerConfigImport
```
Above example returns the list of ServerConfigImport.

### Example 2
```powershell
PS C:\> $result = Get-IntersightServerConfigImport -Name "MoName"
```
Above example returns the ServerConfigImport matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightServerConfigImport -Organization $organization
```
Above example returns the list of ServerConfigImport available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightServerConfigImport -InlineCount allpages
```
Above example returns the list of ServerConfigImport along with count.
...
### -Name
Specifies the name of the ServerConfigImport.
...
### -Organization
Specifies the organization, to fetch the ServerConfigImport under it.
...
[New-IntersightServerConfigImport](./New-IntersightServerConfigImport.md)
