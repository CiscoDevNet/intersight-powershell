...
```powershell
$CapabilitySiocModuleManufacturingDef = Initialize-IntersightCapabilitySiocModuleManufacturingDef  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$CapabilitySiocModuleManufacturingDef | ConvertTo-JSON
```
