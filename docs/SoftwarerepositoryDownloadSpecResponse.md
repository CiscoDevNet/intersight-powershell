...
```powershell
$SoftwarerepositoryDownloadSpecResponse = Initialize-IntersightSoftwarerepositoryDownloadSpecResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwarerepositoryDownloadSpecResponse | ConvertTo-JSON
```
