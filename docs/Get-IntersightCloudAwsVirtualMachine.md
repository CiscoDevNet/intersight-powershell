...
### CmdletParam (Default)
```
Get-IntersightCloudAwsVirtualMachine [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudAwsVirtualMachine [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudAwsVirtualMachine
```
Above example returns the list of CloudAwsVirtualMachine.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudAwsVirtualMachine -Name "MoName"
```
Above example returns the CloudAwsVirtualMachine matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudAwsVirtualMachine -Organization $organization
```
Above example returns the list of CloudAwsVirtualMachine available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudAwsVirtualMachine -InlineCount allpages
```
Above example returns the list of CloudAwsVirtualMachine along with count.
...
### -Name
Specifies the name of the CloudAwsVirtualMachine.
...
### -Organization
Specifies the organization, to fetch the CloudAwsVirtualMachine under it.
