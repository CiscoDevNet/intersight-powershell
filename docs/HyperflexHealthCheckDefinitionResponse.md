...
```powershell
$HyperflexHealthCheckDefinitionResponse = Initialize-IntersightHyperflexHealthCheckDefinitionResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexHealthCheckDefinitionResponse | ConvertTo-JSON
```
