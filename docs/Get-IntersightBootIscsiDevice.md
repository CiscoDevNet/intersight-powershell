...
# Get-IntersightBootIscsiDevice

## SYNOPSIS
Get the BootIscsiDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBootIscsiDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBootIscsiDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;BootIscsiDevice&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBootIscsiDevice
```
Above example returns the list of BootIscsiDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBootIscsiDevice -Name "MoName"
```
Above example returns the BootIscsiDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBootIscsiDevice -Organization $organization
```
Above example returns the list of BootIscsiDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBootIscsiDevice -InlineCount allpages
```
Above example returns the list of BootIscsiDevice along with count.
...
### -Name
Specifies the name of the BootIscsiDevice.
...
### -Organization
Specifies the organization, to fetch the BootIscsiDevice under it.
...
[Set-IntersightBootIscsiDevice](./Set-IntersightBootIscsiDevice.md)
