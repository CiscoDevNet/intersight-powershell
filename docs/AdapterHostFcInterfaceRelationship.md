...
```powershell
$AdapterHostFcInterfaceRelationship = Initialize-IntersightAdapterHostFcInterfaceRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$AdapterHostFcInterfaceRelationship | ConvertTo-JSON
```
