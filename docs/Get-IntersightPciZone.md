...
### CmdletParam (Default)
```
Get-IntersightPciZone [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPciZone [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PciZone&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPciZone
```
Above example returns the list of PciZone.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPciZone -Name "MoName"
```
Above example returns the PciZone matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPciZone -Organization $organization
```
Above example returns the list of PciZone available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPciZone -InlineCount allpages
```
Above example returns the list of PciZone along with count.
...
### -Name
Specifies the name of the PciZone.
...
### -Organization
Specifies the organization, to fetch the PciZone under it.
