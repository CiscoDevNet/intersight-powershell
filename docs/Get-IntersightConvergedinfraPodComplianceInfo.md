...
### CmdletParam (Default)
```
Get-IntersightConvergedinfraPodComplianceInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightConvergedinfraPodComplianceInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
