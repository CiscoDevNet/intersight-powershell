...
# Initialize-IntersightStorageFlexFlashPhysicalDrive
...
```yaml
Type: StorageFlexFlashPhysicalDrive.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: StorageFlexFlashPhysicalDrive.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightStorageFlexFlashPhysicalDrive
```
