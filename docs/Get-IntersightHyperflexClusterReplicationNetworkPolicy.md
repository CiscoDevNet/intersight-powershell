...
## SYNOPSIS
Get the HyperflexClusterReplicationNetworkPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexClusterReplicationNetworkPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexClusterReplicationNetworkPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexClusterReplicationNetworkPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterReplicationNetworkPolicy
```
Above example returns the list of HyperflexClusterReplicationNetworkPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterReplicationNetworkPolicy -Name "MoName"
```
Above example returns the HyperflexClusterReplicationNetworkPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterReplicationNetworkPolicy -Organization $organization
```
Above example returns the list of HyperflexClusterReplicationNetworkPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterReplicationNetworkPolicy -InlineCount allpages
```
Above example returns the list of HyperflexClusterReplicationNetworkPolicy along with count.
...
### -Name
Specifies the name of the HyperflexClusterReplicationNetworkPolicy.
...
### -Organization
Specifies the organization, to fetch the HyperflexClusterReplicationNetworkPolicy under it.
