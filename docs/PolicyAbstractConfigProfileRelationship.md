...
```powershell
$PolicyAbstractConfigProfileRelationship = Initialize-IntersightPolicyAbstractConfigProfileRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$PolicyAbstractConfigProfileRelationship | ConvertTo-JSON
```
