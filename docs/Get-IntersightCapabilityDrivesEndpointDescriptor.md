...
### CmdletParam (Default)
```
Get-IntersightCapabilityDrivesEndpointDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityDrivesEndpointDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityDrivesEndpointDescriptor
```
Above example returns the list of CapabilityDrivesEndpointDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityDrivesEndpointDescriptor -Name "MoName"
```
Above example returns the CapabilityDrivesEndpointDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityDrivesEndpointDescriptor -Organization $organization
```
Above example returns the list of CapabilityDrivesEndpointDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityDrivesEndpointDescriptor -InlineCount allpages
```
Above example returns the list of CapabilityDrivesEndpointDescriptor along with count.
...
### -Name
Specifies the name of the CapabilityDrivesEndpointDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilityDrivesEndpointDescriptor under it.
