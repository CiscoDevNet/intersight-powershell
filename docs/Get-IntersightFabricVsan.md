...
### CmdletParam (Default)
```
Get-IntersightFabricVsan [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricVsan [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricVsan
```
Above example returns the list of FabricVsan.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricVsan -Name "MoName"
```
Above example returns the FabricVsan matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricVsan -Organization $organization
```
Above example returns the list of FabricVsan available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricVsan -InlineCount allpages
```
Above example returns the list of FabricVsan along with count.
...
### -Name
Specifies the name of the FabricVsan.
...
### -Organization
Specifies the organization, to fetch the FabricVsan under it.
