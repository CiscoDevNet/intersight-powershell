...
## SYNOPSIS
Get the ApplianceDeviceUpgradePolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceDeviceUpgradePolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceDeviceUpgradePolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceUpgradePolicy
```
Above example returns the list of ApplianceDeviceUpgradePolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceUpgradePolicy -Name "MoName"
```
Above example returns the ApplianceDeviceUpgradePolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceUpgradePolicy -Organization $organization
```
Above example returns the list of ApplianceDeviceUpgradePolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceUpgradePolicy -InlineCount allpages
```
Above example returns the list of ApplianceDeviceUpgradePolicy along with count.
...
### -Name
Specifies the name of the ApplianceDeviceUpgradePolicy.
...
### -Organization
Specifies the organization, to fetch the ApplianceDeviceUpgradePolicy under it.
...
[Set-IntersightApplianceDeviceUpgradePolicy](./Set-IntersightApplianceDeviceUpgradePolicy.md)
