...
## SYNOPSIS
Get the RecoveryConfigResultEntry

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRecoveryConfigResultEntry [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRecoveryConfigResultEntry [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;RecoveryConfigResultEntry&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRecoveryConfigResultEntry
```
Above example returns the list of RecoveryConfigResultEntry.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRecoveryConfigResultEntry -Name "MoName"
```
Above example returns the RecoveryConfigResultEntry matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRecoveryConfigResultEntry -Organization $organization
```
Above example returns the list of RecoveryConfigResultEntry available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRecoveryConfigResultEntry -InlineCount allpages
```
Above example returns the list of RecoveryConfigResultEntry along with count.
...
### -Name
Specifies the name of the RecoveryConfigResultEntry.
...
### -Organization
Specifies the organization, to fetch the RecoveryConfigResultEntry under it.
