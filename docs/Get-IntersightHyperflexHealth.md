...
## SYNOPSIS
Get the HyperflexHealth

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHealth [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHealth [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHealth
```
Above example returns the list of HyperflexHealth.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHealth -Name "MoName"
```
Above example returns the HyperflexHealth matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHealth -Organization $organization
```
Above example returns the list of HyperflexHealth available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHealth -InlineCount allpages
```
Above example returns the list of HyperflexHealth along with count.
...
### -Name
Specifies the name of the HyperflexHealth.
...
### -Organization
Specifies the organization, to fetch the HyperflexHealth under it.
