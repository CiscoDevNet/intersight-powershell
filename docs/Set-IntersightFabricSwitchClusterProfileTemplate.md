...
# Set-IntersightFabricSwitchClusterProfileTemplate
...
## DESCRIPTION
Update a &apos;FabricSwitchClusterProfileTemplate&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightFabricSwitchClusterProfileTemplate
```
