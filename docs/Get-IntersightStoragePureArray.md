...
## SYNOPSIS
Get the StoragePureArray

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureArray [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureArray [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureArray&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureArray
```
Above example returns the list of StoragePureArray.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureArray -Name "MoName"
```
Above example returns the StoragePureArray matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureArray -Organization $organization
```
Above example returns the list of StoragePureArray available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureArray -InlineCount allpages
```
Above example returns the list of StoragePureArray along with count.
...
### -Name
Specifies the name of the StoragePureArray.
...
### -Organization
Specifies the organization, to fetch the StoragePureArray under it.
...
[Set-IntersightStoragePureArray](./Set-IntersightStoragePureArray.md)
