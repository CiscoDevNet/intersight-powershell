...
## SYNOPSIS
Get the CloudAwsBillingUnit

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudAwsBillingUnit [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudAwsBillingUnit [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudAwsBillingUnit
```
Above example returns the list of CloudAwsBillingUnit.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudAwsBillingUnit -Name "MoName"
```
Above example returns the CloudAwsBillingUnit matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudAwsBillingUnit -Organization $organization
```
Above example returns the list of CloudAwsBillingUnit available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudAwsBillingUnit -InlineCount allpages
```
Above example returns the list of CloudAwsBillingUnit along with count.
...
### -Name
Specifies the name of the CloudAwsBillingUnit.
...
### -Organization
Specifies the organization, to fetch the CloudAwsBillingUnit under it.
