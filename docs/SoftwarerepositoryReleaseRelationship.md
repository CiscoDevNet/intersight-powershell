...
```powershell
$SoftwarerepositoryReleaseRelationship = Initialize-IntersightSoftwarerepositoryReleaseRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$SoftwarerepositoryReleaseRelationship | ConvertTo-JSON
```
