...
## SYNOPSIS
Get the NiatelemetryHttpsAclContractDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryHttpsAclContractDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryHttpsAclContractDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryHttpsAclContractDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclContractDetails
```
Above example returns the list of NiatelemetryHttpsAclContractDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclContractDetails -Name "MoName"
```
Above example returns the NiatelemetryHttpsAclContractDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclContractDetails -Organization $organization
```
Above example returns the list of NiatelemetryHttpsAclContractDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclContractDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryHttpsAclContractDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryHttpsAclContractDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryHttpsAclContractDetails under it.
