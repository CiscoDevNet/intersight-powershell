...
## SYNOPSIS
Get the SoftwarerepositoryCategorySupportConstraint

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwarerepositoryCategorySupportConstraint [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwarerepositoryCategorySupportConstraint [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SoftwarerepositoryCategorySupportConstraint&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategorySupportConstraint
```
Above example returns the list of SoftwarerepositoryCategorySupportConstraint.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategorySupportConstraint -Name "MoName"
```
Above example returns the SoftwarerepositoryCategorySupportConstraint matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategorySupportConstraint -Organization $organization
```
Above example returns the list of SoftwarerepositoryCategorySupportConstraint available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategorySupportConstraint -InlineCount allpages
```
Above example returns the list of SoftwarerepositoryCategorySupportConstraint along with count.
...
### -Name
Specifies the name of the SoftwarerepositoryCategorySupportConstraint.
...
### -Organization
Specifies the organization, to fetch the SoftwarerepositoryCategorySupportConstraint under it.
