...
# Get-IntersightNiaapiApicSweol

## SYNOPSIS
Get the NiaapiApicSweol

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiApicSweol [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiApicSweol [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiaapiApicSweol&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiApicSweol
```
Above example returns the list of NiaapiApicSweol.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiApicSweol -Name "MoName"
```
Above example returns the NiaapiApicSweol matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiApicSweol -Organization $organization
```
Above example returns the list of NiaapiApicSweol available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiApicSweol -InlineCount allpages
```
Above example returns the list of NiaapiApicSweol along with count.
...
### -Name
Specifies the name of the NiaapiApicSweol.
...
### -Organization
Specifies the organization, to fetch the NiaapiApicSweol under it.
