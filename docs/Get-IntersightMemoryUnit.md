...
### CmdletParam (Default)
```
Get-IntersightMemoryUnit [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMemoryUnit [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MemoryUnit&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMemoryUnit
```
Above example returns the list of MemoryUnit.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMemoryUnit -Name "MoName"
```
Above example returns the MemoryUnit matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMemoryUnit -Organization $organization
```
Above example returns the list of MemoryUnit available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMemoryUnit -InlineCount allpages
```
Above example returns the list of MemoryUnit along with count.
...
### -Name
Specifies the name of the MemoryUnit.
...
### -Organization
Specifies the organization, to fetch the MemoryUnit under it.
...
[Set-IntersightMemoryUnit](./Set-IntersightMemoryUnit.md)
