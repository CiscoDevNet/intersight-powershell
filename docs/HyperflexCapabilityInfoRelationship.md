...
```powershell
$HyperflexCapabilityInfoRelationship = Initialize-IntersightHyperflexCapabilityInfoRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexCapabilityInfoRelationship | ConvertTo-JSON
```
