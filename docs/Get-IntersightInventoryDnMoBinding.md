...
## SYNOPSIS
Get the InventoryDnMoBinding

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightInventoryDnMoBinding [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightInventoryDnMoBinding [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;InventoryDnMoBinding&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightInventoryDnMoBinding
```
Above example returns the list of InventoryDnMoBinding.

### Example 2
```powershell
PS C:\> $result = Get-IntersightInventoryDnMoBinding -Name "MoName"
```
Above example returns the InventoryDnMoBinding matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightInventoryDnMoBinding -Organization $organization
```
Above example returns the list of InventoryDnMoBinding available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightInventoryDnMoBinding -InlineCount allpages
```
Above example returns the list of InventoryDnMoBinding along with count.
...
### -Name
Specifies the name of the InventoryDnMoBinding.
...
### -Organization
Specifies the organization, to fetch the InventoryDnMoBinding under it.
