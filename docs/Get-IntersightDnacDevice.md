...
### CmdletParam (Default)
```
Get-IntersightDnacDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightDnacDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;DnacDevice&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightDnacDevice
```
Above example returns the list of DnacDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightDnacDevice -Name "MoName"
```
Above example returns the DnacDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightDnacDevice -Organization $organization
```
Above example returns the list of DnacDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightDnacDevice -InlineCount allpages
```
Above example returns the list of DnacDevice along with count.
...
### -Name
Specifies the name of the DnacDevice.
...
### -Organization
Specifies the organization, to fetch the DnacDevice under it.
