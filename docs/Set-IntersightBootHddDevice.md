...
Set-IntersightBootHddDevice [-AdditionalProperties< Dictionary<string,object>>][-ComputePhysical< ComputePhysicalRelationship>][[-Moid]< string>][-Name< string>][-Order< long>][-PreviousFru< EquipmentFruRelationship>][-State< string>][-Tags< List<MoTag>>][-Type< string>]
