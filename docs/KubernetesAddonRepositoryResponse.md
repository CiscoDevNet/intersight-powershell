...
```powershell
$KubernetesAddonRepositoryResponse = Initialize-IntersightKubernetesAddonRepositoryResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$KubernetesAddonRepositoryResponse | ConvertTo-JSON
```
