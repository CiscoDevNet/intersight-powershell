...
## SYNOPSIS
Get the WorkflowSolutionDefinition

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowSolutionDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowSolutionDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowSolutionDefinition&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionDefinition
```
Above example returns the list of WorkflowSolutionDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionDefinition -Name "MoName"
```
Above example returns the WorkflowSolutionDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionDefinition -Organization $organization
```
Above example returns the list of WorkflowSolutionDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionDefinition -InlineCount allpages
```
Above example returns the list of WorkflowSolutionDefinition along with count.
...
### -Name
Specifies the name of the WorkflowSolutionDefinition.
...
### -Organization
Specifies the organization, to fetch the WorkflowSolutionDefinition under it.
