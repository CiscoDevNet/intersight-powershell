...
New-IntersightIamUser [-AdditionalProperties< Dictionary<string,object>>][-Email< string>][-Idp< IamIdpRelationship>][-Idpreference< IamIdpReferenceRelationship>][-Moid< string>][-Permissions< List<IamPermissionRelationship>>][-Tags< List<MoTag>>][-UserIdOrEmail< string>]
