...
Initialize-IntersightStorageSpanDrives [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< StorageSpanDrives.ClassIdEnum>][-ObjectType< StorageSpanDrives.ObjectTypeEnum>][-Slots< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
