...
# Get-IntersightIamServiceProvider

## SYNOPSIS
Get the IamServiceProvider

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamServiceProvider [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamServiceProvider [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamServiceProvider&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamServiceProvider
```
Above example returns the list of IamServiceProvider.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamServiceProvider -Name "MoName"
```
Above example returns the IamServiceProvider matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamServiceProvider -Organization $organization
```
Above example returns the list of IamServiceProvider available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamServiceProvider -InlineCount allpages
```
Above example returns the list of IamServiceProvider along with count.
...
### -Name
Specifies the name of the IamServiceProvider.
...
### -Organization
Specifies the organization, to fetch the IamServiceProvider under it.
