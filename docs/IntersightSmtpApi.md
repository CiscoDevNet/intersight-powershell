# Intersight.Intersight/Api.IntersightSmtpApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**New-IntersightSmtpPolicy**](IntersightSmtpApi.md#New-IntersightSmtpPolicy) | **POST** /api/v1/smtp/Policies | Create a &#39;smtp.Policy&#39; resource.
[**Remove-IntersightSmtpPolicy**](IntersightSmtpApi.md#Remove-IntersightSmtpPolicy) | **DELETE** /api/v1/smtp/Policies/{Moid} | Delete a &#39;smtp.Policy&#39; resource.
[**Get-IntersightSmtpPolicyByMoid**](IntersightSmtpApi.md#Get-IntersightSmtpPolicyByMoid) | **GET** /api/v1/smtp/Policies/{Moid} | Read a &#39;smtp.Policy&#39; resource.
[**Get-IntersightSmtpPolicyList**](IntersightSmtpApi.md#Get-IntersightSmtpPolicyList) | **GET** /api/v1/smtp/Policies | Read a &#39;smtp.Policy&#39; resource.
[**Set-IntersightSmtpPolicy**](IntersightSmtpApi.md#Set-IntersightSmtpPolicy) | **PATCH** /api/v1/smtp/Policies/{Moid} | Update a &#39;smtp.Policy&#39; resource.
[**Update-IntersightSmtpPolicy**](IntersightSmtpApi.md#Update-IntersightSmtpPolicy) | **POST** /api/v1/smtp/Policies/{Moid} | Update a &#39;smtp.Policy&#39; resource.


<a name="New-IntersightSmtpPolicy"></a>
# **New-IntersightSmtpPolicy**
> SmtpPolicy New-IntersightSmtpPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SmtpPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Create a 'smtp.Policy' resource.
try {
     $Result = New-IntersightSmtpPolicy -SmtpPolicy $SmtpPolicy -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
    Write-Host ("Exception occured when calling New-IntersightSmtpPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a name="Remove-IntersightSmtpPolicy"></a>
# **Remove-IntersightSmtpPolicy**
> void Remove-IntersightSmtpPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'smtp.Policy' resource.
try {
     $Result = Remove-IntersightSmtpPolicy -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightSmtpPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightSmtpPolicyByMoid"></a>
# **Get-IntersightSmtpPolicyByMoid**
> SmtpPolicy Get-IntersightSmtpPolicyByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'smtp.Policy' resource.
try {
     $Result = Get-IntersightSmtpPolicyByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightSmtpPolicyByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightSmtpPolicyList"></a>
# **Get-IntersightSmtpPolicyList**
> SmtpPolicyResponse Get-IntersightSmtpPolicyList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'smtp.Policy' resource.
try {
     $Result = Get-IntersightSmtpPolicyList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightSmtpPolicyList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightSmtpPolicy"></a>
# **Set-IntersightSmtpPolicy**
> SmtpPolicy Set-IntersightSmtpPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SmtpPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$SmtpPolicy = (Initialize-smtp.Policy-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -Enabled $false -MinSeverity "MinSeverity_example" -SenderEmail "SenderEmail_example" -SmtpPort 123 -SmtpRecipients @("SmtpRecipients_example") -SmtpServer "SmtpServer_example" -Organization  -Profiles @()) # SmtpPolicy | The 'smtp.Policy' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'smtp.Policy' resource.
try {
     $Result = Set-IntersightSmtpPolicy -Moid $Moid -SmtpPolicy $SmtpPolicy -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightSmtpPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightSmtpPolicy"></a>
# **Update-IntersightSmtpPolicy**
> SmtpPolicy Update-IntersightSmtpPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SmtpPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$SmtpPolicy =  # SmtpPolicy | The 'smtp.Policy' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'smtp.Policy' resource.
try {
     $Result = Update-IntersightSmtpPolicy -Moid $Moid -SmtpPolicy $SmtpPolicy -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightSmtpPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
