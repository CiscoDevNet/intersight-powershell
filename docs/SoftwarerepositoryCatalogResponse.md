...
```powershell
$SoftwarerepositoryCatalogResponse = Initialize-IntersightSoftwarerepositoryCatalogResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwarerepositoryCatalogResponse | ConvertTo-JSON
```
