...
## SYNOPSIS
Get the StoragePhysicalDiskUsage

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePhysicalDiskUsage [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePhysicalDiskUsage [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePhysicalDiskUsage&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePhysicalDiskUsage
```
Above example returns the list of StoragePhysicalDiskUsage.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePhysicalDiskUsage -Name "MoName"
```
Above example returns the StoragePhysicalDiskUsage matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePhysicalDiskUsage -Organization $organization
```
Above example returns the list of StoragePhysicalDiskUsage available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePhysicalDiskUsage -InlineCount allpages
```
Above example returns the list of StoragePhysicalDiskUsage along with count.
...
### -Name
Specifies the name of the StoragePhysicalDiskUsage.
...
### -Organization
Specifies the organization, to fetch the StoragePhysicalDiskUsage under it.
...
[Set-IntersightStoragePhysicalDiskUsage](./Set-IntersightStoragePhysicalDiskUsage.md)
