...
# Get-IntersightNiatelemetrySpinePolGrpDetails

## SYNOPSIS
Get the NiatelemetrySpinePolGrpDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetrySpinePolGrpDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetrySpinePolGrpDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetrySpinePolGrpDetails&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySpinePolGrpDetails
```
Above example returns the list of NiatelemetrySpinePolGrpDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySpinePolGrpDetails -Name "MoName"
```
Above example returns the NiatelemetrySpinePolGrpDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySpinePolGrpDetails -Organization $organization
```
Above example returns the list of NiatelemetrySpinePolGrpDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySpinePolGrpDetails -InlineCount allpages
```
Above example returns the list of NiatelemetrySpinePolGrpDetails along with count.
...
### -Name
Specifies the name of the NiatelemetrySpinePolGrpDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetrySpinePolGrpDetails under it.
