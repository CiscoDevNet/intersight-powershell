...
# Initialize-IntersightFabricFcStorageRole
...
```yaml
Type: FabricFcStorageRole.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricFcStorageRole.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFabricFcStorageRole
```
