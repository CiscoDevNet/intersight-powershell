...
## SYNOPSIS
Get the NiatelemetryMsoTenantDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryMsoTenantDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryMsoTenantDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoTenantDetails
```
Above example returns the list of NiatelemetryMsoTenantDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoTenantDetails -Name "MoName"
```
Above example returns the NiatelemetryMsoTenantDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoTenantDetails -Organization $organization
```
Above example returns the list of NiatelemetryMsoTenantDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoTenantDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryMsoTenantDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryMsoTenantDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryMsoTenantDetails under it.
