...
## SYNOPSIS
Get the OsConfigurationFile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOsConfigurationFile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOsConfigurationFile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;OsConfigurationFile&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOsConfigurationFile
```
Above example returns the list of OsConfigurationFile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOsConfigurationFile -Name "MoName"
```
Above example returns the OsConfigurationFile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOsConfigurationFile -Organization $organization
```
Above example returns the list of OsConfigurationFile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOsConfigurationFile -InlineCount allpages
```
Above example returns the list of OsConfigurationFile along with count.
...
### -Name
Specifies the name of the OsConfigurationFile.
...
### -Organization
Specifies the organization, to fetch the OsConfigurationFile under it.
