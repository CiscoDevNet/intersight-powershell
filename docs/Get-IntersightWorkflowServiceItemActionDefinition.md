...
# Get-IntersightWorkflowServiceItemActionDefinition

## SYNOPSIS
Get the WorkflowServiceItemActionDefinition

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowServiceItemActionDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowServiceItemActionDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowServiceItemActionDefinition&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemActionDefinition
```
Above example returns the list of WorkflowServiceItemActionDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemActionDefinition -Name "MoName"
```
Above example returns the WorkflowServiceItemActionDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemActionDefinition -Organization $organization
```
Above example returns the list of WorkflowServiceItemActionDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemActionDefinition -InlineCount allpages
```
Above example returns the list of WorkflowServiceItemActionDefinition along with count.
...
### -Name
Specifies the name of the WorkflowServiceItemActionDefinition.
...
### -Organization
Specifies the organization, to fetch the WorkflowServiceItemActionDefinition under it.
