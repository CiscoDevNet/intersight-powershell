...
# Initialize-IntersightWorkflowOperationTypeDeployment
...
Initialize-IntersightWorkflowOperationTypeDeployment [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< WorkflowOperationTypeDeployment.ClassIdEnum>][-ObjectType< WorkflowOperationTypeDeployment.ObjectTypeEnum>][-OperationType< WorkflowOperationTypeDeployment.OperationTypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowOperationTypeDeployment.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowOperationTypeDeployment.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowOperationTypeDeployment.OperationTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowOperationTypeDeployment
```
