...
```powershell
$NiatelemetryNexusDashboardsResponse = Initialize-IntersightNiatelemetryNexusDashboardsResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiatelemetryNexusDashboardsResponse | ConvertTo-JSON
```
