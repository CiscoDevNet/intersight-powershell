...
## SYNOPSIS
Get the OrganizationOrganization

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOrganizationOrganization [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOrganizationOrganization [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOrganizationOrganization
```
Above example returns the list of OrganizationOrganization.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOrganizationOrganization -Name "MoName"
```
Above example returns the OrganizationOrganization matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOrganizationOrganization -Organization $organization
```
Above example returns the list of OrganizationOrganization available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOrganizationOrganization -InlineCount allpages
```
Above example returns the list of OrganizationOrganization along with count.
...
### -Name
Specifies the name of the OrganizationOrganization.
...
### -Organization
Specifies the organization, to fetch the OrganizationOrganization under it.
