...
### CmdletParam (Default)
```
Get-IntersightCapabilityFanModuleManufacturingDef [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityFanModuleManufacturingDef [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityFanModuleManufacturingDef
```
Above example returns the list of CapabilityFanModuleManufacturingDef.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityFanModuleManufacturingDef -Name "MoName"
```
Above example returns the CapabilityFanModuleManufacturingDef matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityFanModuleManufacturingDef -Organization $organization
```
Above example returns the list of CapabilityFanModuleManufacturingDef available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityFanModuleManufacturingDef -InlineCount allpages
```
Above example returns the list of CapabilityFanModuleManufacturingDef along with count.
...
### -Name
Specifies the name of the CapabilityFanModuleManufacturingDef.
...
### -Organization
Specifies the organization, to fetch the CapabilityFanModuleManufacturingDef under it.
