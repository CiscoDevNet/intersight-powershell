...
```powershell
$NiatelemetryMsoTenantDetailsResponse = Initialize-IntersightNiatelemetryMsoTenantDetailsResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiatelemetryMsoTenantDetailsResponse | ConvertTo-JSON
```
