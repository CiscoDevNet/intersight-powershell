...
# Initialize-IntersightAccessPolicy
...
Initialize-IntersightAccessPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AddressType< Model.AccessAddressType>][-ClassId< AccessPolicy.ClassIdEnum>][-ConfigurationType< Model.AccessConfigurationType>][-Description< string>][-InbandIpPool< Model.IppoolPoolRelationship>][-InbandVlan< long>][-InbandVrf< Model.VrfVrfRelationship>][-Moid< string>][-Name< string>][-ObjectType< AccessPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-OutOfBandIpPool< Model.IppoolPoolRelationship>][-OutOfBandVrf< Model.VrfVrfRelationship>][-Profiles< System.Collections.Generic.List`1[Model.PolicyAbstractConfigProfileRelationship]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: Model.AccessConfigurationType
Parameter Sets: (All)
Aliases:
...
```yaml
Type: AccessPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightAccessPolicy
```
