...
# Get-IntersightAssetDeployment

## SYNOPSIS
Get the AssetDeployment

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAssetDeployment [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAssetDeployment [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAssetDeployment
```
Above example returns the list of AssetDeployment.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAssetDeployment -Name "MoName"
```
Above example returns the AssetDeployment matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAssetDeployment -Organization $organization
```
Above example returns the list of AssetDeployment available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAssetDeployment -InlineCount allpages
```
Above example returns the list of AssetDeployment along with count.
...
### -Name
Specifies the name of the AssetDeployment.
...
### -Organization
Specifies the organization, to fetch the AssetDeployment under it.
...
[Remove-IntersightAssetDeployment](./Remove-IntersightAssetDeployment.md)
