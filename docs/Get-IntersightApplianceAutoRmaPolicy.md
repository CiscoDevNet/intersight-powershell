...
## SYNOPSIS
Get the ApplianceAutoRmaPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceAutoRmaPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceAutoRmaPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceAutoRmaPolicy
```
Above example returns the list of ApplianceAutoRmaPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceAutoRmaPolicy -Name "MoName"
```
Above example returns the ApplianceAutoRmaPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceAutoRmaPolicy -Organization $organization
```
Above example returns the list of ApplianceAutoRmaPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceAutoRmaPolicy -InlineCount allpages
```
Above example returns the list of ApplianceAutoRmaPolicy along with count.
...
### -Name
Specifies the name of the ApplianceAutoRmaPolicy.
...
### -Organization
Specifies the organization, to fetch the ApplianceAutoRmaPolicy under it.
