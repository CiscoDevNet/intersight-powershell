...
### CmdletParam (Default)
```
Get-IntersightFabricFcUplinkPcRole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricFcUplinkPcRole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricFcUplinkPcRole&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricFcUplinkPcRole
```
Above example returns the list of FabricFcUplinkPcRole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricFcUplinkPcRole -Name "MoName"
```
Above example returns the FabricFcUplinkPcRole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricFcUplinkPcRole -Organization $organization
```
Above example returns the list of FabricFcUplinkPcRole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricFcUplinkPcRole -InlineCount allpages
```
Above example returns the list of FabricFcUplinkPcRole along with count.
...
### -Name
Specifies the name of the FabricFcUplinkPcRole.
...
### -Organization
Specifies the organization, to fetch the FabricFcUplinkPcRole under it.
