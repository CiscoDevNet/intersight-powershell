...
# Get-IntersightApplianceClusterWorkerNode

## SYNOPSIS
Get the ApplianceClusterWorkerNode

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceClusterWorkerNode [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceClusterWorkerNode [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceClusterWorkerNode&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceClusterWorkerNode
```
Above example returns the list of ApplianceClusterWorkerNode.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceClusterWorkerNode -Name "MoName"
```
Above example returns the ApplianceClusterWorkerNode matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceClusterWorkerNode -Organization $organization
```
Above example returns the list of ApplianceClusterWorkerNode available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceClusterWorkerNode -InlineCount allpages
```
Above example returns the list of ApplianceClusterWorkerNode along with count.
...
### -Name
Specifies the name of the ApplianceClusterWorkerNode.
...
### -Organization
Specifies the organization, to fetch the ApplianceClusterWorkerNode under it.
...
[New-IntersightApplianceClusterWorkerNode](./New-IntersightApplianceClusterWorkerNode.md)

[Set-IntersightApplianceClusterWorkerNode](./Set-IntersightApplianceClusterWorkerNode.md)
