...
```yaml
Type: ResourcepoolQualificationPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ResourcepoolQualificationPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightResourcepoolQualificationPolicy
```
