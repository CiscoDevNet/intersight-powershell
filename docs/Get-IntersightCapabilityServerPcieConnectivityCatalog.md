...
### CmdletParam (Default)
```
Get-IntersightCapabilityServerPcieConnectivityCatalog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityServerPcieConnectivityCatalog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
