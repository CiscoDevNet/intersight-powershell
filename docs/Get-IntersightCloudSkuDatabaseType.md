...
## SYNOPSIS
Get the CloudSkuDatabaseType

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudSkuDatabaseType [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudSkuDatabaseType [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;CloudSkuDatabaseType&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudSkuDatabaseType
```
Above example returns the list of CloudSkuDatabaseType.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudSkuDatabaseType -Name "MoName"
```
Above example returns the CloudSkuDatabaseType matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudSkuDatabaseType -Organization $organization
```
Above example returns the list of CloudSkuDatabaseType available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudSkuDatabaseType -InlineCount allpages
```
Above example returns the list of CloudSkuDatabaseType along with count.
...
### -Name
Specifies the name of the CloudSkuDatabaseType.
...
### -Organization
Specifies the organization, to fetch the CloudSkuDatabaseType under it.
