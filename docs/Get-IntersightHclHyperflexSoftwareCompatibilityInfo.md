...
## SYNOPSIS
Get the HclHyperflexSoftwareCompatibilityInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHclHyperflexSoftwareCompatibilityInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHclHyperflexSoftwareCompatibilityInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HclHyperflexSoftwareCompatibilityInfo&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHclHyperflexSoftwareCompatibilityInfo
```
Above example returns the list of HclHyperflexSoftwareCompatibilityInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHclHyperflexSoftwareCompatibilityInfo -Name "MoName"
```
Above example returns the HclHyperflexSoftwareCompatibilityInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHclHyperflexSoftwareCompatibilityInfo -Organization $organization
```
Above example returns the list of HclHyperflexSoftwareCompatibilityInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHclHyperflexSoftwareCompatibilityInfo -InlineCount allpages
```
Above example returns the list of HclHyperflexSoftwareCompatibilityInfo along with count.
...
### -Name
Specifies the name of the HclHyperflexSoftwareCompatibilityInfo.
...
### -Organization
Specifies the organization, to fetch the HclHyperflexSoftwareCompatibilityInfo under it.
