...
## SYNOPSIS
Get the FcPortChannel

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFcPortChannel [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFcPortChannel [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;FcPortChannel&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFcPortChannel
```
Above example returns the list of FcPortChannel.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFcPortChannel -Name "MoName"
```
Above example returns the FcPortChannel matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFcPortChannel -Organization $organization
```
Above example returns the list of FcPortChannel available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFcPortChannel -InlineCount allpages
```
Above example returns the list of FcPortChannel along with count.
...
### -Name
Specifies the name of the FcPortChannel.
...
### -Organization
Specifies the organization, to fetch the FcPortChannel under it.
