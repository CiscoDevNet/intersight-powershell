...
```powershell
$VirtualizationBaseHypervisorManagerAllOf = Initialize-IntersightVirtualizationBaseHypervisorManagerAllOf  -ClassId null `
 -ObjectType null `
 -Identity null `
 -Name null `
 -Version null `
...
```powershell
$VirtualizationBaseHypervisorManagerAllOf | ConvertTo-JSON
```
