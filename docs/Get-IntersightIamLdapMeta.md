...
### CmdletParam (Default)
```
Get-IntersightIamLdapMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamLdapMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamLdapMeta&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamLdapMeta
```
Above example returns the list of IamLdapMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamLdapMeta -Name "MoName"
```
Above example returns the IamLdapMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamLdapMeta -Organization $organization
```
Above example returns the list of IamLdapMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamLdapMeta -InlineCount allpages
```
Above example returns the list of IamLdapMeta along with count.
...
### -Name
Specifies the name of the IamLdapMeta.
...
### -Organization
Specifies the organization, to fetch the IamLdapMeta under it.
