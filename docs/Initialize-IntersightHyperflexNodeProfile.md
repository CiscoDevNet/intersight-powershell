...
# Initialize-IntersightHyperflexNodeProfile
...
```yaml
Type: HyperflexNodeProfile.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: HyperflexNodeProfile.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightHyperflexNodeProfile
```
