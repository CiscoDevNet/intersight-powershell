...
# Get-IntersightCondThresholdDefinition

## SYNOPSIS
Get the CondThresholdDefinition

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCondThresholdDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCondThresholdDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CondThresholdDefinition&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCondThresholdDefinition
```
Above example returns the list of CondThresholdDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCondThresholdDefinition -Name "MoName"
```
Above example returns the CondThresholdDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCondThresholdDefinition -Organization $organization
```
Above example returns the list of CondThresholdDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCondThresholdDefinition -InlineCount allpages
```
Above example returns the list of CondThresholdDefinition along with count.
...
### -Name
Specifies the name of the CondThresholdDefinition.
...
### -Organization
Specifies the organization, to fetch the CondThresholdDefinition under it.
...
[Remove-IntersightCondThresholdDefinition](./Remove-IntersightCondThresholdDefinition.md)
