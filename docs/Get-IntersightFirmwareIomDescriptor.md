...
## SYNOPSIS
Get the FirmwareIomDescriptor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareIomDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareIomDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;FirmwareIomDescriptor&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareIomDescriptor
```
Above example returns the list of FirmwareIomDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareIomDescriptor -Name "MoName"
```
Above example returns the FirmwareIomDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareIomDescriptor -Organization $organization
```
Above example returns the list of FirmwareIomDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareIomDescriptor -InlineCount allpages
```
Above example returns the list of FirmwareIomDescriptor along with count.
...
### -Name
Specifies the name of the FirmwareIomDescriptor.
...
### -Organization
Specifies the organization, to fetch the FirmwareIomDescriptor under it.
