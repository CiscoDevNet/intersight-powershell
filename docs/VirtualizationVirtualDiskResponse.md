...
```powershell
$VirtualizationVirtualDiskResponse = Initialize-IntersightVirtualizationVirtualDiskResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$VirtualizationVirtualDiskResponse | ConvertTo-JSON
```
