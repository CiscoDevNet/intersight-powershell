...
# Set-IntersightMgmtConfigBackupFile
...
Set-IntersightMgmtConfigBackupFile [-Account< IamAccountRelationship>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Description< string>][-ImportAction< MgmtConfigBackupFile.ImportActionEnum>][-Md5eTag< string>][-Md5sum< string>][[-Moid]< string>][-Name< string>][-ReleaseDate< DateTime>][-Sha512sum< string>][-Size< long>][-SoftwareAdvisoryUrl< string>][-Source< SoftwarerepositoryFileServer>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Version< string>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;MgmtConfigBackupFile&apos; resource.
...
```yaml
Type: MgmtConfigBackupFile.ImportActionEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Set-IntersightMgmtConfigBackupFile
```
...
[Get-IntersightMgmtConfigBackupFile](./Get-IntersightMgmtConfigBackupFile.md)
