...
# Get-IntersightCoremanagementDownload

## SYNOPSIS
Get the CoremanagementDownload

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCoremanagementDownload [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCoremanagementDownload [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CoremanagementDownload&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCoremanagementDownload
```
Above example returns the list of CoremanagementDownload.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCoremanagementDownload -Name "MoName"
```
Above example returns the CoremanagementDownload matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCoremanagementDownload -Organization $organization
```
Above example returns the list of CoremanagementDownload available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCoremanagementDownload -InlineCount allpages
```
Above example returns the list of CoremanagementDownload along with count.
...
### -Name
Specifies the name of the CoremanagementDownload.
...
### -Organization
Specifies the organization, to fetch the CoremanagementDownload under it.
