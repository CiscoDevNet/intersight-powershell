...
# Get-IntersightResourceSelectionCriteria

## SYNOPSIS
Get the ResourceSelectionCriteria

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightResourceSelectionCriteria [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourceSelectionCriteria [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ResourceSelectionCriteria&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourceSelectionCriteria
```
Above example returns the list of ResourceSelectionCriteria.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourceSelectionCriteria -Name "MoName"
```
Above example returns the ResourceSelectionCriteria matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourceSelectionCriteria -Organization $organization
```
Above example returns the list of ResourceSelectionCriteria available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourceSelectionCriteria -InlineCount allpages
```
Above example returns the list of ResourceSelectionCriteria along with count.
...
### -Name
Specifies the name of the ResourceSelectionCriteria.
...
### -Organization
Specifies the organization, to fetch the ResourceSelectionCriteria under it.
...
[Remove-IntersightResourceSelectionCriteria](./Remove-IntersightResourceSelectionCriteria.md)
