...
### CmdletParam (Default)
```
Get-IntersightChassisIomProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightChassisIomProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightChassisIomProfile
```
Above example returns the list of ChassisIomProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightChassisIomProfile -Name "MoName"
```
Above example returns the ChassisIomProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightChassisIomProfile -Organization $organization
```
Above example returns the list of ChassisIomProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightChassisIomProfile -InlineCount allpages
```
Above example returns the list of ChassisIomProfile along with count.
...
### -Name
Specifies the name of the ChassisIomProfile.
...
### -Organization
Specifies the organization, to fetch the ChassisIomProfile under it.
