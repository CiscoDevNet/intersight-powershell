...
```powershell
$SoftwarerepositoryCachedImageResponse = Initialize-IntersightSoftwarerepositoryCachedImageResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwarerepositoryCachedImageResponse | ConvertTo-JSON
```
