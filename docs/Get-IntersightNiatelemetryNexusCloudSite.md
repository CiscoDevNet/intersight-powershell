...
# Get-IntersightNiatelemetryNexusCloudSite

## SYNOPSIS
Get the NiatelemetryNexusCloudSite

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryNexusCloudSite [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryNexusCloudSite [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryNexusCloudSite&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusCloudSite
```
Above example returns the list of NiatelemetryNexusCloudSite.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusCloudSite -Name "MoName"
```
Above example returns the NiatelemetryNexusCloudSite matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusCloudSite -Organization $organization
```
Above example returns the list of NiatelemetryNexusCloudSite available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusCloudSite -InlineCount allpages
```
Above example returns the list of NiatelemetryNexusCloudSite along with count.
...
### -Name
Specifies the name of the NiatelemetryNexusCloudSite.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryNexusCloudSite under it.
