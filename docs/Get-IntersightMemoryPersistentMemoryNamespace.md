...
## SYNOPSIS
Get the MemoryPersistentMemoryNamespace

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMemoryPersistentMemoryNamespace [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMemoryPersistentMemoryNamespace [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;MemoryPersistentMemoryNamespace&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryNamespace
```
Above example returns the list of MemoryPersistentMemoryNamespace.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryNamespace -Name "MoName"
```
Above example returns the MemoryPersistentMemoryNamespace matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryNamespace -Organization $organization
```
Above example returns the list of MemoryPersistentMemoryNamespace available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryNamespace -InlineCount allpages
```
Above example returns the list of MemoryPersistentMemoryNamespace along with count.
...
### -Name
Specifies the name of the MemoryPersistentMemoryNamespace.
...
### -Organization
Specifies the organization, to fetch the MemoryPersistentMemoryNamespace under it.
...
[Set-IntersightMemoryPersistentMemoryNamespace](./Set-IntersightMemoryPersistentMemoryNamespace.md)
