...
```powershell
$NiatelemetryNiaInventoryFabricResponse = Initialize-IntersightNiatelemetryNiaInventoryFabricResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiatelemetryNiaInventoryFabricResponse | ConvertTo-JSON
```
