...
## SYNOPSIS
Get the ExternalsiteAuthorization

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightExternalsiteAuthorization [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightExternalsiteAuthorization [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ExternalsiteAuthorization&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightExternalsiteAuthorization
```
Above example returns the list of ExternalsiteAuthorization.

### Example 2
```powershell
PS C:\> $result = Get-IntersightExternalsiteAuthorization -Name "MoName"
```
Above example returns the ExternalsiteAuthorization matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightExternalsiteAuthorization -Organization $organization
```
Above example returns the list of ExternalsiteAuthorization available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightExternalsiteAuthorization -InlineCount allpages
```
Above example returns the list of ExternalsiteAuthorization along with count.
...
### -Name
Specifies the name of the ExternalsiteAuthorization.
...
### -Organization
Specifies the organization, to fetch the ExternalsiteAuthorization under it.
