...
## SYNOPSIS
Get the NiatelemetryNiaLicenseState

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryNiaLicenseState [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryNiaLicenseState [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryNiaLicenseState&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaLicenseState
```
Above example returns the list of NiatelemetryNiaLicenseState.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaLicenseState -Name "MoName"
```
Above example returns the NiatelemetryNiaLicenseState matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaLicenseState -Organization $organization
```
Above example returns the list of NiatelemetryNiaLicenseState available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaLicenseState -InlineCount allpages
```
Above example returns the list of NiatelemetryNiaLicenseState along with count.
...
### -Name
Specifies the name of the NiatelemetryNiaLicenseState.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryNiaLicenseState under it.
