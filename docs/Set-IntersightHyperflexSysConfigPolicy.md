...
Set-IntersightHyperflexSysConfigPolicy [-AdditionalProperties< Dictionary<string,object>>][-ClusterProfiles< List<HyperflexClusterProfileRelationship>>][-Description< string>][-DnsDomainName< string>][-DnsServers< List<string>>][[-Moid]< string>][-Name< string>][-NtpServers< List<string>>][-Organization< OrganizationOrganizationRelationship>][-Tags< List<MoTag>>][-Timezone< HyperflexSysConfigPolicy.TimezoneEnum>]
