...
```powershell
$AssetSubscriptionDeviceContractInformation = Initialize-IntersightAssetSubscriptionDeviceContractInformation  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$AssetSubscriptionDeviceContractInformation | ConvertTo-JSON
```
