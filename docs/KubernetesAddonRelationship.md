...
```powershell
$KubernetesAddonRelationship = Initialize-IntersightKubernetesAddonRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$KubernetesAddonRelationship | ConvertTo-JSON
```
