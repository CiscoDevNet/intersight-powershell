...
## SYNOPSIS
Get the NiaapiApicHweol

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiApicHweol [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiApicHweol [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiaapiApicHweol&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiApicHweol
```
Above example returns the list of NiaapiApicHweol.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiApicHweol -Name "MoName"
```
Above example returns the NiaapiApicHweol matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiApicHweol -Organization $organization
```
Above example returns the list of NiaapiApicHweol available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiApicHweol -InlineCount allpages
```
Above example returns the list of NiaapiApicHweol along with count.
...
### -Name
Specifies the name of the NiaapiApicHweol.
...
### -Organization
Specifies the organization, to fetch the NiaapiApicHweol under it.
