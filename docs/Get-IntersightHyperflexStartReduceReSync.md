...
# Get-IntersightHyperflexStartReduceReSync

## SYNOPSIS
Get the HyperflexStartReduceReSync

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexStartReduceReSync [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexStartReduceReSync [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexStartReduceReSync&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexStartReduceReSync
```
Above example returns the list of HyperflexStartReduceReSync.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexStartReduceReSync -Name "MoName"
```
Above example returns the HyperflexStartReduceReSync matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexStartReduceReSync -Organization $organization
```
Above example returns the list of HyperflexStartReduceReSync available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexStartReduceReSync -InlineCount allpages
```
Above example returns the list of HyperflexStartReduceReSync along with count.
...
### -Name
Specifies the name of the HyperflexStartReduceReSync.
...
### -Organization
Specifies the organization, to fetch the HyperflexStartReduceReSync under it.
...
[New-IntersightHyperflexStartReduceReSync](./New-IntersightHyperflexStartReduceReSync.md)
