...
# Initialize-IntersightSoftwareApplianceDistributable
...
Initialize-IntersightSoftwareApplianceDistributable [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Catalog< Model.SoftwarerepositoryCatalogRelationship>][-ClassId< SoftwareApplianceDistributable.ClassIdEnum>][-ComponentMeta< System.Collections.Generic.List`1[Model.FirmwareComponentMeta]>][-Description< string>][-DistributableMetas< System.Collections.Generic.List`1[Model.FirmwareDistributableMetaRelationship]>][-ImageType< string>][-ImportAction< SoftwareApplianceDistributable.ImportActionEnum>][-ImportState< SoftwareApplianceDistributable.ImportStateEnum>][-Md5eTag< string>][-Md5sum< string>][-Mdfid< string>][-Model< string>][-Moid< string>][-Name< string>][-ObjectType< SoftwareApplianceDistributable.ObjectTypeEnum>][-RecommendedBuild< string>][-Release< Model.SoftwarerepositoryReleaseRelationship>][-ReleaseDate< DateTime>][-ReleaseNotesUrl< string>][-Sha512sum< string>][-Size< long>][-SoftwareAdvisoryUrl< string>][-Source< Model.SoftwarerepositoryFileServer>][-SupportedModels< System.Collections.Generic.List`1[string]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Vendor< string>][-Version< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: SoftwareApplianceDistributable.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: SoftwareApplianceDistributable.ImportActionEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: SoftwareApplianceDistributable.ImportStateEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: SoftwareApplianceDistributable.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightSoftwareApplianceDistributable
```
