...
# Get-IntersightIamIpAccessManagement

## SYNOPSIS
Get the IamIpAccessManagement

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamIpAccessManagement [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamIpAccessManagement [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IamIpAccessManagement&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamIpAccessManagement
```
Above example returns the list of IamIpAccessManagement.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamIpAccessManagement -Name "MoName"
```
Above example returns the IamIpAccessManagement matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamIpAccessManagement -Organization $organization
```
Above example returns the list of IamIpAccessManagement available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamIpAccessManagement -InlineCount allpages
```
Above example returns the list of IamIpAccessManagement along with count.
...
### -Name
Specifies the name of the IamIpAccessManagement.
...
### -Organization
Specifies the organization, to fetch the IamIpAccessManagement under it.
