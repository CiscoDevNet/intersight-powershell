...
## SYNOPSIS
Get the StorageNetAppCluster

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppCluster [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppCluster [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppCluster&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCluster
```
Above example returns the list of StorageNetAppCluster.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCluster -Name "MoName"
```
Above example returns the StorageNetAppCluster matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCluster -Organization $organization
```
Above example returns the list of StorageNetAppCluster available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCluster -InlineCount allpages
```
Above example returns the list of StorageNetAppCluster along with count.
...
### -Name
Specifies the name of the StorageNetAppCluster.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppCluster under it.
...
[Set-IntersightStorageNetAppCluster](./Set-IntersightStorageNetAppCluster.md)
