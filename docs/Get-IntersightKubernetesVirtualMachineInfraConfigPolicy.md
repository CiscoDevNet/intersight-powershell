...
## SYNOPSIS
Get the KubernetesVirtualMachineInfraConfigPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesVirtualMachineInfraConfigPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesVirtualMachineInfraConfigPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesVirtualMachineInfraConfigPolicy
```
Above example returns the list of KubernetesVirtualMachineInfraConfigPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesVirtualMachineInfraConfigPolicy -Name "MoName"
```
Above example returns the KubernetesVirtualMachineInfraConfigPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesVirtualMachineInfraConfigPolicy -Organization $organization
```
Above example returns the list of KubernetesVirtualMachineInfraConfigPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesVirtualMachineInfraConfigPolicy -InlineCount allpages
```
Above example returns the list of KubernetesVirtualMachineInfraConfigPolicy along with count.
...
### -Name
Specifies the name of the KubernetesVirtualMachineInfraConfigPolicy.
...
### -Organization
Specifies the organization, to fetch the KubernetesVirtualMachineInfraConfigPolicy under it.
