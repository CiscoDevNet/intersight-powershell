...
# Get-IntersightLicenseIncLicenseCount

## SYNOPSIS
Get the LicenseIncLicenseCount

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightLicenseIncLicenseCount [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightLicenseIncLicenseCount [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;LicenseIncLicenseCount&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightLicenseIncLicenseCount
```
Above example returns the list of LicenseIncLicenseCount.

### Example 2
```powershell
PS C:\> $result = Get-IntersightLicenseIncLicenseCount -Name "MoName"
```
Above example returns the LicenseIncLicenseCount matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightLicenseIncLicenseCount -Organization $organization
```
Above example returns the list of LicenseIncLicenseCount available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightLicenseIncLicenseCount -InlineCount allpages
```
Above example returns the list of LicenseIncLicenseCount along with count.
...
### -Name
Specifies the name of the LicenseIncLicenseCount.
...
### -Organization
Specifies the organization, to fetch the LicenseIncLicenseCount under it.
...
[New-IntersightLicenseIncLicenseCount](./New-IntersightLicenseIncLicenseCount.md)

[Set-IntersightLicenseIncLicenseCount](./Set-IntersightLicenseIncLicenseCount.md)
