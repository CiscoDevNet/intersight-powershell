...
# Initialize-IntersightIppoolReservationReference
...
Initialize-IntersightIppoolReservationReference [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< IppoolReservationReference.ClassIdEnum>][-ConsumerName< string>][-ConsumerType< IppoolReservationReference.ConsumerTypeEnum>][-ObjectType< IppoolReservationReference.ObjectTypeEnum>][-ReservationId< string>][-ReservationMoid< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: IppoolReservationReference.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IppoolReservationReference.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIppoolReservationReference
```
