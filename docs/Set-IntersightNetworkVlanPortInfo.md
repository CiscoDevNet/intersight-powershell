...
Set-IntersightNetworkVlanPortInfo [-AdditionalProperties< Dictionary<string,object>>][-CompressedOptimizationSetsValue< long>][-CompressedVlanPortCountValue< long>][[-Moid]< string>][-Tags< List<MoTag>>][-UncompressedVlanPortCountValue< long>]
