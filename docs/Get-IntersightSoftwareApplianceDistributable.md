...
## SYNOPSIS
Get the SoftwareApplianceDistributable

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwareApplianceDistributable [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwareApplianceDistributable [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;SoftwareApplianceDistributable&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwareApplianceDistributable
```
Above example returns the list of SoftwareApplianceDistributable.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwareApplianceDistributable -Name "MoName"
```
Above example returns the SoftwareApplianceDistributable matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwareApplianceDistributable -Organization $organization
```
Above example returns the list of SoftwareApplianceDistributable available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwareApplianceDistributable -InlineCount allpages
```
Above example returns the list of SoftwareApplianceDistributable along with count.
...
### -Name
Specifies the name of the SoftwareApplianceDistributable.
...
### -Organization
Specifies the organization, to fetch the SoftwareApplianceDistributable under it.
