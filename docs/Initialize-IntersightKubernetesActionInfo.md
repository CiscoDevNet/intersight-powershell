...
Initialize-IntersightKubernetesActionInfo [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< KubernetesActionInfo.ClassIdEnum>][-ObjectType< KubernetesActionInfo.ObjectTypeEnum>][-Status< KubernetesActionInfo.StatusEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
