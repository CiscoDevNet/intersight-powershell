...
# Initialize-IntersightTaskPureScopedInventory
...
```yaml
Type: TaskPureScopedInventory.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TaskPureScopedInventory.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTaskPureScopedInventory
```
