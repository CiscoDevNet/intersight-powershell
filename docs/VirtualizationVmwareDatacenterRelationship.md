...
```powershell
$VirtualizationVmwareDatacenterRelationship = Initialize-IntersightVirtualizationVmwareDatacenterRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$VirtualizationVmwareDatacenterRelationship | ConvertTo-JSON
```
