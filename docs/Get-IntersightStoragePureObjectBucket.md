...
# Get-IntersightStoragePureObjectBucket

## SYNOPSIS
Get the StoragePureObjectBucket

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureObjectBucket [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureObjectBucket [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureObjectBucket&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureObjectBucket
```
Above example returns the list of StoragePureObjectBucket.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureObjectBucket -Name "MoName"
```
Above example returns the StoragePureObjectBucket matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureObjectBucket -Organization $organization
```
Above example returns the list of StoragePureObjectBucket available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureObjectBucket -InlineCount allpages
```
Above example returns the list of StoragePureObjectBucket along with count.
...
### -Name
Specifies the name of the StoragePureObjectBucket.
...
### -Organization
Specifies the organization, to fetch the StoragePureObjectBucket under it.
