...
## SYNOPSIS
Get the HyperflexSysConfigPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexSysConfigPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexSysConfigPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexSysConfigPolicy
```
Above example returns the list of HyperflexSysConfigPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexSysConfigPolicy -Name "MoName"
```
Above example returns the HyperflexSysConfigPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexSysConfigPolicy -Organization $organization
```
Above example returns the list of HyperflexSysConfigPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexSysConfigPolicy -InlineCount allpages
```
Above example returns the list of HyperflexSysConfigPolicy along with count.
...
### -Name
Specifies the name of the HyperflexSysConfigPolicy.
...
### -Organization
Specifies the organization, to fetch the HyperflexSysConfigPolicy under it.
