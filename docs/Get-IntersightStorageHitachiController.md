...
## SYNOPSIS
Get the StorageHitachiController

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiController [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiController [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiController&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiController
```
Above example returns the list of StorageHitachiController.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiController -Name "MoName"
```
Above example returns the StorageHitachiController matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiController -Organization $organization
```
Above example returns the list of StorageHitachiController available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiController -InlineCount allpages
```
Above example returns the list of StorageHitachiController along with count.
...
### -Name
Specifies the name of the StorageHitachiController.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiController under it.
