...
## SYNOPSIS
Get the RecoveryBackupConfigPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRecoveryBackupConfigPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRecoveryBackupConfigPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRecoveryBackupConfigPolicy
```
Above example returns the list of RecoveryBackupConfigPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRecoveryBackupConfigPolicy -Name "MoName"
```
Above example returns the RecoveryBackupConfigPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRecoveryBackupConfigPolicy -Organization $organization
```
Above example returns the list of RecoveryBackupConfigPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRecoveryBackupConfigPolicy -InlineCount allpages
```
Above example returns the list of RecoveryBackupConfigPolicy along with count.
...
### -Name
Specifies the name of the RecoveryBackupConfigPolicy.
...
### -Organization
Specifies the organization, to fetch the RecoveryBackupConfigPolicy under it.
