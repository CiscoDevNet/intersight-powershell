...
# Get-IntersightMerakiNetwork

## SYNOPSIS
Get the MerakiNetwork

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMerakiNetwork [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMerakiNetwork [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MerakiNetwork&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMerakiNetwork
```
Above example returns the list of MerakiNetwork.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMerakiNetwork -Name "MoName"
```
Above example returns the MerakiNetwork matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMerakiNetwork -Organization $organization
```
Above example returns the list of MerakiNetwork available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMerakiNetwork -InlineCount allpages
```
Above example returns the list of MerakiNetwork along with count.
...
### -Name
Specifies the name of the MerakiNetwork.
...
### -Organization
Specifies the organization, to fetch the MerakiNetwork under it.
