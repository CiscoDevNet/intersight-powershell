...
Set-IntersightApplianceAutoRmaPolicy [-AdditionalProperties< Dictionary<string,object>>][-Enable< bool>][[-Moid]< string>][-RegisteredDevice< AssetDeviceRegistrationRelationship>][-Tags< List<MoTag>>]
