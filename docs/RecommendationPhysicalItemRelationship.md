...
```powershell
$RecommendationPhysicalItemRelationship = Initialize-IntersightRecommendationPhysicalItemRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$RecommendationPhysicalItemRelationship | ConvertTo-JSON
```
