...
# Get-IntersightMgmtConfigBackupFile

## SYNOPSIS
Get the MgmtConfigBackupFile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMgmtConfigBackupFile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMgmtConfigBackupFile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MgmtConfigBackupFile&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMgmtConfigBackupFile
```
Above example returns the list of MgmtConfigBackupFile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMgmtConfigBackupFile -Name "MoName"
```
Above example returns the MgmtConfigBackupFile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMgmtConfigBackupFile -Organization $organization
```
Above example returns the list of MgmtConfigBackupFile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMgmtConfigBackupFile -InlineCount allpages
```
Above example returns the list of MgmtConfigBackupFile along with count.
...
### -Name
Specifies the name of the MgmtConfigBackupFile.
...
### -Organization
Specifies the organization, to fetch the MgmtConfigBackupFile under it.
...
[New-IntersightMgmtConfigBackupFile](./New-IntersightMgmtConfigBackupFile.md)

[Remove-IntersightMgmtConfigBackupFile](./Remove-IntersightMgmtConfigBackupFile.md)

[Set-IntersightMgmtConfigBackupFile](./Set-IntersightMgmtConfigBackupFile.md)
