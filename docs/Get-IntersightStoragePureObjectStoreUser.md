...
# Get-IntersightStoragePureObjectStoreUser

## SYNOPSIS
Get the StoragePureObjectStoreUser

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureObjectStoreUser [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureObjectStoreUser [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureObjectStoreUser&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureObjectStoreUser
```
Above example returns the list of StoragePureObjectStoreUser.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureObjectStoreUser -Name "MoName"
```
Above example returns the StoragePureObjectStoreUser matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureObjectStoreUser -Organization $organization
```
Above example returns the list of StoragePureObjectStoreUser available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureObjectStoreUser -InlineCount allpages
```
Above example returns the list of StoragePureObjectStoreUser along with count.
...
### -Name
Specifies the name of the StoragePureObjectStoreUser.
...
### -Organization
Specifies the organization, to fetch the StoragePureObjectStoreUser under it.
