...
```powershell
$HyperflexClusterBackupPolicyDeploymentResponse = Initialize-IntersightHyperflexClusterBackupPolicyDeploymentResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexClusterBackupPolicyDeploymentResponse | ConvertTo-JSON
```
