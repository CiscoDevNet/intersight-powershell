...
## SYNOPSIS
Get the StorageHitachiHost

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiHost [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiHost [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiHost&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiHost
```
Above example returns the list of StorageHitachiHost.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiHost -Name "MoName"
```
Above example returns the StorageHitachiHost matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiHost -Organization $organization
```
Above example returns the list of StorageHitachiHost available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiHost -InlineCount allpages
```
Above example returns the list of StorageHitachiHost along with count.
...
### -Name
Specifies the name of the StorageHitachiHost.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiHost under it.
