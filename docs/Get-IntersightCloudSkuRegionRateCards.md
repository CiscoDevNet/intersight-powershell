...
## SYNOPSIS
Get the CloudSkuRegionRateCards

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudSkuRegionRateCards [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudSkuRegionRateCards [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CloudSkuRegionRateCards&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudSkuRegionRateCards
```
Above example returns the list of CloudSkuRegionRateCards.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudSkuRegionRateCards -Name "MoName"
```
Above example returns the CloudSkuRegionRateCards matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudSkuRegionRateCards -Organization $organization
```
Above example returns the list of CloudSkuRegionRateCards available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudSkuRegionRateCards -InlineCount allpages
```
Above example returns the list of CloudSkuRegionRateCards along with count.
...
### -Name
Specifies the name of the CloudSkuRegionRateCards.
...
### -Organization
Specifies the organization, to fetch the CloudSkuRegionRateCards under it.
