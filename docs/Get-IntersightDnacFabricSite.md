...
# Get-IntersightDnacFabricSite

## SYNOPSIS
Get the DnacFabricSite

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightDnacFabricSite [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightDnacFabricSite [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;DnacFabricSite&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightDnacFabricSite
```
Above example returns the list of DnacFabricSite.

### Example 2
```powershell
PS C:\> $result = Get-IntersightDnacFabricSite -Name "MoName"
```
Above example returns the DnacFabricSite matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightDnacFabricSite -Organization $organization
```
Above example returns the list of DnacFabricSite available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightDnacFabricSite -InlineCount allpages
```
Above example returns the list of DnacFabricSite along with count.
...
### -Name
Specifies the name of the DnacFabricSite.
...
### -Organization
Specifies the organization, to fetch the DnacFabricSite under it.
