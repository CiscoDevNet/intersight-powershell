...
# Get-IntersightNetworkconfigPolicy

## SYNOPSIS
Get the NetworkconfigPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkconfigPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkconfigPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NetworkconfigPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkconfigPolicy
```
Above example returns the list of NetworkconfigPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkconfigPolicy -Name "MoName"
```
Above example returns the NetworkconfigPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkconfigPolicy -Organization $organization
```
Above example returns the list of NetworkconfigPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkconfigPolicy -InlineCount allpages
```
Above example returns the list of NetworkconfigPolicy along with count.
...
### -Name
Specifies the name of the NetworkconfigPolicy.
...
### -Organization
Specifies the organization, to fetch the NetworkconfigPolicy under it.
