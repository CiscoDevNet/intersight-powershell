...
### CmdletParam (Default)
```
Get-IntersightCapabilityGpuEndpointDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityGpuEndpointDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityGpuEndpointDescriptor
```
Above example returns the list of CapabilityGpuEndpointDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityGpuEndpointDescriptor -Name "MoName"
```
Above example returns the CapabilityGpuEndpointDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityGpuEndpointDescriptor -Organization $organization
```
Above example returns the list of CapabilityGpuEndpointDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityGpuEndpointDescriptor -InlineCount allpages
```
Above example returns the list of CapabilityGpuEndpointDescriptor along with count.
...
### -Name
Specifies the name of the CapabilityGpuEndpointDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilityGpuEndpointDescriptor under it.
