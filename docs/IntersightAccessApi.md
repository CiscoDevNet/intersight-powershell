# Intersight.Intersight/Api.IntersightAccessApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**New-IntersightAccessPolicy**](IntersightAccessApi.md#New-IntersightAccessPolicy) | **POST** /api/v1/access/Policies | Create a &#39;access.Policy&#39; resource.
[**Remove-IntersightAccessPolicy**](IntersightAccessApi.md#Remove-IntersightAccessPolicy) | **DELETE** /api/v1/access/Policies/{Moid} | Delete a &#39;access.Policy&#39; resource.
[**Get-IntersightAccessPolicyByMoid**](IntersightAccessApi.md#Get-IntersightAccessPolicyByMoid) | **GET** /api/v1/access/Policies/{Moid} | Read a &#39;access.Policy&#39; resource.
[**Get-IntersightAccessPolicyList**](IntersightAccessApi.md#Get-IntersightAccessPolicyList) | **GET** /api/v1/access/Policies | Read a &#39;access.Policy&#39; resource.
[**Set-IntersightAccessPolicy**](IntersightAccessApi.md#Set-IntersightAccessPolicy) | **PATCH** /api/v1/access/Policies/{Moid} | Update a &#39;access.Policy&#39; resource.
[**Update-IntersightAccessPolicy**](IntersightAccessApi.md#Update-IntersightAccessPolicy) | **POST** /api/v1/access/Policies/{Moid} | Update a &#39;access.Policy&#39; resource.


<a name="New-IntersightAccessPolicy"></a>
# **New-IntersightAccessPolicy**
> AccessPolicy New-IntersightAccessPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-AccessPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Create a 'access.Policy' resource.
try {
     $Result = New-IntersightAccessPolicy -AccessPolicy $AccessPolicy -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
    Write-Host ("Exception occured when calling New-IntersightAccessPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
------------- | ------------- | ------------- | -------------
 **AccessPolicy** | [**AccessPolicy**](AccessPolicy.md)| The &#39;access.Policy&#39; resource to create. | 
...
<a name="Remove-IntersightAccessPolicy"></a>
# **Remove-IntersightAccessPolicy**
> void Remove-IntersightAccessPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'access.Policy' resource.
try {
     $Result = Remove-IntersightAccessPolicy -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightAccessPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightAccessPolicyByMoid"></a>
# **Get-IntersightAccessPolicyByMoid**
> AccessPolicy Get-IntersightAccessPolicyByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'access.Policy' resource.
try {
     $Result = Get-IntersightAccessPolicyByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightAccessPolicyByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightAccessPolicyList"></a>
# **Get-IntersightAccessPolicyList**
> AccessPolicyResponse Get-IntersightAccessPolicyList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'access.Policy' resource.
try {
     $Result = Get-IntersightAccessPolicyList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightAccessPolicyList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightAccessPolicy"></a>
# **Set-IntersightAccessPolicy**
> AccessPolicy Set-IntersightAccessPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-AccessPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$AccessPolicy = (Initialize-access.Policy-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -AddressType (Initialize-access.AddressType-ClassId "ClassId_example" -ObjectType "ObjectType_example" -EnableIpV4 $false -EnableIpV6 $false) -InbandVlan 123 -InbandIpPool  -InbandVrf  -Organization  -Profiles @()) # AccessPolicy | The 'access.Policy' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'access.Policy' resource.
try {
     $Result = Set-IntersightAccessPolicy -Moid $Moid -AccessPolicy $AccessPolicy -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightAccessPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **AccessPolicy** | [**AccessPolicy**](AccessPolicy.md)| The &#39;access.Policy&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Update-IntersightAccessPolicy"></a>
# **Update-IntersightAccessPolicy**
> AccessPolicy Update-IntersightAccessPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-AccessPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$AccessPolicy =  # AccessPolicy | The 'access.Policy' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'access.Policy' resource.
try {
     $Result = Update-IntersightAccessPolicy -Moid $Moid -AccessPolicy $AccessPolicy -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightAccessPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
