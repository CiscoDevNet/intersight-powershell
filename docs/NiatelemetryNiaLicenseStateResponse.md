...
```powershell
$NiatelemetryNiaLicenseStateResponse = Initialize-IntersightNiatelemetryNiaLicenseStateResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiatelemetryNiaLicenseStateResponse | ConvertTo-JSON
```
