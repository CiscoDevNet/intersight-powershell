...
## SYNOPSIS
Get the VirtualizationVmwareVirtualMachine

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareVirtualMachine [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareVirtualMachine [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;VirtualizationVmwareVirtualMachine&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualMachine
```
Above example returns the list of VirtualizationVmwareVirtualMachine.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualMachine -Name "MoName"
```
Above example returns the VirtualizationVmwareVirtualMachine matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualMachine -Organization $organization
```
Above example returns the list of VirtualizationVmwareVirtualMachine available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualMachine -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareVirtualMachine along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareVirtualMachine.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareVirtualMachine under it.
...
[Set-IntersightVirtualizationVmwareVirtualMachine](./Set-IntersightVirtualizationVmwareVirtualMachine.md)
