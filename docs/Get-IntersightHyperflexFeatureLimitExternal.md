...
## SYNOPSIS
Get the HyperflexFeatureLimitExternal

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexFeatureLimitExternal [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexFeatureLimitExternal [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexFeatureLimitExternal
```
Above example returns the list of HyperflexFeatureLimitExternal.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexFeatureLimitExternal -Name "MoName"
```
Above example returns the HyperflexFeatureLimitExternal matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexFeatureLimitExternal -Organization $organization
```
Above example returns the list of HyperflexFeatureLimitExternal available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexFeatureLimitExternal -InlineCount allpages
```
Above example returns the list of HyperflexFeatureLimitExternal along with count.
...
### -Name
Specifies the name of the HyperflexFeatureLimitExternal.
...
### -Organization
Specifies the organization, to fetch the HyperflexFeatureLimitExternal under it.
