...
## SYNOPSIS
Get the ComputeServerSetting

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputeServerSetting [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputeServerSetting [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;ComputeServerSetting&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputeServerSetting
```
Above example returns the list of ComputeServerSetting.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputeServerSetting -Name "MoName"
```
Above example returns the ComputeServerSetting matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputeServerSetting -Organization $organization
```
Above example returns the list of ComputeServerSetting available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputeServerSetting -InlineCount allpages
```
Above example returns the list of ComputeServerSetting along with count.
...
### -Name
Specifies the name of the ComputeServerSetting.
...
### -Organization
Specifies the organization, to fetch the ComputeServerSetting under it.
...
[Set-IntersightComputeServerSetting](./Set-IntersightComputeServerSetting.md)
