...
```powershell
$HyperflexNodeConfigPolicyResponse = Initialize-IntersightHyperflexNodeConfigPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexNodeConfigPolicyResponse | ConvertTo-JSON
```
