...
### CmdletParam (Default)
```
Get-IntersightCapabilityCpuEndpointDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityCpuEndpointDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityCpuEndpointDescriptor
```
Above example returns the list of CapabilityCpuEndpointDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityCpuEndpointDescriptor -Name "MoName"
```
Above example returns the CapabilityCpuEndpointDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityCpuEndpointDescriptor -Organization $organization
```
Above example returns the list of CapabilityCpuEndpointDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityCpuEndpointDescriptor -InlineCount allpages
```
Above example returns the list of CapabilityCpuEndpointDescriptor along with count.
...
### -Name
Specifies the name of the CapabilityCpuEndpointDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilityCpuEndpointDescriptor under it.
