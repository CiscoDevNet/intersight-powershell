...
Initialize-IntersightBootUefiShell [-AdditionalProperties< Dictionary<string,object>>][-ClassId< BootUefiShell.ClassIdEnum>][-Enabled< bool>][-Name< string>][-ObjectType< BootUefiShell.ObjectTypeEnum>]
