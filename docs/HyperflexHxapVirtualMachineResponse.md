...
```powershell
$HyperflexHxapVirtualMachineResponse = Initialize-IntersightHyperflexHxapVirtualMachineResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexHxapVirtualMachineResponse | ConvertTo-JSON
```
