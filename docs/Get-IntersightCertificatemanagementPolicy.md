...
### CmdletParam (Default)
```
Get-IntersightCertificatemanagementPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCertificatemanagementPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCertificatemanagementPolicy
```
Above example returns the list of CertificatemanagementPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCertificatemanagementPolicy -Name "MoName"
```
Above example returns the CertificatemanagementPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCertificatemanagementPolicy -Organization $organization
```
Above example returns the list of CertificatemanagementPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCertificatemanagementPolicy -InlineCount allpages
```
Above example returns the list of CertificatemanagementPolicy along with count.
...
### -Name
Specifies the name of the CertificatemanagementPolicy.
...
### -Organization
Specifies the organization, to fetch the CertificatemanagementPolicy under it.
