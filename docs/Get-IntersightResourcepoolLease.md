...
## SYNOPSIS
Get the ResourcepoolLease

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightResourcepoolLease [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourcepoolLease [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourcepoolLease
```
Above example returns the list of ResourcepoolLease.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourcepoolLease -Name "MoName"
```
Above example returns the ResourcepoolLease matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourcepoolLease -Organization $organization
```
Above example returns the list of ResourcepoolLease available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourcepoolLease -InlineCount allpages
```
Above example returns the list of ResourcepoolLease along with count.
...
### -Name
Specifies the name of the ResourcepoolLease.
...
### -Organization
Specifies the organization, to fetch the ResourcepoolLease under it.
...
[Remove-IntersightResourcepoolLease](./Remove-IntersightResourcepoolLease.md)
