...
# Get-IntersightCondAlarmAggregation

## SYNOPSIS
Get the CondAlarmAggregation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCondAlarmAggregation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCondAlarmAggregation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CondAlarmAggregation&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCondAlarmAggregation
```
Above example returns the list of CondAlarmAggregation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCondAlarmAggregation -Name "MoName"
```
Above example returns the CondAlarmAggregation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCondAlarmAggregation -Organization $organization
```
Above example returns the list of CondAlarmAggregation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCondAlarmAggregation -InlineCount allpages
```
Above example returns the list of CondAlarmAggregation along with count.
...
### -Name
Specifies the name of the CondAlarmAggregation.
...
### -Organization
Specifies the organization, to fetch the CondAlarmAggregation under it.
