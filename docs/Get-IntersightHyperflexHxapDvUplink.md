...
# Get-IntersightHyperflexHxapDvUplink

## SYNOPSIS
Get the HyperflexHxapDvUplink

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHxapDvUplink [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHxapDvUplink [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHxapDvUplink&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapDvUplink
```
Above example returns the list of HyperflexHxapDvUplink.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapDvUplink -Name "MoName"
```
Above example returns the HyperflexHxapDvUplink matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapDvUplink -Organization $organization
```
Above example returns the list of HyperflexHxapDvUplink available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapDvUplink -InlineCount allpages
```
Above example returns the list of HyperflexHxapDvUplink along with count.
...
### -Name
Specifies the name of the HyperflexHxapDvUplink.
...
### -Organization
Specifies the organization, to fetch the HyperflexHxapDvUplink under it.
