...
```powershell
$CapabilityEquipmentSlotArrayResponse = Initialize-IntersightCapabilityEquipmentSlotArrayResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilityEquipmentSlotArrayResponse | ConvertTo-JSON
```
