...
### CmdletParam (Default)
```
Get-IntersightPciEndpoint [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPciEndpoint [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
