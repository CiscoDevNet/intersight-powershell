...
# Initialize-IntersightNiatelemetryDomThresInfo
...
```yaml
Type: NiatelemetryDomThresInfo.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: NiatelemetryDomThresInfo.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightNiatelemetryDomThresInfo
```
