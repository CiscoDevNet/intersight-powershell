...
```powershell
$VirtualizationVmwareDatastoreResponse = Initialize-IntersightVirtualizationVmwareDatastoreResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$VirtualizationVmwareDatastoreResponse | ConvertTo-JSON
```
