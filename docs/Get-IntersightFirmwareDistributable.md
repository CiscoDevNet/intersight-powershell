...
## SYNOPSIS
Get the FirmwareDistributable

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareDistributable [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareDistributable [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareDistributable&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareDistributable
```
Above example returns the list of FirmwareDistributable.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareDistributable -Name "MoName"
```
Above example returns the FirmwareDistributable matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareDistributable -Organization $organization
```
Above example returns the list of FirmwareDistributable available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareDistributable -InlineCount allpages
```
Above example returns the list of FirmwareDistributable along with count.
...
### -Name
Specifies the name of the FirmwareDistributable.
...
### -Organization
Specifies the organization, to fetch the FirmwareDistributable under it.
