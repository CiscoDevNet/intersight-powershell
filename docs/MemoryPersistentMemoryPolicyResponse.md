...
```powershell
$MemoryPersistentMemoryPolicyResponse = Initialize-IntersightMemoryPersistentMemoryPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$MemoryPersistentMemoryPolicyResponse | ConvertTo-JSON
```
