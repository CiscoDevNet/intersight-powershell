...
# Get-IntersightHyperflexHxapDatacenter

## SYNOPSIS
Get the HyperflexHxapDatacenter

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHxapDatacenter [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHxapDatacenter [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHxapDatacenter&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapDatacenter
```
Above example returns the list of HyperflexHxapDatacenter.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapDatacenter -Name "MoName"
```
Above example returns the HyperflexHxapDatacenter matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapDatacenter -Organization $organization
```
Above example returns the list of HyperflexHxapDatacenter available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapDatacenter -InlineCount allpages
```
Above example returns the list of HyperflexHxapDatacenter along with count.
...
### -Name
Specifies the name of the HyperflexHxapDatacenter.
...
### -Organization
Specifies the organization, to fetch the HyperflexHxapDatacenter under it.
