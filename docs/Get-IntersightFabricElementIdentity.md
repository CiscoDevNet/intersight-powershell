...
## SYNOPSIS
Get the FabricElementIdentity

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricElementIdentity [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricElementIdentity [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricElementIdentity&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricElementIdentity
```
Above example returns the list of FabricElementIdentity.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricElementIdentity -Name "MoName"
```
Above example returns the FabricElementIdentity matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricElementIdentity -Organization $organization
```
Above example returns the list of FabricElementIdentity available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricElementIdentity -InlineCount allpages
```
Above example returns the list of FabricElementIdentity along with count.
...
### -Name
Specifies the name of the FabricElementIdentity.
...
### -Organization
Specifies the organization, to fetch the FabricElementIdentity under it.
...
[Set-IntersightFabricElementIdentity](./Set-IntersightFabricElementIdentity.md)
