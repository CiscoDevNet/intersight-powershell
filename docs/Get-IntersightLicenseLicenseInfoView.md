...
# Get-IntersightLicenseLicenseInfoView

## SYNOPSIS
Get the LicenseLicenseInfoView

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightLicenseLicenseInfoView [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightLicenseLicenseInfoView [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;LicenseLicenseInfoView&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightLicenseLicenseInfoView
```
Above example returns the list of LicenseLicenseInfoView.

### Example 2
```powershell
PS C:\> $result = Get-IntersightLicenseLicenseInfoView -Name "MoName"
```
Above example returns the LicenseLicenseInfoView matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightLicenseLicenseInfoView -Organization $organization
```
Above example returns the list of LicenseLicenseInfoView available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightLicenseLicenseInfoView -InlineCount allpages
```
Above example returns the list of LicenseLicenseInfoView along with count.
...
### -Name
Specifies the name of the LicenseLicenseInfoView.
...
### -Organization
Specifies the organization, to fetch the LicenseLicenseInfoView under it.
