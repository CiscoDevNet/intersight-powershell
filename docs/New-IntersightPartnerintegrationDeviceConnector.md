...
# New-IntersightPartnerintegrationDeviceConnector
...
New-IntersightPartnerintegrationDeviceConnector [-Action< PartnerintegrationDeviceConnector.ActionEnum>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;PartnerintegrationDeviceConnector&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightPartnerintegrationDeviceConnector
```
