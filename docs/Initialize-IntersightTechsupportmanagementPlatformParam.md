...
Initialize-IntersightTechsupportmanagementPlatformParam [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< TechsupportmanagementPlatformParam.ClassIdEnum>][-CollectionType< TechsupportmanagementPlatformParam.CollectionTypeEnum>][-IncludeCore< bool>][-ObjectType< TechsupportmanagementPlatformParam.ObjectTypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
