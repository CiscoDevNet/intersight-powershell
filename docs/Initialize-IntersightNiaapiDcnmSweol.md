...
# Initialize-IntersightNiaapiDcnmSweol
...
Initialize-IntersightNiaapiDcnmSweol [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AffectedVersions< string>][-AnnouncementDate< DateTime>][-AnnouncementDateEpoch< long>][-BulletinNo< string>][-ClassId< NiaapiDcnmSweol.ClassIdEnum>][-Description< string>][-EndofNewServiceAttachmentDate< DateTime>][-EndofNewServiceAttachmentDateEpoch< long>][-EndofServiceContractRenewalDate< DateTime>][-EndofServiceContractRenewalDateEpoch< long>][-EndofSwMaintenanceDate< DateTime>][-EndofSwMaintenanceDateEpoch< long>][-Headline< string>][-LastDateofSupport< DateTime>][-LastDateofSupportEpoch< long>][-LastShipDate< DateTime>][-LastShipDateEpoch< long>][-MigrationUrl< string>][-Moid< string>][-ObjectType< NiaapiDcnmSweol.ObjectTypeEnum>][-SoftwareEolUrl< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: NiaapiDcnmSweol.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: NiaapiDcnmSweol.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightNiaapiDcnmSweol
```
