...
Initialize-IntersightCapabilitySwitchingModeCapability [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< CapabilitySwitchingModeCapability.ClassIdEnum>][-ObjectType< CapabilitySwitchingModeCapability.ObjectTypeEnum>][-SwitchingMode< CapabilitySwitchingModeCapability.SwitchingModeEnum>][-VpCompressionSupported< bool>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
