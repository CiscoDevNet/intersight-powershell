...
```powershell
$StoragePureReplicationScheduleAllOf = Initialize-IntersightStoragePureReplicationScheduleAllOf  -ClassId null `
 -ObjectType null `
 -DailyLimit null `
...
```powershell
$StoragePureReplicationScheduleAllOf | ConvertTo-JSON
```
