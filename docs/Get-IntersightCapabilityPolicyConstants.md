...
# Get-IntersightCapabilityPolicyConstants

## SYNOPSIS
Get the CapabilityPolicyConstants

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityPolicyConstants [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityPolicyConstants [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilityPolicyConstants&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityPolicyConstants
```
Above example returns the list of CapabilityPolicyConstants.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityPolicyConstants -Name "MoName"
```
Above example returns the CapabilityPolicyConstants matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityPolicyConstants -Organization $organization
```
Above example returns the list of CapabilityPolicyConstants available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityPolicyConstants -InlineCount allpages
```
Above example returns the list of CapabilityPolicyConstants along with count.
...
### -Name
Specifies the name of the CapabilityPolicyConstants.
...
### -Organization
Specifies the organization, to fetch the CapabilityPolicyConstants under it.
