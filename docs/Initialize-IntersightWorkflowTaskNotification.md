...
# Initialize-IntersightWorkflowTaskNotification
...
Initialize-IntersightWorkflowTaskNotification [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< WorkflowTaskNotification.ClassIdEnum>][-CorrelationId< string>][-EndTime< string>][-Input< string>][-Iteration< long>][-LoopOverTask< bool>][-Moid< string>][-ObjectType< WorkflowTaskNotification.ObjectTypeEnum>][-Output< string>][-ReasonForIncompletion< string>][-ReferenceTaskName< string>][-RetryCount< float>][-ScheduledTime< string>][-StartTime< string>][-Status< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TaskDefName< string>][-TaskDescription< string>][-TaskId< string>][-TaskType< string>][-UpdateTime< string>][-WorkflowId< string>][-WorkflowTaskType< string>][-WorkflowType< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowTaskNotification.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowTaskNotification.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowTaskNotification
```
