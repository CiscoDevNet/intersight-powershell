...
```powershell
$NiatelemetryNexusDashboardControllerDetailsResponse = Initialize-IntersightNiatelemetryNexusDashboardControllerDetailsResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiatelemetryNexusDashboardControllerDetailsResponse | ConvertTo-JSON
```
