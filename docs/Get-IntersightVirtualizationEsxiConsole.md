...
## SYNOPSIS
Get the VirtualizationEsxiConsole

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationEsxiConsole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationEsxiConsole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationEsxiConsole&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationEsxiConsole
```
Above example returns the list of VirtualizationEsxiConsole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationEsxiConsole -Name "MoName"
```
Above example returns the VirtualizationEsxiConsole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationEsxiConsole -Organization $organization
```
Above example returns the list of VirtualizationEsxiConsole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationEsxiConsole -InlineCount allpages
```
Above example returns the list of VirtualizationEsxiConsole along with count.
...
### -Name
Specifies the name of the VirtualizationEsxiConsole.
...
### -Organization
Specifies the organization, to fetch the VirtualizationEsxiConsole under it.
