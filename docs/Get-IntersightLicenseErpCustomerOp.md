...
# Get-IntersightLicenseErpCustomerOp

## SYNOPSIS
Get the LicenseErpCustomerOp

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightLicenseErpCustomerOp [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightLicenseErpCustomerOp [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;LicenseErpCustomerOp&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightLicenseErpCustomerOp
```
Above example returns the list of LicenseErpCustomerOp.

### Example 2
```powershell
PS C:\> $result = Get-IntersightLicenseErpCustomerOp -Name "MoName"
```
Above example returns the LicenseErpCustomerOp matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightLicenseErpCustomerOp -Organization $organization
```
Above example returns the list of LicenseErpCustomerOp available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightLicenseErpCustomerOp -InlineCount allpages
```
Above example returns the list of LicenseErpCustomerOp along with count.
...
### -Name
Specifies the name of the LicenseErpCustomerOp.
...
### -Organization
Specifies the organization, to fetch the LicenseErpCustomerOp under it.
...
[Set-IntersightLicenseErpCustomerOp](./Set-IntersightLicenseErpCustomerOp.md)
