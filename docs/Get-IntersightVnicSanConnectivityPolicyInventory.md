...
# Get-IntersightVnicSanConnectivityPolicyInventory

## SYNOPSIS
Get the VnicSanConnectivityPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicSanConnectivityPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicSanConnectivityPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicSanConnectivityPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicSanConnectivityPolicyInventory
```
Above example returns the list of VnicSanConnectivityPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicSanConnectivityPolicyInventory -Name "MoName"
```
Above example returns the VnicSanConnectivityPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicSanConnectivityPolicyInventory -Organization $organization
```
Above example returns the list of VnicSanConnectivityPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicSanConnectivityPolicyInventory -InlineCount allpages
```
Above example returns the list of VnicSanConnectivityPolicyInventory along with count.
...
### -Name
Specifies the name of the VnicSanConnectivityPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the VnicSanConnectivityPolicyInventory under it.
