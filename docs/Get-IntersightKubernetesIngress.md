...
## SYNOPSIS
Get the KubernetesIngress

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesIngress [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesIngress [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KubernetesIngress&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesIngress
```
Above example returns the list of KubernetesIngress.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesIngress -Name "MoName"
```
Above example returns the KubernetesIngress matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesIngress -Organization $organization
```
Above example returns the list of KubernetesIngress available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesIngress -InlineCount allpages
```
Above example returns the list of KubernetesIngress along with count.
...
### -Name
Specifies the name of the KubernetesIngress.
...
### -Organization
Specifies the organization, to fetch the KubernetesIngress under it.
...
[Remove-IntersightKubernetesIngress](./Remove-IntersightKubernetesIngress.md)
