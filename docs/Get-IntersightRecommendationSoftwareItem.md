...
# Get-IntersightRecommendationSoftwareItem

## SYNOPSIS
Get the RecommendationSoftwareItem

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRecommendationSoftwareItem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRecommendationSoftwareItem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;RecommendationSoftwareItem&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRecommendationSoftwareItem
```
Above example returns the list of RecommendationSoftwareItem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRecommendationSoftwareItem -Name "MoName"
```
Above example returns the RecommendationSoftwareItem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRecommendationSoftwareItem -Organization $organization
```
Above example returns the list of RecommendationSoftwareItem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRecommendationSoftwareItem -InlineCount allpages
```
Above example returns the list of RecommendationSoftwareItem along with count.
...
### -Name
Specifies the name of the RecommendationSoftwareItem.
...
### -Organization
Specifies the organization, to fetch the RecommendationSoftwareItem under it.
