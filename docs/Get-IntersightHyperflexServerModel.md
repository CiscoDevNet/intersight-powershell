...
## SYNOPSIS
Get the HyperflexServerModel

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexServerModel [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexServerModel [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexServerModel
```
Above example returns the list of HyperflexServerModel.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexServerModel -Name "MoName"
```
Above example returns the HyperflexServerModel matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexServerModel -Organization $organization
```
Above example returns the list of HyperflexServerModel available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexServerModel -InlineCount allpages
```
Above example returns the list of HyperflexServerModel along with count.
...
### -Name
Specifies the name of the HyperflexServerModel.
...
### -Organization
Specifies the organization, to fetch the HyperflexServerModel under it.
