...
# Get-IntersightIaasDeviceStatus

## SYNOPSIS
Get the IaasDeviceStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIaasDeviceStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIaasDeviceStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IaasDeviceStatus&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIaasDeviceStatus
```
Above example returns the list of IaasDeviceStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIaasDeviceStatus -Name "MoName"
```
Above example returns the IaasDeviceStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIaasDeviceStatus -Organization $organization
```
Above example returns the list of IaasDeviceStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIaasDeviceStatus -InlineCount allpages
```
Above example returns the list of IaasDeviceStatus along with count.
...
### -Name
Specifies the name of the IaasDeviceStatus.
...
### -Organization
Specifies the organization, to fetch the IaasDeviceStatus under it.
