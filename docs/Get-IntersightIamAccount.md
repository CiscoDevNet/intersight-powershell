...
### CmdletParam (Default)
```
Get-IntersightIamAccount [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamAccount [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IamAccount&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamAccount
```
Above example returns the list of IamAccount.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamAccount -Name "MoName"
```
Above example returns the IamAccount matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamAccount -Organization $organization
```
Above example returns the list of IamAccount available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamAccount -InlineCount allpages
```
Above example returns the list of IamAccount along with count.
...
### -Name
Specifies the name of the IamAccount.
...
### -Organization
Specifies the organization, to fetch the IamAccount under it.
