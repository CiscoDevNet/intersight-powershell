...
## SYNOPSIS
Get the StoragePureProtectionGroupSnapshot

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureProtectionGroupSnapshot [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureProtectionGroupSnapshot [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StoragePureProtectionGroupSnapshot&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureProtectionGroupSnapshot
```
Above example returns the list of StoragePureProtectionGroupSnapshot.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureProtectionGroupSnapshot -Name "MoName"
```
Above example returns the StoragePureProtectionGroupSnapshot matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureProtectionGroupSnapshot -Organization $organization
```
Above example returns the list of StoragePureProtectionGroupSnapshot available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureProtectionGroupSnapshot -InlineCount allpages
```
Above example returns the list of StoragePureProtectionGroupSnapshot along with count.
...
### -Name
Specifies the name of the StoragePureProtectionGroupSnapshot.
...
### -Organization
Specifies the organization, to fetch the StoragePureProtectionGroupSnapshot under it.
