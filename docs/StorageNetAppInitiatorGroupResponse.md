...
```powershell
$StorageNetAppInitiatorGroupResponse = Initialize-IntersightStorageNetAppInitiatorGroupResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageNetAppInitiatorGroupResponse | ConvertTo-JSON
```
