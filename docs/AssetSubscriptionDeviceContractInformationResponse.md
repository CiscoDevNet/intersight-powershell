...
```powershell
$AssetSubscriptionDeviceContractInformationResponse = Initialize-IntersightAssetSubscriptionDeviceContractInformationResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$AssetSubscriptionDeviceContractInformationResponse | ConvertTo-JSON
```
