...
Set-IntersightComputeRackUnitIdentity [-AdditionalProperties< Dictionary<string,object>>][-AdminAction< ComputeRackUnitIdentity.AdminActionEnum>][[-Moid]< string>][-PhysicalDeviceRegistration< AssetDeviceRegistrationRelationship>][-Tags< List<MoTag>>]
