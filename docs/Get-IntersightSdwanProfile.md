...
# Get-IntersightSdwanProfile

## SYNOPSIS
Get the SdwanProfile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSdwanProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSdwanProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SdwanProfile&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSdwanProfile
```
Above example returns the list of SdwanProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSdwanProfile -Name "MoName"
```
Above example returns the SdwanProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSdwanProfile -Organization $organization
```
Above example returns the list of SdwanProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSdwanProfile -InlineCount allpages
```
Above example returns the list of SdwanProfile along with count.
...
### -Name
Specifies the name of the SdwanProfile.
...
### -Organization
Specifies the organization, to fetch the SdwanProfile under it.
