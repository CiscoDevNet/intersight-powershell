...
# Get-IntersightApplianceDeviceClusterInstall

## SYNOPSIS
Get the ApplianceDeviceClusterInstall

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceDeviceClusterInstall [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceDeviceClusterInstall [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceDeviceClusterInstall&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceClusterInstall
```
Above example returns the list of ApplianceDeviceClusterInstall.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceClusterInstall -Name "MoName"
```
Above example returns the ApplianceDeviceClusterInstall matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceClusterInstall -Organization $organization
```
Above example returns the list of ApplianceDeviceClusterInstall available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceClusterInstall -InlineCount allpages
```
Above example returns the list of ApplianceDeviceClusterInstall along with count.
...
### -Name
Specifies the name of the ApplianceDeviceClusterInstall.
...
### -Organization
Specifies the organization, to fetch the ApplianceDeviceClusterInstall under it.
