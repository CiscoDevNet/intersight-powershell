...
# Initialize-IntersightMacpoolPool
...
```yaml
Type: System.Collections.Generic.List`1[Model.MacpoolBlock]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: MacpoolPool.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightMacpoolPool
```
