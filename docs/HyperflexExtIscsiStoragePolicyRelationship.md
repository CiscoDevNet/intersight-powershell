...
```powershell
$HyperflexExtIscsiStoragePolicyRelationship = Initialize-IntersightHyperflexExtIscsiStoragePolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexExtIscsiStoragePolicyRelationship | ConvertTo-JSON
```
