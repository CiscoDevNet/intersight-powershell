...
## SYNOPSIS
Get the HyperflexConfigResultEntry

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexConfigResultEntry [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexConfigResultEntry [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexConfigResultEntry&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexConfigResultEntry
```
Above example returns the list of HyperflexConfigResultEntry.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexConfigResultEntry -Name "MoName"
```
Above example returns the HyperflexConfigResultEntry matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexConfigResultEntry -Organization $organization
```
Above example returns the list of HyperflexConfigResultEntry available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexConfigResultEntry -InlineCount allpages
```
Above example returns the list of HyperflexConfigResultEntry along with count.
...
### -Name
Specifies the name of the HyperflexConfigResultEntry.
...
### -Organization
Specifies the organization, to fetch the HyperflexConfigResultEntry under it.
