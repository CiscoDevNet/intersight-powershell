...
### CmdletParam (Default)
```
Get-IntersightVmrcConsole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVmrcConsole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VmrcConsole&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVmrcConsole
```
Above example returns the list of VmrcConsole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVmrcConsole -Name "MoName"
```
Above example returns the VmrcConsole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVmrcConsole -Organization $organization
```
Above example returns the list of VmrcConsole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVmrcConsole -InlineCount allpages
```
Above example returns the list of VmrcConsole along with count.
...
### -Name
Specifies the name of the VmrcConsole.
...
### -Organization
Specifies the organization, to fetch the VmrcConsole under it.
