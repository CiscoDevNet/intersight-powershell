...
# Get-IntersightOauthAccessToken

## SYNOPSIS
Get the OauthAccessToken

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOauthAccessToken [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOauthAccessToken [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;OauthAccessToken&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOauthAccessToken
```
Above example returns the list of OauthAccessToken.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOauthAccessToken -Name "MoName"
```
Above example returns the OauthAccessToken matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOauthAccessToken -Organization $organization
```
Above example returns the list of OauthAccessToken available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOauthAccessToken -InlineCount allpages
```
Above example returns the list of OauthAccessToken along with count.
...
### -Name
Specifies the name of the OauthAccessToken.
...
### -Organization
Specifies the organization, to fetch the OauthAccessToken under it.
...
[Remove-IntersightOauthAccessToken](./Remove-IntersightOauthAccessToken.md)
