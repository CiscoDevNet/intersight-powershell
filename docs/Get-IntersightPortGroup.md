...
### CmdletParam (Default)
```
Get-IntersightPortGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPortGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PortGroup&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPortGroup
```
Above example returns the list of PortGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPortGroup -Name "MoName"
```
Above example returns the PortGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPortGroup -Organization $organization
```
Above example returns the list of PortGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPortGroup -InlineCount allpages
```
Above example returns the list of PortGroup along with count.
...
### -Organization
Specifies the organization, to fetch the PortGroup under it.
...
[Set-IntersightPortGroup](./Set-IntersightPortGroup.md)
