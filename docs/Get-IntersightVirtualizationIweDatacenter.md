...
## SYNOPSIS
Get the VirtualizationIweDatacenter

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationIweDatacenter [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationIweDatacenter [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweDatacenter
```
Above example returns the list of VirtualizationIweDatacenter.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweDatacenter -Name "MoName"
```
Above example returns the VirtualizationIweDatacenter matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweDatacenter -Organization $organization
```
Above example returns the list of VirtualizationIweDatacenter available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweDatacenter -InlineCount allpages
```
Above example returns the list of VirtualizationIweDatacenter along with count.
...
### -Name
Specifies the name of the VirtualizationIweDatacenter.
...
### -Organization
Specifies the organization, to fetch the VirtualizationIweDatacenter under it.
