...
```powershell
$RecoveryScheduleConfigPolicyRelationship = Initialize-IntersightRecoveryScheduleConfigPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$RecoveryScheduleConfigPolicyRelationship | ConvertTo-JSON
```
