...
## SYNOPSIS
Get the NiatelemetryDcnmTransceiverDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryDcnmTransceiverDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryDcnmTransceiverDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryDcnmTransceiverDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmTransceiverDetails
```
Above example returns the list of NiatelemetryDcnmTransceiverDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmTransceiverDetails -Name "MoName"
```
Above example returns the NiatelemetryDcnmTransceiverDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmTransceiverDetails -Organization $organization
```
Above example returns the list of NiatelemetryDcnmTransceiverDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmTransceiverDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryDcnmTransceiverDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryDcnmTransceiverDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryDcnmTransceiverDetails under it.
