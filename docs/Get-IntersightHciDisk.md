...
### CmdletParam (Default)
```
Get-IntersightHciDisk [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciDisk [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciDisk&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciDisk
```
Above example returns the list of HciDisk.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciDisk -Name "MoName"
```
Above example returns the HciDisk matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciDisk -Organization $organization
```
Above example returns the list of HciDisk available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciDisk -InlineCount allpages
```
Above example returns the list of HciDisk along with count.
...
### -Name
Specifies the name of the HciDisk.
...
### -Organization
Specifies the organization, to fetch the HciDisk under it.
