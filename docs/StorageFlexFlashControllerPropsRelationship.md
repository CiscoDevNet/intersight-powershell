...
```powershell
$StorageFlexFlashControllerPropsRelationship = Initialize-IntersightStorageFlexFlashControllerPropsRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StorageFlexFlashControllerPropsRelationship | ConvertTo-JSON
```
