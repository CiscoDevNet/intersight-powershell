...
```powershell
$StoragePhysicalDiskExtensionRelationship = Initialize-IntersightStoragePhysicalDiskExtensionRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StoragePhysicalDiskExtensionRelationship | ConvertTo-JSON
```
