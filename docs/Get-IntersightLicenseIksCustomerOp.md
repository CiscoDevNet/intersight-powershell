...
## SYNOPSIS
Get the LicenseIksCustomerOp

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightLicenseIksCustomerOp [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightLicenseIksCustomerOp [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;LicenseIksCustomerOp&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightLicenseIksCustomerOp
```
Above example returns the list of LicenseIksCustomerOp.

### Example 2
```powershell
PS C:\> $result = Get-IntersightLicenseIksCustomerOp -Name "MoName"
```
Above example returns the LicenseIksCustomerOp matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightLicenseIksCustomerOp -Organization $organization
```
Above example returns the list of LicenseIksCustomerOp available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightLicenseIksCustomerOp -InlineCount allpages
```
Above example returns the list of LicenseIksCustomerOp along with count.
...
### -Name
Specifies the name of the LicenseIksCustomerOp.
...
### -Organization
Specifies the organization, to fetch the LicenseIksCustomerOp under it.
...
[Set-IntersightLicenseIksCustomerOp](./Set-IntersightLicenseIksCustomerOp.md)
