...
## SYNOPSIS
Get the AdapterConfigPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAdapterConfigPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAdapterConfigPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAdapterConfigPolicy
```
Above example returns the list of AdapterConfigPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAdapterConfigPolicy -Name "MoName"
```
Above example returns the AdapterConfigPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAdapterConfigPolicy -Organization $organization
```
Above example returns the list of AdapterConfigPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAdapterConfigPolicy -InlineCount allpages
```
Above example returns the list of AdapterConfigPolicy along with count.
...
### -Name
Specifies the name of the AdapterConfigPolicy.
...
### -Organization
Specifies the organization, to fetch the AdapterConfigPolicy under it.
