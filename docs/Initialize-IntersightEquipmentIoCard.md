...
# Initialize-IntersightEquipmentIoCard
...
```yaml
Type: EquipmentIoCard.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.EtherNetworkPortRelationship]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: EquipmentIoCard.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightEquipmentIoCard
```
