...
```yaml
Type: WorkflowServiceItemActionInstance.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.WorkflowServiceItemActionDefinitionRelationship
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowServiceItemActionInstance
```
