...
## SYNOPSIS
Get the StoragePureVolumeSnapshot

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureVolumeSnapshot [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureVolumeSnapshot [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureVolumeSnapshot&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureVolumeSnapshot
```
Above example returns the list of StoragePureVolumeSnapshot.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureVolumeSnapshot -Name "MoName"
```
Above example returns the StoragePureVolumeSnapshot matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureVolumeSnapshot -Organization $organization
```
Above example returns the list of StoragePureVolumeSnapshot available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureVolumeSnapshot -InlineCount allpages
```
Above example returns the list of StoragePureVolumeSnapshot along with count.
...
### -Name
Specifies the name of the StoragePureVolumeSnapshot.
...
### -Organization
Specifies the organization, to fetch the StoragePureVolumeSnapshot under it.
