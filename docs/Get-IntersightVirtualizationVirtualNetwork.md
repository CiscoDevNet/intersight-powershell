...
## SYNOPSIS
Get the VirtualizationVirtualNetwork

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVirtualNetwork [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVirtualNetwork [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVirtualNetwork&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVirtualNetwork
```
Above example returns the list of VirtualizationVirtualNetwork.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVirtualNetwork -Name "MoName"
```
Above example returns the VirtualizationVirtualNetwork matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVirtualNetwork -Organization $organization
```
Above example returns the list of VirtualizationVirtualNetwork available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVirtualNetwork -InlineCount allpages
```
Above example returns the list of VirtualizationVirtualNetwork along with count.
...
### -Name
Specifies the name of the VirtualizationVirtualNetwork.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVirtualNetwork under it.
