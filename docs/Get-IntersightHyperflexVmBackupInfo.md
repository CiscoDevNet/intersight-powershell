...
## SYNOPSIS
Get the HyperflexVmBackupInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexVmBackupInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexVmBackupInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexVmBackupInfo&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexVmBackupInfo
```
Above example returns the list of HyperflexVmBackupInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexVmBackupInfo -Name "MoName"
```
Above example returns the HyperflexVmBackupInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexVmBackupInfo -Organization $organization
```
Above example returns the list of HyperflexVmBackupInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexVmBackupInfo -InlineCount allpages
```
Above example returns the list of HyperflexVmBackupInfo along with count.
...
### -Name
Specifies the name of the HyperflexVmBackupInfo.
...
### -Organization
Specifies the organization, to fetch the HyperflexVmBackupInfo under it.
...
[Remove-IntersightHyperflexVmBackupInfo](./Remove-IntersightHyperflexVmBackupInfo.md)
