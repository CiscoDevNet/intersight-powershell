...
## SYNOPSIS
Get the CloudAwsKeyPair

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudAwsKeyPair [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudAwsKeyPair [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CloudAwsKeyPair&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudAwsKeyPair
```
Above example returns the list of CloudAwsKeyPair.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudAwsKeyPair -Name "MoName"
```
Above example returns the CloudAwsKeyPair matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudAwsKeyPair -Organization $organization
```
Above example returns the list of CloudAwsKeyPair available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudAwsKeyPair -InlineCount allpages
```
Above example returns the list of CloudAwsKeyPair along with count.
...
### -Name
Specifies the name of the CloudAwsKeyPair.
...
### -Organization
Specifies the organization, to fetch the CloudAwsKeyPair under it.
