...
Set-IntersightVirtualizationEsxiConsole [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-DeviceRegistration< AssetDeviceRegistrationRelationship>][-Host< VirtualizationVmwareHostRelationship>][[-Moid]< string>][-Status< VirtualizationEsxiConsole.StatusEnum>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> Set-IntersightVirtualizationEsxiConsole
```
