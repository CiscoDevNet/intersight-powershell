...
# Get-IntersightPowerControlState

## SYNOPSIS
Get the PowerControlState

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPowerControlState [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPowerControlState [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PowerControlState&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPowerControlState
```
Above example returns the list of PowerControlState.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPowerControlState -Name "MoName"
```
Above example returns the PowerControlState matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPowerControlState -Organization $organization
```
Above example returns the list of PowerControlState available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPowerControlState -InlineCount allpages
```
Above example returns the list of PowerControlState along with count.
...
### -Name
Specifies the name of the PowerControlState.
...
### -Organization
Specifies the organization, to fetch the PowerControlState under it.
