...
Initialize-IntersightPolicyConfigResultContext [-AdditionalProperties< Dictionary<string,object>>][-ClassId< PolicyConfigResultContext.ClassIdEnum>][-EntityData< object>][-EntityMoid< string>][-EntityName< string>][-EntityType< string>][-ObjectType< PolicyConfigResultContext.ObjectTypeEnum>]
...
### Example 1
```powershell
PS C:\> Initialize-IntersightPolicyConfigResultContext
```
