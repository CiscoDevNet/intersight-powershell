...
# Initialize-IntersightConsoleConsoleConfig
...
```yaml
Type: ConsoleConsoleConfig.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ConsoleConsoleConfig.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightConsoleConsoleConfig
```
