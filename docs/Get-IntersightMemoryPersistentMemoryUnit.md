...
## SYNOPSIS
Get the MemoryPersistentMemoryUnit

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMemoryPersistentMemoryUnit [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMemoryPersistentMemoryUnit [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MemoryPersistentMemoryUnit&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryUnit
```
Above example returns the list of MemoryPersistentMemoryUnit.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryUnit -Name "MoName"
```
Above example returns the MemoryPersistentMemoryUnit matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryUnit -Organization $organization
```
Above example returns the list of MemoryPersistentMemoryUnit available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryUnit -InlineCount allpages
```
Above example returns the list of MemoryPersistentMemoryUnit along with count.
...
### -Name
Specifies the name of the MemoryPersistentMemoryUnit.
...
### -Organization
Specifies the organization, to fetch the MemoryPersistentMemoryUnit under it.
...
[Set-IntersightMemoryPersistentMemoryUnit](./Set-IntersightMemoryPersistentMemoryUnit.md)
