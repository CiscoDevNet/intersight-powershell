# Intersight.Intersight/Api.IntersightVmediaApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**New-IntersightVmediaPolicy**](IntersightVmediaApi.md#New-IntersightVmediaPolicy) | **POST** /api/v1/vmedia/Policies | Create a &#39;vmedia.Policy&#39; resource.
[**Remove-IntersightVmediaPolicy**](IntersightVmediaApi.md#Remove-IntersightVmediaPolicy) | **DELETE** /api/v1/vmedia/Policies/{Moid} | Delete a &#39;vmedia.Policy&#39; resource.
[**Get-IntersightVmediaPolicyByMoid**](IntersightVmediaApi.md#Get-IntersightVmediaPolicyByMoid) | **GET** /api/v1/vmedia/Policies/{Moid} | Read a &#39;vmedia.Policy&#39; resource.
[**Get-IntersightVmediaPolicyList**](IntersightVmediaApi.md#Get-IntersightVmediaPolicyList) | **GET** /api/v1/vmedia/Policies | Read a &#39;vmedia.Policy&#39; resource.
[**Set-IntersightVmediaPolicy**](IntersightVmediaApi.md#Set-IntersightVmediaPolicy) | **PATCH** /api/v1/vmedia/Policies/{Moid} | Update a &#39;vmedia.Policy&#39; resource.
[**Update-IntersightVmediaPolicy**](IntersightVmediaApi.md#Update-IntersightVmediaPolicy) | **POST** /api/v1/vmedia/Policies/{Moid} | Update a &#39;vmedia.Policy&#39; resource.


<a name="New-IntersightVmediaPolicy"></a>
# **New-IntersightVmediaPolicy**
> VmediaPolicy New-IntersightVmediaPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VmediaPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Create a 'vmedia.Policy' resource.
try {
     $Result = New-IntersightVmediaPolicy -VmediaPolicy $VmediaPolicy -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
    Write-Host ("Exception occured when calling New-IntersightVmediaPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a name="Remove-IntersightVmediaPolicy"></a>
# **Remove-IntersightVmediaPolicy**
> void Remove-IntersightVmediaPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'vmedia.Policy' resource.
try {
     $Result = Remove-IntersightVmediaPolicy -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightVmediaPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightVmediaPolicyByMoid"></a>
# **Get-IntersightVmediaPolicyByMoid**
> VmediaPolicy Get-IntersightVmediaPolicyByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'vmedia.Policy' resource.
try {
     $Result = Get-IntersightVmediaPolicyByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightVmediaPolicyByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightVmediaPolicyList"></a>
# **Get-IntersightVmediaPolicyList**
> VmediaPolicyResponse Get-IntersightVmediaPolicyList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'vmedia.Policy' resource.
try {
     $Result = Get-IntersightVmediaPolicyList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightVmediaPolicyList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightVmediaPolicy"></a>
# **Set-IntersightVmediaPolicy**
> VmediaPolicy Set-IntersightVmediaPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VmediaPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$VmediaPolicy = (Initialize-vmedia.Policy-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -Enabled $false -Encryption $false -LowPowerUsb $false -Mappings @((Initialize-vmedia.Mapping-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AuthenticationProtocol "AuthenticationProtocol_example" -DeviceType "DeviceType_example" -HostName "HostName_example" -IsPasswordSet $false -MountOptions "MountOptions_example" -MountProtocol "MountProtocol_example" -Password "Password_example" -RemoteFile "RemoteFile_example" -RemotePath "RemotePath_example" -Username "Username_example" -VolumeName "VolumeName_example")) -Organization  -Profiles @()) # VmediaPolicy | The 'vmedia.Policy' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'vmedia.Policy' resource.
try {
     $Result = Set-IntersightVmediaPolicy -Moid $Moid -VmediaPolicy $VmediaPolicy -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightVmediaPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightVmediaPolicy"></a>
# **Update-IntersightVmediaPolicy**
> VmediaPolicy Update-IntersightVmediaPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VmediaPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'vmedia.Policy' resource.
try {
     $Result = Update-IntersightVmediaPolicy -Moid $Moid -VmediaPolicy $VmediaPolicy -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightVmediaPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
