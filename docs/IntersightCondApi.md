...
------------- | ------------- | -------------
[**Get-IntersightCondAlarmAggregationByMoid**](IntersightCondApi.md#Get-IntersightCondAlarmAggregationByMoid) | **GET** /api/v1/cond/AlarmAggregations/{Moid} | Read a &#39;cond.AlarmAggregation&#39; resource.
[**Get-IntersightCondAlarmAggregationList**](IntersightCondApi.md#Get-IntersightCondAlarmAggregationList) | **GET** /api/v1/cond/AlarmAggregations | Read a &#39;cond.AlarmAggregation&#39; resource.
...
[**Set-IntersightCondAlarm**](IntersightCondApi.md#Set-IntersightCondAlarm) | **PATCH** /api/v1/cond/Alarms/{Moid} | Update a &#39;cond.Alarm&#39; resource.
[**Update-IntersightCondAlarm**](IntersightCondApi.md#Update-IntersightCondAlarm) | **POST** /api/v1/cond/Alarms/{Moid} | Update a &#39;cond.Alarm&#39; resource.


<a name="Get-IntersightCondAlarmAggregationByMoid"></a>
# **Get-IntersightCondAlarmAggregationByMoid**
> CondAlarmAggregation Get-IntersightCondAlarmAggregationByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'cond.AlarmAggregation' resource.
try {
     $Result = Get-IntersightCondAlarmAggregationByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightCondAlarmAggregationByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a name="Get-IntersightCondAlarmAggregationList"></a>
# **Get-IntersightCondAlarmAggregationList**
> CondAlarmAggregationResponse Get-IntersightCondAlarmAggregationList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'cond.AlarmAggregation' resource.
try {
     $Result = Get-IntersightCondAlarmAggregationList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightCondAlarmAggregationList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
# Read a 'cond.Alarm' resource.
try {
     $Result = Get-IntersightCondAlarmByMoid -Moid $Moid
} catch {
...
# Read a 'cond.Alarm' resource.
try {
     $Result = Get-IntersightCondAlarmList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'cond.HclStatus' resource.
try {
     $Result = Get-IntersightCondHclStatusByMoid -Moid $Moid
} catch {
...
# Read a 'cond.HclStatusDetail' resource.
try {
     $Result = Get-IntersightCondHclStatusDetailByMoid -Moid $Moid
} catch {
...
# Read a 'cond.HclStatusDetail' resource.
try {
     $Result = Get-IntersightCondHclStatusDetailList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'cond.HclStatusJob' resource.
try {
     $Result = Get-IntersightCondHclStatusJobByMoid -Moid $Moid
} catch {
...
# Read a 'cond.HclStatusJob' resource.
try {
     $Result = Get-IntersightCondHclStatusJobList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'cond.HclStatus' resource.
try {
     $Result = Get-IntersightCondHclStatusList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
<a name="Set-IntersightCondAlarm"></a>
# **Set-IntersightCondAlarm**
> CondAlarm Set-IntersightCondAlarm<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-CondAlarm] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'cond.Alarm' resource.
try {
     $Result = Set-IntersightCondAlarm -Moid $Moid -CondAlarm $CondAlarm -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightCondAlarm: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightCondAlarm"></a>
# **Update-IntersightCondAlarm**
> CondAlarm Update-IntersightCondAlarm<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-CondAlarm] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$CondAlarm = (Initialize-cond.Alarm-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Acknowledge "Acknowledge_example" -AcknowledgeBy "AcknowledgeBy_example" -AcknowledgeTime Get-Date -AffectedMoDisplayName "AffectedMoDisplayName_example" -AffectedMoId "AffectedMoId_example" -AffectedMoType "AffectedMoType_example" -AffectedObject "AffectedObject_example" -AncestorMoId "AncestorMoId_example" -AncestorMoType "AncestorMoType_example" -Code "Code_example" -CreationTime Get-Date -Description "Description_example" -LastTransitionTime Get-Date -MsAffectedObject "MsAffectedObject_example" -Name "Name_example" -OrigSeverity "OrigSeverity_example" -Severity "Severity_example" -AffectedMo  -RegisteredDevice ) # CondAlarm | The 'cond.Alarm' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'cond.Alarm' resource.
try {
     $Result = Update-IntersightCondAlarm -Moid $Moid -CondAlarm $CondAlarm -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightCondAlarm: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
