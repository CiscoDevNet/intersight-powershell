...
# Get-IntersightBiosTokenSettings

## SYNOPSIS
Get the BiosTokenSettings

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBiosTokenSettings [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBiosTokenSettings [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBiosTokenSettings
```
Above example returns the list of BiosTokenSettings.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBiosTokenSettings -Name "MoName"
```
Above example returns the BiosTokenSettings matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBiosTokenSettings -Organization $organization
```
Above example returns the list of BiosTokenSettings available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBiosTokenSettings -InlineCount allpages
```
Above example returns the list of BiosTokenSettings along with count.
...
### -Name
Specifies the name of the BiosTokenSettings.
...
### -Organization
Specifies the organization, to fetch the BiosTokenSettings under it.
