...
## SYNOPSIS
Get the CondHclStatusDetail

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCondHclStatusDetail [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCondHclStatusDetail [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;CondHclStatusDetail&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCondHclStatusDetail
```
Above example returns the list of CondHclStatusDetail.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCondHclStatusDetail -Name "MoName"
```
Above example returns the CondHclStatusDetail matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCondHclStatusDetail -Organization $organization
```
Above example returns the list of CondHclStatusDetail available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCondHclStatusDetail -InlineCount allpages
```
Above example returns the list of CondHclStatusDetail along with count.
...
### -Name
Specifies the name of the CondHclStatusDetail.
...
### -Organization
Specifies the organization, to fetch the CondHclStatusDetail under it.
