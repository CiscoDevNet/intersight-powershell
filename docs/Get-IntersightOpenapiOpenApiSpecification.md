...
## SYNOPSIS
Get the OpenapiOpenApiSpecification

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOpenapiOpenApiSpecification [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOpenapiOpenApiSpecification [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;OpenapiOpenApiSpecification&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOpenapiOpenApiSpecification
```
Above example returns the list of OpenapiOpenApiSpecification.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOpenapiOpenApiSpecification -Name "MoName"
```
Above example returns the OpenapiOpenApiSpecification matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOpenapiOpenApiSpecification -Organization $organization
```
Above example returns the list of OpenapiOpenApiSpecification available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOpenapiOpenApiSpecification -InlineCount allpages
```
Above example returns the list of OpenapiOpenApiSpecification along with count.
...
### -Name
Specifies the name of the OpenapiOpenApiSpecification.
...
### -Organization
Specifies the organization, to fetch the OpenapiOpenApiSpecification under it.
...
[Remove-IntersightOpenapiOpenApiSpecification](./Remove-IntersightOpenapiOpenApiSpecification.md)
