...
# Get-IntersightWorkflowServiceItemInstance

## SYNOPSIS
Get the WorkflowServiceItemInstance

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowServiceItemInstance [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowServiceItemInstance [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowServiceItemInstance&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemInstance
```
Above example returns the list of WorkflowServiceItemInstance.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemInstance -Name "MoName"
```
Above example returns the WorkflowServiceItemInstance matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemInstance -Organization $organization
```
Above example returns the list of WorkflowServiceItemInstance available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemInstance -InlineCount allpages
```
Above example returns the list of WorkflowServiceItemInstance along with count.
...
### -Name
Specifies the name of the WorkflowServiceItemInstance.
...
### -Organization
Specifies the organization, to fetch the WorkflowServiceItemInstance under it.
...
[Remove-IntersightWorkflowServiceItemInstance](./Remove-IntersightWorkflowServiceItemInstance.md)
