...
# Initialize-IntersightPartnerintegrationFile
...
Initialize-IntersightPartnerintegrationFile [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Catalog< Model.SoftwarerepositoryCatalogRelationship>][-ClassId< PartnerintegrationFile.ClassIdEnum>][-Description< string>][-FileType< PartnerintegrationFile.FileTypeEnum>][-ImportAction< PartnerintegrationFile.ImportActionEnum>][-ImportState< PartnerintegrationFile.ImportStateEnum>][-Md5eTag< string>][-Md5sum< string>][-Moid< string>][-Name< string>][-ObjectType< PartnerintegrationFile.ObjectTypeEnum>][-ReleaseDate< DateTime>][-Sha512sum< string>][-Size< long>][-SoftwareAdvisoryUrl< string>][-Source< Model.SoftwarerepositoryFileServer>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Version< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: PartnerintegrationFile.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: PartnerintegrationFile.ImportActionEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: PartnerintegrationFile.ImportStateEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: PartnerintegrationFile.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightPartnerintegrationFile
```
