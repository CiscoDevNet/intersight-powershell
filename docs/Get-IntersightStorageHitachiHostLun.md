...
## SYNOPSIS
Get the StorageHitachiHostLun

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiHostLun [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiHostLun [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageHitachiHostLun&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiHostLun
```
Above example returns the list of StorageHitachiHostLun.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiHostLun -Name "MoName"
```
Above example returns the StorageHitachiHostLun matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiHostLun -Organization $organization
```
Above example returns the list of StorageHitachiHostLun available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiHostLun -InlineCount allpages
```
Above example returns the list of StorageHitachiHostLun along with count.
...
### -Name
Specifies the name of the StorageHitachiHostLun.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiHostLun under it.
