...
Set-IntersightEquipmentFru [-Action< EquipmentFru.ActionEnum>][-AdditionalProperties< Dictionary<string,object>>][-CurrentFru< EquipmentBaseRelationship>][[-Moid]< string>][-PreviousFru< EquipmentFruRelationship>][-Tags< List<MoTag>>]
