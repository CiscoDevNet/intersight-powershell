...
Set-IntersightFabricSwitchClusterProfile [-AdditionalProperties< Dictionary<string,object>>][-Description< string>][[-Moid]< string>][-Name< string>][-Organization< OrganizationOrganizationRelationship>][-SrcTemplate< PolicyAbstractProfileRelationship>][-SwitchProfiles< List<FabricSwitchProfileRelationship>>][-Tags< List<MoTag>>][-Type< FabricSwitchClusterProfile.TypeEnum>]
