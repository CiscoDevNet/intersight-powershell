# Intersight.Intersight/Api.IntersightVrfApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**New-IntersightVrfVrf**](IntersightVrfApi.md#New-IntersightVrfVrf) | **POST** /api/v1/vrf/Vrves | Create a &#39;vrf.Vrf&#39; resource.
[**Remove-IntersightVrfVrf**](IntersightVrfApi.md#Remove-IntersightVrfVrf) | **DELETE** /api/v1/vrf/Vrves/{Moid} | Delete a &#39;vrf.Vrf&#39; resource.
[**Get-IntersightVrfVrfByMoid**](IntersightVrfApi.md#Get-IntersightVrfVrfByMoid) | **GET** /api/v1/vrf/Vrves/{Moid} | Read a &#39;vrf.Vrf&#39; resource.
[**Get-IntersightVrfVrfList**](IntersightVrfApi.md#Get-IntersightVrfVrfList) | **GET** /api/v1/vrf/Vrves | Read a &#39;vrf.Vrf&#39; resource.
[**Set-IntersightVrfVrf**](IntersightVrfApi.md#Set-IntersightVrfVrf) | **PATCH** /api/v1/vrf/Vrves/{Moid} | Update a &#39;vrf.Vrf&#39; resource.
[**Update-IntersightVrfVrf**](IntersightVrfApi.md#Update-IntersightVrfVrf) | **POST** /api/v1/vrf/Vrves/{Moid} | Update a &#39;vrf.Vrf&#39; resource.


<a name="New-IntersightVrfVrf"></a>
# **New-IntersightVrfVrf**
> VrfVrf New-IntersightVrfVrf<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VrfVrf] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Create a 'vrf.Vrf' resource.
try {
    VrfVrf $Result = New-IntersightVrfVrf -VrfVrf $VrfVrf -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
    Write-Host ("Exception occured when calling New-IntersightVrfVrf: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a name="Remove-IntersightVrfVrf"></a>
# **Remove-IntersightVrfVrf**
> void Remove-IntersightVrfVrf<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'vrf.Vrf' resource.
try {
    Remove-IntersightVrfVrf -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightVrfVrf: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightVrfVrfByMoid"></a>
# **Get-IntersightVrfVrfByMoid**
> VrfVrf Get-IntersightVrfVrfByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'vrf.Vrf' resource.
try {
    VrfVrf $Result = Get-IntersightVrfVrfByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightVrfVrfByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightVrfVrfList"></a>
# **Get-IntersightVrfVrfList**
> VrfVrfResponse Get-IntersightVrfVrfList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'vrf.Vrf' resource.
try {
    VrfVrfResponse $Result = Get-IntersightVrfVrfList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightVrfVrfList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightVrfVrf"></a>
# **Set-IntersightVrfVrf**
> VrfVrf Set-IntersightVrfVrf<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VrfVrf] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$VrfVrf = (Initialize-vrf.Vrf-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -Account ) # VrfVrf | The 'vrf.Vrf' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'vrf.Vrf' resource.
try {
    VrfVrf $Result = Set-IntersightVrfVrf -Moid $Moid -VrfVrf $VrfVrf -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightVrfVrf: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightVrfVrf"></a>
# **Update-IntersightVrfVrf**
> VrfVrf Update-IntersightVrfVrf<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VrfVrf] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'vrf.Vrf' resource.
try {
    VrfVrf $Result = Update-IntersightVrfVrf -Moid $Moid -VrfVrf $VrfVrf -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightVrfVrf: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
