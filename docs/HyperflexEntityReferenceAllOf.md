...
```powershell
$HyperflexEntityReferenceAllOf = Initialize-IntersightHyperflexEntityReferenceAllOf  -ClassId null `
 -ObjectType null `
 -Confignum null `
 -Id null `
 -Idtype null `
...
```powershell
$HyperflexEntityReferenceAllOf | ConvertTo-JSON
```
