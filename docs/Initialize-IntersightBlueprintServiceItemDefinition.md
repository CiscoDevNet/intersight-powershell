...
# Initialize-IntersightBlueprintServiceItemDefinition
...
Initialize-IntersightBlueprintServiceItemDefinition [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-CatalogMoid< string>][-ClassId< BlueprintServiceItemDefinition.ClassIdEnum>][-Description< string>][-InputParameters< object>][-Label< string>][-ObjectType< BlueprintServiceItemDefinition.ObjectTypeEnum>][-ServiceItemDefinitionName< string>][-Version< long>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: BlueprintServiceItemDefinition.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: BlueprintServiceItemDefinition.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightBlueprintServiceItemDefinition
```
