...
New-IntersightIamPrivateKeySpec [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Algorithm< PkixKeyGenerationSpec>][-CertificateRequest< IamCertificateRequestRelationship>][-Moid< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
