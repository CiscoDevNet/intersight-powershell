...
# Get-IntersightVmediaPolicy

## SYNOPSIS
Get the VmediaPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVmediaPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVmediaPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVmediaPolicy
```
Above example returns the list of VmediaPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVmediaPolicy -Name "MoName"
```
Above example returns the VmediaPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVmediaPolicy -Organization $organization
```
Above example returns the list of VmediaPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVmediaPolicy -InlineCount allpages
```
Above example returns the list of VmediaPolicy along with count.
...
### -Name
Specifies the name of the VmediaPolicy.
...
### -Organization
Specifies the organization, to fetch the VmediaPolicy under it.
