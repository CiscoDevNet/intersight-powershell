...
## SYNOPSIS
Get the FabricFcNetworkPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricFcNetworkPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricFcNetworkPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;FabricFcNetworkPolicy&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricFcNetworkPolicy
```
Above example returns the list of FabricFcNetworkPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricFcNetworkPolicy -Name "MoName"
```
Above example returns the FabricFcNetworkPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricFcNetworkPolicy -Organization $organization
```
Above example returns the list of FabricFcNetworkPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricFcNetworkPolicy -InlineCount allpages
```
Above example returns the list of FabricFcNetworkPolicy along with count.
...
### -Name
Specifies the name of the FabricFcNetworkPolicy.
...
### -Organization
Specifies the organization, to fetch the FabricFcNetworkPolicy under it.
