...
# Get-IntersightStoragePureFlashBladeSystem

## SYNOPSIS
Get the StoragePureFlashBladeSystem

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureFlashBladeSystem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureFlashBladeSystem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureFlashBladeSystem&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureFlashBladeSystem
```
Above example returns the list of StoragePureFlashBladeSystem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureFlashBladeSystem -Name "MoName"
```
Above example returns the StoragePureFlashBladeSystem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureFlashBladeSystem -Organization $organization
```
Above example returns the list of StoragePureFlashBladeSystem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureFlashBladeSystem -InlineCount allpages
```
Above example returns the list of StoragePureFlashBladeSystem along with count.
...
### -Name
Specifies the name of the StoragePureFlashBladeSystem.
...
### -Organization
Specifies the organization, to fetch the StoragePureFlashBladeSystem under it.
...
[Set-IntersightStoragePureFlashBladeSystem](./Set-IntersightStoragePureFlashBladeSystem.md)
