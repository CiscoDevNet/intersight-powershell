...
```powershell
$FirmwareServerConfigurationUtilityDistributableList = Initialize-IntersightFirmwareServerConfigurationUtilityDistributableList  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$FirmwareServerConfigurationUtilityDistributableList | ConvertTo-JSON
```
