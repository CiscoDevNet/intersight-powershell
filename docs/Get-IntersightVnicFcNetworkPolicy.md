...
## SYNOPSIS
Get the VnicFcNetworkPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicFcNetworkPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicFcNetworkPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicFcNetworkPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicFcNetworkPolicy
```
Above example returns the list of VnicFcNetworkPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicFcNetworkPolicy -Name "MoName"
```
Above example returns the VnicFcNetworkPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicFcNetworkPolicy -Organization $organization
```
Above example returns the list of VnicFcNetworkPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicFcNetworkPolicy -InlineCount allpages
```
Above example returns the list of VnicFcNetworkPolicy along with count.
...
### -Name
Specifies the name of the VnicFcNetworkPolicy.
...
### -Organization
Specifies the organization, to fetch the VnicFcNetworkPolicy under it.
