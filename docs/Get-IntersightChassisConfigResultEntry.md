...
### CmdletParam (Default)
```
Get-IntersightChassisConfigResultEntry [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightChassisConfigResultEntry [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightChassisConfigResultEntry
```
Above example returns the list of ChassisConfigResultEntry.

### Example 2
```powershell
PS C:\> $result = Get-IntersightChassisConfigResultEntry -Name "MoName"
```
Above example returns the ChassisConfigResultEntry matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightChassisConfigResultEntry -Organization $organization
```
Above example returns the list of ChassisConfigResultEntry available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightChassisConfigResultEntry -InlineCount allpages
```
Above example returns the list of ChassisConfigResultEntry along with count.
...
### -Name
Specifies the name of the ChassisConfigResultEntry.
...
### -Organization
Specifies the organization, to fetch the ChassisConfigResultEntry under it.
