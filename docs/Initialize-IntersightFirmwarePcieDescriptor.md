...
Initialize-IntersightFirmwarePcieDescriptor [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-BrandString< string>][-Capabilities< System.Collections.Generic.List`1[Model.CapabilityCapabilityRelationship]>][-ClassId< FirmwarePcieDescriptor.ClassIdEnum>][-Description< string>][-Label< string>][-Model< string>][-Moid< string>][-ObjectType< FirmwarePcieDescriptor.ObjectTypeEnum>][-Revision< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Vendor< string>][-Version< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: FirmwarePcieDescriptor.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FirmwarePcieDescriptor.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFirmwarePcieDescriptor
```
