...
### CmdletParam (Default)
```
Get-IntersightHciLicense [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciLicense [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciLicense&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciLicense
```
Above example returns the list of HciLicense.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciLicense -Name "MoName"
```
Above example returns the HciLicense matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciLicense -Organization $organization
```
Above example returns the list of HciLicense available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciLicense -InlineCount allpages
```
Above example returns the list of HciLicense along with count.
...
### -Name
Specifies the name of the HciLicense.
...
### -Organization
Specifies the organization, to fetch the HciLicense under it.
