...
# Get-IntersightHciAhvVmDisk

## SYNOPSIS
Get the HciAhvVmDisk

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHciAhvVmDisk [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciAhvVmDisk [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciAhvVmDisk&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciAhvVmDisk
```
Above example returns the list of HciAhvVmDisk.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciAhvVmDisk -Name "MoName"
```
Above example returns the HciAhvVmDisk matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciAhvVmDisk -Organization $organization
```
Above example returns the list of HciAhvVmDisk available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciAhvVmDisk -InlineCount allpages
```
Above example returns the list of HciAhvVmDisk along with count.
...
### -Name
Specifies the name of the HciAhvVmDisk.
...
### -Organization
Specifies the organization, to fetch the HciAhvVmDisk under it.
