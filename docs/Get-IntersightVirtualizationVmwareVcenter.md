...
## SYNOPSIS
Get the VirtualizationVmwareVcenter

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareVcenter [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareVcenter [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareVcenter&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVcenter
```
Above example returns the list of VirtualizationVmwareVcenter.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVcenter -Name "MoName"
```
Above example returns the VirtualizationVmwareVcenter matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVcenter -Organization $organization
```
Above example returns the list of VirtualizationVmwareVcenter available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVcenter -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareVcenter along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareVcenter.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareVcenter under it.
