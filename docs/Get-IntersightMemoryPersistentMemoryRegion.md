...
## SYNOPSIS
Get the MemoryPersistentMemoryRegion

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMemoryPersistentMemoryRegion [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMemoryPersistentMemoryRegion [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MemoryPersistentMemoryRegion&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryRegion
```
Above example returns the list of MemoryPersistentMemoryRegion.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryRegion -Name "MoName"
```
Above example returns the MemoryPersistentMemoryRegion matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryRegion -Organization $organization
```
Above example returns the list of MemoryPersistentMemoryRegion available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryRegion -InlineCount allpages
```
Above example returns the list of MemoryPersistentMemoryRegion along with count.
...
### -Name
Specifies the name of the MemoryPersistentMemoryRegion.
...
### -Organization
Specifies the organization, to fetch the MemoryPersistentMemoryRegion under it.
...
[Set-IntersightMemoryPersistentMemoryRegion](./Set-IntersightMemoryPersistentMemoryRegion.md)
