...
Set-IntersightDeviceconnectorPolicy [-AdditionalProperties< Dictionary<string,object>>][-Description< string>][-LockoutEnabled< bool>][[-Moid]< string>][-Name< string>][-Organization< OrganizationOrganizationRelationship>][-Profiles< List<PolicyAbstractConfigProfileRelationship>>][-Tags< List<MoTag>>]
...
### Example 1
```powershell
PS C:\> Set-IntersightDeviceconnectorPolicy
```
