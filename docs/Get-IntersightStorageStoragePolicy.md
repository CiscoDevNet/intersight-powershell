...
# Get-IntersightStorageStoragePolicy

## SYNOPSIS
Get the StorageStoragePolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageStoragePolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageStoragePolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageStoragePolicy
```
Above example returns the list of StorageStoragePolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageStoragePolicy -Name "MoName"
```
Above example returns the StorageStoragePolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageStoragePolicy -Organization $organization
```
Above example returns the list of StorageStoragePolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageStoragePolicy -InlineCount allpages
```
Above example returns the list of StorageStoragePolicy along with count.
...
### -Name
Specifies the name of the StorageStoragePolicy.
...
### -Organization
Specifies the organization, to fetch the StorageStoragePolicy under it.
