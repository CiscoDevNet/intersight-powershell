...
Initialize-IntersightCertificatemanagementRootCaCertificate [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Certificate< Model.X509Certificate>][-CertificateName< string>][-ClassId< CertificatemanagementRootCaCertificate.ClassIdEnum>][-Enabled< bool>][-ObjectType< CertificatemanagementRootCaCertificate.ObjectTypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: CertificatemanagementRootCaCertificate.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CertificatemanagementRootCaCertificate.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCertificatemanagementRootCaCertificate
```
