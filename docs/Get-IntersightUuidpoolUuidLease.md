...
# Get-IntersightUuidpoolUuidLease

## SYNOPSIS
Get the UuidpoolUuidLease

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightUuidpoolUuidLease [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightUuidpoolUuidLease [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;UuidpoolUuidLease&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightUuidpoolUuidLease
```
Above example returns the list of UuidpoolUuidLease.

### Example 2
```powershell
PS C:\> $result = Get-IntersightUuidpoolUuidLease -Name "MoName"
```
Above example returns the UuidpoolUuidLease matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightUuidpoolUuidLease -Organization $organization
```
Above example returns the list of UuidpoolUuidLease available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightUuidpoolUuidLease -InlineCount allpages
```
Above example returns the list of UuidpoolUuidLease along with count.
...
### -Name
Specifies the name of the UuidpoolUuidLease.
...
### -Organization
Specifies the organization, to fetch the UuidpoolUuidLease under it.
...
[Remove-IntersightUuidpoolUuidLease](./Remove-IntersightUuidpoolUuidLease.md)
