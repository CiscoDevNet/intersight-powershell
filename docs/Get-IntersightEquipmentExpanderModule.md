...
### CmdletParam (Default)
```
Get-IntersightEquipmentExpanderModule [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentExpanderModule [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentExpanderModule
```
Above example returns the list of EquipmentExpanderModule.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentExpanderModule -Name "MoName"
```
Above example returns the EquipmentExpanderModule matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentExpanderModule -Organization $organization
```
Above example returns the list of EquipmentExpanderModule available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentExpanderModule -InlineCount allpages
```
Above example returns the list of EquipmentExpanderModule along with count.
...
### -Name
Specifies the name of the EquipmentExpanderModule.
...
### -Organization
Specifies the organization, to fetch the EquipmentExpanderModule under it.
...
[Set-IntersightEquipmentExpanderModule](./Set-IntersightEquipmentExpanderModule.md)
