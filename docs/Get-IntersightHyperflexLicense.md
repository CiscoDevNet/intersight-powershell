...
## SYNOPSIS
Get the HyperflexLicense

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexLicense [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexLicense [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexLicense&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexLicense
```
Above example returns the list of HyperflexLicense.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexLicense -Name "MoName"
```
Above example returns the HyperflexLicense matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexLicense -Organization $organization
```
Above example returns the list of HyperflexLicense available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexLicense -InlineCount allpages
```
Above example returns the list of HyperflexLicense along with count.
...
### -Name
Specifies the name of the HyperflexLicense.
...
### -Organization
Specifies the organization, to fetch the HyperflexLicense under it.
