...
## SYNOPSIS
Get the NiatelemetryFabricModuleDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryFabricModuleDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryFabricModuleDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryFabricModuleDetails&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricModuleDetails
```
Above example returns the list of NiatelemetryFabricModuleDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricModuleDetails -Name "MoName"
```
Above example returns the NiatelemetryFabricModuleDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricModuleDetails -Organization $organization
```
Above example returns the list of NiatelemetryFabricModuleDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricModuleDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryFabricModuleDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryFabricModuleDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryFabricModuleDetails under it.
