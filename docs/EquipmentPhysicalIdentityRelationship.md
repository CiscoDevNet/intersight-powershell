...
```powershell
$EquipmentPhysicalIdentityRelationship = Initialize-IntersightEquipmentPhysicalIdentityRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$EquipmentPhysicalIdentityRelationship | ConvertTo-JSON
```
