...
# Get-IntersightFabricEthNetworkGroupPolicyInventory

## SYNOPSIS
Get the FabricEthNetworkGroupPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricEthNetworkGroupPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricEthNetworkGroupPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricEthNetworkGroupPolicyInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkGroupPolicyInventory
```
Above example returns the list of FabricEthNetworkGroupPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkGroupPolicyInventory -Name "MoName"
```
Above example returns the FabricEthNetworkGroupPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkGroupPolicyInventory -Organization $organization
```
Above example returns the list of FabricEthNetworkGroupPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkGroupPolicyInventory -InlineCount allpages
```
Above example returns the list of FabricEthNetworkGroupPolicyInventory along with count.
...
### -Name
Specifies the name of the FabricEthNetworkGroupPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the FabricEthNetworkGroupPolicyInventory under it.
