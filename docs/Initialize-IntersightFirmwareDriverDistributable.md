...
# Initialize-IntersightFirmwareDriverDistributable
...
Initialize-IntersightFirmwareDriverDistributable [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Catalog< Model.SoftwarerepositoryCatalogRelationship>][-Category< string>][-ClassId< FirmwareDriverDistributable.ClassIdEnum>][-ComponentMeta< System.Collections.Generic.List`1[Model.FirmwareComponentMeta]>][-Description< string>][-Directory< string>][-DistributableMetas< System.Collections.Generic.List`1[Model.FirmwareDistributableMetaRelationship]>][-ImageType< string>][-ImportAction< FirmwareDriverDistributable.ImportActionEnum>][-ImportState< FirmwareDriverDistributable.ImportStateEnum>][-Md5eTag< string>][-Md5sum< string>][-Mdfid< string>][-Model< string>][-Moid< string>][-Name< string>][-ObjectType< FirmwareDriverDistributable.ObjectTypeEnum>][-Osname< string>][-Osversion< string>][-RecommendedBuild< string>][-Release< Model.SoftwarerepositoryReleaseRelationship>][-ReleaseDate< DateTime>][-ReleaseNotesUrl< string>][-Sha512sum< string>][-Size< long>][-SoftwareAdvisoryUrl< string>][-Source< Model.SoftwarerepositoryFileServer>][-SupportedModels< System.Collections.Generic.List`1[string]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Vendor< string>][-Version< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: FirmwareDriverDistributable.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FirmwareDriverDistributable.ImportActionEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FirmwareDriverDistributable.ImportStateEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FirmwareDriverDistributable.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFirmwareDriverDistributable
```
