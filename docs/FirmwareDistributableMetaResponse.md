...
```powershell
$FirmwareDistributableMetaResponse = Initialize-IntersightFirmwareDistributableMetaResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$FirmwareDistributableMetaResponse | ConvertTo-JSON
```
