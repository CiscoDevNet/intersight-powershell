...
# Get-IntersightApicVpcGroup

## SYNOPSIS
Get the ApicVpcGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApicVpcGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApicVpcGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApicVpcGroup&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApicVpcGroup
```
Above example returns the list of ApicVpcGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApicVpcGroup -Name "MoName"
```
Above example returns the ApicVpcGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApicVpcGroup -Organization $organization
```
Above example returns the list of ApicVpcGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApicVpcGroup -InlineCount allpages
```
Above example returns the list of ApicVpcGroup along with count.
...
### -Name
Specifies the name of the ApicVpcGroup.
...
### -Organization
Specifies the organization, to fetch the ApicVpcGroup under it.
