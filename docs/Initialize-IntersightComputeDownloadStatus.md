...
# Initialize-IntersightComputeDownloadStatus
...
Initialize-IntersightComputeDownloadStatus [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Checksum< Model.ConnectorFileChecksum>][-ClassId< ComputeDownloadStatus.ClassIdEnum>][-DownloadError< string>][-DownloadProgress< long>][-DownloadRetries< long>][-Moid< string>][-ObjectType< ComputeDownloadStatus.ObjectTypeEnum>][-Sha256checksum< byte[]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ComputeDownloadStatus.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ComputeDownloadStatus.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightComputeDownloadStatus
```
