...
# Get-IntersightNiatelemetrySwitchInterface

## SYNOPSIS
Get the NiatelemetrySwitchInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetrySwitchInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetrySwitchInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetrySwitchInterface&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySwitchInterface
```
Above example returns the list of NiatelemetrySwitchInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySwitchInterface -Name "MoName"
```
Above example returns the NiatelemetrySwitchInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySwitchInterface -Organization $organization
```
Above example returns the list of NiatelemetrySwitchInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySwitchInterface -InlineCount allpages
```
Above example returns the list of NiatelemetrySwitchInterface along with count.
...
### -Name
Specifies the name of the NiatelemetrySwitchInterface.
...
### -Organization
Specifies the organization, to fetch the NiatelemetrySwitchInterface under it.
