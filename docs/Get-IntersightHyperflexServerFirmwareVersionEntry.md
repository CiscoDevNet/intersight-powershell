...
### CmdletParam (Default)
```
Get-IntersightHyperflexServerFirmwareVersionEntry [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexServerFirmwareVersionEntry [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;HyperflexServerFirmwareVersionEntry&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexServerFirmwareVersionEntry
```
Above example returns the list of HyperflexServerFirmwareVersionEntry.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexServerFirmwareVersionEntry -Name "MoName"
```
Above example returns the HyperflexServerFirmwareVersionEntry matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexServerFirmwareVersionEntry -Organization $organization
```
Above example returns the list of HyperflexServerFirmwareVersionEntry available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexServerFirmwareVersionEntry -InlineCount allpages
```
Above example returns the list of HyperflexServerFirmwareVersionEntry along with count.
...
### -Name
Specifies the name of the HyperflexServerFirmwareVersionEntry.
...
### -Organization
Specifies the organization, to fetch the HyperflexServerFirmwareVersionEntry under it.
