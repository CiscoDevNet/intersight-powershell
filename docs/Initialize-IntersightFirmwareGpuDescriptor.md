...
# Initialize-IntersightFirmwareGpuDescriptor
...
```yaml
Type: FirmwareGpuDescriptor.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FirmwareGpuDescriptor.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFirmwareGpuDescriptor
```
