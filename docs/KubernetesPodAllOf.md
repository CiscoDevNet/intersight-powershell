...
**Status** | [**KubernetesPodStatus**](KubernetesPodStatus.md) |  | [optional] 
...
```powershell
$KubernetesPodAllOf = Initialize-IntersightKubernetesPodAllOf  -ClassId null `
 -ObjectType null `
 -Status null `
...
```powershell
$KubernetesPodAllOf | ConvertTo-JSON
```
