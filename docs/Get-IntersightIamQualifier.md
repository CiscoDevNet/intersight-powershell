...
# Get-IntersightIamQualifier

## SYNOPSIS
Get the IamQualifier

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamQualifier [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamQualifier [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamQualifier&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamQualifier
```
Above example returns the list of IamQualifier.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamQualifier -Name "MoName"
```
Above example returns the IamQualifier matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamQualifier -Organization $organization
```
Above example returns the list of IamQualifier available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamQualifier -InlineCount allpages
```
Above example returns the list of IamQualifier along with count.
...
### -Name
Specifies the name of the IamQualifier.
...
### -Organization
Specifies the organization, to fetch the IamQualifier under it.
