...
# Initialize-IntersightApplianceDeviceUpgradePolicy
...
```yaml
Type: ApplianceDeviceUpgradePolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ApplianceDeviceUpgradePolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightApplianceDeviceUpgradePolicy
```
