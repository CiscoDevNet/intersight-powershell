...
# Get-IntersightNiatelemetryNicc

## SYNOPSIS
Get the NiatelemetryNicc

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryNicc [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryNicc [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryNicc&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNicc
```
Above example returns the list of NiatelemetryNicc.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNicc -Name "MoName"
```
Above example returns the NiatelemetryNicc matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNicc -Organization $organization
```
Above example returns the list of NiatelemetryNicc available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNicc -InlineCount allpages
```
Above example returns the list of NiatelemetryNicc along with count.
...
### -Name
Specifies the name of the NiatelemetryNicc.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryNicc under it.
