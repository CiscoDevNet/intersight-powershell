...
# New-IntersightIqnpoolReservation
...
New-IntersightIqnpoolReservation [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AllocationType< IqnpoolReservation.AllocationTypeEnum>][-Identity< string>][-Moid< string>][-Organization< OrganizationOrganizationRelationship>][-Pool< IqnpoolPoolRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;IqnpoolReservation&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightIqnpoolReservation
```
