...
# Get-IntersightHyperflexHwCatalog

## SYNOPSIS
Get the HyperflexHwCatalog

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHwCatalog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHwCatalog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHwCatalog&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHwCatalog
```
Above example returns the list of HyperflexHwCatalog.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHwCatalog -Name "MoName"
```
Above example returns the HyperflexHwCatalog matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHwCatalog -Organization $organization
```
Above example returns the list of HyperflexHwCatalog available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHwCatalog -InlineCount allpages
```
Above example returns the list of HyperflexHwCatalog along with count.
...
### -Name
Specifies the name of the HyperflexHwCatalog.
...
### -Organization
Specifies the organization, to fetch the HyperflexHwCatalog under it.
