...
# Initialize-IntersightServerProfileTemplate
...
```yaml
Type: ServerProfileTemplate.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ServerProfileTemplate.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightServerProfileTemplate
```
