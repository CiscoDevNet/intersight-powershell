...
# Get-IntersightConfigExporter

## SYNOPSIS
Get the ConfigExporter

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightConfigExporter [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightConfigExporter [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ConfigExporter&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightConfigExporter
```
Above example returns the list of ConfigExporter.

### Example 2
```powershell
PS C:\> $result = Get-IntersightConfigExporter -Name "MoName"
```
Above example returns the ConfigExporter matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightConfigExporter -Organization $organization
```
Above example returns the list of ConfigExporter available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightConfigExporter -InlineCount allpages
```
Above example returns the list of ConfigExporter along with count.
...
### -Name
Specifies the name of the ConfigExporter.
...
### -Organization
Specifies the organization, to fetch the ConfigExporter under it.
