...
# Get-IntersightHciExternalStorage

## SYNOPSIS
Get the HciExternalStorage

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHciExternalStorage [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciExternalStorage [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciExternalStorage&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciExternalStorage
```
Above example returns the list of HciExternalStorage.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciExternalStorage -Name "MoName"
```
Above example returns the HciExternalStorage matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciExternalStorage -Organization $organization
```
Above example returns the list of HciExternalStorage available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciExternalStorage -InlineCount allpages
```
Above example returns the list of HciExternalStorage along with count.
...
### -Name
Specifies the name of the HciExternalStorage.
...
### -Organization
Specifies the organization, to fetch the HciExternalStorage under it.
