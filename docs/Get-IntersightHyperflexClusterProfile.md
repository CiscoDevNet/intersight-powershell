...
## SYNOPSIS
Get the HyperflexClusterProfile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexClusterProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexClusterProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexClusterProfile&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterProfile
```
Above example returns the list of HyperflexClusterProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterProfile -Name "MoName"
```
Above example returns the HyperflexClusterProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterProfile -Organization $organization
```
Above example returns the list of HyperflexClusterProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterProfile -InlineCount allpages
```
Above example returns the list of HyperflexClusterProfile along with count.
...
### -Name
Specifies the name of the HyperflexClusterProfile.
...
### -Organization
Specifies the organization, to fetch the HyperflexClusterProfile under it.
