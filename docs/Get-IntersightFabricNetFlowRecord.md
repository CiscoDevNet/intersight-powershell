...
# Get-IntersightFabricNetFlowRecord

## SYNOPSIS
Get the FabricNetFlowRecord

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricNetFlowRecord [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricNetFlowRecord [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricNetFlowRecord&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowRecord
```
Above example returns the list of FabricNetFlowRecord.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowRecord -Name "MoName"
```
Above example returns the FabricNetFlowRecord matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowRecord -Organization $organization
```
Above example returns the list of FabricNetFlowRecord available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowRecord -InlineCount allpages
```
Above example returns the list of FabricNetFlowRecord along with count.
...
### -Name
Specifies the name of the FabricNetFlowRecord.
...
### -Organization
Specifies the organization, to fetch the FabricNetFlowRecord under it.
