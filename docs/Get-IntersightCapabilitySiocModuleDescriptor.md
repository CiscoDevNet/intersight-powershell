...
### CmdletParam (Default)
```
Get-IntersightCapabilitySiocModuleDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilitySiocModuleDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilitySiocModuleDescriptor
```
Above example returns the list of CapabilitySiocModuleDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilitySiocModuleDescriptor -Name "MoName"
```
Above example returns the CapabilitySiocModuleDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilitySiocModuleDescriptor -Organization $organization
```
Above example returns the list of CapabilitySiocModuleDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilitySiocModuleDescriptor -InlineCount allpages
```
Above example returns the list of CapabilitySiocModuleDescriptor along with count.
...
### -Name
Specifies the name of the CapabilitySiocModuleDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilitySiocModuleDescriptor under it.
