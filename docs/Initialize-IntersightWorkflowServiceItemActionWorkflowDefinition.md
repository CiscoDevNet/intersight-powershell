...
# Initialize-IntersightWorkflowServiceItemActionWorkflowDefinition
...
Initialize-IntersightWorkflowServiceItemActionWorkflowDefinition [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-CatalogMoid< string>][-ClassId< WorkflowServiceItemActionWorkflowDefinition.ClassIdEnum>][-Description< string>][-InputParameters< object>][-Label< string>][-Name< string>][-ObjectType< WorkflowServiceItemActionWorkflowDefinition.ObjectTypeEnum>][-Version< long>][-WorkflowDefinitionName< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowServiceItemActionWorkflowDefinition.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowServiceItemActionWorkflowDefinition.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowServiceItemActionWorkflowDefinition
```
