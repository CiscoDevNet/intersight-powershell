...
```powershell
$CapabilitySiocModuleDescriptorResponse = Initialize-IntersightCapabilitySiocModuleDescriptorResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilitySiocModuleDescriptorResponse | ConvertTo-JSON
```
