...
## SYNOPSIS
Get the StorageNetAppExportPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppExportPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppExportPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppExportPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppExportPolicy
```
Above example returns the list of StorageNetAppExportPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppExportPolicy -Name "MoName"
```
Above example returns the StorageNetAppExportPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppExportPolicy -Organization $organization
```
Above example returns the list of StorageNetAppExportPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppExportPolicy -InlineCount allpages
```
Above example returns the list of StorageNetAppExportPolicy along with count.
...
### -Name
Specifies the name of the StorageNetAppExportPolicy.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppExportPolicy under it.
