...
## SYNOPSIS
Get the NiatelemetryApicSysLogGrp

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicSysLogGrp [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicSysLogGrp [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryApicSysLogGrp&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSysLogGrp
```
Above example returns the list of NiatelemetryApicSysLogGrp.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSysLogGrp -Name "MoName"
```
Above example returns the NiatelemetryApicSysLogGrp matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSysLogGrp -Organization $organization
```
Above example returns the list of NiatelemetryApicSysLogGrp available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSysLogGrp -InlineCount allpages
```
Above example returns the list of NiatelemetryApicSysLogGrp along with count.
...
### -Name
Specifies the name of the NiatelemetryApicSysLogGrp.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicSysLogGrp under it.
