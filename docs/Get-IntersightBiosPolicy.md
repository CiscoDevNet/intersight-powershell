...
### CmdletParam (Default)
```
Get-IntersightBiosPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBiosPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;BiosPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBiosPolicy
```
Above example returns the list of BiosPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBiosPolicy -Name "MoName"
```
Above example returns the BiosPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBiosPolicy -Organization $organization
```
Above example returns the list of BiosPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBiosPolicy -InlineCount allpages
```
Above example returns the list of BiosPolicy along with count.
...
### -Name
Specifies the name of the BiosPolicy.
...
### -Organization
Specifies the organization, to fetch the BiosPolicy under it.
