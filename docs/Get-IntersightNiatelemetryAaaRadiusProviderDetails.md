...
## SYNOPSIS
Get the NiatelemetryAaaRadiusProviderDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryAaaRadiusProviderDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryAaaRadiusProviderDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryAaaRadiusProviderDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAaaRadiusProviderDetails
```
Above example returns the list of NiatelemetryAaaRadiusProviderDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAaaRadiusProviderDetails -Name "MoName"
```
Above example returns the NiatelemetryAaaRadiusProviderDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAaaRadiusProviderDetails -Organization $organization
```
Above example returns the list of NiatelemetryAaaRadiusProviderDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAaaRadiusProviderDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryAaaRadiusProviderDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryAaaRadiusProviderDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryAaaRadiusProviderDetails under it.
