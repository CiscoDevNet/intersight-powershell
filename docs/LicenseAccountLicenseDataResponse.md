...
```powershell
$LicenseAccountLicenseDataResponse = Initialize-IntersightLicenseAccountLicenseDataResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$LicenseAccountLicenseDataResponse | ConvertTo-JSON
```
