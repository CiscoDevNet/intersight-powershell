...
# Initialize-IntersightWorkloadWorkloadMetadata
...
```yaml
Type: WorkloadWorkloadMetadata.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkloadWorkloadMetadata.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkloadWorkloadMetadata
```
