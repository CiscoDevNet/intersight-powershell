...
# Get-IntersightSoftwareHciDistributable

## SYNOPSIS
Get the SoftwareHciDistributable

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwareHciDistributable [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwareHciDistributable [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwareHciDistributable
```
Above example returns the list of SoftwareHciDistributable.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwareHciDistributable -Name "MoName"
```
Above example returns the SoftwareHciDistributable matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwareHciDistributable -Organization $organization
```
Above example returns the list of SoftwareHciDistributable available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwareHciDistributable -InlineCount allpages
```
Above example returns the list of SoftwareHciDistributable along with count.
...
### -Name
Specifies the name of the SoftwareHciDistributable.
...
### -Organization
Specifies the organization, to fetch the SoftwareHciDistributable under it.
