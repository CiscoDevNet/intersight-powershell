...
### CmdletParam (Default)
```
Get-IntersightEquipmentChassisIdentity [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentChassisIdentity [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisIdentity
```
Above example returns the list of EquipmentChassisIdentity.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisIdentity -Name "MoName"
```
Above example returns the EquipmentChassisIdentity matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisIdentity -Organization $organization
```
Above example returns the list of EquipmentChassisIdentity available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisIdentity -InlineCount allpages
```
Above example returns the list of EquipmentChassisIdentity along with count.
...
### -Name
Specifies the name of the EquipmentChassisIdentity.
...
### -Organization
Specifies the organization, to fetch the EquipmentChassisIdentity under it.
...
[Set-IntersightEquipmentChassisIdentity](./Set-IntersightEquipmentChassisIdentity.md)
