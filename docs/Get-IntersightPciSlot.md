...
### CmdletParam (Default)
```
Get-IntersightPciSlot [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPciSlot [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PciSlot&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPciSlot
```
Above example returns the list of PciSlot.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPciSlot -Name "MoName"
```
Above example returns the PciSlot matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPciSlot -Organization $organization
```
Above example returns the list of PciSlot available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPciSlot -InlineCount allpages
```
Above example returns the list of PciSlot along with count.
...
### -Name
Specifies the name of the PciSlot.
...
### -Organization
Specifies the organization, to fetch the PciSlot under it.
