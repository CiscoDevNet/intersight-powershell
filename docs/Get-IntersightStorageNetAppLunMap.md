...
## SYNOPSIS
Get the StorageNetAppLunMap

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppLunMap [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppLunMap [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLunMap
```
Above example returns the list of StorageNetAppLunMap.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLunMap -Name "MoName"
```
Above example returns the StorageNetAppLunMap matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLunMap -Organization $organization
```
Above example returns the list of StorageNetAppLunMap available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppLunMap -InlineCount allpages
```
Above example returns the list of StorageNetAppLunMap along with count.
...
### -Name
Specifies the name of the StorageNetAppLunMap.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppLunMap under it.
