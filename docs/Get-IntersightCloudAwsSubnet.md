...
## SYNOPSIS
Get the CloudAwsSubnet

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudAwsSubnet [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudAwsSubnet [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;CloudAwsSubnet&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudAwsSubnet
```
Above example returns the list of CloudAwsSubnet.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudAwsSubnet -Name "MoName"
```
Above example returns the CloudAwsSubnet matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudAwsSubnet -Organization $organization
```
Above example returns the list of CloudAwsSubnet available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudAwsSubnet -InlineCount allpages
```
Above example returns the list of CloudAwsSubnet along with count.
...
### -Name
Specifies the name of the CloudAwsSubnet.
...
### -Organization
Specifies the organization, to fetch the CloudAwsSubnet under it.
