...
```powershell
$InventoryGenericInventoryHolderRelationship = Initialize-IntersightInventoryGenericInventoryHolderRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$InventoryGenericInventoryHolderRelationship | ConvertTo-JSON
```
