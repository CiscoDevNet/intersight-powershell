...
Initialize-IntersightRecoveryBackupSchedule [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< RecoveryBackupSchedule.ClassIdEnum>][-ExecutionTime< DateTime>][-FrequencyUnit< RecoveryBackupSchedule.FrequencyUnitEnum>][-Hours< RecoveryBackupSchedule.HoursEnum>][-ObjectType< RecoveryBackupSchedule.ObjectTypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
