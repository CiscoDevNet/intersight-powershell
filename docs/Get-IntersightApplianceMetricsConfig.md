...
# Get-IntersightApplianceMetricsConfig

## SYNOPSIS
Get the ApplianceMetricsConfig

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceMetricsConfig [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceMetricsConfig [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceMetricsConfig&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceMetricsConfig
```
Above example returns the list of ApplianceMetricsConfig.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceMetricsConfig -Name "MoName"
```
Above example returns the ApplianceMetricsConfig matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceMetricsConfig -Organization $organization
```
Above example returns the list of ApplianceMetricsConfig available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceMetricsConfig -InlineCount allpages
```
Above example returns the list of ApplianceMetricsConfig along with count.
...
### -Name
Specifies the name of the ApplianceMetricsConfig.
...
### -Organization
Specifies the organization, to fetch the ApplianceMetricsConfig under it.
...
[Set-IntersightApplianceMetricsConfig](./Set-IntersightApplianceMetricsConfig.md)
