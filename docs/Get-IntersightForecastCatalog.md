...
# Get-IntersightForecastCatalog

## SYNOPSIS
Get the ForecastCatalog

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightForecastCatalog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightForecastCatalog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ForecastCatalog&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightForecastCatalog
```
Above example returns the list of ForecastCatalog.

### Example 2
```powershell
PS C:\> $result = Get-IntersightForecastCatalog -Name "MoName"
```
Above example returns the ForecastCatalog matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightForecastCatalog -Organization $organization
```
Above example returns the list of ForecastCatalog available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightForecastCatalog -InlineCount allpages
```
Above example returns the list of ForecastCatalog along with count.
...
### -Name
Specifies the name of the ForecastCatalog.
...
### -Organization
Specifies the organization, to fetch the ForecastCatalog under it.
