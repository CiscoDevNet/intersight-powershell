...
```powershell
$VirtualizationBaseVirtualMachineRelationship = Initialize-IntersightVirtualizationBaseVirtualMachineRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$VirtualizationBaseVirtualMachineRelationship | ConvertTo-JSON
```
