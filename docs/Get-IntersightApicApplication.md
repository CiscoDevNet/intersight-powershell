...
# Get-IntersightApicApplication

## SYNOPSIS
Get the ApicApplication

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApicApplication [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApicApplication [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApicApplication&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApicApplication
```
Above example returns the list of ApicApplication.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApicApplication -Name "MoName"
```
Above example returns the ApicApplication matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApicApplication -Organization $organization
```
Above example returns the list of ApicApplication available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApicApplication -InlineCount allpages
```
Above example returns the list of ApicApplication along with count.
...
### -Name
Specifies the name of the ApicApplication.
...
### -Organization
Specifies the organization, to fetch the ApicApplication under it.
