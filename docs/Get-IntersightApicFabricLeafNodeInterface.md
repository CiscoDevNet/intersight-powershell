...
# Get-IntersightApicFabricLeafNodeInterface

## SYNOPSIS
Get the ApicFabricLeafNodeInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApicFabricLeafNodeInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApicFabricLeafNodeInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApicFabricLeafNodeInterface&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApicFabricLeafNodeInterface
```
Above example returns the list of ApicFabricLeafNodeInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApicFabricLeafNodeInterface -Name "MoName"
```
Above example returns the ApicFabricLeafNodeInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApicFabricLeafNodeInterface -Organization $organization
```
Above example returns the list of ApicFabricLeafNodeInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApicFabricLeafNodeInterface -InlineCount allpages
```
Above example returns the list of ApicFabricLeafNodeInterface along with count.
...
### -Name
Specifies the name of the ApicFabricLeafNodeInterface.
...
### -Organization
Specifies the organization, to fetch the ApicFabricLeafNodeInterface under it.
