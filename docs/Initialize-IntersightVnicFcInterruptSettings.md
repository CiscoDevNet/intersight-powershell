...
Initialize-IntersightVnicFcInterruptSettings [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< VnicFcInterruptSettings.ClassIdEnum>][-Mode< VnicFcInterruptSettings.ModeEnum>][-ObjectType< VnicFcInterruptSettings.ObjectTypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: VnicFcInterruptSettings.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VnicFcInterruptSettings.ModeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VnicFcInterruptSettings.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVnicFcInterruptSettings
```
