...
Set-IntersightHyperflexHxdpVersion [-AdditionalProperties< Dictionary<string,object>>][-AppCatalog< HyperflexAppCatalogRelationship>][[-Moid]< string>][-Tags< List<MoTag>>][-Version< string>]
