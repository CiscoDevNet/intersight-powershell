...
# Get-IntersightStorageFileItem

## SYNOPSIS
Get the StorageFileItem

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageFileItem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageFileItem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageFileItem&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageFileItem
```
Above example returns the list of StorageFileItem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageFileItem -Name "MoName"
```
Above example returns the StorageFileItem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageFileItem -Organization $organization
```
Above example returns the list of StorageFileItem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageFileItem -InlineCount allpages
```
Above example returns the list of StorageFileItem along with count.
...
### -Name
Specifies the name of the StorageFileItem.
...
### -Organization
Specifies the organization, to fetch the StorageFileItem under it.
