...
## SYNOPSIS
Get the VirtualizationCiscoHypervisorManager

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationCiscoHypervisorManager [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationCiscoHypervisorManager [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationCiscoHypervisorManager&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationCiscoHypervisorManager
```
Above example returns the list of VirtualizationCiscoHypervisorManager.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationCiscoHypervisorManager -Name "MoName"
```
Above example returns the VirtualizationCiscoHypervisorManager matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationCiscoHypervisorManager -Organization $organization
```
Above example returns the list of VirtualizationCiscoHypervisorManager available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationCiscoHypervisorManager -InlineCount allpages
```
Above example returns the list of VirtualizationCiscoHypervisorManager along with count.
...
### -Name
Specifies the name of the VirtualizationCiscoHypervisorManager.
...
### -Organization
Specifies the organization, to fetch the VirtualizationCiscoHypervisorManager under it.
...
[Set-IntersightVirtualizationCiscoHypervisorManager](./Set-IntersightVirtualizationCiscoHypervisorManager.md)
