...
# Get-IntersightNiaapiPuvScriptDownloader

## SYNOPSIS
Get the NiaapiPuvScriptDownloader

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiPuvScriptDownloader [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiPuvScriptDownloader [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiaapiPuvScriptDownloader&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiPuvScriptDownloader
```
Above example returns the list of NiaapiPuvScriptDownloader.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiPuvScriptDownloader -Name "MoName"
```
Above example returns the NiaapiPuvScriptDownloader matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiPuvScriptDownloader -Organization $organization
```
Above example returns the list of NiaapiPuvScriptDownloader available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiPuvScriptDownloader -InlineCount allpages
```
Above example returns the list of NiaapiPuvScriptDownloader along with count.
...
### -Name
Specifies the name of the NiaapiPuvScriptDownloader.
...
### -Organization
Specifies the organization, to fetch the NiaapiPuvScriptDownloader under it.
