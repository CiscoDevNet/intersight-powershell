...
# Get-IntersightStorageNetAppNfsService

## SYNOPSIS
Get the StorageNetAppNfsService

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppNfsService [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppNfsService [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppNfsService&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNfsService
```
Above example returns the list of StorageNetAppNfsService.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNfsService -Name "MoName"
```
Above example returns the StorageNetAppNfsService matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNfsService -Organization $organization
```
Above example returns the list of StorageNetAppNfsService available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNfsService -InlineCount allpages
```
Above example returns the list of StorageNetAppNfsService along with count.
...
### -Name
Specifies the name of the StorageNetAppNfsService.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppNfsService under it.
