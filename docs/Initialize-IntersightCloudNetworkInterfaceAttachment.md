...
```yaml
Type: CloudNetworkInterfaceAttachment.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CloudNetworkInterfaceAttachment.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCloudNetworkInterfaceAttachment
```
