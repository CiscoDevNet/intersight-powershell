...
```powershell
$HyperflexClusterReplicationNetworkPolicyResponse = Initialize-IntersightHyperflexClusterReplicationNetworkPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexClusterReplicationNetworkPolicyResponse | ConvertTo-JSON
```
