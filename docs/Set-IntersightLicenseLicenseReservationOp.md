...
Set-IntersightLicenseLicenseReservationOp [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AuthCode< string>][-GenerateRequestCode< bool>][-GenerateReturnCode< bool>][[-Moid]< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
