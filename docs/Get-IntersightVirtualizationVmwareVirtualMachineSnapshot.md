...
## SYNOPSIS
Get the VirtualizationVmwareVirtualMachineSnapshot

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareVirtualMachineSnapshot [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareVirtualMachineSnapshot [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareVirtualMachineSnapshot&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualMachineSnapshot
```
Above example returns the list of VirtualizationVmwareVirtualMachineSnapshot.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualMachineSnapshot -Name "MoName"
```
Above example returns the VirtualizationVmwareVirtualMachineSnapshot matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualMachineSnapshot -Organization $organization
```
Above example returns the list of VirtualizationVmwareVirtualMachineSnapshot available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareVirtualMachineSnapshot -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareVirtualMachineSnapshot along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareVirtualMachineSnapshot.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareVirtualMachineSnapshot under it.
...
[Set-IntersightVirtualizationVmwareVirtualMachineSnapshot](./Set-IntersightVirtualizationVmwareVirtualMachineSnapshot.md)
