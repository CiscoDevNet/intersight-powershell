...
New-IntersightHyperflexServerFirmwareVersion [-AdditionalProperties< Dictionary<string,object>>][-AppCatalog< HyperflexAppCatalogRelationship>][-Moid< string>][-ServerFirmwareVersionEntries< List<HyperflexServerFirmwareVersionEntryRelationship>>][-Tags< List<MoTag>>]
