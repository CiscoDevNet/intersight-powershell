...
## SYNOPSIS
Get the FabricLinkControlPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricLinkControlPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricLinkControlPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;FabricLinkControlPolicy&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricLinkControlPolicy
```
Above example returns the list of FabricLinkControlPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricLinkControlPolicy -Name "MoName"
```
Above example returns the FabricLinkControlPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricLinkControlPolicy -Organization $organization
```
Above example returns the list of FabricLinkControlPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricLinkControlPolicy -InlineCount allpages
```
Above example returns the list of FabricLinkControlPolicy along with count.
...
### -Name
Specifies the name of the FabricLinkControlPolicy.
...
### -Organization
Specifies the organization, to fetch the FabricLinkControlPolicy under it.
