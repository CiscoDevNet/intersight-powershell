...
## SYNOPSIS
Get the IamDomainNameInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamDomainNameInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamDomainNameInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamDomainNameInfo&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamDomainNameInfo
```
Above example returns the list of IamDomainNameInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamDomainNameInfo -Name "MoName"
```
Above example returns the IamDomainNameInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamDomainNameInfo -Organization $organization
```
Above example returns the list of IamDomainNameInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamDomainNameInfo -InlineCount allpages
```
Above example returns the list of IamDomainNameInfo along with count.
...
### -Name
Specifies the name of the IamDomainNameInfo.
...
### -Organization
Specifies the organization, to fetch the IamDomainNameInfo under it.
