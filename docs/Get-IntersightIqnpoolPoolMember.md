...
# Get-IntersightIqnpoolPoolMember

## SYNOPSIS
Get the IqnpoolPoolMember

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIqnpoolPoolMember [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIqnpoolPoolMember [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IqnpoolPoolMember&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIqnpoolPoolMember
```
Above example returns the list of IqnpoolPoolMember.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIqnpoolPoolMember -Name "MoName"
```
Above example returns the IqnpoolPoolMember matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIqnpoolPoolMember -Organization $organization
```
Above example returns the list of IqnpoolPoolMember available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIqnpoolPoolMember -InlineCount allpages
```
Above example returns the list of IqnpoolPoolMember along with count.
...
### -Name
Specifies the name of the IqnpoolPoolMember.
...
### -Organization
Specifies the organization, to fetch the IqnpoolPoolMember under it.
