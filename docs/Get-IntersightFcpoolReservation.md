...
# Get-IntersightFcpoolReservation

## SYNOPSIS
Get the FcpoolReservation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFcpoolReservation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFcpoolReservation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FcpoolReservation&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFcpoolReservation
```
Above example returns the list of FcpoolReservation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFcpoolReservation -Name "MoName"
```
Above example returns the FcpoolReservation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFcpoolReservation -Organization $organization
```
Above example returns the list of FcpoolReservation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFcpoolReservation -InlineCount allpages
```
Above example returns the list of FcpoolReservation along with count.
...
### -Name
Specifies the name of the FcpoolReservation.
...
### -Organization
Specifies the organization, to fetch the FcpoolReservation under it.
