...
# Get-IntersightBootHddDevice

## SYNOPSIS
Get the BootHddDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBootHddDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBootHddDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;BootHddDevice&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBootHddDevice
```
Above example returns the list of BootHddDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBootHddDevice -Name "MoName"
```
Above example returns the BootHddDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBootHddDevice -Organization $organization
```
Above example returns the list of BootHddDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBootHddDevice -InlineCount allpages
```
Above example returns the list of BootHddDevice along with count.
...
### -Name
Specifies the name of the BootHddDevice.
...
### -Organization
Specifies the organization, to fetch the BootHddDevice under it.
...
[Set-IntersightBootHddDevice](./Set-IntersightBootHddDevice.md)
