...
New-IntersightApplianceDataExportPolicy [-Account< IamAccountRelationship>][-AdditionalProperties< Dictionary<string,object>>][-Enable< bool>][-Moid< string>][-Tags< List<MoTag>>]
