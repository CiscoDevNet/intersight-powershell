...
## SYNOPSIS
Get the StorageFlexFlashVirtualDrive

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageFlexFlashVirtualDrive [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageFlexFlashVirtualDrive [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageFlexFlashVirtualDrive&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashVirtualDrive
```
Above example returns the list of StorageFlexFlashVirtualDrive.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashVirtualDrive -Name "MoName"
```
Above example returns the StorageFlexFlashVirtualDrive matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashVirtualDrive -Organization $organization
```
Above example returns the list of StorageFlexFlashVirtualDrive available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageFlexFlashVirtualDrive -InlineCount allpages
```
Above example returns the list of StorageFlexFlashVirtualDrive along with count.
...
### -Name
Specifies the name of the StorageFlexFlashVirtualDrive.
...
### -Organization
Specifies the organization, to fetch the StorageFlexFlashVirtualDrive under it.
...
[Set-IntersightStorageFlexFlashVirtualDrive](./Set-IntersightStorageFlexFlashVirtualDrive.md)
