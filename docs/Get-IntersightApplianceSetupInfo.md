...
## SYNOPSIS
Get the ApplianceSetupInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceSetupInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceSetupInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceSetupInfo
```
Above example returns the list of ApplianceSetupInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceSetupInfo -Name "MoName"
```
Above example returns the ApplianceSetupInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceSetupInfo -Organization $organization
```
Above example returns the list of ApplianceSetupInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceSetupInfo -InlineCount allpages
```
Above example returns the list of ApplianceSetupInfo along with count.
...
### -Name
Specifies the name of the ApplianceSetupInfo.
...
### -Organization
Specifies the organization, to fetch the ApplianceSetupInfo under it.
...
[Set-IntersightApplianceSetupInfo](./Set-IntersightApplianceSetupInfo.md)
