...
# Get-IntersightUcsdBackupInfo

## SYNOPSIS
Get the UcsdBackupInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightUcsdBackupInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightUcsdBackupInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;UcsdBackupInfo&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightUcsdBackupInfo
```
Above example returns the list of UcsdBackupInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightUcsdBackupInfo -Name "MoName"
```
Above example returns the UcsdBackupInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightUcsdBackupInfo -Organization $organization
```
Above example returns the list of UcsdBackupInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightUcsdBackupInfo -InlineCount allpages
```
Above example returns the list of UcsdBackupInfo along with count.
...
### -Name
Specifies the name of the UcsdBackupInfo.
...
### -Organization
Specifies the organization, to fetch the UcsdBackupInfo under it.
...
[Remove-IntersightUcsdBackupInfo](./Remove-IntersightUcsdBackupInfo.md)
