...
## SYNOPSIS
Get the IamLdapProvider

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamLdapProvider [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamLdapProvider [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamLdapProvider
```
Above example returns the list of IamLdapProvider.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamLdapProvider -Name "MoName"
```
Above example returns the IamLdapProvider matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamLdapProvider -Organization $organization
```
Above example returns the list of IamLdapProvider available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamLdapProvider -InlineCount allpages
```
Above example returns the list of IamLdapProvider along with count.
...
### -Name
Specifies the name of the IamLdapProvider.
...
### -Organization
Specifies the organization, to fetch the IamLdapProvider under it.
