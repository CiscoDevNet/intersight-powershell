...
## SYNOPSIS
Get the NiatelemetryDcnmFexDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryDcnmFexDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryDcnmFexDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryDcnmFexDetails&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmFexDetails
```
Above example returns the list of NiatelemetryDcnmFexDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmFexDetails -Name "MoName"
```
Above example returns the NiatelemetryDcnmFexDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmFexDetails -Organization $organization
```
Above example returns the list of NiatelemetryDcnmFexDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmFexDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryDcnmFexDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryDcnmFexDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryDcnmFexDetails under it.
