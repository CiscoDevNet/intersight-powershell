...
```powershell
$KubernetesNodeGroupProfileResponse = Initialize-IntersightKubernetesNodeGroupProfileResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$KubernetesNodeGroupProfileResponse | ConvertTo-JSON
```
