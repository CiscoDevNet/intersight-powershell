...
```powershell
$CapabilityFanModuleDescriptorResponse = Initialize-IntersightCapabilityFanModuleDescriptorResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilityFanModuleDescriptorResponse | ConvertTo-JSON
```
