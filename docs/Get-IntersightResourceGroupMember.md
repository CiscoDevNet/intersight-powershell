...
# Get-IntersightResourceGroupMember

## SYNOPSIS
Get the ResourceGroupMember

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightResourceGroupMember [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourceGroupMember [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ResourceGroupMember&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourceGroupMember
```
Above example returns the list of ResourceGroupMember.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourceGroupMember -Name "MoName"
```
Above example returns the ResourceGroupMember matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourceGroupMember -Organization $organization
```
Above example returns the list of ResourceGroupMember available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourceGroupMember -InlineCount allpages
```
Above example returns the list of ResourceGroupMember along with count.
...
### -Name
Specifies the name of the ResourceGroupMember.
...
### -Organization
Specifies the organization, to fetch the ResourceGroupMember under it.
...
[Remove-IntersightResourceGroupMember](./Remove-IntersightResourceGroupMember.md)
