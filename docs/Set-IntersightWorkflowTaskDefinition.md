...
Set-IntersightWorkflowTaskDefinition [-AdditionalProperties< Dictionary<string,object>>][-Catalog< WorkflowCatalogRelationship>][-DefaultVersion< bool>][-Description< string>][-ImplementedTasks< List<WorkflowTaskDefinitionRelationship>>][-InterfaceTask< WorkflowTaskDefinitionRelationship>][-Label< string>][[-Moid]< string>][-Name< string>][-Properties< WorkflowProperties>][-RollbackTasks< List<WorkflowRollbackTask>>][-SecurePropAccess< bool>][-Tags< List<MoTag>>][-TaskMetadata< WorkflowTaskMetadataRelationship>][-Version< long>]
