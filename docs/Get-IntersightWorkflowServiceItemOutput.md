...
# Get-IntersightWorkflowServiceItemOutput

## SYNOPSIS
Get the WorkflowServiceItemOutput

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowServiceItemOutput [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowServiceItemOutput [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowServiceItemOutput&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemOutput
```
Above example returns the list of WorkflowServiceItemOutput.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemOutput -Name "MoName"
```
Above example returns the WorkflowServiceItemOutput matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemOutput -Organization $organization
```
Above example returns the list of WorkflowServiceItemOutput available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowServiceItemOutput -InlineCount allpages
```
Above example returns the list of WorkflowServiceItemOutput along with count.
...
### -Name
Specifies the name of the WorkflowServiceItemOutput.
...
### -Organization
Specifies the organization, to fetch the WorkflowServiceItemOutput under it.
...
[Remove-IntersightWorkflowServiceItemOutput](./Remove-IntersightWorkflowServiceItemOutput.md)
