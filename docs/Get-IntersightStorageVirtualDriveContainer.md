...
## SYNOPSIS
Get the StorageVirtualDriveContainer

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageVirtualDriveContainer [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageVirtualDriveContainer [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDriveContainer
```
Above example returns the list of StorageVirtualDriveContainer.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDriveContainer -Name "MoName"
```
Above example returns the StorageVirtualDriveContainer matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDriveContainer -Organization $organization
```
Above example returns the list of StorageVirtualDriveContainer available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDriveContainer -InlineCount allpages
```
Above example returns the list of StorageVirtualDriveContainer along with count.
...
### -Name
Specifies the name of the StorageVirtualDriveContainer.
...
### -Organization
Specifies the organization, to fetch the StorageVirtualDriveContainer under it.
...
[Set-IntersightStorageVirtualDriveContainer](./Set-IntersightStorageVirtualDriveContainer.md)
