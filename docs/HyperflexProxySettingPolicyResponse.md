...
```powershell
$HyperflexProxySettingPolicyResponse = Initialize-IntersightHyperflexProxySettingPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexProxySettingPolicyResponse | ConvertTo-JSON
```
