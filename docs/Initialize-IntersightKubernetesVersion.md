...
# Initialize-IntersightKubernetesVersion
...
```yaml
Type: Model.SoftwareSolutionDistributableRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.KubernetesVersion.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightKubernetesVersion
```
