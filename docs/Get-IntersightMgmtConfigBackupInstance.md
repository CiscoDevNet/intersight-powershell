...
# Get-IntersightMgmtConfigBackupInstance

## SYNOPSIS
Get the MgmtConfigBackupInstance

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMgmtConfigBackupInstance [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMgmtConfigBackupInstance [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MgmtConfigBackupInstance&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMgmtConfigBackupInstance
```
Above example returns the list of MgmtConfigBackupInstance.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMgmtConfigBackupInstance -Name "MoName"
```
Above example returns the MgmtConfigBackupInstance matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMgmtConfigBackupInstance -Organization $organization
```
Above example returns the list of MgmtConfigBackupInstance available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMgmtConfigBackupInstance -InlineCount allpages
```
Above example returns the list of MgmtConfigBackupInstance along with count.
...
### -Name
Specifies the name of the MgmtConfigBackupInstance.
...
### -Organization
Specifies the organization, to fetch the MgmtConfigBackupInstance under it.
...
[Remove-IntersightMgmtConfigBackupInstance](./Remove-IntersightMgmtConfigBackupInstance.md)
