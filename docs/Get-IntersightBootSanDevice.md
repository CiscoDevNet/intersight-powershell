...
# Get-IntersightBootSanDevice

## SYNOPSIS
Get the BootSanDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBootSanDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBootSanDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBootSanDevice
```
Above example returns the list of BootSanDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBootSanDevice -Name "MoName"
```
Above example returns the BootSanDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBootSanDevice -Organization $organization
```
Above example returns the list of BootSanDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBootSanDevice -InlineCount allpages
```
Above example returns the list of BootSanDevice along with count.
...
### -Name
Specifies the name of the BootSanDevice.
...
### -Organization
Specifies the organization, to fetch the BootSanDevice under it.
...
[Set-IntersightBootSanDevice](./Set-IntersightBootSanDevice.md)
