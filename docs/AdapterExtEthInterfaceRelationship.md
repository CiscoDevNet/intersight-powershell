...
```powershell
$AdapterExtEthInterfaceRelationship = Initialize-IntersightAdapterExtEthInterfaceRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$AdapterExtEthInterfaceRelationship | ConvertTo-JSON
```
