...
## SYNOPSIS
Get the CloudTfcAgentpool

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudTfcAgentpool [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudTfcAgentpool [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CloudTfcAgentpool&apos; resource.
...
```
Above example returns the list of CloudTfcAgentpool.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudTfcAgentpool -Name "MoName"
```
Above example returns the CloudTfcAgentpool matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudTfcAgentpool -Organization $organization
```
Above example returns the list of CloudTfcAgentpool available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudTfcAgentpool -InlineCount allpages
```
Above example returns the list of CloudTfcAgentpool along with count.
...
### -Name
Specifies the name of the CloudTfcAgentpool.
...
### -Organization
Specifies the organization, to fetch the CloudTfcAgentpool under it.
