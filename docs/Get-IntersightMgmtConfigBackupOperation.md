...
# Get-IntersightMgmtConfigBackupOperation

## SYNOPSIS
Get the MgmtConfigBackupOperation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMgmtConfigBackupOperation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMgmtConfigBackupOperation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MgmtConfigBackupOperation&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMgmtConfigBackupOperation
```
Above example returns the list of MgmtConfigBackupOperation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMgmtConfigBackupOperation -Name "MoName"
```
Above example returns the MgmtConfigBackupOperation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMgmtConfigBackupOperation -Organization $organization
```
Above example returns the list of MgmtConfigBackupOperation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMgmtConfigBackupOperation -InlineCount allpages
```
Above example returns the list of MgmtConfigBackupOperation along with count.
...
### -Name
Specifies the name of the MgmtConfigBackupOperation.
...
### -Organization
Specifies the organization, to fetch the MgmtConfigBackupOperation under it.
