...
## SYNOPSIS
Get the ConnectorpackConnectorPackUpgrade

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightConnectorpackConnectorPackUpgrade [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightConnectorpackConnectorPackUpgrade [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ConnectorpackConnectorPackUpgrade&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightConnectorpackConnectorPackUpgrade
```
Above example returns the list of ConnectorpackConnectorPackUpgrade.

### Example 2
```powershell
PS C:\> $result = Get-IntersightConnectorpackConnectorPackUpgrade -Name "MoName"
```
Above example returns the ConnectorpackConnectorPackUpgrade matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightConnectorpackConnectorPackUpgrade -Organization $organization
```
Above example returns the list of ConnectorpackConnectorPackUpgrade available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightConnectorpackConnectorPackUpgrade -InlineCount allpages
```
Above example returns the list of ConnectorpackConnectorPackUpgrade along with count.
...
### -Name
Specifies the name of the ConnectorpackConnectorPackUpgrade.
...
### -Organization
Specifies the organization, to fetch the ConnectorpackConnectorPackUpgrade under it.
