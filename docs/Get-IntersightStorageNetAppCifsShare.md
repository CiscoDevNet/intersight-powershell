...
# Get-IntersightStorageNetAppCifsShare

## SYNOPSIS
Get the StorageNetAppCifsShare

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppCifsShare [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppCifsShare [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppCifsShare&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCifsShare
```
Above example returns the list of StorageNetAppCifsShare.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCifsShare -Name "MoName"
```
Above example returns the StorageNetAppCifsShare matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCifsShare -Organization $organization
```
Above example returns the list of StorageNetAppCifsShare available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCifsShare -InlineCount allpages
```
Above example returns the list of StorageNetAppCifsShare along with count.
...
### -Name
Specifies the name of the StorageNetAppCifsShare.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppCifsShare under it.
