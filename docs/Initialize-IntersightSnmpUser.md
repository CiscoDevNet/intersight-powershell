...
Initialize-IntersightSnmpUser [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AuthPassword< string>][-AuthType< SnmpUser.AuthTypeEnum>][-ClassId< SnmpUser.ClassIdEnum>][-Name< string>][-ObjectType< SnmpUser.ObjectTypeEnum>][-PrivacyPassword< string>][-PrivacyType< SnmpUser.PrivacyTypeEnum>][-SecurityLevel< SnmpUser.SecurityLevelEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
