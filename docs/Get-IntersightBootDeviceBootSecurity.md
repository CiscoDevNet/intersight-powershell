...
## SYNOPSIS
Get the BootDeviceBootSecurity

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBootDeviceBootSecurity [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBootDeviceBootSecurity [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBootDeviceBootSecurity
```
Above example returns the list of BootDeviceBootSecurity.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBootDeviceBootSecurity -Name "MoName"
```
Above example returns the BootDeviceBootSecurity matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBootDeviceBootSecurity -Organization $organization
```
Above example returns the list of BootDeviceBootSecurity available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBootDeviceBootSecurity -InlineCount allpages
```
Above example returns the list of BootDeviceBootSecurity along with count.
...
### -Name
Specifies the name of the BootDeviceBootSecurity.
...
### -Organization
Specifies the organization, to fetch the BootDeviceBootSecurity under it.
...
[Set-IntersightBootDeviceBootSecurity](./Set-IntersightBootDeviceBootSecurity.md)
