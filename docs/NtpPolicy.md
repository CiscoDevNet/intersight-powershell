...
**Enabled** | **Boolean** | State of NTP service on the endpoint. | [optional] [default to $true]
...
```powershell
$NtpPolicy = Initialize-IntersightNtpPolicy  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
