...
## SYNOPSIS
Get the HyperflexVmImportOperation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexVmImportOperation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexVmImportOperation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexVmImportOperation
```
Above example returns the list of HyperflexVmImportOperation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexVmImportOperation -Name "MoName"
```
Above example returns the HyperflexVmImportOperation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexVmImportOperation -Organization $organization
```
Above example returns the list of HyperflexVmImportOperation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexVmImportOperation -InlineCount allpages
```
Above example returns the list of HyperflexVmImportOperation along with count.
...
### -Name
Specifies the name of the HyperflexVmImportOperation.
...
### -Organization
Specifies the organization, to fetch the HyperflexVmImportOperation under it.
