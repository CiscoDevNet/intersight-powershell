...
# Get-IntersightIamDefaultAuthentication

## SYNOPSIS
Get the IamDefaultAuthentication

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamDefaultAuthentication [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamDefaultAuthentication [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamDefaultAuthentication&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamDefaultAuthentication
```
Above example returns the list of IamDefaultAuthentication.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamDefaultAuthentication -Name "MoName"
```
Above example returns the IamDefaultAuthentication matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamDefaultAuthentication -Organization $organization
```
Above example returns the list of IamDefaultAuthentication available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamDefaultAuthentication -InlineCount allpages
```
Above example returns the list of IamDefaultAuthentication along with count.
...
### -Name
Specifies the name of the IamDefaultAuthentication.
...
### -Organization
Specifies the organization, to fetch the IamDefaultAuthentication under it.
...
[Set-IntersightIamDefaultAuthentication](./Set-IntersightIamDefaultAuthentication.md)
