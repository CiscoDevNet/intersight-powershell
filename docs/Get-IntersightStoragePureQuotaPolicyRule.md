...
# Get-IntersightStoragePureQuotaPolicyRule

## SYNOPSIS
Get the StoragePureQuotaPolicyRule

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureQuotaPolicyRule [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureQuotaPolicyRule [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureQuotaPolicyRule&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureQuotaPolicyRule
```
Above example returns the list of StoragePureQuotaPolicyRule.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureQuotaPolicyRule -Name "MoName"
```
Above example returns the StoragePureQuotaPolicyRule matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureQuotaPolicyRule -Organization $organization
```
Above example returns the list of StoragePureQuotaPolicyRule available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureQuotaPolicyRule -InlineCount allpages
```
Above example returns the list of StoragePureQuotaPolicyRule along with count.
...
### -Name
Specifies the name of the StoragePureQuotaPolicyRule.
...
### -Organization
Specifies the organization, to fetch the StoragePureQuotaPolicyRule under it.
