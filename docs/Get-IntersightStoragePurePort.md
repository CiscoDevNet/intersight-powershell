...
# Get-IntersightStoragePurePort

## SYNOPSIS
Get the StoragePurePort

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePurePort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePurePort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePurePort&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePurePort
```
Above example returns the list of StoragePurePort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePurePort -Name "MoName"
```
Above example returns the StoragePurePort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePurePort -Organization $organization
```
Above example returns the list of StoragePurePort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePurePort -InlineCount allpages
```
Above example returns the list of StoragePurePort along with count.
...
### -Name
Specifies the name of the StoragePurePort.
...
### -Organization
Specifies the organization, to fetch the StoragePurePort under it.
