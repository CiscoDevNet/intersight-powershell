...
# Set-IntersightSdaaciConnectionDetail
...
Set-IntersightSdaaciConnectionDetail [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Connection< SdaaciConnectionRelationship>][-Description< string>][-IpPool< string>][-Layer3HandoffId< string>][[-Moid]< string>][-PeerAinterface< string>][-PeerAipAddress< string>][-PeerAtype< string>][-PeerBinterface< string>][-PeerBipAddress< string>][-PeerBtype< string>][-Peera< string>][-Peerb< string>][-RouterId< string>][-Status< SdaaciConnectionDetail.StatusEnum>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;SdaaciConnectionDetail&apos; resource.
...
```yaml
Type: SdaaciConnectionRelationship
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Set-IntersightSdaaciConnectionDetail
```
