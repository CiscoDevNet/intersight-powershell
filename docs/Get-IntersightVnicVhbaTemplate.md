...
# Get-IntersightVnicVhbaTemplate

## SYNOPSIS
Get the VnicVhbaTemplate

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicVhbaTemplate [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicVhbaTemplate [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicVhbaTemplate
```
Above example returns the list of VnicVhbaTemplate.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicVhbaTemplate -Name "MoName"
```
Above example returns the VnicVhbaTemplate matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicVhbaTemplate -Organization $organization
```
Above example returns the list of VnicVhbaTemplate available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicVhbaTemplate -InlineCount allpages
```
Above example returns the list of VnicVhbaTemplate along with count.
...
### -Name
Specifies the name of the VnicVhbaTemplate.
...
### -Organization
Specifies the organization, to fetch the VnicVhbaTemplate under it.
