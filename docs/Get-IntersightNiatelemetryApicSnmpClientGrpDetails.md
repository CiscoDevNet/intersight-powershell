...
## SYNOPSIS
Get the NiatelemetryApicSnmpClientGrpDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicSnmpClientGrpDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicSnmpClientGrpDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryApicSnmpClientGrpDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpClientGrpDetails
```
Above example returns the list of NiatelemetryApicSnmpClientGrpDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpClientGrpDetails -Name "MoName"
```
Above example returns the NiatelemetryApicSnmpClientGrpDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpClientGrpDetails -Organization $organization
```
Above example returns the list of NiatelemetryApicSnmpClientGrpDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpClientGrpDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryApicSnmpClientGrpDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryApicSnmpClientGrpDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicSnmpClientGrpDetails under it.
