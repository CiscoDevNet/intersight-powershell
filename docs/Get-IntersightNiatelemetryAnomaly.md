...
# Get-IntersightNiatelemetryAnomaly

## SYNOPSIS
Get the NiatelemetryAnomaly

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryAnomaly [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryAnomaly [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryAnomaly&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAnomaly
```
Above example returns the list of NiatelemetryAnomaly.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAnomaly -Name "MoName"
```
Above example returns the NiatelemetryAnomaly matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAnomaly -Organization $organization
```
Above example returns the list of NiatelemetryAnomaly available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryAnomaly -InlineCount allpages
```
Above example returns the list of NiatelemetryAnomaly along with count.
...
### -Name
Specifies the name of the NiatelemetryAnomaly.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryAnomaly under it.
