...
## SYNOPSIS
Get the StorageHitachiArray

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiArray [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiArray [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiArray&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiArray
```
Above example returns the list of StorageHitachiArray.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiArray -Name "MoName"
```
Above example returns the StorageHitachiArray matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiArray -Organization $organization
```
Above example returns the list of StorageHitachiArray available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiArray -InlineCount allpages
```
Above example returns the list of StorageHitachiArray along with count.
...
### -Name
Specifies the name of the StorageHitachiArray.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiArray under it.
...
[Set-IntersightStorageHitachiArray](./Set-IntersightStorageHitachiArray.md)
