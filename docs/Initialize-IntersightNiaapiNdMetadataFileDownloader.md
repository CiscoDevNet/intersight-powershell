...
```yaml
Type: NiaapiNdMetadataFileDownloader.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: NiaapiNdMetadataFileDownloader.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightNiaapiNdMetadataFileDownloader
```
