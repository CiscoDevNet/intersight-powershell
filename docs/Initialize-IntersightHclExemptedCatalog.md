...
# Initialize-IntersightHclExemptedCatalog
...
```yaml
Type: HclExemptedCatalog.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: HclExemptedCatalog.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightHclExemptedCatalog
```
