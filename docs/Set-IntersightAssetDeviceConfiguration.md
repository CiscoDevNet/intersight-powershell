...
Set-IntersightAssetDeviceConfiguration [-AdditionalProperties< Dictionary<string,object>>][-LocalConfigurationLocked< bool>][-LogLevel< string>][[-Moid]< string>][-Tags< List<MoTag>>]
