...
# Initialize-IntersightBiosPolicy
...
```yaml
Type: System.Collections.Generic.List`1[Model.BiosBaseBiosConfiguration]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: BiosPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightBiosPolicy
```
