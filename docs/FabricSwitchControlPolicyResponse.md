...
```powershell
$FabricSwitchControlPolicyResponse = Initialize-IntersightFabricSwitchControlPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$FabricSwitchControlPolicyResponse | ConvertTo-JSON
```
