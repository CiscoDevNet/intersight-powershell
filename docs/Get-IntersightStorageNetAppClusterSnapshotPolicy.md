...
# Get-IntersightStorageNetAppClusterSnapshotPolicy
...
### CmdletParam (Default)
```
Get-IntersightStorageNetAppClusterSnapshotPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppClusterSnapshotPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppClusterSnapshotPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppClusterSnapshotPolicy
```
Above example returns the list of StorageNetAppClusterSnapshotPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppClusterSnapshotPolicy -Name "MoName"
```
Above example returns the StorageNetAppClusterSnapshotPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppClusterSnapshotPolicy -Organization $organization
```
Above example returns the list of StorageNetAppClusterSnapshotPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppClusterSnapshotPolicy -InlineCount allpages
```
Above example returns the list of StorageNetAppClusterSnapshotPolicy along with count.
...
### -Name
Specifies the name of the StorageNetAppClusterSnapshotPolicy.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppClusterSnapshotPolicy under it.
