...
# Get-IntersightCondCustomHclStatus

## SYNOPSIS
Get the CondCustomHclStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCondCustomHclStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCondCustomHclStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CondCustomHclStatus&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCondCustomHclStatus
```
Above example returns the list of CondCustomHclStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCondCustomHclStatus -Name "MoName"
```
Above example returns the CondCustomHclStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCondCustomHclStatus -Organization $organization
```
Above example returns the list of CondCustomHclStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCondCustomHclStatus -InlineCount allpages
```
Above example returns the list of CondCustomHclStatus along with count.
...
### -Name
Specifies the name of the CondCustomHclStatus.
...
### -Organization
Specifies the organization, to fetch the CondCustomHclStatus under it.
...
[New-IntersightCondCustomHclStatus](./New-IntersightCondCustomHclStatus.md)
