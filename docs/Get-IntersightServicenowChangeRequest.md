...
# Get-IntersightServicenowChangeRequest

## SYNOPSIS
Get the ServicenowChangeRequest

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightServicenowChangeRequest [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightServicenowChangeRequest [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ServicenowChangeRequest&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightServicenowChangeRequest
```
Above example returns the list of ServicenowChangeRequest.

### Example 2
```powershell
PS C:\> $result = Get-IntersightServicenowChangeRequest -Name "MoName"
```
Above example returns the ServicenowChangeRequest matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightServicenowChangeRequest -Organization $organization
```
Above example returns the list of ServicenowChangeRequest available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightServicenowChangeRequest -InlineCount allpages
```
Above example returns the list of ServicenowChangeRequest along with count.
...
### -Name
Specifies the name of the ServicenowChangeRequest.
...
### -Organization
Specifies the organization, to fetch the ServicenowChangeRequest under it.
