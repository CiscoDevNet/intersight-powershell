...
# Get-IntersightWorkflowVariable

## SYNOPSIS
Get the WorkflowVariable

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowVariable [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowVariable [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowVariable&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowVariable
```
Above example returns the list of WorkflowVariable.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowVariable -Name "MoName"
```
Above example returns the WorkflowVariable matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowVariable -Organization $organization
```
Above example returns the list of WorkflowVariable available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowVariable -InlineCount allpages
```
Above example returns the list of WorkflowVariable along with count.
...
### -Name
Specifies the name of the WorkflowVariable.
...
### -Organization
Specifies the organization, to fetch the WorkflowVariable under it.
