...
## SYNOPSIS
Get the NiatelemetryMsoContractDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryMsoContractDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryMsoContractDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryMsoContractDetails&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoContractDetails
```
Above example returns the list of NiatelemetryMsoContractDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoContractDetails -Name "MoName"
```
Above example returns the NiatelemetryMsoContractDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoContractDetails -Organization $organization
```
Above example returns the list of NiatelemetryMsoContractDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryMsoContractDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryMsoContractDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryMsoContractDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryMsoContractDetails under it.
