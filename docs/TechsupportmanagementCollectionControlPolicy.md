...
```powershell
$TechsupportmanagementCollectionControlPolicy = Initialize-IntersightTechsupportmanagementCollectionControlPolicy  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$TechsupportmanagementCollectionControlPolicy | ConvertTo-JSON
```
