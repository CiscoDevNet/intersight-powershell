...
# Get-IntersightPoolIdMappingMember

## SYNOPSIS
Get the PoolIdMappingMember

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPoolIdMappingMember [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPoolIdMappingMember [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PoolIdMappingMember&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPoolIdMappingMember
```
Above example returns the list of PoolIdMappingMember.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPoolIdMappingMember -Name "MoName"
```
Above example returns the PoolIdMappingMember matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPoolIdMappingMember -Organization $organization
```
Above example returns the list of PoolIdMappingMember available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPoolIdMappingMember -InlineCount allpages
```
Above example returns the list of PoolIdMappingMember along with count.
...
### -Name
Specifies the name of the PoolIdMappingMember.
...
### -Organization
Specifies the organization, to fetch the PoolIdMappingMember under it.
