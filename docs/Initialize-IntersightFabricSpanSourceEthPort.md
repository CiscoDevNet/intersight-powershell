...
# Initialize-IntersightFabricSpanSourceEthPort
...
Initialize-IntersightFabricSpanSourceEthPort [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AggregatePortId< long>][-ClassId< FabricSpanSourceEthPort.ClassIdEnum>][-Direction< FabricSpanSourceEthPort.DirectionEnum>][-Moid< string>][-ObjectType< FabricSpanSourceEthPort.ObjectTypeEnum>][-PortId< long>][-SlotId< long>][-SpanSession< Model.FabricSpanSessionRelationship>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: FabricSpanSourceEthPort.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricSpanSourceEthPort.DirectionEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricSpanSourceEthPort.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFabricSpanSourceEthPort
```
