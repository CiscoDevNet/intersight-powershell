...
## SYNOPSIS
Get the FirmwareDistributableMeta

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareDistributableMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareDistributableMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareDistributableMeta&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareDistributableMeta
```
Above example returns the list of FirmwareDistributableMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareDistributableMeta -Name "MoName"
```
Above example returns the FirmwareDistributableMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareDistributableMeta -Organization $organization
```
Above example returns the list of FirmwareDistributableMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareDistributableMeta -InlineCount allpages
```
Above example returns the list of FirmwareDistributableMeta along with count.
...
### -Name
Specifies the name of the FirmwareDistributableMeta.
...
### -Organization
Specifies the organization, to fetch the FirmwareDistributableMeta under it.
