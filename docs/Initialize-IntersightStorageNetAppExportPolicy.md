...
# Initialize-IntersightStorageNetAppExportPolicy
...
```yaml
Type: StorageNetAppExportPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: StorageNetAppExportPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightStorageNetAppExportPolicy
```
