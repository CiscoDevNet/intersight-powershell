...
# Initialize-IntersightRecoveryBackupConfigPolicy
...
Initialize-IntersightRecoveryBackupConfigPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-BackupProfiles< System.Collections.Generic.List`1[Model.RecoveryBackupProfileRelationship]>][-ClassId< RecoveryBackupConfigPolicy.ClassIdEnum>][-Description< string>][-FileNamePrefix< string>][-LocationType< RecoveryBackupConfigPolicy.LocationTypeEnum>][-Moid< string>][-Name< string>][-ObjectType< RecoveryBackupConfigPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Password< string>][-Path< string>][-Protocol< RecoveryBackupConfigPolicy.ProtocolEnum>][-RetentionCount< long>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-UserName< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: System.Collections.Generic.List`1[Model.RecoveryBackupProfileRelationship]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: RecoveryBackupConfigPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: RecoveryBackupConfigPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightRecoveryBackupConfigPolicy
```
