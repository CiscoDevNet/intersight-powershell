...
## SYNOPSIS
Get the VirtualizationIweHost

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationIweHost [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationIweHost [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;VirtualizationIweHost&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweHost
```
Above example returns the list of VirtualizationIweHost.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweHost -Name "MoName"
```
Above example returns the VirtualizationIweHost matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweHost -Organization $organization
```
Above example returns the list of VirtualizationIweHost available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweHost -InlineCount allpages
```
Above example returns the list of VirtualizationIweHost along with count.
...
### -Name
Specifies the name of the VirtualizationIweHost.
...
### -Organization
Specifies the organization, to fetch the VirtualizationIweHost under it.
...
[Set-IntersightVirtualizationIweHost](./Set-IntersightVirtualizationIweHost.md)
