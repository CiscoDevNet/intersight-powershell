...
# Initialize-IntersightFabricPcMember
...
```yaml
Type: FabricPcMember.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricPcMember.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFabricPcMember
```
