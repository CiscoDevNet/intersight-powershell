...
Set-IntersightEquipmentChassisIdentity [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AdminAction< EquipmentChassisIdentity.AdminActionEnum>][-Identifier< long>][[-Moid]< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
