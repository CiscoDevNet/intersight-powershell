...
## SYNOPSIS
Get the BiosVfSelectMemoryRasConfiguration

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBiosVfSelectMemoryRasConfiguration [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBiosVfSelectMemoryRasConfiguration [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBiosVfSelectMemoryRasConfiguration
```
Above example returns the list of BiosVfSelectMemoryRasConfiguration.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBiosVfSelectMemoryRasConfiguration -Name "MoName"
```
Above example returns the BiosVfSelectMemoryRasConfiguration matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBiosVfSelectMemoryRasConfiguration -Organization $organization
```
Above example returns the list of BiosVfSelectMemoryRasConfiguration available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBiosVfSelectMemoryRasConfiguration -InlineCount allpages
```
Above example returns the list of BiosVfSelectMemoryRasConfiguration along with count.
...
### -Name
Specifies the name of the BiosVfSelectMemoryRasConfiguration.
...
### -Organization
Specifies the organization, to fetch the BiosVfSelectMemoryRasConfiguration under it.
