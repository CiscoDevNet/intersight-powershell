...
Set-IntersightStorageEnclosureDisk [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-BlockSize< string>][-DiskId< string>][-DiskState< string>][-Health< string>][[-Moid]< string>][-NumBlocks< string>][-PhysicalDisk< StoragePhysicalDiskRelationship>][-SasAddress1< string>][-SasAddress2< string>][-Size< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
