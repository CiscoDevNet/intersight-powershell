...
Set-IntersightStorageEnclosureDisk [-AdditionalProperties< Dictionary<string,object>>][-BlockSize< string>][-DiskId< string>][-DiskState< string>][-Health< string>][[-Moid]< string>][-NumBlocks< string>][-PhysicalDisk< StoragePhysicalDiskRelationship>][-PreviousFru< EquipmentFruRelationship>][-SasAddress1< string>][-SasAddress2< string>][-Size< string>][-Tags< List<MoTag>>]

```

## DESCRIPTION
Update a &apos;StorageEnclosureDisk&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightStorageEnclosureDisk
```
...
[Get-IntersightStorageEnclosureDisk](./Get-IntersightStorageEnclosureDisk.md)
