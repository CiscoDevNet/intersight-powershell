...
### Example 1
```powershell
PS C:\> Set-IntersightHyperflexHypervisorVirtualMachine
```
...
[Get-IntersightHyperflexHypervisorVirtualMachine](./Get-IntersightHyperflexHypervisorVirtualMachine.md)
