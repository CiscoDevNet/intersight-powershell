...
## SYNOPSIS
Get the HyperflexClusterBackupPolicyDeployment

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexClusterBackupPolicyDeployment [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexClusterBackupPolicyDeployment [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterBackupPolicyDeployment
```
Above example returns the list of HyperflexClusterBackupPolicyDeployment.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterBackupPolicyDeployment -Name "MoName"
```
Above example returns the HyperflexClusterBackupPolicyDeployment matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterBackupPolicyDeployment -Organization $organization
```
Above example returns the list of HyperflexClusterBackupPolicyDeployment available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterBackupPolicyDeployment -InlineCount allpages
```
Above example returns the list of HyperflexClusterBackupPolicyDeployment along with count.
...
### -Name
Specifies the name of the HyperflexClusterBackupPolicyDeployment.
...
### -Organization
Specifies the organization, to fetch the HyperflexClusterBackupPolicyDeployment under it.
