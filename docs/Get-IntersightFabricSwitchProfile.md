...
## SYNOPSIS
Get the FabricSwitchProfile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricSwitchProfile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricSwitchProfile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricSwitchProfile&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricSwitchProfile
```
Above example returns the list of FabricSwitchProfile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricSwitchProfile -Name "MoName"
```
Above example returns the FabricSwitchProfile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricSwitchProfile -Organization $organization
```
Above example returns the list of FabricSwitchProfile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricSwitchProfile -InlineCount allpages
```
Above example returns the list of FabricSwitchProfile along with count.
...
### -Name
Specifies the name of the FabricSwitchProfile.
...
### -Organization
Specifies the organization, to fetch the FabricSwitchProfile under it.
