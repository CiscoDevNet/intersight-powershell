...
# Get-IntersightIamEndPointRole

## SYNOPSIS
Get the IamEndPointRole

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamEndPointRole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamEndPointRole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IamEndPointRole&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamEndPointRole
```
Above example returns the list of IamEndPointRole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamEndPointRole -Name "MoName"
```
Above example returns the IamEndPointRole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamEndPointRole -Organization $organization
```
Above example returns the list of IamEndPointRole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamEndPointRole -InlineCount allpages
```
Above example returns the list of IamEndPointRole along with count.
...
### -Name
Specifies the name of the IamEndPointRole.
...
### -Organization
Specifies the organization, to fetch the IamEndPointRole under it.
