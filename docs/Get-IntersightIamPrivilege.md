...
# Get-IntersightIamPrivilege

## SYNOPSIS
Get the IamPrivilege

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamPrivilege [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamPrivilege [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamPrivilege&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamPrivilege
```
Above example returns the list of IamPrivilege.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamPrivilege -Name "MoName"
```
Above example returns the IamPrivilege matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamPrivilege -Organization $organization
```
Above example returns the list of IamPrivilege available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamPrivilege -InlineCount allpages
```
Above example returns the list of IamPrivilege along with count.
...
### -Name
Specifies the name of the IamPrivilege.
...
### -Organization
Specifies the organization, to fetch the IamPrivilege under it.
