...
# Get-IntersightMacpoolUniverse

## SYNOPSIS
Get the MacpoolUniverse

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMacpoolUniverse [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMacpoolUniverse [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MacpoolUniverse&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMacpoolUniverse
```
Above example returns the list of MacpoolUniverse.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMacpoolUniverse -Name "MoName"
```
Above example returns the MacpoolUniverse matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMacpoolUniverse -Organization $organization
```
Above example returns the list of MacpoolUniverse available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMacpoolUniverse -InlineCount allpages
```
Above example returns the list of MacpoolUniverse along with count.
...
### -Name
Specifies the name of the MacpoolUniverse.
...
### -Organization
Specifies the organization, to fetch the MacpoolUniverse under it.
