...
New-IntersightOprsSyncTargetListMessage [-AdditionalProperties< Dictionary<string,object>>][-Assist< AssetDeviceRegistrationRelationship>][-AssistId< string>][-Moid< string>][-Tags< List<MoTag>>][-TargetType< OprsSyncTargetListMessage.TargetTypeEnum>][-Targets< List<string>>]
