...
# Get-IntersightGraphicsController

## SYNOPSIS
Get the GraphicsController

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightGraphicsController [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightGraphicsController [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;GraphicsController&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightGraphicsController
```
Above example returns the list of GraphicsController.

### Example 2
```powershell
PS C:\> $result = Get-IntersightGraphicsController -Name "MoName"
```
Above example returns the GraphicsController matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightGraphicsController -Organization $organization
```
Above example returns the list of GraphicsController available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightGraphicsController -InlineCount allpages
```
Above example returns the list of GraphicsController along with count.
...
### -Name
Specifies the name of the GraphicsController.
...
### -Organization
Specifies the organization, to fetch the GraphicsController under it.
...
[Set-IntersightGraphicsController](./Set-IntersightGraphicsController.md)
