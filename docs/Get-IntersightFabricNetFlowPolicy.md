...
# Get-IntersightFabricNetFlowPolicy

## SYNOPSIS
Get the FabricNetFlowPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricNetFlowPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricNetFlowPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricNetFlowPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowPolicy
```
Above example returns the list of FabricNetFlowPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowPolicy -Name "MoName"
```
Above example returns the FabricNetFlowPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowPolicy -Organization $organization
```
Above example returns the list of FabricNetFlowPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricNetFlowPolicy -InlineCount allpages
```
Above example returns the list of FabricNetFlowPolicy along with count.
...
### -Name
Specifies the name of the FabricNetFlowPolicy.
...
### -Organization
Specifies the organization, to fetch the FabricNetFlowPolicy under it.
...
[New-IntersightFabricNetFlowPolicy](./New-IntersightFabricNetFlowPolicy.md)

[Remove-IntersightFabricNetFlowPolicy](./Remove-IntersightFabricNetFlowPolicy.md)

[Set-IntersightFabricNetFlowPolicy](./Set-IntersightFabricNetFlowPolicy.md)
