...
# Get-IntersightChangelogItem

## SYNOPSIS
Get the ChangelogItem

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightChangelogItem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightChangelogItem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ChangelogItem&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightChangelogItem
```
Above example returns the list of ChangelogItem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightChangelogItem -Name "MoName"
```
Above example returns the ChangelogItem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightChangelogItem -Organization $organization
```
Above example returns the list of ChangelogItem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightChangelogItem -InlineCount allpages
```
Above example returns the list of ChangelogItem along with count.
...
### -Name
Specifies the name of the ChangelogItem.
...
### -Organization
Specifies the organization, to fetch the ChangelogItem under it.
...
[Remove-IntersightChangelogItem](./Remove-IntersightChangelogItem.md)
