...
New-IntersightHyperflexHxapDatacenter [-AdditionalProperties< Dictionary<string,object>>][-Moid< string>][-RegisteredDevice< AssetDeviceRegistrationRelationship>][-Tags< List<MoTag>>]
