...
```powershell
$FirmwareServerConfigurationUtilityDistributable = Initialize-IntersightFirmwareServerConfigurationUtilityDistributable  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$FirmwareServerConfigurationUtilityDistributable | ConvertTo-JSON
```
