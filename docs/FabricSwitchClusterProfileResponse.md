...
```powershell
$FabricSwitchClusterProfileResponse = Initialize-IntersightFabricSwitchClusterProfileResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$FabricSwitchClusterProfileResponse | ConvertTo-JSON
```
