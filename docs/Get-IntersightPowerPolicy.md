...
### CmdletParam (Default)
```
Get-IntersightPowerPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPowerPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPowerPolicy
```
Above example returns the list of PowerPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPowerPolicy -Name "MoName"
```
Above example returns the PowerPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPowerPolicy -Organization $organization
```
Above example returns the list of PowerPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPowerPolicy -InlineCount allpages
```
Above example returns the list of PowerPolicy along with count.
...
### -Name
Specifies the name of the PowerPolicy.
...
### -Organization
Specifies the organization, to fetch the PowerPolicy under it.
