...
# Initialize-IntersightStoragePureProtectionGroup
...
```yaml
Type: StoragePureProtectionGroup.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: StoragePureProtectionGroup.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightStoragePureProtectionGroup
```
