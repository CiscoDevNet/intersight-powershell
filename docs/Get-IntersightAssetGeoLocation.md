...
# Get-IntersightAssetGeoLocation

## SYNOPSIS
Get the AssetGeoLocation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAssetGeoLocation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAssetGeoLocation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;AssetGeoLocation&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAssetGeoLocation
```
Above example returns the list of AssetGeoLocation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAssetGeoLocation -Name "MoName"
```
Above example returns the AssetGeoLocation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAssetGeoLocation -Organization $organization
```
Above example returns the list of AssetGeoLocation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAssetGeoLocation -InlineCount allpages
```
Above example returns the list of AssetGeoLocation along with count.
...
### -Name
Specifies the name of the AssetGeoLocation.
...
### -Organization
Specifies the organization, to fetch the AssetGeoLocation under it.
...
[Remove-IntersightAssetGeoLocation](./Remove-IntersightAssetGeoLocation.md)
