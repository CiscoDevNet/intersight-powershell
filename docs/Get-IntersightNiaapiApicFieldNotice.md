...
## SYNOPSIS
Get the NiaapiApicFieldNotice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiApicFieldNotice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiApicFieldNotice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiaapiApicFieldNotice&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiApicFieldNotice
```
Above example returns the list of NiaapiApicFieldNotice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiApicFieldNotice -Name "MoName"
```
Above example returns the NiaapiApicFieldNotice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiApicFieldNotice -Organization $organization
```
Above example returns the list of NiaapiApicFieldNotice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiApicFieldNotice -InlineCount allpages
```
Above example returns the list of NiaapiApicFieldNotice along with count.
...
### -Name
Specifies the name of the NiaapiApicFieldNotice.
...
### -Organization
Specifies the organization, to fetch the NiaapiApicFieldNotice under it.
