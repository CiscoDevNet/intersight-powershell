...
# Get-IntersightFcpoolFcBlock

## SYNOPSIS
Get the FcpoolFcBlock

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFcpoolFcBlock [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFcpoolFcBlock [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FcpoolFcBlock&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFcpoolFcBlock
```
Above example returns the list of FcpoolFcBlock.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFcpoolFcBlock -Name "MoName"
```
Above example returns the FcpoolFcBlock matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFcpoolFcBlock -Organization $organization
```
Above example returns the list of FcpoolFcBlock available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFcpoolFcBlock -InlineCount allpages
```
Above example returns the list of FcpoolFcBlock along with count.
...
### -Name
Specifies the name of the FcpoolFcBlock.
...
### -Organization
Specifies the organization, to fetch the FcpoolFcBlock under it.
