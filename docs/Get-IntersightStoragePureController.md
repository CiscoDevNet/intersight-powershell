...
## SYNOPSIS
Get the StoragePureController

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureController [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureController [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureController&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureController
```
Above example returns the list of StoragePureController.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureController -Name "MoName"
```
Above example returns the StoragePureController matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureController -Organization $organization
```
Above example returns the list of StoragePureController available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureController -InlineCount allpages
```
Above example returns the list of StoragePureController along with count.
...
### -Name
Specifies the name of the StoragePureController.
...
### -Organization
Specifies the organization, to fetch the StoragePureController under it.
