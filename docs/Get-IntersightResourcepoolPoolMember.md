...
## SYNOPSIS
Get the ResourcepoolPoolMember

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightResourcepoolPoolMember [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourcepoolPoolMember [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;ResourcepoolPoolMember&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourcepoolPoolMember
```
Above example returns the list of ResourcepoolPoolMember.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourcepoolPoolMember -Name "MoName"
```
Above example returns the ResourcepoolPoolMember matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourcepoolPoolMember -Organization $organization
```
Above example returns the list of ResourcepoolPoolMember available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourcepoolPoolMember -InlineCount allpages
```
Above example returns the list of ResourcepoolPoolMember along with count.
...
### -Name
Specifies the name of the ResourcepoolPoolMember.
...
### -Organization
Specifies the organization, to fetch the ResourcepoolPoolMember under it.
