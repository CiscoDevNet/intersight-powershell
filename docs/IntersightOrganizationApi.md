# Intersight.Intersight/Api.IntersightOrganizationApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**New-IntersightOrganizationOrganization**](IntersightOrganizationApi.md#New-IntersightOrganizationOrganization) | **POST** /api/v1/organization/Organizations | Create a &#39;organization.Organization&#39; resource.
[**Remove-IntersightOrganizationOrganization**](IntersightOrganizationApi.md#Remove-IntersightOrganizationOrganization) | **DELETE** /api/v1/organization/Organizations/{Moid} | Delete a &#39;organization.Organization&#39; resource.
[**Get-IntersightOrganizationOrganizationByMoid**](IntersightOrganizationApi.md#Get-IntersightOrganizationOrganizationByMoid) | **GET** /api/v1/organization/Organizations/{Moid} | Read a &#39;organization.Organization&#39; resource.
[**Get-IntersightOrganizationOrganizationList**](IntersightOrganizationApi.md#Get-IntersightOrganizationOrganizationList) | **GET** /api/v1/organization/Organizations | Read a &#39;organization.Organization&#39; resource.
[**Set-IntersightOrganizationOrganization**](IntersightOrganizationApi.md#Set-IntersightOrganizationOrganization) | **PATCH** /api/v1/organization/Organizations/{Moid} | Update a &#39;organization.Organization&#39; resource.
[**Update-IntersightOrganizationOrganization**](IntersightOrganizationApi.md#Update-IntersightOrganizationOrganization) | **POST** /api/v1/organization/Organizations/{Moid} | Update a &#39;organization.Organization&#39; resource.


<a name="New-IntersightOrganizationOrganization"></a>
# **New-IntersightOrganizationOrganization**
> OrganizationOrganization New-IntersightOrganizationOrganization<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-OrganizationOrganization] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Create a 'organization.Organization' resource.
try {
     $Result = New-IntersightOrganizationOrganization -OrganizationOrganization $OrganizationOrganization -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
    Write-Host ("Exception occured when calling New-IntersightOrganizationOrganization: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
------------- | ------------- | ------------- | -------------
 **OrganizationOrganization** | [**OrganizationOrganization**](OrganizationOrganization.md)| The &#39;organization.Organization&#39; resource to create. | 
...
<a name="Remove-IntersightOrganizationOrganization"></a>
# **Remove-IntersightOrganizationOrganization**
> void Remove-IntersightOrganizationOrganization<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'organization.Organization' resource.
try {
     $Result = Remove-IntersightOrganizationOrganization -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightOrganizationOrganization: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightOrganizationOrganizationByMoid"></a>
# **Get-IntersightOrganizationOrganizationByMoid**
> OrganizationOrganization Get-IntersightOrganizationOrganizationByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'organization.Organization' resource.
try {
     $Result = Get-IntersightOrganizationOrganizationByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightOrganizationOrganizationByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightOrganizationOrganizationList"></a>
# **Get-IntersightOrganizationOrganizationList**
> OrganizationOrganizationResponse Get-IntersightOrganizationOrganizationList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'organization.Organization' resource.
try {
     $Result = Get-IntersightOrganizationOrganizationList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightOrganizationOrganizationList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightOrganizationOrganization"></a>
# **Set-IntersightOrganizationOrganization**
> OrganizationOrganization Set-IntersightOrganizationOrganization<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-OrganizationOrganization] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$OrganizationOrganization = (Initialize-organization.Organization-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -Account  -ResourceGroups @()) # OrganizationOrganization | The 'organization.Organization' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'organization.Organization' resource.
try {
     $Result = Set-IntersightOrganizationOrganization -Moid $Moid -OrganizationOrganization $OrganizationOrganization -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightOrganizationOrganization: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **OrganizationOrganization** | [**OrganizationOrganization**](OrganizationOrganization.md)| The &#39;organization.Organization&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Update-IntersightOrganizationOrganization"></a>
# **Update-IntersightOrganizationOrganization**
> OrganizationOrganization Update-IntersightOrganizationOrganization<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-OrganizationOrganization] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$OrganizationOrganization =  # OrganizationOrganization | The 'organization.Organization' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'organization.Organization' resource.
try {
     $Result = Update-IntersightOrganizationOrganization -Moid $Moid -OrganizationOrganization $OrganizationOrganization -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightOrganizationOrganization: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
