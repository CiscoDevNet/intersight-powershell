...
## SYNOPSIS
Get the FirmwareDimmDescriptor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareDimmDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareDimmDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareDimmDescriptor&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareDimmDescriptor
```
Above example returns the list of FirmwareDimmDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareDimmDescriptor -Name "MoName"
```
Above example returns the FirmwareDimmDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareDimmDescriptor -Organization $organization
```
Above example returns the list of FirmwareDimmDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareDimmDescriptor -InlineCount allpages
```
Above example returns the list of FirmwareDimmDescriptor along with count.
...
### -Name
Specifies the name of the FirmwareDimmDescriptor.
...
### -Organization
Specifies the organization, to fetch the FirmwareDimmDescriptor under it.
