...
New-IntersightTaskPublicCloudScopedInventory [-AdditionalProperties< Dictionary<string,object>>][-Moid< string>][-NamingProperty< string>][-Queries< object>][-RegisteredDevice< AssetDeviceRegistrationRelationship>][-Tags< List<MoTag>>][-Type< string>][-Values< List<string>>]
...
### Example 1
```powershell
PS C:\> New-IntersightTaskPublicCloudScopedInventory
```
