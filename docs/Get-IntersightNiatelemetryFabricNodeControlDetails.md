...
## SYNOPSIS
Get the NiatelemetryFabricNodeControlDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryFabricNodeControlDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryFabricNodeControlDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryFabricNodeControlDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricNodeControlDetails
```
Above example returns the list of NiatelemetryFabricNodeControlDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricNodeControlDetails -Name "MoName"
```
Above example returns the NiatelemetryFabricNodeControlDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricNodeControlDetails -Organization $organization
```
Above example returns the list of NiatelemetryFabricNodeControlDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryFabricNodeControlDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryFabricNodeControlDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryFabricNodeControlDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryFabricNodeControlDetails under it.
