...
Set-IntersightWorkflowSolutionInstance [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Description< string>][[-Moid]< string>][-Name< string>][-Organization< OrganizationOrganizationRelationship>][-SolutionDefinition< WorkflowSolutionDefinitionRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;WorkflowSolutionInstance&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightWorkflowSolutionInstance
```
