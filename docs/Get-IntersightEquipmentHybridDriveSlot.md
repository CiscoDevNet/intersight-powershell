...
# Get-IntersightEquipmentHybridDriveSlot

## SYNOPSIS
Get the EquipmentHybridDriveSlot

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentHybridDriveSlot [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentHybridDriveSlot [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentHybridDriveSlot&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentHybridDriveSlot
```
Above example returns the list of EquipmentHybridDriveSlot.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentHybridDriveSlot -Name "MoName"
```
Above example returns the EquipmentHybridDriveSlot matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentHybridDriveSlot -Organization $organization
```
Above example returns the list of EquipmentHybridDriveSlot available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentHybridDriveSlot -InlineCount allpages
```
Above example returns the list of EquipmentHybridDriveSlot along with count.
...
### -Name
Specifies the name of the EquipmentHybridDriveSlot.
...
### -Organization
Specifies the organization, to fetch the EquipmentHybridDriveSlot under it.
