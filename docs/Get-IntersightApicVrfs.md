...
### CmdletParam (Default)
```
Get-IntersightApicVrfs [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApicVrfs [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApicVrfs&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApicVrfs
```
Above example returns the list of ApicVrfs.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApicVrfs -Name "MoName"
```
Above example returns the ApicVrfs matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApicVrfs -Organization $organization
```
Above example returns the list of ApicVrfs available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApicVrfs -InlineCount allpages
```
Above example returns the list of ApicVrfs along with count.
...
### -Name
Specifies the name of the ApicVrfs.
...
### -Organization
Specifies the organization, to fetch the ApicVrfs under it.
