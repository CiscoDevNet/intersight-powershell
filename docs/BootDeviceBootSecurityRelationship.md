...
```powershell
$BootDeviceBootSecurityRelationship = Initialize-IntersightBootDeviceBootSecurityRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$BootDeviceBootSecurityRelationship | ConvertTo-JSON
```
