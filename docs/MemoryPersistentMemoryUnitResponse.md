...
```powershell
$MemoryPersistentMemoryUnitResponse = Initialize-IntersightMemoryPersistentMemoryUnitResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$MemoryPersistentMemoryUnitResponse | ConvertTo-JSON
```
