...
# Get-IntersightMgmtBackupCategory

## SYNOPSIS
Get the MgmtBackupCategory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMgmtBackupCategory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMgmtBackupCategory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MgmtBackupCategory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMgmtBackupCategory
```
Above example returns the list of MgmtBackupCategory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMgmtBackupCategory -Name "MoName"
```
Above example returns the MgmtBackupCategory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMgmtBackupCategory -Organization $organization
```
Above example returns the list of MgmtBackupCategory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMgmtBackupCategory -InlineCount allpages
```
Above example returns the list of MgmtBackupCategory along with count.
...
### -Name
Specifies the name of the MgmtBackupCategory.
...
### -Organization
Specifies the organization, to fetch the MgmtBackupCategory under it.
