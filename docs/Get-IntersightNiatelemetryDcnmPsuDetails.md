...
## SYNOPSIS
Get the NiatelemetryDcnmPsuDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryDcnmPsuDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryDcnmPsuDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryDcnmPsuDetails&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmPsuDetails
```
Above example returns the list of NiatelemetryDcnmPsuDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmPsuDetails -Name "MoName"
```
Above example returns the NiatelemetryDcnmPsuDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmPsuDetails -Organization $organization
```
Above example returns the list of NiatelemetryDcnmPsuDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmPsuDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryDcnmPsuDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryDcnmPsuDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryDcnmPsuDetails under it.
