...
# Initialize-IntersightSmtpPolicy
...
Initialize-IntersightSmtpPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ApplianceAccount< Model.IamAccountRelationship>][-AuthPassword< string>][-Certificate< Model.IamTrustPointRelationship>][-ClassId< SmtpPolicy.ClassIdEnum>][-Description< string>][-EnableAuth< bool>][-EnableTls< bool>][-Enabled< bool>][-MinSeverity< SmtpPolicy.MinSeverityEnum>][-Moid< string>][-Name< string>][-ObjectType< SmtpPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Profiles< System.Collections.Generic.List`1[Model.PolicyAbstractConfigProfileRelationship]>][-SenderEmail< string>][-SmtpPort< long>][-SmtpRecipients< System.Collections.Generic.List`1[string]>][-SmtpServer< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-UserName< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: SmtpPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightSmtpPolicy
```
