...
### CmdletParam (Default)
```
Get-IntersightCapabilityEquipmentPhysicalDef [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityEquipmentPhysicalDef [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityEquipmentPhysicalDef
```
Above example returns the list of CapabilityEquipmentPhysicalDef.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityEquipmentPhysicalDef -Name "MoName"
```
Above example returns the CapabilityEquipmentPhysicalDef matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityEquipmentPhysicalDef -Organization $organization
```
Above example returns the list of CapabilityEquipmentPhysicalDef available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityEquipmentPhysicalDef -InlineCount allpages
```
Above example returns the list of CapabilityEquipmentPhysicalDef along with count.
...
### -Name
Specifies the name of the CapabilityEquipmentPhysicalDef.
...
### -Organization
Specifies the organization, to fetch the CapabilityEquipmentPhysicalDef under it.
