...
## SYNOPSIS
Get the StorageHitachiPool

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiPool [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiPool [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageHitachiPool&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiPool
```
Above example returns the list of StorageHitachiPool.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiPool -Name "MoName"
```
Above example returns the StorageHitachiPool matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiPool -Organization $organization
```
Above example returns the list of StorageHitachiPool available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiPool -InlineCount allpages
```
Above example returns the list of StorageHitachiPool along with count.
...
### -Name
Specifies the name of the StorageHitachiPool.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiPool under it.
