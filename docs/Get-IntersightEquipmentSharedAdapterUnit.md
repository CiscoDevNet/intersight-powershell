...
### CmdletParam (Default)
```
Get-IntersightEquipmentSharedAdapterUnit [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentSharedAdapterUnit [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
