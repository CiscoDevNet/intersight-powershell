...
# Initialize-IntersightPartnerintegrationInventory
...
```yaml
Type: PartnerintegrationInventory.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.PartnerintegrationModelRelationship]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: PartnerintegrationInventory.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightPartnerintegrationInventory
```
