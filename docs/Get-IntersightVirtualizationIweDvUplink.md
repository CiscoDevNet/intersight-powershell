...
## SYNOPSIS
Get the VirtualizationIweDvUplink

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationIweDvUplink [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationIweDvUplink [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationIweDvUplink&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweDvUplink
```
Above example returns the list of VirtualizationIweDvUplink.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweDvUplink -Name "MoName"
```
Above example returns the VirtualizationIweDvUplink matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweDvUplink -Organization $organization
```
Above example returns the list of VirtualizationIweDvUplink available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweDvUplink -InlineCount allpages
```
Above example returns the list of VirtualizationIweDvUplink along with count.
...
### -Name
Specifies the name of the VirtualizationIweDvUplink.
...
### -Organization
Specifies the organization, to fetch the VirtualizationIweDvUplink under it.
