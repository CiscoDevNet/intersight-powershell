...
### CmdletParam (Default)
```
Get-IntersightNiatelemetryHttpsAclEpgDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryHttpsAclEpgDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetryHttpsAclEpgDetails&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclEpgDetails
```
Above example returns the list of NiatelemetryHttpsAclEpgDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclEpgDetails -Name "MoName"
```
Above example returns the NiatelemetryHttpsAclEpgDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclEpgDetails -Organization $organization
```
Above example returns the list of NiatelemetryHttpsAclEpgDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclEpgDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryHttpsAclEpgDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryHttpsAclEpgDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryHttpsAclEpgDetails under it.
