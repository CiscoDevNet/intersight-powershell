...
## SYNOPSIS
Get the FabricEthNetworkControlPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricEthNetworkControlPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricEthNetworkControlPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricEthNetworkControlPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkControlPolicy
```
Above example returns the list of FabricEthNetworkControlPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkControlPolicy -Name "MoName"
```
Above example returns the FabricEthNetworkControlPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkControlPolicy -Organization $organization
```
Above example returns the list of FabricEthNetworkControlPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricEthNetworkControlPolicy -InlineCount allpages
```
Above example returns the list of FabricEthNetworkControlPolicy along with count.
...
### -Name
Specifies the name of the FabricEthNetworkControlPolicy.
...
### -Organization
Specifies the organization, to fetch the FabricEthNetworkControlPolicy under it.
