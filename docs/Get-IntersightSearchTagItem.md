...
# Get-IntersightSearchTagItem

## SYNOPSIS
Get the SearchTagItem

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSearchTagItem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSearchTagItem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;SearchTagItem&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSearchTagItem
```
Above example returns the list of SearchTagItem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSearchTagItem -Name "MoName"
```
Above example returns the SearchTagItem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSearchTagItem -Organization $organization
```
Above example returns the list of SearchTagItem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSearchTagItem -InlineCount allpages
```
Above example returns the list of SearchTagItem along with count.
...
### -Name
Specifies the name of the SearchTagItem.
...
### -Organization
Specifies the organization, to fetch the SearchTagItem under it.
