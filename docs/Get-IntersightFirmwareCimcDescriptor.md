...
## SYNOPSIS
Get the FirmwareCimcDescriptor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareCimcDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareCimcDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareCimcDescriptor&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareCimcDescriptor
```
Above example returns the list of FirmwareCimcDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareCimcDescriptor -Name "MoName"
```
Above example returns the FirmwareCimcDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareCimcDescriptor -Organization $organization
```
Above example returns the list of FirmwareCimcDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareCimcDescriptor -InlineCount allpages
```
Above example returns the list of FirmwareCimcDescriptor along with count.
...
### -Name
Specifies the name of the FirmwareCimcDescriptor.
...
### -Organization
Specifies the organization, to fetch the FirmwareCimcDescriptor under it.
