...
# Get-IntersightVnicFcVethInventory

## SYNOPSIS
Get the VnicFcVethInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicFcVethInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicFcVethInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicFcVethInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicFcVethInventory
```
Above example returns the list of VnicFcVethInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicFcVethInventory -Name "MoName"
```
Above example returns the VnicFcVethInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicFcVethInventory -Organization $organization
```
Above example returns the list of VnicFcVethInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicFcVethInventory -InlineCount allpages
```
Above example returns the list of VnicFcVethInventory along with count.
...
### -Name
Specifies the name of the VnicFcVethInventory.
...
### -Organization
Specifies the organization, to fetch the VnicFcVethInventory under it.
