...
## SYNOPSIS
Get the IamEndPointPrivilege

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamEndPointPrivilege [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamEndPointPrivilege [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamEndPointPrivilege&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamEndPointPrivilege
```
Above example returns the list of IamEndPointPrivilege.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamEndPointPrivilege -Name "MoName"
```
Above example returns the IamEndPointPrivilege matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamEndPointPrivilege -Organization $organization
```
Above example returns the list of IamEndPointPrivilege available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamEndPointPrivilege -InlineCount allpages
```
Above example returns the list of IamEndPointPrivilege along with count.
...
### -Name
Specifies the name of the IamEndPointPrivilege.
...
### -Organization
Specifies the organization, to fetch the IamEndPointPrivilege under it.
