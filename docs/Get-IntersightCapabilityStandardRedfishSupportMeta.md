...
# Get-IntersightCapabilityStandardRedfishSupportMeta

## SYNOPSIS
Get the CapabilityStandardRedfishSupportMeta

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityStandardRedfishSupportMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityStandardRedfishSupportMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilityStandardRedfishSupportMeta&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityStandardRedfishSupportMeta
```
Above example returns the list of CapabilityStandardRedfishSupportMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityStandardRedfishSupportMeta -Name "MoName"
```
Above example returns the CapabilityStandardRedfishSupportMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityStandardRedfishSupportMeta -Organization $organization
```
Above example returns the list of CapabilityStandardRedfishSupportMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityStandardRedfishSupportMeta -InlineCount allpages
```
Above example returns the list of CapabilityStandardRedfishSupportMeta along with count.
...
### -Name
Specifies the name of the CapabilityStandardRedfishSupportMeta.
...
### -Organization
Specifies the organization, to fetch the CapabilityStandardRedfishSupportMeta under it.
