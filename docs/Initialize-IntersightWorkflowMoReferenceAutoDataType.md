...
# Initialize-IntersightWorkflowMoReferenceAutoDataType
...
Initialize-IntersightWorkflowMoReferenceAutoDataType [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< WorkflowMoReferenceAutoDataType.ClassIdEnum>][-Default< Model.WorkflowDefaultValue>][-Description< string>][-DisplayMeta< Model.WorkflowDisplayMeta>][-InputParameters< object>][-Label< string>][-Name< string>][-ObjectType< WorkflowMoReferenceAutoDataType.ObjectTypeEnum>][-Properties< System.Collections.Generic.List`1[Model.WorkflowMoReferenceAutoProperty]>][-Required< bool>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowMoReferenceAutoDataType.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowMoReferenceAutoDataType.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
Note :- Use Initialize-IntersightWorkflowMoReferenceAutoProperty to create the object of complex type WorkflowMoReferenceAutoProperty

```yaml
Type: System.Collections.Generic.List`1[Model.WorkflowMoReferenceAutoProperty]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowMoReferenceAutoDataType
```
...
[Initialize-IntersightWorkflowMoReferenceAutoProperty](./Initialize-IntersightWorkflowMoReferenceAutoProperty.md)
