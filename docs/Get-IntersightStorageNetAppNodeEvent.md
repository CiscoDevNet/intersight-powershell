...
## SYNOPSIS
Get the StorageNetAppNodeEvent

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppNodeEvent [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppNodeEvent [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppNodeEvent&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNodeEvent
```
Above example returns the list of StorageNetAppNodeEvent.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNodeEvent -Name "MoName"
```
Above example returns the StorageNetAppNodeEvent matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNodeEvent -Organization $organization
```
Above example returns the list of StorageNetAppNodeEvent available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNodeEvent -InlineCount allpages
```
Above example returns the list of StorageNetAppNodeEvent along with count.
...
### -Name
Specifies the name of the StorageNetAppNodeEvent.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppNodeEvent under it.
