...
# Initialize-IntersightNiatelemetryEpg
...
Initialize-IntersightNiatelemetryEpg [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AzurePackCount< long>][-ClassId< NiatelemetryEpg.ClassIdEnum>][-Dn< string>][-EpgDelimiterCount< long>][-FcNpvCount< long>][-FcoeCount< long>][-FvRsDomAttCount< long>][-IntraEpgDvsBmCount< long>][-IntraEpgHyperv< string>][-IsAttrBased< string>][-Microsegmentation< string>][-MicrosoftUsegCount< long>][-Moid< string>][-Name< string>][-ObjectType< NiatelemetryEpg.ObjectTypeEnum>][-OrchslDevVipCfgCount< long>][-RecordType< string>][-RecordVersion< string>][-SiteName< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-UsegHypervCount< long>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: NiatelemetryEpg.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: NiatelemetryEpg.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightNiatelemetryEpg
```
