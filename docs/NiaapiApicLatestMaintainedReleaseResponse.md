...
```powershell
$NiaapiApicLatestMaintainedReleaseResponse = Initialize-IntersightNiaapiApicLatestMaintainedReleaseResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiaapiApicLatestMaintainedReleaseResponse | ConvertTo-JSON
```
