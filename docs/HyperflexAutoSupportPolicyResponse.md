...
```powershell
$HyperflexAutoSupportPolicyResponse = Initialize-IntersightHyperflexAutoSupportPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexAutoSupportPolicyResponse | ConvertTo-JSON
```
