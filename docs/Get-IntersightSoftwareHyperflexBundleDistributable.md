...
## SYNOPSIS
Get the SoftwareHyperflexBundleDistributable

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwareHyperflexBundleDistributable [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwareHyperflexBundleDistributable [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwareHyperflexBundleDistributable
```
Above example returns the list of SoftwareHyperflexBundleDistributable.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwareHyperflexBundleDistributable -Name "MoName"
```
Above example returns the SoftwareHyperflexBundleDistributable matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwareHyperflexBundleDistributable -Organization $organization
```
Above example returns the list of SoftwareHyperflexBundleDistributable available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwareHyperflexBundleDistributable -InlineCount allpages
```
Above example returns the list of SoftwareHyperflexBundleDistributable along with count.
...
### -Name
Specifies the name of the SoftwareHyperflexBundleDistributable.
...
### -Organization
Specifies the organization, to fetch the SoftwareHyperflexBundleDistributable under it.
