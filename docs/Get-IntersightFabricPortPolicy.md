...
## SYNOPSIS
Get the FabricPortPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricPortPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricPortPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricPortPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricPortPolicy
```
Above example returns the list of FabricPortPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricPortPolicy -Name "MoName"
```
Above example returns the FabricPortPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricPortPolicy -Organization $organization
```
Above example returns the list of FabricPortPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricPortPolicy -InlineCount allpages
```
Above example returns the list of FabricPortPolicy along with count.
...
### -Name
Specifies the name of the FabricPortPolicy.
...
### -Organization
Specifies the organization, to fetch the FabricPortPolicy under it.
