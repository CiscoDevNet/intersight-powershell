...
```powershell
$HyperflexVcenterConfigPolicyResponse = Initialize-IntersightHyperflexVcenterConfigPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexVcenterConfigPolicyResponse | ConvertTo-JSON
```
