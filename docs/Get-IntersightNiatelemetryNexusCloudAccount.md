...
# Get-IntersightNiatelemetryNexusCloudAccount
...
### CmdletParam (Default)
```
Get-IntersightNiatelemetryNexusCloudAccount [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryNexusCloudAccount [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryNexusCloudAccount&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusCloudAccount
```
Above example returns the list of NiatelemetryNexusCloudAccount.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusCloudAccount -Name "MoName"
```
Above example returns the NiatelemetryNexusCloudAccount matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusCloudAccount -Organization $organization
```
Above example returns the list of NiatelemetryNexusCloudAccount available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNexusCloudAccount -InlineCount allpages
```
Above example returns the list of NiatelemetryNexusCloudAccount along with count.
...
### -Name
Specifies the name of the NiatelemetryNexusCloudAccount.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryNexusCloudAccount under it.
...
[New-IntersightNiatelemetryNexusCloudAccount](./New-IntersightNiatelemetryNexusCloudAccount.md)

[Set-IntersightNiatelemetryNexusCloudAccount](./Set-IntersightNiatelemetryNexusCloudAccount.md)
