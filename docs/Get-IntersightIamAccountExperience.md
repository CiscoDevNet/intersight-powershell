...
# Get-IntersightIamAccountExperience

## SYNOPSIS
Get the IamAccountExperience

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamAccountExperience [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamAccountExperience [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IamAccountExperience&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamAccountExperience
```
Above example returns the list of IamAccountExperience.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamAccountExperience -Name "MoName"
```
Above example returns the IamAccountExperience matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamAccountExperience -Organization $organization
```
Above example returns the list of IamAccountExperience available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamAccountExperience -InlineCount allpages
```
Above example returns the list of IamAccountExperience along with count.
...
### -Name
Specifies the name of the IamAccountExperience.
...
### -Organization
Specifies the organization, to fetch the IamAccountExperience under it.
