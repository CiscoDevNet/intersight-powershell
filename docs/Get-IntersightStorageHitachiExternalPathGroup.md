...
# Get-IntersightStorageHitachiExternalPathGroup

## SYNOPSIS
Get the StorageHitachiExternalPathGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiExternalPathGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiExternalPathGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiExternalPathGroup&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalPathGroup
```
Above example returns the list of StorageHitachiExternalPathGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalPathGroup -Name "MoName"
```
Above example returns the StorageHitachiExternalPathGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalPathGroup -Organization $organization
```
Above example returns the list of StorageHitachiExternalPathGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalPathGroup -InlineCount allpages
```
Above example returns the list of StorageHitachiExternalPathGroup along with count.
...
### -Name
Specifies the name of the StorageHitachiExternalPathGroup.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiExternalPathGroup under it.
