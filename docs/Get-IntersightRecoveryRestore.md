...
## SYNOPSIS
Get the RecoveryRestore

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRecoveryRestore [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRecoveryRestore [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;RecoveryRestore&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRecoveryRestore
```
Above example returns the list of RecoveryRestore.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRecoveryRestore -Name "MoName"
```
Above example returns the RecoveryRestore matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRecoveryRestore -Organization $organization
```
Above example returns the list of RecoveryRestore available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRecoveryRestore -InlineCount allpages
```
Above example returns the list of RecoveryRestore along with count.
...
### -Name
Specifies the name of the RecoveryRestore.
...
### -Organization
Specifies the organization, to fetch the RecoveryRestore under it.
