...
## SYNOPSIS
Get the NiaapiDcnmHweol

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiDcnmHweol [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiDcnmHweol [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiaapiDcnmHweol&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmHweol
```
Above example returns the list of NiaapiDcnmHweol.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmHweol -Name "MoName"
```
Above example returns the NiaapiDcnmHweol matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmHweol -Organization $organization
```
Above example returns the list of NiaapiDcnmHweol available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmHweol -InlineCount allpages
```
Above example returns the list of NiaapiDcnmHweol along with count.
...
### -Name
Specifies the name of the NiaapiDcnmHweol.
...
### -Organization
Specifies the organization, to fetch the NiaapiDcnmHweol under it.
