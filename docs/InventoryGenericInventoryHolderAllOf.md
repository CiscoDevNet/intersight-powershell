...
```powershell
$InventoryGenericInventoryHolderAllOf = Initialize-IntersightInventoryGenericInventoryHolderAllOf  -ClassId null `
 -ObjectType null `
 -Endpoint null `
 -ComputeBlade null `
...
```powershell
$InventoryGenericInventoryHolderAllOf | ConvertTo-JSON
```
