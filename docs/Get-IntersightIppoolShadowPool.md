...
# Get-IntersightIppoolShadowPool

## SYNOPSIS
Get the IppoolShadowPool

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIppoolShadowPool [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIppoolShadowPool [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IppoolShadowPool&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIppoolShadowPool
```
Above example returns the list of IppoolShadowPool.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIppoolShadowPool -Name "MoName"
```
Above example returns the IppoolShadowPool matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIppoolShadowPool -Organization $organization
```
Above example returns the list of IppoolShadowPool available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIppoolShadowPool -InlineCount allpages
```
Above example returns the list of IppoolShadowPool along with count.
...
### -Name
Specifies the name of the IppoolShadowPool.
...
### -Organization
Specifies the organization, to fetch the IppoolShadowPool under it.
