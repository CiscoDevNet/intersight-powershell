...
```powershell
$HyperflexClusterHealthCheckExecutionSnapshot = Initialize-IntersightHyperflexClusterHealthCheckExecutionSnapshot  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$HyperflexClusterHealthCheckExecutionSnapshot | ConvertTo-JSON
```
