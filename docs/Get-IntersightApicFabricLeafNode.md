...
# Get-IntersightApicFabricLeafNode

## SYNOPSIS
Get the ApicFabricLeafNode

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApicFabricLeafNode [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApicFabricLeafNode [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApicFabricLeafNode&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApicFabricLeafNode
```
Above example returns the list of ApicFabricLeafNode.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApicFabricLeafNode -Name "MoName"
```
Above example returns the ApicFabricLeafNode matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApicFabricLeafNode -Organization $organization
```
Above example returns the list of ApicFabricLeafNode available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApicFabricLeafNode -InlineCount allpages
```
Above example returns the list of ApicFabricLeafNode along with count.
...
### -Name
Specifies the name of the ApicFabricLeafNode.
...
### -Organization
Specifies the organization, to fetch the ApicFabricLeafNode under it.
