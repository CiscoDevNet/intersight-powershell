...
Initialize-IntersightSchedulerBaseScheduleParams [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< SchedulerBaseScheduleParams.ClassIdEnum>][-Duration< string>][-Name< string>][-ObjectType< SchedulerBaseScheduleParams.ObjectTypeEnum>][-StartTime< DateTime>][-TimeZone< SchedulerBaseScheduleParams.VarTimeZoneEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
