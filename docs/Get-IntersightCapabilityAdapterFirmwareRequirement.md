...
## SYNOPSIS
Get the CapabilityAdapterFirmwareRequirement

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityAdapterFirmwareRequirement [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityAdapterFirmwareRequirement [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilityAdapterFirmwareRequirement&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterFirmwareRequirement
```
Above example returns the list of CapabilityAdapterFirmwareRequirement.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterFirmwareRequirement -Name "MoName"
```
Above example returns the CapabilityAdapterFirmwareRequirement matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterFirmwareRequirement -Organization $organization
```
Above example returns the list of CapabilityAdapterFirmwareRequirement available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterFirmwareRequirement -InlineCount allpages
```
Above example returns the list of CapabilityAdapterFirmwareRequirement along with count.
...
### -Name
Specifies the name of the CapabilityAdapterFirmwareRequirement.
...
### -Organization
Specifies the organization, to fetch the CapabilityAdapterFirmwareRequirement under it.
