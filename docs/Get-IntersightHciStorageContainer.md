...
# Get-IntersightHciStorageContainer

## SYNOPSIS
Get the HciStorageContainer

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHciStorageContainer [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciStorageContainer [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciStorageContainer&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciStorageContainer
```
Above example returns the list of HciStorageContainer.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciStorageContainer -Name "MoName"
```
Above example returns the HciStorageContainer matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciStorageContainer -Organization $organization
```
Above example returns the list of HciStorageContainer available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciStorageContainer -InlineCount allpages
```
Above example returns the list of HciStorageContainer along with count.
...
### -Name
Specifies the name of the HciStorageContainer.
...
### -Organization
Specifies the organization, to fetch the HciStorageContainer under it.
