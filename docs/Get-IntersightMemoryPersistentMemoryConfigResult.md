...
## SYNOPSIS
Get the MemoryPersistentMemoryConfigResult

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMemoryPersistentMemoryConfigResult [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMemoryPersistentMemoryConfigResult [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;MemoryPersistentMemoryConfigResult&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryConfigResult
```
Above example returns the list of MemoryPersistentMemoryConfigResult.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryConfigResult -Name "MoName"
```
Above example returns the MemoryPersistentMemoryConfigResult matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryConfigResult -Organization $organization
```
Above example returns the list of MemoryPersistentMemoryConfigResult available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMemoryPersistentMemoryConfigResult -InlineCount allpages
```
Above example returns the list of MemoryPersistentMemoryConfigResult along with count.
...
### -Name
Specifies the name of the MemoryPersistentMemoryConfigResult.
...
### -Organization
Specifies the organization, to fetch the MemoryPersistentMemoryConfigResult under it.
...
[Set-IntersightMemoryPersistentMemoryConfigResult](./Set-IntersightMemoryPersistentMemoryConfigResult.md)
