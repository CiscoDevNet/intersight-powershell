...
New-IntersightHyperflexHealthCheckPackageChecksum [-AdditionalProperties< Dictionary<string,object>>][-Checksum< string>][-Moid< string>][[-Name]< string>][-PackageName< string>][-Tags< List<MoTag>>][-Timestamp< DateTime>][-Version< string>]
