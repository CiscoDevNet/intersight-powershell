...
New-IntersightHyperflexHealthCheckPackageChecksum [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Checksum< string>][-Moid< string>][[-Name]< string>][-PackageName< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Timestamp< DateTime>][-Version< string>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;HyperflexHealthCheckPackageChecksum&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightHyperflexHealthCheckPackageChecksum
```
