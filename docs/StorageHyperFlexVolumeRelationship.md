...
```powershell
$StorageHyperFlexVolumeRelationship = Initialize-IntersightStorageHyperFlexVolumeRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StorageHyperFlexVolumeRelationship | ConvertTo-JSON
```
