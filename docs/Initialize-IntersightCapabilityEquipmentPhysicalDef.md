...
# Initialize-IntersightCapabilityEquipmentPhysicalDef
...
Initialize-IntersightCapabilityEquipmentPhysicalDef [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< CapabilityEquipmentPhysicalDef.ClassIdEnum>][-Depth< float>][-Height< float>][-MaxPower< long>][-MinPower< long>][-Moid< string>][-Name< string>][-NominalPower< long>][-ObjectType< CapabilityEquipmentPhysicalDef.ObjectTypeEnum>][-Pid< CapabilityEquipmentPhysicalDef.PidEnum>][-Sku< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Vid< string>][-Weight< float>][-Width< float>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: CapabilityEquipmentPhysicalDef.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CapabilityEquipmentPhysicalDef.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCapabilityEquipmentPhysicalDef
```
