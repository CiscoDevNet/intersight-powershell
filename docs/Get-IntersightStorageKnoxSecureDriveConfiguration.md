...
# Get-IntersightStorageKnoxSecureDriveConfiguration

## SYNOPSIS
Get the StorageKnoxSecureDriveConfiguration

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageKnoxSecureDriveConfiguration [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageKnoxSecureDriveConfiguration [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageKnoxSecureDriveConfiguration&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageKnoxSecureDriveConfiguration
```
Above example returns the list of StorageKnoxSecureDriveConfiguration.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageKnoxSecureDriveConfiguration -Name "MoName"
```
Above example returns the StorageKnoxSecureDriveConfiguration matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageKnoxSecureDriveConfiguration -Organization $organization
```
Above example returns the list of StorageKnoxSecureDriveConfiguration available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageKnoxSecureDriveConfiguration -InlineCount allpages
```
Above example returns the list of StorageKnoxSecureDriveConfiguration along with count.
...
### -Name
Specifies the name of the StorageKnoxSecureDriveConfiguration.
...
### -Organization
Specifies the organization, to fetch the StorageKnoxSecureDriveConfiguration under it.
