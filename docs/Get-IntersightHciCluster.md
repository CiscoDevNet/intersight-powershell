...
### CmdletParam (Default)
```
Get-IntersightHciCluster [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciCluster [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciCluster&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciCluster
```
Above example returns the list of HciCluster.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciCluster -Name "MoName"
```
Above example returns the HciCluster matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciCluster -Organization $organization
```
Above example returns the list of HciCluster available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciCluster -InlineCount allpages
```
Above example returns the list of HciCluster along with count.
...
### -Name
Specifies the name of the HciCluster.
...
### -Organization
Specifies the organization, to fetch the HciCluster under it.
...
[Set-IntersightHciCluster](./Set-IntersightHciCluster.md)
