...
```powershell
$StorageBaseProtectionGroupSnapshot = Initialize-IntersightStorageBaseProtectionGroupSnapshot  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$StorageBaseProtectionGroupSnapshot | ConvertTo-JSON
```
