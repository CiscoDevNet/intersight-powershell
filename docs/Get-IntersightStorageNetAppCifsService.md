...
# Get-IntersightStorageNetAppCifsService

## SYNOPSIS
Get the StorageNetAppCifsService

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppCifsService [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppCifsService [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppCifsService&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCifsService
```
Above example returns the list of StorageNetAppCifsService.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCifsService -Name "MoName"
```
Above example returns the StorageNetAppCifsService matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCifsService -Organization $organization
```
Above example returns the list of StorageNetAppCifsService available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppCifsService -InlineCount allpages
```
Above example returns the list of StorageNetAppCifsService along with count.
...
### -Name
Specifies the name of the StorageNetAppCifsService.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppCifsService under it.
