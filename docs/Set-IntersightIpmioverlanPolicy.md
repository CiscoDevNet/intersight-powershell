...
Set-IntersightIpmioverlanPolicy [-AdditionalProperties< Dictionary<string,object>>][-Description< string>][-Enabled< bool>][-EncryptionKey< string>][[-Moid]< string>][-Name< string>][-Organization< OrganizationOrganizationRelationship>][-Privilege< IpmioverlanPolicy.PrivilegeEnum>][-Profiles< List<PolicyAbstractConfigProfileRelationship>>][-Tags< List<MoTag>>]
...
### Example 1
```powershell
PS C:\> Set-IntersightIpmioverlanPolicy
```
