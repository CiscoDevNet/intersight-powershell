...
# Initialize-IntersightTaskWorkflowAction
...
Initialize-IntersightTaskWorkflowAction [-Action< TaskWorkflowAction.ActionEnum>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< TaskWorkflowAction.ClassIdEnum>][-InputParams< string>][-IsDynamic< bool>][-Moid< string>][-ObjectType< TaskWorkflowAction.ObjectTypeEnum>][-Retryable< bool>][-SequenceKey< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-WaitOnDuplicate< bool>][-WorkflowContext< string>][-WorkflowFile< Model.TaskFileDownloadInfo>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: TaskWorkflowAction.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TaskWorkflowAction.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.TaskFileDownloadInfo
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTaskWorkflowAction
```
