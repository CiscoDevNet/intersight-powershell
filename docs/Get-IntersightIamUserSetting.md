...
# Get-IntersightIamUserSetting

## SYNOPSIS
Get the IamUserSetting

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamUserSetting [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamUserSetting [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamUserSetting&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamUserSetting
```
Above example returns the list of IamUserSetting.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamUserSetting -Name "MoName"
```
Above example returns the IamUserSetting matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamUserSetting -Organization $organization
```
Above example returns the list of IamUserSetting available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamUserSetting -InlineCount allpages
```
Above example returns the list of IamUserSetting along with count.
...
### -Name
Specifies the name of the IamUserSetting.
...
### -Organization
Specifies the organization, to fetch the IamUserSetting under it.
...
[New-IntersightIamUserSetting](./New-IntersightIamUserSetting.md)

[Set-IntersightIamUserSetting](./Set-IntersightIamUserSetting.md)
