...
# Get-IntersightIamLdapProviderInventory

## SYNOPSIS
Get the IamLdapProviderInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamLdapProviderInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamLdapProviderInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamLdapProviderInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamLdapProviderInventory
```
Above example returns the list of IamLdapProviderInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamLdapProviderInventory -Name "MoName"
```
Above example returns the IamLdapProviderInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamLdapProviderInventory -Organization $organization
```
Above example returns the list of IamLdapProviderInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamLdapProviderInventory -InlineCount allpages
```
Above example returns the list of IamLdapProviderInventory along with count.
...
### -Name
Specifies the name of the IamLdapProviderInventory.
...
### -Organization
Specifies the organization, to fetch the IamLdapProviderInventory under it.
