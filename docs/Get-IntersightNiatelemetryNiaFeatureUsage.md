...
## SYNOPSIS
Get the NiatelemetryNiaFeatureUsage

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryNiaFeatureUsage [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryNiaFeatureUsage [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryNiaFeatureUsage&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaFeatureUsage
```
Above example returns the list of NiatelemetryNiaFeatureUsage.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaFeatureUsage -Name "MoName"
```
Above example returns the NiatelemetryNiaFeatureUsage matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaFeatureUsage -Organization $organization
```
Above example returns the list of NiatelemetryNiaFeatureUsage available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaFeatureUsage -InlineCount allpages
```
Above example returns the list of NiatelemetryNiaFeatureUsage along with count.
...
### -Name
Specifies the name of the NiatelemetryNiaFeatureUsage.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryNiaFeatureUsage under it.
