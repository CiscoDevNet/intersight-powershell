...
## SYNOPSIS
Get the AssetDeviceConnectorManager

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAssetDeviceConnectorManager [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAssetDeviceConnectorManager [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;AssetDeviceConnectorManager&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAssetDeviceConnectorManager
```
Above example returns the list of AssetDeviceConnectorManager.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAssetDeviceConnectorManager -Name "MoName"
```
Above example returns the AssetDeviceConnectorManager matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAssetDeviceConnectorManager -Organization $organization
```
Above example returns the list of AssetDeviceConnectorManager available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAssetDeviceConnectorManager -InlineCount allpages
```
Above example returns the list of AssetDeviceConnectorManager along with count.
...
### -Name
Specifies the name of the AssetDeviceConnectorManager.
...
### -Organization
Specifies the organization, to fetch the AssetDeviceConnectorManager under it.
