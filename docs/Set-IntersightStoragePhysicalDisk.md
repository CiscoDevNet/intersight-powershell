...
Set-IntersightStoragePhysicalDisk [-AdditionalProperties< Dictionary<string,object>>][-DriveFirmware< string>][-FdeCapable< string>][-HotSpareType< string>][[-Moid]< string>][-PhysicalDiskExtensions< List<StoragePhysicalDiskExtensionRelationship>>][-PreviousFru< EquipmentFruRelationship>][-Secured< string>][-Tags< List<MoTag>>]
