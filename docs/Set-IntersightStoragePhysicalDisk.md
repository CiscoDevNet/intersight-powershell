...
Set-IntersightStoragePhysicalDisk [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-DriveFirmware< string>][-FdeCapable< string>][-HotSpareType< string>][[-Moid]< string>][-PhysicalDiskExtensions< System.Collections.Generic.List`1[StoragePhysicalDiskExtensionRelationship]>][-PreviousFru< EquipmentFruRelationship>][-Secured< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: System.Collections.Generic.List`1[StoragePhysicalDiskExtensionRelationship]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Set-IntersightStoragePhysicalDisk
```
