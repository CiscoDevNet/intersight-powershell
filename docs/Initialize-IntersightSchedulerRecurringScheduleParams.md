...
# Initialize-IntersightSchedulerRecurringScheduleParams
...
```yaml
Type: SchedulerRecurringScheduleParams.VarTimeZoneEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightSchedulerRecurringScheduleParams
```
