...
# Set-IntersightIppoolReservation
...
Set-IntersightIppoolReservation [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AllocationType< IppoolReservation.AllocationTypeEnum>][-Identity< string>][-IpType< IppoolReservation.IpTypeEnum>][[-Moid]< string>][-Organization< OrganizationOrganizationRelationship>][-Pool< IppoolPoolRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-VrfMoid< string>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;IppoolReservation&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightIppoolReservation
```
