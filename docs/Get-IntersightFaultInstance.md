...
# Get-IntersightFaultInstance

## SYNOPSIS
Get the FaultInstance

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFaultInstance [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFaultInstance [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;FaultInstance&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFaultInstance
```
Above example returns the list of FaultInstance.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFaultInstance -Name "MoName"
```
Above example returns the FaultInstance matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFaultInstance -Organization $organization
```
Above example returns the list of FaultInstance available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFaultInstance -InlineCount allpages
```
Above example returns the list of FaultInstance along with count.
...
### -Name
Specifies the name of the FaultInstance.
...
### -Organization
Specifies the organization, to fetch the FaultInstance under it.
...
[Set-IntersightFaultInstance](./Set-IntersightFaultInstance.md)
