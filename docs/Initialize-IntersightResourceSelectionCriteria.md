...
# Initialize-IntersightResourceSelectionCriteria
...
Initialize-IntersightResourceSelectionCriteria [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< ResourceSelectionCriteria.ClassIdEnum>][-Description< string>][-Moid< string>][-Name< string>][-ObjectType< ResourceSelectionCriteria.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Selectors< System.Collections.Generic.List`1[Model.ResourceSelector]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ResourceSelectionCriteria.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ResourceSelectionCriteria.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightResourceSelectionCriteria
```
