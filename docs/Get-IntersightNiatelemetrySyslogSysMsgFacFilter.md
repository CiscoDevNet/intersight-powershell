...
## SYNOPSIS
Get the NiatelemetrySyslogSysMsgFacFilter

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetrySyslogSysMsgFacFilter [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetrySyslogSysMsgFacFilter [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetrySyslogSysMsgFacFilter&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySyslogSysMsgFacFilter
```
Above example returns the list of NiatelemetrySyslogSysMsgFacFilter.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySyslogSysMsgFacFilter -Name "MoName"
```
Above example returns the NiatelemetrySyslogSysMsgFacFilter matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySyslogSysMsgFacFilter -Organization $organization
```
Above example returns the list of NiatelemetrySyslogSysMsgFacFilter available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySyslogSysMsgFacFilter -InlineCount allpages
```
Above example returns the list of NiatelemetrySyslogSysMsgFacFilter along with count.
...
### -Name
Specifies the name of the NiatelemetrySyslogSysMsgFacFilter.
...
### -Organization
Specifies the organization, to fetch the NiatelemetrySyslogSysMsgFacFilter under it.
