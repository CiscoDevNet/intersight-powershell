...
## SYNOPSIS
Get the FirmwareUpgradeImpactStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareUpgradeImpactStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareUpgradeImpactStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareUpgradeImpactStatus&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareUpgradeImpactStatus
```
Above example returns the list of FirmwareUpgradeImpactStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareUpgradeImpactStatus -Name "MoName"
```
Above example returns the FirmwareUpgradeImpactStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareUpgradeImpactStatus -Organization $organization
```
Above example returns the list of FirmwareUpgradeImpactStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareUpgradeImpactStatus -InlineCount allpages
```
Above example returns the list of FirmwareUpgradeImpactStatus along with count.
...
### -Name
Specifies the name of the FirmwareUpgradeImpactStatus.
...
### -Organization
Specifies the organization, to fetch the FirmwareUpgradeImpactStatus under it.
