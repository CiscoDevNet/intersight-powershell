...
# Initialize-IntersightEquipmentChassisIdentity
...
Initialize-IntersightEquipmentChassisIdentity [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AdminAction< EquipmentChassisIdentity.AdminActionEnum>][-ClassId< EquipmentChassisIdentity.ClassIdEnum>][-Identifier< long>][-Moid< string>][-ObjectType< EquipmentChassisIdentity.ObjectTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: EquipmentChassisIdentity.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: EquipmentChassisIdentity.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightEquipmentChassisIdentity
```
