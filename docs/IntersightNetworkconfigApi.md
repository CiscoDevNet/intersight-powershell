# Intersight.Intersight/Api.IntersightNetworkconfigApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**New-IntersightNetworkconfigPolicy**](IntersightNetworkconfigApi.md#New-IntersightNetworkconfigPolicy) | **POST** /api/v1/networkconfig/Policies | Create a &#39;networkconfig.Policy&#39; resource.
[**Remove-IntersightNetworkconfigPolicy**](IntersightNetworkconfigApi.md#Remove-IntersightNetworkconfigPolicy) | **DELETE** /api/v1/networkconfig/Policies/{Moid} | Delete a &#39;networkconfig.Policy&#39; resource.
[**Get-IntersightNetworkconfigPolicyByMoid**](IntersightNetworkconfigApi.md#Get-IntersightNetworkconfigPolicyByMoid) | **GET** /api/v1/networkconfig/Policies/{Moid} | Read a &#39;networkconfig.Policy&#39; resource.
[**Get-IntersightNetworkconfigPolicyList**](IntersightNetworkconfigApi.md#Get-IntersightNetworkconfigPolicyList) | **GET** /api/v1/networkconfig/Policies | Read a &#39;networkconfig.Policy&#39; resource.
[**Set-IntersightNetworkconfigPolicy**](IntersightNetworkconfigApi.md#Set-IntersightNetworkconfigPolicy) | **PATCH** /api/v1/networkconfig/Policies/{Moid} | Update a &#39;networkconfig.Policy&#39; resource.
[**Update-IntersightNetworkconfigPolicy**](IntersightNetworkconfigApi.md#Update-IntersightNetworkconfigPolicy) | **POST** /api/v1/networkconfig/Policies/{Moid} | Update a &#39;networkconfig.Policy&#39; resource.


<a name="New-IntersightNetworkconfigPolicy"></a>
# **New-IntersightNetworkconfigPolicy**
> NetworkconfigPolicy New-IntersightNetworkconfigPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-NetworkconfigPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Create a 'networkconfig.Policy' resource.
try {
     $Result = New-IntersightNetworkconfigPolicy -NetworkconfigPolicy $NetworkconfigPolicy -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
    Write-Host ("Exception occured when calling New-IntersightNetworkconfigPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a name="Remove-IntersightNetworkconfigPolicy"></a>
# **Remove-IntersightNetworkconfigPolicy**
> void Remove-IntersightNetworkconfigPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'networkconfig.Policy' resource.
try {
     $Result = Remove-IntersightNetworkconfigPolicy -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightNetworkconfigPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightNetworkconfigPolicyByMoid"></a>
# **Get-IntersightNetworkconfigPolicyByMoid**
> NetworkconfigPolicy Get-IntersightNetworkconfigPolicyByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'networkconfig.Policy' resource.
try {
     $Result = Get-IntersightNetworkconfigPolicyByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightNetworkconfigPolicyByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightNetworkconfigPolicyList"></a>
# **Get-IntersightNetworkconfigPolicyList**
> NetworkconfigPolicyResponse Get-IntersightNetworkconfigPolicyList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'networkconfig.Policy' resource.
try {
     $Result = Get-IntersightNetworkconfigPolicyList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightNetworkconfigPolicyList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightNetworkconfigPolicy"></a>
# **Set-IntersightNetworkconfigPolicy**
> NetworkconfigPolicy Set-IntersightNetworkconfigPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-NetworkconfigPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$NetworkconfigPolicy = (Initialize-networkconfig.Policy-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -AlternateIpv4dnsServer "AlternateIpv4dnsServer_example" -AlternateIpv6dnsServer "AlternateIpv6dnsServer_example" -DynamicDnsDomain "DynamicDnsDomain_example" -EnableDynamicDns $false -EnableIpv4dnsFromDhcp $false -EnableIpv6 $false -EnableIpv6dnsFromDhcp $false -PreferredIpv4dnsServer "PreferredIpv4dnsServer_example" -PreferredIpv6dnsServer "PreferredIpv6dnsServer_example" -ApplianceAccount  -Organization  -Profiles @()) # NetworkconfigPolicy | The 'networkconfig.Policy' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'networkconfig.Policy' resource.
try {
     $Result = Set-IntersightNetworkconfigPolicy -Moid $Moid -NetworkconfigPolicy $NetworkconfigPolicy -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightNetworkconfigPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightNetworkconfigPolicy"></a>
# **Update-IntersightNetworkconfigPolicy**
> NetworkconfigPolicy Update-IntersightNetworkconfigPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-NetworkconfigPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'networkconfig.Policy' resource.
try {
     $Result = Update-IntersightNetworkconfigPolicy -Moid $Moid -NetworkconfigPolicy $NetworkconfigPolicy -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightNetworkconfigPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
