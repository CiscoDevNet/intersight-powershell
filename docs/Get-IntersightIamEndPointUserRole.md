...
# Get-IntersightIamEndPointUserRole

## SYNOPSIS
Get the IamEndPointUserRole

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamEndPointUserRole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamEndPointUserRole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamEndPointUserRole&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserRole
```
Above example returns the list of IamEndPointUserRole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserRole -Name "MoName"
```
Above example returns the IamEndPointUserRole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserRole -Organization $organization
```
Above example returns the list of IamEndPointUserRole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserRole -InlineCount allpages
```
Above example returns the list of IamEndPointUserRole along with count.
...
### -Name
Specifies the name of the IamEndPointUserRole.
...
### -Organization
Specifies the organization, to fetch the IamEndPointUserRole under it.
