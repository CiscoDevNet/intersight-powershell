...
```powershell
$StoragePureSnapshotScheduleResponse = Initialize-IntersightStoragePureSnapshotScheduleResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StoragePureSnapshotScheduleResponse | ConvertTo-JSON
```
