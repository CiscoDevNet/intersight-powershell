...
## SYNOPSIS
Get the HyperflexClusterNetworkPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexClusterNetworkPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexClusterNetworkPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterNetworkPolicy
```
Above example returns the list of HyperflexClusterNetworkPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterNetworkPolicy -Name "MoName"
```
Above example returns the HyperflexClusterNetworkPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterNetworkPolicy -Organization $organization
```
Above example returns the list of HyperflexClusterNetworkPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterNetworkPolicy -InlineCount allpages
```
Above example returns the list of HyperflexClusterNetworkPolicy along with count.
...
### -Name
Specifies the name of the HyperflexClusterNetworkPolicy.
...
### -Organization
Specifies the organization, to fetch the HyperflexClusterNetworkPolicy under it.
