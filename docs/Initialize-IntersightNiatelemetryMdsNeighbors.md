...
# Initialize-IntersightNiatelemetryMdsNeighbors
...
Initialize-IntersightNiatelemetryMdsNeighbors [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< NiatelemetryMdsNeighbors.ClassIdEnum>][-DeviceIp< string>][-DeviceName< string>][-DeviceWwn< string>][-Moid< string>][-NeighborInfo< System.Collections.Generic.List`1[Model.NiatelemetryMdsNeighborInfo]>][-ObjectType< NiatelemetryMdsNeighbors.ObjectTypeEnum>][-RecordType< string>][-RecordVersion< string>][-Serial< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: NiatelemetryMdsNeighbors.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: NiatelemetryMdsNeighbors.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightNiatelemetryMdsNeighbors
```
