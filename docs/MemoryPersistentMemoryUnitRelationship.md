...
```powershell
$MemoryPersistentMemoryUnitRelationship = Initialize-IntersightMemoryPersistentMemoryUnitRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$MemoryPersistentMemoryUnitRelationship | ConvertTo-JSON
```
