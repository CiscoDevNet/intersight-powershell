...
# Get-IntersightApplianceDeviceState

## SYNOPSIS
Get the ApplianceDeviceState

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceDeviceState [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceDeviceState [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceDeviceState&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceState
```
Above example returns the list of ApplianceDeviceState.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceState -Name "MoName"
```
Above example returns the ApplianceDeviceState matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceState -Organization $organization
```
Above example returns the list of ApplianceDeviceState available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceState -InlineCount allpages
```
Above example returns the list of ApplianceDeviceState along with count.
...
### -Name
Specifies the name of the ApplianceDeviceState.
...
### -Organization
Specifies the organization, to fetch the ApplianceDeviceState under it.
