...
```powershell
$HyperflexConfigResultEntryRelationship = Initialize-IntersightHyperflexConfigResultEntryRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexConfigResultEntryRelationship | ConvertTo-JSON
```
