...
```powershell
$StorageFlexFlashControllerResponse = Initialize-IntersightStorageFlexFlashControllerResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageFlexFlashControllerResponse | ConvertTo-JSON
```
