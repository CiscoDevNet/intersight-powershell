...
## SYNOPSIS
Get the FirmwareRunningFirmware

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareRunningFirmware [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareRunningFirmware [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareRunningFirmware&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareRunningFirmware
```
Above example returns the list of FirmwareRunningFirmware.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareRunningFirmware -Name "MoName"
```
Above example returns the FirmwareRunningFirmware matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareRunningFirmware -Organization $organization
```
Above example returns the list of FirmwareRunningFirmware available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareRunningFirmware -InlineCount allpages
```
Above example returns the list of FirmwareRunningFirmware along with count.
...
### -Name
Specifies the name of the FirmwareRunningFirmware.
...
### -Organization
Specifies the organization, to fetch the FirmwareRunningFirmware under it.
...
[Set-IntersightFirmwareRunningFirmware](./Set-IntersightFirmwareRunningFirmware.md)
