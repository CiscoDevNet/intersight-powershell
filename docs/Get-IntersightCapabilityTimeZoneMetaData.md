...
# Get-IntersightCapabilityTimeZoneMetaData

## SYNOPSIS
Get the CapabilityTimeZoneMetaData

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityTimeZoneMetaData [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityTimeZoneMetaData [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilityTimeZoneMetaData&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityTimeZoneMetaData
```
Above example returns the list of CapabilityTimeZoneMetaData.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityTimeZoneMetaData -Name "MoName"
```
Above example returns the CapabilityTimeZoneMetaData matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityTimeZoneMetaData -Organization $organization
```
Above example returns the list of CapabilityTimeZoneMetaData available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityTimeZoneMetaData -InlineCount allpages
```
Above example returns the list of CapabilityTimeZoneMetaData along with count.
...
### -Name
Specifies the name of the CapabilityTimeZoneMetaData.
...
### -Organization
Specifies the organization, to fetch the CapabilityTimeZoneMetaData under it.
