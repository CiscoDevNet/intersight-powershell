...
# Set-IntersightMgmtConfigBackupInstance
...
Set-IntersightMgmtConfigBackupInstance [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AdminAction< MgmtConfigBackupInstance.AdminActionEnum>][-Description< string>][[-Moid]< string>][-RetentionLock< bool>][-Tags< System.Collections.Generic.List`1[MoTag]>][-UserPassword< string>][-UserPublicKey< string>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;MgmtConfigBackupInstance&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightMgmtConfigBackupInstance
```
