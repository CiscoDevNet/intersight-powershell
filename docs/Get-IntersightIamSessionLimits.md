...
# Get-IntersightIamSessionLimits

## SYNOPSIS
Get the IamSessionLimits

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamSessionLimits [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamSessionLimits [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamSessionLimits
```
Above example returns the list of IamSessionLimits.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamSessionLimits -Name "MoName"
```
Above example returns the IamSessionLimits matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamSessionLimits -Organization $organization
```
Above example returns the list of IamSessionLimits available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamSessionLimits -InlineCount allpages
```
Above example returns the list of IamSessionLimits along with count.
...
### -Name
Specifies the name of the IamSessionLimits.
...
### -Organization
Specifies the organization, to fetch the IamSessionLimits under it.
