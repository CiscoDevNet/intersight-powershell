...
### CmdletParam (Default)
```
Get-IntersightStorageNetAppDiskEvent [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppDiskEvent [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageNetAppDiskEvent&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppDiskEvent
```
Above example returns the list of StorageNetAppDiskEvent.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppDiskEvent -Name "MoName"
```
Above example returns the StorageNetAppDiskEvent matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppDiskEvent -Organization $organization
```
Above example returns the list of StorageNetAppDiskEvent available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppDiskEvent -InlineCount allpages
```
Above example returns the list of StorageNetAppDiskEvent along with count.
...
### -Name
Specifies the name of the StorageNetAppDiskEvent.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppDiskEvent under it.
