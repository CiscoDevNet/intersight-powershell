...
# Initialize-IntersightNetworkconfigPolicy
...
Initialize-IntersightNetworkconfigPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AlternateIpv4dnsServer< string>][-AlternateIpv6dnsServer< string>][-ApplianceAccount< Model.IamAccountRelationship>][-ClassId< NetworkconfigPolicy.ClassIdEnum>][-Description< string>][-DynamicDnsDomain< string>][-EnableDynamicDns< bool>][-EnableIpv4dnsFromDhcp< bool>][-EnableIpv6< bool>][-EnableIpv6dnsFromDhcp< bool>][-Moid< string>][-Name< string>][-ObjectType< NetworkconfigPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-PreferredIpv4dnsServer< string>][-PreferredIpv6dnsServer< string>][-Profiles< System.Collections.Generic.List`1[Model.PolicyAbstractConfigProfileRelationship]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: NetworkconfigPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: NetworkconfigPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightNetworkconfigPolicy
```
