...
# Get-IntersightWorkloadWorkloadInstance

## SYNOPSIS
Get the WorkloadWorkloadInstance

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkloadWorkloadInstance [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkloadWorkloadInstance [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkloadWorkloadInstance&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadInstance
```
Above example returns the list of WorkloadWorkloadInstance.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadInstance -Name "MoName"
```
Above example returns the WorkloadWorkloadInstance matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadInstance -Organization $organization
```
Above example returns the list of WorkloadWorkloadInstance available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadInstance -InlineCount allpages
```
Above example returns the list of WorkloadWorkloadInstance along with count.
...
### -Name
Specifies the name of the WorkloadWorkloadInstance.
...
### -Organization
Specifies the organization, to fetch the WorkloadWorkloadInstance under it.
