...
## SYNOPSIS
Get the ComputeRackUnitIdentity

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputeRackUnitIdentity [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputeRackUnitIdentity [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ComputeRackUnitIdentity&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputeRackUnitIdentity
```
Above example returns the list of ComputeRackUnitIdentity.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputeRackUnitIdentity -Name "MoName"
```
Above example returns the ComputeRackUnitIdentity matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputeRackUnitIdentity -Organization $organization
```
Above example returns the list of ComputeRackUnitIdentity available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputeRackUnitIdentity -InlineCount allpages
```
Above example returns the list of ComputeRackUnitIdentity along with count.
...
### -Name
Specifies the name of the ComputeRackUnitIdentity.
...
### -Organization
Specifies the organization, to fetch the ComputeRackUnitIdentity under it.
