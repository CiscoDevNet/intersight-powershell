...
```powershell
$SoftwarerepositoryCategorySupportConstraintResponse = Initialize-IntersightSoftwarerepositoryCategorySupportConstraintResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwarerepositoryCategorySupportConstraintResponse | ConvertTo-JSON
```
