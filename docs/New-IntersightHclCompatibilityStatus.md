...
New-IntersightHclCompatibilityStatus [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Moid< string>][-ProfileList< System.Collections.Generic.List`1[HclHardwareCompatibilityProfile]>][-RequestType< HclCompatibilityStatus.RequestTypeEnum>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
