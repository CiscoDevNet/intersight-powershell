...
New-IntersightHyperflexClusterBackupPolicyDeployment [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-BackupTarget< HyperflexClusterRelationship>][-Discovered< bool>][-Moid< string>][-Organization< OrganizationOrganizationRelationship>][-SourceCluster< HyperflexClusterRelationship>][-SourceDetached< bool>][-Tags< System.Collections.Generic.List`1[MoTag]>][-TargetDetached< bool>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> New-IntersightHyperflexClusterBackupPolicyDeployment
```
