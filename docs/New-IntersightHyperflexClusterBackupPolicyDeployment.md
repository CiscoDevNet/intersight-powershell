...
New-IntersightHyperflexClusterBackupPolicyDeployment [-AdditionalProperties< Dictionary<string,object>>][-BackupTarget< HyperflexClusterRelationship>][-Discovered< bool>][-Moid< string>][-Organization< OrganizationOrganizationRelationship>][-SourceCluster< HyperflexClusterRelationship>][-SourceDetached< bool>][-Tags< List<MoTag>>][-TargetDetached< bool>]
