...
## SYNOPSIS
Get the AdapterExtEthInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAdapterExtEthInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAdapterExtEthInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAdapterExtEthInterface
```
Above example returns the list of AdapterExtEthInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAdapterExtEthInterface -Name "MoName"
```
Above example returns the AdapterExtEthInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAdapterExtEthInterface -Organization $organization
```
Above example returns the list of AdapterExtEthInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAdapterExtEthInterface -InlineCount allpages
```
Above example returns the list of AdapterExtEthInterface along with count.
...
### -Name
Specifies the name of the AdapterExtEthInterface.
...
### -Organization
Specifies the organization, to fetch the AdapterExtEthInterface under it.
