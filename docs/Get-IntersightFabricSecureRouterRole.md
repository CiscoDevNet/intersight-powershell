...
# Get-IntersightFabricSecureRouterRole

## SYNOPSIS
Get the FabricSecureRouterRole

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricSecureRouterRole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricSecureRouterRole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricSecureRouterRole&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricSecureRouterRole
```
Above example returns the list of FabricSecureRouterRole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricSecureRouterRole -Name "MoName"
```
Above example returns the FabricSecureRouterRole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricSecureRouterRole -Organization $organization
```
Above example returns the list of FabricSecureRouterRole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricSecureRouterRole -InlineCount allpages
```
Above example returns the list of FabricSecureRouterRole along with count.
...
### -Name
Specifies the name of the FabricSecureRouterRole.
...
### -Organization
Specifies the organization, to fetch the FabricSecureRouterRole under it.
...
[New-IntersightFabricSecureRouterRole](./New-IntersightFabricSecureRouterRole.md)

[Remove-IntersightFabricSecureRouterRole](./Remove-IntersightFabricSecureRouterRole.md)

[Set-IntersightFabricSecureRouterRole](./Set-IntersightFabricSecureRouterRole.md)
