...
# Get-IntersightVnicEthNetworkPolicy

## SYNOPSIS
Get the VnicEthNetworkPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicEthNetworkPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicEthNetworkPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicEthNetworkPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicEthNetworkPolicy
```
Above example returns the list of VnicEthNetworkPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicEthNetworkPolicy -Name "MoName"
```
Above example returns the VnicEthNetworkPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicEthNetworkPolicy -Organization $organization
```
Above example returns the list of VnicEthNetworkPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicEthNetworkPolicy -InlineCount allpages
```
Above example returns the list of VnicEthNetworkPolicy along with count.
...
### -Name
Specifies the name of the VnicEthNetworkPolicy.
...
### -Organization
Specifies the organization, to fetch the VnicEthNetworkPolicy under it.
