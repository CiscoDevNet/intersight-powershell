...
### CmdletParam (Default)
```
Get-IntersightNiaapiNdMetadataFileDownloader [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiNdMetadataFileDownloader [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
