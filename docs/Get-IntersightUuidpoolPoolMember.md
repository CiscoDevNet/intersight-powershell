...
# Get-IntersightUuidpoolPoolMember

## SYNOPSIS
Get the UuidpoolPoolMember

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightUuidpoolPoolMember [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightUuidpoolPoolMember [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightUuidpoolPoolMember
```
Above example returns the list of UuidpoolPoolMember.

### Example 2
```powershell
PS C:\> $result = Get-IntersightUuidpoolPoolMember -Name "MoName"
```
Above example returns the UuidpoolPoolMember matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightUuidpoolPoolMember -Organization $organization
```
Above example returns the list of UuidpoolPoolMember available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightUuidpoolPoolMember -InlineCount allpages
```
Above example returns the list of UuidpoolPoolMember along with count.
...
### -Name
Specifies the name of the UuidpoolPoolMember.
...
### -Organization
Specifies the organization, to fetch the UuidpoolPoolMember under it.
