...
## SYNOPSIS
Get the KubernetesConfigResultEntry

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesConfigResultEntry [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesConfigResultEntry [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KubernetesConfigResultEntry&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesConfigResultEntry
```
Above example returns the list of KubernetesConfigResultEntry.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesConfigResultEntry -Name "MoName"
```
Above example returns the KubernetesConfigResultEntry matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesConfigResultEntry -Organization $organization
```
Above example returns the list of KubernetesConfigResultEntry available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesConfigResultEntry -InlineCount allpages
```
Above example returns the list of KubernetesConfigResultEntry along with count.
...
### -Name
Specifies the name of the KubernetesConfigResultEntry.
...
### -Organization
Specifies the organization, to fetch the KubernetesConfigResultEntry under it.
