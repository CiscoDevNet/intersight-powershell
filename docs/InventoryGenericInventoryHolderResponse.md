...
```powershell
$InventoryGenericInventoryHolderResponse = Initialize-IntersightInventoryGenericInventoryHolderResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$InventoryGenericInventoryHolderResponse | ConvertTo-JSON
```
