...
# Get-IntersightDnacTemplate

## SYNOPSIS
Get the DnacTemplate

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightDnacTemplate [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightDnacTemplate [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;DnacTemplate&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightDnacTemplate
```
Above example returns the list of DnacTemplate.

### Example 2
```powershell
PS C:\> $result = Get-IntersightDnacTemplate -Name "MoName"
```
Above example returns the DnacTemplate matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightDnacTemplate -Organization $organization
```
Above example returns the list of DnacTemplate available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightDnacTemplate -InlineCount allpages
```
Above example returns the list of DnacTemplate along with count.
...
### -Name
Specifies the name of the DnacTemplate.
...
### -Organization
Specifies the organization, to fetch the DnacTemplate under it.
