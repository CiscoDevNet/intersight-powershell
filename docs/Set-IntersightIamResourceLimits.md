...
# Set-IntersightIamResourceLimits
...
Set-IntersightIamResourceLimits [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AllowApiKeysWithoutExpiry< bool>][-AllowAppRegistrationsWithoutExpiry< bool>][-MaxApiKeyExpiry< long>][-MaxAppRegistrationExpiry< long>][[-Moid]< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;IamResourceLimits&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightIamResourceLimits
```
...
[Get-IntersightIamResourceLimits](./Get-IntersightIamResourceLimits.md)
