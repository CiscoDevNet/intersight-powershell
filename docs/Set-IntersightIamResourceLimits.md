...
Set-IntersightIamResourceLimits [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AllowApiKeysWithoutExpiry< bool>][-AllowAppRegistrationsWithoutExpiry< bool>][-MaxApiKeyExpiry< long>][-MaxAppRegistrationExpiry< long>][[-Moid]< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
