...
## SYNOPSIS
Get the IamSecurityHolder

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamSecurityHolder [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamSecurityHolder [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamSecurityHolder&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamSecurityHolder
```
Above example returns the list of IamSecurityHolder.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamSecurityHolder -Name "MoName"
```
Above example returns the IamSecurityHolder matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamSecurityHolder -Organization $organization
```
Above example returns the list of IamSecurityHolder available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamSecurityHolder -InlineCount allpages
```
Above example returns the list of IamSecurityHolder along with count.
...
### -Name
Specifies the name of the IamSecurityHolder.
...
### -Organization
Specifies the organization, to fetch the IamSecurityHolder under it.
