...
## SYNOPSIS
Get the EquipmentIoExpander

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentIoExpander [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentIoExpander [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentIoExpander&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentIoExpander
```
Above example returns the list of EquipmentIoExpander.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentIoExpander -Name "MoName"
```
Above example returns the EquipmentIoExpander matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentIoExpander -Organization $organization
```
Above example returns the list of EquipmentIoExpander available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentIoExpander -InlineCount allpages
```
Above example returns the list of EquipmentIoExpander along with count.
...
### -Name
Specifies the name of the EquipmentIoExpander.
...
### -Organization
Specifies the organization, to fetch the EquipmentIoExpander under it.
...
[Set-IntersightEquipmentIoExpander](./Set-IntersightEquipmentIoExpander.md)
