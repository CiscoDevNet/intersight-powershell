...
## SYNOPSIS
Get the KubernetesVersionPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesVersionPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesVersionPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KubernetesVersionPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesVersionPolicy
```
Above example returns the list of KubernetesVersionPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesVersionPolicy -Name "MoName"
```
Above example returns the KubernetesVersionPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesVersionPolicy -Organization $organization
```
Above example returns the list of KubernetesVersionPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesVersionPolicy -InlineCount allpages
```
Above example returns the list of KubernetesVersionPolicy along with count.
...
### -Name
Specifies the name of the KubernetesVersionPolicy.
...
### -Organization
Specifies the organization, to fetch the KubernetesVersionPolicy under it.
