...
## SYNOPSIS
Get the ComputeServerPowerPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputeServerPowerPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputeServerPowerPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ComputeServerPowerPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputeServerPowerPolicy
```
Above example returns the list of ComputeServerPowerPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputeServerPowerPolicy -Name "MoName"
```
Above example returns the ComputeServerPowerPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputeServerPowerPolicy -Organization $organization
```
Above example returns the list of ComputeServerPowerPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputeServerPowerPolicy -InlineCount allpages
```
Above example returns the list of ComputeServerPowerPolicy along with count.
...
### -Name
Specifies the name of the ComputeServerPowerPolicy.
...
### -Organization
Specifies the organization, to fetch the ComputeServerPowerPolicy under it.
