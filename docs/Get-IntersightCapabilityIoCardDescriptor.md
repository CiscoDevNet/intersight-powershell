...
### CmdletParam (Default)
```
Get-IntersightCapabilityIoCardDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityIoCardDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityIoCardDescriptor
```
Above example returns the list of CapabilityIoCardDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityIoCardDescriptor -Name "MoName"
```
Above example returns the CapabilityIoCardDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityIoCardDescriptor -Organization $organization
```
Above example returns the list of CapabilityIoCardDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityIoCardDescriptor -InlineCount allpages
```
Above example returns the list of CapabilityIoCardDescriptor along with count.
...
### -Name
Specifies the name of the CapabilityIoCardDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilityIoCardDescriptor under it.
