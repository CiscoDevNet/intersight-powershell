...
**Version** | **String** | The HyperFlex Data Platform version. | [optional] 
...
```powershell
$HyperflexHxdpVersionRelationship = Initialize-IntersightHyperflexHxdpVersionRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexHxdpVersionRelationship | ConvertTo-JSON
```
