...
# Get-IntersightIamSharingRule

## SYNOPSIS
Get the IamSharingRule

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamSharingRule [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamSharingRule [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamSharingRule&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamSharingRule
```
Above example returns the list of IamSharingRule.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamSharingRule -Name "MoName"
```
Above example returns the IamSharingRule matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamSharingRule -Organization $organization
```
Above example returns the list of IamSharingRule available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamSharingRule -InlineCount allpages
```
Above example returns the list of IamSharingRule along with count.
...
### -Name
Specifies the name of the IamSharingRule.
...
### -Organization
Specifies the organization, to fetch the IamSharingRule under it.
