...
## SYNOPSIS
Get the StorageNetAppIpInterfaceEvent

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppIpInterfaceEvent [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppIpInterfaceEvent [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppIpInterfaceEvent&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppIpInterfaceEvent
```
Above example returns the list of StorageNetAppIpInterfaceEvent.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppIpInterfaceEvent -Name "MoName"
```
Above example returns the StorageNetAppIpInterfaceEvent matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppIpInterfaceEvent -Organization $organization
```
Above example returns the list of StorageNetAppIpInterfaceEvent available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppIpInterfaceEvent -InlineCount allpages
```
Above example returns the list of StorageNetAppIpInterfaceEvent along with count.
...
### -Name
Specifies the name of the StorageNetAppIpInterfaceEvent.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppIpInterfaceEvent under it.
