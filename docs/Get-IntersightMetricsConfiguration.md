...
# Get-IntersightMetricsConfiguration

## SYNOPSIS
Get the MetricsConfiguration

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMetricsConfiguration [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMetricsConfiguration [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MetricsConfiguration&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMetricsConfiguration
```
Above example returns the list of MetricsConfiguration.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMetricsConfiguration -Name "MoName"
```
Above example returns the MetricsConfiguration matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMetricsConfiguration -Organization $organization
```
Above example returns the list of MetricsConfiguration available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMetricsConfiguration -InlineCount allpages
```
Above example returns the list of MetricsConfiguration along with count.
...
### -Name
Specifies the name of the MetricsConfiguration.
...
### -Organization
Specifies the organization, to fetch the MetricsConfiguration under it.
...
[Set-IntersightMetricsConfiguration](./Set-IntersightMetricsConfiguration.md)
