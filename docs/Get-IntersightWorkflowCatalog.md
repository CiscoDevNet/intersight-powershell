...
## SYNOPSIS
Get the WorkflowCatalog

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowCatalog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowCatalog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowCatalog&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowCatalog
```
Above example returns the list of WorkflowCatalog.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowCatalog -Name "MoName"
```
Above example returns the WorkflowCatalog matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowCatalog -Organization $organization
```
Above example returns the list of WorkflowCatalog available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowCatalog -InlineCount allpages
```
Above example returns the list of WorkflowCatalog along with count.
...
### -Name
Specifies the name of the WorkflowCatalog.
...
### -Organization
Specifies the organization, to fetch the WorkflowCatalog under it.
