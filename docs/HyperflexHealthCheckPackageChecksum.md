...
```powershell
$HyperflexHealthCheckPackageChecksum = Initialize-IntersightHyperflexHealthCheckPackageChecksum  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$HyperflexHealthCheckPackageChecksum | ConvertTo-JSON
```
