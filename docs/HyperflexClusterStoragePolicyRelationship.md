...
```powershell
$HyperflexClusterStoragePolicyRelationship = Initialize-IntersightHyperflexClusterStoragePolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$HyperflexClusterStoragePolicyRelationship | ConvertTo-JSON
```
