...
### CmdletParam (Default)
```
Get-IntersightDnacTransit [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightDnacTransit [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;DnacTransit&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightDnacTransit
```
Above example returns the list of DnacTransit.

### Example 2
```powershell
PS C:\> $result = Get-IntersightDnacTransit -Name "MoName"
```
Above example returns the DnacTransit matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightDnacTransit -Organization $organization
```
Above example returns the list of DnacTransit available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightDnacTransit -InlineCount allpages
```
Above example returns the list of DnacTransit along with count.
...
### -Name
Specifies the name of the DnacTransit.
...
### -Organization
Specifies the organization, to fetch the DnacTransit under it.
