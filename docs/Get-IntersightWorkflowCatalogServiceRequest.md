...
# Get-IntersightWorkflowCatalogServiceRequest

## SYNOPSIS
Get the WorkflowCatalogServiceRequest

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowCatalogServiceRequest [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowCatalogServiceRequest [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowCatalogServiceRequest&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowCatalogServiceRequest
```
Above example returns the list of WorkflowCatalogServiceRequest.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowCatalogServiceRequest -Name "MoName"
```
Above example returns the WorkflowCatalogServiceRequest matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowCatalogServiceRequest -Organization $organization
```
Above example returns the list of WorkflowCatalogServiceRequest available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowCatalogServiceRequest -InlineCount allpages
```
Above example returns the list of WorkflowCatalogServiceRequest along with count.
...
### -Name
Specifies the name of the WorkflowCatalogServiceRequest.
...
### -Organization
Specifies the organization, to fetch the WorkflowCatalogServiceRequest under it.
