...
[**Get-IntersightKvmVmConsoleByMoid**](IntersightKvmApi.md#Get-IntersightKvmVmConsoleByMoid) | **GET** /api/v1/kvm/VmConsoles/{Moid} | Read a &#39;kvm.VmConsole&#39; resource.
[**Get-IntersightKvmVmConsoleList**](IntersightKvmApi.md#Get-IntersightKvmVmConsoleList) | **GET** /api/v1/kvm/VmConsoles | Read a &#39;kvm.VmConsole&#39; resource.
...
# Create a 'kvm.Policy' resource.
try {
     $Result = New-IntersightKvmPolicy -KvmPolicy $KvmPolicy -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
...
# Delete a 'kvm.Policy' resource.
try {
     $Result = Remove-IntersightKvmPolicy -Moid $Moid
} catch {
...
# Read a 'kvm.KvmSession' resource.
try {
     $Result = Get-IntersightKvmKvmSessionByMoid -Moid $Moid
} catch {
...
# Read a 'kvm.KvmSession' resource.
try {
     $Result = Get-IntersightKvmKvmSessionList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'kvm.Policy' resource.
try {
     $Result = Get-IntersightKvmPolicyByMoid -Moid $Moid
} catch {
...
# Read a 'kvm.Policy' resource.
try {
     $Result = Get-IntersightKvmPolicyList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
<a name="Get-IntersightKvmVmConsoleByMoid"></a>
# **Get-IntersightKvmVmConsoleByMoid**
> KvmVmConsole Get-IntersightKvmVmConsoleByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'kvm.VmConsole' resource.
try {
     $Result = Get-IntersightKvmVmConsoleByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightKvmVmConsoleByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightKvmVmConsoleList"></a>
# **Get-IntersightKvmVmConsoleList**
> KvmVmConsoleResponse Get-IntersightKvmVmConsoleList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'kvm.VmConsole' resource.
try {
     $Result = Get-IntersightKvmVmConsoleList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightKvmVmConsoleList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$KvmPolicy = (Initialize-kvm.Policy-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -EnableLocalServerVideo $false -EnableVideoEncryption $false -Enabled $false -MaximumSessions 123 -RemotePort 123 -Organization  -Profiles @()) # KvmPolicy | The 'kvm.Policy' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'kvm.Policy' resource.
try {
     $Result = Set-IntersightKvmPolicy -Moid $Moid -KvmPolicy $KvmPolicy -IfMatch $IfMatch
} catch {
...
# Update a 'kvm.Policy' resource.
try {
     $Result = Update-IntersightKvmPolicy -Moid $Moid -KvmPolicy $KvmPolicy -IfMatch $IfMatch
} catch {
