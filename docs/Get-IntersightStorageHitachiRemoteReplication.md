...
# Get-IntersightStorageHitachiRemoteReplication

## SYNOPSIS
Get the StorageHitachiRemoteReplication

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiRemoteReplication [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiRemoteReplication [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiRemoteReplication&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteReplication
```
Above example returns the list of StorageHitachiRemoteReplication.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteReplication -Name "MoName"
```
Above example returns the StorageHitachiRemoteReplication matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteReplication -Organization $organization
```
Above example returns the list of StorageHitachiRemoteReplication available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteReplication -InlineCount allpages
```
Above example returns the list of StorageHitachiRemoteReplication along with count.
...
### -Name
Specifies the name of the StorageHitachiRemoteReplication.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiRemoteReplication under it.
