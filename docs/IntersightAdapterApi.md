...
# Create a 'adapter.ConfigPolicy' resource.
try {
     $Result = New-IntersightAdapterConfigPolicy -AdapterConfigPolicy $AdapterConfigPolicy -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
...
# Delete a 'adapter.ConfigPolicy' resource.
try {
     $Result = Remove-IntersightAdapterConfigPolicy -Moid $Moid
} catch {
...
# Read a 'adapter.ConfigPolicy' resource.
try {
     $Result = Get-IntersightAdapterConfigPolicyByMoid -Moid $Moid
} catch {
...
# Read a 'adapter.ConfigPolicy' resource.
try {
     $Result = Get-IntersightAdapterConfigPolicyList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'adapter.ExtEthInterface' resource.
try {
     $Result = Get-IntersightAdapterExtEthInterfaceByMoid -Moid $Moid
} catch {
...
# Read a 'adapter.ExtEthInterface' resource.
try {
     $Result = Get-IntersightAdapterExtEthInterfaceList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'adapter.HostEthInterface' resource.
try {
     $Result = Get-IntersightAdapterHostEthInterfaceByMoid -Moid $Moid
} catch {
...
# Read a 'adapter.HostEthInterface' resource.
try {
     $Result = Get-IntersightAdapterHostEthInterfaceList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'adapter.HostFcInterface' resource.
try {
     $Result = Get-IntersightAdapterHostFcInterfaceByMoid -Moid $Moid
} catch {
...
# Read a 'adapter.HostFcInterface' resource.
try {
     $Result = Get-IntersightAdapterHostFcInterfaceList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'adapter.HostIscsiInterface' resource.
try {
     $Result = Get-IntersightAdapterHostIscsiInterfaceByMoid -Moid $Moid
} catch {
...
# Read a 'adapter.HostIscsiInterface' resource.
try {
     $Result = Get-IntersightAdapterHostIscsiInterfaceList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'adapter.Unit' resource.
try {
     $Result = Get-IntersightAdapterUnitByMoid -Moid $Moid
} catch {
...
# Read a 'adapter.Unit' resource.
try {
     $Result = Get-IntersightAdapterUnitList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$AdapterConfigPolicy = (Initialize-adapter.ConfigPolicy-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -Settings @((Initialize-adapter.AdapterConfig-ClassId "ClassId_example" -ObjectType "ObjectType_example" -DceInterfaceSettings @((Initialize-adapter.DceInterfaceSettings-ClassId "ClassId_example" -ObjectType "ObjectType_example" -FecMode "FecMode_example" -InterfaceId 123)) -EthSettings (Initialize-adapter.EthSettings-ClassId "ClassId_example" -ObjectType "ObjectType_example" -LldpEnabled $false) -FcSettings (Initialize-adapter.FcSettings-ClassId "ClassId_example" -ObjectType "ObjectType_example" -FipEnabled $false) -PortChannelSettings (Initialize-adapter.PortChannelSettings-ClassId "ClassId_example" -ObjectType "ObjectType_example" -Enabled $false) -SlotId "SlotId_example")) -Organization  -Profiles @()) # AdapterConfigPolicy | The 'adapter.ConfigPolicy' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'adapter.ConfigPolicy' resource.
try {
     $Result = Set-IntersightAdapterConfigPolicy -Moid $Moid -AdapterConfigPolicy $AdapterConfigPolicy -IfMatch $IfMatch
} catch {
...
# Update a 'adapter.ConfigPolicy' resource.
try {
     $Result = Update-IntersightAdapterConfigPolicy -Moid $Moid -AdapterConfigPolicy $AdapterConfigPolicy -IfMatch $IfMatch
} catch {
