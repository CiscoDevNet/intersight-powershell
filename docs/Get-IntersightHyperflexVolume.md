...
## SYNOPSIS
Get the HyperflexVolume

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexVolume [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexVolume [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;HyperflexVolume&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexVolume
```
Above example returns the list of HyperflexVolume.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexVolume -Name "MoName"
```
Above example returns the HyperflexVolume matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexVolume -Organization $organization
```
Above example returns the list of HyperflexVolume available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexVolume -InlineCount allpages
```
Above example returns the list of HyperflexVolume along with count.
...
### -Name
Specifies the name of the HyperflexVolume.
...
### -Organization
Specifies the organization, to fetch the HyperflexVolume under it.
...
[Set-IntersightHyperflexVolume](./Set-IntersightHyperflexVolume.md)
