...
# Get-IntersightWorkloadBlueprint

## SYNOPSIS
Get the WorkloadBlueprint

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkloadBlueprint [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkloadBlueprint [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkloadBlueprint&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkloadBlueprint
```
Above example returns the list of WorkloadBlueprint.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkloadBlueprint -Name "MoName"
```
Above example returns the WorkloadBlueprint matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkloadBlueprint -Organization $organization
```
Above example returns the list of WorkloadBlueprint available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkloadBlueprint -InlineCount allpages
```
Above example returns the list of WorkloadBlueprint along with count.
...
### -Name
Specifies the name of the WorkloadBlueprint.
...
### -Organization
Specifies the organization, to fetch the WorkloadBlueprint under it.
