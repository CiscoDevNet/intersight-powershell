...
```powershell
$StoragePureProtectionGroupResponse = Initialize-IntersightStoragePureProtectionGroupResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StoragePureProtectionGroupResponse | ConvertTo-JSON
```
