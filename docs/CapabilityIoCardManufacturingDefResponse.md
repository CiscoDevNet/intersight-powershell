...
```powershell
$CapabilityIoCardManufacturingDefResponse = Initialize-IntersightCapabilityIoCardManufacturingDefResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilityIoCardManufacturingDefResponse | ConvertTo-JSON
```
