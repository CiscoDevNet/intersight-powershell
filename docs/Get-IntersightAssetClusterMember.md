...
# Get-IntersightAssetClusterMember

## SYNOPSIS
Get the AssetClusterMember

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAssetClusterMember [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAssetClusterMember [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;AssetClusterMember&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAssetClusterMember
```
Above example returns the list of AssetClusterMember.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAssetClusterMember -Name "MoName"
```
Above example returns the AssetClusterMember matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAssetClusterMember -Organization $organization
```
Above example returns the list of AssetClusterMember available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAssetClusterMember -InlineCount allpages
```
Above example returns the list of AssetClusterMember along with count.
...
### -Name
Specifies the name of the AssetClusterMember.
...
### -Organization
Specifies the organization, to fetch the AssetClusterMember under it.
...
[Remove-IntersightAssetClusterMember](./Remove-IntersightAssetClusterMember.md)
