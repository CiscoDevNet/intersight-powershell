...
# Get-IntersightNetworkLicenseFile

## SYNOPSIS
Get the NetworkLicenseFile

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkLicenseFile [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkLicenseFile [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NetworkLicenseFile&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkLicenseFile
```
Above example returns the list of NetworkLicenseFile.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkLicenseFile -Name "MoName"
```
Above example returns the NetworkLicenseFile matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkLicenseFile -Organization $organization
```
Above example returns the list of NetworkLicenseFile available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkLicenseFile -InlineCount allpages
```
Above example returns the list of NetworkLicenseFile along with count.
...
### -Name
Specifies the name of the NetworkLicenseFile.
...
### -Organization
Specifies the organization, to fetch the NetworkLicenseFile under it.
