...
```yaml
Type: WorkflowServiceItemActionProperties.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowServiceItemActionProperties.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowServiceItemActionProperties
```
