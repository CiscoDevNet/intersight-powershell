...
New-IntersightCapabilityFexCapabilityDef [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-FecConfigOnHifPortSupported< bool>][-Moid< string>][[-Name]< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;CapabilityFexCapabilityDef&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightCapabilityFexCapabilityDef
```
