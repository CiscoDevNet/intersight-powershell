...
Initialize-IntersightConnectorStreamKeepalive [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< ConnectorStreamKeepalive.ClassIdEnum>][-EncryptedAesKey< string>][-EncryptionKey< string>][-ObjectType< ConnectorStreamKeepalive.ObjectTypeEnum>][-SecureProperties< object>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ConnectorStreamKeepalive.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ConnectorStreamKeepalive.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightConnectorStreamKeepalive
```
