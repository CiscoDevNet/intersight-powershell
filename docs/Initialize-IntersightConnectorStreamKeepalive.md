...
Initialize-IntersightConnectorStreamKeepalive [-AdditionalProperties< Dictionary<string,object>>][-ClassId< ConnectorStreamKeepalive.ClassIdEnum>][-EncryptedAesKey< string>][-EncryptionKey< string>][-ObjectType< ConnectorStreamKeepalive.ObjectTypeEnum>][-SecureProperties< object>][-StreamName< string>]
