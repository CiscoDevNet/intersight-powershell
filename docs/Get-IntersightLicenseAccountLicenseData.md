...
## SYNOPSIS
Get the LicenseAccountLicenseData

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightLicenseAccountLicenseData [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightLicenseAccountLicenseData [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;LicenseAccountLicenseData&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightLicenseAccountLicenseData
```
Above example returns the list of LicenseAccountLicenseData.

### Example 2
```powershell
PS C:\> $result = Get-IntersightLicenseAccountLicenseData -Name "MoName"
```
Above example returns the LicenseAccountLicenseData matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightLicenseAccountLicenseData -Organization $organization
```
Above example returns the list of LicenseAccountLicenseData available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightLicenseAccountLicenseData -InlineCount allpages
```
Above example returns the list of LicenseAccountLicenseData along with count.
...
### -Name
Specifies the name of the LicenseAccountLicenseData.
...
### -Organization
Specifies the organization, to fetch the LicenseAccountLicenseData under it.
...
[Set-IntersightLicenseAccountLicenseData](./Set-IntersightLicenseAccountLicenseData.md)
