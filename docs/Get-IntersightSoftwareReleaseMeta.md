...
## SYNOPSIS
Get the SoftwareReleaseMeta

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwareReleaseMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwareReleaseMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;SoftwareReleaseMeta&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwareReleaseMeta
```
Above example returns the list of SoftwareReleaseMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwareReleaseMeta -Name "MoName"
```
Above example returns the SoftwareReleaseMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwareReleaseMeta -Organization $organization
```
Above example returns the list of SoftwareReleaseMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwareReleaseMeta -InlineCount allpages
```
Above example returns the list of SoftwareReleaseMeta along with count.
...
### -Name
Specifies the name of the SoftwareReleaseMeta.
...
### -Organization
Specifies the organization, to fetch the SoftwareReleaseMeta under it.
