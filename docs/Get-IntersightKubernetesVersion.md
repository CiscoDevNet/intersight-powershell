...
### CmdletParam (Default)
```
Get-IntersightKubernetesVersion [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesVersion [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesVersion
```
Above example returns the list of KubernetesVersion.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesVersion -Name "MoName"
```
Above example returns the KubernetesVersion matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesVersion -Organization $organization
```
Above example returns the list of KubernetesVersion available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesVersion -InlineCount allpages
```
Above example returns the list of KubernetesVersion along with count.
...
### -Name
Specifies the name of the KubernetesVersion.
...
### -Organization
Specifies the organization, to fetch the KubernetesVersion under it.
