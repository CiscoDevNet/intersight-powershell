...
## SYNOPSIS
Get the HyperflexBackupCluster

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexBackupCluster [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexBackupCluster [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexBackupCluster&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexBackupCluster
```
Above example returns the list of HyperflexBackupCluster.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexBackupCluster -Name "MoName"
```
Above example returns the HyperflexBackupCluster matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexBackupCluster -Organization $organization
```
Above example returns the list of HyperflexBackupCluster available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexBackupCluster -InlineCount allpages
```
Above example returns the list of HyperflexBackupCluster along with count.
...
### -Name
Specifies the name of the HyperflexBackupCluster.
...
### -Organization
Specifies the organization, to fetch the HyperflexBackupCluster under it.
...
[Remove-IntersightHyperflexBackupCluster](./Remove-IntersightHyperflexBackupCluster.md)
