...
# Get-IntersightHyperflexHealthCheckSchedulePolicy

## SYNOPSIS
Get the HyperflexHealthCheckSchedulePolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHealthCheckSchedulePolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHealthCheckSchedulePolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHealthCheckSchedulePolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckSchedulePolicy
```
Above example returns the list of HyperflexHealthCheckSchedulePolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckSchedulePolicy -Name "MoName"
```
Above example returns the HyperflexHealthCheckSchedulePolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckSchedulePolicy -Organization $organization
```
Above example returns the list of HyperflexHealthCheckSchedulePolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckSchedulePolicy -InlineCount allpages
```
Above example returns the list of HyperflexHealthCheckSchedulePolicy along with count.
...
### -Name
Specifies the name of the HyperflexHealthCheckSchedulePolicy.
...
### -Organization
Specifies the organization, to fetch the HyperflexHealthCheckSchedulePolicy under it.
