...
## SYNOPSIS
Get the HyperflexHealthCheckExecutionSnapshot

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHealthCheckExecutionSnapshot [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHealthCheckExecutionSnapshot [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHealthCheckExecutionSnapshot&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckExecutionSnapshot
```
Above example returns the list of HyperflexHealthCheckExecutionSnapshot.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckExecutionSnapshot -Name "MoName"
```
Above example returns the HyperflexHealthCheckExecutionSnapshot matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckExecutionSnapshot -Organization $organization
```
Above example returns the list of HyperflexHealthCheckExecutionSnapshot available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHealthCheckExecutionSnapshot -InlineCount allpages
```
Above example returns the list of HyperflexHealthCheckExecutionSnapshot along with count.
...
### -Name
Specifies the name of the HyperflexHealthCheckExecutionSnapshot.
...
### -Organization
Specifies the organization, to fetch the HyperflexHealthCheckExecutionSnapshot under it.
