...
### CmdletParam (Default)
```
Get-IntersightCapabilityServerDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityServerDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityServerDescriptor
```
Above example returns the list of CapabilityServerDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityServerDescriptor -Name "MoName"
```
Above example returns the CapabilityServerDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityServerDescriptor -Organization $organization
```
Above example returns the list of CapabilityServerDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityServerDescriptor -InlineCount allpages
```
Above example returns the list of CapabilityServerDescriptor along with count.
...
### -Name
Specifies the name of the CapabilityServerDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilityServerDescriptor under it.
...
[Remove-IntersightCapabilityServerDescriptor](./Remove-IntersightCapabilityServerDescriptor.md)
