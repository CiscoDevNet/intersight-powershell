...
```powershell
$StorageHyperFlexStorageContainerRelationship = Initialize-IntersightStorageHyperFlexStorageContainerRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StorageHyperFlexStorageContainerRelationship | ConvertTo-JSON
```
