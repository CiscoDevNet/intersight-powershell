...
### CmdletParam (Default)
```
Get-IntersightCapabilitySwitchCapability [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilitySwitchCapability [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchCapability
```
Above example returns the list of CapabilitySwitchCapability.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchCapability -Name "MoName"
```
Above example returns the CapabilitySwitchCapability matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchCapability -Organization $organization
```
Above example returns the list of CapabilitySwitchCapability available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilitySwitchCapability -InlineCount allpages
```
Above example returns the list of CapabilitySwitchCapability along with count.
...
### -Name
Specifies the name of the CapabilitySwitchCapability.
...
### -Organization
Specifies the organization, to fetch the CapabilitySwitchCapability under it.
