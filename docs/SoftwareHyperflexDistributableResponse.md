...
```powershell
$SoftwareHyperflexDistributableResponse = Initialize-IntersightSoftwareHyperflexDistributableResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwareHyperflexDistributableResponse | ConvertTo-JSON
```
