...
# Get-IntersightNiatelemetryCloudDetails

## SYNOPSIS
Get the NiatelemetryCloudDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryCloudDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryCloudDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryCloudDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryCloudDetails
```
Above example returns the list of NiatelemetryCloudDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryCloudDetails -Name "MoName"
```
Above example returns the NiatelemetryCloudDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryCloudDetails -Organization $organization
```
Above example returns the list of NiatelemetryCloudDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryCloudDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryCloudDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryCloudDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryCloudDetails under it.
