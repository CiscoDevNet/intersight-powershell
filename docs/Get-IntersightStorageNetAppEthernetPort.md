...
## SYNOPSIS
Get the StorageNetAppEthernetPort

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppEthernetPort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppEthernetPort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageNetAppEthernetPort&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppEthernetPort
```
Above example returns the list of StorageNetAppEthernetPort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppEthernetPort -Name "MoName"
```
Above example returns the StorageNetAppEthernetPort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppEthernetPort -Organization $organization
```
Above example returns the list of StorageNetAppEthernetPort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppEthernetPort -InlineCount allpages
```
Above example returns the list of StorageNetAppEthernetPort along with count.
...
### -Name
Specifies the name of the StorageNetAppEthernetPort.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppEthernetPort under it.
