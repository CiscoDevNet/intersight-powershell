...
```powershell
$WorkflowCustomDataTypeDefinitionResponse = Initialize-IntersightWorkflowCustomDataTypeDefinitionResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$WorkflowCustomDataTypeDefinitionResponse | ConvertTo-JSON
```
