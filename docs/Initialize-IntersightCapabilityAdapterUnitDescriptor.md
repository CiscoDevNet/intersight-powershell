...
# Initialize-IntersightCapabilityAdapterUnitDescriptor
...
```yaml
Type: CapabilityAdapterUnitDescriptor.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.CapabilityFeatureConfig]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CapabilityAdapterUnitDescriptor.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCapabilityAdapterUnitDescriptor
```
