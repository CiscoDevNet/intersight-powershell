...
# Get-IntersightCapabilityUpdateOrderMeta

## SYNOPSIS
Get the CapabilityUpdateOrderMeta

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityUpdateOrderMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityUpdateOrderMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilityUpdateOrderMeta&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityUpdateOrderMeta
```
Above example returns the list of CapabilityUpdateOrderMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityUpdateOrderMeta -Name "MoName"
```
Above example returns the CapabilityUpdateOrderMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityUpdateOrderMeta -Organization $organization
```
Above example returns the list of CapabilityUpdateOrderMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityUpdateOrderMeta -InlineCount allpages
```
Above example returns the list of CapabilityUpdateOrderMeta along with count.
...
### -Name
Specifies the name of the CapabilityUpdateOrderMeta.
...
### -Organization
Specifies the organization, to fetch the CapabilityUpdateOrderMeta under it.
