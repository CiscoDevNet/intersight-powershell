...
# Get-IntersightApicExternalRoutedLayerThreeDomain

## SYNOPSIS
Get the ApicExternalRoutedLayerThreeDomain

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApicExternalRoutedLayerThreeDomain [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApicExternalRoutedLayerThreeDomain [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApicExternalRoutedLayerThreeDomain&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApicExternalRoutedLayerThreeDomain
```
Above example returns the list of ApicExternalRoutedLayerThreeDomain.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApicExternalRoutedLayerThreeDomain -Name "MoName"
```
Above example returns the ApicExternalRoutedLayerThreeDomain matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApicExternalRoutedLayerThreeDomain -Organization $organization
```
Above example returns the list of ApicExternalRoutedLayerThreeDomain available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApicExternalRoutedLayerThreeDomain -InlineCount allpages
```
Above example returns the list of ApicExternalRoutedLayerThreeDomain along with count.
...
### -Name
Specifies the name of the ApicExternalRoutedLayerThreeDomain.
...
### -Organization
Specifies the organization, to fetch the ApicExternalRoutedLayerThreeDomain under it.
