...
# Get-IntersightNiaapiDcnmCcoPost

## SYNOPSIS
Get the NiaapiDcnmCcoPost

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiDcnmCcoPost [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiDcnmCcoPost [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiaapiDcnmCcoPost&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmCcoPost
```
Above example returns the list of NiaapiDcnmCcoPost.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmCcoPost -Name "MoName"
```
Above example returns the NiaapiDcnmCcoPost matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmCcoPost -Organization $organization
```
Above example returns the list of NiaapiDcnmCcoPost available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiDcnmCcoPost -InlineCount allpages
```
Above example returns the list of NiaapiDcnmCcoPost along with count.
...
### -Name
Specifies the name of the NiaapiDcnmCcoPost.
...
### -Organization
Specifies the organization, to fetch the NiaapiDcnmCcoPost under it.
