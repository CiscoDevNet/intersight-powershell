...
### CmdletParam (Default)
```
Get-IntersightAssetTarget [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAssetTarget [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAssetTarget
```
Above example returns the list of AssetTarget.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAssetTarget -Name "MoName"
```
Above example returns the AssetTarget matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAssetTarget -Organization $organization
```
Above example returns the list of AssetTarget available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAssetTarget -InlineCount allpages
```
Above example returns the list of AssetTarget along with count.
...
### -Name
Specifies the name of the AssetTarget.
...
### -Organization
Specifies the organization, to fetch the AssetTarget under it.
