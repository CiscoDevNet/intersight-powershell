...
## SYNOPSIS
Get the HyperflexDatastoreStatistic

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexDatastoreStatistic [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexDatastoreStatistic [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexDatastoreStatistic&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexDatastoreStatistic
```
Above example returns the list of HyperflexDatastoreStatistic.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexDatastoreStatistic -Name "MoName"
```
Above example returns the HyperflexDatastoreStatistic matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexDatastoreStatistic -Organization $organization
```
Above example returns the list of HyperflexDatastoreStatistic available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexDatastoreStatistic -InlineCount allpages
```
Above example returns the list of HyperflexDatastoreStatistic along with count.
...
### -Name
Specifies the name of the HyperflexDatastoreStatistic.
...
### -Organization
Specifies the organization, to fetch the HyperflexDatastoreStatistic under it.
