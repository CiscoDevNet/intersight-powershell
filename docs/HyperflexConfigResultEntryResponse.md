...
```powershell
$HyperflexConfigResultEntryResponse = Initialize-IntersightHyperflexConfigResultEntryResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexConfigResultEntryResponse | ConvertTo-JSON
```
