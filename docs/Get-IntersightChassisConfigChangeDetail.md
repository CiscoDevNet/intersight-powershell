...
### CmdletParam (Default)
```
Get-IntersightChassisConfigChangeDetail [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightChassisConfigChangeDetail [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightChassisConfigChangeDetail
```
Above example returns the list of ChassisConfigChangeDetail.

### Example 2
```powershell
PS C:\> $result = Get-IntersightChassisConfigChangeDetail -Name "MoName"
```
Above example returns the ChassisConfigChangeDetail matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightChassisConfigChangeDetail -Organization $organization
```
Above example returns the list of ChassisConfigChangeDetail available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightChassisConfigChangeDetail -InlineCount allpages
```
Above example returns the list of ChassisConfigChangeDetail along with count.
...
### -Name
Specifies the name of the ChassisConfigChangeDetail.
...
### -Organization
Specifies the organization, to fetch the ChassisConfigChangeDetail under it.
