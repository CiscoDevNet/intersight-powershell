# Intersight.Intersight/Api.IntersightConfigApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**New-IntersightConfigExporter**](IntersightConfigApi.md#New-IntersightConfigExporter) | **POST** /api/v1/config/Exporters | Create a &#39;config.Exporter&#39; resource.
[**New-IntersightConfigImporter**](IntersightConfigApi.md#New-IntersightConfigImporter) | **POST** /api/v1/config/Importers | Create a &#39;config.Importer&#39; resource.
[**Remove-IntersightConfigExporter**](IntersightConfigApi.md#Remove-IntersightConfigExporter) | **DELETE** /api/v1/config/Exporters/{Moid} | Delete a &#39;config.Exporter&#39; resource.
[**Remove-IntersightConfigImporter**](IntersightConfigApi.md#Remove-IntersightConfigImporter) | **DELETE** /api/v1/config/Importers/{Moid} | Delete a &#39;config.Importer&#39; resource.
[**Get-IntersightConfigExportedItemByMoid**](IntersightConfigApi.md#Get-IntersightConfigExportedItemByMoid) | **GET** /api/v1/config/ExportedItems/{Moid} | Read a &#39;config.ExportedItem&#39; resource.
[**Get-IntersightConfigExportedItemList**](IntersightConfigApi.md#Get-IntersightConfigExportedItemList) | **GET** /api/v1/config/ExportedItems | Read a &#39;config.ExportedItem&#39; resource.
[**Get-IntersightConfigExporterByMoid**](IntersightConfigApi.md#Get-IntersightConfigExporterByMoid) | **GET** /api/v1/config/Exporters/{Moid} | Read a &#39;config.Exporter&#39; resource.
[**Get-IntersightConfigExporterList**](IntersightConfigApi.md#Get-IntersightConfigExporterList) | **GET** /api/v1/config/Exporters | Read a &#39;config.Exporter&#39; resource.
[**Get-IntersightConfigImportedItemByMoid**](IntersightConfigApi.md#Get-IntersightConfigImportedItemByMoid) | **GET** /api/v1/config/ImportedItems/{Moid} | Read a &#39;config.ImportedItem&#39; resource.
[**Get-IntersightConfigImportedItemList**](IntersightConfigApi.md#Get-IntersightConfigImportedItemList) | **GET** /api/v1/config/ImportedItems | Read a &#39;config.ImportedItem&#39; resource.
[**Get-IntersightConfigImporterByMoid**](IntersightConfigApi.md#Get-IntersightConfigImporterByMoid) | **GET** /api/v1/config/Importers/{Moid} | Read a &#39;config.Importer&#39; resource.
[**Get-IntersightConfigImporterList**](IntersightConfigApi.md#Get-IntersightConfigImporterList) | **GET** /api/v1/config/Importers | Read a &#39;config.Importer&#39; resource.


<a name="New-IntersightConfigExporter"></a>
# **New-IntersightConfigExporter**
> ConfigExporter New-IntersightConfigExporter<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ConfigExporter] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfNoneMatch] <String><br>

Create a 'config.Exporter' resource.
...
# Create a 'config.Exporter' resource.
try {
    ConfigExporter $Result = New-IntersightConfigExporter -ConfigExporter $ConfigExporter -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
    Write-Host ("Exception occured when calling New-IntersightConfigExporter: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
------------- | ------------- | ------------- | -------------
 **ConfigExporter** | [**ConfigExporter**](ConfigExporter.md)| The &#39;config.Exporter&#39; resource to create. | 
...
<a name="New-IntersightConfigImporter"></a>
# **New-IntersightConfigImporter**
> ConfigImporter New-IntersightConfigImporter<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ConfigImporter] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfNoneMatch] <String><br>

Create a 'config.Importer' resource.
...
$ConfigImporter = (Initialize-config.Importer-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -ImportPath "ImportPath_example" -ImportSource "ImportSource_example" -Name "Name_example" -SkipIntegrityChecks $false -Status "Status_example" -StatusMessage "StatusMessage_example" -ImportedItems @((Initialize-config.ImportedItem.Relationship-ClassId "ClassId_example" -ObjectType "ObjectType_example" -Moid "Moid_example" -Selector "Selector_example" -Link "Link_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -IsShared $false -IsUpdated $false -Item  -Name "Name_example" -NewMoid "NewMoid_example" -ServiceVersion "ServiceVersion_example" -Status "Status_example" -StatusMessage "StatusMessage_example" -Importer (Initialize-config.Importer.Relationship-ClassId "ClassId_example" -ObjectType "ObjectType_example" -Moid "Moid_example" -Selector "Selector_example" -Link "Link_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -ImportPath "ImportPath_example" -ImportSource "ImportSource_example" -Name "Name_example" -SkipIntegrityChecks $false -Status "Status_example" -StatusMessage "StatusMessage_example" -ImportedItems @((Initialize-config.ImportedItem.Relationship-ClassId "ClassId_example" -ObjectType "ObjectType_example" -Moid "Moid_example" -Selector "Selector_example" -Link "Link_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -IsShared $false -IsUpdated $false -Item  -Name "Name_example" -NewMoid "NewMoid_example" -ServiceVersion "ServiceVersion_example" -Status "Status_example" -StatusMessage "StatusMessage_example" -Importer (Initialize-config.Importer.Relationship-ClassId "ClassId_example" -ObjectType "ObjectType_example" -Moid "Moid_example" -Selector "Selector_example" -Link "Link_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -ImportPath "ImportPath_example" -ImportSource "ImportSource_example" -Name "Name_example" -SkipIntegrityChecks $false -Status "Status_example" -StatusMessage "StatusMessage_example" -ImportedItems @() -Organization ))) -Organization ))) -Organization ) # ConfigImporter | The 'config.Importer' resource to create.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
$IfNoneMatch = "IfNoneMatch_example" # String | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)

# Create a 'config.Importer' resource.
try {
    ConfigImporter $Result = New-IntersightConfigImporter -ConfigImporter $ConfigImporter -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
    Write-Host ("Exception occured when calling New-IntersightConfigImporter: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ConfigImporter** | [**ConfigImporter**](ConfigImporter.md)| The &#39;config.Importer&#39; resource to create. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
 **IfNoneMatch** | **String**| For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte. | [optional] 
...
<a name="Remove-IntersightConfigExporter"></a>
# **Remove-IntersightConfigExporter**
> void Remove-IntersightConfigExporter<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>

Delete a 'config.Exporter' resource.
...
# Delete a 'config.Exporter' resource.
try {
    Remove-IntersightConfigExporter -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightConfigExporter: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Remove-IntersightConfigImporter"></a>
# **Remove-IntersightConfigImporter**
> void Remove-IntersightConfigImporter<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>

Delete a 'config.Importer' resource.
...
# Delete a 'config.Importer' resource.
try {
    Remove-IntersightConfigImporter -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightConfigImporter: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightConfigExportedItemByMoid"></a>
# **Get-IntersightConfigExportedItemByMoid**
> ConfigExportedItem Get-IntersightConfigExportedItemByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>

Read a 'config.ExportedItem' resource.
...
# Read a 'config.ExportedItem' resource.
try {
    ConfigExportedItem $Result = Get-IntersightConfigExportedItemByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightConfigExportedItemByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightConfigExportedItemList"></a>
# **Get-IntersightConfigExportedItemList**
> ConfigExportedItemResponse Get-IntersightConfigExportedItemList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'config.ExportedItem' resource.
try {
    ConfigExportedItemResponse $Result = Get-IntersightConfigExportedItemList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightConfigExportedItemList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightConfigExporterByMoid"></a>
# **Get-IntersightConfigExporterByMoid**
> ConfigExporter Get-IntersightConfigExporterByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>

Read a 'config.Exporter' resource.
...
# Read a 'config.Exporter' resource.
try {
    ConfigExporter $Result = Get-IntersightConfigExporterByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightConfigExporterByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightConfigExporterList"></a>
# **Get-IntersightConfigExporterList**
> ConfigExporterResponse Get-IntersightConfigExporterList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'config.Exporter' resource.
try {
    ConfigExporterResponse $Result = Get-IntersightConfigExporterList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightConfigExporterList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightConfigImportedItemByMoid"></a>
# **Get-IntersightConfigImportedItemByMoid**
> ConfigImportedItem Get-IntersightConfigImportedItemByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>

Read a 'config.ImportedItem' resource.
...
# Read a 'config.ImportedItem' resource.
try {
    ConfigImportedItem $Result = Get-IntersightConfigImportedItemByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightConfigImportedItemByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightConfigImportedItemList"></a>
# **Get-IntersightConfigImportedItemList**
> ConfigImportedItemResponse Get-IntersightConfigImportedItemList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'config.ImportedItem' resource.
try {
    ConfigImportedItemResponse $Result = Get-IntersightConfigImportedItemList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightConfigImportedItemList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightConfigImporterByMoid"></a>
# **Get-IntersightConfigImporterByMoid**
> ConfigImporter Get-IntersightConfigImporterByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>

Read a 'config.Importer' resource.
...
# Read a 'config.Importer' resource.
try {
    ConfigImporter $Result = Get-IntersightConfigImporterByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightConfigImporterByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightConfigImporterList"></a>
# **Get-IntersightConfigImporterList**
> ConfigImporterResponse Get-IntersightConfigImporterList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'config.Importer' resource.
try {
    ConfigImporterResponse $Result = Get-IntersightConfigImporterList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightConfigImporterList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
