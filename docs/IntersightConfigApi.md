...
# Create a 'config.Exporter' resource.
try {
     $Result = New-IntersightConfigExporter -ConfigExporter $ConfigExporter -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
...
# Delete a 'config.Exporter' resource.
try {
     $Result = Remove-IntersightConfigExporter -Moid $Moid
} catch {
...
# Delete a 'config.Importer' resource.
try {
     $Result = Remove-IntersightConfigImporter -Moid $Moid
} catch {
...
# Read a 'config.ExportedItem' resource.
try {
     $Result = Get-IntersightConfigExportedItemByMoid -Moid $Moid
} catch {
...
# Read a 'config.ExportedItem' resource.
try {
     $Result = Get-IntersightConfigExportedItemList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'config.Exporter' resource.
try {
     $Result = Get-IntersightConfigExporterByMoid -Moid $Moid
} catch {
...
# Read a 'config.Exporter' resource.
try {
     $Result = Get-IntersightConfigExporterList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'config.ImportedItem' resource.
try {
     $Result = Get-IntersightConfigImportedItemByMoid -Moid $Moid
} catch {
...
# Read a 'config.ImportedItem' resource.
try {
     $Result = Get-IntersightConfigImportedItemList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'config.Importer' resource.
try {
     $Result = Get-IntersightConfigImporterByMoid -Moid $Moid
} catch {
...
# Read a 'config.Importer' resource.
try {
     $Result = Get-IntersightConfigImporterList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
