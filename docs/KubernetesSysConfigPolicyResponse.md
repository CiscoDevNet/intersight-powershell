...
```powershell
$KubernetesSysConfigPolicyResponse = Initialize-IntersightKubernetesSysConfigPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$KubernetesSysConfigPolicyResponse | ConvertTo-JSON
```
