...
Set-IntersightChangelogItem [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Catalog< WorkflowCatalogRelationship>][-DateVersion< DateTime>][-Entity< string>][[-Moid]< string>][-SemanticVersion< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Value< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;ChangelogItem&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightChangelogItem
```
