...
# Get-IntersightIamResourceRoles

## SYNOPSIS
Get the IamResourceRoles

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamResourceRoles [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamResourceRoles [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamResourceRoles
```
Above example returns the list of IamResourceRoles.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamResourceRoles -Name "MoName"
```
Above example returns the IamResourceRoles matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamResourceRoles -Organization $organization
```
Above example returns the list of IamResourceRoles available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamResourceRoles -InlineCount allpages
```
Above example returns the list of IamResourceRoles along with count.
...
### -Name
Specifies the name of the IamResourceRoles.
...
### -Organization
Specifies the organization, to fetch the IamResourceRoles under it.
