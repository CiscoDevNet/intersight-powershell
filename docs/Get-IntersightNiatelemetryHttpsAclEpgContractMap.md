...
## SYNOPSIS
Get the NiatelemetryHttpsAclEpgContractMap

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryHttpsAclEpgContractMap [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryHttpsAclEpgContractMap [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetryHttpsAclEpgContractMap&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclEpgContractMap
```
Above example returns the list of NiatelemetryHttpsAclEpgContractMap.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclEpgContractMap -Name "MoName"
```
Above example returns the NiatelemetryHttpsAclEpgContractMap matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclEpgContractMap -Organization $organization
```
Above example returns the list of NiatelemetryHttpsAclEpgContractMap available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryHttpsAclEpgContractMap -InlineCount allpages
```
Above example returns the list of NiatelemetryHttpsAclEpgContractMap along with count.
...
### -Name
Specifies the name of the NiatelemetryHttpsAclEpgContractMap.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryHttpsAclEpgContractMap under it.
