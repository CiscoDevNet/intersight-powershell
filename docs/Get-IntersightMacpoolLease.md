...
# Get-IntersightMacpoolLease

## SYNOPSIS
Get the MacpoolLease

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMacpoolLease [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMacpoolLease [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MacpoolLease&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMacpoolLease
```
Above example returns the list of MacpoolLease.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMacpoolLease -Name "MoName"
```
Above example returns the MacpoolLease matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMacpoolLease -Organization $organization
```
Above example returns the list of MacpoolLease available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMacpoolLease -InlineCount allpages
```
Above example returns the list of MacpoolLease along with count.
...
### -Name
Specifies the name of the MacpoolLease.
...
### -Organization
Specifies the organization, to fetch the MacpoolLease under it.
...
[Remove-IntersightMacpoolLease](./Remove-IntersightMacpoolLease.md)
