...
## SYNOPSIS
Get the NiaapiApicReleaseRecommend

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiApicReleaseRecommend [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiApicReleaseRecommend [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiApicReleaseRecommend
```
Above example returns the list of NiaapiApicReleaseRecommend.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiApicReleaseRecommend -Name "MoName"
```
Above example returns the NiaapiApicReleaseRecommend matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiApicReleaseRecommend -Organization $organization
```
Above example returns the list of NiaapiApicReleaseRecommend available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiApicReleaseRecommend -InlineCount allpages
```
Above example returns the list of NiaapiApicReleaseRecommend along with count.
...
### -Name
Specifies the name of the NiaapiApicReleaseRecommend.
...
### -Organization
Specifies the organization, to fetch the NiaapiApicReleaseRecommend under it.
