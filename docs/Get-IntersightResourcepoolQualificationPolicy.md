...
# Get-IntersightResourcepoolQualificationPolicy

## SYNOPSIS
Get the ResourcepoolQualificationPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightResourcepoolQualificationPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourcepoolQualificationPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ResourcepoolQualificationPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourcepoolQualificationPolicy
```
Above example returns the list of ResourcepoolQualificationPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourcepoolQualificationPolicy -Name "MoName"
```
Above example returns the ResourcepoolQualificationPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourcepoolQualificationPolicy -Organization $organization
```
Above example returns the list of ResourcepoolQualificationPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourcepoolQualificationPolicy -InlineCount allpages
```
Above example returns the list of ResourcepoolQualificationPolicy along with count.
...
### -Name
Specifies the name of the ResourcepoolQualificationPolicy.
...
### -Organization
Specifies the organization, to fetch the ResourcepoolQualificationPolicy under it.
...
[Remove-IntersightResourcepoolQualificationPolicy](./Remove-IntersightResourcepoolQualificationPolicy.md)
