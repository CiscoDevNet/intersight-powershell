...
Initialize-IntersightConnectorFileChecksum [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< ConnectorFileChecksum.ClassIdEnum>][-Hash< byte[]>][-HashAlgorithm< ConnectorFileChecksum.HashAlgorithmEnum>][-ObjectType< ConnectorFileChecksum.ObjectTypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ConnectorFileChecksum.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ConnectorFileChecksum.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightConnectorFileChecksum
```
