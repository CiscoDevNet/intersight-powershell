...
Initialize-IntersightFabricQosClass [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AdminState< FabricQosClass.AdminStateEnum>][-BandwidthPercent< long>][-ClassId< FabricQosClass.ClassIdEnum>][-Cos< long>][-Mtu< long>][-MulticastOptimize< bool>][-Name< FabricQosClass.NameEnum>][-ObjectType< FabricQosClass.ObjectTypeEnum>][-PacketDrop< bool>][-Weight< long>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
