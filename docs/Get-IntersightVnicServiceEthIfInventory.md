...
# Get-IntersightVnicServiceEthIfInventory

## SYNOPSIS
Get the VnicServiceEthIfInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicServiceEthIfInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicServiceEthIfInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicServiceEthIfInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicServiceEthIfInventory
```
Above example returns the list of VnicServiceEthIfInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicServiceEthIfInventory -Name "MoName"
```
Above example returns the VnicServiceEthIfInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicServiceEthIfInventory -Organization $organization
```
Above example returns the list of VnicServiceEthIfInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicServiceEthIfInventory -InlineCount allpages
```
Above example returns the list of VnicServiceEthIfInventory along with count.
...
### -Name
Specifies the name of the VnicServiceEthIfInventory.
...
### -Organization
Specifies the organization, to fetch the VnicServiceEthIfInventory under it.
