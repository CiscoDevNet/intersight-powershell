...
# Get-IntersightSshPolicyInventory

## SYNOPSIS
Get the SshPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSshPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSshPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SshPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSshPolicyInventory
```
Above example returns the list of SshPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSshPolicyInventory -Name "MoName"
```
Above example returns the SshPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSshPolicyInventory -Organization $organization
```
Above example returns the list of SshPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSshPolicyInventory -InlineCount allpages
```
Above example returns the list of SshPolicyInventory along with count.
...
### -Name
Specifies the name of the SshPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the SshPolicyInventory under it.
