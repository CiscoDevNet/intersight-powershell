...
```yaml
Type: Model.VnicSanConnectivityPolicyRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.VnicFcIfRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.FcpoolLeaseRelationship
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVnicFcIf
```
