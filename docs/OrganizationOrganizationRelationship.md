...
```powershell
$OrganizationOrganizationRelationship = Initialize-IntersightOrganizationOrganizationRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$OrganizationOrganizationRelationship | ConvertTo-JSON
```
