...
# Initialize-IntersightIamUserQualifier
...
Initialize-IntersightIamUserQualifier [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< IamUserQualifier.ClassIdEnum>][-Moid< string>][-NotificationScope< IamUserQualifier.NotificationScopeEnum>][-NotifyGuestUsers< bool>][-ObjectType< IamUserQualifier.ObjectTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-UserDetails< System.Collections.Generic.List`1[Model.IamUserDetails]>][-Usergroup< Model.IamUserGroupRelationship>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: IamUserQualifier.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IamUserQualifier.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.IamUserDetails]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIamUserQualifier
```
