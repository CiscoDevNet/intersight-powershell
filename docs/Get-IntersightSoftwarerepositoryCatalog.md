...
## SYNOPSIS
Get the SoftwarerepositoryCatalog

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwarerepositoryCatalog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwarerepositoryCatalog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SoftwarerepositoryCatalog&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCatalog
```
Above example returns the list of SoftwarerepositoryCatalog.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCatalog -Name "MoName"
```
Above example returns the SoftwarerepositoryCatalog matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCatalog -Organization $organization
```
Above example returns the list of SoftwarerepositoryCatalog available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCatalog -InlineCount allpages
```
Above example returns the list of SoftwarerepositoryCatalog along with count.
...
### -Name
Specifies the name of the SoftwarerepositoryCatalog.
...
### -Organization
Specifies the organization, to fetch the SoftwarerepositoryCatalog under it.
