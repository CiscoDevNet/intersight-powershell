...
# Get-IntersightMgmtObjectBackupMeta

## SYNOPSIS
Get the MgmtObjectBackupMeta

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMgmtObjectBackupMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMgmtObjectBackupMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MgmtObjectBackupMeta&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMgmtObjectBackupMeta
```
Above example returns the list of MgmtObjectBackupMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMgmtObjectBackupMeta -Name "MoName"
```
Above example returns the MgmtObjectBackupMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMgmtObjectBackupMeta -Organization $organization
```
Above example returns the list of MgmtObjectBackupMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMgmtObjectBackupMeta -InlineCount allpages
```
Above example returns the list of MgmtObjectBackupMeta along with count.
...
### -Name
Specifies the name of the MgmtObjectBackupMeta.
...
### -Organization
Specifies the organization, to fetch the MgmtObjectBackupMeta under it.
