...
# Get-IntersightPartnerintegrationInventory

## SYNOPSIS
Get the PartnerintegrationInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPartnerintegrationInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPartnerintegrationInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PartnerintegrationInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationInventory
```
Above example returns the list of PartnerintegrationInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationInventory -Name "MoName"
```
Above example returns the PartnerintegrationInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationInventory -Organization $organization
```
Above example returns the list of PartnerintegrationInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationInventory -InlineCount allpages
```
Above example returns the list of PartnerintegrationInventory along with count.
...
### -Name
Specifies the name of the PartnerintegrationInventory.
...
### -Organization
Specifies the organization, to fetch the PartnerintegrationInventory under it.
...
[Remove-IntersightPartnerintegrationInventory](./Remove-IntersightPartnerintegrationInventory.md)
