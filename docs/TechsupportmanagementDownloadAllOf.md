...
```powershell
$TechsupportmanagementDownloadAllOf = Initialize-IntersightTechsupportmanagementDownloadAllOf  -ClassId null `
 -ObjectType null `
...
```powershell
$TechsupportmanagementDownloadAllOf | ConvertTo-JSON
```
