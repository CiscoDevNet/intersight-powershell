...
# Get-IntersightEquipmentExpanderModuleIdentity

## SYNOPSIS
Get the EquipmentExpanderModuleIdentity

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentExpanderModuleIdentity [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentExpanderModuleIdentity [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentExpanderModuleIdentity&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentExpanderModuleIdentity
```
Above example returns the list of EquipmentExpanderModuleIdentity.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentExpanderModuleIdentity -Name "MoName"
```
Above example returns the EquipmentExpanderModuleIdentity matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentExpanderModuleIdentity -Organization $organization
```
Above example returns the list of EquipmentExpanderModuleIdentity available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentExpanderModuleIdentity -InlineCount allpages
```
Above example returns the list of EquipmentExpanderModuleIdentity along with count.
...
### -Name
Specifies the name of the EquipmentExpanderModuleIdentity.
...
### -Organization
Specifies the organization, to fetch the EquipmentExpanderModuleIdentity under it.
...
[Set-IntersightEquipmentExpanderModuleIdentity](./Set-IntersightEquipmentExpanderModuleIdentity.md)
