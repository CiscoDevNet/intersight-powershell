...
## SYNOPSIS
Get the LicenseLicenseReservationOp

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightLicenseLicenseReservationOp [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightLicenseLicenseReservationOp [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightLicenseLicenseReservationOp
```
Above example returns the list of LicenseLicenseReservationOp.

### Example 2
```powershell
PS C:\> $result = Get-IntersightLicenseLicenseReservationOp -Name "MoName"
```
Above example returns the LicenseLicenseReservationOp matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightLicenseLicenseReservationOp -Organization $organization
```
Above example returns the list of LicenseLicenseReservationOp available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightLicenseLicenseReservationOp -InlineCount allpages
```
Above example returns the list of LicenseLicenseReservationOp along with count.
...
### -Name
Specifies the name of the LicenseLicenseReservationOp.
...
### -Organization
Specifies the organization, to fetch the LicenseLicenseReservationOp under it.
