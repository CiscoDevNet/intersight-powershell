...
# Set-IntersightStorageDriveSecurityPolicy
...
Set-IntersightStorageDriveSecurityPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Description< string>][-KeySetting< StorageKeySetting>][[-Moid]< string>][-Name< string>][-Organization< OrganizationOrganizationRelationship>][-Profiles< System.Collections.Generic.List`1[PolicyAbstractConfigProfileRelationship]>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;StorageDriveSecurityPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightStorageDriveSecurityPolicy
```
