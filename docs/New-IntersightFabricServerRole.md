...
New-IntersightFabricServerRole [-AdditionalProperties< Dictionary<string,object>>][-AggregatePortId< long>][-Moid< string>][-PortId< long>][-PortPolicy< FabricPortPolicyRelationship>][-SlotId< long>][-Tags< List<MoTag>>]
