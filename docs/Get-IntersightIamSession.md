...
### CmdletParam (Default)
```
Get-IntersightIamSession [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamSession [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamSession
```
Above example returns the list of IamSession.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamSession -Name "MoName"
```
Above example returns the IamSession matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamSession -Organization $organization
```
Above example returns the list of IamSession available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamSession -InlineCount allpages
```
Above example returns the list of IamSession along with count.
...
### -Name
Specifies the name of the IamSession.
...
### -Organization
Specifies the organization, to fetch the IamSession under it.
...
[Remove-IntersightIamSession](./Remove-IntersightIamSession.md)
