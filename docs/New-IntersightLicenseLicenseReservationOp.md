...
New-IntersightLicenseLicenseReservationOp [-Account< IamAccountRelationship>][-AdditionalProperties< Dictionary<string,object>>][-AuthCode< string>][-GenerateRequestCode< bool>][-GenerateReturnCode< bool>][-Moid< string>][-Tags< List<MoTag>>]
