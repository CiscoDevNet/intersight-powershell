...
New-IntersightIamResourceRoles [-AdditionalProperties< Dictionary<string,object>>][-Moid< string>][-Permission< IamPermissionRelationship>][-Roles< List<IamRoleRelationship>>][-Tags< List<MoTag>>]
