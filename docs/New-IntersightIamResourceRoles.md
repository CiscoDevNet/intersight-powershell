...
# New-IntersightIamResourceRoles
...
New-IntersightIamResourceRoles [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Moid< string>][-Permission< IamPermissionRelationship>][-PrivilegeSets< System.Collections.Generic.List`1[IamPrivilegeSetRelationship]>][-Resource< MoBaseMoRelationship>][-Roles< System.Collections.Generic.List`1[IamRoleRelationship]>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> New-IntersightIamResourceRoles
```
