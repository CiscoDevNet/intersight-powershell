...
New-IntersightIamResourceRoles [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Moid< string>][-Permission< IamPermissionRelationship>][-Resource< MoBaseMoRelationship>][-Roles< System.Collections.Generic.List`1[IamRoleRelationship]>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
