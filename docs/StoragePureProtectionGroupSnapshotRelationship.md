...
```powershell
$StoragePureProtectionGroupSnapshotRelationship = Initialize-IntersightStoragePureProtectionGroupSnapshotRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StoragePureProtectionGroupSnapshotRelationship | ConvertTo-JSON
```
