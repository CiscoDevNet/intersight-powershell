...
```powershell
$VirtualizationVmwareClusterRelationship = Initialize-IntersightVirtualizationVmwareClusterRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$VirtualizationVmwareClusterRelationship | ConvertTo-JSON
```
