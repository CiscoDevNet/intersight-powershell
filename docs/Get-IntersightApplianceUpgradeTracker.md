...
# Get-IntersightApplianceUpgradeTracker

## SYNOPSIS
Get the ApplianceUpgradeTracker

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceUpgradeTracker [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceUpgradeTracker [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceUpgradeTracker&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceUpgradeTracker
```
Above example returns the list of ApplianceUpgradeTracker.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceUpgradeTracker -Name "MoName"
```
Above example returns the ApplianceUpgradeTracker matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceUpgradeTracker -Organization $organization
```
Above example returns the list of ApplianceUpgradeTracker available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceUpgradeTracker -InlineCount allpages
```
Above example returns the list of ApplianceUpgradeTracker along with count.
...
### -Name
Specifies the name of the ApplianceUpgradeTracker.
...
### -Organization
Specifies the organization, to fetch the ApplianceUpgradeTracker under it.
