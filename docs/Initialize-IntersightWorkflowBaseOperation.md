...
# Initialize-IntersightWorkflowBaseOperation
...
Initialize-IntersightWorkflowBaseOperation [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< WorkflowBaseOperation.ClassIdEnum>][-ObjectType< WorkflowBaseOperation.ObjectTypeEnum>][-OperationType< WorkflowBaseOperation.OperationTypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowBaseOperation.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowBaseOperation.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowBaseOperation.OperationTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowBaseOperation
```
