...
Initialize-IntersightCloudSkuInstanceType [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ArchitectureType< CloudSkuInstanceType.ArchitectureTypeEnum>][-ClassId< CloudSkuInstanceType.ClassIdEnum>][-CpuUnit< CloudSkuInstanceType.CpuUnitEnum>][-CudaSupport< bool>][-CustomAttributes< System.Collections.Generic.List`1[Model.CloudCustomAttributes]>][-Description< string>][-IsActive< bool>][-IsAutoDiscovered< bool>][-LocalStorageSize< float>][-LocalStorageSizeUnit< CloudSkuInstanceType.LocalStorageSizeUnitEnum>][-MemorySize< float>][-MemorySizeUnit< CloudSkuInstanceType.MemorySizeUnitEnum>][-Moid< string>][-Name< string>][-NetworkPerformance< string>][-NumOfCpus< long>][-NumOfNics< long>][-ObjectType< CloudSkuInstanceType.ObjectTypeEnum>][-PlatformType< CloudSkuInstanceType.PlatformTypeEnum>][-ServiceCategory< CloudSkuInstanceType.ServiceCategoryEnum>][-ServiceFamily< string>][-ServiceName< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Target< Model.AssetTargetRelationship>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
