...
# Initialize-IntersightCloudSkuInstanceType
...
Initialize-IntersightCloudSkuInstanceType [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ArchitectureType< CloudSkuInstanceType.ArchitectureTypeEnum>][-BasePrice< float>][-ClassId< CloudSkuInstanceType.ClassIdEnum>][-CpuUnit< CloudSkuInstanceType.CpuUnitEnum>][-CudaSupport< bool>][-Currency< CloudSkuInstanceType.CurrencyEnum>][-CustomAttributes< System.Collections.Generic.List`1[Model.CloudCustomAttributes]>][-Description< string>][-IsActive< bool>][-IsAutoDiscovered< bool>][-LocalStorageSize< float>][-LocalStorageSizeUnit< CloudSkuInstanceType.LocalStorageSizeUnitEnum>][-MemorySize< float>][-MemorySizeUnit< CloudSkuInstanceType.MemorySizeUnitEnum>][-Moid< string>][-Name< string>][-NetworkPerformance< string>][-NumOfCpus< long>][-NumOfNics< long>][-ObjectType< CloudSkuInstanceType.ObjectTypeEnum>][-PlatformType< CloudSkuInstanceType.PlatformTypeEnum>][-Region< Model.CloudRegionsRelationship>][-RegionId< string>][-ServiceCategory< CloudSkuInstanceType.ServiceCategoryEnum>][-ServiceFamily< string>][-ServiceName< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Target< Model.AssetTargetRelationship>][-Unit< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: CloudSkuInstanceType.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CloudSkuInstanceType.CpuUnitEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CloudSkuInstanceType.CurrencyEnum
Parameter Sets: (All)
Aliases:
...
### -MemorySizeUnit
Units to represent memory, for e.g. MB or GB.\n* `MB` - Enum to represent mega byte storage unit.\n* `GB` - Enum to represent Giga byte storage unit.\n* `TB` - Enum to represent Tera byte storage unit.

```yaml
Type: CloudSkuInstanceType.MemorySizeUnitEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CloudSkuInstanceType.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CloudSkuInstanceType.ServiceCategoryEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCloudSkuInstanceType
```
