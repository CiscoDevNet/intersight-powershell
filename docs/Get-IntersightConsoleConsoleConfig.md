...
# Get-IntersightConsoleConsoleConfig

## SYNOPSIS
Get the ConsoleConsoleConfig

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightConsoleConsoleConfig [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightConsoleConsoleConfig [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ConsoleConsoleConfig&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightConsoleConsoleConfig
```
Above example returns the list of ConsoleConsoleConfig.

### Example 2
```powershell
PS C:\> $result = Get-IntersightConsoleConsoleConfig -Name "MoName"
```
Above example returns the ConsoleConsoleConfig matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightConsoleConsoleConfig -Organization $organization
```
Above example returns the list of ConsoleConsoleConfig available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightConsoleConsoleConfig -InlineCount allpages
```
Above example returns the list of ConsoleConsoleConfig along with count.
...
### -Name
Specifies the name of the ConsoleConsoleConfig.
...
### -Organization
Specifies the organization, to fetch the ConsoleConsoleConfig under it.
