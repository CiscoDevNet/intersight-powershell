...
# Get-IntersightAssetClaimToken

## SYNOPSIS
Get the AssetClaimToken

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAssetClaimToken [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAssetClaimToken [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;AssetClaimToken&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAssetClaimToken
```
Above example returns the list of AssetClaimToken.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAssetClaimToken -Name "MoName"
```
Above example returns the AssetClaimToken matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAssetClaimToken -Organization $organization
```
Above example returns the list of AssetClaimToken available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAssetClaimToken -InlineCount allpages
```
Above example returns the list of AssetClaimToken along with count.
...
### -Name
Specifies the name of the AssetClaimToken.
...
### -Organization
Specifies the organization, to fetch the AssetClaimToken under it.
...
[New-IntersightAssetClaimToken](./New-IntersightAssetClaimToken.md)

[Remove-IntersightAssetClaimToken](./Remove-IntersightAssetClaimToken.md)
