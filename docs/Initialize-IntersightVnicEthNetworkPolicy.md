...
# Initialize-IntersightVnicEthNetworkPolicy
...
Initialize-IntersightVnicEthNetworkPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< VnicEthNetworkPolicy.ClassIdEnum>][-Description< string>][-Moid< string>][-Name< string>][-ObjectType< VnicEthNetworkPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TargetPlatform< VnicEthNetworkPolicy.TargetPlatformEnum>][-VlanSettings< Model.VnicVlanSettings>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: VnicEthNetworkPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VnicEthNetworkPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVnicEthNetworkPolicy
```
