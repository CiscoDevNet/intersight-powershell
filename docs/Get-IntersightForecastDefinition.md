...
# Get-IntersightForecastDefinition

## SYNOPSIS
Get the ForecastDefinition

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightForecastDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightForecastDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightForecastDefinition
```
Above example returns the list of ForecastDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightForecastDefinition -Name "MoName"
```
Above example returns the ForecastDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightForecastDefinition -Organization $organization
```
Above example returns the list of ForecastDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightForecastDefinition -InlineCount allpages
```
Above example returns the list of ForecastDefinition along with count.
...
### -Name
Specifies the name of the ForecastDefinition.
...
### -Organization
Specifies the organization, to fetch the ForecastDefinition under it.
