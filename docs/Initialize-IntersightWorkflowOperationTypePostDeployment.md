...
# Initialize-IntersightWorkflowOperationTypePostDeployment
...
Initialize-IntersightWorkflowOperationTypePostDeployment [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< WorkflowOperationTypePostDeployment.ClassIdEnum>][-ObjectType< WorkflowOperationTypePostDeployment.ObjectTypeEnum>][-OperationType< WorkflowOperationTypePostDeployment.OperationTypeEnum>][-ServiceItemActionDefinition< Model.MoMoRef>][-ServiceItemInstance< Model.MoMoRef>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowOperationTypePostDeployment.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowOperationTypePostDeployment.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowOperationTypePostDeployment.OperationTypeEnum
Parameter Sets: (All)
Aliases:
...
Specify the service item action definition which needs to be executed on the service item instance.
...
### -ServiceItemInstance
Specify the service item instance to issue post-deployment action.
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowOperationTypePostDeployment
```
