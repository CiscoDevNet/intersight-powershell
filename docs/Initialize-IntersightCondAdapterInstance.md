...
# Initialize-IntersightCondAdapterInstance
...
Initialize-IntersightCondAdapterInstance [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< CondAdapterInstance.ClassIdEnum>][-DriverName< string>][-DriverVersion< string>][-Firmware< string>][-Model< string>][-ObjectType< CondAdapterInstance.ObjectTypeEnum>][-Type< CondAdapterInstance.TypeEnum>][-Vendor< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: CondAdapterInstance.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CondAdapterInstance.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CondAdapterInstance.TypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCondAdapterInstance
```
