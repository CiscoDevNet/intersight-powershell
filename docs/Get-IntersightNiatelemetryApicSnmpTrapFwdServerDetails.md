...
## SYNOPSIS
Get the NiatelemetryApicSnmpTrapFwdServerDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicSnmpTrapFwdServerDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicSnmpTrapFwdServerDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpTrapFwdServerDetails
```
Above example returns the list of NiatelemetryApicSnmpTrapFwdServerDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpTrapFwdServerDetails -Name "MoName"
```
Above example returns the NiatelemetryApicSnmpTrapFwdServerDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpTrapFwdServerDetails -Organization $organization
```
Above example returns the list of NiatelemetryApicSnmpTrapFwdServerDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpTrapFwdServerDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryApicSnmpTrapFwdServerDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryApicSnmpTrapFwdServerDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicSnmpTrapFwdServerDetails under it.
