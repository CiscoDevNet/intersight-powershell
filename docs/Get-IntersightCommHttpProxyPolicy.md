...
# Get-IntersightCommHttpProxyPolicy

## SYNOPSIS
Get the CommHttpProxyPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCommHttpProxyPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCommHttpProxyPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;CommHttpProxyPolicy&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCommHttpProxyPolicy
```
Above example returns the list of CommHttpProxyPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCommHttpProxyPolicy -Name "MoName"
```
Above example returns the CommHttpProxyPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCommHttpProxyPolicy -Organization $organization
```
Above example returns the list of CommHttpProxyPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCommHttpProxyPolicy -InlineCount allpages
```
Above example returns the list of CommHttpProxyPolicy along with count.
...
### -Name
Specifies the name of the CommHttpProxyPolicy.
...
### -Organization
Specifies the organization, to fetch the CommHttpProxyPolicy under it.
