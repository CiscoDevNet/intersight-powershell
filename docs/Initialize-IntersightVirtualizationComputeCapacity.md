...
Initialize-IntersightVirtualizationComputeCapacity [-AdditionalProperties< Dictionary<string,object>>][-Capacity< long>][-ClassId< VirtualizationComputeCapacity.ClassIdEnum>][-Free< long>][-ObjectType< VirtualizationComputeCapacity.ObjectTypeEnum>][-Used< long>]
...
```yaml
Type: VirtualizationComputeCapacity.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VirtualizationComputeCapacity.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVirtualizationComputeCapacity
```
