...
# Get-IntersightCondHclStatus

## SYNOPSIS
Get the CondHclStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCondHclStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCondHclStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;CondHclStatus&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCondHclStatus
```
Above example returns the list of CondHclStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCondHclStatus -Name "MoName"
```
Above example returns the CondHclStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCondHclStatus -Organization $organization
```
Above example returns the list of CondHclStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCondHclStatus -InlineCount allpages
```
Above example returns the list of CondHclStatus along with count.
...
### -Name
Specifies the name of the CondHclStatus.
...
### -Organization
Specifies the organization, to fetch the CondHclStatus under it.
