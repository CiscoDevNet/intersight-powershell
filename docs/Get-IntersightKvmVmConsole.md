...
# Get-IntersightKvmVmConsole

## SYNOPSIS
Get the KvmVmConsole

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKvmVmConsole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKvmVmConsole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KvmVmConsole&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKvmVmConsole
```
Above example returns the list of KvmVmConsole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKvmVmConsole -Name "MoName"
```
Above example returns the KvmVmConsole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKvmVmConsole -Organization $organization
```
Above example returns the list of KvmVmConsole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKvmVmConsole -InlineCount allpages
```
Above example returns the list of KvmVmConsole along with count.
...
### -Name
Specifies the name of the KvmVmConsole.
...
### -Organization
Specifies the organization, to fetch the KvmVmConsole under it.
