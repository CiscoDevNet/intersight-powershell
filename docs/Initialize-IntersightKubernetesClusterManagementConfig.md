...
```yaml
Type: KubernetesClusterManagementConfig.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: KubernetesClusterManagementConfig.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightKubernetesClusterManagementConfig
```
