...
```powershell
$StorageNetAppEthernetPortResponse = Initialize-IntersightStorageNetAppEthernetPortResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageNetAppEthernetPortResponse | ConvertTo-JSON
```
