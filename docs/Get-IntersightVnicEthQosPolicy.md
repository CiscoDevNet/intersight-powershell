...
## SYNOPSIS
Get the VnicEthQosPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicEthQosPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicEthQosPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicEthQosPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicEthQosPolicy
```
Above example returns the list of VnicEthQosPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicEthQosPolicy -Name "MoName"
```
Above example returns the VnicEthQosPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicEthQosPolicy -Organization $organization
```
Above example returns the list of VnicEthQosPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicEthQosPolicy -InlineCount allpages
```
Above example returns the list of VnicEthQosPolicy along with count.
...
### -Name
Specifies the name of the VnicEthQosPolicy.
...
### -Organization
Specifies the organization, to fetch the VnicEthQosPolicy under it.
