...
# Get-IntersightTaskWorkflowAction

## SYNOPSIS
Get the TaskWorkflowAction

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightTaskWorkflowAction [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightTaskWorkflowAction [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;TaskWorkflowAction&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightTaskWorkflowAction
```
Above example returns the list of TaskWorkflowAction.

### Example 2
```powershell
PS C:\> $result = Get-IntersightTaskWorkflowAction -Name "MoName"
```
Above example returns the TaskWorkflowAction matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightTaskWorkflowAction -Organization $organization
```
Above example returns the list of TaskWorkflowAction available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightTaskWorkflowAction -InlineCount allpages
```
Above example returns the list of TaskWorkflowAction along with count.
...
### -Name
Specifies the name of the TaskWorkflowAction.
...
### -Organization
Specifies the organization, to fetch the TaskWorkflowAction under it.
