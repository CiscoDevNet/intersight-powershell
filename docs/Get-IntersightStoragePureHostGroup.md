...
## SYNOPSIS
Get the StoragePureHostGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureHostGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureHostGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StoragePureHostGroup&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureHostGroup
```
Above example returns the list of StoragePureHostGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureHostGroup -Name "MoName"
```
Above example returns the StoragePureHostGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureHostGroup -Organization $organization
```
Above example returns the list of StoragePureHostGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureHostGroup -InlineCount allpages
```
Above example returns the list of StoragePureHostGroup along with count.
...
### -Name
Specifies the name of the StoragePureHostGroup.
...
### -Organization
Specifies the organization, to fetch the StoragePureHostGroup under it.
