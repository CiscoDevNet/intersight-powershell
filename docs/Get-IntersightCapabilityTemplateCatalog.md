...
# Get-IntersightCapabilityTemplateCatalog

## SYNOPSIS
Get the CapabilityTemplateCatalog

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityTemplateCatalog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityTemplateCatalog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilityTemplateCatalog&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityTemplateCatalog
```
Above example returns the list of CapabilityTemplateCatalog.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityTemplateCatalog -Name "MoName"
```
Above example returns the CapabilityTemplateCatalog matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityTemplateCatalog -Organization $organization
```
Above example returns the list of CapabilityTemplateCatalog available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityTemplateCatalog -InlineCount allpages
```
Above example returns the list of CapabilityTemplateCatalog along with count.
...
### -Name
Specifies the name of the CapabilityTemplateCatalog.
...
### -Organization
Specifies the organization, to fetch the CapabilityTemplateCatalog under it.
