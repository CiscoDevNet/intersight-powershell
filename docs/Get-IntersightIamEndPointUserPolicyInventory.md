...
# Get-IntersightIamEndPointUserPolicyInventory

## SYNOPSIS
Get the IamEndPointUserPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamEndPointUserPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamEndPointUserPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamEndPointUserPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserPolicyInventory
```
Above example returns the list of IamEndPointUserPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserPolicyInventory -Name "MoName"
```
Above example returns the IamEndPointUserPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserPolicyInventory -Organization $organization
```
Above example returns the list of IamEndPointUserPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserPolicyInventory -InlineCount allpages
```
Above example returns the list of IamEndPointUserPolicyInventory along with count.
...
### -Name
Specifies the name of the IamEndPointUserPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the IamEndPointUserPolicyInventory under it.
