...
# Get-IntersightIamOAuthToken

## SYNOPSIS
Get the IamOAuthToken

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamOAuthToken [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamOAuthToken [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamOAuthToken&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamOAuthToken
```
Above example returns the list of IamOAuthToken.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamOAuthToken -Name "MoName"
```
Above example returns the IamOAuthToken matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamOAuthToken -Organization $organization
```
Above example returns the list of IamOAuthToken available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamOAuthToken -InlineCount allpages
```
Above example returns the list of IamOAuthToken along with count.
...
### -Name
Specifies the name of the IamOAuthToken.
...
### -Organization
Specifies the organization, to fetch the IamOAuthToken under it.
...
[Remove-IntersightIamOAuthToken](./Remove-IntersightIamOAuthToken.md)
