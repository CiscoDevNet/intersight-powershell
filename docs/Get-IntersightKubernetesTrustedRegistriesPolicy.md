...
## SYNOPSIS
Get the KubernetesTrustedRegistriesPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesTrustedRegistriesPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesTrustedRegistriesPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;KubernetesTrustedRegistriesPolicy&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesTrustedRegistriesPolicy
```
Above example returns the list of KubernetesTrustedRegistriesPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesTrustedRegistriesPolicy -Name "MoName"
```
Above example returns the KubernetesTrustedRegistriesPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesTrustedRegistriesPolicy -Organization $organization
```
Above example returns the list of KubernetesTrustedRegistriesPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesTrustedRegistriesPolicy -InlineCount allpages
```
Above example returns the list of KubernetesTrustedRegistriesPolicy along with count.
...
### -Name
Specifies the name of the KubernetesTrustedRegistriesPolicy.
...
### -Organization
Specifies the organization, to fetch the KubernetesTrustedRegistriesPolicy under it.
