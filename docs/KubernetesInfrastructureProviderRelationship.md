# KubernetesInfrastructureProviderRelationship
## Properties
...
```powershell
$KubernetesInfrastructureProviderRelationship = Initialize-IntersightKubernetesInfrastructureProviderRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$KubernetesInfrastructureProviderRelationship | ConvertTo-JSON
```
