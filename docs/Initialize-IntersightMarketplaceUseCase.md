...
# Initialize-IntersightMarketplaceUseCase
...
```yaml
Type: MarketplaceUseCase.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.MarketplaceUseCaseDependency]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.MarketplaceUseCaseLocale]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: MarketplaceUseCase.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightMarketplaceUseCase
```
