...
```powershell
$HyperflexClusterBackupPolicyListAllOf = Initialize-IntersightHyperflexClusterBackupPolicyListAllOf  -Count null `
 -Results null
```

- Convert the resource to JSON
```powershell
$HyperflexClusterBackupPolicyListAllOf | ConvertTo-JSON
```
