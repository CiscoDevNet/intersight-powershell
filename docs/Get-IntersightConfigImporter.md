...
# Get-IntersightConfigImporter

## SYNOPSIS
Get the ConfigImporter

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightConfigImporter [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightConfigImporter [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ConfigImporter&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightConfigImporter
```
Above example returns the list of ConfigImporter.

### Example 2
```powershell
PS C:\> $result = Get-IntersightConfigImporter -Name "MoName"
```
Above example returns the ConfigImporter matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightConfigImporter -Organization $organization
```
Above example returns the list of ConfigImporter available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightConfigImporter -InlineCount allpages
```
Above example returns the list of ConfigImporter along with count.
...
### -Name
Specifies the name of the ConfigImporter.
...
### -Organization
Specifies the organization, to fetch the ConfigImporter under it.
