...
# Get-IntersightFabricSpanSession

## SYNOPSIS
Get the FabricSpanSession

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricSpanSession [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricSpanSession [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricSpanSession&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricSpanSession
```
Above example returns the list of FabricSpanSession.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricSpanSession -Name "MoName"
```
Above example returns the FabricSpanSession matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricSpanSession -Organization $organization
```
Above example returns the list of FabricSpanSession available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricSpanSession -InlineCount allpages
```
Above example returns the list of FabricSpanSession along with count.
...
### -Name
Specifies the name of the FabricSpanSession.
...
### -Organization
Specifies the organization, to fetch the FabricSpanSession under it.
