...
# Get-IntersightNetworkDiscoveredNeighbor

## SYNOPSIS
Get the NetworkDiscoveredNeighbor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkDiscoveredNeighbor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkDiscoveredNeighbor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NetworkDiscoveredNeighbor&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkDiscoveredNeighbor
```
Above example returns the list of NetworkDiscoveredNeighbor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkDiscoveredNeighbor -Name "MoName"
```
Above example returns the NetworkDiscoveredNeighbor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkDiscoveredNeighbor -Organization $organization
```
Above example returns the list of NetworkDiscoveredNeighbor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkDiscoveredNeighbor -InlineCount allpages
```
Above example returns the list of NetworkDiscoveredNeighbor along with count.
...
### -Name
Specifies the name of the NetworkDiscoveredNeighbor.
...
### -Organization
Specifies the organization, to fetch the NetworkDiscoveredNeighbor under it.
