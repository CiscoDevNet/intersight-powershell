...
# Get-IntersightIppoolShadowBlock

## SYNOPSIS
Get the IppoolShadowBlock

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIppoolShadowBlock [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIppoolShadowBlock [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IppoolShadowBlock&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIppoolShadowBlock
```
Above example returns the list of IppoolShadowBlock.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIppoolShadowBlock -Name "MoName"
```
Above example returns the IppoolShadowBlock matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIppoolShadowBlock -Organization $organization
```
Above example returns the list of IppoolShadowBlock available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIppoolShadowBlock -InlineCount allpages
```
Above example returns the list of IppoolShadowBlock along with count.
...
### -Name
Specifies the name of the IppoolShadowBlock.
...
### -Organization
Specifies the organization, to fetch the IppoolShadowBlock under it.
