...
## SYNOPSIS
Get the SoftwarerepositoryCategoryMapperModel

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwarerepositoryCategoryMapperModel [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwarerepositoryCategoryMapperModel [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SoftwarerepositoryCategoryMapperModel&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategoryMapperModel
```
Above example returns the list of SoftwarerepositoryCategoryMapperModel.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategoryMapperModel -Name "MoName"
```
Above example returns the SoftwarerepositoryCategoryMapperModel matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategoryMapperModel -Organization $organization
```
Above example returns the list of SoftwarerepositoryCategoryMapperModel available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCategoryMapperModel -InlineCount allpages
```
Above example returns the list of SoftwarerepositoryCategoryMapperModel along with count.
...
### -Name
Specifies the name of the SoftwarerepositoryCategoryMapperModel.
...
### -Organization
Specifies the organization, to fetch the SoftwarerepositoryCategoryMapperModel under it.
