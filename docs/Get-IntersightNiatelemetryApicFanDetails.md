...
## SYNOPSIS
Get the NiatelemetryApicFanDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicFanDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicFanDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetryApicFanDetails&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicFanDetails
```
Above example returns the list of NiatelemetryApicFanDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicFanDetails -Name "MoName"
```
Above example returns the NiatelemetryApicFanDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicFanDetails -Organization $organization
```
Above example returns the list of NiatelemetryApicFanDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicFanDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryApicFanDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryApicFanDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicFanDetails under it.
