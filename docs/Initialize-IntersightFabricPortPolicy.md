...
# Initialize-IntersightFabricPortPolicy
...
Initialize-IntersightFabricPortPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< FabricPortPolicy.ClassIdEnum>][-Description< string>][-DeviceModel< FabricPortPolicy.DeviceModelEnum>][-Moid< string>][-Name< string>][-ObjectType< FabricPortPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Profiles< System.Collections.Generic.List`1[Model.FabricBaseSwitchProfileRelationship]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: FabricPortPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricPortPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFabricPortPolicy
```
