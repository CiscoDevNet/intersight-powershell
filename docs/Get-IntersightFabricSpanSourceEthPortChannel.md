...
# Get-IntersightFabricSpanSourceEthPortChannel

## SYNOPSIS
Get the FabricSpanSourceEthPortChannel

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricSpanSourceEthPortChannel [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricSpanSourceEthPortChannel [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricSpanSourceEthPortChannel&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceEthPortChannel
```
Above example returns the list of FabricSpanSourceEthPortChannel.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceEthPortChannel -Name "MoName"
```
Above example returns the FabricSpanSourceEthPortChannel matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceEthPortChannel -Organization $organization
```
Above example returns the list of FabricSpanSourceEthPortChannel available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricSpanSourceEthPortChannel -InlineCount allpages
```
Above example returns the list of FabricSpanSourceEthPortChannel along with count.
...
### -Name
Specifies the name of the FabricSpanSourceEthPortChannel.
...
### -Organization
Specifies the organization, to fetch the FabricSpanSourceEthPortChannel under it.
...
[Remove-IntersightFabricSpanSourceEthPortChannel](./Remove-IntersightFabricSpanSourceEthPortChannel.md)
