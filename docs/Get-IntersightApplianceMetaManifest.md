...
# Get-IntersightApplianceMetaManifest

## SYNOPSIS
Get the ApplianceMetaManifest

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceMetaManifest [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceMetaManifest [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceMetaManifest&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceMetaManifest
```
Above example returns the list of ApplianceMetaManifest.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceMetaManifest -Name "MoName"
```
Above example returns the ApplianceMetaManifest matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceMetaManifest -Organization $organization
```
Above example returns the list of ApplianceMetaManifest available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceMetaManifest -InlineCount allpages
```
Above example returns the list of ApplianceMetaManifest along with count.
...
### -Name
Specifies the name of the ApplianceMetaManifest.
...
### -Organization
Specifies the organization, to fetch the ApplianceMetaManifest under it.
