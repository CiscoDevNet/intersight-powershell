...
Set-IntersightStorageFlexUtilPhysicalDrive [-AdditionalProperties< Dictionary<string,object>>][-BlockSize< string>][-Capacity< string>][-Controller< string>][-DrivesEnabled< string>][-Health< string>][-ManufacturerDate< string>][-ManufacturerId< string>][[-Moid]< string>][-OemId< string>][-PartitionCount< string>][-PdStatus< string>][-PhysicalDrive< string>][-PreviousFru< EquipmentFruRelationship>][-ProductName< string>][-ProductRevision< string>][-ReadErrorCount< string>][-ReadErrorThreshold< string>][-Tags< List<MoTag>>][-WriteEnabled< string>][-WriteErrorCount< string>][-WriteErrorThreshold< string>]
