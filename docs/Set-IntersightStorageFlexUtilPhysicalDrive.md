...
Set-IntersightStorageFlexUtilPhysicalDrive [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-BlockSize< string>][-Capacity< string>][-Controller< string>][-DrivesEnabled< string>][-Health< string>][-ManufacturerDate< string>][-ManufacturerId< string>][[-Moid]< string>][-OemId< string>][-PartitionCount< string>][-PdStatus< string>][-PhysicalDrive< string>][-PreviousFru< EquipmentFruRelationship>][-ProductName< string>][-ProductRevision< string>][-ReadErrorCount< string>][-ReadErrorThreshold< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-WriteEnabled< string>][-WriteErrorCount< string>][-WriteErrorThreshold< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> Set-IntersightStorageFlexUtilPhysicalDrive
```
...
[Get-IntersightStorageFlexUtilPhysicalDrive](./Get-IntersightStorageFlexUtilPhysicalDrive.md)
