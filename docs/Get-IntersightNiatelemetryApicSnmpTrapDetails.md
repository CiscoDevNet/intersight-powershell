...
## SYNOPSIS
Get the NiatelemetryApicSnmpTrapDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicSnmpTrapDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicSnmpTrapDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryApicSnmpTrapDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpTrapDetails
```
Above example returns the list of NiatelemetryApicSnmpTrapDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpTrapDetails -Name "MoName"
```
Above example returns the NiatelemetryApicSnmpTrapDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpTrapDetails -Organization $organization
```
Above example returns the list of NiatelemetryApicSnmpTrapDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpTrapDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryApicSnmpTrapDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryApicSnmpTrapDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicSnmpTrapDetails under it.
