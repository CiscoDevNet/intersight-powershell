...
### CmdletParam (Default)
```
Get-IntersightVrfVrf [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVrfVrf [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VrfVrf&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVrfVrf
```
Above example returns the list of VrfVrf.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVrfVrf -Name "MoName"
```
Above example returns the VrfVrf matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVrfVrf -Organization $organization
```
Above example returns the list of VrfVrf available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVrfVrf -InlineCount allpages
```
Above example returns the list of VrfVrf along with count.
...
### -Name
Specifies the name of the VrfVrf.
...
### -Organization
Specifies the organization, to fetch the VrfVrf under it.
