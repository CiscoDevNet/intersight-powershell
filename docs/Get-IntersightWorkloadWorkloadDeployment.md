...
## SYNOPSIS
Get the WorkloadWorkloadDeployment

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkloadWorkloadDeployment [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkloadWorkloadDeployment [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkloadWorkloadDeployment&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadDeployment
```
Above example returns the list of WorkloadWorkloadDeployment.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadDeployment -Name "MoName"
```
Above example returns the WorkloadWorkloadDeployment matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadDeployment -Organization $organization
```
Above example returns the list of WorkloadWorkloadDeployment available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadDeployment -InlineCount allpages
```
Above example returns the list of WorkloadWorkloadDeployment along with count.
...
### -Name
Specifies the name of the WorkloadWorkloadDeployment.
...
### -Organization
Specifies the organization, to fetch the WorkloadWorkloadDeployment under it.
