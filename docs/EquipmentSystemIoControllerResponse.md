...
```powershell
$EquipmentSystemIoControllerResponse = Initialize-IntersightEquipmentSystemIoControllerResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$EquipmentSystemIoControllerResponse | ConvertTo-JSON
```
