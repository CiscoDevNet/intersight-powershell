...
```powershell
$StorageFlexFlashVirtualDriveRelationship = Initialize-IntersightStorageFlexFlashVirtualDriveRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StorageFlexFlashVirtualDriveRelationship | ConvertTo-JSON
```
