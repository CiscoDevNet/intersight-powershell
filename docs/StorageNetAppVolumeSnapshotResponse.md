...
```powershell
$StorageNetAppVolumeSnapshotResponse = Initialize-IntersightStorageNetAppVolumeSnapshotResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageNetAppVolumeSnapshotResponse | ConvertTo-JSON
```
