...
## SYNOPSIS
Get the NiatelemetryDcnmModuleDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryDcnmModuleDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryDcnmModuleDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmModuleDetails
```
Above example returns the list of NiatelemetryDcnmModuleDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmModuleDetails -Name "MoName"
```
Above example returns the NiatelemetryDcnmModuleDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmModuleDetails -Organization $organization
```
Above example returns the list of NiatelemetryDcnmModuleDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmModuleDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryDcnmModuleDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryDcnmModuleDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryDcnmModuleDetails under it.
