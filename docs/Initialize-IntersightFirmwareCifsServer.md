...
Initialize-IntersightFirmwareCifsServer [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< FirmwareCifsServer.ClassIdEnum>][-FileLocation< string>][-MountOptions< FirmwareCifsServer.MountOptionsEnum>][-ObjectType< FirmwareCifsServer.ObjectTypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
