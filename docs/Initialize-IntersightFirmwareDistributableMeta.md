...
# Initialize-IntersightFirmwareDistributableMeta
...
Initialize-IntersightFirmwareDistributableMeta [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-BucketName< string>][-ClassId< FirmwareDistributableMeta.ClassIdEnum>][-FileType< FirmwareDistributableMeta.FileTypeEnum>][-FromVersion< string>][-Mdfid< string>][-Moid< string>][-ObjectType< FirmwareDistributableMeta.ObjectTypeEnum>][-SoftwareTypeId< string>][-Source< FirmwareDistributableMeta.SourceEnum>][-SupportedModels< System.Collections.Generic.List`1[string]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-ToVersion< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: FirmwareDistributableMeta.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FirmwareDistributableMeta.FileTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FirmwareDistributableMeta.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FirmwareDistributableMeta.SourceEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFirmwareDistributableMeta
```
