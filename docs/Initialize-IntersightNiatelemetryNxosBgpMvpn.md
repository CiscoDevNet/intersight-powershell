...
```yaml
Type: NiatelemetryNxosBgpMvpn.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: NiatelemetryNxosBgpMvpn.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightNiatelemetryNxosBgpMvpn
```
