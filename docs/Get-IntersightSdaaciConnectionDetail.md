...
# Get-IntersightSdaaciConnectionDetail

## SYNOPSIS
Get the SdaaciConnectionDetail

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSdaaciConnectionDetail [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSdaaciConnectionDetail [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SdaaciConnectionDetail&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSdaaciConnectionDetail
```
Above example returns the list of SdaaciConnectionDetail.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSdaaciConnectionDetail -Name "MoName"
```
Above example returns the SdaaciConnectionDetail matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSdaaciConnectionDetail -Organization $organization
```
Above example returns the list of SdaaciConnectionDetail available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSdaaciConnectionDetail -InlineCount allpages
```
Above example returns the list of SdaaciConnectionDetail along with count.
...
### -Name
Specifies the name of the SdaaciConnectionDetail.
...
### -Organization
Specifies the organization, to fetch the SdaaciConnectionDetail under it.
...
[Remove-IntersightSdaaciConnectionDetail](./Remove-IntersightSdaaciConnectionDetail.md)
