...
## SYNOPSIS
Get the FirmwareEula

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareEula [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareEula [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareEula&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareEula
```
Above example returns the list of FirmwareEula.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareEula -Name "MoName"
```
Above example returns the FirmwareEula matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareEula -Organization $organization
```
Above example returns the list of FirmwareEula available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareEula -InlineCount allpages
```
Above example returns the list of FirmwareEula along with count.
...
### -Name
Specifies the name of the FirmwareEula.
...
### -Organization
Specifies the organization, to fetch the FirmwareEula under it.
...
[New-IntersightFirmwareEula](./New-IntersightFirmwareEula.md)
