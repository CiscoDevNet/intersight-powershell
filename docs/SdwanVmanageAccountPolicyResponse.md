...
```powershell
$SdwanVmanageAccountPolicyResponse = Initialize-IntersightSdwanVmanageAccountPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SdwanVmanageAccountPolicyResponse | ConvertTo-JSON
```
