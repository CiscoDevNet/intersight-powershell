...
## SYNOPSIS
Get the StoragePureProtectionGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureProtectionGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureProtectionGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureProtectionGroup
```
Above example returns the list of StoragePureProtectionGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureProtectionGroup -Name "MoName"
```
Above example returns the StoragePureProtectionGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureProtectionGroup -Organization $organization
```
Above example returns the list of StoragePureProtectionGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureProtectionGroup -InlineCount allpages
```
Above example returns the list of StoragePureProtectionGroup along with count.
...
### -Name
Specifies the name of the StoragePureProtectionGroup.
...
### -Organization
Specifies the organization, to fetch the StoragePureProtectionGroup under it.
