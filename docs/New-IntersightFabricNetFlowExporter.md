...
# New-IntersightFabricNetFlowExporter
...
New-IntersightFabricNetFlowExporter [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Destination< string>][-Dscp< long>][-GatewayIp< string>][-Moid< string>][[-Name]< string>][-NetFlowPolicy< FabricNetFlowPolicyRelationship>][-OptionExporterStatsTimeout< long>][-OptionInterfaceTableTimeout< long>][-SourceInterface< FabricVlanExportInterface>][-Tags< System.Collections.Generic.List`1[MoTag]>][-TemplateDataTimeout< long>][-UdpPort< long>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;FabricNetFlowExporter&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightFabricNetFlowExporter
```
