...
# Initialize-IntersightOprsDeployment
...
Initialize-IntersightOprsDeployment [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Assist< Model.AssetDeviceRegistrationRelationship>][-AvailableReplicas< long>][-ClassId< OprsDeployment.ClassIdEnum>][-DesiredReplicas< long>][-Event< string>][-Labels< System.Collections.Generic.List`1[Model.OprsKvpair]>][-Moid< string>][-Name< string>][-Namespace< string>][-ObjectType< OprsDeployment.ObjectTypeEnum>][-Status< OprsDeployment.StatusEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TimeStamp< DateTime>][-UnavailableReplicas< long>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: OprsDeployment.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.OprsKvpair]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: OprsDeployment.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightOprsDeployment
```
