...
# Get-IntersightNiatelemetryClusterNode

## SYNOPSIS
Get the NiatelemetryClusterNode

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryClusterNode [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryClusterNode [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryClusterNode&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryClusterNode
```
Above example returns the list of NiatelemetryClusterNode.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryClusterNode -Name "MoName"
```
Above example returns the NiatelemetryClusterNode matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryClusterNode -Organization $organization
```
Above example returns the list of NiatelemetryClusterNode available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryClusterNode -InlineCount allpages
```
Above example returns the list of NiatelemetryClusterNode along with count.
...
### -Name
Specifies the name of the NiatelemetryClusterNode.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryClusterNode under it.
