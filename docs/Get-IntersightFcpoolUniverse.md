...
## SYNOPSIS
Get the FcpoolUniverse

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFcpoolUniverse [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFcpoolUniverse [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FcpoolUniverse&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFcpoolUniverse
```
Above example returns the list of FcpoolUniverse.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFcpoolUniverse -Name "MoName"
```
Above example returns the FcpoolUniverse matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFcpoolUniverse -Organization $organization
```
Above example returns the list of FcpoolUniverse available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFcpoolUniverse -InlineCount allpages
```
Above example returns the list of FcpoolUniverse along with count.
...
### -Name
Specifies the name of the FcpoolUniverse.
...
### -Organization
Specifies the organization, to fetch the FcpoolUniverse under it.
