...
```powershell
$StorageFlexFlashPhysicalDriveResponse = Initialize-IntersightStorageFlexFlashPhysicalDriveResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageFlexFlashPhysicalDriveResponse | ConvertTo-JSON
```
