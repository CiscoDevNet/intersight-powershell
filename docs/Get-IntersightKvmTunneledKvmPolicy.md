...
# Get-IntersightKvmTunneledKvmPolicy

## SYNOPSIS
Get the KvmTunneledKvmPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKvmTunneledKvmPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKvmTunneledKvmPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KvmTunneledKvmPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKvmTunneledKvmPolicy
```
Above example returns the list of KvmTunneledKvmPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKvmTunneledKvmPolicy -Name "MoName"
```
Above example returns the KvmTunneledKvmPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKvmTunneledKvmPolicy -Organization $organization
```
Above example returns the list of KvmTunneledKvmPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKvmTunneledKvmPolicy -InlineCount allpages
```
Above example returns the list of KvmTunneledKvmPolicy along with count.
...
### -Name
Specifies the name of the KvmTunneledKvmPolicy.
...
### -Organization
Specifies the organization, to fetch the KvmTunneledKvmPolicy under it.
