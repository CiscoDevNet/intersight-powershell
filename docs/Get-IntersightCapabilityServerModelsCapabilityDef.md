...
### CmdletParam (Default)
```
Get-IntersightCapabilityServerModelsCapabilityDef [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityServerModelsCapabilityDef [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityServerModelsCapabilityDef
```
Above example returns the list of CapabilityServerModelsCapabilityDef.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityServerModelsCapabilityDef -Name "MoName"
```
Above example returns the CapabilityServerModelsCapabilityDef matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityServerModelsCapabilityDef -Organization $organization
```
Above example returns the list of CapabilityServerModelsCapabilityDef available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityServerModelsCapabilityDef -InlineCount allpages
```
Above example returns the list of CapabilityServerModelsCapabilityDef along with count.
...
### -Name
Specifies the name of the CapabilityServerModelsCapabilityDef.
...
### -Organization
Specifies the organization, to fetch the CapabilityServerModelsCapabilityDef under it.
