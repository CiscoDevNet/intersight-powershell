...
## SYNOPSIS
Get the StorageNetAppSvmEvent

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppSvmEvent [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppSvmEvent [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppSvmEvent&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSvmEvent
```
Above example returns the list of StorageNetAppSvmEvent.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSvmEvent -Name "MoName"
```
Above example returns the StorageNetAppSvmEvent matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSvmEvent -Organization $organization
```
Above example returns the list of StorageNetAppSvmEvent available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSvmEvent -InlineCount allpages
```
Above example returns the list of StorageNetAppSvmEvent along with count.
...
### -Name
Specifies the name of the StorageNetAppSvmEvent.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppSvmEvent under it.
