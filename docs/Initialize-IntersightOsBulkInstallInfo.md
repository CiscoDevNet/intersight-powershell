...
# Initialize-IntersightOsBulkInstallInfo
...
Initialize-IntersightOsBulkInstallInfo [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< OsBulkInstallInfo.ClassIdEnum>][-ConfigurationFile< Model.OsConfigurationFileRelationship>][-FileContent< string>][-Moid< string>][-Name< string>][-ObjectType< OsBulkInstallInfo.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-OsImage< Model.SoftwarerepositoryOperatingSystemFileRelationship>][-ScuImage< Model.FirmwareServerConfigurationUtilityDistributableRelationship>][-Servers< System.Collections.Generic.List`1[Model.ComputePhysicalRelationship]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-ValidationInfos< System.Collections.Generic.List`1[Model.OsValidationInformation]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: OsBulkInstallInfo.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: OsBulkInstallInfo.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.OsValidationInformation]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightOsBulkInstallInfo
```
