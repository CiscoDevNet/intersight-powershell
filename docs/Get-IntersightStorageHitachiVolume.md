...
## SYNOPSIS
Get the StorageHitachiVolume

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiVolume [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiVolume [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiVolume&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiVolume
```
Above example returns the list of StorageHitachiVolume.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiVolume -Name "MoName"
```
Above example returns the StorageHitachiVolume matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiVolume -Organization $organization
```
Above example returns the list of StorageHitachiVolume available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiVolume -InlineCount allpages
```
Above example returns the list of StorageHitachiVolume along with count.
...
### -Name
Specifies the name of the StorageHitachiVolume.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiVolume under it.
