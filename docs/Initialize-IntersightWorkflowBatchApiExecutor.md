...
# Initialize-IntersightWorkflowBatchApiExecutor
...
```yaml
Type: WorkflowBatchApiExecutor.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowBatchApiExecutor.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowBatchApiExecutor
```
