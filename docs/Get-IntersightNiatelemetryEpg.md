...
### CmdletParam (Default)
```
Get-IntersightNiatelemetryEpg [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryEpg [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryEpg&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryEpg
```
Above example returns the list of NiatelemetryEpg.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryEpg -Name "MoName"
```
Above example returns the NiatelemetryEpg matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryEpg -Organization $organization
```
Above example returns the list of NiatelemetryEpg available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryEpg -InlineCount allpages
```
Above example returns the list of NiatelemetryEpg along with count.
...
### -Name
Specifies the name of the NiatelemetryEpg.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryEpg under it.
