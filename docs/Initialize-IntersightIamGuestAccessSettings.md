...
# Initialize-IntersightIamGuestAccessSettings
...
Initialize-IntersightIamGuestAccessSettings [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AllowedDomainNames< System.Collections.Generic.List`1[string]>][-ClassId< IamGuestAccessSettings.ClassIdEnum>][-MaxGuestAccessLinkShelfLife< long>][-Moid< string>][-ObjectType< IamGuestAccessSettings.ObjectTypeEnum>][-OverrideIpAccessRestriction< bool>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: IamGuestAccessSettings.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IamGuestAccessSettings.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIamGuestAccessSettings
```
