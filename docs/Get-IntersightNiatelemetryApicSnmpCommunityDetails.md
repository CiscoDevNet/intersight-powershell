...
## SYNOPSIS
Get the NiatelemetryApicSnmpCommunityDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicSnmpCommunityDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicSnmpCommunityDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpCommunityDetails
```
Above example returns the list of NiatelemetryApicSnmpCommunityDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpCommunityDetails -Name "MoName"
```
Above example returns the NiatelemetryApicSnmpCommunityDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpCommunityDetails -Organization $organization
```
Above example returns the list of NiatelemetryApicSnmpCommunityDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicSnmpCommunityDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryApicSnmpCommunityDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryApicSnmpCommunityDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicSnmpCommunityDetails under it.
