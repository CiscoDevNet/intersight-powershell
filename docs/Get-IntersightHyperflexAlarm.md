...
# Get-IntersightHyperflexAlarm

## SYNOPSIS
Get the HyperflexAlarm

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexAlarm [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexAlarm [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexAlarm&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexAlarm
```
Above example returns the list of HyperflexAlarm.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexAlarm -Name "MoName"
```
Above example returns the HyperflexAlarm matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexAlarm -Organization $organization
```
Above example returns the list of HyperflexAlarm available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexAlarm -InlineCount allpages
```
Above example returns the list of HyperflexAlarm along with count.
...
### -Name
Specifies the name of the HyperflexAlarm.
...
### -Organization
Specifies the organization, to fetch the HyperflexAlarm under it.
