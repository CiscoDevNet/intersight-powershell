...
Initialize-IntersightBootVirtualMedia [-AdditionalProperties< Dictionary<string,object>>][-ClassId< BootVirtualMedia.ClassIdEnum>][-Enabled< bool>][-Name< string>][-ObjectType< BootVirtualMedia.ObjectTypeEnum>][-Subtype< BootVirtualMedia.SubtypeEnum>]
