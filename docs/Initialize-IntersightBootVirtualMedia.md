...
Initialize-IntersightBootVirtualMedia [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< BootVirtualMedia.ClassIdEnum>][-Enabled< bool>][-Name< string>][-ObjectType< BootVirtualMedia.ObjectTypeEnum>][-Subtype< BootVirtualMedia.SubtypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: BootVirtualMedia.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: BootVirtualMedia.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: BootVirtualMedia.SubtypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightBootVirtualMedia
```
