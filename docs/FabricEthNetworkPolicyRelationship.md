...
```powershell
$FabricEthNetworkPolicyRelationship = Initialize-IntersightFabricEthNetworkPolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$FabricEthNetworkPolicyRelationship | ConvertTo-JSON
```
