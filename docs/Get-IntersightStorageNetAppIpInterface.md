...
## SYNOPSIS
Get the StorageNetAppIpInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppIpInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppIpInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppIpInterface&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppIpInterface
```
Above example returns the list of StorageNetAppIpInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppIpInterface -Name "MoName"
```
Above example returns the StorageNetAppIpInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppIpInterface -Organization $organization
```
Above example returns the list of StorageNetAppIpInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppIpInterface -InlineCount allpages
```
Above example returns the list of StorageNetAppIpInterface along with count.
...
### -Name
Specifies the name of the StorageNetAppIpInterface.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppIpInterface under it.
