...
### CmdletParam (Default)
```
Get-IntersightPciDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPciDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PciDevice&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPciDevice
```
Above example returns the list of PciDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPciDevice -Name "MoName"
```
Above example returns the PciDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPciDevice -Organization $organization
```
Above example returns the list of PciDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPciDevice -InlineCount allpages
```
Above example returns the list of PciDevice along with count.
...
### -Name
Specifies the name of the PciDevice.
...
### -Organization
Specifies the organization, to fetch the PciDevice under it.
...
[Set-IntersightPciDevice](./Set-IntersightPciDevice.md)
