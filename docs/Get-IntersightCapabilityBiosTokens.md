...
# Get-IntersightCapabilityBiosTokens

## SYNOPSIS
Get the CapabilityBiosTokens

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityBiosTokens [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityBiosTokens [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilityBiosTokens&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityBiosTokens
```
Above example returns the list of CapabilityBiosTokens.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityBiosTokens -Name "MoName"
```
Above example returns the CapabilityBiosTokens matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityBiosTokens -Organization $organization
```
Above example returns the list of CapabilityBiosTokens available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityBiosTokens -InlineCount allpages
```
Above example returns the list of CapabilityBiosTokens along with count.
...
### -Name
Specifies the name of the CapabilityBiosTokens.
...
### -Organization
Specifies the organization, to fetch the CapabilityBiosTokens under it.
