...
### CmdletParam (Default)
```
Get-IntersightFirmwarePolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwarePolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwarePolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwarePolicy
```
Above example returns the list of FirmwarePolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwarePolicy -Name "MoName"
```
Above example returns the FirmwarePolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwarePolicy -Organization $organization
```
Above example returns the list of FirmwarePolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwarePolicy -InlineCount allpages
```
Above example returns the list of FirmwarePolicy along with count.
...
### -Name
Specifies the name of the FirmwarePolicy.
...
### -Organization
Specifies the organization, to fetch the FirmwarePolicy under it.
...
[Remove-IntersightFirmwarePolicy](./Remove-IntersightFirmwarePolicy.md)
