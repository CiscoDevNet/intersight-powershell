...
## SYNOPSIS
Get the RecommendationHardwareExpansionRequestItem

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRecommendationHardwareExpansionRequestItem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRecommendationHardwareExpansionRequestItem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;RecommendationHardwareExpansionRequestItem&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRecommendationHardwareExpansionRequestItem
```
Above example returns the list of RecommendationHardwareExpansionRequestItem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRecommendationHardwareExpansionRequestItem -Name "MoName"
```
Above example returns the RecommendationHardwareExpansionRequestItem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRecommendationHardwareExpansionRequestItem -Organization $organization
```
Above example returns the list of RecommendationHardwareExpansionRequestItem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRecommendationHardwareExpansionRequestItem -InlineCount allpages
```
Above example returns the list of RecommendationHardwareExpansionRequestItem along with count.
...
### -Name
Specifies the name of the RecommendationHardwareExpansionRequestItem.
...
### -Organization
Specifies the organization, to fetch the RecommendationHardwareExpansionRequestItem under it.
