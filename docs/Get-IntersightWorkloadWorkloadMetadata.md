...
# Get-IntersightWorkloadWorkloadMetadata

## SYNOPSIS
Get the WorkloadWorkloadMetadata

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkloadWorkloadMetadata [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkloadWorkloadMetadata [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkloadWorkloadMetadata&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadMetadata
```
Above example returns the list of WorkloadWorkloadMetadata.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadMetadata -Name "MoName"
```
Above example returns the WorkloadWorkloadMetadata matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadMetadata -Organization $organization
```
Above example returns the list of WorkloadWorkloadMetadata available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadMetadata -InlineCount allpages
```
Above example returns the list of WorkloadWorkloadMetadata along with count.
...
### -Name
Specifies the name of the WorkloadWorkloadMetadata.
...
### -Organization
Specifies the organization, to fetch the WorkloadWorkloadMetadata under it.
...
[Set-IntersightWorkloadWorkloadMetadata](./Set-IntersightWorkloadWorkloadMetadata.md)
