...
### CmdletParam (Default)
```
Get-IntersightPciLink [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPciLink [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPciLink
```
Above example returns the list of PciLink.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPciLink -Name "MoName"
```
Above example returns the PciLink matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPciLink -Organization $organization
```
Above example returns the list of PciLink available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPciLink -InlineCount allpages
```
Above example returns the list of PciLink along with count.
...
### -Name
Specifies the name of the PciLink.
...
### -Organization
Specifies the organization, to fetch the PciLink under it.
...
[Set-IntersightPciLink](./Set-IntersightPciLink.md)
