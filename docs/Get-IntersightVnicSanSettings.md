...
# Get-IntersightVnicSanSettings

## SYNOPSIS
Get the VnicSanSettings

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicSanSettings [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicSanSettings [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicSanSettings&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicSanSettings
```
Above example returns the list of VnicSanSettings.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicSanSettings -Name "MoName"
```
Above example returns the VnicSanSettings matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicSanSettings -Organization $organization
```
Above example returns the list of VnicSanSettings available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicSanSettings -InlineCount allpages
```
Above example returns the list of VnicSanSettings along with count.
...
### -Name
Specifies the name of the VnicSanSettings.
...
### -Organization
Specifies the organization, to fetch the VnicSanSettings under it.
