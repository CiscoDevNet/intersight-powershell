...
# Get-IntersightHyperflexHxapHost

## SYNOPSIS
Get the HyperflexHxapHost

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHxapHost [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHxapHost [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHxapHost&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapHost
```
Above example returns the list of HyperflexHxapHost.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapHost -Name "MoName"
```
Above example returns the HyperflexHxapHost matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapHost -Organization $organization
```
Above example returns the list of HyperflexHxapHost available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapHost -InlineCount allpages
```
Above example returns the list of HyperflexHxapHost along with count.
...
### -Name
Specifies the name of the HyperflexHxapHost.
...
### -Organization
Specifies the organization, to fetch the HyperflexHxapHost under it.
...
[Set-IntersightHyperflexHxapHost](./Set-IntersightHyperflexHxapHost.md)
