...
New-IntersightKubernetesVirtualMachineNodeProfile [-Action< string>][-ActionParams< System.Collections.Generic.List`1[PolicyActionParam]>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-CloudProvider< KubernetesVirtualMachineNodeProfile.CloudProviderEnum>][-ConfigContext< PolicyConfigContext>][-Description< string>][-Interfaces< System.Collections.Generic.List`1[KubernetesEthernet]>][-IpAddresses< System.Collections.Generic.List`1[IppoolIpLeaseRelationship]>][-Moid< string>][[-Name]< string>][-NodeGroup< KubernetesNodeGroupProfileRelationship>][-PolicyBucket< System.Collections.Generic.List`1[PolicyAbstractPolicyRelationship]>][-ScheduledActions< System.Collections.Generic.List`1[PolicyScheduledAction]>][-SrcTemplate< PolicyAbstractProfileRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Target< AssetDeviceRegistrationRelationship>][-Type< KubernetesVirtualMachineNodeProfile.TypeEnum>][-VirtualMachine< VirtualizationVirtualMachineRelationship>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> New-IntersightKubernetesVirtualMachineNodeProfile
```
