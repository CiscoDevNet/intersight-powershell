...
```powershell
$CapabilitySiocModuleCapabilityDefList = Initialize-IntersightCapabilitySiocModuleCapabilityDefList  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilitySiocModuleCapabilityDefList | ConvertTo-JSON
```
