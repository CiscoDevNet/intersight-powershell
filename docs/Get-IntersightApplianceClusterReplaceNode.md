...
# Get-IntersightApplianceClusterReplaceNode

## SYNOPSIS
Get the ApplianceClusterReplaceNode

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceClusterReplaceNode [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceClusterReplaceNode [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceClusterReplaceNode&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceClusterReplaceNode
```
Above example returns the list of ApplianceClusterReplaceNode.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceClusterReplaceNode -Name "MoName"
```
Above example returns the ApplianceClusterReplaceNode matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceClusterReplaceNode -Organization $organization
```
Above example returns the list of ApplianceClusterReplaceNode available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceClusterReplaceNode -InlineCount allpages
```
Above example returns the list of ApplianceClusterReplaceNode along with count.
...
### -Name
Specifies the name of the ApplianceClusterReplaceNode.
...
### -Organization
Specifies the organization, to fetch the ApplianceClusterReplaceNode under it.
...
[New-IntersightApplianceClusterReplaceNode](./New-IntersightApplianceClusterReplaceNode.md)

[Set-IntersightApplianceClusterReplaceNode](./Set-IntersightApplianceClusterReplaceNode.md)
