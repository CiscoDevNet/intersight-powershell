...
# Create a 'license.LicenseInfo' resource.
try {
    LicenseLicenseInfo $Result = New-IntersightLicenseLicenseInfo -LicenseLicenseInfo $LicenseLicenseInfo -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
...
$LicenseLicenseReservationOp = (Initialize-license.LicenseReservationOp-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -AuthCode "AuthCode_example" -AuthCodeInstalled $false -ConfirmCode "ConfirmCode_example" -GenerateRequestCode $false -GenerateReturnCode $false -RequestCode "RequestCode_example" -ReturnCode "ReturnCode_example" -Account ) # LicenseLicenseReservationOp | The 'license.LicenseReservationOp' resource to create.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
$IfNoneMatch = "IfNoneMatch_example" # String | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)

# Create a 'license.LicenseReservationOp' resource.
try {
    LicenseLicenseReservationOp $Result = New-IntersightLicenseLicenseReservationOp -LicenseLicenseReservationOp $LicenseLicenseReservationOp -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
...
# Read a 'license.AccountLicenseData' resource.
try {
    LicenseAccountLicenseData $Result = Get-IntersightLicenseAccountLicenseDataByMoid -Moid $Moid
} catch {
...
# Read a 'license.AccountLicenseData' resource.
try {
    LicenseAccountLicenseDataResponse $Result = Get-IntersightLicenseAccountLicenseDataList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'license.CustomerOp' resource.
try {
    LicenseCustomerOp $Result = Get-IntersightLicenseCustomerOpByMoid -Moid $Moid
} catch {
...
# Read a 'license.CustomerOp' resource.
try {
    LicenseCustomerOpResponse $Result = Get-IntersightLicenseCustomerOpList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'license.LicenseInfo' resource.
try {
    LicenseLicenseInfo $Result = Get-IntersightLicenseLicenseInfoByMoid -Moid $Moid
} catch {
...
# Read a 'license.LicenseInfo' resource.
try {
    LicenseLicenseInfoResponse $Result = Get-IntersightLicenseLicenseInfoList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'license.LicenseReservationOp' resource.
try {
    LicenseLicenseReservationOp $Result = Get-IntersightLicenseLicenseReservationOpByMoid -Moid $Moid
} catch {
...
# Read a 'license.LicenseReservationOp' resource.
try {
    LicenseLicenseReservationOpResponse $Result = Get-IntersightLicenseLicenseReservationOpList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'license.SmartlicenseToken' resource.
try {
    LicenseSmartlicenseToken $Result = Get-IntersightLicenseSmartlicenseTokenByMoid -Moid $Moid
} catch {
...
# Read a 'license.SmartlicenseToken' resource.
try {
    LicenseSmartlicenseTokenResponse $Result = Get-IntersightLicenseSmartlicenseTokenList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$LicenseAccountLicenseData = (Initialize-license.AccountLicenseData-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -AccountId "AccountId_example" -AgentData "AgentData_example" -AuthExpireTime "AuthExpireTime_example" -AuthInitialTime "AuthInitialTime_example" -AuthNextTime "AuthNextTime_example" -Category "Category_example" -DefaultLicenseType "DefaultLicenseType_example" -ErrorDesc "ErrorDesc_example" -Group "Group_example" -HighestCompliantLicenseTier "HighestCompliantLicenseTier_example" -LastSync Get-Date -LastUpdatedTime Get-Date -LicenseState "LicenseState_example" -LicenseTechSupportInfo "LicenseTechSupportInfo_example" -RegisterExpireTime "RegisterExpireTime_example" -RegisterInitialTime "RegisterInitialTime_example" -RegisterNextTime "RegisterNextTime_example" -RegistrationStatus "RegistrationStatus_example" -RenewFailureString "RenewFailureString_example" -SmartAccount "SmartAccount_example" -SyncStatus "SyncStatus_example" -VirtualAccount "VirtualAccount_example" -Account  -CustomerOp  -Licenseinfos @() -SmartlicenseToken ) # LicenseAccountLicenseData | The 'license.AccountLicenseData' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'license.AccountLicenseData' resource.
try {
    LicenseAccountLicenseData $Result = Set-IntersightLicenseAccountLicenseData -Moid $Moid -LicenseAccountLicenseData $LicenseAccountLicenseData -IfMatch $IfMatch
} catch {
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$LicenseCustomerOp = (Initialize-license.CustomerOp-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -ActiveAdmin $false -DeregisterDevice $false -EnableTrial $false -EvaluationPeriod 123 -ExtraEvaluation 123 -RenewAuthorization $false -RenewIdCertificate $false -ShowAgentTechSupport $false -AccountLicenseData ) # LicenseCustomerOp | The 'license.CustomerOp' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'license.CustomerOp' resource.
try {
    LicenseCustomerOp $Result = Set-IntersightLicenseCustomerOp -Moid $Moid -LicenseCustomerOp $LicenseCustomerOp -IfMatch $IfMatch
} catch {
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$LicenseLicenseInfo = (Initialize-license.LicenseInfo-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -ActiveAdmin $false -DaysLeft 123 -EndTime Get-Date -EnforceMode "EnforceMode_example" -ErrorDesc "ErrorDesc_example" -EvaluationPeriod 123 -ExtraEvaluation 123 -LicenseCount 123 -LicenseState "LicenseState_example" -LicenseType "LicenseType_example" -StartTime Get-Date -TrialAdmin $false -AccountLicenseData ) # LicenseLicenseInfo | The 'license.LicenseInfo' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'license.LicenseInfo' resource.
try {
    LicenseLicenseInfo $Result = Set-IntersightLicenseLicenseInfo -Moid $Moid -LicenseLicenseInfo $LicenseLicenseInfo -IfMatch $IfMatch
} catch {
...
# Update a 'license.LicenseReservationOp' resource.
try {
    LicenseLicenseReservationOp $Result = Set-IntersightLicenseLicenseReservationOp -Moid $Moid -LicenseLicenseReservationOp $LicenseLicenseReservationOp -IfMatch $IfMatch
} catch {
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$LicenseSmartlicenseToken = (Initialize-license.SmartlicenseToken-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Token "Token_example" -AccountLicenseData ) # LicenseSmartlicenseToken | The 'license.SmartlicenseToken' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'license.SmartlicenseToken' resource.
try {
    LicenseSmartlicenseToken $Result = Set-IntersightLicenseSmartlicenseToken -Moid $Moid -LicenseSmartlicenseToken $LicenseSmartlicenseToken -IfMatch $IfMatch
} catch {
...
# Update a 'license.AccountLicenseData' resource.
try {
    LicenseAccountLicenseData $Result = Update-IntersightLicenseAccountLicenseData -Moid $Moid -LicenseAccountLicenseData $LicenseAccountLicenseData -IfMatch $IfMatch
} catch {
...
# Update a 'license.CustomerOp' resource.
try {
    LicenseCustomerOp $Result = Update-IntersightLicenseCustomerOp -Moid $Moid -LicenseCustomerOp $LicenseCustomerOp -IfMatch $IfMatch
} catch {
...
# Update a 'license.LicenseInfo' resource.
try {
    LicenseLicenseInfo $Result = Update-IntersightLicenseLicenseInfo -Moid $Moid -LicenseLicenseInfo $LicenseLicenseInfo -IfMatch $IfMatch
} catch {
...
# Update a 'license.LicenseReservationOp' resource.
try {
    LicenseLicenseReservationOp $Result = Update-IntersightLicenseLicenseReservationOp -Moid $Moid -LicenseLicenseReservationOp $LicenseLicenseReservationOp -IfMatch $IfMatch
} catch {
...
# Update a 'license.SmartlicenseToken' resource.
try {
    LicenseSmartlicenseToken $Result = Update-IntersightLicenseSmartlicenseToken -Moid $Moid -LicenseSmartlicenseToken $LicenseSmartlicenseToken -IfMatch $IfMatch
} catch {
