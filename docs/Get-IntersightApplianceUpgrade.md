...
## SYNOPSIS
Get the ApplianceUpgrade

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceUpgrade [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceUpgrade [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceUpgrade
```
Above example returns the list of ApplianceUpgrade.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceUpgrade -Name "MoName"
```
Above example returns the ApplianceUpgrade matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceUpgrade -Organization $organization
```
Above example returns the list of ApplianceUpgrade available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceUpgrade -InlineCount allpages
```
Above example returns the list of ApplianceUpgrade along with count.
...
### -Name
Specifies the name of the ApplianceUpgrade.
...
### -Organization
Specifies the organization, to fetch the ApplianceUpgrade under it.
