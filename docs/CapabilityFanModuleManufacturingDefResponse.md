...
```powershell
$CapabilityFanModuleManufacturingDefResponse = Initialize-IntersightCapabilityFanModuleManufacturingDefResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilityFanModuleManufacturingDefResponse | ConvertTo-JSON
```
