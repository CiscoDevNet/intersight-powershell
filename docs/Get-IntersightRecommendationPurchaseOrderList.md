...
# Get-IntersightRecommendationPurchaseOrderList

## SYNOPSIS
Get the RecommendationPurchaseOrderList

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRecommendationPurchaseOrderList [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRecommendationPurchaseOrderList [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;RecommendationPurchaseOrderList&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRecommendationPurchaseOrderList
```
Above example returns the list of RecommendationPurchaseOrderList.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRecommendationPurchaseOrderList -Name "MoName"
```
Above example returns the RecommendationPurchaseOrderList matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRecommendationPurchaseOrderList -Organization $organization
```
Above example returns the list of RecommendationPurchaseOrderList available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRecommendationPurchaseOrderList -InlineCount allpages
```
Above example returns the list of RecommendationPurchaseOrderList along with count.
...
### -Name
Specifies the name of the RecommendationPurchaseOrderList.
...
### -Organization
Specifies the organization, to fetch the RecommendationPurchaseOrderList under it.
