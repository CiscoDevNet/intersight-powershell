...
## SYNOPSIS
Get the NiatelemetrySyslogSysMsg

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetrySyslogSysMsg [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetrySyslogSysMsg [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetrySyslogSysMsg&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySyslogSysMsg
```
Above example returns the list of NiatelemetrySyslogSysMsg.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySyslogSysMsg -Name "MoName"
```
Above example returns the NiatelemetrySyslogSysMsg matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySyslogSysMsg -Organization $organization
```
Above example returns the list of NiatelemetrySyslogSysMsg available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySyslogSysMsg -InlineCount allpages
```
Above example returns the list of NiatelemetrySyslogSysMsg along with count.
...
### -Name
Specifies the name of the NiatelemetrySyslogSysMsg.
...
### -Organization
Specifies the organization, to fetch the NiatelemetrySyslogSysMsg under it.
