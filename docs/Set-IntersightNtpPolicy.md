...
Set-IntersightNtpPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ApplianceAccount< IamAccountRelationship>][-AuthenticatedNtpServers< System.Collections.Generic.List`1[NtpAuthNtpServer]>][-Description< string>][-Enabled< bool>][[-Moid]< string>][-Name< string>][-NtpServers< System.Collections.Generic.List`1[string]>][-Organization< OrganizationOrganizationRelationship>][-Profiles< System.Collections.Generic.List`1[PolicyAbstractConfigProfileRelationship]>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Timezone< NtpPolicy.TimezoneEnum>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
