...
Set-IntersightFabricSystemQosPolicy [-AdditionalProperties< Dictionary<string,object>>][-Classes< List<FabricQosClass>>][-Description< string>][[-Moid]< string>][-Name< string>][-Organization< OrganizationOrganizationRelationship>][-Profiles< List<FabricSwitchProfileRelationship>>][-Tags< List<MoTag>>]
...
### Example 1
```powershell
PS C:\> Set-IntersightFabricSystemQosPolicy
```
