...
```powershell
$AssetDeviceContractInformationResponse = Initialize-IntersightAssetDeviceContractInformationResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$AssetDeviceContractInformationResponse | ConvertTo-JSON
```
