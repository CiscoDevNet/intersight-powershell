...
# Initialize-IntersightBulkMoMerger
...
Initialize-IntersightBulkMoMerger [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< BulkMoMerger.ClassIdEnum>][-MergeAction< BulkMoMerger.MergeActionEnum>][-Moid< string>][-ObjectType< BulkMoMerger.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Sources< System.Collections.Generic.List`1[Model.MoBaseMo]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TargetConfig< Model.MoBaseMo>][-Targets< System.Collections.Generic.List`1[Model.MoBaseMo]>][-WorkflowNameSuffix< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: BulkMoMerger.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightBulkMoMerger
```
