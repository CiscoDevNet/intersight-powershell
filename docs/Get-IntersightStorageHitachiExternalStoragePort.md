...
# Get-IntersightStorageHitachiExternalStoragePort

## SYNOPSIS
Get the StorageHitachiExternalStoragePort

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiExternalStoragePort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiExternalStoragePort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiExternalStoragePort&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalStoragePort
```
Above example returns the list of StorageHitachiExternalStoragePort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalStoragePort -Name "MoName"
```
Above example returns the StorageHitachiExternalStoragePort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalStoragePort -Organization $organization
```
Above example returns the list of StorageHitachiExternalStoragePort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalStoragePort -InlineCount allpages
```
Above example returns the list of StorageHitachiExternalStoragePort along with count.
...
### -Name
Specifies the name of the StorageHitachiExternalStoragePort.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiExternalStoragePort under it.
