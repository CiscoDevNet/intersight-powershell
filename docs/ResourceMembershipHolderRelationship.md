...
```powershell
$ResourceMembershipHolderRelationship = Initialize-IntersightResourceMembershipHolderRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$ResourceMembershipHolderRelationship | ConvertTo-JSON
```
