...
# Get-IntersightVirtualizationVmwareProactiveHa

## SYNOPSIS
Get the VirtualizationVmwareProactiveHa

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareProactiveHa [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareProactiveHa [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareProactiveHa&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareProactiveHa
```
Above example returns the list of VirtualizationVmwareProactiveHa.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareProactiveHa -Name "MoName"
```
Above example returns the VirtualizationVmwareProactiveHa matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareProactiveHa -Organization $organization
```
Above example returns the list of VirtualizationVmwareProactiveHa available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareProactiveHa -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareProactiveHa along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareProactiveHa.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareProactiveHa under it.
