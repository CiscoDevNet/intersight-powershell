...
# Get-IntersightEtherLanPort

## SYNOPSIS
Get the EtherLanPort

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEtherLanPort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEtherLanPort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EtherLanPort&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEtherLanPort
```
Above example returns the list of EtherLanPort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEtherLanPort -Name "MoName"
```
Above example returns the EtherLanPort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEtherLanPort -Organization $organization
```
Above example returns the list of EtherLanPort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEtherLanPort -InlineCount allpages
```
Above example returns the list of EtherLanPort along with count.
...
### -Name
Specifies the name of the EtherLanPort.
...
### -Organization
Specifies the organization, to fetch the EtherLanPort under it.
