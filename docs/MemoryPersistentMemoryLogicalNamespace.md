...
```powershell
$MemoryPersistentMemoryLogicalNamespace = Initialize-IntersightMemoryPersistentMemoryLogicalNamespace  -ClassId null `
 -ObjectType null `
 -Capacity null `
 -Mode null `
 -Name null `
...
```powershell
$MemoryPersistentMemoryLogicalNamespace | ConvertTo-JSON
```
