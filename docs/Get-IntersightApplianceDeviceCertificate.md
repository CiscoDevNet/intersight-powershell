...
## SYNOPSIS
Get the ApplianceDeviceCertificate

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceDeviceCertificate [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceDeviceCertificate [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceDeviceCertificate&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceCertificate
```
Above example returns the list of ApplianceDeviceCertificate.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceCertificate -Name "MoName"
```
Above example returns the ApplianceDeviceCertificate matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceCertificate -Organization $organization
```
Above example returns the list of ApplianceDeviceCertificate available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceDeviceCertificate -InlineCount allpages
```
Above example returns the list of ApplianceDeviceCertificate along with count.
...
### -Name
Specifies the name of the ApplianceDeviceCertificate.
...
### -Organization
Specifies the organization, to fetch the ApplianceDeviceCertificate under it.
