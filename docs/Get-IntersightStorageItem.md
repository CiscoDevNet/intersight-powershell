...
### CmdletParam (Default)
```
Get-IntersightStorageItem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageItem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageItem
```
Above example returns the list of StorageItem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageItem -Name "MoName"
```
Above example returns the StorageItem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageItem -Organization $organization
```
Above example returns the list of StorageItem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageItem -InlineCount allpages
```
Above example returns the list of StorageItem along with count.
...
### -Name
Specifies the name of the StorageItem.
...
### -Organization
Specifies the organization, to fetch the StorageItem under it.
