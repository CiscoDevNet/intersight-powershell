...
# Get-IntersightComputeServerPowerParameters

## SYNOPSIS
Get the ComputeServerPowerParameters

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputeServerPowerParameters [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputeServerPowerParameters [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ComputeServerPowerParameters&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputeServerPowerParameters
```
Above example returns the list of ComputeServerPowerParameters.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputeServerPowerParameters -Name "MoName"
```
Above example returns the ComputeServerPowerParameters matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputeServerPowerParameters -Organization $organization
```
Above example returns the list of ComputeServerPowerParameters available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputeServerPowerParameters -InlineCount allpages
```
Above example returns the list of ComputeServerPowerParameters along with count.
...
### -Name
Specifies the name of the ComputeServerPowerParameters.
...
### -Organization
Specifies the organization, to fetch the ComputeServerPowerParameters under it.
