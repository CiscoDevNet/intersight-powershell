...
# Get-IntersightMgmtOrgBackupOperation

## SYNOPSIS
Get the MgmtOrgBackupOperation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMgmtOrgBackupOperation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMgmtOrgBackupOperation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MgmtOrgBackupOperation&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMgmtOrgBackupOperation
```
Above example returns the list of MgmtOrgBackupOperation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMgmtOrgBackupOperation -Name "MoName"
```
Above example returns the MgmtOrgBackupOperation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMgmtOrgBackupOperation -Organization $organization
```
Above example returns the list of MgmtOrgBackupOperation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMgmtOrgBackupOperation -InlineCount allpages
```
Above example returns the list of MgmtOrgBackupOperation along with count.
...
### -Name
Specifies the name of the MgmtOrgBackupOperation.
...
### -Organization
Specifies the organization, to fetch the MgmtOrgBackupOperation under it.
