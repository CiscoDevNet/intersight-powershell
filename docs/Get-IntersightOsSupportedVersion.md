...
# Get-IntersightOsSupportedVersion

## SYNOPSIS
Get the OsSupportedVersion

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOsSupportedVersion [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOsSupportedVersion [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;OsSupportedVersion&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOsSupportedVersion
```
Above example returns the list of OsSupportedVersion.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOsSupportedVersion -Name "MoName"
```
Above example returns the OsSupportedVersion matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOsSupportedVersion -Organization $organization
```
Above example returns the list of OsSupportedVersion available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOsSupportedVersion -InlineCount allpages
```
Above example returns the list of OsSupportedVersion along with count.
...
### -Name
Specifies the name of the OsSupportedVersion.
...
### -Organization
Specifies the organization, to fetch the OsSupportedVersion under it.
