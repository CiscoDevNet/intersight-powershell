...
# Get-IntersightPowerPowerGroup

## SYNOPSIS
Get the PowerPowerGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPowerPowerGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPowerPowerGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PowerPowerGroup&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPowerPowerGroup
```
Above example returns the list of PowerPowerGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPowerPowerGroup -Name "MoName"
```
Above example returns the PowerPowerGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPowerPowerGroup -Organization $organization
```
Above example returns the list of PowerPowerGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPowerPowerGroup -InlineCount allpages
```
Above example returns the list of PowerPowerGroup along with count.
...
### -Name
Specifies the name of the PowerPowerGroup.
...
### -Organization
Specifies the organization, to fetch the PowerPowerGroup under it.
...
[Remove-IntersightPowerPowerGroup](./Remove-IntersightPowerPowerGroup.md)
