...
## SYNOPSIS
Get the NiatelemetryPodCommPolicies

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryPodCommPolicies [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryPodCommPolicies [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPodCommPolicies
```
Above example returns the list of NiatelemetryPodCommPolicies.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPodCommPolicies -Name "MoName"
```
Above example returns the NiatelemetryPodCommPolicies matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPodCommPolicies -Organization $organization
```
Above example returns the list of NiatelemetryPodCommPolicies available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPodCommPolicies -InlineCount allpages
```
Above example returns the list of NiatelemetryPodCommPolicies along with count.
...
### -Name
Specifies the name of the NiatelemetryPodCommPolicies.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryPodCommPolicies under it.
