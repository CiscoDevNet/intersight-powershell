...
Initialize-IntersightManagementController [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< ManagementController.ClassIdEnum>][-EquipmentIoCardBase< Model.EquipmentIoCardBaseRelationship>][-Moid< string>][-ObjectType< ManagementController.ObjectTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ManagementController.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightManagementController
```
