...
### CmdletParam (Default)
```
Get-IntersightCapabilitySiocModuleManufacturingDef [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilitySiocModuleManufacturingDef [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilitySiocModuleManufacturingDef
```
Above example returns the list of CapabilitySiocModuleManufacturingDef.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilitySiocModuleManufacturingDef -Name "MoName"
```
Above example returns the CapabilitySiocModuleManufacturingDef matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilitySiocModuleManufacturingDef -Organization $organization
```
Above example returns the list of CapabilitySiocModuleManufacturingDef available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilitySiocModuleManufacturingDef -InlineCount allpages
```
Above example returns the list of CapabilitySiocModuleManufacturingDef along with count.
...
### -Name
Specifies the name of the CapabilitySiocModuleManufacturingDef.
...
### -Organization
Specifies the organization, to fetch the CapabilitySiocModuleManufacturingDef under it.
