...
## SYNOPSIS
Get the ApplianceGroupStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceGroupStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceGroupStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceGroupStatus
```
Above example returns the list of ApplianceGroupStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceGroupStatus -Name "MoName"
```
Above example returns the ApplianceGroupStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceGroupStatus -Organization $organization
```
Above example returns the list of ApplianceGroupStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceGroupStatus -InlineCount allpages
```
Above example returns the list of ApplianceGroupStatus along with count.
...
### -Name
Specifies the name of the ApplianceGroupStatus.
...
### -Organization
Specifies the organization, to fetch the ApplianceGroupStatus under it.
