...
```powershell
$NiatelemetryApicFexDetailsResponse = Initialize-IntersightNiatelemetryApicFexDetailsResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiatelemetryApicFexDetailsResponse | ConvertTo-JSON
```
