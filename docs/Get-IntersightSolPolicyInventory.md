...
# Get-IntersightSolPolicyInventory

## SYNOPSIS
Get the SolPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSolPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSolPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SolPolicyInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSolPolicyInventory
```
Above example returns the list of SolPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSolPolicyInventory -Name "MoName"
```
Above example returns the SolPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSolPolicyInventory -Organization $organization
```
Above example returns the list of SolPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSolPolicyInventory -InlineCount allpages
```
Above example returns the list of SolPolicyInventory along with count.
...
### -Name
Specifies the name of the SolPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the SolPolicyInventory under it.
