...
```powershell
$NiatelemetryNexusDashboardMemoryDetails = Initialize-IntersightNiatelemetryNexusDashboardMemoryDetails  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$NiatelemetryNexusDashboardMemoryDetails | ConvertTo-JSON
```
