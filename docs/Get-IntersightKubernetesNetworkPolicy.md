...
## SYNOPSIS
Get the KubernetesNetworkPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesNetworkPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesNetworkPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KubernetesNetworkPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesNetworkPolicy
```
Above example returns the list of KubernetesNetworkPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesNetworkPolicy -Name "MoName"
```
Above example returns the KubernetesNetworkPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesNetworkPolicy -Organization $organization
```
Above example returns the list of KubernetesNetworkPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesNetworkPolicy -InlineCount allpages
```
Above example returns the list of KubernetesNetworkPolicy along with count.
...
### -Name
Specifies the name of the KubernetesNetworkPolicy.
...
### -Organization
Specifies the organization, to fetch the KubernetesNetworkPolicy under it.
