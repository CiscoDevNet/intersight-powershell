...
## SYNOPSIS
Get the FabricFcoeUplinkRole

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricFcoeUplinkRole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricFcoeUplinkRole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricFcoeUplinkRole
```
Above example returns the list of FabricFcoeUplinkRole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricFcoeUplinkRole -Name "MoName"
```
Above example returns the FabricFcoeUplinkRole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricFcoeUplinkRole -Organization $organization
```
Above example returns the list of FabricFcoeUplinkRole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricFcoeUplinkRole -InlineCount allpages
```
Above example returns the list of FabricFcoeUplinkRole along with count.
...
### -Name
Specifies the name of the FabricFcoeUplinkRole.
...
### -Organization
Specifies the organization, to fetch the FabricFcoeUplinkRole under it.
