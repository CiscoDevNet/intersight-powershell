...
New-IntersightCapabilityServerModelsCapabilityDef [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Models< System.Collections.Generic.List`1[string]>][-Moid< string>][[-Name]< string>][-ServerType< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
