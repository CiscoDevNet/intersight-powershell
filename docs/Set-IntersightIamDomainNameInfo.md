...
Set-IntersightIamDomainNameInfo [-Action< IamDomainNameInfo.ActionEnum>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-DomainName< string>][-FailureDetails< IamFailureDetails>][[-Moid]< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
