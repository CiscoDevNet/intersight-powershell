...
```powershell
$NiatelemetryNexusDashboardControllerDetails = Initialize-IntersightNiatelemetryNexusDashboardControllerDetails  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$NiatelemetryNexusDashboardControllerDetails | ConvertTo-JSON
```
