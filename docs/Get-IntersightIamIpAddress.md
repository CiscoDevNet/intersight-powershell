...
# Get-IntersightIamIpAddress

## SYNOPSIS
Get the IamIpAddress

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamIpAddress [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamIpAddress [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IamIpAddress&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamIpAddress
```
Above example returns the list of IamIpAddress.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamIpAddress -Name "MoName"
```
Above example returns the IamIpAddress matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamIpAddress -Organization $organization
```
Above example returns the list of IamIpAddress available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamIpAddress -InlineCount allpages
```
Above example returns the list of IamIpAddress along with count.
...
### -Name
Specifies the name of the IamIpAddress.
...
### -Organization
Specifies the organization, to fetch the IamIpAddress under it.
