...
# Get-IntersightStorageDriveSecurityPolicy

## SYNOPSIS
Get the StorageDriveSecurityPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageDriveSecurityPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageDriveSecurityPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageDriveSecurityPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageDriveSecurityPolicy
```
Above example returns the list of StorageDriveSecurityPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageDriveSecurityPolicy -Name "MoName"
```
Above example returns the StorageDriveSecurityPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageDriveSecurityPolicy -Organization $organization
```
Above example returns the list of StorageDriveSecurityPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageDriveSecurityPolicy -InlineCount allpages
```
Above example returns the list of StorageDriveSecurityPolicy along with count.
...
### -Name
Specifies the name of the StorageDriveSecurityPolicy.
...
### -Organization
Specifies the organization, to fetch the StorageDriveSecurityPolicy under it.
...
[Remove-IntersightStorageDriveSecurityPolicy](./Remove-IntersightStorageDriveSecurityPolicy.md)
