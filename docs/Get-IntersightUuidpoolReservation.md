...
# Get-IntersightUuidpoolReservation

## SYNOPSIS
Get the UuidpoolReservation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightUuidpoolReservation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightUuidpoolReservation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;UuidpoolReservation&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightUuidpoolReservation
```
Above example returns the list of UuidpoolReservation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightUuidpoolReservation -Name "MoName"
```
Above example returns the UuidpoolReservation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightUuidpoolReservation -Organization $organization
```
Above example returns the list of UuidpoolReservation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightUuidpoolReservation -InlineCount allpages
```
Above example returns the list of UuidpoolReservation along with count.
...
### -Name
Specifies the name of the UuidpoolReservation.
...
### -Organization
Specifies the organization, to fetch the UuidpoolReservation under it.
...
[Remove-IntersightUuidpoolReservation](./Remove-IntersightUuidpoolReservation.md)
