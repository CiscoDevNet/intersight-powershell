...
# Get-IntersightStoragePureManagementAccessPolicy

## SYNOPSIS
Get the StoragePureManagementAccessPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureManagementAccessPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureManagementAccessPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureManagementAccessPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureManagementAccessPolicy
```
Above example returns the list of StoragePureManagementAccessPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureManagementAccessPolicy -Name "MoName"
```
Above example returns the StoragePureManagementAccessPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureManagementAccessPolicy -Organization $organization
```
Above example returns the list of StoragePureManagementAccessPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureManagementAccessPolicy -InlineCount allpages
```
Above example returns the list of StoragePureManagementAccessPolicy along with count.
...
### -Name
Specifies the name of the StoragePureManagementAccessPolicy.
...
### -Organization
Specifies the organization, to fetch the StoragePureManagementAccessPolicy under it.
