...
# Get-IntersightIaasServiceRequest

## SYNOPSIS
Get the IaasServiceRequest

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIaasServiceRequest [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIaasServiceRequest [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IaasServiceRequest&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIaasServiceRequest
```
Above example returns the list of IaasServiceRequest.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIaasServiceRequest -Name "MoName"
```
Above example returns the IaasServiceRequest matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIaasServiceRequest -Organization $organization
```
Above example returns the list of IaasServiceRequest available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIaasServiceRequest -InlineCount allpages
```
Above example returns the list of IaasServiceRequest along with count.
...
### -Name
Specifies the name of the IaasServiceRequest.
...
### -Organization
Specifies the organization, to fetch the IaasServiceRequest under it.
