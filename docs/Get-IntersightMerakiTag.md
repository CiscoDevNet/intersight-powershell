...
### CmdletParam (Default)
```
Get-IntersightMerakiTag [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMerakiTag [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MerakiTag&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMerakiTag
```
Above example returns the list of MerakiTag.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMerakiTag -Name "MoName"
```
Above example returns the MerakiTag matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMerakiTag -Organization $organization
```
Above example returns the list of MerakiTag available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMerakiTag -InlineCount allpages
```
Above example returns the list of MerakiTag along with count.
...
### -Name
Specifies the name of the MerakiTag.
...
### -Organization
Specifies the organization, to fetch the MerakiTag under it.
