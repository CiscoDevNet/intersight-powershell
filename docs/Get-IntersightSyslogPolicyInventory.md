...
# Get-IntersightSyslogPolicyInventory

## SYNOPSIS
Get the SyslogPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSyslogPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSyslogPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SyslogPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSyslogPolicyInventory
```
Above example returns the list of SyslogPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSyslogPolicyInventory -Name "MoName"
```
Above example returns the SyslogPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSyslogPolicyInventory -Organization $organization
```
Above example returns the list of SyslogPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSyslogPolicyInventory -InlineCount allpages
```
Above example returns the list of SyslogPolicyInventory along with count.
...
### -Name
Specifies the name of the SyslogPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the SyslogPolicyInventory under it.
