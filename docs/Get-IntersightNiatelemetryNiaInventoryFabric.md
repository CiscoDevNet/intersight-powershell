...
## SYNOPSIS
Get the NiatelemetryNiaInventoryFabric

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryNiaInventoryFabric [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryNiaInventoryFabric [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryNiaInventoryFabric&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaInventoryFabric
```
Above example returns the list of NiatelemetryNiaInventoryFabric.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaInventoryFabric -Name "MoName"
```
Above example returns the NiatelemetryNiaInventoryFabric matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaInventoryFabric -Organization $organization
```
Above example returns the list of NiatelemetryNiaInventoryFabric available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryNiaInventoryFabric -InlineCount allpages
```
Above example returns the list of NiatelemetryNiaInventoryFabric along with count.
...
### -Name
Specifies the name of the NiatelemetryNiaInventoryFabric.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryNiaInventoryFabric under it.
