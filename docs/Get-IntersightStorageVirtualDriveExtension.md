...
## SYNOPSIS
Get the StorageVirtualDriveExtension

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageVirtualDriveExtension [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageVirtualDriveExtension [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDriveExtension
```
Above example returns the list of StorageVirtualDriveExtension.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDriveExtension -Name "MoName"
```
Above example returns the StorageVirtualDriveExtension matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDriveExtension -Organization $organization
```
Above example returns the list of StorageVirtualDriveExtension available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageVirtualDriveExtension -InlineCount allpages
```
Above example returns the list of StorageVirtualDriveExtension along with count.
...
### -Name
Specifies the name of the StorageVirtualDriveExtension.
...
### -Organization
Specifies the organization, to fetch the StorageVirtualDriveExtension under it.
...
[Set-IntersightStorageVirtualDriveExtension](./Set-IntersightStorageVirtualDriveExtension.md)
