...
## SYNOPSIS
Get the HyperflexDevicePackageDownloadState

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexDevicePackageDownloadState [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexDevicePackageDownloadState [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexDevicePackageDownloadState&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexDevicePackageDownloadState
```
Above example returns the list of HyperflexDevicePackageDownloadState.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexDevicePackageDownloadState -Name "MoName"
```
Above example returns the HyperflexDevicePackageDownloadState matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexDevicePackageDownloadState -Organization $organization
```
Above example returns the list of HyperflexDevicePackageDownloadState available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexDevicePackageDownloadState -InlineCount allpages
```
Above example returns the list of HyperflexDevicePackageDownloadState along with count.
...
### -Name
Specifies the name of the HyperflexDevicePackageDownloadState.
...
### -Organization
Specifies the organization, to fetch the HyperflexDevicePackageDownloadState under it.
