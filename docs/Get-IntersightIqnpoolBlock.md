...
# Get-IntersightIqnpoolBlock

## SYNOPSIS
Get the IqnpoolBlock

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIqnpoolBlock [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIqnpoolBlock [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIqnpoolBlock
```
Above example returns the list of IqnpoolBlock.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIqnpoolBlock -Name "MoName"
```
Above example returns the IqnpoolBlock matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIqnpoolBlock -Organization $organization
```
Above example returns the list of IqnpoolBlock available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIqnpoolBlock -InlineCount allpages
```
Above example returns the list of IqnpoolBlock along with count.
...
### -Name
Specifies the name of the IqnpoolBlock.
...
### -Organization
Specifies the organization, to fetch the IqnpoolBlock under it.
