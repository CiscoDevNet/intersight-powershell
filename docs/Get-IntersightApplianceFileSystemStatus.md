...
## SYNOPSIS
Get the ApplianceFileSystemStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceFileSystemStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceFileSystemStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceFileSystemStatus
```
Above example returns the list of ApplianceFileSystemStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceFileSystemStatus -Name "MoName"
```
Above example returns the ApplianceFileSystemStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceFileSystemStatus -Organization $organization
```
Above example returns the list of ApplianceFileSystemStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceFileSystemStatus -InlineCount allpages
```
Above example returns the list of ApplianceFileSystemStatus along with count.
...
### -Name
Specifies the name of the ApplianceFileSystemStatus.
...
### -Organization
Specifies the organization, to fetch the ApplianceFileSystemStatus under it.
