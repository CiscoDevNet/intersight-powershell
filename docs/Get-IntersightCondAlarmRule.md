...
# Get-IntersightCondAlarmRule

## SYNOPSIS
Get the CondAlarmRule

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCondAlarmRule [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCondAlarmRule [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CondAlarmRule&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCondAlarmRule
```
Above example returns the list of CondAlarmRule.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCondAlarmRule -Name "MoName"
```
Above example returns the CondAlarmRule matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCondAlarmRule -Organization $organization
```
Above example returns the list of CondAlarmRule available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCondAlarmRule -InlineCount allpages
```
Above example returns the list of CondAlarmRule along with count.
...
### -Name
Specifies the name of the CondAlarmRule.
...
### -Organization
Specifies the organization, to fetch the CondAlarmRule under it.
