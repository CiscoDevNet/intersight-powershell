...
# Get-IntersightOauthAuthorization

## SYNOPSIS
Get the OauthAuthorization

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightOauthAuthorization [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightOauthAuthorization [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;OauthAuthorization&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightOauthAuthorization
```
Above example returns the list of OauthAuthorization.

### Example 2
```powershell
PS C:\> $result = Get-IntersightOauthAuthorization -Name "MoName"
```
Above example returns the OauthAuthorization matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightOauthAuthorization -Organization $organization
```
Above example returns the list of OauthAuthorization available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightOauthAuthorization -InlineCount allpages
```
Above example returns the list of OauthAuthorization along with count.
...
### -Name
Specifies the name of the OauthAuthorization.
...
### -Organization
Specifies the organization, to fetch the OauthAuthorization under it.
