...
# Get-IntersightSchedulerTaskResult

## SYNOPSIS
Get the SchedulerTaskResult

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSchedulerTaskResult [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSchedulerTaskResult [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SchedulerTaskResult&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSchedulerTaskResult
```
Above example returns the list of SchedulerTaskResult.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSchedulerTaskResult -Name "MoName"
```
Above example returns the SchedulerTaskResult matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSchedulerTaskResult -Organization $organization
```
Above example returns the list of SchedulerTaskResult available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSchedulerTaskResult -InlineCount allpages
```
Above example returns the list of SchedulerTaskResult along with count.
...
### -Name
Specifies the name of the SchedulerTaskResult.
...
### -Organization
Specifies the organization, to fetch the SchedulerTaskResult under it.
...
[Remove-IntersightSchedulerTaskResult](./Remove-IntersightSchedulerTaskResult.md)
