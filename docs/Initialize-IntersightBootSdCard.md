...
### -Bootloader
Details of the bootloader to be used during SD card boot.
...
```yaml
Type: BootSdCard.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightBootSdCard
```
