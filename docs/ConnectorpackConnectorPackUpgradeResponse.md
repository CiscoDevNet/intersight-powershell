...
```powershell
$ConnectorpackConnectorPackUpgradeResponse = Initialize-IntersightConnectorpackConnectorPackUpgradeResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$ConnectorpackConnectorPackUpgradeResponse | ConvertTo-JSON
```
