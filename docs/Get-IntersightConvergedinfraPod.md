...
### CmdletParam (Default)
```
Get-IntersightConvergedinfraPod [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightConvergedinfraPod [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightConvergedinfraPod
```
Above example returns the list of ConvergedinfraPod.

### Example 2
```powershell
PS C:\> $result = Get-IntersightConvergedinfraPod -Name "MoName"
```
Above example returns the ConvergedinfraPod matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightConvergedinfraPod -Organization $organization
```
Above example returns the list of ConvergedinfraPod available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightConvergedinfraPod -InlineCount allpages
```
Above example returns the list of ConvergedinfraPod along with count.
...
### -Name
Specifies the name of the ConvergedinfraPod.
...
### -Organization
Specifies the organization, to fetch the ConvergedinfraPod under it.
...
[Set-IntersightConvergedinfraPod](./Set-IntersightConvergedinfraPod.md)
