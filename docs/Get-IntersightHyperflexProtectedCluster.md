...
## SYNOPSIS
Get the HyperflexProtectedCluster

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexProtectedCluster [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexProtectedCluster [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexProtectedCluster&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexProtectedCluster
```
Above example returns the list of HyperflexProtectedCluster.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexProtectedCluster -Name "MoName"
```
Above example returns the HyperflexProtectedCluster matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexProtectedCluster -Organization $organization
```
Above example returns the list of HyperflexProtectedCluster available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexProtectedCluster -InlineCount allpages
```
Above example returns the list of HyperflexProtectedCluster along with count.
...
### -Name
Specifies the name of the HyperflexProtectedCluster.
...
### -Organization
Specifies the organization, to fetch the HyperflexProtectedCluster under it.
