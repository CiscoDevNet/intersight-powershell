...
## SYNOPSIS
Get the KubernetesCluster

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesCluster [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesCluster [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesCluster
```
Above example returns the list of KubernetesCluster.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesCluster -Name "MoName"
```
Above example returns the KubernetesCluster matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesCluster -Organization $organization
```
Above example returns the list of KubernetesCluster available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesCluster -InlineCount allpages
```
Above example returns the list of KubernetesCluster along with count.
...
### -Name
Specifies the name of the KubernetesCluster.
...
### -Organization
Specifies the organization, to fetch the KubernetesCluster under it.
