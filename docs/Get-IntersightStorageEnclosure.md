...
## SYNOPSIS
Get the StorageEnclosure

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageEnclosure [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageEnclosure [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageEnclosure&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageEnclosure
```
Above example returns the list of StorageEnclosure.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageEnclosure -Name "MoName"
```
Above example returns the StorageEnclosure matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageEnclosure -Organization $organization
```
Above example returns the list of StorageEnclosure available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageEnclosure -InlineCount allpages
```
Above example returns the list of StorageEnclosure along with count.
...
### -Name
Specifies the name of the StorageEnclosure.
...
### -Organization
Specifies the organization, to fetch the StorageEnclosure under it.
...
[Set-IntersightStorageEnclosure](./Set-IntersightStorageEnclosure.md)
