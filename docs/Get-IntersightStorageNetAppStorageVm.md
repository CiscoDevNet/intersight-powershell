...
## SYNOPSIS
Get the StorageNetAppStorageVm

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppStorageVm [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppStorageVm [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppStorageVm&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppStorageVm
```
Above example returns the list of StorageNetAppStorageVm.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppStorageVm -Name "MoName"
```
Above example returns the StorageNetAppStorageVm matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppStorageVm -Organization $organization
```
Above example returns the list of StorageNetAppStorageVm available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppStorageVm -InlineCount allpages
```
Above example returns the list of StorageNetAppStorageVm along with count.
...
### -Name
Specifies the name of the StorageNetAppStorageVm.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppStorageVm under it.
