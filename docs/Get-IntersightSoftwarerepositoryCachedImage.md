...
## SYNOPSIS
Get the SoftwarerepositoryCachedImage

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwarerepositoryCachedImage [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwarerepositoryCachedImage [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SoftwarerepositoryCachedImage&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCachedImage
```
Above example returns the list of SoftwarerepositoryCachedImage.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCachedImage -Name "MoName"
```
Above example returns the SoftwarerepositoryCachedImage matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCachedImage -Organization $organization
```
Above example returns the list of SoftwarerepositoryCachedImage available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryCachedImage -InlineCount allpages
```
Above example returns the list of SoftwarerepositoryCachedImage along with count.
...
### -Name
Specifies the name of the SoftwarerepositoryCachedImage.
...
### -Organization
Specifies the organization, to fetch the SoftwarerepositoryCachedImage under it.
