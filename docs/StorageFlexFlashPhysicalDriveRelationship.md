...
```powershell
$StorageFlexFlashPhysicalDriveRelationship = Initialize-IntersightStorageFlexFlashPhysicalDriveRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StorageFlexFlashPhysicalDriveRelationship | ConvertTo-JSON
```
