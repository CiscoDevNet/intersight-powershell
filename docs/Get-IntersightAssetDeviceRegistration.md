...
## SYNOPSIS
Get the AssetDeviceRegistration

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAssetDeviceRegistration [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAssetDeviceRegistration [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAssetDeviceRegistration
```
Above example returns the list of AssetDeviceRegistration.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAssetDeviceRegistration -Name "MoName"
```
Above example returns the AssetDeviceRegistration matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAssetDeviceRegistration -Organization $organization
```
Above example returns the list of AssetDeviceRegistration available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAssetDeviceRegistration -InlineCount allpages
```
Above example returns the list of AssetDeviceRegistration along with count.
...
### -Name
Specifies the name of the AssetDeviceRegistration.
...
### -Organization
Specifies the organization, to fetch the AssetDeviceRegistration under it.
