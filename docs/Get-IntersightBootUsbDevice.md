...
# Get-IntersightBootUsbDevice

## SYNOPSIS
Get the BootUsbDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBootUsbDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBootUsbDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;BootUsbDevice&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBootUsbDevice
```
Above example returns the list of BootUsbDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBootUsbDevice -Name "MoName"
```
Above example returns the BootUsbDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBootUsbDevice -Organization $organization
```
Above example returns the list of BootUsbDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBootUsbDevice -InlineCount allpages
```
Above example returns the list of BootUsbDevice along with count.
...
### -Name
Specifies the name of the BootUsbDevice.
...
### -Organization
Specifies the organization, to fetch the BootUsbDevice under it.
...
[Set-IntersightBootUsbDevice](./Set-IntersightBootUsbDevice.md)
