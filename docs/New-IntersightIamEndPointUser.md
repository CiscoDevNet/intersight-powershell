...
New-IntersightIamEndPointUser [-AdditionalProperties< Dictionary<string,object>>][-EndPointUserRole< List<IamEndPointUserRoleRelationship>>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-Tags< List<MoTag>>]
