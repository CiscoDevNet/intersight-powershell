...
# Get-IntersightStoragePureDirectoryExport

## SYNOPSIS
Get the StoragePureDirectoryExport

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureDirectoryExport [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureDirectoryExport [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureDirectoryExport&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectoryExport
```
Above example returns the list of StoragePureDirectoryExport.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectoryExport -Name "MoName"
```
Above example returns the StoragePureDirectoryExport matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectoryExport -Organization $organization
```
Above example returns the list of StoragePureDirectoryExport available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureDirectoryExport -InlineCount allpages
```
Above example returns the list of StoragePureDirectoryExport along with count.
...
### -Name
Specifies the name of the StoragePureDirectoryExport.
...
### -Organization
Specifies the organization, to fetch the StoragePureDirectoryExport under it.
