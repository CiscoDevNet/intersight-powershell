...
```powershell
$FirmwareUpgradeImpactStatusResponse = Initialize-IntersightFirmwareUpgradeImpactStatusResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$FirmwareUpgradeImpactStatusResponse | ConvertTo-JSON
```
