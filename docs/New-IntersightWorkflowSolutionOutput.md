...
New-IntersightWorkflowSolutionOutput [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Moid< string>][[-Name]< string>][-Output< object>][-SolutionInstance< WorkflowSolutionInstanceRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;WorkflowSolutionOutput&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightWorkflowSolutionOutput
```
