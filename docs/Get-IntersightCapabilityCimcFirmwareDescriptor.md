...
### CmdletParam (Default)
```
Get-IntersightCapabilityCimcFirmwareDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityCimcFirmwareDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityCimcFirmwareDescriptor
```
Above example returns the list of CapabilityCimcFirmwareDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityCimcFirmwareDescriptor -Name "MoName"
```
Above example returns the CapabilityCimcFirmwareDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityCimcFirmwareDescriptor -Organization $organization
```
Above example returns the list of CapabilityCimcFirmwareDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityCimcFirmwareDescriptor -InlineCount allpages
```
Above example returns the list of CapabilityCimcFirmwareDescriptor along with count.
...
### -Name
Specifies the name of the CapabilityCimcFirmwareDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilityCimcFirmwareDescriptor under it.
