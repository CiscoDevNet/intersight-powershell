...
New-IntersightIamApiKey [-AdditionalProperties< Dictionary<string,object>>][-HashAlgorithm< IamApiKey.HashAlgorithmEnum>][-KeySpec< PkixKeyGenerationSpec>][-Moid< string>][-PrivateKey< string>][-Purpose< string>][-SigningAlgorithm< IamApiKey.SigningAlgorithmEnum>][-Tags< List<MoTag>>]
