...
### CmdletParam (Default)
```
Get-IntersightCapabilityEquipmentSlotArray [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityEquipmentSlotArray [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityEquipmentSlotArray
```
Above example returns the list of CapabilityEquipmentSlotArray.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityEquipmentSlotArray -Name "MoName"
```
Above example returns the CapabilityEquipmentSlotArray matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityEquipmentSlotArray -Organization $organization
```
Above example returns the list of CapabilityEquipmentSlotArray available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityEquipmentSlotArray -InlineCount allpages
```
Above example returns the list of CapabilityEquipmentSlotArray along with count.
...
### -Name
Specifies the name of the CapabilityEquipmentSlotArray.
...
### -Organization
Specifies the organization, to fetch the CapabilityEquipmentSlotArray under it.
