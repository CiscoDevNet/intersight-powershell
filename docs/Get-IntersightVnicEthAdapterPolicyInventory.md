...
# Get-IntersightVnicEthAdapterPolicyInventory

## SYNOPSIS
Get the VnicEthAdapterPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicEthAdapterPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicEthAdapterPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicEthAdapterPolicyInventory
```
Above example returns the list of VnicEthAdapterPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicEthAdapterPolicyInventory -Name "MoName"
```
Above example returns the VnicEthAdapterPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicEthAdapterPolicyInventory -Organization $organization
```
Above example returns the list of VnicEthAdapterPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicEthAdapterPolicyInventory -InlineCount allpages
```
Above example returns the list of VnicEthAdapterPolicyInventory along with count.
...
### -Name
Specifies the name of the VnicEthAdapterPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the VnicEthAdapterPolicyInventory under it.
