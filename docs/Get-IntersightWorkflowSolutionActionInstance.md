...
## SYNOPSIS
Get the WorkflowSolutionActionInstance

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowSolutionActionInstance [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowSolutionActionInstance [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionActionInstance
```
Above example returns the list of WorkflowSolutionActionInstance.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionActionInstance -Name "MoName"
```
Above example returns the WorkflowSolutionActionInstance matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionActionInstance -Organization $organization
```
Above example returns the list of WorkflowSolutionActionInstance available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowSolutionActionInstance -InlineCount allpages
```
Above example returns the list of WorkflowSolutionActionInstance along with count.
...
### -Name
Specifies the name of the WorkflowSolutionActionInstance.
...
### -Organization
Specifies the organization, to fetch the WorkflowSolutionActionInstance under it.
