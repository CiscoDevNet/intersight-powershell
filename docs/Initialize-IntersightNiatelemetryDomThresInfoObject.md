...
# Initialize-IntersightNiatelemetryDomThresInfoObject
...
```yaml
Type: NiatelemetryDomThresInfoObject.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
Note :- Use Initialize-IntersightNiatelemetryDomThresInfo to create the object of complex type NiatelemetryDomThresInfo

```yaml
Type: System.Collections.Generic.List`1[Model.NiatelemetryDomThresInfo]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: NiatelemetryDomThresInfoObject.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightNiatelemetryDomThresInfoObject
```
...
[Initialize-IntersightNiatelemetryDomThresInfo](./Initialize-IntersightNiatelemetryDomThresInfo.md)
