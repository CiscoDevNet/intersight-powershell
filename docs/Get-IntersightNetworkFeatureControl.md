...
# Get-IntersightNetworkFeatureControl

## SYNOPSIS
Get the NetworkFeatureControl

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkFeatureControl [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkFeatureControl [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NetworkFeatureControl&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkFeatureControl
```
Above example returns the list of NetworkFeatureControl.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkFeatureControl -Name "MoName"
```
Above example returns the NetworkFeatureControl matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkFeatureControl -Organization $organization
```
Above example returns the list of NetworkFeatureControl available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkFeatureControl -InlineCount allpages
```
Above example returns the list of NetworkFeatureControl along with count.
...
### -Name
Specifies the name of the NetworkFeatureControl.
...
### -Organization
Specifies the organization, to fetch the NetworkFeatureControl under it.
