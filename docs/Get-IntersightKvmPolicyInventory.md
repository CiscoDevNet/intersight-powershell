...
# Get-IntersightKvmPolicyInventory

## SYNOPSIS
Get the KvmPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKvmPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKvmPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KvmPolicyInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKvmPolicyInventory
```
Above example returns the list of KvmPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKvmPolicyInventory -Name "MoName"
```
Above example returns the KvmPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKvmPolicyInventory -Organization $organization
```
Above example returns the list of KvmPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKvmPolicyInventory -InlineCount allpages
```
Above example returns the list of KvmPolicyInventory along with count.
...
### -Name
Specifies the name of the KvmPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the KvmPolicyInventory under it.
