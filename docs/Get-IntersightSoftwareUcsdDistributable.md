...
## SYNOPSIS
Get the SoftwareUcsdDistributable

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwareUcsdDistributable [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwareUcsdDistributable [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SoftwareUcsdDistributable&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwareUcsdDistributable
```
Above example returns the list of SoftwareUcsdDistributable.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwareUcsdDistributable -Name "MoName"
```
Above example returns the SoftwareUcsdDistributable matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwareUcsdDistributable -Organization $organization
```
Above example returns the list of SoftwareUcsdDistributable available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwareUcsdDistributable -InlineCount allpages
```
Above example returns the list of SoftwareUcsdDistributable along with count.
...
### -Name
Specifies the name of the SoftwareUcsdDistributable.
...
### -Organization
Specifies the organization, to fetch the SoftwareUcsdDistributable under it.
