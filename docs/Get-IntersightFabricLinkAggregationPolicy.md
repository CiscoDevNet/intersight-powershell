...
## SYNOPSIS
Get the FabricLinkAggregationPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricLinkAggregationPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricLinkAggregationPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricLinkAggregationPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricLinkAggregationPolicy
```
Above example returns the list of FabricLinkAggregationPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricLinkAggregationPolicy -Name "MoName"
```
Above example returns the FabricLinkAggregationPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricLinkAggregationPolicy -Organization $organization
```
Above example returns the list of FabricLinkAggregationPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricLinkAggregationPolicy -InlineCount allpages
```
Above example returns the list of FabricLinkAggregationPolicy along with count.
...
### -Name
Specifies the name of the FabricLinkAggregationPolicy.
...
### -Organization
Specifies the organization, to fetch the FabricLinkAggregationPolicy under it.
