...
## SYNOPSIS
Get the HyperflexClusterHealthCheckExecutionSnapshot

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexClusterHealthCheckExecutionSnapshot [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexClusterHealthCheckExecutionSnapshot [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexClusterHealthCheckExecutionSnapshot&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterHealthCheckExecutionSnapshot
```
Above example returns the list of HyperflexClusterHealthCheckExecutionSnapshot.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterHealthCheckExecutionSnapshot -Name "MoName"
```
Above example returns the HyperflexClusterHealthCheckExecutionSnapshot matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterHealthCheckExecutionSnapshot -Organization $organization
```
Above example returns the list of HyperflexClusterHealthCheckExecutionSnapshot available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterHealthCheckExecutionSnapshot -InlineCount allpages
```
Above example returns the list of HyperflexClusterHealthCheckExecutionSnapshot along with count.
...
### -Name
Specifies the name of the HyperflexClusterHealthCheckExecutionSnapshot.
...
### -Organization
Specifies the organization, to fetch the HyperflexClusterHealthCheckExecutionSnapshot under it.
