...
### CmdletParam (Default)
```
Get-IntersightEquipmentChassisIdPool [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentChassisIdPool [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisIdPool
```
Above example returns the list of EquipmentChassisIdPool.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisIdPool -Name "MoName"
```
Above example returns the EquipmentChassisIdPool matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisIdPool -Organization $organization
```
Above example returns the list of EquipmentChassisIdPool available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisIdPool -InlineCount allpages
```
Above example returns the list of EquipmentChassisIdPool along with count.
...
### -Name
Specifies the name of the EquipmentChassisIdPool.
...
### -Organization
Specifies the organization, to fetch the EquipmentChassisIdPool under it.
