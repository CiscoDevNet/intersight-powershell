...
## SYNOPSIS
Get the NiatelemetryPasswordStrengthCheck

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryPasswordStrengthCheck [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryPasswordStrengthCheck [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetryPasswordStrengthCheck&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPasswordStrengthCheck
```
Above example returns the list of NiatelemetryPasswordStrengthCheck.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPasswordStrengthCheck -Name "MoName"
```
Above example returns the NiatelemetryPasswordStrengthCheck matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPasswordStrengthCheck -Organization $organization
```
Above example returns the list of NiatelemetryPasswordStrengthCheck available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryPasswordStrengthCheck -InlineCount allpages
```
Above example returns the list of NiatelemetryPasswordStrengthCheck along with count.
...
### -Name
Specifies the name of the NiatelemetryPasswordStrengthCheck.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryPasswordStrengthCheck under it.
