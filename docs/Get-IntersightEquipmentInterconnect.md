...
### CmdletParam (Default)
```
Get-IntersightEquipmentInterconnect [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentInterconnect [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
