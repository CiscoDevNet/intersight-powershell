...
## SYNOPSIS
Get the ComputeRackUnit

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputeRackUnit [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputeRackUnit [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;ComputeRackUnit&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputeRackUnit
```
Above example returns the list of ComputeRackUnit.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputeRackUnit -Name "MoName"
```
Above example returns the ComputeRackUnit matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputeRackUnit -Organization $organization
```
Above example returns the list of ComputeRackUnit available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputeRackUnit -InlineCount allpages
```
Above example returns the list of ComputeRackUnit along with count.
...
### -Name
Specifies the name of the ComputeRackUnit.
...
### -Organization
Specifies the organization, to fetch the ComputeRackUnit under it.
