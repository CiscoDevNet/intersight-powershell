...
New-IntersightCapabilityServerDescriptor [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Capabilities< System.Collections.Generic.List`1[CapabilityCapabilityRelationship]>][-Description< string>][-IsNcsiEnabled< bool>][-Model< string>][-Moid< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Vendor< string>][-Version< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;CapabilityServerDescriptor&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightCapabilityServerDescriptor
```
