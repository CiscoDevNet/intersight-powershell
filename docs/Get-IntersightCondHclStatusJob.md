...
# Get-IntersightCondHclStatusJob
...
### CmdletParam (Default)
```
Get-IntersightCondHclStatusJob [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCondHclStatusJob [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;CondHclStatusJob&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCondHclStatusJob
```
Above example returns the list of CondHclStatusJob.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCondHclStatusJob -Name "MoName"
```
Above example returns the CondHclStatusJob matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCondHclStatusJob -Organization $organization
```
Above example returns the list of CondHclStatusJob available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCondHclStatusJob -InlineCount allpages
```
Above example returns the list of CondHclStatusJob along with count.
...
### -Name
Specifies the name of the CondHclStatusJob.
...
### -Organization
Specifies the organization, to fetch the CondHclStatusJob under it.
