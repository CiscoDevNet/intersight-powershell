...
## SYNOPSIS
Get the FirmwareUpgrade

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareUpgrade [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareUpgrade [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareUpgrade&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareUpgrade
```
Above example returns the list of FirmwareUpgrade.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareUpgrade -Name "MoName"
```
Above example returns the FirmwareUpgrade matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareUpgrade -Organization $organization
```
Above example returns the list of FirmwareUpgrade available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareUpgrade -InlineCount allpages
```
Above example returns the list of FirmwareUpgrade along with count.
...
### -Name
Specifies the name of the FirmwareUpgrade.
...
### -Organization
Specifies the organization, to fetch the FirmwareUpgrade under it.
