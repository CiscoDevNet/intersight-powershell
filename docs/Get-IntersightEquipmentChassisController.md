...
# Get-IntersightEquipmentChassisController

## SYNOPSIS
Get the EquipmentChassisController

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentChassisController [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentChassisController [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentChassisController&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisController
```
Above example returns the list of EquipmentChassisController.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisController -Name "MoName"
```
Above example returns the EquipmentChassisController matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisController -Organization $organization
```
Above example returns the list of EquipmentChassisController available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentChassisController -InlineCount allpages
```
Above example returns the list of EquipmentChassisController along with count.
...
### -Name
Specifies the name of the EquipmentChassisController.
...
### -Organization
Specifies the organization, to fetch the EquipmentChassisController under it.
...
[Set-IntersightEquipmentChassisController](./Set-IntersightEquipmentChassisController.md)
