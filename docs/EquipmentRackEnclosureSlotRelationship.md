...
```powershell
$EquipmentRackEnclosureSlotRelationship = Initialize-IntersightEquipmentRackEnclosureSlotRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$EquipmentRackEnclosureSlotRelationship | ConvertTo-JSON
```
