...
# Get-IntersightTechsupportmanagementEndPoint

## SYNOPSIS
Get the TechsupportmanagementEndPoint

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightTechsupportmanagementEndPoint [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightTechsupportmanagementEndPoint [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;TechsupportmanagementEndPoint&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementEndPoint
```
Above example returns the list of TechsupportmanagementEndPoint.

### Example 2
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementEndPoint -Name "MoName"
```
Above example returns the TechsupportmanagementEndPoint matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementEndPoint -Organization $organization
```
Above example returns the list of TechsupportmanagementEndPoint available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementEndPoint -InlineCount allpages
```
Above example returns the list of TechsupportmanagementEndPoint along with count.
...
### -Name
Specifies the name of the TechsupportmanagementEndPoint.
...
### -Organization
Specifies the organization, to fetch the TechsupportmanagementEndPoint under it.
