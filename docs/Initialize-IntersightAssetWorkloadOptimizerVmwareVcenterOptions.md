...
```yaml
Type: AssetWorkloadOptimizerVmwareVcenterOptions.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: AssetWorkloadOptimizerVmwareVcenterOptions.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightAssetWorkloadOptimizerVmwareVcenterOptions
```
