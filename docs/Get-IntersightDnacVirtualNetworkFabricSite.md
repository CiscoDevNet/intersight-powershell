...
# Get-IntersightDnacVirtualNetworkFabricSite

## SYNOPSIS
Get the DnacVirtualNetworkFabricSite

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightDnacVirtualNetworkFabricSite [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightDnacVirtualNetworkFabricSite [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;DnacVirtualNetworkFabricSite&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightDnacVirtualNetworkFabricSite
```
Above example returns the list of DnacVirtualNetworkFabricSite.

### Example 2
```powershell
PS C:\> $result = Get-IntersightDnacVirtualNetworkFabricSite -Name "MoName"
```
Above example returns the DnacVirtualNetworkFabricSite matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightDnacVirtualNetworkFabricSite -Organization $organization
```
Above example returns the list of DnacVirtualNetworkFabricSite available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightDnacVirtualNetworkFabricSite -InlineCount allpages
```
Above example returns the list of DnacVirtualNetworkFabricSite along with count.
...
### -Name
Specifies the name of the DnacVirtualNetworkFabricSite.
...
### -Organization
Specifies the organization, to fetch the DnacVirtualNetworkFabricSite under it.
