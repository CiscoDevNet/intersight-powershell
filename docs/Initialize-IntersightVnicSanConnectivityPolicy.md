...
# Initialize-IntersightVnicSanConnectivityPolicy
...
Initialize-IntersightVnicSanConnectivityPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< VnicSanConnectivityPolicy.ClassIdEnum>][-Description< string>][-FcIfs< System.Collections.Generic.List`1[Model.VnicFcIfRelationship]>][-Moid< string>][-Name< string>][-ObjectType< VnicSanConnectivityPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-PlacementMode< VnicSanConnectivityPolicy.PlacementModeEnum>][-Profiles< System.Collections.Generic.List`1[Model.PolicyAbstractConfigProfileRelationship]>][-StaticWwnnAddress< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TargetPlatform< VnicSanConnectivityPolicy.TargetPlatformEnum>][-WwnnAddressType< VnicSanConnectivityPolicy.WwnnAddressTypeEnum>][-WwnnPool< Model.FcpoolPoolRelationship>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: VnicSanConnectivityPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.VnicFcIfRelationship]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VnicSanConnectivityPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVnicSanConnectivityPolicy
```
