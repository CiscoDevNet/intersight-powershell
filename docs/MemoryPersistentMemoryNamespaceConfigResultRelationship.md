...
```powershell
$MemoryPersistentMemoryNamespaceConfigResultRelationship = Initialize-IntersightMemoryPersistentMemoryNamespaceConfigResultRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$MemoryPersistentMemoryNamespaceConfigResultRelationship | ConvertTo-JSON
```
