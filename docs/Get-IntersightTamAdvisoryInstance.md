...
## SYNOPSIS
Get the TamAdvisoryInstance

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightTamAdvisoryInstance [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightTamAdvisoryInstance [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;TamAdvisoryInstance&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightTamAdvisoryInstance
```
Above example returns the list of TamAdvisoryInstance.

### Example 2
```powershell
PS C:\> $result = Get-IntersightTamAdvisoryInstance -Name "MoName"
```
Above example returns the TamAdvisoryInstance matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightTamAdvisoryInstance -Organization $organization
```
Above example returns the list of TamAdvisoryInstance available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightTamAdvisoryInstance -InlineCount allpages
```
Above example returns the list of TamAdvisoryInstance along with count.
...
### -Name
Specifies the name of the TamAdvisoryInstance.
...
### -Organization
Specifies the organization, to fetch the TamAdvisoryInstance under it.
