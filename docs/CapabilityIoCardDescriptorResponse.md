...
```powershell
$CapabilityIoCardDescriptorResponse = Initialize-IntersightCapabilityIoCardDescriptorResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilityIoCardDescriptorResponse | ConvertTo-JSON
```
