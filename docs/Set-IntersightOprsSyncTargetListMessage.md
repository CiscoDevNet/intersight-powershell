...
Set-IntersightOprsSyncTargetListMessage [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Assist< AssetDeviceRegistrationRelationship>][-AssistId< string>][[-Moid]< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-TargetType< OprsSyncTargetListMessage.TargetTypeEnum>][-Targets< System.Collections.Generic.List`1[string]>][-TimeStamp< DateTime>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
