...
```powershell
$InventoryGenericInventoryResponse = Initialize-IntersightInventoryGenericInventoryResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$InventoryGenericInventoryResponse | ConvertTo-JSON
```
