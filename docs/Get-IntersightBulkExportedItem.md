...
# Get-IntersightBulkExportedItem

## SYNOPSIS
Get the BulkExportedItem

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBulkExportedItem [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBulkExportedItem [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;BulkExportedItem&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBulkExportedItem
```
Above example returns the list of BulkExportedItem.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBulkExportedItem -Name "MoName"
```
Above example returns the BulkExportedItem matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBulkExportedItem -Organization $organization
```
Above example returns the list of BulkExportedItem available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBulkExportedItem -InlineCount allpages
```
Above example returns the list of BulkExportedItem along with count.
...
### -Name
Specifies the name of the BulkExportedItem.
...
### -Organization
Specifies the organization, to fetch the BulkExportedItem under it.
