...
## SYNOPSIS
Get the VirtualizationIweVirtualMachine

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationIweVirtualMachine [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationIweVirtualMachine [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;VirtualizationIweVirtualMachine&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweVirtualMachine
```
Above example returns the list of VirtualizationIweVirtualMachine.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweVirtualMachine -Name "MoName"
```
Above example returns the VirtualizationIweVirtualMachine matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweVirtualMachine -Organization $organization
```
Above example returns the list of VirtualizationIweVirtualMachine available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationIweVirtualMachine -InlineCount allpages
```
Above example returns the list of VirtualizationIweVirtualMachine along with count.
...
### -Name
Specifies the name of the VirtualizationIweVirtualMachine.
...
### -Organization
Specifies the organization, to fetch the VirtualizationIweVirtualMachine under it.
...
[Set-IntersightVirtualizationIweVirtualMachine](./Set-IntersightVirtualizationIweVirtualMachine.md)
