...
# Initialize-IntersightCatalystsdwanVedgeDevice
...
```yaml
Type: CatalystsdwanVedgeDevice.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CatalystsdwanVedgeDevice.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCatalystsdwanVedgeDevice
```
