...
# Get-IntersightEquipmentLocatorLed

## SYNOPSIS
Get the EquipmentLocatorLed

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentLocatorLed [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentLocatorLed [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentLocatorLed&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentLocatorLed
```
Above example returns the list of EquipmentLocatorLed.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentLocatorLed -Name "MoName"
```
Above example returns the EquipmentLocatorLed matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentLocatorLed -Organization $organization
```
Above example returns the list of EquipmentLocatorLed available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentLocatorLed -InlineCount allpages
```
Above example returns the list of EquipmentLocatorLed along with count.
...
### -Name
Specifies the name of the EquipmentLocatorLed.
...
### -Organization
Specifies the organization, to fetch the EquipmentLocatorLed under it.
...
[Set-IntersightEquipmentLocatorLed](./Set-IntersightEquipmentLocatorLed.md)
