...
# Get-IntersightCapabilityActionsMetaData

## SYNOPSIS
Get the CapabilityActionsMetaData

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityActionsMetaData [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityActionsMetaData [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilityActionsMetaData&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityActionsMetaData
```
Above example returns the list of CapabilityActionsMetaData.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityActionsMetaData -Name "MoName"
```
Above example returns the CapabilityActionsMetaData matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityActionsMetaData -Organization $organization
```
Above example returns the list of CapabilityActionsMetaData available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityActionsMetaData -InlineCount allpages
```
Above example returns the list of CapabilityActionsMetaData along with count.
...
### -Name
Specifies the name of the CapabilityActionsMetaData.
...
### -Organization
Specifies the organization, to fetch the CapabilityActionsMetaData under it.
