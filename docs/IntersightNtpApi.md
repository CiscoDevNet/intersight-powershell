# Intersight.Intersight/Api.IntersightNtpApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**New-IntersightNtpPolicy**](IntersightNtpApi.md#New-IntersightNtpPolicy) | **POST** /api/v1/ntp/Policies | Create a &#39;ntp.Policy&#39; resource.
[**Remove-IntersightNtpPolicy**](IntersightNtpApi.md#Remove-IntersightNtpPolicy) | **DELETE** /api/v1/ntp/Policies/{Moid} | Delete a &#39;ntp.Policy&#39; resource.
[**Get-IntersightNtpPolicyByMoid**](IntersightNtpApi.md#Get-IntersightNtpPolicyByMoid) | **GET** /api/v1/ntp/Policies/{Moid} | Read a &#39;ntp.Policy&#39; resource.
[**Get-IntersightNtpPolicyList**](IntersightNtpApi.md#Get-IntersightNtpPolicyList) | **GET** /api/v1/ntp/Policies | Read a &#39;ntp.Policy&#39; resource.
[**Set-IntersightNtpPolicy**](IntersightNtpApi.md#Set-IntersightNtpPolicy) | **PATCH** /api/v1/ntp/Policies/{Moid} | Update a &#39;ntp.Policy&#39; resource.
[**Update-IntersightNtpPolicy**](IntersightNtpApi.md#Update-IntersightNtpPolicy) | **POST** /api/v1/ntp/Policies/{Moid} | Update a &#39;ntp.Policy&#39; resource.


<a name="New-IntersightNtpPolicy"></a>
# **New-IntersightNtpPolicy**
> NtpPolicy New-IntersightNtpPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-NtpPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Create a 'ntp.Policy' resource.
try {
     $Result = New-IntersightNtpPolicy -NtpPolicy $NtpPolicy -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
    Write-Host ("Exception occured when calling New-IntersightNtpPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
------------- | ------------- | ------------- | -------------
 **NtpPolicy** | [**NtpPolicy**](NtpPolicy.md)| The &#39;ntp.Policy&#39; resource to create. | 
...
<a name="Remove-IntersightNtpPolicy"></a>
# **Remove-IntersightNtpPolicy**
> void Remove-IntersightNtpPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Delete a 'ntp.Policy' resource.
try {
     $Result = Remove-IntersightNtpPolicy -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Remove-IntersightNtpPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightNtpPolicyByMoid"></a>
# **Get-IntersightNtpPolicyByMoid**
> NtpPolicy Get-IntersightNtpPolicyByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'ntp.Policy' resource.
try {
     $Result = Get-IntersightNtpPolicyByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightNtpPolicyByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightNtpPolicyList"></a>
# **Get-IntersightNtpPolicyList**
> NtpPolicyResponse Get-IntersightNtpPolicyList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'ntp.Policy' resource.
try {
     $Result = Get-IntersightNtpPolicyList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightNtpPolicyList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightNtpPolicy"></a>
# **Set-IntersightNtpPolicy**
> NtpPolicy Set-IntersightNtpPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-NtpPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$NtpPolicy = (Initialize-ntp.Policy-ClassId "ClassId_example" -ObjectType "ObjectType_example" -AccountMoid "AccountMoid_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -Description "Description_example" -Name "Name_example" -Enabled $false -NtpServers @("NtpServers_example") -Timezone "Timezone_example" -ApplianceAccount  -Organization  -Profiles @()) # NtpPolicy | The 'ntp.Policy' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'ntp.Policy' resource.
try {
     $Result = Set-IntersightNtpPolicy -Moid $Moid -NtpPolicy $NtpPolicy -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightNtpPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **NtpPolicy** | [**NtpPolicy**](NtpPolicy.md)| The &#39;ntp.Policy&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Update-IntersightNtpPolicy"></a>
# **Update-IntersightNtpPolicy**
> NtpPolicy Update-IntersightNtpPolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-NtpPolicy] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$NtpPolicy =  # NtpPolicy | The 'ntp.Policy' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'ntp.Policy' resource.
try {
     $Result = Update-IntersightNtpPolicy -Moid $Moid -NtpPolicy $NtpPolicy -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightNtpPolicy: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
