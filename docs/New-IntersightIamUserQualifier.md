...
New-IntersightIamUserQualifier [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Moid< string>][-NotificationScope< IamUserQualifier.NotificationScopeEnum>][-NotifyGuestUsers< bool>][-Tags< System.Collections.Generic.List`1[MoTag]>][-UserDetails< System.Collections.Generic.List`1[IamUserDetails]>][-Usergroup< IamUserGroupRelationship>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
