...
# Initialize-IntersightResourcepoolMembershipReservation
...
Initialize-IntersightResourcepoolMembershipReservation [-Account< Model.IamAccountRelationship>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< ResourcepoolMembershipReservation.ClassIdEnum>][-Description< string>][-Expiration< DateTime>][-Identity< Model.MoBaseMoRelationship>][-Moid< string>][-ObjectType< ResourcepoolMembershipReservation.ObjectTypeEnum>][-Pools< System.Collections.Generic.List`1[Model.ResourcepoolPoolRelationship]>][-ReservationSelector< string>][-ResourceType< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ResourcepoolMembershipReservation.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ResourcepoolMembershipReservation.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightResourcepoolMembershipReservation
```
