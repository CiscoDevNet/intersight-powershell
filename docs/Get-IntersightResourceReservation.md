...
# Get-IntersightResourceReservation

## SYNOPSIS
Get the ResourceReservation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightResourceReservation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourceReservation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ResourceReservation&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourceReservation
```
Above example returns the list of ResourceReservation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourceReservation -Name "MoName"
```
Above example returns the ResourceReservation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourceReservation -Organization $organization
```
Above example returns the list of ResourceReservation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourceReservation -InlineCount allpages
```
Above example returns the list of ResourceReservation along with count.
...
### -Name
Specifies the name of the ResourceReservation.
...
### -Organization
Specifies the organization, to fetch the ResourceReservation under it.
