...
# Get-IntersightPoolIdMappingPolicy

## SYNOPSIS
Get the PoolIdMappingPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPoolIdMappingPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPoolIdMappingPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PoolIdMappingPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPoolIdMappingPolicy
```
Above example returns the list of PoolIdMappingPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPoolIdMappingPolicy -Name "MoName"
```
Above example returns the PoolIdMappingPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPoolIdMappingPolicy -Organization $organization
```
Above example returns the list of PoolIdMappingPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPoolIdMappingPolicy -InlineCount allpages
```
Above example returns the list of PoolIdMappingPolicy along with count.
...
### -Name
Specifies the name of the PoolIdMappingPolicy.
...
### -Organization
Specifies the organization, to fetch the PoolIdMappingPolicy under it.
...
[New-IntersightPoolIdMappingPolicy](./New-IntersightPoolIdMappingPolicy.md)

[Remove-IntersightPoolIdMappingPolicy](./Remove-IntersightPoolIdMappingPolicy.md)

[Set-IntersightPoolIdMappingPolicy](./Set-IntersightPoolIdMappingPolicy.md)
