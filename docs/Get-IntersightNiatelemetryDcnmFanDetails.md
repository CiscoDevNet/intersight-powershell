...
## SYNOPSIS
Get the NiatelemetryDcnmFanDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryDcnmFanDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryDcnmFanDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryDcnmFanDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmFanDetails
```
Above example returns the list of NiatelemetryDcnmFanDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmFanDetails -Name "MoName"
```
Above example returns the NiatelemetryDcnmFanDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmFanDetails -Organization $organization
```
Above example returns the list of NiatelemetryDcnmFanDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryDcnmFanDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryDcnmFanDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryDcnmFanDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryDcnmFanDetails under it.
