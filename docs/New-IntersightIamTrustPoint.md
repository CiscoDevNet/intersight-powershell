...
New-IntersightIamTrustPoint [-AdditionalProperties< Dictionary<string,object>>][-Certificates< List<X509Certificate>>][-Chain< string>][-Moid< string>][-Tags< List<MoTag>>]
...
```yaml
Type: System.Collections.Generic.List`1[X509Certificate]
Parameter Sets: (All)
Aliases:
