...
# Get-IntersightServicenowChangeRequestDoc

## SYNOPSIS
Get the ServicenowChangeRequestDoc

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightServicenowChangeRequestDoc [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightServicenowChangeRequestDoc [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ServicenowChangeRequestDoc&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightServicenowChangeRequestDoc
```
Above example returns the list of ServicenowChangeRequestDoc.

### Example 2
```powershell
PS C:\> $result = Get-IntersightServicenowChangeRequestDoc -Name "MoName"
```
Above example returns the ServicenowChangeRequestDoc matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightServicenowChangeRequestDoc -Organization $organization
```
Above example returns the list of ServicenowChangeRequestDoc available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightServicenowChangeRequestDoc -InlineCount allpages
```
Above example returns the list of ServicenowChangeRequestDoc along with count.
...
### -Name
Specifies the name of the ServicenowChangeRequestDoc.
...
### -Organization
Specifies the organization, to fetch the ServicenowChangeRequestDoc under it.
