...
# Get-IntersightStorageHitachiRemoteCopyPairGad

## SYNOPSIS
Get the StorageHitachiRemoteCopyPairGad

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiRemoteCopyPairGad [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiRemoteCopyPairGad [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiRemoteCopyPairGad&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteCopyPairGad
```
Above example returns the list of StorageHitachiRemoteCopyPairGad.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteCopyPairGad -Name "MoName"
```
Above example returns the StorageHitachiRemoteCopyPairGad matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteCopyPairGad -Organization $organization
```
Above example returns the list of StorageHitachiRemoteCopyPairGad available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiRemoteCopyPairGad -InlineCount allpages
```
Above example returns the list of StorageHitachiRemoteCopyPairGad along with count.
...
### -Name
Specifies the name of the StorageHitachiRemoteCopyPairGad.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiRemoteCopyPairGad under it.
