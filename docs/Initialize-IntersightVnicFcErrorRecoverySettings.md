...
Initialize-IntersightVnicFcErrorRecoverySettings [-AdditionalProperties< Dictionary<string,object>>][-ClassId< VnicFcErrorRecoverySettings.ClassIdEnum>][-Enabled< bool>][-IoRetryCount< long>][-IoRetryTimeout< long>][-LinkDownTimeout< long>][-ObjectType< VnicFcErrorRecoverySettings.ObjectTypeEnum>][-PortDownTimeout< long>]
