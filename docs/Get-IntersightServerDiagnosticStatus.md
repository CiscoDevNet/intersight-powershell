...
# Get-IntersightServerDiagnosticStatus

## SYNOPSIS
Get the ServerDiagnosticStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightServerDiagnosticStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightServerDiagnosticStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ServerDiagnosticStatus&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightServerDiagnosticStatus
```
Above example returns the list of ServerDiagnosticStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightServerDiagnosticStatus -Name "MoName"
```
Above example returns the ServerDiagnosticStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightServerDiagnosticStatus -Organization $organization
```
Above example returns the list of ServerDiagnosticStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightServerDiagnosticStatus -InlineCount allpages
```
Above example returns the list of ServerDiagnosticStatus along with count.
...
### -Name
Specifies the name of the ServerDiagnosticStatus.
...
### -Organization
Specifies the organization, to fetch the ServerDiagnosticStatus under it.
