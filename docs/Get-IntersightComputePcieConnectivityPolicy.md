...
### CmdletParam (Default)
```
Get-IntersightComputePcieConnectivityPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputePcieConnectivityPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
