# Intersight.Intersight/Api.IntersightExternalsiteApi

All URIs are relative to *https://intersight.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**New-IntersightExternalsiteAuthorization**](IntersightExternalsiteApi.md#New-IntersightExternalsiteAuthorization) | **POST** /api/v1/externalsite/Authorizations | Create a &#39;externalsite.Authorization&#39; resource.
[**Get-IntersightExternalsiteAuthorizationByMoid**](IntersightExternalsiteApi.md#Get-IntersightExternalsiteAuthorizationByMoid) | **GET** /api/v1/externalsite/Authorizations/{Moid} | Read a &#39;externalsite.Authorization&#39; resource.
[**Get-IntersightExternalsiteAuthorizationList**](IntersightExternalsiteApi.md#Get-IntersightExternalsiteAuthorizationList) | **GET** /api/v1/externalsite/Authorizations | Read a &#39;externalsite.Authorization&#39; resource.
[**Set-IntersightExternalsiteAuthorization**](IntersightExternalsiteApi.md#Set-IntersightExternalsiteAuthorization) | **PATCH** /api/v1/externalsite/Authorizations/{Moid} | Update a &#39;externalsite.Authorization&#39; resource.
[**Update-IntersightExternalsiteAuthorization**](IntersightExternalsiteApi.md#Update-IntersightExternalsiteAuthorization) | **POST** /api/v1/externalsite/Authorizations/{Moid} | Update a &#39;externalsite.Authorization&#39; resource.


<a name="New-IntersightExternalsiteAuthorization"></a>
# **New-IntersightExternalsiteAuthorization**
> ExternalsiteAuthorization New-IntersightExternalsiteAuthorization<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ExternalsiteAuthorization] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Create a 'externalsite.Authorization' resource.
try {
     $Result = New-IntersightExternalsiteAuthorization -ExternalsiteAuthorization $ExternalsiteAuthorization -IfMatch $IfMatch -IfNoneMatch $IfNoneMatch
} catch {
    Write-Host ("Exception occured when calling New-IntersightExternalsiteAuthorization: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a name="Get-IntersightExternalsiteAuthorizationByMoid"></a>
# **Get-IntersightExternalsiteAuthorizationByMoid**
> ExternalsiteAuthorization Get-IntersightExternalsiteAuthorizationByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'externalsite.Authorization' resource.
try {
     $Result = Get-IntersightExternalsiteAuthorizationByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightExternalsiteAuthorizationByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightExternalsiteAuthorizationList"></a>
# **Get-IntersightExternalsiteAuthorizationList**
> ExternalsiteAuthorizationResponse Get-IntersightExternalsiteAuthorizationList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
...
# Read a 'externalsite.Authorization' resource.
try {
     $Result = Get-IntersightExternalsiteAuthorizationList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightExternalsiteAuthorizationList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightExternalsiteAuthorization"></a>
# **Set-IntersightExternalsiteAuthorization**
> ExternalsiteAuthorization Set-IntersightExternalsiteAuthorization<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ExternalsiteAuthorization] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'externalsite.Authorization' resource.
try {
     $Result = Set-IntersightExternalsiteAuthorization -Moid $Moid -ExternalsiteAuthorization $ExternalsiteAuthorization -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightExternalsiteAuthorization: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightExternalsiteAuthorization"></a>
# **Update-IntersightExternalsiteAuthorization**
> ExternalsiteAuthorization Update-IntersightExternalsiteAuthorization<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ExternalsiteAuthorization] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'externalsite.Authorization' resource.
try {
     $Result = Update-IntersightExternalsiteAuthorization -Moid $Moid -ExternalsiteAuthorization $ExternalsiteAuthorization -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightExternalsiteAuthorization: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
