...
## SYNOPSIS
Get the MetricsMetricsExploration

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMetricsMetricsExploration [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMetricsMetricsExploration [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MetricsMetricsExploration&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMetricsMetricsExploration
```
Above example returns the list of MetricsMetricsExploration.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMetricsMetricsExploration -Name "MoName"
```
Above example returns the MetricsMetricsExploration matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMetricsMetricsExploration -Organization $organization
```
Above example returns the list of MetricsMetricsExploration available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMetricsMetricsExploration -InlineCount allpages
```
Above example returns the list of MetricsMetricsExploration along with count.
...
### -Name
Specifies the name of the MetricsMetricsExploration.
...
### -Organization
Specifies the organization, to fetch the MetricsMetricsExploration under it.
