...
## SYNOPSIS
Get the VnicSanConnectivityPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicSanConnectivityPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicSanConnectivityPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicSanConnectivityPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicSanConnectivityPolicy
```
Above example returns the list of VnicSanConnectivityPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicSanConnectivityPolicy -Name "MoName"
```
Above example returns the VnicSanConnectivityPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicSanConnectivityPolicy -Organization $organization
```
Above example returns the list of VnicSanConnectivityPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicSanConnectivityPolicy -InlineCount allpages
```
Above example returns the list of VnicSanConnectivityPolicy along with count.
...
### -Name
Specifies the name of the VnicSanConnectivityPolicy.
...
### -Organization
Specifies the organization, to fetch the VnicSanConnectivityPolicy under it.
