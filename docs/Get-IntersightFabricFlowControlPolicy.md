...
## SYNOPSIS
Get the FabricFlowControlPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricFlowControlPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricFlowControlPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricFlowControlPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricFlowControlPolicy
```
Above example returns the list of FabricFlowControlPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricFlowControlPolicy -Name "MoName"
```
Above example returns the FabricFlowControlPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricFlowControlPolicy -Organization $organization
```
Above example returns the list of FabricFlowControlPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricFlowControlPolicy -InlineCount allpages
```
Above example returns the list of FabricFlowControlPolicy along with count.
...
### -Name
Specifies the name of the FabricFlowControlPolicy.
...
### -Organization
Specifies the organization, to fetch the FabricFlowControlPolicy under it.
