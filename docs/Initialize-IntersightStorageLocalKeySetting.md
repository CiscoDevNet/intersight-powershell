...
Initialize-IntersightStorageLocalKeySetting [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< StorageLocalKeySetting.ClassIdEnum>][-ExistingKey< string>][-NewKey< string>][-ObjectType< StorageLocalKeySetting.ObjectTypeEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: StorageLocalKeySetting.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: StorageLocalKeySetting.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightStorageLocalKeySetting
```
