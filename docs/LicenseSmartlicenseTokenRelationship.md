...
```powershell
$LicenseSmartlicenseTokenRelationship = Initialize-IntersightLicenseSmartlicenseTokenRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$LicenseSmartlicenseTokenRelationship | ConvertTo-JSON
```
