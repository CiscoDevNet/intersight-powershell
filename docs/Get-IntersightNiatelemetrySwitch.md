...
# Get-IntersightNiatelemetrySwitch

## SYNOPSIS
Get the NiatelemetrySwitch

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetrySwitch [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetrySwitch [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetrySwitch&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySwitch
```
Above example returns the list of NiatelemetrySwitch.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySwitch -Name "MoName"
```
Above example returns the NiatelemetrySwitch matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySwitch -Organization $organization
```
Above example returns the list of NiatelemetrySwitch available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySwitch -InlineCount allpages
```
Above example returns the list of NiatelemetrySwitch along with count.
...
### -Name
Specifies the name of the NiatelemetrySwitch.
...
### -Organization
Specifies the organization, to fetch the NiatelemetrySwitch under it.
