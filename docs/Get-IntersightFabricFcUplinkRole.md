...
## SYNOPSIS
Get the FabricFcUplinkRole

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricFcUplinkRole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricFcUplinkRole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;FabricFcUplinkRole&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricFcUplinkRole
```
Above example returns the list of FabricFcUplinkRole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricFcUplinkRole -Name "MoName"
```
Above example returns the FabricFcUplinkRole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricFcUplinkRole -Organization $organization
```
Above example returns the list of FabricFcUplinkRole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricFcUplinkRole -InlineCount allpages
```
Above example returns the list of FabricFcUplinkRole along with count.
...
### -Name
Specifies the name of the FabricFcUplinkRole.
...
### -Organization
Specifies the organization, to fetch the FabricFcUplinkRole under it.
