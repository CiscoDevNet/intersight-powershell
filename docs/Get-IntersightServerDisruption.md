...
# Get-IntersightServerDisruption

## SYNOPSIS
Get the ServerDisruption

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightServerDisruption [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightServerDisruption [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ServerDisruption&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightServerDisruption
```
Above example returns the list of ServerDisruption.

### Example 2
```powershell
PS C:\> $result = Get-IntersightServerDisruption -Name "MoName"
```
Above example returns the ServerDisruption matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightServerDisruption -Organization $organization
```
Above example returns the list of ServerDisruption available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightServerDisruption -InlineCount allpages
```
Above example returns the list of ServerDisruption along with count.
...
### -Name
Specifies the name of the ServerDisruption.
...
### -Organization
Specifies the organization, to fetch the ServerDisruption under it.
