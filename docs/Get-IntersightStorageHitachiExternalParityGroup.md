...
# Get-IntersightStorageHitachiExternalParityGroup

## SYNOPSIS
Get the StorageHitachiExternalParityGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageHitachiExternalParityGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageHitachiExternalParityGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageHitachiExternalParityGroup&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalParityGroup
```
Above example returns the list of StorageHitachiExternalParityGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalParityGroup -Name "MoName"
```
Above example returns the StorageHitachiExternalParityGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalParityGroup -Organization $organization
```
Above example returns the list of StorageHitachiExternalParityGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageHitachiExternalParityGroup -InlineCount allpages
```
Above example returns the list of StorageHitachiExternalParityGroup along with count.
...
### -Name
Specifies the name of the StorageHitachiExternalParityGroup.
...
### -Organization
Specifies the organization, to fetch the StorageHitachiExternalParityGroup under it.
