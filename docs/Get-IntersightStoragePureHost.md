...
# Get-IntersightStoragePureHost

## SYNOPSIS
Get the StoragePureHost

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePureHost [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePureHost [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StoragePureHost&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePureHost
```
Above example returns the list of StoragePureHost.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePureHost -Name "MoName"
```
Above example returns the StoragePureHost matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePureHost -Organization $organization
```
Above example returns the list of StoragePureHost available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePureHost -InlineCount allpages
```
Above example returns the list of StoragePureHost along with count.
...
### -Name
Specifies the name of the StoragePureHost.
...
### -Organization
Specifies the organization, to fetch the StoragePureHost under it.
