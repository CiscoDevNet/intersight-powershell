...
## SYNOPSIS
Get the FabricConfigResultEntry

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricConfigResultEntry [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricConfigResultEntry [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricConfigResultEntry&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricConfigResultEntry
```
Above example returns the list of FabricConfigResultEntry.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricConfigResultEntry -Name "MoName"
```
Above example returns the FabricConfigResultEntry matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricConfigResultEntry -Organization $organization
```
Above example returns the list of FabricConfigResultEntry available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricConfigResultEntry -InlineCount allpages
```
Above example returns the list of FabricConfigResultEntry along with count.
...
### -Name
Specifies the name of the FabricConfigResultEntry.
...
### -Organization
Specifies the organization, to fetch the FabricConfigResultEntry under it.
