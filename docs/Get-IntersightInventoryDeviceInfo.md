...
## SYNOPSIS
Get the InventoryDeviceInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightInventoryDeviceInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightInventoryDeviceInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightInventoryDeviceInfo
```
Above example returns the list of InventoryDeviceInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightInventoryDeviceInfo -Name "MoName"
```
Above example returns the InventoryDeviceInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightInventoryDeviceInfo -Organization $organization
```
Above example returns the list of InventoryDeviceInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightInventoryDeviceInfo -InlineCount allpages
```
Above example returns the list of InventoryDeviceInfo along with count.
...
### -Name
Specifies the name of the InventoryDeviceInfo.
...
### -Organization
Specifies the organization, to fetch the InventoryDeviceInfo under it.
