...
```yaml
Type: NotificationSimpleMoCondition.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: NotificationSimpleMoCondition.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[NotificationSimpleMoCondition.OperationsEnum]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightNotificationSimpleMoCondition
```
