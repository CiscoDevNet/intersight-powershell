...
```yaml
Type: TechsupportmanagementTechSupportStatus.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TechsupportmanagementTechSupportStatus.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTechsupportmanagementTechSupportStatus
```
