...
## SYNOPSIS
Get the HyperflexKeyEncryptionKey

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexKeyEncryptionKey [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexKeyEncryptionKey [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexKeyEncryptionKey&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexKeyEncryptionKey
```
Above example returns the list of HyperflexKeyEncryptionKey.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexKeyEncryptionKey -Name "MoName"
```
Above example returns the HyperflexKeyEncryptionKey matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexKeyEncryptionKey -Organization $organization
```
Above example returns the list of HyperflexKeyEncryptionKey available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexKeyEncryptionKey -InlineCount allpages
```
Above example returns the list of HyperflexKeyEncryptionKey along with count.
...
### -Name
Specifies the name of the HyperflexKeyEncryptionKey.
...
### -Organization
Specifies the organization, to fetch the HyperflexKeyEncryptionKey under it.
