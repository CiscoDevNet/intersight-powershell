...
# Initialize-IntersightFirmwarePciNodeUpgrade
...
```yaml
Type: FirmwarePciNodeUpgrade.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FirmwarePciNodeUpgrade.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.PciNodeRelationship
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFirmwarePciNodeUpgrade
```
