...
### CmdletParam (Default)
```
Get-IntersightCapabilityIoCardCapabilityDef [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityIoCardCapabilityDef [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityIoCardCapabilityDef
```
Above example returns the list of CapabilityIoCardCapabilityDef.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityIoCardCapabilityDef -Name "MoName"
```
Above example returns the CapabilityIoCardCapabilityDef matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityIoCardCapabilityDef -Organization $organization
```
Above example returns the list of CapabilityIoCardCapabilityDef available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityIoCardCapabilityDef -InlineCount allpages
```
Above example returns the list of CapabilityIoCardCapabilityDef along with count.
...
### -Name
Specifies the name of the CapabilityIoCardCapabilityDef.
...
### -Organization
Specifies the organization, to fetch the CapabilityIoCardCapabilityDef under it.
