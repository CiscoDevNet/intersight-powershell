...
## SYNOPSIS
Get the IaasUcsdManagedInfra

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIaasUcsdManagedInfra [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIaasUcsdManagedInfra [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IaasUcsdManagedInfra&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIaasUcsdManagedInfra
```
Above example returns the list of IaasUcsdManagedInfra.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIaasUcsdManagedInfra -Name "MoName"
```
Above example returns the IaasUcsdManagedInfra matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIaasUcsdManagedInfra -Organization $organization
```
Above example returns the list of IaasUcsdManagedInfra available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIaasUcsdManagedInfra -InlineCount allpages
```
Above example returns the list of IaasUcsdManagedInfra along with count.
...
### -Name
Specifies the name of the IaasUcsdManagedInfra.
...
### -Organization
Specifies the organization, to fetch the IaasUcsdManagedInfra under it.
