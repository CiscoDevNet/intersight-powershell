...
## SYNOPSIS
Get the RecoveryScheduleConfigPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRecoveryScheduleConfigPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRecoveryScheduleConfigPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRecoveryScheduleConfigPolicy
```
Above example returns the list of RecoveryScheduleConfigPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRecoveryScheduleConfigPolicy -Name "MoName"
```
Above example returns the RecoveryScheduleConfigPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRecoveryScheduleConfigPolicy -Organization $organization
```
Above example returns the list of RecoveryScheduleConfigPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRecoveryScheduleConfigPolicy -InlineCount allpages
```
Above example returns the list of RecoveryScheduleConfigPolicy along with count.
...
### -Name
Specifies the name of the RecoveryScheduleConfigPolicy.
...
### -Organization
Specifies the organization, to fetch the RecoveryScheduleConfigPolicy under it.
