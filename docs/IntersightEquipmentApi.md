# Intersight.Intersight/Api.IntersightEquipmentApi
...
[**Get-IntersightEquipmentIoCardOperationByMoid**](IntersightEquipmentApi.md#Get-IntersightEquipmentIoCardOperationByMoid) | **GET** /api/v1/equipment/IoCardOperations/{Moid} | Read a &#39;equipment.IoCardOperation&#39; resource.
...
[**Set-IntersightEquipmentChassis**](IntersightEquipmentApi.md#Set-IntersightEquipmentChassis) | **PATCH** /api/v1/equipment/Chasses/{Moid} | Update a &#39;equipment.Chassis&#39; resource.
...
[**Update-IntersightEquipmentFan**](IntersightEquipmentApi.md#Update-IntersightEquipmentFan) | **POST** /api/v1/equipment/Fans/{Moid} | Update a &#39;equipment.Fan&#39; resource.
...
# Read a 'equipment.Chassis' resource.
try {
    EquipmentChassis $Result = Get-IntersightEquipmentChassisByMoid -Moid $Moid
} catch {
...
# Read a 'equipment.ChassisIdentity' resource.
try {
    EquipmentChassisIdentity $Result = Get-IntersightEquipmentChassisIdentityByMoid -Moid $Moid
} catch {
...
# Read a 'equipment.ChassisIdentity' resource.
try {
    EquipmentChassisIdentityResponse $Result = Get-IntersightEquipmentChassisIdentityList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentChassisIdentityList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
# Read a 'equipment.Chassis' resource.
try {
    EquipmentChassisResponse $Result = Get-IntersightEquipmentChassisList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'equipment.DeviceSummary' resource.
try {
    EquipmentDeviceSummary $Result = Get-IntersightEquipmentDeviceSummaryByMoid -Moid $Moid
} catch {
...
# Read a 'equipment.DeviceSummary' resource.
try {
    EquipmentDeviceSummaryResponse $Result = Get-IntersightEquipmentDeviceSummaryList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
...
# Read a 'equipment.Fan' resource.
try {
    EquipmentFan $Result = Get-IntersightEquipmentFanByMoid -Moid $Moid
} catch {
...
# Read a 'equipment.Fan' resource.
try {
    EquipmentFanResponse $Result = Get-IntersightEquipmentFanList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentFanList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
# Read a 'equipment.FanModule' resource.
try {
    EquipmentFanModule $Result = Get-IntersightEquipmentFanModuleByMoid -Moid $Moid
} catch {
...
# Read a 'equipment.FanModule' resource.
try {
    EquipmentFanModuleResponse $Result = Get-IntersightEquipmentFanModuleList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentFanModuleList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
# Read a 'equipment.Fex' resource.
try {
    EquipmentFex $Result = Get-IntersightEquipmentFexByMoid -Moid $Moid
} catch {
...
# Read a 'equipment.FexIdentity' resource.
try {
    EquipmentFexIdentity $Result = Get-IntersightEquipmentFexIdentityByMoid -Moid $Moid
} catch {
...
<a name="Get-IntersightEquipmentFexIdentityList"></a>
# **Get-IntersightEquipmentFexIdentityList**
> EquipmentFexIdentityResponse Get-IntersightEquipmentFexIdentityList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.FexIdentity' resource.
try {
    EquipmentFexIdentityResponse $Result = Get-IntersightEquipmentFexIdentityList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentFexIdentityList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentFexList"></a>
# **Get-IntersightEquipmentFexList**
> EquipmentFexResponse Get-IntersightEquipmentFexList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.Fex' resource.
try {
    EquipmentFexResponse $Result = Get-IntersightEquipmentFexList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentFexList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentFexOperationByMoid"></a>
# **Get-IntersightEquipmentFexOperationByMoid**
> EquipmentFexOperation Get-IntersightEquipmentFexOperationByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'equipment.FexOperation' resource.
try {
    EquipmentFexOperation $Result = Get-IntersightEquipmentFexOperationByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentFexOperationByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentFexOperationList"></a>
# **Get-IntersightEquipmentFexOperationList**
> EquipmentFexOperationResponse Get-IntersightEquipmentFexOperationList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.FexOperation' resource.
try {
    EquipmentFexOperationResponse $Result = Get-IntersightEquipmentFexOperationList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentFexOperationList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentIdentitySummaryByMoid"></a>
# **Get-IntersightEquipmentIdentitySummaryByMoid**
> EquipmentIdentitySummary Get-IntersightEquipmentIdentitySummaryByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'equipment.IdentitySummary' resource.
try {
    EquipmentIdentitySummary $Result = Get-IntersightEquipmentIdentitySummaryByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentIdentitySummaryByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentIdentitySummaryList"></a>
# **Get-IntersightEquipmentIdentitySummaryList**
> EquipmentIdentitySummaryResponse Get-IntersightEquipmentIdentitySummaryList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.IdentitySummary' resource.
try {
    EquipmentIdentitySummaryResponse $Result = Get-IntersightEquipmentIdentitySummaryList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentIdentitySummaryList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentIoCardByMoid"></a>
# **Get-IntersightEquipmentIoCardByMoid**
> EquipmentIoCard Get-IntersightEquipmentIoCardByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'equipment.IoCard' resource.
try {
    EquipmentIoCard $Result = Get-IntersightEquipmentIoCardByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentIoCardByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentIoCardList"></a>
# **Get-IntersightEquipmentIoCardList**
> EquipmentIoCardResponse Get-IntersightEquipmentIoCardList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.IoCard' resource.
try {
    EquipmentIoCardResponse $Result = Get-IntersightEquipmentIoCardList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentIoCardList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentIoCardOperationByMoid"></a>
# **Get-IntersightEquipmentIoCardOperationByMoid**
> EquipmentIoCardOperation Get-IntersightEquipmentIoCardOperationByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'equipment.IoCardOperation' resource.
try {
    EquipmentIoCardOperation $Result = Get-IntersightEquipmentIoCardOperationByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentIoCardOperationByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentIoCardOperationList"></a>
# **Get-IntersightEquipmentIoCardOperationList**
> EquipmentIoCardOperationResponse Get-IntersightEquipmentIoCardOperationList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.IoCardOperation' resource.
try {
    EquipmentIoCardOperationResponse $Result = Get-IntersightEquipmentIoCardOperationList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentIoCardOperationList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentIoExpanderByMoid"></a>
# **Get-IntersightEquipmentIoExpanderByMoid**
> EquipmentIoExpander Get-IntersightEquipmentIoExpanderByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'equipment.IoExpander' resource.
try {
    EquipmentIoExpander $Result = Get-IntersightEquipmentIoExpanderByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentIoExpanderByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentIoExpanderList"></a>
# **Get-IntersightEquipmentIoExpanderList**
> EquipmentIoExpanderResponse Get-IntersightEquipmentIoExpanderList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.IoExpander' resource.
try {
    EquipmentIoExpanderResponse $Result = Get-IntersightEquipmentIoExpanderList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentIoExpanderList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentLocatorLedByMoid"></a>
# **Get-IntersightEquipmentLocatorLedByMoid**
> EquipmentLocatorLed Get-IntersightEquipmentLocatorLedByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'equipment.LocatorLed' resource.
try {
    EquipmentLocatorLed $Result = Get-IntersightEquipmentLocatorLedByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentLocatorLedByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentLocatorLedList"></a>
# **Get-IntersightEquipmentLocatorLedList**
> EquipmentLocatorLedResponse Get-IntersightEquipmentLocatorLedList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.LocatorLed' resource.
try {
    EquipmentLocatorLedResponse $Result = Get-IntersightEquipmentLocatorLedList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentLocatorLedList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentPsuByMoid"></a>
# **Get-IntersightEquipmentPsuByMoid**
> EquipmentPsu Get-IntersightEquipmentPsuByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'equipment.Psu' resource.
try {
    EquipmentPsu $Result = Get-IntersightEquipmentPsuByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentPsuByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentPsuControlByMoid"></a>
# **Get-IntersightEquipmentPsuControlByMoid**
> EquipmentPsuControl Get-IntersightEquipmentPsuControlByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'equipment.PsuControl' resource.
try {
    EquipmentPsuControl $Result = Get-IntersightEquipmentPsuControlByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentPsuControlByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentPsuControlList"></a>
# **Get-IntersightEquipmentPsuControlList**
> EquipmentPsuControlResponse Get-IntersightEquipmentPsuControlList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.PsuControl' resource.
try {
    EquipmentPsuControlResponse $Result = Get-IntersightEquipmentPsuControlList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentPsuControlList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentPsuList"></a>
# **Get-IntersightEquipmentPsuList**
> EquipmentPsuResponse Get-IntersightEquipmentPsuList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.Psu' resource.
try {
    EquipmentPsuResponse $Result = Get-IntersightEquipmentPsuList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentPsuList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentRackEnclosureByMoid"></a>
# **Get-IntersightEquipmentRackEnclosureByMoid**
> EquipmentRackEnclosure Get-IntersightEquipmentRackEnclosureByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'equipment.RackEnclosure' resource.
try {
    EquipmentRackEnclosure $Result = Get-IntersightEquipmentRackEnclosureByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentRackEnclosureByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentRackEnclosureList"></a>
# **Get-IntersightEquipmentRackEnclosureList**
> EquipmentRackEnclosureResponse Get-IntersightEquipmentRackEnclosureList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.RackEnclosure' resource.
try {
    EquipmentRackEnclosureResponse $Result = Get-IntersightEquipmentRackEnclosureList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentRackEnclosureList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentRackEnclosureSlotByMoid"></a>
# **Get-IntersightEquipmentRackEnclosureSlotByMoid**
> EquipmentRackEnclosureSlot Get-IntersightEquipmentRackEnclosureSlotByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'equipment.RackEnclosureSlot' resource.
try {
    EquipmentRackEnclosureSlot $Result = Get-IntersightEquipmentRackEnclosureSlotByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentRackEnclosureSlotByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentRackEnclosureSlotList"></a>
# **Get-IntersightEquipmentRackEnclosureSlotList**
> EquipmentRackEnclosureSlotResponse Get-IntersightEquipmentRackEnclosureSlotList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.RackEnclosureSlot' resource.
try {
    EquipmentRackEnclosureSlotResponse $Result = Get-IntersightEquipmentRackEnclosureSlotList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentRackEnclosureSlotList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentSharedIoModuleByMoid"></a>
# **Get-IntersightEquipmentSharedIoModuleByMoid**
> EquipmentSharedIoModule Get-IntersightEquipmentSharedIoModuleByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'equipment.SharedIoModule' resource.
try {
    EquipmentSharedIoModule $Result = Get-IntersightEquipmentSharedIoModuleByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentSharedIoModuleByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentSharedIoModuleList"></a>
# **Get-IntersightEquipmentSharedIoModuleList**
> EquipmentSharedIoModuleResponse Get-IntersightEquipmentSharedIoModuleList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.SharedIoModule' resource.
try {
    EquipmentSharedIoModuleResponse $Result = Get-IntersightEquipmentSharedIoModuleList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentSharedIoModuleList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentSwitchCardByMoid"></a>
# **Get-IntersightEquipmentSwitchCardByMoid**
> EquipmentSwitchCard Get-IntersightEquipmentSwitchCardByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'equipment.SwitchCard' resource.
try {
    EquipmentSwitchCard $Result = Get-IntersightEquipmentSwitchCardByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentSwitchCardByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentSwitchCardList"></a>
# **Get-IntersightEquipmentSwitchCardList**
> EquipmentSwitchCardResponse Get-IntersightEquipmentSwitchCardList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.SwitchCard' resource.
try {
    EquipmentSwitchCardResponse $Result = Get-IntersightEquipmentSwitchCardList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentSwitchCardList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentSystemIoControllerByMoid"></a>
# **Get-IntersightEquipmentSystemIoControllerByMoid**
> EquipmentSystemIoController Get-IntersightEquipmentSystemIoControllerByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'equipment.SystemIoController' resource.
try {
    EquipmentSystemIoController $Result = Get-IntersightEquipmentSystemIoControllerByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentSystemIoControllerByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentSystemIoControllerList"></a>
# **Get-IntersightEquipmentSystemIoControllerList**
> EquipmentSystemIoControllerResponse Get-IntersightEquipmentSystemIoControllerList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.SystemIoController' resource.
try {
    EquipmentSystemIoControllerResponse $Result = Get-IntersightEquipmentSystemIoControllerList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentSystemIoControllerList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentTpmByMoid"></a>
# **Get-IntersightEquipmentTpmByMoid**
> EquipmentTpm Get-IntersightEquipmentTpmByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'equipment.Tpm' resource.
try {
    EquipmentTpm $Result = Get-IntersightEquipmentTpmByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentTpmByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentTpmList"></a>
# **Get-IntersightEquipmentTpmList**
> EquipmentTpmResponse Get-IntersightEquipmentTpmList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.Tpm' resource.
try {
    EquipmentTpmResponse $Result = Get-IntersightEquipmentTpmList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentTpmList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentTransceiverByMoid"></a>
# **Get-IntersightEquipmentTransceiverByMoid**
> EquipmentTransceiver Get-IntersightEquipmentTransceiverByMoid<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
...
# Read a 'equipment.Transceiver' resource.
try {
    EquipmentTransceiver $Result = Get-IntersightEquipmentTransceiverByMoid -Moid $Moid
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentTransceiverByMoid: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-IntersightEquipmentTransceiverList"></a>
# **Get-IntersightEquipmentTransceiverList**
> EquipmentTransceiverResponse Get-IntersightEquipmentTransceiverList<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VarFilter] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Orderby] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Top] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Skip] <System.Nullable[Int32]><br>
...
# Read a 'equipment.Transceiver' resource.
try {
    EquipmentTransceiverResponse $Result = Get-IntersightEquipmentTransceiverList -VarFilter $VarFilter -Orderby $Orderby -Top $Top -Skip $Skip -Select $Select -Expand $Expand -Apply $Apply -Count $Count -Inlinecount $Inlinecount -At $At -Tags $Tags
} catch {
    Write-Host ("Exception occured when calling Get-IntersightEquipmentTransceiverList: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-IntersightEquipmentChassis"></a>
# **Set-IntersightEquipmentChassis**
> EquipmentChassis Set-IntersightEquipmentChassis<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentChassis] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.Chassis' resource.
try {
    EquipmentChassis $Result = Set-IntersightEquipmentChassis -Moid $Moid -EquipmentChassis $EquipmentChassis -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentChassis: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentChassis** | [**EquipmentChassis**](EquipmentChassis.md)| The &#39;equipment.Chassis&#39; resource to update. | 
...
<a name="Set-IntersightEquipmentChassisIdentity"></a>
# **Set-IntersightEquipmentChassisIdentity**
> EquipmentChassisIdentity Set-IntersightEquipmentChassisIdentity<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentChassisIdentity] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentChassisIdentity = (Initialize-equipment.ChassisIdentity-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -AdminAction "AdminAction_example" -AdminActionState "AdminActionState_example" -Identifier 123 -Lifecycle "Lifecycle_example" -Model "Model_example" -Serial "Serial_example" -Vendor "Vendor_example" -DeviceRegistration  -IoCardIdentityList @((Initialize-equipment.IoCardIdentity-ClassId "ClassId_example" -ObjectType "ObjectType_example" -IoCardMoid "IoCardMoid_example" -ModuleId 123 -NetworkElementMoid "NetworkElementMoid_example" -SwitchId 123)) -Chassis ) # EquipmentChassisIdentity | The 'equipment.ChassisIdentity' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.ChassisIdentity' resource.
try {
    EquipmentChassisIdentity $Result = Set-IntersightEquipmentChassisIdentity -Moid $Moid -EquipmentChassisIdentity $EquipmentChassisIdentity -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentChassisIdentity: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentChassisIdentity** | [**EquipmentChassisIdentity**](EquipmentChassisIdentity.md)| The &#39;equipment.ChassisIdentity&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentFan"></a>
# **Set-IntersightEquipmentFan**
> EquipmentFan Set-IntersightEquipmentFan<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentFan] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentFan = (Initialize-equipment.Fan-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -Description "Description_example" -FanId 123 -FanModuleId 123 -ModuleId 123 -OperState "OperState_example" -PartNumber "PartNumber_example" -VarPid "VarPid_example" -Presence "Presence_example" -Sku "Sku_example" -TrayId 123 -Vid "Vid_example" -EquipmentFanModule  -EquipmentFex  -InventoryDeviceInfo  -RegisteredDevice ) # EquipmentFan | The 'equipment.Fan' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.Fan' resource.
try {
    EquipmentFan $Result = Set-IntersightEquipmentFan -Moid $Moid -EquipmentFan $EquipmentFan -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentFan: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentFan** | [**EquipmentFan**](EquipmentFan.md)| The &#39;equipment.Fan&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentFanModule"></a>
# **Set-IntersightEquipmentFanModule**
> EquipmentFanModule Set-IntersightEquipmentFanModule<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentFanModule] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentFanModule = (Initialize-equipment.FanModule-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -Description "Description_example" -ModuleId 123 -OperState "OperState_example" -PartNumber "PartNumber_example" -VarPid "VarPid_example" -Presence "Presence_example" -Sku "Sku_example" -TrayId 123 -Vid "Vid_example" -ComputeRackUnit  -EquipmentChassis  -EquipmentRackEnclosure  -Fans @() -InventoryDeviceInfo  -NetworkElement  -RegisteredDevice ) # EquipmentFanModule | The 'equipment.FanModule' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.FanModule' resource.
try {
    EquipmentFanModule $Result = Set-IntersightEquipmentFanModule -Moid $Moid -EquipmentFanModule $EquipmentFanModule -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentFanModule: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentFanModule** | [**EquipmentFanModule**](EquipmentFanModule.md)| The &#39;equipment.FanModule&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentFex"></a>
# **Set-IntersightEquipmentFex**
> EquipmentFex Set-IntersightEquipmentFex<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentFex] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentFex = (Initialize-equipment.Fex-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -ConnectionStatus "ConnectionStatus_example" -Description "Description_example" -ModuleId 123 -OperState "OperState_example" -PartNumber "PartNumber_example" -VarPid "VarPid_example" -Presence "Presence_example" -ProductName "ProductName_example" -Sku "Sku_example" -Version "Version_example" -Vid "Vid_example" -HostPorts @() -MgmtController  -NetworkPorts @() -DiscoveryState "DiscoveryState_example" -Fans @() -InventoryDeviceInfo  -LocatorLed  -NetworkElement  -Psus @() -RegisteredDevice ) # EquipmentFex | The 'equipment.Fex' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.Fex' resource.
try {
    EquipmentFex $Result = Set-IntersightEquipmentFex -Moid $Moid -EquipmentFex $EquipmentFex -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentFex: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentFex** | [**EquipmentFex**](EquipmentFex.md)| The &#39;equipment.Fex&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentFexIdentity"></a>
# **Set-IntersightEquipmentFexIdentity**
> EquipmentFexIdentity Set-IntersightEquipmentFexIdentity<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentFexIdentity] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentFexIdentity = (Initialize-equipment.FexIdentity-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -AdminAction "AdminAction_example" -AdminActionState "AdminActionState_example" -Identifier 123 -Lifecycle "Lifecycle_example" -Model "Model_example" -Serial "Serial_example" -Vendor "Vendor_example" -DeviceRegistration  -PhysicalDeviceRegistration  -SwitchId 123 -Fex  -NetworkElement ) # EquipmentFexIdentity | The 'equipment.FexIdentity' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.FexIdentity' resource.
try {
    EquipmentFexIdentity $Result = Set-IntersightEquipmentFexIdentity -Moid $Moid -EquipmentFexIdentity $EquipmentFexIdentity -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentFexIdentity: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentFexIdentity** | [**EquipmentFexIdentity**](EquipmentFexIdentity.md)| The &#39;equipment.FexIdentity&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentFexOperation"></a>
# **Set-IntersightEquipmentFexOperation**
> EquipmentFexOperation Set-IntersightEquipmentFexOperation<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentFexOperation] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentFexOperation = (Initialize-equipment.FexOperation-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -AdminLocatorLedAction "AdminLocatorLedAction_example" -AdminLocatorLedActionState "AdminLocatorLedActionState_example" -DeviceRegistration  -Fex ) # EquipmentFexOperation | The 'equipment.FexOperation' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.FexOperation' resource.
try {
    EquipmentFexOperation $Result = Set-IntersightEquipmentFexOperation -Moid $Moid -EquipmentFexOperation $EquipmentFexOperation -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentFexOperation: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentFexOperation** | [**EquipmentFexOperation**](EquipmentFexOperation.md)| The &#39;equipment.FexOperation&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentIoCard"></a>
# **Set-IntersightEquipmentIoCard**
> EquipmentIoCard Set-IntersightEquipmentIoCard<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentIoCard] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentIoCard = (Initialize-equipment.IoCard-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -ConnectionStatus "ConnectionStatus_example" -Description "Description_example" -ModuleId 123 -OperState "OperState_example" -PartNumber "PartNumber_example" -VarPid "VarPid_example" -Presence "Presence_example" -ProductName "ProductName_example" -Sku "Sku_example" -Version "Version_example" -Vid "Vid_example" -HostPorts @() -MgmtController  -NetworkPorts @() -ConnectionPath "ConnectionPath_example" -DcSupported $false -Side "Side_example" -EquipmentChassis  -InventoryDeviceInfo  -PhysicalDeviceRegistration  -RegisteredDevice ) # EquipmentIoCard | The 'equipment.IoCard' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.IoCard' resource.
try {
    EquipmentIoCard $Result = Set-IntersightEquipmentIoCard -Moid $Moid -EquipmentIoCard $EquipmentIoCard -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentIoCard: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentIoCard** | [**EquipmentIoCard**](EquipmentIoCard.md)| The &#39;equipment.IoCard&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentIoCardOperation"></a>
# **Set-IntersightEquipmentIoCardOperation**
> EquipmentIoCardOperation Set-IntersightEquipmentIoCardOperation<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentIoCardOperation] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentIoCardOperation = (Initialize-equipment.IoCardOperation-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -AdminPowerState "AdminPowerState_example" -ConfigState "ConfigState_example" -DeviceRegistration  -IoCard ) # EquipmentIoCardOperation | The 'equipment.IoCardOperation' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.IoCardOperation' resource.
try {
    EquipmentIoCardOperation $Result = Set-IntersightEquipmentIoCardOperation -Moid $Moid -EquipmentIoCardOperation $EquipmentIoCardOperation -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentIoCardOperation: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentIoCardOperation** | [**EquipmentIoCardOperation**](EquipmentIoCardOperation.md)| The &#39;equipment.IoCardOperation&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentIoExpander"></a>
# **Set-IntersightEquipmentIoExpander**
> EquipmentIoExpander Set-IntersightEquipmentIoExpander<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentIoExpander] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentIoExpander = (Initialize-equipment.IoExpander-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -OperState "OperState_example" -Presence "Presence_example" -ComputeBlade  -InventoryDeviceInfo  -RegisteredDevice ) # EquipmentIoExpander | The 'equipment.IoExpander' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.IoExpander' resource.
try {
    EquipmentIoExpander $Result = Set-IntersightEquipmentIoExpander -Moid $Moid -EquipmentIoExpander $EquipmentIoExpander -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentIoExpander: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentIoExpander** | [**EquipmentIoExpander**](EquipmentIoExpander.md)| The &#39;equipment.IoExpander&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentLocatorLed"></a>
# **Set-IntersightEquipmentLocatorLed**
> EquipmentLocatorLed Set-IntersightEquipmentLocatorLed<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentLocatorLed] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentLocatorLed = (Initialize-equipment.LocatorLed-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Color "Color_example" -OperState "OperState_example" -ComputeBlade  -ComputeRackUnit  -EquipmentChassis  -EquipmentFex  -InventoryDeviceInfo  -RegisteredDevice  -StoragePhysicalDisk ) # EquipmentLocatorLed | The 'equipment.LocatorLed' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.LocatorLed' resource.
try {
    EquipmentLocatorLed $Result = Set-IntersightEquipmentLocatorLed -Moid $Moid -EquipmentLocatorLed $EquipmentLocatorLed -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentLocatorLed: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentLocatorLed** | [**EquipmentLocatorLed**](EquipmentLocatorLed.md)| The &#39;equipment.LocatorLed&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentPsu"></a>
# **Set-IntersightEquipmentPsu**
> EquipmentPsu Set-IntersightEquipmentPsu<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentPsu] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentPsu = (Initialize-equipment.Psu-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -Description "Description_example" -OperState "OperState_example" -PartNumber "PartNumber_example" -VarPid "VarPid_example" -Presence "Presence_example" -PsuFwVersion "PsuFwVersion_example" -PsuId 123 -PsuInputSrc "PsuInputSrc_example" -PsuType "PsuType_example" -PsuWattage "PsuWattage_example" -Sku "Sku_example" -Vid "Vid_example" -Voltage "Voltage_example" -ComputeRackUnit  -EquipmentChassis  -EquipmentFex  -EquipmentRackEnclosure  -InventoryDeviceInfo  -NetworkElement  -RegisteredDevice ) # EquipmentPsu | The 'equipment.Psu' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.Psu' resource.
try {
    EquipmentPsu $Result = Set-IntersightEquipmentPsu -Moid $Moid -EquipmentPsu $EquipmentPsu -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentPsu: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentPsu** | [**EquipmentPsu**](EquipmentPsu.md)| The &#39;equipment.Psu&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentPsuControl"></a>
# **Set-IntersightEquipmentPsuControl**
> EquipmentPsuControl Set-IntersightEquipmentPsuControl<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentPsuControl] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentPsuControl = (Initialize-equipment.PsuControl-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -ClusterState "ClusterState_example" -InputPowerState "InputPowerState_example" -Name "Name_example" -OperQualifier "OperQualifier_example" -OperState "OperState_example" -OutputPowerState "OutputPowerState_example" -Redundancy "Redundancy_example" -EquipmentChassis  -InventoryDeviceInfo  -RegisteredDevice ) # EquipmentPsuControl | The 'equipment.PsuControl' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.PsuControl' resource.
try {
    EquipmentPsuControl $Result = Set-IntersightEquipmentPsuControl -Moid $Moid -EquipmentPsuControl $EquipmentPsuControl -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentPsuControl: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentPsuControl** | [**EquipmentPsuControl**](EquipmentPsuControl.md)| The &#39;equipment.PsuControl&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentRackEnclosure"></a>
# **Set-IntersightEquipmentRackEnclosure**
> EquipmentRackEnclosure Set-IntersightEquipmentRackEnclosure<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentRackEnclosure] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentRackEnclosure = (Initialize-equipment.RackEnclosure-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -EnclosureId 123 -Fanmodules @() -InventoryDeviceInfo  -Psus @() -RegisteredDevice  -Slots @()) # EquipmentRackEnclosure | The 'equipment.RackEnclosure' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.RackEnclosure' resource.
try {
    EquipmentRackEnclosure $Result = Set-IntersightEquipmentRackEnclosure -Moid $Moid -EquipmentRackEnclosure $EquipmentRackEnclosure -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentRackEnclosure: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentRackEnclosure** | [**EquipmentRackEnclosure**](EquipmentRackEnclosure.md)| The &#39;equipment.RackEnclosure&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentRackEnclosureSlot"></a>
# **Set-IntersightEquipmentRackEnclosureSlot**
> EquipmentRackEnclosureSlot Set-IntersightEquipmentRackEnclosureSlot<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentRackEnclosureSlot] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentRackEnclosureSlot = (Initialize-equipment.RackEnclosureSlot-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -RackId 123 -RackUnitDn "RackUnitDn_example" -EquipmentRackEnclosure  -InventoryDeviceInfo  -RackUnit  -RegisteredDevice ) # EquipmentRackEnclosureSlot | The 'equipment.RackEnclosureSlot' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.RackEnclosureSlot' resource.
try {
    EquipmentRackEnclosureSlot $Result = Set-IntersightEquipmentRackEnclosureSlot -Moid $Moid -EquipmentRackEnclosureSlot $EquipmentRackEnclosureSlot -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentRackEnclosureSlot: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentRackEnclosureSlot** | [**EquipmentRackEnclosureSlot**](EquipmentRackEnclosureSlot.md)| The &#39;equipment.RackEnclosureSlot&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentSharedIoModule"></a>
# **Set-IntersightEquipmentSharedIoModule**
> EquipmentSharedIoModule Set-IntersightEquipmentSharedIoModule<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentSharedIoModule] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentSharedIoModule = (Initialize-equipment.SharedIoModule-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -ConfigState "ConfigState_example" -Discovery "Discovery_example" -MacOfSharedIomAside "MacOfSharedIomAside_example" -MacOfSharedIomBside "MacOfSharedIomBside_example" -OperState "OperState_example" -PartNumber "PartNumber_example" -Reachability "Reachability_example" -UsrLbl "UsrLbl_example" -Vid "Vid_example" -Controller  -EquipmentSystemIoController  -InventoryDeviceInfo  -PortGroups @() -RegisteredDevice ) # EquipmentSharedIoModule | The 'equipment.SharedIoModule' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.SharedIoModule' resource.
try {
    EquipmentSharedIoModule $Result = Set-IntersightEquipmentSharedIoModule -Moid $Moid -EquipmentSharedIoModule $EquipmentSharedIoModule -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentSharedIoModule: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentSharedIoModule** | [**EquipmentSharedIoModule**](EquipmentSharedIoModule.md)| The &#39;equipment.SharedIoModule&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentSwitchCard"></a>
# **Set-IntersightEquipmentSwitchCard**
> EquipmentSwitchCard Set-IntersightEquipmentSwitchCard<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentSwitchCard] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentSwitchCard = (Initialize-equipment.SwitchCard-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -Description "Description_example" -NumPorts 123 -OutOfBandIpAddress "OutOfBandIpAddress_example" -OutOfBandIpGateway "OutOfBandIpGateway_example" -Presence "Presence_example" -SlotId 123 -State "State_example" -SwitchId "SwitchId_example" -FcPortChannels @() -InventoryDeviceInfo  -NetworkElement  -PortChannels @() -PortGroups @() -RegisteredDevice ) # EquipmentSwitchCard | The 'equipment.SwitchCard' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.SwitchCard' resource.
try {
    EquipmentSwitchCard $Result = Set-IntersightEquipmentSwitchCard -Moid $Moid -EquipmentSwitchCard $EquipmentSwitchCard -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentSwitchCard: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentSwitchCard** | [**EquipmentSwitchCard**](EquipmentSwitchCard.md)| The &#39;equipment.SwitchCard&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentSystemIoController"></a>
# **Set-IntersightEquipmentSystemIoController**
> EquipmentSystemIoController Set-IntersightEquipmentSystemIoController<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentSystemIoController] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentSystemIoController = (Initialize-equipment.SystemIoController-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -ChassisId "ChassisId_example" -ConnectionPath "ConnectionPath_example" -ConnectionStatus "ConnectionStatus_example" -Description "Description_example" -ManagingInstance "ManagingInstance_example" -OperState "OperState_example" -PartNumber "PartNumber_example" -VarPid "VarPid_example" -SystemIoControllerId 123 -Cmc  -EquipmentChassis  -InventoryDeviceInfo  -RegisteredDevice  -SharedIoModule ) # EquipmentSystemIoController | The 'equipment.SystemIoController' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.SystemIoController' resource.
try {
    EquipmentSystemIoController $Result = Set-IntersightEquipmentSystemIoController -Moid $Moid -EquipmentSystemIoController $EquipmentSystemIoController -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentSystemIoController: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentSystemIoController** | [**EquipmentSystemIoController**](EquipmentSystemIoController.md)| The &#39;equipment.SystemIoController&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentTpm"></a>
# **Set-IntersightEquipmentTpm**
> EquipmentTpm Set-IntersightEquipmentTpm<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentTpm] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentTpm = (Initialize-equipment.Tpm-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -ActivationStatus "ActivationStatus_example" -AdminState "AdminState_example" -Ownership "Ownership_example" -Presence "Presence_example" -TpmId 123 -Version "Version_example" -ComputeBoard  -InventoryDeviceInfo  -RegisteredDevice ) # EquipmentTpm | The 'equipment.Tpm' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.Tpm' resource.
try {
    EquipmentTpm $Result = Set-IntersightEquipmentTpm -Moid $Moid -EquipmentTpm $EquipmentTpm -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentTpm: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentTpm** | [**EquipmentTpm**](EquipmentTpm.md)| The &#39;equipment.Tpm&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Set-IntersightEquipmentTransceiver"></a>
# **Set-IntersightEquipmentTransceiver**
> EquipmentTransceiver Set-IntersightEquipmentTransceiver<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentTransceiver] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentTransceiver = (Initialize-equipment.Transceiver-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -OperSpeed "OperSpeed_example" -OperState "OperState_example" -OperStateQual "OperStateQual_example" -PortId 123 -SlotId 123 -SwitchId "SwitchId_example" -Type "Type_example" -EtherPhysicalPort  -RegisteredDevice ) # EquipmentTransceiver | The 'equipment.Transceiver' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.Transceiver' resource.
try {
    EquipmentTransceiver $Result = Set-IntersightEquipmentTransceiver -Moid $Moid -EquipmentTransceiver $EquipmentTransceiver -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Set-IntersightEquipmentTransceiver: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
------------- | ------------- | ------------- | -------------
 **Moid** | **String**| The unique Moid identifier of a resource instance. | 
 **EquipmentTransceiver** | [**EquipmentTransceiver**](EquipmentTransceiver.md)| The &#39;equipment.Transceiver&#39; resource to update. | 
 **IfMatch** | **String**| For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | [optional] 
...
<a name="Update-IntersightEquipmentChassis"></a>
# **Update-IntersightEquipmentChassis**
> EquipmentChassis Update-IntersightEquipmentChassis<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentChassis] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
$Moid = "Moid_example" # String | The unique Moid identifier of a resource instance.
$EquipmentChassis = (Initialize-equipment.Chassis-AccountMoid "AccountMoid_example" -ClassId "ClassId_example" -CreateTime Get-Date -DomainGroupMoid "DomainGroupMoid_example" -ModTime Get-Date -Moid "Moid_example" -ObjectType "ObjectType_example" -Owners @("Owners_example") -SharedScope "SharedScope_example" -Tags @() -VersionContext  -Ancestors @() -Parent  -PermissionResources @() -DisplayNames "TODO" -DeviceMoId "DeviceMoId_example" -Dn "Dn_example" -Rn "Rn_example" -Model "Model_example" -Revision "Revision_example" -Serial "Serial_example" -Vendor "Vendor_example" -ChassisId 123 -ConnectionPath "ConnectionPath_example" -ConnectionStatus "ConnectionStatus_example" -Description "Description_example" -FaultSummary 123 -ManagementMode "ManagementMode_example" -Name "Name_example" -OperState "OperState_example" -PartNumber "PartNumber_example" -VarPid "VarPid_example" -PlatformType "PlatformType_example" -ProductName "ProductName_example" -Sku "Sku_example" -Vid "Vid_example" -Blades @() -Fanmodules @() -InventoryDeviceInfo  -Ioms @() -LocatorLed  -PsuControl  -Psus @() -RegisteredDevice  -Sasexpanders @() -Siocs @() -StorageEnclosures @()) # EquipmentChassis | The 'equipment.Chassis' resource to update.
$IfMatch = "IfMatch_example" # String | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

# Update a 'equipment.Chassis' resource.
try {
    EquipmentChassis $Result = Update-IntersightEquipmentChassis -Moid $Moid -EquipmentChassis $EquipmentChassis -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentChassis: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentChassisIdentity"></a>
# **Update-IntersightEquipmentChassisIdentity**
> EquipmentChassisIdentity Update-IntersightEquipmentChassisIdentity<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentChassisIdentity] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.ChassisIdentity' resource.
try {
    EquipmentChassisIdentity $Result = Update-IntersightEquipmentChassisIdentity -Moid $Moid -EquipmentChassisIdentity $EquipmentChassisIdentity -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentChassisIdentity: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentFan"></a>
# **Update-IntersightEquipmentFan**
> EquipmentFan Update-IntersightEquipmentFan<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentFan] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.Fan' resource.
try {
    EquipmentFan $Result = Update-IntersightEquipmentFan -Moid $Moid -EquipmentFan $EquipmentFan -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentFan: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentFanModule"></a>
# **Update-IntersightEquipmentFanModule**
> EquipmentFanModule Update-IntersightEquipmentFanModule<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentFanModule] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.FanModule' resource.
try {
    EquipmentFanModule $Result = Update-IntersightEquipmentFanModule -Moid $Moid -EquipmentFanModule $EquipmentFanModule -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentFanModule: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentFex"></a>
# **Update-IntersightEquipmentFex**
> EquipmentFex Update-IntersightEquipmentFex<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentFex] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.Fex' resource.
try {
    EquipmentFex $Result = Update-IntersightEquipmentFex -Moid $Moid -EquipmentFex $EquipmentFex -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentFex: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentFexIdentity"></a>
# **Update-IntersightEquipmentFexIdentity**
> EquipmentFexIdentity Update-IntersightEquipmentFexIdentity<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentFexIdentity] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.FexIdentity' resource.
try {
    EquipmentFexIdentity $Result = Update-IntersightEquipmentFexIdentity -Moid $Moid -EquipmentFexIdentity $EquipmentFexIdentity -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentFexIdentity: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentFexOperation"></a>
# **Update-IntersightEquipmentFexOperation**
> EquipmentFexOperation Update-IntersightEquipmentFexOperation<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentFexOperation] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.FexOperation' resource.
try {
    EquipmentFexOperation $Result = Update-IntersightEquipmentFexOperation -Moid $Moid -EquipmentFexOperation $EquipmentFexOperation -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentFexOperation: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentIoCard"></a>
# **Update-IntersightEquipmentIoCard**
> EquipmentIoCard Update-IntersightEquipmentIoCard<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentIoCard] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.IoCard' resource.
try {
    EquipmentIoCard $Result = Update-IntersightEquipmentIoCard -Moid $Moid -EquipmentIoCard $EquipmentIoCard -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentIoCard: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentIoCardOperation"></a>
# **Update-IntersightEquipmentIoCardOperation**
> EquipmentIoCardOperation Update-IntersightEquipmentIoCardOperation<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentIoCardOperation] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.IoCardOperation' resource.
try {
    EquipmentIoCardOperation $Result = Update-IntersightEquipmentIoCardOperation -Moid $Moid -EquipmentIoCardOperation $EquipmentIoCardOperation -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentIoCardOperation: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentIoExpander"></a>
# **Update-IntersightEquipmentIoExpander**
> EquipmentIoExpander Update-IntersightEquipmentIoExpander<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentIoExpander] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.IoExpander' resource.
try {
    EquipmentIoExpander $Result = Update-IntersightEquipmentIoExpander -Moid $Moid -EquipmentIoExpander $EquipmentIoExpander -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentIoExpander: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentLocatorLed"></a>
# **Update-IntersightEquipmentLocatorLed**
> EquipmentLocatorLed Update-IntersightEquipmentLocatorLed<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentLocatorLed] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.LocatorLed' resource.
try {
    EquipmentLocatorLed $Result = Update-IntersightEquipmentLocatorLed -Moid $Moid -EquipmentLocatorLed $EquipmentLocatorLed -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentLocatorLed: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentPsu"></a>
# **Update-IntersightEquipmentPsu**
> EquipmentPsu Update-IntersightEquipmentPsu<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentPsu] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.Psu' resource.
try {
    EquipmentPsu $Result = Update-IntersightEquipmentPsu -Moid $Moid -EquipmentPsu $EquipmentPsu -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentPsu: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentPsuControl"></a>
# **Update-IntersightEquipmentPsuControl**
> EquipmentPsuControl Update-IntersightEquipmentPsuControl<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentPsuControl] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.PsuControl' resource.
try {
    EquipmentPsuControl $Result = Update-IntersightEquipmentPsuControl -Moid $Moid -EquipmentPsuControl $EquipmentPsuControl -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentPsuControl: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentRackEnclosure"></a>
# **Update-IntersightEquipmentRackEnclosure**
> EquipmentRackEnclosure Update-IntersightEquipmentRackEnclosure<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentRackEnclosure] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.RackEnclosure' resource.
try {
    EquipmentRackEnclosure $Result = Update-IntersightEquipmentRackEnclosure -Moid $Moid -EquipmentRackEnclosure $EquipmentRackEnclosure -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentRackEnclosure: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentRackEnclosureSlot"></a>
# **Update-IntersightEquipmentRackEnclosureSlot**
> EquipmentRackEnclosureSlot Update-IntersightEquipmentRackEnclosureSlot<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentRackEnclosureSlot] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.RackEnclosureSlot' resource.
try {
    EquipmentRackEnclosureSlot $Result = Update-IntersightEquipmentRackEnclosureSlot -Moid $Moid -EquipmentRackEnclosureSlot $EquipmentRackEnclosureSlot -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentRackEnclosureSlot: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentSharedIoModule"></a>
# **Update-IntersightEquipmentSharedIoModule**
> EquipmentSharedIoModule Update-IntersightEquipmentSharedIoModule<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentSharedIoModule] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.SharedIoModule' resource.
try {
    EquipmentSharedIoModule $Result = Update-IntersightEquipmentSharedIoModule -Moid $Moid -EquipmentSharedIoModule $EquipmentSharedIoModule -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentSharedIoModule: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentSwitchCard"></a>
# **Update-IntersightEquipmentSwitchCard**
> EquipmentSwitchCard Update-IntersightEquipmentSwitchCard<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentSwitchCard] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.SwitchCard' resource.
try {
    EquipmentSwitchCard $Result = Update-IntersightEquipmentSwitchCard -Moid $Moid -EquipmentSwitchCard $EquipmentSwitchCard -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentSwitchCard: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentSystemIoController"></a>
# **Update-IntersightEquipmentSystemIoController**
> EquipmentSystemIoController Update-IntersightEquipmentSystemIoController<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentSystemIoController] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.SystemIoController' resource.
try {
    EquipmentSystemIoController $Result = Update-IntersightEquipmentSystemIoController -Moid $Moid -EquipmentSystemIoController $EquipmentSystemIoController -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentSystemIoController: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentTpm"></a>
# **Update-IntersightEquipmentTpm**
> EquipmentTpm Update-IntersightEquipmentTpm<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentTpm] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.Tpm' resource.
try {
    EquipmentTpm $Result = Update-IntersightEquipmentTpm -Moid $Moid -EquipmentTpm $EquipmentTpm -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentTpm: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Update-IntersightEquipmentTransceiver"></a>
# **Update-IntersightEquipmentTransceiver**
> EquipmentTransceiver Update-IntersightEquipmentTransceiver<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Moid] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EquipmentTransceiver] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IfMatch] <String><br>
...
# Update a 'equipment.Transceiver' resource.
try {
    EquipmentTransceiver $Result = Update-IntersightEquipmentTransceiver -Moid $Moid -EquipmentTransceiver $EquipmentTransceiver -IfMatch $IfMatch
} catch {
    Write-Host ("Exception occured when calling Update-IntersightEquipmentTransceiver: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
