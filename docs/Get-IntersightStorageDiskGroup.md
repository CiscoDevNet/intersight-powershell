...
# Get-IntersightStorageDiskGroup

## SYNOPSIS
Get the StorageDiskGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageDiskGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageDiskGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageDiskGroup&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageDiskGroup
```
Above example returns the list of StorageDiskGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageDiskGroup -Name "MoName"
```
Above example returns the StorageDiskGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageDiskGroup -Organization $organization
```
Above example returns the list of StorageDiskGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageDiskGroup -InlineCount allpages
```
Above example returns the list of StorageDiskGroup along with count.
...
### -Name
Specifies the name of the StorageDiskGroup.
...
### -Organization
Specifies the organization, to fetch the StorageDiskGroup under it.
...
[Set-IntersightStorageDiskGroup](./Set-IntersightStorageDiskGroup.md)
