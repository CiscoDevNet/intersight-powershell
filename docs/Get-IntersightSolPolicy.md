...
### CmdletParam (Default)
```
Get-IntersightSolPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSolPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSolPolicy
```
Above example returns the list of SolPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSolPolicy -Name "MoName"
```
Above example returns the SolPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSolPolicy -Organization $organization
```
Above example returns the list of SolPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSolPolicy -InlineCount allpages
```
Above example returns the list of SolPolicy along with count.
...
### -Name
Specifies the name of the SolPolicy.
...
### -Organization
Specifies the organization, to fetch the SolPolicy under it.
