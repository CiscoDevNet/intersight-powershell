...
# Get-IntersightVnicEthIfInventory

## SYNOPSIS
Get the VnicEthIfInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicEthIfInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicEthIfInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicEthIfInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicEthIfInventory
```
Above example returns the list of VnicEthIfInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicEthIfInventory -Name "MoName"
```
Above example returns the VnicEthIfInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicEthIfInventory -Organization $organization
```
Above example returns the list of VnicEthIfInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicEthIfInventory -InlineCount allpages
```
Above example returns the list of VnicEthIfInventory along with count.
...
### -Name
Specifies the name of the VnicEthIfInventory.
...
### -Organization
Specifies the organization, to fetch the VnicEthIfInventory under it.
