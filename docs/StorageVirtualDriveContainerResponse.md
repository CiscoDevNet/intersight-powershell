...
```powershell
$StorageVirtualDriveContainerResponse = Initialize-IntersightStorageVirtualDriveContainerResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StorageVirtualDriveContainerResponse | ConvertTo-JSON
```
