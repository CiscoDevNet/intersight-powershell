...
### CmdletParam (Default)
```
Get-IntersightHciNode [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciNode [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciNode&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciNode
```
Above example returns the list of HciNode.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciNode -Name "MoName"
```
Above example returns the HciNode matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciNode -Organization $organization
```
Above example returns the list of HciNode available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciNode -InlineCount allpages
```
Above example returns the list of HciNode along with count.
...
### -Name
Specifies the name of the HciNode.
...
### -Organization
Specifies the organization, to fetch the HciNode under it.
...
[Set-IntersightHciNode](./Set-IntersightHciNode.md)
