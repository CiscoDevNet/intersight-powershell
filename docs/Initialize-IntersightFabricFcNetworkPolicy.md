...
# Initialize-IntersightFabricFcNetworkPolicy
...
```yaml
Type: FabricFcNetworkPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricFcNetworkPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFabricFcNetworkPolicy
```
