...
# Get-IntersightMgmtOrgRestoreOperation

## SYNOPSIS
Get the MgmtOrgRestoreOperation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMgmtOrgRestoreOperation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMgmtOrgRestoreOperation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MgmtOrgRestoreOperation&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMgmtOrgRestoreOperation
```
Above example returns the list of MgmtOrgRestoreOperation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMgmtOrgRestoreOperation -Name "MoName"
```
Above example returns the MgmtOrgRestoreOperation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMgmtOrgRestoreOperation -Organization $organization
```
Above example returns the list of MgmtOrgRestoreOperation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMgmtOrgRestoreOperation -InlineCount allpages
```
Above example returns the list of MgmtOrgRestoreOperation along with count.
...
### -Name
Specifies the name of the MgmtOrgRestoreOperation.
...
### -Organization
Specifies the organization, to fetch the MgmtOrgRestoreOperation under it.
