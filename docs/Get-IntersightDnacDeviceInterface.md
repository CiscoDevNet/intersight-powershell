...
# Get-IntersightDnacDeviceInterface

## SYNOPSIS
Get the DnacDeviceInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightDnacDeviceInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightDnacDeviceInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;DnacDeviceInterface&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightDnacDeviceInterface
```
Above example returns the list of DnacDeviceInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightDnacDeviceInterface -Name "MoName"
```
Above example returns the DnacDeviceInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightDnacDeviceInterface -Organization $organization
```
Above example returns the list of DnacDeviceInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightDnacDeviceInterface -InlineCount allpages
```
Above example returns the list of DnacDeviceInterface along with count.
...
### -Name
Specifies the name of the DnacDeviceInterface.
...
### -Organization
Specifies the organization, to fetch the DnacDeviceInterface under it.
