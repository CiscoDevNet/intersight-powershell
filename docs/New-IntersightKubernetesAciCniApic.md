...
# New-IntersightKubernetesAciCniApic
...
New-IntersightKubernetesAciCniApic [-AciCniProfiles< System.Collections.Generic.List`1[KubernetesAciCniProfileRelationship]>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AssetApicMoid< string>][-Moid< string>][-NumAciCniProfiles< long>][-Organization< OrganizationOrganizationRelationship>][-RegisteredDevice< AssetDeviceRegistrationRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: System.Collections.Generic.List`1[KubernetesAciCniProfileRelationship]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> New-IntersightKubernetesAciCniApic
```
