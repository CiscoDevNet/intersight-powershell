...
New-IntersightKubernetesAciCniApic [-AciCniProfiles< List<KubernetesAciCniProfileRelationship>>][-AdditionalProperties< Dictionary<string,object>>][-AssetApicMoid< string>][-Moid< string>][-NumAciCniProfiles< long>][-Organization< OrganizationOrganizationRelationship>][-RegisteredDevice< AssetDeviceRegistrationRelationship>][-Tags< List<MoTag>>]
