...
# Get-IntersightIamEndPointUserInventory

## SYNOPSIS
Get the IamEndPointUserInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamEndPointUserInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamEndPointUserInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamEndPointUserInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserInventory
```
Above example returns the list of IamEndPointUserInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserInventory -Name "MoName"
```
Above example returns the IamEndPointUserInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserInventory -Organization $organization
```
Above example returns the list of IamEndPointUserInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamEndPointUserInventory -InlineCount allpages
```
Above example returns the list of IamEndPointUserInventory along with count.
...
### -Name
Specifies the name of the IamEndPointUserInventory.
...
### -Organization
Specifies the organization, to fetch the IamEndPointUserInventory under it.
