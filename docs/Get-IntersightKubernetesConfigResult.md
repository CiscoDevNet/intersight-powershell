...
## SYNOPSIS
Get the KubernetesConfigResult

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesConfigResult [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesConfigResult [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;KubernetesConfigResult&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesConfigResult
```
Above example returns the list of KubernetesConfigResult.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesConfigResult -Name "MoName"
```
Above example returns the KubernetesConfigResult matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesConfigResult -Organization $organization
```
Above example returns the list of KubernetesConfigResult available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesConfigResult -InlineCount allpages
```
Above example returns the list of KubernetesConfigResult along with count.
...
### -Name
Specifies the name of the KubernetesConfigResult.
...
### -Organization
Specifies the organization, to fetch the KubernetesConfigResult under it.
