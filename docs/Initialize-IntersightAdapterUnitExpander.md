...
# Initialize-IntersightAdapterUnitExpander
...
```yaml
Type: Model.AdapterUnitRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: AdapterUnitExpander.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightAdapterUnitExpander
```
