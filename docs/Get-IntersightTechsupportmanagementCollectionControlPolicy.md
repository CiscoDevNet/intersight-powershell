...
### CmdletParam (Default)
```
Get-IntersightTechsupportmanagementCollectionControlPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightTechsupportmanagementCollectionControlPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementCollectionControlPolicy
```
Above example returns the list of TechsupportmanagementCollectionControlPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementCollectionControlPolicy -Name "MoName"
```
Above example returns the TechsupportmanagementCollectionControlPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementCollectionControlPolicy -Organization $organization
```
Above example returns the list of TechsupportmanagementCollectionControlPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightTechsupportmanagementCollectionControlPolicy -InlineCount allpages
```
Above example returns the list of TechsupportmanagementCollectionControlPolicy along with count.
...
### -Name
Specifies the name of the TechsupportmanagementCollectionControlPolicy.
...
### -Organization
Specifies the organization, to fetch the TechsupportmanagementCollectionControlPolicy under it.
