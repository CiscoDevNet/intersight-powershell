...
```powershell
$StorageEnclosureDiskSlotEpRelationship = Initialize-IntersightStorageEnclosureDiskSlotEpRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$StorageEnclosureDiskSlotEpRelationship | ConvertTo-JSON
```
