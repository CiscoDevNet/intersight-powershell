...
## SYNOPSIS
Get the VirtualizationVmwareKernelNetwork

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareKernelNetwork [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareKernelNetwork [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareKernelNetwork&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareKernelNetwork
```
Above example returns the list of VirtualizationVmwareKernelNetwork.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareKernelNetwork -Name "MoName"
```
Above example returns the VirtualizationVmwareKernelNetwork matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareKernelNetwork -Organization $organization
```
Above example returns the list of VirtualizationVmwareKernelNetwork available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareKernelNetwork -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareKernelNetwork along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareKernelNetwork.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareKernelNetwork under it.
...
[Set-IntersightVirtualizationVmwareKernelNetwork](./Set-IntersightVirtualizationVmwareKernelNetwork.md)
