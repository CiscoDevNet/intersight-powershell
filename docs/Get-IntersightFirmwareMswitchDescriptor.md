...
### CmdletParam (Default)
```
Get-IntersightFirmwareMswitchDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareMswitchDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;FirmwareMswitchDescriptor&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareMswitchDescriptor
```
Above example returns the list of FirmwareMswitchDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareMswitchDescriptor -Name "MoName"
```
Above example returns the FirmwareMswitchDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareMswitchDescriptor -Organization $organization
```
Above example returns the list of FirmwareMswitchDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareMswitchDescriptor -InlineCount allpages
```
Above example returns the list of FirmwareMswitchDescriptor along with count.
...
### -Name
Specifies the name of the FirmwareMswitchDescriptor.
...
### -Organization
Specifies the organization, to fetch the FirmwareMswitchDescriptor under it.
