...
## SYNOPSIS
Get the NiatelemetryApicCoreFileDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicCoreFileDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicCoreFileDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryApicCoreFileDetails&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicCoreFileDetails
```
Above example returns the list of NiatelemetryApicCoreFileDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicCoreFileDetails -Name "MoName"
```
Above example returns the NiatelemetryApicCoreFileDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicCoreFileDetails -Organization $organization
```
Above example returns the list of NiatelemetryApicCoreFileDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicCoreFileDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryApicCoreFileDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryApicCoreFileDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicCoreFileDetails under it.
