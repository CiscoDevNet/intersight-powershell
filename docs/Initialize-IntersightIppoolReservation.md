...
# Initialize-IntersightIppoolReservation
...
Initialize-IntersightIppoolReservation [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AllocationType< IppoolReservation.AllocationTypeEnum>][-ClassId< IppoolReservation.ClassIdEnum>][-Identity< string>][-IpType< IppoolReservation.IpTypeEnum>][-Moid< string>][-ObjectType< IppoolReservation.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Pool< Model.IppoolPoolRelationship>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-VrfMoid< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: IppoolReservation.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IppoolReservation.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIppoolReservation
```
