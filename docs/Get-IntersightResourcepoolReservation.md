...
# Get-IntersightResourcepoolReservation

## SYNOPSIS
Get the ResourcepoolReservation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightResourcepoolReservation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightResourcepoolReservation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ResourcepoolReservation&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightResourcepoolReservation
```
Above example returns the list of ResourcepoolReservation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightResourcepoolReservation -Name "MoName"
```
Above example returns the ResourcepoolReservation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightResourcepoolReservation -Organization $organization
```
Above example returns the list of ResourcepoolReservation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightResourcepoolReservation -InlineCount allpages
```
Above example returns the list of ResourcepoolReservation along with count.
...
### -Name
Specifies the name of the ResourcepoolReservation.
...
### -Organization
Specifies the organization, to fetch the ResourcepoolReservation under it.
...
[Remove-IntersightResourcepoolReservation](./Remove-IntersightResourcepoolReservation.md)
