...
# Initialize-IntersightVnicEthQosPolicy
...
Initialize-IntersightVnicEthQosPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Burst< long>][-ClassId< VnicEthQosPolicy.ClassIdEnum>][-Cos< long>][-Description< string>][-Moid< string>][-Mtu< long>][-Name< string>][-ObjectType< VnicEthQosPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Priority< VnicEthQosPolicy.PriorityEnum>][-RateLimit< long>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TrustHostCos< bool>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: VnicEthQosPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VnicEthQosPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVnicEthQosPolicy
```
