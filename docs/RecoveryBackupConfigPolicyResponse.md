...
```powershell
$RecoveryBackupConfigPolicyResponse = Initialize-IntersightRecoveryBackupConfigPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$RecoveryBackupConfigPolicyResponse | ConvertTo-JSON
```
