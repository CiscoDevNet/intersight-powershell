...
### CmdletParam (Default)
```
Get-IntersightFirmwareUnsupportedVersionUpgrade [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareUnsupportedVersionUpgrade [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareUnsupportedVersionUpgrade&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareUnsupportedVersionUpgrade
```
Above example returns the list of FirmwareUnsupportedVersionUpgrade.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareUnsupportedVersionUpgrade -Name "MoName"
```
Above example returns the FirmwareUnsupportedVersionUpgrade matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareUnsupportedVersionUpgrade -Organization $organization
```
Above example returns the list of FirmwareUnsupportedVersionUpgrade available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareUnsupportedVersionUpgrade -InlineCount allpages
```
Above example returns the list of FirmwareUnsupportedVersionUpgrade along with count.
...
### -Name
Specifies the name of the FirmwareUnsupportedVersionUpgrade.
...
### -Organization
Specifies the organization, to fetch the FirmwareUnsupportedVersionUpgrade under it.
