...
# Get-IntersightComputeDownloadStatus

## SYNOPSIS
Get the ComputeDownloadStatus

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputeDownloadStatus [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputeDownloadStatus [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ComputeDownloadStatus&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputeDownloadStatus
```
Above example returns the list of ComputeDownloadStatus.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputeDownloadStatus -Name "MoName"
```
Above example returns the ComputeDownloadStatus matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputeDownloadStatus -Organization $organization
```
Above example returns the list of ComputeDownloadStatus available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputeDownloadStatus -InlineCount allpages
```
Above example returns the list of ComputeDownloadStatus along with count.
...
### -Name
Specifies the name of the ComputeDownloadStatus.
...
### -Organization
Specifies the organization, to fetch the ComputeDownloadStatus under it.
