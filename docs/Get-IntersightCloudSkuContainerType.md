...
## SYNOPSIS
Get the CloudSkuContainerType

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudSkuContainerType [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudSkuContainerType [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CloudSkuContainerType&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudSkuContainerType
```
Above example returns the list of CloudSkuContainerType.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudSkuContainerType -Name "MoName"
```
Above example returns the CloudSkuContainerType matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudSkuContainerType -Organization $organization
```
Above example returns the list of CloudSkuContainerType available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudSkuContainerType -InlineCount allpages
```
Above example returns the list of CloudSkuContainerType along with count.
...
### -Name
Specifies the name of the CloudSkuContainerType.
...
### -Organization
Specifies the organization, to fetch the CloudSkuContainerType under it.
