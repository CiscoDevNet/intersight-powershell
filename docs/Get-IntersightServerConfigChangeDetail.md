...
## SYNOPSIS
Get the ServerConfigChangeDetail

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightServerConfigChangeDetail [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightServerConfigChangeDetail [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ServerConfigChangeDetail&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightServerConfigChangeDetail
```
Above example returns the list of ServerConfigChangeDetail.

### Example 2
```powershell
PS C:\> $result = Get-IntersightServerConfigChangeDetail -Name "MoName"
```
Above example returns the ServerConfigChangeDetail matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightServerConfigChangeDetail -Organization $organization
```
Above example returns the list of ServerConfigChangeDetail available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightServerConfigChangeDetail -InlineCount allpages
```
Above example returns the list of ServerConfigChangeDetail along with count.
...
### -Name
Specifies the name of the ServerConfigChangeDetail.
...
### -Organization
Specifies the organization, to fetch the ServerConfigChangeDetail under it.
