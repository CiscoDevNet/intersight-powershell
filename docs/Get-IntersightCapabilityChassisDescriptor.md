...
### CmdletParam (Default)
```
Get-IntersightCapabilityChassisDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityChassisDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityChassisDescriptor
```
Above example returns the list of CapabilityChassisDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityChassisDescriptor -Name "MoName"
```
Above example returns the CapabilityChassisDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityChassisDescriptor -Organization $organization
```
Above example returns the list of CapabilityChassisDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityChassisDescriptor -InlineCount allpages
```
Above example returns the list of CapabilityChassisDescriptor along with count.
...
### -Name
Specifies the name of the CapabilityChassisDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilityChassisDescriptor under it.
