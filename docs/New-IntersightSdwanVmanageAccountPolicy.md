...
New-IntersightSdwanVmanageAccountPolicy [-AdditionalProperties< Dictionary<string,object>>][-Description< string>][-EndpointAddress< string>][-Moid< string>][[-Name]< string>][-Organization< OrganizationOrganizationRelationship>][-Password< string>][-Port< long>][-Profiles< List<SdwanProfileRelationship>>][-Tags< List<MoTag>>][-Username< string>]
