...
# Get-IntersightSmtpPolicyInventory

## SYNOPSIS
Get the SmtpPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSmtpPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSmtpPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SmtpPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSmtpPolicyInventory
```
Above example returns the list of SmtpPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSmtpPolicyInventory -Name "MoName"
```
Above example returns the SmtpPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSmtpPolicyInventory -Organization $organization
```
Above example returns the list of SmtpPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSmtpPolicyInventory -InlineCount allpages
```
Above example returns the list of SmtpPolicyInventory along with count.
...
### -Name
Specifies the name of the SmtpPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the SmtpPolicyInventory under it.
