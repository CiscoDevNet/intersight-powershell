...
```powershell
$EquipmentRackEnclosureSlotResponse = Initialize-IntersightEquipmentRackEnclosureSlotResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$EquipmentRackEnclosureSlotResponse | ConvertTo-JSON
```
