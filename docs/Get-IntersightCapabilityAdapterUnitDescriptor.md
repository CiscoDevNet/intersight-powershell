...
## SYNOPSIS
Get the CapabilityAdapterUnitDescriptor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityAdapterUnitDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityAdapterUnitDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterUnitDescriptor
```
Above example returns the list of CapabilityAdapterUnitDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterUnitDescriptor -Name "MoName"
```
Above example returns the CapabilityAdapterUnitDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterUnitDescriptor -Organization $organization
```
Above example returns the list of CapabilityAdapterUnitDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityAdapterUnitDescriptor -InlineCount allpages
```
Above example returns the list of CapabilityAdapterUnitDescriptor along with count.
...
### -Name
Specifies the name of the CapabilityAdapterUnitDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilityAdapterUnitDescriptor under it.
