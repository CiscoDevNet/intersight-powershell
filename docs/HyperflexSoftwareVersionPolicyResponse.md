...
```powershell
$HyperflexSoftwareVersionPolicyResponse = Initialize-IntersightHyperflexSoftwareVersionPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexSoftwareVersionPolicyResponse | ConvertTo-JSON
```
