...
## SYNOPSIS
Get the AssetDeviceContractInformation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightAssetDeviceContractInformation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightAssetDeviceContractInformation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;AssetDeviceContractInformation&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightAssetDeviceContractInformation
```
Above example returns the list of AssetDeviceContractInformation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightAssetDeviceContractInformation -Name "MoName"
```
Above example returns the AssetDeviceContractInformation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightAssetDeviceContractInformation -Organization $organization
```
Above example returns the list of AssetDeviceContractInformation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightAssetDeviceContractInformation -InlineCount allpages
```
Above example returns the list of AssetDeviceContractInformation along with count.
...
### -Name
Specifies the name of the AssetDeviceContractInformation.
...
### -Organization
Specifies the organization, to fetch the AssetDeviceContractInformation under it.
