...
## SYNOPSIS
Get the NiatelemetryApicFlashDetails

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicFlashDetails [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicFlashDetails [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicFlashDetails
```
Above example returns the list of NiatelemetryApicFlashDetails.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicFlashDetails -Name "MoName"
```
Above example returns the NiatelemetryApicFlashDetails matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicFlashDetails -Organization $organization
```
Above example returns the list of NiatelemetryApicFlashDetails available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicFlashDetails -InlineCount allpages
```
Above example returns the list of NiatelemetryApicFlashDetails along with count.
...
### -Name
Specifies the name of the NiatelemetryApicFlashDetails.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicFlashDetails under it.
