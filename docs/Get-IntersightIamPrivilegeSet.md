...
# Get-IntersightIamPrivilegeSet

## SYNOPSIS
Get the IamPrivilegeSet

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamPrivilegeSet [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamPrivilegeSet [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IamPrivilegeSet&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamPrivilegeSet
```
Above example returns the list of IamPrivilegeSet.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamPrivilegeSet -Name "MoName"
```
Above example returns the IamPrivilegeSet matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamPrivilegeSet -Organization $organization
```
Above example returns the list of IamPrivilegeSet available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamPrivilegeSet -InlineCount allpages
```
Above example returns the list of IamPrivilegeSet along with count.
...
### -Name
Specifies the name of the IamPrivilegeSet.
...
### -Organization
Specifies the organization, to fetch the IamPrivilegeSet under it.
