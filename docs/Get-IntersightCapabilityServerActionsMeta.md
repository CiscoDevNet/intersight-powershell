...
# Get-IntersightCapabilityServerActionsMeta

## SYNOPSIS
Get the CapabilityServerActionsMeta

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCapabilityServerActionsMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityServerActionsMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CapabilityServerActionsMeta&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityServerActionsMeta
```
Above example returns the list of CapabilityServerActionsMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityServerActionsMeta -Name "MoName"
```
Above example returns the CapabilityServerActionsMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityServerActionsMeta -Organization $organization
```
Above example returns the list of CapabilityServerActionsMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityServerActionsMeta -InlineCount allpages
```
Above example returns the list of CapabilityServerActionsMeta along with count.
...
### -Name
Specifies the name of the CapabilityServerActionsMeta.
...
### -Organization
Specifies the organization, to fetch the CapabilityServerActionsMeta under it.
...
[Remove-IntersightCapabilityServerActionsMeta](./Remove-IntersightCapabilityServerActionsMeta.md)
