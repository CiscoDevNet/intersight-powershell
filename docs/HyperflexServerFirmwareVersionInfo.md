...
```powershell
$HyperflexServerFirmwareVersionInfo = Initialize-IntersightHyperflexServerFirmwareVersionInfo  -ClassId null `
 -ObjectType null `
 -ServerPlatform null `
 -Version null
```
...
```powershell
$HyperflexServerFirmwareVersionInfo | ConvertTo-JSON
```
