...
```powershell
$CapabilitySwitchDescriptorResponse = Initialize-IntersightCapabilitySwitchDescriptorResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilitySwitchDescriptorResponse | ConvertTo-JSON
```
