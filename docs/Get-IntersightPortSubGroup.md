...
# Get-IntersightPortSubGroup

## SYNOPSIS
Get the PortSubGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPortSubGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPortSubGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PortSubGroup&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPortSubGroup
```
Above example returns the list of PortSubGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPortSubGroup -Name "MoName"
```
Above example returns the PortSubGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPortSubGroup -Organization $organization
```
Above example returns the list of PortSubGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPortSubGroup -InlineCount allpages
```
Above example returns the list of PortSubGroup along with count.
...
### -Name
Specifies the name of the PortSubGroup.
...
### -Organization
Specifies the organization, to fetch the PortSubGroup under it.
...
[Set-IntersightPortSubGroup](./Set-IntersightPortSubGroup.md)
