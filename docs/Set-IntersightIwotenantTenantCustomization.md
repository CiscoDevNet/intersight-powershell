...
Set-IntersightIwotenantTenantCustomization [-Account< IamAccountRelationship>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-EnableDataExtractor< bool>][-IwoId< string>][[-Moid]< string>][-MskServerForDataExtractor< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-WriteUserAccessKeyId< string>][-WriteUserSecretAccessKey< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
