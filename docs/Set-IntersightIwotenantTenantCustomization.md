...
# Set-IntersightIwotenantTenantCustomization
...
Set-IntersightIwotenantTenantCustomization [-Account< IamAccountRelationship>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-EnableDataExtractor< bool>][-IwoId< string>][[-Moid]< string>][-MskServerForDataExtractor< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-WriteUserAccessKeyId< string>][-WriteUserSecretAccessKey< string>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;IwotenantTenantCustomization&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightIwotenantTenantCustomization
```
