...
Set-IntersightHyperflexFeatureLimitExternal [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AppCatalog< HyperflexAppCatalogRelationship>][-FeatureLimitEntries< System.Collections.Generic.List`1[HyperflexFeatureLimitEntry]>][[-Moid]< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
