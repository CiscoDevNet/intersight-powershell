...
Set-IntersightHyperflexFeatureLimitExternal [-AdditionalProperties< Dictionary<string,object>>][-AppCatalog< HyperflexAppCatalogRelationship>][-FeatureLimitEntries< List<HyperflexFeatureLimitEntry>>][[-Moid]< string>][-Tags< List<MoTag>>]
