...
# Get-IntersightStorageNetAppNonDataIpInterfaceEvent

## SYNOPSIS
Get the StorageNetAppNonDataIpInterfaceEvent

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppNonDataIpInterfaceEvent [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppNonDataIpInterfaceEvent [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppNonDataIpInterfaceEvent&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNonDataIpInterfaceEvent
```
Above example returns the list of StorageNetAppNonDataIpInterfaceEvent.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNonDataIpInterfaceEvent -Name "MoName"
```
Above example returns the StorageNetAppNonDataIpInterfaceEvent matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNonDataIpInterfaceEvent -Organization $organization
```
Above example returns the list of StorageNetAppNonDataIpInterfaceEvent available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppNonDataIpInterfaceEvent -InlineCount allpages
```
Above example returns the list of StorageNetAppNonDataIpInterfaceEvent along with count.
...
### -Name
Specifies the name of the StorageNetAppNonDataIpInterfaceEvent.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppNonDataIpInterfaceEvent under it.
