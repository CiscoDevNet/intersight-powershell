...
```powershell
$VirtualizationStorageCapacityAllOf = Initialize-IntersightVirtualizationStorageCapacityAllOf  -ClassId null `
 -ObjectType null `
 -Capacity null `
 -Free null `
 -Used null
...
```powershell
$VirtualizationStorageCapacityAllOf | ConvertTo-JSON
```
