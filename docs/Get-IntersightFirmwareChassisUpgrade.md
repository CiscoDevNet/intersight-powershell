...
### CmdletParam (Default)
```
Get-IntersightFirmwareChassisUpgrade [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareChassisUpgrade [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareChassisUpgrade&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareChassisUpgrade
```
Above example returns the list of FirmwareChassisUpgrade.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareChassisUpgrade -Name "MoName"
```
Above example returns the FirmwareChassisUpgrade matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareChassisUpgrade -Organization $organization
```
Above example returns the list of FirmwareChassisUpgrade available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareChassisUpgrade -InlineCount allpages
```
Above example returns the list of FirmwareChassisUpgrade along with count.
...
### -Name
Specifies the name of the FirmwareChassisUpgrade.
...
### -Organization
Specifies the organization, to fetch the FirmwareChassisUpgrade under it.
