...
## SYNOPSIS
Get the ComputeBlade

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputeBlade [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputeBlade [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputeBlade
```
Above example returns the list of ComputeBlade.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputeBlade -Name "MoName"
```
Above example returns the ComputeBlade matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputeBlade -Organization $organization
```
Above example returns the list of ComputeBlade available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputeBlade -InlineCount allpages
```
Above example returns the list of ComputeBlade along with count.
...
### -Name
Specifies the name of the ComputeBlade.
...
### -Organization
Specifies the organization, to fetch the ComputeBlade under it.
...
[Set-IntersightComputeBlade](./Set-IntersightComputeBlade.md)
