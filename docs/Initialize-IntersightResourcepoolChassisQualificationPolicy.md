...
# Initialize-IntersightResourcepoolChassisQualificationPolicy
...
Initialize-IntersightResourcepoolChassisQualificationPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< ResourcepoolChassisQualificationPolicy.ClassIdEnum>][-Description< string>][-ExcludeServers< bool>][-Moid< string>][-Name< string>][-ObjectType< ResourcepoolChassisQualificationPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Qualifiers< System.Collections.Generic.List`1[Model.ResourceResourceQualifier]>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ResourcepoolChassisQualificationPolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ResourcepoolChassisQualificationPolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightResourcepoolChassisQualificationPolicy
```
