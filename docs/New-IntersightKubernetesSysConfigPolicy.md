...
New-IntersightKubernetesSysConfigPolicy [-AdditionalProperties< Dictionary<string,object>>][-ClusterProfiles< List<KubernetesClusterProfileRelationship>>][-Description< string>][-DnsDomainName< string>][-DnsServers< List<string>>][-Moid< string>][[-Name]< string>][-NtpServers< List<string>>][-Organization< OrganizationOrganizationRelationship>][-Tags< List<MoTag>>][-Timezone< KubernetesSysConfigPolicy.TimezoneEnum>]
