...
# Get-IntersightHyperflexInitiatorGroup

## SYNOPSIS
Get the HyperflexInitiatorGroup

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexInitiatorGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexInitiatorGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexInitiatorGroup&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexInitiatorGroup
```
Above example returns the list of HyperflexInitiatorGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexInitiatorGroup -Name "MoName"
```
Above example returns the HyperflexInitiatorGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexInitiatorGroup -Organization $organization
```
Above example returns the list of HyperflexInitiatorGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexInitiatorGroup -InlineCount allpages
```
Above example returns the list of HyperflexInitiatorGroup along with count.
...
### -Name
Specifies the name of the HyperflexInitiatorGroup.
...
### -Organization
Specifies the organization, to fetch the HyperflexInitiatorGroup under it.
...
[Set-IntersightHyperflexInitiatorGroup](./Set-IntersightHyperflexInitiatorGroup.md)
