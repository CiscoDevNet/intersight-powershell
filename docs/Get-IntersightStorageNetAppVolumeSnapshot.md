...
## SYNOPSIS
Get the StorageNetAppVolumeSnapshot

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppVolumeSnapshot [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppVolumeSnapshot [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppVolumeSnapshot&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppVolumeSnapshot
```
Above example returns the list of StorageNetAppVolumeSnapshot.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppVolumeSnapshot -Name "MoName"
```
Above example returns the StorageNetAppVolumeSnapshot matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppVolumeSnapshot -Organization $organization
```
Above example returns the list of StorageNetAppVolumeSnapshot available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppVolumeSnapshot -InlineCount allpages
```
Above example returns the list of StorageNetAppVolumeSnapshot along with count.
...
### -Name
Specifies the name of the StorageNetAppVolumeSnapshot.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppVolumeSnapshot under it.
