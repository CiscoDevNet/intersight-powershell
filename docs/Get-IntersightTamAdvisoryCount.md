...
# Get-IntersightTamAdvisoryCount

## SYNOPSIS
Get the TamAdvisoryCount

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightTamAdvisoryCount [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightTamAdvisoryCount [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;TamAdvisoryCount&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightTamAdvisoryCount
```
Above example returns the list of TamAdvisoryCount.

### Example 2
```powershell
PS C:\> $result = Get-IntersightTamAdvisoryCount -Name "MoName"
```
Above example returns the TamAdvisoryCount matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightTamAdvisoryCount -Organization $organization
```
Above example returns the list of TamAdvisoryCount available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightTamAdvisoryCount -InlineCount allpages
```
Above example returns the list of TamAdvisoryCount along with count.
...
### -Name
Specifies the name of the TamAdvisoryCount.
...
### -Organization
Specifies the organization, to fetch the TamAdvisoryCount under it.
