...
## SYNOPSIS
Get the IamLdapPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamLdapPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamLdapPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamLdapPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamLdapPolicy
```
Above example returns the list of IamLdapPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamLdapPolicy -Name "MoName"
```
Above example returns the IamLdapPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamLdapPolicy -Organization $organization
```
Above example returns the list of IamLdapPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamLdapPolicy -InlineCount allpages
```
Above example returns the list of IamLdapPolicy along with count.
...
### -Name
Specifies the name of the IamLdapPolicy.
...
### -Organization
Specifies the organization, to fetch the IamLdapPolicy under it.
