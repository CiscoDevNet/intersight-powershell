...
# Get-IntersightVnicVifIdPool

## SYNOPSIS
Get the VnicVifIdPool

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicVifIdPool [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicVifIdPool [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicVifIdPool&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicVifIdPool
```
Above example returns the list of VnicVifIdPool.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicVifIdPool -Name "MoName"
```
Above example returns the VnicVifIdPool matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicVifIdPool -Organization $organization
```
Above example returns the list of VnicVifIdPool available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicVifIdPool -InlineCount allpages
```
Above example returns the list of VnicVifIdPool along with count.
...
### -Name
Specifies the name of the VnicVifIdPool.
...
### -Organization
Specifies the organization, to fetch the VnicVifIdPool under it.
...
[Set-IntersightVnicVifIdPool](./Set-IntersightVnicVifIdPool.md)
