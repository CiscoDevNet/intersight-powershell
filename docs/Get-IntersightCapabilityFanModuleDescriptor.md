...
### CmdletParam (Default)
```
Get-IntersightCapabilityFanModuleDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityFanModuleDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityFanModuleDescriptor
```
Above example returns the list of CapabilityFanModuleDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityFanModuleDescriptor -Name "MoName"
```
Above example returns the CapabilityFanModuleDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityFanModuleDescriptor -Organization $organization
```
Above example returns the list of CapabilityFanModuleDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityFanModuleDescriptor -InlineCount allpages
```
Above example returns the list of CapabilityFanModuleDescriptor along with count.
...
### -Name
Specifies the name of the CapabilityFanModuleDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilityFanModuleDescriptor under it.
