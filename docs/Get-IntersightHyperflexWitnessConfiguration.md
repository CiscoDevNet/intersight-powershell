...
## SYNOPSIS
Get the HyperflexWitnessConfiguration

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexWitnessConfiguration [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexWitnessConfiguration [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexWitnessConfiguration&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexWitnessConfiguration
```
Above example returns the list of HyperflexWitnessConfiguration.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexWitnessConfiguration -Name "MoName"
```
Above example returns the HyperflexWitnessConfiguration matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexWitnessConfiguration -Organization $organization
```
Above example returns the list of HyperflexWitnessConfiguration available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexWitnessConfiguration -InlineCount allpages
```
Above example returns the list of HyperflexWitnessConfiguration along with count.
...
### -Name
Specifies the name of the HyperflexWitnessConfiguration.
...
### -Organization
Specifies the organization, to fetch the HyperflexWitnessConfiguration under it.
