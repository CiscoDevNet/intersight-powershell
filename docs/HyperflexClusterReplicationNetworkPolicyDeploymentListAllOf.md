...
```powershell
$HyperflexClusterReplicationNetworkPolicyDeploymentListAllOf = Initialize-IntersightHyperflexClusterReplicationNetworkPolicyDeploymentListAllOf  -Count null `
 -Results null
```

- Convert the resource to JSON
```powershell
$HyperflexClusterReplicationNetworkPolicyDeploymentListAllOf | ConvertTo-JSON
```
