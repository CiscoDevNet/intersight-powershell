...
# Get-IntersightApplianceBackupRotateData

## SYNOPSIS
Get the ApplianceBackupRotateData

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceBackupRotateData [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceBackupRotateData [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceBackupRotateData&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceBackupRotateData
```
Above example returns the list of ApplianceBackupRotateData.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceBackupRotateData -Name "MoName"
```
Above example returns the ApplianceBackupRotateData matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceBackupRotateData -Organization $organization
```
Above example returns the list of ApplianceBackupRotateData available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceBackupRotateData -InlineCount allpages
```
Above example returns the list of ApplianceBackupRotateData along with count.
...
### -Name
Specifies the name of the ApplianceBackupRotateData.
...
### -Organization
Specifies the organization, to fetch the ApplianceBackupRotateData under it.
