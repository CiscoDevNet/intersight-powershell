...
# Get-IntersightWorkloadWorkloadDefinition

## SYNOPSIS
Get the WorkloadWorkloadDefinition

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkloadWorkloadDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkloadWorkloadDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkloadWorkloadDefinition&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadDefinition
```
Above example returns the list of WorkloadWorkloadDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadDefinition -Name "MoName"
```
Above example returns the WorkloadWorkloadDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadDefinition -Organization $organization
```
Above example returns the list of WorkloadWorkloadDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkloadWorkloadDefinition -InlineCount allpages
```
Above example returns the list of WorkloadWorkloadDefinition along with count.
...
### -Name
Specifies the name of the WorkloadWorkloadDefinition.
...
### -Organization
Specifies the organization, to fetch the WorkloadWorkloadDefinition under it.
