...
## SYNOPSIS
Get the NiatelemetryApicDbgexpRsExportDest

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicDbgexpRsExportDest [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicDbgexpRsExportDest [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetryApicDbgexpRsExportDest&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicDbgexpRsExportDest
```
Above example returns the list of NiatelemetryApicDbgexpRsExportDest.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicDbgexpRsExportDest -Name "MoName"
```
Above example returns the NiatelemetryApicDbgexpRsExportDest matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicDbgexpRsExportDest -Organization $organization
```
Above example returns the list of NiatelemetryApicDbgexpRsExportDest available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicDbgexpRsExportDest -InlineCount allpages
```
Above example returns the list of NiatelemetryApicDbgexpRsExportDest along with count.
...
### -Name
Specifies the name of the NiatelemetryApicDbgexpRsExportDest.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicDbgexpRsExportDest under it.
