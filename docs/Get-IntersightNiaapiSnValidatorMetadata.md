...
# Get-IntersightNiaapiSnValidatorMetadata

## SYNOPSIS
Get the NiaapiSnValidatorMetadata

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiSnValidatorMetadata [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiSnValidatorMetadata [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiaapiSnValidatorMetadata&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiSnValidatorMetadata
```
Above example returns the list of NiaapiSnValidatorMetadata.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiSnValidatorMetadata -Name "MoName"
```
Above example returns the NiaapiSnValidatorMetadata matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiSnValidatorMetadata -Organization $organization
```
Above example returns the list of NiaapiSnValidatorMetadata available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiSnValidatorMetadata -InlineCount allpages
```
Above example returns the list of NiaapiSnValidatorMetadata along with count.
...
### -Name
Specifies the name of the NiaapiSnValidatorMetadata.
...
### -Organization
Specifies the organization, to fetch the NiaapiSnValidatorMetadata under it.
