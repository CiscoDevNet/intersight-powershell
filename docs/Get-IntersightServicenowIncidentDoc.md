...
# Get-IntersightServicenowIncidentDoc

## SYNOPSIS
Get the ServicenowIncidentDoc

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightServicenowIncidentDoc [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightServicenowIncidentDoc [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ServicenowIncidentDoc&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightServicenowIncidentDoc
```
Above example returns the list of ServicenowIncidentDoc.

### Example 2
```powershell
PS C:\> $result = Get-IntersightServicenowIncidentDoc -Name "MoName"
```
Above example returns the ServicenowIncidentDoc matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightServicenowIncidentDoc -Organization $organization
```
Above example returns the list of ServicenowIncidentDoc available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightServicenowIncidentDoc -InlineCount allpages
```
Above example returns the list of ServicenowIncidentDoc along with count.
...
### -Name
Specifies the name of the ServicenowIncidentDoc.
...
### -Organization
Specifies the organization, to fetch the ServicenowIncidentDoc under it.
