...
## SYNOPSIS
Get the NiatelemetrySshVersionTwo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetrySshVersionTwo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetrySshVersionTwo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetrySshVersionTwo&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySshVersionTwo
```
Above example returns the list of NiatelemetrySshVersionTwo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySshVersionTwo -Name "MoName"
```
Above example returns the NiatelemetrySshVersionTwo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySshVersionTwo -Organization $organization
```
Above example returns the list of NiatelemetrySshVersionTwo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetrySshVersionTwo -InlineCount allpages
```
Above example returns the list of NiatelemetrySshVersionTwo along with count.
...
### -Name
Specifies the name of the NiatelemetrySshVersionTwo.
...
### -Organization
Specifies the organization, to fetch the NiatelemetrySshVersionTwo under it.
