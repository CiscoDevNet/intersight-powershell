...
### CmdletParam (Default)
```
Get-IntersightHciAlarm [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciAlarm [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciAlarm&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciAlarm
```
Above example returns the list of HciAlarm.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciAlarm -Name "MoName"
```
Above example returns the HciAlarm matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciAlarm -Organization $organization
```
Above example returns the list of HciAlarm available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciAlarm -InlineCount allpages
```
Above example returns the list of HciAlarm along with count.
...
### -Name
Specifies the name of the HciAlarm.
...
### -Organization
Specifies the organization, to fetch the HciAlarm under it.
