...
### CmdletParam (Default)
```
Get-IntersightIamCertificate [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamCertificate [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamCertificate
```
Above example returns the list of IamCertificate.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamCertificate -Name "MoName"
```
Above example returns the IamCertificate matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamCertificate -Organization $organization
```
Above example returns the list of IamCertificate available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamCertificate -InlineCount allpages
```
Above example returns the list of IamCertificate along with count.
...
### -Name
Specifies the name of the IamCertificate.
...
### -Organization
Specifies the organization, to fetch the IamCertificate under it.
