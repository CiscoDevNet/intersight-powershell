...
# Get-IntersightWorkflowUiDisplayMetadata

## SYNOPSIS
Get the WorkflowUiDisplayMetadata

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowUiDisplayMetadata [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowUiDisplayMetadata [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowUiDisplayMetadata&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowUiDisplayMetadata
```
Above example returns the list of WorkflowUiDisplayMetadata.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowUiDisplayMetadata -Name "MoName"
```
Above example returns the WorkflowUiDisplayMetadata matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowUiDisplayMetadata -Organization $organization
```
Above example returns the list of WorkflowUiDisplayMetadata available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowUiDisplayMetadata -InlineCount allpages
```
Above example returns the list of WorkflowUiDisplayMetadata along with count.
...
### -Name
Specifies the name of the WorkflowUiDisplayMetadata.
...
### -Organization
Specifies the organization, to fetch the WorkflowUiDisplayMetadata under it.
