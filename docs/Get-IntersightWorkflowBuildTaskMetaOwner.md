...
## SYNOPSIS
Get the WorkflowBuildTaskMetaOwner

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowBuildTaskMetaOwner [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowBuildTaskMetaOwner [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowBuildTaskMetaOwner
```
Above example returns the list of WorkflowBuildTaskMetaOwner.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowBuildTaskMetaOwner -Name "MoName"
```
Above example returns the WorkflowBuildTaskMetaOwner matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowBuildTaskMetaOwner -Organization $organization
```
Above example returns the list of WorkflowBuildTaskMetaOwner available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowBuildTaskMetaOwner -InlineCount allpages
```
Above example returns the list of WorkflowBuildTaskMetaOwner along with count.
...
### -Name
Specifies the name of the WorkflowBuildTaskMetaOwner.
...
### -Organization
Specifies the organization, to fetch the WorkflowBuildTaskMetaOwner under it.
