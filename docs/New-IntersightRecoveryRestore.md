...
New-IntersightRecoveryRestore [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-BackupInfo< RecoveryAbstractBackupInfoRelationship>][-ConfigParams< RecoveryConfigParams>][-Device< AssetDeviceRegistrationRelationship>][-Moid< string>][-Organization< OrganizationOrganizationRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
