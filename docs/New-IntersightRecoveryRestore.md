...
New-IntersightRecoveryRestore [-AdditionalProperties< Dictionary<string,object>>][-BackupInfo< RecoveryAbstractBackupInfoRelationship>][-ConfigParams< RecoveryConfigParams>][-Device< AssetDeviceRegistrationRelationship>][-Moid< string>][-Organization< OrganizationOrganizationRelationship>][-Tags< List<MoTag>>]
...
```yaml
Type: RecoveryAbstractBackupInfoRelationship
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> New-IntersightRecoveryRestore
```
