...
# Initialize-IntersightTaskNexusSystemScopedInventory
...
```yaml
Type: TaskNexusSystemScopedInventory.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TaskNexusSystemScopedInventory.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTaskNexusSystemScopedInventory
```
