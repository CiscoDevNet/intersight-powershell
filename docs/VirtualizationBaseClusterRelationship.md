...
```powershell
$VirtualizationBaseClusterRelationship = Initialize-IntersightVirtualizationBaseClusterRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$VirtualizationBaseClusterRelationship | ConvertTo-JSON
```
