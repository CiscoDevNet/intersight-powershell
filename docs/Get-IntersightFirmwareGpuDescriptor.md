...
## SYNOPSIS
Get the FirmwareGpuDescriptor

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFirmwareGpuDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFirmwareGpuDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FirmwareGpuDescriptor&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFirmwareGpuDescriptor
```
Above example returns the list of FirmwareGpuDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFirmwareGpuDescriptor -Name "MoName"
```
Above example returns the FirmwareGpuDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFirmwareGpuDescriptor -Organization $organization
```
Above example returns the list of FirmwareGpuDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFirmwareGpuDescriptor -InlineCount allpages
```
Above example returns the list of FirmwareGpuDescriptor along with count.
...
### -Name
Specifies the name of the FirmwareGpuDescriptor.
...
### -Organization
Specifies the organization, to fetch the FirmwareGpuDescriptor under it.
