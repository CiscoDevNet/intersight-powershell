...
# Get-IntersightGraphicsCard

## SYNOPSIS
Get the GraphicsCard

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightGraphicsCard [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightGraphicsCard [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;GraphicsCard&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightGraphicsCard
```
Above example returns the list of GraphicsCard.

### Example 2
```powershell
PS C:\> $result = Get-IntersightGraphicsCard -Name "MoName"
```
Above example returns the GraphicsCard matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightGraphicsCard -Organization $organization
```
Above example returns the list of GraphicsCard available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightGraphicsCard -InlineCount allpages
```
Above example returns the list of GraphicsCard along with count.
...
### -Name
Specifies the name of the GraphicsCard.
...
### -Organization
Specifies the organization, to fetch the GraphicsCard under it.
...
[Set-IntersightGraphicsCard](./Set-IntersightGraphicsCard.md)
