...
# Get-IntersightLicenseIncCustomerOp

## SYNOPSIS
Get the LicenseIncCustomerOp

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightLicenseIncCustomerOp [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightLicenseIncCustomerOp [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;LicenseIncCustomerOp&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightLicenseIncCustomerOp
```
Above example returns the list of LicenseIncCustomerOp.

### Example 2
```powershell
PS C:\> $result = Get-IntersightLicenseIncCustomerOp -Name "MoName"
```
Above example returns the LicenseIncCustomerOp matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightLicenseIncCustomerOp -Organization $organization
```
Above example returns the list of LicenseIncCustomerOp available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightLicenseIncCustomerOp -InlineCount allpages
```
Above example returns the list of LicenseIncCustomerOp along with count.
...
### -Name
Specifies the name of the LicenseIncCustomerOp.
...
### -Organization
Specifies the organization, to fetch the LicenseIncCustomerOp under it.
...
[Set-IntersightLicenseIncCustomerOp](./Set-IntersightLicenseIncCustomerOp.md)
