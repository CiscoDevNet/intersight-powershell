...
```powershell
$NiatelemetryNiaFeatureUsageResponse = Initialize-IntersightNiatelemetryNiaFeatureUsageResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiatelemetryNiaFeatureUsageResponse | ConvertTo-JSON
```
