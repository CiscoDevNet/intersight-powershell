...
## SYNOPSIS
Get the SoftwareHyperflexDistributable

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwareHyperflexDistributable [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwareHyperflexDistributable [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SoftwareHyperflexDistributable&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwareHyperflexDistributable
```
Above example returns the list of SoftwareHyperflexDistributable.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwareHyperflexDistributable -Name "MoName"
```
Above example returns the SoftwareHyperflexDistributable matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwareHyperflexDistributable -Organization $organization
```
Above example returns the list of SoftwareHyperflexDistributable available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwareHyperflexDistributable -InlineCount allpages
```
Above example returns the list of SoftwareHyperflexDistributable along with count.
...
### -Name
Specifies the name of the SoftwareHyperflexDistributable.
...
### -Organization
Specifies the organization, to fetch the SoftwareHyperflexDistributable under it.
