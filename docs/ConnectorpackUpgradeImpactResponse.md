...
```powershell
$ConnectorpackUpgradeImpactResponse = Initialize-IntersightConnectorpackUpgradeImpactResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$ConnectorpackUpgradeImpactResponse | ConvertTo-JSON
```
