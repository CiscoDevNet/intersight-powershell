...
# Get-IntersightIamTrustPoint

## SYNOPSIS
Get the IamTrustPoint

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamTrustPoint [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamTrustPoint [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamTrustPoint
```
Above example returns the list of IamTrustPoint.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamTrustPoint -Name "MoName"
```
Above example returns the IamTrustPoint matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamTrustPoint -Organization $organization
```
Above example returns the list of IamTrustPoint available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamTrustPoint -InlineCount allpages
```
Above example returns the list of IamTrustPoint along with count.
...
### -Name
Specifies the name of the IamTrustPoint.
...
### -Organization
Specifies the organization, to fetch the IamTrustPoint under it.
