...
## SYNOPSIS
Get the StorageFlexUtilVirtualDrive

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageFlexUtilVirtualDrive [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageFlexUtilVirtualDrive [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageFlexUtilVirtualDrive&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageFlexUtilVirtualDrive
```
Above example returns the list of StorageFlexUtilVirtualDrive.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageFlexUtilVirtualDrive -Name "MoName"
```
Above example returns the StorageFlexUtilVirtualDrive matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageFlexUtilVirtualDrive -Organization $organization
```
Above example returns the list of StorageFlexUtilVirtualDrive available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageFlexUtilVirtualDrive -InlineCount allpages
```
Above example returns the list of StorageFlexUtilVirtualDrive along with count.
...
### -Name
Specifies the name of the StorageFlexUtilVirtualDrive.
...
### -Organization
Specifies the organization, to fetch the StorageFlexUtilVirtualDrive under it.
...
[Set-IntersightStorageFlexUtilVirtualDrive](./Set-IntersightStorageFlexUtilVirtualDrive.md)
