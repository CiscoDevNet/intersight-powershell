...
# Initialize-IntersightIwotenantTenantCustomization
...
Initialize-IntersightIwotenantTenantCustomization [-Account< Model.IamAccountRelationship>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< IwotenantTenantCustomization.ClassIdEnum>][-EnableDataExtractor< bool>][-IwoId< string>][-Moid< string>][-MskServerForDataExtractor< string>][-ObjectType< IwotenantTenantCustomization.ObjectTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-WriteUserAccessKeyId< string>][-WriteUserSecretAccessKey< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: IwotenantTenantCustomization.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IwotenantTenantCustomization.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIwotenantTenantCustomization
```
