...
# Initialize-IntersightTaskCatalystSdwanScopedInventory
...
```yaml
Type: TaskCatalystSdwanScopedInventory.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTaskCatalystSdwanScopedInventory
```
