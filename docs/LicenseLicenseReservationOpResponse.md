...
```powershell
$LicenseLicenseReservationOpResponse = Initialize-IntersightLicenseLicenseReservationOpResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$LicenseLicenseReservationOpResponse | ConvertTo-JSON
```
