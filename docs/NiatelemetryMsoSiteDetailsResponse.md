...
```powershell
$NiatelemetryMsoSiteDetailsResponse = Initialize-IntersightNiatelemetryMsoSiteDetailsResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$NiatelemetryMsoSiteDetailsResponse | ConvertTo-JSON
```
