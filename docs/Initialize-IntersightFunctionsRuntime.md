...
```yaml
Type: FunctionsRuntime.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.FunctionsRuntimeComponent]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FunctionsRuntime.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFunctionsRuntime
```
