...
Set-IntersightIamIdp [-AdditionalProperties< Dictionary<string,object>>][-DomainName< string>][-EnableSingleLogout< bool>][-Metadata< string>][[-Moid]< string>][-Name< string>][-Tags< List<MoTag>>][-Type< IamIdp.TypeEnum>][-Usergroups< List<IamUserGroupRelationship>>][-Users< List<IamUserRelationship>>]
