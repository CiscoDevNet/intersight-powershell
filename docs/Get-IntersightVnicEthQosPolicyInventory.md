...
# Get-IntersightVnicEthQosPolicyInventory

## SYNOPSIS
Get the VnicEthQosPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicEthQosPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicEthQosPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicEthQosPolicyInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicEthQosPolicyInventory
```
Above example returns the list of VnicEthQosPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicEthQosPolicyInventory -Name "MoName"
```
Above example returns the VnicEthQosPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicEthQosPolicyInventory -Organization $organization
```
Above example returns the list of VnicEthQosPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicEthQosPolicyInventory -InlineCount allpages
```
Above example returns the list of VnicEthQosPolicyInventory along with count.
...
### -Name
Specifies the name of the VnicEthQosPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the VnicEthQosPolicyInventory under it.
