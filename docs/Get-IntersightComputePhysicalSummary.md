...
## SYNOPSIS
Get the ComputePhysicalSummary

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputePhysicalSummary [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputePhysicalSummary [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ComputePhysicalSummary&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputePhysicalSummary
```
Above example returns the list of ComputePhysicalSummary.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputePhysicalSummary -Name "MoName"
```
Above example returns the ComputePhysicalSummary matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputePhysicalSummary -Organization $organization
```
Above example returns the list of ComputePhysicalSummary available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputePhysicalSummary -InlineCount allpages
```
Above example returns the list of ComputePhysicalSummary along with count.
...
### -Name
Specifies the name of the ComputePhysicalSummary.
...
### -Organization
Specifies the organization, to fetch the ComputePhysicalSummary under it.
