...
# Get-IntersightHyperflexHxapVirtualDisk

## SYNOPSIS
Get the HyperflexHxapVirtualDisk

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHxapVirtualDisk [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHxapVirtualDisk [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHxapVirtualDisk&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapVirtualDisk
```
Above example returns the list of HyperflexHxapVirtualDisk.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapVirtualDisk -Name "MoName"
```
Above example returns the HyperflexHxapVirtualDisk matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapVirtualDisk -Organization $organization
```
Above example returns the list of HyperflexHxapVirtualDisk available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapVirtualDisk -InlineCount allpages
```
Above example returns the list of HyperflexHxapVirtualDisk along with count.
...
### -Name
Specifies the name of the HyperflexHxapVirtualDisk.
...
### -Organization
Specifies the organization, to fetch the HyperflexHxapVirtualDisk under it.
...
[Set-IntersightHyperflexHxapVirtualDisk](./Set-IntersightHyperflexHxapVirtualDisk.md)
