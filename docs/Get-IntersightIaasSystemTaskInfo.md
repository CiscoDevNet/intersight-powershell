...
# Get-IntersightIaasSystemTaskInfo

## SYNOPSIS
Get the IaasSystemTaskInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIaasSystemTaskInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIaasSystemTaskInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IaasSystemTaskInfo&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIaasSystemTaskInfo
```
Above example returns the list of IaasSystemTaskInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIaasSystemTaskInfo -Name "MoName"
```
Above example returns the IaasSystemTaskInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIaasSystemTaskInfo -Organization $organization
```
Above example returns the list of IaasSystemTaskInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIaasSystemTaskInfo -InlineCount allpages
```
Above example returns the list of IaasSystemTaskInfo along with count.
...
### -Name
Specifies the name of the IaasSystemTaskInfo.
...
### -Organization
Specifies the organization, to fetch the IaasSystemTaskInfo under it.
