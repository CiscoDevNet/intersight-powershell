...
## SYNOPSIS
Get the NetworkVlanPortInfo

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkVlanPortInfo [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkVlanPortInfo [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NetworkVlanPortInfo&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkVlanPortInfo
```
Above example returns the list of NetworkVlanPortInfo.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkVlanPortInfo -Name "MoName"
```
Above example returns the NetworkVlanPortInfo matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkVlanPortInfo -Organization $organization
```
Above example returns the list of NetworkVlanPortInfo available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkVlanPortInfo -InlineCount allpages
```
Above example returns the list of NetworkVlanPortInfo along with count.
...
### -Name
Specifies the name of the NetworkVlanPortInfo.
...
### -Organization
Specifies the organization, to fetch the NetworkVlanPortInfo under it.
...
[Set-IntersightNetworkVlanPortInfo](./Set-IntersightNetworkVlanPortInfo.md)
