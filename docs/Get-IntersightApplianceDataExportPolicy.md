...
## SYNOPSIS
Get the ApplianceDataExportPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceDataExportPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceDataExportPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceDataExportPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceDataExportPolicy
```
Above example returns the list of ApplianceDataExportPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceDataExportPolicy -Name "MoName"
```
Above example returns the ApplianceDataExportPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceDataExportPolicy -Organization $organization
```
Above example returns the list of ApplianceDataExportPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceDataExportPolicy -InlineCount allpages
```
Above example returns the list of ApplianceDataExportPolicy along with count.
...
### -Name
Specifies the name of the ApplianceDataExportPolicy.
...
### -Organization
Specifies the organization, to fetch the ApplianceDataExportPolicy under it.
