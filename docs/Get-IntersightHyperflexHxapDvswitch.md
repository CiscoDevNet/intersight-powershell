...
# Get-IntersightHyperflexHxapDvswitch

## SYNOPSIS
Get the HyperflexHxapDvswitch

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexHxapDvswitch [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexHxapDvswitch [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexHxapDvswitch&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapDvswitch
```
Above example returns the list of HyperflexHxapDvswitch.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapDvswitch -Name "MoName"
```
Above example returns the HyperflexHxapDvswitch matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapDvswitch -Organization $organization
```
Above example returns the list of HyperflexHxapDvswitch available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexHxapDvswitch -InlineCount allpages
```
Above example returns the list of HyperflexHxapDvswitch along with count.
...
### -Name
Specifies the name of the HyperflexHxapDvswitch.
...
### -Organization
Specifies the organization, to fetch the HyperflexHxapDvswitch under it.
