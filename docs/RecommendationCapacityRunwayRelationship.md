...
```powershell
$RecommendationCapacityRunwayRelationship = Initialize-IntersightRecommendationCapacityRunwayRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$RecommendationCapacityRunwayRelationship | ConvertTo-JSON
```
