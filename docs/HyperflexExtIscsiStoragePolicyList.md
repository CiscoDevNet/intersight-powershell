...
```powershell
$HyperflexExtIscsiStoragePolicyList = Initialize-IntersightHyperflexExtIscsiStoragePolicyList  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexExtIscsiStoragePolicyList | ConvertTo-JSON
```
