...
## SYNOPSIS
Get the IamLocalUserPasswordPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamLocalUserPasswordPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamLocalUserPasswordPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamLocalUserPasswordPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamLocalUserPasswordPolicy
```
Above example returns the list of IamLocalUserPasswordPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamLocalUserPasswordPolicy -Name "MoName"
```
Above example returns the IamLocalUserPasswordPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamLocalUserPasswordPolicy -Organization $organization
```
Above example returns the list of IamLocalUserPasswordPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamLocalUserPasswordPolicy -InlineCount allpages
```
Above example returns the list of IamLocalUserPasswordPolicy along with count.
...
### -Name
Specifies the name of the IamLocalUserPasswordPolicy.
...
### -Organization
Specifies the organization, to fetch the IamLocalUserPasswordPolicy under it.
...
[Set-IntersightIamLocalUserPasswordPolicy](./Set-IntersightIamLocalUserPasswordPolicy.md)
