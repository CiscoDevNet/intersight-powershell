...
# Get-IntersightPartnerintegrationDocIssues

## SYNOPSIS
Get the PartnerintegrationDocIssues

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPartnerintegrationDocIssues [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPartnerintegrationDocIssues [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PartnerintegrationDocIssues&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationDocIssues
```
Above example returns the list of PartnerintegrationDocIssues.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationDocIssues -Name "MoName"
```
Above example returns the PartnerintegrationDocIssues matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationDocIssues -Organization $organization
```
Above example returns the list of PartnerintegrationDocIssues available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationDocIssues -InlineCount allpages
```
Above example returns the list of PartnerintegrationDocIssues along with count.
...
### -Name
Specifies the name of the PartnerintegrationDocIssues.
...
### -Organization
Specifies the organization, to fetch the PartnerintegrationDocIssues under it.
