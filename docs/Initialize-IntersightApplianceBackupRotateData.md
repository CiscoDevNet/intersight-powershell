...
# Initialize-IntersightApplianceBackupRotateData
...
Initialize-IntersightApplianceBackupRotateData [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< ApplianceBackupRotateData.ClassIdEnum>][-Filename< string>][-Moid< string>][-ObjectType< ApplianceBackupRotateData.ObjectTypeEnum>][-Protocol< ApplianceBackupRotateData.ProtocolEnum>][-RemoteHost< string>][-RemotePath< string>][-RemotePort< long>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Username< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ApplianceBackupRotateData.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ApplianceBackupRotateData.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ApplianceBackupRotateData.ProtocolEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightApplianceBackupRotateData
```
