...
## SYNOPSIS
Get the TamSecurityAdvisory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightTamSecurityAdvisory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightTamSecurityAdvisory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;TamSecurityAdvisory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightTamSecurityAdvisory
```
Above example returns the list of TamSecurityAdvisory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightTamSecurityAdvisory -Name "MoName"
```
Above example returns the TamSecurityAdvisory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightTamSecurityAdvisory -Organization $organization
```
Above example returns the list of TamSecurityAdvisory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightTamSecurityAdvisory -InlineCount allpages
```
Above example returns the list of TamSecurityAdvisory along with count.
...
### -Name
Specifies the name of the TamSecurityAdvisory.
...
### -Organization
Specifies the organization, to fetch the TamSecurityAdvisory under it.
