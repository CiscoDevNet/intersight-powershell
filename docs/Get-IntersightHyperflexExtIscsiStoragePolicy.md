...
## SYNOPSIS
Get the HyperflexExtIscsiStoragePolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexExtIscsiStoragePolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexExtIscsiStoragePolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexExtIscsiStoragePolicy
```
Above example returns the list of HyperflexExtIscsiStoragePolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexExtIscsiStoragePolicy -Name "MoName"
```
Above example returns the HyperflexExtIscsiStoragePolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexExtIscsiStoragePolicy -Organization $organization
```
Above example returns the list of HyperflexExtIscsiStoragePolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexExtIscsiStoragePolicy -InlineCount allpages
```
Above example returns the list of HyperflexExtIscsiStoragePolicy along with count.
...
### -Name
Specifies the name of the HyperflexExtIscsiStoragePolicy.
...
### -Organization
Specifies the organization, to fetch the HyperflexExtIscsiStoragePolicy under it.
