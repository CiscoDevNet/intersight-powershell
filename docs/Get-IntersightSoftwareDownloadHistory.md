...
## SYNOPSIS
Get the SoftwareDownloadHistory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwareDownloadHistory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwareDownloadHistory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;SoftwareDownloadHistory&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwareDownloadHistory
```
Above example returns the list of SoftwareDownloadHistory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwareDownloadHistory -Name "MoName"
```
Above example returns the SoftwareDownloadHistory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwareDownloadHistory -Organization $organization
```
Above example returns the list of SoftwareDownloadHistory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwareDownloadHistory -InlineCount allpages
```
Above example returns the list of SoftwareDownloadHistory along with count.
...
### -Name
Specifies the name of the SoftwareDownloadHistory.
...
### -Organization
Specifies the organization, to fetch the SoftwareDownloadHistory under it.
