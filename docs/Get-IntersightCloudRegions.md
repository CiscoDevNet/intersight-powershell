...
# Get-IntersightCloudRegions

## SYNOPSIS
Get the CloudRegions

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudRegions [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudRegions [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CloudRegions&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudRegions
```
Above example returns the list of CloudRegions.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudRegions -Name "MoName"
```
Above example returns the CloudRegions matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudRegions -Organization $organization
```
Above example returns the list of CloudRegions available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudRegions -InlineCount allpages
```
Above example returns the list of CloudRegions along with count.
...
### -Name
Specifies the name of the CloudRegions.
...
### -Organization
Specifies the organization, to fetch the CloudRegions under it.
...
[Set-IntersightCloudRegions](./Set-IntersightCloudRegions.md)
