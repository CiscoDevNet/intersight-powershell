...
```powershell
$SoftwarerepositoryCategoryMapperModel = Initialize-IntersightSoftwarerepositoryCategoryMapperModel  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$SoftwarerepositoryCategoryMapperModel | ConvertTo-JSON
```
