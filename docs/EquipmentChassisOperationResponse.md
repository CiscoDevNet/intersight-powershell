...
```powershell
$EquipmentChassisOperationResponse = Initialize-IntersightEquipmentChassisOperationResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$EquipmentChassisOperationResponse | ConvertTo-JSON
```
