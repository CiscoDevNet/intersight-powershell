...
Initialize-IntersightCondHclStatusDetail [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< CondHclStatusDetail.ClassIdEnum>][-Moid< string>][-ObjectType< CondHclStatusDetail.ObjectTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
