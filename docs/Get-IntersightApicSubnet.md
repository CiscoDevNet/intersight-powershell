...
### CmdletParam (Default)
```
Get-IntersightApicSubnet [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApicSubnet [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApicSubnet&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApicSubnet
```
Above example returns the list of ApicSubnet.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApicSubnet -Name "MoName"
```
Above example returns the ApicSubnet matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApicSubnet -Organization $organization
```
Above example returns the list of ApicSubnet available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApicSubnet -InlineCount allpages
```
Above example returns the list of ApicSubnet along with count.
...
### -Name
Specifies the name of the ApicSubnet.
...
### -Organization
Specifies the organization, to fetch the ApicSubnet under it.
