...
# Get-IntersightApplianceFileSystemTelemetry

## SYNOPSIS
Get the ApplianceFileSystemTelemetry

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceFileSystemTelemetry [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceFileSystemTelemetry [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ApplianceFileSystemTelemetry&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceFileSystemTelemetry
```
Above example returns the list of ApplianceFileSystemTelemetry.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceFileSystemTelemetry -Name "MoName"
```
Above example returns the ApplianceFileSystemTelemetry matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceFileSystemTelemetry -Organization $organization
```
Above example returns the list of ApplianceFileSystemTelemetry available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceFileSystemTelemetry -InlineCount allpages
```
Above example returns the list of ApplianceFileSystemTelemetry along with count.
...
### -Name
Specifies the name of the ApplianceFileSystemTelemetry.
...
### -Organization
Specifies the organization, to fetch the ApplianceFileSystemTelemetry under it.
