...
## SYNOPSIS
Get the VirtualizationVmwareNetwork

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationVmwareNetwork [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationVmwareNetwork [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationVmwareNetwork&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareNetwork
```
Above example returns the list of VirtualizationVmwareNetwork.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareNetwork -Name "MoName"
```
Above example returns the VirtualizationVmwareNetwork matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareNetwork -Organization $organization
```
Above example returns the list of VirtualizationVmwareNetwork available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationVmwareNetwork -InlineCount allpages
```
Above example returns the list of VirtualizationVmwareNetwork along with count.
...
### -Name
Specifies the name of the VirtualizationVmwareNetwork.
...
### -Organization
Specifies the organization, to fetch the VirtualizationVmwareNetwork under it.
...
[Set-IntersightVirtualizationVmwareNetwork](./Set-IntersightVirtualizationVmwareNetwork.md)
