...
# Get-IntersightCatalystsdwanPhysicalPort

## SYNOPSIS
Get the CatalystsdwanPhysicalPort

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCatalystsdwanPhysicalPort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCatalystsdwanPhysicalPort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CatalystsdwanPhysicalPort&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanPhysicalPort
```
Above example returns the list of CatalystsdwanPhysicalPort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanPhysicalPort -Name "MoName"
```
Above example returns the CatalystsdwanPhysicalPort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanPhysicalPort -Organization $organization
```
Above example returns the list of CatalystsdwanPhysicalPort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCatalystsdwanPhysicalPort -InlineCount allpages
```
Above example returns the list of CatalystsdwanPhysicalPort along with count.
...
### -Name
Specifies the name of the CatalystsdwanPhysicalPort.
...
### -Organization
Specifies the organization, to fetch the CatalystsdwanPhysicalPort under it.
