...
```powershell
$SoftwareUcsdBundleDistributableResponse = Initialize-IntersightSoftwareUcsdBundleDistributableResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwareUcsdBundleDistributableResponse | ConvertTo-JSON
```
