...
### CmdletParam (Default)
```
Get-IntersightVnicFcIf [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicFcIf [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicFcIf
```
Above example returns the list of VnicFcIf.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicFcIf -Name "MoName"
```
Above example returns the VnicFcIf matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicFcIf -Organization $organization
```
Above example returns the list of VnicFcIf available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicFcIf -InlineCount allpages
```
Above example returns the list of VnicFcIf along with count.
...
### -Name
Specifies the name of the VnicFcIf.
...
### -Organization
Specifies the organization, to fetch the VnicFcIf under it.
