...
## SYNOPSIS
Get the CloudAwsNetworkInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightCloudAwsNetworkInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCloudAwsNetworkInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;CloudAwsNetworkInterface&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCloudAwsNetworkInterface
```
Above example returns the list of CloudAwsNetworkInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCloudAwsNetworkInterface -Name "MoName"
```
Above example returns the CloudAwsNetworkInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCloudAwsNetworkInterface -Organization $organization
```
Above example returns the list of CloudAwsNetworkInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCloudAwsNetworkInterface -InlineCount allpages
```
Above example returns the list of CloudAwsNetworkInterface along with count.
...
### -Name
Specifies the name of the CloudAwsNetworkInterface.
...
### -Organization
Specifies the organization, to fetch the CloudAwsNetworkInterface under it.
