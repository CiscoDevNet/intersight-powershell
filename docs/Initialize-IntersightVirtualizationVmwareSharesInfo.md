...
Initialize-IntersightVirtualizationVmwareSharesInfo [-AdditionalProperties< Dictionary<string,object>>][-ClassId< VirtualizationVmwareSharesInfo.ClassIdEnum>][-Level< string>][-ObjectType< VirtualizationVmwareSharesInfo.ObjectTypeEnum>][-Shares< long>]
