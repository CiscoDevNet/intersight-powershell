...
### CmdletParam (Default)
```
Get-IntersightStorageNetAppFcInterfaceEvent [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppFcInterfaceEvent [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StorageNetAppFcInterfaceEvent&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcInterfaceEvent
```
Above example returns the list of StorageNetAppFcInterfaceEvent.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcInterfaceEvent -Name "MoName"
```
Above example returns the StorageNetAppFcInterfaceEvent matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcInterfaceEvent -Organization $organization
```
Above example returns the list of StorageNetAppFcInterfaceEvent available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcInterfaceEvent -InlineCount allpages
```
Above example returns the list of StorageNetAppFcInterfaceEvent along with count.
...
### -Name
Specifies the name of the StorageNetAppFcInterfaceEvent.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppFcInterfaceEvent under it.
