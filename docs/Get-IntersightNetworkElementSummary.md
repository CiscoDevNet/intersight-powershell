...
## SYNOPSIS
Get the NetworkElementSummary

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNetworkElementSummary [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkElementSummary [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NetworkElementSummary&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkElementSummary
```
Above example returns the list of NetworkElementSummary.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkElementSummary -Name "MoName"
```
Above example returns the NetworkElementSummary matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkElementSummary -Organization $organization
```
Above example returns the list of NetworkElementSummary available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkElementSummary -InlineCount allpages
```
Above example returns the list of NetworkElementSummary along with count.
...
### -Name
Specifies the name of the NetworkElementSummary.
...
### -Organization
Specifies the organization, to fetch the NetworkElementSummary under it.
