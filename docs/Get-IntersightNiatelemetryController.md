...
# Get-IntersightNiatelemetryController

## SYNOPSIS
Get the NiatelemetryController

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryController [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryController [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryController&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryController
```
Above example returns the list of NiatelemetryController.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryController -Name "MoName"
```
Above example returns the NiatelemetryController matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryController -Organization $organization
```
Above example returns the list of NiatelemetryController available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryController -InlineCount allpages
```
Above example returns the list of NiatelemetryController along with count.
...
### -Name
Specifies the name of the NiatelemetryController.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryController under it.
