...
# Get-IntersightSdwanRouterNode

## SYNOPSIS
Get the SdwanRouterNode

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSdwanRouterNode [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSdwanRouterNode [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSdwanRouterNode
```
Above example returns the list of SdwanRouterNode.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSdwanRouterNode -Name "MoName"
```
Above example returns the SdwanRouterNode matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSdwanRouterNode -Organization $organization
```
Above example returns the list of SdwanRouterNode available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSdwanRouterNode -InlineCount allpages
```
Above example returns the list of SdwanRouterNode along with count.
...
### -Name
Specifies the name of the SdwanRouterNode.
...
### -Organization
Specifies the organization, to fetch the SdwanRouterNode under it.
