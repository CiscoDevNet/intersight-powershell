...
## SYNOPSIS
Get the KubernetesContainerRuntimePolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightKubernetesContainerRuntimePolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesContainerRuntimePolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesContainerRuntimePolicy
```
Above example returns the list of KubernetesContainerRuntimePolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesContainerRuntimePolicy -Name "MoName"
```
Above example returns the KubernetesContainerRuntimePolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesContainerRuntimePolicy -Organization $organization
```
Above example returns the list of KubernetesContainerRuntimePolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesContainerRuntimePolicy -InlineCount allpages
```
Above example returns the list of KubernetesContainerRuntimePolicy along with count.
...
### -Name
Specifies the name of the KubernetesContainerRuntimePolicy.
...
### -Organization
Specifies the organization, to fetch the KubernetesContainerRuntimePolicy under it.
