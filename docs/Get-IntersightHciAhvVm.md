...
### CmdletParam (Default)
```
Get-IntersightHciAhvVm [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHciAhvVm [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HciAhvVm&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHciAhvVm
```
Above example returns the list of HciAhvVm.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHciAhvVm -Name "MoName"
```
Above example returns the HciAhvVm matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHciAhvVm -Organization $organization
```
Above example returns the list of HciAhvVm available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHciAhvVm -InlineCount allpages
```
Above example returns the list of HciAhvVm along with count.
...
### -Name
Specifies the name of the HciAhvVm.
...
### -Organization
Specifies the organization, to fetch the HciAhvVm under it.
...
[Set-IntersightHciAhvVm](./Set-IntersightHciAhvVm.md)
