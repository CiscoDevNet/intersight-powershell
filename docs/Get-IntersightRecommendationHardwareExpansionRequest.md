...
# Get-IntersightRecommendationHardwareExpansionRequest

## SYNOPSIS
Get the RecommendationHardwareExpansionRequest

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightRecommendationHardwareExpansionRequest [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightRecommendationHardwareExpansionRequest [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;RecommendationHardwareExpansionRequest&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightRecommendationHardwareExpansionRequest
```
Above example returns the list of RecommendationHardwareExpansionRequest.

### Example 2
```powershell
PS C:\> $result = Get-IntersightRecommendationHardwareExpansionRequest -Name "MoName"
```
Above example returns the RecommendationHardwareExpansionRequest matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightRecommendationHardwareExpansionRequest -Organization $organization
```
Above example returns the list of RecommendationHardwareExpansionRequest available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightRecommendationHardwareExpansionRequest -InlineCount allpages
```
Above example returns the list of RecommendationHardwareExpansionRequest along with count.
...
### -Name
Specifies the name of the RecommendationHardwareExpansionRequest.
...
### -Organization
Specifies the organization, to fetch the RecommendationHardwareExpansionRequest under it.
...
[New-IntersightRecommendationHardwareExpansionRequest](./New-IntersightRecommendationHardwareExpansionRequest.md)

[Set-IntersightRecommendationHardwareExpansionRequest](./Set-IntersightRecommendationHardwareExpansionRequest.md)
