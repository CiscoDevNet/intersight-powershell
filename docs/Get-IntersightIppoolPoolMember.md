...
# Get-IntersightIppoolPoolMember

## SYNOPSIS
Get the IppoolPoolMember

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIppoolPoolMember [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIppoolPoolMember [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IppoolPoolMember&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIppoolPoolMember
```
Above example returns the list of IppoolPoolMember.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIppoolPoolMember -Name "MoName"
```
Above example returns the IppoolPoolMember matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIppoolPoolMember -Organization $organization
```
Above example returns the list of IppoolPoolMember available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIppoolPoolMember -InlineCount allpages
```
Above example returns the list of IppoolPoolMember along with count.
...
### -Name
Specifies the name of the IppoolPoolMember.
...
### -Organization
Specifies the organization, to fetch the IppoolPoolMember under it.
