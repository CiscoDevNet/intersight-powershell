...
## SYNOPSIS
Get the SoftwarerepositoryRelease

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSoftwarerepositoryRelease [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSoftwarerepositoryRelease [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryRelease
```
Above example returns the list of SoftwarerepositoryRelease.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryRelease -Name "MoName"
```
Above example returns the SoftwarerepositoryRelease matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryRelease -Organization $organization
```
Above example returns the list of SoftwarerepositoryRelease available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSoftwarerepositoryRelease -InlineCount allpages
```
Above example returns the list of SoftwarerepositoryRelease along with count.
...
### -Name
Specifies the name of the SoftwarerepositoryRelease.
...
### -Organization
Specifies the organization, to fetch the SoftwarerepositoryRelease under it.
