...
# Get-IntersightPortMacBinding

## SYNOPSIS
Get the PortMacBinding

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPortMacBinding [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPortMacBinding [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PortMacBinding&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPortMacBinding
```
Above example returns the list of PortMacBinding.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPortMacBinding -Name "MoName"
```
Above example returns the PortMacBinding matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPortMacBinding -Organization $organization
```
Above example returns the list of PortMacBinding available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPortMacBinding -InlineCount allpages
```
Above example returns the list of PortMacBinding along with count.
...
### -Name
Specifies the name of the PortMacBinding.
...
### -Organization
Specifies the organization, to fetch the PortMacBinding under it.
...
[Set-IntersightPortMacBinding](./Set-IntersightPortMacBinding.md)
