...
Set-IntersightEquipmentSharedIoModule [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-EquipmentSystemIoController< EquipmentSystemIoControllerRelationship>][[-Moid]< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
