...
```powershell
$HyperflexHealthCheckPackageChecksumResponse = Initialize-IntersightHyperflexHealthCheckPackageChecksumResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$HyperflexHealthCheckPackageChecksumResponse | ConvertTo-JSON
```
