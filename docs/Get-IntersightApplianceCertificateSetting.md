...
## SYNOPSIS
Get the ApplianceCertificateSetting

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceCertificateSetting [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceCertificateSetting [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceCertificateSetting
```
Above example returns the list of ApplianceCertificateSetting.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceCertificateSetting -Name "MoName"
```
Above example returns the ApplianceCertificateSetting matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceCertificateSetting -Organization $organization
```
Above example returns the list of ApplianceCertificateSetting available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceCertificateSetting -InlineCount allpages
```
Above example returns the list of ApplianceCertificateSetting along with count.
...
### -Name
Specifies the name of the ApplianceCertificateSetting.
...
### -Organization
Specifies the organization, to fetch the ApplianceCertificateSetting under it.
...
[Set-IntersightApplianceCertificateSetting](./Set-IntersightApplianceCertificateSetting.md)
