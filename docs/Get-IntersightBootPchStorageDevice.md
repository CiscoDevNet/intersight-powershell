...
## SYNOPSIS
Get the BootPchStorageDevice

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightBootPchStorageDevice [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightBootPchStorageDevice [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightBootPchStorageDevice
```
Above example returns the list of BootPchStorageDevice.

### Example 2
```powershell
PS C:\> $result = Get-IntersightBootPchStorageDevice -Name "MoName"
```
Above example returns the BootPchStorageDevice matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightBootPchStorageDevice -Organization $organization
```
Above example returns the list of BootPchStorageDevice available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightBootPchStorageDevice -InlineCount allpages
```
Above example returns the list of BootPchStorageDevice along with count.
...
### -Name
Specifies the name of the BootPchStorageDevice.
...
### -Organization
Specifies the organization, to fetch the BootPchStorageDevice under it.
...
[Set-IntersightBootPchStorageDevice](./Set-IntersightBootPchStorageDevice.md)
