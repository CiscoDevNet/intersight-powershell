...
### CmdletParam (Default)
```
Get-IntersightKubernetesAddonDefinition [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightKubernetesAddonDefinition [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;KubernetesAddonDefinition&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightKubernetesAddonDefinition
```
Above example returns the list of KubernetesAddonDefinition.

### Example 2
```powershell
PS C:\> $result = Get-IntersightKubernetesAddonDefinition -Name "MoName"
```
Above example returns the KubernetesAddonDefinition matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightKubernetesAddonDefinition -Organization $organization
```
Above example returns the list of KubernetesAddonDefinition available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightKubernetesAddonDefinition -InlineCount allpages
```
Above example returns the list of KubernetesAddonDefinition along with count.
...
### -Name
Specifies the name of the KubernetesAddonDefinition.
...
### -Organization
Specifies the organization, to fetch the KubernetesAddonDefinition under it.
