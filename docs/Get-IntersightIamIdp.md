...
### CmdletParam (Default)
```
Get-IntersightIamIdp [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamIdp [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;IamIdp&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamIdp
```
Above example returns the list of IamIdp.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamIdp -Name "MoName"
```
Above example returns the IamIdp matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamIdp -Organization $organization
```
Above example returns the list of IamIdp available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamIdp -InlineCount allpages
```
Above example returns the list of IamIdp along with count.
...
### -Name
Specifies the name of the IamIdp.
...
### -Organization
Specifies the organization, to fetch the IamIdp under it.
