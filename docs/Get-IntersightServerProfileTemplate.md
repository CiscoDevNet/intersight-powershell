...
# Get-IntersightServerProfileTemplate

## SYNOPSIS
Get the ServerProfileTemplate

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightServerProfileTemplate [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightServerProfileTemplate [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ServerProfileTemplate&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightServerProfileTemplate
```
Above example returns the list of ServerProfileTemplate.

### Example 2
```powershell
PS C:\> $result = Get-IntersightServerProfileTemplate -Name "MoName"
```
Above example returns the ServerProfileTemplate matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightServerProfileTemplate -Organization $organization
```
Above example returns the list of ServerProfileTemplate available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightServerProfileTemplate -InlineCount allpages
```
Above example returns the list of ServerProfileTemplate along with count.
...
### -Name
Specifies the name of the ServerProfileTemplate.
...
### -Organization
Specifies the organization, to fetch the ServerProfileTemplate under it.
