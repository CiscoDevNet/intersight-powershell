...
## SYNOPSIS
Get the StoragePhysicalDiskExtension

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStoragePhysicalDiskExtension [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStoragePhysicalDiskExtension [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;StoragePhysicalDiskExtension&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStoragePhysicalDiskExtension
```
Above example returns the list of StoragePhysicalDiskExtension.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStoragePhysicalDiskExtension -Name "MoName"
```
Above example returns the StoragePhysicalDiskExtension matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStoragePhysicalDiskExtension -Organization $organization
```
Above example returns the list of StoragePhysicalDiskExtension available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStoragePhysicalDiskExtension -InlineCount allpages
```
Above example returns the list of StoragePhysicalDiskExtension along with count.
...
### -Name
Specifies the name of the StoragePhysicalDiskExtension.
...
### -Organization
Specifies the organization, to fetch the StoragePhysicalDiskExtension under it.
...
[Set-IntersightStoragePhysicalDiskExtension](./Set-IntersightStoragePhysicalDiskExtension.md)
