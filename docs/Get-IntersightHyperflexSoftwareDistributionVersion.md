...
## SYNOPSIS
Get the HyperflexSoftwareDistributionVersion

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexSoftwareDistributionVersion [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexSoftwareDistributionVersion [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareDistributionVersion
```
Above example returns the list of HyperflexSoftwareDistributionVersion.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareDistributionVersion -Name "MoName"
```
Above example returns the HyperflexSoftwareDistributionVersion matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareDistributionVersion -Organization $organization
```
Above example returns the list of HyperflexSoftwareDistributionVersion available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexSoftwareDistributionVersion -InlineCount allpages
```
Above example returns the list of HyperflexSoftwareDistributionVersion along with count.
...
### -Name
Specifies the name of the HyperflexSoftwareDistributionVersion.
...
### -Organization
Specifies the organization, to fetch the HyperflexSoftwareDistributionVersion under it.
