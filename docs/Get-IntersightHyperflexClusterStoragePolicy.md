...
## SYNOPSIS
Get the HyperflexClusterStoragePolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexClusterStoragePolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexClusterStoragePolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HyperflexClusterStoragePolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterStoragePolicy
```
Above example returns the list of HyperflexClusterStoragePolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterStoragePolicy -Name "MoName"
```
Above example returns the HyperflexClusterStoragePolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterStoragePolicy -Organization $organization
```
Above example returns the list of HyperflexClusterStoragePolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexClusterStoragePolicy -InlineCount allpages
```
Above example returns the list of HyperflexClusterStoragePolicy along with count.
...
### -Name
Specifies the name of the HyperflexClusterStoragePolicy.
...
### -Organization
Specifies the organization, to fetch the HyperflexClusterStoragePolicy under it.
