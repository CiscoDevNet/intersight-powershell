...
# Initialize-IntersightIamEndPointUserRole
...
```yaml
Type: IamEndPointUserRole.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.IamEndPointUserRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.IamEndPointUserPolicyRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: IamEndPointUserRole.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightIamEndPointUserRole
```
