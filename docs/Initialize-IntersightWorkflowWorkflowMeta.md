...
# Initialize-IntersightWorkflowWorkflowMeta
...
Initialize-IntersightWorkflowWorkflowMeta [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< WorkflowWorkflowMeta.ClassIdEnum>][-Description< string>][-InputParameters< System.Collections.Generic.List`1[string]>][-Moid< string>][-Name< string>][-ObjectType< WorkflowWorkflowMeta.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-OutputParameters< object>][-Retryable< bool>][-SchemaVersion< long>][-Src< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Tasks< object>][-Type< WorkflowWorkflowMeta.TypeEnum>][-Version< long>][-WaitOnDuplicate< bool>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowWorkflowMeta.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowWorkflowMeta.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowWorkflowMeta.TypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowWorkflowMeta
```
