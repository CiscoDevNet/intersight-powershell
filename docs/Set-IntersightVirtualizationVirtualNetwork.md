...
Set-IntersightVirtualizationVirtualNetwork [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Cluster< VirtualizationBaseClusterRelationship>][-Description< string>][-InfraNetwork< bool>][[-Moid]< string>][-Mtu< long>][-Name< string>][-NetworkType< VirtualizationVirtualNetwork.NetworkTypeEnum>][-RegisteredDevice< AssetDeviceRegistrationRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Trunk< System.Collections.Generic.List`1[string]>][-Vlan< long>][-Vswitch< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> Set-IntersightVirtualizationVirtualNetwork
```
