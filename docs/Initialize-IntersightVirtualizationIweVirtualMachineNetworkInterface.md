...
# Initialize-IntersightVirtualizationIweVirtualMachineNetworkInterface
...
Initialize-IntersightVirtualizationIweVirtualMachineNetworkInterface [-AdapterType< VirtualizationIweVirtualMachineNetworkInterface.AdapterTypeEnum>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< VirtualizationIweVirtualMachineNetworkInterface.ClassIdEnum>][-InterfaceName< string>][-IpAddress< System.Collections.Generic.List`1[string]>][-MacAddress< string>][-Moid< string>][-Name< string>][-ObjectType< VirtualizationIweVirtualMachineNetworkInterface.ObjectTypeEnum>][-PrimaryIpAddress< string>][-RegisteredDevice< Model.AssetDeviceRegistrationRelationship>][-Status< VirtualizationIweVirtualMachineNetworkInterface.StatusEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-VirtualMachineName< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: VirtualizationIweVirtualMachineNetworkInterface.AdapterTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VirtualizationIweVirtualMachineNetworkInterface.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: VirtualizationIweVirtualMachineNetworkInterface.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### -Status
Current status of virtual network interface status.\n* `Up` - Virtual network interface is up and running.\n* `Down` - Virtual network interface is down and not running.

```yaml
Type: VirtualizationIweVirtualMachineNetworkInterface.StatusEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightVirtualizationIweVirtualMachineNetworkInterface
```
