...
# Initialize-IntersightWorkflowCatalogServiceRequest
...
Initialize-IntersightWorkflowCatalogServiceRequest [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-CatalogItemDefinition< Model.WorkflowCatalogItemDefinitionRelationship>][-ClassId< WorkflowCatalogServiceRequest.ClassIdEnum>][-Description< string>][-Idp< Model.IamIdpRelationship>][-IdpReference< Model.IamIdpReferenceRelationship>][-Input< object>][-Label< string>][-Moid< string>][-Name< string>][-ObjectType< WorkflowCatalogServiceRequest.ObjectTypeEnum>][-Operation< Model.WorkflowBaseOperation>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-User< Model.IamUserRelationship>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: Model.WorkflowCatalogItemDefinitionRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowCatalogServiceRequest.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowCatalogServiceRequest.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.WorkflowBaseOperation
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowCatalogServiceRequest
```
