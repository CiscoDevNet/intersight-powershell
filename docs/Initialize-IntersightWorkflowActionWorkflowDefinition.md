...
Initialize-IntersightWorkflowActionWorkflowDefinition [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-CatalogMoid< string>][-ClassId< WorkflowActionWorkflowDefinition.ClassIdEnum>][-Description< string>][-InputParameters< object>][-Label< string>][-Name< string>][-ObjectType< WorkflowActionWorkflowDefinition.ObjectTypeEnum>][-Version< long>][-WorkflowDefinitionName< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: WorkflowActionWorkflowDefinition.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: WorkflowActionWorkflowDefinition.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightWorkflowActionWorkflowDefinition
```
