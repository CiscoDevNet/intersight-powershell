...
## SYNOPSIS
Get the WorkflowBuildTaskMeta

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightWorkflowBuildTaskMeta [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightWorkflowBuildTaskMeta [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;WorkflowBuildTaskMeta&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightWorkflowBuildTaskMeta
```
Above example returns the list of WorkflowBuildTaskMeta.

### Example 2
```powershell
PS C:\> $result = Get-IntersightWorkflowBuildTaskMeta -Name "MoName"
```
Above example returns the WorkflowBuildTaskMeta matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightWorkflowBuildTaskMeta -Organization $organization
```
Above example returns the list of WorkflowBuildTaskMeta available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightWorkflowBuildTaskMeta -InlineCount allpages
```
Above example returns the list of WorkflowBuildTaskMeta along with count.
...
### -Name
Specifies the name of the WorkflowBuildTaskMeta.
...
### -Organization
Specifies the organization, to fetch the WorkflowBuildTaskMeta under it.
