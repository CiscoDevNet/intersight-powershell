...
Set-IntersightHyperflexServerModel [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AppCatalog< HyperflexAppCatalogRelationship>][[-Moid]< string>][-ServerModelEntries< System.Collections.Generic.List`1[HyperflexServerModelEntry]>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> Set-IntersightHyperflexServerModel
```
