...
Set-IntersightHyperflexServerModel [-AdditionalProperties< Dictionary<string,object>>][-AppCatalog< HyperflexAppCatalogRelationship>][[-Moid]< string>][-ServerModelEntries< List<HyperflexServerModelEntry>>][-Tags< List<MoTag>>]
