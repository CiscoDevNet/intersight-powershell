...
```powershell
$VirtualizationBaseHypervisorManager = Initialize-IntersightVirtualizationBaseHypervisorManager  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$VirtualizationBaseHypervisorManager | ConvertTo-JSON
```
