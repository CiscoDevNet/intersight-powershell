...
## SYNOPSIS
Get the ApplianceImageBundle

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightApplianceImageBundle [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightApplianceImageBundle [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightApplianceImageBundle
```
Above example returns the list of ApplianceImageBundle.

### Example 2
```powershell
PS C:\> $result = Get-IntersightApplianceImageBundle -Name "MoName"
```
Above example returns the ApplianceImageBundle matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightApplianceImageBundle -Organization $organization
```
Above example returns the list of ApplianceImageBundle available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightApplianceImageBundle -InlineCount allpages
```
Above example returns the list of ApplianceImageBundle along with count.
...
### -Name
Specifies the name of the ApplianceImageBundle.
...
### -Organization
Specifies the organization, to fetch the ApplianceImageBundle under it.
