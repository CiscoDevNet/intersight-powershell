...
# New-IntersightFabricSpanSourceEthPort
...
New-IntersightFabricSpanSourceEthPort [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AggregatePortId< long>][-Direction< FabricSpanSourceEthPort.DirectionEnum>][-Moid< string>][-PortId< long>][-SlotId< long>][-SpanSession< FabricSpanSessionRelationship>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Create a &apos;FabricSpanSourceEthPort&apos; resource.
...
### Example 1
```powershell
PS C:\> New-IntersightFabricSpanSourceEthPort
```
