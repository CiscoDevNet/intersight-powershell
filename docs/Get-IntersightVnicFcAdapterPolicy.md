...
## SYNOPSIS
Get the VnicFcAdapterPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicFcAdapterPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicFcAdapterPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicFcAdapterPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicFcAdapterPolicy
```
Above example returns the list of VnicFcAdapterPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicFcAdapterPolicy -Name "MoName"
```
Above example returns the VnicFcAdapterPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicFcAdapterPolicy -Organization $organization
```
Above example returns the list of VnicFcAdapterPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicFcAdapterPolicy -InlineCount allpages
```
Above example returns the list of VnicFcAdapterPolicy along with count.
...
### -Name
Specifies the name of the VnicFcAdapterPolicy.
...
### -Organization
Specifies the organization, to fetch the VnicFcAdapterPolicy under it.
