...
New-IntersightWorkflowUiDisplayMetadata [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-MetaDefinition< MoBaseMoRelationship>][-Moid< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-UiFormConfigs< System.Collections.Generic.List`1[WorkflowUiFormConfig]>][-UiViewConfigs< System.Collections.Generic.List`1[WorkflowUiViewConfig]>][-IfMatch< String>][-IfNoneMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
