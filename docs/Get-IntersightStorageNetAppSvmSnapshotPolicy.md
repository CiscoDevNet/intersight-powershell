...
# Get-IntersightStorageNetAppSvmSnapshotPolicy

## SYNOPSIS
Get the StorageNetAppSvmSnapshotPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppSvmSnapshotPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppSvmSnapshotPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppSvmSnapshotPolicy&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSvmSnapshotPolicy
```
Above example returns the list of StorageNetAppSvmSnapshotPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSvmSnapshotPolicy -Name "MoName"
```
Above example returns the StorageNetAppSvmSnapshotPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSvmSnapshotPolicy -Organization $organization
```
Above example returns the list of StorageNetAppSvmSnapshotPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppSvmSnapshotPolicy -InlineCount allpages
```
Above example returns the list of StorageNetAppSvmSnapshotPolicy along with count.
...
### -Name
Specifies the name of the StorageNetAppSvmSnapshotPolicy.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppSvmSnapshotPolicy under it.
