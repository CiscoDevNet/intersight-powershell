...
Set-IntersightVirtualizationVmwareVirtualMachineSnapshot [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-CreationTime< DateTime>][-CurrentSnapshot< bool>][-Description< string>][-Golden< bool>][-Identity< string>][-Key< long>][[-Moid]< string>][-Name< string>][-PredecessorId< long>][-Quiesced< bool>][-RefValue< string>][-RegisteredDevice< AssetDeviceRegistrationRelationship>][-SnapshotSize< long>][-Tags< System.Collections.Generic.List`1[MoTag]>][-IfMatch< String>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]

```

## DESCRIPTION
Update a &apos;VirtualizationVmwareVirtualMachineSnapshot&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightVirtualizationVmwareVirtualMachineSnapshot
```
...
[Get-IntersightVirtualizationVmwareVirtualMachineSnapshot](./Get-IntersightVirtualizationVmwareVirtualMachineSnapshot.md)
