...
# Initialize-IntersightCondAlarmRule
...
Initialize-IntersightCondAlarmRule [-Account< Model.IamAccountRelationship>][-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< CondAlarmRule.ClassIdEnum>][-Description< string>][-Devices< System.Collections.Generic.List`1[Model.MoBaseMoRelationship]>][-Moid< string>][-Name< string>][-ObjectType< CondAlarmRule.ObjectTypeEnum>][-State< CondAlarmRule.StateEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-ThresholdDefinitionStates< System.Collections.Generic.List`1[Model.CondThresholdDefinitionState]>][-ThresholdDefinitions< System.Collections.Generic.List`1[Model.CondThresholdDefinitionRelationship]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: CondAlarmRule.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: CondAlarmRule.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.CondThresholdDefinitionState]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.CondThresholdDefinitionRelationship]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightCondAlarmRule
```
