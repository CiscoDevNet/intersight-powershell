...
```powershell
$ChassisConfigChangeDetailRelationship = Initialize-IntersightChassisConfigChangeDetailRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$ChassisConfigChangeDetailRelationship | ConvertTo-JSON
```
