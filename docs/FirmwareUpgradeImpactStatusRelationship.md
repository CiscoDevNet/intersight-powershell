...
```powershell
$FirmwareUpgradeImpactStatusRelationship = Initialize-IntersightFirmwareUpgradeImpactStatusRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$FirmwareUpgradeImpactStatusRelationship | ConvertTo-JSON
```
