...
# Get-IntersightNiaapiNdEncryptedFileDownload

## SYNOPSIS
Get the NiaapiNdEncryptedFileDownload

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiaapiNdEncryptedFileDownload [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiaapiNdEncryptedFileDownload [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiaapiNdEncryptedFileDownload&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiaapiNdEncryptedFileDownload
```
Above example returns the list of NiaapiNdEncryptedFileDownload.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiaapiNdEncryptedFileDownload -Name "MoName"
```
Above example returns the NiaapiNdEncryptedFileDownload matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiaapiNdEncryptedFileDownload -Organization $organization
```
Above example returns the list of NiaapiNdEncryptedFileDownload available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiaapiNdEncryptedFileDownload -InlineCount allpages
```
Above example returns the list of NiaapiNdEncryptedFileDownload along with count.
...
### -Name
Specifies the name of the NiaapiNdEncryptedFileDownload.
...
### -Organization
Specifies the organization, to fetch the NiaapiNdEncryptedFileDownload under it.
