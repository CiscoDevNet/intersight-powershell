...
# Get-IntersightElectricitymapsCarbonIntensity

## SYNOPSIS
Get the ElectricitymapsCarbonIntensity

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightElectricitymapsCarbonIntensity [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightElectricitymapsCarbonIntensity [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ElectricitymapsCarbonIntensity&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightElectricitymapsCarbonIntensity
```
Above example returns the list of ElectricitymapsCarbonIntensity.

### Example 2
```powershell
PS C:\> $result = Get-IntersightElectricitymapsCarbonIntensity -Name "MoName"
```
Above example returns the ElectricitymapsCarbonIntensity matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightElectricitymapsCarbonIntensity -Organization $organization
```
Above example returns the list of ElectricitymapsCarbonIntensity available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightElectricitymapsCarbonIntensity -InlineCount allpages
```
Above example returns the list of ElectricitymapsCarbonIntensity along with count.
...
### -Name
Specifies the name of the ElectricitymapsCarbonIntensity.
...
### -Organization
Specifies the organization, to fetch the ElectricitymapsCarbonIntensity under it.
