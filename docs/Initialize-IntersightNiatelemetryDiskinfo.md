...
Initialize-IntersightNiatelemetryDiskinfo [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< NiatelemetryDiskinfo.ClassIdEnum>][-Free< long>][-Name< string>][-ObjectType< NiatelemetryDiskinfo.ObjectTypeEnum>][-Total< long>][-Used< long>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: NiatelemetryDiskinfo.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: NiatelemetryDiskinfo.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightNiatelemetryDiskinfo
```
