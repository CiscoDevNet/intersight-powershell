...
Initialize-IntersightNiatelemetryDiskinfo [-AdditionalProperties< Dictionary<string,object>>][-ClassId< NiatelemetryDiskinfo.ClassIdEnum>][-Free< long>][-Name< string>][-ObjectType< NiatelemetryDiskinfo.ObjectTypeEnum>][-Total< long>][-Used< long>]
