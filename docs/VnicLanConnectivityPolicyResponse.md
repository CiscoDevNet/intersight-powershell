...
```powershell
$VnicLanConnectivityPolicyResponse = Initialize-IntersightVnicLanConnectivityPolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$VnicLanConnectivityPolicyResponse | ConvertTo-JSON
```
