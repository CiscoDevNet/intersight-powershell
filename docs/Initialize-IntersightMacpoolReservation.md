...
# Initialize-IntersightMacpoolReservation
...
```yaml
Type: MacpoolReservation.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: MacpoolReservation.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightMacpoolReservation
```
