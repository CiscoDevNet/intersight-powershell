...
## DESCRIPTION
Update a &apos;MetricsConfiguration&apos; resource.
...
### Example 1
```powershell
PS C:\> Set-IntersightMetricsConfiguration
```
...
[Get-IntersightMetricsConfiguration](./Get-IntersightMetricsConfiguration.md)
