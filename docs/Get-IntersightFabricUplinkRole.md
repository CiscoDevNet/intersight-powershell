...
# Get-IntersightFabricUplinkRole

## SYNOPSIS
Get the FabricUplinkRole

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricUplinkRole [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricUplinkRole [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricUplinkRole&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricUplinkRole
```
Above example returns the list of FabricUplinkRole.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricUplinkRole -Name "MoName"
```
Above example returns the FabricUplinkRole matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricUplinkRole -Organization $organization
```
Above example returns the list of FabricUplinkRole available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricUplinkRole -InlineCount allpages
```
Above example returns the list of FabricUplinkRole along with count.
...
### -Name
Specifies the name of the FabricUplinkRole.
...
### -Organization
Specifies the organization, to fetch the FabricUplinkRole under it.
