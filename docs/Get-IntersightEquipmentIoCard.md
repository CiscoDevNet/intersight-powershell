...
### CmdletParam (Default)
```
Get-IntersightEquipmentIoCard [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentIoCard [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentIoCard
```
Above example returns the list of EquipmentIoCard.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentIoCard -Name "MoName"
```
Above example returns the EquipmentIoCard matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentIoCard -Organization $organization
```
Above example returns the list of EquipmentIoCard available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentIoCard -InlineCount allpages
```
Above example returns the list of EquipmentIoCard along with count.
...
### -Name
Specifies the name of the EquipmentIoCard.
...
### -Organization
Specifies the organization, to fetch the EquipmentIoCard under it.
...
[Set-IntersightEquipmentIoCard](./Set-IntersightEquipmentIoCard.md)
