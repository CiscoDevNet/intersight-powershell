...
```powershell
$FirmwareSasExpanderDescriptorResponse = Initialize-IntersightFirmwareSasExpanderDescriptorResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$FirmwareSasExpanderDescriptorResponse | ConvertTo-JSON
```
