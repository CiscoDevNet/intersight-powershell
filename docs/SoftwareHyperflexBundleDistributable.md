...
```powershell
$SoftwareHyperflexBundleDistributable = Initialize-IntersightSoftwareHyperflexBundleDistributable  -ClassId null `
 -ObjectType null `
 -AccountMoid null `
 -CreateTime null `
...
```powershell
$SoftwareHyperflexBundleDistributable | ConvertTo-JSON
```
