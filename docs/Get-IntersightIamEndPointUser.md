...
# Get-IntersightIamEndPointUser

## SYNOPSIS
Get the IamEndPointUser

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightIamEndPointUser [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightIamEndPointUser [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;IamEndPointUser&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightIamEndPointUser
```
Above example returns the list of IamEndPointUser.

### Example 2
```powershell
PS C:\> $result = Get-IntersightIamEndPointUser -Name "MoName"
```
Above example returns the IamEndPointUser matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightIamEndPointUser -Organization $organization
```
Above example returns the list of IamEndPointUser available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightIamEndPointUser -InlineCount allpages
```
Above example returns the list of IamEndPointUser along with count.
...
### -Name
Specifies the name of the IamEndPointUser.
...
### -Organization
Specifies the organization, to fetch the IamEndPointUser under it.
