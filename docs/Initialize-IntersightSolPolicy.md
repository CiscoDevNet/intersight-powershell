...
# Initialize-IntersightSolPolicy
...
Initialize-IntersightSolPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-BaudRate< SolPolicy.BaudRateEnum>][-ClassId< SolPolicy.ClassIdEnum>][-ComPort< SolPolicy.ComPortEnum>][-Description< string>][-Enabled< bool>][-Moid< string>][-Name< string>][-ObjectType< SolPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Profiles< System.Collections.Generic.List`1[Model.PolicyAbstractConfigProfileRelationship]>][-SshPort< long>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> Initialize-IntersightSolPolicy
```
