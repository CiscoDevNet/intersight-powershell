...
# Get-IntersightVnicLanSettings

## SYNOPSIS
Get the VnicLanSettings

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicLanSettings [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicLanSettings [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicLanSettings&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicLanSettings
```
Above example returns the list of VnicLanSettings.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicLanSettings -Name "MoName"
```
Above example returns the VnicLanSettings matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicLanSettings -Organization $organization
```
Above example returns the list of VnicLanSettings available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicLanSettings -InlineCount allpages
```
Above example returns the list of VnicLanSettings along with count.
...
### -Name
Specifies the name of the VnicLanSettings.
...
### -Organization
Specifies the organization, to fetch the VnicLanSettings under it.
