...
## SYNOPSIS
Get the HyperflexConfigResult

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHyperflexConfigResult [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHyperflexConfigResult [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;HyperflexConfigResult&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHyperflexConfigResult
```
Above example returns the list of HyperflexConfigResult.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHyperflexConfigResult -Name "MoName"
```
Above example returns the HyperflexConfigResult matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHyperflexConfigResult -Organization $organization
```
Above example returns the list of HyperflexConfigResult available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHyperflexConfigResult -InlineCount allpages
```
Above example returns the list of HyperflexConfigResult along with count.
...
### -Name
Specifies the name of the HyperflexConfigResult.
...
### -Organization
Specifies the organization, to fetch the HyperflexConfigResult under it.
