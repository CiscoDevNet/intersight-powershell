...
# Get-IntersightFabricLanPinGroup
...
### CmdletParam (Default)
```
Get-IntersightFabricLanPinGroup [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricLanPinGroup [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricLanPinGroup&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricLanPinGroup
```
Above example returns the list of FabricLanPinGroup.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricLanPinGroup -Name "MoName"
```
Above example returns the FabricLanPinGroup matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricLanPinGroup -Organization $organization
```
Above example returns the list of FabricLanPinGroup available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricLanPinGroup -InlineCount allpages
```
Above example returns the list of FabricLanPinGroup along with count.
...
### -Name
Specifies the name of the FabricLanPinGroup.
...
### -Organization
Specifies the organization, to fetch the FabricLanPinGroup under it.
...
[Remove-IntersightFabricLanPinGroup](./Remove-IntersightFabricLanPinGroup.md)
