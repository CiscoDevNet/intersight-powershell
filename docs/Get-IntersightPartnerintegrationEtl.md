...
# Get-IntersightPartnerintegrationEtl

## SYNOPSIS
Get the PartnerintegrationEtl

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightPartnerintegrationEtl [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightPartnerintegrationEtl [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;PartnerintegrationEtl&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationEtl
```
Above example returns the list of PartnerintegrationEtl.

### Example 2
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationEtl -Name "MoName"
```
Above example returns the PartnerintegrationEtl matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationEtl -Organization $organization
```
Above example returns the list of PartnerintegrationEtl available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightPartnerintegrationEtl -InlineCount allpages
```
Above example returns the list of PartnerintegrationEtl along with count.
...
### -Name
Specifies the name of the PartnerintegrationEtl.
...
### -Organization
Specifies the organization, to fetch the PartnerintegrationEtl under it.
...
[Remove-IntersightPartnerintegrationEtl](./Remove-IntersightPartnerintegrationEtl.md)
