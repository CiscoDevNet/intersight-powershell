...
## SYNOPSIS
Get the EquipmentSystemIoController

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentSystemIoController [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentSystemIoController [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;EquipmentSystemIoController&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentSystemIoController
```
Above example returns the list of EquipmentSystemIoController.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentSystemIoController -Name "MoName"
```
Above example returns the EquipmentSystemIoController matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentSystemIoController -Organization $organization
```
Above example returns the list of EquipmentSystemIoController available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentSystemIoController -InlineCount allpages
```
Above example returns the list of EquipmentSystemIoController along with count.
...
### -Name
Specifies the name of the EquipmentSystemIoController.
...
### -Organization
Specifies the organization, to fetch the EquipmentSystemIoController under it.
...
[Set-IntersightEquipmentSystemIoController](./Set-IntersightEquipmentSystemIoController.md)
