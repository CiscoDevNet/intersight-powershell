...
```powershell
$CapabilityCimcFirmwareDescriptorResponse = Initialize-IntersightCapabilityCimcFirmwareDescriptorResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilityCimcFirmwareDescriptorResponse | ConvertTo-JSON
```
