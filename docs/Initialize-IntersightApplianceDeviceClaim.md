...
# Initialize-IntersightApplianceDeviceClaim
...
```yaml
Type: ApplianceDeviceClaim.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ApplianceDeviceClaim.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightApplianceDeviceClaim
```
