...
### Example 1
```powershell
PS C:\> Set-IntersightIamLocalUserPasswordPolicy
```
...
[Get-IntersightIamLocalUserPasswordPolicy](./Get-IntersightIamLocalUserPasswordPolicy.md)
