...
## SYNOPSIS
Get the LicenseIwoCustomerOp

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightLicenseIwoCustomerOp [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightLicenseIwoCustomerOp [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;LicenseIwoCustomerOp&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightLicenseIwoCustomerOp
```
Above example returns the list of LicenseIwoCustomerOp.

### Example 2
```powershell
PS C:\> $result = Get-IntersightLicenseIwoCustomerOp -Name "MoName"
```
Above example returns the LicenseIwoCustomerOp matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightLicenseIwoCustomerOp -Organization $organization
```
Above example returns the list of LicenseIwoCustomerOp available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightLicenseIwoCustomerOp -InlineCount allpages
```
Above example returns the list of LicenseIwoCustomerOp along with count.
...
### -Name
Specifies the name of the LicenseIwoCustomerOp.
...
### -Organization
Specifies the organization, to fetch the LicenseIwoCustomerOp under it.
...
[Set-IntersightLicenseIwoCustomerOp](./Set-IntersightLicenseIwoCustomerOp.md)
