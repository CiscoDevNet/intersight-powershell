...
# Get-IntersightMarketplaceUseCase

## SYNOPSIS
Get the MarketplaceUseCase

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightMarketplaceUseCase [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightMarketplaceUseCase [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;MarketplaceUseCase&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightMarketplaceUseCase
```
Above example returns the list of MarketplaceUseCase.

### Example 2
```powershell
PS C:\> $result = Get-IntersightMarketplaceUseCase -Name "MoName"
```
Above example returns the MarketplaceUseCase matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightMarketplaceUseCase -Organization $organization
```
Above example returns the list of MarketplaceUseCase available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightMarketplaceUseCase -InlineCount allpages
```
Above example returns the list of MarketplaceUseCase along with count.
...
### -Name
Specifies the name of the MarketplaceUseCase.
...
### -Organization
Specifies the organization, to fetch the MarketplaceUseCase under it.
