...
# Initialize-IntersightKvmPolicy
...
Initialize-IntersightKvmPolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< KvmPolicy.ClassIdEnum>][-Description< string>][-EnableLocalServerVideo< bool>][-EnableVideoEncryption< bool>][-Enabled< bool>][-MaximumSessions< long>][-Moid< string>][-Name< string>][-ObjectType< KvmPolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Profiles< System.Collections.Generic.List`1[Model.PolicyAbstractConfigProfileRelationship]>][-RemotePort< long>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-TunneledKvmEnabled< bool>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
### Example 1
```powershell
PS C:\> Initialize-IntersightKvmPolicy
```
