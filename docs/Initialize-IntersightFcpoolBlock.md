...
Initialize-IntersightFcpoolBlock [-AdditionalProperties< Dictionary<string,object>>][-ClassId< FcpoolBlock.ClassIdEnum>][-From< string>][-ObjectType< FcpoolBlock.ObjectTypeEnum>][-To< string>]
