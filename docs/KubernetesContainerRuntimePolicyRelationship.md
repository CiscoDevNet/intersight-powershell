...
```powershell
$KubernetesContainerRuntimePolicyRelationship = Initialize-IntersightKubernetesContainerRuntimePolicyRelationship  -ClassId null `
 -ObjectType null `
 -Moid null `
 -Selector null `
 -Link null `
...
```powershell
$KubernetesContainerRuntimePolicyRelationship | ConvertTo-JSON
```
