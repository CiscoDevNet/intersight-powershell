...
# Get-IntersightSdcardPolicyInventory

## SYNOPSIS
Get the SdcardPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightSdcardPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightSdcardPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;SdcardPolicyInventory&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightSdcardPolicyInventory
```
Above example returns the list of SdcardPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightSdcardPolicyInventory -Name "MoName"
```
Above example returns the SdcardPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightSdcardPolicyInventory -Organization $organization
```
Above example returns the list of SdcardPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightSdcardPolicyInventory -InlineCount allpages
```
Above example returns the list of SdcardPolicyInventory along with count.
...
### -Name
Specifies the name of the SdcardPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the SdcardPolicyInventory under it.
