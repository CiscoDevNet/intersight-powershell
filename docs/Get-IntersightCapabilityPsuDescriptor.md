...
### CmdletParam (Default)
```
Get-IntersightCapabilityPsuDescriptor [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightCapabilityPsuDescriptor [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightCapabilityPsuDescriptor
```
Above example returns the list of CapabilityPsuDescriptor.

### Example 2
```powershell
PS C:\> $result = Get-IntersightCapabilityPsuDescriptor -Name "MoName"
```
Above example returns the CapabilityPsuDescriptor matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightCapabilityPsuDescriptor -Organization $organization
```
Above example returns the list of CapabilityPsuDescriptor available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightCapabilityPsuDescriptor -InlineCount allpages
```
Above example returns the list of CapabilityPsuDescriptor along with count.
...
### -Name
Specifies the name of the CapabilityPsuDescriptor.
...
### -Organization
Specifies the organization, to fetch the CapabilityPsuDescriptor under it.
