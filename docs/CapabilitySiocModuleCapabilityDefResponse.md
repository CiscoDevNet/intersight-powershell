...
```powershell
$CapabilitySiocModuleCapabilityDefResponse = Initialize-IntersightCapabilitySiocModuleCapabilityDefResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$CapabilitySiocModuleCapabilityDefResponse | ConvertTo-JSON
```
