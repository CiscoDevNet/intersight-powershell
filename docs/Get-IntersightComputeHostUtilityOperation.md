...
## SYNOPSIS
Get the ComputeHostUtilityOperation

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputeHostUtilityOperation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputeHostUtilityOperation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ComputeHostUtilityOperation&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputeHostUtilityOperation
```
Above example returns the list of ComputeHostUtilityOperation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputeHostUtilityOperation -Name "MoName"
```
Above example returns the ComputeHostUtilityOperation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputeHostUtilityOperation -Organization $organization
```
Above example returns the list of ComputeHostUtilityOperation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputeHostUtilityOperation -InlineCount allpages
```
Above example returns the list of ComputeHostUtilityOperation along with count.
...
### -Name
Specifies the name of the ComputeHostUtilityOperation.
...
### -Organization
Specifies the organization, to fetch the ComputeHostUtilityOperation under it.
...
[New-IntersightComputeHostUtilityOperation](./New-IntersightComputeHostUtilityOperation.md)
