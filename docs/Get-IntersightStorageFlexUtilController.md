...
## SYNOPSIS
Get the StorageFlexUtilController

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageFlexUtilController [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageFlexUtilController [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageFlexUtilController&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageFlexUtilController
```
Above example returns the list of StorageFlexUtilController.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageFlexUtilController -Name "MoName"
```
Above example returns the StorageFlexUtilController matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageFlexUtilController -Organization $organization
```
Above example returns the list of StorageFlexUtilController available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageFlexUtilController -InlineCount allpages
```
Above example returns the list of StorageFlexUtilController along with count.
...
### -Name
Specifies the name of the StorageFlexUtilController.
...
### -Organization
Specifies the organization, to fetch the StorageFlexUtilController under it.
...
[Set-IntersightStorageFlexUtilController](./Set-IntersightStorageFlexUtilController.md)
