...
# Get-IntersightVnicFcNetworkPolicyInventory

## SYNOPSIS
Get the VnicFcNetworkPolicyInventory

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVnicFcNetworkPolicyInventory [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVnicFcNetworkPolicyInventory [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VnicFcNetworkPolicyInventory&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVnicFcNetworkPolicyInventory
```
Above example returns the list of VnicFcNetworkPolicyInventory.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVnicFcNetworkPolicyInventory -Name "MoName"
```
Above example returns the VnicFcNetworkPolicyInventory matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVnicFcNetworkPolicyInventory -Organization $organization
```
Above example returns the list of VnicFcNetworkPolicyInventory available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVnicFcNetworkPolicyInventory -InlineCount allpages
```
Above example returns the list of VnicFcNetworkPolicyInventory along with count.
...
### -Name
Specifies the name of the VnicFcNetworkPolicyInventory.
...
### -Organization
Specifies the organization, to fetch the VnicFcNetworkPolicyInventory under it.
