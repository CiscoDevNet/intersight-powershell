...
# Get-IntersightNiatelemetryApicPerformanceData

## SYNOPSIS
Get the NiatelemetryApicPerformanceData

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryApicPerformanceData [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryApicPerformanceData [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NiatelemetryApicPerformanceData&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicPerformanceData
```
Above example returns the list of NiatelemetryApicPerformanceData.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicPerformanceData -Name "MoName"
```
Above example returns the NiatelemetryApicPerformanceData matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicPerformanceData -Organization $organization
```
Above example returns the list of NiatelemetryApicPerformanceData available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryApicPerformanceData -InlineCount allpages
```
Above example returns the list of NiatelemetryApicPerformanceData along with count.
...
### -Name
Specifies the name of the NiatelemetryApicPerformanceData.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryApicPerformanceData under it.
