...
## SYNOPSIS
Get the EquipmentSharedIoModule

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightEquipmentSharedIoModule [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentSharedIoModule [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;EquipmentSharedIoModule&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentSharedIoModule
```
Above example returns the list of EquipmentSharedIoModule.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentSharedIoModule -Name "MoName"
```
Above example returns the EquipmentSharedIoModule matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentSharedIoModule -Organization $organization
```
Above example returns the list of EquipmentSharedIoModule available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentSharedIoModule -InlineCount allpages
```
Above example returns the list of EquipmentSharedIoModule along with count.
...
### -Name
Specifies the name of the EquipmentSharedIoModule.
...
### -Organization
Specifies the organization, to fetch the EquipmentSharedIoModule under it.
...
[Set-IntersightEquipmentSharedIoModule](./Set-IntersightEquipmentSharedIoModule.md)
