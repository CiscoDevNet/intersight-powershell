...
Initialize-IntersightEquipmentSwitchCard [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< EquipmentSwitchCard.ClassIdEnum>][-FcPortChannels< System.Collections.Generic.List`1[Model.FcPortChannelRelationship]>][-Moid< string>][-ObjectType< EquipmentSwitchCard.ObjectTypeEnum>][-OutOfBandIpMask< string>][-PortChannels< System.Collections.Generic.List`1[Model.EtherPortChannelRelationship]>][-PreviousFru< Model.EquipmentFruRelationship>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Thermal< EquipmentSwitchCard.ThermalEnum>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
