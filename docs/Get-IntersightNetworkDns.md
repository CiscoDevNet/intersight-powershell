...
### CmdletParam (Default)
```
Get-IntersightNetworkDns [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNetworkDns [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;NetworkDns&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNetworkDns
```
Above example returns the list of NetworkDns.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNetworkDns -Name "MoName"
```
Above example returns the NetworkDns matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNetworkDns -Organization $organization
```
Above example returns the list of NetworkDns available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNetworkDns -InlineCount allpages
```
Above example returns the list of NetworkDns along with count.
...
### -Name
Specifies the name of the NetworkDns.
...
### -Organization
Specifies the organization, to fetch the NetworkDns under it.
