...
```powershell
$ApplianceDeviceCertificateResponse = Initialize-IntersightApplianceDeviceCertificateResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$ApplianceDeviceCertificateResponse | ConvertTo-JSON
```
