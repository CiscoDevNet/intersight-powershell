...
New-IntersightResourceReservation [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Description< string>][-Expiration< DateTime>][-Groups< System.Collections.Generic.List`1[ResourceGroupRelationship]>][-Identity< MoBaseMoRelationship>][-MarkFail< bool>][-Moid< string>][-ReservationSelector< string>][-ResourceType< string>][-Tags< System.Collections.Generic.List`1[MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
