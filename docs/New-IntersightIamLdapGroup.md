...
New-IntersightIamLdapGroup [-AdditionalProperties< Dictionary<string,object>>][-Domain< string>][-EndPointRole< List<IamEndPointRoleRelationship>>][-LdapPolicy< IamLdapPolicyRelationship>][-Moid< string>][[-Name]< string>][-Tags< List<MoTag>>]
