...
```powershell
$SoftwarerepositoryCategoryMapperModelResponse = Initialize-IntersightSoftwarerepositoryCategoryMapperModelResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$SoftwarerepositoryCategoryMapperModelResponse | ConvertTo-JSON
```
