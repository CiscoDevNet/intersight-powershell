...
# Initialize-IntersightKubernetesNodeGroupProfile
...
```yaml
Type: KubernetesNodeGroupProfile.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.KubernetesClusterProfileRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.KubernetesBaseInfrastructureProviderRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.KubernetesVersionPolicyRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.KubernetesNodeGroupLabel]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.KubernetesNodeProfileRelationship]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: KubernetesNodeGroupProfile.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.KubernetesNodeGroupTaint]
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightKubernetesNodeGroupProfile
```
