...
```powershell
$StoragePureProtectionGroupSnapshotResponse = Initialize-IntersightStoragePureProtectionGroupSnapshotResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$StoragePureProtectionGroupSnapshotResponse | ConvertTo-JSON
```
