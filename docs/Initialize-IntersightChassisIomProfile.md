...
# Initialize-IntersightChassisIomProfile
...
```yaml
Type: ChassisIomProfile.IomEntityEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ChassisIomProfile.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ChassisIomProfile.TypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightChassisIomProfile
```
