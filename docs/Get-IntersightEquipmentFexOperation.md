...
### CmdletParam (Default)
```
Get-IntersightEquipmentFexOperation [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightEquipmentFexOperation [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightEquipmentFexOperation
```
Above example returns the list of EquipmentFexOperation.

### Example 2
```powershell
PS C:\> $result = Get-IntersightEquipmentFexOperation -Name "MoName"
```
Above example returns the EquipmentFexOperation matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightEquipmentFexOperation -Organization $organization
```
Above example returns the list of EquipmentFexOperation available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightEquipmentFexOperation -InlineCount allpages
```
Above example returns the list of EquipmentFexOperation along with count.
...
### -Name
Specifies the name of the EquipmentFexOperation.
...
### -Organization
Specifies the organization, to fetch the EquipmentFexOperation under it.
...
[Set-IntersightEquipmentFexOperation](./Set-IntersightEquipmentFexOperation.md)
