...
# Initialize-IntersightServerConfigChangeDetail
...
Initialize-IntersightServerConfigChangeDetail [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-Changes< System.Collections.Generic.List`1[string]>][-ClassId< ServerConfigChangeDetail.ClassIdEnum>][-ConfigChangeContext< Model.PolicyConfigResultContext>][-ConfigChangeFlag< ServerConfigChangeDetail.ConfigChangeFlagEnum>][-Disruptions< System.Collections.Generic.List`1[string]>][-Message< string>][-ModStatus< ServerConfigChangeDetail.ModStatusEnum>][-Moid< string>][-ObjectType< ServerConfigChangeDetail.ObjectTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ServerConfigChangeDetail.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ServerConfigChangeDetail.ConfigChangeFlagEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ServerConfigChangeDetail.ModStatusEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ServerConfigChangeDetail.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightServerConfigChangeDetail
```
...
[Initialize-IntersightPolicyConfigResultContext](./Initialize-IntersightPolicyConfigResultContext.md)
