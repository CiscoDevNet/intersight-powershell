...
# Get-IntersightFabricSpanDestEthPort

## SYNOPSIS
Get the FabricSpanDestEthPort

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightFabricSpanDestEthPort [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightFabricSpanDestEthPort [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;FabricSpanDestEthPort&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightFabricSpanDestEthPort
```
Above example returns the list of FabricSpanDestEthPort.

### Example 2
```powershell
PS C:\> $result = Get-IntersightFabricSpanDestEthPort -Name "MoName"
```
Above example returns the FabricSpanDestEthPort matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightFabricSpanDestEthPort -Organization $organization
```
Above example returns the list of FabricSpanDestEthPort available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightFabricSpanDestEthPort -InlineCount allpages
```
Above example returns the list of FabricSpanDestEthPort along with count.
...
### -Name
Specifies the name of the FabricSpanDestEthPort.
...
### -Organization
Specifies the organization, to fetch the FabricSpanDestEthPort under it.
