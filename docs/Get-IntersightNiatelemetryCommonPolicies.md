...
## SYNOPSIS
Get the NiatelemetryCommonPolicies

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightNiatelemetryCommonPolicies [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightNiatelemetryCommonPolicies [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &amp;apos;NiatelemetryCommonPolicies&amp;apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightNiatelemetryCommonPolicies
```
Above example returns the list of NiatelemetryCommonPolicies.

### Example 2
```powershell
PS C:\> $result = Get-IntersightNiatelemetryCommonPolicies -Name "MoName"
```
Above example returns the NiatelemetryCommonPolicies matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightNiatelemetryCommonPolicies -Organization $organization
```
Above example returns the list of NiatelemetryCommonPolicies available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightNiatelemetryCommonPolicies -InlineCount allpages
```
Above example returns the list of NiatelemetryCommonPolicies along with count.
...
### -Name
Specifies the name of the NiatelemetryCommonPolicies.
...
### -Organization
Specifies the organization, to fetch the NiatelemetryCommonPolicies under it.
