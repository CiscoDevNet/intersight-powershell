...
```powershell
$KubernetesContainerRuntimePolicyResponse = Initialize-IntersightKubernetesContainerRuntimePolicyResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$KubernetesContainerRuntimePolicyResponse | ConvertTo-JSON
```
