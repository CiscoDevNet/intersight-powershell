...
# Initialize-IntersightTaskNexusScopedInventory
...
```yaml
Type: TaskNexusScopedInventory.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: TaskNexusScopedInventory.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightTaskNexusScopedInventory
```
