...
# Initialize-IntersightFabricFcZonePolicy
...
Initialize-IntersightFabricFcZonePolicy [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< FabricFcZonePolicy.ClassIdEnum>][-Description< string>][-FcTargetMembers< System.Collections.Generic.List`1[Model.FabricFcZoneMember]>][-FcTargetZoningType< FabricFcZonePolicy.FcTargetZoningTypeEnum>][-Moid< string>][-Name< string>][-ObjectType< FabricFcZonePolicy.ObjectTypeEnum>][-Organization< Model.OrganizationOrganizationRelationship>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: FabricFcZonePolicy.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: System.Collections.Generic.List`1[Model.FabricFcZoneMember]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricFcZonePolicy.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFabricFcZonePolicy
```
