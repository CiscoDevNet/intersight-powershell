...
# Initialize-IntersightFabricPortOperation
...
```yaml
Type: FabricPortOperation.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: FabricPortOperation.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightFabricPortOperation
```
