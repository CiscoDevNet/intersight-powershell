...
# Get-IntersightHclServerCatalog

## SYNOPSIS
Get the HclServerCatalog

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightHclServerCatalog [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightHclServerCatalog [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;HclServerCatalog&apos; resource.
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightHclServerCatalog
```
Above example returns the list of HclServerCatalog.

### Example 2
```powershell
PS C:\> $result = Get-IntersightHclServerCatalog -Name "MoName"
```
Above example returns the HclServerCatalog matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightHclServerCatalog -Organization $organization
```
Above example returns the list of HclServerCatalog available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightHclServerCatalog -InlineCount allpages
```
Above example returns the list of HclServerCatalog along with count.
...
### -Name
Specifies the name of the HclServerCatalog.
...
### -Organization
Specifies the organization, to fetch the HclServerCatalog under it.
