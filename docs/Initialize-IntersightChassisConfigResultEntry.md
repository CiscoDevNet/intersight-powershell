...
# Initialize-IntersightChassisConfigResultEntry
...
Initialize-IntersightChassisConfigResultEntry [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-ClassId< ChassisConfigResultEntry.ClassIdEnum>][-CompletedTime< string>][-ConfigResult< Model.ChassisConfigResultRelationship>][-Context< Model.PolicyConfigResultContext>][-Message< string>][-Moid< string>][-ObjectType< ChassisConfigResultEntry.ObjectTypeEnum>][-OwnerId< string>][-State< string>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Type< string>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ChassisConfigResultEntry.ClassIdEnum
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Model.ChassisConfigResultRelationship
Parameter Sets: (All)
Aliases:
...
```yaml
Type: ChassisConfigResultEntry.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightChassisConfigResultEntry
```
