...
# Get-IntersightComputeBiosPostPolicy

## SYNOPSIS
Get the ComputeBiosPostPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightComputeBiosPostPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightComputeBiosPostPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;ComputeBiosPostPolicy&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightComputeBiosPostPolicy
```
Above example returns the list of ComputeBiosPostPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightComputeBiosPostPolicy -Name "MoName"
```
Above example returns the ComputeBiosPostPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightComputeBiosPostPolicy -Organization $organization
```
Above example returns the list of ComputeBiosPostPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightComputeBiosPostPolicy -InlineCount allpages
```
Above example returns the list of ComputeBiosPostPolicy along with count.
...
### -Name
Specifies the name of the ComputeBiosPostPolicy.
...
### -Organization
Specifies the organization, to fetch the ComputeBiosPostPolicy under it.
