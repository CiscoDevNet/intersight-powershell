...
```powershell
$FirmwareDriverDistributableResponse = Initialize-IntersightFirmwareDriverDistributableResponse  -ObjectType null `
 -Count null `
 -Results null
```
...
```powershell
$FirmwareDriverDistributableResponse | ConvertTo-JSON
```
