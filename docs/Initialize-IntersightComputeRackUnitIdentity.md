...
# Initialize-IntersightComputeRackUnitIdentity
...
Initialize-IntersightComputeRackUnitIdentity [-AdditionalProperties< System.Collections.Generic.Dictionary`2[string,object]>][-AdminAction< ComputeRackUnitIdentity.AdminActionEnum>][-ClassId< ComputeRackUnitIdentity.ClassIdEnum>][-Identifier< long>][-Moid< string>][-ObjectType< ComputeRackUnitIdentity.ObjectTypeEnum>][-Tags< System.Collections.Generic.List`1[Model.MoTag]>][-Json< SwitchParameter>][-WithHttpInfo< SwitchParameter>]
...
```yaml
Type: ComputeRackUnitIdentity.ObjectTypeEnum
Parameter Sets: (All)
Aliases:
...
### Example 1
```powershell
PS C:\> Initialize-IntersightComputeRackUnitIdentity
```
