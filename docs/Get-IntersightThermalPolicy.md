...
# Get-IntersightThermalPolicy

## SYNOPSIS
Get the ThermalPolicy

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightThermalPolicy [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightThermalPolicy [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightThermalPolicy
```
Above example returns the list of ThermalPolicy.

### Example 2
```powershell
PS C:\> $result = Get-IntersightThermalPolicy -Name "MoName"
```
Above example returns the ThermalPolicy matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightThermalPolicy -Organization $organization
```
Above example returns the list of ThermalPolicy available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightThermalPolicy -InlineCount allpages
```
Above example returns the list of ThermalPolicy along with count.
...
### -Name
Specifies the name of the ThermalPolicy.
...
### -Organization
Specifies the organization, to fetch the ThermalPolicy under it.
