...
## SYNOPSIS
Get the StorageNetAppFcInterface

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightStorageNetAppFcInterface [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightStorageNetAppFcInterface [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;StorageNetAppFcInterface&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcInterface
```
Above example returns the list of StorageNetAppFcInterface.

### Example 2
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcInterface -Name "MoName"
```
Above example returns the StorageNetAppFcInterface matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcInterface -Organization $organization
```
Above example returns the list of StorageNetAppFcInterface available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightStorageNetAppFcInterface -InlineCount allpages
```
Above example returns the list of StorageNetAppFcInterface along with count.
...
### -Name
Specifies the name of the StorageNetAppFcInterface.
...
### -Organization
Specifies the organization, to fetch the StorageNetAppFcInterface under it.
