...
## SYNOPSIS
Get the VirtualizationHost

## SYNTAX

### CmdletParam (Default)
```
Get-IntersightVirtualizationHost [-Name <String>] [-Organization <OrganizationOrganizationRelationship>]
 [<CommonParameters>]
```

### QueryParam
```
Get-IntersightVirtualizationHost [-Count <Boolean>] [-InlineCount <String>] [-Select <String>] [-Filter <String>]
 [-Expand <String>] [-Skip <Int32>] [-Top <Int32>] [-At <String>] [-Orderby <String>] [-Apply <String>]
 [-Tag <String>] [<CommonParameters>]
```
## DESCRIPTION
Read a &apos;VirtualizationHost&apos; resource.,
...
### Example 1
```powershell
PS C:\> $result = Get-IntersightVirtualizationHost
```
Above example returns the list of VirtualizationHost.

### Example 2
```powershell
PS C:\> $result = Get-IntersightVirtualizationHost -Name "MoName"
```
Above example returns the VirtualizationHost matched with name.

### Example 3
```powershell
PS C:\> $result = Get-IntersightVirtualizationHost -Organization $organization
```
Above example returns the list of VirtualizationHost available under the $organization .

### Example 4
```powershell
PS C:\> $result = Get-IntersightVirtualizationHost -InlineCount allpages
```
Above example returns the list of VirtualizationHost along with count.
...
### -Name
Specifies the name of the VirtualizationHost.
...
### -Organization
Specifies the organization, to fetch the VirtualizationHost under it.
...
[Set-IntersightVirtualizationHost](./Set-IntersightVirtualizationHost.md)
