...
Describe -tag 'Intersight' -name 'IntersightFirmwareDirectDownloadAllOf' {
    Context 'IntersightFirmwareDirectDownloadAllOf' {
        It 'Initialize-IntersightFirmwareDirectDownloadAllOf' {
            ...
            #$NewObject = Initialize-IntersightFirmwareDirectDownloadAllOf -HttpServer "TEST_VALUE" -ImageSource "TEST_VALUE" -IsPasswordSet "TEST_VALUE" -Password "TEST_VALUE" -Upgradeoption "TEST_VALUE" -Username "TEST_VALUE"
