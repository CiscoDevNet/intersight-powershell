...
$software_hyperflex_bundle_distributable1 = New-IntersightSoftwareHyperflexBundleDistributable -ComponentMeta $component_meta1 -Release $release1 -Catalog $catalog1 -DistributableMetas $distributable_metas1 -Name 'software_hyperflex_bundle_distributable1' -Sha512Sum '<sha_512_checksum>' -Size 7471044747 -Model '' -Mdfid '' -Vendor 'Cisco' -SupportedModels @('C240-M5')