...
$software_hyperflex_distributable1 = New-IntersightSoftwareHyperflexDistributable -ComponentMeta $component_meta1 -Release $release1 -Catalog $catalog1 -DistributableMetas $distributable_metas1 -Name 'software_hyperflex_distributable1' -Sha512Sum '<sha_512_checksum>' -Size 7471044747 -Model '' -Mdfid '' -Vendor 'Cisco' -SupportedModels @('HyperFlex Data Platform')