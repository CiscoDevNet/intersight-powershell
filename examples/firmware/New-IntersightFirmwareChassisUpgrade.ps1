...
$firmware_chassis_upgrade1 = New-IntersightFirmwareChassisUpgrade -DirectDownload $direct_download1 -NetworkShare $network_share1 -SkipEstimateImpact 0 -Status 'SUCCESSFUL' -UpgradeType 'network_upgrade' -ExcludeComponentList @('local-disk')