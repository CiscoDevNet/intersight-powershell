...
$firmware_upgrade1 = New-IntersightFirmwareUpgrade -DirectDownload $direct_download1 -NetworkShare $network_share1 -SkipEstimateImpact 0 -Status 'SUCCESSFUL' -UpgradeType NetworkUpgrade