...
- Intersight.PowerShell version: 1.0.9.5517
- C# SDK version: 1.0.9.5517
...
```powershell
Remove-Module -FullyQualifiedName @{ModuleName = "Intersight.PowerShell"; ModuleVersion = "1.0.9.5517"}
```
or
