...
- Intersight.PowerShell version: 1.0.9.4950
- C# SDK version: 1.0.9.4950
...
```powershell
Remove-Module -FullyQualifiedName @{ModuleName = "Intersight.PowerShell"; ModuleVersion = "1.0.9.4950"}
```
or
