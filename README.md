...
- Intersight.PowerShell version: 1.0.11.8814
- C# SDK version: 1.0.11.8814
...
```powershell
Remove-Module -FullyQualifiedName @{ModuleName = "Intersight.PowerShell"; ModuleVersion = "1.0.11.8814"}
```
or
