...
- Intersight.PowerShell version: 1.0.9.5313
- C# SDK version: 1.0.9.5313
...
```powershell
Remove-Module -FullyQualifiedName @{ModuleName = "Intersight.PowerShell"; ModuleVersion = "1.0.9.5313"}
```
or
